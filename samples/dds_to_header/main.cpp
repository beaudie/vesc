...
int main(int argc, char **argv)
{
    ...
    std::size_t levels = std::max(static_cast<size_t>(1), static_cast<std::size_t>(header.dwMipMapCount));
    ...
    {
        std::size_t widthAtLevel = std::max(width >> i, static_cast<size_t>(1));
        std::size_t heightAtLevel = std::max(height >> i, static_cast<size_t>(1));
