  ...
  public:
    ...
    virtual bool initialize()
    {
        ...
        const std::string combineFS =
            ...
            "void main()\n"
            "{\n"
            "   float layer = floor(2.0*uv.x);\n"
            "   vec2 adjustedUV = vec2(fract(uv.x*2.), uv.y);\n"
    ...
    virtual void draw()
    {
        // Draw to multiview fbo.
        {
            ...
            // Generate the translation matrices for the left and right eye.
            ...
            // Set the viewport to be the size of one of the views.
        ...
        // Combine both views.
        {
            ...
            // Bind the 2D array texture to be used a sampler.
