...
GLuint CreateSimpleTexture3D()
{
    ...
    // Load the texture: 2x2x2 Image, 4 bytes per pixel (R, G, B, A)
    const size_t width                         = 2;
    const size_t height                        = 2;
    const size_t depth                         = 4;
    const size_t bpp                           = 4;
    GLubyte pixels[width * height * depth * 4] = {
        255, 0,   0,   255,  // Red
        255, 0,   0,   255,  // Red
        255, 0,   0,   255,  // Red
        255, 0,   0,   255,  // Red
    ...
    glTexImage3D(GL_TEXTURE_3D, 0, GL_RGBA, width, height, depth, 0, GL_RGBA, GL_UNSIGNED_BYTE,
                 pixels);
