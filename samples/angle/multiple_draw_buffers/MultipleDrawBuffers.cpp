...
class MultipleDrawBuffersSample : public SampleApplication
{
  public:
    ...
    virtual bool initialize()
    {
        ...
        mMRTProgram = CompileProgramFromFile(getExecutableDir() + "/multiple_draw_buffers_vs.glsl",
                                             getExecutableDir() + "/multiple_draw_buffers_fs.glsl");
        if (!mMRTProgram)
        {
            return false;
        }

        mCopyProgram = CompileProgramFromFile(getExecutableDir() + "/multiple_draw_buffers_vs.glsl",
                                              getExecutableDir() + "/multiple_draw_buffers_copy_fs.glsl");
        if (!mCopyProgram)
        {
            return false;
        }
