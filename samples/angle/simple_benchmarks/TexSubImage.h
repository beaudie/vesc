...
const int SUB_IMAGE_WIDTH = 64;
const int SUB_IMAGE_HEIGHT = 64;

class TexSubImageBenchmark : public SimpleBenchmark
{
public:
    TexSubImageBenchmark::TexSubImageBenchmark(EGLint requestedRenderer)
        : SimpleBenchmark("TexSubImage", 512, 512, 2, requestedRenderer)
    {
    }
    ...
    virtual void drawBenchmark()
    {
        glTexSubImage2D(GL_TEXTURE_2D, 0,
            rand() % (IMAGE_WIDTH - SUB_IMAGE_WIDTH), rand() % (IMAGE_HEIGHT - SUB_IMAGE_HEIGHT),
            SUB_IMAGE_WIDTH, SUB_IMAGE_HEIGHT, GL_RGBA, GL_UNSIGNED_BYTE, mPixels);
