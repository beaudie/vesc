  ...
  public:
    TexRedefBenchSample::TexRedefBenchSample()
        : SampleApplication("Microbench", 1280, 1280),
          mFrameCount(0), mPixels0(NULL), mPixels1(NULL), mTimeFrame(false)
    {
    }

    void createPixelData()
    {
        mPixels0 = new GLubyte[512 * 512 * 4];
        mPixels1 = new GLubyte[512 * 512 * 4];
        GLubyte *pixPtr0 = mPixels0;
        GLubyte *pixPtr1 = mPixels1;
    ...
    virtual bool initialize()
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 256, 256, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 1, GL_RGBA, 128, 128, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 2, GL_RGBA, 64, 64, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 3, GL_RGBA, 32, 32, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 4, GL_RGBA, 16, 16, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 5, GL_RGBA, 8, 8, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 6, GL_RGBA, 4, 4, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 7, GL_RGBA, 2, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
        glTexImage2D(GL_TEXTURE_2D, 8, GL_RGBA, 1, 1, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
    ...
    virtual void draw()
    {
        ...
        { 
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 512, 512, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 256, 256, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 128, 128, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 64, 64, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 32, 32, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 16, 16, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 8, 8, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 4, 4, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 2, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 1, 1, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels0);
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 512, 512, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 256, 256, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 128, 128, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 64, 64, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 32, 32, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 16, 16, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 8, 8, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 4, 4, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 2, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 1, 1, 0, GL_RGBA, GL_UNSIGNED_BYTE, mPixels1);
