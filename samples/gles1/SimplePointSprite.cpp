...
{
  public:
    SimplePointSpriteSample(EGLint displayType)
        : SampleApplication("SimplePointSpriteSample", 1280, 720, 1 /* gles1 */, 0, displayType)
    {
    }
    ...
    virtual void destroy() { glDeleteTextures(1, &mTexture); }
...
int main(int argc, char **argv)
{
    ...
    SimplePointSpriteSample app(displayType);
    return app.run();
}
