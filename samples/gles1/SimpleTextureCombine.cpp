...
{
  public:
    SimpleTextureCombineSample(EGLint displayType)
        : SampleApplication("SimpleTextureEnvironment", 1280, 720, 1 /* gles1 */, 0, displayType)
    {
    }
    ...
    virtual void destroy() { glDeleteTextures((GLsizei)mTextures.size(), mTextures.data()); }
...
int main(int argc, char **argv)
{
    ...
    SimpleTextureCombineSample app(displayType);
