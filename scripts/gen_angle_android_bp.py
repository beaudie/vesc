...
# within Android.
#
# The tool can also generate a json file that describes the dependencies of the
# Chromium build which can then be used to generate the Android.bp file. This is
# handy when tweaking the generation script.
#   cd <chromium>/src
#   gen_angle_android_bp.py --desc_output angle.json //third_party/angle:libGLESv2 //third_party/angle:libEGL
#
# Once the angle.json has been created, can run tool to create Android.bp
#   gen_angle_android_bp.py --desc angle.json //third_party/angle:libGLESv2 //third_party/angle:libEGL
#
