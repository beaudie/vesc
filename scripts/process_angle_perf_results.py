...
def _upload_to_skia_perf(benchmark_directory_map, benchmark_enabled_map, build_properties):
    metric_filenames = []
...
def process_perf_results(output_json,
  ...
  """
    ...
    _upload_to_skia_perf(benchmark_directory_map, benchmark_enabled_map, build_properties)
