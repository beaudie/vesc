...
def write_source(data_source_name, all_cmds, api, path, include_path, ns = "", prefix = None):
...
def gen_libegl_loader():
    ...
    write_source(data_source_name, all_cmds, "egl", path, "libEGL", "", "EGL")
...
def gen_gl_loader():
    ...
    write_source(data_source_name, all_cmds, "gles", path, "util")
...
def gen_egl_loader():
    ...
    write_source(data_source_name, all_cmds, "egl", path, "util")
