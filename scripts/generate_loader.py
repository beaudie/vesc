...
def gen_trace_gles_and_egl_loaders():
    path = os.path.join("..", "src", "tests", "trace_utils")
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        outputs = [
            ...
            '../src/tests/trace_utils/trace_egl_loader_autogen.cpp',
            '../src/tests/trace_utils/trace_egl_loader_autogen.h',
            '../src/tests/trace_utils/trace_gles_loader_autogen.cpp',
            '../src/tests/trace_utils/trace_gles_loader_autogen.h',
        ]
