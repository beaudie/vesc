...
TEMPLATE_GL_VALIDATION_HEADER = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}.
//
// Copyright 2020 The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
TEMPLATE_EGL_VALIDATION_HEADER = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}.
//
// Copyright 2020 The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
def write_validation_header(annotation,
                            comment,
                            protos,
                            source,
                            template=TEMPLATE_GL_VALIDATION_HEADER):
    content = template.format(
        script_name=os.path.basename(sys.argv[0]),
        data_source_name=source,
...
def main():
    ...
    for major_version, minor_version in [[1, 0], [1, 1], [1, 2], [1, 3], [1, 4], [1, 5]]:
        version = "{}_{}".format(major_version, minor_version)
        annotation = "EGL_{}".format(version)
        name_prefix = "EGL_VERSION_"
        ...
        comment = "\n// EGL %s.%s" % (major_version, minor_version)
    ...
    for extension_name, ext_cmd_names in sorted(eglxml.ext_data.iteritems()):
        egl_extension_commands.extend(eglxml.ext_data[extension_name])
