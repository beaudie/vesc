...
for major_version, minor_version in [[2, 0], [3, 0], [3, 1], [1, 0]]:
    ...
    decls, defs, libgles_defs, libgles_exports = get_entry_points(all_commands, gles_commands, len(libgles_ep_exports)+1)
...
for extension_name, ext_cmd_names in sorted(ext_data.iteritems()):
    ...
    decls, defs, libgles_defs, libgles_exports = get_entry_points(all_commands, ext_cmd_names, len(libgles_ep_exports)+1)
