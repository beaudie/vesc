...
// found in the LICENSE file.
//
// capture_gles{annotation}_autogen.h:
...
// found in the LICENSE file.
//
// capture_gles{annotation}_autogen.cpp:
//   Capture functions for the OpenGL ES {comment} entry points.

#include "libANGLE/capture_gles{annotation}_autogen.h"

#include "libANGLE/Context.h"
#include "libANGLE/FrameCapture.h"
#include "libANGLE/validationES{annotation}.h"
...
{{
    ...
    ParamBuffer paramBuffer("{full_name}");
    {parameter_captures}
...
template_sources_includes = """#include "libGLESv2/entry_points_gles_{annotation1}_autogen.h"

#include "libANGLE/Context.h"
#include "libANGLE/Context.inl.h"
#include "libANGLE/capture_gles{annotation2}_autogen.h"
#include "libANGLE/validationES{annotation2}.h"
...
def get_entry_points(all_commands, gles_commands, is_explicit_context, all_param_types):
    decls = []
    defs = []
    export_defs = []
    validation_protos = []
...
def write_capture_header(annotation, comment, protos, capture_pointer_funcs):
    ...
    path = path_to("libANGLE", "capture_gles%s_autogen.h" % annotation)
...
def write_capture_source(annotation, comment, capture_methods):
    ...
    path = path_to("libANGLE", "capture_gles%s_autogen.cpp" % annotation)
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        outputs = [
            ...
            '../src/libANGLE/capture_gles1_autogen.cpp',
            '../src/libANGLE/capture_gles1_autogen.h',
            '../src/libANGLE/capture_gles2_autogen.cpp',
            '../src/libANGLE/capture_gles2_autogen.h',
            '../src/libANGLE/capture_gles3_autogen.cpp',
            '../src/libANGLE/capture_gles3_autogen.h',
            '../src/libANGLE/capture_gles31_autogen.cpp',
            '../src/libANGLE/capture_gles31_autogen.h',
            '../src/libANGLE/capture_glesext_autogen.cpp',
            '../src/libANGLE/capture_glesext_autogen.h',
    ...
    for major_version, minor_version in [[2, 0], [3, 0], [3, 1], [1, 0]]:
        ...
        decls, defs, libgles_defs, validation_protos, capture_protos, capture_methods, capture_pointer_funcs = get_entry_points(
            all_commands, gles_commands, False, all_gles_param_types)
        ...
        source_includes = template_sources_includes.format(
            annotation1=annotation.lower(), annotation2=version_annotation)
        ...
        write_validation_header(version_annotation, comment, validation_protos)

        write_capture_header(version_annotation, comment, capture_protos, capture_pointer_funcs)
        write_capture_source(version_annotation, comment, capture_methods)
    ...
    for extension_name, ext_cmd_names in sorted(xml.ext_data.iteritems()):
        ...
        decls, defs, libgles_defs, validation_protos, capture_protos, capture_methods, capture_param_funcs = get_entry_points(
            xml.all_commands, ext_cmd_names, False, all_gles_param_types)
    ...
    if registry_xml.support_EGL_ANGLE_explicit_context:
        ...
        decls, defs, libgles_defs, validation_protos, capture_protos, capture_methods, capture_param_funcs = get_entry_points(
            xml.all_commands, cmds, True, all_gles_param_types)
    ...
    source_includes = template_sources_includes.format(annotation1="ext", annotation2="EXT")
    source_includes += """
    ...
    write_capture_source("ext", "extension", ext_capture_methods)
