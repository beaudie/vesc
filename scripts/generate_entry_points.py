...
#include "libANGLE/validationES{}{}_autogen.h"
#include "libANGLE/validationES{}{}_inlines.h"
...
for major_version, minor_version in [[2, 0], [3, 0], [3, 1], [1, 0]]:
    ...
    source_includes = template_sources_includes.format(
        annotation.lower(), major_version, minor_if_not_zero, major_version, minor_if_not_zero)
...
source_includes = template_sources_includes.format("ext", "EXT", "", "EXT", "")
source_includes += """
