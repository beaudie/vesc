...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        outputs = [
            ...
            #'../src/libGLESv2/libGL_autogen.cpp',
            #'../src/libGLESv2/libGL_autogen.def',
        ]
    ...
    for major_version in sorted(
        ...
        for _, minor_version in filter(is_major, registry_xml.DESKTOP_GL_VERSIONS):
            ...
            eps = GLEntryPoints(apis.GL, glxml, just_libgl_commands)
            ...
            #TODO(eddiehatfield): Come back to the def/exports files when we are working on windows.
    ...
    #write_export_files("\n".join([item for item in libgles_ep_defs + libgl_ep_defs]), LIBGLESV2_EXPORT_INCLUDES,
    #                   "gl.xml and gl_angle_ext.xml", "libGLESv2", "OpenGL ES")
