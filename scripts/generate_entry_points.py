...
ParamBuffer Capture{short_name}({params_with_type})
{{
...
template_sources_includes = """#include "libGLESv2/entry_points_{annotation1}_autogen.h"

#include "libANGLE/Context.h"
#include "libANGLE/Context.inl.h"
#include "libANGLE/capture_{annotation2}_autogen.h"
#include "libANGLE/validation{annotation3}.h"
...
template_capture_proto = "angle::ParamBuffer Capture%s(%s);"
...
def main():
    ...
    for major_version, minor_version in [[2, 0], [3, 0], [3, 1], [1, 0]]:
        ...
        source_includes = template_sources_includes.format(
            ...
            annotation2=annotation.lower(),
            annotation3="ES" + version_annotation)
    ...
    source_includes = template_sources_includes.format(
        annotation1="gles_ext", annotation2="gles_ext", annotation3="ESEXT")
    source_includes += """
