...
# available in gl.xml.
# FIXME(jmadill): Support extensions not in gl.xml.
...
for extension in root.findall("extensions/extension"):
    ...
    extension_commands = extension.findall('./require/command')
    ext_cmd_names = sorted([command.attrib['name'] for command in extension_commands])

    ext_data[extension_name] = ext_cmd_names
...
for extension_name, ext_cmd_names in sorted(ext_data.iteritems()):
    ...
    # Append the extension description to the first EP
