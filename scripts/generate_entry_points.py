...
# List of GLES1 extensions for which we don't
# need to add Context.h decls.
gles1_no_context_decl_extensions = [
    "GL_OES_framebuffer_object",
]

# List of GLES1 API calls that have had their semantics changed in later GLES
# versions, but the name kept the same 
gles1_overloaded = [
    "glGetPointerv",
]
...
gles1_context_interface_header = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}.
//
// Copyright {year} The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
gles1_context_interface_decl_template = """    {return_type} {name_lower_no_suffix}({internal_params}); \\"""
...
def format_gles1_context_interface_decl(cmd_name, proto, params):
    packed_gl_enums = cmd_packed_gl_enums.get(cmd_name, {})
    ...
    return gles1_context_interface_decl_template.format(
        return_type = return_type,
        name_lower_no_suffix = name_lower_no_suffix,
...
def get_gles1_decls(all_commands, gles_commands):
    ...
    for command in all_commands:
        ...
        param_text = ["".join(param.itertext()) for param in command.findall('param')]
        proto_text = "".join(proto.itertext())
        decls.append(format_gles1_context_interface_decl(cmd_name, proto_text, param_text))
...
def write_gles1_decls(template, decls):
    ...
    path = path_to("libANGLE", "ContextGLES1Decls_autogen.h")
...
write_gles1_decls(gles1_context_interface_header, gles1decls)
