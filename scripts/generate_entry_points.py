...
def get_lock_domain(api, params):
    ...
    if has_surface and has_context:
        return lock_domain_global + lock_domain_surface

    if has_surface:
        return lock_domain_globallock_domain_surface
