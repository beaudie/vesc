...
def write_stubs_header(annotation, title, data_source, out_file, all_commands, commands,
                       cmd_packed_egl_enums, packed_param_types, stubs_header_template):
    ...
    output = stubs_header_template.format(**args)
...
def main():
    ...
    write_stubs_header("cl", "CL", "cl.xml", CL_STUBS_HEADER_PATH, clxml.all_commands, cl_commands,
                       CLEntryPoints.get_packed_enums(), CL_PACKED_TYPES, TEMPLATE_CL_STUBS_HEADER)
    ...
    write_stubs_header("egl", "EGL", "egl.xml", EGL_STUBS_HEADER_PATH, eglxml.all_commands,
    ...
    write_validation_header("EGL", "EGL", egl_validation_protos, "egl.xml and egl_angle_ext.xml",
                            TEMPLATE_EGL_VALIDATION_HEADER)
    write_stubs_header("egl_ext", "EXT extension", "egl.xml and egl_angle_ext.xml",
