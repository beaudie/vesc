...
{{
    ...
    SVDT_EGL_SCOPED_CONTEXT_LOCK({name}, thread{comma_if_needed_context_lock}{internal_context_lock_params});
...
#ifndef LIBANGLE_{annotation_upper}_CONTEXT_LOCK_AUTOGEN_H_
#define LIBANGLE_{annotation_upper}_CONTEXT_LOCK_AUTOGEN_H_
...
#endif  // LIBANGLE_{annotation_upper}_CONTEXT_LOCK_AUTOGEN_H_
"""
...
TEMPLATE_CONTEXT_LOCK_PROTO = "std::unique_lock<angle::GlobalMutex> GetContextLock_%s(%s);"
...
def format_entry_point_def(api, command_node, cmd_name, proto, params, cmd_packed_enums,
    ...
    internal_context_lock_params = [
        ...
        for param in params
        if just_the_type_packed(param, packed_enums) in ["gl::Context *"]
    ]
    packed_gl_enum_conversions = []
    for param in params:
        name = just_the_name(param)
...
def get_context_lock_params(api, cmd_name, params, cmd_packed_gl_enums, packed_param_types):
    ...
    return ", ".join([
        ...
        for param in params
        if just_the_type_packed(param, packed_gl_enums) in ["Thread *", "gl::Context *"]
    ])
