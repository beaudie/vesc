...
template_entry_point_gles1_override_def = """{return_type}GL_APIENTRY {name}({params})
{{
    {event_comment}EVENT("({format_params})"{comma_if_needed}{pass_params});
...
def format_entry_point_def(cmd_name, proto, params, isGles1):
    ...
    if isGles1:
        ...
        if name_lower_no_suffix in gles1_overrides:
            print "use override " + name_lower_no_suffix
            template = template_entry_point_gles1_override_def
