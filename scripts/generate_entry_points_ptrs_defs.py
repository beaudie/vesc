...
template_glext_explicit_context_inl = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}.
//
// Copyright {year} The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
template_glext_function_pointer = """typedef {return_type}(GL_APIENTRYP PFN{name_upper}{explicit_context_suffix})({explicit_context_param}{explicit_context_comma}{params});"""
...
def format_glext_ptr(cmd_name, proto, params, is_explicit_context):
    return_type = proto[:-len(cmd_name)]

    return template_glext_function_pointer.format(
...
def format_glext_proto(cmd_name, proto, params, is_explicit_context, is_gles1):
    return_type = proto[:-len(cmd_name)]

    return template_glext_function_prototype.format(
