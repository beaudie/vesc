...
def library_target_to_blueprint(target, build_info, copy_to_vendor,
...
def gn_target_to_blueprint(target, build_info, copy_to_vendor,
                           relative_install_path):
    for abi in abi_targets:
        ...
        if gn_type in blueprint_library_target_types:
            if copy_to_vendor and gn_type == 'shared_library':
                return library_target_to_blueprint(target, build_info, True,
                           relative_install_path)
            else:
                return library_target_to_blueprint(target, build_info, False,
                           None)
...
def main():
    ...
    for target in targets_to_write:
        blueprint_targets.append(gn_target_to_blueprint(
            target,
            build_info,
            copy_to_vendor,
