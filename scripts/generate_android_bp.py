...
def gn_action_args_to_blueprint_args(blueprint_inputs, blueprint_outputs, args):
    ...
    remap_folders = [
        ...
        ('gen/third_party/vulkan-deps/glslang/src/include/glslang/build_info.h', 'glslang/build_info.h'),
        ('third_party/vulkan-deps/glslang/src', 'external/angle/third_party/vulkan-deps/glslang/src'),
        ('../../', ''),
        ('gen/', ''),
    ]
