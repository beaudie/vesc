...
# We need to set DEPOT_TOOLS_WIN_TOOLCHAIN to 1 for Googlers, as otherwise
# vs_toolchain.py fails during 'gn desc' due to being unable to find the
# Visual Studio files.
GN_ENV['DEPOT_TOOLS_WIN_TOOLCHAIN'] = '0'
for directory in os.environ.get('PATH', []).split(os.pathsep):
    vs_dir = os.path.join(directory, 'win_toolchain', 'vs_files')
    if os.path.exists(vs_dir):
        GN_ENV['DEPOT_TOOLS_WIN_TOOLCHAIN'] = '1'
