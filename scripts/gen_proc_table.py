...
def main():
    ...
    proc_data.append('#if defined(ANGLE_EXPOSE_WGL_ENTRY_POINTS)')
    proc_data.extend(['    {"%s", P(%s)},' % (cmd, cmd) for cmd in sorted(wgl_commands)])
    proc_data.append('#endif // defined(ANGLE_EXPOSE_WGL_ENTRY_POINTS')
