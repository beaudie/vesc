...
{{
    static angle::base::NoDestructor<ProcTable> sProcTable(ProcTable(
        {{{proc_data}}}));
    return *sProcTable;
}}
...
def main():
    ...
    proc_data = ['{"%s", ::cl::%s}' % (cmd, cmd) for cmd in cl_commands]
    # The command 'clIcdGetPlatformIDsKHR' is not in the dispatch table and needs to be redirected
    proc_data.append('{"clIcdGetPlatformIDsKHR", ::cl::clGetPlatformIDs}')
