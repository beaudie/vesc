...
def main():
    ...
    if angle_test_util.HasGtestShardsAndIndex(env):
        shard_count, shard_index = angle_test_util.PopGtestShardsAndIndex(env)
        extra_flags += ['--shard-count=' + shard_count, '--shard-index=' + shard_index]
...
if __name__ == '__main__':
    angle_test_util.MinimalScriptTest(main)
