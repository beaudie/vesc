...
def main():
    ...
    parser.add_argument('gn_path', help='path to GN. (out/Release)')
    parser.add_argument('test', help='test name. (angle_end2end_tests)')
    parser.add_argument('os_dim', help='OS dimension. (Windows-10)')
    parser.add_argument('gpu_dim', help='GPU dimension. (intel-hd-630-win10-stable)')
