...
# Special enum groups that don't have any enum values. Add groups here if you get compile errors.
empty_enum_groups = ['SemaphoreParameterName']
...
def main(header_output_path, source_output_path):
    ...
    gl_group_name = registry_xml.default_enum_group_names[registry_xml.apis.GL]
    gles_group_name = registry_xml.default_enum_group_names[registry_xml.apis.GLES]
    gl_enum_in_groups[gl_group_name] = gl_default_enums
    gl_enum_in_groups[gles_group_name] = gles_default_enums
    ...
    for enums_node in xml.root.findall('enums'):
        for enum in enums_node.findall('enum'):
            ...
            if enum_name in gles_enums or enum_name in bigl_enums:
    ...
    for empty_group in empty_enum_groups:
        assert not empty_group in gl_enum_in_groups, 'Remove %s from the empty groups list, it has enums now.' % empty_group
        gl_enum_in_groups[empty_group] = dict()
