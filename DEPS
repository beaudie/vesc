...
vars = {
  ...
  'chromium_revision': '6154e218769042ab726c20687b7809ade99e2b08',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@c20d1c9e249f459fe2135fdaaa089fb0e338fc82',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@32c8bef651119ef8a6e2ac2e2faf69f4de57aa20',
    'condition': 'not build_with_chromium',
  },
