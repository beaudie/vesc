...
vars = {
  ...
  'chromium_revision': '8e4786fb941801e755c515f0ae3347d0da9082bf',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@a738be34eb54056f512c18f926fcd24a996c5196',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@05c82547eee1b3ab16778ff95aa779b565ac3993',
    'condition': 'not build_with_chromium',
  },
