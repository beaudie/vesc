...
vars = {
  ...
  'chromium_revision': 'bfcb02f1ceb574659c9f0d9b5eb1cbf85040696b',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@83c3cb39f6a92a7594bc930b5f4bdccf37abfbc3',
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@f542c19948a80ec4cd8cd902b7d80ab522c0f4d2',
    'condition': 'not build_with_chromium',
  },
