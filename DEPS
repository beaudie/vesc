...
vars = {
  ...
  'chromium_revision': 'a28bdc27ef94dc756a1fa3ee773e77dbb221bb2a',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@1c30cb9d1cfda02da6e59d6b8f5cb25481c7cd5e',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@a7a5b36e746f6701c607a124b539fc979c579c65',
    'condition': 'not build_with_chromium',
  },
