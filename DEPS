...
vars = {
  ...
  'chromium_revision': 'f037245783713f0eb7b58e834fe5be4c752ca19a',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@89d594dd65324ef0e816a3215518324b14741862',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@073eb20c0e3c4b42d2177b6bca18aebd74c910a0',
    'condition': 'not build_with_chromium',
  },
