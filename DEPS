...
hooks = [
  # The hooks are duplicated for the same reason as the deps, see above.
  # Newly-added deps don't need to be duplicated.
  ...
  },
  {
    ...
    # Hook intentionally only present in new location.
    'name': 'win_toolchain',
    'pattern': '.',
