...
vars = {
  ...
  'chromium_revision': 'e7c434e849f3f4ae90548eabe6039390d88ce463',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@49d269d82f15ad6a6d700f42b9fe403593bf2b3b',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@55e7ce979eb597db102011edb782157a40eb4336',
    'condition': 'not build_with_chromium',
  },
