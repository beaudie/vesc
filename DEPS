...
deps = {
  ...
  '{angle_root}/build': {
    'url': '{chromium_git}/chromium/src/build.git@d7787756cbd19b868fa37c0414333ae5e0ed5ec8',
  ...
  '{angle_root}/tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang.git@3a16568a56486d7d032b8ec7b8dae892413a9a7a',
    'condition': 'not build_with_chromium',
  },
