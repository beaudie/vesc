...
vars = {
  ...
  'chromium_revision': '884dd119b3b684f6666885aeeaddd888c6cc2cb4',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@3cf06a3cf2afdbd2b45bed689f40092d5abae859',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@d4f7010e95b5a3bb4785d052d6d2ea69afd56a77',
    'condition': 'not build_with_chromium',
  },
