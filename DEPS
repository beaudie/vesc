...
vars = {
  ...
  'chromium_revision': 'c7862ee06dc8e9557a6d4fc4618dad34a7078ce1',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@244e0f8abcae467b095a61cde355079f284d6854',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@165cd5a297b12153a93907ca81203dbf15e0f51b',
    'condition': 'not build_with_chromium',
  },
