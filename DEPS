...
vars = {
  ...
  'chromium_revision': 'b3b8b3812b88772ea7112499b598535c1a6f7969',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@065dcf3d4aaf9ab1a306ce98edf8d13655bfa7db',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@2d8283225a443094ae6f1b29307e55aedc05b6dc',
    'condition': 'not build_with_chromium',
  },
