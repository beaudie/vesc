...
vars = {
  ...
  'chromium_revision': '93323abd6358120fabfec1587c02110d85f232aa',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@a0fda66c0c8adf476707ec6976ae3176b17fc17a',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@b254bdf8b2c6197cf4a86988a078172faa19fb5d',
    'condition': 'not build_with_chromium',
  },
