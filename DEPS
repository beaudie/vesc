...
vars = {
  ...
  'chromium_revision': '3019e8b61afee13c8a85410a39b88e4445fa1d19',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@1fd509001790a871dc487ff4a679e179f58efd0b',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@966b6b08281426cddff46c4f4fb3879028f2a00b',
    'condition': 'not build_with_chromium',
  },
