...
vars = {
  ...
  'chromium_revision': '39c131a7e772fcf5fcbf73afaaae7045f4823e46',
...
deps = {
  ...
  'third_party/depot_tools': {
    'url': Var('chromium_git') + '/chromium/tools/depot_tools.git@a64e2481791e478b2ed747c0fdb3ce1064c84219',
    'condition': 'not build_with_chromium',
  },
