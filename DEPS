...
vars = {
  ...
  'chromium_revision': '59412b99c5b8ab6c608f72cb18c99204b33b7ec9',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@882a4eaafa1c7f9746630b008444b0e87e5211ba',
  ...
  'tools/perf': {
    'url': '{chromium_git}/chromium/src/tools/perf@91a23aef011b8647f6d2357aadca21cf0cce326e',
    'condition': 'not build_with_chromium',
  },
