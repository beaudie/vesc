...
deps = {
  ...
  'third_party/clspv': {
    'url': Var('github_git') + '/gowtham-sarc/clspv.git@518eb15aa1ab75c5f0e7f96b6aba445f45ae4b63',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/llvm': {
    'url': Var('github_git') + '/llvm/llvm-project@5888dee7d04748744743a35d3aef030018bdc275',
    'condition': 'not build_with_chromium',
  },
