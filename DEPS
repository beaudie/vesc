...
vars = {
  ...
  'chromium_revision': 'c1f5d920eb1620e227fcecf2df49433f14af4cd2',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@5722dc7e9d53c90f83146db0c5a0c4275d2b951a',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@fd106d16b0fc6dd9261952544ece099b630c20bb',
    'condition': 'not build_with_chromium',
  },
