...
vars = {
  ...
  'chromium_revision': '729f45da86489ec52f95fbcb5d019d77d404c895',
...
deps = {
  ...
  'third_party/depot_tools': {
    'url': Var('chromium_git') + '/chromium/tools/depot_tools.git@097ccfa40e3b06711357252be8714b5b16a24581',
    'condition': 'not build_with_chromium',
  },
