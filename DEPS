...
vars = {
  ...
  'chromium_revision': '71838b7e3b22d9eebcd93f720fe5613389a49f63',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@1b1e3755f44be6186dc92856c1413ba9175222ae',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@0d4b3aa9cffebc489c7045747294039d126e6efd',
    'condition': 'not build_with_chromium',
  },
