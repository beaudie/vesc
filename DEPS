...
vars = {
  ...
  'chromium_revision': '0647c9e1b098e3872cf70d2c5fe39b0fa60e69aa',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@8e4aa5b90b838588a2bee808162e3c87b3a786ed',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@814d9d7e516631b0c910e3ced3485b29204780d8',
    'condition': 'not build_with_chromium',
  },
