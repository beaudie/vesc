...
vars = {
  ...
  'chromium_revision': 'fc1e6e2eb270fd82580bc9f20ec2e777dae3f91e',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@66b7e48915228484c74824e72446a6ef550bad52',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@f8266a949c267f3002c7ec2618d4a165953d6e59',
    'condition': 'not build_with_chromium',
  },
