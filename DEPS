...
vars = {
  ...
  'chromium_revision': '38804e6d83b2f9f781a50add638e7b8eeb70c521',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@5d70e83ee7015037506cbf2ff6652462d8e1da6b',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@c4a20cb12b388115ab2820ece0f3655aa6107fec',
    'condition': 'not build_with_chromium',
  },
