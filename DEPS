...
vars = {
  ...
  'chromium_revision': '2f74d0edc619b063c26b647a50fbed5b9051084e',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@83cc2ebf32f5f8a10d276b3f07f98d3b62247b37',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@f37f2d115c158637f8b46a0518b90d938059a69c',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/zlib': {
    'url': '{chromium_git}/chromium/src/third_party/zlib@2a6432e74981917d2e8a3da8aa294979077f38c0',
    'condition': 'not build_with_chromium',
  },

  'tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang.git@81bf7cadacde86aefc4f78705ecba843f50cd207',
    'condition': 'not build_with_chromium',
  },
