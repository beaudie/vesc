...
vars = {
  ...
  'chromium_revision': '4a495cbe00ff3a7e8f75cce1cdde82a0d04e3a15',
...
deps = {
  ...
  'third_party/depot_tools': {
    'url': Var('chromium_git') + '/chromium/tools/depot_tools.git@943ffbe2212029e5686e3deb0d3852c39f3176f9',
    'condition': 'not build_with_chromium',
  },
