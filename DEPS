...
vars = {
  ...
  'chromium_revision': 'a1826289d17ca062775bfb1fc76c478cd926681c',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@f142cf193dec6aae916e97b388b62e8a77992a0f',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@55f73b69fcf2b8652ffa3ea110fcf6604b21d89a',
    'condition': 'not build_with_chromium',
  },
