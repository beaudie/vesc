...
vars = {
  ...
  'chromium_revision': '52bc4a5ea5692faca9d46f267286d6a17d097a34',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@8907941989aa75fc9ca0559fe47846431004d048',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@efad9f9d65c03398209854667f7e895dec4a1f09',
    'condition': 'not build_with_chromium',
  },
