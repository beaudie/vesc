...
vars = {
  ...
  'chromium_revision': 'eb94798792f9f8a8b26e61e38b7fd38a5a1962a5',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@0b7a0198da6202822e3c9d934327e390760459f1',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@d9eedb5f0ffa95be55919b3b4d1c78d66b3c412c',
    'condition': 'not build_with_chromium',
  },
