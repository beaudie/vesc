...
vars = {
  ...
  'chromium_revision': '4769dcc0d23bf8baf758dd5b7183c5b194c8cf76',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@2f6c079e55604408d0265c164c4ecff321bc5555',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@155a50a14fb90126c7636a4996a00a72f67afd8d',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': '{chromium_git}/chromium/src/tools/perf@60f98c8cb8bff5a5eb0132106148a79a1577e3c9',
    'condition': 'not build_with_chromium',
  },
