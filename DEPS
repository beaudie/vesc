...
vars = {
  ...
  'chromium_revision': '81101d8ce4953819c89ea163fc4f5eee86318f8a',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@85604a1062e243ff995ae2be4f9ae3e236c3bc19',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@e0df90154be8768ef4b56a195be28a14990c1dde',
    'condition': 'not build_with_chromium',
  },
