...
vars = {
  ...
  'chromium_revision': '16f9e63d7abb25be9e0ac624f63ea22a9baf307c',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@ad78bf96d49456f2840d08cf4601849e8bf584f3',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': Var('chromium_git') + '/chromium/src/tools/mb@6022ef025ae5959c22012910b5615ec8e24ef00a',
    'condition': 'not build_with_chromium',
  },
