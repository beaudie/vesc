...
vars = {
  ...
  'chromium_revision': '723f0d34e405407534cee0a718665ee72775c60e',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@eb410d53b341d011a0f1967f010340b7819ecfd2',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@769a956890ab71c6ae0bb281fbac44b85f856116',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@0a2bf9081552d15c618069bbc0e792455f7e9f54',
    'condition': 'not build_with_chromium',
  },
