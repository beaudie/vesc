...
vars = {
  ...
  'chromium_revision': '9e205d0e9cceee0f464270a130ccab21f2470483',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@9d5c32282de17517d92763af2d11dbeb1f6539aa',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@c6e22e62b6020542bb0f9d92dd27c2cb2e7da82b',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/android_deps': {
    'url': Var('chromium_git') + '/chromium/src/third_party/android_deps@3cb2b64c7ec4b21774285740554fd2f1ca1840ba',
    'condition': 'checkout_android and not build_with_chromium',
  },
  ...
  'third_party/zlib': {
    'url': Var('chromium_git') + '/chromium/src/third_party/zlib@4e8c4d69fda7aa903f725a96917ad09d9c5d6a66',
    'condition': 'not build_with_chromium',
  },

  'tools/android': {
    'url': Var('chromium_git') + '/chromium/src/tools/android@a8256b3e9a9c6bc2151b7bf5ff31b6b24ccd92ec',
    'condition': 'checkout_android and not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@8effc9c29d6a2f97a064209d475ff335ffefb108',
    'condition': 'not build_with_chromium',
  },
