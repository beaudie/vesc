...
vars = {
  ...
  'chromium_revision': 'ff7c75cde052effb9733d512d000bf42c05177c7',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@407087083e399b1ca56d47bcc24f1f068211e6ed',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@5cb702857e8bae67fdadb2132653cc487677a794',
    'condition': 'not build_with_chromium',
  },
