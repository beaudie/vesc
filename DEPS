...
vars = {
  ...
  'chromium_revision': 'a41e18a6cd4e39a2a7fef7e68b5688d3e05449d8',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@78a87cac7b9c99939383adc013b6d1cc12aec423',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@a7b9a28ddd9f94efe6ceef6171056df50f41fafa',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/clang': {
    'url': '{chromium_git}/chromium/src/tools/clang.git@bc7937e10a3f24e5094a29f64fd66688ca8019fa',
    'condition': 'not build_with_chromium',
  },
