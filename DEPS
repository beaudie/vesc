...
vars = {
  ...
  'chromium_revision': 'fbebb1f200adc580fe196e22041039b294c8303f',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@417e11ef96d4140606cb6390ef5c372caf46e6f9',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': Var('chromium_git') + '/chromium/src/tools/mb@d55750c7b837555be19166712ceaf15ff2defcf2',
    'condition': 'not build_with_chromium',
  },
