...
deps = {
  ...
  'third_party/vulkan-deps': {
    'url': Var('chromium_git') + '/vulkan-deps@9e0a0c176e6b2420c47c07875a045166c86ac265',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/vulkan-validation-layers/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@e0dd7ee7a48b409528cc30e102557a1785e3e6c2',
    'condition': 'not build_with_chromium',
  },
