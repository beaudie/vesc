...
vars = {
  ...
  'chromium_revision': 'ea9aa6dd02e1e7798e5f51c296f8b63a57363dfb',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@14ce4cbdef5efc548360078467bd20ff6648ca5d',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': '{chromium_git}/chromium/src/tools/perf@e464c1f709975dc1cf36efafb131d074fead6e64',
    'condition': 'not build_with_chromium',
  },
