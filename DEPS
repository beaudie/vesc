...
vars = {
  ...
  'chromium_revision': '3131b8b11def47a9664ef64c5acf690d6ea1abc7',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@33b62adde7c105962a85bc5fb12398feb058c6a4',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@e856f4f0a791724becd2e40dc1fbc24bd2c541b6',
    'condition': 'not build_with_chromium',
  },
