...
vars = {
  ...
  'chromium_revision': '94b16360bc403303b93baaf72edcf35662c4e43e',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@10ff7caa978e1e019c733a3ef83cd0e2df8b2687',
  ...
  'third_party/depot_tools': {
    'url': '{chromium_git}/chromium/tools/depot_tools.git@0a5bae7ebcceab7abdfa2d61b168c93d0fb01697',
    'condition': 'not build_with_chromium',
  },
