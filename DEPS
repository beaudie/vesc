...
vars = {
  ...
  'chromium_revision': '1571727e634f5bf462b2dd7f9f3812a4682cae03',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@134ae1b83366f84fb3b992061bef945223dfdafb',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': '{chromium_git}/chromium/src/tools/mb@51b8fa37995e2f8114058cc0becc587a68c73a03',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': '{chromium_git}/chromium/src/tools/perf@20454374b75b3102d15746614798c153caffc7b9',
    'condition': 'not build_with_chromium',
  },
