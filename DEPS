...
vars = {
  ...
  'chromium_revision': '8a00ec55db22db1522de1caf52d9bb65571955ae',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@5be2904f88c5277ccddfd13002c5e1c34ac924a9',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@4fd4b63ebd8dedcab0f4099ecce99525f7d9cecf',
    'condition': 'not build_with_chromium',
  },
