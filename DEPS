...
vars = {
  ...
  'chromium_revision': '21ab2d264144b0826837c1cdad7cd113482517ae',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@a62c0fe7949d26609ebfaede42551eda0e97b689',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@d9c26b0cb05d1b4b54cfced2d4e0381e5bccbfce',
    'condition': 'not build_with_chromium',
  },
