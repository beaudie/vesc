...
vars = {
  ...
  'chromium_revision': '63be2c4c005414d208ff9d6f7b55888a9673c9ac',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@16c7c6a9e5b90c9aa39b3e24b5bb3accaf7300cd',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@db31bc14e5116261586c556600f619133b3b3be4',
    'condition': 'not build_with_chromium',
  },
