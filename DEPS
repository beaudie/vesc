...
deps = {
  ...
  'third_party/glslang-angle/src':
    Var('android_git') + '/platform/external/shaderc/glslang' + '@' + '20f01e7fd04a5fa2de7b2f185b3cdc2771db506f',
  ...
  'third_party/vulkan-validation-layers/src':
    Var('android_git') + '/platform/external/vulkan-validation-layers' + '@' + '2fbc1a61dff1781368a0c592c25985abb46e4891',
