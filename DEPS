...
vars = {
  ...
  'chromium_revision': 'edc46cb14f9b679ac32ab72b4068ae5f993cf198',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@84f059ecf747158f26cc9d60f1326a04aad9911a',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/clang': {
    'url': Var('chromium_git') + '/chromium/src/tools/clang.git@1dfa6f6b762528ccd5c3892648b000629491ff8b',
    'condition': 'not build_with_chromium',
  },
