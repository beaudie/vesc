...
vars = {
  ...
  'chromium_revision': '34073d2cb5dbde07f5bdbc4c67777c7df820621b',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@03a089b7ac4eb8f764d26d8edda7f766688c6f6c',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@9a94166e80a7f6547de92b46f42bad3130328e94',
    'condition': 'not build_with_chromium',
  },
