...
vars = {
  ...
  'chromium_revision': 'dfd39a22dded82b5376dbb77347e0149a769317c',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@eb3e180b4c481fb17827ba9c01dd4b1b3d2aba1f',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@eb8ded0738d6690e45c466f76d4b829c6c505fbc',
    'condition': 'not build_with_chromium',
  },
