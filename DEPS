...
vars = {
  ...
  'chromium_revision': '74af017c9ab783f5156ca74373db15d623c56d97',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@286c9e59398619c76f7dd4e8ad891ac1fe40b325',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@d4f1bf751340439512ca4ee2a5750ea277de80b6',
    'condition': 'not build_with_chromium',
  },
