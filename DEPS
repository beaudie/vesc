...
vars = {
  ...
  'chromium_revision': '21f3be27fad68762a37c1197ac42bdd66ba9dd50',
...
deps = {
  ...
  'tools/clang': {
    'url': Var('chromium_git') + '/chromium/src/tools/clang.git@170f677e74b7bff10db8a6d916fe10aaf6d44c2b',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@c246a83c9e82fa8b450c17b5206488d479ef0613',
    'condition': 'not build_with_chromium',
  },
