...
vars = {
  ...
  'chromium_revision': '805929e3cc8da0eb458c3997800fab348b964de1',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@12dbdb030b0c2f61415b4821ecd2c84dab899d92',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@3f8603cc162da63b289b4468f822582f160af366',
    'condition': 'not build_with_chromium',
  },
