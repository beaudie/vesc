...
vars = {
  ...
  'chromium_revision': 'c9d2b58f2fdd2da37952eba9e88cfb6fef3edb61',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@3d177886af9c37b8fb923141e9bf4bd64d3cdfa2',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@739b21b404ad55ec9d8006fa7003e5bc7f4d2ef6',
    'condition': 'not build_with_chromium',
  },
