...
deps = {
  ...
  'third_party/vulkan-deps': {
    'url': Var('chromium_git') + '/vulkan-deps@21666dacf74300527819905d157ee4398d582da8',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/spirv-tools/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@ee749f50576b164afdf02e4b116a073661ecf8ff',
    'condition': 'not build_with_chromium',
  },
