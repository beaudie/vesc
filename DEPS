...
vars = {
  ...
  'chromium_revision': 'b4b787f066a69d8a022d493e511a5cb1b2a6e1f5',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@af0ba694d8d93d846355f915b035c326678f6f1b',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@599b179748fc6da4a47b85e855252782a746df5e',
    'condition': 'not build_with_chromium',
  },
