...
vars = {
  ...
  'chromium_revision': 'c0605bdf0acf177989b1c8aeb583be4280d88a2d',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@ff01135102675603fd64938e614b9f27590f3480',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@02ac8c3c7d1c4d13a44fba7adf447588d09369dc',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/depot_tools': {
    'url': '{chromium_git}/chromium/tools/depot_tools.git@0f8ce6d99f516dd42ea77440ae3faed8fbd86ca5',
    'condition': 'not build_with_chromium',
  },
