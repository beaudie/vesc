...
vars = {
  ...
  'chromium_revision': '466fcead79212c9feeaa79ceac117e6085193ca9',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@18546dc762e2b2a3eea57a08ce5fad971601bac6',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@baed76544cd96ce402348a5d0453e3cf386f895a',
    'condition': 'not build_with_chromium',
  },
