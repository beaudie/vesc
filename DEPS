...
vars = {
  ...
  'chromium_revision': '14eb3cf01256abe88a2333af0a88dba1cf458bc3',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@da1855e06bb877723a42937907e4e208dab90241',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@4379dffd12716fe8fb5db977990674e44f08af5c',
    'condition': 'not build_with_chromium',
  },
