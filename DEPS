...
vars = {
  ...
  'chromium_revision': 'c517be5ec7ac1eb2ad274a787378f24965f24e5c',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@ef3b71a91b662426b842846ef01714ecedfe626c',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@a528baa0c670df2d9347c1e68d1fb5093cc93cd0',
    'condition': 'not build_with_chromium',
  },
