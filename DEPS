...
vars = {
  ...
  'chromium_revision': '715f82f729fb15f6504334d60b98e4de90dc7509',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@0c75d62b0bc118236c37752a9557cbb7cbd3fbfa',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@129e2ccccd42979c1e3fe6e01d188c7726be2de2',
    'condition': 'not build_with_chromium',
  },
