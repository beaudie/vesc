...
vars = {
  ...
  'chromium_revision': '22e59c79b02ce0ecf4e89e0c43a8fb515de7195f',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@2237d3cb4fd622371b3f8db0d266e1f965d59ba9',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@15a944165560d27aef50c7a320dfece033aa40dd',
    'condition': 'not build_with_chromium',
  },
