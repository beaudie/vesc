...
vars = {
  ...
  'chromium_revision': '087d891a729c9587524df8cd01e3ac9f1c889a93',
...
deps = {
  ...
  'buildtools': {
    'url': Var('chromium_git') + '/chromium/src/buildtools.git@a3b582543407d6cbdf85a398e5456eed248d4d64',
    'condition': 'not build_with_chromium',
  },
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@1743f95806e76f5c2a527411b0e262a487ff5137',
    'condition': 'not build_with_chromium',
  },
