...
vars = {
  ...
  'chromium_revision': '41f429dd84241d224450b7485398f847122b62ee',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@558db6e1e09b52fbf0338c25be9c35dc5c9cd3af',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@6280c24d65ce922d4d2b193e923da115ea2b6e74',
    'condition': 'not build_with_chromium',
  },
