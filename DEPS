...
vars = {
  ...
  'chromium_revision': '7d8ab070f7a527dec5a5d01b34744468503e5781',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@b837f39fe69248ecc51f70a56503d73c4765b8d2',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@f1af09e240c5809e96183a601de5d0bc5a5da1cf',
    'condition': 'not build_with_chromium',
  },
