...
vars = {
  ...
  'chromium_revision': '78b5547ea963ba7ffd56526f9944ec4cce9f7460',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@5328cf8d5599a47ce0157bd390e7de050b3efe69',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@8f215d5f5229428d74721409688280544e191224',
    'condition': 'not build_with_chromium',
  },
