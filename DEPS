...
vars = {
  ...
  'chromium_revision': '2e7ca6a31bb2a0e33c8e545749b5280f4cf15078',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@a77d9138fce39e0ba5d5d9da0060fa846955ff63',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@55fd0c28ae0230771e2c433a63f8fe4e03196f4a',
    'condition': 'not build_with_chromium',
  },
