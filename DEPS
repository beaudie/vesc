...
hooks = [
  ...
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-clang-format',
                '-s', Var('root') + '/buildtools/mac/clang-format.sha1',
    ],
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-clang-format',
                '-s', Var('root') + '/buildtools/linux64/clang-format.sha1',
    ],
  },
  ...
  },
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-gn',
                '-s', Var('root') + '/buildtools/mac/gn.sha1',
    ],
  },
  {
    'name': 'gn_linux64',
    ...
    'action': [ 'download_from_google_storage',
                ...
                '--no_auth',
                '--bucket', 'chromium-gn',
                '-s', Var('root') + '/buildtools/linux64/gn.sha1',
    ],
  },

  {
    ...
    'action': ['python', Var('root') + '/build/vs_toolchain.py', 'update', '--force'],
  },

  {
    ...
    'name': 'clang',
    'pattern': '.',
    'action': ['python', Var('root') + '/tools/clang/scripts/update.py', '--if-needed'],
  },
  ...
  # Pull rc binaries using checked-in hashes.
  {
    ...
    'action': [ 'download_from_google_storage',
                ...
                '-s', Var('root') + '/build/toolchain/win/rc/win/rc.exe.sha1',
    ],
  },

  {
    ...
    'pattern': '.',
    'action': ['python', Var('root') + '/gyp/gyp_angle'],
  },
]
