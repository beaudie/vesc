...
vars = {
  ...
  'chromium_revision': 'ed2af6817ba7749cb958f37a9c0393db9eab687a',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@18074c8147cb44ee93e37736b716468743a35fa1',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@cf54ed1d3a75a9407d19edfa0602cee5638437d3',
    'condition': 'not build_with_chromium',
  },
