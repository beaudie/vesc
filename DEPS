...
vars = {
  ...
  'chromium_revision': '52b406ed858f018bb66758c31fc6e5f738c190a5',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@2c32a1f0d6705a60b1088960f7525169e1b8108b',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@39047fddd17d27fdbd8f6cce676400c0140829ce',
    'condition': 'not build_with_chromium',
  },
