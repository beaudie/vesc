...
vars = {
  ...
  'chromium_revision': '37c317e7b5a2c86805008c69748a7e810bc851eb',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@27ce505029a685ca65499fa44bd1ecbb8ce0082f',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@66026a1216e472bd11432a3a9a1bca9446057708',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/mb': {
    'url': '{chromium_git}/chromium/src/tools/mb@f83e27d110e35fe1f925751217ddb72b5a40aa2c',
    'condition': 'not build_with_chromium',
  },
