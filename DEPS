...
deps = {
  ...
  # required by {angle_root}/testing
  '{angle_root}/third_party/libFuzzer': {
    'url': '{chromium_git}/chromium/src/testing/libfuzzer@3691e9f437ac8583181b4c3a2ffe991726125f68',
    'condition': 'not build_with_chromium',
  },
