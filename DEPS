...
vars = {
  ...
  'chromium_revision': '0b0b239d062d113e1b3fa7baa836d96169753843',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@3090c552c3a947f2bf776a3f87b56c74f5e94673',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@c0e5a1ed243fbe6cbbfdb1babcfb74a207275ecf',
    'condition': 'not build_with_chromium',
  },
