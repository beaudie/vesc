...
vars = {
  ...
  'chromium_revision': 'd5d231879ae7ca25d71d8d17616f561f20c58065',
...
deps = {
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@23aa0d1082881e672ba0dacacb06dbcc658ad913',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/perf': {
    'url': Var('chromium_git') + '/chromium/src/tools/perf@d77f1ee80e3ccd965da956db29e6715537bcaec0',
    'condition': 'not build_with_chromium',
  },
