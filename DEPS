...
vars = {
  ...
  'chromium_revision': 'c06ac3fbbeab36d93f421d9eb98fc5ba71129f93',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@d30526368bcaea620e0673f71f758e30757610ec',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@cee2926d92d5b25a46fca0e8186d79d6573d668b',
    'condition': 'not build_with_chromium',
  },
