...
vars = {
  ...
  'chromium_revision': '08c9d11dc8d6e624ed82e10f469474f34d3ae981',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@98e61f20eafc18af744a14dcecf564d06a039036',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@5bfc24157dc07990d38b965b71674df361c2073f',
    'condition': 'not build_with_chromium',
  },
  ...
  'tools/clang': {
    'url': Var('chromium_git') + '/chromium/src/tools/clang.git@a2b1b904922c296fb57a85aa85ecb4ea357f9647',
    'condition': 'not build_with_chromium',
  },
