...
vars = {
  ...
  'chromium_revision': '6de7b971a2475bb558e80581e18848f9ce8fe8c7',
...
deps = {
  ...
  'build': {
    'url': Var('chromium_git') + '/chromium/src/build.git@f849d11fa5dd0c45191fc246162ae6877338dee0',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@e18ebe7270796d96e0a954053a8930d90fd67c9c',
    'condition': 'not build_with_chromium',
  },
  ...
  'third_party/depot_tools': {
    'url': Var('chromium_git') + '/chromium/tools/depot_tools.git@5736125232b59d5797bc2d0d852658e9235b7a23',
    'condition': 'not build_with_chromium',
  },
