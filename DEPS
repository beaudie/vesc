...
vars = {
  ...
  'chromium_revision': '58277ea177f8dc32f5fd6b73047d4cf552405f52',
...
deps = {
  ...
  'build': {
    'url': '{chromium_git}/chromium/src/build.git@206a1f9bad19dcf3d0b4b33c14afe980b31ce877',
  ...
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@21319da64a42e5175c978ec1bfad601e12c7acb5',
    'condition': 'not build_with_chromium',
  },
