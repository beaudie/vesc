...
// Map type VkPipelineShaderStageCreateInfo to id
...
// Map type VkPipelineVertexInputStateCreateInfo to id
...
// Map type VkPipelineInputAssemblyStateCreateInfo to id
...
// Map type VkPipelineTessellationStateCreateInfo to id
...
// Map type VkPipelineViewportStateCreateInfo to id
...
// Map type VkPipelineRasterizationStateCreateInfo to id
...
// Map type VkPipelineMultisampleStateCreateInfo to id
...
// Map type VkPipelineDepthStencilStateCreateInfo to id
...
// Map type VkPipelineColorBlendStateCreateInfo to id
...
// Map type VkPipelineDynamicStateCreateInfo to id
...
// Map type VkDescriptorSetLayoutCreateInfo to id
...
// Map type VkPhysicalDeviceSubgroupProperties to id
...
// Map type VkPhysicalDevice16BitStorageFeatures to id
...
// Map type VkDeviceGroupRenderPassBeginInfo to id
...
// Map type VkDeviceGroupCommandBufferBeginInfo to id
...
// Map type VkBindBufferMemoryDeviceGroupInfo to id
...
// Map type VkBindImageMemoryDeviceGroupInfo to id
...
// Map type VkBufferMemoryRequirementsInfo2 to id
...
// Map type VkImageSparseMemoryRequirementsInfo2 to id
...
// Map type VkSparseImageMemoryRequirements2 to id
...
// Map type VkPhysicalDeviceImageFormatInfo2 to id
...
// Map type VkPhysicalDeviceMemoryProperties2 to id
...
// Map type VkPhysicalDeviceSparseImageFormatInfo2 to id
...
// Map type VkPhysicalDevicePointClippingProperties to id
...
// Map type VkRenderPassInputAttachmentAspectCreateInfo to id
...
// Map type VkRenderPassMultiviewCreateInfo to id
...
// Map type VkPhysicalDeviceMultiviewFeatures to id
...
// Map type VkPhysicalDeviceMultiviewProperties to id
...
// Map type VkPhysicalDeviceVariablePointersFeatures to id
...
// Map type VkPhysicalDeviceProtectedMemoryFeatures to id
...
// Map type VkPhysicalDeviceProtectedMemoryProperties to id
...
// Map type VkSamplerYcbcrConversionCreateInfo to id
...
// Map type VkImagePlaneMemoryRequirementsInfo to id
...
// Map type VkPhysicalDeviceSamplerYcbcrConversionFeatures to id
...
// Map type VkSamplerYcbcrConversionImageFormatProperties to id
...
// Map type VkDescriptorUpdateTemplateCreateInfo to id
...
// Map type VkPhysicalDeviceExternalImageFormatInfo to id
...
// Map type VkPhysicalDeviceExternalBufferInfo to id
...
// Map type VkExternalMemoryImageCreateInfo to id
...
// Map type VkExternalMemoryBufferCreateInfo to id
...
// Map type VkPhysicalDeviceExternalFenceInfo to id
...
// Map type VkPhysicalDeviceExternalSemaphoreInfo to id
...
// Map type VkPhysicalDeviceMaintenance3Properties to id
...
// Map type VkPhysicalDeviceShaderDrawParametersFeatures to id
...
// Map type VkBindImageMemorySwapchainInfoKHR to id
...
// Map type VkDeviceGroupPresentCapabilitiesKHR to id
...
// Map type VkDeviceGroupSwapchainCreateInfoKHR to id
...
// Map type VkPhysicalDeviceSurfaceInfo2KHR to id
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkImportMemoryWin32HandleInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkExportMemoryWin32HandleInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkMemoryWin32HandlePropertiesKHR to id
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkWin32KeyedMutexAcquireReleaseInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkImportSemaphoreWin32HandleInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkExportSemaphoreWin32HandleInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkSemaphoreGetWin32HandleInfoKHR to id
...
// Map type VkPhysicalDevicePushDescriptorPropertiesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR
template <>
struct LvlTypeMap<VkPhysicalDevicePushDescriptorPropertiesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR>
{
    typedef VkPhysicalDevicePushDescriptorPropertiesKHR Type;
};

// Map type VkPhysicalDeviceFloat16Int8FeaturesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceFloat16Int8FeaturesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT16_INT8_FEATURES_KHR>
{
...
template <>
struct LvlTypeMap<VkAttachmentDescription2KHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR>
{
...
template <>
struct LvlTypeMap<VkAttachmentReference2KHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2_KHR>
{
...
template <>
struct LvlTypeMap<VkSubpassDescription2KHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2_KHR>
{
...
template <>
struct LvlTypeMap<VkSubpassDependency2KHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2_KHR>
{
...
template <>
struct LvlTypeMap<VkRenderPassCreateInfo2KHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2_KHR>
{
...
template <>
struct LvlTypeMap<VkSubpassBeginInfoKHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO_KHR>
{
...
template <>
struct LvlTypeMap<VkSubpassEndInfoKHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SUBPASS_END_INFO_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SUBPASS_END_INFO_KHR>
{
    typedef VkSubpassEndInfoKHR Type;
};

// Map type VkSharedPresentSurfaceCapabilitiesKHR to id
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkImportFenceWin32HandleInfoKHR to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkExportFenceWin32HandleInfoKHR to id
...
template <>
struct LvlTypeMap<VkImageFormatListCreateInfoKHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR>
{
    typedef VkImageFormatListCreateInfoKHR Type;
};

// Map type VkPhysicalDevice8BitStorageFeaturesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR
template <>
struct LvlTypeMap<VkPhysicalDevice8BitStorageFeaturesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR>
{
    typedef VkPhysicalDevice8BitStorageFeaturesKHR Type;
};

// Map type VkPhysicalDeviceShaderAtomicInt64FeaturesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceShaderAtomicInt64FeaturesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES_KHR>
{
    typedef VkPhysicalDeviceShaderAtomicInt64FeaturesKHR Type;
};

// Map type VkPhysicalDeviceDriverPropertiesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceDriverPropertiesKHR>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR>
{
    typedef VkPhysicalDeviceDriverPropertiesKHR Type;
};

// Map type VkPhysicalDeviceFloatControlsPropertiesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceFloatControlsPropertiesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES_KHR>
{
    typedef VkPhysicalDeviceFloatControlsPropertiesKHR Type;
};

// Map type VkSubpassDescriptionDepthStencilResolveKHR to id
// VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR
template <>
struct LvlTypeMap<VkSubpassDescriptionDepthStencilResolveKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE_KHR>
{
    typedef VkSubpassDescriptionDepthStencilResolveKHR Type;
};

// Map type VkPhysicalDeviceDepthStencilResolvePropertiesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceDepthStencilResolvePropertiesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES_KHR>
{
    typedef VkPhysicalDeviceDepthStencilResolvePropertiesKHR Type;
};

// Map type VkPhysicalDeviceVulkanMemoryModelFeaturesKHR to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES_KHR
template <>
struct LvlTypeMap<VkPhysicalDeviceVulkanMemoryModelFeaturesKHR>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES_KHR;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES_KHR>
{
    typedef VkPhysicalDeviceVulkanMemoryModelFeaturesKHR Type;
};

// Map type VkSurfaceProtectedCapabilitiesKHR to id
...
// Map type VkDedicatedAllocationImageCreateInfoNV to id
...
// Map type VkDedicatedAllocationBufferCreateInfoNV to id
...
// Map type VkDedicatedAllocationMemoryAllocateInfoNV to id
...
// Map type VkPhysicalDeviceTransformFeedbackFeaturesEXT to id
...
// Map type VkPhysicalDeviceTransformFeedbackPropertiesEXT to id
...
// Map type VkStreamDescriptorSurfaceCreateInfoGGP to id
...
// Map type VkPhysicalDeviceCornerSampledImageFeaturesNV to id
...
// Map type VkExternalMemoryImageCreateInfoNV to id
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkImportMemoryWin32HandleInfoNV to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkExportMemoryWin32HandleInfoNV to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkWin32KeyedMutexAcquireReleaseInfoNV to id
...
// Map type VkPhysicalDeviceASTCDecodeFeaturesEXT to id
...
// Map type VkConditionalRenderingBeginInfoEXT to id
...
// Map type VkDeviceGeneratedCommandsFeaturesNVX to id
// VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_FEATURES_NVX
template <>
struct LvlTypeMap<VkDeviceGeneratedCommandsFeaturesNVX>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_FEATURES_NVX;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_FEATURES_NVX>
{
    typedef VkDeviceGeneratedCommandsFeaturesNVX Type;
};

// Map type VkDeviceGeneratedCommandsLimitsNVX to id
// VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_LIMITS_NVX
template <>
struct LvlTypeMap<VkDeviceGeneratedCommandsLimitsNVX>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_LIMITS_NVX;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DEVICE_GENERATED_COMMANDS_LIMITS_NVX>
{
    typedef VkDeviceGeneratedCommandsLimitsNVX Type;
};

// Map type VkIndirectCommandsLayoutCreateInfoNVX to id
// VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NVX
template <>
struct LvlTypeMap<VkIndirectCommandsLayoutCreateInfoNVX>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NVX;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_NVX>
{
...
template <>
struct LvlTypeMap<VkCmdProcessCommandsInfoNVX>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_CMD_PROCESS_COMMANDS_INFO_NVX;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_CMD_PROCESS_COMMANDS_INFO_NVX>
{
    typedef VkCmdProcessCommandsInfoNVX Type;
};

// Map type VkCmdReserveSpaceForCommandsInfoNVX to id
// VK_STRUCTURE_TYPE_CMD_RESERVE_SPACE_FOR_COMMANDS_INFO_NVX
template <>
struct LvlTypeMap<VkCmdReserveSpaceForCommandsInfoNVX>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_CMD_RESERVE_SPACE_FOR_COMMANDS_INFO_NVX;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_CMD_RESERVE_SPACE_FOR_COMMANDS_INFO_NVX>
{
...
template <>
struct LvlTypeMap<VkObjectTableCreateInfoNVX>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_OBJECT_TABLE_CREATE_INFO_NVX;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_OBJECT_TABLE_CREATE_INFO_NVX>
{
    typedef VkObjectTableCreateInfoNVX Type;
};

// Map type VkPipelineViewportWScalingStateCreateInfoNV to id
...
// Map type VkSwapchainCounterCreateInfoEXT to id
...
// Map type VkPipelineViewportSwizzleStateCreateInfoNV to id
...
// Map type VkPhysicalDeviceDiscardRectanglePropertiesEXT to id
...
// Map type VkPipelineDiscardRectangleStateCreateInfoEXT to id
...
// Map type VkPhysicalDeviceDepthClipEnableFeaturesEXT to id
...
// Map type VkDebugUtilsMessengerCallbackDataEXT to id
...
// Map type VkDebugUtilsMessengerCreateInfoEXT to id
...
#ifdef VK_USE_PLATFORM_ANDROID_KHR
// Map type VkAndroidHardwareBufferUsageANDROID to id
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
// Map type VkAndroidHardwareBufferPropertiesANDROID to id
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
// Map type VkAndroidHardwareBufferFormatPropertiesANDROID to id
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
// Map type VkImportAndroidHardwareBufferInfoANDROID to id
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
#ifdef VK_USE_PLATFORM_ANDROID_KHR
// Map type VkMemoryGetAndroidHardwareBufferInfoANDROID to id
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
// Map type VkSamplerReductionModeCreateInfoEXT to id
// VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkSamplerReductionModeCreateInfoEXT>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT>
{
    typedef VkSamplerReductionModeCreateInfoEXT Type;
};

// Map type VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT>
{
    typedef VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT Type;
};

// Map type VkPhysicalDeviceInlineUniformBlockFeaturesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceInlineUniformBlockFeaturesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT>
{
    typedef VkPhysicalDeviceInlineUniformBlockFeaturesEXT Type;
};

// Map type VkPhysicalDeviceInlineUniformBlockPropertiesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceInlineUniformBlockPropertiesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT>
{
    typedef VkPhysicalDeviceInlineUniformBlockPropertiesEXT Type;
};

// Map type VkWriteDescriptorSetInlineUniformBlockEXT to id
// VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT
template <>
struct LvlTypeMap<VkWriteDescriptorSetInlineUniformBlockEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT>
{
    typedef VkWriteDescriptorSetInlineUniformBlockEXT Type;
};

// Map type VkDescriptorPoolInlineUniformBlockCreateInfoEXT to id
// VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkDescriptorPoolInlineUniformBlockCreateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT>
{
...
// Map type VkRenderPassSampleLocationsBeginInfoEXT to id
...
// Map type VkPipelineSampleLocationsStateCreateInfoEXT to id
...
// Map type VkPhysicalDeviceSampleLocationsPropertiesEXT to id
...
// Map type VkPipelineCoverageToColorStateCreateInfoNV to id
...
// Map type VkPipelineCoverageModulationStateCreateInfoNV to id
...
// Map type VkDrmFormatModifierPropertiesListEXT to id
...
// Map type VkPhysicalDeviceImageDrmFormatModifierInfoEXT to id
...
// Map type VkImageDrmFormatModifierListCreateInfoEXT to id
...
// Map type VkImageDrmFormatModifierExplicitCreateInfoEXT to id
...
// Map type VkImageDrmFormatModifierPropertiesEXT to id
...
// Map type VkShaderModuleValidationCacheCreateInfoEXT to id
...
// Map type VkDescriptorSetLayoutBindingFlagsCreateInfoEXT to id
// VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkDescriptorSetLayoutBindingFlagsCreateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT>
{
    typedef VkDescriptorSetLayoutBindingFlagsCreateInfoEXT Type;
};

// Map type VkPhysicalDeviceDescriptorIndexingFeaturesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceDescriptorIndexingFeaturesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT>
{
    typedef VkPhysicalDeviceDescriptorIndexingFeaturesEXT Type;
};

// Map type VkPhysicalDeviceDescriptorIndexingPropertiesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceDescriptorIndexingPropertiesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT>
{
    typedef VkPhysicalDeviceDescriptorIndexingPropertiesEXT Type;
};

// Map type VkDescriptorSetVariableDescriptorCountAllocateInfoEXT to id
// VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT
template <>
struct LvlTypeMap<VkDescriptorSetVariableDescriptorCountAllocateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT>
{
    typedef VkDescriptorSetVariableDescriptorCountAllocateInfoEXT Type;
};

// Map type VkDescriptorSetVariableDescriptorCountLayoutSupportEXT to id
// VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT
template <>
struct LvlTypeMap<VkDescriptorSetVariableDescriptorCountLayoutSupportEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT>
{
...
// Map type VkPhysicalDeviceShadingRateImageFeaturesNV to id
...
// Map type VkPhysicalDeviceShadingRateImagePropertiesNV to id
...
// Map type VkRayTracingShaderGroupCreateInfoNV to id
...
// Map type VkRayTracingPipelineCreateInfoNV to id
...
// Map type VkAccelerationStructureCreateInfoNV to id
...
// Map type VkBindAccelerationStructureMemoryInfoNV to id
...
// Map type VkWriteDescriptorSetAccelerationStructureNV to id
...
// Map type VkPhysicalDeviceImageViewImageFormatInfoEXT to id
...
// Map type VkDeviceQueueGlobalPriorityCreateInfoEXT to id
// VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkDeviceQueueGlobalPriorityCreateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT>
{
    typedef VkDeviceQueueGlobalPriorityCreateInfoEXT Type;
};

// Map type VkImportMemoryHostPointerInfoEXT to id
...
// Map type VkMemoryHostPointerPropertiesEXT to id
...
template <>
struct LvlTypeMap<VkCalibratedTimestampInfoEXT>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT>
{
    typedef VkCalibratedTimestampInfoEXT Type;
};

// Map type VkPhysicalDeviceShaderCorePropertiesAMD to id
...
// Map type VkDeviceMemoryOverallocationCreateInfoAMD to id
...
// Map type VkPipelineVertexInputDivisorStateCreateInfoEXT to id
// VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkPipelineVertexInputDivisorStateCreateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT>
{
    typedef VkPipelineVertexInputDivisorStateCreateInfoEXT Type;
};

// Map type VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES_EXT>
{
...
#endif  // VK_USE_PLATFORM_GGP
// Map type VkPipelineCreationFeedbackCreateInfoEXT to id
// VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkPipelineCreationFeedbackCreateInfoEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT>
{
    typedef VkPipelineCreationFeedbackCreateInfoEXT Type;
};

// Map type VkPhysicalDeviceComputeShaderDerivativesFeaturesNV to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV
template <>
struct LvlTypeMap<VkPhysicalDeviceComputeShaderDerivativesFeaturesNV>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV>
{
    typedef VkPhysicalDeviceComputeShaderDerivativesFeaturesNV Type;
};

// Map type VkPhysicalDeviceMeshShaderFeaturesNV to id
...
// Map type VkPhysicalDeviceMeshShaderPropertiesNV to id
...
template <>
struct LvlTypeMap<VkPhysicalDeviceFragmentShaderBarycentricFeaturesNV>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV>
{
...
// Map type VkPhysicalDeviceExclusiveScissorFeaturesNV to id
...
// Map type VkQueueFamilyCheckpointPropertiesNV to id
...
// Map type VkPhysicalDevicePCIBusInfoPropertiesEXT to id
...
// Map type VkDisplayNativeHdrSurfaceCapabilitiesAMD to id
...
// Map type VkSwapchainDisplayNativeHdrCreateInfoAMD to id
...
// Map type VkImagePipeSurfaceCreateInfoFUCHSIA to id
...
// Map type VkPhysicalDeviceFragmentDensityMapFeaturesEXT to id
...
// Map type VkRenderPassFragmentDensityMapCreateInfoEXT to id
...
// Map type VkPhysicalDeviceScalarBlockLayoutFeaturesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceScalarBlockLayoutFeaturesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES_EXT>
{
    typedef VkPhysicalDeviceScalarBlockLayoutFeaturesEXT Type;
};

// Map type VkPhysicalDeviceMemoryBudgetPropertiesEXT to id
...
// Map type VkPhysicalDeviceMemoryPriorityFeaturesEXT to id
...
// Map type VkMemoryPriorityAllocateInfoEXT to id
...
template <>
struct LvlTypeMap<VkBufferDeviceAddressInfoEXT>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_EXT;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_EXT>
{
    typedef VkBufferDeviceAddressInfoEXT Type;
};

// Map type VkBufferDeviceAddressCreateInfoEXT to id
...
// Map type VkImageStencilUsageCreateInfoEXT to id
// VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT
template <>
struct LvlTypeMap<VkImageStencilUsageCreateInfoEXT>
{
    static const VkStructureType kSType = VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT;
};

template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT>
{
...
// Map type VkPhysicalDeviceCooperativeMatrixFeaturesNV to id
...
// Map type VkPhysicalDeviceCooperativeMatrixPropertiesNV to id
...
// Map type VkPhysicalDeviceYcbcrImageArraysFeaturesEXT to id
...
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkSurfaceFullScreenExclusiveInfoEXT to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkSurfaceCapabilitiesFullScreenExclusiveEXT to id
...
#endif  // VK_USE_PLATFORM_WIN32_KHR
#ifdef VK_USE_PLATFORM_WIN32_KHR
// Map type VkSurfaceFullScreenExclusiveWin32InfoEXT to id
...
// Map type VkPhysicalDeviceHostQueryResetFeaturesEXT to id
// VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT
template <>
struct LvlTypeMap<VkPhysicalDeviceHostQueryResetFeaturesEXT>
{
    static const VkStructureType kSType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT;
};
...
template <>
struct LvlSTypeMap<VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES_EXT>
{
