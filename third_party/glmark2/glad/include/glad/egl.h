 ...
 *
 * Commandline:
 *    --api='egl=1.5' --extensions='EGL_EXT_platform_base,EGL_KHR_platform_x11' c
 *
 * Online:
 *    http://glad.sh/#api=egl%3D1.5&extensions=EGL_EXT_platform_base%2CEGL_KHR_platform_x11&generator=c&options=
 *
 */
