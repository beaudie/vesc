...
#ifndef EGL_ANGLE_platform_angle_wgpu
#define EGL_ANGLE_platform_angle_wgpu 1
#define EGL_PLATFORM_ANGLE_TYPE_WGPU_ANGLE 0x34DD
#endif /* EGL_ANGLE_platform_angle_wgpu */
