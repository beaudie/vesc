...
#ifndef EGL_ANGLE_vulkan_image_client_buffer
#define EGL_ANGLE_vulkan_image_client_buffer
#define EGL_VULKAN_IMAGE_ANGLE 0x34D2
...
#endif /* EGL_ANGLE_vulkan_image_client_buffer */
