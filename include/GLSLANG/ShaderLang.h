...
// - Code to select the viewport index is included at the end of main: gl_ViewportIndex =
// int(ViewID_OVR)
// Note: The SH_INITIALIZE_BUILTINS_FOR_INSTANCED_MULTIVIEW flag also has to be
// enabled to have the temporary variable ViewID_OVR declared and initialized.
