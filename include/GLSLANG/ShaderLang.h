...
// // Rewrite gl_BaseVertex as a uniform int
// const ShCompileOptions SH_EMULATE_GL_BASE_VERTEX = UINT64_C(1) << 43;

// // Rewrite gl_BaseInstance as a uniform int
// const ShCompileOptions SH_EMULATE_GL_BASE_INSTANCE = UINT64_C(1) << 44;
