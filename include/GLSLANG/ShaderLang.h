...
// ViewID_OVR is added as a varying variable to both the vertex and fragment shaders. Note that the
// qualifier will be different depending on the shader version.
