...
typedef enum
{
    ...
    SH_HLSL_3_OUTPUT       = 0x8B48,  // D3D 9
    SH_HLSL_4_OUTPUT       = 0x8B49,  // D3D 11
    SH_HLSL_4_FL9_3_OUTPUT = 0x8B4A   // D3D 11 feature level 9_3
} ShShaderOutput;
...
//         SH_HLSL_3_OUTPUT or SH_HLSL_4_OUTPUT. Note: Each output type may only
