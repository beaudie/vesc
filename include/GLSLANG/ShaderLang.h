...
{
    Undeclared,  // Indicates that no PLS uniform was declared at the binding index in question.
    RGBA8,
    RGBA8I,
    RGBA8UI,
    R32F,
...
// Returns the pixel local storage uniform format at each binding index, or "Undeclared" if there is
// not one.
