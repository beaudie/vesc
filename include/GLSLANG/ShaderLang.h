...
struct ShPixelLocalStorageOptions
{
    ...
    // AMD when the render pass doesn't have attachments. To work around this we attach one of the
    // PLS textures to the framebuffer during PLS-only render passes.
