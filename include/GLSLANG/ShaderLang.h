...
typedef enum {
  ...
  SH_GLSL_130_OUTPUT           = 0x8B47,//Note: GLSL 1.3 is not core, 1.5 is. However, for now, we will modify the code assuming glsl 1.3 is core. In future, we will modify it. 
