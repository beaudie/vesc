...
// Change interface block layout qualifiers to std430 for any layout that is not explicitly set to
// std140.  This is to comply with GL_KHR_vulkan_glsl where shared and packed are not allowed (and
// std430 could be used instead) and unspecified layouts can assume either std140 or std430 (and we
// choose std430).
