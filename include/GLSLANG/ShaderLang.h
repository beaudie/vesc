...
enum ReservedIds
{
    ...
    // Type pointers
    kIdFloatOutputTypePointer,
    kIdFloatPrivateTypePointer,
    kIdFloatUniformTypePointer,
    kIdIntInputTypePointer,
    kIdIntOutputTypePointer,
    kIdIntPrivateTypePointer,
    kIdUIntOutputTypePointer,
    kIdUIntPrivateTypePointer,
