...
// Sampler, image and atomic counter share registers(t type and u type), compiler had reserved
// an range of registers for image2D/iimage2D/uimage2D variables, The methods return the first
// index.
