...
// This flag initializes gl_FragColor to vec4(0,0,0,0) at the
// beginning of the fragment shader's main(). It is intended as a workaround for drivers which
// get context lost if gl_FragColor is not written.
const ShCompileOptions SH_INIT_GL_FRAG_COLOR = UINT64_C(1) << 61;
