...
struct FeaturesVk : FeatureSetBase
{
    ...
    // extension, on which the GL_ANGLE_memory_object_zircon_handle extension can be layered.
    angle::Feature supportsExternalMemoryZirconHandle = {
        "supports_external_memory_zircon_handle", angle::FeatureCategory::VulkanFeatures,
    ...
    // extension, on which the GL_ANGLE_semaphore_zircon_handle extension can be layered.
    angle::Feature supportsExternalSemaphoreZirconHandle = {
        "supports_external_semaphore_zircon_handle", angle::FeatureCategory::VulkanFeatures,
