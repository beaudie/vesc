...
struct FeaturesVk : FeatureSetBase
{
    ...
    // For debug purposes, prefer using a draw to clear, rather than vkCmdClearAttachments.
    // NOTE: Known to generate test failures on Qualcomm devices.
    // TODO(http://anglebug.com/5194): Remove when no longer necessary.
