...
struct FeaturesGL : FeatureSetBase
{
    ...
    FeatureInfo supportsNativeShaderFramebufferFetchEXT = {
        "supportsNativeShaderFramebufferFetchEXT", FeatureCategory::OpenGLFeatures,
        "Backend GL context supports EXT_shader_framebuffer_fetch extension", &members,
        "http://anglebug.com/7279"};

    FeatureInfo supportsNativeShaderFramebufferFetchNonCoherentEXT = {
        "supportsNativeShaderFramebufferFetchNonCoherentEXT", FeatureCategory::OpenGLFeatures,
