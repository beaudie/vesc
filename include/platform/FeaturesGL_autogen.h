...
struct FeaturesGL : FeatureSetBase
{
    ...
    FeatureInfo disableClipCullDistance = {
        "disableClipCullDistance", FeatureCategory::OpenGLWorkarounds,
        "Adreno shader compiler does not handle redeclared built-ins.", &members,
