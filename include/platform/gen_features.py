...
def main():
    ...
    for src_file, (category_prefix, class_name) in feature_files.items():
        ...
        for feature_json in features_json:
            ...
            feature = textwrap.indent(
                template_feature.format(
                    var_name=var_name,
        ...
        with open(header_path(class_name), 'w', newline='\n') as fout:
            fout.write(header)
            fout.close()
    ...
    with open(feature_list_header_file, 'w', newline='\n') as fout:
        fout.write(
    ...
    with open(feature_list_source_file, 'w', newline='\n') as fout:
        fout.write(
