...
namespace angle
{
struct CompilerWorkaroundsD3D : angle::FeaturesStruct
{
    CompilerWorkaroundsD3D();
    ~CompilerWorkaroundsD3D();

    angle::Feature skipOptimization =
        angle::Feature("skip_optimization",
                       angle::FeatureCategory::D3D_COMPILER_WORKAROUNDS,
                       "Skip optimization",
                       &members);

    angle::Feature useMaxOptimization =
        angle::Feature("use_max_optimization",
                       angle::FeatureCategory::D3D_COMPILER_WORKAROUNDS,
                       "Use maximum optimization",
                       &members);

    // IEEE strictness needs to be enabled for NANs to work.
    angle::Feature enableIEEEStrictness =
        angle::Feature("enable_ieee_strictness",
                       angle::FeatureCategory::D3D_COMPILER_WORKAROUNDS,
                       "IEEE strictness needs to be enabled for NANs to work",
                       &members);
};

inline CompilerWorkaroundsD3D::CompilerWorkaroundsD3D()  = default;
inline CompilerWorkaroundsD3D::~CompilerWorkaroundsD3D() = default;

struct WorkaroundsD3D : angle::FeaturesStruct
{
    WorkaroundsD3D();
    ~WorkaroundsD3D();
    ...
    angle::Feature mrtPerfWorkaround =
        angle::Feature("mrt_perf_workaround",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
                       "Some NVIDIA D3D11 drivers have a bug where they ignore null render targets",
                       &members);

    angle::Feature setDataFasterThanImageUpload =
        angle::Feature("set_data_faster_than_image_upload",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature useInstancedPointSpriteEmulation = angle::Feature(
    ...
    angle::Feature depthStencilBlitExtraCopy = angle::Feature(
    ...
    angle::Feature expandIntegerPowExpressions = angle::Feature(
    ...
    angle::Feature flushAfterEndingTransformFeedback = angle::Feature(
    ...
    angle::Feature getDimensionsIgnoresBaseLevel =
        angle::Feature("get_dimensions_ignores_base_level",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature preAddTexelFetchOffsets = angle::Feature(
    ...
    // before we sample.
    angle::Feature emulateTinyStencilTextures = angle::Feature(
    ...
    angle::Feature disableB5G6R5Support = angle::Feature(
    ...
    angle::Feature rewriteUnaryMinusOperator =
        angle::Feature("rewrite_unary_minus_operator",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature callClearTwice =
        angle::Feature("call_clear_twice",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature useSystemMemoryForConstantBuffers =
        angle::Feature("use_system_memory_for_constant_buffers",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature selectViewInGeometryShader = angle::Feature(
    ...
    angle::Feature addDummyTextureNoRenderTarget =
        angle::Feature("add_dummy_texture_no_render_target",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature skipVSConstantRegisterZero =
        angle::Feature("skip_vs_constant_register_zero",
                       angle::FeatureCategory::D3D_WORKAROUNDS,
    ...
    angle::Feature forceAtomicValueResolution = angle::Feature(
