...
struct CompilerWorkaroundsD3D : angle::FeatureSetBase
{
    ...
    angle::Feature skipOptimization = {"skip_optimization",
                                       angle::FeatureCategory::D3DCompilerWorkarounds,
                                       "Skip optimization", &members};

    angle::Feature useMaxOptimization = {"use_max_optimization",
                                         angle::FeatureCategory::D3DCompilerWorkarounds,
                                         "Use maximum optimization", &members};

    // IEEE strictness needs to be enabled for NANs to work.
    angle::Feature enableIEEEStrictness = {
        "enable_ieee_strictness", angle::FeatureCategory::D3DCompilerWorkarounds,
        "IEEE strictness needs to be enabled for NANs to work", &members};
};
