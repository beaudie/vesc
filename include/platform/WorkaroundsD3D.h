...
struct WorkaroundsD3D
{
    ...
    // This workaround is for the ANGLE_mutltiview extension. If enabled the viewport or render
    // target slice will be selected in the geometry shader stage. The workaround flag is added to
    // make it possible to select the code path within higher level code.
