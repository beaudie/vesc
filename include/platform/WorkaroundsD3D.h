...
namespace angle
{
struct CompilerWorkaroundsD3D : angle::FeatureSetBase
{
    CompilerWorkaroundsD3D();
    ~CompilerWorkaroundsD3D();

    angle::Feature skipOptimization = angle::Feature("skip_optimization",
                                                     angle::FeatureCategory::D3DCompilerWorkarounds,
                                                     "Skip optimization",
                                                     &members);
