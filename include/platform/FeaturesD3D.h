...
struct FeaturesD3D : FeatureSetBase
{
    ...
    // Allow to translate uniform block to StructuredBuffer. This is targeted to work around a slow
    ...
    Feature allowTranslateUniformBlockToStructuredBuffer = {
        ...
        "There is a slow fxc compile performance issue with dynamic uniform indexing if translate "
        "an uniform block with a large array member to cbuffer.",
