...
struct FrontendFeatures : angle::FeatureSetBase
{
    ...
    angle::Feature disableProgramBinary = {
        "disable_program_binary", angle::FeatureCategory::FrontendWorkarounds,
        "We are seeing flickering issues on some AMD drivers related to program binary usage.",
        &members, "http://crbug.com/1122224"};
};
