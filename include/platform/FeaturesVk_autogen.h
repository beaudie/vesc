...
struct FeaturesVk : FeatureSetBase
{
    ...
    FeatureInfo syncMonolithicPiplinesToBlobCache = {
        "syncMonolithicPiplinesToBlobCache", FeatureCategory::VulkanWorkarounds,
    ...
    FeatureInfo mergeProgramPipelineCachesToGlobalCache = {
        ...
        "monolithic piplines can reuse blobs from partial pipelines",
        &members, "https://anglebug.com/7369"};
