#ifndef __gl3ext_angle_h_
#define __gl3ext_angle_h_ 1
...
#ifndef GL_ANGLE_MULTISAMPLE_TEXTURE
#define GL_ANGLE_MULTISAMPLE_TEXTURE 1
...
typedef void (GL_APIENTRYP PFNGLTEXSTORAGE2DMULTISAMPLEANGLE) (GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
