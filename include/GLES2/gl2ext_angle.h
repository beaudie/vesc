...
typedef void (GL_APIENTRYP PFNGLSETBLOBCACHEFUNCSANGLEPROC) (GLSETBLOBPROCANGLE, GLGETBLOBPROCANGLE, const void*);
typedef void (GL_APIENTRYP PFNGLGETPOINTERVANGLEPROC) (GLenum pname, void **params);
#ifdef GL_GLEXT_PROTOTYPES
GL_APICALL void GL_APIENTRY glSetBlobCacheFuncsANGLE (GLSETBLOBPROCANGLE, GLGETBLOBPROCANGLE, const void*);
