...
egl::Display *Display::getDisplay(EGLNativeDisplayType displayId, EGLint displayType, bool anglePlatformAngle)
{
    ...
    egl::Display *display = new egl::Display(displayId, displayType, anglePlatformAngle);
    displays->insert(std::make_pair(displayId, display));

    return display;
}

Display::Display(EGLNativeDisplayType displayId, EGLint displayType, bool anglePlatformAngle)
    : mDisplayId(displayId),
      mRequestedDisplayType(displayType),
      mAnglePlatformAngle(anglePlatformAngle),
      mRenderer(NULL)
{
}
...
bool Display::initialize()
{
    ...
    mRenderer = glCreateRenderer(this, mDisplayId, mRequestedDisplayType, mAnglePlatformAngle);
