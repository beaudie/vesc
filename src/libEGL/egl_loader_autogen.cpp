...
PFNEGLPROGRAMCACHEPOPULATEMETALBINARYARCHIVEANGLEPROC
l_EGL_ProgramCachePopulateMetalBinaryArchiveANGLE;
PFNEGLPROGRAMCACHEQUERYMETALBINARYARCHIVEANGLEPROC l_EGL_ProgramCacheQueryMetalBinaryArchiveANGLE;
...
void LoadLibEGL_EGL(LoadProc loadProc)
{
    ...
    l_EGL_ProgramCachePopulateMetalBinaryArchiveANGLE =
        reinterpret_cast<PFNEGLPROGRAMCACHEPOPULATEMETALBINARYARCHIVEANGLEPROC>(
            loadProc("EGL_ProgramCachePopulateMetalBinaryArchiveANGLE"));
    l_EGL_ProgramCacheQueryMetalBinaryArchiveANGLE =
        reinterpret_cast<PFNEGLPROGRAMCACHEQUERYMETALBINARYARCHIVEANGLEPROC>(
            loadProc("EGL_ProgramCacheQueryMetalBinaryArchiveANGLE"));
