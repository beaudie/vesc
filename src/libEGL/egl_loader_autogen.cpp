...
PFNEGLPREPARECREATEWINDOWSURFACEANGLEPROC l_EGL_PrepareCreateWindowSurfaceANGLE;
...
void LoadLibEGL_EGL(LoadProc loadProc)
{
    ...
    l_EGL_PrepareCreateWindowSurfaceANGLE =
        reinterpret_cast<PFNEGLPREPARECREATEWINDOWSURFACEANGLEPROC>(
            loadProc("EGL_PrepareCreateWindowSurfaceANGLE"));
