...
class Display
{
  public:
    ...
    static egl::Display *getDisplay(EGLNativeDisplayType displayId, EGLint displayType, bool anglePlatformAngle);
  ...
  private:
    ...
    Display(EGLNativeDisplayType displayId, EGLint displayType, bool anglePlatformAngle);

    bool restoreLostDevice();

    EGLNativeDisplayType mDisplayId;
    EGLint mRequestedDisplayType;
    bool mAnglePlatformAngle;
