...
def _AddDeqpFiles(suite_name):
    ...
    # TODO: when do we need gen/vk_gl_cts_data/data/gl_cts ?
    # Possibly in multiple suites?
    # https://crsrc.org/c/third_party/angle/src/tests/deqp_support/deqp_data_autogen.gni;drc=3960e63b1a9ce85658a9031c43d55efd85534525;l=298
