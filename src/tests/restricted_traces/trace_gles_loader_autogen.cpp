...
ANGLE_TRACE_LOADER_EXPORT PFNGLACQUIRETEXTURESPROC t_glAcquireTextures;
ANGLE_TRACE_LOADER_EXPORT PFNGLRELEASETEXTURESPROC t_glReleaseTextures;
...
void LoadGLES(LoadProc loadProc)
{
    ...
    t_glAcquireTextures = reinterpret_cast<PFNGLACQUIRETEXTURESPROC>(loadProc("glAcquireTextures"));
    t_glReleaseTextures = reinterpret_cast<PFNGLRELEASETEXTURESPROC>(loadProc("glReleaseTextures"));
