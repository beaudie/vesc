...
void SetupReplayContextShared(void)
{
    ...
    glGenTextures(1, (GLuint *)gReadBuffer);
    UpdateTextureID(3, 0);
    // No binding for textureID 3, using default GL_TEXTURE0;
    ...
    glUniform1iv(gUniformLocations[gCurrentProgram][0], 1, (const GLint *)&gBinaryData[352]);
    glUniform1iv(gUniformLocations[gCurrentProgram][1], 1, (const GLint *)&gBinaryData[368]);
