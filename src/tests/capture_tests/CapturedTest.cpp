...
void main(void) {
   gl_Position = vec4(0.5, 0.5, 0.5, 1.0);
        ...
        constexpr char kActiveBeforeVS[] = R"(attribute vec4 a_position;
...
void main()
{
    ...
    v_texCoord = a_texCoord;
        ...
        constexpr char kActiveBeforeFS[] = R"(precision mediump float;
varying vec2 v_texCoord;
...
void main()
{
    gl_FragColor = texture2D(s_texture, v_texCoord);
        ...
        const char *activeVsSourceArray[1] = {kActiveBeforeVS};
        ...
        const char *activeFsSourceArray[1] = {kActiveBeforeFS};
...
void CapturedTest::frame1()
{
    ...
    // Draw using texture bound before capture started
...
void CapturedTest::frame2()
{
    ...
    constexpr char kActiveDuringVS[] = R"(attribute vec4 a_position;
attribute vec2 a_texCoord;
varying vec2 v_texCoord;
void main()
{
    ...
    constexpr char kActiveDuringFS[] = R"(precision mediump float;
varying vec2 v_texCoord;
uniform sampler2D s_texture;
void main()
{
    ...
    const char *activeVsSourceArray[1] = {kActiveDuringVS};
    ...
    const char *activeFsSourceArray[1] = {kActiveDuringFS};
