                      ...
                      public ::testing::TestWithParam<MultiviewImplementationParams>
{
  protected:
    ...
    {
        if (!ensureExtensionEnabled(extensionName()))
        {
        ...
        {
            if (!ensureExtensionEnabled("GL_OES_texture_storage_multisample_2d_array"))
            {
            ...
            if (!ensureExtensionEnabled("GL_ANGLE_multiview_multisample"))
            {
                std::cout << "Test skipped due to missing GL_ANGLE_multiview_multisample."
                          << std::endl;
                return false;
