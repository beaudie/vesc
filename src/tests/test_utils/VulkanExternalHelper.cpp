...
void VulkanExternalHelper::initialize()
{
    ...
    for (const auto *extensionName : requestedInstanceExtensions)
    {
    ...
    VkInstanceCreateInfo instanceCreateInfo = {
        ...
        /* .enabledExtensionCount = */ enabledInstanceExtensions.size(),
    ...
    ASSERT(mGraphicsQueueFamilyIndex != -1u);

    constexpr size_t queueCreateInfoCount             = 1;
    constexpr size_t graphicsQueueCount               = 1;
    float graphicsQueuePriorities[graphicsQueueCount] = {0.f};
