...
#define ANGLE_ALL_TEST_PLATFORMS_ES1 ES1_D3D11(), ES1_OPENGL(), ES1_OPENGLES()

#define ANGLE_ALL_TEST_PLATFORMS_ES2 ES2_D3D9(), ES2_D3D11(), ES2_OPENGL(), ES2_OPENGLES()

#define ANGLE_ALL_TEST_PLATFORMS_ES3 ES3_D3D11(), ES3_OPENGL(), ES3_OPENGLES()

#define ANGLE_ALL_TEST_PLATFORMS_ES31 ES31_D3D11(), ES31_OPENGL(), ES31_OPENGLES()

#define ANGLE_ALL_TEST_PLATFORMS_ES32 ES32_VULKAN()
