...
#define ANGLE_ALL_TEST_PLATFORMS_GL33_CORE GL33_CORE_VULKAN(), GL33_CORE_VULKAN_SWIFTSHADER()
...
// Instantiate the test once for each desktop GL 3.3 core platform
#define ANGLE_INSTANTIATE_TEST_GL33_CORE(testName)                                      \
    const PlatformParameters testName##params[] = {ANGLE_ALL_TEST_PLATFORMS_GL33_CORE}; \
    INSTANTIATE_TEST_SUITE_P(, testName, ANGLE_INSTANTIATE_TEST_PLATFORMS(testName),    \
                             testing::PrintToStringParamName())

#define ANGLE_INSTANTIATE_TEST_GL33_CORE_AND(testName, ...)                            \
    const PlatformParameters testName##params[] = {ANGLE_ALL_TEST_PLATFORMS_GL33_CORE, \
                                                   __VA_ARGS__};                       \
    INSTANTIATE_TEST_SUITE_P(, testName, ANGLE_INSTANTIATE_TEST_PLATFORMS(testName),   \
                             testing::PrintToStringParamName())
