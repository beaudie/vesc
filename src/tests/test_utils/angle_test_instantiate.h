...
#define ANGLE_ALL_TEST_PLATFORMS_ES1                                                               \
    ES1_D3D11(), ES1_OPENGL(), ES1_OPENGL_EGL(), ES1_OPENGLES(), ES1_OPENGLES_EGL(), ES1_VULKAN(), \
        ES1_VULKAN_SWIFTSHADER(), WithAsyncCommandQueueFeatureVulkan(ES1_VULKAN())

#define ANGLE_ALL_TEST_PLATFORMS_ES2                                                             \
    ES2_D3D9(), ES2_D3D11(), ES2_OPENGL(), ES2_OPENGL_EGL(), ES2_OPENGLES(), ES2_OPENGLES_EGL(), \
        ES2_VULKAN(), ES2_VULKAN_SWIFTSHADER(), ES2_METAL(),                                     \
        WithAsyncCommandQueueFeatureVulkan(ES2_VULKAN())

#define ANGLE_ALL_TEST_PLATFORMS_ES3                                                               \
    ES3_D3D11(), ES3_OPENGL(), ES3_OPENGL_EGL(), ES3_OPENGLES(), ES3_OPENGLES_EGL(), ES3_VULKAN(), \
        ES3_VULKAN_SWIFTSHADER(), ES3_METAL(), WithAsyncCommandQueueFeatureVulkan(ES3_VULKAN())

#define ANGLE_ALL_TEST_PLATFORMS_ES31                                                     \
    ES31_D3D11(), ES31_OPENGL(), ES31_OPENGL_EGL(), ES31_OPENGLES(), ES31_OPENGLES_EGL(), \
        ES31_VULKAN(), ES31_VULKAN_SWIFTSHADER(),                                         \
