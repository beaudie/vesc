...
void ANGLETest::setupIndexedQuadIndexBuffer()
{
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(angle::IndexedQuadIndices), angle::IndexedQuadIndices, GL_STATIC_DRAW);
}
                                ...
                                bool useIndexBuffer)
{
    ...
    if (useIndexBuffer)
    {
        glGetIntegerv(GL_ELEMENT_ARRAY_BUFFER_BINDING, reinterpret_cast<GLint *>(&prevIndexBinding));
