...
OSWindow *ANGLETestBase::getOSWindow()
{
    ...
    auto it = mOSWindows.find(mCurrentRenderer);
    ...
    std::string name   = "ANGLE_TEST" + std::string(angle::GetRendererName(mCurrentRenderer));
    ...
    mOSWindows[mCurrentRenderer] = osWindow;
    return osWindow;
}
