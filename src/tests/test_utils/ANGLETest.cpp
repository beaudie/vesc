...
ANGLETestBase::ANGLETestBase(const angle::PlatformParameters &params)
    : mWidth(16),
      ...
      mAlwaysForceNewDisplay(angle::AlwaysForceNewDisplay()),
      mCurrentPlatform(nullptr)
{
    ...
    if (mAlwaysForceNewDisplay && mOSWindow)
    {
...
void ANGLETestBase::ANGLETestTearDown()
{
    ...
    if (mCurrentPlatform->resetCounter++ >= kWindowReuseLimit || mForceNewDisplay)
    {
