...
void WriteResults(bool interrupted,
                  const TestResults &testResults,
                  ...
                  const char *testSuiteName)
{
    ...
    {
        WriteTestResults(interrupted, testResults, resultsFile, testSuiteName);
    }
...
class TestEventListener : public testing::EmptyTestEventListener
{
  public:
    ...
    void OnTestProgramEnd(const testing::UnitTest &testProgramInfo) override
    {
        ...
        WriteResults(false, *mTestResults, mResultsFile, mHistogramJsonFile, mTestSuiteName);
    }
...
void TestSuite::onCrashOrTimeout(TestResultType crashOrTimeout)
{
    ...
    WriteResults(true, mTestResults, mResultsFile, mHistogramJsonFile, mTestSuiteName.c_str());
}
