...
{
    return EGLPlatformParameters(EGL_PLATFORM_ANGLE_DEVICE_TYPE_NULL_ANGLE);
}
...
{
    return PlatformParameters(1, 0, EGLPlatformParameters(EGL_PLATFORM_ANGLE_DEVICE_TYPE_NULL_ANGLE));
}
...
{
    return PlatformParameters(2, 0, EGLPlatformParameters(EGL_PLATFORM_ANGLE_DEVICE_TYPE_NULL_ANGLE));
}
