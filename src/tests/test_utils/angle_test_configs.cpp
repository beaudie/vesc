...
PlatformParameters GL33_CORE_VULKAN()
{
    return PlatformParameters(EGL_OPENGL_API, 3, 3, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT,
                              egl_platform::VULKAN());
}

PlatformParameters GL33_CORE_VULKAN_SWIFTSHADER()
{
    return PlatformParameters(EGL_OPENGL_API, 3, 3, EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT,
