...
PlatformParameters ES31_D3D11_FL10_1()
{
    return PlatformParameters(3, 1, egl_platform::D3D11_FL10_1());
}

PlatformParameters ES31_D3D11_FL10_0()
{
    return PlatformParameters(3, 1, egl_platform::D3D11_FL10_0());
}
