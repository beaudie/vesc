                                    ...
                                    GLuint depthStencilTexture)
{
    ...
    ASSERT_TRUE((samples == 0) || isMultiview);
                                    ...
                                    GLuint depthStencilTexture)
{
    ...
    CreateMultiviewBackingTextures(isMultiview, samples, viewWidth, height, numLayers,
...
void AttachMultiviewTextures(GLenum target,
                             ...
                             GLuint depthStencilTexture)
{
    ASSERT_TRUE(isMultiview || (baseViewIndex == 0));
                             ...
                             GLuint depthStencilTexture)
{
    ASSERT_TRUE(colorTexture != 0u);
    std::vector<GLuint> colorTextures(1, colorTexture);
    AttachMultiviewTextures(target, isMultiview, viewWidth, numViews, baseViewIndex, colorTextures,
