...
#define ASSERT_GLENUM_NE(expected, actual) ASSERT_NE(static_cast<GLenum>(expected), static_cast<GLenum>(actual))
#define EXPECT_GLENUM_NE(expected, actual) EXPECT_NE(static_cast<GLenum>(expected), static_cast<GLenum>(actual))
