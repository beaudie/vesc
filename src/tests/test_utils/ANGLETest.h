...
// The input here for pixelPoints are the expected pixel precision locations, we add .5 to every
...
void CreatePixelCenterWindowCoords(std::vector<Vector2> pixelPoints,
                                   int windowWidth,
                                   int windowHeight,
