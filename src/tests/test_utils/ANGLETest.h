...
struct GLColor16
{
    ...
    static const GLColor16 red;
    static const GLColor16 green;
    static const GLColor16 blue;
    static const GLColor16 cyan;
    static const GLColor16 black;
...
#define EXPECT_PIXEL16_EQ(x, y, r, g, b, a) \
    EXPECT_EQ(angle::MakeGLColor16(r, g, b, a), angle::ReadColor16(x, y))

#define EXPECT_PIXEL16_ALPHA_EQ(x, y, a) EXPECT_EQ(a, angle::ReadColor16(x, y).A)

#define EXPECT_PIXEL16_COLOR_EQ(x, y, angleColor) EXPECT_EQ(angleColor, angle::ReadColor16(x, y))
