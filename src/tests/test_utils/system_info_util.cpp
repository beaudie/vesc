...
size_t findGPU(SystemInfo &systemInfo, bool lowPower)
{
...
size_t FindLowPowerGPU(SystemInfo &systemInfo)
{
    return findGPU(systemInfo, true);
}

size_t FindHighPowerGPU(SystemInfo &systemInfo)
{
    return findGPU(systemInfo, false);
}

size_t FindActiveOpenGLGPU(SystemInfo &systemInfo)
{
