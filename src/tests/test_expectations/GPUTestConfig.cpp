...
bool OperatingSystemVersionNumbers(int32_t *majorVersion, int32_t *minorVersion);

bool IsWinVersion(const int32_t majorVersion);
bool IsWinVersion(const int32_t majorVersion, const int32_t minorVersion);
bool IsWinXP();
bool IsWinVista();
bool IsWin7();
bool IsWin8();
...
bool IsMacVersion(const int32_t majorVersion, const int32_t minorVersion);
bool IsMacLeopard();
...
bool IsDeviceIdGPU(const std::string &gpuDeviceId);
...
bool GetGPUTestSystemInfo(SystemInfo **sysInfo)
{
    ...
    if (sSystemInfo == nullptr)
    {
        ...
        {
            std::cout << "Error populating SystemInfo for dEQP tests." << endl;
        }
        else
        {
            sPopulated = true;
...
bool GetActiveGPU(GPUDeviceInfo **devInfo)
{
