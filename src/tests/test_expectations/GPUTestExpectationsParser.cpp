...
const TokenInfo kTokenData[kNumberOfTokens] = {
    ...
    {"chromeos"},  // ChromeOS not supported yet
...
static inline bool StartsWithASCII(const std::string &str,
...
static inline bool LowerCaseEqualsASCII(const std::string &a, const char *b)
{
    return DoLowerCaseEqualsASCII(a.begin(), a.end(), b);
}

static inline Token ParseToken(const std::string &word)
{
...
static inline bool NamesMatching(const std::string &ref, const std::string &testName)
{
