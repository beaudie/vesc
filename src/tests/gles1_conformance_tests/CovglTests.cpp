...
// CovglTest have additional error check in TEST ProbeError(Call* funtions, so we need to override
// FailAndDie. One feasible method is set __attribute__((weak)) to origin FailAndDie(), and override
// here.
