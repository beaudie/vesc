...
{
    r_eglCreateImage     = reinterpret_cast<PFNEGLCREATEIMAGEPROC>(EGLCreateImage);
    r_eglCreateImageKHR  = reinterpret_cast<PFNEGLCREATEIMAGEKHRPROC>(EGLCreateImageKHR);
    r_eglDestroyImage    = reinterpret_cast<PFNEGLDESTROYIMAGEPROC>(EGLDestroyImage);
    r_eglDestroyImageKHR = reinterpret_cast<PFNEGLDESTROYIMAGEKHRPROC>(EGLDestroyImageKHR);
    gEGLWindow           = window;
}
