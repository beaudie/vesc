...
static EGLBoolean ANGLE_REPLAY_EXPORT EGLDestroyImage(EGLDisplay display, EGLImage image)
{
    return gEGLWindow->destroyImage(image);
}

static EGLBoolean ANGLE_REPLAY_EXPORT EGLDestroyImageKHR(EGLDisplay display, EGLImage image)
{
