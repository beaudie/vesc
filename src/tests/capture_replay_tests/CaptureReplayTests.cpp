  ...
  public:
    ...
    int runTest(uint32_t testIndex, const TestTraceInfo &testTraceInfo)
    {
             ...
             frame++)
        {
            ...
            const char *chapturedSerializedState =
            ...
            bool isEqual =
                (chapturedSerializedState && replayedSerializedState)
                    ? compareSerializedContexts(replayedSerializedState, chapturedSerializedState)
                    : (chapturedSerializedState == replayedSerializedState);
            ...
            if (!isEqual)
            {
                ...
                debugCapture << (chapturedSerializedState ? chapturedSerializedState : "") << "\n";
