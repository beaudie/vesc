...
constexpr char kTracePath[] = ANGLE_MACRO_STRINGIZE(ANGLE_CAPTURE_REPLAY_TEST_NAMES_PATH);
  ...
  public:
    ...
    int run()
    {
        ...
        for (const std::string &trace : traces)
        {
            ...
            traceJsonPathStream << ANGLE_CAPTURE_REPLAY_TEST_DATA_DIR << trace << ".json";
            ...
            {
                std::cout << "Unable to load trace data for " << trace << "\n";
            }
            else
            {
