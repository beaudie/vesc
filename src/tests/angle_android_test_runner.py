...
def RunWithChromiumTestRunner(args):
...
def main():
    ...
    parser.add_argument(
        '--use-angle-scripts',
        help='Use ANGLE scripts instead of Chroimum/catapult',
        action='store_true')

    args, extra_args = parser.parse_known_args()

    use_angle_scripts = args.use_angle_scripts or args.suite == 'angle_trace_tests'
    ...
    if use_angle_scripts:
        return RunAndroidTestSuite(args, extra_args)
    else:
        return RunWithChromiumTestRunner(args)
