...

{
    'variables':
    {
        ...
        [
            ...
            '<(angle_path)/src/tests/deqp_support/egluNativeDisplay.cpp',
            '<(angle_path)/src/tests/deqp_support/egluNativeDisplay.hpp',
            ...
            '<(angle_path)/src/tests/deqp_support/egluUtil.cpp',
