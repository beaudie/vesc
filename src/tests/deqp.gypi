...

                        {
                            ...
                            [
                                ['angle_standalone==1',
                                {
                                    'sources':
                                    [
                                        'third_party/gpu_test_expectations/gpu/config/gpu_info.cc',
                                        'third_party/gpu_test_expectations/gpu/config/gpu_info.h',
                                        'third_party/gpu_test_expectations/gpu/config/gpu_test_config.cc',
                                        'third_party/gpu_test_expectations/gpu/config/gpu_test_config.h',
                                        'third_party/gpu_test_expectations/gpu/config/gpu_test_expectations_parser.cc',
                                        'third_party/gpu_test_expectations/gpu/config/gpu_test_expectations_parser.h',
                                    ],
                                }]
                            ],
                        },
