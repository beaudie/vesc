...
{
    const char *str = "#line 2147483646\n/*\n*/";
...
// Test for an error being generated when the line number overflows - line continutation version
TEST_F(LocationTest, LineOverflowInLineContinuation)
{
    const char *str = "#line 2147483646\n\\\n";
