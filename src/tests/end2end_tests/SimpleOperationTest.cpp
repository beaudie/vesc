...
{
  protected:
    SimpleOperationTest() : ANGLETest(GetParam().mClientVersion, GetParam().mEGLPlatformParameters)
    {
        setWindowWidth(128);
        setWindowHeight(128);
        setConfigRedBits(8);
...
INSTANTIATE_TEST_CASE_P(
    ANGLE, SimpleOperationTest,
    ::testing::Values(ES2_D3D9(), ES2_D3D11(), ES3_D3D11(), ES2_OPENGL(), ES3_OPENGL()));
