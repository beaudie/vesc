...
class QueryDisplayAttributeTest : public ANGLETest
{
  protected:
    ...
    virtual void SetUp()
    {
        ...
        if (strstr(extensionString, "EGL_ANGLE_device_d3d") && strstr(extensionString, "EGL_EXT_display_device"))
        {
        ...
        {
            FAIL() << "ANGLE extension EGL_EXT_display_device export eglQueryDisplayAttribEXT was not found";
        }

        if (!mQueryDeviceAttribEXT)
        {
            FAIL() << "ANGLE extension EGL_EXT_display_device export eglQueryDeviceAttribEXT was not found";
        }
    }
