...
TYPED_TEST(CompressedTextureTest, CompressedTexImage)
{
    ...
    {
        std::cout << "Test skipped because ES3 or GL_EXT_texture_compression_dxt1 is not available." << std::endl;
        return;
    }
...
TYPED_TEST(CompressedTextureTest, CompressedTexStorage)
{
    ...
    {
        std::cout << "Test skipped due to missing GL_EXT_texture_storage or GL_OES_rgb8_rgba8" << std::endl;
        return;
    }
