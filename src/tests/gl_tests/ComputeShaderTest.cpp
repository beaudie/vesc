...
TEST_P(ComputeShaderTest, ImageLoad)
{
    const std::string csSource =
        ...
        "layout(rgba32f) uniform highp readonly image2D mImage2DInput;\n"
...
TEST_P(ComputeShaderTest, ImageStore)
{
    const std::string csSource =
        ...
        "layout(rgba8ui) uniform highp writeonly uimage2DArray mImage2DArrayOutput_1;\n"
        "void main()\n"
        "{\n"
        ...
        "    imageStore(mImage2DArrayOutput_1, ivec3(gl_LocalInvocationID.xyz), uvec4(0));\n"
        "}\n";
