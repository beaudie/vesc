...
class ComputeShaderTestESS3 : public ANGLETest
{
  protected:
    ComputeShaderTestESS3() {}
};
...
// 3.10
TEST_P(ComputeShaderTestESS3, NotSupported)
{
...
ANGLE_INSTANTIATE_TEST(ComputeShaderTestESS3, ES3_OPENGL(), ES3_OPENGLES());
