...
TEST_P(ComputeShaderTest, ShaderStorageBlocksVectorArray)
{
    const std::string csSource =
        ...
        void main()
        {
            float data = instanceA.v[gl_LocalInvocationIndex][1];
            v[0][gl_LocalInvocationIndex] = data;
        })";
...
TEST_P(ComputeShaderTest, ShaderStorageBlocksWithUnsizedArray)
{
    const std::string csSource =
        ...
        void main()
        {
            ...
            instanceB[0].v[gl_LocalInvocationIndex] = data;
        }
        )";
