...
void main()
{
    ...
    constexpr GLuint kInputValues11[] = {4, 4, 4, 4};
    constexpr GLuint kInputValues12[] = {5};
    constexpr GLuint kInputValues2[]  = {0, 0, 0, 0};

    glBindTexture(GL_TEXTURE_2D, texture[0]);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_R32UI, 2, 2, 0, GL_RED_INTEGER, GL_UNSIGNED_INT,
                 kInputValues11);
    glTexImage2D(GL_TEXTURE_2D, 1, GL_R32UI, 1, 1, 0, GL_RED_INTEGER, GL_UNSIGNED_INT,
                 kInputValues12);
    EXPECT_GL_NO_ERROR();
