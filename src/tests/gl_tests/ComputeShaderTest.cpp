...
// Test that storing data to image and then loading the same image data can work correctly.
...
// Test that loading image data and then storing data to same image can work correctly.
