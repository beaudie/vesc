...
// That that bind UVA with type buffer to slot 0, then bind UAV with type image to slot 0, then
...
// That that bind UVA with type image to slot 0, then bind UAV with type buffer to slot 0. The test
// runs well.
