...
void main()
{
    ...
    imageStore(ci0, ivec2(0, 0), vec4(0.5));
    imageStore(ci0, ivec2(1, 1), vec4(0.5));
    ...
    // const float data = 0.5;
    // GLint binaryDataInt = *((int*)&data);
    // glUniform1iv(uniformLocations[0], 1, &binaryDataInt);  // cs1
    glUniform1i(uniformLocations[0], 0);  // cs1
    ...
    // GLubyte == khronos_uint8_t ==> typedef unsigned char khronos_uint8_t;
    ...
    GLFramebuffer framebuffer;
    glBindFramebuffer(GL_READ_FRAMEBUFFER, framebuffer);
    glFramebufferTextureLayer(GL_READ_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, texture1Id, 0, 0);
    glReadBuffer(GL_COLOR_ATTACHMENT0);
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor(angle::Vector4(0.5, 0.5, 0.5, 0.5)));
