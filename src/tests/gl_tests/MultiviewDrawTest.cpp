...
class MultiviewFramebufferTestBase : public MultiviewTestBase
{
  protected:
    ...
    void updateFBOs(int viewWidth, int height, int numViews, int numLayers, int baseViewIndex)
    {
        ...
        CreateMultiviewBackingTextures(mSamples, viewWidth, height, numLayers,
        ...
        AttachMultiviewTextures(GL_DRAW_FRAMEBUFFER, viewWidth, numViews,
    ...
    void resolveMultisampledFBO()
    {
        ...
        if (mResolveFramebuffer.empty())
        {
            ...
            CreateMultiviewBackingTextures(0, mViewWidth, mViewHeight, numLayers,
                            ...
                            public ::testing::TestWithParam<MultiviewRenderTestParams>
{
  protected:
    MultiviewRenderTest()
        : MultiviewFramebufferTestBase(GetParam(), GetParam().mSamples)
    {}
