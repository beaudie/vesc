...
TEST_P(MultiviewSideBySideRenderDualViewTest, DrawArraysTwoViews)
{
    if (!requestMultiviewExtension())
    {
        return;
...
// Check that the attribute divisor is correctly adjusted when drawing with multi-view programs.
