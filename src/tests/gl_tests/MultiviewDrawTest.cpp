...
class MultiviewRenderTest : public MultiviewDrawTest,
                            public ::testing::TestWithParam<MultiviewTestParams>
{
  protected:
    MultiviewRenderTest() : MultiviewDrawTest(GetParam()), mViewWidth(0), mViewHeight(0) {}
    void SetUp() override { MultiviewDrawTest::DrawTestSetUp(); }
    void createFBO(int widthPerView, int height, int numViews)
    {
        GLenum fboLayout = GetParam().mMultiviewLayout;
        mViewWidth       = widthPerView;
        mViewHeight      = height;
        ...
        switch (fboLayout)
        {
            case GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE:
            {
                int textureWidth = widthPerView * numViews;
            ...
            case GL_FRAMEBUFFER_MULTIVIEW_LAYERED_ANGLE:
                ...
                glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_RGBA8, widthPerView, height, numViews, 0,
                ...
                glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_DEPTH_COMPONENT32F, widthPerView, height,
    ...
    {
        switch (GetParam().mMultiviewLayout)
        {
            case GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE:
...
class MultiviewSideBySideRenderTest : public MultiviewRenderTest
{
  protected:
    MultiviewSideBySideRenderTest()
    {
        ASSERT(GetParam().mMultiviewLayout == GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE);
    }
};
...
TEST_P(MultiviewRenderTest, DrawArraysInstanced)
{
    ...
    const GLubyte expectedRedChannel[2][2][2] = {{{0, 255}, {0, 255}}, {{255, 0}, {255, 0}}};
...
TEST_P(MultiviewRenderTest, AttribDivisor)
{
    ...
    const GLubyte expectedRedChannel[2][4][4] = {
...
TEST_P(MultiviewRenderPrimitiveTest, Points)
{
    ...
    const GLubyte expectedRedChannelData[2][2][4] = {{{255, 0, 0, 0}, {0, 0, 0, 255}},
                                                     {{255, 0, 0, 0}, {0, 0, 0, 255}}};
...
TEST_P(MultiviewRenderPrimitiveTest, Lines)
{
    ...
    const GLubyte expectedRedChannelData[2][2][4] = {{{255, 255, 255, 255}, {0, 0, 0, 0}},
...
TEST_P(MultiviewRenderPrimitiveTest, LineStrip)
{
    ...
    const GLubyte expectedRedChannelData[2][2][4] = {{{255, 255, 255, 255}, {0, 0, 0, 255}},
...
TEST_P(MultiviewRenderPrimitiveTest, LineLoop)
{
    ...
    const GLubyte expectedRedChannelData[2][4][4] = {
...
TEST_P(MultiviewRenderPrimitiveTest, TriangleStrip)
{
    ...
    const GLubyte expectedRedChannelData[2][2][2] = {{{0, 0}, {0, 255}}, {{0, 0}, {0, 255}}};
    checkRedChannel(expectedRedChannelData[0][0]);
...
ANGLE_INSTANTIATE_TEST(MultiviewSideBySideRenderTest, SideBySideOpenGL());
