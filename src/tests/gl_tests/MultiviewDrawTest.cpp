...
// program differs.
// 2) generates an INVALID_OPERATION error if the program does not use the multiview extension, but
// the active draw framebuffer has more than one view.
// 3) does not generate any error if the number of views is the same.
TEST_P(MultiviewDrawValidationTest, NumViewsMismatch)
{
    ...
    // Check for a GL_INVALID_OPERATION error with the program not using the multiview extension,
    // but the active draw framebuffer having more than 1 view.
    {
