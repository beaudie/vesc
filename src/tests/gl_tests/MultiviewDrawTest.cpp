...
{
  protected:
    MultiviewSideBySideRenderTest() : mProgram(0u) {}
...
class MultiviewSideBySideRenderTwoViewTest : public MultiviewSideBySideRenderTest
{
  protected:
    MultiviewSideBySideRenderTwoViewTest() {}
...
// The test checks glDrawArrays can be used to render into two views.
TEST_P(MultiviewSideBySideRenderTwoViewTest, DrawArraysTwoViews)
{
    if (!requestMultiviewExtension())
    {
        return;
...
// The test checks glDrawElements can be used to render into two views.
TEST_P(MultiviewSideBySideRenderTwoViewTest, DrawElements)
{
    if (!requestMultiviewExtension())
    {
        return;
...
// The test checks glDrawRangeElements can be used to render into two views.
TEST_P(MultiviewSideBySideRenderTwoViewTest, DrawRangeElements)
{
    if (!requestMultiviewExtension())
    {
        return;
...
// The test checks glDrawArrays can be used to render into four views.
...
ANGLE_INSTANTIATE_TEST(MultiviewSideBySideRenderTwoViewTest, ES3_OPENGL());
