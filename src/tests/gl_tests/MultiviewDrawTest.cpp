...
TEST_P(MultiviewSideBySideRenderTest, DontTouchDivisor)
{
    ...
    const int kDivisor = 1;
    for (int j = 1; j < kDivisor * 4; ++j)
    {
        pixelXPositions.push_back(1);
    }
    ...
    // Create a program and fbo with N number of views and draw N instances of a point horizontally.
