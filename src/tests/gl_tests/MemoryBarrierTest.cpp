...
protected:
    ...
    void textureUpdateBitBufferWriteThenCopy(ShaderWritePipeline writePipeline,
            WriteResource writeResource,
            NoopOp preBarrierOp, NoopOp postBarrierOp);
    void textureUpdateBitCopyThenBufferWrite(ShaderWritePipeline writePipeline,
            WriteResource writeResource,
            NoopOp preBarrierOp, NoopOp postBarrierOp, GLbitfield barrierBit);
...
void MemoryBarrierTestBase::textureUpdateBitBufferWriteThenCopy(ShaderWritePipeline writePipeline,
        WriteResource writeResource,
        NoopOp preBarrierOp, NoopOp postBarrierOp)
{
    GLTexture color;
...
void MemoryBarrierTestBase::textureUpdateBitCopyThenBufferWrite(ShaderWritePipeline writePipeline,
        WriteResource writeResource,
        NoopOp preBarrierOp, NoopOp postBarrierOp, GLbitfield barrierBit)
{
    GLTexture color;
...
TEST_P(MemoryBarrierImageOnlyTest, ShaderImageAccessBitCopyThenWrite)
{
    ...
    textureUpdateBitCopyThenBufferWrite(writePipeline, writeResource, preBarrierOp, postBarrierOp, GL_SHADER_IMAGE_ACCESS_BARRIER_BIT);
}
...
TEST_P(MemoryBarrierImageOnlyTest, TextureUpdateBitWriteThenCopy)
{
    ...
    textureUpdateBitBufferWriteThenCopy(writePipeline, writeResource, preBarrierOp, postBarrierOp);
}
...
TEST_P(MemoryBarrierImageOnlyTest, TextureUpdateBitCopyThenWrite)
{
    ...
    textureUpdateBitCopyThenBufferWrite(writePipeline, writeResource, preBarrierOp, postBarrierOp, GL_TEXTURE_UPDATE_BARRIER_BIT);
}
