...
// How to get this to only run on Metal?
// How to get the feature to show up as set in ensureCapsInitializes?
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(FramebufferTest_ES3Metal);
ANGLE_INSTANTIATE_TEST_ES3_AND(FramebufferTest_ES3Metal,
