...
// Simulate Black Desert Mobile game's usage of depth attachment. This tests render to a depth
// texture level that is excluded from [base_level, max_level]. This specific test renders to an
// immutable texture at the level that is less than GL_TEXTURE_BASE_LEVEL.
