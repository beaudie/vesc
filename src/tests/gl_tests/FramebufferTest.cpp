...
TEST_P(FramebufferTest_ES3, ClearColorWithBlack)
{
    ...
    const std::string &fragmentShaderSource =
        ...
        "in vec2 texCoord;\n"
        "void main() {\n"
        "    sk_FragColor = texture(uTextureSampler, texCoord);\n"
        "}\n";
    ...
    glBindAttribLocation(prog.get(), 1, "inLocalCoord");
    ...
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 16, reinterpret_cast<void *>(0x8));
