...
{
    constexpr GLsizei kSizeLarge = 128;
    constexpr GLsizei kSizeSmall = 64;
    ...
    // Validate the result.
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(kSizeLarge - 1, 0, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(0, kSizeLarge - 1, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(kSizeLarge - 1, kSizeLarge - 1, GLColor::green);

    // Do the same, but chaning from the large to small attachment.
    ...
    // Validate the result.
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor::blue);
    EXPECT_PIXEL_COLOR_EQ(kSizeSmall - 1, 0, GLColor::blue);
    EXPECT_PIXEL_COLOR_EQ(0, kSizeSmall - 1, GLColor::blue);
    EXPECT_PIXEL_COLOR_EQ(kSizeSmall - 1, kSizeSmall - 1, GLColor::blue);
}
