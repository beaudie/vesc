...
ANGLE_INSTANTIATE_TEST_ES2_AND(AddMockTextureNoRenderTargetTest,
                               WithAddMockTextureNoRenderTarget(ES2_D3D9()),
                               WithAddMockTextureNoRenderTarget(ES2_D3D11()));
...
ANGLE_INSTANTIATE_TEST_ES3_AND(FramebufferTest_ES3,
                               WithEmulatedPrerotation90(ES3_VULKAN()),
                               WithEmulatedPrerotation180(ES3_VULKAN()),
                               WithEmulatedPrerotation270(ES3_VULKAN()));
