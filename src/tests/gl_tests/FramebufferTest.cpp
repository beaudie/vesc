...
{
    testDitherDisabledProperlyOnRGB565(GLColor::red);
}
...
{
    testDitherDisabledProperlyOnRGB565(GLColor::green);
}
...
{
    testDitherDisabledProperlyOnRGB565(GLColor::blue);
}
...
{
    testDitherDisabledProperlyOnRGB565(GLColor::white);
}
