...
TEST_P(StateChangeTestES3, InvalidateThenCopyThenBlend)
{
...
TEST_P(StateChangeTestES3, InvalidateThenBlitThenBlend)
{
...
TEST_P(StateChangeTestES3, InvalidateThenGenerateMipmaps)
{
...
TEST_P(StateChangeTestES3, InvalidateThenUpload)
{
    // Create the framebuffer that will be invalidated
    GLTexture renderTarget;
    glBindTexture(GL_TEXTURE_2D, renderTarget);
...
TEST_P(StateChangeTestES3, SubInvalidateThenDraw)
{
    // Create the framebuffer that will be invalidated
    GLTexture renderTarget;
    glBindTexture(GL_TEXTURE_2D, renderTarget);
