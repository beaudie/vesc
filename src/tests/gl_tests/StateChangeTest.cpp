...
class WebGLValidationStateChangeTest : public ValidationStateChangeTest
{
  protected:
    WebGLValidationStateChangeTest() { setWebGLCompatibilityEnabled(true); }
};
...
TEST_P(WebGLValidationStateChangeTest, DrawFramebufferNegativeAPI)
{
...
TEST_P(WebGLValidationStateChangeTest, MultiAttachmentDrawFramebufferNegativeAPI)
{
...
layout(location = 1) out ivec4 outInt;
void main()
{
    outFloat = vec4(0, 1, 0, 1);
    outInt = ivec4(0, 1, 0, 1);
})";
...
TEST_P(WebGLValidationStateChangeTest, TransformFeedbackNegativeAPI)
{
    constexpr char kFS[] = R"(#version 300 es
precision mediump float;
...
ANGLE_INSTANTIATE_TEST(WebGLValidationStateChangeTest, ES3_D3D11(), ES3_OPENGL());
