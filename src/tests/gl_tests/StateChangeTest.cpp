...
// TODO: Add similar tests for other state affected by framebuffer attachments.  In particular,
// blend state.  In particular, see FramebufferVk::syncState calling updateBlendFuncsAndEquations.
// These tests would affect the state by changing the attachments.
