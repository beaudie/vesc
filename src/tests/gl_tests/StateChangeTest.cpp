...
void main()
{
    ...
    glStencilFuncSeparate(GL_FRONT, GL_ALWAYS, 128, 128);
    glStencilOpSeparate(GL_FRONT, GL_KEEP, GL_KEEP, GL_REPLACE);
    glStencilFuncSeparate(GL_BACK, GL_ALWAYS, 128, 128);
    ...
    glStencilFuncSeparate(GL_FRONT, GL_NOTEQUAL, 128, 128);
    glStencilOpSeparate(GL_FRONT, GL_KEEP, GL_KEEP, GL_KEEP);
    glStencilFuncSeparate(GL_BACK, GL_NOTEQUAL, 128, 128);
    glStencilOpSeparate(GL_BACK, GL_KEEP, GL_KEEP, GL_KEEP);
    glStencilMask(128);
