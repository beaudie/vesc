...
// level 0 instead of the base level resulting in an incomplete texture. The test creates a cubemap
// texture, specifying the images only for mip level 1 filled with white color, updates the base
// level to be 1 and renders a quad. The program samples the cubemap using a direction vector
// (0,0,0).
