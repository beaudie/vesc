...
class TextureCubeArrayTestES31 : public ANGLETest
{
  protected:
    TextureCubeArrayTestES31() {}
};
...
TEST_P(TextureCubeArrayTestES31, IncompleteTexture)
{
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(TextureCubeArrayTestES31);
ANGLE_INSTANTIATE_TEST_ES31(TextureCubeArrayTestES31);
