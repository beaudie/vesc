...
class RGBTextureBufferES31 : public ANGLETest<>
{
  protected:
    RGBTextureBufferES31() {}
...
void RGBTextureBufferES31::TestInt(GLuint format)
{
...
TEST_P(RGBTextureBufferES31, Uint)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_texture_buffer"));
...
TEST_P(RGBTextureBufferES31, Sint)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_texture_buffer"));
    // On D3D11 pixels remain transparent black.
    ANGLE_SKIP_TEST_IF(IsD3D11());
...
TEST_P(RGBTextureBufferES31, Float)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_texture_buffer"));
    // On D3D11 pixels remain transparent black.
    ANGLE_SKIP_TEST_IF(IsD3D11());
...
TEST_P(RGBTextureBufferES31, SSBOWrite)
{
...
// Tests RGB32 texture buffer with a SSBO write (without barrier)
TEST_P(RGBTextureBufferES31, SSBOWriteWithoutBarrier)
{
    GLProgram programSSBO;
    SetupSSBOProgram(programSSBO);
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(RGBTextureBufferES31);
ANGLE_INSTANTIATE_TEST_ES31(RGBTextureBufferES31);
