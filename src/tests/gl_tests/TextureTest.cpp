...
TEST_P(TextureBufferTestES31, TexBufferFormatMismatch)
{
    ...
    const std::array<uint8_t, 4> kTexData8n{255};
    const std::array<uint8_t, 4> kTexData8i{1};
    for (auto format :
    ...
    const std::array<uint16_t, 4> kTexData16f{kHalfFloatOne};
    const std::array<uint16_t, 4> kTexData16i{1};
    ...
    const std::array<GLfloat, 4> kTexData32f{1.0f};
    const std::array<uint32_t, 4> kTexData32i{1};
