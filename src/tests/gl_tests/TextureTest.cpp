...
class SamplerInStructArrayAsFunctionParameterTest : public Texture2DTest
{
  protected:
    SamplerInStructArrayAsFunctionParameterTest() : Texture2DTest() {}
...
class SamplerInNestedStructAsFunctionParameterTest : public Texture2DTest
{
protected:
    SamplerInNestedStructAsFunctionParameterTest() : Texture2DTest() {}
...
class SamplerInStructAndOtherVariableTest : public Texture2DTest
{
protected:
    SamplerInStructAndOtherVariableTest() : Texture2DTest() {}
...
// Test to make sure that there isn't a name conflict between sampler extracted from a struct and
// a similarly named uniform.
TEST_P(SamplerInStructAndOtherVariableTest, SamplerInStructAndOtherVariable)
{
    // TODO: This test is still failing. A bit tricky to solve.
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D, mTexture2D);
    GLubyte texDataGreen[2u * 2u * 4u];
    FillWithRGBA<GLubyte>(2u * 2u, 0u, 255u, 0u, 255u, texDataGreen);
