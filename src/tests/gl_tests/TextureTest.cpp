...
static GLColor16 SliceFormatColor16(GLenum format, GLColor16 full)
{
    switch (format)
    {
        case GL_RED:
...
{
  protected:
    Texture2DNorm16TestES3() : Texture2DTestES3(), mTextures{0, 0, 0}, mFBO(0) {}
    ...
    void testNorm16Texture(GLint internalformat, GLenum format, GLenum type)
    {
        ...
        EXPECT_PIXEL16_COLOR_EQ(0, 0, SliceFormatColor16(format, expectedValue));
    ...
    void testNorm16Render(GLint internalformat, GLenum format, GLenum type)
    {
        ...
        EXPECT_PIXEL16_COLOR_EQ(0, 0, SliceFormatColor16(format, imageData));
