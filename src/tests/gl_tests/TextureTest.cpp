...
TEST_P(TextureCubeTest, CubeMapFBOScisscoredClear)
{
    ...
    std::vector<GLColor> colors(kSize * kSize);
    glReadPixels(0, 0, kSize, kSize, GL_RGBA, GL_UNSIGNED_BYTE, colors.data());
