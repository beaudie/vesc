...
TEST_P(Texture2DTestES3, TextureMemoryAllocation)
{
    std::vector<std::pair<uint32_t, uint32_t>> textureWidthHeightPairs = {
        std::make_pair(256, 256),  std::make_pair(257, 257),   std::make_pair(384, 384),
        std::make_pair(1440, 960), std::make_pair(2044, 1042), std::make_pair(2044, 1152),
    };

    {
        GLTexture testTexture;
        glBindTexture(GL_TEXTURE_2D, testTexture);
        WARN() << "Allocate 1x1 texture";
