...
TEST_P(CopyImageTestES31, ArraySelfCopyImageSubDataReadAfterWrite)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_copy_image"));
...
// Verify that copies between texture layers works
TEST_P(CopyImageTestES31, ArraySelfCopyImageSubDataWriteAfterRead)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_copy_image"));
    ...
    // TODO: Expand the test. Some details are missing/altered.
}
