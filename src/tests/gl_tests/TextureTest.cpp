...
{
  protected:
    IntegerTexture2DTestES3() : Texture2DTestES3() {}
...
void main()
{
    ...
    void setUpProgram() override { Texture2DTestES3::setUpProgram(); }

    void SetUp() override { Texture2DTestES3::SetUp(); }

    void TearDown() override { Texture2DTestES3::TearDown(); }
};
