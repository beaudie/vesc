...
{
    // TODO(lucferron): Enable when we implement float support in ES3.0.
    ANGLE_SKIP_TEST_IF(IsVulkan());
...
{
    // TODO(lucferron): Enable when we implement half float support in ES3.0.
    ANGLE_SKIP_TEST_IF(IsVulkan());
...
ANGLE_INSTANTIATE_TEST(Texture2DTest,
                       ...
                       ES2_OPENGLES(),
                       ES2_VULKAN());
lu ANGLE_INSTANTIATE_TEST(TextureCubeTest,
                          ES2_D3D9(),
                          ES2_D3D11(),
                          ES2_D3D11_FL10_0(),
                          ES2_D3D11_FL9_3(),
