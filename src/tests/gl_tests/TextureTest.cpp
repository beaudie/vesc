...
TEST_P(Texture2DTestES3, TextureImplPropogatesDirtyBits)
{
    ...
    // Needs triage on Vulkan backend. http://anglebug.com/??
...
TEST_P(Texture2DArrayTestES3, DrawWithLevelsOutsideRangeWithInconsistentDimensions)
{
    ...
    // TODO(cnorthrop): Depth vs. array issue in VK backend. http://anglebug.com/??
    ANGLE_SKIP_TEST_IF(IsVulkan());
...
{
    // Requires non-color staging buffer support. http://anglebug.com/??
    ANGLE_SKIP_TEST_IF(IsVulkan());
...
TEST_P(Texture2DTestES3, DepthTexturesWithMipmaps)
{
    ...
    // TODO(cnorthrop): Also failing on Vulkan/Windows/AMD. http://anglebug.com/??
...
{
    // TODO: Triage this failure on Vulkan: http://anglebug.com/??
    ANGLE_SKIP_TEST_IF(IsVulkan());
