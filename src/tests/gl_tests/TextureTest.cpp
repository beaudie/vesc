...
// Test basic GL_EXT_copy_image copy without any draw calls
TEST_P(Texture2DTestES3, CopyImageFB)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(2, 1, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(3, 0, GLColor::red);
    EXPECT_PIXEL_COLOR_EQ(3, 1, GLColor::red);

    EXPECT_PIXEL_COLOR_EQ(0, 2, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(1, 2, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(0, 3, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(1, 3, GLColor::green);

    EXPECT_PIXEL_COLOR_EQ(2, 2, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(2, 3, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ(3, 2, GLColor::red);
    EXPECT_PIXEL_COLOR_EQ(3, 3, GLColor::red);
