...
// Test that reclearing color to the same value works if color was written to in between.
...
// Test that reclearing depth to the same value works if depth was written to in between.
...
// Test that reclearing stencil to the same value works if stencil was written to in between.
