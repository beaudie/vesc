...
{
protected:
    void MaskedScissoredColorDepthStencilClear(bool mask, bool scissor, bool clearDepth, bool clearStencil);
};
...
void ClearTest::MaskedScissoredColorDepthStencilClear(bool mask, bool scissor, bool clearDepth, bool clearStencil)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(whalf, hhalf, mask ? color2Masked : color2);

    if (scissor)
    {
        EXPECT_PIXEL_COLOR_EQ(0, 0, color1) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(w - 1, h - 1, color1) << "out-of-scissor area should have retained color";
    }
    ...
    if (clearDepth)
    {
        ...
        EXPECT_PIXEL_COLOR_EQ(whalf, hhalf, GLColor::blue);

        if (scissor)
        {
            EXPECT_PIXEL_COLOR_EQ(0, 0, color1) << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1) << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1) << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(w - 1, h - 1, color1) << "out-of-scissor area should have retained depth";
        }
    }
    ...
    if (clearStencil)
    {
        ...
        EXPECT_PIXEL_COLOR_EQ(whalf, hhalf, GLColor::green);

        if (scissor)
        {
            EXPECT_PIXEL_COLOR_EQ(0, 0, color1) << "out-of-scissor area should have retained stencil";
            EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1) << "out-of-scissor area should have retained stencil";
            EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1) << "out-of-scissor area should have retained stencil";
            EXPECT_PIXEL_COLOR_EQ(w - 1, h - 1, color1) << "out-of-scissor area should have retained stencil";
        }
    }
}
