...
TEST_P(ClearTest, ClearIssue)
{
    ...
    // Failure seen on Windows NVIDIA Vulkan. http://anglebug.com/2485
    ANGLE_SKIP_TEST_IF(IsVulkan() && IsNVIDIA() && IsWindows());
    ...
    ANGLE_GL_PROGRAM(blueProgram, shader_library::essl1::vs::simple(),
                     shader_library::essl1::fs::blue());
    drawQuad(blueProgram, shader_library::positionAttribName(), 0.5f);
