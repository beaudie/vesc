                                                      ...
                                                      bool clearStencil)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(whalf, hhalf, mask ? color2Masked : color2RGB);

    if (scissor)
    {
        EXPECT_PIXEL_COLOR_EQ(0, 0, color1RGB) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1RGB) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1RGB) << "out-of-scissor area should have retained color";
        EXPECT_PIXEL_COLOR_EQ(w - 1, h - 1, color1RGB)
            << "out-of-scissor area should have retained color";
    }
    ...
    if (clearDepth)
    {
        ...
        if (scissor)
        {
            EXPECT_PIXEL_COLOR_EQ(0, 0, color1RGB) << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1RGB)
                << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1RGB)
                << "out-of-scissor area should have retained depth";
            EXPECT_PIXEL_COLOR_EQ(w - 1, h - 1, color1RGB)
                << "out-of-scissor area should have retained depth";
        }
    ...
    if (clearStencil)
    {
        ...
        if (scissor)
        {
            EXPECT_PIXEL_COLOR_EQ(0, 0, color1RGB)
                << "out-of-scissor area should have retained stencil";
            EXPECT_PIXEL_COLOR_EQ(w - 1, 0, color1RGB)
                << "out-of-scissor area should have retained stencil";
            EXPECT_PIXEL_COLOR_EQ(0, h - 1, color1RGB)
                << "out-of-scissor area should have retained stencil";
