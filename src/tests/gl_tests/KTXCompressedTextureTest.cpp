...
TEST_P(KTXCompressedTextureTest, CompressedTexImageETC1)
{
    ...
    LoadETC1RGB8ToRGBA8(ktx_etc1_width, ktx_etc1_height, 1, ktx_etc1_data,
                        ...
                        decompressedBytesPerPixel * ktx_etc1_width, 0);

    GLTexture decompressedTexture;
    glBindTexture(GL_TEXTURE_2D, decompressedTexture);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, ktx_etc1_width, ktx_etc1_height, 0, GL_RGBA,
                 GL_UNSIGNED_BYTE, decompressedTextureData);
