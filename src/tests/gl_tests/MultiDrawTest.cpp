...
{
    return
        R"(#extension GL_ANGLE_multi_draw : require
...
class MultiDrawTest : public ANGLETest
{
  protected:
    MultiDrawTest() : mVertexBuffer(0u), mIndexBuffer(0u), mSimpleProgram(0u), mDrawIDProgram(0u)
    {
...
// Tests basic functionality of glMultiDrawArraysANGLE with gl_DrawID
TEST_P(MultiDrawTest, MultiDrawArraysDrawID)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramWithDrawID();
    DoDrawArrays();
...
// Tests basic functionality of glMultiDrawElementsANGLE with gl_DrawID
TEST_P(MultiDrawTest, MultiDrawElementsDrawID)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramWithDrawID();
    DoDrawElements();
...
ANGLE_INSTANTIATE_TEST(MultiDrawTest,
                       ES2_D3D9(),
                       ES2_OPENGL(),
                       ES2_OPENGLES(),
                       ES2_VULKAN(),
