...
//
// After drawing FRAG_REJECT_TEST_BOX, pixels inside
// {FRAG_REJECT_TEST_WIDTH, FRAG_REJECT_TEST_HEIGHT} should be drawn green. Fragments outside should
// have been rejected, leaving the pixels black.
