...
// Check that it works to draw with GL_MAX_LOCAL_STORAGE_PLANES_ANGLE,
// GL_MAX_LOCAL_STORAGE_BYTES_ANGLE, and GL_MAX_FRAGMENT_OUTPUTS_WITH_LOCAL_STORAGE_ANGLE.
