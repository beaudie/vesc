...
TEST_P(PixelLocalStorageTest, ClearState)
{
    ...
    glBindFramebuffer(GL_FRAMEBUFFER, fbo);
    glBeginPixelLocalStorageANGLE(3, GLenumArray({GL_CLEAR_ANGLE, GL_CLEAR_ANGLE, GL_CLEAR_ANGLE}));
    glEndPixelLocalStorageANGLE();
    ...
    EXPECT_PIXEL_LOCAL_CLEAR_VALUE_FLOAT(0, ({1, 0, 0, 0}));
    ...
    glFramebufferPixelLocalClearValuefvANGLE(0, ClearF(-100.5, 1, 1, 0));
    ...
    EXPECT_PIXEL_LOCAL_CLEAR_VALUE_FLOAT(0, ({-100.5, 1, 1, 0}));
    EXPECT_PIXEL_LOCAL_CLEAR_VALUE_UNSIGNED_INT(2, ({0xbaadbeef, 1, 1, 0}));
    glEndPixelLocalStorageANGLE();
    attachTextureToScratchFBO(tex32f);
    EXPECT_PIXEL_RECT32F_EQ(0, 0, 1, 1, GLColor32F(-100.5, 0, 0, 1));
