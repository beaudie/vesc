...
// Check that FramebufferPixelLocalStorageRestoreANGLE validate as specified.
TEST_P(PixelLocalStorageValidationTest, FramebufferPixelLocalStorageRestoreANGLE)
{
