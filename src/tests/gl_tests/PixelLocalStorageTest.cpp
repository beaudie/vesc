...
TEST_P(PixelLocalStorageCompilerTest, Declarations)
{
    ...
    // TODO(anglebug.com/7484): If supported, function args don't allow memory qualifiers.
    void main()
    {
    })";
    ...
    // TODO(anglebug.com/7484): If supported, function args require precision.
...
TEST_P(PixelLocalStorageCompilerTest, LayoutQualifiers)
{
    ...
    // TODO(anglebug.com/7484): If supported, function args require a format.
    void main()
    {
    })";
