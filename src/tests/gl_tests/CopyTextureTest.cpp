...
class CopyTextureTest : public ANGLETest
{
  protected:
                                            ...
                                            const std::array<size_t, 4> &expectedUniqueValues)
    {
        ...
        {
            sourceGradient[i] = GLColor(i, i, i, i);
        }
...
TEST_P(CopyTextureTest, DownsampleRGBA4444)
{
    ...
    GLColor pixels[] = {GLColor(0, 5, 7, 14), GLColor(17, 22, 30, 30), GLColor(34, 35, 36, 46),
                        GLColor(51, 53, 55, 60)};
    ...
    EXPECT_PIXEL_COLOR_EQ(1, 0, GLColor(17, 17, 17, 17));
    EXPECT_PIXEL_COLOR_EQ(0, 1, GLColor(34, 34, 34, 34));
    EXPECT_PIXEL_COLOR_EQ(1, 1, GLColor(51, 51, 51, 51));
...
TEST_P(CopyTextureTest, DownsampleRGB565)
{
    ...
    GLColor pixels[] = {GLColor(0, 5, 7, 14), GLColor(17, 22, 30, 30), GLColor(34, 33, 36, 46),
                        GLColor(50, 52, 55, 60)};
    ...
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor(0, 4, 0, 255));
    EXPECT_PIXEL_COLOR_EQ(1, 0, GLColor(16, 20, 25, 255));
    EXPECT_PIXEL_COLOR_EQ(0, 1, GLColor(33, 32, 33, 255));
    EXPECT_PIXEL_COLOR_EQ(1, 1, GLColor(49, 49, 49, 255));
...
TEST_P(CopyTextureTest, DownsampleRGBA5551)
{
    ...
    GLColor pixels[] = {GLColor(0, 5, 7, 14), GLColor(17, 22, 30, 30), GLColor(33, 34, 36, 46),
                        GLColor(50, 51, 55, 255)};
    ...
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor(0, 0, 0, 0));
    EXPECT_PIXEL_COLOR_EQ(1, 0, GLColor(16, 16, 25, 0));
    EXPECT_PIXEL_COLOR_EQ(0, 1, GLColor(33, 33, 33, 0));
    EXPECT_PIXEL_COLOR_EQ(1, 1, GLColor(49, 49, 49, 255));
