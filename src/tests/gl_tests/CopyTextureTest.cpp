...
TEST_P(CopyTextureTestDest, LuminanceDest)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, LuminanceDestMultiply)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, LuminanceDestUnmultiply)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, LuminanceAlphaDest)
{
    if (!checkExtensions())
    {
        return;
...
// UnpackPremultiply parameter
TEST_P(CopyTextureTestDest, LuminanceAlphaDestMultiply)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, LuminanceAlphaDestUnmultiply)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, AlphaDest)
{
    if (!checkExtensions())
    {
        return;
...
TEST_P(CopyTextureTestDest, AlphaDestMultiply)
{
    if (!checkExtensions())
    {
        return;
...
// Test to ensure that CopyTexture works with ALPHA texture as a destination with
// UnpackUnmultiplyAlpha parameter
TEST_P(CopyTextureTestDest, AlphaDestUnmultiply)
{
    if (!checkExtensions())
    {
        return;
