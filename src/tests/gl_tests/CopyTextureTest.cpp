...
class CopyTextureTest : public ANGLETest
{
  protected:
    ...
    void calculateCopyTextureResults(GLenum sourceFormat, bool premultiplyAlpha, bool unmultiplyAlpha, uint8_t *sourceColor, GLColor *destColor)
    {
        GLColor color;
    ...
    void testCopyTexture(GLenum sourceFormat, GLenum destFormat, bool flipY, bool premultiplyAlpha, bool unmultiplyAlpha)
    {
        ...
        {
            calculateCopyTextureResults(sourceFormat, premultiplyAlpha, unmultiplyAlpha, &srcColors[i * componentCount],
                    &destColors[i]);
        }
