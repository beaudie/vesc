...
TEST_P(CopyTextureTestES3, DrawThenCopyThenBlend)
{
    ...
    //
    // 1) Blits for multisample resolves work properly, and the
    // contents of the destination texture are correct afterward.
    //
    // 2) CopyTexSubImage2D operations after multisample resolves work
    // correctly. This is verified by blending the resulting texture
