...
TEST_P(CopyTextureTest, CopySubTextureOffset)
{
    ...
    GLColor transparentPixels[4 * 4] = {GLColor::transparent, GLColor::transparent,
                                        GLColor::transparent, GLColor::transparent};
    glBindTexture(GL_TEXTURE_2D, mTextures[1]);
    ...
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor::transparent);
