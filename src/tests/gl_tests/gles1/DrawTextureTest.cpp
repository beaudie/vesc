...
TEST_P(DrawTextureTest, DrawWithTexCoordPtrThenDisableTexture2DAndDrawAnother)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(3 * kWindowWidth / 4, kWindowHeight - 1, kColorCornerBR);
    EXPECT_PIXEL_COLOR_EQ(0, 3 * kWindowHeight / 4, kColorCornerTL);
    EXPECT_PIXEL_COLOR_EQ(kWindowWidth / 2, kWindowHeight - 1, kColorCornerTR);
    EXPECT_PIXEL_COLOR_EQ(kWindowWidth - 1, 0, GLColor::black);
