...
void main()
{
    ...
    GLint maxCounterBindingsSupported = 0;
    glGetIntegerv(GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS, &maxCounterBindingsSupported);
    ANGLE_SKIP_TEST_IF(maxCounterBindingsSupported < 1);
    ...
    EXPECT_EQ(2, params[3]);   // num_active_variables
    EXPECT_EQ(16, params[4]);  // buffer_data_size
