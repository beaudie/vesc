...
void main()
{
    ...
    // TODO(jiajia.qin@intel.com): top_level_array_stride are not correctly handled in D3D side.
    // http://anglebug.com/1920. EXPECT_LE(0, params[11]);  // top_level_array_stride
