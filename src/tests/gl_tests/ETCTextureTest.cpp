...
TEST_P(ETCTextureTest, ETC2RGB8Validation)
{
    ...
    if (supported)
    {
        ...
        glCompressedTexImage2D(GL_TEXTURE_2D, 1, GL_COMPRESSED_RGB8_LOSSY_DECODE_ETC2_ANGLE, 2, 2,
                               0, sizeof(pixel), pixel);
        glCompressedTexImage2D(GL_TEXTURE_2D, 2, GL_COMPRESSED_RGB8_LOSSY_DECODE_ETC2_ANGLE, 1, 1,
                               0, sizeof(pixel), pixel);
    }
    else
    {
...
TEST_P(ETCTextureTest, ETC2SRGB8Validation)
{
    ...
    if (supported)
    {
        ...
        glCompressedTexImage2D(GL_TEXTURE_2D, 1, GL_COMPRESSED_SRGB8_LOSSY_DECODE_ETC2_ANGLE, 2, 2,
                               0, sizeof(pixel), pixel);
        glCompressedTexImage2D(GL_TEXTURE_2D, 2, GL_COMPRESSED_SRGB8_LOSSY_DECODE_ETC2_ANGLE, 1, 1,
                               0, sizeof(pixel), pixel);
    }
    else
    {
