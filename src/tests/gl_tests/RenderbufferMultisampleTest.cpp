...
// Test that multisample framebuffer fetch works with glBlend GL_COLORBURN_KHR
TEST_P(RenderbufferMultisampleTest, ColorBurnBlend)
{
    ...
    std::array<Vector4, 4> quadColor = {
        Vector4(1.0f, 0.0f, 0.0f, 1.0f), Vector4(0.0f, 1.0f, 0.0f, 1.0f),
        Vector4(0.0f, 0.0f, 1.0f, 1.0f), Vector4(1.0f, 1.0f, 1.0f, 1.0f)};
