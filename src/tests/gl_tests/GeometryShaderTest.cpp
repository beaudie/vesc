...
TEST_P(GeometryShaderTest, LinkWhenShaderVersionMismatch)
{
    ...
    GLuint program = CompileProgram(kDefaultVertexShaderVersion300, emptyGeometryShader,
...
TEST_P(GeometryShaderTest, LinkValidationOnGeometryShader)
{
    ...
    // link failure.
    GLuint program =
        CompileProgram(kDefaultVertexShader, gsWithoutInvocations, kDefaultFragmentShader);
    ...
    program = CompileProgram(kDefaultVertexShader, gsWithoutInputPrimitive, kDefaultFragmentShader);
    EXPECT_EQ(0u, program);

    program =
        CompileProgram(kDefaultVertexShader, gsWithoutOutputPrimitive, kDefaultFragmentShader);
    EXPECT_EQ(0u, program);

    program = CompileProgram(kDefaultVertexShader, gsWithoutMaxVertices, kDefaultFragmentShader);
    EXPECT_EQ(0u, program);
