...
constexpr char kEGLMtlImageNativeTextureExt[] = "EGL_ANGLE_mtl_texture_client_buffer";
                                                ...
                                                GLuint *textureOut)
{
    ...
    // Create image
    EGLImageKHR image =
        eglCreateImageKHR(window->getDisplay(), EGL_NO_CONTEXT, EGL_MTL_TEXTURE_ANGLE,
