...
// Test validation of glCompressedTexSubImage3D with sub-block texture dimensions
TEST_P(DXT1CompressedTextureTestES3, CompressedTexSubImageValidationSubBlockLevels)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_texture_compression_dxt1"));
