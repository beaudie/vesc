...
class DXT1CompressedTextureTestWebGL : public DXT1CompressedTextureTest
{
  protected:
    DXT1CompressedTextureTestWebGL() { setWebGLCompatibilityEnabled(true); }
};

// Regression test for https://crbug.com/1289428
TEST_P(DXT1CompressedTextureTestWebGL, InitializeTextureContents)
{
...
ANGLE_INSTANTIATE_TEST_ES2_AND_ES3(DXT1CompressedTextureTestWebGL);
