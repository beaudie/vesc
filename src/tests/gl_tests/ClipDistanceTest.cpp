...
TEST_P(ClipCullDistanceTest, SizeCheck)
{
    ...
    // Check that validating the redeclared array size of gl_ClipDistance is same as correctly
    // operated?
...
void main()
{
    ...
    // Check that validating the redeclared array size of gl_CullDistance is same as correctly
    // operated?
