...
// If gl_ClipDistance or gl_CullDistance is redeclared on some shader stages, the array size of the
// redeclared variables should be same
TEST_P(ClipCullDistanceTest, SizeCheck)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_EXT_clip_cull_distance"));

    // Check that validating the redeclared array size of gl_ClipDistance is same is correctly
    // operated
...
void main()
{
    ...
    // Check that validating the redeclared array size of gl_CullDistance is same is correctly
    // operated
