...
class VulkanDescriptorSetLayoutDescTest : public ANGLETest<>
{
  protected:
    ...
    void updateBindings(const std::vector<uint32_t> &bindings,
                        rx::vk::DescriptorSetLayoutDesc *desc)
    {
        ASSERT(bindings.size() <= mBindings.size());
        for (uint32_t index : bindings)
        {
...
// Test basic interaction betwee DescriptorSetLayoutDesc and DescriptorSetLayoutCache
TEST_P(VulkanDescriptorSetLayoutDescTest, Basic)
{
    ...
    ASSERT(mDescriptorSetLayoutCache.getCacheMissCount() == 1);
    ...
    result = mDescriptorSetLayoutCache.getDescriptorSetLayout(contextVk, mDescriptorSetLayoutDesc,
                                                              &descriptorSetLayout);
    ASSERT(result == angle::Result::Continue);
    ASSERT(mDescriptorSetLayoutCache.getCacheMissCount() == 2);
    ...
    result = mDescriptorSetLayoutCache.getDescriptorSetLayout(contextVk, mDescriptorSetLayoutDesc,
                                                              &descriptorSetLayout);
    ASSERT(result == angle::Result::Continue);
    ASSERT(mDescriptorSetLayoutCache.getCacheMissCount() == 3);
    ...
    ASSERT(result == angle::Result::Continue);
    ASSERT(mDescriptorSetLayoutCache.getCacheHitCount() == 1);
    ASSERT(mDescriptorSetLayoutCache.getCacheMissCount() == 3);
