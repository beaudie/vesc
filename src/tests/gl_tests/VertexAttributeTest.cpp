...
TEST_P(VertexAttributeTest, DrawWithSameClientMemoryPointerInDifferentFormat)
{
    std::array<GLshort, kVertexCount> inputData = {
        {0, 1, 2, 3, -1, -2, -3, -4, 32766, 32767, -32768, -32767, -32766}};
...
TEST_P(VertexAttributeTest, UsingDifferentFormatAndSameBuffer)
{
    ...
    // Use normalized short as the format of the data in mBuffer in the next draw.
...
TEST_P(VertexAttributeTest, NegativeUsingDifferentFormatAndSameBuffer)
{
    ...
    // Use normalized short as the format of the data in mBuffer in the next draw, but
