...
class VertexAttributeTestES31 : public VertexAttributeTestES3
{
  protected:
    ...
    static const GLint ES31_MAX_STRIDE                 = 2048;
    static const GLint ES31_MAX_ATTRIB_RELATIVE_OFFSET = 2047;
};
...
// ES3.1 defines the minimum value of MAX_VERTEX_ATTRIB_STRIDE (2048) and
// MAX_VERTEX_ATTRIB_RELATIVE_OFFSET (2047). This test intends to verify using them as stride and
// offset doesn't mess up the draw in ES3.1.
TEST_P(VertexAttributeTestES31, DrawArraysWithLargeStrideAndOffset)
{
    drawArraysWithStrideAndOffset(ES31_MAX_STRIDE, ES31_MAX_ATTRIB_RELATIVE_OFFSET);
}
