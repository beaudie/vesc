...
class VertexAttributeTest : public ANGLETest
{
  protected:
    ...
    void initBasicProgram()
    {
        ...
        ANGLE_GL_PROGRAM(program, testVertexShaderSource, testFragmentShaderSource);
...
TEST_P(VertexAttributeTest, UnsignedByteUnnormalized)
{
    ...
    std::array<GLubyte, kVertexCount> inputData = {0,   1,   2,   3,   4,   5,   6,   7,   125, 126,
...
{
    std::array<GLbyte, kVertexCount> inputData = {0,  1,   2,   3,   4,    -1,   -2,  -3,
...
{
    std::array<GLushort, kVertexCount> inputData = {0,     1,     2,     3,     254,   255,  256,
...
{
    std::array<GLshort, kVertexCount> inputData = {0,  1,     2,     3,      -1,     -2,    -3,
...
TEST_P(VertexAttributeTestES3, IntUnnormalized)
{
    ...
    std::array<GLint, kVertexCount> inputData = {0,  1,  2,  3,      -1, -2,    -3,
                                                 -4, -1, hi, hi - 1, lo, lo + 1};
    std::array<GLfloat, kVertexCount> expectedData;
    for (size_t i = 0; i < kVertexCount; i++)
    {
...
TEST_P(VertexAttributeTestES3, UnsignedIntUnnormalized)
{
    ...
    std::array<GLuint, kVertexCount> inputData = {0,       1,   2,       3,      254,    255, 256,
...
void VertexAttributeCachingTest::SetUp()
{
    ...
    constexpr GLint maxSize     = 4;
    constexpr GLsizei maxStride = 4;
