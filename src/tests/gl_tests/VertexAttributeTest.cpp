...
ANGLE_INSTANTIATE_TEST_ES2_AND_ES3_AND_ES31(VertexAttributeTest);

ANGLE_INSTANTIATE_TEST_ES2_AND_ES3_AND_ES31(VertexAttributeOORTest);

ANGLE_INSTANTIATE_TEST_ES3(VertexAttributeTestES3);

ANGLE_INSTANTIATE_TEST_ES31(VertexAttributeTestES31);

ANGLE_INSTANTIATE_TEST_ES2_AND_ES3_AND_ES31(VertexAttributeCachingTest);
