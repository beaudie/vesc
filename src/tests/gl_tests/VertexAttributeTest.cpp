...
class VertexAttributeTestES31 : public VertexAttributeTestES3
{
  protected:
    ...
    // Set the maximum values to prevent running out of memory and other potential errors.
...
// Verify using MAX_VERTEX_ATTRIB_RELATIVE_OFFSET as offset doesn't mess up the draw.
...
ANGLE_INSTANTIATE_TEST(VertexAttributeTestES31, ES31_D3D11());
