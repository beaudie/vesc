...
void main()
{
    ...
    if (loc1Select < 0.5)
        ...
        result.g = all(lessThan(abs(_a - loc1Expected), vec4(0.01))) ? 1.0 : 0.0;
    ...
    glBindAttribLocation(program, 1, "_a");
...
const vec4 _aExpected = vec4(2.0, 2.1, 2.2, 2.3);
const mat4 a_0Expected = mat4(3.0, 3.1, 3.2, 3.3, 3.4, 3.5, 3.6, 3.7, 3.8, 3.9, 3.10, 3.11, 3.12, 3.13, 3.14, 3.15);
...
void main()
{
    ...
    result.b = all(lessThan(abs(_a - _aExpected), vec4(0.01))) ? 1.0 : 0.0;
    mat4 diff4 = a_0 - a_0Expected;
    result.a = all(lessThan(abs(diff4[0]) + abs(diff4[1]) + abs(diff4[2]) + abs(diff4[3]), vec4(0.01))) ? 1.0 : 0.0;
    color = result;
})";
...
void main(void)
{
    ...
    glBindAttribLocation(program, 6, "_a");
    ...
    glVertexAttrib4f(8, 3.4, 3.5, 3.6, 3.7);
    glVertexAttrib4f(9, 3.8, 3.9, 3.10, 3.11);
    glVertexAttrib4f(10, 3.12, 3.13, 3.14, 3.15);
