...
class VertexAttributeTestES31 : public VertexAttributeTestES3
{
  protected:
    ...
    // Set the maximum values to prevent using too much memory.
...
// Verify using value of minimum MAX_VERTEX_ATTRIB_STRIDE as stride doesn't mess up the draw.
...
// Verify using value of minimum MAX_VERTEX_ATTRIB_RELATIVE_OFFSET as offset doesn't mess up the
// draw.
