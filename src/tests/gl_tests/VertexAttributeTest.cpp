...
TEST_P(VertexAttributeTest, VertexAttribPointerCopyBufferFromInvalidaIndex2)
{
    InitAttribProgram();
...
TEST_P(VertexAttributeTest, VertexAttribPointerCopyBufferFromInvalidaIndex1)
{
    InitAttribProgram();
...
TEST_P(VertexAttributeTest, VertexAttribPointerCopyBufferFromInvalidaIndex0)
{
    InitAttribProgram();
