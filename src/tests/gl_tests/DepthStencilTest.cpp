...
TEST_P(DepthStencilTestES3, FramebufferClearBeforeStencilTestStateAndStencilAttached)
{
...
TEST_P(DepthStencilTestES3, StencilTestStateAndFramebufferClearBeforeStencilAttached)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_NV_read_stencil"));
