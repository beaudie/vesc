...
//
// DepthStencilTest:
//   Tests covering depth- or stencil-only rendering to make sure the other non-existing aspect is not affecting the results (since the format may be emulated with one that has both aspects).
//
