...
//
// TODO(b/192315789): enable this test.
TEST_P(DepthStencilTestES3, DISABLED_FramebufferClearBeforeStencilTestStateAndStencilAttached)
{
    ...
    GLuint colorLocation = glGetUniformLocation(program, angle::essl1_shaders::ColorUniform());
...
//
// TODO(b/192315789): enable this test.
TEST_P(DepthStencilTestES3, DISABLED_StencilTestStateAndFramebufferClearBeforeStencilAttached)
{
    ANGLE_SKIP_TEST_IF(!IsGLExtensionEnabled("GL_NV_read_stencil"));
