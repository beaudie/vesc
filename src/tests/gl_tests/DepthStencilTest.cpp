...
TEST_P(DepthStencilTestES3, ReadPixelsDepth24)
{
    ...
    clearAndCompareDepth(0.125f, 0x20000020);
    clearAndCompareDepth(0.5f, 0x80000080);
    clearAndCompareDepth(1.0f, 0xffffffff);

    // Test draw
    ANGLE_GL_PROGRAM(depthTestProgram, essl3_shaders::vs::Simple(), essl3_shaders::fs::Green());
    drawAndCompareDepth(depthTestProgram, 0.0f, 0x80000080);
    drawAndCompareDepth(depthTestProgram, 0.125f, 0x8fffff8f);
    drawAndCompareDepth(depthTestProgram, 0.5f, 0xbfffffbf);
