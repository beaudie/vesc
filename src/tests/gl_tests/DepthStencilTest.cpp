...
void DepthStencilTestES3::setupFramebuffer24()
{
...
TEST_P(DepthStencilTestES3, ReadPixelsDepth24Clear)
{
    ANGLE_SKIP_TEST_IF(getClientMajorVersion() < 3 && !IsGLExtensionEnabled("GL_OES_depth24") &&
...
TEST_P(DepthStencilTestES3, ReadPixelsDepth24Draw)
{
    ANGLE_SKIP_TEST_IF(getClientMajorVersion() < 3 && !IsGLExtensionEnabled("GL_OES_depth24") &&
                       !IsGLExtensionEnabled("GL_NV_read_depth"));
