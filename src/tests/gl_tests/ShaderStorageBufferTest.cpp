...
//
// Glslang wrapper replaces the layout/qualifier of an inactive SSBO with |struct|, effectively
// turning the interface block declaration into a struct definition.  This generally works except
// for SSBOs with an unsized array.  This test makes sure this special case is properly handled.
