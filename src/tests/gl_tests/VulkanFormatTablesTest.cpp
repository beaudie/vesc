...
const std::vector<VkImageCreateFlags> kImageCreateFlagsToTest = {
...
TEST_P(VulkanFormatTablesTest, TestFormatSupport)
{
    ...
    for (GLenum internalFormat : allFormats)
    {
        ...
        for (VkImageCreateFlags flagsToTest : kImageCreateFlagsToTest)
        {
            ...
            bool isTexturable =
                vkGetPhysicalDeviceImageFormatProperties(
                    ...
                    VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_SAMPLED_BIT, flagsToTest,
            ...
            const bool isRenderableColor =
                (vkGetPhysicalDeviceImageFormatProperties(
                    renderer->getPhysicalDevice(), vkFormat.vkTextureFormat, VK_IMAGE_TYPE_2D,
                    VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, flagsToTest,
                    &imageProperties)) == VK_SUCCESS;
            const bool isRenderableDepthStencil =
                (vkGetPhysicalDeviceImageFormatProperties(
                    renderer->getPhysicalDevice(), vkFormat.vkTextureFormat, VK_IMAGE_TYPE_2D,
                    VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT,
                    flagsToTest, &imageProperties)) == VK_SUCCESS;
