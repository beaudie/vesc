...
TEST_P(VulkanPerformanceCounterTest, SubmittingOutsideCommandBufferDoesNotBreakRenderPass)
{
    ...
    uint32_t expectedSubmitCommandsCount = getPerfCounters().vkQueueSubmitCalls + kNumSubmits;
    ...
    EXPECT_EQ(getPerfCounters().vkQueueSubmitCalls, expectedSubmitCommandsCount);
}
...
TEST_P(VulkanPerformanceCounterTest, UnnecessaryFlushDoesntCauseSubmission)
{
    ...
    swapBuffers();
    uint32_t expectedVkQueueSubmitCalls = getPerfCounters().vkQueueSubmitCalls;
    ...
    glFinish();
    EXPECT_EQ(getPerfCounters().vkQueueSubmitCalls, expectedVkQueueSubmitCalls);
...
TEST_P(VulkanPerformanceCounterTest_SingleBuffer, SwapBuffersAfterFlushIgnored)
{
    ...
    swapBuffers();
    uint32_t expectedCommandQueueSubmitCalls = getPerfCounters().commandQueueSubmitCalls;
    ...
    EXPECT_EQ(getPerfCounters().commandQueueSubmitCalls, expectedCommandQueueSubmitCalls);
