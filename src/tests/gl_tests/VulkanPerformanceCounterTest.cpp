...
void main() {
    ...
    GLuint expectedCacheMisses = getPerfCounters().shaderBuffersDescriptorSetCacheMisses;
    EXPECT_GT(expectedCacheMisses, 0u);
    ...
    GLuint actualCacheMisses = getPerfCounters().shaderBuffersDescriptorSetCacheMisses;
    EXPECT_EQ(expectedCacheMisses, actualCacheMisses);
}
