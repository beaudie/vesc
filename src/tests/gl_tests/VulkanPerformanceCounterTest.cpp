...
TEST_P(VulkanPerformanceCounterTest, ColorClearMaskedDrawThenClear)
{
    ...
    compareColorOpCounters(getPerfCounters(), expected);
    EXPECT_EQ(expected.colorClearAttachments, getPerfCounters().colorClearAttachments);
}
...
TEST_P(VulkanPerformanceCounterTest, DepthStencilMaskedDrawThenClear)
{
    ...
    EXPECT_EQ(expected.depthClearAttachments, getPerfCounters().depthClearAttachments);
    EXPECT_EQ(expected.stencilClearAttachments, getPerfCounters().depthClearAttachments);
}
