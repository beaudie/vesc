       ...
       SubmittingOutsideCommandBufferWithCubeMapUpdatesUsesCorrectSerials)
{
    ...
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 1, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 2, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 3, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 4, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
    glTexSubImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + 5, 0, 0, 0, kTexDim, kTexDim, GL_RGBA,
                    GL_UNSIGNED_BYTE, kInitialData.data());
