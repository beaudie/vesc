  ...
  protected:
    VulkanPerformanceCounterTest()
        : mLoadOpNoneSupport(ANGLEFeature::Unknown),
          ...
          mDisablePipelineCacheWarmUp(ANGLEFeature::Unknown)
    {
    ...
    void initANGLEFeatures()
    {
        ...
        for (EGLAttrib index = 0; index < featureCount; index++)
        {
            ...
            else if (strcmp(featureName, GetFeatureName(Feature::DisablePipelineCacheWarmUp)) == 0)
            {
                mDisablePipelineCacheWarmUp = isSupported;
            }
        }
        ...
        ASSERT_NE(mDisablePipelineCacheWarmUp, ANGLEFeature::Unknown);
    ...
    ANGLEFeature mDisablePipelineCacheWarmUp;
};
...
TEST_P(VulkanPerformanceCounterTest, PipelineCacheIsWarmedUpAtLinkTime)
{
    ...
    ANGLE_SKIP_TEST_IF(mSupportsPipelineCreationFeedback != ANGLEFeature::Supported ||
                       mDisablePipelineCacheWarmUp == ANGLEFeature::Supported);
