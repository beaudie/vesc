...
TEST_P(ImageTestES3, SourceAHBTargetExternalESSL3_YUVUpdatedBetweenDraws)
{
    ...
    // Create a texture target to bind to the first ahb egl image.
    GLuint ahbTexture1;
    ...
    // Create a texture target to bind to the second ahb egl image.
    GLuint ahbTexture2;
    ...
    GLubyte expectedColor[4] = {255, 159, 211, 255};
    EXPECT_PIXEL_NEAR(0, 0, expectedColor[0], expectedColor[1], expectedColor[2],
                          expectedColor[3], 1);
