...
class ImageTest : public ANGLETest
{
  protected:
                                   ...
                                   size_t bytesPerPixel)
    {
        ...
        EXPECT_EQ(0, AHardwareBuffer_lock(aHardwareBuffer, AHARDWAREBUFFER_USAGE_CPU_WRITE_OFTEN, -1,
    ...
    {
        // Set Android Memory
        AHardwareBuffer *aHardwareBuffer = createAndroidHardwareBuffer(width, height, depth,
...
void ImageTest::SourceAHBTarget2D_helper(const EGLint *attribs)
{
    ...
    EGLImageKHR image;
    createEGLImageAndroidHardwareBufferSource(1, 1, 1, GL_RGBA8, attribs, data, 4,
                                              &source, &image);
