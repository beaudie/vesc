...
// Test sampling immutable texture created with YUV internal format
TEST_P(ImageTestES3, Source2DYUVTarget2D)
{
    ...
    createEGLImage2DTextureImmutableSource(2, 2, GL_G8_B8R8_2PLANE_420_UNORM_ANGLE,
    ...
    glBindTexture(GL_TEXTURE_2D, source);
    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, 2, 2, GL_G8_B8R8_2PLANE_420_UNORM_ANGLE,
