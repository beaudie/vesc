...
class ImageTest : public ANGLETest
{
  protected:
    ...
    void Source3DTargetTexture_helper(const bool withColorspace = false);
    void Source3DTargetRenderbuffer_helper(const bool withColorspace = false);
    void Source3DTargetExternal_helper(const bool withColorspace = false);
    void Source3DTargetExternalESSL3_helper(const bool withColorspace = false);
...
TEST_P(ImageTest, ValidationGLEGLImage)
{
    ...
    if (hasImageGLColorspaceExt() && IsGLExtensionEnabled("GL_EXT_texture_sRGB_decode"))
    {
...
TEST_P(ImageTest, Source2DTargetRenderbuffer)
{
    ...
    if (hasImageGLColorspaceExt() && getClientMajorVersion() >= 3)
    {
...
{
    Source3DTargetRenderbuffer_helper();
    if (hasImageGLColorspaceExt() && getClientMajorVersion() >= 3)
    {
...
{
    Source3DTargetExternalESSL3_helper();
    if (hasImageGLColorspaceExt() && IsGLExtensionEnabled("GL_EXT_texture_sRGB_decode"))
    {
...
TEST_P(ImageTest, SourceRenderbufferTargetRenderbuffer)
{
    ...
    if (hasImageGLColorspaceExt() && IsGLExtensionEnabled("GL_EXT_sRGB"))
    {
