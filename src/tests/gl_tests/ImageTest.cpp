                                                  ...
                                                  GLuint srcTexture)
{
    ...
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, dstTexture, 1);
    ASSERT_GL_FRAMEBUFFER_COMPLETE(GL_FRAMEBUFFER);
    EXPECT_PIXEL_NEAR(2, 2, expectedColor[0], expectedColor[1], expectedColor[2], expectedColor[3],
                      1);
    EXPECT_PIXEL_NEAR(4, 4, expectedColor[0], expectedColor[1], expectedColor[2], expectedColor[3],
                      1);
    EXPECT_PIXEL_NEAR(8, 8, expectedColor[0], expectedColor[1], expectedColor[2], expectedColor[3],
                      1);
