...
#ifndef ANGLE_AHARDWARE_BUFFER_YUV_SUPPORT
    std::cout << "Test skipped: !ANGLE_AHARDWARE_BUFFER_YUV_SUPPORT." << std::endl;
    return;
#endif
...
TEST_P(ImageTestES3, RenderToYUVAHB)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor(255, 159, 212, 255));
