...
TEST_P(ImageTest, SourceAHBTarget2DDepth)
{
    ...
    createEGLImageAndroidHardwareBufferSource(
        width, height, depth, GL_DEPTH_COMPONENT32F, kDefaultAttribs,
        reinterpret_cast<GLubyte *>(&depthValue), 4, &source, &image);
    ...
    drawQuad(colorFillProgram, essl1_shaders::PositionAttrib(), 0.5f, 1.0f);

    // Since 0.5f < 1.0f, all fragments of the color attachment should be blue.
