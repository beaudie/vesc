...
TEST_P(ImageTest, Source2DTarget2DStorage)
{
    Source2DTarget2DStorage_helper(false);
}

TEST_P(ImageTest, Source2DTarget2DStorage_Colorspace)
{
    ANGLE_SKIP_TEST_IF(!hasImageGLColorspaceExt());
...
void ImageTest::Source2DTarget2DStorage_helper(bool withColorspace)
{
    ...
    // Create the Image
    createEGLImage2DTextureSource(1, 1, GL_RGBA8, GL_UNSIGNED_BYTE, attributes, data, &source,
                                  &image);
...
TEST_P(ImageTest, Source2DTargetExternalStorage)
{
    Source2DTargetExternalStorage_helper(false);
}

TEST_P(ImageTest, Source2DTargetExternalStorage_Colorspace)
{
    ANGLE_SKIP_TEST_IF(!hasImageGLColorspaceExt());
...
TEST_P(ImageTest, Source3DTarget3DStorage)
{
    Source3DTarget3DStorage_helper(false);
}

TEST_P(ImageTest, Source3DTarget3DStorage_Colorspace)
{
    ANGLE_SKIP_TEST_IF(!hasImageGLColorspaceExt());
...
void ImageTest::Source3DTarget3DStorage_helper(bool withColorspace)
{
    ...
    // Qualcom drivers only accepts 2D and external texture targets
    // for glEGLImageTargetTexStorageEXT()
    ANGLE_SKIP_TEST_IF(IsAndroid() && IsOpenGLES());
    ...
    // Create the Image
    createEGLImage3DTextureSource(1, 1, 1, GL_RGBA8, GL_UNSIGNED_BYTE,
