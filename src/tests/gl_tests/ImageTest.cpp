...
// Test glClear on FBO with AHB attachments are flushed before we read back
TEST_P(ImageTestES3, AHBClearNotBeingPerformed)
{
    ...
    EGLImageKHR ahbImage2 =
        eglCreateImageKHR(window->getDisplay(), EGL_NO_CONTEXT, EGL_NATIVE_BUFFER_ANDROID,
                          angle::android::AHardwareBufferToClientBuffer(ahb), kDefaultAttribs);
    ASSERT_EGL_SUCCESS();
    ...
    // Create a second framebuffer which is again backed by the same AHB.
    {
        ...
        //   SwiftShader: vkBeginCommandBuffer(VkCommandBuffer, const VkCommandBufferBeginInfo *)
        //   (VkCommandBuffer commandBuffer = 0x7cc9c9207480, const VkCommandBufferBeginInfo*
        //   pBeginInfo = 0x7cc95fe1b600) SwiftShader: vkCmdPipelineBarrier(VkCommandBuffer,
        //   VkPipelineStageFlags, VkPipelineStageFlags, VkDependencyFlags, uint32_t, const
        //   VkMemoryBarrier *, uint32_t, const VkBufferMemoryBarrier *, uint32_t, const
        //   VkImageMemoryBarrier *) (VkCommandBuffer commandBuffer = 0x7cc9c9207480,
        //   VkPipelineStageFlags srcStageMask = 0x14000, VkPipelineStageFlags dstStageMask = 0x400,
        //   VkDependencyFlags dependencyFlags = 0, uint32_t memoryBarrierCount = 0, onst
        //   VkMemoryBarrier* pMemoryBarriers = 0x0, uint32_t bufferMemoryBarrierCount = 0, const
        //   VkBufferMemoryBarrier* pBufferMemoryBarriers = 0x0, uint32_t imageMemoryBarrierCount =
        //   1, const VkImageMemoryBarrier* pImageMemoryBarriers = 0x7cc9c9211498) ANGLE   : EVENT:
        //   glFinish(context = 1) SwiftShader: vkEndCommandBuffer(VkCommandBuffer) (VkCommandBuffer
        //   commandBuffer = 0x7cc9c9207480) SwiftShader: vkResetFences(VkDevice, uint32_t, const
        //   VkFence *) (VkDevice device = 0x7cc9601bf160, uint32_t fenceCount = 1, const VkFence*
        //   pFences = 0x7cc95fe1b340) SwiftShader: vkQueueSubmit(VkQueue, uint32_t, const
        //   VkSubmitInfo *, VkFence) (VkQueue queue = 0x7ccae91d9040, uint32_t submitCount = 1,
        //   const VkSubmitInfo* pSubmits = 0x7cc9c9211498, VkFence fence = 0x7cc9994fa0b8)
        //   SwiftShader: vkGetFenceStatus(VkDevice, VkFence) (VkDevice device = 0x7cc9601bf160,
        //   VkFence fence = 0x7cc9994fa0b8) SwiftShader: vkResetCommandBuffer(VkCommandBuffer,
        //   VkCommandBufferResetFlags) (VkCommandBuffer commandBuffer = 0x7cc9c9207480,
