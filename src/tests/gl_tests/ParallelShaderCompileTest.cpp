...
class ParallelShaderCompileTest : public ANGLETest
{
  protected:
    ...
    void SetUp() override
    {
        ...
        mParallelShaderCompile = reinterpret_cast<PFNGLMAXSHADERCOMPILERTHREADSKHRPROC>(
            eglGetProcAddress("glMaxShaderCompilerThreadsKHR"));
    }

    void TearDown() override { ANGLETest::TearDown(); }

    bool requestParallelShaderCompileExtension()
    {
    ...
    PFNGLMAXSHADERCOMPILERTHREADSKHRPROC mParallelShaderCompile = nullptr;
};

// Test basic functionality of GL_KHR_parallel_shader_compile
TEST_P(ParallelShaderCompileTest, Basic)
{
    ANGLE_SKIP_TEST_IF(!requestParallelShaderCompileExtension());

    ASSERT_NE(mParallelShaderCompile, nullptr);
