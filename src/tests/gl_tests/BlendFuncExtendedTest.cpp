...
ANGLE_INSTANTIATE_TEST_ES3(EXTBlendFuncExtendedTestES3);
ANGLE_INSTANTIATE_TEST_ES31(EXTBlendFuncExtendedTestES3);
ANGLE_INSTANTIATE_TEST_ES2(EXTBlendFuncExtendedDrawTest);
ANGLE_INSTANTIATE_TEST_ES3(EXTBlendFuncExtendedDrawTestES3);
ANGLE_INSTANTIATE_TEST_ES31(EXTBlendFuncExtendedDrawTestES3);
