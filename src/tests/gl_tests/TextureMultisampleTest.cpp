...
// Tests the maximum value of MAX_INTEGER_SAMPLES is supported and a larger value is not.
TEST_P(TextureMultisampleTest, MaxIntegerSamplesValid)
{
    ...
    texStorageMultisample(GL_TEXTURE_2D_MULTISAMPLE, maxIntegerSamples + 1, GL_RGBA8I, 1, 1,
                          GL_FALSE);
    ASSERT_GL_ERROR(GL_INVALID_OPERATION);
...
// Tests the maximum value of MAX_COLOR_TEXTURE_SAMPLES is supported and a larger value is not.
TEST_P(TextureMultisampleTest, MaxColorTextureSamplesValid)
{
    ...
    texStorageMultisample(GL_TEXTURE_2D_MULTISAMPLE, maxColorTextureSamples + 1, GL_RGBA8, 1, 1,
                          GL_FALSE);
    ASSERT_GL_ERROR(GL_INVALID_OPERATION);
...
// Tests the maximum value of MAX_DEPTH_TEXTURE_SAMPLES is supported and a larger value is not.
TEST_P(TextureMultisampleTest, MaxDepthTextureSamplesValid)
{
    ...
    texStorageMultisample(GL_TEXTURE_2D_MULTISAMPLE, maxDepthTextureSamples + 1, GL_RGBA8, 1, 1,
                          GL_FALSE);
    ASSERT_GL_ERROR(GL_INVALID_OPERATION);
