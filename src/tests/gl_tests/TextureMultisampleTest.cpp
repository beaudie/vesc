...
// Try to compile shaders using GL_ANGLE_texture_multisample_array when the extension is not
// enabled.
...
TEST_P(TextureMultisampleArrayWebGLTest, SimpleTexelFetch)
{
    ...
    ANGLE_GL_PROGRAM(texelFetchProgram, essl31_shaders::vs::Passthrough(), blitArrayTextureLayerFragmentShader());
...
// Test out-of-range texel fetches from a multisample array texture. Test with sample number out of range.
...
// Test out-of-range texel fetches from a multisample array texture. Test with layer index out of range.
