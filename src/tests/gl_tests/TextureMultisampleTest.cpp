...
class TextureMultisampleTest : public ANGLETest
{
  protected:
    ...
    bool ES3MultisampleExtSupported()
    {
...
{
    // TODO(yizhou) : support ANGLE_texture_multisample extension on d3d11
    ANGLE_SKIP_TEST_IF(IsD3D11() || !ES3MultisampleExtSupported());
    ...
    glTexStorage2DMultisampleANGLE(GL_TEXTURE_2D_MULTISAMPLE_ANGLE, samplesToUse, GL_RGBA8, kWidth,
                              kHeight, GL_TRUE);
    ASSERT_GL_NO_ERROR();
