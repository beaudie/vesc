...
// When program link or relink fails, if we try to install the unsuccessfully
...
TEST_P(LinkAndRelinkFailureTest, RenderingProgramWithoutProgramInstalled)
{
    glUseProgram(0);
...
TEST_P(LinkAndRelinkFailureTest, RenderingProgramWithProgramInstalled)
{
...
// state before the link, it should report an error for UseProgram and
// DispatchCompute.
TEST_P(LinkAndRelinkFailureTestES31, ComputeProgramWithoutProgramInstalled)
{
    glUseProgram(0);
    GLuint program = glCreateProgram();
...
TEST_P(LinkAndRelinkFailureTestES31, ComputeProgramWithProgramInstalled)
{
