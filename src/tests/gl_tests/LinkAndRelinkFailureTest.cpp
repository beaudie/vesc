...
class RenderPipelineTest : public ANGLETest
{
  protected:
    RenderPipelineTest() {}
};

class ComputePipelineTest : public ANGLETest
{
  protected:
    ComputePipelineTest() {}
};
...
TEST_P(RenderPipelineTest, LinkFailureTest)
{
...
TEST_P(RenderPipelineTest, RelinkFailureTest)
{
...
TEST_P(ComputePipelineTest, LinkFailureTest)
{
    // Link failure, and no valid program installed in the pipeline before.
...
TEST_P(ComputePipelineTest, RelinkFailureTest)
{
...
ANGLE_INSTANTIATE_TEST(RenderPipelineTest, ES2_OPENGL(), ES2_OPENGLES(), ES2_D3D9(), ES2_D3D11());
ANGLE_INSTANTIATE_TEST(ComputePipelineTest, ES31_OPENGL(), ES31_OPENGLES());
