...
class InstancingTest : public ANGLETest
{
  protected:
    ...
    void SetUp() override
    {
        ...
        const GLfloat qvertex1[3] = {-quadRadius, quadRadius, 0.0f};
        const GLfloat qvertex2[3] = {-quadRadius, -quadRadius, 0.0f};
        const GLfloat qvertex3[3] = {quadRadius, -quadRadius, 0.0f};
        const GLfloat qvertex4[3] = {quadRadius, quadRadius, 0.0f};
