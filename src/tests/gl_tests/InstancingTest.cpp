...
class InstancingTest : public ANGLETest
{
  protected:
    ...
    void runDrawArraysTest(GLuint first, GLsizei count, GLsizei instanceCount, const float *offset)
    {
    ...
    virtual void runDrawElementsTest(const std::string &vs, bool shouldAttribZeroBeInstanced)
    {
        const std::string &fs =
            "precision mediump float;\n"
            "void main()\n"
