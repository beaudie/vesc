...
class InstancingTest : public ANGLETest
{
  protected:
    ...
    {
        // The window is divided into kMaxDrawn slices.
    ...
    void checkDrawing(unsigned lastDrawn)
    {
        for (unsigned i = 0; i < kMaxDrawn; ++i)
        {
            ...
            for (unsigned j = 0; j < ArraySize(kPointVertices); j += 2)
            {
...
TEST_P(InstancingTestAllConfigs, AllVariants)
{
            ...
            for (bool indexed : {true, false})
                for (bool offset : {true, false})
                    for (bool buffer : {true, false})
                        runTest(2, 1, points, a0, indexed, offset, buffer);
}
...
TEST_P(InstancingTestAllConfigs, AttributeZeroInstanced)
{
    ...
    runTest(2, 1, true /* attrib 0 instanced */, false /* quads */, true /* DrawElements */,
...
TEST_P(InstancingTestAllConfigs, AttributeZeroNotInstanced)
{
    ...
    runTest(2, 1, false /* attrib 1 instanced */, false /* quads */, true /* DrawElements */,
            false /* N/A */, false /* no buffer */);
}
...
TEST_P(InstancingTestNo9_3, DrawArraysWithOffset)
{
    ...
    runTest(2, 1, false /* attribute 1 instanced */, false /* quads */, false /* DrawArrays */,
...
TEST_P(InstancingTestPoints, DrawArrays)
{
    ...
    runTest(2, 1, false /* attrib 1 instanced */, true /* points */, false /* DrawArrays */,
...
TEST_P(InstancingTestPoints, DrawElements)
{
    ...
    runTest(2, 1, false /* attrib 1 instanced */, true /* points */, true /* DrawElements */,
