...
class InstancingTest : public ANGLETest
{
  protected:
    ...
    bool setupDrawArraysTest(const std::string &vs)
    {
    ...
    bool setupInstancedPointsTest()
    {
        ...
        const std::string vs =
            SHADER_SOURCE(attribute vec3 a_position; attribute vec3 a_instancePos; void main()
                          {
...
TEST_P(InstancingTestNo9_3, DrawArraysWithOffset)
{
    ...
    bool result = setupDrawArraysTest(vs);
    ASSERT_EQ(result, true);

    float offset1[3] = { 0, 0, 0 };
    runDrawArraysTest(mProgram, 0, 6, 2, offset1);

    float offset2[3] = { 0.0f, 1.0f, 0 };
    runDrawArraysTest(mProgram, 6, 6, 2, offset2);
...
TEST_P(InstancingTestPoints, DrawArrays)
{
    ...
    bool result = setupInstancedPointsTest();
    ASSERT_EQ(result, true);
