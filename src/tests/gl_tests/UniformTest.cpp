...
// This test reproduces a driver bug on Intel windows platforms since driver upgrades from 4901 to
// 4944. In some situation, when a boolean uniform with false value is used as the if and for
// condtions, the bug will be triggered. It seems that the shader doesn't get a right 'false' value
// from the uniform.
