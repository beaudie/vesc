...
// This test has a regression when Intel windows driver upgrades to 4944. In some situation, when a
// boolean uniform with false value is used as the if and for condtions, the bug will be triggered.
// It seems that the shader doesn't get a right 'false' value from the uniform.
