...
TEST_P(WebGLCompatibilityTest, InvalidCompressedTextureFormat)
{
    ...
    validateCompressedTexImageExtensionFormat(GL_COMPRESSED_RGBA_ASTC_4x4_KHR, /*width*/ 4,
                                              /*height*/ 4,
                                              /*imageSize*/ 8, "textureCompressionASTCLDR");
    validateCompressedTexImageExtensionFormat(GL_COMPRESSED_RGBA_ASTC_4x4_KHR, /*width*/ 4,
                                              /*height*/ 4,
                                              /*imageSize*/ 8, "textureCompressionASTCHDR");
}
