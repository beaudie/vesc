...
{
    if (a.source != b.source || a.type != b.type || a.id != b.id || a.severity != b.severity ||
        a.message != b.message)
    {
        return false;
    }
