...
class WebGLCompatibilityTest : public ANGLETest
{
  protected:
    ...
    template <typename T>
    void TestFloatTextureFormat(GLenum format,
                                GLenum type,
                                ...
                                const float floatData[4])
    {
        ...
        const std::string samplingFs =
            ...
            "    }\n"
            // "        gl_FragColor = (color + vec4(1000, 1000, 1000, 1000)) / vec4(2000, 2000,
            // 2000, 2000);\n"
            "}\n";
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, format, 1, 1, 0, format, type, textureData);
        if (!texturingEnabled)
        {
...
{
    constexpr float data[] = {-0.1f, 0.0f, 0.0f, 1.0f};
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
...

        {
            ...
            bool render  = false;
            TestFloatTextureFormat(GL_LUMINANCE, GL_FLOAT, texture, filter, render, data, data);
        }
    }
}
...
{
    constexpr float textureData[]   = {-0.1f, 0.0f, 0.0f, 0.0f};
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
...

        {
            ...
            bool filter  = extensionEnabled("GL_OES_texture_float_linear");
            bool render  = false;
            TestFloatTextureFormat(GL_ALPHA, GL_FLOAT, texture, filter, render, textureData,
                                   readPixelData);
        }
    }
}
...
TEST_P(WebGLCompatibilityTest, LA32FTextures)
{
    ...
    constexpr float readPixelData[] = {textureData[0], 0.0f, 0.0f, textureData[1]};
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
...

        {
            ...
            bool filter  = extensionEnabled("GL_OES_texture_float_linear");
            bool render  = false;
            TestFloatTextureFormat(GL_LUMINANCE_ALPHA, GL_FLOAT, texture, filter, render,
...
TEST_P(WebGLCompatibilityTest, R32FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
...

        {
            ...
            TestFloatTextureFormat(GL_RED, GL_FLOAT, texture, filter, render, data, data);
        }
    }
}
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
...

        {
            ...
            bool filter = extensionEnabled("GL_OES_texture_float_linear") &&
                          extensionEnabled("GL_EXT_texture_rg");
            bool render = extensionEnabled("GL_EXT_color_buffer_float");
            TestFloatTextureFormat(GL_RG, GL_FLOAT, texture, filter, render, data, data);
        }
    }
}
...
TEST_P(WebGLCompatibilityTest, RGB32FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        {
            bool texture = getClientMajorVersion() >= 3 || extensionEnabled("GL_OES_texture_float");
            bool filter  = extensionEnabled("GL_OES_texture_float_linear");
            bool render  = extensionEnabled("GL_CHROMIUM_color_buffer_float_rgb");
            TestFloatTextureFormat(GL_RGB, GL_FLOAT, texture, filter, render, data, data);
        }
    }
}
...
TEST_P(WebGLCompatibilityTest, RGBA32FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        TestFloatTextureFormat(GL_RGBA, GL_FLOAT, texture, filter, render, data, data);
    }
}
...
TEST_P(WebGLCompatibilityTest, R16FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        bool texture =
            getClientMajorVersion() >= 3 || (extensionEnabled("GL_OES_texture_half_float") &&
                                             extensionEnabled("GL_EXT_texture_rg"));
        bool filter =
        ...
        bool render = extensionEnabled("GL_EXT_color_buffer_half_float") &&
                      extensionEnabled("GL_EXT_texture_rg");
        TestFloatTextureFormat(GL_RED, GL_HALF_FLOAT_OES, texture, filter, render, textureData,
                               readPixelsData);
    }
}
...
TEST_P(WebGLCompatibilityTest, RG16FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        bool render = extensionEnabled("GL_EXT_color_buffer_half_float") &&
                      extensionEnabled("GL_EXT_texture_rg");
        TestFloatTextureFormat(GL_RG, GL_HALF_FLOAT_OES, texture, filter, render, textureData,
                               readPixelsData);
    }
}
...
TEST_P(WebGLCompatibilityTest, RGB16FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        bool filter =
            getClientMajorVersion() >= 3 || extensionEnabled("GL_OES_texture_half_float_linear");
        bool render = extensionEnabled("GL_EXT_color_buffer_half_float");
        TestFloatTextureFormat(GL_RGB, GL_HALF_FLOAT_OES, texture, filter, render, textureData,
                               readPixelsData);
    }
}
...
TEST_P(WebGLCompatibilityTest, RGBA16FTextures)
{
    ...
    for (auto extension : FloatingPointTextureExtensions)
    {
        ...
        TestFloatTextureFormat(GL_RGBA, GL_HALF_FLOAT_OES, texture, filter, render, textureData,
                               readPixelsData);
    }
}
