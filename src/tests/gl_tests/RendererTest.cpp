...
ANGLE_INSTANTIATE_TEST(RendererTest,
    ...
    ES2_OPENGL(), ES2_OPENGL(2, 1), ES2_OPENGL(3, 0), ES2_OPENGL(3, 1), ES2_OPENGL(3, 2), ES2_OPENGL(3, 3),
    ES2_OPENGL(4, 0), ES2_OPENGL(4, 1), ES2_OPENGL(4, 2), ES2_OPENGL(4, 3), ES2_OPENGL(4, 4), ES2_OPENGL(4, 5),

    // ES2 on top of desktop OpenGL versions 3.2 to 4.5
    ES3_OPENGL(), ES3_OPENGL(3, 2), ES3_OPENGL(3, 3),
    ES3_OPENGL(4, 0), ES3_OPENGL(4, 1), ES3_OPENGL(4, 2), ES3_OPENGL(4, 3), ES3_OPENGL(4, 4), ES3_OPENGL(4, 5),

    // ES2 on top of OpenGL ES 2.0 to 3.1
    ES2_OPENGLES(), ES2_OPENGLES(2, 0), ES2_OPENGLES(3, 0), ES2_OPENGLES(3, 1),

    // ES2 on top of OpenGL ES 3.0 to 3.1
    ES3_OPENGLES(), ES3_OPENGLES(3, 0), ES3_OPENGLES(3, 1));
}
