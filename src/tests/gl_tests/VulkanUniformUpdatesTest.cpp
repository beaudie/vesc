...
class VulkanUniformUpdatesTest : public ANGLETest
{
  protected:
    ...
    void limitMaxSets()
    {
        ...
        VkDescriptorPoolSize uniformSetSize = { VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC, rx::GetUniformBufferDescriptorCount() };
        ...
        VkDescriptorPoolSize textureSetSize = { VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, contextVk->getRenderer()->getMaxActiveTextures() };
