...
void main()
{
    ...
    rx::ProgramVk *programVk = contextVk->getCurrentProgram();

    // Set a really small min size so that every uniform update allocates a new buffer.
    programVk->setDefaultUniformBlocksMinSize(256);
