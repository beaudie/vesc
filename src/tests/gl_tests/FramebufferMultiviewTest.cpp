...
class FramebufferMultiviewLayeredClearTest : public FramebufferMultiviewTest
{
  protected:
                        ...
                        bool depth)
    {
        ...
        CreateMultiviewBackingTextures(true, 0, width, height, numLayers, mColorTex, mDepthTex,
                                       mDepthStencilTex);
        ...
        AttachMultiviewTextures(GL_FRAMEBUFFER, true, width, numViews, baseViewIndex, mColorTex,
