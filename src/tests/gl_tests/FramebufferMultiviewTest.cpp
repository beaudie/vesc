...
class FramebufferMultiviewLayeredClearTest : public FramebufferMultiviewTest
{
  protected:
    ...
    GLColor getLayerColor(GLint x, GLint y, size_t layer, GLenum attachment)
    {
...
TEST_P(FramebufferMultiviewLayeredClearTest, ColorBufferClear)
{
    ...
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 0, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 1, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 2, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 3, GL_COLOR_ATTACHMENT0));
}
...
TEST_P(FramebufferMultiviewLayeredClearTest, ClearIndividualColorBuffer)
{
    ...
    for (int i = 0; i < 2; ++i)
    {
        for (int layer = 0; layer < 4; ++layer)
        {
            ...
            EXPECT_EQ(GLColor::red, getLayerColor(0, 0, layer, colorAttachment));
        }
    }
    ...
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 0, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::blue, getLayerColor(0, 0, 1, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::blue, getLayerColor(0, 0, 2, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 3, GL_COLOR_ATTACHMENT0));

    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 0, GL_COLOR_ATTACHMENT1));
    EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 1, GL_COLOR_ATTACHMENT1));
    EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 2, GL_COLOR_ATTACHMENT1));
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 3, GL_COLOR_ATTACHMENT1));
}
...
TEST_P(FramebufferMultiviewLayeredClearTest, UnmodifiedDetachedTexture)
{
    ...
    {
        GLenum colorAttachment = static_cast<GLenum>(GL_COLOR_ATTACHMENT0 + i);
        EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 0, colorAttachment));
        EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 1, colorAttachment));
        EXPECT_EQ(GLColor::green, getLayerColor(0, 0, 2, colorAttachment));
        EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 3, colorAttachment));
    }
...
TEST_P(FramebufferMultiviewLayeredClearTest, ScissoredClear)
{
    ...
    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 0, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::red, getLayerColor(1, 0, 0, GL_COLOR_ATTACHMENT0));

    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 1, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::green, getLayerColor(1, 0, 1, GL_COLOR_ATTACHMENT0));

    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 2, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::green, getLayerColor(1, 0, 2, GL_COLOR_ATTACHMENT0));

    EXPECT_EQ(GLColor::red, getLayerColor(0, 0, 3, GL_COLOR_ATTACHMENT0));
    EXPECT_EQ(GLColor::red, getLayerColor(1, 0, 3, GL_COLOR_ATTACHMENT0));
}
