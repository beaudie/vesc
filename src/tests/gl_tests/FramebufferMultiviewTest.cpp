...
class FramebufferMultiviewClearTest : public FramebufferMultiviewTest
{
  protected:
    ...
    void createFBO(size_t numColorBuffers, bool stencil, bool depth)
    {
    ...
    void checkAlternatingColumnsOfRedAndGreenInFBO()
    {
        ...
        EXPECT_PIXEL_COLOR_EQ(0, 1, GLColor(255, 0, 0, 0));

        // column 1
        EXPECT_PIXEL_COLOR_EQ(1, 0, GLColor(0, 255, 0, 0));
        EXPECT_PIXEL_COLOR_EQ(1, 1, GLColor(0, 255, 0, 0));

        // column 2
        EXPECT_PIXEL_COLOR_EQ(2, 0, GLColor(255, 0, 0, 0));
        EXPECT_PIXEL_COLOR_EQ(2, 1, GLColor(255, 0, 0, 0));

        // column 3
        EXPECT_PIXEL_COLOR_EQ(3, 0, GLColor(0, 255, 0, 0));
        EXPECT_PIXEL_COLOR_EQ(3, 1, GLColor(0, 255, 0, 0));
    }
