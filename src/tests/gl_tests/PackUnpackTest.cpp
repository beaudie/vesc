...
TEST_P(PackUnpackTest, PackUnpackSnormNormal)
{
    ...
    compareBeforeAfter(mSNormProgram, 0.5f, -0.2f, 0.5f, -0.2f);
    compareBeforeAfter(mSNormProgram, -0.35f, 0.75f, -0.35f, 0.75f);
    compareBeforeAfter(mSNormProgram, 0.00392f, -0.99215f, 0.00392f, -0.99215f);
    compareBeforeAfter(mSNormProgram, 1.0f, -0.00392f, 1.0f, -0.00392f);
}
...
{
    compareBeforeAfter(mHalfProgram, 0.5f, -0.2f, 0.5f, -0.2f);
    compareBeforeAfter(mHalfProgram, -0.35f, 0.75f, -0.35f, 0.75f);
    compareBeforeAfter(mHalfProgram, 0.00392f, -0.99215f, 0.00392f, -0.99215f);
    compareBeforeAfter(mHalfProgram, 1.0f, -0.00392f, 1.0f, -0.00392f);
}
...
{
    compareBeforeAfter(mSNormProgram, 0.00001f, -0.00001f, 0.00001f, -0.00001f);
}
...
{
    compareBeforeAfter(mHalfProgram, 0.00001f, -0.00001f, 0.00001f, -0.00001f);
}
...
{
    compareBeforeAfter(mSNormProgram, 0.00000f, -0.00000f, 0.00000f, -0.00000f);
}
...
{
    compareBeforeAfter(mHalfProgram, 0.00000f, -0.00000f, 0.00000f, -0.00000f);
}
