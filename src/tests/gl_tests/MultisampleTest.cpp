...
TEST_P(MultisampleTest, Line)
{
    ...
    EXPECT_PIXEL_COLOR_NEAR(0, 2, kDarkRed, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(1, 3, GLColor::red, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(2, 3, GLColor::red, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(3, 3, kMidRed, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(4, 4, kMidRed, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(5, 4, GLColor::red, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(6, 4, GLColor::red, kErrorMargin);
    EXPECT_PIXEL_COLOR_NEAR(7, 5, kDarkRed, kErrorMargin);
}
