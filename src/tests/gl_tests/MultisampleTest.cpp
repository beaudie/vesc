                               ...
                               public ::testing::TestWithParam<angle::PlatformParameters>
{
  protected:
    ...
    void testResolveToFBO(GLenum format,
                          ...
                          GLint height)
    {
        ...
        EXPECT_PIXEL_RECT_EQ(0, 0, kWidth, kHeight, expected_color);
        ASSERT_GL_NO_ERROR();
    }
...
// These colors match the shader in testResolveToFBO which returns (0.5, 0.6, 0.7, 0.8).
