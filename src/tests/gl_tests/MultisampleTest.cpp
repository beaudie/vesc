...
// Also, the multisample line width granularity should not be negative.
TEST_P(MultisampleTestES32, MultisampleLineWidthRangeAndGranularityCheck)
{
    GLfloat range[2] = {0, 0};
...
ANGLE_INSTANTIATE_TEST_ES32(MultisampleTestES32);
