...
TEST_P(DiscardFramebufferEXTTest, ClearDepthThenDrawWithDepthTestThenDiscard)
{
    ...
    EXPECT_PIXEL_COLOR_EQ(4, 4, GLColor::red);
    EXPECT_PIXEL_COLOR_EQ(kTexWidth / 2 + 4, 4, GLColor::blue);
    EXPECT_PIXEL_COLOR_EQ(4, kTexHeight / 2 + 4, GLColor::red);
    EXPECT_PIXEL_COLOR_EQ(kTexWidth / 2 + 4, kTexHeight / 2 + 4, GLColor::red);
#if 0
