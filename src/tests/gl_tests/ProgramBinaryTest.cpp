...
TEST_P(ProgramBinaryTest, FloatDynamicShaderSize)
{
    ...
    {
        std::cout << "Test skipped because GL_OES_get_program_binary is not available." << std::endl;
        return;
    }
...
ANGLE_INSTANTIATE_TEST(ProgramBinaryTest, ES2_D3D9(), ES2_D3D11(), ES3_D3D11(), ES2_OPENGL(), ES3_OPENGL());
