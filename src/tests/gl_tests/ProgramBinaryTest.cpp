...
ANGLE_INSTANTIATE_TEST_ES3_AND(ProgramBinaryES3Test,
                               WithCompileShadersDuringProgramLink(ES3_VULKAN()));
...
ANGLE_INSTANTIATE_TEST_ES31_AND(ProgramBinaryES31Test,
                                WithCompileShadersDuringProgramLink(ES31_VULKAN()));
...
ANGLE_INSTANTIATE_TEST(ProgramBinariesAcrossPlatforms,
                       ...
                       PlatformsWithLinkResult(WithCompileShadersDuringProgramLink(ES2_VULKAN()),        WithCompileShadersDuringProgramLink(ES2_VULKAN()),           true         ), // Loading + reloading binary with compiling shaders at link time should work
                       PlatformsWithLinkResult(WithCompileShadersDuringProgramLink(ES3_VULKAN()),        WithCompileShadersDuringProgramLink(ES3_VULKAN()),           true         ), // Loading + reloading binary with compiling shaders at link time should work
                       );
// clang-format on
