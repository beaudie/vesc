...
// TODO: add more tests:
// - One that toggles between dither and not, making sure it properly disables and enables
// - One that uses multiple mixed format attachments, and the correct ones should be dithered.
