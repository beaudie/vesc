...
TEST_P(BlendMinMaxTest, RGBA32f)
{
    ...
    {
        std::cout << "Test skipped because ES3 and GL_EXT_color_buffer_float are not available." << std::endl;
        return;
    }
...
TEST_P(BlendMinMaxTest, RGBA16F)
{
    ...
    {
        std::cout << "Test skipped because ES3 and GL_EXT_color_buffer_half_float are not available." << std::endl;
        return;
    }
...
ANGLE_INSTANTIATE_TEST(BlendMinMaxTest, ES2_D3D9(), ES2_D3D11(), ES2_OPENGL(), ES2_OPENGLES());
