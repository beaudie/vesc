...
TEST_P(BlendMinMaxTest, RGBA16F)
{
    ...
    // TODO(geofflang): This fails because readpixels with UNSIGNED_BYTE/RGBA does not work with half float buffers
...
ANGLE_INSTANTIATE_TEST(BlendMinMaxTest, ES2_D3D9(), ES2_D3D11(), ES2_D3D11_FL9_3(), ES2_OPENGL(), ES2_OPENGLES());
