...
class VulkanMemoryTest : public ANGLETest<>
{
  protected:
    ...
    void checkMemorySizesForDeviceOOMTest(VkPhysicalDevice physicalDevice,
...
void VulkanMemoryTest::checkMemorySizesForDeviceOOMTest(VkPhysicalDevice physicalDevice,
                                                        VkDeviceSize *totalDeviceMemorySizeOut)
{
    ...
    *totalDeviceMemorySizeOut                 = 0;
    ...
    ANGLE_SKIP_TEST_IF(heapsWithoutLocalDeviceMemoryBit == 0 || *totalDeviceMemorySizeOut == 0);
}
...
TEST_P(VulkanMemoryTest, AllocateVMAImageWhenDeviceOOM)
{
    ...
    checkMemorySizesForDeviceOOMTest(helper.getPhysicalDevice(), &totalDeviceLocalMemoryHeapSize);
