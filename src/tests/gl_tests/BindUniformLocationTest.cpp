...
class BindUniformLocationTest : public ANGLETest
{
  protected:
    ...
    {
        ANGLETest::SetUp();
        mBindUniformLocation = reinterpret_cast<PFNGLBINDUNIFORMLOCATIONCHROMIUMPROC>(eglGetProcAddress("glBindUniformLocationCHROMIUM"));
    }
    ...
    typedef void (GL_APIENTRYP PFNGLBINDUNIFORMLOCATIONCHROMIUMPROC) (GLuint program, GLint location,
        const GLchar* name);
