...
// Test the value of atomic counter can read while rendering.
TEST_P(AtomicCounterBufferTest31, ReadAtomicCounterWhileRendering)
{
...
// Test the value of atomic counters can be changed while computing.
TEST_P(AtomicCounterBufferTest31, ChangeAtomicCounterWhileComputing)
{
