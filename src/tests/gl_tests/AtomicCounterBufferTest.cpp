...
TEST_P(AtomicCounterBufferTest31, AtomicCounterBufferRepeatedBindUnbind)
{
    ...
    for (int32_t i = 0; i < kBufferCount; i++)
    {
        ...
        for (int32_t bufferCount = 0; bufferCount < maxAtomicCounterBuffers; bufferCount++)
        {
            ...
            uint32_t biningSlotIndex = bufferCount % kBindingSlotsSize;
            uint32_t biningSlot      = kBindingSlots[biningSlotIndex];
            uint32_t bindingPoint    = biningSlot % maxAtomicCounterBuffers;
