...
TEST_P(GetImageTestES31, Texture2DArray)
{
    ...
    std::vector<GLColor> actualPixels(expectedPixels.size(), GLColor::black);
...
TEST_P(GetImageTestES31, TextureCubeMapArray)
{
    ...
    std::vector<GLColor> expectedPixels = {
        GLColor::red,     GLColor::red,     GLColor::green,   GLColor::green,   GLColor::blue,
        GLColor::blue,    GLColor::yellow,  GLColor::yellow,  GLColor::cyan,    GLColor::cyan,
        GLColor::magenta, GLColor::magenta, GLColor::red,     GLColor::red,     GLColor::green,
        GLColor::green,   GLColor::blue,    GLColor::blue,    GLColor::yellow,  GLColor::yellow,
        GLColor::cyan,    GLColor::cyan,    GLColor::magenta, GLColor::magenta,
    };

    GLTexture tex;
    glBindTexture(GL_TEXTURE_CUBE_MAP_ARRAY, tex);
    glTexImage3D(GL_TEXTURE_CUBE_MAP_ARRAY, 0, GL_RGBA, kSize, kSize, kSize * 6, 0, GL_RGBA,
                 GL_UNSIGNED_BYTE, expectedPixels.data());
    ASSERT_GL_NO_ERROR();
