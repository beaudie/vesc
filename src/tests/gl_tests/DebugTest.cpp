...
class DebugTestES2 : public DebugTest
{};
...
TEST_P(DebugTestES2, InsertMessage)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
TEST_P(DebugTestES2, InsertMessageMultiple)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
TEST_P(DebugTestES2, DebugCallback)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
TEST_P(DebugTestES2, GetPointer)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
TEST_P(DebugTestES2, MessageControl1)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
// Test usage of message control.  Example taken from GL_KHR_debug spec.
TEST_P(DebugTestES2, MessageControl2)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
TEST_P(DebugTestES2, ObjectLabels)
{
    ANGLE_SKIP_TEST_IF(!mDebugExtensionAvailable);
...
// Test basic usage of setting and getting labels
TEST_P(DebugTestES2, ObjectPtrLabels)
{
...
ANGLE_INSTANTIATE_TEST_ES2_AND_ES3(DebugTestES2);
