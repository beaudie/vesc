...
namespace ExtraPlatform
{
// NOTE(hqle): Remove this and use ANGLE_INSTANTIATE_TEST_ES3 once Metal is fully ES3 compliant.
ANGLE_INSTANTIATE_TEST(UniformBufferTest, ES3_METAL());
}  // namespace ExtraPlatform
