...
{
// TODO(Jiajia): Figure out why this fails on Intel on Mac/Win.
// This case can pass on Intel Mac-10.11/10.12. But it fails on Intel Mac-10.10.
// This case can pass on Intel Win10. But it fails on Intel win7.
#if defined(ANGLE_PLATFORM_APPLE) || defined(ANGLE_PLATFORM_WINDOWS)
    if (IsIntel())
    {
        std::cout << "Test skipped on Intel on Mac/Win." << std::endl;
        return;
    }
#endif
