...
TEST_P(GLSLTest_ES31, ImageLoadAfterClear)
{
    ...
    glClear(GL_COLOR_BUFFER_BIT);
    // TODO: GL_SHADER_IMAGE_ACCESS_BARRIER_BIT | GL_FRAMEBUFFER_BARRIER_BIT ?
    ...
    int v            = glGetAttribLocation(program, "vertex");
    glEnableVertexAttribArray(v);
    glVertexAttribPointer(v, 2, GL_FLOAT, false, 0, vertices);
