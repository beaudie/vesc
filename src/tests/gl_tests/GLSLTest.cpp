...
void main()
{
    ...
    gl_Position.zw = vec2(0, 1);
                     ...
                     R"(#version 310 es
precision highp float;
layout(binding=0, rgba8) coherent volatile readonly highp uniform image2D img_r;
layout(binding=0, rgba8) coherent volatile writeonly highp uniform image2D img_w;
