...
// Check that imageLoad gives the correct color after clearing the texture -- anglebug.com/####
TEST_P(GLSLTest_ES31, ImageLoadAfterClear)
{
    ANGLE_GL_PROGRAM(program,
                     ...
                     void main() {
                         ...
                         fragColor = vec4(1, 0, 0, 0) + imageLoad(img, coord);
                     })");
    ...
    // Draw the texture plus red into the main framebuffer via imageLoad, and make sure the texture
