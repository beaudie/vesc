...
TEST_P(GLSLTest_ES31, RGBTextureBufferEmulation)
{
    ...
    texData[3]                 = 255;  // first texel(1) red
    texData[intOffset + 3 + 1] = 255;  // second texel(1) green
    ...
    GLuint texDataUpd[] = {0, 0, 0, 0, 0, 255};  // second texel(1) blue
    ...
    GLuint texDataUpd2[] = {0, 0, 0, 0, 255, 0};  // second texel(1) green
    void *mappedBuffer =
