...
// the function references an unrelated struct.  Regression test for AST validation applied to a
// multipass transformation, where references to decalrations were attempted to be validated without
// having the entire shader.
