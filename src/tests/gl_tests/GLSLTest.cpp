...
TEST_P(GLSLTest_ES3, NestedSamplingOperation)
{
    ...
    const std::string &nestedFragmentShader =
        ...
        "void main ()\n"
        "{\n"
        "    fragColor = texture(samplerB, texCoord + (texture(samplerA, texCoord).xy));\n"
        "}\n";
    ...
    EXPECT_PIXEL_COLOR_EQ_VEC2(ul, GLColor::red);
    EXPECT_PIXEL_COLOR_EQ_VEC2(ur, GLColor::green);
    EXPECT_PIXEL_COLOR_EQ_VEC2(ll, GLColor::blue);
    EXPECT_PIXEL_COLOR_EQ_VEC2(lr, GLColor::yellow);
}
