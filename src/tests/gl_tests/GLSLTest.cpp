...
{
    // Skipping initial failures so we can set up a passing iOS test bot. http://anglebug.com/5491
    ANGLE_SKIP_TEST_IF(IsIOS() && IsOpenGLES());
...
TEST_P(WebGL2GLSLTest, VaryingStructNotInitializedInVertexShader)
{
    ...
    // TODO(http://anglebug.com/5491): iOS thinks that the precision qualifiers don't match on the
