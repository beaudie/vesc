...
TEST_P(GLSLTest, VectorizeVectorScalarArithmeticBug)
{
    // The VectorizeVectorScalarArithmetic transformation is generating invalid code (notice how
    // sbcd references i outside the for loop.  The loop condition doesn't look right either):
    //
    //     #version 450
    //     void main(){
