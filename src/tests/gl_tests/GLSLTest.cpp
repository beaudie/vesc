...
ANGLE_INSTANTIATE_TEST_ES2_AND_ES3_AND(GLSLTest, WithGenerateSPIRVThroughGlslang(ES2_VULKAN()));

ANGLE_INSTANTIATE_TEST_ES2_AND_ES3(GLSLTestNoValidation);

GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GLSLTest_ES3);
ANGLE_INSTANTIATE_TEST_ES3_AND(GLSLTest_ES3, WithGenerateSPIRVThroughGlslang(ES3_VULKAN()));

GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GLSLTestLoops);
ANGLE_INSTANTIATE_TEST_ES3_AND(GLSLTestLoops, WithGenerateSPIRVThroughGlslang(ES3_VULKAN()));

ANGLE_INSTANTIATE_TEST_ES2_AND(WebGLGLSLTest, WithGenerateSPIRVThroughGlslang(ES2_VULKAN()));

GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(WebGL2GLSLTest);
ANGLE_INSTANTIATE_TEST_ES3_AND(WebGL2GLSLTest, WithGenerateSPIRVThroughGlslang(ES3_VULKAN()));

GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(GLSLTest_ES31);
ANGLE_INSTANTIATE_TEST_ES31_AND(GLSLTest_ES31, WithGenerateSPIRVThroughGlslang(ES31_VULKAN()));
...
ANGLE_INSTANTIATE_TEST(GLSLTest_ES31_InitShaderVariables,
                       WithForceInitShaderVariables(ES31_VULKAN()));
