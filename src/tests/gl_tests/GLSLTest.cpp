...
// Tests initializing a shader IO block with an array.
...
// Tests initializing a shader IO block with a struct.
...
// Tests initializing a shader IO block with a complicated set of types.
