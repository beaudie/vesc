...
void main()
{
    ...
    color = vec4(mi[0][0] == 0.0 ? 0 : 1,
                 mu[2][2] == 0.0 ? 0 : 1,
                 mb[1][1] == 0.0 ? 0 : 1,
                 m[0][1] == float(i) && m[1][0] == 0.0 && m[2][0] == 0.0 ? 0 : 1);
})";
...
void main()
{
    ...
    color = vec4(v2.x == 0.0 && v2.y == 0.0 ? 0 : 1,
                 v3.x == 0.0 && v3.y == 0.0 && v3.z == 0.0 ? 0 : 1,
                 v4.x == 0.0 && v4.y == 0.0 && v4.z == 0.0 && v4.w == 0.0 ? 0 : 1,
                 1);
})";
