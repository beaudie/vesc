...
//     mRenderbuffer); EXPECT_GL_FRAMEBUFFER_COMPLETE(GL_FRAMEBUFFER);
...
//     glBindFramebuffer(GL_FRAMEBUFFER, mFBO);
//     glFramebufferTexture2DMultisampleEXT(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D,
//     mTextures[0], 0, 4); EXPECT_GL_FRAMEBUFFER_COMPLETE(GL_FRAMEBUFFER);
...
//     void *mappedPtr    = glMapBufferRange(GL_PIXEL_PACK_BUFFER, 0, 6, GL_MAP_READ_BIT);
