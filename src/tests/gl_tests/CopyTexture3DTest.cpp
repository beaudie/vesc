...
TEST_P(Texture2DArrayCopy, UnsignedByteFormats55)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats52)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats15)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats51)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
TEST_P(Texture2DArrayCopy, UnsignedByteFormats1)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats62)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats332)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats22)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats21)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
