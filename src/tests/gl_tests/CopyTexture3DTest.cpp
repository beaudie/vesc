...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats2)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats3)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats4)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats5)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats6)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats7)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats8)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats9)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// snorm formats.
TEST_P(Texture2DArrayCopy, SnormFormats10)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats2)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats3)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats4)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats5)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats6)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats7)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats8)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats9)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// unsigned byte formats.
TEST_P(Texture2DArrayCopy, UnsignedByteFormats10)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats2)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats3)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats4)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats5)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats6)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats7)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats8)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats9)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
...
// Test passthrough, premultiply alpha, and unmultiply alpha copies for GL_TEXTURE_2D_ARRAY with
// float formats.
TEST_P(Texture2DArrayCopy, FloatFormats10)
{
    ANGLE_SKIP_TEST_IF(!checkExtensions());
