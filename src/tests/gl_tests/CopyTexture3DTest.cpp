...
class CopyTexture3DTest : public ANGLETest
{
  protected:
                  ...
                  const GLColor &expectedColor)
    {
        ...
        glBindTexture(testTarget, mTextures[1]);
        ...
        glBindTexture(testTarget, mTextures[0]);
        glCopyTexture3DANGLE(mTextures[1], 0, testTarget, mTextures[0], 0, destInternalFormat,
        ...
        if (renderType == GL_RGBA8)
        {
            ...
            EXPECT_GL_NO_ERROR();
            EXPECT_COLOR_NEAR(expectedColor, actual, 0.2);
            return;
        }
...
TEST_P(Texture3DCopy, CopySubTexture)
{
    ...
    glTexParameteri(GL_TEXTURE_3D, GL_TEXTURE_MAX_LEVEL, 0);
    EXPECT_GL_NO_ERROR();
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_3D, mTextures[0], 0, 0, 0, 0, 0, 0, 0, 2, 2,
                            2, false, false, false);
    glBindTexture(GL_TEXTURE_3D, mTextures[0]);
    EXPECT_GL_NO_ERROR();
    drawQuad(mProgram, "position", 0.5f);
...
TEST_P(Texture3DCopy, CopyFromMipmap)
{
    ...
    glCopyTexture3DANGLE(mTextures[1], 1, GL_TEXTURE_3D, mTextures[0], 0, GL_RGBA, GL_UNSIGNED_BYTE,
                         false, false, false);
    glBindTexture(GL_TEXTURE_3D, mTextures[0]);
    EXPECT_GL_NO_ERROR();
    drawQuad(mProgram, "position", 0.5f);
...
TEST_P(Texture3DCopy, OffsetSubCopy)
{
    ...
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_3D, mTextures[0], 0, 0, 0, 0, 1, 1, 1, 2, 2,
                            2, false, false, false);
    glBindTexture(GL_TEXTURE_3D, mTextures[0]);
    EXPECT_GL_NO_ERROR();
    ...
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_3D, mTextures[0], 0, 1, 1, 1, 0, 0, 0, 1, 1,
                            1, false, false, false);
    EXPECT_GL_NO_ERROR();
    drawQuad(mProgram, "position", 1.0f);
    EXPECT_PIXEL_COLOR_EQ(0, 0, GLColor::green);
...
TEST_P(Texture3DCopy, FlipY)
{
    ...
    glCopyTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_3D, mTextures[0], 0, GL_RGBA, GL_UNSIGNED_BYTE,
                         true, false, false);
...
TEST_P(Texture2DArrayCopy, CopySubTexture)
{
    ...
    glBindTexture(GL_TEXTURE_2D_ARRAY, mTextures[1]);
    EXPECT_GL_NO_ERROR();
    ...
    glActiveTexture(GL_TEXTURE0);
    glBindTexture(GL_TEXTURE_2D_ARRAY, mTextures[0]);
    glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_RGBA, 2, 2, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE,
                 texDataRed.data());
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
    ...
    glTexParameteri(GL_TEXTURE_2D_ARRAY, GL_TEXTURE_MAX_LEVEL, 0);
    EXPECT_GL_NO_ERROR();
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_2D_ARRAY, mTextures[0], 0, 0, 0, 0, 0, 0, 0,
...
TEST_P(Texture2DArrayCopy, CopyFromMipmap)
{
    ...
    EXPECT_GL_NO_ERROR();
    glCopyTexture3DANGLE(mTextures[1], 1, GL_TEXTURE_2D_ARRAY, mTextures[0], 0, GL_RGBA,
...
TEST_P(Texture2DArrayCopy, OffsetSubCopy)
{
    ...
    EXPECT_GL_NO_ERROR();
    // Copy the 2x2x2 green cube into a new texture
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_2D_ARRAY, mTextures[0], 0, 0, 0, 0, 1, 1, 1,
                            2, 2, 2, false, false, false);
    glBindTexture(GL_TEXTURE_2D_ARRAY, mTextures[0]);
    EXPECT_GL_NO_ERROR();
    drawQuad(mProgram, "position", 1.0f);
    ...
    // Copy the 1x1x1 blue cube into the the 2x2x2 green cube at location (1, 1, 1)
    glCopySubTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_2D_ARRAY, mTextures[0], 0, 1, 1, 1, 0, 0, 0,
...
TEST_P(Texture2DArrayCopy, FlipY)
{
    ...
    // Flip the y coordinate. This will put the greem half on top, and the red half on the bottom.
    glCopyTexture3DANGLE(mTextures[1], 0, GL_TEXTURE_2D_ARRAY, mTextures[0], 0, GL_RGBA,
