...
TEST_P(RobustResourceInitTest, CopyTexSubImage3D)
{
    ANGLE_SKIP_TEST_IF(!setup());
    ANGLE_SKIP_TEST_IF(getClientMajorVersion() < 3);
...
TEST_P(RobustResourceInitTest, Texture2DArray)
{
    ANGLE_SKIP_TEST_IF(!setup());
    ANGLE_SKIP_TEST_IF(getClientMajorVersion() < 3);
...
TEST_P(RobustResourceInitTest, CompressedSubImage)
{
    ANGLE_SKIP_TEST_IF(!setup());
    ANGLE_SKIP_TEST_IF(getClientMajorVersion() < 3);  // Needed for TexStorage
    ...
    static constexpr uint8_t img_8x8_rgb_dxt1[] = {
        0xe0, 0x07, 0x00, 0xf8, 0x11, 0x10, 0x15, 0x00, 0x1f, 0x00, 0xe0, 0xff, 0x11, 0x10, 0x15, 0x00,
        0xe0, 0x07, 0x1f, 0xf8, 0x44, 0x45, 0x40, 0x55, 0x1f, 0x00, 0xff, 0x07, 0x44, 0x45, 0x40, 0x55,
    };
