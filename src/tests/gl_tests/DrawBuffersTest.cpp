...
TEST_P(ColorMaskForDrawBuffersTest, StateChangeAffectsColorMask)
{
    ...
    // Draw with the second attachment disabled
    drawBuffers[0] = GL_COLOR_ATTACHMENT0;
...
// TODO: Add a similar test for blend state change.  See FramebufferVk::syncState calling
// updateBlendFuncsAndEquations.  This test would affect this state by disabling/enabling draw
// buffers.
