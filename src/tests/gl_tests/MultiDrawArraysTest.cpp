...
TEST_P(MultiDrawArraysTest, CanCompile)
{
...
TEST_P(MultiDrawArraysTest, MultiDrawArrays)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramNoDrawID();
    DoDrawArrays();
...
TEST_P(MultiDrawArraysTest, MultiDrawArraysDrawID)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramWithDrawID();
    DoDrawArrays();
...
TEST_P(MultiDrawArraysTest, MultiDrawElements)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramNoDrawID();
    DoDrawElements();
...
TEST_P(MultiDrawArraysTest, MultiDrawElementsDrawID)
{
    ANGLE_SKIP_TEST_IF(!requestExtension());
    SetupProgramWithDrawID();
    DoDrawElements();
