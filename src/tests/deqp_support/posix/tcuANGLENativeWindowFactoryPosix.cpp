...
#include "tcuANGLENativeWindowFactoryPosix.h"
#include "tcuTexture.hpp"

namespace tcu
{

constexpr eglu::NativeWindow::Capability kPosixWindowCapabilities =
...
{
    return new NativeWindowFactoryPosix(eventState, preRotation, kPosixWindowCapabilities);
}

NativeWindowFactoryPosix::NativeWindowFactoryPosix(
...
NativeWindow *NativeWindow::New(ANGLENativeDisplay *nativeDisplay,
                                ...
                                uint32_t preRotation)
{
    return new NativeWindowPosix(nativeDisplay, params, eventState, preRotation,
                                 kPosixWindowCapabilities);
}

NativeWindowPosix::NativeWindowPosix(ANGLENativeDisplay *nativeDisplay,
                                     const eglu::WindowParams &params,
                                     EventState *eventState,
                                     uint32_t preRotation,
                                     const eglu::NativeWindow::Capability windowCapability)
