...
const dEQPCaseList &dEQPTestSuiteData::GetCaseList(size_t testModuleIndex)
{
...
void dEQPTest::TestBody()
{
    ...
    const auto &caseInfo =
        dEQPTestSuiteData::GetCaseList(mTestModuleIndex).getCaseInfo(mTestCaseIndex);
...
void RegisterGLCTSTests()
{
    ...
    const dEQPCaseList &caseList = dEQPTestSuiteData::GetCaseList(testModuleIndex);
