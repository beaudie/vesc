...
const char *gCaseListSearchPaths[] = {
    ...
    "/../../third_party/angle/src/third_party/deqp/src/android/cts/master/",
...
void dEQPCaseList::initialize()
{
    ...
    Optional<std::string> caseListPath =
        FindFileFromPaths(gCaseListSearchPaths, ArraySize(gCaseListSearchPaths), exeDir,
                          gCaseListFiles[mTestModuleIndex]);
