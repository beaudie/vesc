...
static constexpr std::pair<const char *, gpu::GPUTestConfig::API> g_eglDisplayAPIs[] = {
...
constexpr char *g_deqpEGLString  = "--deqp-egl-display-type=";
constexpr char *g_angleEGLString = "--use-angle=";
