...
const std::string gInfoTag = "[TESTSTATS]";
...
class dEQPTest : public testing::TestWithParam<size_t>
{
  ...
  protected:
    ...
    static void PrintTestStats()
    {
        ...
        std::cout << GetTestStatLine("Total", std::to_string(sTestCount)) << std::endl;
        std::cout << GetTestStatLine("Passed", std::to_string(sPassedTestCount)) << std::endl;
        std::cout << GetTestStatLine("Failed", std::to_string(sFailedTestCount)) << std::endl;
        std::cout << GetTestStatLine("Skipped", std::to_string(sSkippedTestCount)) << std::endl;
        std::cout << GetTestStatLine("Not Supported", std::to_string(sNotSupportedTestCount))
                  << std::endl;
        std::cout << GetTestStatLine("Exception", std::to_string(sTestExceptionCount)) << std::endl;
        std::cout << GetTestStatLine("Crashed", std::to_string(crashedCount)) << std::endl;
