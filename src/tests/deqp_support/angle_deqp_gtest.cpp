...
const char *gTestExpectationsFiles[] = {
    ...
    "deqp_khr_gles31_test_expectations.txt",    "deqp_rotate_gles3_test_expectations.txt",
    "deqp_rotate_gles3_test_expectations.txt",  "deqp_rotate_gles3_test_expectations.txt",
    "deqp_rotate_gles31_test_expectations.txt", "deqp_rotate_gles31_test_expectations.txt",
    "deqp_rotate_gles31_test_expectations.txt",
};
...
#ifdef ANGLE_DEQP_ROTATE90_GLES3_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE90_GLES3, 7);
#endif

#ifdef ANGLE_DEQP_ROTATE180_GLES3_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE180_GLES3, 8);
#endif

#ifdef ANGLE_DEQP_ROTATE270_GLES3_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE270_GLES3, 9);
#endif

#ifdef ANGLE_DEQP_ROTATE90_GLES31_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE90_GLES31, 10);
#endif

#ifdef ANGLE_DEQP_ROTATE180_GLES31_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE180_GLES31, 11);
#endif

#ifdef ANGLE_DEQP_ROTATE270_GLES31_TESTS
ANGLE_INSTANTIATE_DEQP_TEST_CASE(ROTATE270_GLES31, 12);
#endif
