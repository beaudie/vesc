...
#include "android/tcuANGLENativeWindowFactoryAndroid.h"
...
//    if (mPreRotation == 90 || mPreRotation == 270)
//    {
//        // Return the original dimensions dEQP asked for.  This ensures that the dEQP code is
//        never
...
#    endif  // ANGLE_USE_WAYLAND
    ...
    m_nativeWindowRegistry.registerFactory(new NativeWindowFactoryAndroid(eventState, preRotation));
