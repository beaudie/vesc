...
def main(build_dir, verbose, use_goma, gtest_filter):
    ...
    capture_out_dir = "src/tests/capture_replay_tests"  # relative to ANGLE folder
    ...
    for test in all_tests:
        ...
        if run_output[0] == 0 and replay_file_created_keyword in run_output[1]:
            ...
            print("Skipping replay since capture didn't produce any file or has crashed")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gtest_filter', default="*/ES2_Vulkan")
