        ...
        for output_line in output_lines:
            ...
            if len(words) == 3 and words[0] == RESULT_TAG:
                ...
                if result == 0:
                    ...
                    if expected_to_pass:
                        logging.error('Initialization failure: %s' % test_name)
                    else:
                        logging.info(
                    ...
                    if expected_to_pass:
                        logging.error('Context comparison failed: %s' % test_name)
                    ...
                    logging.error("Unknown test result code: %s -> %d" % (test_name, result))
