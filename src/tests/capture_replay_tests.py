...
def main(build_dir, verbose, use_goma, gtest_filter, test_exec):
    ...
    for test in all_tests:
        ...
        if run_output[0] == 0 and CanRunReplay(capture_out_dir):
            ...
            print("Skipped: " + test.full_test_name + ". Skipping replay since capture didn't produce appropriate files or has crashed")
    for environment_var in environment_vars:
...
if __name__ == "__main__":
    ...
    main(args.build_dir, distutils.util.strtobool(args.verbose), args.use_goma, args.gtest_filter, args.test_suite)
