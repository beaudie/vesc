...
class TestBatchResult():
    ...
    def __init__(self, grouped_results, verbose):
        self.results = {}
        self.results[GroupedResult.Passed] = []
        self.results[GroupedResult.Failed] = []
        self.results[GroupedResult.TimedOut] = []
        self.results[GroupedResult.Crashed] = []
        self.results[GroupedResult.CompileFailed] = []
        self.results[GroupedResult.Skipped] = []
...
class TestBatch():
    ...
    def GetResults(self):
        return TestBatchResult(self.results, self.args.verbose).results
