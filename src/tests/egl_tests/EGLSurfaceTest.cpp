...
TEST_P(EGLSurfaceTest, ResizeWindow)
{
    ...
    // TODO(syoussefi): an issue with the X11 backend makes vkQueuePresentKHR not return
    // out-of-date, even though the dEQP test for window resize uses the same X11Window class and
    // out-of-date is generated as expected.  To be investigated.  http://anglebug.com/3122
