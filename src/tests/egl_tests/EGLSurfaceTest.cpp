...
TEST_P(EGLSingleBufferTest, OnSetSurfaceAttrib)
{
    ...
    if (eglSurfaceAttrib(mDisplay, surface, EGL_RENDER_BUFFER, EGL_SINGLE_BUFFER))
    {
        ...
        //        EXPECT_EGL_TRUE(eglQueryContext(mDisplay, context, EGL_RENDER_BUFFER,
        //        &actualRenderbuffer)); EXPECT_EGL_TRUE(actualRenderbuffer == EGL_SINGLE_BUFFER);
        ...
        //        EXPECT_EGL_TRUE(eglQueryContext(mDisplay, context, EGL_RENDER_BUFFER,
        //        &actualRenderbuffer)); EXPECT_EGL_TRUE(actualRenderbuffer == EGL_BACK_BUFFER);
