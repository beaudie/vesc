...
TEST_P(EGLSurfaceTest, deqpBug)
{
    ...
    EGLint attribs[] = {
        EGL_WIDTH, mOSWindow->getWidth(), EGL_HEIGHT, mOSWindow->getHeight(), EGL_NONE, EGL_NONE};

    EGLSurface surface = eglCreatePbufferSurface(mDisplay, mConfig, attribs);
    ASSERT_EGL_SUCCESS();
    ...
    const char kSimpleAttributeVS[] = R"(
    ...
    const char kSimpleAttributeFS[] = R"(
      varying mediump vec4 v_color;
      void main()
      {
    ...
    std::array<GLfloat, 6 * 4> positionData = {-1.0f, 1.0f,  0.5f, 1.0f, -1.0f, -1.0f, 0.5f, 1.0f,
                                               ...
                                               1.0f,  -1.0f, 0.5f, 1.0f, 1.0f,  1.0f,  0.5f, 1.0f};
    std::array<GLfloat, 6 * 4> colorData    = {0.0, 1.0, 0.0, 1.0f, 0.0, 1.0, 0.0, 1.0f,
                                               0.0, 1.0, 0.0, 1.0f, 0.0, 1.0, 0.0, 1.0f,
                                               0.0, 1.0, 0.0, 1.0f, 0.0, 1.0, 0.0, 1.0f};
