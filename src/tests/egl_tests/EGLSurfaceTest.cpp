...
TEST_P(EGLSurfaceTest, OutOfBoundsScissorWithClearShrinkWindow)
{
    initializeDisplay();
    initializeSurfaceWithDefaultConfig(false);
    initializeMainContext();
...
TEST_P(EGLSurfaceTest, OutOfBoundsScissorWithClearGrowWindow)
{
    initializeDisplay();
    initializeSurfaceWithDefaultConfig(false);
    initializeMainContext();
...
TEST_P(EGLSurfaceTest3, OutOfBoundsScissorWithClearBuffer)
{
    initializeDisplay();
    initializeSurfaceWithDefaultConfig(false);
    initializeMainContext();
