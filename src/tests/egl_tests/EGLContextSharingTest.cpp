...
// handle this in the way it expects. Only the vulkan backend has the wprkaround needed for this
// test
...
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(EGLContextSharingTestHelloNeighbor);
