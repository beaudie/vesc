...
TEST_P(EGLContextSharingTest, DisplayShareGroupObjectSharing)
{
    ...
    ASSERT_TRUE(glIsTexture(textureFromCtx0));
    ...
    ASSERT_TRUE(glIsBuffer(bufferFromCtx0));
    ...
    ASSERT_FALSE(glIsBuffer(bufferFromCtx0));
    ...
    ASSERT_GL_NO_ERROR();
    ASSERT_FALSE(glIsTexture(textureFromCtx0));
