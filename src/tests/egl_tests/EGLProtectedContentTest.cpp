...
class EGLProtectedContentTest : public ANGLETest
{
  public:
    ...
    {
        std::cout << "Start testSetup" << std::endl;
...
// Following have undefined behavior - may crash with memory violation, removed
...
{
    std::cout << "Start winTest" << std::endl;
    ANGLE_SKIP_TEST_IF(!IsEGLDisplayExtensionEnabled(mDisplay, "EGL_EXT_protected_content"));
...
{
    std::cout << "Start textureFromImageTest" << std::endl;
    ...
    std::cout << "End textureFromImageTest" << std::endl;
}
...
void EGLProtectedContentTest::textureFromAndroidNativeBufferTest(bool isProtectedContext,
                                                                 bool isProtectedTexture)
{
    std::cout << "Start textureFromANBTest" << std::endl;
    ...
    std::cout << "End textureFromANBTest" << std::endl;
}
