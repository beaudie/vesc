...
TEST_P(D3D11TextureStreamSamplingTest, RGBA)
{
    ...
    result = eglCreateStreamProducerD3DTextureNV12ANGLE(mDisplay, mStream, nullptr);
    ASSERT_EGL_TRUE(result);
    ASSERT_EGL_SUCCESS();
    ...
    result = eglStreamPostD3DTextureNV12ANGLE(mDisplay, mStream, (void *)texture, nullptr);
    ASSERT_EGL_TRUE(result);
    ASSERT_EGL_SUCCESS();
...
TEST_P(D3D11TextureStreamSamplingTest, NV12)
{
    ...
    EGLBoolean result = eglStreamConsumerGLTextureExternalAttribsNV(mDisplay, mStream,
                                                                    consumerAttributes);
    ASSERT_EGL_TRUE(result);
    ASSERT_EGL_SUCCESS();
