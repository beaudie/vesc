...
//   EGL extension EGL_ANGLE_power_preference
//
...
class EGLPowerPreferenceTestMultiDisplay : public EGLPowerPreferenceTest
{
  protected:
    ...
    void initializeWindow()
    {
        ...
        mOSWindow->initialize("EGLPowerPreferenceTestMultiDisplay", kWindowWidth, kWindowHeight);
...
TEST_P(EGLPowerPreferenceTest, SelectGPU)
{
    ANGLE_SKIP_TEST_IF(!IsEGLClientExtensionEnabled("EGL_ANGLE_power_preference"));
    ASSERT_NE(GetParam().eglParameters.powerPreference, EGL_DONT_CARE);

    bool lowPower = (GetParam().eglParameters.powerPreference == EGL_LOW_POWER_ANGLE);
    ASSERT_EQ(findGPU(lowPower), findActiveGPU());
}

TEST_P(EGLPowerPreferenceTestMultiDisplay, ReInitializePowerPreferenceLowToHigh)
{
    ANGLE_SKIP_TEST_IF(!IsEGLClientExtensionEnabled("EGL_ANGLE_power_preference"));
...
TEST_P(EGLPowerPreferenceTestMultiDisplay, ReInitializePowerPreferenceHighToLow)
{
    ANGLE_SKIP_TEST_IF(!IsEGLClientExtensionEnabled("EGL_ANGLE_power_preference"));
...
TEST_P(EGLPowerPreferenceTestMultiDisplay, MultiDisplayTest)
{
    ANGLE_SKIP_TEST_IF(!IsEGLClientExtensionEnabled("EGL_ANGLE_power_preference"));
...
ANGLE_INSTANTIATE_TEST(EGLPowerPreferenceTest,
                       WithLowPowerGPU(ES2_METAL()),
                       WithLowPowerGPU(ES3_METAL()),
                       WithHighPowerGPU(ES2_METAL()),
                       WithHighPowerGPU(ES3_METAL()));

ANGLE_INSTANTIATE_TEST(EGLPowerPreferenceTestMultiDisplay,
