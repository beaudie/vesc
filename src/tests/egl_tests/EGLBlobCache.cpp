...
TEST_P(EGLBlobCacheTest, Functional)
{
    ...
    constexpr char vertexShaderSrc[] = R"(attribute vec4 aTest;
...
void main()
{
    ...
    constexpr char fragmentShaderSrc[] = R"(precision mediump float;
varying vec4 vTest;
void main()
{
    gl_FragColor = vTest;
    ...
    constexpr char vertexShaderSrc2[] = R"(attribute vec4 aTest;
attribute vec2 aPosition;
varying vec4 vTest;
void main()
{
    ...
    constexpr char fragmentShaderSrc2[] = R"(precision mediump float;
varying vec4 vTest;
void main()
{
