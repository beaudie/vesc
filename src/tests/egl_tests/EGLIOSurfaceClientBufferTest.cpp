...
class IOSurfaceClientBufferTest : public ANGLETest<>
{
  protected:
                     ...
                     const std::array<T, dataSize> &data)
    {
        ...
        if ((internalFormat == GL_RGB || internalFormat == GL_BGR_ANGLE) && IsMac() && IsOpenGL())
        {
...
TEST_P(IOSurfaceClientBufferTest, RenderToRGBA8888IOSurface)
{
    ...
    // TODO(http://anglebug.com/8350): OpenGL doesn't support RGBA IOSurface.
...
TEST_P(IOSurfaceClientBufferTest, RenderToRGBX8888IOSurface)
{
    ...
    doClearTest(ioSurface, 1, 1, 0, GL_RGB, GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE, color);
}
...
TEST_P(IOSurfaceClientBufferTest, ReadFromRGBX8888IOSurface)
{
    ...
    GLColor color(1, 2, 3, 255);
    doSampleTest(ioSurface, 1, 1, 0, GL_RGB, GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE, &color,
                 sizeof(color), R | G | B);
}
...
TEST_P(IOSurfaceClientBufferTest, RenderToBGRX8888IOSurface)
{
    ...
    doClearTest(ioSurface, 1, 1, 0, GL_BGR_ANGLE, GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE, color);
}
...
TEST_P(IOSurfaceClientBufferTest, ReadFromBGRX8888IOSurface)
{
    ...
    doSampleTest(ioSurface, 1, 1, 0, GL_BGR_ANGLE, GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE, &color,
                 sizeof(color), R | G | B);
}
