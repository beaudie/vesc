...
TEST_P(IOSurfaceClientBufferTest, RenderToBGRA8888IOSurface) {
    ...
    const EGLint attribs[] = {
        ...
        EGL_TEXTURE_FORMAT,                GL_BGRA_EXT,
    ...
    EGLBoolean result = eglBindTexImage(mDisplay, pbuffer, EGL_BACK_BUFFER); // XXX add TEXTURE_RECTANGLE_ANGLE to spec text
