...
#define QUERY_AND_LOG_CAPABILITY_HELPER(enumValue, enumString, stream)                     \
    {                                                                                      \
        GLint result;                                                                      \
...
#define QUERY_AND_LOG_CAPABILITY(enum, stream) QUERY_AND_LOG_CAPABILITY_HELPER(enum, #enum, stream)
...
TEST_P(EGLPrintEGLinfoTest, PrintGLESCapabilitiesInfo)
{
    ...
    switch (getClientMajorVersion())
    {
        case 3:
            ...
            {
                // Fall through since the set of capabilities of a newer GLES version is a superset
                // of an older version's capabilities
                case 2:
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS,
                                             stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS,
                                             stream);
                ...
                case 1:
                    ...
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_COUNT, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_COUNT, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_COUNT, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_SIZE, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_SIZE, stream);
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_COMPUTE_WORK_GROUP_SIZE, stream);
                ...
                case 0:
                    ...
                    QUERY_AND_LOG_CAPABILITY(GL_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS,
                                             stream);
