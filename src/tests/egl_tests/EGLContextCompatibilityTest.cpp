...
class EGLContextCompatibilityTest : public testing::TestWithParam<PlatformParameters>
{
  public:
    ...
    void SetUp() override
    {
        ...
        ASSERT_TRUE(eglGetPlatformDisplayEXT != NULL);
        ...
        ASSERT_TRUE(eglInitialize(mDisplay, NULL, NULL) != EGL_FALSE);

        int nConfigs = 0;
        ASSERT_TRUE(eglGetConfigs(mDisplay, nullptr, 0, &nConfigs));
  ...
  protected:
    bool areConfigsCompatible(EGLConfig c1, EGLConfig c2, EGLint surfaceBit)
    {
        ...
        return colorBufferType1 == colorBufferType2 &&
               ...
               (surfaceType1 & surfaceType2 & surfaceBit != 0);
    }
