...
TEST_F(EGLDeviceCreationTest, BasicD3D11Device)
{
    ...
    ASSERT_TRUE(EGL_NO_DEVICE_EXT != eglDevice);
    ASSERT_EGL_SUCCESS();
...
TEST_F(EGLDeviceCreationTest, InvalidD3D11Device)
{
    ...
    EXPECT_TRUE(EGL_NO_DEVICE_EXT == eglDevice);
    EXPECT_TRUE(EGL_BAD_ATTRIBUTE == eglGetError());
}
...
TEST_F(EGLDeviceCreationTest, AnyD3D9Device)
{
    ...
    ASSERT_TRUE(EGL_NO_DEVICE_EXT == eglDevice);
    ASSERT_TRUE(EGL_BAD_ATTRIBUTE == eglGetError());
}
