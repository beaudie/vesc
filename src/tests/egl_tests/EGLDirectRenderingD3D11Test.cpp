  ...
  protected:
    ...
    void initializeEGL(bool enableDirectRendering)
    {
        ...
        EGLint displayAttribs[] = {EGL_PLATFORM_ANGLE_TYPE_ANGLE,
                                   ...
                                   EGL_PLATFORM_ANGLE_MAX_VERSION_MAJOR_ANGLE,
                                   GetParam().eglParameters.majorVersion,
                                   EGL_EXPERIMENTAL_DIRECT_RENDERING_ANGLE,
        ...
        ASSERT_EQ(EGL_TRUE, eglInitialize(mDisplay, NULL, NULL));
        ...
        ASSERT_EQ(EGL_TRUE, eglChooseConfig(mDisplay, configAttribs, &mConfig, 1, &numConfigs));
    ...
    void makeCurrent() { ASSERT_TRUE(eglMakeCurrent(mDisplay, mSurface, mSurface, mContext)); }
