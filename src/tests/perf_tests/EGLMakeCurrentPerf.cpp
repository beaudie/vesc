...
void EGLMakeCurrentPerfTest::SetUp()
{
    ...
    mContexts[0] = eglCreateContext(mDisplay, mConfig, EGL_NO_CONTEXT, NULL);
    ASSERT_NE(EGL_NO_CONTEXT, mContexts[0]);
    mContexts[1] = eglCreateContext(mDisplay, mConfig, EGL_NO_CONTEXT, NULL);
