...
class TraceBenchmark : public ANGLERenderTest, public ::testing::WithParamInterface<TracePerfParams>
{
  public:
    TraceBenchmark();
...
TraceBenchmark::TraceBenchmark()
    : ANGLERenderTest("TracePerf", GetParam()), mStartFrame(0), mEndFrame(0)
{}

void TraceBenchmark::initializeBenchmark()
{
...
void TraceBenchmark::destroyBenchmark() {}

void TraceBenchmark::drawBenchmark()
{
    startGpuTimer();
...
TEST_P(TraceBenchmark, Run)
{
    run();
}

ANGLE_INSTANTIATE_TEST(TraceBenchmark,
