...
// TODO(jmadill): Use a user data pointer to the platform methods?
Captures *g_captures;

double CapturePlatform_currentTime()
{
    return g_captures->timer->getElapsedTime();
}

void CapturePlatform_histogramCustomCounts(const char *name,
                                           int sample,
                                           int /*min*/,
                                           int /*max*/,
                                           int /*bucketCount*/)
