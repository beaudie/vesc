...
std::string ReadPixelsParams::story() const
{
    ...
    strstr << RenderTestParams::story() << (useFBO ? "_fromFBO" : "")
           << (drawBeforeRead ? "_withDraw" : "");
...
ReadPixelsParams D3D11FromFBOWithDrawParams()
{
    ReadPixelsParams params;
    params.eglParameters  = egl_platform::D3D11();
    params.drawBeforeRead = true;
...
ReadPixelsParams MetalFromFBOWithDrawParams()
{
    ReadPixelsParams params;
    params.eglParameters  = egl_platform::METAL();
    params.drawBeforeRead = true;
...
ReadPixelsParams OpenGLOrGLESFromFBOWithDrawParams()
{
    ReadPixelsParams params;
    params.eglParameters  = egl_platform::OPENGL_OR_GLES();
    params.drawBeforeRead = true;
...
ReadPixelsParams VulkanFromFBOWithDrawParams()
{
    ReadPixelsParams params;
    params.eglParameters  = egl_platform::VULKAN();
    params.drawBeforeRead = true;
...
ANGLE_INSTANTIATE_TEST(ReadPixelsBenchmark,
                       D3D11Params(),
                       D3D11WithDrawParams(),
                       D3D11FromFBOWithDrawParams(),
                       MetalParams(),
                       MetalWithDrawParams(),
                       MetalFromFBOWithDrawParams(),
                       OpenGLOrGLESParams(),
                       OpenGLOrGLESWithDrawParams(),
                       OpenGLOrGLESFromFBOWithDrawParams(),
                       VulkanParams(),
                       VulkanWithDrawParams(),
                       VulkanFromFBOWithDrawParams());
