...
class IndexDataManagerPerfTest : public ANGLEPerfTest
{
  public:
    ...
    DISALLOW_COPY_AND_ASSIGN(IndexDataManagerPerfTest);
...
void IndexDataManagerPerfTest::step(float dt, double totalTime)
{
    ...
    {
        if (!mIndexBuffer.getIndexRangeCache()->findRange(GL_UNSIGNED_SHORT, 0, mIndexCount, &translatedIndexData.indexRange, nullptr))
        {
