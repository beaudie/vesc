...
constexpr const char *kBenchmarks[] = {
    "build:use-vbo=false",
    "build:use-vbo=true",
...
class glmark2Benchmark : public testing::TestWithParam<std::tuple<PlatformParameters, size_t>>
{
  public:
    glmark2Benchmark()
    {
    ...
    void run()
    {
        ...
        const char *benchmark = kBenchmarks[std::get<1>(GetParam())];
