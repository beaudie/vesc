...
void MultiviewSideBySidePerfBenchmark::initializeBenchmark()
{
    ...
    // Setting the scissor prevents back-and-forth setting of scissor state on the backend.
    // This is an unfortunate performance pitfall - maybe it could be avoided somehow?
    glEnable(GL_SCISSOR_TEST);
    glScissor(0, 0, getWindow()->getWidth() / 2, getWindow()->getHeight());
