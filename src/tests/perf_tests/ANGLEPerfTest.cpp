...
constexpr bool kTraceEventOutputEnabled       = true;
constexpr char kTraceEventOutputFile[]        = "trace.json";
...
void ANGLERenderTest::TearDown()
{
    ...
    if (kTraceEventOutputEnabled)
    {
        DumpTraceEventsToJSONFile(mTraceEventBuffer, kTraceEventOutputFile);
    }
