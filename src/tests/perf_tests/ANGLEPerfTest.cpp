...
{
    printf("======== mName: %s, mBackend: %s, mStory: %s", mName.c_str(), mBackend.c_str(),
           mStory.c_str());
#if defined(ANGLE_PLATFORM_ANDROID)
    __android_log_print(ANDROID_LOG_INFO, "ANGLE", "mName: %s, mBackend: %s, mStory: %s",
                        mName.c_str(), mBackend.c_str(), mStory.c_str());
#endif
    if (mSkipTest)
    {
