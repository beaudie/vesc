    ...
    switch (testParams.driver)
    {
        case angle::GLESDriverType::AngleEGL:
            ...
            mEntryPointsLib.reset(
                angle::OpenSharedLibrary(ANGLE_EGL_LIBRARY_NAME, angle::SEARCH_APPLICATION_DIR));
            break;
        case angle::GLESDriverType::SystemEGL:
        ...
        case angle::GLESDriverType::SystemWGL:
            ...
            mEntryPointsLib.reset(angle::OpenSharedLibrary("opengl32", angle::SEARCH_SYSTEM_DIR));
#else
