...
struct MultiviewPerfParams final : public RenderTestParams
{
                        ...
                        ExtensionName multiviewExtensionIn)
    {
        ...
        PlatformParameters overriden;
        overriden.eglParameters = platformParametersIn;

        if (multiviewOption == MultiviewOption::InstancedMultiviewGeometryShader)
        {
            overriden = WithSelectViewInGeometryShader(overriden);
        }
        eglParameters = overriden.eglParameters;
        ;
    }
