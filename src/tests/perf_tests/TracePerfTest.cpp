                                             ...
                                             EGLint const *attrib_list)
{
    GLWindowContext newContext =
        getGLWindow()->createContext(reinterpret_cast<GLWindowContext>(share_context));
...
void TracePerfTest::onEglMakeCurrent(EGLDisplay display,
                                     ...
                                     EGLContext context)
{
    getGLWindow()->makeCurrent(reinterpret_cast<GLWindowContext>(context));
}

EGLContext TracePerfTest::onEglGetCurrentContext()
{
    return getGLWindow()->getCurrentContext();
}
