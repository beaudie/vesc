...
class TracePerfTest : public ANGLERenderTest, public ::testing::WithParamInterface<TracePerfParams>
{
  public:
    ...
    void onDrawElementsBaseVertexOES(GLenum mode,
                                     GLsizei count,
                                     GLenum type,
                                     const void *indices,
                                     GLint basevertex);
...
void KHRONOS_APIENTRY DrawElementsBaseVertexOESProc(GLenum mode,
                                                    GLsizei count,
                                                    GLenum type,
                                                    const void *indices,
                                                    GLint basevertex)
{
    gCurrentTracePerfTest->onDrawElementsBaseVertexOES(mode, count, type, indices, basevertex);
}
...
angle::GenericProc KHRONOS_APIENTRY TraceLoadProc(const char *procName)
{
    ...
    if (strcmp(procName, "glDrawElementsBaseVertexOES") == 0)
    {
        return reinterpret_cast<angle::GenericProc>(DrawElementsBaseVertexOESProc);
    }
...
void TracePerfTest::onDrawElementsBaseVertexOES(GLenum mode,
                                                GLsizei count,
                                                GLenum type,
                                                const void *indices,
                                                GLint basevertex)
