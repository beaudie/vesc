...
class TracePerfTest : public ANGLERenderTest, public ::testing::WithParamInterface<TracePerfParams>
{
  public:
    ...
    void onScissor(GLint x, GLint y, GLsizei width, GLsizei height);
    ...
    void onBlitFramebuffer(GLint srcX0,
                           GLint srcY0,
                           GLint srcX1,
                           GLint srcY1,
                           GLint dstX0,
...
void KHRONOS_APIENTRY ScissorProc(GLint x, GLint y, GLsizei width, GLsizei height)
{
    gCurrentTracePerfTest->onScissor(x, y, width, height);
}
...
void KHRONOS_APIENTRY BlitFramebufferProc(GLint srcX0,
                                          GLint srcY0,
                                          GLint srcX1,
                                          GLint srcY1,
                                          GLint dstX0,
                                          ...
                                          GLenum filter)
{
    gCurrentTracePerfTest->onBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1,
                                             mask, filter);
}

void KHRONOS_APIENTRY ReadPixelsProc(GLint x,
                                     GLint y,
                                     GLsizei width,
                                     GLsizei height,
                                     GLenum format,
                                     ...
                                     void *pixels)
{
    gCurrentTracePerfTest->onReadPixels(x, y, width, height, format, type, pixels);
}
...
angle::GenericProc KHRONOS_APIENTRY TraceLoadProc(const char *procName)
{
    ...
    {
        return reinterpret_cast<angle::GenericProc>(ScissorProc);
    }
    ...
    {
        return reinterpret_cast<angle::GenericProc>(BlitFramebufferProc);
    }
    if (strcmp(procName, "glReadPixels") == 0)
    {
        return reinterpret_cast<angle::GenericProc>(ReadPixelsProc);
    }
...
void TracePerfTest::onScissor(GLint x, GLint y, GLsizei width, GLsizei height)
{
    if (gMinimizeGPUWork)
    {
        glScissor(x, y, 1, 1);
...
void TracePerfTest::onDrawElements(GLenum mode, GLsizei count, GLenum type, const void *indices)
{
    if (gMinimizeGPUWork)
    {
        glDrawElements(mode, 3, type, indices);
    }
    else
    {
...
void TracePerfTest::onDrawElementsIndirect(GLenum mode, GLenum type, const void *indirect)
{
    if (gMinimizeGPUWork)
    {
        glDrawElementsInstancedBaseVertex(mode, 3, type, 0, 1, 0);
    }
    else
    {
                                            ...
                                            GLsizei instancecount)
{
    if (gMinimizeGPUWork)
    {
        glDrawElementsInstanced(mode, 3, type, indices, 1);
    }
    else
    {
                                             ...
                                             GLint basevertex)
{
    if (gMinimizeGPUWork)
    {
        glDrawElementsBaseVertex(mode, 3, type, indices, basevertex);
    }
    else
    {
                                                      ...
                                                      GLint basevertex)
{
    if (gMinimizeGPUWork)
    {
        glDrawElementsInstancedBaseVertex(mode, 3, type, indices, 1, basevertex);
    }
    else
    {
                                        ...
                                        const void *indices)
{
    if (gMinimizeGPUWork)
    {
        glDrawRangeElements(mode, start, end, 3, type, indices);
    }
    else
    {
                                          ...
                                          GLsizei instancecount)
{
    if (gMinimizeGPUWork)
    {
        glDrawArraysInstanced(mode, first, 3, 1);
    }
    else
    {
...
void TracePerfTest::onDrawArraysIndirect(GLenum mode, const void *indirect)
{
    if (gMinimizeGPUWork)
    {
        glDrawArraysInstanced(mode, 0, 3, 1);
    }
    else
    {
...
void TracePerfTest::onBlitFramebuffer(GLint srcX0,
                                      GLint srcY0,
                                      GLint srcX1,
                                      GLint srcY1,
                                      GLint dstX0,
                                      ...
                                      GLenum filter)
{
    if (gMinimizeGPUWork)
    {
        glBlitFramebuffer(srcX0, srcY0, srcX0 + 1, srcY0 + 1, dstX0, dstY0, dstX0 + 1, dstY0 + 1,
                          mask, filter);
    }
    else
    {
...
void TracePerfTest::onReadPixels(GLint x,
                                 GLint y,
                                 GLsizei width,
                                 GLsizei height,
                                 GLenum format,
