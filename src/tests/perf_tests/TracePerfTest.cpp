...
class TracePerfTest : public ANGLERenderTest
{
  public:
    ...
    EGLContext onCreateContext(EGLDisplay display,
                               EGLConfig config,
                               EGLContext share_context,
                               EGLint const *attrib_list);
    void onMakeCurrent(EGLDisplay display, EGLSurface draw, EGLSurface read, EGLContext context);
...
EGLContext KHRONOS_APIENTRY CreateContext(EGLDisplay display,
                                          ...
                                          EGLint const *attrib_list)
{
    return gCurrentTracePerfTest->onCreateContext(display, config, share_context, attrib_list);
}
...
void KHRONOS_APIENTRY MakeCurrent(EGLDisplay display,
                                  ...
                                  EGLContext context)
{
    gCurrentTracePerfTest->onMakeCurrent(display, draw, read, context);
}
...
EGLContext TracePerfTest::onCreateContext(EGLDisplay display,
                                          EGLConfig config,
                                          EGLContext share_context,
                                          EGLint const *attrib_list)
{
...
void TracePerfTest::onMakeCurrent(EGLDisplay display,
                                  EGLSurface draw,
                                  EGLSurface read,
                                  EGLContext context)
{
