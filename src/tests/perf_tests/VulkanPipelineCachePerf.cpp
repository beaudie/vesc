...
void VulkanPipelineCachePerfTest::step()
{
    ...
    ssm[gl::ShaderType::Vertex].get().get().setHandle(reinterpret_cast<VkShaderModule>(1ull));
    ssm[gl::ShaderType::Fragment].get().get().setHandle(reinterpret_cast<VkShaderModule>(2ull));
