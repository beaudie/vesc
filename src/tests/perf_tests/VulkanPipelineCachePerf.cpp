...
void VulkanPipelineCachePerfTest::step()
{
    ...
    for (int iteration = 0; iteration < 100; ++iteration)
    {
        ...
        {
            (void)mCache.getPipeline(VK_NULL_HANDLE, VK_NULL_HANDLE, rp, pl, am, sm, sm, hit,
                                     &result);
        }
    }
         ...
         ++missCount, ++mMissIndex)
    {
        ...
        (void)mCache.getPipeline(VK_NULL_HANDLE, VK_NULL_HANDLE, rp, pl, am, sm, sm, miss, &result);
    }
}
