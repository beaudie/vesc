...
* [`CaptureReplayPerf`](CaptureReplayPerf.cpp): Runs replays of internal captures, not available publicly. To enable, read more in [`InternalCaptureTests`](internal_captures/InternalCaptureTests.md)
