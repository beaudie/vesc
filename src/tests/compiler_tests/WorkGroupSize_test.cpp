...
TEST_F(WorkGroupSizeTest, OnlyLocalSizeXSpecified)
{
    ...
    ASSERT_EQ(mTranslator->getLocalSizeX(), 5);
    ASSERT_EQ(mTranslator->getLocalSizeY(), 1);
    ASSERT_EQ(mTranslator->getLocalSizeZ(), 1);
}
...
TEST_F(WorkGroupSizeTest, LocalSizeXandZ)
{
    ...
    ASSERT_EQ(mTranslator->getLocalSizeX(), 5);
    ASSERT_EQ(mTranslator->getLocalSizeY(), 1);
    ASSERT_EQ(mTranslator->getLocalSizeZ(), 10);
}
...
TEST_F(WorkGroupSizeTest, LocalSizeAll)
{
    ...
    ASSERT_EQ(mTranslator->getLocalSizeX(), 5);
    ASSERT_EQ(mTranslator->getLocalSizeY(), 15);
    ASSERT_EQ(mTranslator->getLocalSizeZ(), 10);
}
