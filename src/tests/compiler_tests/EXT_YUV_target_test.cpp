...
const char ESSL300_YUVQuialifierMultipleTimesShader[] =
    "precision mediump float;\n"
...
const char ESSL300_YUVQuialifierFailureShader1[] =
    "precision mediump float;\n"
    "layout(yuv) in vec4 fragColor;\n"
    "void main() { \n"
    "}\n";

const char ESSL300_YUVQuialifierFailureShader2[] =
    "precision mediump float;\n"
    "layout(yuv) uniform;\n"
...
const char ESSL300_YuvCscStandartdEXTConstructFailureShader[] =
    "precision mediump float;\n"
    "yuvCscStandardEXT conv1 = yuvCscStandardEXT();\n"
    "yuvCscStandardEXT conv2 = yuvCscStandardEXT(itu_601);\n"
    "void main() { \n"
    "}\n";

// Shader that specifies yuvCscStandartEXT type conversion fails to compile.
const char ESSL300_YuvCscStandartdEXTConversionFailureShader[] =
    "precision mediump float;\n"
    "yuvCscStandardEXT conv1 = false;\n"
    "yuvCscStandardEXT conv2 = 0;\n"
    "yuvCscStandardEXT conv3 = 1u;\n"
    "yuvCscStandardEXT conv4 = 2.0f;\n"
    "yuvCscStandardEXT conv5 = itu_601 | itu_709;\n"
    "yuvCscStandardEXT conv6 = itu_601 & itu_709 ;\n"
    "yuvCscStandardEXT conv7 = itu_601 | true;\n"
    "yuvCscStandardEXT conv8 = itu_601 & 3.0f;\n"
    "void main() { \n"
    "}\n";

// Shader that specifies yuvCscStandartEXT type qualifiers fails to compile.
const char ESSL300_YuvCscStandartdEXTQualifiersFailureShader[] =
    "precision mediump float;\n"
    "in yuvCscStandardEXT conv1 = itu_601;\n"
    "out yuvCscStandardEXT conv2 = itu_601;\n"
    "uniform yuvCscStandardEXT conv3 = itu_601;\n"
    "void main() { \n"
    "}\n";
...
INSTANTIATE_TEST_CASE_P(CorrectESSL300Shaders,
                        ...
                        Combine(Values(ESSLVersion300),
                                Values(ESSL300_FragColorShader,
                                       ESSL300_YUVQuialifierMultipleTimesShader,
...
INSTANTIATE_TEST_CASE_P(IncorrectESSL300Shaders,
                        ...
                        Combine(Values(ESSLVersion300),
                                Values(ESSL300_YUVQuialifierFailureShader1,
                                       ESSL300_YUVQuialifierFailureShader2,
                                       ...
                                       ESSL300_YuvCscStandartdEXTConstructFailureShader,
                                       ESSL300_YuvCscStandartdEXTConversionFailureShader,
                                       ESSL300_YuvCscStandartdEXTQualifiersFailureShader)));
