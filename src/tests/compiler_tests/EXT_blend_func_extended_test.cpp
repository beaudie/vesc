...
static const char ESSLVersion310[] = "#version 310 es\n";
static const char EXTBFEPragma[] = "#extension GL_EXT_blend_func_extended : require\n";

static const char ESSL100_SimpleShader1[] =
...
static const char ESSL100_ColorAndDataWriteFailureShader1[] =
        "precision mediump float;\n"
        "void main() {\n"
...
static const char ESSL100_ColorAndDataWriteFailureShader2[] =
    "precision mediump float;\n"
    "void main() {\n"
    "    gl_FragColor = vec4(1.0);\n"
    "    gl_SecondaryFragDataEXT[gl_MaxDualSourceDrawBuffersEXT] = vec4(0.1);\n"
...
static const char ESSL100_ColorAndDataWriteFailureShader3[] =
    "#extension GL_EXT_draw_buffers : require\n"
    "precision mediump float;\n"
    "void main() {\n"
    "    gl_SecondaryFragColorEXT = vec4(1.0);\n"
...
// binding functions.
static const char ESSL300_LocationAndUnspecifiedOutputShader[] =
    "precision mediump float;\n"
...
static const char ESSL300_TwoUnspecifiedLocationOutputsShader[] =
    "precision mediump float;\n"
...
static const char ESSL310_LocationIndexShader[] =
    "precision mediump float;\n"
    "layout(location = 0) out mediump vec4 fragColor;"
...
static const char ESSL310_LocationIndexFailureShader[] =
    "precision mediump float;\n"
    "layout(location = 0) out mediump vec4 fragColor;"
...
class EXTBlendFuncExtendedTest : public testing::TestWithParam<testing::tuple<ShShaderSpec, const char*, const char*>>
{
  protected:
    virtual void SetUp()
    {
    ...
    {
        DestroyCompiler();
        mCompiler = ShConstructCompiler(GL_FRAGMENT_SHADER, testing::get<0>(GetParam()), SH_GLSL_OUTPUT, &mResources);
...
{
    // Extension is required to compile properly. Expect failure.
...
{
    // Pragma is required to compile properly. Expect failure.
...
INSTANTIATE_TEST_CASE_P(
    ...
    EXTBlendFuncExtendedCompileFailureTest,
    Values(make_tuple(SH_GLES3_SPEC,
                      ESSLVersion300,
