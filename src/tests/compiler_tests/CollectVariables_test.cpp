...
// Test that gl_SecondaryFragColor built-in usage in ESSL2 fragment shader is reflected in the
...
// Test that gl_SecondaryFragData built-in usage in ESSL2 fragment shader is reflected in the
// output variables list.
