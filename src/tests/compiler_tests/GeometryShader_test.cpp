...
class GeometryShaderEXTTest : public GeometryShaderTest
{
  public:
    GeometryShaderEXTTest() {}
...
// OES_geometry_shader or EXT_geometry_shader enabled.
...
TEST_F(GeometryShaderTest, Version310WithEXTExtensionOnOES)
{
    const std::string &shaderString =
        "#version 310 es\n"
...
// Geometry Shaders are supported in GLSL ES shaders version 310 with EXT_geometry_shader enabled.
TEST_F(GeometryShaderEXTTest, Version310WithEXTExtension)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "#extension GL_EXT_geometry_shader : require\n"
...
// Geometry Shaders are supported in GLSL ES shaders version 310 with OES_geometry_shader enabled.
TEST_F(GeometryShaderEXTTest, Version310WithOESExtensionOnEXT)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "#extension GL_OES_geometry_shader : require\n"
