...
// different input primitive declarations.
...
// Geometry Shaders don't allow declaring different input primitives in a same layout.
...
// Geometry Shaders allow declaring 'invocations' == 1 in the same layout of the input primitive
// declaration.
...
// Geometry Shaders don't allow 'invocations' larger than the maximum value (32 in this test).
...
// Geometry Shaders allow 'invocations' declared in the input layout with input primitives.
...
// Geometry Shaders allow duplicated declarations of 'invocations'.
...
// Geometry Shaders don't allow multiple different declarations of 'invocations' in different
// layouts.
...
// Geometry Shaders don't allow multiple different declarations of 'invocations' in one layout.
...
// Geometry Shaders allow duplicated declaration of output primitive, but don't allow multiple
// different output primitive declarations.
...
// Geometry Shaders don't allow 'location' defined with input/output primitives.
