...
// input primitive. When the size is specified, it must match the number of vertices for
// the input primitive type; otherwise it should be a link error instead of a compilation
// error.
