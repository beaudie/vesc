...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x000001f9u, ImmutableString("texture2DLod(00I10B00B").mangledNameHash());
    ASSERT_EQ(0x000001fau, ImmutableString("texture2DProjLod(00I20B00B").mangledNameHash());
    ASSERT_EQ(0x000001fbu, ImmutableString("texture2DProjLod(00I30B00B").mangledNameHash());
    ASSERT_EQ(0x000001fcu, ImmutableString("textureCubeLod(00K20B00B").mangledNameHash());
    ...
    ASSERT_EQ(0x00000065u, ImmutableString("texture2DLod").unmangledNameHash());
    ASSERT_EQ(0x00000066u, ImmutableString("texture2DProjLod").unmangledNameHash());
    ASSERT_EQ(0x00000067u, ImmutableString("textureCubeLod").unmangledNameHash());
