...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x0000024au, ImmutableString("textureSize(00P").mangledNameHash());
    ASSERT_EQ(0x0000024bu, ImmutableString("textureSize(00V").mangledNameHash());
    ASSERT_EQ(0x0000024cu, ImmutableString("textureSize(00b").mangledNameHash());
    ASSERT_EQ(0x0000024du, ImmutableString("textureSize(00Q").mangledNameHash());
    ASSERT_EQ(0x0000024eu, ImmutableString("textureSize(00W").mangledNameHash());
    ASSERT_EQ(0x0000024fu, ImmutableString("textureSize(00c").mangledNameHash());
    ASSERT_EQ(0x00000250u, ImmutableString("textureSize(00k00D").mangledNameHash());
    ASSERT_EQ(0x00000251u, ImmutableString("textureSize(00s00D").mangledNameHash());
    ASSERT_EQ(0x00000252u, ImmutableString("textureSize(00x00D").mangledNameHash());
    ASSERT_EQ(0x00000253u, ImmutableString("textureSize(00l00D").mangledNameHash());
    ASSERT_EQ(0x00000254u, ImmutableString("textureSize(00j").mangledNameHash());
    ASSERT_EQ(0x00000255u, ImmutableString("textureSize(00r").mangledNameHash());
    ...
    ASSERT_EQ(0x0000031fu, ImmutableString("textureGather(00d10B").mangledNameHash());
    ASSERT_EQ(0x00000320u, ImmutableString("textureGather(00d10B00B").mangledNameHash());
    ASSERT_EQ(0x00000321u, ImmutableString("textureGather(00f20B").mangledNameHash());
    ASSERT_EQ(0x00000322u, ImmutableString("textureGather(00f20B00B").mangledNameHash());
    ASSERT_EQ(0x00000323u, ImmutableString("textureGather(00e20B").mangledNameHash());
    ASSERT_EQ(0x00000324u, ImmutableString("textureGather(00e20B00B").mangledNameHash());
    ASSERT_EQ(0x00000325u, ImmutableString("textureGather(00k30B").mangledNameHash());
    ASSERT_EQ(0x00000326u, ImmutableString("textureGather(00s30B").mangledNameHash());
    ASSERT_EQ(0x00000327u, ImmutableString("textureGather(00x30B").mangledNameHash());
    ASSERT_EQ(0x00000328u, ImmutableString("textureGather(00k30B00D").mangledNameHash());
    ASSERT_EQ(0x00000329u, ImmutableString("textureGather(00s30B00D").mangledNameHash());
    ASSERT_EQ(0x0000032au, ImmutableString("textureGather(00x30B00D").mangledNameHash());
    ASSERT_EQ(0x0000032bu, ImmutableString("textureGather(00l30B00B").mangledNameHash());
