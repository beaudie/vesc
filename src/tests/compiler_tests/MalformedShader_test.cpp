...
// GLSL ES 3.1 Revision 4, 4.4.1.1 Compute Shader Inputs
...
// GLSL ES 3.1 Revision 4, 4.4.1.1 Compute Shader Inputs
TEST_F(MalformedComputeShaderTest, DifferingLocalSizeMultipleInputVariables)
{
    const std::string &shaderString =
        "#version 310 es\n"
...
// GLSL ES 3.1 Revision 4, 4.4.1.1 Compute Shader Inputs
TEST_F(MalformedComputeShaderTest, SameLocalSizeMultipleInputVariables)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "layout(local_size_x = 5, local_size_y = 6) in;\n"
