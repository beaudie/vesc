...
// Shared memory cannot be combined with any other storage qualifiers.
...
// The shared memory qualifier can be only used in global scope.
...
// The shared memory qualifier cannot be used in a combination with the invariant qualifier.
...
// The shared memory qualifier cannot be used in a combination with a memory qualifier.
...
// The shared memory qualifier cannot be used in a combination with the layout qualifier.
