...
// compute shaders should have work group size specified. Based on 4.4.1.1 in GLES 3.1 spec
...
// work group size less than 1. It should be at least 1. Based on 4.4.1.1 in GLES 3.1 spec
...
// work group size is correct for 2 of the dimensions, but not for the z dimension. Based on 4.4.1.1
// in GLES 3.1 spec
...
// work group size is definitely bigger than the minimum in the x dimension. Based on 4.4.1.1 in
// GLES 3.1 spec
...
// work group size is definitely bigger than the minimum in the y dimension. Based on 4.4.1.1 in
// GLES 3.1 spec
...
// work group size is definitely bigger than the minimum in the z dimension. Based on 4.4.1.1 in
// GLES 3.1 spec
...
// multiple work group layout qualifiers with differing values. Based on 4.4.1.1 in GLES 3.1 spec
...
// invalid use of out storage qualifier in a compute shader
