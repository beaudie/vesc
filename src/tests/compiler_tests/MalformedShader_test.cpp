...
// Test that vector field selection from a value taken from an array constructor is accepted as a constant expression.
...
// Test that structure field selection from a value taken from an array constructor is accepted as a constant expression.
...
// Test that using an array constructor in a parameter to a built-in function is accepted as a constant expression.
...
// Test that using an array constructor in a parameter to a constructor is accepted as a constant expression.
