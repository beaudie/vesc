...
// A variable cannot have repeating type specifiers.
TEST_F(QualificationOrderShaderTest, RepeatingTypes)
{
    const std::string &shaderString =
        "#version 300 es\n"
        "precision mediump float;\n"
...
// A variable cannot have two different storage qualifiers.
