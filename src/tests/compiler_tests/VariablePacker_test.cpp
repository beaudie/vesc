...
TEST(VariablePacking, Struct)
{
    ...
    // Test example from GLSL ES 3.0 spec chapter 11, but in a struct
    std::vector<sh::ShaderVariable> vars;
    vars.push_back(sh::ShaderVariable(GL_STRUCT_ANGLEX, 0));

    sh::ShaderVariable &myStruct = vars[0];
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_VEC4, 0));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_MAT3, 0));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_MAT3, 0));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_VEC2, 6));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_VEC2, 4));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT_VEC2, 0));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT, 3));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT, 2));
    myStruct.fields.push_back(sh::ShaderVariable(GL_FLOAT, 0));
