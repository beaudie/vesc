...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x2731c1cu, ImmutableString("gl_Layer").hash32());
    ...
    ASSERT_EQ(0xa15fba3u, ImmutableString("bitfieldInsert(3D3D0C0C").hash32());
    ...
    ASSERT_EQ(0xf0c6701u, ImmutableString("bitfieldReverse(3D").hash32());
    ASSERT_EQ(0x3827bbd4u, ImmutableString("bitCount(0C").hash32());
    ASSERT_EQ(0x18254addu, ImmutableString("bitCount(1C").hash32());
    ASSERT_EQ(0x82bed72u, ImmutableString("bitCount(2C").hash32());
    ...
    ASSERT_EQ(0x32be593u, ImmutableString("bitCount(2D").hash32());
    ...
    ASSERT_EQ(0x296d786u, ImmutableString("findMSB(3C").hash32());
    ...
    ASSERT_EQ(0x596dc3fu, ImmutableString("findMSB(3D").hash32());
    ...
    ASSERT_EQ(0xa58432du, ImmutableString("imulExtended(2C2C2C2C").hash32());
    ...
    ASSERT_EQ(0xf61635eu, ImmutableString("textureGather(0P1B").hash32());
    ...
    ASSERT_EQ(0x47e2010u, ImmutableString("textureGather(0U1B0C").hash32());
    ...
    ASSERT_EQ(0x1a83888u, ImmutableString("textureGatherOffset(0S2B1C0C").hash32());
    ...
    ASSERT_EQ(0xb8d8d0eu, ImmutableString("atomicCounter(0F").hash32());
    ...
    ASSERT_EQ(0xfab9dd9u, ImmutableString("atomicCompSwap(0C0C0C").hash32());
    ...
    ASSERT_EQ(0xa05f04u, ImmutableString("imageLoad(0g2C").hash32());
    ...
    ASSERT_EQ(0x8583a0u, ImmutableString("imageStore(0k2C3D").hash32());
    ...
    ASSERT_EQ(0x29d3b2bu, ImmutableString("gl_MaxComputeTextureImageUnits").hash32());
    ...
    ASSERT_EQ(0x2c4bde0u, ImmutableString("gl_Position").hash32());
    ...
    ASSERT_EQ(0xc793f9bu, ImmutableString("round(0B").hash32());
    ...
    ASSERT_EQ(0x13cb578u, ImmutableString("roundEven(3B").hash32());
    ...
    ASSERT_EQ(0xfaba203u, ImmutableString("floatBitsToInt(2B").hash32());
    ASSERT_EQ(0xeda92de6u, ImmutableString("floatBitsToInt(3B").hash32());
    ASSERT_EQ(0x4a657b6u, ImmutableString("floatBitsToUint(0B").hash32());
    ...
    ASSERT_EQ(0xc15d48au, ImmutableString("intBitsToFloat(2C").hash32());
    ...
    ASSERT_EQ(0xf88eaa3u, ImmutableString("matrixCompMult(9B9B").hash32());
    ...
    ASSERT_EQ(0xc26b204u, ImmutableString("outerProduct(2B3B").hash32());
    ASSERT_EQ(0xfbc1e56fu, ImmutableString("transpose(5B").hash32());
    ASSERT_EQ(0x4cd89bbu, ImmutableString("transpose(AB").hash32());
    ...
    ASSERT_EQ(0x671c30au, ImmutableString("inverse(5B").hash32());
    ASSERT_EQ(0xf7d6756u, ImmutableString("inverse(AB").hash32());
    ...
    ASSERT_EQ(0xb5bd931u, ImmutableString("lessThan(3D3D").hash32());
    ...
    ASSERT_EQ(0xb283d1du, ImmutableString("texture(0S2B").hash32());
    ...
    ASSERT_EQ(0xd1f9db8u, ImmutableString("textureProj(0P3B").hash32());
    ASSERT_EQ(0x5fa8e2fu, ImmutableString("textureProj(0U3B").hash32());
    ...
    ASSERT_EQ(0x72c92c3u, ImmutableString("textureLod(0X2B0B").hash32());
    ...
    ASSERT_EQ(0x77c06e5u, ImmutableString("textureSize(0I0C").hash32());
    ...
    ASSERT_EQ(0x9e0f252u, ImmutableString("textureProjLod(0Q3B0B").hash32());
    ...
    ASSERT_EQ(0x233df8fu, ImmutableString("texelFetch(0V2C0C").hash32());
    ...
    ASSERT_EQ(0x17a65d7u, ImmutableString("textureGrad(0I2B2B2B").hash32());
    ...
    ASSERT_EQ(0x776d647u, ImmutableString("textureProjOffset(0U2B1C").hash32());
    ...
    ASSERT_EQ(0x1882d1au, ImmutableString("textureProjOffset(0U3B1C").hash32());
    ...
    ASSERT_EQ(0xda46ec0u, ImmutableString("texelFetchOffset(0X2C0C1C").hash32());
    ...
    ASSERT_EQ(0x98595d1u, ImmutableString("textureGradOffset(0U1B1B1B1C").hash32());
    ...
    ASSERT_EQ(0xbe139b9u, ImmutableString("textureSize(0M0C").hash32());
    ...
    ASSERT_EQ(0x42a180au, ImmutableString("texture(0U1B0B").hash32());
    ...
    ASSERT_EQ(0x2c4537au, ImmutableString("textureProj(0L3B0B").hash32());
    ...
    ASSERT_EQ(0x4c9f876u, ImmutableString("fwidth(1B").hash32());
    ...
    ASSERT_EQ(0x5cd2a61u, ImmutableString("texture2DRect(0N1B").hash32());
    ...
    ASSERT_EQ(0xcf3085au, ImmutableString("texture2DLod(0H1B0B").hash32());
    ...
    ASSERT_EQ(0x48d047eu, ImmutableString("gl_LastFragColor").hash32());
    ...
    ASSERT_EQ(0xfc88166u, ImmutableString("degrees(2B").hash32());
    ...
    ASSERT_EQ(0x5339330u, ImmutableString("acos(3B").hash32());
    ...
    ASSERT_EQ(0x548e241u, ImmutableString("atan(3B3B").hash32());
    ...
    ASSERT_EQ(0xb09eda9u, ImmutableString("log(0B").hash32());
    ...
    ASSERT_EQ(0x61a7a4fu, ImmutableString("fract(0B").hash32());
    ...
    ASSERT_EQ(0x46a9b13u, ImmutableString("mod(2B0B").hash32());
    ...
    ASSERT_EQ(0x9846a3u, ImmutableString("max(2B2B").hash32());
    ...
    ASSERT_EQ(0x887a662u, ImmutableString("distance(3B3B").hash32());
    ...
    ASSERT_EQ(0xc4b44deu, ImmutableString("refract(1B1B0B").hash32());
    ...
    ASSERT_EQ(0xf84439eu, ImmutableString("all(1E").hash32());
    ...
    ASSERT_EQ(0x81f826fu, ImmutableString("gl_MaxCombinedTextureImageUnits").hash32());
