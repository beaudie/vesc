...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x000007f2u, ImmutableString("beginInvocationInterlockARB(").mangledNameHash());
    ASSERT_EQ(0x000007f3u, ImmutableString("endInvocationInterlockARB(").mangledNameHash());
    ASSERT_EQ(0x000007f4u, ImmutableString("beginInvocationInterlockNV(").mangledNameHash());
    ASSERT_EQ(0x000007f5u, ImmutableString("endInvocationInterlockNV(").mangledNameHash());
    ASSERT_EQ(0x000007f6u, ImmutableString("beginFragmentShaderOrderingINTEL(").mangledNameHash());
    ...
    ASSERT_EQ(0x000000c1u, ImmutableString("beginInvocationInterlockARB").unmangledNameHash());
    ASSERT_EQ(0x000000c2u, ImmutableString("endInvocationInterlockARB").unmangledNameHash());
    ASSERT_EQ(0x000000c3u, ImmutableString("beginInvocationInterlockNV").unmangledNameHash());
    ASSERT_EQ(0x000000c4u, ImmutableString("endInvocationInterlockNV").unmangledNameHash());
    ASSERT_EQ(0x000000c5u, ImmutableString("beginFragmentShaderOrderingINTEL").unmangledNameHash());
