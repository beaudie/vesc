...
TEST(ImmutableStringTest, ScriptGeneratedHashesMatch)
{
    ...
    ASSERT_EQ(0x000002c9u, ImmutableString("texture(00l30B00B").mangledNameHash());
    ASSERT_EQ(0x000002cau, ImmutableString("texture(00k30B").mangledNameHash());
    ASSERT_EQ(0x000002cbu, ImmutableString("texture(00s30B").mangledNameHash());
    ASSERT_EQ(0x000002ccu, ImmutableString("texture(00x30B").mangledNameHash());
    ASSERT_EQ(0x000002cdu, ImmutableString("texture(00k30B00B").mangledNameHash());
    ASSERT_EQ(0x000002ceu, ImmutableString("texture(00s30B00B").mangledNameHash());
    ASSERT_EQ(0x000002cfu, ImmutableString("texture(00x30B00B").mangledNameHash());
    ...
    ASSERT_EQ(0x000004ccu, ImmutableString("textureGather(00O20B").mangledNameHash());
    ASSERT_EQ(0x000004cdu, ImmutableString("textureGather(00q20B").mangledNameHash());
    ASSERT_EQ(0x000004ceu, ImmutableString("textureGather(00v20B").mangledNameHash());
    ASSERT_EQ(0x000004cfu, ImmutableString("textureGather(00O20B00D").mangledNameHash());
    ASSERT_EQ(0x000004d0u, ImmutableString("textureGather(00q20B00D").mangledNameHash());
    ASSERT_EQ(0x000004d1u, ImmutableString("textureGather(00v20B00D").mangledNameHash());
    ASSERT_EQ(0x000004d2u, ImmutableString("textureGather(00d10B").mangledNameHash());
    ASSERT_EQ(0x000004d3u, ImmutableString("textureGather(00d10B00B").mangledNameHash());
    ASSERT_EQ(0x000004d4u, ImmutableString("textureGather(00f20B").mangledNameHash());
    ASSERT_EQ(0x000004d5u, ImmutableString("textureGather(00f20B00B").mangledNameHash());
    ASSERT_EQ(0x000004d6u, ImmutableString("textureGather(00e20B").mangledNameHash());
    ASSERT_EQ(0x000004d7u, ImmutableString("textureGather(00e20B00B").mangledNameHash());
    ASSERT_EQ(0x000004d8u, ImmutableString("textureGather(00l30B00B").mangledNameHash());
