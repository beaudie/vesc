...
{
  public:
    ANGLEDrawIDTest() : MatchOutputCodeTest(GL_VERTEX_SHADER, SH_VARIABLES, SH_GLSL_COMPATIBILITY_OUTPUT)
    {
...
TEST_F(ANGLEDrawIDTest, RequiresEmulation)
{
    ...
    std::string infoLog;
    bool success = compileTestShader(
        GL_VERTEX_SHADER, SH_GLES3_1_SPEC,
