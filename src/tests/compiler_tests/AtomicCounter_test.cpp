...
// Test that offset overlapping leads to compile-time error.
...
// Test that equality operators can't operate atomic counters.
TEST_F(AtomicCounterTest, InvalidEqualityComparasion)
{
    const std::string &source =
        "#version 310 es\n"
