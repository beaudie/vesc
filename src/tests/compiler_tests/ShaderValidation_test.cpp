...
// Test that gl_Layer is valid in fragment shader with GL_OES_geometry_shader.
...
// Test that gl_Layer is invalid in fragment shader without GL_OES_geometry_shader.
