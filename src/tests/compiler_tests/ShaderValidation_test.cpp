...
// Test that textureGather can be used in an ES31 shader without having the component specified.
TEST_F(FragmentShaderValidationTest, CorrectUseOfTextureGather)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "precision mediump float;\n"
        ...
        "void main()\n"
        "{\n"
        "    o_color = textureGather(tex, vec2(0));"
        "}\n";
...
// Test that textureGather can be used in an ES31 shader with having the component explicitly
// specified.
TEST_F(FragmentShaderValidationTest, CorrectUseOfTextureGatherExplicitComponent)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "precision mediump float;\n"
        ...
        "void main()\n"
        "{\n"
        "    o_color = textureGather(tex, vec2(0), 0) + \n"
        "              textureGather(tex, vec2(0), 1) + \n"
        "              textureGather(tex, vec2(0), 2) + \n"
        "              textureGather(tex, vec2(0), 3);\n"
        "}\n";
...
// Test that textureGatherOffset can be used in an ES31 shader.
TEST_F(FragmentShaderValidationTest, CorrectUseOfTextureGatherOffset)
{
    const std::string &shaderString =
        "#version 310 es\n"
        "precision mediump float;\n"
        ...
        "void main()\n"
        "{\n"
        "    o_color = textureGatherOffset(tex, vec2(0), ivec2(-1), 2);"
        "}\n";
...
// Test that shader compilation fails if the offset is too small.
