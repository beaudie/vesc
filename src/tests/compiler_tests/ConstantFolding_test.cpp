...
// Test that zero or true is not found in AST when it is not expected. This is to make sure that the
// subsequent tests run correctly.
// Note that constantFoundInAST(false) isn't a meaningful check - false is always in the AST.
