...
{
  public:
    MultiviewTranslatorVertexShaderTest()
        : MatchOutputCodeTest(GL_VERTEX_SHADER,
                              SH_PREFIX_VARYINGS_IF_MULTIVIEW_IS_ON,
                              SH_ESSL_OUTPUT)
    {
...
TEST_F(MultiviewTranslatorVertexShaderTest, VertexShaderOutputVariableNames)
{
    ...
    EXPECT_TRUE(foundInCode("webgl_angle_vert_output_myStructData"));
    EXPECT_TRUE(foundInCode("webgl_angle_vert_output_out_f"));
    EXPECT_FALSE(foundInCode("webgl_angle_vert_output_gl_Position"));
}
...
TEST_F(MultiviewTranslatorFragmentShaderTest, FragmentShaderInputVariableNames)
{
    ...
    EXPECT_TRUE(foundInCode("webgl_angle_frag_input_myStructData"));
    EXPECT_TRUE(foundInCode("webgl_angle_frag_input_out_f"));
}