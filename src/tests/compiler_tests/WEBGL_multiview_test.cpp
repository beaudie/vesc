...
class WEBGLMultiviewVertexShaderTest : public ShaderCompileTreeTest
{
  ...
  protected:
    ...
    void initResources(ShBuiltInResources *resources) override { resources->OVR_multiview = 1; }
};
...
TEST_F(WEBGLMultiviewVertexShaderTest, ValidViewIDInTernary)
{
    ...
    {
        FAIL() << "Shader compilation succeeded, expecting success:\n" << mInfoLog;
    }
}
...
// Read gl_ViewID_OVR in a OVR_multiview fragment shader.
