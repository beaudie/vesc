...
// Test that ViewID_OVR is declared in an ESSL 3.00 fragment shader and decorated as a flat input
...
// Test that ViewID_OVR is declared in an ESSL 1.00 vertex shader and decorated as a flat varying.
