...
//   Tests for constant folding that results in NaN and should also generate a warning.
//   The spec does not mandate generating NaNs, but this is reasonable behavior in this case.
//
