...
namespace {
static const char ESSLVersion100[] = "#version 100\n";
static const char ESSLVersion300[] = "#version 300 es\n";
static const char EXTFDPragma[] = "#extension GL_EXT_frag_depth : require\n";
} // namespace
...
class FragDepthTest : public testing::TestWithParam<int>
{
  protected:
    ...
    {
        DestroyCompiler();
        mCompiler = ShConstructCompiler(GL_FRAGMENT_SHADER, SH_GLES3_SPEC, SH_GLSL_OUTPUT, &mResources);
