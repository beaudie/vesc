...
// Test that comma expression referring to an uniform block instance-name as an array subscript is
// an error.
...
// Test that expressions using binary operations on an uniform block instance-name is an error.
