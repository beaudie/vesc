...
ANGLE_EXPORT void STCompileAndResolve(
    ...
    switch (type) {
        ...
        case kShaderTypeFragment: {
            initShaderVariableInfo(
                sh::GetAttributes(handle), &res->allAttributesCount, (ST_ShaderVariable**)&res->pAllAttributes);
            ...
            initShaderVariableInfo(
                ...
                &res->inputVaryingsCount, (ST_ShaderVariable**)&res->pInputVaryings);
        ...
        case kShaderTypeTessControl: {
            break;
        }
        case kShaderTypeTessEval: {
            break;
        }
        default:
