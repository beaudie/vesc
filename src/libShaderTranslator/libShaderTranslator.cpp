...
ANGLE_EXPORT ShHandle STConstructCompiler(GLenum type, ShShaderSpec spec, ShShaderOutput output, ShBuiltInResources* resources) {
    return sh::ConstructCompiler(type, spec, output, resources);
}

ANGLE_EXPORT bool STCompile(ShHandle compiler, const char *const* shaderStrings, size_t numStrings, ShCompileOptions compileOptions) {
...
ANGLE_EXPORT NameHashingMap STGetNameHashingMap(const ShHandle handle) {
...
static void copy_var(const sh::ShaderVariable& var, struct st_shader_variable* out_var) {
    ...
    if (out_var->array_sizes_count) {
        out_var->array_sizes = (unsigned int*)malloc(out_var->array_sizes_count * sizeof(unsigned int));
        memcpy(out_var->array_sizes, var.arraySizes.data(), (out_var->array_sizes_count * sizeof(unsigned int)));
    }
    ...
    if (out_var->fields_count) {
        out_var->fields = (struct st_shader_variable*)malloc(out_var->fields_count * sizeof(struct st_shader_variable));
...
static void copy_var_with_location(const sh::VariableWithLocation& var, struct st_shader_variable* out_var) {
...
static void copy_interface_block_field(const sh::InterfaceBlockField& var, struct st_shader_variable* out_var) {
    copy_var(var, out_var);
...
static void copy_interface_block(const sh::InterfaceBlock& ib, struct st_interface_block* out_ib) {
    ...
    if (out_ib->fields_count) {
        out_ib->fields = (struct st_shader_variable*)malloc(out_ib->fields_count * sizeof(struct st_shader_variable));
...
ANGLE_EXPORT void STGetUniforms(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetVaryings(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetInputVaryings(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetOutputVaryings(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetAttributes(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetOutputVariables(const ShHandle handle, int* out_count, struct st_shader_variable* out_vars) {
...
ANGLE_EXPORT void STGetInterfaceBlocks(const ShHandle handle, int* out_count, struct st_interface_block* out_ibs) {
...
ANGLE_EXPORT void STGetUniformBlocks(const ShHandle handle, int* out_count, struct st_interface_block* out_ibs) {
...
ANGLE_EXPORT void STGetShaderStorageBlocks(const ShHandle handle, int* out_count, struct st_interface_block* out_ibs) {
...
ANGLE_EXPORT void STGetComputeShaderLocalGroupSize(const ShHandle handle, int* out_count, struct st_work_group_size* out_wg) {
