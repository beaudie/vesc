                        ...
                        [
                            {
                                ...
                                'action': ['cmd /C "echo|set /p=#define COMMIT_HASH > common/commit.h & git --version > NUL 2>&1 && (git rev-parse --short=12 HEAD >> common/commit.h) || (echo badf00dbad00 >> common/commit.h)" > NUL'],
                            }
                        ] #actions
                    }
                ] # targets
