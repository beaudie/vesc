...
// CL 1.1
cl_mem CL_API_ENTRY CL_CreateSubBuffer(cl_mem buffer,
                                       cl_mem_flags flags,
...
cl_event CL_API_ENTRY CL_CreateUserEvent(cl_context context, cl_int *errcode_ret)
{
...
cl_int CL_API_ENTRY CL_SetUserEventStatus(cl_event event, cl_int execution_status)
{
...
cl_int CL_API_ENTRY CL_SetEventCallback(cl_event event,
...
cl_int CL_API_ENTRY CL_EnqueueReadBufferRect(cl_command_queue command_queue,
                                             cl_mem buffer,
                                             cl_bool blocking_read,
...
cl_int CL_API_ENTRY CL_EnqueueWriteBufferRect(cl_command_queue command_queue,
                                              cl_mem buffer,
                                              cl_bool blocking_write,
                                              const size_t *buffer_origin,
                                              const size_t *host_origin,
...
cl_int CL_API_ENTRY CL_EnqueueCopyBufferRect(cl_command_queue command_queue,
                                             cl_mem src_buffer,
                                             cl_mem dst_buffer,
                                             const size_t *src_origin,
                                             const size_t *dst_origin,
...
// CL 1.2
cl_int CL_API_ENTRY CL_CreateSubDevices(cl_device_id in_device,
...
cl_int CL_API_ENTRY CL_RetainDevice(cl_device_id device)
{
...
cl_int CL_API_ENTRY CL_ReleaseDevice(cl_device_id device)
{
...
cl_mem CL_API_ENTRY CL_CreateImage(cl_context context,
                                   cl_mem_flags flags,
                                   const cl_image_format *image_format,
...
cl_program CL_API_ENTRY CL_CreateProgramWithBuiltInKernels(cl_context context,
                                                           cl_uint num_devices,
                                                           const cl_device_id *device_list,
...
cl_int CL_API_ENTRY CL_CompileProgram(cl_program program,
                                      cl_uint num_devices,
                                      const cl_device_id *device_list,
                                      const char *options,
...
cl_program CL_API_ENTRY CL_LinkProgram(cl_context context,
                                       cl_uint num_devices,
                                       const cl_device_id *device_list,
                                       const char *options,
...
cl_int CL_API_ENTRY CL_UnloadPlatformCompiler(cl_platform_id platform)
{
...
cl_int CL_API_ENTRY CL_GetKernelArgInfo(cl_kernel kernel,
                                        cl_uint arg_index,
...
cl_int CL_API_ENTRY CL_EnqueueFillBuffer(cl_command_queue command_queue,
                                         cl_mem buffer,
                                         const void *pattern,
                                         size_t pattern_size,
                                         size_t offset,
...
cl_int CL_API_ENTRY CL_EnqueueFillImage(cl_command_queue command_queue,
                                        cl_mem image,
...
cl_int CL_API_ENTRY CL_EnqueueMigrateMemObjects(cl_command_queue command_queue,
                                                cl_uint num_mem_objects,
...
cl_int CL_API_ENTRY CL_EnqueueMarkerWithWaitList(cl_command_queue command_queue,
                                                 cl_uint num_events_in_wait_list,
                                                 const cl_event *event_wait_list,
                                                 cl_event *event)
{
...
cl_int CL_API_ENTRY CL_EnqueueBarrierWithWaitList(cl_command_queue command_queue,
                                                  cl_uint num_events_in_wait_list,
                                                  const cl_event *event_wait_list,
                                                  cl_event *event)
{
...
void *CL_API_ENTRY CL_GetExtensionFunctionAddressForPlatform(cl_platform_id platform,
...
cl_mem CL_API_ENTRY CL_CreatePipe(cl_context context,
                                  cl_mem_flags flags,
...
cl_int CL_API_ENTRY CL_GetPipeInfo(cl_mem pipe,
...
void *CL_API_ENTRY CL_SVMAlloc(cl_context context,
...
void CL_API_ENTRY CL_SVMFree(cl_context context, void *svm_pointer)
{
...
cl_int CL_API_ENTRY CL_SetKernelArgSVMPointer(cl_kernel kernel,
                                              cl_uint arg_index,
                                              const void *arg_value)
{
...
cl_int CL_API_ENTRY CL_SetKernelExecInfo(cl_kernel kernel,
...
cl_int CL_API_ENTRY CL_EnqueueSVMFree(cl_command_queue command_queue,
...
cl_int CL_API_ENTRY CL_EnqueueSVMMemcpy(cl_command_queue command_queue,
...
cl_int CL_API_ENTRY CL_EnqueueSVMMemFill(cl_command_queue command_queue,
                                         void *svm_ptr,
                                         const void *pattern,
                                         size_t pattern_size,
                                         size_t size,
...
cl_int CL_API_ENTRY CL_EnqueueSVMMap(cl_command_queue command_queue,
                                     cl_bool blocking_map,
                                     cl_map_flags flags,
                                     void *svm_ptr,
                                     size_t size,
...
cl_int CL_API_ENTRY CL_EnqueueSVMUnmap(cl_command_queue command_queue,
                                       void *svm_ptr,
                                       cl_uint num_events_in_wait_list,
                                       const cl_event *event_wait_list,
                                       cl_event *event)
...
// CL 2.1
cl_int CL_API_ENTRY CL_SetDefaultDeviceCommandQueue(cl_context context,
                                                    cl_device_id device,
...
cl_int CL_API_ENTRY CL_GetDeviceAndHostTimer(cl_device_id device,
...
cl_int CL_API_ENTRY CL_GetHostTimer(cl_device_id device, cl_ulong *host_timestamp)
{
...
cl_program CL_API_ENTRY CL_CreateProgramWithIL(cl_context context,
                                               const void *il,
                                               size_t length,
                                               cl_int *errcode_ret)
{
...
cl_kernel CL_API_ENTRY CL_CloneKernel(cl_kernel source_kernel, cl_int *errcode_ret)
{
...
cl_int CL_API_ENTRY CL_GetKernelSubGroupInfo(cl_kernel kernel,
                                             cl_device_id device,
...
cl_int CL_API_ENTRY CL_EnqueueSVMMigrateMem(cl_command_queue command_queue,
                                            cl_uint num_svm_pointers,
...
// CL 2.2
cl_int CL_API_ENTRY CL_SetProgramReleaseCallback(cl_program program,
                                                 void(CL_CALLBACK *pfn_notify)(cl_program program,
                                                                               void *user_data),
                                                 void *user_data)
{
...
cl_int CL_API_ENTRY CL_SetProgramSpecializationConstant(cl_program program,
                                                        cl_uint spec_id,
                                                        size_t spec_size,
...
cl_mem CL_API_ENTRY CL_CreateBufferWithProperties(cl_context context,
...
cl_mem CL_API_ENTRY CL_CreateImageWithProperties(cl_context context,
                                                 const cl_mem_properties *properties,
                                                 cl_mem_flags flags,
                                                 const cl_image_format *image_format,
                                                 const cl_image_desc *image_desc,
