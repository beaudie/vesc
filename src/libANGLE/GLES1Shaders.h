...
uniform vec4 xyzwNdc;
uniform vec4 texuvwhCrop;
uniform vec4 texNdcDims;

void main() {
    vec3 pos;
    vec2 texcoord;

    float xNdc = xyzwNdc[0];
    float yNdc = xyzwNdc[1];
    float zNdc = xyzwNdc[2];

    float texCropU = texuvwhCrop[0];
    float texCropV = texuvwhCrop[1];
    float texCropW = texuvwhCrop[2];
    float texCropH = texuvwhCrop[3];

    float texW = texNdcDims[0];
    float texH = texNdcDims[1];
    float wNdc = texNdcDims[2];
    float hNdc = texNdcDims[3];
    ...
    case 3:
        ...
        pos.y = yNdc;
        pos.z = zNdc;
        texcoord.x = texCropU / texW;
        texcoord.y = texCropV / texH;
        break;
    ...
    case 1:
        ...
        pos.y = yNdc;
        pos.z = zNdc;
        texcoord.x = (texCropU + texCropW) / texW;
        texcoord.y = texCropV / texH;
        break;
    ...
    case 4:
        ...
        pos.z = zNdc;
        texcoord.x = (texCropU + texCropW) / texW;
        texcoord.y = (texCropV + texCropH) / texH;
        break;
