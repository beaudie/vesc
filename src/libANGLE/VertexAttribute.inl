...
{
    memset(&Values, 0, sizeof(((VertexAttribCurrentValueData*)0)->Values));
}
...
{
    return (a.Type == b.Type && memcmp(&a.Values, &b.Values, sizeof(((VertexAttribCurrentValueData*)0)->Values)) == 0);
}
