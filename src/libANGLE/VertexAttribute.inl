...
inline bool SameVertexAttribFormat(const VertexAttribute &a, const VertexAttribute &b)
{
...
inline bool SameBindingStrideAndOffset(const VertexBinding &a, const VertexBinding &b)
{
    return a.stride == b.stride && a.offset == b.offset;
}

inline bool UseClientMemoryPointer(const VertexBinding &binding)
{
    return binding.buffer.get() == nullptr;
}

inline bool IsVertexAttribPointerValid(size_t attribIndex, const VertexAttribute &a)
{
    return attribIndex == a.bindingIndex && a.relativeOffset == 0;
}
