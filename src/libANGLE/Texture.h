                      ...
                      public LabeledObject
{
  public:
    ...
    size_t getChannelBaseType(GLenum target, size_t level, GLenum pname) const;
    size_t getChannelSize(GLenum target, size_t level, GLenum pname) const;
    size_t getInternalFormat(GLenum target, size_t level) const;
