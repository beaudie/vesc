...
class Texture final : public AttachableObject
{
  public:
    ...
    GLsizei getAttachmentWidth(const gl::AttachmentSubResource &subResource) const override;
    GLsizei getAttachmentHeight(const gl::AttachmentSubResource &subResource) const override;
