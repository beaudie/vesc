...
class Texture final : public RenderableObject
{
  public:
    ...
    GLsizei getAttachmentWidth(const gl::FramebufferAttachment::Target &target) const override;
    GLsizei getAttachmentHeight(const gl::FramebufferAttachment::Target &target) const override;
