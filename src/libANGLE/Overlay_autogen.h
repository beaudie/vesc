...
enum class WidgetId
{
    ...
    // Hash key collision rate of vulkan texture descriptor cache tables
    VulkanTextureDescriptorCacheHashKeyCollisionRate,
...
#define ANGLE_WIDGET_ID_X(PROC)                 \
    ...
    PROC(VulkanTextureDescriptorCacheHashKeyCollisionRate)
