...
enum class WidgetId
{
    ...
    // Percentage of active Vulkan Texture Descriptor Cache in every 30 seconds
    VulkanTextureDescriptorActiveCacheRatio,
...
#define ANGLE_WIDGET_ID_X(PROC)                 \
    ...
    PROC(VulkanTextureDescriptorActiveCacheRatio)
