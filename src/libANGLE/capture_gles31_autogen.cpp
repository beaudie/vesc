...
//
// capture_gles31_autogen.cpp:
//   Capture functions for the OpenGL ES 3.1 entry points.

#include "libANGLE/capture_gles31_autogen.h"
...
void CaptureActiveShaderProgram(Context *context, GLuint pipeline, GLuint program)
{
    ...
    ParamBuffer paramBuffer("glActiveShaderProgram");
                             ...
                             GLenum format)
{
    ...
    ParamBuffer paramBuffer("glBindImageTexture");
...
void CaptureBindProgramPipeline(Context *context, GLuint pipeline)
{
    ...
    ParamBuffer paramBuffer("glBindProgramPipeline");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
                             ...
                             GLsizei stride)
{
    ...
    ParamBuffer paramBuffer("glBindVertexBuffer");
                                 ...
                                 const GLchar *const *strings)
{
    ...
    ParamBuffer paramBuffer("glCreateShaderProgramv");
...
void CaptureDeleteProgramPipelines(Context *context, GLsizei n, const GLuint *pipelines)
{
    ...
    ParamBuffer paramBuffer("glDeleteProgramPipelines");
                            ...
                            GLuint num_groups_z)
{
    ...
    ParamBuffer paramBuffer("glDispatchCompute");
...
void CaptureDispatchComputeIndirect(Context *context, GLintptr indirect)
{
    ...
    ParamBuffer paramBuffer("glDispatchComputeIndirect");
...
void CaptureDrawArraysIndirect(Context *context, PrimitiveMode modePacked, const void *indirect)
{
    ...
    ParamBuffer paramBuffer("glDrawArraysIndirect");
                                 ...
                                 const void *indirect)
{
    ...
    ParamBuffer paramBuffer("glDrawElementsIndirect");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
...
void CaptureFramebufferParameteri(Context *context, GLenum target, GLenum pname, GLint param)
{
    ...
    ParamBuffer paramBuffer("glFramebufferParameteri");
...
void CaptureGenProgramPipelines(Context *context, GLsizei n, GLuint *pipelines)
{
    ...
    ParamBuffer paramBuffer("glGenProgramPipelines");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGetBooleani_v(Context *context, GLenum target, GLuint index, GLboolean *data)
{
    ...
    ParamBuffer paramBuffer("glGetBooleani_v");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
...
void CaptureGetFramebufferParameteriv(Context *context, GLenum target, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetFramebufferParameteriv");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetMultisamplefv(Context *context, GLenum pname, GLuint index, GLfloat *val)
{
    ...
    ParamBuffer paramBuffer("glGetMultisamplefv");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
                                  ...
                                  GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetProgramInterfaceiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                      ...
                                      GLchar *infoLog)
{
    ...
    ParamBuffer paramBuffer("glGetProgramPipelineInfoLog");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
...
void CaptureGetProgramPipelineiv(Context *context, GLuint pipeline, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetProgramPipelineiv");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                    ...
                                    const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glGetProgramResourceIndex");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("programInterface", ParamType::TGLenum, programInterface);
                                       ...
                                       const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glGetProgramResourceLocation");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("programInterface", ParamType::TGLenum, programInterface);
                                   ...
                                   GLchar *name)
{
    ...
    bool isCallValid = ValidateGetProgramResourceName(context, program, programInterface, index,
                                                      bufSize, length, name);
    ParamBuffer paramBuffer("glGetProgramResourceName");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("programInterface", ParamType::TGLenum, programInterface);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                 ...
                                 GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetProgramResourceiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("programInterface", ParamType::TGLenum, programInterface);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
                                   ...
                                   GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexLevelParameterfv");
                                   ...
                                   GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexLevelParameteriv");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureIsProgramPipeline(Context *context, GLuint pipeline)
{
    ...
    ParamBuffer paramBuffer("glIsProgramPipeline");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
...
void CaptureMemoryBarrier(Context *context, GLbitfield barriers)
{
    ...
    ParamBuffer paramBuffer("glMemoryBarrier");
...
void CaptureMemoryBarrierByRegion(Context *context, GLbitfield barriers)
{
    ...
    ParamBuffer paramBuffer("glMemoryBarrierByRegion");
    paramBuffer.addValueParam("barriers", ParamType::TGLbitfield, barriers);
...
void CaptureProgramUniform1f(Context *context, GLuint program, GLint location, GLfloat v0)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1f");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                              ...
                              const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
...
void CaptureProgramUniform1i(Context *context, GLuint program, GLint location, GLint v0)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1i");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
                              ...
                              const GLint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1iv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
...
void CaptureProgramUniform1ui(Context *context, GLuint program, GLint location, GLuint v0)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1ui");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
                               ...
                               const GLuint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform1uiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                             ...
                             GLfloat v1)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2f");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLfloat, v0);
                              ...
                              const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
...
void CaptureProgramUniform2i(Context *context, GLuint program, GLint location, GLint v0, GLint v1)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2i");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLint, v0);
                              ...
                              const GLint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2iv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                              ...
                              GLuint v1)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2ui");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLuint, v0);
                               ...
                               const GLuint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform2uiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                             ...
                             GLfloat v2)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3f");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLfloat, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLfloat, v1);
                              ...
                              const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                             ...
                             GLint v2)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3i");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLint, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLint, v1);
                              ...
                              const GLint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3iv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                              ...
                              GLuint v2)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3ui");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLuint, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLuint, v1);
                               ...
                               const GLuint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform3uiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                             ...
                             GLfloat v3)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4f");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLfloat, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLfloat, v1);
                              ...
                              const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                             ...
                             GLint v3)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4i");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLint, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLint, v1);
                              ...
                              const GLint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4iv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                              ...
                              GLuint v3)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4ui");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("v0", ParamType::TGLuint, v0);
    paramBuffer.addValueParam("v1", ParamType::TGLuint, v1);
                               ...
                               const GLuint *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniform4uiv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                                    ...
                                    const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix2fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix2x3fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix2x4fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                    ...
                                    const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix3fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix3x2fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix3x4fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                    ...
                                    const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix4fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix4x2fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
                                      ...
                                      const GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glProgramUniformMatrix4x3fv");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("transpose", ParamType::TGLboolean, transpose);
...
void CaptureSampleMaski(Context *context, GLuint maskNumber, GLbitfield mask)
{
    ...
    ParamBuffer paramBuffer("glSampleMaski");
                                    ...
                                    GLboolean fixedsamplelocations)
{
    ...
    ParamBuffer paramBuffer("glTexStorage2DMultisample");
...
void CaptureUseProgramStages(Context *context, GLuint pipeline, GLbitfield stages, GLuint program)
{
    ...
    ParamBuffer paramBuffer("glUseProgramStages");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
...
void CaptureValidateProgramPipeline(Context *context, GLuint pipeline)
{
    ...
    ParamBuffer paramBuffer("glValidateProgramPipeline");
    paramBuffer.addValueParam("pipeline", ParamType::TGLuint, pipeline);
...
void CaptureVertexAttribBinding(Context *context, GLuint attribindex, GLuint bindingindex)
{
    ...
    ParamBuffer paramBuffer("glVertexAttribBinding");
                               ...
                               GLuint relativeoffset)
{
    ...
    ParamBuffer paramBuffer("glVertexAttribFormat");
    paramBuffer.addValueParam("attribindex", ParamType::TGLuint, attribindex);
                                ...
                                GLuint relativeoffset)
{
    ...
    ParamBuffer paramBuffer("glVertexAttribIFormat");
    paramBuffer.addValueParam("attribindex", ParamType::TGLuint, attribindex);
    paramBuffer.addValueParam("size", ParamType::TGLint, size);
    paramBuffer.addValueParam("typePacked", ParamType::TVertexAttribType, typePacked);
    paramBuffer.addValueParam("relativeoffset", ParamType::TGLuint, relativeoffset);
...
void CaptureVertexBindingDivisor(Context *context, GLuint bindingindex, GLuint divisor)
{
    ...
    ParamBuffer paramBuffer("glVertexBindingDivisor");
    paramBuffer.addValueParam("bindingindex", ParamType::TGLuint, bindingindex);
