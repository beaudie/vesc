                                                ...
                                                GLenum shaderType) const
{
    ...
    // block.
    size_t firstBlockUniformIndex = getCurrentBlockMemberIndex();
    ...
    size_t lastBlockUniformIndex = getCurrentBlockMemberIndex();
    ...
    for (unsigned int arrayElement = 0; arrayElement < interfaceBlock.elementCount();
         ++arrayElement)
    {
        // TODO(jiajia.qin@intel.com): ShaderStorageBlock implementation for getBlockSize.
