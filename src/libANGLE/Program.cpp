...
angle::Result Program::linkImpl(const Context *context)
{
    ...
    {
        resources.init(0, PackMode::ANGLE_RELAXED, &mState.mExecutable->mUniformBlocks,
    ...
    else
    {
        ...
        resources.init(static_cast<GLuint>(data.getCaps().maxVaryingVectors), packMode,
    ...
    mState.mExecutable->mLinkedVaryingPacking = std::move(resources.varyingPacking);
