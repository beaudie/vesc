...
Error Program::link(const gl::Context *context)
{
    ...
    if (computeShader)
    {
        ...
        LinkedResources resources = {{0, PackMode::ANGLE_RELAXED},
                                     {&mState.mUniformBlocks, &mState.mUniforms},
                                     {&mState.mShaderStorageBlocks, nullptr}};
    ...
    else
    {
        ...
        LinkedResources resources = {{data.getCaps().maxVaryingVectors, packMode},
                                     {&mState.mUniformBlocks, &mState.mUniforms},
                                     {&mState.mShaderStorageBlocks, nullptr}};
...
{
    ShaderStorageBlockLinker blockLinker(&mState.mShaderStorageBlocks, nullptr);
