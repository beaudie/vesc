...
bool Program::linkValidateGlobalNames(InfoLog &infoLog) const
{
    ...
    std::unordered_map<
        std::string,
        std::vector<std::pair<const sh::InterfaceBlock *, const sh::InterfaceBlockField *> *>>
            ...
            for (const auto &field : uniformBlock.fields)
            {
                if (!uniformBlockFieldMap.count(field.name))
                {
                    ...
                    std::pair<const sh::InterfaceBlock *, const sh::InterfaceBlockField *>
                        blockAndFieldPair(&uniformBlock, &field);
                    std::vector<
                        std::pair<const sh::InterfaceBlock *, const sh::InterfaceBlockField *> *>
                        newUniformBlockList;
                ...
                std::vector<
                    std::pair<const sh::InterfaceBlock *, const sh::InterfaceBlockField *> *>
                    prevBlockFieldPairs = uniformBlockFieldMap[field.name];
