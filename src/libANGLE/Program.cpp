...
bool Program::linkVaryings(const Context *context, InfoLog &infoLog) const
{
    ...
    if (geometryShader)
    {
        return linkValidateShaderInterfaceMatching(context, vertexShader, geometryShader,
                                                   infoLog) &&
               linkValidateShaderInterfaceMatching(context, geometryShader, fragmentShader,
                                                   infoLog);
    }
    else
    {
        return linkValidateShaderInterfaceMatching(context, vertexShader, fragmentShader, infoLog);
    }
}
