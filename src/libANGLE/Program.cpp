...
void Program::copyResourceName(const std::string name,
                               GLsizei bufSize,
                               GLsizei *length,
                               GLchar *dest) const
{
...
void Program::copyInputResourceName(GLuint index,
                                    GLsizei bufSize,
                                    GLsizei *length,
                                    GLchar *name) const
{
    ASSERT(mLinkResolved);
    copyResourceName(getInputResourceName(index), bufSize, length, name);
}

void Program::copyOutputResourceName(GLuint index,
                                     GLsizei bufSize,
                                     GLsizei *length,
                                     GLchar *name) const
{
    ...
    copyResourceName(mState.mOutputVariables[index].name, bufSize, length, name);
}

void Program::copyUniformResourceName(GLuint index,
                                      GLsizei bufSize,
                                      GLsizei *length,
                                      GLchar *name) const
{
    ...
    copyResourceName(mState.mUniforms[index].name, bufSize, length, name);
}

void Program::copyBufferVariableResourceName(GLuint index,
                                             GLsizei bufSize,
                                             GLsizei *length,
                                             GLchar *name) const
{
    ...
    copyResourceName(mState.mBufferVariables[index].name, bufSize, length, name);
}
