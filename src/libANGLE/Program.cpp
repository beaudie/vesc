...
{
    getUniformInternal(location, reinterpret_cast<uint8_t *>(v));
}
...
void Program::getUniformInternal(GLint location, uint8_t *dataOut) const
{
    ...
    size_t elementSize = uniform.getElementSize();
    memcpy(dataOut, srcPointer, elementSize);
}
}
