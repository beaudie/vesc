...
void Program::setUniformInternal(GLint location, GLsizei count, const T *v)
{
    ...
    // element index used, as reported byGetActiveUniform, will be ignored by the GL."
    unsigned int elementCount = linkedUniform->elementCount();
    GLsizei clampedCount =
        std::min(count, static_cast<GLsizei>(elementCount - locationInfo.element));
