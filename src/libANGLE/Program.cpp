...
bool Program::linkValidateShaders(const Context *context, InfoLog &infoLog)
{
    ...
    else
    {
        ...
        if (geometryShader)
        {
            // [GL_EXT_geometry_shader] Chapter 7.3
            // Linking can fail for a variety of reasons as specified in the OpenGL ES Shading
            // Language Specification, as well as any of the following reasons: * One or more of the
            // shader objects attached to <program> are not compiled successfully. * The shaders do
            // not use the same shader language version. * <program> contains objects to form a
            // geometry shader, and
