...
void Program::detachShader(const Context *context, Shader *shader)
{
    ...
    // Don't actually detach the shader yet, since we may need to
    // relink the varyings at draw time if this Program is in a Program Pipeline Object
    // TODO(timvp): http://anglebug.com/3570: Is there a better way?
}
