                                 ...
                                 GLsizei *length)
{
    ...
    if (binary)
    {
        ...
        // release the memory.  Note that implicit caching to blob cache is always done before the
        // application retrieves the memory, so that also won't need the binary _after_ this
        // operation.
        mBinary.clear();
    }
