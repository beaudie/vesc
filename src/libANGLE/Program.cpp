...
ProgramInput::ProgramInput(const sh::ShaderVariable &var)
{
    ...
    basicDataTypeStruct.type                         = var.type;
    basicDataTypeStruct.location                     = var.hasImplicitLocation ? -1 : var.location;
    basicDataTypeStruct.interpolation                = var.interpolation;
    basicDataTypeStruct.flagBitsAsUInt16             = 0;
    ...
    basicDataTypeStruct.basicTypeElementCount        = var.getBasicTypeElementCount();
    basicDataTypeStruct.id                           = var.id;
    basicDataTypeStruct.arraySizeProduct             = var.getArraySizeProduct();
}
