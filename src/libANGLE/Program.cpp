...
bool Program::linkInterfaceBlocks(const Context *context, InfoLog &infoLog)
{
    ...
    if (!validateVertexAndFragmentInterfaceBlocks(vertexShader.getInterfaceBlocks(context),
                                                  fragmentShader.getInterfaceBlocks(context),
                                         ...
                                         bool webglCompatibility) const
{
    ...
    if (vertexInterfaceBlock.blockType != fragmentInterfaceBlock.blockType)
    {
        infoLog << "Block type differ for interface block '" << blockName
                << "' between vertex and fragment shaders";
        return false;
    }
