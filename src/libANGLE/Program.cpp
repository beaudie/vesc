...
bool Program::linkValidateBuiltInVaryings(InfoLog &infoLog) const
{
    ...
    {
        if (glPositionIsInvariant != glFragCoordIsInvariant)
        {
            infoLog << "Invariance differs for gl_Position and gl_FragCoord.";
            return false;
        }
        if (glPointSizeIsInvariant != glPointCoordIsInvariant)
        {
            infoLog << "Invariance differs for gl_PointSize and gl_PointCoord.";
            return false;
        }
