                                  ...
                                  GLuint combinedShaderStorageBlocksCount)
{
    ...
    // Kimmo's interpretation of the GL_EXT_blend_func_extended spec which is implemented here:
    //
    // I don't think the EXT_blend_func_extended specifies anything related to binding specific
    // elements of an output array in explicit terms.
    //
    ...
    // must infer the only possible interpretation (?). Note again: this need of interpretation is
    // my own interpretation of the logic, and it might be completely off of what GL spec logic is.
    //
