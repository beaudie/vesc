                           ...
                           InfoLog &infoLog)
{
    ...
    {
        mState.mExecutable->addShaderUniforms(shader->getType(), shader->getUniforms());
    }

    if (!mState.mExecutable->linkUniforms(context->getCaps(), context->getClientVersion(), infoLog,
                                          mState.mUniformLocationBindings, combinedImageUniformsOut,
                                          unusedUniformsOut, &mState.mUniformLocations))
    {
        return false;
    }
