...
GLuint getActiveResourceIndex(const std::vector<VarT> &list, const std::string &name)
{
...
{
    return getActiveResourceIndex(mUniforms, name);
}
...
{
    return getActiveResourceIndex(mState.mOutputVariables, std::string(name));
}
