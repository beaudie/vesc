...
bool ValidateProgramUniform1i(Context *context, ProgramID program, GLint location, GLint v0)
{
...
bool ValidateProgramUniform1ui(Context *context, ProgramID program, GLint location, GLuint v0)
{
...
bool ValidateProgramUniform1f(Context *context, ProgramID program, GLint location, GLfloat v0)
{
...
bool ValidateActiveShaderProgram(Context *context, GLuint pipeline, ProgramID program)
{
    UNIMPLEMENTED();
    return false;
}
