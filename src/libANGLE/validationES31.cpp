                                   ...
                                   GLint level)
{
    ...
    if (texture != 0)
    {
        ...
        // We put this validation before ValidateFramebufferTextureBase it is an INVALID_OPERATION
        // error instead for both FramebufferTexture2D and FramebufferTextureLayer:
