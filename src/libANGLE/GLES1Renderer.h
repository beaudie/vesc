...
struct GLES1ShaderStates
{
    ...
    Vec3Uniform pointDistanceAttenuation;

    Vec4Uniform mDrawTextureCoords;
    Vec2Uniform mDrawTextureDims;
};
...
class GLES1Renderer final : angle::NonCopyable
{
  ...
  private:
    ...
    void addShaderFloat(std::stringstream &outStream, const char *name, float value);
    void addShaderVec2(std::stringstream &outStream, const char *name, Vec2Uniform &value);
    void addShaderVec3(std::stringstream &outStream, const char *name, Vec3Uniform &value);
