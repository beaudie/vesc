...
class GLES1Renderer
{
  public:
    ...
    static const int kVertexAttribIndex;
    static const int kNormalAttribIndex;
    static const int kColorAttribIndex;
    static const int kPointSizeAttribIndex;
    static const int kTextureCoordAttribIndexBase;
