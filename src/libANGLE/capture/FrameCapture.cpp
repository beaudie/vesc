                              ...
                              bool validationEnabled)
{
    ...
    for (gl::BufferBinding binding : angle::AllEnums<gl::BufferBinding>())
    {
        ...
        bool isNewArrayBufferBinding  = arrayBuffer && arrayBuffer->id() != bufferID;
        if ((isArray && isNewArrayBufferBinding) || (!isArray && bufferID.value != 0))
        {
        ...
        if (bufferID.value != 0 || isNewArrayBufferBinding)
        {
