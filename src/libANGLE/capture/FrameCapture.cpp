    ...
    {
        {
            ...
            {
                if (shareContext.first == context->id())
                {
                    if (usesMidExecutionCapture())
                    {
                ...
                if (usesMidExecutionCapture())
                {
                    ...
                    // MEC started
                    if (mActiveContexts.find(shareContext.first.value) != mActiveContexts.end())
                    {
                        ...
                        out << "    "
                            << FmtSetupFunction(kNoPartId, shareContext.first, FuncUsage::Call)
                            << ";\n";
                    }
                }
            }
