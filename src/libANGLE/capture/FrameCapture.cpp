                                     ...
                                     bool isCallValid)
{
    ...
    if (isCallValid)
    {
        ...
        if (contextCount > 1 && mLastContextId != context->id().value)
        {
            ...
            // 'gContextMap'.
            paramBuffer.addValueParam("display", ParamType::TEGLDisplay, EGL_NO_DISPLAY);
            paramBuffer.addValueParam("draw", ParamType::TEGLSurface, EGL_NO_SURFACE);
            paramBuffer.addValueParam("read", ParamType::TEGLSurface, EGL_NO_SURFACE);
