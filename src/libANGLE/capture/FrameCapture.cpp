...
void ResetOpaqueTypeObjects(std::stringstream &out,
                            DataTracker *dataTracker,
                            std::stringstream &header,
                            ResourceTracker *resourceTracker,
                            std::vector<uint8_t> *binaryData)
{
    ResetFenceSyncObjects(out, dataTracker, header, resourceTracker, binaryData);
}
                    ...
                    bool serializeStateEnabled)
{
    ...
    if (frameIndex == frameCount)
    {
        ...
        ResetOpaqueTypeObjects(restoreCallStream, &dataTracker, header, resourceTracker,
                               binaryData);
