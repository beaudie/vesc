                                         ...
                                         const FrameCaptureShared &frameCaptureShared)
{
    ...
    setupCallStream << "    AllocateGlobalMemory(" << maxClientArraySize << ", " << readBufferSize
                    << ");\n";
                                       ...
                                       const FrameCaptureShared &frameCaptureShared)
{
    ...
    if (frameIndex == 1)
    {
        ...
        size_t maxClientArraySize = MaxClientArraySize(clientArraySizes);
        setupCallStream << "    AllocateGlobalMemory(" << maxClientArraySize << ", "
                        << readBufferSize << ");\n";
...

    {
        ...
        callStream << "{\n";
        callStream << "    AllocateGlobalMemory(" << maxClientArraySize << ", " << readBufferSize
                   << ");\n";
...
void FrameCaptureShared::onEndFrame(const gl::Context *context)
{
    ...
    if (!mFrameCalls.empty() || !frameCapture->getSetupCalls().empty() || mIsFirstFrame)
    {
