...
void MaybeResetEGLSyncObjects(std::stringstream &out,
                              ...
                              size_t *maxResourceIDBufferSize)
{
    // This function is similar to MaybeResetResources, but is just different enough to warrant
    // its own function.  In particular, it uses Destroy instead of Delete.
