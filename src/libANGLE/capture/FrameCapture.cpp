...
void DeleteResourcesInReset(const ResourceSet &newResources,
                         ...
                         size_t *maxResourceIDBufferSize)
{
    ...
    switch (resourceIDType)
    {
        case ResourceIDType::Buffer:
        {
            ...
            DeleteResourcesInReset(newBuffers, buffersToDelete, "Buffer", maxResourceIDBufferSize);
        ...
        case ResourceIDType::Framebuffer:
        {
            ...
            DeleteResourcesInReset(newFramebuffers, framebuffersToDelete, "Framebuffer",
                                   maxResourceIDBufferSize);
        ...
        case ResourceIDType::Renderbuffer:
        {
            ...
            DeleteResourcesInReset(newRenderbuffers, renderbuffersToDelete, "Renderbuffer",
                                   maxResourceIDBufferSize);
        ...
        case ResourceIDType::Texture:
        {
            ...
            DeleteResourcesInReset(newTextures, texturesToDelete, "Texture",
                                   maxResourceIDBufferSize);
        ...
        case ResourceIDType::VertexArray:
        {
            ...
            DeleteResourcesInReset(newVertexArrays, vertexArraysToDelete, "VertexArray",
                                   maxResourceIDBufferSize);
