            ...
            if (index.getType() == gl::TextureType::External)
            {
                ...
                else
                {
                    ...
                    for (std::vector<CallCapture> *calls : texSetupCalls)
                    {
                        ...
                        eglCreateImageKHRCall.customFunctionName = "CreateEGLImageKHR";
                        eglCreateImageKHRCall.params.addValueParam("width", ParamType::TGLsizei,
                                                                   desc.size.width);
                        eglCreateImageKHRCall.params.addValueParam("height", ParamType::TGLsizei,
                                                                   desc.size.height);
                        eglCreateImageKHRCall.params.addValueParam("image", ParamType::TGLuint,
                                                                   eglImageID.value);

                        calls->emplace_back(std::move(eglCreateImageKHRCall));
                    }
                }
