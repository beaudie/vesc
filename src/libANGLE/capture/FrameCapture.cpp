                                                  ...
                                                  bool writeResetContextCall)
{
    ...
    // Serialize trace metadata into a JSON file.
    JsonSerializer json;
    ...
    json.addScalar("PlatformType", attributes.getAsInt(EGL_PLATFORM_ANGLE_TYPE_ANGLE));
    json.addScalar("DeviceType", attributes.getAsInt(EGL_PLATFORM_ANGLE_DEVICE_TYPE_ANGLE));
    ...
    json.addScalar("IsBinaryDataCompressed", mCompression ? 1 : 0);
    json.addScalar("AreClientArraysEnabled", glState.areClientArraysEnabled() ? 1 : 0);
    json.addScalar("IsBindGeneratesResourcesEnabled",
                   glState.isBindGeneratesResourceEnabled() ? 1 : 0);
    json.addScalar("IsWebGLCompatibilityEnabled", glState.isWebGL() ? 1 : 0);
    json.addScalar("IsRobustResourceInitEnabled", glState.isRobustResourceInitEnabled() ? 1 : 0);
    json.endDocument();
