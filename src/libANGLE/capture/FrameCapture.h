...
class CoherentBuffer
{
  public:
    ...
    // Sets the whole buffer clean and protects the whole range
    void protect();
    ...
    // Returns start and sizes of dirty ranges
    std::vector<std::pair<uintptr_t, size_t>> getDirtyRanges();
...
class CoherentBufferTracker final : angle::NonCopyable
{
  public:
    ...
    void protectBuffer(gl::BufferID id);
