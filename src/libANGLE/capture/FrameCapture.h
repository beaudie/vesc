...
using ResourceIDToSetupCallsMap = std::map<ResourceID, gl::Range<size_t>>;
...
class FrameCaptureShared final : angle::NonCopyable
{
  public:
    ...
    ResourceIDToSetupCallsMap *getResourceIDToSetupCalls() { return &mResourceIDToSetupCalls; }
    void markResourceSetupCalls(std::vector<CallCapture> *setupCalls,
                                ResourceID id,
