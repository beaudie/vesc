                                 ...
                                 ParamCapture *paramCapture)
{
    ...
    paramCapture->arrayClientPointerIndex   = kCaptureClientArrayIndexColor;
}
...
{
    paramCapture->value.voidConstPointerVal = pointer;
    paramCapture->arrayClientPointerIndex   = kCaptureClientArrayIndexNormal;
}
                                    ...
                                    ParamCapture *paramCapture)
{
    ...
    paramCapture->arrayClientPointerIndex   = kCaptureClientArrayIndexTexCoordBase + activeTexture;
}
...
{
    paramCapture->value.voidConstPointerVal = pointer;
    paramCapture->arrayClientPointerIndex   = kCaptureClientArrayIndexPosition;
}
