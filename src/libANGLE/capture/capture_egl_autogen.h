...
angle::CallCapture CaptureQueryDisplayAttribANGLE(egl::Thread *thread,
                                                  ...
                                                  EGLAttrib *value,
                                                  EGLBoolean returnValue);
angle::CallCapture CaptureProgramCacheQueryMetalBinaryArchiveANGLE(egl::Thread *thread,
                                                                   bool isCallValid,
                                                                   egl::Display *dpyPacked,
                                                                   EGLint index,
                                                                   void *key,
                                                                   EGLint *keySize,
                                                                   void **binaryArchive);
angle::CallCapture CaptureProgramCachePopulateMetalBinaryArchiveANGLE(egl::Thread *thread,
                                                                      bool isCallValid,
                                                                      egl::Display *dpyPacked,
                                                                      const void *key,
                                                                      EGLint keySize,
