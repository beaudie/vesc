...
angle::CallCapture CaptureAcquireTextures(const State &glState,
                                          bool isCallValid,
                                          GLuint numTextures,
                                          const TextureID *texturesPacked,
                                          const GLenum *layouts);
angle::CallCapture CaptureReleaseTextures(const State &glState,
                                          bool isCallValid,
                                          GLuint numTextures,
                                          const TextureID *texturesPacked,
                                          GLenum *layouts);
...
void CaptureGetTranslatedShaderSourceANGLE_source(const State &glState,
                                                  ...
                                                  GLchar *source,
                                                  angle::ParamCapture *paramCapture);
void CaptureAcquireTextures_texturesPacked(const State &glState,
                                           bool isCallValid,
                                           GLuint numTextures,
                                           const TextureID *texturesPacked,
                                           const GLenum *layouts,
                                           angle::ParamCapture *paramCapture);
void CaptureAcquireTextures_layouts(const State &glState,
                                    bool isCallValid,
                                    GLuint numTextures,
                                    const TextureID *texturesPacked,
                                    const GLenum *layouts,
                                    angle::ParamCapture *paramCapture);
void CaptureReleaseTextures_texturesPacked(const State &glState,
                                           bool isCallValid,
                                           GLuint numTextures,
                                           const TextureID *texturesPacked,
                                           GLenum *layouts,
                                           angle::ParamCapture *paramCapture);
void CaptureReleaseTextures_layouts(const State &glState,
                                    bool isCallValid,
                                    GLuint numTextures,
                                    const TextureID *texturesPacked,
                                    GLenum *layouts,
