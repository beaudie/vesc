...
bool ValidateGetStringi(Context *context, GLenum name, GLuint index)
{
    if (context->getClientMajorVersion() < 3)
    {
        context->handleError(Error(GL_INVALID_OPERATION, "glGetStringi requires OpenGL ES 3.0 or higher."));
        return false;
    }
    ...
    case GL_EXTENSIONS:
        ...
        {
            context->handleError(Error(GL_INVALID_VALUE, "index must be less than the number of extension strings."));
            return false;
        }
        break;
    ...
    case GL_REQUESTABLE_EXTENSIONS_ANGLE:
        ...
        {
            context->handleError(Error(GL_INVALID_VALUE, "index must be less than the number of requestable extension strings."));
            return false;
        }
        break;
