...
static bool ValidCopyConversion(GLenum textureFormat, GLenum framebufferFormat)
{
    // From ES 3.0.1 spec, table 3.15
    // Also, some formats necessary for ANGLE back-buffers
                                              ...
                                              GLuint readBufferHandle)
{
    ...
    if (!ValidCopyConversion(textureFormatInfo.format, framebufferFormatInfo.format))
    {
        return false;
    }
