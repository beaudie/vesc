                                                  ...
                                                  GLsizei numViews)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kMultiviewNotAvailable);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kMultiviewViewsTooSmall);
        return false;
    }

    if (static_cast<GLuint>(numViews) > context->getCaps().maxViews)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kMultiviewViewsTooLarge);
        return false;
    }
    ...
    switch (GetUnsizedFormat(srcInternalFormat))
    {
        ...
        default:
            ANGLE_VALIDATION_ERRORF(context, entryPoint, GL_INVALID_OPERATION,
                                    kInvalidInternalFormat, srcInternalFormat);
            return false;
    }
                                              ...
                                              GLenum type)
{
    ...
    {
        ANGLE_VALIDATION_ERRORF(context, entryPoint, GL_INVALID_VALUE, kInvalidInternalFormat,
                                internalFormat);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, k3DDepthStencil);
        return false;
    }
                                       ...
                                       const void *pixels)
{
    ...
    switch (texType)
    {
        ...
        case TextureType::CubeMapArray:
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kCubemapInvalidDepth);
                return false;
            }
            break;
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidMipLevel);
        return false;
    }
    ...
    if (isCompressed)
    {
        ...
        if (!isSubImage)
        {
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kCompressedMismatch);
                return false;
            }
    ...
    if (isSubImage)
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kCompressedMismatch);
            return false;
        }
                                           ...
                                           GLsizei depth)
{
    ...
    switch (target)
    {
        ...
        case TextureType::Rectangle:
        {
            if (levels != 1)
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidMipLevels);
                return false;
            }
...
bool ValidateReadBuffer(const Context *context, angle::EntryPoint entryPoint, GLenum src)
{
    ...
    if (readFBO == nullptr)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kNoReadFramebuffer);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidReadBuffer);
        return false;
    }
                                  ...
                                  const void *data)
{
    ...
    if (!formatInfo.compressed)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidCompressedFormat);
        return false;
    }
                                     ...
                                     GLsizeiptr size)
{
    ...
    switch (target)
    {
        ...
        case BufferBinding::AtomicCounter:
        {
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kOffsetAlignment);
                return false;
            }
            break;
        }
                             ...
                             GLsizeiptr size)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidBindBufferSize);
        return false;
    }
                                   ...
                                   GLint value)
{
    ...
    switch (pname)
    {
        case GL_PROGRAM_BINARY_RETRIEVABLE_HINT:
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidBooleanValue);
                return false;
            }
            break;
                                   ...
                                   GLboolean unpackUnmultiplyAlpha)
{
    ...
    if (x < 0 || y < 0 || z < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativeXYZ);
        return false;
    }

    if (width < 0 || height < 0 || depth < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativeHeightWidthDepth);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kDestinationTextureTooSmall);
        return false;
    }
                                     ...
                                     const void *data)
{
    ...
    if (data == nullptr)
    {
        ...
        if (context->getTextureByTarget(target)->isCompressedFormatEmulated(context, target, level))
        {
            ...
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidEmulatedFormat);
            return false;
        }
    }
                                    ...
                                    PrimitiveMode primitiveMode)
{
    ...
    switch (primitiveMode)
    {
        ...
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidPrimitiveMode);
            return false;
    }
                               ...
                               GLsizeiptr size)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kBufferOffsetOverflow);
        return false;
    }
    ...
    if (readBuffer == writeBuffer)
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kCopyAlias);
            return false;
        }
    }
                                  ...
                                  const void *pointer)
{
    ...
    if (stride < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativeStride);
        return false;
    }
                       ...
                       const GLint *values)
{
    ...
    if (!syncObject)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kSyncMissing);
        return false;
    }
                                            ...
                                            GLsizei numViews)
{
    ...
    if (texture.value != 0)
    {
        if (baseViewIndex < 0)
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativeBaseViewIndex);
            return false;
        }
...
bool ValidatePauseTransformFeedback(const Context *context, angle::EntryPoint entryPoint)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kTransformFeedbackPaused);
        return false;
    }
                       ...
                       GLbitfield flags)
{
    ...
    if (flags != 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidFlags);
        return false;
    }
                      ...
                      GLuint64 timeout)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidTimeout);
        return false;
    }
                         ...
                         SamplerID sampler)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidCombinedImageUnit);
        return false;
    }
                                         ...
                                         const GLfloat *params)
{
        ...
        !context->getExtensions().getTexLevelParameterANGLE)
    {
        ANGLE_VALIDATION_ERROR(
            context, entryPoint, GL_INVALID_OPERATION,
