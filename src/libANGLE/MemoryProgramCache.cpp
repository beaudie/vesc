                                           ...
                                           InfoLog &infoLog)
{
         ...
         uniformIndexIndex++)
    {
        ...
        stream.readIntVector<unsigned int>(&variable.arrayElementIndices);
    ...
    for (unsigned int outputIndex = 0; outputIndex < outputVarCount; ++outputIndex)
    {
        ...
        stream.readIntVector<unsigned int>(&locationData.arrayElementIndices);
                                   ...
                                   angle::MemoryBuffer *binaryOut)
{
    ...
    {
        stream.writeIntVector(variable.arrayElementIndices);
    ...
    for (const auto &outputPair : state.getOutputLocations())
    {
        ...
        stream.writeIntVector(outputPair.second.arrayElementIndices);
