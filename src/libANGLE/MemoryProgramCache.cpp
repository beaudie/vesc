...
void WriteShaderVarGroupBuffer(BinaryOutputStream *stream, const ShaderVarGroupBuffer &var)
{
...
void LoadShaderVarGroupBuffer(BinaryInputStream *stream, ShaderVarGroupBuffer *var)
{
                                           ...
                                           InfoLog &infoLog)
{
         ...
         ++uniformBlockIndex)
    {
        ...
        LoadShaderVarGroupBuffer(&stream, &uniformBlock);
    ...
    for (unsigned int bufferIndex = 0; bufferIndex < atomicCounterBufferCount; ++bufferIndex)
    {
        ...
        LoadShaderVarGroupBuffer(&stream, &atomicCounterBuffer);
