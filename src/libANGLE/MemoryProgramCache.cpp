...
bool MemoryProgramCache::get(const ProgramHash &programHash,
                             Context *context,
                             std::vector<uint8_t> *programOut)
{
    return mBlobCache.get(context->getCurrentDisplay(), programHash.data(), kProgramHashLength,
                          programOut);
}
...
bool MemoryProgramCache::getAt(size_t index, ProgramHash *hashOut, std::vector<uint8_t> *programOut)
{
                                    ...
                                    const Program *program)
{
    ...
    mBlobCache.put(context->getCurrentDisplay(), programHash.data(), kProgramHashLength,
                   serializedProgram.data(), serializedProgram.size());
