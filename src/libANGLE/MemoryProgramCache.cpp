                                           ...
                                           InfoLog &infoLog)
{
    ...
    state->mAttributesTypeMask.types_from_ulong(stream.readInt<uint32_t>());
    state->mAttributesTypeMask.mask_from_ulong(stream.readInt<uint32_t>());
                                   ...
                                   angle::MemoryBuffer *binaryOut)
{
    ...
    static_assert(MAX_VERTEX_ATTRIBS <= sizeof(unsigned long) * 8,
                  "Too many vertex attribs for mask");
    stream.writeInt(static_cast<uint32_t>(state.mAttributesTypeMask.types_to_ulong()));
    stream.writeInt(static_cast<uint32_t>(state.mAttributesTypeMask.mask_to_ulong()));
