                                           ...
                                           InfoLog &infoLog)
{
    ...
    static_assert(IMPLEMENTATION_MAX_DRAW_BUFFERS * 2 == 16,
                  "All bits of DrawBufferTypeMask can be contained in an uint16_t");
    state->mDrawBufferTypeMask = stream.readInt<uint16_t>();
                                   ...
                                   angle::MemoryBuffer *binaryOut)
{
    ...
    static_assert(IMPLEMENTATION_MAX_DRAW_BUFFERS * 2 == 16,
                  "All bits of DrawBufferTypeMask can be contained in an uint16_t");
    stream.writeInt(static_cast<uint16_t>(state.mDrawBufferTypeMask.to_uint16()));
