...
void ExternalImageSibling::onAttach(const gl::Context *context, rx::Serial framebuferSerial) {}

void ExternalImageSibling::onDetach(const gl::Context *context, rx::Serial framebuferSerial) {}
