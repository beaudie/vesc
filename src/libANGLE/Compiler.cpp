      ...
      mGeometryCompiler(nullptr)
{
    ...
    // Currently we enable or disable both GL_OES_geometry_shader and GL_EXT_geometry_shader at the
    // same time.
    ASSERT(extensions.oesGeometryShader == extensions.extGeometryShader);
    mResources.OES_geometry_shader = extensions.oesGeometryShader;
