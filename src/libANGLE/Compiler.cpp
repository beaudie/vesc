      ...
      mComputeCompiler(nullptr)
{
    ...
    mResources.MaxComputeSharedMemorySize          = caps.maxComputeSharedMemorySize;
    mResources.MaxUniformLocations                 = caps.maxUniformLocations;
    mResources.MaxShaderStorageBlockSize           = caps.maxShaderStorageBlockSize;
    mResources.MaxVertexShaderStorageBlocks        = caps.maxVertexShaderStorageBlocks;
    mResources.MaxFragmentShaderStorageBlocks      = caps.maxFragmentShaderStorageBlocks;
    mResources.MaxCombinedComputeUniformComponents = caps.maxCombinedComputeUniformComponents;
}
