...
class FlattenUniformVisitor : public sh::VariableNameVisitor
{
  public:
                            ...
                            const std::vector<unsigned int> &arraySizes) override
    {
        ...
        bool isFragmentInOut                    = IsFragmentInOut(variable.FragmentInOut);
        ...
        else
        {
            ...
            linkedUniform.FragmentInOut       = variable.FragmentInOut;
    ...
    InfoLog &infoLog)
{
    ...
    for (const sh::ShaderVariable &uniform : shader->getUniforms())
    {
        ...
        {
            unusedUniforms.emplace_back(
                uniform.name, IsSamplerType(uniform.type), IsImageType(uniform.type),
                IsAtomicCounterType(uniform.type), IsFragmentInOut(uniform.FragmentInOut));
        }
    }
