...
void UniformLinker::pruneUnusedUniforms()
{
    ...
    while (uniformIter != mUniforms.end())
    {
        ...
        {
            UnusedUniform unusedUniform = {uniformIter->name, uniformIter->isSampler()};
            mUnusedUniforms.emplace_back(unusedUniform);
    ...
    ShaderType shaderType)
{
    ...
    {
        UnusedUniform unusedUniform = {uniform.name, IsSamplerType(uniform.type)};
        unusedUniforms->emplace_back(unusedUniform);
    }
    return ShaderUniformCount();
}
    ...
    int *location)
{
    ...
    else
    {
        ...
        {
            UnusedUniform unusedUniform = {linkedUniform.name, linkedUniform.isSampler()};
            unusedUniforms->emplace_back(unusedUniform);
        }
