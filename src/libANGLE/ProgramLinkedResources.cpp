                                             ...
                                             int blockIndex) const
{
    if (field.isStruct())
    {
        if (field.isArray())
        {
            defineBlockMemberStructArrayMembers(getMemberInfo, field, 0u, fullName, fullMappedName,
                                                blockIndex);
        }
        else
        {
    ...
    {
        for (unsigned int arrayElement = 0u; arrayElement < field.getOutermostArraySize();
             ++arrayElement)
        {
