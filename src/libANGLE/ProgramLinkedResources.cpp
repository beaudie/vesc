...
UsedUniform::UsedUniform(const sh::ShaderVariable &uniform)
...
UsedUniform::UsedUniform(const UsedUniform &uniform)
    : sh::ShaderVariable(uniform),
...
UsedUniform &UsedUniform::operator=(const UsedUniform &uniform)
{
                               ...
                               std::vector<VariableLocation> *uniformLocationsOutOrNull)
{
    ...
    for (const UsedUniform &uniformHelper : mUniforms)
    {
        LinkedUniform uniform(uniformHelper);
