                                                ...
                                                ShShaderOutput compilerOutputType) const
{
         ...
         ++arrayElement)
    {
        ...
        {
            // HLSL's compiler path handles these layouts on its own.
            isActive = isActive ||
        ...
        if (isActive || sh::IsOutputHLSL(compilerOutputType))
        {
                                                 ...
                                                 const ProgramLinkedResources &resources) const
{
    ...
    ASSERT(compilerOutputType != ShShaderOutput::SH_INVALID);
