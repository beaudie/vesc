...
void UniformLinker::getResults(std::vector<UsedUniform> *usedUniformsOut,
                               std::vector<UnusedUniform> *unusedUniformsOut,
                               std::vector<VariableLocation> *uniformLocationsOutOrNull)
{
    usedUniformsOut->swap(mUniforms);
    unusedUniformsOut->swap(mUnusedUniforms);
...
{
    uniformBlockLinker.init(uniformBlocksOut, &usedUniforms, &unusedInterfaceBlocks);
...
void ProgramLinkedResources::getLinkedUniforms(std::vector<LinkedUniform> *uniforms,
                                               std::vector<std::string> *uniformNames,
                                               std::vector<std::string> *uniformMappedNames)
{
    uniforms->reserve(usedUniforms.size());
    uniformNames->reserve(usedUniforms.size());
    uniformMappedNames->reserve(usedUniforms.size());
    for (const UsedUniform &usedUniform : usedUniforms)
    {
