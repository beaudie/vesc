...
class FramebufferAttachment final
{
  public:
    ...
    void detach(const Context *context, rx::Serial framebuferSerial);
...
class FramebufferAttachmentObject : public angle::Subject, public angle::ObserverInterface
{
  public:
    ...
    virtual void onAttach(const Context *context, rx::Serial framebuferSerial) = 0;
    virtual void onDetach(const Context *context, rx::Serial framebuferSerial) = 0;
