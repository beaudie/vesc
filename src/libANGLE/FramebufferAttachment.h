...
class FramebufferAttachment : angle::NonCopyable
{
  ...
  protected:
    Target mTarget;
    BindingPointer<RenderableObject> mResource;
};
...
class RenderableObject : public RefCountObject
{
  public:
    RenderableObject(GLuint id) : RefCountObject(id) {}
