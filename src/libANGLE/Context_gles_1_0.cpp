...
gl::ClientVertexArrayType Context::paramToVertexArrayType(GLenum param) const
{
    switch (param)
    {
        ...
        case GL_VERTEX_ARRAY_POINTER:
            return gl::ClientVertexArrayType::Vertex;
        case GL_NORMAL_ARRAY:
        case GL_NORMAL_ARRAY_BUFFER_BINDING:
        case GL_NORMAL_ARRAY_STRIDE:
        case GL_NORMAL_ARRAY_TYPE:
        case GL_NORMAL_ARRAY_POINTER:
            return gl::ClientVertexArrayType::Normal;
        case GL_COLOR_ARRAY:
        ...
        case GL_COLOR_ARRAY_POINTER:
            return gl::ClientVertexArrayType::Color;
        case GL_POINT_SIZE_ARRAY_OES:
        case GL_POINT_SIZE_ARRAY_BUFFER_BINDING_OES:
        case GL_POINT_SIZE_ARRAY_STRIDE_OES:
        case GL_POINT_SIZE_ARRAY_TYPE_OES:
        case GL_POINT_SIZE_ARRAY_POINTER_OES:
            return gl::ClientVertexArrayType::PointSize;
        ...
        case GL_TEXTURE_COORD_ARRAY_POINTER:
            return gl::ClientVertexArrayType::TextureCoord;
        default:
            UNREACHABLE();
            return gl::ClientVertexArrayType::InvalidEnum;
    }
}
