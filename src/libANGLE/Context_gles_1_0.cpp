...
{
    mGLState.gles1().multMatrix(angle::Mat4::Frustum(
                FixedToFloat(l),
                FixedToFloat(r),
                FixedToFloat(b),
                FixedToFloat(t),
...
{
    mGLState.gles1().multMatrix(angle::Mat4::Ortho(
                FixedToFloat(l),
                FixedToFloat(r),
                FixedToFloat(b),
                FixedToFloat(t),
...
{
    mGLState.gles1().multMatrix(angle::Mat4::Scale(angle::Vector3(
...
{
    mGLState.gles1().multMatrix(angle::Mat4::Translate(angle::Vector3(
                    FixedToFloat(x), FixedToFloat(y), FixedToFloat(z))));
}
