...
Error GLES1Renderer::prepareForDraw(Context *context, State *glState)
{
    ...
    // Texturing
    {
        ...
        setUniform1iv(programObject, mProgramState.textureFormatLoc, kTexUnitCount, tex2DFormats.data());
        ...
        setUniform1iv(programObject, mProgramState.textureEnvModeLoc, kTexUnitCount, uniformBuffers.texEnvModes.data());
        setUniform1iv(programObject, mProgramState.combineRgbLoc, kTexUnitCount, uniformBuffers.texCombineRgbs.data());
        setUniform1iv(programObject, mProgramState.combineAlphaLoc, kTexUnitCount, uniformBuffers.texCombineAlphas.data());

        setUniform1iv(programObject, mProgramState.src0rgbLoc, kTexUnitCount, uniformBuffers.texCombineSrc0Rgbs.data());
        setUniform1iv(programObject, mProgramState.src0alphaLoc, kTexUnitCount, uniformBuffers.texCombineSrc0Alphas.data());
        setUniform1iv(programObject, mProgramState.src1rgbLoc, kTexUnitCount, uniformBuffers.texCombineSrc1Rgbs.data());
        setUniform1iv(programObject, mProgramState.src1alphaLoc, kTexUnitCount, uniformBuffers.texCombineSrc1Alphas.data());
        setUniform1iv(programObject, mProgramState.src2rgbLoc, kTexUnitCount, uniformBuffers.texCombineSrc2Rgbs.data());
        setUniform1iv(programObject, mProgramState.src2alphaLoc, kTexUnitCount, uniformBuffers.texCombineSrc2Alphas.data());

        setUniform1iv(programObject, mProgramState.op0rgbLoc, kTexUnitCount, uniformBuffers.texCombineOp0Rgbs.data());
        setUniform1iv(programObject, mProgramState.op0alphaLoc, kTexUnitCount, uniformBuffers.texCombineOp0Alphas.data());
        setUniform1iv(programObject, mProgramState.op1rgbLoc, kTexUnitCount, uniformBuffers.texCombineOp1Rgbs.data());
        setUniform1iv(programObject, mProgramState.op1alphaLoc, kTexUnitCount, uniformBuffers.texCombineOp1Alphas.data());
        setUniform1iv(programObject, mProgramState.op2rgbLoc, kTexUnitCount, uniformBuffers.texCombineOp2Rgbs.data());
        setUniform1iv(programObject, mProgramState.op2alphaLoc, kTexUnitCount, uniformBuffers.texCombineOp2Alphas.data());

        setUniform4fv(programObject, mProgramState.textureEnvColorLoc, kTexUnitCount, reinterpret_cast<float*>(uniformBuffers.texEnvColors.data()));
        setUniform1fv(programObject, mProgramState.rgbScaleLoc, kTexUnitCount, uniformBuffers.texEnvRgbScales.data());
        setUniform1fv(programObject, mProgramState.alphaScaleLoc, kTexUnitCount, uniformBuffers.texEnvAlphaScales.data());
    }
