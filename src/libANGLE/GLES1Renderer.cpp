...
void GLES1Renderer::addFragmentShaderDefs(std::stringstream &outStream)
{
    ...
    outStream << "bool enable_texture_2d[kMaxTexUnits] = bool[kMaxTexUnits]("
              << getShaderBool(Tex2d0) << ", " << getShaderBool(Tex2d1) << ", "
              << getShaderBool(Tex2d2) << ", " << getShaderBool(Tex2d3) << ");";
    ...
    outStream << "bool enable_texture_cube_map[kMaxTexUnits] = bool[kMaxTexUnits]("
              << getShaderBool(TexCube0) << ", " << getShaderBool(TexCube1) << ", "
              << getShaderBool(TexCube2) << ", " << getShaderBool(TexCube3) << ");";
    ...
    outStream << "bool point_sprite_coord_replace[kMaxTexUnits] = bool[kMaxTexUnits]("
              << getShaderBool(PointSpriteCoordReplaces0) << ", "
              << getShaderBool(PointSpriteCoordReplaces1) << ", "
              << getShaderBool(PointSpriteCoordReplaces2) << ", "
              << getShaderBool(PointSpriteCoordReplaces3) << ");";

    // bool light_enables[kMaxLights] = bool[kMaxLights](...);
    outStream << "\n";
    outStream << "bool light_enables[kMaxLights] = bool[kMaxLights](" << getShaderBool(Light0)
              << ", " << getShaderBool(Light1) << ", " << getShaderBool(Light2) << ", "
              << getShaderBool(Light3) << ", " << getShaderBool(Light4) << ", "
              << getShaderBool(Light5) << ", " << getShaderBool(Light6) << ", "
              << getShaderBool(Light7) << ");";
    ...
    outStream << "bool clip_plane_enables[kMaxClipPlanes] = bool[kMaxClipPlanes]("
              << getShaderBool(ClipPlane0) << ", " << getShaderBool(ClipPlane1) << ", "
              << getShaderBool(ClipPlane2) << ", " << getShaderBool(ClipPlane3) << ", "
              << getShaderBool(ClipPlane4) << ", " << getShaderBool(ClipPlane5) << ");";
}
