                                         ...
                                         ShaderProgramID *programOut)
{
    ...
    *programOut = program;
    ...
    {
        GLint infoLogLength = programObject->getState().getProgramExecutable().getInfoLogLength();
        std::vector<char> infoLog(infoLogLength, 0);
        programObject->getState().getProgramExecutable().getInfoLog(infoLogLength - 1, nullptr,
                                                                    infoLog.data());
