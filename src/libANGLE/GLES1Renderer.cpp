...
void GLES1Renderer::onDestroy(Context *context, State *state)
{
    if (mRendererProgramInitialized)
    {
        ...
        for (const auto &programState : mProgramStates)
        {
            mShaderPrograms->deleteProgram(context, {programState.second.program});
        }
...
angle::Result GLES1Renderer::prepareForDraw(PrimitiveMode mode, Context *context, State *glState)
{
    ...
    bool tex2DEnables[kTexUnitCount];
    bool texCubeEnables[kTexUnitCount];
    ...
    mGLES1StateEnabled[Tex2d0] = tex2DEnables[0];
    mGLES1StateEnabled[Tex2d1] = tex2DEnables[1];
    mGLES1StateEnabled[Tex2d2] = tex2DEnables[2];
    mGLES1StateEnabled[Tex2d3] = tex2DEnables[3];

    mGLES1StateEnabled[TexCube0] = texCubeEnables[0];
    mGLES1StateEnabled[TexCube1] = texCubeEnables[1];
    mGLES1StateEnabled[TexCube2] = texCubeEnables[2];
    mGLES1StateEnabled[TexCube3] = texCubeEnables[3];
    ...
    mGLES1StateEnabled[ClipPlanes]         = enableClipPlanes;
    mGLES1StateEnabled[DrawTexture]        = mDrawTextureEnabled;
    mGLES1StateEnabled[PointRasterization] = mode == PrimitiveMode::Points;
    mGLES1StateEnabled[ShadeModelFlat]     = gles1State.mShadeModel == ShadingModel::Flat;
    mGLES1StateEnabled[AlphaTest]          = glState->getEnableFeature(GL_ALPHA_TEST);
    mGLES1StateEnabled[Lighting]           = glState->getEnableFeature(GL_LIGHTING);
    mGLES1StateEnabled[RescaleNormal]      = glState->getEnableFeature(GL_RESCALE_NORMAL);
    mGLES1StateEnabled[Normalize]          = glState->getEnableFeature(GL_NORMALIZE);
    mGLES1StateEnabled[Fog]                = glState->getEnableFeature(GL_FOG);
    mGLES1StateEnabled[PointSprite]        = glState->getEnableFeature(GL_POINT_SPRITE_OES);
    mGLES1StateEnabled[ColorMaterial]      = glState->getEnableFeature(GL_COLOR_MATERIAL);

    // TODO (lfy@google.com): Implement two-sided lighting model (lightModel.twoSided)
    mGLES1StateEnabled[LightModelTwoSided] = false;
    ...
    mGLES1StateEnabled[PointSpriteCoordReplaces0] = pointSpriteCoordReplaces[0];
    mGLES1StateEnabled[PointSpriteCoordReplaces1] = pointSpriteCoordReplaces[1];
    mGLES1StateEnabled[PointSpriteCoordReplaces2] = pointSpriteCoordReplaces[2];
    mGLES1StateEnabled[PointSpriteCoordReplaces3] = pointSpriteCoordReplaces[3];
    ...
    mGLES1StateEnabled[Light0] = lightEnables[0];
    mGLES1StateEnabled[Light1] = lightEnables[1];
    mGLES1StateEnabled[Light2] = lightEnables[2];
    mGLES1StateEnabled[Light3] = lightEnables[3];
    mGLES1StateEnabled[Light4] = lightEnables[4];
    mGLES1StateEnabled[Light5] = lightEnables[5];
    mGLES1StateEnabled[Light6] = lightEnables[6];
    mGLES1StateEnabled[Light7] = lightEnables[7];

    mGLES1StateEnabled[ClipPlane0] = clipPlaneEnables[0];
    mGLES1StateEnabled[ClipPlane1] = clipPlaneEnables[1];
    mGLES1StateEnabled[ClipPlane2] = clipPlaneEnables[2];
    mGLES1StateEnabled[ClipPlane3] = clipPlaneEnables[3];
    mGLES1StateEnabled[ClipPlane4] = clipPlaneEnables[4];
    mGLES1StateEnabled[ClipPlane5] = clipPlaneEnables[5];
    ...
    if (gles1State.isDirty(GLES1State::DIRTY_GLES1_LIGHTS))
    {
        ...
        // gl->uniform1i(programState.lightModelTwoSidedLoc, lightModel.twoSided);
...
void GLES1Renderer::addShaderBool(std::stringstream &outStream, GLES1StateEnables state)
{
...
{
    outStream << "\n";
    outStream << "#define " << enableString << " ";
    addShaderBool(outStream, state);
}
...
angle::Result GLES1Renderer::initializeRendererProgram(Context *context, State *glState)
{
    ...
    // Track that we've created a program for this state combination
    ...
    addShaderDefine(GLES1DrawVShaderStateDefs, GLES1StateEnables::DrawTexture,
                    "enable_draw_texture");
    addShaderDefine(GLES1DrawVShaderStateDefs, GLES1StateEnables::PointRasterization,
                    "point_rasterization");
    addShaderDefine(GLES1DrawVShaderStateDefs, GLES1StateEnables::RescaleNormal,
                    "enable_rescale_normal");
    addShaderDefine(GLES1DrawVShaderStateDefs, GLES1StateEnables::Normalize, "enable_normalize");
    ...
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::Lighting, "enable_lighting");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::Fog, "enable_fog");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::ClipPlanes, "enable_clip_planes");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::DrawTexture,
                    "enable_draw_texture");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::PointRasterization,
                    "point_rasterization");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::PointSprite,
                    "point_sprite_enabled");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::AlphaTest, "enable_alpha_test");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::ShadeModelFlat,
                    "shade_model_flat");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::ColorMaterial,
                    "enable_color_material");
    addShaderDefine(GLES1DrawFShaderStateDefs, GLES1StateEnables::LightModelTwoSided,
                    "light_model_two_sided");

    // bool enable_texture_2d[kMaxTexUnits] = bool[kMaxTexUnits](false, false, false, false);
    GLES1DrawFShaderStateDefs << "\n";
    GLES1DrawFShaderStateDefs << "bool enable_texture_2d[kMaxTexUnits] = "
                              << "bool[kMaxTexUnits](";
    addShaderBool(GLES1DrawFShaderStateDefs, Tex2d0);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Tex2d1);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Tex2d2);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Tex2d3);
    GLES1DrawFShaderStateDefs << ");";

    // bool enable_texture_cube_map[kMaxTexUnits] = bool[kMaxTexUnits](false, false, false, false);
    GLES1DrawFShaderStateDefs << "\n";
    GLES1DrawFShaderStateDefs << "bool enable_texture_cube_map[kMaxTexUnits] = "
                              << "bool[kMaxTexUnits](";
    addShaderBool(GLES1DrawFShaderStateDefs, TexCube0);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, TexCube1);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, TexCube2);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, TexCube3);
    GLES1DrawFShaderStateDefs << ");";

    // bool point_sprite_coord_replace[kMaxTexUnits] = bool[kMaxTexUnits](false, false, false,
    //                                                                    false);
    GLES1DrawFShaderStateDefs << "\n";
    GLES1DrawFShaderStateDefs << "bool point_sprite_coord_replace[kMaxTexUnits] = "
                              << "bool[kMaxTexUnits](";
    addShaderBool(GLES1DrawFShaderStateDefs, PointSpriteCoordReplaces0);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, PointSpriteCoordReplaces1);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, PointSpriteCoordReplaces2);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, PointSpriteCoordReplaces3);
    GLES1DrawFShaderStateDefs << ");";

    // bool light_enables[kMaxLights] = bool[kMaxLights](false, false, false, false, false, false,
    // false, false);
    GLES1DrawFShaderStateDefs << "\n";
    GLES1DrawFShaderStateDefs << "bool light_enables[kMaxLights] = "
                              << "bool[kMaxLights](";
    addShaderBool(GLES1DrawFShaderStateDefs, Light0);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light1);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light2);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light3);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light4);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light5);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light6);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, Light7);
    GLES1DrawFShaderStateDefs << ");";

    // bool clip_plane_enables[kMaxClipPlanes];
    GLES1DrawFShaderStateDefs << "\n";
    GLES1DrawFShaderStateDefs << "bool clip_plane_enables[kMaxClipPlanes] = "
                              << "bool[kMaxClipPlanes](";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane0);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane1);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane2);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane3);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane4);
    GLES1DrawFShaderStateDefs << ", ";
    addShaderBool(GLES1DrawFShaderStateDefs, ClipPlane5);
    GLES1DrawFShaderStateDefs << ");";
