                                ...
                                float height)
{
    ...
    float xNdc = scaleScreenCoordinateToNdc(x, viewport.width);
    float yNdc = scaleScreenCoordinateToNdc(y, viewport.height);
    float wNdc = scaleScreenDimensionToNdc(width, viewport.width);
    float hNdc = scaleScreenDimensionToNdc(height, viewport.height);
