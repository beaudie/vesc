...
Error GLES1Renderer::prepareForDraw(Context *context, State *glState)
{
    ...
    // Matrices
    {
        ...
        setUniformMatrix4fv(programObject, mProgramState.modelviewMatrixLoc, 1, GL_FALSE, modelview.data());

        angle::Mat4 modelviewInvTr = modelview.transpose().inverse();
        setUniformMatrix4fv(programObject, mProgramState.modelviewInvTrLoc, 1, GL_FALSE, modelviewInvTr.data());
    ...
    // Texturing
    {
        ...
        setUniform1iv(programObject, mProgramState.enableTexture2DLoc, kTexUnitCount, tex2DEnables.data());
        setUniform1iv(programObject, mProgramState.enableTextureCubeMapLoc, kTexUnitCount, texCubeEnables.data());
    }

    // Shading, materials, and lighting
    {
        setUniform1i(programObject, mProgramState.shadeModelFlatLoc, gles1State.mShadeModel == ShadingModel::Flat);
        setUniform1i(programObject, mProgramState.enableLightingLoc, glState->getEnableFeature(GL_LIGHTING));
        setUniform1i(programObject, mProgramState.enableLightingLoc, glState->getEnableFeature(GL_RESCALE_NORMAL));
        setUniform1i(programObject, mProgramState.enableLightingLoc, glState->getEnableFeature(GL_NORMALIZE));
        setUniform1i(programObject, mProgramState.enableLightingLoc, glState->getEnableFeature(GL_COLOR_MATERIAL));
        ...
        setUniform4fv(programObject, mProgramState.materialSpecularLoc, 1, material.specular.data());
        setUniform4fv(programObject, mProgramState.materialEmissiveLoc, 1, material.emissive.data());
        setUniform1f(programObject, mProgramState.materialSpecularExponentLoc, material.specularExponent);

        const auto &lightModel = gles1State.mLightModel;

        setUniform4fv(programObject, mProgramState.lightModelSceneAmbientLoc, 1, lightModel.color.data());
        // TODO
        ...
        setUniform1iv(programObject, mProgramState.lightEnablesLoc, kLightCount, uniformBuffers.lightEnables.data());
        setUniform4fv(programObject, mProgramState.lightAmbientsLoc, kLightCount, (GLfloat*)uniformBuffers.lightAmbients.data());
        setUniform4fv(programObject, mProgramState.lightDiffusesLoc, kLightCount, (GLfloat*)uniformBuffers.lightDiffuses.data());
        setUniform4fv(programObject, mProgramState.lightSpecularsLoc, kLightCount, (GLfloat*)uniformBuffers.lightSpeculars.data());
        setUniform4fv(programObject, mProgramState.lightPositionsLoc, kLightCount, (GLfloat*)uniformBuffers.lightPositions.data());
        setUniform3fv(programObject, mProgramState.lightDirectionsLoc, kLightCount, (GLfloat*)uniformBuffers.lightDirections.data());
        setUniform1fv(programObject, mProgramState.lightSpotlightExponentsLoc, kLightCount, (GLfloat*)uniformBuffers.spotlightExponents.data());
        setUniform1fv(programObject, mProgramState.lightSpotlightCutoffAnglesLoc, kLightCount, (GLfloat*)uniformBuffers.spotlightCutoffAngles.data());
        setUniform1fv(programObject, mProgramState.lightAttenuationConstsLoc, kLightCount, (GLfloat*)uniformBuffers.attenuationConsts.data());
        setUniform1fv(programObject, mProgramState.lightAttenuationLinearsLoc, kLightCount, (GLfloat*)uniformBuffers.attenuationLinears.data());
        setUniform1fv(programObject, mProgramState.lightAttenuationQuadraticsLoc, kLightCount, (GLfloat*)uniformBuffers.attenuationQuadratics.data());
...
Error GLES1Renderer::initializeRendererProgram(Context *context, State *glState)
{
    ...
    mProgramState.enableRescaleNormalLoc = programObject->getUniformLocation("enable_rescale_normal");
    mProgramState.enableNormalizeLoc = programObject->getUniformLocation("enable_normalize");
    mProgramState.enableColorMaterialLoc = programObject->getUniformLocation("enable_color_material");
...
void GLES1Renderer::setUniform1iv(Program* programObject, GLint loc, GLint count, const GLint* value) {
    if (loc == -1) return;
    programObject->setUniform1iv(loc, count, value);
}

void GLES1Renderer::setUniformMatrix4fv(Program* programObject, GLint loc, GLint count, GLboolean transpose, const GLfloat* value) {
    if (loc == -1) return;
    programObject->setUniformMatrix4fv(loc, count, transpose, value);
}

void GLES1Renderer::setUniform4fv(Program* programObject, GLint loc, GLint count, const GLfloat* value) {
    if (loc == -1) return;
    programObject->setUniform4fv(loc, count, value);
}

void GLES1Renderer::setUniform3fv(Program* programObject, GLint loc, GLint count, const GLfloat* value) {
    if (loc == -1) return;
...
void GLES1Renderer::setUniform1fv(Program* programObject, GLint loc, GLint count, const GLfloat* value) {
    if (loc == -1) return;
