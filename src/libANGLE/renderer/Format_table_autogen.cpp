...
constexpr Format g_formatInfoTable[] = {
    ...
    { Format::ID::A1R5G5B5_UNORM, GL_A1R5G5B5_ANGLEX, GL_A1R5G5B5_ANGLEX, GenerateMip<A1R5G5B5>, NoCopyFunctions, ReadColor<A1R5G5B5, GLfloat>, WriteColor<A1R5G5B5, GLfloat>, GL_UNSIGNED_NORMALIZED, 5, 5, 5, 1, 0, 0 },
