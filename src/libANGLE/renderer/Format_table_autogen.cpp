...
constexpr Format g_formatInfoTable[] = {
    ...
    { Format::ID::A1R5G5B5_TYPELESS_UNORM, GL_A1R5G5B5_TYPELESS_ANGLEX, GL_A1R5G5B5_TYPELESS_ANGLEX, GenerateMip<A1R5G5B5>, NoCopyFunctions, ReadColor<A1R5G5B5, GLfloat>, WriteColor<A1R5G5B5, GLfloat>, GL_UNSIGNED_NORMALIZED, 5, 5, 5, 1, 0, 0 },
...
Format::ID Format::InternalFormatToID(GLenum internalFormat)
{
    switch (internalFormat)
    {
        ...
        case GL_A1R5G5B5_TYPELESS_ANGLEX:
            return Format::ID::A1R5G5B5_TYPELESS_UNORM;
