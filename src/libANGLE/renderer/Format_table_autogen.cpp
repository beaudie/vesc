...
constexpr Format g_formatInfoTable[] = {
    ...
    { Format::ID::D16_UNORM, GL_DEPTH_COMPONENT16, GL_DEPTH_COMPONENT16, GenerateMip<D16>, NoCopyFunctions, ReadColor<D16, GLfloat>, WriteColor<D16, GLfloat>, GL_UNSIGNED_NORMALIZED, 0, 0, 0, 0, 16, 0, 2, false },
    { Format::ID::D24_UNORM, GL_DEPTH_COMPONENT24, GL_DEPTH_COMPONENT24, GenerateMip<D24>, NoCopyFunctions, ReadColor<D24, GLfloat>, WriteColor<D24, GLfloat>, GL_UNSIGNED_NORMALIZED, 0, 0, 0, 0, 24, 0, 3, false },
    { Format::ID::D24_UNORM_S8_UINT, GL_DEPTH24_STENCIL8, GL_DEPTH24_STENCIL8, GenerateMip<D24S8>, NoCopyFunctions, ReadColor<D24S8, GLfloat>, WriteColor<D24S8, GLfloat>, GL_UNSIGNED_NORMALIZED, 0, 0, 0, 0, 24, 8, 4, false },
    { Format::ID::D32_FLOAT, GL_DEPTH_COMPONENT32F, GL_DEPTH_COMPONENT32F, GenerateMip<D32F>, NoCopyFunctions, ReadColor<D32F, GLfloat>, WriteColor<D32F, GLfloat>, GL_FLOAT, 0, 0, 0, 0, 32, 0, 4, false },
    { Format::ID::D32_FLOAT_S8X24_UINT, GL_DEPTH32F_STENCIL8, GL_DEPTH32F_STENCIL8, GenerateMip<D32S8F>, NoCopyFunctions, ReadColor<D32S8F, GLfloat>, WriteColor<D32S8F, GLfloat>, GL_FLOAT, 0, 0, 0, 0, 32, 8, 8, false },
    { Format::ID::D32_UNORM, GL_DEPTH_COMPONENT32_OES, GL_DEPTH_COMPONENT32_OES, GenerateMip<D32>, NoCopyFunctions, ReadColor<D32, GLfloat>, WriteColor<D32, GLfloat>, GL_UNSIGNED_NORMALIZED, 0, 0, 0, 0, 32, 0, 4, false },
    ...
    { Format::ID::S8_UINT, GL_STENCIL_INDEX8, GL_STENCIL_INDEX8, GenerateMip<S8>, NoCopyFunctions, ReadColor<S8, GLuint>, WriteColor<S8, GLuint>, GL_UNSIGNED_INT, 0, 0, 0, 0, 0, 8, 1, false },
    // clang-format on
};
