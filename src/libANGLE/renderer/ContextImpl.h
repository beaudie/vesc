...
class ContextImpl : public GLImplFactory
{
  public:
    ...
    virtual angle::Result acquireTextures(const gl::TextureVector &textures, const GLenum *layouts);
    virtual angle::Result releaseTextures(const gl::TextureVector &textures, GLenum *layouts);
