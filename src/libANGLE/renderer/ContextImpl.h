...
class ContextImpl : public GLImplFactory
{
  public:
    ...
    virtual angle::Result acquireTextures(const gl::TextureVector &, const uint *layouts);
    virtual angle::Result releaseTextures(const gl::TextureVector &, uint *layouts);
