...
class ContextImpl : public GLImplFactory
{
  public:
    ...
    virtual angle::Result acquireTextures(const gl::TextureBarrierVector &textureBarriers);
    virtual angle::Result releaseTextures(gl::TextureBarrierVector *textureBarriers);
