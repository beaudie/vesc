...
class ContextImpl : public GLImplFactory
{
  public:
    ...
    virtual angle::Result acquireTextures(const gl::TextureVector &textures, const uint *layouts);
    virtual angle::Result releaseTextures(const gl::TextureVector &textures, uint *layouts);
