...
class CLContextImpl : angle::NonCopyable
{
  public:
    ...
    using Array = std::vector<CLContextImpl *>;

    CLContextImpl(CLPlatformImpl &platform, CLDeviceImpl::Array &&devices);
...
inline const CLDeviceImpl::Array &CLContextImpl::getDevices() const
{
    return mDevices;
}
