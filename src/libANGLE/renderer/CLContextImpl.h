...
class CLContextImpl : angle::NonCopyable
{
  public:
    ...
    virtual angle::Result getDevices(cl::DevicePtrs &devPtrs) const = 0;

    virtual angle::Result createCommandQueue(const cl::CommandQueue &commandQueue,
                                             CLCommandQueueImpl::Ptr &implPtr) = 0;
    ...
    virtual angle::Result createUserEvent(const cl::Event &event, CLEventImpl::Ptr &implPtr) = 0;
