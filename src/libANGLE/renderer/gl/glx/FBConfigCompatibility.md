...
a context to be able to render to a surface, both their config
must be compatible. Compatibility is losely described in both
the GLX and EGL specs but we the following is clear:
...
the confusion and call GLX context our backing context.
