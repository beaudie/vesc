                                         ...
                                         glx::Context *context)
{
    ...
    const ContextCreationInfo contextsToTry[] = {
        { EGL_PLATFORM_ANGLE_TYPE_OPENGL_ANGLE, GLX_CONTEXT_CORE_PROFILE_BIT_ARB, gl::Version(0, 0) },
        { EGL_PLATFORM_ANGLE_TYPE_OPENGL_ANGLE, 0, gl::Version(0, 0) },
        { EGL_PLATFORM_ANGLE_TYPE_OPENGLES_ANGLE, GLX_CONTEXT_ES2_PROFILE_BIT_EXT, gl::Version(0, 0) },
    };
    ...
    size_t toTryLength = std::extent<decltype(contextsToTry)>::value;
    if (mIsMesa)
    {
        toTry       = mesaContextsToTry;
        toTryLength = std::extent<decltype(mesaContextsToTry)>::value;
    }
