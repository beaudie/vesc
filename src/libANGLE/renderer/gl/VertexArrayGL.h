...
class VertexArrayGL : public VertexArrayImpl
{
  ...
  private:
    ...
    bool arrayBufferUsageChanged(size_t bindingIndex) const;
    bool attributeNeedsStreaming(size_t attribIndex) const;
    bool usesClientMemoryPointer(size_t attribIndex) const;
    void updateNeedsStreaming(size_t attribIndex);
    void updateClientMemoryPointer(size_t attribIndex);

    bool vertexAttribEnabledChanged(size_t attribIndex) const;
    bool vertexAttribPointerChanged(size_t attribIndex) const;
    bool vertexBindingDivisorChanged(size_t bindingIndex) const;
    void updateAttribEnabled(size_t attribIndex);
    void updateAttribPointerWithArrayBuffer(size_t attribIndex);
