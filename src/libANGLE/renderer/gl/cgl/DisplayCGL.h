...
class DisplayCGL : public DisplayGL
{
  public:
    ...
    egl::Error restoreLostDevice(const egl::Thread *thread) override;
    ...
    egl::Error waitClient(const egl::Thread *thread) const override;
    egl::Error waitNative(const egl::Thread *thread, EGLint engine) const override;
