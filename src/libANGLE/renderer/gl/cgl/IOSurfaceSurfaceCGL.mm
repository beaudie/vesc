...
static const IOSurfaceFormatInfo kIOSurfaceFormats[] = {
    {GL_RED,      GL_RED,         GL_UNSIGNED_BYTE,  1, GL_RED,  GL_RED,  GL_UNSIGNED_BYTE           },
    {GL_R8UI,     GL_RED_INTEGER, GL_UNSIGNED_SHORT, 2, GL_RED,  GL_RED,  GL_UNSIGNED_SHORT          },
    {GL_RG,       GL_RG,          GL_UNSIGNED_BYTE,  2, GL_RG,   GL_RG,   GL_UNSIGNED_BYTE           },
    {GL_BGRA_EXT, GL_BGRA_EXT,    GL_UNSIGNED_BYTE,  4, GL_BGRA, GL_RGBA, GL_UNSIGNED_INT_8_8_8_8_REV},
    {GL_RGBA,     GL_RGBA,        GL_HALF_FLOAT,     8, GL_RGBA, GL_RGBA, GL_HALF_FLOAT              },
};
// clang-format on
...
egl::Error IOSurfaceSurfaceCGL::bindTexImage(gl::Texture *texture, EGLint buffer)
{
    ...
    auto error         = CGLTexImageIOSurface2D(mDisplay->getCGLContext(), GL_TEXTURE_RECTANGLE,
                                        format.nativeFormat, mWidth, mHeight, format.nativeInternalFormat,
