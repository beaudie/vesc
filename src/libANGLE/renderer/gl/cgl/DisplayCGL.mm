...
egl::Error DisplayCGL::restoreLostDevice(const egl::Thread *thread)
{
    UNIMPLEMENTED();
    return egl::EglBadDisplay();
}
...
egl::Error DisplayCGL::waitClient(const egl::Thread *thread) const
{
    // TODO(cwallez) UNIMPLEMENTED()
    return egl::NoError();
}

egl::Error DisplayCGL::waitNative(const egl::Thread *thread, EGLint engine) const
{
    // TODO(cwallez) UNIMPLEMENTED()
    return egl::NoError();
}
