                                                       ...
                                                       ExternalContextState *state)
{
    ...
    if (extensions.vertexArrayObjectOES)
    {
        ...
        ERR() << "EEEE state->vertexArrayBinding=" << state->vertexArrayBinding;
        ERR() << "EEEE glIsVertexArray()=" << (int)mFunctions->isVertexArray(state->vertexArrayBinding);
        bindVertexArray(0, 0);
    }
    ...
    for (size_t i = 0; i < state->vertexAttrib.size(); ++i)
    {
        ...
        // {
        //     mFunctions->getVertexAttribiv(i, GL_VERTEX_ATTRIB_ARRAY_DIVISOR,
        //     &vertexAttrib.divisor);
        // }
                                                      ...
                                                      const ExternalContextState *state)
{
    ...
    ERR() << "EEEE state->vertexArrayBinding=" << state->vertexArrayBinding;
    ERR() << "EEEE mFunctions->getError()=" << std::hex << mFunctions->getError();
    ASSERT(mFunctions->getError() == GL_NO_ERROR);
}
