                                                 ...
                                                 GLsizei instanceCount)
{
    ...
    ANGLE_TRY_FAST(vaoGL->syncDrawArraysState(context, program->getActiveAttribLocationsMask(),
                                                   ...
                                                   const void **outIndices)
{
    ...
    ANGLE_TRY_FAST(vaoGL->syncDrawElementsState(context, program->getActiveAttribLocationsMask(),
