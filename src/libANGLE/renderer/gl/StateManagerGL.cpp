                                           ...
                                           ExternalContextState *state)
{
    ...
    if (mDepthTestEnabled != static_cast<bool>(state->depthTest))
    {
    ...
    if (mCullFaceEnabled != static_cast<bool>(state->cullFace))
    {
    ...
    if (mDepthMask != static_cast<bool>(state->depthMask))
    {
    ...
    if (mSampleCoverageValue != state->sampleCoverageValue ||
        mSampleCoverageInvert != static_cast<bool>(state->sampleCoverageInvert))
    {
    ...
    if (mDitherEnabled != static_cast<bool>(state->enableDither))
    {
    ...
    if (mPolygonOffsetFillEnabled != static_cast<bool>(state->enablePolygonOffsetFill))
    {
    ...
    if (mSampleAlphaToOneEnabled != static_cast<bool>(state->enableSampleAlphaToCoverage))
    {
    ...
    if (mSampleCoverageEnabled != static_cast<bool>(state->enableSampleCoverage))
    {
    ...
    if (extensions.multisampleCompatibility)
    {
        ...
        if (mMultisamplingEnabled != static_cast<bool>(state->multisampleEnabled))
        {
