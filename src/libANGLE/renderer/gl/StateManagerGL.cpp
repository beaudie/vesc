...
ANGLE_INLINE bool DrawBuffersNeedMasking(const gl::Program *program,
                                         const gl::Framebuffer *drawFramebuffer)
{
    return (program->getActiveOutputVariables() & drawFramebuffer->getEnabledDrawBuffers()) !=
           drawFramebuffer->getEnabledDrawBuffers();
}
}  // namespace
...
StateManagerGL::StateManagerGL(const FunctionsGL *functions,
    ...
    : mFunctions(functions),
      ...
      mDrawBuffersValid(true),
      mDrawBuffersNeedMasking(false),
...
ANGLE_INLINE void StateManagerGL::updateDrawBuffersNeedsMasking(
    ...
    const gl::Framebuffer *drawFramebuffer)
{
    mDrawBuffersNeedMasking = DrawBuffersNeedMasking(program, drawFramebuffer);
    mDrawBuffersValid       = false;
}
...
void StateManagerGL::syncDrawBuffersStateImpl(const gl::Context *context, bool isDrawCommand)
{
    ...
    if (isDrawCommand && mDrawBuffersNeedMasking && program)
    {
