...
void RendererGL::syncState(const gl::Data &data, const gl::State::DirtyBits &dirtyBits)
{
    mStateManager->syncState(*data.state, dirtyBits);
}

bool RendererGL::shouldClearDirtyBitsAfterSync() const
{
    return true;
}
}
