...
TextureImpl *RendererGL::createTexture(GLenum target, const gl::TextureState &data)
{
    return new TextureGL(target, mFunctions, mWorkarounds, mStateManager, mBlitter, data);
}
