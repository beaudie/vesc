      ...
      mNativeParallelCompileEnabled(false)
{
    ...
    mWorkarounds.overrideFeatures(display->getState().featureOverridesEnabled, true);
    mWorkarounds.overrideFeatures(display->getState().featureOverridesDisabled, false);
