...
// RendererGL.h: Defines a renderer class for OpenGL.
...
class RendererGL : public Renderer
{
  public:
    ...
    gl::Error drawArrays(const gl::Data &data, GLenum mode, GLint first, GLsizei count, GLsizei instances) override;
    gl::Error drawElements(const gl::Data &data, GLenum mode, GLsizei count, GLenum type, const GLvoid *indices, GLsizei instances, const RangeUI &indexRange) override;
