...
gl::AtomicCounterBufferSizeMap ProgramGL::getAtomicCounterBufferSizeMap() const
{
    gl::AtomicCounterBufferSizeMap sizeMap;
...
void ProgramGL::linkResources(const gl::ProgramLinkedResources &resources)
{
    ...
    resources.atomicCounterBufferLinker.link(getAtomicCounterBufferSizeMap());
}
