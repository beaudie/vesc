...
void InitializeFeatures(const FunctionsGL *functions, angle::FeaturesGL *features)
{
    ...
    ANGLE_FEATURE_CONDITION(features, emulateSizedLUMAFormats,
                            functions->isAtLeastGLES(gl::Version(3, 0)) &&
                                !functions->hasGLESExtension("GL_EXT_texture_storage"));
    // ANGLE_LOG(WARN) << "functions->isAtLeastGLES(gl::Version(3, 0)): "
    //                 << functions->isAtLeastGLES(gl::Version(3, 0));
    // ANGLE_LOG(WARN) << "functions->hasGLESExtension(\"GL_EXT_texture_storage\"): "
    //                 << functions->hasGLESExtension("GL_EXT_texture_storage");
}
