...
{
    if (IsApple() && SupportsVertexArrayObjects(functions))
    {
        // Apple doesn't expose the core profile bit so we never use the default VAO as long as
        // there is any kind of VAO support.
        return false;
    }
