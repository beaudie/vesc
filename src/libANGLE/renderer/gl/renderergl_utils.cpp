    ...
    *maxSupportedESVersion = gl::Version(3, 1);
    ...
    else
    {
        ...
        extensions->shaderPixelLocalStorageANGLE =
            hasFragmentShaderImageLoadStore ||
            features.supportsNativeShaderFramebufferFetchNonCoherentEXT.enabled;
    ...
    if (features.supportsNativeShaderFramebufferFetchNonCoherentEXT.enabled)
    {
...
void InitializeFeatures(const FunctionsGL *functions, angle::FeaturesGL *features)
{
    ...
    // EXT_shader_framebuffer_fetch_non_coherent
    ANGLE_FEATURE_CONDITION(
        features, supportsNativeShaderFramebufferFetchNonCoherentEXT,
