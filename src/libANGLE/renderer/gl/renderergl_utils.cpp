...
uint32_t GetDeviceID(const FunctionsGL *functions)
{
    ...
    constexpr std::pair<const char *, uint32_t> kKnownDeviceIDs[] = {
        ...
        {"Adreno (TM) 430", ANDROID_DEVICE_ID_NEXUS6P},
        {"Adreno (TM) 530", ANDROID_DEVICE_ID_PIXEL1XL},
        {"Adreno (TM) 540", ANDROID_DEVICE_ID_PIXEL2},
        {"Adreno (TM) 630", ANDROID_DEVICE_ID_PIXEL3XL},
        {"Adreno (TM) 330", ANDROID_DEVICE_ID_NEXUS5},
        {"Adreno (TM) 420", ANDROID_DEVICE_ID_NEXUS6},
        {"NVIDIA Tegra", ANDROID_DEVICE_ID_NVIDIATEGRA},
    };
...
void GenerateWorkarounds(const FunctionsGL *functions, WorkaroundsGL *workarounds)
{
    ...
    workarounds->clampPointSize = IsAndroid();
    ...
    workarounds->unsizedsRGBReadPixelsDoesntTransform = IsAndroid();
