...
bool IsAdreno42xAndOlder(const FunctionsGL *functions)
{
...
void InitializeFeatures(const FunctionsGL *functions, angle::FeaturesGL *features)
{
    ...
    // crbug.com/1171371
    // If output variables are not assigned value, it may cause context lost for Adreno 42x and 3xx.
    ANGLE_FEATURE_CONDITION(features, initOutputVariables, IsAdreno42xAndOlder(functions));
}
