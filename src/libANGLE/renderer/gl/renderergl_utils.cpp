                  ...
                  gl::Extensions *extensions, gl::Version *maxSupportedESVersion)
{
    ...
    *maxSupportedESVersion = gl::Version(3, 0);
    ...
    // The gl-uniform-arrays WebGL conformance test struggles to complete on time if the max uniform
    // vectors is too large.  Artificially limit the maximum until the test is updated.
