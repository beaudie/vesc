                  ...
                  MultiviewImplementationTypeGL *multiviewImplementationType)
{
    ...
    *maxSupportedESVersion = gl::Version(3, 1);
    ...
    extensions->webglVideoTextureWEBGL = !IsAndroid() && !IsApple();
...
{
    return (functions->mapBufferRangeEXT != nullptr) ||
...
uint8_t *MapBufferRangeWithFallback(const FunctionsGL *functions,
                                    ...
                                    GLbitfield access)
{
    if (functions->mapBufferRangeEXT != nullptr)
    {
        return static_cast<uint8_t *>(functions->mapBufferRangeEXT(target, offset, length, access));
    }
