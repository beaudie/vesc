                  ...
                  MultisampleTextureEXT *multisampleTextureExt)
{
    ...
    *maxSupportedESVersion = gl::Version(3, 1);
    ...
    if (functions->hasGLExtension("GL_ARB_texture_multisample"))
    {
        *multisampleTextureExt = MultisampleTextureEXT::ARB_TEXTURE_MULTISAMPLE;
    }
    ...
    extensions->textureMultisample =
        functions->isAtLeastGL(gl::Version(3, 2)) || functions->isAtLeastGLES(gl::Version(3, 1));
    functions->hasGLExtension("GL_ARB_texture_multisample");
