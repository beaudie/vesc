...
static const gl::BufferTarget SourceBufferOperationTarget = gl::BufferTarget::CopyRead;
...
static const gl::BufferTarget DestBufferOperationTarget = gl::BufferTarget::Array;
