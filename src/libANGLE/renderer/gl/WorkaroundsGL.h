...
struct WorkaroundsGL
{
    ...
    // On some NVIDIA drivers certain types of GLSL arithmetic ops mixing vectors and scalars may be executed incorrectly. Change them in the shader translator.
    // Tracking bug: http://crbug.com/772651
