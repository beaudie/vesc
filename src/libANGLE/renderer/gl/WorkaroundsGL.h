...
struct WorkaroundsGL
{
    ...
    // Calling getInternalformativ for GL_NUM_SAMPLES and the internal format GL_BGRA8_EXT generates
    // a GL_INVALID_ENUM error on macOS and on some OpenGL drivers on other OSs.
