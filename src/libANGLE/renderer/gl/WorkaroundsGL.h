...
struct WorkaroundsGL : angle::FeaturesStruct
{
    WorkaroundsGL();
    ~WorkaroundsGL();
    ...
    angle::Feature avoid1BitAlphaTextureFormats =
        angle::Feature("avoid_1_bit_alpha_texture_formats",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature rgba4IsNotSupportedForColorRendering =
        angle::Feature("rgba4_is_not_supported_for_color_rendering",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature doesSRGBClearsOnLinearFramebufferAttachments =
        angle::Feature("does_srgb_clears_on_linear_framebuffer_attachments",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature doWhileGLSLCausesGPUHang =
        angle::Feature("do_while_glsl_causes_gpu_hang",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature finishDoesNotCauseQueriesToBeAvailable = angle::Feature(
    ...
    angle::Feature alwaysCallUseProgramAfterLink =
        angle::Feature("always_call_use_program_after_link",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
                       "Always call useProgram after a successful link to avoid a driver bug",
                       &members);

    // In the case of unpacking from a pixel unpack buffer, unpack overlapping rows row by row.
    angle::Feature unpackOverlappingRowsSeparatelyUnpackBuffer = angle::Feature(
    ...
    angle::Feature packOverlappingRowsSeparatelyPackBuffer = angle::Feature(
    ...
    angle::Feature initializeCurrentVertexAttributes = angle::Feature(
    ...
    angle::Feature emulateAbsIntFunction =
        angle::Feature("emulate_abs_int_function",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature addAndTrueToLoopCondition =
        angle::Feature("add_and_true_to_loop_condition",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
                       "On Intel Mac, calculation of loop conditions in for and while loop has bug",
                       &members);
    ...
    angle::Feature unpackLastRowSeparatelyForPaddingInclusion = angle::Feature(
    ...
    angle::Feature packLastRowSeparatelyForPaddingInclusion = angle::Feature(
    ...
    angle::Feature emulateIsnanFloat =
        angle::Feature("emulate_isnan_float",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature useUnusedBlocksWithStandardOrSharedLayout =
        angle::Feature("use_unused_blocks_with_standard_or_shared_layout",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    // on AMD.
    angle::Feature dontRemoveInvariantForFragmentInput = angle::Feature(
    ...
    angle::Feature removeInvariantAndCentroidForESSL3 =
        angle::Feature("remove_invarient_and_centroid_for_essl3",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature rewriteFloatUnaryMinusOperator =
        angle::Feature("rewrite_float_unary_minus_operator",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature emulateAtan2Float =
        angle::Feature("emulate_atan_2_float",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
                       "On NVIDIA drivers, atan(y, x) may return a wrong answer",
                       &members,
    ...
    angle::Feature reapplyUBOBindingsAfterUsingBinaryProgram =
        angle::Feature("reapply_ubo_bindings_after_using_binary_program",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature emulateMaxVertexAttribStride = angle::Feature(
    ...
    angle::Feature dontInitializeUninitializedLocals = angle::Feature(
    ...
    angle::Feature rewriteVectorScalarArithmetic =
        angle::Feature("rewrite_vector_scalar_arithmetic",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature dontUseLoopsToInitializeVariables =
        angle::Feature("dont_use_loops_to_initialize_variables",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature clampFragDepth =
        angle::Feature("clamp_frag_depth",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature rewriteRepeatedAssignToSwizzled =
        angle::Feature("rewrite_repeated_assign_to_swizzled",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature disableBlendFuncExtended = angle::Feature(
    ...
    angle::Feature unsizedsRGBReadPixelsDoesntTransform =
        angle::Feature("unsized_srgb_read_pixels_doesnt_transform",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature queryCounterBitsGeneratesErrors = angle::Feature(
    ...
    angle::Feature dontRelinkProgramsInParallel =
        angle::Feature("query_counter_bits_generates_errors",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
    ...
    angle::Feature disableWorkerContexts =
        angle::Feature("disable_worker_contexts",
                       angle::FeatureCategory::OPENGL_WORKAROUNDS,
