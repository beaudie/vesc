...
struct WorkaroundsGL
{
    ...
    // On Mac with OpenGL version lower than 4.5, unused std140 or shared uniform blocks will be
    // treated as inactive which is not consistent with WebGL2.0 spec. Use all members in a unused
    // std140 or shared uniform block at the beginning of main to work around it.
