...
struct WorkaroundsGL : angle::FeatureSetBase
{
    ...
    // on AMD.
    angle::Feature dontRemoveInvariantForFragmentInput = {
        "dont_remove_invariant_for_fragment_input", angle::FeatureCategory::OpenGLWorkarounds,
        "On AMD GLSL >=4.20, keep invariant declaration for input in fragment shader", &members};
