...
struct WorkaroundsGL
{
    ...
    // Always call useProgram after a successful to avoid a driver bug.
    // This workaround is meant to reproduce the use_current_program_after_successful_link
    // workaround in Chromium. It has been shown that this workaround is not necessary for MacOSX
    // 10.9 and higher.
