...
{
  public:
    FunctionsGLDRM(PFNGETPROCPROC getProc)
      : mGetProc(getProc)
    {
    }
...
egl::Error DisplayDRM::initialize(egl::Display *display)
{
    ...
    if (!mDRM.initialize(xDisplay, DefaultScreen(xDisplay), &drmInitError))
    {
...
#endif
    return egl::Error(EGL_NOT_INITIALIZED, "DisplayDRM::initialize not implemented.");
}
