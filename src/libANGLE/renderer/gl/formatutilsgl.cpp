...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    // TODO: GL_BGRA8_EXT texture is possible on ES in presence of either GL_EXT_texture_format_BGRA8888 or GL_APPLE_texture_format_BGRA8888, but we don't have a construct to express "extension A or extension B"
    InsertFormatMapping(&map, GL_BGRA8_EXT,         VersionOrExts(1, 2, "GL_EXT_bgra"),               Always(), VersionOrExts(1, 2, "GL_EXT_bgra"),            ExtsOnly("GL_EXT_texture_format_BGRA8888"),   Never(),  Never()                                   );
    ...
    InsertFormatMapping(&map, GL_DEPTH_COMPONENT32_OES, VersionOnly(1, 5),                                  VersionOrExts(1, 5, "GL_ARB_depth_texture"), VersionOnly(1, 5),                                  ExtsOnly("EXT_texture_storage"),             Never(),                                     ExtsOnly("GL_OES_depth32")                                             );
