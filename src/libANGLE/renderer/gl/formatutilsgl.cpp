                                      ...
                                      GLenum sizedInternalFormat)
{
    ...
    else if (functions->isAtLeastGLES(gl::Version(3, 0)))
    {
        ...
        if (formatInfo.format == GL_LUMINANCE || formatInfo.format == GL_LUMINANCE_ALPHA ||
            formatInfo.format == GL_ALPHA)
        {
            // Luminance alpha formats don't have sized versions without extensions.  Just use the
            // unsized formats.
