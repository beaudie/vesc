...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    InsertFormatMapping(&map, GL_SRGB8_ALPHA8,      VersionOrExts(2, 1, "GL_EXT_texture_sRGB"),       Always(), VersionOrExts(2, 1, "GL_EXT_texture_sRGB"),    VersionOnly(3, 0),                          Always(), VersionOnly(3, 0)                         );
    ...
    InsertFormatMapping(&map, GL_SRGB,              VersionOrExts(2, 1, "GL_EXT_texture_sRGB"),       Always(), Never(),                                       ExtsOnly("GL_EXT_sRGB"),                    Always(), Never()                                   );
    InsertFormatMapping(&map, GL_SRGB_ALPHA,        VersionOrExts(2, 1, "GL_EXT_texture_sRGB"),       Always(), Never(),                                       ExtsOnly("GL_EXT_sRGB"),                    Always(), Never()                                   );

    // From GL_EXT_texture_format_BGRA8888
    InsertFormatMapping(&map, GL_BGRA8_EXT,         VersionOrExts(1, 2, "GL_EXT_bgra"),               Always(), VersionOrExts(1, 2, "GL_EXT_bgra"),            ExtsOnly("GL_APPLE_texture_format_BGRA8888"), Never(),  Never()                                   );
    ...
    InsertFormatMapping(&map, GL_DEPTH_COMPONENT32_OES, VersionOnly(1, 5),                                  VersionOrExts(1, 5, "GL_ARB_depth_texture"), VersionOnly(1, 5),                                  Never(),                                     Never(),                                     ExtsOnly("GL_OES_depth32")                                             );
