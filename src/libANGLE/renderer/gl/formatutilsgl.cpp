...
InternalFormat::InternalFormat()
    : texture(), filter(), textureAttachment(), renderbufferAttachment()
{
}
                                       ...
                                       const SupportRequirement &esRenderbufferAttachment)
{
    ...
    formatInfo.glInfo.renderbufferAttachment   = desktopRender;
    ...
    formatInfo.glesInfo.renderbufferAttachment = esRenderbufferAttachment;
