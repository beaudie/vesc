...
template <typename T>
static void AssignGLExtensionEntryPoint(const std::vector<std::string> &extensions, const std::string &requiredExtensions,
                                        void *function, T *outFunction)
{
    std::istringstream stream(requiredExtensions);

    std::string requiredExtension;
    while (std::getline(stream, requiredExtension, ' '))
    {
