...
void InitializeTableDesktopGLNULL(DispatchTableGL *table, FunctionsGL *functionsGL, const std::set<std::string> &extensions)
{
    ...
    if (version >= gl::Version(4, 2))
    {
        ...
        ASSIGN_NULL("glDrawElementsInstancedBaseVertexBaseInstance", drawElementsInstancedBaseVertexBaseInstance);
    ...
    if (version >= gl::Version(4, 5))
    {
        ...
        ASSIGN_NULL("glGetNamedFramebufferAttachmentParameteriv", getNamedFramebufferAttachmentParameteriv);
    ...
    if (extensions.count("GL_EXT_direct_state_access") != 0)
    {
        ...
        ASSIGN_NULL("glGetNamedFramebufferAttachmentParameterivEXT", getNamedFramebufferAttachmentParameteriv);
        ...
        ASSIGN_NULL("glNamedRenderbufferStorageMultisampleEXT", namedRenderbufferStorageMultisample);
    ...
    if (extensions.count("GL_EXT_framebuffer_object") != 0)
    {
        ...
        ASSIGN_NULL("glGetFramebufferAttachmentParameterivEXT", getFramebufferAttachmentParameteriv);
    ...
    if (extensions.count("GL_NV_path_rendering") != 0)
    {
        ...
        ASSIGN_NULL("glStencilThenCoverStrokePathInstancedNV", stencilThenCoverStrokePathInstancedNV);
...
void InitializeTableGLESNULL(DispatchTableGL *table, FunctionsGL *functionsGL, const std::set<std::string> &extensions)
{
    ...
    if (extensions.count("GL_EXT_base_instance") != 0)
    {
        ...
        ASSIGN_NULL("glDrawElementsInstancedBaseVertexBaseInstanceEXT", drawElementsInstancedBaseVertexBaseInstance);
    }
