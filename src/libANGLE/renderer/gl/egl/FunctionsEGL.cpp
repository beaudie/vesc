...
egl::Error FunctionsEGL::initialize(EGLNativeDisplayType nativeDisplay, void *nativeLibHandle)
{
    mLibHandle = nativeLibHandle;
...
#define ANGLE_GET_PROC_OR_ERROR(MEMBER, NAME)                                            \
    ...
    // Get this one first so it can be used to get others.
