...
#define ANGLE_GET_PROC_OR_ERROR(MEMBER, NAME)                                           \
    ...
    {
        // Older version of Angle announced this extension without implementing the following
        // functions. Fail softly to avoid crashes when running nested on such versions. See
        // anglebug.com/7664 for details.
