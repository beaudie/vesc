...
struct FunctionsEGL::EGLFunctionTable
{
    ...
    EGLBoolean (*chooseConfigPtr)(EGLDisplay display, EGLint const * attrib_list, EGLConfig *configs, EGLint config_size, EGLint *num_config);
    EGLBoolean (*getConfigAttribPtr)(EGLDisplay display, EGLConfig config, EGLint attribute, EGLint *value);
...
EGLBoolean FunctionsEGL::chooseConfig(EGLint const *attribList, EGLConfig *configs, EGLint configSize, EGLint *numConfig)
{
...
EGLImageKHR FunctionsEGL::createImageKHR(EGLContext context, EGLenum target, EGLClientBuffer buffer, const EGLint *attrib_list) const
{
