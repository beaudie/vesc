...
egl::Error DisplayAndroid::restoreLostDevice(const egl::Thread *thread)
{
    UNIMPLEMENTED();
    return egl::NoError();
}
...
egl::Error DisplayAndroid::waitClient(const egl::Thread *thread) const
{
    UNIMPLEMENTED();
    return egl::NoError();
}

egl::Error DisplayAndroid::waitNative(const egl::Thread *thread, EGLint engine) const
{
    UNIMPLEMENTED();
    return egl::NoError();
}
