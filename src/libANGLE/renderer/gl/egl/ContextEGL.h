...
// ContextEGL.h: Context class for GL on EGL platforms.  Wraps a RendererEGL.
...
{
  public:
    ContextEGL(const gl::ContextState &state, std::shared_ptr<RendererEGL> renderer);
    ~ContextEGL() override;
...
#endif  // LIBANGLE_RENDERER_GL_EGL_CONTEXTEGL_H_
