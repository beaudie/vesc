  ...
  public:
    ...
    class Buffer final : angle::NonCopyable
    {
      public:
        ...
        egl::Error attachToFramebuffer(const gl::Context *context, FramebufferImpl *framebuffer);
        egl::Error detachFromFramebuffer(const gl::Context *context, FramebufferImpl *framebuffer);
