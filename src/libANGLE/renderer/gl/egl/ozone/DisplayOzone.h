...
#ifndef LIBANGLE_RENDERER_GL_OZONE_DISPLAYOZONE_H_
#define LIBANGLE_RENDERER_GL_OZONE_DISPLAYOZONE_H_
...
class DisplayOzone final : public DisplayGL
{
  ...
  private:
    ...
    // holds display size, so we can easily make a buffer that size
...
#endif  // LIBANGLE_RENDERER_GL_OZONE_DISPLAYOZONE_H_
