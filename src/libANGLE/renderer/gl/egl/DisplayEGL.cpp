...
RobustnessVideoMemoryPurgeStatus GetRobustnessVideoMemoryPurge(const egl::AttributeMap &attribs)
{
    return static_cast<RobustnessVideoMemoryPurgeStatus>(
...
void DisplayEGL::generateExtensions(egl::DisplayExtensions *outExtensions) const
{
    ...
    outExtensions->createContextRobustness = mHasEXTCreateContextRobustness;
