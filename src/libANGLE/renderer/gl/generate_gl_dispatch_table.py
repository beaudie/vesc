...
for comment, entry_points in json_data.iteritems():
    for entry_point_no_prefix in entry_points:
        ...
        if entry_point in gl_extension_commands:
            found = True
            for extension in gl_extension_commands[entry_point]:
                safe_append(gl_extension_requirements, extension, entry_point)

        if entry_point in gles2_extension_commands:
            found = True
            for extension in gles2_extension_commands[entry_point]:
