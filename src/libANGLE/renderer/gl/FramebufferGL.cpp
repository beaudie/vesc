                                        ...
                                        void *pixels)
{
    ...
    bool useOverlappingRowsWorkaround =
        workarounds.packOverlappingRowsSeparatelyPackBuffer.applied && packBuffer &&
    ...
    if (workarounds.packLastRowSeparatelyForPaddingInclusion.applied)
    {
...
void FramebufferGL::syncClearState(const gl::Context *context, GLbitfield mask)
{
    ...
    if (functions->standard == STANDARD_GL_DESKTOP)
    {
        ...
        if (workarounds.doesSRGBClearsOnLinearFramebufferAttachments.applied &&
