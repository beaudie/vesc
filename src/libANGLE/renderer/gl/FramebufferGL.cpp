                                                      ...
                                                      const gl::Rectangle &destArea)
{
    ...
    bounds.sourceRegion =
        gl::Rectangle(sourceArea.x, sourceArea.y, sourceArea.width, sourceArea.height);
    bounds.sourceRegion = bounds.sourceRegion.removeReversal();

    bounds.destBounds = gl::Rectangle(0, 0, drawSize.width, drawSize.height);
    bounds.destRegion = gl::Rectangle(destArea.x, destArea.y, destArea.width, destArea.height);
    bounds.destRegion = bounds.destRegion.removeReversal();
