                                ...
                                void *ptrOrOffset) const
{
    ...
    {
        retVal = readPixelsRowByRow(area, readFormat, readType, packState, pixels);
    }
    else
    {
        ...
        retVal = readPixelsAllAtOnce(area, readFormat, readType, packState, pixels,
                                     useLastRowPaddingWorkaround);
    }

    packState.pixelBuffer.set(nullptr);
    return retVal;
}
