  ...
  public:
                             ...
                             GLubyte *pixels)
    {
        ...
        if (enabled)
        {
            ...
            auto checkedAllocatedBytes = 32 + checkedSkipBytes + checkedRowBytes * checkedRows;
                                              ...
                                              GLubyte *tmpPixels)
{
    ...
    // We don't care the behavior when pack.rowLength < area.width
                                                ...
                                                GLubyte *pixels) const
{
    ...
    angle::Result result = workaround.Initialize(context, area, originalReadFormat, format, type,
                                                 skipBytes, rowBytes, pack, pixels);
    if (result != angle::Result::Continue)
    {
        return result;
    }
