                                           ...
                                           gl::Rectangle *newDestArea)
{
    ...
    if (!bounds.sourceBounds.encloses(bounds.sourceRegion))
    {
        ...
        GLuint destMappingX0 = std::round(bounds.destX + destMappingXOffset);
        GLuint destMappingY0 = std::round(bounds.destY + destMappingYOffset);

        GLuint destMappingX1 = std::round(bounds.destX + destMappingXOffset + destMappingWidth);
        GLuint destMappingY1 = std::round(bounds.destY + destMappingYOffset + destMappingHeight);
