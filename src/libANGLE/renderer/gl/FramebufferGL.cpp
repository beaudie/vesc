    ...
    if (mWorkarounds.limitBlitFramebufferDimensions)
    {
        ...
        if (widthOutOfRange || heightOutOfRange)
        {
            if (destArea.width() == sourceArea.width() &&
                ...
                destArea.flipX() == sourceArea.flipX() && destArea.flipY() == sourceArea.flipY())
            {
                ...
                gl::BlitRectangle unflippedSourceArea(sourceArea);
                gl::BlitRectangle unflippedDestArea(destArea);
                unflippedSourceArea.removeFlip();
                unflippedDestArea.removeFlip();
