...
Error FramebufferGL::clear(const ContextImpl *context, GLbitfield mask)
{
    syncClearState(mask);
    mStateManager->bindFramebuffer(GL_FRAMEBUFFER, mFramebufferID);
...
Error FramebufferGL::clearBufferfv(const ContextImpl *context,
                                   GLenum buffer,
                                   GLint drawbuffer,
...
Error FramebufferGL::clearBufferuiv(const ContextImpl *context,
                                    GLenum buffer,
                                    GLint drawbuffer,
                                    const GLuint *values)
{
...
Error FramebufferGL::clearBufferiv(const ContextImpl *context,
                                   GLenum buffer,
                                   GLint drawbuffer,
                                   const GLint *values)
{
...
Error FramebufferGL::clearBufferfi(const ContextImpl *context,
                                   GLenum buffer,
                                   GLint drawbuffer,
                                   GLfloat depth,
                                   GLint stencil)
...
Error FramebufferGL::readPixels(const ContextImpl *context,
                                const gl::Rectangle &area,
                                GLenum format,
                                GLenum type,
                                GLvoid *pixels) const
...
Error FramebufferGL::blit(const ContextImpl *context,
