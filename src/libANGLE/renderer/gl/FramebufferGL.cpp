                                                ...
                                                gl::Rectangle *newDestArea)
{
    ...
    if (!sourceBounds.encloses(sourceRegion))
    {
        ...
        GLuint destMappingX0 = static_cast<GLuint>(std::round(destX + destMappingXOffset));
        GLuint destMappingY0 = static_cast<GLuint>(std::round(destY + destMappingYOffset));

        GLuint destMappingX1 =
            static_cast<GLuint>(std::round(destX + destMappingXOffset + destMappingWidth));
        GLuint destMappingY1 =
            static_cast<GLuint>(std::round(destY + destMappingYOffset + destMappingHeight));
