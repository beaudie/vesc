                               ...
                               const gl::Framebuffer *source)
{
    ...
    bool nonempty = ClipRectangle(origSourceArea, gl::Rectangle(0, 0, fbSize.width, fbSize.height),
                                  &sourceArea);
    ...
    else
    {
        if (UseTexImage2D(getTarget()))
        {
            ...
            if (context->getExtensions().webglCompatibility)
            {
                ...
                context->getScratchBuffer(origSourceArea.width * origSourceArea.height * pixelBytes,
                                          &zero);
                zero->fill(0);
            ...
            mFunctions->texImage2D(
                ...
                gl::GetUnsizedFormat(copyTexImageFormat.internalFormat), type, textureData);
