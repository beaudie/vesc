...
gl::Error TextureGL::generateMipmap()
{
    ...
    const size_t maxLevel     = mState.getMipmapMaxLevel();
...
void TextureGL::syncState(size_t textureUnit) const
{
    ...
    SyncTextureStateSwizzle(mFunctions, applyTextureFunc, levelInfo, mState, mAppliedTextureState, mState.mTarget, GL_TEXTURE_SWIZZLE_R, &gl::TextureState::mSwizzleRed);
    SyncTextureStateSwizzle(mFunctions, applyTextureFunc, levelInfo, mState, mAppliedTextureState, mState.mTarget, GL_TEXTURE_SWIZZLE_G, &gl::TextureState::mSwizzleGreen);
    SyncTextureStateSwizzle(mFunctions, applyTextureFunc, levelInfo, mState, mAppliedTextureState, mState.mTarget, GL_TEXTURE_SWIZZLE_B, &gl::TextureState::mSwizzleBlue);
    SyncTextureStateSwizzle(mFunctions, applyTextureFunc, levelInfo, mState, mAppliedTextureState, mState.mTarget, GL_TEXTURE_SWIZZLE_A, &gl::TextureState::mSwizzleAlpha);
