                               ...
                               const gl::Framebuffer *source)
{
    ...
    {
        // TODO(fjhenigman): We don't have robust resource initialization at the moment but when we
        // do we might be able to save some of work in this slow path.  Assert to call attention to
        // this TODO.
        ASSERT(!context->getGLState().isRobustResourceInitEnabled());
