                               ...
                               const gl::Framebuffer *source)
{
    ...
    {
        // TODO(fjhenigman): If we have robust resource initialization, we ought to be able to save
        // some of the work in this slow path.  Assert to call attention to this TODO.
        ASSERT(!context->getExtensions().robustResourceInitialization);
