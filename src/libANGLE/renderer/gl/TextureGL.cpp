                                        ...
                                        const uint8_t *pixels)
{
    ...
    {
        GLenum gl_type =
            target == gl::TextureTarget::VideoTexture ? GL_TEXTURE_2D : ToGLenum(target);

        ASSERT(size.depth == 1);
        ANGLE_GL_TRY_ALWAYS_CHECK(
            context, functions->texImage2D(gl_type, static_cast<GLint>(level),
                                     ...
                                     const uint8_t *pixels)
{
    ...
    if (nativegl::UseTexImage2D(getType()))
    {
        ...
        if (target == gl::TextureTarget::VideoTexture)
        {
            ANGLE_GL_TRY(context, functions->texSubImage2D(GL_TEXTURE_2D, static_cast<GLint>(level),
                                   ...
                                   const gl::Texture::DirtyBits &dirtyBits)
{
    ...
    GLenum gl_type =
        getType() == gl::TextureType::VideoTexture ? GL_TEXTURE_2D : ToGLenum(getType());
    ...
    for (auto dirtyBit : (dirtyBits | mLocalDirtyBits))
    {
        ...
        switch (dirtyBit)
        {
            case gl::Texture::DIRTY_BIT_MIN_FILTER:
                ...
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_MIN_FILTER,
            ...
            case gl::Texture::DIRTY_BIT_MAX_ANISOTROPY:
                ...
                ANGLE_GL_TRY(context,
                             functions->texParameterf(gl_type, GL_TEXTURE_MAX_ANISOTROPY_EXT,
            ...
            case gl::Texture::DIRTY_BIT_MIN_LOD:
                ...
                ANGLE_GL_TRY(context, functions->texParameterf(gl_type, GL_TEXTURE_MIN_LOD,
                                                               mAppliedSampler.getMinLod()));
                break;
            case gl::Texture::DIRTY_BIT_MAX_LOD:
                mAppliedSampler.setMaxLod(mState.getSamplerState().getMaxLod());
                ANGLE_GL_TRY(context, functions->texParameterf(gl_type, GL_TEXTURE_MAX_LOD,
            ...
            case gl::Texture::DIRTY_BIT_COMPARE_MODE:
                ...
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_COMPARE_MODE,
            ...
            case gl::Texture::DIRTY_BIT_COMPARE_FUNC:
                ...
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_COMPARE_FUNC,
            ...
            case gl::Texture::DIRTY_BIT_SRGB_DECODE:
                ...
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_SRGB_DECODE_EXT,
            ...
            case gl::Texture::DIRTY_BIT_BORDER_COLOR:
            {
                ...
                switch (borderColor.type)
                {
                    case angle::ColorGeneric::Type::Float:
                        ANGLE_GL_TRY(context,
                                     functions->texParameterfv(gl_type, GL_TEXTURE_BORDER_COLOR,
                                                               &borderColor.colorF.red));
                        break;
                    case angle::ColorGeneric::Type::Int:
                        ANGLE_GL_TRY(context,
                                     functions->texParameterIiv(gl_type, GL_TEXTURE_BORDER_COLOR,
                                                                &borderColor.colorI.red));
                        break;
                    case angle::ColorGeneric::Type::UInt:
                        ANGLE_GL_TRY(context,
                                     functions->texParameterIuiv(gl_type, GL_TEXTURE_BORDER_COLOR,
            ...
            case gl::Texture::DIRTY_BIT_BASE_LEVEL:
                ...
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_BASE_LEVEL,
                                                               mAppliedBaseLevel));
                break;
            case gl::Texture::DIRTY_BIT_MAX_LEVEL:
                mAppliedMaxLevel = mState.getEffectiveMaxLevel();
                ANGLE_GL_TRY(context, functions->texParameteri(gl_type, GL_TEXTURE_MAX_LEVEL,
                                                               mAppliedMaxLevel));
                break;
            case gl::Texture::DIRTY_BIT_DEPTH_STENCIL_TEXTURE_MODE:
            {
                ...
                ANGLE_GL_TRY(context,
                             functions->texParameteri(gl_type, GL_DEPTH_STENCIL_TEXTURE_MODE,
