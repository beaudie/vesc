                                                               ...
                                                               GLenum type)
{
    ...
    if (!use1BitAlphaWorkaround && (functions->standard == STANDARD_GL_DESKTOP || functions->isAtLeastGLES(gl::Version(3, 0))))
    {
...
TextureGL::TextureGL(GLenum type, const FunctionsGL *functions, const WorkaroundsGL &workarounds, StateManagerGL *stateManager)
    : TextureImpl(),
      mTextureType(type),
