...
egl::Error DisplayWGL::initializeImpl(egl::Display *display)
{
    ...
    PIXELFORMATDESCRIPTOR pixelFormatDescriptor = wgl::GetDefaultPixelFormatDescriptor(true);
    ...
    {
        std::vector<int> attribs = wgl::GetDefaultPixelFormatAttributes(false, true);
...
bool DisplayWGL::isStereoSupported() const
{
    return mStereo;
}
