...
{
    return new WindowSurfaceWGL(this, window, mPixelFormat, mWGLContext, mFunctionsWGL);
}
                                              ...
                                              const egl::AttributeMap &attribs)
{
    ...
    return new PbufferSurfaceWGL(this, width, height, textureFormat, textureTarget, largest,
