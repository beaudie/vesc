...
egl::Error DisplayWGL::initializeImpl(egl::Display *display)
{
    ...
    static constexpr bool kDefaultWGLVirtualizedContexts = false;
                                   ...
                                   gl::Context *context)
{
    ...
    HDC newDC = mVirtualizedContexts ? currentContext.dc : mDeviceContext;
    if (drawSurface)
    {
    ...
    HGLRC newContext = mVirtualizedContexts ? currentContext.glrc : nullptr;
    if (context)
    {
