                                             ...
                                             const egl::AttributeMap &attribs)
{
    ...
    return new DXGISwapChainWindowSurfaceWGL(this->getRenderer(), window, mD3D11Device, mD3D11DeviceHandle, mWGLContext, mDeviceContext, mFunctionsGL, mFunctionsWGL);
