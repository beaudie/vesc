...
void DXGISwapChainWindowSurfaceWGL::attachToFramebuffer(FramebufferImpl *framebuffer)
{
...
void DXGISwapChainWindowSurfaceWGL::detachFromFramebuffer(FramebufferImpl *framebuffer)
{
    FramebufferGL *framebufferGL = static_cast<FramebufferGL *>(framebuffer);
