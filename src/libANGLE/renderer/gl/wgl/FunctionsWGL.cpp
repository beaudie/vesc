...
void FunctionsWGL::intialize(HMODULE glModule, HDC context)
{
    ...
    GetWGLExtensionProcAddress(glModule, getProcAddress, extensions, "WGL_ARB_pbuffer", "wglBindTexImageARB", &bindTexImageARB);
    GetWGLExtensionProcAddress(glModule, getProcAddress, extensions, "WGL_ARB_pbuffer", "wglReleaseTexImageARB", &releaseTexImageARB);
    GetWGLExtensionProcAddress(glModule, getProcAddress, extensions, "WGL_ARB_pbuffer", "wglSetPbufferAttribARB", &setPbufferAttribARB);
}
