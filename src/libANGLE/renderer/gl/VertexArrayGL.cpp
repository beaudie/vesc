                                           ...
                                           const void **outIndices) const
{
    ...
    if (type != GL_NONE)
    {
        ANGLE_TRY_FAST(syncIndexData(context, count, type, indices, primitiveRestartEnabled,
    ...
    {
        ANGLE_TRY_FAST(streamAttributes(context, needsStreamingAttribs, instanceCount, indexRange));
    }
