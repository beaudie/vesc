                                           ...
                                           const void **outIndices) const
{
    ...
    if (type != GL_NONE)
    {
        ANGLE_TRY_EXPR(syncIndexData(context, count, type, indices, primitiveRestartEnabled,
    ...
    {
        ANGLE_TRY_EXPR(streamAttributes(context, needsStreamingAttribs, instanceCount, indexRange));
    }
                                           ...
                                           const void **outIndices) const
{
    ...
    if (elementArrayBuffer != nullptr)
    {
        ...
        if (attributesNeedStreaming)
        {
            ...
            ANGLE_TRY_ERR(mState.getElementArrayBuffer()->getIndexRange(
                                              ...
                                              const gl::IndexRange &indexRange) const
{
    ...
    {
        context->handleError(gl::OutOfMemory()
