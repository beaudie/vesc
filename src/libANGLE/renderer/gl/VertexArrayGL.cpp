...
void VertexArrayGL::updateAttribPointer(const gl::Context *context, size_t attribIndex)
{
    ...
    // mAttributesNeedStreaming[attribIndex] (same as it was in the last draw).
...
void VertexArrayGL::updateAttribFormat(size_t attribIndex)
{
    ...
    // should be updated in updateAttribPointer() and its format and binding should be updated in
    // streamAttributes().
...
void VertexArrayGL::syncState(const gl::Context *context, const VertexArray::DirtyBits &dirtyBits)
{
    ...
    for (size_t dirtyBit : dirtyBits)
    {
        ...
        // when VertexAttribPointer is called. Skip updating format, binding, and attribBinding
        // separately on platforms that don't support Vertex Attrib Binding because they should be
        // updated together in updateAttribPointer.
