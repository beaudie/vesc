...
gl::Error VertexArrayGL::syncElementArrayState(const gl::Context *context) const
{
    ...
    if (elementArrayBuffer != mAppliedElementArrayBuffer.get())
    {
        ...
        mStateManager->bindBuffer(gl::BufferType::ElementArray, bufferGL->getBufferID());
                                       ...
                                       const void **outIndices) const
{
    ...
    else
    {
        ...
        mStateManager->bindBuffer(gl::BufferType::ElementArray, mStreamingElementArrayBuffer);
        mAppliedElementArrayBuffer.set(context, nullptr);
                                          ...
                                          const gl::IndexRange &indexRange) const
{
    ...
    mStateManager->bindBuffer(gl::BufferType::Array, mStreamingArrayBuffer);
...
void VertexArrayGL::updateAttribPointer(const gl::Context *context, size_t attribIndex)
{
    ...
    mStateManager->bindBuffer(gl::BufferType::Array, arrayBufferGL->getBufferID());
