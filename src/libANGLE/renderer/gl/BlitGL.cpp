                                                          ...
                                                          gl::Framebuffer *source)
{
    ...
    ANGLE_GL_TRY(context, mFunctions->uniform1i(blitProgram->srgbTransformLocation, 0));
                                     ...
                                     bool *copySucceededOut)
{
    ...
    if (unpackPremultiplyAlpha == unpackUnmultiplyAlpha && !srgbTransform)
    {
        ANGLE_GL_TRY(context, mFunctions->uniform1i(blitProgram->multiplyAlphaLocation, 0));
        ANGLE_GL_TRY(context, mFunctions->uniform1i(blitProgram->unMultiplyAlphaLocation, 0));
        ANGLE_GL_TRY(context, mFunctions->uniform1i(blitProgram->srgbTransformLocation, 0));
    ...
    else
    {
        ...
        ANGLE_GL_TRY(context,
                     mFunctions->uniform1i(blitProgram->srgbTransformLocation, srgbTransform));
    }
                                                ...
                                                bool unpackUnmultiplyAlpha)
{
    ...
    if (status != GL_FRAMEBUFFER_COMPLETE)
    {
        ...
        ANGLE_TRY(copySubTexture(
            ...
            needsLumaWorkaround, lumaFormat, false, false, false, 0, &copySucceeded));
        if (!copySucceeded)
        {
                                     ...
                                     BlitProgram **program)
{
    ...
    if (result.program == 0)
    {
...

        {
            ...
            fsSourceStream << "uniform bool u_srgb_transform;\n";
            ...
            // Write the sRGB to/from linear functions.
            ...
            fsSourceStream << "}\n";
            fsSourceStream << "float transformSrgbToLinear(float cl)\n";
            fsSourceStream << "{\n";
            fsSourceStream << "    if (cl <= 0.0)\n";
            fsSourceStream << "        return 0.0;\n";
            fsSourceStream << "    if (cl < 0.04045)\n";
            fsSourceStream << "        return cl / 12.92;\n";
            fsSourceStream << "    if (cl < 1.0)\n";
            fsSourceStream << "        return pow((cl + 0.055) / 1.055, 2.4);\n";
            fsSourceStream << "    return 1.0;\n";
            fsSourceStream << "}\n";
            ...
            fsSourceStream << "    if (u_srgb_transform == 1)\n";
            fsSourceStream << "    {\n";
            ...
            fsSourceStream << "    }\n";
            fsSourceStream << "    if (u_srgb_transform == 2)\n";
            fsSourceStream << "    {\n";
            fsSourceStream << "        color.x = transformSrgbToLinear(color.x);\n";
            fsSourceStream << "        color.y = transformSrgbToLinear(color.y);\n";
            fsSourceStream << "        color.z = transformSrgbToLinear(color.z);\n";
            fsSourceStream << "    }\n";
        ...
        result.srgbTransformLocation = ANGLE_GL_TRY(
            context, mFunctions->getUniformLocation(result.program, "u_srgb_transform"));
    }
