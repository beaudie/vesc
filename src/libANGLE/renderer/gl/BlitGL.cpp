                                         ...
                                         const gl::Extents &sourceBaseLevelSize)
{
    ...
    // Copy source to a linear RGBA8 texuture with a draw
    ...
    ANGLE_GL_TRY(context, mFunctions->texImage2D(
                              ToGLenum(sourceTarget), 0, GL_RGBA, sourceBaseLevelSize.width,
                              sourceBaseLevelSize.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr));
