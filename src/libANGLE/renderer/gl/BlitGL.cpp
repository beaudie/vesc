                                                   ...
                                                   GLenum destComponentType)
{
    switch (sourceComponentType)
    {
        ...
        case GL_INT:
            ASSERT(destComponentType == GL_INT);
            return BlitProgramType::INT_TO_INT;
        ...
        default:
            switch (destComponentType)
            {
                ...
                case GL_INT:
                    return BlitProgramType::FLOAT_TO_INT;
    ...
    if (result.program == 0)
    {
...

        {
            ...
            switch (type)
            {
                ...
                case BlitProgramType::FLOAT_TO_INT:
                ...
                case BlitProgramType::INT_TO_INT:
                    samplerType       = "isampler2D";
                    samplerResultType = "ivec4";
                    break;
            ...
            fsSourceStream << "    if (u_multiply_alpha) {color.xyz = color.xyz * color.a;}\n";
            fsSourceStream << "    if (u_unmultiply_alpha && color.a != 0.0) {color.xyz = "
                              "color.xyz / color.a;}\n";
