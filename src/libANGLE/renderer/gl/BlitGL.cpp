                                       ...
                                       FramebufferGL *source)
{
    ...
    auto checkAttachment = [](const gl::Context *context,
                              const gl::FramebufferAttachment *attachment, bool *needsClearInit) {
    ...
    for (size_t colorAttachmentIdx : colorAttachments)
    {
        ...
        ANGLE_TRY(checkAttachment(
            context, source->getState().getColorAttachment(colorAttachmentIdx), &needsInit));
    ...
    {
        ANGLE_TRY(
            checkAttachment(context, source->getState().getDepthAttachment(), &depthNeedsInit));
    }
    ...
    {
        ANGLE_TRY(
            checkAttachment(context, source->getState().getStencilAttachment(), &stencilNeedsInit));
    }
