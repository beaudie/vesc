...
class StateManagerGL final : angle::NonCopyable
{
  public:
    ...
    void bindBuffer(gl::BufferTarget target, GLuint buffer);
    void bindBufferBase(gl::BufferTarget target, size_t index, GLuint buffer);
    void bindBufferRange(gl::BufferTarget target,
                         size_t index,
                         GLuint buffer,
                         size_t offset,
                         size_t size);
  ...
  private:
    ...
    angle::PackedEnumMap<gl::BufferTarget, GLuint> mBuffers;
    ...
    angle::PackedEnumMap<gl::BufferTarget, std::vector<IndexedBufferBinding>> mIndexedBuffers;
