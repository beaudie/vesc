...
class StateManagerGL final : angle::NonCopyable
{
  public:
    ...
    void bindBuffer(gl::BufferType target, GLuint buffer);
    void bindBufferBase(gl::BufferType target, size_t index, GLuint buffer);
    void bindBufferRange(gl::BufferType target,
                         size_t index,
                         GLuint buffer,
                         size_t offset,
                         size_t size);
  ...
  private:
    ...
    angle::PackedEnumMap<gl::BufferType, GLuint> mBuffers;
    ...
    angle::PackedEnumMap<gl::BufferType, std::vector<IndexedBufferBinding>> mIndexedBuffers;
