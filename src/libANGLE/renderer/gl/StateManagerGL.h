...
class StateManagerGL final : angle::NonCopyable
{
  public:
    ...
    void setScissor(const gl::Rectangle &scissor, bool forceUpdate);

    void setViewport(const gl::Rectangle &viewport, bool forceUpdate);
  ...
  private:
    ...
    void handleFramebufferSideBySideTransition(bool sideBySide, const gl::Rectangle &viewport, const gl::Rectangle &scissor, bool scissorTest, const std::vector<gl::Offset> *viewportOffsets);
