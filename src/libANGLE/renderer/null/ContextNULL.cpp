...
gl::Error ContextNULL::onMakeCurrent(const gl::Context *context, const gl::Context *prevContext)
{
    return gl::NoError();
}

gl::Error ContextNULL::onMakeUnCurrent(const gl::Context *context, const gl::Context *nextContext)
{
    return gl::NoError();
}
