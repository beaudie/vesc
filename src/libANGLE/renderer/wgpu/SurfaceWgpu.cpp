...
angle::Result WindowSurfaceWgpu::updateCurrentTexture(const egl::Display *display)
{
    ...
    {
        // TODO: Handle out of date or suboptimal surface textures.
        WARN() << "Unhandled SurfaceGetCurrentTextureStatus: "
    ...
    wgpu::TextureView view;
    ANGLE_TRY(mColorAttachment.texture.createTextureView(gl::LevelIndex(level), layer, view));
    mColorAttachment.renderTarget.set(&mColorAttachment.texture, view, webgpu::LevelIndex(level),
                                      layer, mColorAttachment.texture.toWgpuTextureFormat());
