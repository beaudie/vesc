...
class WgpuDefaultBlockEncoder : public sh::Std140BlockEncoder
{
  public:
                       ...
                       int matrixStride) override
    {
        ...
        // TODO(anglebug.com/42267100): support matCx2, bools, arrays of small values. This ASSERT
        // doesn't cover arrays of small structs which also don't work.
        ASSERT(gl::VariableRowCount(type) != 2 && type != GL_BOOL &&
               (arraySizes.empty() || gl::VariableComponentCount(type) >= 3));
