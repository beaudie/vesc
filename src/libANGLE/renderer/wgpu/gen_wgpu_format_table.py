...
image_snorm_template = """mActualSampleOnlyImageFormatID = {image};
...
def gen_format_case(angle, internal_format, wgpu_json_data):
    ...
    def get_formats(format, type):
        ...
        compressed = wgpu_fallbacks.get(format, {}).get(type + "_compressed", [])
