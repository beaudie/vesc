                  ...
                  gl::Version *maxSupportedESVersion)
{
    ...
    GLuint maxUniformBlockSize =
        static_cast<GLuint>(std::min(0x10000ull, limitsWgpu.maxUniformBufferBindingSize));
    ...
    glCaps->maxVertexOutputComponents = rx::LimitToInt(limitsWgpu.maxInterStageShaderComponents);

    glCaps->maxFragmentUniformVectors  = maxUniformVectors;
    glCaps->maxFragmentInputComponents = rx::LimitToInt(limitsWgpu.maxInterStageShaderComponents);
    ...
    glCaps->maxUniformBlockSize      = rx::LimitToInt64(limitsWgpu.maxBufferSize);
    ...
    glCaps->maxVaryingComponents     = rx::LimitToInt(limitsWgpu.maxInterStageShaderComponents);
