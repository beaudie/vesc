...
#ifndef LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUWAYLAND_H_
#define LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUWAYLAND_H_
...
#endif  // LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUWAYLAND_H_
