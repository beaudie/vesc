...
#ifndef LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUMETALLAYER_H_
#define LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUMETALLAYER_H_
...
#endif  // LIBANGLE_RENDERER_WGPU_WIN32_WINDOWSURFACEWGPUMETALLAYER_H_
