                                      ...
                                      void *pixels)
{
    ...
    textureDataLayout.bytesPerRow  = roundUp(aspectFormat.pixelBytes * area.width, (GLuint)256);
    textureDataLayout.rowsPerImage = textureDataLayout.bytesPerRow * area.height;
