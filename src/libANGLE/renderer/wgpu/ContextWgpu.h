...
class AllocationTrackerWgpu : angle::NonCopyable
{
  public:
    explicit AllocationTrackerWgpu(size_t maxTotalAllocationSize);
    ~AllocationTrackerWgpu();
...
{
  public:
    ContextWgpu(const gl::State &state,
                gl::ErrorSet *errorSet,
                AllocationTrackerWgpu *allocationTracker);
