...
class TextureImpl
{
  public:
    ...
    virtual gl::Error copySubImage(GLenum target, size_t level, const gl::Extents &destOffset, const gl::Rectangle &sourceArea,
                                   const gl::Framebuffer *source);

    virtual gl::Error setStorage(GLenum target, size_t levels, GLenum internalFormat, const gl::Extents &size);
