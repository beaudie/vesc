...
def main():
    ...
    cl_r_to_angle = angle_format.load_forward_table('angle_r_format_map.json')
    cl_rg_to_angle = angle_format.load_forward_table('angle_rg_format_map.json')
    cl_rgb_to_angle = angle_format.load_forward_table('angle_rgb_format_map.json')
    cl_rgba_to_angle = angle_format.load_forward_table('angle_rgba_format_map.json')
