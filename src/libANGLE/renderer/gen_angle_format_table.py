...
format_entry_template = """    {{ FormatID::{id}, {glInternalFormat}, {fboImplementationInternalFormat}, {mipGenerationFunction}, {fastCopyFunctions}, {colorReadFunction}, {colorWriteFunction}, {namedComponentType}, {R}, {G}, {B}, {A}, {L}, {D}, {S}, {pixelBytes}, {componentAlignmentMask}, {channelCount}, {isBlock}, {isFixed}, {isScaled}, {vertexAttribType} }},
"""
...
def json_to_table_data(format_id, json, angle_to_gl):
    ...
    parsed["componentAlignmentMask"] = get_component_alignment_mask(parsed["channels"],
                                                                    parsed["bits"])
    parsed["channelCount"] = 0 if parsed["channels"] == None else len(parsed["channels"])
