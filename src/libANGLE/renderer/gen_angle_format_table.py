...
TEMPLATE_FORMAT_ID_H = """// GENERATED FILE - DO NOT EDIT.
...
TEMPLATE_METAL_FORMAT_H = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}
//
// Copyright 2020 The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
TEMPLATE_FORMAT_TABLE_CPP = """// GENERATED FILE - DO NOT EDIT.
// Generated by {script_name} using data from {data_source_name}
//
// Copyright 2020 The ANGLE Project Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
...
FORMAT_TABLE_CPP_PATH = 'Format_table_autogen.cpp'
FORMAT_ID_HEADER_PATH = 'FormatID_autogen.h'
METAL_HEADER_PATH = 'renderer/metal/shaders/format_autogen.h'
...
def write_file(path, template, args):
    with open(path, 'wt') as out_file:
        output_h = template.format(**args)
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        outputs = [FORMAT_TABLE_CPP_PATH, FORMAT_ID_HEADER_PATH, METAL_HEADER_PATH]
    ...
    write_file(FORMAT_TABLE_CPP_PATH, TEMPLATE_FORMAT_TABLE_CPP, args)
    write_file(FORMAT_ID_HEADER_PATH, TEMPLATE_FORMAT_ID_H, args)
    write_file(METAL_HEADER_PATH, TEMPLATE_METAL_FORMAT_H, args)
