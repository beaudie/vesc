...
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(4, 4);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(2, 3);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(3, 2);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(2, 4);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(4, 2);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(3, 4);
INSTANTIATE_SET_UNIFORM_MATRIX_FUNC(4, 3);

#undef INSTANTIATE_SET_UNIFORM_MATRIX_FUNC
