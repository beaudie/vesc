...
LoadImageFunctionInfo R16_SSCALED_ANGLEX_to_R16_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_SHORT:
...
LoadImageFunctionInfo R16_USCALED_ANGLEX_to_R16_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_SHORT:
...
LoadImageFunctionInfo R32_FIXED_ANGLEX_to_R32_FIXED(GLenum type)
{
    switch (type)
    {
        case GL_INT:
...
LoadImageFunctionInfo R8_SSCALED_ANGLEX_to_R8_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_BYTE:
...
LoadImageFunctionInfo R8_USCALED_ANGLEX_to_R8_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RG16_SSCALED_ANGLEX_to_R16G16_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_SHORT:
...
LoadImageFunctionInfo RG16_USCALED_ANGLEX_to_R16G16_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_SHORT:
...
LoadImageFunctionInfo RG32_FIXED_ANGLEX_to_R32G32_FIXED(GLenum type)
{
    switch (type)
    {
        case GL_INT:
...
LoadImageFunctionInfo RG8_SSCALED_ANGLEX_to_R8G8_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_BYTE:
...
LoadImageFunctionInfo RG8_USCALED_ANGLEX_to_R8G8_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RGB10_A2_SSCALED_ANGLEX_to_R10G10B10A2_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RGB10_A2_USCALED_ANGLEX_to_R10G10B10A2_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RGB16_SSCALED_ANGLEX_to_R16G16B16_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_SHORT:
...
LoadImageFunctionInfo RGB16_USCALED_ANGLEX_to_R16G16B16_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_SHORT:
...
LoadImageFunctionInfo RGB32_FIXED_ANGLEX_to_R32G32B32_FIXED(GLenum type)
{
    switch (type)
    {
        case GL_INT:
...
LoadImageFunctionInfo RGB8_SSCALED_ANGLEX_to_R8G8B8_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_BYTE:
...
LoadImageFunctionInfo RGB8_USCALED_ANGLEX_to_R8G8B8_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RGBA16_SSCALED_ANGLEX_to_R16G16B16A16_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_SHORT:
...
LoadImageFunctionInfo RGBA16_USCALED_ANGLEX_to_R16G16B16A16_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_SHORT:
...
LoadImageFunctionInfo RGBA32_FIXED_ANGLEX_to_R32G32B32A32_FIXED(GLenum type)
{
    switch (type)
    {
        case GL_INT:
...
LoadImageFunctionInfo RGBA8_SSCALED_ANGLEX_to_R8G8B8A8_SSCALED(GLenum type)
{
    switch (type)
    {
        case GL_BYTE:
...
LoadImageFunctionInfo RGBA8_USCALED_ANGLEX_to_R8G8B8A8_USCALED(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadFunctionMap GetLoadFunctionsMap(GLenum internalFormat, FormatID angleFormat)
{
    ...
    switch (internalFormat)
    {
        ...
        case GL_R16_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16_SSCALED:
                    return R16_SSCALED_ANGLEX_to_R16_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_R16_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16_USCALED:
                    return R16_USCALED_ANGLEX_to_R16_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_R32_FIXED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R32_FIXED:
                    return R32_FIXED_ANGLEX_to_R32_FIXED;
                default:
                    break;
            }
            break;
        ...
        case GL_R8_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8_SSCALED:
                    return R8_SSCALED_ANGLEX_to_R8_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_R8_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8_USCALED:
                    return R8_USCALED_ANGLEX_to_R8_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RG16_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16_SSCALED:
                    return RG16_SSCALED_ANGLEX_to_R16G16_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RG16_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16_USCALED:
                    return RG16_USCALED_ANGLEX_to_R16G16_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RG32_FIXED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R32G32_FIXED:
                    return RG32_FIXED_ANGLEX_to_R32G32_FIXED;
                default:
                    break;
            }
            break;
        ...
        case GL_RG8_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8_SSCALED:
                    return RG8_SSCALED_ANGLEX_to_R8G8_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RG8_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8_USCALED:
                    return RG8_USCALED_ANGLEX_to_R8G8_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB10_A2_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R10G10B10A2_SSCALED:
                    return RGB10_A2_SSCALED_ANGLEX_to_R10G10B10A2_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB10_A2_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R10G10B10A2_USCALED:
                    return RGB10_A2_USCALED_ANGLEX_to_R10G10B10A2_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB16_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16B16_SSCALED:
                    return RGB16_SSCALED_ANGLEX_to_R16G16B16_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB16_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16B16_USCALED:
                    return RGB16_USCALED_ANGLEX_to_R16G16B16_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB32_FIXED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R32G32B32_FIXED:
                    return RGB32_FIXED_ANGLEX_to_R32G32B32_FIXED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB8_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8B8_SSCALED:
                    return RGB8_SSCALED_ANGLEX_to_R8G8B8_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGB8_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8B8_USCALED:
                    return RGB8_USCALED_ANGLEX_to_R8G8B8_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGBA16_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16B16A16_SSCALED:
                    return RGBA16_SSCALED_ANGLEX_to_R16G16B16A16_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGBA16_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R16G16B16A16_USCALED:
                    return RGBA16_USCALED_ANGLEX_to_R16G16B16A16_USCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGBA32_FIXED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R32G32B32A32_FIXED:
                    return RGBA32_FIXED_ANGLEX_to_R32G32B32A32_FIXED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGBA8_SSCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8B8A8_SSCALED:
                    return RGBA8_SSCALED_ANGLEX_to_R8G8B8A8_SSCALED;
                default:
                    break;
            }
            break;
        ...
        case GL_RGBA8_USCALED_ANGLEX:
        {
            switch (angleFormat)
            {
                case FormatID::R8G8B8A8_USCALED:
                    return RGBA8_USCALED_ANGLEX_to_R8G8B8A8_USCALED;
                default:
                    break;
            }
            break;
    ...
    fprintf(stderr, "Going to fail with internalFormat 0x%04X, 0x%04X\n", internalFormat,
            Format::Get(angleFormat).glInternalFormat);
