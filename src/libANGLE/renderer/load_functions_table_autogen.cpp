...
LoadImageFunctionInfo PALETTE4_R5_G6_B5_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE4_RGB5_A1_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE4_RGB8_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE4_RGBA4_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE4_RGBA8_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE8_R5_G6_B5_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE8_RGB5_A1_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE8_RGB8_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE8_RGBA4_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo PALETTE8_RGBA8_OES_to_default(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
    ...
    switch (internalFormat)
    {
        ...
        case GL_PALETTE4_R5_G6_B5_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE4_R5_G6_B5_OES_to_default;
            }
        }
        case GL_PALETTE4_RGB5_A1_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE4_RGB5_A1_OES_to_default;
            }
        }
        case GL_PALETTE4_RGB8_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE4_RGB8_OES_to_default;
            }
        }
        case GL_PALETTE4_RGBA4_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE4_RGBA4_OES_to_default;
            }
        }
        case GL_PALETTE4_RGBA8_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE4_RGBA8_OES_to_default;
            }
        }
        case GL_PALETTE8_R5_G6_B5_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE8_R5_G6_B5_OES_to_default;
            }
        }
        case GL_PALETTE8_RGB5_A1_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE8_RGB5_A1_OES_to_default;
            }
        }
        case GL_PALETTE8_RGB8_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE8_RGB8_OES_to_default;
            }
        }
        case GL_PALETTE8_RGBA4_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE8_RGBA4_OES_to_default;
            }
        }
        case GL_PALETTE8_RGBA8_OES:
        {
            switch (angleFormat)
            {
                ...
                default:
                    return PALETTE8_RGBA8_OES_to_default;
            }
        }
