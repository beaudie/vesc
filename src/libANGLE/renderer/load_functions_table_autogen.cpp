...
LoadImageFunctionInfo RGBX8_ANGLEX_to_B8G8R8A8_UNORM(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadImageFunctionInfo RGBX8_ANGLEX_to_B8G8R8X8_UNORM(GLenum type)
{
    switch (type)
    {
        case GL_UNSIGNED_BYTE:
...
LoadFunctionMap GetLoadFunctionsMap(GLenum internalFormat, FormatID angleFormat)
{
    ...
    switch (internalFormat)
    {
        ...
        case GL_RGBX8_ANGLEX:
        {
            ...
            {
                case FormatID::B8G8R8A8_UNORM:
                    return RGBX8_ANGLEX_to_B8G8R8A8_UNORM;
                case FormatID::B8G8R8X8_UNORM:
                    return RGBX8_ANGLEX_to_B8G8R8X8_UNORM;
                default:
                    break;
            }
            break;
