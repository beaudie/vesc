...
class WindowSurfaceVk : public SurfaceImpl
{
  ...
  private:
    ...
    // When acquiring a new image for rendering, we take a temporary semaphore that lives until
    // the corresponding frame is submitted.
    vk::SemaphoreHelper mAcquireNextImageSemaphore;
