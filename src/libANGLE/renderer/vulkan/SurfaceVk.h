...
class WindowSurfaceVk : public SurfaceVk
{
  public:
    ...
    angle::Result getUserWidth(const egl::Display *display, EGLint *value) const override;
    angle::Result getUserHeight(const egl::Display *display, EGLint *value) const override;
