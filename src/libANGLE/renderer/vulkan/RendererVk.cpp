...
void RendererVk::initFeatures(DisplayVk *displayVk, const ExtensionNameList &deviceExtensionNames)
{
    ...
    // Enable allocation sanitization when debug layers are enabled.
    ANGLE_FEATURE_CONDITION((&mFeatures), allocateNonZeroMemory, mEnableValidationLayers);
                                            ...
                                            Serial *serialOut)
{
    ...
    ANGLE_TRY(queueSubmit(context, egl::ContextPriority::Medium, submitInfo, nullptr, serialOut));
