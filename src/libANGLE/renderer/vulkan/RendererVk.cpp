...
void RendererVk::initFeatures(DisplayVk *displayVk, const ExtensionNameList &deviceExtensionNames)
{
    ...
    // Enable glFlush deferal for android only for now. Needs testing data for other platforms to
    // enable it
    ANGLE_FEATURE_CONDITION(&mFeatures, deferFlushUntilEndRenderPass, /*IsAndroid()*/ true);
