                                     ...
                                     const char *wsiLayer)
{
    ...
    // Create async worker thread pool to compress.
    bool multithreaded  = true;
    int threadCount     = 1;
    mCompressThreadPool = angle::WorkerThreadPool::Create(multithreaded);
    mCompressThreadPool->setMaxThreads(threadCount);
