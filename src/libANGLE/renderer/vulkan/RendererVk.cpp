...
angle::Result RendererVk::initializeDevice(DisplayVk *displayVk, uint32_t queueFamilyIndex)
{
    ...
    // Index order: Low, High, Medium - so no need to rearange according to count:
    ...
    // When only 1 Queue, use same for all, Low index. identify as Medium, since its default.
    VkQueue queue;
