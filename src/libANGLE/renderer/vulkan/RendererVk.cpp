...
namespace
{
const uint32_t MockVendorID = 0xba5eba11;
const uint32_t MockDeviceID = 0xf005ba11;
}
...
vk::Error RendererVk::initialize(const egl::AttributeMap &attribs, const char *wsiName)
{
    ...
    if (enableNullDriver)
    {
        ...
        for (const auto &physicalDevice : physicalDevices)
        {
            ...
            if ((MockVendorID == physicalDeviceProperties.vendorID) &&
                (MockDeviceID == physicalDeviceProperties.deviceID) &&
