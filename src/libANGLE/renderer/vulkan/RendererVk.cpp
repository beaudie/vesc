...
constexpr SkippedSyncvalMessage kSkippedSyncvalMessages[] = {
    ...
    {"SYNC-HAZARD-READ_AFTER_WRITE",
     "vkCmdDrawIndexedIndirect: Hazard READ_AFTER_WRITE for vertex VkBuffer",
     "usage: SYNC_VERTEX_ATTRIBUTE_INPUT_VERTEX_ATTRIBUTE_READ", false},
    {"SYNC-HAZARD-READ_AFTER_WRITE",
     "vkCmdDrawIndirect: Hazard READ_AFTER_WRITE for vertex VkBuffer",
     "usage: SYNC_VERTEX_ATTRIBUTE_INPUT_VERTEX_ATTRIBUTE_READ", false},
    {"SYNC-HAZARD-READ_AFTER_WRITE",
     "vkCmdDrawIndexedIndirect: Hazard READ_AFTER_WRITE for index VkBuffer",
     "usage: SYNC_INDEX_INPUT_INDEX_READ", false},
    // From:
    // MultisampledRenderToTextureES3Test.TransformFeedbackTest
    // http://anglebug.com/6725
