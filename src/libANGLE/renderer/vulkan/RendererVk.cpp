                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    // Platform expects VkPresentRegionsKHR rectangles with a bottom-left origin, while spec
    // states they should have a top-left origin.
    ANGLE_FEATURE_CONDITION(&mFeatures, invertYPresentRegionRectangles, IsAndroid());
