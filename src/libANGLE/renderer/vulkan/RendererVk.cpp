...
{
    return !mSharedGarbageList.empty() || !mPendingSubmitGarbageList.empty() ||
           !mSuballocationGarbageList.empty() || !mPendingSubmitSuballocationGarbageList.empty();
}
...
void RendererVk::cleanupGarbage()
{
    ...
    mSharedGarbageList.cleanup(this);
    // Clean up suballocation garbages
    mSuballocationGarbageDestroyed += mSuballocationGarbageList.cleanup(this);
    ...
    mOrphanedBufferBlocks.pruneEmptyBufferBlocks(this);
}
...
void RendererVk::cleanupPendingSubmissionGarbage()
{
    ...
    mPendingSubmitGarbageList.moveSubmittedGarbageToList(this, &mSharedGarbageList);
    mPendingSubmitSuballocationGarbageList.moveSubmittedGarbageToList(this,
                                                                      &mSuballocationGarbageList);
}
