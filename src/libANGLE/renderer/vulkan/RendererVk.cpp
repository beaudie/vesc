                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    bool isDynamicStateSupported = true;
    if (isARM)
    {
        ...
        isDynamicStateSupported = armDriverVersion >= ARMDriverVersion(44, 1, 0);
    }
    else if (isIntel && IsWindows())
    {
        // Vertex input dynamic state is supported for Windows/Intel drivers since 100.9684.
        // https://anglebug.com/8563#c4
        IntelDriverVersion intelDriverVersion(mPhysicalDeviceProperties.driverVersion);
        isDynamicStateSupported = intelDriverVersion >= GetWinIntelDriverVersion(100, 9684);
    }
    ...
    ANGLE_FEATURE_CONDITION(
        ...
        mExtendedDynamicStateFeatures.extendedDynamicState == VK_TRUE && isDynamicStateSupported);
    ...
    ANGLE_FEATURE_CONDITION(
        ...
        mFeatures.supportsExtendedDynamicState.enabled && isDynamicStateSupported);
    ...
    ANGLE_FEATURE_CONDITION(
        ...
        mExtendedDynamicState2Features.extendedDynamicState2 == VK_TRUE && isDynamicStateSupported);

    ANGLE_FEATURE_CONDITION(
        &mFeatures, usePrimitiveRestartEnableDynamicState,
        mFeatures.supportsExtendedDynamicState2.enabled && isDynamicStateSupported);
