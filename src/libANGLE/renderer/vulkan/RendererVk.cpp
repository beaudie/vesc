                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    //
    // when this feature is supported.  That can hurt performance on Qualcomm
    // open source driver.  https://issuetracker.google.com/issues/255837430
    ANGLE_FEATURE_CONDITION(
        &mFeatures, supportsRasterizationOrderAttachmentAccess,
        !isQualcommOpenSource &&
