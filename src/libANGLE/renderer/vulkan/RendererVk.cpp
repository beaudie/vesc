...
void RendererVk::queryDeviceExtensionFeatures(const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    // Hack
    std::cout << "device feat got, protected mem: " << mProtectedMemoryFeatures.protectedMemory
              << std::endl;
...
#    endif  // !defined(ANGLE_SHARED_LIBVULKAN)
    ...
    //    {
    //        vk::AddToPNextChain(&enabledFeatures, &mProtectedMemoryFeatures);
    //    }
    ...
    std::cout << "mLineRasterizationFeatures.bresenhamLines: "
              << mLineRasterizationFeatures.bresenhamLines << std::endl;
    ...
    std::cout << "mProvokingVertexFeatures.provokingVertexLast: "
              << mProvokingVertexFeatures.provokingVertexLast << std::endl;
    ...
    // Hack
    std::cout << "getFeatures().supportsProtectedMemory.enabled: "
              << getFeatures().supportsProtectedMemory.enabled << std::endl;
                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    std::cout << "mProvokingVertexFeatures.provokingVertexLast, set bresenhamLineRasterization: "
              << mLineRasterizationFeatures.bresenhamLines << std::endl;
    ...
    // Hack
    std::cout << "supportsProtectedMemory set: " << mFeatures.supportsProtectedMemory.enabled
              << std::endl;
