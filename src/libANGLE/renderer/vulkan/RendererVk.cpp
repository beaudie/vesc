                                               ...
                                               CommandBufferHelperT **commandBufferHelperOut)
{
    ...
    return recycler->getCommandBufferHelper(context, commandPool, &mFreeCommandBuffers,
    ...
    vk::OutsideRenderPassCommandBufferHelper **commandBuffer)
{
    ...
    std::unique_lock<std::mutex> lock(mCommandBufferRecyclerMutex);
    mOutsideRenderPassCommandBufferRecycler.recycleCommandBufferHelper(device, &mFreeCommandBuffers,
                                                                       commandBuffer);
}
    ...
    vk::RenderPassCommandBufferHelper **commandBuffer)
{
    ...
    std::unique_lock<std::mutex> lock(mCommandBufferRecyclerMutex);
    mRenderPassCommandBufferRecycler.recycleCommandBufferHelper(device, &mFreeCommandBuffers,
                                                                commandBuffer);
}
