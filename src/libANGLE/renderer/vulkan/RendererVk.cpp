                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    // For Windows Nvidia Vulkan driver, Vulkan pipeline cache will only generate one single huge
    // cache for one process shared by all graphics piplines in the same process, which can be huge.
