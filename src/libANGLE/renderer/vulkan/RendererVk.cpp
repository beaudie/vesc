...
VKAPI_ATTR void *PoolAllocationFunction(void *pUserData,
                                        size_t size,
                                        size_t alignment,
                                        VkSystemAllocationScope allocationScope)
{
    ERR() << "Calling PoolAllocationFunction";
...
VKAPI_ATTR void *PoolReallocationFunction(void *pUserData,
                                          void *pOriginal,
                                          size_t size,
                                          size_t alignment,
                                          VkSystemAllocationScope allocationScope)
{
    ERR() << "Calling PoolReallocationFunction";
...
{
    ERR() << "Calling PoolFreeFunction";
}

VKAPI_ATTR void PoolInternalAllocationNotification(void *pUserData,
                                                   size_t size,
                                                   VkInternalAllocationType allocationType,
                                                   VkSystemAllocationScope allocationScope)
{}

VKAPI_ATTR void PoolInternalFreeNotification(void *pUserData,
                                             size_t size,
                                             VkInternalAllocationType allocationType,
                                             VkSystemAllocationScope allocationScope)
{}
...
{
    ERR() << "InitPoolAllocationCallbacks";
...
angle::Result RendererVk::initializeDevice(DisplayVk *displayVk, uint32_t queueFamilyIndex)
{
    ...
    // mPoolAllocator = new angle::PoolAllocator();
...
angle::Result RendererVk::checkCompletedCommands(vk::Context *context)
{
    ...
    ERR() << "Calling mInFlightCommands.erase";
                                      ...
                                      vk::CommandBuffer &&commandBuffer)
{
    ...
    ERR() << "moving mPoolAllocator in submitFrame";
