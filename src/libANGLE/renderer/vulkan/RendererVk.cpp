                                                        ...
                                                        VkDeviceSize *sizeOut)
{
    ...
    result = vma::AllocateAndBindMemoryForImage(
        allocator.getHandle(), &image->mHandle, requiredFlags, preferredFlags, 0,
    ...
    if (result != VK_SUCCESS)
    {
        return retryAllocateAndBindMemory(context, result, image, requiredFlags, preferredFlags,
                                          memoryAllocationType, memoryRequirements.memoryTypeBits,
                                          allocateDedicatedMemory, allocationOut, memoryFlagsOut,
