...
void RendererVk::initFeatures(const ExtensionNameList &deviceExtensionNames)
{
    ...
    ANGLE_FEATURE_CONDITION((&mFeatures), extraCopyBufferRegion,
                            IsWindows() && IsIntel(mPhysicalDeviceProperties.vendorID))

    // http://anglebug.com/3055
    ANGLE_FEATURE_CONDITION((&mFeatures), forceCPUPathForCubeMapCopy,
                            IsWindows() && IsIntel(mPhysicalDeviceProperties.vendorID))
    ...
    ANGLE_FEATURE_CONDITION((&mFeatures), clampPointSize,
                            IsNvidia(mPhysicalDeviceProperties.vendorID))
    ...
    ANGLE_FEATURE_CONDITION((&mFeatures), disableFifoPresentMode,
    ...
    ANGLE_FEATURE_CONDITION((&mFeatures), forceNonZeroScissor,
                            IsWindows() && IsIntel(mPhysicalDeviceProperties.vendorID))
    ...
    ANGLE_FEATURE_CONDITION((&mFeatures), disallowSeamfulCubeMapEmulation,
                            IsWindows() && IsAMD(mPhysicalDeviceProperties.vendorID))

    ANGLE_FEATURE_CONDITION((&mFeatures), forceD16TexFilter,
                            IsAndroid() && IsQualcomm(mPhysicalDeviceProperties.vendorID))
