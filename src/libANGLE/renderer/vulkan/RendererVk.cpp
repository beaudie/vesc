                                     ...
                                     const char *wsiLayer)
{
    ...
    // Disable validation layers on Release Windows as the bots are not correctly set up
    // http://anglebug.com/3946
    mEnableValidationLayers = false;
#else
    ...
    // Currently disabling validation layers on 32-bit Android as it's hitting assert
    // http://anglebug.com/3924
