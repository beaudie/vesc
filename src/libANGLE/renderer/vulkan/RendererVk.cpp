...
angle::Result RendererVk::onBlobCacheFuncs(DisplayVk *display)
{
    // Blob cache functions have been set, so we can now create new pipelien cache, and then read
    // the cache data.
