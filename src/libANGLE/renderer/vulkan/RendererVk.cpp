...
void PackHeaderDataForPipelineCache(uint32_t cacheDataSize,
                                    ...
                                    uint64_t *dataOut)
{
    uint64_t concatenatedData = 0;
    concatenatedData          = cacheDataSize & 0xFFFFFFFF;
    concatenatedData          = (concatenatedData << 32) | compressedDataCRC;
    concatenatedData          = (concatenatedData << 16) | numChunks;
                                      ...
                                      size_t *chunkIndexOut)
{
    ...
    *compressedDataCRCOut = data & 0xFFFF;
    data >>= 16;
    *cacheDataSizeOut = data & 0xFFFFFFFF;
}
