                                     ...
                                     const char *wsiLayer)
{
    ...
    mDeviceVersion = mInstanceVersion = VK_API_VERSION_1_0;
    if (enumerateInstanceVersion)
    {
        ...
        if (isVulkan11Instance())
        {
            ...
            mDeviceVersion = kPreferredVulkanAPIVersion;
            ...
            {
                mDeviceVersion = VK_API_VERSION_1_1;
            }
        }
    }
    ...
    mApplicationInfo.apiVersion         = mDeviceVersion;
