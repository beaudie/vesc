                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    // subgroup_clustered, subgroup_shuffle, subgroup_basic, subgroup arithmetic
    ...
    const VkSubgroupFeatureFlags requiredSubgroupOp =
        ...
        VK_SUBGROUP_FEATURE_CLUSTERED_BIT | VK_SUBGROUP_FEATURE_ARITHMETIC_BIT;
    static constexpr bool supportTranscodeEtcToBc = false;
    ANGLE_FEATURE_CONDITION(
