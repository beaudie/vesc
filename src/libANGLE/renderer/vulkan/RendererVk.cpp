                                        ...
                                        vk::SharedResourceUsePool *resourcePool)
{
    ...
    std::lock_guard<std::mutex> lock(mGarbageMutex);
    resourceList->releaseResourceUses(resourcePool);
}
                                      ...
                                      Serial *serialOut)
{
    ...
    }
    {
        ...
        if (resourceList)
        {
            resourceList->releaseResourceUsesAndUpdateSerials(mCurrentQueueSerial, resourcePool);
        }
                                            ...
                                            Serial *serialOut)
{
    ...
    ANGLE_TRY(queueSubmit(context, priority, submitInfo, nullptr, nullptr, fence, serialOut));
