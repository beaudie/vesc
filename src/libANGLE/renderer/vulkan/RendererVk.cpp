    ...
    std::vector<VkPipelineStageFlags> &&waitSemaphoreStageMasks)
{
    ...
    if (isAsyncCommandQueueEnabled())
    {
        ANGLE_TRY(mCommandProcessor.flushWaitSemaphores(protectionType, priority,
    ...
    vk::RenderPassCommandBufferHelper **renderPassCommands)
{
    ...
    if (isAsyncCommandQueueEnabled())
    {
        ANGLE_TRY(mCommandProcessor.flushRenderPassCommands(context, protectionType, priority,
    ...
    vk::OutsideRenderPassCommandBufferHelper **outsideRPCommands)
{
    ...
    if (isAsyncCommandQueueEnabled())
    {
        ANGLE_TRY(mCommandProcessor.flushOutsideRPCommands(context, protectionType, priority,
                                                           outsideRPCommands));
    }
    else
    {
