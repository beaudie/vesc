...
vk::Error RendererVk::getInternalPipeline(const vk::ShaderAndSerial &vertexShader,
                                          ...
                                          vk::PipelineAndSerial **pipelineOut)
{
    ASSERT(vertexShader.queueSerial() == pipelineDesc.getShaderStageInfo()[0].moduleSerial);
    ASSERT(fragmentShader.queueSerial() == pipelineDesc.getShaderStageInfo()[1].moduleSerial);
