                                         ...
                                         vk::Shared<vk::Fence> *sharedFenceOut)
{
    ...
    {
        vk::ScopedShared<vk::Fence> fence(mDevice);
        fence.get().set(new vk::RefCounted<vk::Fence>(), mDevice);
        ...
        mSubmitFence = std::move(fence.release());
    }

    sharedFenceOut->set(mSubmitFence, mDevice);
    return angle::Result::Continue;
}
