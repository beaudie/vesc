...
MemoryReportCallback(const VkDeviceMemoryReportCallbackDataEXT *callbackData, void *userData)
{
    ...
    switch (callbackData->type)
    {
        case VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_ALLOCATE_EXT:
            reportType = " Alloc";
            rendererVk->allocatedMemory[callbackData->objectType] += callbackData->size;
            size = rendererVk->allocatedMemory[callbackData->objectType];
            break;
        ...
        case VK_DEVICE_MEMORY_REPORT_EVENT_TYPE_IMPORT_EXT:
            reportType = "Import";
            rendererVk->importedMemory[callbackData->objectType] += callbackData->size;
            size = rendererVk->importedMemory[callbackData->objectType];
            break;
