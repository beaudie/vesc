...
void RendererVk::findMaxPendingSuballocationGarbageSize()
{
    ...
    // The limit is capped to 1GB.
    constexpr VkDeviceSize kMaxPendingGarbageSize = 1 * 1024 * 1024 * 1024;
    mPendingSuballocationGarbageSizeLimit         = std::min(maxHeapSize, kMaxPendingGarbageSize);
}
