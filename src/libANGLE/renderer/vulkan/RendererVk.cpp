                                     ...
                                     const char *wsiLayer)
{
    ...
    ANGLE_VK_TRY_NO_LSAN(displayVk,
                         vkEnumerateInstanceLayerProperties(&instanceLayerCount, nullptr));

    std::vector<VkLayerProperties> instanceLayerProps(instanceLayerCount);
    if (instanceLayerCount > 0)
    {
        ANGLE_VK_TRY_NO_LSAN(displayVk, vkEnumerateInstanceLayerProperties(
                                            &instanceLayerCount, instanceLayerProps.data()));
    }
    ...
    ANGLE_VK_TRY_NO_LSAN(displayVk, vkEnumerateInstanceExtensionProperties(
    ...
    {
        ANGLE_VK_TRY_NO_LSAN(
            displayVk, vkEnumerateInstanceExtensionProperties(nullptr, &instanceExtensionCount,
    ...
    else
    {
        ...
        ANGLE_VK_TRY_NO_LSAN(displayVk, enumerateInstanceVersion(&apiVersion));
