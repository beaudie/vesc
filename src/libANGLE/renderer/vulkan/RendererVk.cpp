    ...
    VkPhysicalDeviceProperties2 *deviceProperties)
{
    ...
    {
        vk::AddToPNextChain(deviceFeatures, &mExternalFormatResolveFeaturesANDROID);
        vk::AddToPNextChain(deviceProperties, &mExternalFormatResolvePropertiesANDROID);
    }
#endif
}
...
#if defined(ANGLE_PLATFORM_ANDROID)
    mExternalFormatResolveFeaturesANDROID = {};
    mExternalFormatResolveFeaturesANDROID.sType =
        VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FORMAT_RESOLVE_FEATURES_ANDROID;

    mExternalFormatResolvePropertiesANDROID = {};
    mExternalFormatResolvePropertiesANDROID.sType =
...
#if defined(ANGLE_PLATFORM_ANDROID)
    mExternalFormatResolveFeaturesANDROID.pNext   = nullptr;
    mExternalFormatResolvePropertiesANDROID.pNext = nullptr;
#endif
}
    ...
    const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    if (mFeatures.supportsExternalFormatResolve.enabled)
    {
        ...
        vk::AddToPNextChain(&mEnabledFeatures, &mExternalFormatResolveFeaturesANDROID);
    }
#endif
}
