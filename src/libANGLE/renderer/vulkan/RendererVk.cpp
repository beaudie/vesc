                                                        ...
                                                        VkDeviceSize *sizeOut)
{
    ...
    *memoryFlagsOut =
    ...
    if (renderer->getFeatures().allocateNonZeroMemory.enabled &&
        (*memoryFlagsOut & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT) != 0)
    {
        result =
            mapMemoryAndInitWithNonZeroValue(renderer, allocationOut, *memoryFlagsOut, *sizeOut);
    }
                                                                   ...
                                                                   VkDeviceSize size)
{
    ...
    memset(mappedMemoryData, kNonZeroInitValue, static_cast<size_t>(size));
