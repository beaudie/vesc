...
bool RendererVk::canPreferDeviceLocalMemoryHostVisible()
{
    ...
    return memoryProperties.getMaxHeapSizeWithFlags(kHostVisiableDeviceLostFlags) >=
           memoryProperties.getMaxHeapSizeWithFlags(VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
}
