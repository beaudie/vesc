...
ICD ChooseICDFromAttribs(const egl::AttributeMap &attribs)
{
...
{
  public:
    ScopedVkLoaderEnvironment(bool enableValidationLayers, ICD icd)
...
// Android Vulkan loader doesn't need this either.
        ...
        if (mEnableValidationLayers || icd != ICD::Default)
        {
    ...
    ICD getEnabledICD() const { return mICD; }
  ...
  private:
    bool setICDEnvironment(const char *icd)
    {
        ...
        mChangedICDEnv  = angle::SetEnvironmentVar(gVkLoaderICDFilenamesEnv, icd);
