                                     ...
                                     const char *wsiLayer)
{
    ...
    tempBuffer.getMemoryRequirements(mDevice, &memoryRequirements);
    ASSERT(gl::isPow2(memoryRequirements.alignment));
    ...
    mDefaultBufferAlignment =
        std::max({static_cast<size_t>(limitsVk.minUniformBufferOffsetAlignment),
                  ...
                  static_cast<size_t>(memoryRequirements.alignment)});
