                                     ...
                                     const char *wsiLayer)
{
    ...
    if (mMemoryProperties.getMemoryTypeCount() > 0)
    {
        ...
        // Host visible vertex conversion buffer
        ...
        mVertexConversionBufferAlignment =
            std::max(static_cast<VkDeviceSize>(vk::kVertexBufferAlignment),
                     mPhysicalDeviceProperties.limits.minStorageBufferOffsetAlignment);
    }
