                              ...
                              const vk::ExtensionNameList &deviceExtensionNames)
{
    ...
    ANGLE_FEATURE_CONDITION(&mFeatures, disallowMixedDepthStencilLoadOpNoneAndLoad, isARM);
    ...
    // Numerous tests that previously never created a Vulkan pipeline fail or crash on Qualcomm
    // drivers when they do during cache warm up.
    ANGLE_FEATURE_CONDITION(&mFeatures, warmUpPipelineCacheAtLink, !isQualcommProprietary);
