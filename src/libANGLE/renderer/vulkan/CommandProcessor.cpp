...
class CommandProcessor::Task
{
  public:
    ...
    Task(Task &&other) : Task() { *this = std::move(other); }
...
// CommandProcessor::Task implementation
void CommandProcessor::Task::initTask()
{
...
void CommandProcessor::Task::initProcessCommands(CommandBufferHelper *commandBuffer,
...
void CommandProcessor::Task::copyPresentInfo(const VkPresentInfoKHR &other)
{
...
void CommandProcessor::Task::initPresent(egl::ContextPriority priority,
...
void CommandProcessor::Task::initFinishToSerial(Serial serial)
{
...
void CommandProcessor::Task::initFlushAndQueueSubmit(
    const std::vector<VkSemaphore> &waitSemaphores,
    const std::vector<VkPipelineStageFlags> &waitSemaphoreStageMasks,
    const Semaphore *semaphore,
    egl::ContextPriority priority,
...
void CommandProcessor::Task::initOneOffQueueSubmit(VkCommandBuffer commandBufferHandle,
                                                   egl::ContextPriority priority,
                                                   const Fence *fence,
                                                   Serial submitQueueSerial)
{
...
CommandProcessor::Task &CommandProcessor::Task::operator=(Task &&rhs)
{
    if (this == &rhs)
    {
        return *this;
...
void CommandProcessor::queueCommand(Task &&task)
{
...
angle::Result CommandProcessor::processTask(Task *task)
{
...
void CommandProcessor::destroy(RendererVk *renderer)
{
    Task endTask;
    endTask.initTask(CustomTask::Exit);
    queueCommand(std::move(endTask));
    (void)waitForWorkComplete(nullptr);
