...
void CommandProcessor::queueCommands(const vk::CommandProcessorTask &commands)
{
    ...
    ASSERT(commands.workerCommand == vk::CustomTask::Flush ||
           commands.workerCommand == vk::CustomTask::FinishToSerial ||
           commands.workerCommand == vk::CustomTask::QueueWaitIdle ||
           commands.workerCommand == vk::CustomTask::DeviceWaitIdle ||
           commands.workerCommand == vk::CustomTask::Present ||
           commands.workerCommand == vk::CustomTask::Exit || commands.commandBuffer == nullptr ||
