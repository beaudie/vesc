    ...
    const QueueSerial &submitQueueSerial)
{
    ...
    return queueSubmit(context, lock, queue, submitInfo, scopedBatch, &batch.fence.get(),
                       batch.queueSerial);
}
                                              ...
                                              const QueueSerial &submitQueueSerial)
{
    ...
    return queueSubmit(context, lock, queue, submitInfo, scopedBatch, fence, submitQueueSerial);
}
