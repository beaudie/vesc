...
angle::Result CommandProcessor::waitForAllWorkToBeSubmittedToDevice(Context *context)
{
    ANGLE_TRACE_EVENT0("gpu.angle", "CommandProcessor::waitForAllWorkToBeSubmittedToDevice");
    std::lock_guard<std::mutex> dequeueLock(mSubmissionMutex);
...
void CommandProcessor::destroy(Context *context)
{
    ...
    (void)waitForAllWorkToBeSubmittedToDevice(context);
...
void CommandProcessor::handleDeviceLost(RendererVk *renderer)
{
    ...
    std::lock_guard<std::mutex> enqueueLock(mWorkerMutex);
    (void)waitForAllWorkToBeSubmittedToDevice(this);
                                                  ...
                                                  const QueueSerial &submitQueueSerial)
{
    ...
    if (submitPolicy == SubmitPolicy::EnsureSubmitted)
    {
        ...
        // function.
        ANGLE_TRY(waitForQueueSerialToBeSubmittedToDevice(context, submitQueueSerial));
    }
...
angle::Result CommandProcessor::waitForResourceUseToBeSubmittedToDevice(vk::Context *context,
