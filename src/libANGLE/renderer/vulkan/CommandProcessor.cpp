                                              ...
                                              const bool isDeviceLost)
{
...

    {
        ...
        {
            bool finished;
            ANGLE_TRY(checkOneCommandBatch(context, &finished, isDeviceLost));
            if (!finished)
            {
                                                 ...
                                                 const bool isDeviceLost)
{
    ...
    *finished           = false;
    ...
    // Upon context destruction, if the device is lost, we assume all of the commands have finished,
