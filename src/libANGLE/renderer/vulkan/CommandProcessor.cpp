                                              ...
                                              uint64_t timeout)
{
    ...
    if (finishedCount > 0)
    {
        ANGLE_TRY(retireFinishedCommandsAndCleanupGarbageLocked(context));
    }
...
angle::Result CommandQueue::retireFinishedCommandsAndCleanupGarbageLocked(Context *context)
{
    RendererVk *renderer = context->getRenderer();
