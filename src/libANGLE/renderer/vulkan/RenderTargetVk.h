...
class RenderTargetVk final : public FramebufferAttachmentRenderTarget
{
  public:
    ...
    bool isImageTransient() const { return mPersistence != RenderTargetTransience::Default; }
    bool isEntirelyTransient() const
    {
        return mPersistence == RenderTargetTransience::EntirelyTransient;
    }
  ...
  private:
    ...
    RenderTargetTransience mPersistence;
};
