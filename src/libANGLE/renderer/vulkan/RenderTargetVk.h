...
class RenderTargetVk final : public FramebufferAttachmentRenderTarget
{
  public:
    ...
    bool needsClear(bool *useDefaultValueOut) const
    {
        return mImage->needsClear(mLevelIndex, mLayerIndex, useDefaultValueOut);
    }

    void setNeedsClear() { mImage->setNeedsClear(mLevelIndex, mLayerIndex, false); }
