...
class RenderTargetVk final : public FramebufferAttachmentRenderTarget
{
  public:
    ...
    // See the description of mIsImageDataEphemeral for details of how the following two can
    // interact.
  ...
  private:
    ...
    // !IsEphemeral            No resolve                |               Resolve
    ...
    //
    // In the above, storeOp of the resolve attachment is always STORE.  if !IsEphemeral, storeOp is
