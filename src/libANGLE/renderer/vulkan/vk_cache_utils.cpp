                                           ...
                                           RenderPassHelper *renderPassHelper)
{
    ...
    if (desc.hasDepthStencilResolveAttachment())
    {
        ...
        depthStencilResolve.depthResolveMode = desc.hasDepthStencilResolveAttachment()
                                                   ? VK_RESOLVE_MODE_SAMPLE_ZERO_BIT
                                                   : VK_RESOLVE_MODE_NONE;
        depthStencilResolve.stencilResolveMode = desc.hasDepthStencilResolveAttachment()
                                                     ? VK_RESOLVE_MODE_SAMPLE_ZERO_BIT
                                                     : VK_RESOLVE_MODE_NONE;
