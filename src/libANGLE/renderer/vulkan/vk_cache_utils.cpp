    ...
    Pipeline *pipelineOut) const
{
    ...
    const gl::ProgramExecutable *programExecutable = contextVk->getState().getProgramExecutable();
    if (programExecutable)
    {
        for (sh::ShaderVariable attribute : programExecutable->getProgramInputs())
        {
