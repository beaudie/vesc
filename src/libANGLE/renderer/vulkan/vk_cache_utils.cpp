...
size_t DescriptorSetLayoutDesc::hash() const
{
    ...
    {
        descriptorSetLayoutBindingsHash = angle::ComputeGenericHash(
    ...
    {
        immutableSamplersHash = angle::ComputeGenericHash(
            mImmutableSamplers.data(), validImmutableSamplersCount * sizeof(VkSampler));
    }
                                     ...
                                     const Sampler *immutableSampler)
{
    ...
    packedBinding.bindingIndex        = bindingIndex;
    packedBinding.hasImmutableSampler = 0;

    if (immutableSampler)
    {
        ASSERT(count == 1);
        packedBinding.hasImmutableSampler = 1;
...
void DescriptorSetLayoutDesc::unpackBindings(VkDescriptorSetLayoutBindingVector *bindings) const
{
