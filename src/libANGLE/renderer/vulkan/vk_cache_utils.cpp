...
void RenderPassDesc::packDepthStencilAttachment(angle::FormatID formatID, bool readOnly)
{
    ...
    size_t offset     = readOnly ? Color0DepthStencilRead : Color0DepthStencilWrite;
