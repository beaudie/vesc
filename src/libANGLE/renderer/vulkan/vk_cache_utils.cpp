    ...
    for (uint32_t samplerIndex = 0; samplerIndex < samplerBindings.size(); ++samplerIndex)
    {
        ...
        for (uint32_t arrayElement = 0; arrayElement < arraySize; ++arrayElement)
        {
            ...
            else
            {
                ...
                // std::cout << "descIndex=" << descIndex << " textureIndex=" << textureIndex
                //           << " imageViewSerialOrOffset=" << infoDesc.imageViewSerialOrOffset
                //           << " samplerOrBufferSerial=" << infoDesc.samplerOrBufferSerial
                //           << std::endl;
            }
