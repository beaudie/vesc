...
{
    ASSERT(mPackedDescriptorSetLayout.size() == mValidDescriptorSetLayoutIndexMask.count());
    ASSERT(mImmutableSamplers.size() == mValidDescriptorSetLayoutIndexMask.count());
