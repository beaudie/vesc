                                               ...
                                               Pipeline *pipelineOut) const
{
    ...
    angle::FixedVector<VkVertexInputBindingDescription, gl::MAX_VERTEX_ATTRIBS> bindingDescs(
        activeAttribCount);
    angle::FixedVector<VkVertexInputAttributeDescription, gl::MAX_VERTEX_ATTRIBS> attributeDescs(
        activeAttribCount);
