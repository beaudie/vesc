...
{
    ASSERT(layout != RenderPassDepthStencilLayout::Unused);
    ...
    size_t offset     = layout == RenderPassDepthStencilLayout::ReadOnly ? Color0DepthStencilRead
                                                                     : Color0DepthStencilWrite;
