                                              ...
                                              vk::RenderPassPerfCounters *countersOut)
{
    ...
    countersOut->depthStores +=
        ds.storeOp == static_cast<uint32_t>(RenderPassStoreOp::Store) ? 1 : 0;
    ...
    countersOut->stencilStores +=
        ds.stencilStoreOp == static_cast<uint32_t>(RenderPassStoreOp::Store) ? 1 : 0;
    ...
    vk::RenderPassPerfCounters *countersOut)
{
    ...
    countersOut->depthStores +=
        dsResolve.storeOp == static_cast<uint32_t>(RenderPassStoreOp::Store) ? 1 : 0;
    ...
    countersOut->stencilStores +=
        dsResolve.stencilStoreOp == static_cast<uint32_t>(RenderPassStoreOp::Store) ? 1 : 0;
