...
void InitializeDefaultSubpassSelfDependencies(std::vector<VkSubpassDependency> *subpassDependencies,
                                              uint32_t subpassIndex)
{
    ...
    dependency->dstAccessMask =
        VK_ACCESS_INPUT_ATTACHMENT_READ_BIT | VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT;
    dependency->dependencyFlags = VK_DEPENDENCY_BY_REGION_BIT;
}
                                           ...
                                           RenderPassHelper *renderPassHelper)
{
    ...
    InitializeDefaultSubpassSelfDependencies(&subpassDependencies, drawSubpassIndex);
