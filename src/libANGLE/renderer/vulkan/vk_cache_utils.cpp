...
DescriptorSetLayoutDesc::DescriptorSetLayoutDesc()
    : mBindingIndices{}, mDescriptorSetLayoutBindings{}, mImmutableSamplers{}
{}
...
size_t DescriptorSetLayoutDesc::hash() const
{
    ...
    ASSERT(mDescriptorSetLayoutBindings.size() == validDescriptorSetLayoutCount);
...
bool DescriptorSetLayoutDesc::operator==(const DescriptorSetLayoutDesc &other) const
{
    return mBindingIndices == other.mBindingIndices &&
           mDescriptorSetLayoutBindings == other.mDescriptorSetLayoutBindings &&
...
void DescriptorSetLayoutDesc::unpackBindings(DescriptorSetLayoutBindingVector *bindings) const
{
    ...
    {
        const PackedDescriptorSetBinding &packedBinding = mDescriptorSetLayoutBindings[position];
