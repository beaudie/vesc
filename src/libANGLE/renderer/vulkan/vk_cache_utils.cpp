    ...
    Pipeline *pipelineOut) const
{
    ...
    inputAssemblyState.topology =
        static_cast<VkPrimitiveTopology>(mInputAssembltyAndColorBlendStateInfo.primitive.topology);
    inputAssemblyState.primitiveRestartEnable =
        static_cast<VkBool32>(mInputAssembltyAndColorBlendStateInfo.primitive.restartEnable);
                                             ...
                                             GLuint relativeOffset)
{
    ...
    constexpr size_t kBindingBaseBit = offsetof(GraphicsPipelineDesc, mVertexInputBindings) >> 2;
    ...
    ANGLE_SET_INDEXED_TRANSITION_BIT(transition, mVertexInputAttribs, formats, attribIndex, 8);
    ANGLE_SET_INDEXED_TRANSITION_BIT(transition, mVertexInputAttribs, offsets, attribIndex, 16);
}

void GraphicsPipelineDesc::updateTopology(GraphicsPipelineTransitionBits *transition,
                                          gl::PrimitiveMode drawMode)
{
    mInputAssembltyAndColorBlendStateInfo.primitive.topology =
        static_cast<uint32_t>(gl_vk::GetPrimitiveTopology(drawMode));
    ANGLE_SET_TRANSITION_BIT(transition, mInputAssembltyAndColorBlendStateInfo, primitive);
}
                                            ...
                                            const gl::ColorF &color)
{
    ...
    constexpr size_t kSize = sizeof(mInputAssembltyAndColorBlendStateInfo.blendConstants[0]) * 8;
    ANGLE_SET_INDEXED_TRANSITION_BIT(transition, mInputAssembltyAndColorBlendStateInfo,
                                              ...
                                              bool isBlendEnabled)
{
    ...
    ANGLE_SET_TRANSITION_BIT(transition, mInputAssembltyAndColorBlendStateInfo, blendEnableMask);
}
                                                ...
                                                const gl::BlendState &blendState)
{
    ...
    {
        PackedColorBlendAttachmentState &blendAttachmentState =
            mInputAssembltyAndColorBlendStateInfo.attachments[attachmentIndex];
