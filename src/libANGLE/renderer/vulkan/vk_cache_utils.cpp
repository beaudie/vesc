...
void InitializeDefaultSubpassSelfDependencies(const RenderPassDesc &desc,
                                           ...
                                           RenderPassHelper *renderPassHelper)
{
    ...
    InitializeDefaultSubpassSelfDependencies(desc, drawSubpassIndex, &subpassDependencies);
