                                              ...
                                              vk::RenderPassPerfCounters *renderPassCounters)
{
    ...
    VkExternalFormatANDROID externalFormat = {VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID, nullptr,
                                              0};
#endif
    bool isYUVExternalFormat = false;
    ...
    for (uint32_t colorIndexGL = 0; colorIndexGL < desc.colorAttachmentRange(); ++colorIndexGL)
    {
        ...
        if (attachmentFormatID >= angle::FormatID::EXTERNAL0 &&
            attachmentFormatID <= angle::FormatID::EXTERNAL7)
        {
            ASSERT(!isYUVExternalFormat);
            isYUVExternalFormat = true;
            const ExternalYuvFormatInfo &externalFormatInfo =
