                         ...
                         angle::FormatID intendedFormatID)
{
    ...
    else
    {
        ...
        {
            ASSERT(vkFormat.getActualImageVkFormat(false) == vkFormat.getActualImageVkFormat(true));
            mExternalOrVkFormat = ToUnderlying(vkFormat.getActualImageVkFormat(false));
        }
    }
