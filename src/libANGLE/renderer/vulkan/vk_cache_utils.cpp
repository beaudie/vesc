                                               ...
                                               gl::ComponentType vsInputType)
{
    ...
    {
        if (attribType == gl::VertexAttribType::Float || attribType == gl::VertexAttribType::Fixed)
        {
            attribType = vsInputType == gl::ComponentType::Int ? gl::VertexAttribType::Int
                                                               : gl::VertexAttribType::UnsignedInt;
        }
        else if (attribType == gl::VertexAttribType::HalfFloat ||
                 attribType == gl::VertexAttribType::HalfFloatOES)
        {
        ...
        if (attribType != programAttribType)
        {
                ...
                programAttribType == gl::ComponentType::Float)
            {
                ...
                if (programAttribType != gl::ComponentType::Float)
                {
                    vkFormat =
                        context->getRenderer()
                            ->getFormat(patchVertexAttribComponentType(formatID, programAttribType))
