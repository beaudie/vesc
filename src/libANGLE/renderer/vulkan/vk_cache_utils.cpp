...
void InitializeSpecializationInfo(
    ...
    vk::SpecConstMap<VkSpecializationMapEntry> *specializationEntriesOut,
    vk::SpecConstMap<VkBool32> *specializationValuesOut,
    VkSpecializationInfo *specializationInfoOut)
{
    // Collect specialization constants.
    for (const vk::SpecConstId id : angle::AllEnums<vk::SpecConstId>())
    {
    ...
    Pipeline *pipelineOut) const
{
    ...
    vk::SpecConstMap<VkSpecializationMapEntry> specializationEntries;
    vk::SpecConstMap<VkBool32> specializationValues;
