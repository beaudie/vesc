...
void SamplerDesc::update(const gl::SamplerState &samplerState)
{
    ...
    SetBitField(mCompareEnabled, samplerState.getCompareMode() == GL_COMPARE_REF_TO_TEXTURE);
    SetBitField(mCompareOp, gl_vk::GetCompareOp(samplerState.getCompareFunc()));
