...
// SynchronizingPipelineCache implementation.
void SynchronizingPipelineCache::getLock(std::unique_lock<std::mutex> *lockOut)
{
    if (mMutex != nullptr)
    {
...
angle::Result SynchronizingPipelineCache::createGraphicsPipeline(
    ContextVk *contextVk,
    ...
    vk::Pipeline *pipelineOut)
{
    ...
    ANGLE_VK_TRY(contextVk,
                 pipelineOut->initGraphics(contextVk->getDevice(), createInfo, *mPipelineCache));

    return angle::Result::Continue;
}

angle::Result SynchronizingPipelineCache::createComputePipeline(
    ContextVk *contextVk,
    ...
    vk::Pipeline *pipelineOut)
{
    ...
    ANGLE_VK_TRY(contextVk,
                 pipelineOut->initCompute(contextVk->getDevice(), createInfo, *mPipelineCache));
