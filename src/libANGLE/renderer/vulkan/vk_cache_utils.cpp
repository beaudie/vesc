...
void ShaderBuffersDescriptorDesc::reset()
{
    ...
    for (size_t reservedIndex = 0; reservedIndex < kReservedBufferMasks; ++reservedIndex)
    {
...
void ShaderBuffersDescriptorDesc::setBufferMask(uint32_t bufferTypeIndex, uint64_t bufferMask)
{
    mPayload[bufferTypeIndex * 2]     = bufferMask & (angle::Bit<uint64_t>(32) - 1);
    mPayload[bufferTypeIndex * 2 + 1] = bufferMask >> 32;
}

void ShaderBuffersDescriptorDesc::addBufferSerial(BufferSerial bufferSerial)
{
