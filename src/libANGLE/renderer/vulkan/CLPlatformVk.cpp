...
angle::Result CLPlatformVk::initBackendRenderer()
{
    ...
    // In memory |SizedMRUCache| does not require dual slot and support zero sized values.
    featureOverrides.disabled.push_back("useDualPipelineBlobCacheSlots");
    featureOverrides.enabled.push_back("hasBlobCacheWithZeroSizedValuesSupport");
