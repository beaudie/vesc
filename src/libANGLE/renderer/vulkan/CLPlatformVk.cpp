...
constexpr vk::UseDebugLayers kUseValidationLayers = vk::UseDebugLayers::YesIfAvailable;
#else
constexpr vk::UseDebugLayers kUseValidationLayers = vk::UseDebugLayers::No;
#endif
...
angle::Result CLPlatformVk::initBackendRenderer()
{
    ...
    ANGLE_TRY(mRenderer->initialize(this, this, angle::vk::ICD::Default, 0, 0, kUseValidationLayers,
