                                          ...
                                          uint32_t queueFamilyIndex)
{
    ...
    VkAllocationCallbacks callback = MemoryAllocationCallback::BuildCallbackCommandPool(callbacks);
    ANGLE_VK_TRY(context, mCommandPool.init(context->getDevice(), commandPoolInfo, &callback));
