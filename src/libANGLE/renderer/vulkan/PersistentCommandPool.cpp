...
angle::Result PersistentCommandPool::init(vk::Context *context, uint32_t queueFamilyIndex)
{
    ...
    // TODO (https://issuetracker.google.com/issues/) We currently reset individual
    //  command buffers (CBs) from this pool. Alternatively we could reset the entire command pool.
