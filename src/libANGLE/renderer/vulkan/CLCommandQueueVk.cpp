                                                  ...
                                                  CLEventImpl::CreateFunc *eventCreateFunc)
{
    ...
    else
    {
        ...
        commandBuffer->copyBuffer(bufferVk.getBuffer().getBuffer(),
                                  transferBufferVk.getBuffer().getBuffer(), 1, &copyRegion);
    }
...
angle::Result CLCommandQueueVk::onResourceAccess(const vk::CommandBufferAccess &access)
{
    ...
    // TODO (g.tammana) handle images
    // http://angleproject:8512
