...
{
    WARN() << "\"clSetCommandQueueProperty\" has been deprecated as of OpenCL 1.1";
    UNIMPLEMENTED();
...
cl_int CLCommandQueueVk::enqueueNativeKernel(cl::UserFunc userFunc,
                                             ...
                                             CLEventImpl::CreateFunc *eventCreateFunc)
{
    // We currently do not support native kernels
...
{
    WARN() << "\"clEnqueueMarker\" has been deprecated as of OpenCL 1.2 ";
    UNIMPLEMENTED();
    return CL_OUT_OF_RESOURCES;  // TODO(annestrand) Placeholder error for now
}
...
{
    WARN() << "\"clEnqueueWaitForEvents\" has been deprecated as of OpenCL 1.2 ";
    UNIMPLEMENTED();
    return CL_OUT_OF_RESOURCES;  // TODO(annestrand) Placeholder error for now
}
