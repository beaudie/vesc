                                                        ...
                                                        const BlitResolveParameters &params)
{
    ...
    blitBuffer.get().retainBuffer(&contextVk->getResourceUseList(), vk::ResourceUseType::Read);
                                     ...
                                     const CopyImageBitsParameters &params)
{
    ...
    dstBuffer.get().retainBuffer(&contextVk->getResourceUseList(), vk::ResourceUseType::Read);
