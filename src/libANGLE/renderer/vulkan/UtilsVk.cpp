                              ...
                              bool stencilWrite)
{
    ...
    if (depthWrite)
    {
        ...
        renderPassCommands->updateDepthReadOnlyMode(contextVk,
                                                    framebuffer->isReadOnlyDepthFeedbackLoopMode());
    }
    if (stencilWrite)
    {
        ...
        renderPassCommands->updateStencilReadOnlyMode(
            contextVk, framebuffer->isReadOnlyStencilFeedbackLoopMode());
    }
}
