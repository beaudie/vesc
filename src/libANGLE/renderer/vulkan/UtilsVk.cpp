...
uint32_t GetFormatDefaultChannelMask(const angle::Format &intendedFormat,
                                 ...
                                 const CopyImageParameters &params)
{
    ...
    shaderParams.srcIsSRGB  = srcColorEncoding == GL_SRGB;
    shaderParams.destIsSRGB = destColorEncoding == GL_SRGB;
