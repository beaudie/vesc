                                                  ...
                                                  size_t pushConstantsSize)
{
    ...
    ANGLE_TRY(context->getDescriptorSetLayout(descriptorSetDesc,
    ...
    ANGLE_TRY(context->getPipelineLayout(pipelineLayoutDesc, mDescriptorSetLayouts[function],
                                       ...
                                       vk::CommandBuffer **commandBufferOut)
{
    ...
    ANGLE_TRY(contextVk->getCompatibleRenderPass(renderPassDesc, &renderPass));
                                  ...
                                  const ClearImageParameters &params)
{
    ...
    vk::CommandBuffer *commandBuffer;
    if (!framebuffer->appendToStartedRenderPass(contextVk->getCurrentQueueSerial(), &commandBuffer))
    {
