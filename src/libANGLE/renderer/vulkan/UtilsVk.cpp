                                 ...
                                 const CopyImageParameters &params)
{
    ...
    if (src->isLayoutChangeNecessary(vk::ImageHelper::Layout::FragmentShaderReadOnly))
    {
        vk::CommandBuffer *srcLayoutChange;
        ANGLE_TRY(src->recordCommands(contextVk, &srcLayoutChange));
        src->changeLayout(VK_IMAGE_ASPECT_COLOR_BIT,
                          vk::ImageHelper::Layout::FragmentShaderReadOnly, srcLayoutChange);
    }
    ...
    dest->changeLayout(VK_IMAGE_ASPECT_COLOR_BIT, vk::ImageHelper::Layout::ColorAttachment,
                       destLayoutChange);
