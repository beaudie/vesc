                                                        ...
                                                        const BlitResolveParameters &params)
{
    ...
    blitBuffer.get().retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
                                     ...
                                     const CopyImageBitsParameters &params)
{
    ...
    srcBuffer.get().retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
    dstBuffer.get().retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
