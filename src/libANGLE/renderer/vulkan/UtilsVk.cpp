                                                        ...
                                                        const BlitResolveParameters &params)
{
    ...
    ANGLE_VK_TRY_ALLOC(
        ...
        blitBuffer.get().initSuballocation(
            ...
            BufferUsageType::Static, &isOutOfMemory));
                                     ...
                                     const CopyImageBitsParameters &params)
{
    ...
    ANGLE_VK_TRY_ALLOC(
        contextVk, srcBuffer.get().init(contextVk, bufferInfo, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                                        &isOutOfMemory));
    ...
    ANGLE_VK_TRY_ALLOC(
        contextVk, dstBuffer.get().init(contextVk, bufferInfo, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                                        &isOutOfMemory));
