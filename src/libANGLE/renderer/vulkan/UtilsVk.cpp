                                           ...
                                           const ConvertVertexParameters &params)
{
    ...
    const uint32_t srcValueBits = shaderParams.Bs * 8;
    ...
    switch (flags)
    {
        ...
        case ConvertVertex_comp::kSnormToFloat:
            // The largest signed number is 0b011...1 which is srcValueMask >> 1
            shaderParams.srcEmulatedAlpha = srcValueMask >> 1;
            break;

        case ConvertVertex_comp::kUnormToFloat:
            // The largest unsigned number is 0b11...1 which is srcValueMask
        ...
        case ConvertVertex_comp::kFloatToFloat:
            shaderParams.srcEmulatedAlpha = kFloatOne.asUint;
            break;
                                     ...
                                     const CopyImageBitsParameters &params)
{
    ...
    const VkDeviceSize srcBufferSize = roundUpPow2(srcPixelBytes * totalPixelCount, 4u);
    const VkDeviceSize dstBufferSize = roundUpPow2(dstPixelBytes * totalPixelCount, 4u);
