                                 ...
                                 const CopyImageParameters &params)
{
    ...
    // TODO(ianelliott): Understand why the following work-around is needed, at least on a Pixel 4
    // XL.  The scissor (above) will prevent rendering from occuring outside of the intended area.
    if ((params.srcRotation == SurfaceRotation::Rotated90Degrees) ||
        (params.srcRotation == SurfaceRotation::Rotated270Degrees))
    {
