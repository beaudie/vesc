                                            ...
                                            vk::RenderPassCommandBuffer *commandBuffer)
{
    ...
    return setupGraphicsProgram(contextVk, mPipelineLayouts[function].get(), vsShader, fsShader,
                                programAndPipelines, pipelineDesc, descriptorSet, pushConstants,
                                pushConstantsSize, commandBuffer);
}
                                 ...
                                 const CopyImageParameters &params)
{
    ...
    vk::SamplerDesc samplerDesc(contextVk, gl::SamplerState(), false,
                                &src->getYcbcrConversionDesc(), src->getIntendedFormatID());
    ...
    ANGLE_TRY(setupGraphicsProgram(contextVk, mImageCopyPipelineLayouts[samplerDesc].get(),
                                   vertexShader, fragmentShader, &mImageCopy[flags][samplerDesc],
