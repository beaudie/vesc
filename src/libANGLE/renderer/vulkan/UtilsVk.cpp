                                  ...
                                  const ClearImageParameters &params)
{
    ...
    ANGLE_TRY(dst->initLayerImageView(contextVk, destViewType, VK_IMAGE_ASPECT_COLOR_BIT,
                                      ...
                                      params.dstLayer, 1, gl::YuvSamplingMode::Default,
                                         ...
                                         const CopyImageToBufferParameters &params)
{
    ...
    angle::FormatID actualFormat = src->getActualFormatID();
    ...
    if (params.unresolveDepth || params.unresolveStencil)
    {
        ...
        if (params.unresolveDepth)
        {
            ANGLE_TRY(depthStencilSrc->initLayerImageView(
                ...
                &depthView.get(), levelIndex, 1, layerIndex, 1, gl::YuvSamplingMode::Default,
                vk::ImageHelper::kDefaultImageViewUsageFlags));
        ...
        if (params.unresolveStencil)
        {
            ANGLE_TRY(depthStencilSrc->initLayerImageView(
                ...
                &stencilView.get(), levelIndex, 1, layerIndex, 1, gl::YuvSamplingMode::Default,
                vk::ImageHelper::kDefaultImageViewUsageFlags));
