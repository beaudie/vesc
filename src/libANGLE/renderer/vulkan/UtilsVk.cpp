                                                  ...
                                                  size_t pushConstantsSize)
{
    ...
    ANGLE_TRY(context->getRenderer()->getDescriptorSetLayout(
        context, descriptorSetDesc, &mDescriptorSetLayouts[function][kSetIndex]));
    ...
    ANGLE_TRY(context->getRenderer()->getPipelineLayout(
