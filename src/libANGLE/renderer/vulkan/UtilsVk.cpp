                                        ...
                                        const VkBufferImageCopy *copyRegion)
{
    ...
    shaderParams.offsetX             = copyRegion->imageOffset.x;
    shaderParams.offsetY             = copyRegion->imageOffset.y;
    shaderParams.texelOffset         = 0;
    shaderParams.width               = static_cast<int32_t>(width);
    shaderParams.height              = static_cast<int32_t>(height);
    shaderParams.alphaBits           = static_cast<int32_t>(format.alphaBits);
