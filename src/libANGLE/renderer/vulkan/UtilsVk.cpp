...
angle::Result UtilsVk::startRenderPass(ContextVk *contextVk,
                                       ...
                                       vk::CommandBuffer **preRenderPassCommandBufferOut,
                                       vk::CommandBuffer **renderPassCommandBufferOut)
{
    ...
    ANGLE_TRY(image->beginRenderPass(contextVk, framebuffer, renderArea, renderPassDesc,
                                     ...
                                     preRenderPassCommandBufferOut, renderPassCommandBufferOut));
                                 ...
                                 const CopyImageParameters &params)
{
    ...
    vk::CommandBuffer *commandBuffer;
    ANGLE_TRY(startRenderPass(contextVk, dest, destView, renderPassDesc, renderArea,
                              &layoutTransitionCommandBuffer, &commandBuffer));

    dest->changeLayoutWithCommand(VK_IMAGE_ASPECT_COLOR_BIT, vk::ImageLayout::ColorAttachment,
                                  layoutTransitionCommandBuffer);
