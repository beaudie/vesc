                                        ...
                                        const BlitResolveParameters &params)
{
    ...
    // open.  Otherwise, this function closes the render pass, which may incur a flush and then
    // the views are used in a new command buffer without having been retained for it.
