                                     ...
                                     gl::ShaderMap<std::string> *shaderSourcesOut)
{
    ...
    if (!intermediateSources[gl::ShaderType::Vertex].empty())
    {
        AssignAttributeLocations(programState, &intermediateSources[gl::ShaderType::Vertex]);
        AssignOutputLocations(programState, &intermediateSources[gl::ShaderType::Fragment]);
        AssignVaryingLocations(resources, &intermediateSources[gl::ShaderType::Vertex],
                               &intermediateSources[gl::ShaderType::Fragment]);
    }
