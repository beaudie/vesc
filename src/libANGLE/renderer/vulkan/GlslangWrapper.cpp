                                             ...
                                             const std::string &layoutString)
{
    ...
    const char *kQualifierEndMarker = " @@";
    searchStringBuilder << kLayoutMarkerBegin << variableName << kQualifierEndMarker;
    ...
    if (qualifierPos != std::string::npos)
    {
        ...
        size_t innerContentEndPos   = shaderString->find(kQualifierEndMarker, innerContentBeginPos);
        std::string innerContent =
            shaderString->substr(innerContentBeginPos, innerContentEndPos - innerContentBeginPos);
        angle::ReplaceSubstring(
            shaderString, kQualifierMarkerBegin + innerContent + kQualifierEndMarker, innerContent);
    }
}
...
void CleanupUnusedMarker(std::string *shaderSource, std::string marker)
{
    ...
    while (pos != std::string::npos)
    {
        ...
        size_t innerContentEndPos   = shaderSource->find(kMarkerEnd, pos);
        std::string innerContent =
