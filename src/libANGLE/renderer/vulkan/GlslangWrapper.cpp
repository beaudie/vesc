                                     ...
                                     std::string *fragmentSourceOut)
{
    ...
    vertexSource.insertDefaultUniformsSpecifier(std::move(vertexDefaultUniformsBinding));
    fragmentSource.insertDefaultUniformsSpecifier(std::move(fragmentDefaultUniformsBinding));
