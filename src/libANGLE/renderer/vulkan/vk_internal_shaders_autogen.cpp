                                    ...
                                    const ShaderAndSerial **shaderOut)
{
    ...
    ASSERT((shaderFlags & functionMask) >= DispatchUtils_comp::IS_CLEAR &&
           (shaderFlags & functionMask) <= DispatchUtils_comp::IS_COPY)
    ASSERT((shaderFlags & resourcetypeMask) >= DispatchUtils_comp::IS_BUFFER &&
           (shaderFlags & resourcetypeMask) <= DispatchUtils_comp::IS_TEXTURE2DArray)
