                                                       ...
                                                       vk::ImageHelper &srcImageHelper)
{
    ...
    // 2- copy the image to the newly acquired buffer.
    ...
    commandBuffer->copyImageToBuffer(bufferHandle, srcImageHelper.getImage(),
                                     srcImageHelper.getCurrentLayout(), 1, &copyToBuffer);
    ...
    // 3- create a new item for mSubresourceUpdates with the populated buffer
