...
bool NeedsRGBAEmulation(angle::FormatID formatID)
{
    return GetRGBAEmulationDstFormat(formatID) != angle::FormatID::NONE;
}
}  // anonymous namespace
                                   ...
                                   gl::Command source)
{
    ...
    if (mState.getBuffer().get() != nullptr)
    {
        ...
        if (NeedsRGBAEmulation(getBaseLevelFormat(renderer).getIntendedFormatID()))
        {
                                                   ...
                                                   const vk::BufferView **viewOut)
{
    ...
    if (NeedsRGBAEmulation(imageUniformFormat->getIntendedFormatID()))
    {
