...
bool TextureVk::isMutableTextureConsistentlySpecifiedForFlush()
{
    ...
    // For performance, flushing is skipped if the number of staged updates in a mip level is more
    // than one. For a cubemap, this applies to each face of the cube instead.
