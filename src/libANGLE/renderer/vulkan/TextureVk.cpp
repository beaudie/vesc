                                                   ...
                                                   FramebufferAttachmentRenderTarget **rtOut)
{
    ...
    const RenderToTextureSampleCount samplesIndex =
        static_cast<RenderToTextureSampleCount>(PackSampleCount(samples));
...
angle::Result TextureVk::initRenderTargets(ContextVk *contextVk,
                                           GLuint layerCount,
                                           GLuint levelIndex,
                                           RenderToTextureSampleCount samplesIndex)
{
    ...
    for (uint32_t layerIndex = 0; layerIndex < layerCount; ++layerIndex)
    {
        ...
        const bool isMultisampledRenderToTexture =
            samplesIndex != RenderToTextureSampleCount::NotRenderToTexture;
