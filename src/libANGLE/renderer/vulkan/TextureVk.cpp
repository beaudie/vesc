                                   ...
                                   ImageMipLevels mipLevels)
{
        ...
        contextVk->getFeatures().supportsMultisampledRenderToSingleSampled.enabled)
    {
        ...
        if (vk::ImageHelper::FormatSupportsUsage(renderer, actualImageFormat, imageType,
                                                 imageTiling, mImageUsageFlags,
                                                 createFlagsMultisampled, nullptr, true) &&
            vk::ImageHelper::FormatSupportsUsage(renderer, additionalViewFormat, imageType,
                                                 imageTiling, mImageUsageFlags,
                                                 createFlagsMultisampled, nullptr, true))
        {
