                              ...
                              VkClearValue *clearValueOut)
{
    ...
    *clearValueOut = {};
    if (!intendedFormat.hasDepthOrStencilBits())
    {
        ...
        intendedFormat.pixelReadFunction(constValue, reinterpret_cast<uint8_t *>(&colorValue));
    ...
    else
    {
        uint32_t dsData[4] = {0};
        double depthValue  = 0;
        intendedFormat.pixelReadFunction(constValue, reinterpret_cast<uint8_t *>(dsData));
                                       ...
                                       const uint8_t *data)
{
    ...
    GetVkClearValueFromBytes(constValue.data(), intendedFormat, &clearValue);
