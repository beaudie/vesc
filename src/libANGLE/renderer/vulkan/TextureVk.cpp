                                   ...
                                   const gl::Texture::DirtyBits &dirtyBits)
{
    ...
    samplerInfo.minLod = gl_vk::GetSamplerMinLod(samplerState, samplerState.getMinLod());
    samplerInfo.maxLod = gl_vk::GetSamplerMaxLod(samplerState, samplerState.getMaxLod());
