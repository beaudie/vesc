                                        ...
                                        TextureVk *source)
{
    ...
    if (sourceInternalFormat == GL_ALPHA8_EXT || sourceInternalFormat == GL_LUMINANCE8_EXT ||
        sourceInternalFormat == GL_LUMINANCE8_ALPHA8_EXT)
    {
        pixelReadFunction = sourceVkFormat.angleFormat().pixelReadFunction;
    }
    if (destInternalFormat == GL_ALPHA8_EXT || destInternalFormat == GL_LUMINANCE8_EXT ||
        destInternalFormat == GL_LUMINANCE8_ALPHA8_EXT)
    {
