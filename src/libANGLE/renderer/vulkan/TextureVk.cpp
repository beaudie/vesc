                                          ...
                                          gl::Framebuffer *source)
{
    ...
    if (canDraw)
    {
        ...
        // TODO: test to see if the bots ever hit this path.
        ASSERT(false);
        ...
        return copySubImageImplWithDraw(
            contextVk, index, modifiedDestOffset,
            gl::Offset(clippedSourceArea.x, clippedSourceArea.y, 0),
            gl::Extents(clippedDestArea.width, clippedDestArea.height, 1), framebufferVk);
    }
    fprintf(stderr, "----------------- USING SLOW PATH\n");
