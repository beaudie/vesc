                                          ...
                                          gl::Framebuffer *source)
{
    ...
    if (CanCopyWithDraw(renderer, srcFormat, destFormat) && !forceCPUPath)
    {
        ...
        const vk::ImageView *fetchImageView = nullptr;
        ANGLE_TRY(colorReadRT->getFetchImageViewAndRecordUse(contextVk, &fetchImageView));
        ...
        return copySubImageImplWithDraw(contextVk, offsetImageIndex, modifiedDestOffset, destFormat,
                                        ...
                                        &colorReadRT->getImage(), fetchImageView);
    }
                                                      ...
                                                      vk::ImageHelper *srcImage)
{
    ...
    ASSERT(layerCount == (uint32_t)gl::ImageIndex::kEntireLevel ||
           layerCount == (uint32_t)sourceBox.depth);
    ...
    {
        ASSERT(srcSubresource.baseArrayLayer == (uint32_t)srcOffset.z);
        srcOffset.z = 0;
    }
