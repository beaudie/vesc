                               ...
                               bool selfOwned)
{
    ...
    for (uint32_t i = 0; i < mRenderTargets.size(); ++i)
    {
        mRenderTargets[i].clear();
    }
                                                   ...
                                                   FramebufferAttachmentRenderTarget **rtOut)
{
    ...
    ASSERT(imageIndex.getLevelIndex() != -1);
    ...
    ASSERT(imageIndex.getLevelIndex() < (GLint)mRenderTargets.size());
