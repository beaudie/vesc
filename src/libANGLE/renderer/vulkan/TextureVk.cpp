                                            ...
                                            const gl::ImageIndex &imageIndex)
{
    ...
    {
        // The Vulkan spec states: vkCmdClearColorImage(): image must not use any of the formats
        // that require a sampler {YCbCr} conversion, so skip the content initialization
        return angle::Result::Continue;
    }
    else
    {
