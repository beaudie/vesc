                                             ...
                                             const vk::ImageView **imageViewOut)
{
    ...
    return mImageViews.getAliasedLevelDrawImageView(contextVk, mState.getType(), *mImage,
                                                    nativeLevel, nativeLayer, mImageUsageFlags,
                                                    format.vkImageFormat, imageViewOut);
}
