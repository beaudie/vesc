...
gl::Error TextureVk::onDestroy(const gl::Context *context)
{
    ...
    mSampler.release(contextVk, getStoredQueueSerials());
...
void TextureVk::releaseImage(const gl::Context *context)
{
    ...
    mBaseLevelImageView.release(contextVk, getStoredQueueSerials());
    mMipmapImageView.release(contextVk, getStoredQueueSerials());
