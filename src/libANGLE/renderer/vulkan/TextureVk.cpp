                              ...
                              const uint8_t *pixels)
{
    ...
    if (pixels)
    {
        ...
        ANGLE_TRY(renderer->createStagingImage(TextureDimension::TEX_2D, vkFormat, size, &stagingImage));
        ...
        loadFunction.loadFunction(size.width, size.height, size.depth, source, inputRowPitch, inputDepthPitch, mapPointer, inputRowPitch, inputDepthPitch);
