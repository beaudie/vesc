                                        ...
                                        TextureVk *source)
{
    ...
    bool newBufferAllocated = false;
    source->mImage.changeLayoutWithStages(
    ...
    commandBuffer->copyImageToBuffer(source->mImage.getImage(), source->mImage.getCurrentLayout(),
    ...
    ANGLE_TRY(mPixelBuffer.flushUpdatesToImage(renderer, destLevelCount, &mImage, commandBuffer));
    return gl::NoError();
}
