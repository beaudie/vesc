                              ...
                              bool appendOffset)
{
    if (buffersMask.any())
    {
             ...
             ++bufferIndex)
        {
            ...
            // cached descriptorSet. This is to tell BufferVk object that this bufferVk objkect is
            // been used as descriptorSet cache key so that BufferVk has an opportunity to optimize
            // future allocations.
            bufferVk->usedAsDescriptorSetCacheKey();
