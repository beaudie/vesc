                              ...
                              bool appendOffset)
{
    if (buffersMask.any())
    {
             ...
             ++bufferIndex)
        {
            ...
            // If buffer is sub-allocated, we should use the master buffer's serial to increase the
            // cache hit rate
    ...
    DirtyBits dirtyBitMask)
{
    ...
    xfbBufferDesc.updateDefaultUniformBuffer(uniformBuffer ? uniformBuffer->getBlockBufferSerial()
                                                           ...
                                                           PipelineType pipelineType)
{
    ...
    vk::BufferSerial bufferSerial  = buffer->getBlockBufferSerial();
