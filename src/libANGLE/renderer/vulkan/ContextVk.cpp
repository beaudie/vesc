                                                      ...
                                                      bool *imageResolved)
{
    ...
    if (colorImageMS->valid() && renderArea == invalidateArea)
    {
        ...
        drawFramebufferVk->addCurrentFramebufferToGarbage(this);
        ...
        ANGLE_TRY(drawFramebufferVk->getFramebuffer(this, &newFramebuffer, colorImage,
                                                    ...
                                                    BypassImageViewUpdate::Disabled));
...
void ContextVk::restoreFinishedRenderPass(vk::OptionalImageFramebuffer &framebuffer)
{
    ...
    if (mRenderPassCommands->started() &&
        mRenderPassCommands->getFramebufferHandle() == framebuffer.framebuffer.getHandle() &&
