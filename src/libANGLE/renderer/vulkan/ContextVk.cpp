                                   ...
                                   vk::CommandBuffer **commandBufferOut)
{
    ...
    *commandBufferOut = mRenderPassCommandBuffer;
    ...
    else if (mProgramPipeline->dirtyUniforms())
    {
    ...
    const DriverUniformsDescriptorSet &driverUniforms)
{
    ...
    {
        ANGLE_TRY(
            mProgram->updateDescriptorSets(this, commandBuffer, mProgram->getPipelineLayout()));
    }
    else
    {
    ...
    else
    {
        for (const gl::ShaderType shaderType : gl::AllShaderTypes())
        {
            ...
            if (program)
            {
                commandBuffer->bindDescriptorSets(mProgramPipeline->getPipelineLayout(), bindPoint,
                                                  kDriverUniformsDescriptorSetIndex, 1,
                                                  &driverUniforms.descriptorSet, 1,
                                                  &driverUniforms.dynamicOffset);
            }
        }
    }
