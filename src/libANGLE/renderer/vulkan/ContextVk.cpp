...
void ContextVk::onDestroy(const gl::Context *context)
{
    ...
    (void)mRenderer->finish(this, &mCommandGraph, std::move(mCommandPool));
                               ...
                               const vk::Semaphore &signalSemaphore)
{
    ...
    ANGLE_TRY(mRenderer->flush(this, &mCommandGraph, std::move(oldCommandPool), waitSemaphore,
                               signalSemaphore));
...
angle::Result ContextVk::finish()
{
    ...
    ANGLE_TRY(mRenderer->finish(this, &mCommandGraph, std::move(oldCommandPool)));
