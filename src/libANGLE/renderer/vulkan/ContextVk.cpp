    ...
    PipelineType pipelineType)
{
    ...
    if (executable->hasTextures())
    {
        ...
        ANGLE_TRY(mActiveTexturesDesc.updateExecutableActiveTextures(
            this, &mResourceUseList, executableVk->getVariableInfoMap(), *executable,
            mActiveTextures, mState.getSamplers(), mEmulateSeamfulCubeMapSampling, pipelineType));
    ...
    DirtyBits dirtyBitMask)
{
    ...
    uniformsAndXfbDesc.updateUniformsAndXfb(this, *executable, *executableVk, *currentUniformBuffer,
                                            mEmptyBuffer, transformFeedbackVk);
                                                       ...
                                                       PipelineType pipelineType)
{
    ...
    ProgramExecutableVk *executableVk = getExecutable();
    return executableVk->bindDescriptorSets(this, &mResourceUseList, commandBuffer, pipelineType);
}
...
angle::Result ContextVk::bindUniformsAndXfbDescriptorPool(
...
angle::Result ContextVk::bindTextureDescriptorPool(
    const vk::DescriptorSetLayoutDesc &descriptorSetLayoutDesc,
...
angle::Result ContextVk::bindShaderResourcesDescriptorPool(
    const vk::DescriptorSetLayoutDesc &descriptorSetLayoutDesc,
    vk::DescriptorPoolPointer *poolPointerOut)
{
