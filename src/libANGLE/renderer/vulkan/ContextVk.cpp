                                                       ...
                                                       DirtyBits dirtyBitMask)
{
    ...
    drawFramebufferVk->initRenderPassAttachmentOps(this, &renderPassAttachmentOps,
    ...
    // Check to see if we can reuse the current renderPass.
    ...
    {
        WARN() << "reusing started renderpass";
    ...
    ANGLE_TRY(startRenderPassWithAttachmentOps(scissoredRenderArea, renderPassAttachmentOps,
