                                                          ...
                                                          VkDeviceSize *indirectBufferOffsetOut)
{
    ...
    *indirectBufferOffsetOut = dstIndirectBufOffset;
    ...
    vk::FramebufferHelper *framebuffer = mDrawFramebuffer->getFramebuffer();
    dstIndirectBuf->onRead(this, framebuffer, VK_ACCESS_INDIRECT_COMMAND_READ_BIT);
                                            ...
                                            const void *indirect)
{
    ...
    if (mode == gl::PrimitiveMode::LineLoop)
    {
        ...
        ANGLE_TRY(setupLineLoopArrayIndirectDraw(context, mode, currentIndirectBuf,
                                              ...
                                              const void *indirect)
{
    ...
    {
        ANGLE_TRY(
            setupIndexedIndirectDraw(context, mode, type, currentIndirectBuf, &commandBuffer));
    }
