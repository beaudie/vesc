                                     ...
                                     vk::ImageHelper *image)
{
    ...
    // This assertion is no longer valid due to we defer the depth stencil image layout transition.
    // But we could add it back once we tracks all attachments in the render pass.
#if 0
