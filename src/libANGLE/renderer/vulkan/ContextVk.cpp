...
angle::Result ContextVk::createGraphicsPipeline()
{
    ...
    //      TODO: job should be kicked off here?
    //      TODO: each of the creations should be gated on the corresponding bits being dirty.
    if (descPtr == nullptr)
    {
        // Not found in cache
        ...
        else
        {
            ...
            if (mCurrentGraphicsPipelineShaders == nullptr ||
                (mGraphicsPipelineTransition & kShadersTransitionBitsMask).any())
            {
                vk::PipelineHelper *oldGraphicsPipelineShaders = mCurrentGraphicsPipelineShaders;

                const vk::GraphicsPipelineDesc *shadersDescPtr = nullptr;
                ANGLE_TRY(executableVk->getGraphicsPipeline(
                    this, vk::GraphicsPipelineSubset::Shaders, *mGraphicsPipelineDesc, glExecutable,
                ...
                if (shadersDescPtr == nullptr)
                {
                    ANGLE_TRY(executableVk->createGraphicsPipeline(
                        ...
                        PipelineSource::Draw, *mGraphicsPipelineDesc, glExecutable, &shadersDescPtr,
                        &mCurrentGraphicsPipelineShaders));
                }
                if (oldGraphicsPipelineShaders)
                {
                    oldGraphicsPipelineShaders->addTransition(
                        mGraphicsPipelineTransition & kShadersTransitionBitsMask, shadersDescPtr,
                        mCurrentGraphicsPipelineShaders);
                }
            }
            ...
            ANGLE_TRY(CreateGraphicsPipelineSubset(
                ...
                mGraphicsPipelineTransition & kVertexInputTransitionBitsMask,
            ...
            ANGLE_TRY(CreateGraphicsPipelineSubset(
                this, *mGraphicsPipelineDesc,
                mGraphicsPipelineTransition & kFragmentOutputTransitionBitsMask,
            ...
            ANGLE_TRY(executableVk->linkGraphicsPipelineLibraries(
                this, &pipelineCache, PipelineSource::Draw, *mGraphicsPipelineDesc, glExecutable,
