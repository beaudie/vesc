...
void ContextVk::updateGraphicsPipelineDescWithSpecConstUsageBits(SpecConstUsageBits usageBits)
{
    ...
    {
        gl::Framebuffer *drawFramebuffer = getState().getDrawFramebuffer();
        mGraphicsPipelineDesc->updateDrawableSize(&mGraphicsPipelineTransition,
                                                  drawFramebuffer->getDimensions().width,
                                                  drawFramebuffer->getDimensions().height);
    }
}
...
void ContextVk::onDrawFramebufferRenderPassDescChange(FramebufferVk *framebufferVk)
{
    ...
    mGraphicsPipelineDesc->updateDrawableSize(&mGraphicsPipelineTransition,
                                              framebufferVk->getState().getDimensions().width,
