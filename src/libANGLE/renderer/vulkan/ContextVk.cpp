      ...
      mGpuEventTimestampOrigin(0)
{
    ...
    mGraphicsDirtyBitHandlers[DIRTY_BIT_DEFAULT_ATTRIBS] = &ContextVk::handleDirtyDefaultAttribs;
    mGraphicsDirtyBitHandlers[DIRTY_BIT_PIPELINE]        = &ContextVk::handleDirtyGraphicsPipeline;
    mGraphicsDirtyBitHandlers[DIRTY_BIT_TEXTURES]        = &ContextVk::handleDirtyTextures;
    mGraphicsDirtyBitHandlers[DIRTY_BIT_VERTEX_BUFFERS]  = &ContextVk::handleDirtyVertexBuffers;
    mGraphicsDirtyBitHandlers[DIRTY_BIT_INDEX_BUFFER]    = &ContextVk::handleDirtyIndexBuffer;
    ...
    mComputeDirtyBitHandlers[DIRTY_BIT_TEXTURES] = &ContextVk::handleDirtyTextures;
    ...
    mGraphicsDirtyBits = mNewCommandBufferDirtyBits;
...
{
    // TODO(syoussefi): mCommandBuffer is really mRenderPassCommandBuffer. Rename it for clarity.
    // http://anglebug.com/3562

    ANGLE_TRY(mDispatcher.recordCommands(commandBufferOut));
    ...
    mComputeDirtyBits &= ~dirtyBitMask;
    ...
    for (size_t dirtyBit : dirtyBits)
    {
        switch (dirtyBit)
        {
            ...
            case gl::State::DIRTY_BIT_PROGRAM_EXECUTABLE:
            {
                ...
                if (glState.getProgram()->hasLinkedShaderStage(gl::ShaderType::Compute))
                {
                    mCurrentComputePipeline = nullptr;
                }
                else
