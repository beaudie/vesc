...
angle::Result ContextVk::handleDirtyEventLogImpl(vk::CommandBuffer *commandBuffer)
{
    ...
    if (mEventLog.empty() || !mRenderer->enableCallingDebugUtils())
    {
        return angle::Result::Continue;
    }
...
{
    if (!mRenderer->enableDebugUtils() && !mRenderer->enableCallingDebugUtils())
    {
        return angle::Result::Continue;
    }
...
{
    if (!mRenderer->enableCallingDebugUtils())
    {
        return;
    }
