...
{
    ERR() << "INAZ: device: " << getDevice() << "; ContextVk: " << this;
...
{
    ERR() << "INAZ: device: " << getDevice() << "; ContextVk: " << this << "; - BEGIN";
    ...
    ERR() << "INAZ: device: " << getDevice() << "; ContextVk: " << this << "; - END";
}
...
{
    ERR() << "INAZ: device: " << getDevice() << "; handle: " << semaphore
          << "; ContextVk: " << this;
