...
void ContextVk::syncObjectPerfCounters()
{
    ...
    mPerfCounters.descriptorSetAllocations += mPerfCounters.uniformsAndXfbDescriptorSetCacheMisses;
    mPerfCounters.descriptorSetAllocations += mPerfCounters.textureDescriptorSetCacheMisses;
    mPerfCounters.descriptorSetAllocations += mPerfCounters.shaderBuffersDescriptorSetCacheMisses;
}
