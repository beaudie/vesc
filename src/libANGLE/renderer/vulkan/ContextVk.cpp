...
angle::Result ContextVk::initialize()
{
    ...
    constexpr angle::PackedEnumMap<vk::PipelineType, VkShaderStageFlags> kPipelineStages = {
        {vk::PipelineType::Graphics, VK_SHADER_STAGE_ALL_GRAPHICS},
        {vk::PipelineType::Compute, VK_SHADER_STAGE_COMPUTE_BIT},
    };
    for (vk::PipelineType pipeline : angle::AllEnums<vk::PipelineType>())
    {
                                                           ...
                                                           vk::CommandBuffer *commandBuffer)
{
    return handleDirtyDescriptorSetsImpl(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS,
                                         mDriverUniforms[vk::PipelineType::Graphics]);
}
                                                          ...
                                                          vk::CommandBuffer *commandBuffer)
{
    return handleDirtyDescriptorSetsImpl(commandBuffer, VK_PIPELINE_BIND_POINT_COMPUTE,
                                         mDriverUniforms[vk::PipelineType::Compute]);
}
                                                           ...
                                                           vk::CommandBuffer *commandBuffer)
{
    ...
    ANGLE_TRY(allocateDriverUniforms(sizeof(GraphicsDriverUniforms),
                                     &mDriverUniforms[vk::PipelineType::Graphics], &buffer, &ptr,
                                     &newBuffer));
                                                          ...
                                                          vk::CommandBuffer *commandBuffer)
{
    ...
    ANGLE_TRY(allocateDriverUniforms(sizeof(ComputeDriverUniforms),
                                     &mDriverUniforms[vk::PipelineType::Compute], &buffer, &ptr,
                                     &newBuffer));
