...
angle::Result ContextVk::initialize()
{
    ...
    VkDescriptorPoolSize textureSetSize = { VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, mRenderer->getMaxActiveTextures() };
    ...
    ANGLE_TRY(mDynamicDescriptorPools[kDriverUniformsDescriptorSetIndex].init(this, &driverSetSize, 1));
