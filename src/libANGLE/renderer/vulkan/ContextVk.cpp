...
vk::BufferHelper *ContextVk::checkCounterBufferAllocation(gl::TransformFeedbackID id, size_t index)
{
    ...
    if (iter == mTransformFeedbackCounterBufferHelperMap.end())
    {
        ...
        angle::Result result = initCounterBuffer(bufferEntry[index]);
    ...
    else
    {
        ...
        {
            angle::Result result = initCounterBuffer(iter->second[index]);
            ASSERT(result == angle::Result::Continue);
        }
