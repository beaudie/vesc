...
gl::ClipSpaceOrigin GetClipSpaceOriginFromGLState(const gl::State &glState)
{
    return glState.isClipControlUpperLeftOrigin() ? gl::ClipSpaceOrigin::UpperLeft
                                                  : gl::ClipSpaceOrigin::LowerLeft;
}
