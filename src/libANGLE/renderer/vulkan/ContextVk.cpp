                                                       ...
                                                       PipelineType pipelineType)
{
    ...
    ProgramExecutableVk *executableVk = getExecutable();
    return executableVk->updateDescriptorSets(this, &resourceUseList, commandBuffer, pipelineType);
}
                                           ...
                                           RenderPassClosureReason renderPassClosureReason)
{
    ...
    {
        ANGLE_TRY(driverUniform.dynamicBuffer.releaseInFlightBuffersToResourceUseList(
    ...
    if (mHasInFlightStreamedVertexBuffers.any())
    {
        ...
        {
            ANGLE_TRY(mStreamedVertexBuffers[attribIndex].releaseInFlightBuffersToResourceUseList(
                this, resourceUseList));
        }
