...
void ContextVk::onDestroy(const gl::Context *context)
{
    ...
    mResourceUseList.releaseResourceUses(mShareGroupVk->getSharedResourceUsePool());
...
angle::Result ContextVk::flushImpl(const vk::Semaphore *signalSemaphore)
{
    ...
    mResourceUseList.releaseResourceUsesAndUpdateSerials(serial,
                                                         mShareGroupVk->getSharedResourceUsePool());
                                     ...
                                     vk::ImageHelper *image)
{
    ...
    image->retain(&mResourceUseList, mShareGroupVk->getSharedResourceUsePool());
