...
{
    ANGLE_TRY(mDescriptorPoolManager.init(this, mRenderer->getUniformBufferDescriptorCount(),
...
DescriptorPoolManager &ContextVk::getDescriptorPoolManager()
{
