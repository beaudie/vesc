                               ...
                               bool invertViewport)
{
    ...
    gl_vk::GetViewport(
        ...
        // height of the viewport when when clip space is mapped into screen space.
...
{
    mClipSpaceOrigin = glState.isClipControlUpperLeftOrigin() ? ClipSpaceOrigin::UpperLeft
