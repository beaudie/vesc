...
ContextVk::ContextVk(const gl::State &state, gl::ErrorSet *errorSet, RendererVk *renderer)
    : ContextImpl(state, errorSet),
      ...
      mOutsideRenderPassCommands(false, renderer->getFeatures().preferSingleBarrierCall.enabled),
      mRenderPassCommands(true, renderer->getFeatures().preferSingleBarrierCall.enabled),
