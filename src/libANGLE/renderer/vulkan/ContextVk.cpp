...
CommandBufferHelper::CommandBufferHelper(bool canHaveRenderPass)
    : mImageBarrierSrcStageMask(0),
      ...
      mIsRenderPassCommandBuffer(canHaveRenderPass)
{}
...
void CommandBufferHelper::addRenderPassCommandDiagnostics(ContextVk *contextVk)
{
