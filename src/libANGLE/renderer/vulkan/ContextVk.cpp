                                           ...
                                           uint32_t *numIndicesOut)
{
    ...
    vk::BufferHelper *srcIndexBuffer     = &vk::GetImpl(elementArrayBuffer)->getBuffer();
    vk::BufferHelper *dstIndexBuffer     = nullptr;

    ANGLE_TRY(vertexArrayVk->handleLineLoop(this, srcIndexBuffer, firstVertex, vertexOrIndexCount,
