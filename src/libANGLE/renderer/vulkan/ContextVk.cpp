...
vk::BufferBlock *ContextVk::getTempBufferBlock(vk::BufferPool *pool)
{
...
void ContextVk::setTempBufferBlock(vk::BufferPool *pool, vk::BufferBlock *block)
{
    mPoolBlockMap[pool] = block;
}

void ContextVk::cleanTempBufferBlock(vk::BufferPool *pool)
{
    if (mPoolBlockMap.find(pool) != mPoolBlockMap.end())
    {
