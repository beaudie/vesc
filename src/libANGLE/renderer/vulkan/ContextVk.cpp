...
angle::Result ContextVk::handleDirtyGraphicsPipeline(DirtyBits::Iterator *dirtyBitsIterator)
{
    ...
    dirtyBitsIterator->setLaterBit(DIRTY_BIT_PIPELINE_BIND);
...
angle::Result ContextVk::handleDirtyGraphicsRenderPass(DirtyBits::Iterator *dirtyBitsIterator)
{
    ...
    return startRenderPass(scissoredRenderArea, nullptr, dirtyBitsIterator);
}

angle::Result ContextVk::handleDirtyGraphicsPipelineBind(DirtyBits::Iterator *dirtyBitsIterator)
{
...
angle::Result ContextVk::onDrawFramebufferRenderPassDescChange(
    ...
    DirtyBits::Iterator *dirtyBitsIterator)
{
    ...
    ASSERT(dirtyBitsIterator);
    return handleDirtyGraphicsPipeline(dirtyBitsIterator);
}
