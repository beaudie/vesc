...
// rotate gl_Position in the last geometry shader and gl_FragCoord in the fragment shader.  Rotation
// of gl_Position is done in SPIR-V.  The following are the rotation matrices for the fragment
// shader.
//
