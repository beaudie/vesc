                                                           ...
                                                           DirtyBits dirtyBitMask)
{
    ...
    *driverUniforms = {
    ...
    VkShaderStageFlags pushConstantShaderStageFlags =
        (VK_SHADER_STAGE_ALL_GRAPHICS & getRenderer()->getSupportedVulkanShaderStageMask()) |
...
angle::Result ContextVk::handleDirtyComputeDriverUniforms()
{
    ...
    mOutsideRenderPassCommands->getCommandBuffer().pushConstants(
        executableVk->getPipelineLayout(), pushConstantShaderStageFlags, 0, driverUniformSize,
        &driverUniforms);
