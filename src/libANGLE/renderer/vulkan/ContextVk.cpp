                                   ...
                                   PipelineType pipelineType)
{
    ...
    if (image.hasRenderPassUsageFlag(vk::RenderPassUsage::RenderTargetAttachment))
    {
        ...
        if (image.isDepthOrStencil())
        {
            ...
            //
            // - depth stencil both used as sampler, both read-only
            // - depth used as sampler and read-only, stencil written or not
            // - stencil used as sampler and read-only, depth written or not
