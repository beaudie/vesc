...
constexpr angle::PackedEnumMap<RenderPassClosureReason, const char *> kRenderPassClosureReason = {{
    ...
    {RenderPassClosureReason::Swap, "Render pass closed due to window buffer swap"},
    ...
    {RenderPassClosureReason::BufferUseThenMap,
                                                      ...
                                                      DirtyBits dirtyBitMask)
{
    ...
    ANGLE_TRY(flushCommandsAndEndRenderPassImpl(
        QueueSubmitType::PerformQueueSubmit, RenderPassClosureReason::AlreadySpecifiedElsewhere));
