                                                            ...
                                                            DirtyBits dirtyBitMask)
{
    if (mRenderPassCommands->started())
    {
        ...
        mIsReactivateRenderPassAllowed = false;
        mHasDeferredFlush              = true;
    }
    return angle::Result::Continue;
}
                                                       ...
                                                       DirtyBits dirtyBitMask)
{
    ...
    drawFramebufferVk->initRenderPassAttachmentOps(
        this, &renderArea, &renderPassAttachmentOps, &packedClearValues,
        &packedInitialContentDefinedBits, &unresolveAttachmentMask);
    ...
    if (hasStartedRenderPassWithQueueSerial(drawFramebufferVk->getLastRenderPassQueueSerial()) &&
        mIsReactivateRenderPassAllowed && mRenderPassCommands->getRenderArea() == renderArea &&
    ...
    ANGLE_TRY(startRenderPassWithAttachmentOps(
        renderArea, renderPassAttachmentOps, packedClearValues, packedInitialContentDefinedBits,
        unresolveAttachmentMask, nullptr, &renderPassDescChanged));
    ...
    vk::RenderPassCommandBuffer **commandBufferOut)
{
    ...
    ANGLE_TRY(mRenderPassCommands->beginRenderPass(
        ...
        colorAttachmentCount, depthStencilAttachmentIndex, clearValues, initialContentDefinedBits,
                                         ...
                                         bool *renderPassDescChangedOut)
{
    ...
    return startRenderPassWithAttachmentOps(
        renderArea, renderPassAttachmentOps, packedClearValues, packedInitialContentDefinedBits,
        unresolveAttachmentMask, commandBufferOut, renderPassDescChangedOut);
}
    ...
    bool *renderPassDescChangedOut)
{
    ...
    ANGLE_TRY(drawFramebufferVk->startNewRenderPass(
        ...
        packedInitialContentDefinedBits, unresolveAttachmentMask, &mRenderPassCommandBuffer,
    ...
    // By default, render pass is allowed to be reactivated.
    mIsReactivateRenderPassAllowed = true;
