...
struct GraphicsDriverUniforms
{
    ...
    float viewportYScale;     // TODO(ianelliott): Decide whether to keep for the long term
    float negViewportYScale;  // TODO(ianelliott): Decide whether to keep for the long term
