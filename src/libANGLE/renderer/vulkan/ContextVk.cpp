    ...
    PipelineType pipelineType)
{
    ...
    if (executable->hasTextures())
    {
        ...
        ANGLE_TRY(executableVk->updateTexturesDescriptorSet(
            this, &mUpdateDescriptorSetsBuilder, &mResourceUseList, mActiveTexturesDesc));
    }
                                                        ...
                                                        PipelineType pipelineType)
{
    ...
    ANGLE_TRY(executableVk->updateShaderResourcesDescriptorSet(
        this, &mUpdateDescriptorSetsBuilder, &mResourceUseList, mShaderBuffersDescriptorDesc));
    ...
    DirtyBits dirtyBitMask)
{
    ...
    return executableVk->updateUniformsAndXfbDescriptorSet(this, &mUpdateDescriptorSetsBuilder,
                                                           &mResourceUseList, currentUniformBuffer,
                                                           uniformsAndXfbDesc);
}
...
void ContextVk::syncObjectPerfCounters()
{
    ...
    for (vk::DynamicDescriptorPool &pool : mDriverUniformsDescriptorPools)
    {
        ...
        mPerfCounters.descriptorSetAllocations += pool.getAndResetDescriptorSetAllocationCount();
    }
}
