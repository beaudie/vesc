...
void ContextVk::updatePipelineColorMask() const
{
    if (mProgramHasOutput)
    {
    ...
    for (size_t dirtyBit : dirtyBits)
    {
        switch (dirtyBit)
        {
            ...
            case gl::State::DIRTY_BIT_PROGRAM_BINDING:
            {
                ...
                mProgramHasOutput   = mProgram->getState().getActiveOutputVariables().any();
