...
gl::Error ContextVk::drawArrays(const gl::Context *context, GLenum mode, GLint first, GLsizei count)
{
    ...
    {
        ANGLE_TRY(mLineLoopHandler.createLineLoopIndexBufferFromScratch(this, first, count));
                                  ...
                                  const void *indices)
{
    ...
    if (mode == GL_LINE_LOOP)
    {
        ANGLE_TRY(mLineLoopHandler.createLineLoopIndexBufferFromUsersIndexBuffer(
