    ...
    PipelineType pipelineType)
{
    ...
    if (executable->hasTextures())
    {
        ...
        mActiveTextureDescriptorDesc.updatePreCacheActiveTextures(
            *executable, executable->getSamplerBindings(), executable->getActiveSamplersMask(),
