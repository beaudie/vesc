...
template <typename CommandBufferT>
void UpdateBarrierForShaderUniformBuffers(ContextVk *contextVk,
                                          CommandBufferT *commandBufferHelper,
...
template <typename CommandBufferT>
void UpdateBarrierForShaderStorageBuffers(ContextVk *contextVk,
                                          CommandBufferT *commandBufferHelper,
                                          gl::ShaderType shaderType,
                                          const vk::PipelineStage pipelineStage,
...
template <typename CommandBufferT>
void UpdateBarrierForShaderAtomicCounterBuffers(ContextVk *contextVk,
                                                CommandBufferT *commandBufferHelper,
                                                gl::ShaderType shaderType,
                                                const vk::PipelineStage pipelineStage,
                                                        ...
                                                        PipelineType pipelineType)
{
    ...
    for (const gl::ShaderType shaderType : executable->getLinkedShaderStages())
    {
        ...
        UpdateBarrierForShaderStorageBuffers(this, commandBufferHelper, shaderType, pipelineStage,
                                             executable->getShaderStorageBlocks(),
                                             mState.getOffsetBindingPointerShaderStorageBuffers());
        UpdateBarrierForShaderAtomicCounterBuffers(
            this, commandBufferHelper, shaderType, pipelineStage,
            executable->getAtomicCounterBuffers(),
...
angle::Result ContextVk::handleDirtyUniformBuffersImpl(CommandBufferT *commandBufferHelper)
{
    ...
    bool descriptorSetDescDirty = false;
...
angle::Result ContextVk::handleDirtyStorageBuffersImpl(CommandBufferT *commandBufferHelper)
{
    ...
    for (gl::ShaderType shaderType : executable->getLinkedShaderStages())
    {
        mShaderBuffersDescriptorDesc.updateShaderBuffers(
            ...
            mShaderBufferWriteDescriptorDescBuilder.getDescs(), &descriptorSetDescDirty);
