...
angle::Result ContextVk::acquireTextures(const gl::TextureBarrierVector &textureBarriers)
{
...
angle::Result ContextVk::releaseTextures(gl::TextureBarrierVector *textureBarriers)
{
