...
angle::Result ContextVk::flush(const gl::Context *context)
{
    ...
    if (mSyncObjectPendingFlush || getState().isShared())
    {
        ...
        getShareGroupVk()->appendResourceUseList(std::move(mResourceUseList));
...
angle::Result ContextVk::submitFrame(const vk::Semaphore *signalSemaphore)
{
    ...
    ANGLE_TRY(mRenderer->submitFrame(this, mContextPriority, std::move(mWaitSemaphores),
                                     ...
                                     std::move(getShareGroupVk()->getResourceUseLists()),
