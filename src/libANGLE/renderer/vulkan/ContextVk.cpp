                                   ...
                                   vk::CommandBuffer **commandBufferOut)
{
    ...
    {
        (*commandBufferOut)
            ->bindVertexBuffers(0, maxAttrib, mVertexArray->getCurrentArrayBufferHandles().data(),
                                           ...
                                           vk::CommandBuffer **commandBufferOut)
{
    ...
    mIndexBufferDirty        = true;
    mCurrentDrawElementsType = GL_UNSIGNED_INT;
    return setupDraw(context, drawCallParams, true, commandBufferOut);
}
...
angle::Result ContextVk::updateDefaultAttribute(size_t attribIndex)
{
    ...
    mVertexArray->updateDefaultAttrib(mRenderer, attribIndex, bufferHandle, offset);
    return angle::Result::Continue();
}
}  // namespace rx
