...
angle::Result ContextVk::checkAndFlushSuballocationGarbage()
{
    // If too much pending suballocation garbage has accumulated, we should flush them.
    if (mRenderer->hasExcessiveSuballocationGarbage())
    {
...
angle::Result ContextVk::allocateForCopyBuffer(vk::BufferHelper *bufferHelper,
                                               size_t size,
...
angle::Result ContextVk::allocateForCopyImage(vk::BufferHelper *bufferHelper,
                                              size_t size,
                                              vk::MemoryCoherency coherency,
...
angle::Result ContextVk::allocateForVertexConversion(vk::BufferHelper *bufferHelper,
                                                     size_t size,
