...
constexpr angle::PackedEnumMap<RenderPassClosureReason, const char *> kRenderPassClosureReason = {{
    ...
    {RenderPassClosureReason::OutOfReservedQueueSerialForOutsideCommands,
     "Render pass closed due to out of reserved queue serial for outside commands"},
    {RenderPassClosureReason::FlushRenderPassAttachment,
     "Render pass closed due to render pass attachment flush"},
