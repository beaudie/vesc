...
gl::Error ContextVk::drawArrays(const gl::Context *context, GLenum mode, GLint first, GLsizei count)
{
    ...
    {
        vertexArrayVk->onLineLoopDraw(context, mRenderer, drawCallParams, drawNode);
        vk::LineLoopHandler::Draw(count, commandBuffer);
    }
    else
    {
        vertexArrayVk->onDraw(context, mRenderer, drawCallParams, drawNode, newCommands);
                                  ...
                                  const void *indices)
{
    ...
    {
        vertexArrayVk->onIndexedDraw(context, mRenderer, drawCallParams, drawNode, newCommands);
