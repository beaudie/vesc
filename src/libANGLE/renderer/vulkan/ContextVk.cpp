    ...
    UpdateDepthFeedbackLoopReason stencilReason)
{
         ...
         mDepthStencilAttachmentFlags[vk::RenderPassUsage::StencilReadOnlyAttachment]))
    {
        ...
        mDepthStencilAttachmentFlags.reset(vk::RenderPassUsage::DepthReadOnlyAttachment);
        mDepthStencilAttachmentFlags.reset(vk::RenderPassUsage::StencilReadOnlyAttachment);
        mDepthStencilAttachmentFlags.reset(vk::RenderPassUsage::DepthFeedbackLoop);
        mDepthStencilAttachmentFlags.reset(vk::RenderPassUsage::StencilFeedbackLoop);
    }
...
angle::Result ContextVk::updateActiveTextures(const gl::Context *context, gl::Command command)
{
    ...
    for (size_t textureUnit : activeTextures)
    {
        ...
        if (!isIncompleteTexture && texture->isDepthOrStencil())
        {
            ...
            ANGLE_TRY(updateReadOnlyDepthStencilFeedbackLoopMode(
                texture, command, getDrawFramebuffer(), isStencilTexture));
        }
...
angle::Result ContextVk::updateReadOnlyDepthStencilFeedbackLoopMode(gl::Texture *texture,
                                                                    gl::Command command,
                                                                    ...
                                                                    bool isStencilTexture)
{
    ...
    if (oldUsageFlags == mDepthStencilAttachmentFlags)
    {
        return angle::Result::Continue;
    }
