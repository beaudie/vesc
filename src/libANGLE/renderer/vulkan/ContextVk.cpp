    ...
    CommandBufferHelper *commandBufferHelper)
{
    ...
    const gl::ActiveTextureArray<gl::ShaderBitSet> &activeSamplerShaderBits =
        mState.getProgram()->getActiveSamplerShaderBits();
    for (size_t textureUnit : activeTextures)
    {
        ...
        {
            gl::ShaderBitSet shaderBits = activeSamplerShaderBits[textureUnit];
