...
void ContextVk::onDestroy(const gl::Context *context)
{
    ...
    if (!mInFlightCommands.empty() || !mCurrentGarbage.empty() || !mGarbageQueue.empty())
    {
        (void)finishImpl();
    }
                                     ...
                                     vk::PrimaryCommandBuffer &&commandBuffer)
{
    ...
    // we need to explicitly notify every other Contexts using this VkQueue that they their current
