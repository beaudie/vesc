...
void ContextVk::updateScissor(const gl::State &glState, const FramebufferVk *framebufferVk)
{
    ...
    for (auto iter = dirtyBits.begin(), endIter = dirtyBits.end(); iter != endIter; ++iter)
    {
        ...
        switch (dirtyBit)
        {
            ...
            case gl::State::DIRTY_BIT_SCISSOR:
                ASSERT(vk::GetImpl(glState.getDrawFramebuffer()) == mDrawFramebuffer);
                updateScissor(glState, mDrawFramebuffer);
                break;
