                                                          ...
                                                          vk::CommandBuffer *commandBuffer)
{
    ...
    else
    {
        ...
        for (size_t attribIndex : attribsMask)
        {
            ...
            if (arrayBuffer)
            {
                mRenderPassCommands.bufferRead(VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT, arrayBuffer);
            }
        }
    }
                                                        ...
                                                        vk::CommandBuffer *commandBuffer)
{
    ...
    {
        mRenderPassCommands.bufferRead(VK_ACCESS_INDEX_READ_BIT, elementArrayBuffer);
    }
...
angle::Result ContextVk::updateScissor(const gl::State &glState)
{
    ...
    else
    {
        ...
        {
            const gl::Rectangle &newRenderArea = framebufferVk->getScissoredRenderArea(this);
            if (!mRenderPassCommands.getRenderArea().encloses(newRenderArea))
            {
...
void CommandBufferHelper::bufferRead(VkAccessFlags readAccessType, vk::BufferHelper *buffer)
{
...
void CommandBufferHelper::bufferWrite(VkAccessFlags writeAccessType, vk::BufferHelper *buffer)
{
...
void CommandBufferHelper::recordBarrier(vk::PrimaryCommandBuffer *primary)
{
    ...
    {
        ASSERT(mGlobalMemoryBarrierDstAccess == 0 && mGlobalMemoryBarrierStages == 0);
        return;
    }
