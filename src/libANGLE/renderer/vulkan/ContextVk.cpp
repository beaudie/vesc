...
angle::Result ContextVk::initialize()
{
    ...
    RendererVk *renderer = getRenderer();
    ...
    mDriverUniformsBuffer.init(minAlignment, renderer);
                                                   ...
                                                   vk::CommandBuffer *commandBuffer)
{
    ...
    mDriverUniformsBuffer.releaseRetainedBuffers(renderer);
    ...
    *driverUniforms                = {
    ...
    if (!mDriverUniformsSetLayout.valid())
    {
        ...
        ANGLE_TRY(renderer->getDescriptorSetLayout(this, desc, &mDriverUniformsSetLayout));
    }
