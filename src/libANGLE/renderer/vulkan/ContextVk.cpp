                                                 ...
                                                 vk::Buffer **indirectBufferOut)
{
    ...
    if (mState.isTransformFeedbackActiveUnpaused())
    {
        ...
        // Spec says: An INVALID_OPERATION error is generated if transform feedback is active
        // and not paused
                                                          ...
                                                          VkDeviceSize *indirectBufferOffsetOut)
{
    ...
    *indirectBufferOut = const_cast<vk::Buffer *>(&indirectBufferHelperOut->getBuffer());
    ...
    vk::FramebufferHelper *framebuffer = mDrawFramebuffer->getFramebuffer();
    indirectBufferHelperOut->onRead(framebuffer, VK_ACCESS_INDIRECT_COMMAND_READ_BIT);
