...
angle::Result VkImageImageSiblingVk::initImpl(DisplayVk *displayVk)
{
    ...
    constexpr bool kRotatedAspectRatio  = false;
    constexpr int kSamples              = 1;
    constexpr bool kIsRobustInitEnabled = false;
    mImage->init2DWeakReference(displayVk, mVkImage, mSize, kRotatedAspectRatio, intendedFormatID,
                                actualImageFormatID, kSamples, kIsRobustInitEnabled);
