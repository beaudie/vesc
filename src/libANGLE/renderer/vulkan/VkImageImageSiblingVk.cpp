    ...
    : mVkImage(reinterpret_cast<VkImage>(buffer))
{
    ...
    intptr_t info_hi = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_HI));
    intptr_t info_lo = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_LO));
    const VkImageCreateInfo *info =
        reinterpret_cast<VkImageCreateInfo *>((info_hi << 32) | info_lo);
