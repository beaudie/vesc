    ...
    : mVkImage(reinterpret_cast<VkImage>(buffer))
{
    ...
    uintptr_t info_hi = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_HI_ANGLE));
    uintptr_t info_lo = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_LO_ANGLE));
