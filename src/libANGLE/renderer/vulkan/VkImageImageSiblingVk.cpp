...
{
    ASSERT(attribs.contains(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_HI));
    ASSERT(attribs.contains(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_LO));
    uintptr_t info_hi = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_HI));
    uintptr_t info_lo = static_cast<uintptr_t>(attribs.get(EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_LO));
    const VkImageCreateInfo *info =
        reinterpret_cast<VkImageCreateInfo *>((info_hi << 32) | (info_lo & 0xffffffff));
