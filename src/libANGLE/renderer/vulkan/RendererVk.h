...
class RendererVk : angle::NonCopyable
{
  public:
    ...
    angle::Result onBlobCacheFuncs(DisplayVk *display);
    void setPipelineCacheDirty(bool flag) { mPipelineCacheDirty = flag; }
    bool pipelineCacheDirty() { return mPipelineCacheDirty; }
