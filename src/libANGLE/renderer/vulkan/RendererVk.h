...
class RendererVk : angle::NonCopyable
{
  ...
  private:
    ...
    using MemoryAllocationHeapSize = std::vector<VkDeviceSize>;
    std::array<MemoryAllocationHeapSize, vk::kMemoryAllocationTypeCount>
        mActiveHeapMemoryAllocationsSize;
