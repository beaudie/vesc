...
class RendererVk : angle::NonCopyable
{
  public:
    ...
    angle::Result initialize(DisplayVk *displayVk,
                             ...
                             const char *wsiLayer);
    // Load/reload volk vk* function ptrs if needed for an already initialized RendererVk
    angle::Result initializeVolkIfNeeded(DisplayVk *displayVk) const;
    void loadVolkInstanceIfNeeded() const;
    void loadVolkDeviceIfNeeded() const;
