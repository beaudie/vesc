...
class RendererVk : angle::NonCopyable
{
  ...
  private:
    ...
    vk::Error flushCommandNode(vk::CommandBuffer *primaryCommandBuffer,
    ...
    struct CommandBatchInfo final : angle::NonCopyable
    {
        CommandBatchInfo();
        ~CommandBatchInfo();
        CommandBatchInfo(CommandBatchInfo &&other);
        CommandBatchInfo &operator=(CommandBatchInfo &&other);
    ...
    std::vector<CommandBatchInfo> mInFlightCommands;
    ...
    std::vector<gl::BindingPointer<vk::CommandBufferNode>> mOpenCommandGraph;
};
