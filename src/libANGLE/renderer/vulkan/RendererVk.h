...
class RendererVk : angle::NonCopyable
{
  public:
    ...
    void onGetPipelineCache(DisplayVk *display);
    void onNewGraphicsPipeline() { mPipelineCacheDirty = true; }
    const vk::PipelineCache &getPipelineCache();
  ...
  private:
    ...
    void initPipelineCache(DisplayVk *display, vk::PipelineCache *pipelineCache);
