...
class RendererVk : angle::NonCopyable
{
  public:
    ...
    uint32_t getStagingBufferMemoryTypeIndex(bool coherent) const
    {
        return coherent ? mCoherentStagingBufferMemoryTypeIndex
    ...
    uint32_t getUniformBufferMemoryTypeIndex() const { return mUniformBufferMemoryTypeIndex; }
  ...
  private:
    ...
    uint32_t mUniformBufferMemoryTypeIndex;
