...
egl::Error ImageVk::exportVkImage(void *vk_image, void *vk_image_create_info)
{
    *reinterpret_cast<VkImage *>(vk_image) = mImage->getImage().getHandle();
    auto *info = reinterpret_cast<VkImageCreateInfo *>(vk_image_create_info);
