...
ResourceVk::ResourceVk() : mCurrentInUseCommands(nullptr)
{
}
...
{
    return (mCurrentInUseCommands != nullptr);
}

vk::CommandBufferNode *ResourceVk::getCurrentInUseCommands()
{
    return mCurrentInUseCommands;
}

vk::CommandBufferNode *ResourceVk::sireCommandNode(RendererVk *renderer)
{
    ...
    if (mCurrentInUseCommands)
    {
        mCurrentInUseCommands->setAfterDependency(newCommands);
        newCommands->addBeforeDependency(mCurrentInUseCommands);
    }

    mCurrentInUseCommands = newCommands;
    return newCommands;
}

vk::Error ResourceVk::recordChildCommands(RendererVk *renderer,
                                          vk::CommandBuffer **commandBufferOut)
{
    vk::CommandBufferNode *commands = sireCommandNode(renderer);
...
void ResourceVk::chainNewCommands(vk::CommandBufferNode *newCommands)
{
    if (isCurrentlyInUse())
    {
