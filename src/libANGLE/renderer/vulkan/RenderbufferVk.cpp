                                             ...
                                             size_t height)
{
    ...
    if ((mImage == nullptr || !mImage->valid()) && (width != 0 && height != 0))
    {
        ...
        mRenderTarget.init(mImage, &mDrawImageView, &mReadImageView, gl::TextureType::_2D, nullptr,
                           0, 0);
    }
                                                       ...
                                                       egl::Image *image)
{
    ...
    mRenderTarget.init(mImage, &mDrawImageView, &mReadImageView, gl::TextureType::_2D,
