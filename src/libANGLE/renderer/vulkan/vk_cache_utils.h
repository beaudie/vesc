...
class DescriptorSetHelper final : public Resource
{
  public:
    ...
    DescriptorSetHelper &operator=(DescriptorSetHelper &&other)
    {
...
using RefCountedDescriptorSetHelper = SharedPtr<DescriptorSetHelper>;
...
class DescriptorSetCache final : angle::NonCopyable
{
  public:
    ...
    void insertDescriptorSet(const vk::DescriptorSetDesc &desc,
                             const vk::RefCountedDescriptorSetHelper &descriptorSetHelper)
    {
