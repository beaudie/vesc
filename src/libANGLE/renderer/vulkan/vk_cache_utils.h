...
class WriteDescriptorDescs
{
  public:
    ...
    void reset() { mWriteDescriptors.clear(); }
...
class DescriptorSetDesc
{
  public:
    ...
    void updateWriteDesc(uint32_t bindingIndex,
                         ...
                         uint32_t descriptorCount)
    {
        mWriteDescriptorDescs.updateWriteDesc(bindingIndex, descriptorType, descriptorCount);
    }
...
class DescriptorSetDescBuilder final
{
  ...
  private:
    ...
    void updateWriteDesc(uint32_t bindingIndex,
                         ...
                         uint32_t descriptorCount)
    {
        mDesc.updateWriteDesc(bindingIndex, descriptorType, descriptorCount);
    }
    DescriptorSetDesc mDesc;
