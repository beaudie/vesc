...
struct PackedInputAssemblyAndColorBlendStateInfo final
{
    ...
    uint8_t srcColorBlendFactorBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS / 2];
    uint8_t dstColorBlendFactorBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS / 2];
    uint8_t srcAlphaBlendFactorBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS / 2];
    uint8_t dstAlphaBlendFactorBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS / 2];
    uint8_t colorBlendOpBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS];
    uint8_t alphaBlendOpBits[gl::IMPLEMENTATION_MAX_DRAW_BUFFERS];
