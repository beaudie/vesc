...
enum RenderPassDepthStencilLayout
{
    Unused,
    Write,
    ReadOnly,
...
class alignas(4) RenderPassDesc final
{
  public:
    ...
    void packDepthStencilAttachment(angle::FormatID angleFormatID, bool depthWritesEnabled);
    ...
    RenderPassDepthStencilLayout getDepthStencilLayout() const;
  ...
  private:
    ...
    uint8_t mPackedColorAttachmentRangeAndDSLayout : 5;
...
class FramebufferDesc
{
  public:
    ...
    void updateDepthWritesEnabled(bool depthWritesEnabled);
    size_t hash() const;
    void reset();
