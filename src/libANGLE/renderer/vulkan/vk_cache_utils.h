...
constexpr size_t kDefaultDescriptorSetLayoutBindingsCount = 4;
...
class DescriptorSetLayoutDesc final
{
  ...
  private:
    ...
    angle::FastVector<uint16_t, kDefaultDescriptorSetLayoutBindingsCount> mBindingIndices;
    angle::FastVector<PackedDescriptorSetBinding, kDefaultDescriptorSetLayoutBindingsCount>
        mDescriptorSetLayoutBindings;
    angle::FastVector<VkSampler, kDefaultDescriptorSetLayoutBindingsCount> mImmutableSamplers;
};
