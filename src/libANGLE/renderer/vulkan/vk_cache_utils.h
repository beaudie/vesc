...
struct PackedRasterizationAndMultisampleStateInfo final
{
    ...
    uint32_t sampleMask[gl::MAX_SAMPLE_MASK_WORDS];  // TODO: make MAX_SAMPLE_MASK_WORDS 1. Limit
                                                     // sample count to 32 instead of 64+.
};
...
static_assert(kPackedDynamicState1StateSize == 8, "Size check failed");
