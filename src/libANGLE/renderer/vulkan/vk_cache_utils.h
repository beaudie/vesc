...
class WriteDescriptorDescs
{
  public:
    ...
    {
        mWriteDescs.clear();
        mHasDynamicDescriptorSet = false;
    }
    bool hasDynamicDescriptorSet() const { return mHasDynamicDescriptorSet; }

  private:
    friend class WriteDescriptorDescBuilder;
    angle::FastMap<WriteDescriptorDesc, kFastDescriptorSetDescLimit> mWriteDescs;
    bool mHasDynamicDescriptorSet = false;
};
...
class DescriptorSetDesc
{
  ...
  private:
    // After a preliminary minimum size, use heap memory.
    angle::FixedVector<DescriptorInfoDesc, 128> mDescriptorInfos;
};
...
class DescriptorSetDescBuilder final
{
  ...
  private:
    ...
    DescriptorSetDesc mDesc;
    angle::FixedVector<DescriptorDescHandles, 128> mHandles;
    angle::FixedVector<uint32_t, 128> mDynamicOffsets;
};
