...
class UniformsAndXfbDesc
{
  public:
    ...
    {
        mBufferObjectIDs[kDefaultUniformBufferIndex] = bufferSerial;
    ...
    void updateTransformFeedbackBuffer(size_t xfbIndex, BufferSerial bufferSerial)
    {
        ...
        mBufferObjectIDs[bufferIndex] = bufferSerial;
        mBufferCount                  = std::max(mBufferCount, bufferIndex);
    }
    size_t hash() const;
    void reset();
  ...
  private:
    ...
    std::array<BufferSerial, kMaxBufferCount> mBufferObjectIDs;
};
