...
class alignas(4) RenderPassDesc final
{
  public:
    ...
    bool isRenderToTexture(RendererVk *renderer) const;
    bool hasDepthStencilUnresolveAttachment(RendererVk *renderer) const;
    bool hasDepthUnresolveAttachment(RendererVk *renderer) const;
  ...
  private:
    ...
    // Used only when VK_EXT_multisampled_render_to_single_sampled is available.
    static constexpr uint8_t kIsRenderToTexture = 0x20;
    // Used only when VK_EXT_multisampled_render_to_single_sampled is not available.
