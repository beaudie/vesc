...
using DescriptorSetLayoutBindingVector = std::vector<VkDescriptorSetLayoutBinding>;
...
class DescriptorSetLayoutDesc final
{
  ...
  private:
    ...
    std::unordered_map<uint32_t, PackedDescriptorSetBinding> mDescriptorSetLayoutBindings;
    std::unordered_map<uint32_t, VkSampler> mImmutableSamplers;
};
