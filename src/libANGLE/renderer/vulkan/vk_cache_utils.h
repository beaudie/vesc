...
class SamplerDesc final
{
  ...
  private:
    ...
    // The externalFormat is guaranteed to be unique and any image with the same externFormat can
...
class SamplerYcbcrConversionCache final : angle::NonCopyable
{
  public:
    ...
    VkSamplerYcbcrConversion getYuvConversion(uint64_t externalFormat);
