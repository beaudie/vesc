...
// YuvConversion Cache
template <typename T>
using SamplerYcbcrConversionMap = angle::HashMap<T, vk::RefCountedSamplerYcbcrConversion>;
    ...
    : public HasCacheStats<VulkanCacheType::SamplerYcbcrConversion>
{
  public:
    ...
    VkSamplerYcbcrConversion getSamplerYcbcrConversion(uint64_t externalFormat,
