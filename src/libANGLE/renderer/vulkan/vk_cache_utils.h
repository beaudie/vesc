...
struct ImageSubresourceRange
{
    ...
    {
        return level == other.level && levelCount == other.levelCount && layer == other.layer &&
               layerMode == other.layerMode && srgbDecodeMode == other.srgbDecodeMode &&
               srgbMode == other.srgbMode;
    }
};
