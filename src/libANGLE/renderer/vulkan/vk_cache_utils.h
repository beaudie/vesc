...
//
// - Set 0 contains all uniform blocks.  Bindings 0 and 1 are reserved for default uniforms in the
//   vertex and fragment shaders respectively.  User-defined uniform blocks are placed at specified
//   bindings offset by 2.
// - Set 1 contains all textures.
// - Set 2 contains the ANGLE driver uniforms at binding 0.
...
// Start binding index for uniforms defined in the shaders:
constexpr uint32_t kUserUniformBlocksBindingStartIndex = 2;
