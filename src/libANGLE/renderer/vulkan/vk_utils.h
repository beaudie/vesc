...
// ContextVk::PipelineType::EnumCount = 2
using ContextDescriptorSetList = std::array<uint32_t, 2>;
// UtilsVk::Function::EnumCount = 20
using UtilsDescriptorSetList = std::array<uint32_t, 20>;
...
// Descriptor Set Allocation Counts
// DescriptorSetIndex::EnumCount = 4
using ProgramDescriptorSetCountList = std::array<uint32_t, 4>;
struct ProgramDescriptorSetPerfCounters
{
    ProgramDescriptorSetCountList descriptorSetsAllocated;
};
