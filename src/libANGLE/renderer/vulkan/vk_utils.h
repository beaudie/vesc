...
template <typename T>
using ShaderMap = angle::PackedEnumMap<gl::ShaderType, T>;

using ShaderBitSet = angle::PackedEnumBitSet<gl::ShaderType>;

using AllShaderTypes = angle::AllEnums<gl::ShaderType>;
