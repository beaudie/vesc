...
class LineLoopHandler final : angle::NonCopyable
{
  public:
    ...
    gl::Error bindLineLoopIndexBuffer(GLenum drawMode,
                                      int firstVertex,
                                      int lastVertex,
                                      ContextVk *contextVk,
    ...
    // Returns true if the draw have been handled by this handler.
    bool draw(GLenum drawMode, GLsizei count, CommandBuffer *commandBuffer);
