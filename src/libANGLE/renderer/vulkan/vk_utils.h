...
{
    ++mSize;
    CommandBuffer::draw(vertexCount, firstVertex);
}
...
{
    ++mSize;
    CommandBuffer::drawInstanced(vertexCount, instanceCount, firstVertex);
}
...
{
    ++mSize;
    CommandBuffer::drawInstancedBaseInstance(vertexCount, instanceCount, firstVertex,
                                             firstInstance);
}
...
{
    ++mSize;
    CommandBuffer::drawIndexedBaseVertex(indexCount, vertexOffset);
}
...
{
    ++mSize;
    CommandBuffer::drawIndexedInstanced(indexCount, instanceCount);
}
...
{
    ++mSize;
    CommandBuffer::drawIndexedInstancedBaseVertex(indexCount, instanceCount, vertexOffset);
}
...
{
    ++mSize;
    CommandBuffer::drawIndexedInstancedBaseVertexBaseInstance(indexCount, instanceCount, firstIndex,
