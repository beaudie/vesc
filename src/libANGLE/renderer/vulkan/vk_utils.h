...
class BufferBlock final : angle::NonCopyable
{
  public:
    ...
    VkResult allocate(VkDeviceSize size, VkDeviceSize alignment, VmaVirtualAllocation *allocationOut, VkDeviceSize *offsetOut);
...
class BufferSuballocation final : angle::NonCopyable
{
  public:
    ...
    void init(VkDevice device, BufferBlock *block, VmaVirtualAllocation allocation, VkDeviceSize offset, VkDeviceSize size);
