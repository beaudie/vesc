...
#define ANGLE_VK_TRY_ALLOW_OTHER(context, command, success, incomplete)                  \
    do                                                                                   \
    {                                                                                    \
        auto ANGLE_LOCAL_VAR = command;                                                  \
...
#define ANGLE_VK_TRY_ALLOW_INCOMPLETE(context, command) \
    ANGLE_VK_TRY_ALLOW_OTHER(context, command, VK_SUCCESS, VK_INCOMPLETE)

#define ANGLE_VK_TRY_ALLOW_NOT_READY(context, command) \
    ANGLE_VK_TRY_ALLOW_OTHER(context, command, VK_SUCCESS, VK_NOT_READY)

#define ANGLE_VK_TRY_EVENT_STATUS(context, command) \
    ANGLE_VK_TRY_ALLOW_OTHER(context, command, VK_EVENT_SET, VK_EVENT_RESET)
