...
angle::Result CLContextVk::getDevices(cl::DevicePtrs &devPtrs) const
{
    UNIMPLEMENTED();
...
angle::Result CLContextVk::createSampler(const cl::Sampler &sampler, CLSamplerImpl::Ptr &implPtr)
{
    UNIMPLEMENTED();
    // TODO(annestrand) Placeholder error for now
    ANGLE_CL_ERROR(CL_OUT_OF_RESOURCES);
...
angle::Result CLContextVk::createUserEvent(const cl::Event &event, CLEventImpl::Ptr &implPtr)
{
    UNIMPLEMENTED();
    // TODO(annestrand) Placeholder error for now
    ANGLE_CL_ERROR(CL_OUT_OF_RESOURCES);
