...
{
    return mTextureUpdateDataManager.onMutableTextureUpload(contextVk, newTexture);
}

void ShareGroupVk::onTextureRelease(TextureVk *textureVk)
{
    mTextureUpdateDataManager.onTextureRelease(textureVk);
}

angle::Result TextureUpdateDataManager::onMutableTextureUpload(ContextVk *contextVk,
...
void TextureUpdateDataManager::onTextureRelease(TextureVk *textureVk)
{
