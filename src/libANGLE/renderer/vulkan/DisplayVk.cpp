...
angle::Result ShareGroupVk::unifyContextsPriority(ContextVk *contextVk,
                                                   ...
                                                   egl::ContextPriority newPriority)
{
...

    {
        ...
        ANGLE_TRY(renderer->submitPriorityDependency(contextVk, protectionType1, protectionType2,
                                                     mContextsPriority, newPriority, index.get()));
    }
