...
static constexpr VkDeviceSize kMaxStaticBufferSizeToUseBuddyAlgorithm  = 256;
static constexpr VkDeviceSize kMaxDynamicBufferSizeToUseBuddyAlgorithm = 4096;
                                                   ...
                                                   bool isDynamicUsage)
{
    ...
    if ((isDynamicUsage && size <= kMaxDynamicBufferSizeToUseBuddyAlgorithm) ||
        (!isDynamicUsage && size <= kMaxStaticBufferSizeToUseBuddyAlgorithm))
    {
        algorithm = SuballocationAlgorithm::Buddy;
    }
    else
    {
        algorithm = SuballocationAlgorithm::General;
    }
