...
class CommandBufferCommandTracker
{
  ...
  private:
    ...
    // The number of copy commands used from buffers and images to images. Used to submit the
    // command buffer for the outside render pass.
