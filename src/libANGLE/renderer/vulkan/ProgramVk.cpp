                               ...
                               vk::GraphicsPipelineDesc *graphicsPipelineDescOut)
{
    ...
    graphicsPipelineDescOut->setRenderPassDescSampleCount(1);
    ...
    {
        graphicsPipelineDescOut->setRenderPassDescColorAttachmentFormat(
            colorAttachmentIndex, kDefaultColorAttachmentFormat);
    }
}
}  // anonymous namespace
                                           ...
                                           const gl::ProgramMergedVaryings &mergedVaryings)
{
    ...
    {
        // This is a performance improvement feature and is not essential for functionality.
        // As such, treat any errors as non-fatal and move on.
        angle::Result ignoreReturn = createGraphicsPipelineWithDefaultState(context);
...
angle::Result ProgramVk::createGraphicsPipelineWithDefaultState(const gl::Context *context)
{
    ...
    return mExecutable.getGraphicsPipelineForProgram(contextVk, mode, graphicsPipelineDesc,
