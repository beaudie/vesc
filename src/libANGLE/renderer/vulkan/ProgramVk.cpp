...
vk::Error ProgramVk::allocateDescriptorSets(ContextVk *contextVk, uint32_t descriptorSetIndex)
{
    RendererVk *renderer = contextVk->getRenderer();
...
vk::Error ProgramVk::updateUniforms(ContextVk *contextVk)
{
    ...
    if (anyNewBufferAllocated)
    {
        ...
        ANGLE_TRY(allocateDescriptorSets(contextVk, UniformBufferIndex));
...
vk::Error ProgramVk::updateTexturesDescriptorSet(ContextVk *contextVk)
{
    ...
    ANGLE_TRY(allocateDescriptorSets(contextVk, TextureIndex));
