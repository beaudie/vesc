...
{
    resetGlslangProgramInterfaceInfo();
}
...
void ProgramVk::resetGlslangProgramInterfaceInfo()
{
    ...
    mGlslangProgramInterfaceInfo.xfbBindingIndexStart = kXfbBindingIndexStart;

    mGlslangProgramInterfaceInfo.locationsUsedForXfbExtension = 0;
}
