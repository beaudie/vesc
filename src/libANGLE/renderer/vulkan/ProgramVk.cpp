...
angle::Result ProgramVk::updateTexturesDescriptorSet(ContextVk *contextVk, vk::FramebufferHelper *framebuffer)
{
    ASSERT(hasTextures());
         ...
         ++textureIndex)
    {
             ...
             ++arrayElement)
        {
            ...
            if (image.getCurrentLayout() != VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
            {
                ...
                image.changeLayoutWithStages(VK_IMAGE_ASPECT_COLOR_BIT,
