                                  ...
                                  bool *outBufferModified)
{
    ...
    const uint64_t minUniformBufferOffsetAlignment = contextVk->getRenderer()
    ...
    streamingBuffer.allocate(contextVk, bufferData.size(), minUniformBufferOffsetAlignment, &data,
