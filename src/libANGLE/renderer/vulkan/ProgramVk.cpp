...
{
  public:
    WarmUpTaskCommon(RendererVk *renderer) : vk::Context(renderer) {}
    WarmUpTaskCommon(RendererVk *renderer,
    ...
    angle::Result getResult(const gl::Context *context, gl::InfoLog &infoLog) override
    {
        ...
        // Clean up temporary obecj first, it's done no matter what may fail below.
