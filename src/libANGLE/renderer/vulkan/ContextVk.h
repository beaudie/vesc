...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  ...
  private:
    ...
    // DynamicBuffer for streaming vertex data from client memory pointer as well as for default
    // attributes. mHasInFlightStreamedVertexBuffer indicates if the dynamic buffer has any
