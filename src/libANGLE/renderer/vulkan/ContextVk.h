...
class ContextVk : public ContextImpl, public vk::Context, public vk::RenderPassOwner
{
  public:
    ...
    bool emulateSeamfulCubeMapSampling() const { return mState.getClientMajorVersion() == 2; }
  ...
  private:
    ...
    DriverUniformsDescriptorSet mGraphicsDriverUniforms;
    DriverUniformsDescriptorSet mComputeDriverUniforms;
