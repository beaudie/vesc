...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  public:
    ...
    angle::Result allocateForCopyBuffer(vk::BufferHelper *bufferHelper,
                                        size_t size,
                                        vk::MemoryCoherency coherency);
    // Suballocate a host visible buffer with alignment good for copyImage.
    angle::Result allocateForCopyImage(vk::BufferHelper *bufferHelper,
                                       size_t size,
                                       vk::MemoryCoherency coherency,
    ...
    angle::Result allocateForVertexConversion(vk::BufferHelper *bufferHelper,
                                              size_t size,
    ...
    angle::Result checkAndFlushSuballocationGarbage();
    angle::Result checkAndFlushImageGarbage();
