...
class ContextVk : public ContextImpl, public vk::Context
{
  public:
    ...
    // We use texture objectID to optimize texture binding updates. Each permutation of a
    ...
    ImageViewObjectID generateAttachmentImageViewObjectID();
    BufferObjectID generateBufferObjectID();
    TextureObjectID generateTextureObjectID();
    SamplerObjectID generateSamplerObjectID();
