...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  public:
    ...
    angle::Result beginNewRenderPass(const vk::MaybeImagelessFramebuffer &framebuffer,
    ...
    bool hasStartedRenderPassWithSerial(const vk::RenderPassSerial rpSerial) const
    {
        return hasStartedRenderPass() && mRenderPassCommands->getRenderPassSerial() == rpSerial;
    }
    ...
    void restoreFinishedRenderPass(const vk::RenderPassSerial rpSerial);
