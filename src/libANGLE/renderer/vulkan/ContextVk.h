...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  public:
    ...
    angle::Result acquireTextures(const gl::TextureVector &textures, const uint *layouts) override;
    angle::Result releaseTextures(const gl::TextureVector &textures, uint *layouts) override;
