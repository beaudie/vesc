...
class ContextVk : public ContextImpl
{
  public:
    ...
    const VkClearColorValue &getClearColorValue() const;
    const VkClearDepthStencilValue &getClearDepthStencilValue() const;
  ...
  private:
    ...
    VkClearDepthStencilValue mClearDepthStencilValue;
};
