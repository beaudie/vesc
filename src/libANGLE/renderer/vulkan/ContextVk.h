...
class ContextVk : public ContextImpl, public vk::Context, public vk::CommandBufferOwner
{
  ...
  private:
    ...
    angle::Result submitFrame(const VkSubmitInfo &submitInfo, vk::CommandBuffer &&commandBuffer);
    void freeAllInFlightResources();
    angle::Result flushCommandGraph(vk::CommandBuffer *commandBatch);

    angle::Result synchronizeCpuGpuTime();
    angle::Result traceGpuEventImpl(vk::CommandBuffer *commandBuffer, char phase, const char *name);
