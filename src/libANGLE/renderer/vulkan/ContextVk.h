...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  public:
    ...
    const vk::QueueSerials &getLastSubmittedQueueSerials() const
    {
        return mRenderer->getLastSubmittedQueueSerials();
    }
    const vk::QueueSerials &getLastCompletedQueueSerials() const
    {
        return mRenderer->getLastCompletedQueueSerials();
    }
    ...
    angle::Result finishToSerials(const vk::QueueSerials &queueSerials);
