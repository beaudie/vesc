...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  public:
    ...
    angle::Result updateRenderPassDepthFeedbackLoopMode(bool forDepthClear, bool forStencilClear);
  ...
  private:
    ...
    enum DirtyBitType : size_t
    {
        ...
        // record commands.
        DIRTY_BIT_EVENT_LOG,
        // Update depth/stencil accesses in the render pass.
    ...
    angle::Result updateRenderPassDepthFeedbackLoopModeImpl(DirtyBits::Iterator *dirtyBitsIterator,
                                                            DirtyBits dirtyBitMask,
                                                            bool forDepthClear,
