...
class ContextVk : public ContextImpl, public vk::Context, public MultisampleTextureInitializer
{
  ...
  private:
    ...
    static constexpr DirtyBits kXfbBuffersAndDescSetDirtyBits{DIRTY_BIT_TRANSFORM_FEEDBACK_BUFFERS,
                                                              DIRTY_BIT_DESCRIPTOR_SETS};
    static constexpr DirtyBits kDepthStencilDynamicStateDirtyBits =
        DirtyBits{DIRTY_BIT_DYNAMIC_DEPTH_BIAS,         DIRTY_BIT_DYNAMIC_STENCIL_COMPARE_MASK,
                  ...
                  DIRTY_BIT_DYNAMIC_STENCIL_OP,         DIRTY_BIT_DYNAMIC_DEPTH_BIAS_ENABLE};
