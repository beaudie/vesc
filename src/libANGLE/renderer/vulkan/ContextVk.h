...
class CommandQueue final : angle::NonCopyable
{
  public:
    ...
    angle::Result finishToSerialOrTimeout(vk::Context *context, Serial serial, uint64_t timeout);
...
class ContextVk : public ContextImpl, public vk::Context, public vk::RenderPassOwner
{
  public:
    ...
    // A variant of finishToSerial that can time out.
    angle::Result finishToSerialOrTimeout(Serial serial, uint64_t timeout);
