...
class ContextVk : public ContextImpl, public vk::Context
{
  public:
    ...
    {
        return onBufferRead(vk::MemoryReadType::TransferRead, vk::PipelineStage::Transfer, buffer);
    }
    angle::Result onBufferTransferWrite(vk::BufferHelper *buffer)
    {
        return onBufferWrite(vk::MemoryWriteType::TransferWrite, vk::PipelineStage::Transfer,
                             buffer);
    }
    angle::Result onBufferComputeShaderRead(vk::BufferHelper *buffer)
    {
        return onBufferRead(vk::MemoryReadType::ComputeShaderRead, vk::PipelineStage::ComputeShader,
                            buffer);
    }
    angle::Result onBufferComputeShaderWrite(vk::BufferHelper *buffer)
    {
        return onBufferWrite(vk::MemoryWriteType::ComputeShaderWrite,
                             vk::PipelineStage::ComputeShader, buffer);
    }
  ...
  private:
    ...
    angle::Result onBufferRead(vk::MemoryReadType readType,
                               vk::PipelineStage readStage,
                               vk::BufferHelper *buffer);
    angle::Result onBufferWrite(vk::MemoryWriteType writeType,
