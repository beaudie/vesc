...
class UtilsVk : angle::NonCopyable
{
  ...
  private:
    ...
    struct MultisampledCopyShaderParams
    {
        // Structure matching PushConstants in MultisampledCopy.frag
        int32_t srcExtent[2]  = {};
        int32_t srcOffset[2]  = {};
        int32_t destOffset[2] = {};
        int32_t srcLayer      = 0;
    ...
    angle::Result ensureMultisampledCopyResourcesInitialized(vk::Context *context);
    ...
    vk::ShaderProgramHelper
        mMultisampledCopyPrograms[vk::InternalShader::MultisampledCopy_frag::kFlagsMask |
                                  vk::InternalShader::MultisampledCopy_frag::kFormatMask];
    vk::ShaderProgramHelper
