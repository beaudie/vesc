...
CLBufferVk::CLBufferVk(const cl::Buffer &buffer) : CLMemoryVk(buffer)
{
    ...
    mDefaultBCI             = {};
    mDefaultBCI.sType       = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO;
    mDefaultBCI.size        = buffer.getSize();
    mDefaultBCI.usage       = getVkUsageFlags();
    mDefaultBCI.sharingMode = VK_SHARING_MODE_EXCLUSIVE;
}
