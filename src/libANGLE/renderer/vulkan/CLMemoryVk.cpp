...
VkImageUsageFlags CLImageVk::getVkImageUsageFlags()
{
    ...
    if (mMemory.getFlags().isSet((CL_MEM_KERNEL_READ_AND_WRITE | CL_MEM_WRITE_ONLY)))
    {
...
angle::Result CLImageVk::create(cl::MemFlags flags,
                                ...
                                void *hostPtr)
{
    ...
    if (mMemory.getFlags().isSet(CL_MEM_USE_HOST_PTR | CL_MEM_COPY_HOST_PTR))
    {
        ...
        ANGLE_CL_IMPL_TRY_ERROR(mImage.copyBuffer(mContext, &mStagingBuffer, copyRegion),
                                CL_OUT_OF_RESOURCES);
    }
...
angle::Result CLImageVk::map()
{
    UNIMPLEMENTED();
    ANGLE_CL_RETURN_ERROR(CL_OUT_OF_RESOURCES);
}

angle::Result CLImageVk::unmap()
{
    UNIMPLEMENTED();
    ANGLE_CL_RETURN_ERROR(CL_OUT_OF_RESOURCES);
}
