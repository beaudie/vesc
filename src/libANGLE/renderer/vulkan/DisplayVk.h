...
class ShareGroupVk : public ShareGroupImpl
{
  public:
    ...
    void appendFramebufferHelperWithNoAttachments(vk::FramebufferHelper &&framebufferHelper)
    {
        mFramebufferWithNoAttachments.emplace_back(std::move(framebufferHelper));
    }

    void destroyFramebufferHelperWithNoAttachments(RendererVk *rendererVk);
