                                    ...
                                    void *pixels)
{
    ...
    size_t allocationSize    = clippedArea.width * angleFormat.pixelBytes * clippedArea.height;
    ...
    region.bufferImageHeight               = clippedArea.height;
    region.bufferOffset                    = static_cast<VkDeviceSize>(stagingOffset);
    region.bufferRowLength                 = clippedArea.width;
    region.imageExtent.width               = clippedArea.width;
    region.imageExtent.height              = clippedArea.height;
    region.imageExtent.depth               = 1;
    region.imageOffset.x                   = clippedArea.x;
    region.imageOffset.y                   = clippedArea.y;
    ...
    PackPixels(params, angleFormat, clippedArea.width * angleFormat.pixelBytes, readPixelBuffer,
