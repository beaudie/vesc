                                       ...
                                       const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    bool clearColorWithDraw = (clearColor && maskedClearColor) || preferDrawOverClearAttachments;
    bool clearDepthWithDraw = (clearDepth && scissoredClear) || preferDrawOverClearAttachments;
    bool clearStencilWithDraw =
        (clearStencil && (maskedClearStencil || scissoredClear)) || preferDrawOverClearAttachments;
