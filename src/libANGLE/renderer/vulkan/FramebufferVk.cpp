                                                ...
                                                bool *renderPassDescChangedOut)
{
    ...
    if (mBackbuffer)
    {
        // If this render pass uses system framebuffer, we must wait for the acquired semaphore as
        // well.
        contextVk->addWaitSemaphore(mBackbuffer->releaseCurrentAcquireImageSemaphore(),
