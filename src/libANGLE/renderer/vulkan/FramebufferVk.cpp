                                                ...
                                                vk::CommandBuffer **commandBufferOut)
{
    ...
    for (size_t colorIndexGL : mState.getEnabledDrawBuffers())
    {
        ...
        //
        // In an ideal world, this could be done in a subpass so that the multisampled data always
        // ever stays on a tiled renderer's tile and no memory backing is allocated for it.
        if (colorRenderTarget->hasResolveAttachment() &&
