                                  ...
                                  GLenum filter)
{
    ...
    if (blitColorBuffer)
    {
        ...
        {
            // Flush the render pass, which may incur a flush, before taking any views.  Otherwise
            // the view serials would not reflect the render pass they are really used in.
