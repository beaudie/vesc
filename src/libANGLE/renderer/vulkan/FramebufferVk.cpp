                                                          ...
                                                          bool deferClears)
{
    ...
    if (depthStencilRT)
    {
        if (deferClears)
        {
            vk::ClearValueReference clearValueRef(&mDeferredClears, vk::kClearValueDepthIndex);
                                           ...
                                           const VkClearDepthStencilValue &clearDepthStencilValue)
{
    if (clearDepth)
    {
        ...
        mDeferredClears.store(vk::kClearValueDepthIndex, clearValue);
    ...
    vk::CommandBuffer **commandBufferOut)
{
    ...
    if (depthStencilRenderTarget)
    {
        ...
        if (mDeferredClears.testDepth() || mDeferredClears.testStencil())
        {
            ...
            packedClearValues.store(numAttachments, clearValue);
        }
        else
        {
            packedClearValues.store(numAttachments, kUninitializedClearValue);
