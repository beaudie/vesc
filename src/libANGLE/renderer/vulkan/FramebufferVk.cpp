                                                ...
                                                vk::CommandBuffer **commandBufferOut)
{
    ...
    for (size_t colorIndexGL : mState.getEnabledDrawBuffers())
    {
        ...
        renderPassAttachmentOps.setLayouts(numAttachments, vk::ImageLayout::ColorAttachment,
    ...
    if (depthStencilRenderTarget)
    {
        ...
        renderPassAttachmentOps.setLayouts(numAttachments, vk::ImageLayout::DepthStencilAttachment,
