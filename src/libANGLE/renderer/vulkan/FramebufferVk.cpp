                                  ...
                                  GLenum filter)
{
    ...
    if (blitColorBuffer)
    {
                 ...
                 (rotation == SurfaceRotation::Identity))
        {
            ...
            // into. If there's no render pass with commands, then the multisample draw has already
            // occurred so the subpass resolve attachment no longer has an opportunity to be written
            // to.
