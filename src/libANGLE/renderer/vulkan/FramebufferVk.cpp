...
{
    mFramebufferCacheHelper.releaseFramebufferDescReferences(contextVk);
                                ...
                                vk::FramebufferHelper &&newFramebuffer)
{
    ...
    vk::RefCountedFramebufferDescHelper *framebufferDescHelper =
        new vk::RefCountedFramebufferDescHelper(desc);
    mFramebufferCacheHelper.addFramebufferDescReference(contextVk, framebufferDescHelper);
    ...
    {
        colorRenderTargets[colorIndexGL]->addFramebufferDescReference(contextVk,
                                                                      framebufferDescHelper);
    }

    if (getDepthStencilRenderTarget())
    {
        getDepthStencilRenderTarget()->addFramebufferDescReference(contextVk,
                                                                   framebufferDescHelper);
    }

    // We don't delete it here because mFramebufferCacheHelper owns one refcount of it
    ASSERT(framebufferDescHelper->isReferenced());
}
