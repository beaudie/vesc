                                ...
                                vk::FramebufferHelper &&newFramebuffer)
{
    ...
    {
        colorRenderTargets[colorIndexGL]->addFramebufferDescReference(framebufferDescHelper);
    }

    if (getDepthStencilRenderTarget())
    {
        getDepthStencilRenderTarget()->addFramebufferDescReference(framebufferDescHelper);
    }
}
