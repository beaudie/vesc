                                  ...
                                  GLenum filter)
{
    ...
    if (blitColorBuffer)
    {
                 ...
                 (rotation == SurfaceRotation::Identity))
        {
            ...
            //  this hack to 'restore' the started render pass.
            if (!contextVk->hasRenderPassCommandBuffer())
            {
                vk::CommandBufferHelper *renderPassCmds = contextVk->getRenderPassCommands();
                if (renderPassCmds->started() &&
                    renderPassCmds->getFramebufferHandle() == srcVkFramebuffer->getHandle())
                {
                    ...
                    contextVk->restoreRenderPassCommandBuffer();
                }
            }
                                                     ...
                                                     vk::ImageHelper *srcImage)
{
    ...
    perfCounters->vkCmdResolveImageCount++;
