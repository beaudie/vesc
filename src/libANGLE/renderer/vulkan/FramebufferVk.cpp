...
gl::Error FramebufferVk::getDefaultHeight(GLenum target, GLint *defaultHeight)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultHeight is unimplemented.";
}

gl::Error FramebufferVk::getDefaultWidth(GLenum target, GLint *defaultWidth)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultWidth is unimplemented.";
}

gl::Error FramebufferVk::getDefaultSamples(GLenum target, GLint *defaultSamples)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultSamples is unimplemented.";
}

gl::Error FramebufferVk::getDefaultFixedSampleLocations(GLenum target,
