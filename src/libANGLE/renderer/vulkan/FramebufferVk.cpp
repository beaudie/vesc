...
{
    mFramebuffer = new vk::FramebufferHelper();
...
void FramebufferVk::clearCache(ContextVk *contextVk)
{
    ...
    {
        vk::FramebufferHelper *fbToRelease = entry.second;
        fbToRelease->release(contextVk);
        delete fbToRelease;
    }
...
angle::Result FramebufferVk::getFramebuffer(ContextVk *contextVk, vk::Framebuffer **framebufferOut)
{
    ...
    *framebufferOut                            = &mFramebuffer->getFramebuffer();
    mFramebufferCache[mCurrentFramebufferDesc] = mFramebuffer;
    return angle::Result::Continue;
}
