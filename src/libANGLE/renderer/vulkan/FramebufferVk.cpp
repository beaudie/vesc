                                                ...
                                                gl::AttachmentsMask *unresolveAttachmentMask) const
{
    ...
    for (size_t colorIndexGL : mState.getColorAttachmentsMask())
    {
        ...
        {
            initialContentDefinedBits->setColor(colorIndexVk,
    ...
    if (depthStencilRenderTarget)
    {
        ...
        {
            initialContentDefinedBits->setDepth(depthStencilRenderTarget->hasDefinedContent());
            initialContentDefinedBits->setStencil(
    ...
    bool *renderPassDescChangedOut)
{
    ...
    ANGLE_TRY(contextVk->beginNewRenderPass(framebuffer, renderArea, mRenderPassDesc,
                                            renderPassAttachmentOps, mColorAttachmentCount,
                                            mDepthStencilAttachmentIndex, packedClearValues,
                                            packedInitialContentDefinedBits, commandBufferOut));
