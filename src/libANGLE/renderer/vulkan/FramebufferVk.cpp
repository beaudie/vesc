                                          ...
                                          bool blitStencilBuffer)
{
    ...
    vk::ImageHelper *readImage = readRenderTarget->getImageForRead(
        &mFramebuffer, vk::ImageHelper::Layout::TransferSrc, commandBuffer);
                                              ...
                                              RenderTargetVk *drawRenderTarget)
{
    ...
    imageForWrite->changeLayout(imageForWrite->getAspectFlags(),
                                vk::ImageHelper::Layout::TransferDst, commandBuffer);
                                             ...
                                             bool flipDest)
{
    ...
    dstImage->changeLayout(aspectMask, vk::ImageHelper::Layout::TransferDst, commandBuffer);
