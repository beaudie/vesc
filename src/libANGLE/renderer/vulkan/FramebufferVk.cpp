                                       ...
                                       const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    if (clearAnyWithRenderPassLoadOp)
    {
        ...
        // If we in an active renderpass and the framebuffer hasn't changed, inline the clear
        if (contextVk->hasStartedRenderPass() && framebufferIsCurrent)
        {
            ...
            clearWithClearAttachment(
                ...
                clearColorBuffers, clearDepthWithRenderPassLoadOp, clearStencilWithRenderPassLoadOp,
