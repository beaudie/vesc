                                            ...
                                            const GLenum *attachments)
{
    ...
    VkFramebuffer renderPassFramebuffer = contextVk->getRenderPassFramebuffer();
    vk::Framebuffer *currentFramebuffer = nullptr;
    ANGLE_TRY(getFramebuffer(contextVk, &currentFramebuffer));
    bool matchingRenderPassFramebuffer = renderPassFramebuffer != VK_NULL_HANDLE &&
                                         currentFramebuffer != nullptr &&
                                         (renderPassFramebuffer == currentFramebuffer->getHandle());
