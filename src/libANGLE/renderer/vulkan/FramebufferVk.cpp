    ...
    vk::FramebufferAttachmentsVector<RenderTargetInfo> *renderTargetsInfoOut)
{
    ...
    for (size_t colorIndexGL : mState.getColorAttachmentsMask())
    {
        ...
        renderTargetsInfoOut->emplace_back(RenderTargetInfo(
            colorRenderTarget, RenderTargetResolveImageUsage::DoNotUseResolveImage));
    }
    ...
    if (depthStencilRenderTarget)
    {
        ...
        attachments->push_back(imageView->getHandle());
        renderTargetsInfoOut->emplace_back(RenderTargetInfo(
            depthStencilRenderTarget, RenderTargetResolveImageUsage::DoNotUseResolveImage));
    }
    ...
    if (resolveImageViewIn)
    {
        ...
        renderTargetsInfoOut->emplace_back(RenderTargetInfo(
            resolveRenderTargetIn, (resolveRenderTargetIn->hasResolveAttachment())
                                       ? RenderTargetResolveImageUsage::UseResolveImage
                                       : RenderTargetResolveImageUsage::DoNotUseResolveImage));
    }
    else
    {
        ...
        for (size_t colorIndexGL : mState.getColorAttachmentsMask())
        {
            ...
            if (colorRenderTarget->hasResolveAttachment())
            {
                ...
                renderTargetsInfoOut->emplace_back(RenderTargetInfo(
                    colorRenderTarget, RenderTargetResolveImageUsage::UseResolveImage));
            }
        }
    }
    ...
    if (depthStencilRenderTarget && depthStencilRenderTarget->hasResolveAttachment())
    {
        ...
        attachments->push_back(imageView->getHandle());
        renderTargetsInfoOut->emplace_back(RenderTargetInfo(
            depthStencilRenderTarget, RenderTargetResolveImageUsage::UseResolveImage));
    }
    ...
    else
    {
        ...
        for (auto const &info : renderTargetsInfo)
        {
            vk::ImageHelper *renderTargetImage =
                (info.resolveImageUsage == RenderTargetResolveImageUsage::UseResolveImage)
