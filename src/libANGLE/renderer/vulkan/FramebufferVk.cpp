                                 ...
                                 const VkClearDepthStencilValue &depthStencil)
{
    ...
    commandBuffer->clearDepthStencilImage(*renderTarget->image, depthStencil, 1, &clearRange);
...
gl::Error FramebufferVk::clear(const gl::Context *context, GLbitfield mask)
{
    ...
    const VkClearDepthStencilValue &clearDepthStencilValue =
        contextVk->getClearValue().depthStencil;
...
gl::Error FramebufferVk::getRenderNode(const gl::Context *context, vk::CommandBufferNode **nodeOut)
{
    ...
    std::vector<VkClearValue> attachmentClearValues(1, contextVk->getClearValue());
