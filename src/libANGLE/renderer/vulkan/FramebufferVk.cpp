...
{
    mFramebufferCacheHelper.destroy(contextVk);
                                ...
                                vk::FramebufferHelper &&newFramebuffer)
{
    ...
    // it can be destroyed promptly.
    mFramebufferCacheHelper.addFramebufferDescReference(
        contextVk, new vk::RefCountedFramebufferDescHelper(desc));
    ...
    {
        colorRenderTargets[colorIndexGL]->addFramebufferDescReference(
            contextVk, mFramebufferCacheHelper.back());
    }

    if (getDepthStencilRenderTarget())
    {
        getDepthStencilRenderTarget()->addFramebufferDescReference(contextVk,
                                                                   mFramebufferCacheHelper.back());
    }
}
