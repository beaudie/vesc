                                       ...
                                       gl::Command command)
{
    ...
    // If mIsCurrentFramebufferCached==true, meaning the previous framebuffer
    // has at least 1 attachment, and we can reliably use the FramebufferDesc
    // as a way to tell if there is any framebuffer change.
    if (mIsCurrentFramebufferCached && mCurrentFramebufferDesc == priorFramebufferDesc)
    {
        return angle::Result::Continue;
    }
