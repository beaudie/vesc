    ...
    if (mDeferredClears.any())
    {
        ...
        else
        {
            ...
            if (clearAnyWithDraw || isAnyAttachment3DWithoutAllLayers ||
                mIsAHBColorAttachments.count() > 0)
            {
                                                   ...
                                                   uint32_t colorIndexGL)
{
    ...
    if (enabledColor)
    {
        ...
        if (mState.getColorAttachments()[colorIndexGL].isCreatedWithAHB())
        {
            mIsAHBColorAttachments.set(colorIndexGL, 1);
        }
        else
        {
            mIsAHBColorAttachments.set(colorIndexGL, 0);
        }
    }
    else
    {
