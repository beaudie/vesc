                                             ...
                                             bool flipY)
{
    ...
    // TODO: bugs here, write regression test
    blit.srcSubresource.mipLevel = srcImage->toImageLevel(readRenderTarget->getLevelIndex()).get();
    ...
    blit.dstSubresource.mipLevel = dstImage->toImageLevel(drawRenderTarget->getLevelIndex()).get();
    ...
    if (blitDepthBuffer || blitStencilBuffer)
    {
        ...
        else
        {
            ...
            vk::LevelIndex levelIndex =
                depthStencilImage->toImageLevel(readRenderTarget->getLevelIndex());
                                                     ...
                                                     vk::ImageHelper *srcImage)
{
    ...
    for (size_t colorIndexGL : mState.getEnabledDrawBuffers())
    {
        ...
        vk::ImageHelper &dstImage = drawRenderTarget->getImageForWrite();
        vk::LevelIndex levelVK    = dstImage.toImageLevel(drawRenderTarget->getLevelIndex());
                                                                ...
                                                                RenderTargetVk *colorRenderTarget)
{
    ...
    vk::LevelIndex levelVK = src->toImageLevel(colorRenderTarget->getLevelIndex());
