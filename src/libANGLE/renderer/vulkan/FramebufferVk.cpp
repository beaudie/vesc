                                            ...
                                            const GLenum *attachments)
{
    ...
    const vk::Framebuffer *renderPassFramebuffer = contextVk->getRenderPassFramebuffer();
    bool matchingRenderPassFramebuffer =
        renderPassFramebuffer != nullptr && mFramebuffer != nullptr &&
        (renderPassFramebuffer->getHandle() == mFramebuffer->getFramebuffer().getHandle());

    if (contextVk->hasStartedRenderPass() && matchingRenderPassFramebuffer)
    {
