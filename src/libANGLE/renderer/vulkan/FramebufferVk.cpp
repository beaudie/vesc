                                       ...
                                       const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    if (isMidRenderPassClear)
    {
        ...
        ASSERT(contextVk->hasStartedRenderPassWithFramebufferSerial(mFramebufferSerial));
                                  ...
                                  GLenum filter)
{
    ...
    if (blitColorBuffer)
    {
                 ...
                 !reinterpretsColorspace)
        {
            ...
            contextVk->restoreFinishedRenderPass(srcFramebufferVk->getFramebufferSerial());
            ...
            bool canResolveWithSubpass = mState.getEnabledDrawBuffers().count() == 1 &&
                                         ...
                                         contextVk->hasStartedRenderPassWithFramebufferSerial(
                                             srcFramebufferVk->getFramebufferSerial());
                                            ...
                                            const gl::Rectangle &invalidateArea)
{
    ...
    if (contextVk->hasStartedRenderPassWithFramebufferSerial(mFramebufferSerial))
    {
                                                ...
                                                bool *renderPassDescChangedOut)
{
    ...
    ANGLE_TRY(contextVk->beginNewRenderPass(
        *framebuffer, renderArea, mRenderPassDesc, renderPassAttachmentOps, colorIndexVk,
        depthStencilAttachmentIndex, packedClearValues, commandBufferOut, &mFramebufferSerial));
