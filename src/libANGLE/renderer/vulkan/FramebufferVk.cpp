                                    ...
                                    void *pixels)
{
    ...
    if (contextVk->isViewportFlipEnabled(framebuffer))
    {
                              ...
                              GLenum filter)
{
    ...
    bool flipSource                    = contextVk->isViewportFlipEnabled(sourceFramebuffer);
    bool flipDest                      = contextVk->isViewportFlipEnabled(sourceFramebuffer);
    ...
    if (blitDepthBuffer || blitStencilBuffer)
    {
        ...
        {
            if (flipSource || contextVk->isViewportFlipEnabled(sourceFramebuffer))
            {
                                                   ...
                                                   bool clearStencil)
{
    ...
    if (contextVk->isViewportFlipEnabled(contextVk->getGLState().getDrawFramebuffer()))
    {
