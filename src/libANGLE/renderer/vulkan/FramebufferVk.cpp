                                        ...
                                        const GLenum *attachments)
{
    ...
    {
        invalidateImpl(context, count, attachments);
    }
...
void FramebufferVk::invalidateImpl(const gl::Context *context,
                                   size_t count,
                                   const GLenum *attachments)
{
    ...
    bool invalidateDepthBuffer;
    bool invalidateStencilBuffer;
    ...
    mFramebuffer.finishCurrentCommands(vk::GetImpl(context));
}
                                       ...
                                       const gl::Framebuffer::DirtyBits &dirtyBits)
{
    ...
    contextVk->onFramebufferChange(context, this);
