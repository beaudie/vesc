                                  ...
                                  GLenum filter)
{
    ...
    printf("%s @line:%d enter. dynamicState=%d\n", __FUNCTION__, __LINE__,
    ...
    if (blitDepthBuffer || blitStencilBuffer)
    {
        ...
        printf("\tcanBlitWithCommand:%d, intendedFormatID:%d, actualFormatID:%d, \n",
               canBlitWithCommand, ToUnderlying(readRenderTarget->getImageIntendedFormatID()),
               ToUnderlying(readRenderTarget->getImageActualFormatID()));
