                                ...
                                RenderTargetVk *dstRenderTarget)
{
    ...
    return (IsMaskFlagSet<VkFormatFeatureFlags>(readImageProperties.optimalTilingFeatures,
                                                VK_FORMAT_FEATURE_BLIT_SRC_BIT) &&
            IsMaskFlagSet<VkFormatFeatureFlags>(drawImageProperties.optimalTilingFeatures,
                                       ...
                                       bool blitStencilBuffer)
{
    ...
    VkImageAspectFlags aspectMask = blitDepthBuffer
