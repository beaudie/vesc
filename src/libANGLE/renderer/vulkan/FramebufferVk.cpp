                                       ...
                                       const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    bool scissoredClear = scissoredRenderArea != getNonRotatedCompleteRenderArea();
                                       ...
                                       const gl::Framebuffer::DirtyBits &dirtyBits)
{
    ...
    // not come from FramebufferVk::getScissoredRenderArea().  May need to address below.
    ...
    if (binding == GL_READ_FRAMEBUFFER && !mDeferredClears.empty())
    {
        ...
        // FramebufferVk::getScissoredRenderArea(), which is based on the draw FBO's rotation).
        // Since the rectangle is scissored, it must be fully rotated, and not just have the width
        // and height swapped.
