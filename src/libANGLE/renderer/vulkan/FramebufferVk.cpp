                                  ...
                                  GLenum filter)
{
    ...
    // Need to rotate certain values that will be used for UtilsVk::BlitResolveParameters
    ...
    switch (rotation)
    {
        ...
        case SurfaceRotation::Rotated90Degrees:
            ...
            break;
        case SurfaceRotation::Rotated180Degrees:
            ASSERT(params.flipX == false);
            ASSERT(params.flipY == true);
            params.flipX = true;
            params.flipY = false;
            break;
        case SurfaceRotation::Rotated270Degrees:
            ...
            {
                std::swap(params.stretch[0], params.stretch[1]);
                // TODO(ianelliott): Seems like this isn't needed
                std::swap(params.flipX, params.flipY);
            }
            ASSERT(params.flipX == false);
            ASSERT(params.flipY == false);
            params.flipX = true;
            params.flipY = true;
            break;
        default:
