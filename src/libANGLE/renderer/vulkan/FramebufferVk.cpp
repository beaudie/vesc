                                       ...
                                       const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    if (clearAnyWithRenderPassLoadOp)
    {
        ...
        {
            clearWithRenderPassOp(contextVk, clearColorDrawBuffersMask,
...
void FramebufferVk::clearWithRenderPassOp(ContextVk *contextVk,
                                          gl::DrawBufferMask clearColorBuffers,
                                          bool clearDepth,
                                          bool clearStencil,
                                          const VkClearColorValue &clearColorValue,
                                          const VkClearDepthStencilValue &clearDepthStencilValue)
{
    ...
    if (contextVk->hasStartedRenderPass())
    {
        ...
        {
            VkClearValue clearValue = getCorrectedColorClearValue(colorIndexGL, clearColorValue);
            commands.updateRenderPassColorClear(colorIndexGL, clearValue);
        }
