...
{
    const std::vector<GLenum> kColorFormats = {GL_BGRA8_EXT};
    //, GL_RGB8, GL_RGB565, GL_RGBA4, GL_RGB5_A1};

    std::vector<GLenum> depthStencilFormats = {GL_NONE, GL_DEPTH24_STENCIL8, GL_DEPTH_COMPONENT24,
