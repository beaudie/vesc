...
{
    constexpr GLenum colorFormats[]        = {GL_BGRA8_EXT, GL_BGRX8_ANGLEX};
    constexpr GLenum depthStencilFormats[] = {GL_NONE, GL_DEPTH24_STENCIL8};
    constexpr EGLint sampleCounts[]        = {0};
