...
void CommandBufferNode::appendColorRenderTarget(Serial serial, RenderTargetVk *colorRenderTarget)
{
    ...
    PackColorAttachmentDesc(&mRenderPassDesc, *colorRenderTarget->format,
                            colorRenderTarget->samples);
...
{
    // TODO(jmadill): Layout transition?
    PackDepthStencilAttachmentDesc(&mRenderPassDesc, *depthStencilRenderTarget->format,
                                             ...
                                             vk::CommandBuffer *primaryCommandBuffer)
{
    ...
    if (mInsideRenderPassCommands.valid())
    {
        ...
        beginInfo.clearValueCount =
            mRenderPassDesc.colorAttachmentCount + mRenderPassDesc.depthStencilAttachmentCount;
