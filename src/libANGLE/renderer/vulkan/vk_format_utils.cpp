...
static const LoadImageFunctionInfo kEtcToBcLoadingFunc[] = {
    {angle::LoadEACRG11SToRG8, true},     // EAC_R11G11_SNORM
    {angle::LoadEACRG11ToRG8, true},      // EAC_R11G11_UNORM
    {angle::LoadEACR11SToR8, true},       // EAC_R11_SNORM
    {angle::LoadEACR11ToR8, true},        // EAC_R11_UNORM_BLOCK
    {angle::LoadETC1RGB8ToBC1, true},     // ETC1_LOSSY_DECODE_R8G8B8_UNORM
    {angle::LoadETC2RGB8ToBC1, true},     // ETC1_R8G8B8_UNORM
    {angle::LoadETC2SRGB8A1ToBC1, true},  // ETC2_R8G8B8A1_SRGB
    {angle::LoadETC2RGB8A1ToBC1, true},   // ETC2_R8G8B8A1_UNORM
    {angle::LoadETC2SRGBA8ToBC3, true},   // ETC2_R8G8B8A8_SRGB
    {angle::LoadETC2RGBA8ToBC3, true},    // ETC2_R8G8B8A8_UNORM
    {angle::LoadETC2SRGB8ToBC1, true},    // ETC2_R8G8B8_SRGB
    {angle::LoadETC2RGB8ToBC1, true},     // ETC2_R8G8B8_UNORM
};
