...
static const LoadImageFunctionInfo kEtcToBcLoadingFunc[] = {
    LoadImageFunctionInfo(angle::LoadEACRG11SToRG8, true),     // EAC_R11G11_SNORM
    LoadImageFunctionInfo(angle::LoadEACRG11ToRG8, true),      // EAC_R11G11_UNORM
    LoadImageFunctionInfo(angle::LoadEACR11SToR8, true),       // EAC_R11_SNORM
    LoadImageFunctionInfo(angle::LoadEACR11ToR8, true),        // EAC_R11_UNORM_BLOCK
    LoadImageFunctionInfo(angle::LoadETC1RGB8ToBC1, true),     // ETC1_LOSSY_DECODE_R8G8B8_UNORM
    LoadImageFunctionInfo(angle::LoadETC2RGB8ToBC1, true),     // ETC1_R8G8B8_UNORM
    LoadImageFunctionInfo(angle::LoadETC2SRGB8A1ToBC1, true),  // ETC2_R8G8B8A1_SRGB
    LoadImageFunctionInfo(angle::LoadETC2RGB8A1ToBC1, true),   // ETC2_R8G8B8A1_UNORM
    LoadImageFunctionInfo(angle::LoadETC2SRGBA8ToBC3, true),   // ETC2_R8G8B8A8_SRGB
    LoadImageFunctionInfo(angle::LoadETC2RGBA8ToBC3, true),    // ETC2_R8G8B8A8_UNORM
    LoadImageFunctionInfo(angle::LoadETC2SRGB8ToBC1, true),    // ETC2_R8G8B8_SRGB
    LoadImageFunctionInfo(angle::LoadETC2RGB8ToBC1, true),     // ETC2_R8G8B8_UNORM
};

LoadImageFunctionInfo GetEtcToBcTransCodingFunc(angle::FormatID formatID)
{
    ASSERT(IsETCFormat(formatID));
    return kEtcToBcLoadingFunc[static_cast<uint32_t>(formatID) -
