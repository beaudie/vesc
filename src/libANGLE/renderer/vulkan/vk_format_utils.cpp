...
{
    // Returns true for only those formats that have native support for blit operations
    // Here we check that there are no fallback formats needed for image blit operations
