                                ...
                                int compressedStartIndex)
{
    {
        size_t skip = renderer->getFeatures().forceFallbackFormat.enabled ? 1 : 0;
        int i = FindSupportedFormat(renderer, info, skip, numInfo, HasFullBufferFormatSupport);
    ...
    {
        int i = FindSupportedFormat(renderer, info + compressedStartIndex, 0,
                                    numInfo - compressedStartIndex, HasFullBufferFormatSupport);
    ...
    {
        actualCompressedBufferFormatID         = actualBufferFormatID;
        vkCompressedBufferFormat               = vkBufferFormat;
        vkCompressedBufferFormatIsPacked       = vkBufferFormatIsPacked;
        compressedVertexLoadFunction           = vertexLoadFunction;
        compressedVertexLoadRequiresConversion = vertexLoadRequiresConversion;
    }
}
