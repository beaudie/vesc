...
namespace
{
template <VkFormat vk::Format::*typeFormat, VkFormatFeatureFlags VkFormatProperties::*features>
                          ...
                          const VkFormatFeatureFlags featureBits)
{
    if (!format.isVkPropertiesSet)
    {
        ...
        if (IsMaskFlagSet(formatProperties.*features, featureBits))
        {
            return true;
        }

        // Otherwise query the format features and cache it.
        vkGetPhysicalDeviceFormatProperties(physicalDevice, format.*typeFormat,
                                            &format.vkProperties);
        format.isVkPropertiesSet = true;
    }
                                 ...
                                 vk::Format *format)
{
        ...
        HasTextureFormatFeatureBits(physicalDevice, testFormat, kBitsDepth))
    {
        ...
        // testFormat
        format->isVkPropertiesSet = testFormat.isVkPropertiesSet;
        format->vkProperties      = testFormat.vkProperties;
        return true;
    }
...
bool HasLinearTextureFormatFeatureBits(VkPhysicalDevice physicalDevice,
                                       ...
                                       const VkFormatFeatureFlags featureBits)
{
    return HasFormatFeatureBits<&Format::vkTextureFormat,
                                &VkFormatProperties::linearTilingFeatures>(physicalDevice, format,
                                                                           featureBits);
}
...
{
    return HasFormatFeatureBits<&Format::vkTextureFormat,
                                &VkFormatProperties::optimalTilingFeatures>(physicalDevice, format,
                                                                            featureBits);
}
...
bool HasBufferFormatFeatureBits(VkPhysicalDevice physicalDevice,
                                ...
                                const VkFormatFeatureFlags featureBits)
{
    return HasFormatFeatureBits<&Format::vkBufferFormat, &VkFormatProperties::bufferFeatures>(
