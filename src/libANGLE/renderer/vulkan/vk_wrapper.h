...
ANGLE_INLINE VkResult CommandPool::reset(VkDevice device)
{
    if (valid())
    {
        // Defaulting to soft reset. Can add flags param if/when needed
        return vkResetCommandPool(device, mHandle, 0);
    }
    return VK_SUCCESS;
}
