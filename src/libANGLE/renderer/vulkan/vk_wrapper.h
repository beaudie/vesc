...
class Allocation final : public WrappedObject<Allocation, VmaAllocation>
{
  public:
    ...
    void getMemoryTypeProperties(const Allocator &allocator, VkMemoryPropertyFlags *flagsOut) const;
...
ANGLE_INLINE void Allocation::getMemoryTypeProperties(const Allocator &allocator,
                                                      VkMemoryPropertyFlags *flagsOut) const
{
    ASSERT(valid());
    vma::GetMemoryTypeProperties(allocator.getHandle(), mMemoryTypeIndex, flagsOut);
}
