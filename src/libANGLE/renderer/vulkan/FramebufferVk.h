...
class FramebufferVk : public FramebufferImpl
{
  public:
    ...
    ANGLE_INLINE angle::Result startNewRenderPass(ContextVk *contextVk,
                                                  const gl::Rectangle &renderArea,
                                                  vk::CommandBuffer **commandBufferOut)
    {
        return startNewRenderPassWithMask(contextVk, renderArea, mState.getEnabledDrawBuffers(),
                                          commandBufferOut);
    }

    angle::Result startNewRenderPassWithMask(ContextVk *contextVk,
                                             const gl::Rectangle &renderArea,
    ...
    vk::ClearValuesArray *getDeferredClears() { return &mDeferredClears; }
