...
class FramebufferVk : public FramebufferImpl
{
  public:
    ...
    void updateFramebufferDescColorResolve(uint32_t colorIndexGL,
                                           vk::ImageViewSubresourceSerial serial)
    {
        mCurrentFramebufferDesc.updateColorResolve(colorIndexGL, serial);
    }
