...
void ProgramExecutableVk::reset(ContextVk *contextVk)
{
    ...
    mNumDefaultUniformDescriptors                          = 0;
    mTransformOptions.enableLineRasterEmulation            = 0;
    mTransformOptions.surfaceRotation                      = 0;
    mTransformOptions.removeEarlyFragmentTestsOptimization = 0;
    mTransformOptions.reserved                             = 0;
