...
{
    if (mDescriptorSets[setIndex])
    {
        mDescriptorSets[setIndex]->onUnbind();
    }
    ...
    mDescriptorSets[setIndex]->onBind();
...
{
    if (mDescriptorSets[DescriptorSetIndex::Texture])
    {
        mDescriptorSets[DescriptorSetIndex::Texture]->onUnbind();
    }
    ...
    mDescriptorSets[DescriptorSetIndex::Texture]->onBind();
