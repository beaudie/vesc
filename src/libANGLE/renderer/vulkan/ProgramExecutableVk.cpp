    ...
    ContextVk *contextVk)
{
    ...
    if (defaultUniformBlock.uniformData.empty())
    {
        ...
        bufferHelper->retainBuffer(&contextVk->getResourceUseList(), vk::ResourceUseType::Read);
    ...
    bool cacheHit)
{
    ...
    emptyBuffer.retainBuffer(&contextVk->getResourceUseList(), vk::ResourceUseType::Read);
