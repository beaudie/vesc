                                                        ...
                                                        const gl::ProgramExecutable &glExecutable)
{
    ...
    mShaderResourceWriteDescriptorDescs.updateShaderBuffers(linkedShaderStages, mVariableInfoMap,
                                                            glExecutable.getUniformBlocks(),
                                                            getUniformBufferDescriptorType());
    mShaderResourceWriteDescriptorDescs.updateShaderBuffers(linkedShaderStages, mVariableInfoMap,
                                                            glExecutable.getShaderStorageBlocks(),
