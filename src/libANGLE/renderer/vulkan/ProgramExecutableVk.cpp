...
namespace
{
constexpr vk::MemoryWriteType GetShaderWriteMemoryType(gl::ShaderType shaderType)
{
...
constexpr vk::MemoryReadType GetUniformReadMemoryType(gl::ShaderType shaderType)
{
