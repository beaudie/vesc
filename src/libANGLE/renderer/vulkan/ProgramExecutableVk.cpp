    ...
    gl::ActiveTextureArray<vk::TextureUnit> *activeTextures)
{
    ...
    ANGLE_TRY(contextVk->getShareGroupVk()->getDescriptorSetLayoutCache().getDescriptorSetLayout(
    ...
    ANGLE_TRY(contextVk->getShareGroupVk()->getPipelineLayoutCache().getPipelineLayout(
