...
void CommandBuffer::queryCounter(VkPipelineStageFlagBits pipelineStage,
...
{
    ANGLE_VK_TRY_RETURN_ALLOW_TIMEOUT(context, vkWaitForFences(context->getDevice(),
                1, &mHandle, true, timeout));
}
