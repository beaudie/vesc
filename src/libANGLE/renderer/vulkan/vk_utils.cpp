...
bool BufferSuballocation::hasAllocationVirtualBlock() const
{
    return valid() && mBufferBlock->hasVirtualBlock();
}

angle::Result BufferSuballocation::map(Context *context)
{
    return mBufferBlock->map(context);
}
}  // namespace vk
}  // namespace rx
