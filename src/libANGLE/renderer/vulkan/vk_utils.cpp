...
angle::Result PipelineCache::getCacheData(Context *context, size_t *cacheSize, void *cacheData)
{
    ...
    // also acceptable and the resulting buffer will contain valid value by spec.  However, angle
    // currently ensures *cacheSize to be either 0 or of enough size, therefore VK_INCOMPLETE is not
    // expected.
