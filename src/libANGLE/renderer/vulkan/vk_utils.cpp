                                              ...
                                              vk::DeviceMemory *deviceMemoryOut)
{
    ...
    ANGLE_VK_TRY_RETURN(context, deviceMemoryOut->allocate(context->getDevice(), allocInfo));
}
                                          ...
                                          vk::DeviceMemory *deviceMemoryOut)
{
    ...
    ANGLE_VK_TRY_RETURN(context, bufferOrImage->bindMemory(context->getDevice(), *deviceMemoryOut));
}
