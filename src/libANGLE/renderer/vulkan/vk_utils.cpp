...
// NoOpErrorProxyContext implementation.
NoOpErrorProxyContext::NoOpErrorProxyContext(Context *errorHandlingContext)
    : Context(errorHandlingContext->getRenderer()), mErrorHandlingContext(errorHandlingContext)
{}

void NoOpErrorProxyContext::handleError(VkResult result,
                                        const char *file,
                                        const char *function,
                                        unsigned int line)
{
