...
gl::Error LineLoopHandler::bindLineLoopIndexBuffer(GLenum drawMode,
                                                   int firstVertex,
                                                   int lastVertex,
                                                   ContextVk *contextVk,
                                                   vk::CommandBuffer **commandBuffer)
{
        ...
        lastVertex != mLineLoopBufferLastIndex)
    {
        ...
        uint32_t count = lastVertex - firstVertex + 1;
...
bool LineLoopHandler::draw(GLenum drawMode, GLsizei count, CommandBuffer *commandBuffer)
{
    if (drawMode == GL_LINE_LOOP)
    {
