                         ...
                         uint32_t *pEnabledLayerCount)
{
    ...
    {
        *pppEnabledLayerNames = &g_VkStdValidationLayerName;
        *pEnabledLayerCount   = 1;
    }
    else if (HasValidationLayers(layerProps))
    {
        *pppEnabledLayerNames = g_VkValidationLayerNames;
        *pEnabledLayerCount   = g_VkNumValidationLayerNames;
    }
    else
    {
        ...
        *pppEnabledLayerNames = nullptr;
        *pEnabledLayerCount   = 0;
        return false;
    }
