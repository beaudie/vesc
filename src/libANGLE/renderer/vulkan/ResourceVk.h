...
bool ReadWriteResource::usedByCommandBuffer(const QueueSerial &commandBufferQueueSerial) const
{
    return mReadOnlyUse.usedByCommandBuffer(commandBufferQueueSerial);
}

bool ReadWriteResource::writtenByCommandBuffer(const QueueSerial &commandBufferQueueSerial) const
{
