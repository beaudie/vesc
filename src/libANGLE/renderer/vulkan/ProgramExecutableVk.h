...
class ProgramExecutableVk
{
  public:
    ...
    const vk::WriteDescriptorDescs &getShaderResourceWriteDescriptors() const
    {
        return mShaderResourceWriteDescriptors;
    }
    const vk::WriteDescriptorDescs &getDefaultUniformWriteDescriptors(
        TransformFeedbackVk *transformFeedbackVk) const
    {
        return transformFeedbackVk == nullptr ? mDefaultUniformWriteDescriptors
                                              : mDefaultUniformAndXfbWriteDescriptors;
    }
  ...
  private:
    ...
    vk::WriteDescriptorDescs mShaderResourceWriteDescriptors;
    vk::WriteDescriptorDescs mTextureWriteDescriptors;
    vk::WriteDescriptorDescs mDefaultUniformWriteDescriptors;
    vk::WriteDescriptorDescs mDefaultUniformAndXfbWriteDescriptors;
};
