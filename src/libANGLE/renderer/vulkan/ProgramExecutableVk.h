...
class ProgramExecutableVk
{
  ...
  private:
    ...
    vk::DescriptorPoolPointer mUniformsAndXfbDescriptorsPool;
    vk::DescriptorPoolPointer mTextureDescriptorsPool;
    vk::DescriptorPoolPointer mShaderBufferDescriptorsPool;
