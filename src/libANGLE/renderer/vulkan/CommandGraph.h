...
class SharedResourceUse final : angle::NonCopyable
{
  public:
    ...
    ANGLE_INLINE bool isInUseByANGLE() const
    {
        ASSERT(valid());
        return mUse->counter > 1;
    }

    ANGLE_INLINE bool isInUseByDriver(Serial lastCompletedSerial) const
    {
        ASSERT(valid());
    ...
    {
        return isInUseByANGLE() || isInUseByDriver(lastCompletedSerial);
    }
...
class CommandGraphResource : angle::NonCopyable
{
  public:
    ...
    void onResourceUse(ResourceUseList *resourceUseList);
...
ANGLE_INLINE void CommandGraphResource::onResourceUse(ResourceUseList *resourceUseList)
{
