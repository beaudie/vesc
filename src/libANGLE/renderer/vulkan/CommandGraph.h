...
{
    SharedGarbageObject();
    SharedGarbageObject(const SharedResourceUse &lifetimeIn, GarbageObjectBase &&objectIn);
...
class CommandGraphResource : angle::NonCopyable
{
  public:
    ...
    Serial getLatestSerial() const { return mUse->serial; }
