...
// inheritance or composition. Faster than using an interface class since it has inlined methods.
...
class CommandGraphNode final : angle::NonCopyable
{
  public:
    ...
    void setCommandBufferOwner(CommandBufferOwner *owner) { mCommandBufferOwner = owner; }
