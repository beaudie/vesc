...
{
  public:
    constexpr PackedAttachmentIndex() : mAttachmentIndex(0) {}
...
static constexpr PackedAttachmentIndex kInvalidAttachmentIndex = PackedAttachmentIndex(-1);
static constexpr PackedAttachmentIndex kZeroAttachmentIndex    = PackedAttachmentIndex(0);
