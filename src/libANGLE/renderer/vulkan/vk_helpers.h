...
struct CommandBufferHelper : angle::NonCopyable
{
  ...
  private:
    ...
    std::unordered_set<ImageSerial> mRenderPassUsedImages;
};
...
enum class ImageLayout
{
    ...
    TransferSrc,
    TransferDst,
    VertexShaderDepthStencilReadOnly,
    VertexShaderReadOnly,
    VertexShaderWrite,
    GeometryShaderDepthStencilReadOnly,
    GeometryShaderReadOnly,
    GeometryShaderWrite,
    FragmentShaderDepthStencilReadOnly,
    FragmentShaderReadOnly,
    FragmentShaderWrite,
    ComputeShaderDepthStencilReadOnly,
    ComputeShaderReadOnly,
    ComputeShaderWrite,
    AllGraphicsShaderDepthStencilReadOnly,
...
{
    ASSERT(mIsRenderPassCommandBuffer);
    return mRenderPassUsedImages.count(image.getImageSerial()) > 0;
}
}  // namespace vk
}  // namespace rx
