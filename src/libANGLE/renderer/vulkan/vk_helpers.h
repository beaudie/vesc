...
class DescriptorPoolCacheCallback : angle::NonCopyable
{
  public:
    ...
    virtual void onNewDescriptorPool(uint32_t poolIndex,
                                     RefCountedDescriptorPoolHelper *newPool)     = 0;
    virtual void onResetDescriptorPool(uint32_t poolIndex,
...
class CachedDescriptorPool final : public DescriptorPoolCacheCallback
{
  public:
    ...
    void onNewDescriptorPool(uint32_t poolIndex, RefCountedDescriptorPoolHelper *newPool) override;
    void onResetDescriptorPool(uint32_t poolIndex,
    ...
    void accumulateCacheStats(Accumulator *accum)
    {
        ...
        //{
        //    innerCache.accumulateCacheStats(accum);
        //}
    }
...
template <typename DescriptorDescT, VulkanCacheType CacheType>
class DescriptorMetaCache final : public HasCacheStats<CacheType>
{
  public:
