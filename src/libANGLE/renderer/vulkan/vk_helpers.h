...
class DescriptorPoolHelper final : public Resource
{
  public:
    ...
    angle::Result allocateAndCacheDescriptorSet(ContextVk *contextVk,
...
class DynamicDescriptorPool final : angle::NonCopyable
{
  public:
    ...
    size_t getDescriptorSetAllocationCount() const { return mDescriptorSetAllocationCount; }
  ...
  private:
    ...
    uint32_t mDescriptorSetAllocationCount;
};
...
class BufferHelper : public ReadWriteResource
{
  public:
    ...
    BufferSerial getBufferOrBlockSerial() const
    {
        return mSuballocation.valid() ? mSuballocation.getBlockSerial() : mSerial;
    }
