...
class CommandBufferHelper : angle::NonCopyable
{
  public:
    ...
    void setMemoryBarrierIssued()
    {
        if (!empty())
        {
            mHasMemoryBarrierIssuedInLifeTime = true;
        }
    }
    bool hasMemoryBarrierIssuedInLifeTime() const { return mHasMemoryBarrierIssuedInLifeTime; }
  ...
  private:
    ...
    bool mHasMemoryBarrierIssuedInLifeTime;
