...
class DynamicBuffer : angle::NonCopyable
{
  public:
    ...
    // Init that gives the ability to pass in specified memory property flags for the
    // buffer. Additionally, provides the option to disable suballocation of the dynamic
    // buffer.
  ...
  private:
    ...
    // Disable suballocation
    bool mDisableSubAllocation;
