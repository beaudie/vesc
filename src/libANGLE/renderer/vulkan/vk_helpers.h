...
using ImageSourceID                        = uint64_t;
constexpr ImageSourceID kZeroImageSourceID = 0;
...
class RenderPassAttachment final
{
  public:
    ...
    void init(ImageSourceID sourceID,
              ImageHelper *image,
    ...
    bool hasImageFromSource(ImageSourceID sourceID, const ImageHelper *image) const
    {
        return image == mImage && sourceID == mSourceID;
    }
  ...
  private:
    ...
    // Object ID from which image was originated
    ImageSourceID mSourceID;
...
class RenderPassCommandBufferHelper final : public CommandBufferHelperCommon
{
  public:
    ...
    void finalizeImageLayout(Context *context, ImageSourceID sourceID, const ImageHelper *image);
