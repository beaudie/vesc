...
class ImageHelper final : public Resource, public angle::Subject
{
  ...
  private:
    ...
    void updateNonFragmentAccessHistory(VkPipelineStageFlags stageMask)
    {
        // First shift bitfield left. Then add new bit at the right most to reflect this usage
        mNonFragmentAccessHistory <<= 1;
        ...
        {
            mNonFragmentAccessHistory.set(0);
        }
    }
    ...
    NonFragmentAccessHistory mNonFragmentAccessHistory;
