...
class RenderPassCommandBufferHelper final : public CommandBufferHelperCommon
{
  ...
  private:
    ...
    angle::FlatUnorderedSet<ImageSerial, kFlatMapSize> mRenderPassReadImagesWithLayoutTransition;
...
{
    return mRenderPassReadImagesWithLayoutTransition.contains(image.getImageSerial());
}
