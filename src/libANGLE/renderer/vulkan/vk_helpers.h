...
class CommandBufferAccess : angle::NonCopyable
{
  public:
    ...
    const ReadBuffers &getReadBuffers() const { return readBuffers; }
    const WriteBuffers &getWriteBuffers() const { return writeBuffers; }
    const ReadImages &getReadImages() const { return readImages; }
    const WriteImages &getWriteImages() const { return writeImages; }
