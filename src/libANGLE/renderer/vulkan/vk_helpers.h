...
enum class ImageLayout
{
    ...
    VertexShaderWrite          = 7,
    FragmentShaderReadOnly     = 8,
    FragmentShaderWrite        = 9,
    ComputeShaderReadOnly      = 10,
    ComputeShaderWrite         = 11,
    AllGraphicsShadersReadOnly = 12,
    AllGraphicsShadersWrite    = 13,
    ColorAttachment            = 14,
    DepthStencilAttachment     = 14,
    Present                    = 16,
