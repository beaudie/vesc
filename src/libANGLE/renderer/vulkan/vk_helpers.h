...
class ImageViewHelper : angle::NonCopyable
{
  public:
    ...
    {
        return mLinearColorspace ? getValidReadViewImpl(mPerLevelLinearReadImageViews)
                                 : getValidReadViewImpl(mPerLevelNonLinearReadImageViews);
    }

    const ImageView &getFetchImageView() const
    {
        return mLinearColorspace ? getValidReadViewImpl(mPerLevelLinearFetchImageViews)
                                 : getValidReadViewImpl(mPerLevelNonLinearFetchImageViews);
    }

    const ImageView &getCopyImageView() const
    {
        return mLinearColorspace ? getValidReadViewImpl(mPerLevelLinearCopyImageViews)
                                 : getValidReadViewImpl(mPerLevelNonLinearCopyImageViews);
    }
