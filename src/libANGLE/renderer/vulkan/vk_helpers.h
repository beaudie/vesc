...
class ImageViewHelper : angle::NonCopyable
{
  public:
    ...
    void onResourceUse(ResourceUseList *resourceUseList) const { resourceUseList->add(mUse); }
...
class SamplerHelper final : angle::NonCopyable
{
  public:
    ...
    void onResourceUse(ResourceUseList *resourceUseList) { resourceUseList->add(mUse); }
