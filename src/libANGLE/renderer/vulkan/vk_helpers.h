...
class ImageHelper final : public Resource, public angle::Subject
{
  public:
    ...
    bool hasStagedUpdatesInBaseMaxRange() const;
  ...
  private:
    ...
    bool hasStagedUpdatesInRange(gl::LevelIndex levelStart, gl::LevelIndex levelEnd) const;
    ...
    gl::TexLevelFastVector<std::vector<SubresourceUpdate>> mSubresourceUpdates;
