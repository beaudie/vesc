  ...
  public:
    ...
    void execute(PrimaryCommandBuffer *primary, const bool supportsSynchronization2)
    {
        ...
        if (supportsSynchronization2)
        {
            ...
            {
                imageMemoryBarrier2.srcStageMask = mSrcStageMask;
                imageMemoryBarrier2.dstStageMask = mDstStageMask;
            }

            primary->pipelineBarrier2(0, memoryBarrierCount,
                                      memoryBarrierCount > 0 ? &memoryBarrier2 : nullptr, 0,
...
class OutsideRenderPassCommandBufferHelper final : public CommandBufferHelperCommon
{
  public:
    ...
    void executeBarriers2(Context *contextVk,
...
class ImageHelper final : public Resource, public angle::Subject
{
  ...
  private:
    ...
    void applyImageMemoryBarrier(OutsideRenderPassCommandBuffer *commandBuffer,
