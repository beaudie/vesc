...
class CommandBufferHelper : angle::NonCopyable
{
  public:
    ...
    {
        ASSERT(mIsRenderPassCommandBuffer);
        return cmdCountInvalidated == kNoLongerInvalidatedCmdSize ||
               (cmdCountInvalidated != kNeverInvalidatedCmdSize &&
    ...
    {
        ASSERT(mIsRenderPassCommandBuffer);
        return cmdCountInvalidated != kNeverInvalidatedCmdSize &&
    ...
    bool shouldRestoreDepthStencilAttachment()
    {
        ...
        return isNoLongerInvalidated(mDepthCmdSizeInvalidated, mDepthCmdSizeDisabled) ||
               isNoLongerInvalidated(mStencilCmdSizeInvalidated, mStencilCmdSizeDisabled);
    }
