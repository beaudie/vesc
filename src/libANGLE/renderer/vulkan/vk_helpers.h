...
class MaybeImagelessFramebuffer : angle::NonCopyable
{
  public:
    ...
    {
        ASSERT(mImageViews.size() == rhs.mImageViews.size());
        mFramebuffer.setHandle(rhs.mFramebuffer.getHandle());
        std::swap(mImageViews, rhs.mImageViews);
        mImageless = rhs.mImageless;

        return *this;
    }

    //    void updateFramebuffer(Framebuffer newFramebuffer,
    //                           FramebufferAttachmentArray<VkImageView> &updatedImageViews,
    //                           ImagelessStatus imageless)
    //    {
    //        ASSERT(mImageViews.size() >= updatedImageViews.size());
    //        std::swap(mFramebuffer, newFramebuffer);
    //        std::swap(mImageViews, updatedImageViews);
    //        mImageless = imageless;
    //    }
    ...
    void setAsImageless() { mImageless = ImagelessStatus::Imageless; }
