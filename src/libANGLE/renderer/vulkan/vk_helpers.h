...
class DynamicBuffer : angle::NonCopyable
{
  public:
    ...
    // be nullptr.
    Error allocate(ContextVk *context,
                   size_t sizeInBytes,
                   uint8_t **ptrOut,
                   VkBuffer *handleOut,
                   uint32_t *offsetOut,
...
class LineLoopHandler final : angle::NonCopyable,
                              angle::ObserverInterface,
                              public CommandGraphResource
{
  public:
    LineLoopHandler();
    ~LineLoopHandler();
    ...
    CommandGraphResource *getLineLoopBufferResource();
  ...
  private:
    ...
    DynamicBuffer mDynamicLineLoopIndicesData;
