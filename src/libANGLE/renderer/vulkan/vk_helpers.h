...
using PipelineSerialArray  = angle::PackedEnumMap<PipelineStage, Serial>;
...
class MemoryBarrierTimelineTracker : angle::NonCopyable
{
  public:
    ...
    bool updateReadAfterWriteBarrier(PipelineStage writeStage,
    ...
    // This returns true if a barrier is needed.
    bool updateWriteAfterWriteBarrier(PipelineStage prevWriteStage,
    ...
    // This returns true if a barrier is needed.
    bool updateWriteAfterReadBarrier(PipelineStagesMask &readStageMask,
                                     PipelineSerialArray &readSerials,
                                     PipelineStage writeStage,
                                     MemoryWriteType writeType,
                                     PipelineBarrier *barrier);

    void updateSrcStageMask(PipelineStage stage)
    {
    ...
    static constexpr uint32_t kIndexInvalid = -1;
  ...
  private:
    ...
    static constexpr uint32_t kReadAfterWriteMemoryBarriersCount =
        static_cast<uint32_t>(MemoryWriteType::EnumCount)
        << static_cast<uint32_t>(MemoryReadType::BitCount);
    angle::FixedVector<Serial, kReadAfterWriteMemoryBarriersCount> mReadAfterWriteBarrierSerials;
    angle::FixedVector<uint32_t, kReadAfterWriteMemoryBarriersCount>
    ...
    static constexpr uint32_t kWriteAfterWriteMemoryBarriersCount =
        static_cast<uint32_t>(MemoryWriteType::EnumCount)
        << static_cast<uint32_t>(MemoryWriteType::BitCount);
    angle::FixedVector<Serial, kWriteAfterWriteMemoryBarriersCount> mWriteAfterWriteBarrierSerials;
    angle::FixedVector<uint32_t, kWriteAfterWriteMemoryBarriersCount>
    ...
    PipelineSerialArray mSrcStageSerials;
    PipelineStagesMask mSrcStageMask;
};
...
class BufferHelper final : public Resource
{
  ...
  private:
    ...
    PipelineSerialArray mCurrentReadSerials;
};
