...
class ImageHelper final : public Resource, public angle::Subject
{
  public:
    ...
    void invalidateSubresourceContent(gl::LevelIndex level, uint32_t layerIndex);
    void invalidateSubresourceStencilContent(gl::LevelIndex level, uint32_t layerIndex);
