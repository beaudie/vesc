...
class CommandBufferHelper : angle::NonCopyable
{
  ...
  private:
    ...
    // Array size of mImages
    PackedAttachmentIndex mImagesCount;
    // Index to mImages for the specific ImageHelper object
    PackedAttachmentIndex mColorResolveImageIndex;
    PackedAttachmentIndex mDepthStencilResolveImageIndex;
