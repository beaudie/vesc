...
class QueryHelper final
{
  public:
    ...
    // for occlusion query
    angle::Result beginQuery(const ContextVk *contextVk, CommandBuffer *commandBuffer);
    angle::Result endQuery(const ContextVk *contextVk, CommandBuffer *commandBuffer);
