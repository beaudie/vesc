...
#define POPULATE_CALLBACK(VULKANOBJ, CALLBACKPTR)               \
    do                                                          \
    {                                                           \
        mCallbackMap[MemoryAllocationCallbackType::VULKANOBJ] = \
...
class MemoryAllocationCallback
{
  public:
    MemoryAllocationCallback()
    {
        ...
        // Initialize all callbacks (TODO: if the feature is enabled)
        POPULATE_CALLBACK(Unknown, this);
        POPULATE_CALLBACK(Allocator, this);
        POPULATE_CALLBACK(Buffer, this);
        POPULATE_CALLBACK(BufferView, this);
        POPULATE_CALLBACK(CommandPool, this);
        POPULATE_CALLBACK(DebugUtils, this);
        POPULATE_CALLBACK(DescriptorPool, this);
        POPULATE_CALLBACK(DescriptorSetLayout, this);
        POPULATE_CALLBACK(Device, this);
        POPULATE_CALLBACK(DeviceMemory, this);
        POPULATE_CALLBACK(Event, this);
        POPULATE_CALLBACK(Framebuffer, this);
        POPULATE_CALLBACK(Image, this);
        POPULATE_CALLBACK(ImageView, this);
        POPULATE_CALLBACK(Instance, this);
        POPULATE_CALLBACK(Pipeline, this);
        POPULATE_CALLBACK(PipelineCache, this);
        POPULATE_CALLBACK(PipelineLayout, this);
        POPULATE_CALLBACK(QueryPool, this);
        POPULATE_CALLBACK(RenderPass, this);
        POPULATE_CALLBACK(Sampler, this);
        POPULATE_CALLBACK(SamplerYcbcrConversion, this);
        POPULATE_CALLBACK(Semaphore, this);
        POPULATE_CALLBACK(ShaderModule, this);
        POPULATE_CALLBACK(Swapchain, this);
    }
