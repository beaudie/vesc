...
#include "libANGLE/renderer/vulkan/WindowSurfaceVkWin32.h"
...
vk::ErrorOrResult<gl::Extents> WindowSurfaceVkWin32::createSurfaceVk()
{
    ...
    ANGLE_VK_TRY(vkCreateWin32SurfaceKHR(mInstance, &createInfo, nullptr, &mSurface));
