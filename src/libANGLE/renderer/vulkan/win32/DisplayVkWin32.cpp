...
egl::ConfigSet DisplayVkWin32::generateConfigs()
{
    ...
    egl::Config bgraWithDepthStencil;
    bgraWithDepthStencil                    = bgra;
    bgraWithDepthStencil.depthStencilFormat = GL_DEPTH24_STENCIL8;
    bgraWithDepthStencil.depthSize          = 24;
    bgraWithDepthStencil.stencilSize        = 8;

    egl::ConfigSet configSet;
    configSet.add(bgra);
    configSet.add(bgraWithDepthStencil);
    return configSet;
}
