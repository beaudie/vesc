                                      ...
                                      const gl::ProgramVaryingPacking &varyingPacking)
{
    ...
    if (options.supportsTransformFeedbackExtension &&
        glExecutable.hasLinkedShaderStage(linkedTransformFeedbackStage))
    {
        ASSERT(gl::ShaderTypeSupportsTransformFeedback(linkedTransformFeedbackStage));

        const gl::Program *glProgram = mState.getShaderProgram(linkedTransformFeedbackStage);
        ASSERT(glProgram);
        ...
        GlslangAssignTransformFeedbackLocations(
            linkedTransformFeedbackStage, glProgram->getState(), isTransformFeedbackStage,
