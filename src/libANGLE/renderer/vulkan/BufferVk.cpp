                                              ...
                                              gl::BufferUsage usage)
{
    ...
    // buffer.
    mHasValidData = false;
    mUniformBuffer = target == gl::BufferBinding::Uniform;
                                            ...
                                            BufferUsageType usageType)
{
    ...
    ANGLE_TRY(contextVk->initBufferAllocation(&mBuffer, mMemoryTypeIndex, size, alignment,
                                              usageType, mUniformBuffer));
