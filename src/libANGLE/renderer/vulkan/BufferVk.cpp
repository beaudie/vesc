                                             ...
                                             bool hostVisible)
{
    ...
    return bufferHelper->initForVertexConversion(contextVk, size, hostVisible);
}
                                           ...
                                           uint8_t **mapPtr)
{
    ...
    ANGLE_TRY(mStagingBuffer.initForCopyBuffer(contextVk, static_cast<size_t>(size), coherent));
    *mapPtr                = mStagingBuffer.getMappedMemory();
    mIsStagingBufferMapped = true;
