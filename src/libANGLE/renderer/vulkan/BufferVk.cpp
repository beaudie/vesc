...
ANGLE_INLINE VkMemoryPropertyFlags GetStorageMemoryType(GLbitfield storageFlags)
{
    ...
    if (((storageFlags & GL_MAP_READ_BIT) != 0) || ((storageFlags & GL_MAP_WRITE_BIT) != 0) ||
        ((storageFlags & GL_DYNAMIC_STORAGE_BIT_EXT) != 0))
    {
                                       ...
                                       GLbitfield flags)
{
    ...
    bool persistentMapRequired                = (flags & GL_MAP_PERSISTENT_BIT_EXT) != 0;
