                                               ...
                                               size_t size)
{
    ...
    if (target == gl::BufferBinding::PixelUnpack)
    {
        ...
        // since we do not need the CPU only buffer for functionality
                                    ...
                                    GLsizeiptr size)
{
    ...
    // If the CPU only buffer is enabled for the destination buffer then
                                     ...
                                     void **mapPtr)
{
    ...
    else
    {
        ...
        // or not, just return the CPU buffer.
...
angle::Result BufferVk::unmapImpl(ContextVk *contextVk)
{
    ...
    else
    {
        ...
        size_t offset       = mState.getMapOffset();
        size_t size         = mState.getMapLength();
        ...
        if (writeOperation)
        {
            ...
            const uint8_t *data = (mShadowBuffer.getCurrentBuffer() + offset);
                                      ...
                                      gl::IndexRange *outRange)
{
    ...
    {
        mapPointer = (mShadowBuffer.getCurrentBuffer() + offset);
    }
