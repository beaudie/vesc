                                         ...
                                         BufferUpdateType updateType)
{
    ...
    VkDeviceSize OldBufferOffset = mBufferOffset;
    ...
    if (updateRegionBeforeSubData)
    {
        ...
        {
            copyRegions.push_back({OldBufferOffset, mBufferOffset, offset});
        }
    }
    ...
    if (updateRegionAfterSubData)
    {
        ...
        {
            copyRegions.push_back({OldBufferOffset + offsetAfterSubdata,
