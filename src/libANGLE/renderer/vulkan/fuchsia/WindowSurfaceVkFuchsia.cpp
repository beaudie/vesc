...
{
    InitFuchsiaImagePipeSurfaceFunctions(context->getRenderer()->getInstance());
...
angle::Result WindowSurfaceVkFuchsia::getCurrentWindowSize(vk::Context *context, gl::Extents *extentsOut)
{
    fuchsia_egl_window *egl_window = reinterpret_cast<fuchsia_egl_window *>(mNativeWindowType);
