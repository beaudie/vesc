...
void DisplayVkFuchsia::generateExtensionsVk(egl::DisplayExtensions *outExtensions) const
{
    // EGL_ANGLE_window_fixed_size is required to provide window surface size.
