...
class ShaderLibrary final : angle::NonCopyable
{
  public:
    ...
    angle::Result getBlitResolve_frag(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getBlitResolveStencilNoExport_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getConvertIndex_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getConvertIndexIndirectLineLoop_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getConvertIndirectLineLoop_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getConvertVertex_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getCopyImageToBuffer_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getEtcToBc_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getExportStencil_frag(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getFullScreenTri_vert(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getGenerateMipmap_comp(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getImageClear_frag(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getImageCopy_frag(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getOverlayDraw_frag(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);
angle::Result getOverlayDraw_vert(Context *context, uint32_t shaderFlags, RefCounted<ShaderModule> **shaderOut);

  private:
    RefCounted<ShaderModule> mBlitResolve_frag_shaders[InternalShader::BlitResolve_frag::kArrayLen];
RefCounted<ShaderModule> mBlitResolveStencilNoExport_comp_shaders[InternalShader::BlitResolveStencilNoExport_comp::kArrayLen];
RefCounted<ShaderModule> mConvertIndex_comp_shaders[InternalShader::ConvertIndex_comp::kArrayLen];
RefCounted<ShaderModule> mConvertIndexIndirectLineLoop_comp_shaders[InternalShader::ConvertIndexIndirectLineLoop_comp::kArrayLen];
RefCounted<ShaderModule> mConvertIndirectLineLoop_comp_shaders[InternalShader::ConvertIndirectLineLoop_comp::kArrayLen];
RefCounted<ShaderModule> mConvertVertex_comp_shaders[InternalShader::ConvertVertex_comp::kArrayLen];
RefCounted<ShaderModule> mCopyImageToBuffer_comp_shaders[InternalShader::CopyImageToBuffer_comp::kArrayLen];
RefCounted<ShaderModule> mEtcToBc_comp_shaders[InternalShader::EtcToBc_comp::kArrayLen];
RefCounted<ShaderModule> mExportStencil_frag_shaders[InternalShader::ExportStencil_frag::kArrayLen];
RefCounted<ShaderModule> mFullScreenTri_vert_shaders[InternalShader::FullScreenTri_vert::kArrayLen];
RefCounted<ShaderModule> mGenerateMipmap_comp_shaders[InternalShader::GenerateMipmap_comp::kArrayLen];
