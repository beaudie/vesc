...
class ShaderLibrary final : angle::NonCopyable
{
  ...
  private:
    ShaderAndSerial
        mDispatchUtils_comp_shaders[InternalShader::DispatchUtils_comp::flagsMask |
                                    InternalShader::DispatchUtils_comp::functionMask |
                                    InternalShader::DispatchUtils_comp::resourcetypeMask];
