...
enum OutputFormat
{
    kEtcRgb8ToBC1   = 0x00000000,
    kEtcRgb8a1ToBC1 = 0x00000001,
    kEtcRgba8ToBC3  = 0x00000002,
    kEtcR11ToBC4    = 0x00000003,
    kEtcRg11ToBC5   = 0x00000004,
};
constexpr size_t kArrayLen = 0x00000005;
}  // namespace EtcToBc_comp
