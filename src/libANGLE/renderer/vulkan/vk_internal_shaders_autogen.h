...
namespace MultisampledCopy_frag
{
enum flags
{
    kSrcIsArray = 0x00000001,
...
class ShaderLibrary final : angle::NonCopyable
{
  public:
    ...
    angle::Result getImageCopy_frag(Context *context,
                                    uint32_t shaderFlags,
                                    RefCounted<ShaderAndSerial> **shaderOut);
    angle::Result getMultisampledCopy_frag(Context *context,
                                           uint32_t shaderFlags,
                                           RefCounted<ShaderAndSerial> **shaderOut);
  ...
  private:
    ...
    RefCounted<ShaderAndSerial>
        mMultisampledCopy_frag_shaders[InternalShader::MultisampledCopy_frag::kFlagsMask |
                                       InternalShader::MultisampledCopy_frag::kFormatMask];
    RefCounted<ShaderAndSerial>
