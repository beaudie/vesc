...
enum flags
{
    kUnresolveDepth   = 0x00000001,
    kUnresolveStencil = 0x00000002,
};
constexpr size_t kArrayLen = 0x00000004;
}  // namespace Unresolve_frag
...
class ShaderLibrary final : angle::NonCopyable
{
  public:
    ...
    angle::Result getUnresolve_frag(Context *context,
                                    uint32_t shaderFlags,
                                    RefCounted<ShaderAndSerial> **shaderOut);
    angle::Result getBlitResolve_frag_code(Context *context,
                                           uint32_t shaderFlags,
                                           std::vector<uint32_t> *shaderCodeOut);
    angle::Result getBlitResolveStencilNoExport_comp_code(Context *context,
                                                          uint32_t shaderFlags,
                                                          std::vector<uint32_t> *shaderCodeOut);
    angle::Result getConvertIndex_comp_code(Context *context,
                                            uint32_t shaderFlags,
                                            std::vector<uint32_t> *shaderCodeOut);
    angle::Result getConvertIndexIndirectLineLoop_comp_code(Context *context,
                                                            uint32_t shaderFlags,
                                                            std::vector<uint32_t> *shaderCodeOut);
    angle::Result getConvertIndirectLineLoop_comp_code(Context *context,
                                                       uint32_t shaderFlags,
                                                       std::vector<uint32_t> *shaderCodeOut);
    angle::Result getConvertVertex_comp_code(Context *context,
                                             uint32_t shaderFlags,
                                             std::vector<uint32_t> *shaderCodeOut);
    angle::Result getFullScreenQuad_vert_code(Context *context,
                                              uint32_t shaderFlags,
                                              std::vector<uint32_t> *shaderCodeOut);
    angle::Result getGenerateMipmap_comp_code(Context *context,
                                              uint32_t shaderFlags,
                                              std::vector<uint32_t> *shaderCodeOut);
    angle::Result getImageClear_frag_code(Context *context,
                                          uint32_t shaderFlags,
                                          std::vector<uint32_t> *shaderCodeOut);
    angle::Result getImageCopy_frag_code(Context *context,
                                         uint32_t shaderFlags,
                                         std::vector<uint32_t> *shaderCodeOut);
    angle::Result getOverlayCull_comp_code(Context *context,
                                           uint32_t shaderFlags,
                                           std::vector<uint32_t> *shaderCodeOut);
    angle::Result getOverlayDraw_comp_code(Context *context,
                                           uint32_t shaderFlags,
                                           std::vector<uint32_t> *shaderCodeOut);
    angle::Result getUnresolve_frag_code(Context *context,
                                         uint32_t shaderFlags,
                                         std::vector<uint32_t> *shaderCodeOut);
