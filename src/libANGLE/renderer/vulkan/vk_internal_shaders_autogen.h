...
namespace MultisampledFlip_frag
{
enum flags
{
    kSrcIsArray = 0x00000001,
...
class ShaderLibrary final : angle::NonCopyable
{
  public:
    ...
    angle::Result getImageCopy_frag(Context *context,
                                    uint32_t shaderFlags,
                                    RefCounted<ShaderAndSerial> **shaderOut);
    angle::Result getMultisampledFlip_frag(Context *context,
                                           uint32_t shaderFlags,
                                           RefCounted<ShaderAndSerial> **shaderOut);
  ...
  private:
    ...
    RefCounted<ShaderAndSerial>
        mMultisampledFlip_frag_shaders[InternalShader::MultisampledFlip_frag::kFlagsMask |
                                       InternalShader::MultisampledFlip_frag::kFormatMask];
    RefCounted<ShaderAndSerial>
