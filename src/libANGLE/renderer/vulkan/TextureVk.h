...
class TextureVk : public TextureImpl, public angle::ObserverInterface
{
  public:
    ...
    bool adjustViewFormatForSampler() const
    {
        return (mActualSamplerFormat != VK_FORMAT_UNDEFINED);
    }
    void setSamplerFormat(VkFormat samplerFormat) { mActualSamplerFormat = samplerFormat; }
    VkFormat getSamplerFormat(VkFormat samplerFormat) const { return mActualSamplerFormat; }
