...
class TextureVk : public TextureImpl, public angle::ObserverInterface
{
  ...
  private:
    ...
    // |mImage| either points to mMultisampledImages[0] if |mOwnsImage|, indicating that |TextureVk|
    // owns the image.  Otherwise it is a weak pointer shared with another class.
