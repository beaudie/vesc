                            ...
                            angle::NativeWindowSystem nativeWindowSystem)
{
    ...
    // b/42266906: Samsung Vulkan driver with API level < 1.3.244 has a bug in imageless
    //             framebuffer support.
    //
    // b/369693310: Qualcomm with imageless framebuffers, vkCreateFramebuffer loops forever.
    //
    // b/372273294: PowerVR with imageless framebuffer spends enormous amounts of time in
    //              framebuffer destruction and creation. ANGLE doesn't cache imageless
    //              framebuffers, instead adding them to garbage collection, expecting
    //              them to be lightweight.
