...
angle::Result Renderer::ensurePipelineCacheInitialized(vk::Context *context)
{
    ...
    {
        ANGLE_TRY(getPipelineCacheDataIfNew(context, &mPipelineCacheSizeAtLastSync,
...
angle::Result Renderer::getPipelineCacheDataIfNew(vk::Context *context,
                                                  ...
                                                  std::vector<uint8_t> *pipelineCacheDataOut)
{
    ...
    // |PipelineAccessCache|, and is locked once here.
    vk::PipelineCacheAccess globalCache;
    globalCache.init(&mPipelineCache, nullptr);

    std::unique_lock<angle::SimpleMutex> cacheLock(mPipelineCacheMutex);
                                            ...
                                            const gl::Context *contextGL)
{
    ...
    ANGLE_TRY(getPipelineCacheDataIfNew(context, &pipelineCacheSize, mPipelineCacheSizeAtLastSync,
                                        &pipelineCacheData));
