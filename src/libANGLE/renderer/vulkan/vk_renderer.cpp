                            ...
                            angle::NativeWindowSystem nativeWindowSystem)
{
    ...
    // supported.
    const bool imageAtomicsSupported =
        ExtensionFound(VK_EXT_SHADER_ATOMIC_FLOAT_EXTENSION_NAME, deviceExtensionNames) &&
        mShaderAtomicFloatFeatures.shaderImageFloat32Atomics == VK_TRUE;
    ANGLE_FEATURE_CONDITION(&mFeatures, emulateR32fImageAtomicExchange, !imageAtomicsSupported);
