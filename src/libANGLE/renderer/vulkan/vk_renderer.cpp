...
size_t StorePipelineCacheVkChunks(VkPhysicalDeviceProperties physicalDeviceProperties,
                                  vk::GlobalOps *globalOps,
                                  ContextVk *contextVk,
                                  bool checkExistingChunks,
...
void ErasePipelineCacheVkChunks(VkPhysicalDeviceProperties physicalDeviceProperties,
                                vk::GlobalOps *globalOps,
                                const size_t numChunks,
                                const uint8_t slotIndex,
                                angle::MemoryBuffer *scratchBuffer);
