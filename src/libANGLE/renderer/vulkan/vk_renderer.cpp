                            ...
                            angle::NativeWindowSystem nativeWindowSystem)
{
    ...
    // http://b/329911999. Some Qualcomm devices show increased memory usage for images when MSRTSS
    // is enabled, even if the image does not end up using this feature.
    ANGLE_FEATURE_CONDITION(
