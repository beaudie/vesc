...
void Renderer::onDestroy(vk::Context *context)
{
    ...
    if (mPlaceHolderDescriptorSetLayout && mPlaceHolderDescriptorSetLayout->get().valid())
    {
        ...
        ANGLE_DEFINE_CALLBACKS(callbacksDescSetLayout, this, DescriptorSetLayout);
        mPlaceHolderDescriptorSetLayout->get().destroy(getDevice(), callbacksDescSetLayout);
    ...
    ANGLE_DEFINE_CALLBACKS(callbacksEvent, this, Event);
    mRefCountedEventRecycler.destroy(mDevice, callbacksEvent);
