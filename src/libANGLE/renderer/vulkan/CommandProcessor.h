...
class CommandProcessorTask
{
  public:
    ...
    std::vector<VkPipelineStageFlags2> &getWaitSemaphoreStageMasks()
    {
    ...
    VkPipelineStageFlags2 getOneOffWaitSemaphoreStageMask() const
    {
  ...
  private:
    ...
    VkPipelineStageFlags2 mOneOffWaitSemaphoreStageMask;
