...
class CommandProcessorTask
{
  public:
    ...
    void initFinishToSerial(const Serials &serials);
    ...
    const Serials &getFinishSerials() const { return mFinishSerials; }
...
class CommandQueueInterface : angle::NonCopyable
{
  public:
    ...
    virtual angle::Result queueSubmitOneOff(Context *context,
                                            ...
                                            const vk::QueueSerial &submitQueueSerial) = 0;
...
class CommandQueue final : public CommandQueueInterface
{
  public:
    ...
    const Serials &getLastSubmittedSerials() const { return mLastSubmittedSerials; }
    const Serials &getLastCompletedSerials() const { return mLastCompletedSerials; }
    ...
    {
        return queueSerial.serial <= mLastCompletedSerials[queueSerial.index];
    }
  ...
  private:
    ...
    bool allInFlightCommandsAreAfterSerial(const Serials &serials);
    ...
    Serials mLastCompletedSerials;
    Serials mLastSubmittedSerials;
...
class CommandProcessor final : public Context, public CommandQueueInterface
{
  public:
    ...
    angle::Result queueSubmitOneOff(Context *context,
                                    ...
                                    const Fence *fence,
                                    SubmitPolicy submitPolicy,
                                    const vk::QueueSerial &submitQueueSerial) override;
    VkResult queuePresent(egl::ContextPriority contextPriority,
                          const VkPresentInfoKHR &presentInfo) override;
    ...
    const Serials &getLastSubmittedSerials() const
    {
        return mCommandQueue.getLastSubmittedSerials();
    }
    const Serials &getLastCompletedSerials() const
    {
