...
class CommandProcessorTask
{
  public:
    ...
    void initPresent(bool hasProtectedContent,
                     egl::ContextPriority priority,
                     const VkPresentInfoKHR &presentInfo);

    void initFinishToSerial(bool hasProtectedContent, Serial serial);
...
class CommandQueueInterface : angle::NonCopyable
{
  public:
    ...
    virtual angle::Result queueSubmitOneOff(Context *context,
                                            ...
                                            Serial submitQueueSerial)  = 0;
    virtual VkResult queuePresent(bool hasProtectedContent,
                                  egl::ContextPriority contextPriority,
    ...
    virtual angle::Result checkCompletedCommands(Context *context, bool hasProtectedContent) = 0;
...
class CommandQueue final : public CommandQueueInterface
{
  public:
    ...
    angle::Result finishToSerial(Context *context,
                                 bool hasProtectedContent,
                                 Serial finishSerial,
    ...
    VkResult queuePresent(bool hasProtectedContent,
                          egl::ContextPriority contextPriority,
    ...
    angle::Result checkCompletedCommands(Context *context, bool hasProtectedContent) override;
  ...
  private:
    ...
    bool allInFlightCommandsAreAfterSerial(bool hasProtectedContent, Serial serial);
    ...
    GarbageQueue &getGarbageQueue(bool hasProtectedContent)
    {
        if (hasProtectedContent)
        {
            return mProtectedGarbageQueue;
        }
        else
        {
            return mGarbageQueue;
        }
    }
    std::vector<CommandBatch> &getInFlightCommands(bool hasProtectedContent)
    {
        if (hasProtectedContent)
        {
            return mProtectedInFlightCommands;
        }
        else
        {
            return mInFlightCommands;
        }
    }

    GarbageQueue mGarbageQueue;
    GarbageQueue mProtectedGarbageQueue;

    std::vector<CommandBatch> mInFlightCommands;
    std::vector<CommandBatch> mProtectedInFlightCommands;
...
class CommandProcessor : public Context, public CommandQueueInterface
{
  public:
    ...
    angle::Result finishAllWork(Context *context, bool hasProtectedContent);
  ...
  private:
    ...
    VkResult present(bool hasProtectedContent,
                     egl::ContextPriority priority,
                     const VkPresentInfoKHR &presentInfo);
