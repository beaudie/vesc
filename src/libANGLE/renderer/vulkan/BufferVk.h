...
class BufferVk : public BufferImpl
{
  ...
  private:
    ...
    angle::Result mapBuffer(ContextVk *contextVk, uint8_t **ptrOut);
    angle::Result mapBufferWithOffset(ContextVk *contextVk, uint8_t **ptrOut, size_t offset);
    void unmapBuffer(RendererVk *rendererVk);
