...
class ConversionBuffer
{
  public:
    ...
    void addDirtyBufferRange(const gl::RangeUL &range) { mDirtyRanges.emplace_back(range); }
  ...
  private:
    ...
    std::vector<gl::RangeUL> mDirtyRanges;
...
class BufferVk : public BufferImpl
{
  ...
  private:
    ...
    void dataUpdated();
    void dataUpdated(const gl::RangeUL &range);
