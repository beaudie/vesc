             ...
             currentCommand->id != CommandID::Invalid; currentCommand = NextCommand(currentCommand))
        {
            switch (currentCommand->id)
            {
                ...
                case CommandID::ImageBarrier2:
                {
                    ...
                    memoryBarrier2.srcStageMask        = imageMemoryBarriers2->srcStageMask;
                    memoryBarrier2.dstStageMask        = imageMemoryBarriers2->dstStageMask;
                ...
                case CommandID::ImageWaitEvent2:
                {
                    ...
                    pDependencyInfo.imageMemoryBarrierCount  = 1;
                    pDependencyInfo.pImageMemoryBarriers     = imageMemoryBarriers2;
                    vkCmdWaitEvents2KHR(cmdBuffer, 1, &(params->event), &pDependencyInfo);
                    break;
                }
                case CommandID::InsertDebugUtilsLabel:
                {
                ...
                case CommandID::ResetEvent2:
                {
                    ...
                    vkCmdResetEvent2KHR(cmdBuffer, params->event, params->stageMask);
                    break;
                }
                case CommandID::ResetQueryPool:
                {
                ...
                case CommandID::SetEvent2:
                {
                    ...
                    const VkImageMemoryBarrier2 *imageMemoryBarriers2 =
                        GetNextArrayParameter<VkImageMemoryBarrier2>(memoryBarriers2,
                                                                     params->memoryBarrier2Count);
                    VkDependencyInfo dependencyInfo        = {};
                    dependencyInfo.sType                   = VK_STRUCTURE_TYPE_DEPENDENCY_INFO;
                    dependencyInfo.dependencyFlags         = params->dependencyFlags;
                    dependencyInfo.memoryBarrierCount      = params->memoryBarrier2Count;
                    dependencyInfo.pMemoryBarriers         = memoryBarriers2;
                    dependencyInfo.imageMemoryBarrierCount = params->imageMemoryBarrier2Count;
                    dependencyInfo.pImageMemoryBarriers    = imageMemoryBarriers2;
                    vkCmdSetEvent2KHR(cmdBuffer, params->event, &dependencyInfo);
                    break;
                }
                case CommandID::SetFragmentShadingRate:
                {
                ...
                case CommandID::WaitEvents2:
                {
                    ...
                    vkCmdWaitEvents2KHR(cmdBuffer, params->eventCount, events, dependencyInfos);
                    break;
                }
                case CommandID::WriteTimestamp:
                {
