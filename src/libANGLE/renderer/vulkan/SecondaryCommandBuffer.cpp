                                          ...
                                          const void *data)
{
    ...
    // Copy variable sized data
    storePointerParameter(data, &paramStruct->data, dataSize);
}
                                           ...
                                           const void *data)
{
    ...
    // Copy variable sized data
    storePointerParameter(data, &paramStruct->data, size);
}
...
void SecondaryCommandBuffer::parse(VkCommandBuffer cmdBuffer)
{
