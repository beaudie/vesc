...
void SecondaryCommandBuffer::executeCommands(VkCommandBuffer cmdBuffer)
{
         ...
         currentCommand                = currentCommand->next)
    {
        switch (currentCommand->id)
        {
            ...
            {
                const UpdateBufferParams *params = getParamPtr<UpdateBufferParams>(currentCommand);
            ...
            {
                const SetViewportParams *params = getParamPtr<SetViewportParams>(currentCommand);
