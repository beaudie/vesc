...
{
    return renderer->hasUnfinishedUse(mUse.getResourceUse());
}

bool Resource::isCurrentlyInUse(RendererVk *renderer) const
{
    return mUse.usedInRecordedCommands() || renderer->hasUnfinishedUse(mUse.getResourceUse());
}
...
{
    return renderer->hasUnfinishedUse(mReadOnlyUse.getResourceUse());
}

bool ReadWriteResource::isCurrentlyInUse(RendererVk *renderer) const
{
    return mReadOnlyUse.usedInRecordedCommands() ||
           renderer->hasUnfinishedUse(mReadOnlyUse.getResourceUse());
}

bool ReadWriteResource::isCurrentlyInUseForWrite(RendererVk *renderer) const
{
    return mReadWriteUse.usedInRecordedCommands() ||
           renderer->hasUnfinishedUse(mReadWriteUse.getResourceUse());
}
