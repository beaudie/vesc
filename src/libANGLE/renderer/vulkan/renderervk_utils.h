...
struct PackedRenderPassDesc final
{
    PackedRenderPassDesc();
    PackedRenderPassDesc(const PackedRenderPassDesc &other);
    PackedRenderPassDesc &operator=(const PackedRenderPassDesc &other);
