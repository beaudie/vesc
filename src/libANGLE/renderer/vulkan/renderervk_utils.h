...
class ResourceVk
{
  public:
    ...
    vk::CommandBufferNode *sireCommandNode(RendererVk *renderer);

    // Helper method: returns a started CommandBuffer that renders outside the RenderPass.
    vk::Error recordChildCommands(RendererVk *renderer, vk::CommandBuffer **commandBufferOut);
    ...
    void chainNewCommands(vk::CommandBufferNode *newCommands);

  private:
    Serial mStoredQueueSerial;
    vk::CommandBufferNode *mCurrentInUseCommands;
};
