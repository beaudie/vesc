...
def get_get_function_h(shader_and_variation):
    ...
    return 'angle::Result %s(Context *context, uint32_t shaderFlags, RefCounted<ShaderAndSerial> **shaderOut);' % function_name
...
def get_get_function_cpp(shader_and_variation):
    ...
    definition = 'angle::Result ShaderLibrary::%s(Context *context, uint32_t shaderFlags, RefCounted<ShaderAndSerial> **shaderOut)\n{\n' % function_name
