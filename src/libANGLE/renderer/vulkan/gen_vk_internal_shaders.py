...
def find_build_path():
    ...
    # This script is 5 levels deep in the angle repo, so it should only check
    # for out dirs up to that depth.
    vk_shader_script_depth = 5
    for _ in range(vk_shader_script_depth):
      ...
      # If we didn't find a build directory this time, try again a level up
