...
void LiteCommandBuffer::updatePtrCmdData(const ptrType *paramData,
                                           ...
                                           const uint32_t *dynamicOffsets)
{
    ...
    updatePtrCmdData<VkDescriptorSet>(descriptorSets, &paramStruct->descriptorSets, descSize);
    updatePtrCmdData<uint32_t>(dynamicOffsets, &paramStruct->dynamicOffsets, offsetSize);
}
