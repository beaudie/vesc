...
vk::Framebuffer &WindowSurfaceVk::chooseFramebuffer()
{
    if (isMultiSampled())
    {
        return mFramebufferResolveMSMode == FramebufferResolveOptimizationMS::Enabled
                                                     ...
                                                     vk::Framebuffer **framebufferOut)
{
    ...
    vk::Framebuffer &currentFramebuffer =
        chooseFramebuffer();  // Pass mFramebufferResolveMSMode as function argument
    ...
    if (isMultiSampled())
    {
        ...
        if (mFramebufferResolveMSMode == FramebufferResolveOptimizationMS::Enabled)
        {
            ...
            for (SwapchainImage &swapchainImage : mSwapchainImages)
            {
                ...
                ANGLE_VK_TRY(contextVk, swapchainImage.framebufferResolveMS.init(
                                            contextVk->getDevice(), framebufferInfoMS));
            }
        }
        else
        {
