    ...
    const vk::FramebufferResolveOptimizePresentMS framebufferResolveMSMode)
{
    if (isMultiSampled())
    {
        return framebufferResolveMSMode == vk::FramebufferResolveOptimizePresentMS::Enabled
    ...
    ASSERT(framebufferResolveMSMode == vk::FramebufferResolveOptimizePresentMS::Disabled);
                                       ...
                                       bool *presentOutOfDate)
{
    ...
    vk::Framebuffer &currentFramebuffer =
        chooseFramebuffer(vk::FramebufferResolveOptimizePresentMS::Disabled);
    ...
    vk::Framebuffer **framebufferOut)
{
    ...
    vk::Framebuffer &currentFramebuffer = chooseFramebuffer(framebufferResolveMSMode);
    if (currentFramebuffer.valid())
    {
    ...
    if (isMultiSampled())
    {
        ...
        if (framebufferResolveMSMode == vk::FramebufferResolveOptimizePresentMS::Enabled)
        {
