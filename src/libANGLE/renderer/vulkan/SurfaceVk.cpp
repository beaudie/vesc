                                                  ...
                                                  const vk::ContextSerialMap &serials)
{
    ...
    imageView.release(displayVk, serials);
}
...
void WindowSurfaceVk::destroy(const egl::Display *display)
{
    ...
    mAcquireNextImageSemaphore.release(displayVk, getStoredQueueSerials());
    ...
    mDepthStencilImageView.release(displayVk, getStoredQueueSerials());
    ...
    for (SwapchainImage &swapchainImage : mSwapchainImages)
    {
        ...
        swapchainImage.image.release(displayVk, getStoredQueueSerials());
        swapchainImage.imageView.release(displayVk, getStoredQueueSerials());
        swapchainImage.framebuffer.release(displayVk, getStoredQueueSerials());
        swapchainImage.imageAcquiredSemaphore.release(displayVk, getStoredQueueSerials());
        swapchainImage.commandsCompleteSemaphore.release(displayVk, getStoredQueueSerials());
    }
...
angle::Result WindowSurfaceVk::swapImpl(vk::Context *context, DisplayVk *displayVk)
{
    ...
    ANGLE_TRY(beginWriteResource(context, &swapCommands));
