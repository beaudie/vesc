                                       ...
                                       bool &swapchainOutOfDate)
{
    ...
    // continuing.
    // If VK_SUBOPTIMAL_KHR is returned we it's because the device orientation
    // changed and we should recreate the swapchain with a new window
    // orientation. We aren't quite ready for that so just ignore for now.
