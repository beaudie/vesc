...
WindowSurfaceVk::SwapchainCleanupData::SwapchainCleanupData() = default;
WindowSurfaceVk::SwapchainCleanupData::~SwapchainCleanupData()
{
...
WindowSurfaceVk::SwapchainCleanupData::SwapchainCleanupData(
    WindowSurfaceVk::SwapchainCleanupData &&other)
    : swapchain(other.swapchain), semaphores(std::move(other.semaphores))
{
    other.swapchain = VK_NULL_HANDLE;
}

void WindowSurfaceVk::SwapchainCleanupData::destroy(VkDevice device,
...
WindowSurfaceVk::ImagePresentHistory::ImagePresentHistory() = default;
WindowSurfaceVk::ImagePresentHistory::~ImagePresentHistory()
{
    ASSERT(!semaphore.valid());
    ASSERT(oldSwapchains.empty());
}

WindowSurfaceVk::ImagePresentHistory::ImagePresentHistory(ImagePresentHistory &&other)
