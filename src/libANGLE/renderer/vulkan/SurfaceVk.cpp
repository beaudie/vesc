                                                         ...
                                                         FramebufferAttachmentRenderTarget **rtOut)
{
    if (mNeedToAcquireNextSwapchainImage)
    {
        ...
        ANGLE_TRACE_EVENT0("gpu.angle", "WindowSurfaceVk::getAttachmentRenderTarget: First use");
                                        ...
                                        const void *pNextChain)
{
    ...
    if (mNeedToAcquireNextSwapchainImage)
    {
        ...
        ANGLE_TRACE_EVENT0("gpu.angle", "WindowSurfaceVk::swapImpl: Swap Image Not Yet Acquired");
        ANGLE_TRY(doDeferredAcquireNextImage(context, false));
    }
    ...
    else
    {
        ...
        ANGLE_TRACE_EVENT0("gpu.angle", "WindowSurfaceVk::swapImpl: Out of Date Swapbuffer");
                                                  ...
                                                  const gl::ImageIndex &imageIndex)
{
    ...
    if (mNeedToAcquireNextSwapchainImage)
    {
        ...
        ANGLE_TRACE_EVENT0("gpu.angle", "WindowSurfaceVk::initializeContents: Need Swap Image");
        ANGLE_TRY(doDeferredAcquireNextImage(context, false));
    }
