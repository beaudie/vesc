...
egl::Error WindowSurfaceVk::makeCurrent(const gl::Context *context)
{
    ...
    angle::Result result = makeCurrentImpl(displayVk);
    return angle::ToEGL(result, EGL_BAD_SURFACE);
}
...
angle::Result WindowSurfaceVk::makeCurrentImpl(DisplayVk *displayVk)
{
...
{
    return mSwapchainSize.width;
}

EGLint WindowSurfaceVk::getHeight() const
{
    return mSwapchainSize.height;
}
