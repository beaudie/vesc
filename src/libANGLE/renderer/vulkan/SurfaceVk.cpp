...
namespace
{
// false is the base behaviour...
constexpr bool kEnableAcquireHistory                = true;
constexpr bool kEnableAssertFenceSignaledInCleanup  = true;  // Might fire on Intel.
constexpr bool kDisablePresentHistoryCleanup        = true;
constexpr bool kDestroyFenceRecyclerNeedCheckStatus = true;
constexpr bool kDestroyFenceRecyclerNeedWait        = true;
constexpr bool kDestroyFenceRecyclerNeedReset       = true;
constexpr bool kDestroyFenceRecyclerBeforeSwapchain = false;  // This will fix crashing on Intel.
...
void DumpAcquireHistory(VkDevice device,
                        const std::vector<impl::AcquireHistoryItem> &acquireHistory)
{
                                 ...
                                 impl::ImageAcquireOperation *acquire)
{
    ...
    {
        WARN() << "fence(" << result->acquireFence.getHandle() << ").getStatus()...";
                                    ...
                                    vk::Recycler<vk::Semaphore> *semaphoreRecycler)
{
    if (fence.valid())
    {
        ...
        ASSERT(!kEnableAssertFenceSignaledInCleanup || status == VK_SUCCESS);
