                                               ...
                                               VkSwapchainKHR lastSwapchain)
{
    ...
    {
        ANGLE_TRY(renderer->finish(context, false));
    }
                                       ...
                                       bool *presentOutOfDate)
{
    ...
    Serial *swapSerial = &mSwapHistory[mCurrentSwapHistoryIndex];
    {
        ...
        ANGLE_TRY(
            renderer->finishToSerial(contextVk, contextVk->hasProtectedContent(), *swapSerial));
    }
    ...
    *swapSerial = renderer->getLastSubmittedQueueSerial();
    ...
    VkResult result = renderer->queuePresent(contextVk, contextVk->hasProtectedContent(),
