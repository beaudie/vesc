    ...
    : SurfaceVk(surfaceState), mWidth(width), mHeight(height)
{
    mColorRenderTarget.init(&mColorAttachment.image, &mColorAttachment.imageView,
                            &mColorAttachment.imageView, gl::TextureType::_2D, nullptr, 0, 0);
    mDepthStencilRenderTarget.init(
        &mDepthStencilAttachment.image, &mDepthStencilAttachment.imageView,
        &mDepthStencilAttachment.imageView, gl::TextureType::_2D, nullptr, 0, 0);
}
      ...
      mCurrentSwapHistoryIndex(0)
{
    ...
    mColorRenderTarget.init(&mColorImageMS, &mColorImageViewMS, &mColorImageViewMS,
                            gl::TextureType::_2D, nullptr, 0, 0);
    mDepthStencilRenderTarget.init(&mDepthStencilImage, &mDepthStencilImageView,
                                   &mDepthStencilImageView, gl::TextureType::_2D, nullptr, 0, 0);
}
