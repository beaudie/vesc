...
angle::Result WindowSurfaceVk::swapImpl(const gl::Context *context, EGLint *rects, EGLint n_rects)
{
...

    {
        ...
        ANGLE_TRY(nextSwapchainImage(vk::GetImpl(context), mCurrentSwapHistoryIndex));
    }
...
angle::Result WindowSurfaceVk::nextSwapchainImage(rx::ContextVk *contextVk,
                                                  uint32_t swapHistoryIndex)
{
