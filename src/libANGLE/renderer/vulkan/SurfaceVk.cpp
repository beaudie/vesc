                                                              ...
                                                              const vk::Format &vkFormat)
{
    ...
    ANGLE_TRY(image.stageClearIfEmulatedFormat(gl::ImageIndex::Make2D(0), vkFormat));
                                               ...
                                               VkSwapchainKHR oldSwapchain)
{
    ...
    for (uint32_t imageIndex = 0; imageIndex < imageCount; ++imageIndex)
    {
        ...
        // Clear the image if it has emulated channels.
        ANGLE_TRY(member.image.stageClearIfEmulatedFormat(gl::ImageIndex::Make2D(0), format));
    }
