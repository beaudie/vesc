                                               ...
                                               VkSwapchainKHR lastSwapchain)
{
    ...
    if (renderer->getFeatures().supportsSurfaceMaintenance1.enabled)
    {
        ...
        // b/368647924: vulkan loader causes extension to be listed when not actually supported.
        // kCompatiblePresentModesSize is above max count to catch this case and work around.
