                                               ...
                                               VkSwapchainKHR lastSwapchain)
{
    ...
    if (renderer->getFeatures().supportsSwapchainMaintenance1.enabled)
    {
        ...
        surfacePresentMode.sType = (VkStructureType)VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_EXT;
        ...
        compatibleModes.sType =
            (VkStructureType)VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_EXT;
        ...
        {
            compatibleModesInfo.sType =
                (VkStructureType)VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_EXT;
                                       ...
                                       bool *presentOutOfDate)
{
    ...
    if (contextVk->getFeatures().supportsSwapchainMaintenance1.enabled)
    {
                                    ...
                                    mCompatiblePresentModes.size()))
        {
            ...
            presentModeInfo.sType =
                (VkStructureType)VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_EXT;
