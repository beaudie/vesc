...
std::vector<VkDrmFormatModifierPropertiesEXT> DisplayVkLinux::GetDrmModifiers(const DisplayVk *displayVk,
                                          VkFormat vkFormat)
{
...
std::vector<uint32_t> DisplayVkLinux::GetDrmFormats(const RendererVk *rendererVk)
{
