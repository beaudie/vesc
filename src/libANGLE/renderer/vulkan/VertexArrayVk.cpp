...
#define ANGLE_VERTEX_DIRTY_BINDING_FUNC(INDEX)                                                  \
    ...
    {                                                                                           \
        const gl::VertexArray::DirtyBindingBits divisorStrideDirtyBits = (*bindingBits)[INDEX]; \
        divisorStrideDirtyBits &= gl::VertexArray::DirtyBindingBits{                            \
            gl::VertexArray::DIRTY_BINDING_DIVISOR, gl::VertexArray::DIRTY_BINDING_STRIDE};     \
                                                                                                \
        for (size_t attribIndex : bindings[INDEX].getBoundAttributesMask())                     \
        {                                                                                       \
            const bool bufferOnly = divisorStrideDirtyBits.none() &&                            \
                                    (*attribBits)[attribIndex].noneExcluding(                   \
