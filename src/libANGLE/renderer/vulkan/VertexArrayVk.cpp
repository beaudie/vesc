                                                   ...
                                                   const void *indices)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mTranslatedByteIndexData,
                                                           ...
                                                           vk::BufferHelper **indirectBufferVkOut)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mTranslatedByteIndirectData,
                                                   ...
                                                   BufferBindingDirty *bindingDirty)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mStreamedIndexData, amount,
                                                     vk::MemoryHostVisibility::Visible));
                                                    ...
                                                    bool compressed)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(dstBuffer, numVertices * dstFormatSize,
                                                     vk::MemoryHostVisibility::NonVisible));
                                                    ...
                                                    bool compressed)
{
    ...
    // Allocate buffer for results
    ANGLE_TRY(contextVk->allocateForVertexConversion(dstBufferHelper, numVertices * dstFormatSize,
                                                     vk::MemoryHostVisibility::Visible));
