                                                   ...
                                                   const void *indices)
{
    ...
    ANGLE_VK_TRY_ALLOC(contextVk, result,
                       mTranslatedByteIndexData.allocateForVertexConversion(
                           contextVk, sizeof(GLushort) * srcDataSize,
                           vk::MemoryHostVisibility::NonVisible, &result));
                                                           ...
                                                           vk::BufferHelper **indirectBufferVkOut)
{
    ...
    ANGLE_VK_TRY_ALLOC(contextVk, result,
                       mTranslatedByteIndirectData.allocateForVertexConversion(
                                                         ...
                                                         vk::BufferHelper **indirectBufferOut)
{
    ANGLE_VK_TRY_ALLOC(
        ...
        mLineLoopHelper.streamIndicesIndirect(
            ...
            indirectBufferOffset, &mCurrentElementArrayBuffer, indirectBufferOut, &result));
                                                        ...
                                                        vk::BufferHelper **indirectBufferOut)
{
    ...
    ANGLE_VK_TRY_ALLOC(contextVk, result,
                       mLineLoopHelper.streamArrayIndirect(
                           ...
                           &mCurrentElementArrayBuffer, indirectBufferOut, &result));
                                                   ...
                                                   BufferBindingDirty *bindingDirty)
{
    ...
    ANGLE_VK_TRY_ALLOC(contextVk, result,
                       mStreamedIndexData.allocateForVertexConversion(
                           contextVk, amount, vk::MemoryHostVisibility::Visible, &result));
                                                    ...
                                                    bool compressed)
{
    ...
    ANGLE_VK_TRY_ALLOC(
        contextVk, result,
        dstBuffer->allocateForVertexConversion(contextVk, numVertices * dstFormatSize,
                                               vk::MemoryHostVisibility::NonVisible, &result));
                                                    ...
                                                    bool compressed)
{
    ...
    ANGLE_VK_TRY_ALLOC(
        contextVk, result,
        dstBufferHelper->allocateForVertexConversion(contextVk, numVertices * dstFormatSize,
                                                     vk::MemoryHostVisibility::Visible, &result));
                                            ...
                                            uint32_t *indexCountOut)
{
    if (indexTypeOrInvalid != gl::DrawElementsType::InvalidEnum)
    {
        ...
        if (mDirtyLineLoopTranslation)
        {
            ...
            else
            {
                ...
                ANGLE_VK_TRY_ALLOC(
                    contextVk, result,
                    mLineLoopHelper.getIndexBufferForElementArrayBuffer(
                        contextVk, elementArrayBufferVk, indexTypeOrInvalid, vertexOrIndexCount,
                        offset, &mCurrentElementArrayBuffer, indexCountOut, &result));
            }
        }
        ...
        mLineLoopBufferFirstIndex != firstVertex || mLineLoopBufferLastIndex != lastVertex)
    {
        ANGLE_VK_TRY_ALLOC(
            contextVk, result,
            mLineLoopHelper.getIndexBufferForDrawArrays(contextVk, clampedVertexCount, firstVertex,
                                                        &mCurrentElementArrayBuffer, &result));
