                                                   ...
                                                   const void *indices)
{
    ...
    mTranslatedByteIndexData.releaseRetainedBuffers();
                                                   ...
                                                   const void *sourcePointer)
{
    ...
    mDynamicIndexData.releaseRetainedBuffers();
                                                    ...
                                                    ConversionBuffer *conversion)
{
    ...
    conversion->data.releaseRetainedBuffers();
                                                 ...
                                                 const void *indices)
{
    ...
    RendererVk *renderer = contextVk->getRenderer();
    mDynamicVertexData.releaseRetainedBuffers();
