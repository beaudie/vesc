                               ...
                               uint32_t replicateCount)
{
    ...
    ANGLE_TRY(dstBufferHelper->suballocateForVertexConversion(contextVk, bytesToAllocate,
                                                   ...
                                                   const void *indices)
{
    ...
    // Allocate buffer for results
    ANGLE_TRY(mTranslatedByteIndexData.suballocateForVertexConversion(
                                                           ...
                                                           vk::BufferHelper **indirectBufferVkOut)
{
    ...
    ANGLE_TRY(mTranslatedByteIndirectData.suballocateForVertexConversion(
                                                   ...
                                                   const void *sourcePointer)
{
    ...
    ANGLE_TRY(mStreamedIndexData.suballocateForVertexConversion(contextVk, amount,
                                                                vk::MemoryHostVisibility::Visible));
                                                    ...
                                                    bool compressed)
{
    ...
    ANGLE_TRY(dstBuffer->suballocateForVertexConversion(contextVk, numVertices * dstFormatSize,
