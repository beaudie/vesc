                                                   ...
                                                   const void *indices)
{
    ...
    ANGLE_TRY(AllocateVertexConversionBuffer(contextVk, &mTranslatedByteIndexData,
                                             sizeof(GLushort) * srcDataSize, true));
                                                           ...
                                                           vk::BufferHelper **indirectBufferVkOut)
{
    ...
    *indirectBufferVkOut = &mTranslatedByteIndirectData;
    ...
    return contextVk->getUtils().convertIndexIndirectBuffer(
                                                    ...
                                                    bool compressed)
{
    ...
    ANGLE_TRY(
        AllocateVertexConversionBuffer(contextVk, dstBuffer, numVertices * dstFormatSize, false));
