                                         ...
                                         size_t attribIndex)
{
    ...
    if (attrib.enabled)
    {
        ...
        if (bufferGL)
        {
            ...
            {
                // Preparation for mapping buffer.
    ...
    if (releaseConversion && mCurrentArrayBufferConversion[attribIndex].valid())
        mCurrentArrayBufferConversion[attribIndex].releaseAndReset(renderer);
