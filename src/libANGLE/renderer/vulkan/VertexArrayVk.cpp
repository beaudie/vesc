                                                   ...
                                                   const void *indices)
{
    ...
    vk::BufferHelper *src        = &bufferVk->getBuffer(&srcBufferOffset);
                                                           ...
                                                           VkDeviceSize *indirectBufferVkOffsetOut)
{
    ...
    ASSERT(mCurrentElementArrayBuffer ==
           &vk::GetImpl(getState().getElementArrayBuffer())->getBuffer(&elementArrayBufferOffset));
                                                    ...
                                                    bool compressed)
{
    ...
    VkDeviceSize srcBufferOffset      = 0;
    vk::BufferHelper *srcBufferHelper = &srcBuffer->getBuffer(&srcBufferOffset);
    ...
    params.srcOffset   = binding.getOffset() + relativeOffset + srcBufferOffset;
            ...
            case gl::VertexArray::DIRTY_BIT_ELEMENT_ARRAY_BUFFER_DATA:
            {
                ...
                if (bufferGL && bufferGL->getSize() > 0)
                {
                    ...
                    mCurrentElementArrayBuffer =
                        &bufferVk->getBuffer(&mCurrentElementArrayBufferOffset);
                }
                else
                {
                    mCurrentElementArrayBuffer       = nullptr;
