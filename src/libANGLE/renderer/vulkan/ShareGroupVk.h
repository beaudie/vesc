...
class ShareGroupVk : public ShareGroupImpl
{
  public:
    ...
    vk::RefCountedEventsGarbageRecycler *getRefCountedEventGarbageRecycler()
    {
        return &mRefCountedEventGarbageRecycler;
    }
    void cleanupRefCountedEventGarbage(vk::Renderer *renderer)
    {
        mRefCountedEventGarbageRecycler.cleanup(renderer);
    }
    void cleanupExcessiveRefCountedEventGarbage(vk::Renderer *renderer)
    {
        ...
        if (mRefCountedEventGarbageRecycler.getGarbageCount() > kExcessiveGarbageCountThreshold)
        {
            mRefCountedEventGarbageRecycler.cleanup(renderer);
        }
    }
  ...
  private:
    ...
    vk::RefCountedEventsGarbageRecycler mRefCountedEventGarbageRecycler;
};
}  // namespace rx
