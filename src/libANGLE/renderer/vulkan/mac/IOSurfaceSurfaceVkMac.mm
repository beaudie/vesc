                                               ...
                                               EGLint buffer)
{
    ...
    //     {
    //         return egl::EglContextLost() << "CGLTexImageIOSurface2D failed: " <<
...
// framebuffer.
class IOSurfaceFramebufferVk : public FramebufferVk
{
  public:
    IOSurfaceFramebufferVk(const gl::FramebufferState &data,
                           GLuint id,
                           GLuint textureId,
                           bool isDefault,
                           bool emulatedAlpha)
        : FramebufferVk(data, id, isDefault, emulatedAlpha), mTextureId(textureId)
    {}
                                                                 ...
                                                                 const gl::FramebufferState &state)
{
    ...
    // hasEmulatedAlphaChannel());
}

angle::Result IOSurfaceSurfaceVkMac::initializeAlphaChannel(const gl::Context *context,
                                                            GLuint texture)
{
...
bool IOSurfaceSurfaceVkMac::hasEmulatedAlphaChannel() const
{
    const auto &format = kIOSurfaceFormats[mFormatIndex];
