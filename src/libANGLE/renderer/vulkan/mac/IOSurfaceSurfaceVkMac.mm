                                               ...
                                               EGLint buffer)
{
    ...
    angle::Result result = mColorAttachment.image.stageSubresourceUpdate(
        ...
        gl::Extents(IOSurfaceGetWidthOfPlane(mIOSurface, mPlane) & 0xFFFFFFFF,
                    pixelUnpack.imageHeight, 1),
        gl::Offset(),
        gl::GetSizedInternalFormatInfo(kIOSurfaceFormats[mFormatIndex].nativeSizedInternalFormat),
        pixelUnpack, nullptr, kIOSurfaceFormats[mFormatIndex].type,
