...
angle::Result IOSurfaceSurfaceVkMac::initializeImpl(DisplayVk *displayVk)
{
    ...
    ANGLE_TRY(mColorAttachment.initializeWithExternalMemory(
        ...
        renderer->getFormat(kIOSurfaceFormats[mFormatIndex].internalFormat), samples, mIOSurface));
                                               ...
                                               EGLint buffer)
{
    ...
    // textureVk->setImageHelper(contextVk, &image, gl::TextureType::_2D, format, 0, 0,
    // image.getBaseLevel(), false);
