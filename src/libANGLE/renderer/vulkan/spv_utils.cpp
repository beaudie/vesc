                              ...
                              ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    variableInfoMapOut->setActiveStages(uniformBindingInfo.frontShaderType, variableType, varId,
...
TransformationState SpirvTransformer::transformTypePointer(const uint32_t *instruction)
{
    ...
    return mInactiveVaryingRemover.transformTypePointer(id, storageClass, typeId, mSpirvBlobOut);
}
                           ...
                           ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    for (const gl::ShaderType shaderType : programExecutable.getLinkedShaderStages())
    {
        ...
        SpvAssignLocations(options, programExecutable, resources.varyingPacking, shaderType,
                           frontShaderType, isXfbStage, programInterfaceInfo, variableInfoMapOut);
