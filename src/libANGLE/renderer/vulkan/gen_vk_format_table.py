...
{space}    {texture_template}
{space}    {buffer_template}
{space}    break;
"""

texture_basic_template = """{space}    textureFormatID = angle::Format::ID::{texture};
{space}    vkTextureFormat = {vk_texture_format};
{space}    textureInitializerFunction = {texture_initializer};"""

texture_fallback_template = """{space}    initTextureFallback(physicalDevice,
{space}                        angle::Format::ID::{texture},
{space}                        {vk_texture_format},
{space}                        {texture_initializer},
{space}                        angle::Format::ID::{texture_fallback},
{space}                        {vk_texture_format_fallback},
{space}                        {texture_initializer_fallback});"""

buffer_basic_template = """{space}    bufferFormatID = angle::Format::ID::{buffer};
{space}    vkBufferFormat = {vk_buffer_format};"""

buffer_fallback_template = """{space}    initBufferFallback(physicalDevice,
{space}                       angle::Format::ID::{buffer},
{space}                       vk_buffer_format},
{space}                       angle::Format::ID::{buffer_fallback},
{space}                       {vk_buffer_format_fallback});"""
