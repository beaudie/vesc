...
class CBHRingAllocatorHelper
{
  public:
    CBHRingAllocatorHelper() : mAllocator(nullptr), mAllocSharedCP(nullptr) {}
    void resetAllocator();
...
class CommandRingAllocatorHelper final : angle::RingBufferAllocateListener
{
  public:
    CommandRingAllocatorHelper()
