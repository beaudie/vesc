                                 ...
                                 vk::RenderPassDesc *renderPassDesc)
{
    ...
    mImage->changeLayout(VK_IMAGE_ASPECT_COLOR_BIT, vk::ImageHelper::Layout::ColorAttachment,
                         commandBuffer);
                                        ...
                                        vk::RenderPassDesc *renderPassDesc)
{
    ...
    mImage->changeLayout(aspectFlags, vk::ImageHelper::Layout::DepthStencilAttachment,
                         commandBuffer);
