...
void RenderTargetVk::init(const vk::ImageHelperSource *source,
                                 ...
                                 vk::PackedAttachmentIndex packedAttachmentIndex)
{
    ...
    contextVk->onColorDraw(mLevelIndexGL, mLayerIndex, framebufferLayerCount, mSource, mImage,
...
void RenderTargetVk::onDepthStencilDraw(ContextVk *contextVk, uint32_t framebufferLayerCount)
{
    ...
    contextVk->onDepthStencilDraw(mLevelIndexGL, mLayerIndex, framebufferLayerCount, mSource,
