...
#if defined(__LP64__)
constexpr char kAndroidSystemPath[] = "/system/lib64/";
#else
constexpr char kAndroidSystemPath[] = "/system/lib/";
#endif
...
AHBFunctions::AHBFunctions()
{
    ...
    if (!valid())
    {
        ...
        std::string fullPath   = kAndroidSystemPath + kNativeWindowLibraryName;
