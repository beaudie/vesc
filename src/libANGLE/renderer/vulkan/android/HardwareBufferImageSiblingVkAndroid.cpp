...
angle::Result HardwareBufferImageSiblingVkAndroid::initImpl(DisplayVk *displayVk)
{
    ...
    vk::YcbcrConversionDesc ycbcrConversionDesc;
    if (bufferFormatProperties.format == VK_FORMAT_UNDEFINED)
    {
        ...
        ycbcrConversionDesc.update(renderer, bufferFormatProperties.externalFormat,
    ...
    ANGLE_TRY(mImage->initExternalMemory(
        ...
        &ycbcrConversionDesc, 1, &dedicatedAllocInfoPtr, VK_QUEUE_FAMILY_FOREIGN_EXT, flags));
