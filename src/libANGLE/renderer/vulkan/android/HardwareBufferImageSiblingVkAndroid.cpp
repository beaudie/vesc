...
angle::Result HardwareBufferImageSiblingVkAndroid::initImpl(DisplayVk *displayVk)
{
    ...
    __android_log_print(ANDROID_LOG_ERROR, "ANGLE",
                        "VkAndroidHardwareBufferPropertiesANDROID: size: %lu, memoryTypeBits: 0x%X",
                        bufferProperties.allocationSize, bufferProperties.memoryTypeBits);

    __android_log_print(ANDROID_LOG_ERROR, "ANGLE",
                        "VkAndroidHardwareBufferFormatPropertiesANDROID: format: %u, "
                        "externalFormat: %lu, formatFeatures: 0x%X",
                        bufferFormatProperties.format, bufferFormatProperties.externalFormat,
    ...
    __android_log_print(
        ...
        "HardwareBufferImageSiblingVkAndroid: vk texture format: GLenum: 0x%X vkFormat: %u",
