...
angle::Result HardwareBufferImageSiblingVkAndroid::initImpl(DisplayVk *displayVk)
{
    ...
    imageListFormats[kBaseFormatIndex] = vkFormat.actualImageVkFormat;
    imageListFormats[kAdditionalFormatIndex] =
        vkFormat.actualImageFormat().isSRGB ? vk::ConvertToLinear(vkFormat.actualImageVkFormat)
                                            : vk::ConvertToSRGB(vkFormat.actualImageVkFormat);
    ...
    if (renderer->getFeatures().supportsImageFormatList.enabled)
    {
        ...
        formatListInfo.pViewFormats    = imageListFormats;
