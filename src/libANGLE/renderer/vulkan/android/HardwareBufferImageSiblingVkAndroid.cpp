...
angle::Result HardwareBufferImageSiblingVkAndroid::initImpl(DisplayVk *displayVk)
{
    ...
    VkFormat imageFormat                                 = vkFormat.vkImageFormat;
    VkFormat imageListFormat                             = vkFormat.actualImageFormat().isSRGB
                                   ? vk::ConvertToLinear(imageFormat)
    ...
    externalFormat.pNext                   = additionalCreateInfo;
