                                            ...
                                            GLsizei srcDepth)
{
                                        ...
                                        destVkFormat, destTilingMode))
    {
        ...
        srcImage->retain(&contextVk->getResourceUseList(), contextVk->getSharedResourceUsePool());
        dstImage->retain(&contextVk->getResourceUseList(), contextVk->getSharedResourceUsePool());
