                                                          ...
                                                          BufferHelper **bufferOut)
{
    ...
    ANGLE_TRY(AllocateVertexConversionBuffer(contextVk, &mDynamicIndexBuffer, allocateBytes, true));
                                                                  ...
                                                                  uint32_t *indexCountOut)
{
    ...
    *indexCountOut = indexCount + 1;
    ...
    ANGLE_TRY(
        AllocateVertexConversionBuffer(contextVk, &mDynamicIndexBuffer, allocateBytes, false));
                                            ...
                                            uint32_t *indexCountOut)
{
    ...
    *indexCountOut = numOutIndices;
    ...
    ANGLE_TRY(AllocateVertexConversionBuffer(contextVk, &mDynamicIndexBuffer,
                                             unitSize * numOutIndices, true));
                                                    ...
                                                    BufferHelper **indirectBufferOut)
{
    ...
    ANGLE_TRY(AllocateVertexConversionBuffer(contextVk, &mDynamicIndirectBuffer,
                                             sizeof(VkDrawIndexedIndirectCommand), false));
...
angle::Result BufferHelper::initStagingBuffer(ContextVk *contextVk, size_t size)
{
    RendererVk *renderer = contextVk->getRenderer();
    size_t alignment     = renderer->getStagingBufferAlignment();
    return initSubAllocation(contextVk, renderer->getNonCoherentStagingBufferMemoryTypeIndex(),
                             size, alignment);
}
    ...
    for (std::vector<SubresourceUpdate> &levelUpdates : mSubresourceUpdates)
    {
        for (SubresourceUpdate &update : levelUpdates)
        {
                ...
                update.data.buffer.formatID == srcFormatID)
            {
                ...
                ANGLE_TRY(dstBuffer->initStagingBuffer(contextVk, dstBufferSize));
                                                 ...
                                                 StagingBufferOffsetArray *bufferOffsetsOut)
{
    ...
    ANGLE_TRY(dstBuffer->initStagingBuffer(contextVk, bufferSize));
                                      ...
                                      void *pixels)
{
    ...
    ANGLE_TRY(bufferHelper->initStagingBuffer(contextVk, allocationSize));
