...
{
    ASSERT(this != &other);
    other.mImageType               = VK_IMAGE_TYPE_2D;
    other.mExtents                 = {};
    other.mFormat                  = nullptr;
    other.mSamples                 = 1;
    other.mSerial                  = rx::kZeroSerial;
    other.mCurrentLayout           = ImageLayout::Undefined;
    other.mCurrentQueueFamilyIndex = std::numeric_limits<uint32_t>::max();
    other.mBaseLevel               = 0;
    other.mMaxLevel                = 0;
    other.mLayerCount              = 0;
    other.mLevelCount              = 0;
...
void ImageHelper::stageRobustResourceClearWithFormat(const gl::ImageIndex &index,
...
angle::Result ImageHelper::flushSingleSubresourceStagedUpdates(ContextVk *contextVk,
                                                               ...
                                                               uint32_t layer,
                                                               CommandBuffer *commandBuffer,
                                                               ClearValueReference *deferredClear)
{
    ...
    if (deferredClear)
    {
        ...
        if (foundClear.valid())
        {
            ...
            deferredClear->set(update.aspectFlags, update.value);
