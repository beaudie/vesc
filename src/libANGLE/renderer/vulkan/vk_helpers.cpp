...
angle::Result DescriptorPoolHelper::getOrAllocateDescriptorSet(
    ContextVk *contextVk,
    ...
    DescriptorCacheResult *cacheResultOut)
{
    ...
    bindingOut->set(mDescriptorPools[mCurrentPoolIndex]);
    ANGLE_TRY(mDescriptorPools[mCurrentPoolIndex]->get().getOrAllocateDescriptorSet(
        contextVk, desc, descriptorSetLayout, descriptorSetOut, cacheResultOut));
    if (*cacheResultOut == DescriptorCacheResult::NewAllocation)
    {
