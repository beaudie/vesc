                                              ...
                                              bool isDynamicUsage)
{
    ...
    vk::BufferPool *pool = contextVk->getDefaultBufferPool(size, memoryTypeIndex, isDynamicUsage);
                                                        ...
                                                        MemoryHostVisibility hostVisibility)
{
    ...
    return initSuballocation(contextVk, memoryTypeIndex, sizeToAllocate, alignment, false);
}
                                                 ...
                                                 uint8_t **dataPtr)
{
    ...
    ANGLE_TRY(
        initSuballocation(contextVk, memoryTypeIndex, allocationSize, stagingAlignment, false));
