                                                       ...
                                                       uint32_t layerCount)
{
    ...
    for (size_t index = 0; index < levelUpdates->size();)
    {
        ...
        if (update->isLayerRangeExactMatch(layerIndex, layerCount))
        {
                                                         ...
                                                         uint32_t layerCount)
{
    ...
    for (size_t index = 0; index < levelUpdates->size(); ++index)
    {
        ...
        if (update->updateSource == UpdateSource::ClearAfterInvalidate &&
            update->isLayerRangeExactMatch(layerIndex, layerCount))
        {
                                                               ...
                                                               uint32_t deferredClearIndex)
{
    ...
    if (deferredClears)
    {
        ...
        for (size_t updateIndex = 0; updateIndex < levelUpdates->size(); ++updateIndex)
        {
            ...
            if (update.isWithinLayerRange(layer, layerCount))
            {
...
bool ImageHelper::SubresourceUpdate::isLayerRangeExactMatch(uint32_t layerIndex,
                                                            uint32_t layerCount) const
{
    uint32_t updateBaseLayer, updateLayerCount;
...
bool ImageHelper::SubresourceUpdate::isWithinLayerRange(uint32_t layerIndex,
                                                        uint32_t layerCount) const
{
    uint32_t updateBaseLayer, updateLayerCount;
    getDestSubresource(gl::ImageIndex::kEntireLevel, &updateBaseLayer, &updateLayerCount);
