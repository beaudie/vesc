                                              ...
                                              CommandBuffer *commandBuffer)
{
    ...
    for (SubresourceUpdate &update : mSubresourceUpdates)
    {
        ...
        else if (update.updateSource == UpdateSource::Buffer)
        {
            ...
            currentBuffer->onResourceUse(&contextVk->getResourceUseList());
                                      ...
                                      DynamicBuffer *stagingBuffer)
{
    ...
    if (isMultisampled)
    {
        ...
        resolvedImage.get().onResourceUse(&contextVk->getResourceUseList());
...
{
    onResourceUse(&contextVk->getResourceUseList());
