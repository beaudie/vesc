...
constexpr angle::PackedEnumMap<ImageLayout, ImageMemoryBarrierData> kImageMemoryBarrierData = {
    ...
    {
        ImageLayout::VertexShaderDepthStencilReadOnly,
        {
    ...
    {
        ImageLayout::GeometryShaderDepthStencilReadOnly,
        {
            VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL,
    ...
    {
        ImageLayout::FragmentShaderDepthStencilReadOnly,
        {
            VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL,
    ...
    {
        ImageLayout::ComputeShaderDepthStencilReadOnly,
        {
            VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL,
            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
            VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
...
void CommandBufferHelper::addCommandDiagnostics(ContextVk *contextVk)
{
    ...
    if (mIsRenderPassCommandBuffer)
    {
        ...
        size_t depthStencilAttachmentCount =
            mRenderPassDesc.getDepthStencilLayout() == RenderPassDepthStencilLayout::Unused ? 0 : 1;
