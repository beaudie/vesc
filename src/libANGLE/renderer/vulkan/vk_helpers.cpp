...
{
  const static ImageMemoryBarrierData kImageMemoryBarrierData[static_cast<uint32_t>(ImageLayout::PrebuildLayoutCount)] =
  {
      ...
      mSubresourceUpdates(std::move(other.mSubresourceUpdates))
{
    ...
    other.mBarrierData = ImageMemoryBarrierData::getPrebuildBarrierData(other.mCurrentLayout);
}
