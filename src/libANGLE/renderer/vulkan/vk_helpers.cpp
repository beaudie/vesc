...
Error DynamicBuffer::allocate(ContextVk *context,
                              size_t sizeInBytes,
                              uint8_t **ptrOut,
                              VkBuffer *handleOut,
                              uint32_t *offsetOut,
...
// LineLoopHandler implementation.
LineLoopHandler::LineLoopHandler()
    : mObserverBinding(this, 0u),
      mDynamicLineLoopIndicesData(kLineLoopDynamicBufferUsage, kLineLoopDynamicBufferMinSize),
...
void LineLoopHandler::bindIndexBuffer(VkIndexType indexType, CommandBuffer **commandBuffer)
{
                                                                   ...
                                                                   int count)
{
    ...
    bufferVk->onReadResource(getCurrentWritingNode(currentSerial), currentSerial);
...
CommandGraphResource *LineLoopHandler::getLineLoopBufferResource()
{
    return this;
}
