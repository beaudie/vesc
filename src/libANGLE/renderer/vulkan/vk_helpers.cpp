                                            ...
                                            GLsizei srcDepth)
{
                                        ...
                                        destTilingMode))
    {
        ...
        VkImageAspectFlags srcAspectFlags = srcImage->getAspectFlags();
        VkImageAspectFlags dstAspectFlags = dstImage->getAspectFlags();
        ...
        access.onImageTransferRead(srcAspectFlags, srcImage);
        access.onImageTransferWrite(dstLevelGL, 1, region.dstSubresource.baseArrayLayer,
                                    region.dstSubresource.layerCount, dstAspectFlags, dstImage);
