                                                    ...
                                                    VkDeviceSize size)
{
    ...
    if (!isHostVisible() && (usage & VK_BUFFER_USAGE_TRANSFER_DST_BIT) != 0)
    {
        ...
        ANGLE_TRY(
            renderer->getCommandBufferOneOff(context, CommandContent::Unprotected, &commandBuffer));
                                                   ...
                                                   VkDeviceSize size)
{
    ...
    PrimaryCommandBuffer commandBuffer;
    auto commandContext = ConvertProtectedBitToCommandContent(hasProtectedContent);
    ANGLE_TRY(renderer->getCommandBufferOneOff(context, commandContext, &commandBuffer));
    ...
    QueueSerial queueSerial;
    ANGLE_TRY(renderer->queueSubmitOneOff(context, std::move(commandBuffer), commandContext,
                                          egl::ContextPriority::Medium, nullptr, 0, nullptr,
                                          vk::SubmitPolicy::AllowDeferred, &queueSerial));
                                                    ...
                                                    vk::BufferHelper *bufferHelper)
{
    ...
    ANGLE_TRY(rendererVk->getCommandBufferOneOff(displayVk, CommandContent::Unprotected,
                                                    ...
                                                    vk::BufferHelper *bufferHelper)
{
    ...
    PrimaryCommandBuffer commandBuffer;
    ANGLE_TRY(
        rendererVk->getCommandBufferOneOff(displayVk, CommandContent::Unprotected, &commandBuffer));
