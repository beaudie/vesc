...
void CommandBufferHelper::bufferWrite(ContextVk *contextVk,
                                      ...
                                      BufferHelper *buffer)
{
    buffer->retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
...
void CommandBufferHelper::imageWrite(ContextVk *contextVk,
                                     ...
                                     ImageHelper *image)
{
    image->retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
                                          ...
                                          PackedAttachmentIndex packedAttachmentIndex)
{
    ...
    image->retain(resourceUseList, vk::ResourceUseType::ReadWrite);
    if (!usesImageInRenderPass(*image))
    {
    ...
    if (resolveImage)
    {
        resolveImage->retain(resourceUseList, vk::ResourceUseType::ReadWrite);
                                                 ...
                                                 VkDescriptorSet *descriptorSetsOut)
{
    ...
    retain(&contextVk->getResourceUseList(), vk::ResourceUseType::Read);
                                            ...
                                            GLsizei srcDepth)
{
                                        ...
                                        destVkFormat, destTilingMode))
    {
        ...
        dstImage->retain(&contextVk->getResourceUseList(), vk::ResourceUseType::ReadWrite);
