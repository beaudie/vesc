                                              ...
                                              const gl::CubeFaceArray<gl::TexLevelMask> &skipLevels)
{
    ...
    // TODO: Handle the clear emulated channels first, and count the other updates.
    // The CEC updates are supposed to come first and should not have duplicates
    // (verifyEmulatedClearsAreBeforeOtherUpdates()).
         ...
         ++updateMipLevelGL)
    {
        ...
        for (SubresourceUpdate &update : *levelUpdates)
        {
            ...
            else if (update.updateSource == UpdateSource::Buffer)
            {
                ...
                {
                    access.onBufferComputeShaderRead(currentBuffer);
                }
                else
                {
            ...
            else if (update.updateSource == UpdateSource::Image)
            {
                ...
                access.onImageTransferRead(aspectFlags, &update.refCounted.image->get());
            }
