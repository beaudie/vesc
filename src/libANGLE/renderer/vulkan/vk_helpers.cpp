...
ImageHelper::ImageHelper(ImageHelper &&other)
    : CommandGraphResource(CommandGraphResourceType::Image),
      ...
      mHighestLevel(other.mHighestLevel),
...
uint32_t ImageHelper::getMaxLevel()
{
    return mMaxLevel;
}

void ImageHelper::setMaxLevel(uint32_t maxLevel)
{
    mMaxLevel = maxLevel;
}

uint32_t ImageHelper::getHighestLevel()
{
    return mHighestLevel;
}

void ImageHelper::setHighestLevel(uint32_t level)
{
    mHighestLevel = level;
}
