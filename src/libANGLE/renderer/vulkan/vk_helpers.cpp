...
angle::Result ImageHelper::stageResourceClearWithFormatImpl(ContextVk *contextVk,
                                                            const gl::ImageIndex &index,
                                                            const gl::Extents &glExtents,
                                                              ...
                                                              const angle::Format &imageFormat)
{
    ...
    return stageResourceClearWithFormatImpl(contextVk, index, glExtents, intendedFormat,
                                            imageFormat, clearValue);
}
