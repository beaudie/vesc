                                     ...
                                     ImageHelper *image)
{
    ...
    if (mIsRenderPassCommandBuffer)
    {
        // As noted in the header we don't support simultaneous reads for Images. We must
        // handle different read Image layouts. Unlike Images, Buffers do not have layouts.
        if (aliasingMode == AliasingMode::Disallowed)
        {
