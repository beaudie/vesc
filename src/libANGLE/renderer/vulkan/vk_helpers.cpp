                                      ...
                                      bool *newBufferAllocatedOut)
{
    ...
    if (!checkedNextWriteOffset.IsValid() || checkedNextWriteOffset.ValueOrDie() >= mSize)
    {
        ...
        ANGLE_TRY(
            AllocateBufferMemory(context, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT, &actualMemoryPropertyFlags, &mBuffer, &mMemory));
		mHostCoherent = (VK_MEMORY_PROPERTY_HOST_COHERENT_BIT == (VK_MEMORY_PROPERTY_HOST_COHERENT_BIT & actualMemoryPropertyFlags));
