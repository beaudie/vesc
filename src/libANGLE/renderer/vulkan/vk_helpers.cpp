...
// static
bool ImageHelper::CanCopyWithTransfer(RendererVk *renderer,
                                      ...
                                      VkImageTiling destTilingMode)
{
    ...
    // size and are compatible, but for now, let's just support same-size copies with transfer.
                                            ...
                                            GLsizei srcDepth)
{
    ...
    if (CanCopyWithTransfer(contextVk->getRenderer(), sourceVkFormat, srcTilingMode, destVkFormat,
                            destTilingMode))
    {
