...
{
    return transition.srcStageMask & context->getRenderer()->getSupportedVulkanPipelineStageFlags();
}

VkPipelineStageFlags GetImageLayoutDstStageMask(Context *context,
                                                const ImageMemoryBarrierData &transition)
{
    return transition.dstStageMask & context->getRenderer()->getSupportedVulkanPipelineStageFlags();
}
