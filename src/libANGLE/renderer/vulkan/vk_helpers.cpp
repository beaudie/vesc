                                     ...
                                     BufferHelper *buffer)
{
    ...
    if (buffer->readBarrier(readAccessType, stageBits, &mPipelineBarriers[readStage]))
    {
                                      ...
                                      BufferHelper *buffer)
{
    ...
    if (buffer->writeBarrier(writeAccessType, stageBits, &mPipelineBarriers[writeStage]))
    {
...
void CommandBufferHelper::addCommandDiagnostics(ContextVk *contextVk)
{
    ...
    if (mIsRenderPassCommandBuffer)
    {
        ...
        size_t depthStencilAttachmentCount =
            mRenderPassDesc.getDepthStencilAccess() == ResourceAccess::Unused ? 0 : 1;
...
bool BufferHelper::readBarrier(VkAccessFlags readAccessType,
...
bool BufferHelper::writeBarrier(VkAccessFlags writeAccessType,
                                              ...
                                              CommandBuffer *commandBuffer)
{
    ...
    for (SubresourceUpdate &update : mSubresourceUpdates)
    {
        ...
        if (updateLayerCount >= kMaxParallelSubresourceUpload)
        {
            ...
            writeBarrier(aspectFlags, ImageLayout::TransferDst, commandBuffer);
