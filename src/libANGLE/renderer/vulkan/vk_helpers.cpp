                               ...
                               CommandBuffer *commandBuffer)
{
    ...
    changeLayoutAndQueue(aspectMask, newLayout, mCurrentQueueFamilyIndex, commandBuffer);
}
...
void ImageHelper::changeLayoutAndQueue(VkImageAspectFlags aspectMask,
                                       ...
                                       CommandBuffer *commandBuffer)
{
    if (!isLayoutChangeNecessary(newLayout) && !isQueueChangeNeccesary(newQueueFamilyIndex))
    {
        return;
    }
