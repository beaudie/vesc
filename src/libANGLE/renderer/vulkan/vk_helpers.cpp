                                          ...
                                          const DescriptorSetLayout &descriptorSetLayout)
{
        ...
        mEmptyDescriptorSet == VK_NULL_HANDLE)
    {
        ...
        mDescriptorPools[kEmptyDescriptorSetPoolIndex]->get().allocateDescriptorSet(
...
angle::Result DynamicDescriptorPool::allocateNewPool(Context *context)
{
    ...
    // the pool that mEmptyDescriptorSet gets allocated from.
    ...
    for (size_t poolIndex = 0; poolIndex < mDescriptorPools.size();)
    {
        ...
        if (poolIndex != kEmptyDescriptorSetPoolIndex &&
            !mDescriptorPools[poolIndex]->isReferenced() &&
