...
// FIXME: CHANGE FROM size_t TO uint32_t
void CommandBufferHelper::OnDepthStencilAccess(ResourceAccess access,
                                               size_t *cmdCountInvalidated,
                                               size_t *cmdCountDisabled)
{
    if (access == vk::ResourceAccess::Write)
    {
        // Drawing to this attachment is being enabled.
        ...
        ASSERT(*cmdCountDisabled != kEnabledCmdCount);
