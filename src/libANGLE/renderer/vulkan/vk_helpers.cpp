                                                          ...
                                                          BufferHelper **bufferOut)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mDynamicIndexBuffer, allocateBytes,
                                            ...
                                            uint32_t *indexCountOut)
{
    ...
    *indexCountOut = numOutIndices;
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mDynamicIndexBuffer, unitSize * numOutIndices,
                                                     MemoryHostVisibility::Visible));
                                                    ...
                                                    BufferHelper **indirectBufferOut)
{
    ...
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mDynamicIndexBuffer, allocateBytes,
                                                     MemoryHostVisibility::Visible));
    ANGLE_TRY(contextVk->allocateForVertexConversion(&mDynamicIndirectBuffer,
...
void ImageHelper::releaseImage(RendererVk *renderer)
{
    ...
    renderer->collectImageGarbage(mUse, mImage, mAllocationSize);
    renderer->collectGarbage(mUse, &mDeviceMemory);
    mUse.reset();
    mImageSerial = kInvalidImageSerial;
    setEntireContentUndefined();
}
                                 ...
                                 VkDeviceSize *sizeOut)
{
    ...
    if (renderer->getFeatures().useVmaForImageSuballocation.enabled)
    {
        ...
        VK_RESULT_TRY(renderer->getImageMemorySuballocator().allocateAndBindMemory(
            ...
            mMemoryAllocationType, &mVmaAllocation, flagsOut, &mMemoryTypeIndex, &mAllocationSize));
    }
    else
    {
...
angle::Result ImageHelper::initMemoryWithNonZero(Context *context,
                                                 bool hasProtectedContent,
                                                 const MemoryProperties &memoryProperties,
                                                 VkMemoryPropertyFlags flags,
                                                 MemoryAllocationType allocationType)
{
    ...
    ANGLE_VK_TRY(context, initMemory(context, memoryProperties, flags, 0, allocationType,
                                       ...
                                       uint32_t layerCount)
{
    ...
    ANGLE_TRY(initMemoryWithNonZero(context, hasProtectedContent, memoryProperties,
                                    memoryPropertyFlags, vk::MemoryAllocationType::StagingImage));
    return angle::Result::Continue;
}
    ...
    bool isRobustResourceInitEnabled)
{
    ...
    ANGLE_TRY(initMemoryWithNonZero(
                                                      ...
                                                      const GLuint inputSkipBytes)
{
    ...
    ANGLE_TRY(contextVk->allocateForCopyImage(currentBuffer, allocationSize,
    ...
    for (std::vector<SubresourceUpdate> &levelUpdates : mSubresourceUpdates)
    {
        for (SubresourceUpdate &update : levelUpdates)
        {
                ...
                update.data.buffer.formatID == srcFormatID)
            {
                ...
                ANGLE_TRY(contextVk->allocateForCopyImage(dstBuffer, dstBufferSize,
                                                        ...
                                                        const VkClearValue &clearValue)
{
    ...
    if (imageFormat.isBlock)
    {
        ...
        uint8_t *stagingPointer;
        VkDeviceSize stagingOffset;
        ANGLE_TRY(contextVk->allocateForCopyImage(currentBuffer, totalSize,
                                                 ...
                                                 uint8_t **outDataPtr)
{
    ...
    ANGLE_TRY(contextVk->allocateForCopyImage(dstBuffer, bufferSize, MemoryCoherency::Coherent,
                                          ...
                                          void *pixels)
{
    ...
    ANGLE_TRY(contextVk->allocateForCopyImage(stagingBuffer, allocationSize,
