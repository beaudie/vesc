                                        ...
                                        bool hasProtectedContent)
{
    ...
    {
        VkFormatFeatureFlags kChromaSubSampleFeatureBits;
        if (IsYUVExternalFormat(actualFormatID))
        {
            ...
            kChromaSubSampleFeatureBits =
                rendererVk->mExternalFormatTable.getExternalFormatInfo(actualFormatID)
                    .formatFeatures;
        }
        else
        {
            ...
            kChromaSubSampleFeatureBits = VK_FORMAT_FEATURE_COSITED_CHROMA_SAMPLES_BIT |
