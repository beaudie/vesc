                                 ...
                                 VkMemoryPropertyFlags memoryPropertyFlags)
{
    ...
    if (renderer->getFeatures().allocateNonZeroMemory.enabled)
    {
        ...
        // Only works if the buffer is created with transfer bits.
...
angle::Result BufferHelper::initializeMemory(Context *context, VkDeviceSize size)
{
    ...
    Serial serial;
    ANGLE_TRY(renderer->queueSubmitOneOff(context, std::move(commandBuffer), &serial));
