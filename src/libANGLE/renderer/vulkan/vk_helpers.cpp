...
void CommandBufferHelperCommon::setEventsImpl(Context *context, CommandBufferT *commandBuffer)
{
                                                                ...
                                                                ImageHelper *image2)
{
    ...
    setEventsImpl(context, &mCommandBuffer);
}
