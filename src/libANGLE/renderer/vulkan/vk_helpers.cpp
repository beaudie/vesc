                                                      ...
                                                      const GLuint inputSkipBytes)
{
    ...
    DynamicBuffer *dynamicBuffer = stagingStorage ? stagingStorage : &mStagingBuffer;
    ANGLE_TRY(dynamicBuffer->allocate(contextVk, allocationSize, &stagingPointer, &bufferHandle,
                                      &stagingOffset, nullptr));
    BufferHelper *currentBuffer = dynamicBuffer->getCurrentBuffer();
                                                  ...
                                                  const Format &vkFormat)
{
    ...
    ANGLE_TRY(stageSubresourceUpdateImpl(contextVk, index, glExtents, offset, formatInfo, unpack,
                                         stagingStorage, type, pixels, vkFormat, inputRowPitch,
