                                 ...
                                 VkMemoryPropertyFlags memoryPropertyFlags)
{
    ...
    if (createInfo->size > BufferMemorySubAllocator::kMaxSizeToUseBufferMemorySubAllocator)
    {
    ...
    else
    {
        ...
        ANGLE_VK_TRY(contextVk,
                     bufferMemorySubAllocator.createBuffer(
                         *createInfo, requiredFlags, preferredFlags, persistentlyMapped,
                         &memoryTypeIndex, &mBuffer, mMemory.getAllocationObject(), &sizeOut));
