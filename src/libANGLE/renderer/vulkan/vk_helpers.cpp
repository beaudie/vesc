                                                            ...
                                                            const VkClearValue &clearValue)
{
    if (aspectFlags & VK_IMAGE_ASPECT_DEPTH_BIT)
    {
        ...
        mClearValues.store(kClearValueDepthIndex, VK_IMAGE_ASPECT_DEPTH_BIT, clearValue);
    }

    if (aspectFlags & VK_IMAGE_ASPECT_STENCIL_BIT)
    {
        mAttachmentOps.setClearStencilOp(mDepthStencilAttachmentIndex);
        mClearValues.store(kClearValueStencilIndex, VK_IMAGE_ASPECT_STENCIL_BIT, clearValue);
    }
}
