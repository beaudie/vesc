                                     ...
                                     OutsideRenderPassCommandBuffer *commandBuffer)
{
    ...
    changeQueueFamily(rendererDeviceQueueIndex.familyIndex(), externalQueueIndex.familyIndex(),
                      commandBuffer);
                                    ...
                                    OutsideRenderPassCommandBuffer *commandBuffer)
{
    ...
    // GL!
    if (mCurrentDeviceQueueIndex != externalQueueIndex || mCurrentLayout != desiredLayout)
    {
