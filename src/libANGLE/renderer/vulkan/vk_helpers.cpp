                                    ...
                                    ImageHelper *image)
{
    ...
    if (mIsRenderPassCommandBuffer)
    {
        ...
        {
            // If the image also used as depth stencil attachment, and we have already inserted a
            // layout transition, we should not do layout transition at endRenderPass time. You can
            // only enter here when there is a depth feedback loop.
            mDepthStencilImage = nullptr;
