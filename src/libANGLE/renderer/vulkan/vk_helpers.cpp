...
YcbcrConversionDesc ImageHelper::guessConversionDesc(Context *context,
                                ...
                                bool hasProtectedContent)
{
    return initExternal(context, textureType, extents, format.getIntendedFormatID(),
                        ...
                        guessConversionDesc(context, format.getActualRenderableImageFormatID(),
                                        ...
                                        YcbcrConversionDesc conversionDesc)
{
    ...
    ASSERT(mYcbcrConversionDesc.valid() || !actualFormat.isYUV);
