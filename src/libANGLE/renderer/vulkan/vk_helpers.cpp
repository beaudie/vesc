                                      ...
                                      bool *newBufferAllocatedOut)
{
    ...
    constexpr uint32_t kDecayPercentage = 63;
    static_assert(kDecayPercentage >= 0 && kDecayPercentage <= 100);
    mSizeInRecentHistory = (mSizeInRecentHistory * kDecayPercentage +
                            minRequiredBlockSize * (100 - kDecayPercentage)) /
                           100;
