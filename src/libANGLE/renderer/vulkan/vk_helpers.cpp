...
angle::Result ImageViewHelper::initOverrideReadViews(ContextVk *contextVk,
                                                     gl::TextureType viewType,
                                                     const ImageHelper &image,
                                                     const Format &format,
                                                     const gl::SwizzleState &swizzleState,
                                                     ...
                                                     uint32_t layerCount)
{
    VkFormat nonLinearOverrideFormat = NonLinearFormatOverride(image.getFormat().vkImageFormat);
    VkFormat linearOverrideFormat    = LinearFormatOverride(image.getFormat().vkImageFormat);
        ...
        viewType == gl::TextureType::_2DMultisampleArray)
    {
        ...
        // TODO(http://anglebug.com/4004): SwizzleState incorrect for CopyTextureCHROMIUM.
        if (linearFormat != VK_FORMAT_UNDEFINED && !mLinearFetchImageView.valid())
        {
