...
angle::Result ImageHelper::flushStagedUpdates(ContextVk *contextVk,
                                              ...
                                              uint32_t layerStart,
                                              uint32_t layerEnd,
                                              angle::BitSet32<32> skipLevelsMask,
                                              CommandBuffer *commandBuffer)
{
    ...
    for (SubresourceUpdate &update : mSubresourceUpdates)
    {
        ...
        const bool isUpdateLevelOutsideRange = updateMipLevel < levelStart + mBaseLevel ||
                                               updateMipLevel >= levelEnd + mBaseLevel ||
                                               updateMipLevel > mMaxLevel;
        ...
        if (isUpdateLevelOutsideRange || areUpdateLayersOutsideRange ||
            skipLevelsMask.test(updateMipLevel - mBaseLevel))
        {
