...
PipelineStageGroup GetExecutionUnitFromPipelineStageFlags(VkPipelineStageFlags dstStageMask)
{
...
void ImageHelper::updatePipelineStageAccessHistory()
{
    ...
    mPipelineStageAccessHeuristic.updateHeuristic(barrierData.pipelineStageGroup);
}
...
void ImageHelper::onRenderPassAttach(const QueueSerial &queueSerial)
{
    ...
    mPipelineStageAccessHeuristic.updateHeuristic(PipelineStageGroup::FragmentOnly);
}
