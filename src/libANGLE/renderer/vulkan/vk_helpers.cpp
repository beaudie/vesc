                                                          ...
                                                          BufferHelper **bufferOut)
{
    ...
    ANGLE_TRY(mDynamicIndexBuffer.suballocateForVertexConversion(contextVk, allocateBytes,
                                            ...
                                            uint32_t *indexCountOut)
{
    ...
    *indexCountOut = numOutIndices;
    ...
    ANGLE_TRY(mDynamicIndexBuffer.suballocateForVertexConversion(
                                                    ...
                                                    BufferHelper **indirectBufferOut)
{
    ...
    ANGLE_TRY(mDynamicIndexBuffer.suballocateForVertexConversion(contextVk, allocateBytes,
                                                                 MemoryHostVisibility::Visible));
    ANGLE_TRY(mDynamicIndirectBuffer.suballocateForVertexConversion(
...
angle::Result BufferHelper::suballocateForCopyBuffer(ContextVk *contextVk,
                                                     size_t size,
...
angle::Result BufferHelper::suballocateForVertexConversion(ContextVk *contextVk,
                                                           size_t size,
...
angle::Result BufferHelper::suballocateForCopyImage(ContextVk *contextVk,
                                                    size_t size,
                                                    MemoryCoherency coherency,
                                                    angle::FormatID formatId,
                                                    VkDeviceSize *offset,
                                                      ...
                                                      const GLuint inputSkipBytes)
{
    ...
    ANGLE_TRY(currentBuffer->suballocateForCopyImage(contextVk, allocationSize,
    ...
    for (std::vector<SubresourceUpdate> &levelUpdates : mSubresourceUpdates)
    {
        for (SubresourceUpdate &update : levelUpdates)
        {
                ...
                update.data.buffer.formatID == srcFormatID)
            {
                ...
                ANGLE_TRY(dstBuffer->suballocateForCopyImage(
                                                              ...
                                                              const angle::Format &imageFormat)
{
    ...
    if (imageFormat.isBlock)
    {
        ...
        uint8_t *stagingPointer;
        VkDeviceSize stagingOffset;
        ANGLE_TRY(currentBuffer->suballocateForCopyImage(
            contextVk, totalSize, MemoryCoherency::NonCoherent, imageFormat.id, &stagingOffset,
            &stagingPointer));
                                                 ...
                                                 uint8_t **outDataPtr)
{
    ...
    ANGLE_TRY(dstBuffer->suballocateForCopyImage(contextVk, bufferSize, MemoryCoherency::Coherent,
                                      ...
                                      void *pixels)
{
    ...
    ANGLE_TRY(stagingBuffer->suballocateForCopyImage(contextVk, allocationSize,
