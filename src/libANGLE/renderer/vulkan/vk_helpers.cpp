                            ...
                            uint8_t *outPtr)
{
    switch (glIndexType)
    {
        case gl::DrawElementsType::UnsignedByte:
            CopyLineLoopIndicesWithRestart<uint8_t, uint16_t>(indexCount, srcPtr, outLimit, outPtr,
                                                              0xFFFF);
            break;
        case gl::DrawElementsType::UnsignedShort:
            CopyLineLoopIndicesWithRestart<uint16_t, uint16_t>(indexCount, srcPtr, outLimit, outPtr,
                                                               0xFFFF);
            break;
        case gl::DrawElementsType::UnsignedInt:
            CopyLineLoopIndicesWithRestart<uint32_t, uint32_t>(indexCount, srcPtr, outLimit, outPtr,
                                                               0xFFFFFFFF);
            break;
        default:
            UNREACHABLE();
                                            ...
                                            size_t *indexCountOut)
{
    ...
    {
        numOutIndices = GetLineLoopIndexCountWithRestart(glIndexType, indexCount, srcPtr);
    }
