...
// clang-format off
const ImageMemoryBarrierData* ImageMemoryBarrierData::getPrebuildBarrierData(ImageLayout imageLayout)
{
...
{
  // The prebuilt layout enums are always statically created in getPrebuildBarrierData.
...
ImageHelper::ImageHelper()
    : mFormat(nullptr),
      ...
      mLevelCount(0)
{
    mBarrierData = ImageMemoryBarrierData::getPrebuildBarrierData(mCurrentLayout);
}
...
angle::Result ImageHelper::initializeNonZeroMemory(Context *context, VkDeviceSize size)
{
    ...
    const ImageMemoryBarrierData *transitionTo =
        ImageMemoryBarrierData::getPrebuildBarrierData(ImageLayout::TransferDst);
                                       ...
                                       CommandBuffer *commandBuffer)
{
    ...
    const ImageMemoryBarrierData *transitionTo =
        ImageMemoryBarrierData::getPrebuildBarrierData(newLayout);
