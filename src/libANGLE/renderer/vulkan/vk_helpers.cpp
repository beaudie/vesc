...
void CommandBufferHelper::onDepthStateChanged(const gl::DepthStencilState &dsState)
{
...
void CommandBufferHelper::onStencilStateChanged(const gl::DepthStencilState &dsState)
{
