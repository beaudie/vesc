    ...
    DescriptorSetHelper *descriptorSetHelperOut)
{
    ...
    if (bindingOut->valid() && bindingOut->get().allocateDescriptorSet(context, descriptorSetLayout,
                                                                       descriptorSetHelperOut))
    {
        return angle::Result::Continue;
    }
    ...
    SharedDescriptorSetCacheKey *newSharedCacheKeyOut)
{
    ...
    RefCountedDescriptorPoolBinding poolBinding;
    DescriptorSetHelper descriptorSetHelper;
    ANGLE_TRY(
        allocateDescriptorSet(context, descriptorSetLayout, &poolBinding, &descriptorSetHelper));
    ...
    *newSharedCacheKeyOut = CreateSharedDescriptorSetCacheKey(desc, this);
    poolBinding.get().onNewDescriptorSetAllocated(*newSharedCacheKeyOut);
