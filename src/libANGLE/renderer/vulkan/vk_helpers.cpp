                                         ...
                                         CommandBuffer *commandBuffer)
{
    ...
    commandBuffer->piplineBarrier(srcStageMask, dstStageMask, 0, 0, nullptr, 0, nullptr, 1,
                                  &imageMemoryBarrier);
...
angle::Result ImageHelper::generateMipmapsWithBlit(ContextVk *contextVk, GLuint maxLevel)
{
    ...
    for (uint32_t mipLevel = 1; mipLevel <= maxLevel; mipLevel++)
    {
        ...
        commandBuffer->piplineBarrier(VK_PIPELINE_STAGE_TRANSFER_BIT,
    ...
    // We can do it for all layers at once.
    commandBuffer->piplineBarrier(VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT, 0,
