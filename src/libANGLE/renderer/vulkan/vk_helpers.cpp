...
void CommandBufferHelper::updateColorImageLayout(Context *context,
                                                 ImageHelper *image,
                                                 VkImageAspectFlags aspectFlags,
                                                 ImageLayout imageLayout)
{
    ...
    if (mImageToPresent == image)
    {
        // Use finalLayout instead of extra barrier for layout change to present
        mImageToPresent->setCurrentImageLayout(vk::ImageLayout::Present);
        ...
        SetBitField(mAttachmentOps[kAttachmentIndexZero].finalLayout,
                    mImageToPresent->getCurrentImageLayout());
        mImageToPresent = nullptr;
    }
}
                                                   ...
                                                   PackedAttachmentIndex packedAttachmentIndex)
{
    ...
    updateColorImageLayout(context, mColorImages[packedAttachmentIndex], VK_IMAGE_ASPECT_COLOR_BIT,
                           imageLayout);
}
    ...
    PackedAttachmentIndex packedAttachmentIndex)
{
    ...
    // Do layout change.
    ImageLayout imageLayout = ImageLayout::ColorAttachment;
    updateColorImageLayout(context, mColorResolveImages[packedAttachmentIndex],
                                                     ...
                                                     const PackedAttachmentIndex index)
{
    ...
    mRenderPassDesc = renderPassDesc;
    // Because we are reusing the existing renderpass for MSAA resolve and adding the color
