                                                      ...
                                                      bool *availableOut)
{
    ...
    if (mUse.getSerial().valid())
    {
        ...
        result = getQueryPool().getResults(device, mQuery, 1, resultSize, resultOut,
...
angle::Result QueryHelper::getUint64Result(ContextVk *contextVk,
                                           size_t resultSize,
                                           uint64_t *resultOut)
{
    ASSERT(valid());
    if (mUse.getSerial().valid())
    {
        ...
        ANGLE_VK_TRY(contextVk, getQueryPool().getResults(device, mQuery, 1, resultSize, resultOut,
                                                          sizeof(uint64_t), kFlags));
    }
    else
    {
