                              ...
                              VkSemaphore *acquireNextImageSemaphoreOut)
{
    ...
    *acquireNextImageSemaphoreOut = mAcquireNextImageSemaphore.release();
    ...
    uint32_t usedByNonFragmentStage =
        (dstStageMask & ~kAllFragmentAndAttachmentPipelineStageFlags) == 0 ? 0 : 1;
    mAccumulatedPipelineStageFlags = (mAccumulatedPipelineStageFlags << 1) | usedByNonFragmentStage;
                                         ...
                                         VkSemaphore *semaphoreOut)
{
    ...
    else
    {
        ...
        uint32_t usedByNonFragmentStage =
            (dstStageMask & ~kAllFragmentAndAttachmentPipelineStageFlags) == 0 ? 0 : 1;
        mAccumulatedPipelineStageFlags =
            (mAccumulatedPipelineStageFlags << 1) | usedByNonFragmentStage;
...
void ImageHelper::setCurrentRefCountedEvent(Context *context, EventMaps &eventMaps)
{
    ...
    if (mAccumulatedPipelineStageFlags == 0)
    {
        return;
    }
