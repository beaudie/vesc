                                                      ...
                                                      const GLuint inputSkipBytes)
{
    ...
    ANGLE_TRY(currentBuffer->flush(contextVk->getRenderer(), stagingOffset, allocationSize));
    ANGLE_TRY(currentBuffer->invalidate(contextVk->getRenderer(), stagingOffset, allocationSize));
