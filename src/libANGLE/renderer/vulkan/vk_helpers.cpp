                               ...
                               CommandBuffer *commandBuffer)
{
    ...
    forceChangeLayout(aspectMask, newLayout, mCurrentQueueFamilyIndex, commandBuffer);
}

bool ImageHelper::isQueueChangeNeccesary(uint32_t newQueueFamilyIndex)
{
    return mCurrentQueueFamilyIndex != newQueueFamilyIndex;
}

void ImageHelper::changeQueue(VkImageAspectFlags aspectMask,
                              ...
                              CommandBuffer *commandBuffer)
{
    ...
    forceChangeLayout(aspectMask, mCurrentLayout, newQueueFamilyIndex, commandBuffer);
}

void ImageHelper::forceChangeLayout(VkImageAspectFlags aspectMask,
                                    ImageLayout newLayout,
                                    uint32_t newQueueFamilyIndex,
                                    CommandBuffer *commandBuffer)
{
