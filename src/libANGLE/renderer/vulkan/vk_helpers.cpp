...
void CommandBufferHelper::finalizeDeferredImageLayout(Context *context, const ImageHelper *image)
{
    ASSERT(mIsRenderPassCommandBuffer);
...
void ImageHelper::releaseImageFromShareContexts(RendererVk *renderer, ContextVk *contextVk)
{
    if (contextVk && mImageSerial.valid())
    {
        ...
        {
            ctx->finalizeDeferredImageLayout(this);
        }
    }
...
void ImageHelper::stageSelfForBaseLevel(ContextVk *contextVk)
{
    ...
    contextVk->finalizeDeferredImageLayout(this);
