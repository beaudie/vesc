                       ...
                       uint32_t query)
{
    ...
    mQuery                    = query;
    mHasValidMostRecentSerial = false;
}
...
void QueryHelper::updateSerial(const ContextVk *contextVk)
{
    mMostRecentSerial         = contextVk->getCurrentQueueSerial();
    mHasValidMostRecentSerial = true;
}
...
bool QueryHelper::hasPendingWork(ContextVk *contextVk)
{
    ...
    return mHasValidMostRecentSerial && (mMostRecentSerial == contextVk->getCurrentQueueSerial());
}
