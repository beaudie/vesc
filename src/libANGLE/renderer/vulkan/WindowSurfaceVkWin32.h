...
#ifndef LIBANGLE_RENDERER_VULKAN_WINDOWSURFACEVKWIN32_H_
#define LIBANGLE_RENDERER_VULKAN_WINDOWSURFACEVKWIN32_H_
...
#endif  // LIBANGLE_RENDERER_VULKAN_WINDOWSURFACEVKWIN32_H_
