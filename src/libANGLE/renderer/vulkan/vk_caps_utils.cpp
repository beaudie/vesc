...
constexpr unsigned int kStagesSupported       = 2;
constexpr unsigned int UNIFORM_RESERVED_PER_STAGE = 1;
                  ...
                  gl::Limitations * /* outLimitations */)
{
    ...
    // TODO: this is an ES 3.0 property and we can skip implementing it for now.
    ...
    outCaps->maxVertexTextureImageUnits = physicalDeviceProperties.limits.maxPerStageDescriptorSamplers;
