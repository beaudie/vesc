...
void RendererVk::ensureCapsInitialized() const
{
    ...
    // Clamp the maxUniformBlockSize to 65536u (majority of devices support up to this size
    // currently), on AMD the maxUniformBufferRange is near uint32_t max.
    maxUniformBlockSize = std::min(65536u, maxUniformBlockSize);
    ...
    const uint32_t maxCombinedStorageBuffers = limitsVk.maxDescriptorSetStorageBuffers;
