...
#if defined(ANGLE_BUILD_WITH_CHROMIUM)
    // Enabled when bulit into Chromium for further analysis.
    mNativeExtensions.parallelShaderCompileKHR = true;
#else
    // Disabled for standalone Vulkan backend builds, since it's slower.
