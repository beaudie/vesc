...
void RendererVk::ensureCapsInitialized() const
{
    ...
    // TODO(anglebug.com/7524): rgba8i and rgba8ui formats in Vulkan are specified to give undefined
    // behavior if the values being stored are larger than 8 bits. Enable r32* packing on Vulkan PLS
    // to work around this. The Vulkan backend might want to handle this case generally.
