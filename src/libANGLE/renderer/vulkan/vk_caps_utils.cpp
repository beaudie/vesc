...
void RendererVk::ensureCapsInitialized() const
{
    ...
    mNativeExtensions.textureCubeMapArrayOES = (mPhysicalDeviceFeatures.imageCubeArray == VK_TRUE);
    mNativeExtensions.textureCubeMapArrayEXT = (mPhysicalDeviceFeatures.imageCubeArray == VK_TRUE);
