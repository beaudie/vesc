...
void RendererVk::ensureCapsInitialized() const
{
    ...
    GLuint maxUniformVectors =
        limitsVk.maxUniformBufferRange / (sizeof(GLfloat) * kComponentsPerVector);
    ...
    const uint32_t maxPerStageUniformBuffers = limitsVk.maxPerStageDescriptorUniformBuffers;
    ...
    const uint32_t maxPerStageStorageBuffers = limitsVk.maxPerStageDescriptorStorageBuffers;
    ...
    mNativeCaps.maxUniformBlockSize      = limitsVk.maxUniformBufferRange;
