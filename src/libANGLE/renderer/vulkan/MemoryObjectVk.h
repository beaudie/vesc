...
//
// MemoryObjectVk.h: Defines the class interface for MemoryObjectVk, implementing MemoryObjectImpl.
...
{
  public:
    virtual angle::Result initImage(const gl::Context *context,
                                    gl::TextureType type,
                                    size_t levels,
                                    GLenum internalFormat,
                                    const gl::Extents &size,
                                    GLuint64 offset,
                                    vk::ImageHelper *image) = 0;
};
