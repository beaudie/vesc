...
void RefCountedEvent::init(Context *context, ImageLayout layout)
{
    ...
    createInfo.flags             = context->getRenderer()->getRefCountedEventCreateFlags();
                                       ...
                                       VkAccessFlags dstAccess)
{
    ...
    for (EventBarrier &barrier : mBarriers)
    {
        ...
        // dstStageMask. Otherwise we will end up with two waitEVent call that wait for the same
