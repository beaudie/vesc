...
{
    *map = kEventPipelineStageFlagBitMap;
                                          ...
                                          PrimaryCommandBuffer *commandbuffer)
{
    ...
    while (!mEventsToReset.empty())
    {
        ...
        {
            VkPipelineStageFlags stageMask = renderer->getPipelineStageMask(refCountedEvent);
                                       ...
                                       VkAccessFlags dstAccess)
{
    ...
    VkPipelineStageFlags stageFlags = renderer->getPipelineStageMask(waitEvent);
...
{
    ASSERT(waitEvent.valid());
    VkPipelineStageFlags srcStageFlags = renderer->getPipelineStageMask(waitEvent);
