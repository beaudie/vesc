                                                                              ...
                                                                              const char *pName)
{
    ...
    const NameAndFunction kWrappedFunctions[] = {
        {"vkCreateInstance", reinterpret_cast<PFN_vkVoidFunction>(DeviceVk::WrappedCreateInstance)},
        {"vkEnumerateInstanceExtensionProperties",
         reinterpret_cast<PFN_vkVoidFunction>(
             DeviceVk::WrappedEnumerateInstanceExtensionProperties)},
        {"vkEnumerateInstanceLayerProperties",
         reinterpret_cast<PFN_vkVoidFunction>(DeviceVk::WrappedEnumerateInstanceLayerProperties)},
        {"vkEnumerateInstanceVersion",
         reinterpret_cast<PFN_vkVoidFunction>(DeviceVk::WrappedEnumerateInstanceVersion)},
        {"vkGetInstanceProcAddr",
         reinterpret_cast<PFN_vkVoidFunction>(DeviceVk::WrappedGetInstanceProcAddr)},
    };
