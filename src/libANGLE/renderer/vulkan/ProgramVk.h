...
class ProgramVk : public ProgramImpl
{
  public:
    ...
    const vk::DescriptorSetLayoutPointerArray *getShaderStageDescriptorSetLayouts(
        gl::ShaderType shaderType) const
    {
        return &mDescriptorSetLayouts[(int)shaderType];
    }
    const vk::PipelineLayoutDesc *getPipelineLayoutDesc() const { return &mPipelineLayoutDesc; }
  ...
  private:
    ...
    vk::DescriptorSetLayoutArrayofArrays<std::vector<VkDescriptorSet>> mDescriptorSets;
    vk::DescriptorSetLayoutArrayofArrays<vk::DescriptorSetLayoutArray<VkDescriptorSet>>
    ...
    vk::DescriptorSetLayoutArrayofArrays<vk::DescriptorSetLayoutPointerArray> mDescriptorSetLayouts;
