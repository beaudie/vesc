  ...
  private:
    ...
    class ShaderInfo final : angle::NonCopyable
    {
      public:
        ...
        vk::Error getShadersAndPipeline(const ContextVk *contextVk,
        ...
        vk::Error updateDefaultUniformsDescriptorSet(
            ContextVk *contextVk,
      ...
      private:
        ...
        // We keep a reference to the pipeline and descriptor set layouts. This ensures they don't
        // get deleted while this program is in use.
