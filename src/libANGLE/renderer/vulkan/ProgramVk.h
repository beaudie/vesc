...
class ProgramVk : public ProgramImpl
{
  ...
  private:
                                           ...
                                           vk::ShaderProgramHelper **shaderProgramOut)
    {
        ...
        {
            ANGLE_TRY(
                mShaderInfo.initShaders(contextVk, mShaderSources, &mShaderInfo.getSpirvShaders()));
        }
    ...
    angle::Result loadSpirvShader(ContextVk *contextVk, gl::BinaryInputStream *stream);
    void saveSpirvShader(gl::BinaryOutputStream *stream);
    ...
    class ShaderInfo final : angle::NonCopyable
    {
      public:
        ...
        gl::ShaderMap<SpirvShader> &getSpirvShaders() { return mSpirvShaders; }
        const gl::ShaderMap<SpirvShader> &getSpirvShaders() const { return mSpirvShaders; }
