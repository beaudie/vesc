...
class ProgramVk : public ProgramImpl
{
  public:
    ...
    {
        return initProgram(contextVk, shaderType, isLastPreRasterizationStage, optionBits,
  ...
  private:
                                           ...
                                           const ShaderInterfaceVariableInfoMap &variableInfoMap)
    {
        ...
        {
            ANGLE_TRY(programInfo->initProgram(contextVk, shaderType, isLastPreRasterizationStage,
