                                ...
                                CommandGraphNodeFunction function)
{
    switch (resourceType)
    {
        ...
        case CommandGraphResourceType::MemoryBarrier:
                                                ...
                                                PrimaryCommandBuffer *primaryCommandBuffer)
{
    ...
    switch (mFunction)
    {
        ...
        case CommandGraphNodeFunction::MemoryBarrier:
            // Nothing to do.  The memory barrier is already handled above through global memory
            // barrier flags.
            break;
...
{
    CommandGraphNode *newNode = allocateBarrierNode(CommandGraphNodeFunction::MemoryBarrier,
                                                    CommandGraphResourceType::MemoryBarrier, 0);
        ...
        else if (node->getResourceTypeForDiagnostics() == CommandGraphResourceType::Query)
        {
            ...
            else
            {
                ...
                strstr << id;
                 ...
                 node->getResourceTypeForDiagnostics() == CommandGraphResourceType::MemoryBarrier)
        {
