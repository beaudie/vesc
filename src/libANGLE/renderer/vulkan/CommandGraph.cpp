...
{
    // Every resource node is expected to have only one child node.  This function is used only
    // with special functionality that introduce a graph execution barrier whose node is not
    // going to participate in an |addDependency| call.
