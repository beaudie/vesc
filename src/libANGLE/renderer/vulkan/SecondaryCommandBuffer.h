...
class SecondaryCommandBuffer final : angle::NonCopyable
{
  ...
  private:
    ...
    ANGLE_INLINE StructType *initCommand(CommandID cmdID, size_t variableSize)
    {
        ...
        return commonInit<StructType>(cmdID, fixedAllocationSize + variableSize);
    }
    ...
    {
        return commonInit<StructType>(cmdID, sizeof(StructType) + sizeof(CommandHeader));
    }
