    ...
    const VkVertexInputAttributeDescription2EXT *vertexAttributeDescriptions)
{
    ...
    writePtr =
        storePointerParameter(writePtr, vertexBindingDescriptions, vertexBindingDescriptionSize);
    storePointerParameter(writePtr, vertexAttributeDescriptions, vertexAttributeDescriptionSize);
}
