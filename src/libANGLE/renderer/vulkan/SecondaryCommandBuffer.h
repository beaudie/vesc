...
class SecondaryCommandBuffer final : angle::NonCopyable
{
  public:
    ...
    // Use this bitmask to align size_t to 4-bytes
    static constexpr size_t kFourByteAlignment = static_cast<size_t>(-1) - 3;
                                         ...
                                         uint8_t **variableDataPtr)
    {
        ...
        if (mCurrentBytesRemaining < requiredSize)
        {
            ...
            else
            {
                ...
                const size_t alignedSize = (requiredSize + 3) & kFourByteAlignment;
                                                                ...
                                                                const VkDebugUtilsLabelEXT &label)
{
    ...
    const size_t alignedStringSize = (stringSize + 3) & kFourByteAlignment;
