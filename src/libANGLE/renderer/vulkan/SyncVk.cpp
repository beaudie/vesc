                                     ...
                                     VkResult *outResult)
{
    ...
    ANGLE_TRY(
        renderer->waitForQueueSerialsWithUserTimeout(context, mUse.getSerials(), timeout, &status));
                                                ...
                                                VkResult *outResult)
{
    ...
    if (mUse.valid())
    {
        ...
        ANGLE_TRY(renderer->waitForQueueSerialsWithUserTimeout(context, mUse.getSerials(), timeout,
                                                               &status));
    }
    else
    {
