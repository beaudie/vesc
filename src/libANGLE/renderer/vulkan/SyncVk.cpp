                                 ...
                                 EGLenum type)
{
    ...
    return angle::ToEGL(mFenceSync.initializeWithExternalFd(vk::GetImpl(context), mExternalFd),
...
{
    return angle::ToEGL(mFenceSync.dupNativeFenceFD(vk::GetImpl(display), fdOut),
