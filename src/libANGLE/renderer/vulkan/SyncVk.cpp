...
angle::Result SyncHelper::serverWait(ContextVk *contextVk)
{
    ...
    //    {
    //        // TODO: where to specify the pipeline stage mask if all the barrier objects are
    //        nullptr VkDependencyInfo dependencyInfo         = {}; dependencyInfo.sType =
    //        VK_STRUCTURE_TYPE_DEPENDENCY_INFO; dependencyInfo.bufferMemoryBarrierCount = 0;
    //        dependencyInfo.pBufferMemoryBarriers    = nullptr;
    //        dependencyInfo.memoryBarrierCount       = 0;
    //        dependencyInfo.pMemoryBarriers          = nullptr;
    //        dependencyInfo.imageMemoryBarrierCount  = 0;
    //        dependencyInfo.pImageMemoryBarriers     = nullptr;
    //        commandBuffer->pipelineBarrier2(0, 0, nullptr, 0, nullptr, 0, nullptr);
    //    }
    //    else
    //    {
