    ...
    *reinterpret_cast<uint8_t *>(&endiannessTest) = 1;
    ...
    flags |= srcIsInt && destIsInt
                 ...
                 : srcIsUint && destIsUint
                       ...
                       : srcIsInt ? ConvertVertex_comp::kUintToFloat
    ...
    fprintf(
        ...
        flags, src->getSize(), params.srcOffset, dest->getSize(), params.destOffset);
    ...
    VkDescriptorBufferInfo buffers[2] = {
        {dest->getBuffer().getHandle(), params.destOffset, params.destSize},
        {src->getBuffer().getHandle(), params.srcOffset, params.srcSize},
    };
