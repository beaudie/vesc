...
class SurfaceImpl : public FramebufferAttachmentObjectImpl
{
  public:
    ...
    virtual angle::Result getUserWidth(const egl::Display *display, EGLint *value) const;
    virtual angle::Result getUserHeight(const egl::Display *display, EGLint *value) const;
