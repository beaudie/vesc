...
using UpdateShaderStateFunctor = std::function<void(bool compiled, ShHandle)>;
class WaitableCompileEvent : public angle::WaitableEvent
{
  public:
    ...
    virtual bool postTranslate(std::string *infoLog,
                               UpdateShaderStateFunctor &&UpdateShaderStateFunctor) = 0;
