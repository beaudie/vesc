                                                              ...
                                                              gl::PrimitiveMode &outPrimitiveMode)
{
    ...
    encoder->setBufferForWrite(newBuffer, static_cast<uint32_t>(indexOffset) + static_cast<uint32_t>(newOffset), 1);
                                                          ...
                                                          gl::PrimitiveMode &outPrimitiveMode)
{
    ...
    mtl::BufferRef newBuffer;
    if (mIndexBuffers.allocate(context, newIndexCount * indexSize, nullptr, &newBuffer, &newIndexOffset) ==
        angle::Result::Stop)
    {
        return nullptr;
    }
