...
class BufferManager
{
  public:
    ...
    // static constexpr size_t kMaxSizePowerOf2 = 31u;
    // static constexpr size_t kMaxBufferSize = (1u << kMaxSizePowerOf2);
