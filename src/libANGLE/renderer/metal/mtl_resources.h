                      ...
                      public std::enable_shared_from_this<Texture>
{
  public:
    ...
    gl::Extents size(const ImageIndexLegalizer &index) const;

    uint32_t widthAt0() const { return width(MipmapNativeLevel()); }
    uint32_t heightAt0() const { return height(MipmapNativeLevel()); }
    uint32_t depthAt0() const { return depth(MipmapNativeLevel()); }
    gl::Extents sizeAt0() const { return size(MipmapNativeLevel()); }
