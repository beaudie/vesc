...
IOSurfaceBaseMtl::IOSurfaceBaseMtl(const egl::SurfaceState &state)
...
egl::Error IOSurfaceBaseMtl::getSyncValues(EGLuint64KHR *ust,
                                           EGLuint64KHR *msc,
                                           EGLuint64KHR *sbc)
{
    UNIMPLEMENTED();
...
angle::Result IOSurfaceBaseMtl::getAttachmentRenderTarget(
    ...
    : IOSurfaceBaseMtl(state)
{
    ...
    initializeWithIOSurface(display, state, reinterpret_cast<IOSurfaceRef>(buffer), width, height, formatIndex);
}
