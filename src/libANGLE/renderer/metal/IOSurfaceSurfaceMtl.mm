...
constexpr std::array<IOSurfaceFormatInfo, 11> kIOSurfaceFormats = {{
    ...
    {GL_RGB,      GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE,    4, angle::FormatID::R8G8B8A8_UNORM},
    {GL_BGR_ANGLE,GL_UNSIGNED_INT_8_8_8_8_REV_ANGLE,    4, angle::FormatID::B8G8R8A8_UNORM},
...
angle::Result IOSurfaceSurfaceMtl::ensureColorTextureCreated(const gl::Context *context)
{
    ...
    if (kIOSurfaceFormats[mIOSurfaceFormatIdx].internalFormat == GL_RGB ||
        kIOSurfaceFormats[mIOSurfaceFormatIdx].internalFormat == GL_BGR_ANGLE)
    {
