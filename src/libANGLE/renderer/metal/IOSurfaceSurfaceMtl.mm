...
// GL_RGB is a special case. The native angle::FormatID would be either R8G8B8A8_UNORM or R8G8B8A8_UNORM based on the IOSurface's pixel format.
    ...
    : OffscreenSurfaceMtl(display, state, attribs), mIOSurface((__bridge IOSurfaceRef)(buffer))
{
    ...
    {
        // The actual format depends on the IOSurface's format.
