...
// - the respective level & slice of an original texture if the passed texture is a view.
// - the passed texture if it is not a view.
...
void CopyBufferToOriginalTexture(ContextMtl *contextMtl,
    ...
    const mtl::TextureRef &texture)
{
    ...
    CopyBufferToOriginalTexture(contextMtl, encoder, stagingBuffer, 0, stagingBufferRowPitch,
    ...
    const mtl::TextureRef &texture)
{
    ...
    CopyBufferToOriginalTexture(contextMtl, encoder, stagingDepthBuffer, 0,
    ...
    CopyBufferToOriginalTexture(contextMtl, encoder, stagingStencilBuffer, 0,
                                stagingStencilBufferRowPitch, stagingStencilBuffer2DImageSize,
                                region.size, texture, slice, mipmapLevel, region.origin,
...
mtl::TextureRef TextureMtl::NativeTextureWrapper::createMipsSwizzleView(
    GLuint glLevel,
    uint32_t levels,
    MTLPixelFormat format,
    const mtl::TextureSwizzleChannels &swizzle)
