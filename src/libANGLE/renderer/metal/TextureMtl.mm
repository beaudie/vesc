...
mtl::TextureRef *GetLayerLevelTextureView(LayerLevelTextureViewVector *layerLevelTextureViews,
                                          uint32_t layer,
                                          uint32_t level,
                                          uint32_t layerCount,
                                          uint32_t levelCount)
{
    ...
    TextureViewVector &levelTextureViews = (*layerLevelTextureViews)[layer];
