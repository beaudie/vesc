...
void BlitBufferToOriginalTextureIfNeeded(ContextMtl *contextMtl,
    ...
    const mtl::TextureRef &texture)
{
    ...
    BlitBufferToOriginalTextureIfNeeded(
    ...
    const mtl::TextureRef &texture)
{
    ...
    BlitBufferToOriginalTextureIfNeeded(contextMtl, encoder, stagingDepthBuffer, 0,
                                        stagingDepthBufferRowPitch, stagingDepthBuffer2DImageSize,
                                                     ...
                                                     const mtl::TextureRef &texture)
{
    ...
    BlitBufferToOriginalTextureIfNeeded(contextMtl, encoder, stagingBuffer, 0,
                                        stagingBufferRowPitch, stagingBuffer2DImageSize,
