                                            ...
                                            const BlitParams &params)
{
    ...
    {
        // We need to swap Y here because lower (left/right) in blit shader, means it's lower in
        // normalize device coordinates (NDC). NDC has Y direction in opposite direction of texture
        // coordinates.
        std::swap(y0, y1);
    }
    else
