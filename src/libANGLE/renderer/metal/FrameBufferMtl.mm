                                   ...
                                   GLenum filter)
{
    ...
    bool unpackFlipX = adjustedSrcRect.isReversedX();
    bool unpackFlipY = adjustedSrcRect.isReversedY();
    ...
    baseParams.dstTextureSize = mState.getExtents();  // Why is this not dstFramebufferDimensions?
