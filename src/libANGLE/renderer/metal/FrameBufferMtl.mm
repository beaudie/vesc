                                        ...
                                        gl::Command command)
{
    ...
    // update the Metal context attachments cache before preparing a render pass.
    static_assert(gl::Framebuffer::DIRTY_BIT_COLOR_ATTACHMENT_0 == 0, "FB dirty bits");
                                                ...
                                                bool checkProgram)
{
    ...
    const gl::DrawBufferMask incompatibleAttachments =
        checkProgram ? mtl::GetImpl(context)->getIncompatibleAttachments() : gl::DrawBufferMask();
