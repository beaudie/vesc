                                         ...
                                         void *pixels)
{
    ...
    ANGLE_CHECK_GL_MATH(
        contextMtl, sizedFormatInfo.computeSkipBytes(type, outputPitch, 0, pixelPackState, false,
                                                     &outputSkipBytes));
    ...
    PackPixelsParams params(flippedArea, angleFormat, outputPitch, pixelPackState.reverseRowOrder,
                            packBuffer, 0);
    if (mFlipY)
    {
