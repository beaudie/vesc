...
void DisplayMtl::ensureCapsInitialized() const
{
    ...
    if (supportsEitherGPUFamily(2, 1))
    {
        mNativeCaps.maxDrawBuffers      = 8;
        mNativeCaps.maxColorAttachments = 8;
    }
    else
    {
        mNativeCaps.maxDrawBuffers      = 4;
        mNativeCaps.maxColorAttachments = 4;
    }
