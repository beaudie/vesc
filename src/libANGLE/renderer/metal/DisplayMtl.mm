...
void DisplayMtl::generateExtensions(egl::DisplayExtensions *outExtensions) const
{
    ...
    // TODO(anglebug.com/5505):
    // EGLContextSharingTest.DisplayShareGroupObjectSharing and
    // EGLContextSharingTest.DisplayShareGroupReleasedWithLastContext are
    // hanging while switching contexts after the introduction of the
    // ProvokingVertexHelper. Need to understand why its management of command
    // buffers in the display's shared command queue isn't working with this
    // extension.
    outExtensions->displayTextureShareGroup   = false;
...
{
    // TODO(anglebug.com/5505): Apple's implementation conditionalized this on
...
void DisplayMtl::initializeExtensions() const
{
    ...
    // TODO(anglebug.com/5505): Apple's implementation exposed
    ...
    // GL_APPLE_clip_distance
    // TODO(anglebug.com/5505): TranslatorMetalDirect's Layout class can't
    // handle the gl_ClipDistance array yet.
    mNativeExtensions.clipDistanceAPPLE = !CompilerMtl::useDirectToMSLCompiler();
