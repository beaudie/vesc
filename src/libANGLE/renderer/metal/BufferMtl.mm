...
{
    // TODO: This is the wrong check as it returns true too often.
    // What's really needed is to know if the current render pass
    // is scheduled to write to the buffer where as this returns
    // if anything, a blit pass, a compute pass, is schuduled to write
    // to the buffer.
