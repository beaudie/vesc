...
static inline void writeR16_SNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
}
static inline void writeR16_UNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.r)), bufferOffset, buffer);
}
...
static inline void writeR16G16_SNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.g)), bufferOffset + 2, buffer);
}
static inline void writeR16G16_UNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.g)), bufferOffset + 2, buffer);
}
...
static inline void writeR16G16B16A16_SNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.g)), bufferOffset + 2, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.b)), bufferOffset + 4, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.a)), bufferOffset + 6, buffer);
}
static inline void writeR16G16B16A16_UNORM(ushort2 gIndices, constant WritePixelParams &options, uint bufferOffset, vec<float, 4> color, device uchar *buffer)
{
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.g)), bufferOffset + 2, buffer);
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.b)), bufferOffset + 4, buffer);
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.a)), bufferOffset + 6, buffer);
}
