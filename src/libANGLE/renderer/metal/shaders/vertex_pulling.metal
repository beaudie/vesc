...
// at unaligned offset.
//
// At runtime, when a pipeline is being compiled, we can generate a code to call a specialed version
...
//  - fetchAttribute1: will calls specialized "pullVertexAsUInt4" with constants (offset=2,
//  stride=3).
//  - fetchAttribute2: will calls specialized "pullVertexAsUInt4" with constants (offset=3,
//  stride=4).
//
...
#define FETCH_CODE(UNALIGNED_INPUT, DEST)                                                          \
    {                                                                                              \
        ...
        {                                                                                          \
            vertexFinalIndex = gl_InstanceIndex / kVertexPullingDivisor;                           \
        }                                                                                          \
