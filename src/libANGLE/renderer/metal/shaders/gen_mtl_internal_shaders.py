...
configs = [{
    "metal_standard": "macos-metal2.1",
    "min_os_version": "10.14",
    "variable_name": "gDefaultMetallib_2_1",
    "header": "mtl_internal_shaders_2_1_macos.h"
}, {
    "metal_standard": "macos-metal2.0",
    "min_os_version": "10.13",
    "variable_name": "gDefaultMetallib_2_0",
    "header": "mtl_internal_shaders_2_0_macos.h"
}, {
    "metal_standard": "ios-metal2.1",
    "min_os_version": "12",
    "variable_name": "gDefaultMetallib_2_1",
    "header": "mtl_internal_shaders_2_1_ios.h"
}, {
    "metal_standard": "ios-metal2.0",
    "min_os_version": "11",
    "variable_name": "gDefaultMetallib_2_0",
    "header": "mtl_internal_shaders_2_0_ios.h"
}]
...
def generate_metallib_header(metal_src, metal_standard, min_os_version, variable_name,
                             dest_header_file):
    boilerplate_code = template_header_boilerplate.format(
        script_name=os.path.basename(sys.argv[0]))

    metallib_data = metal_to_metallib(metal_src, metal_standard, min_os_version)
...
def main():
    ...
    for config in configs:
        generate_metallib_header(combined_metal_src, config["metal_standard"],
                                 config["min_os_version"], config["variable_name"],
                                 config["header"])
