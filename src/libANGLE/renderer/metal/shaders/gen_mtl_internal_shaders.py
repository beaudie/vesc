...
def main():
    ...
    os.system(
        'echo "\n\nchar gDefaultMetallibSrc[] = R\\"(" >> mtl_default_shaders_src_autogen.inc')
    ...
    os.system('echo "#include <metal_pack>" >> mtl_default_shaders_src_autogen.inc')
    os.system(
        'clang -xc++ -E -DSKIP_STD_HEADERS temp/master_source.metal >> mtl_default_shaders_src_autogen.inc'
    )
