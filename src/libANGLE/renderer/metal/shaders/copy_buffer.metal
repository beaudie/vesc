...
static inline void writeR16_SNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
}
static inline void writeR16_UNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
...
static inline void writeR16G16_SNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.g)), bufferOffset + 2, buffer);
}
static inline void writeR16G16_UNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.r)), bufferOffset, buffer);
...
static inline void writeR16G16B16A16_SNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
    shortToBytes(as_type<short>(floatToNormalized<short>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<short>(floatToNormalized<short>(color.g)), bufferOffset + 2, buffer);
...
static inline void writeR16G16B16A16_UNORM(COMMON_WRITE_FLOAT_FUNC_PARAMS)
{
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.r)), bufferOffset, buffer);
    shortToBytes(as_type<ushort>(floatToNormalized<ushort>(color.g)), bufferOffset + 2, buffer);
