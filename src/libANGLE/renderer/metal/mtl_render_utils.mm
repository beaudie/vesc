    ...
    AutoObjCPtr<id<MTLComputePipelineState>> *outComputePipeline)
{
    ...
    if (!shader)
    {
        ANGLE_MTL_OBJC_SCOPE
        {
            ...
            ANGLE_TRY(
                EnsureComputeShaderInitialized(contextMtl, shaderName, funcConstants, &shader));
        }
    }
    ...
    AutoObjCPtr<id<MTLComputePipelineState>> *outComputePipeline)
{
    ...
    if (!shader)
    {
        ANGLE_MTL_OBJC_SCOPE
        {
            ...
            ANGLE_TRY(EnsureComputeShaderInitialized(contextMtl, @"combineVisibilityResult",
    ...
    AutoObjCPtr<id<MTLComputePipelineState>> *outPipelineState)
{
    ...
    if (!shader)
    {
        ...
        ANGLE_MTL_OBJC_SCOPE
        {
            ...
            ANGLE_TRY(EnsureComputeShaderInitialized(contextMtl, @"convertToFloatVertexFormatCS",
                                                     funcConstants, &shader));
        }
    }
