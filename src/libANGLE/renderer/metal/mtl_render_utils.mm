                                  ...
                                  bool isColorBlit)
{
    ...
    float u0 = params.srcNormalizedCoords.v[0];
    float v0 = params.srcNormalizedCoords.v[1];
    float u1 = params.srcNormalizedCoords.v[2];
    float v1 = params.srcNormalizedCoords.v[3];
