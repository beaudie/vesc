...
AutoObjCPtr<MTLRenderPipelineDescriptor *> RenderPipelineDesc::createMTLRenderPipelineDescriptor(
    ...
    bool insertDefaultAttribLayout)
{
    ANGLE_MTL_OBJC_SCOPE
    {
        ...
        auto objCDesc = desc.createMTLRenderPipelineDescriptor(mVertexShader, mFragmentShader);
