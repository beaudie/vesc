...
TextureRef Texture::parentTexture()
{
    ...
    if (!mParentTexture)
    {
        ...
        // and its view. For example, the original Texture object might keep a ref to its stencil
        // view. Had we kept the original object's ref in the stencil view, there would have been a
        // cyclic reference.
