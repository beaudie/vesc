...
class MTLWaitableCompileEventImpl final : public WaitableCompileEvent
{
  public:
    ...
    {
        // TODO(jonahr): Fix usage of translator
        // sh::TShHandleBase *base    = static_cast<sh::TShHandleBase
        // *>(mTranslateTask->getHandle()); auto translatorMetalDirect =
        // base->getAsTranslatorMetalDirect(); if (translatorMetalDirect != nullptr)
        // {
                                                         ...
                                                         ShCompileOptions options)
{
        ...
        !contextMtl->getDisplay()->getFeatures().hasBaseVertexInstancedDraw.enabled)
    {
        ...
        // TODO(jonahr): Fix usage of translator
        // sh::TShHandleBase *base = static_cast<sh::TShHandleBase
        // *>(compilerInstance->getHandle()); auto translatorMetalDirect =
        // base->getAsTranslatorMetalDirect(); if (translatorMetalDirect == nullptr)
        // {
