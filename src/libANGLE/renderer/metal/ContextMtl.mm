...
{
    if (!mWorkTexture || mWorkTexture->textureType() != srcTexture->textureType() ||
        mWorkTexture->pixelFormat() != srcTexture->pixelFormat() ||
        mWorkTexture->mipmapLevels() != srcTexture->mipmapLevels() ||
        mWorkTexture->cubeFacesOrArrayLength() != srcTexture->cubeFacesOrArrayLength() ||
        mWorkTexture->widthAt0() != srcTexture->widthAt0() ||
        mWorkTexture->heightAt0() != srcTexture->heightAt0() ||
        mWorkTexture->depthAt0() != srcTexture->depthAt0())
    {
