                                    ...
                                    const gl::State::DirtyBits &bitMask)
{
    ...
    constexpr gl::State::DirtyBits blendBitsMask(
    ...
    gl::State::DirtyBits mergedDirtyBits = gl::State::DirtyBits(dirtyBits);
    mergedDirtyBits.set(gl::State::DIRTY_BIT_BLEND_ENABLED, (dirtyBits & blendBitsMask).any());
