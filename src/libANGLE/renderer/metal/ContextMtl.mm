                                           ...
                                           GLsizei instances)
{
    ...
    const std::vector<DrawCommandRange> drawCommands = mVertexArray->getDrawIndices(
        context, type, convertedType, mode, drawIdxBuffer, convertedCounti32, convertedOffset);
    ...
    else
    {
        ...
        // TODO(anglebug.com/5505): merge transform feedback support into this code path.
