...
def main():
    ...
    image_mac_override = map_image["override_mac"]
    image_non_mac_override = map_image["override_non_mac"]
    image_angle_to_mtl = map_image["map"]
    image_mac_specific_formats = map_image["map_mac"]
    image_ios_specific_formats = map_image["map_ios"]

    vertex_angle_override = map_vertex["override"]
    vertex_angle_streaming_override = map_vertex["override_streaming"]
