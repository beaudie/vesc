  ...
  private:
    struct ShaderKey
    {
        ...
        struct Hash
        {
            ...
            {
                return (static_cast<size_t>(k.numColorAttachments) << 0) ^
                       (static_cast<size_t>(k.alphaPremultiplyType) << 3) ^
                       (static_cast<size_t>(k.sourceTextureType) << 5);
            }
        };
    };
