                                   ...
                                   gl::InfoLog &infoLog)
{
    ...
    const gl::ProgramExecutable *glExecutable = glContext->getState().getProgramExecutable();
    ASSERT(glExecutable);
    ANGLE_TRY(mtl::GlslangGetShaderSpirvCode(contextMtl, *glExecutable, contextMtl->getCaps(),
