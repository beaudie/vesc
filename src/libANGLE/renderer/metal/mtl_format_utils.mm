                            ...
                            std::vector<GLenum> *compressedFormatsOut)
{
    ...
    tmpTextureExtensions.packedDepthStenciOES   = true;  // We support this reguardless
...
#else
    tmpTextureExtensions.packedDepthStenciOES   = true;  // override to D32_FLOAT_S8X24_UINT
