...
angle::Result ContextImpl::acquireTextures(const gl::TextureVector &textures, const uint *layouts)
{
    return angle::Result::Continue;
}

angle::Result ContextImpl::releaseTextures(const gl::TextureVector &textures, uint *layouts)
{
    return angle::Result::Continue;
}
