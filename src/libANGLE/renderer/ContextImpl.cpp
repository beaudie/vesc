...
angle::Result ContextImpl::acquireTextures(const gl::TextureVector &, const uint *layouts)
{
    return angle::Result::Continue;
}

angle::Result ContextImpl::releaseTextures(const gl::TextureVector &, uint *layouts)
{
    return angle::Result::Continue;
}
