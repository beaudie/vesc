...
#define ANGLE_D3D_WORKAROUND_NONE                    0
#define ANGLE_D3D_WORKAROUND_SKIP_OPTIMIZATION       (1 << 0)
#define ANGLE_D3D_WORKAROUND_MAX_OPTIMIZATION        (1 << 1)
#define ANGLE_D3D_WORKAROUND_COMPILE_IEEE_STRICTNESS (1 << 2)
