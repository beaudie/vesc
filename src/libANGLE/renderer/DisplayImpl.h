...
class DisplayImpl : public EGLImplFactory
{
  public:
    ...
    virtual egl::Error restoreLostDevice(const egl::Thread *thread) = 0;
    ...
    virtual egl::Error waitClient(const egl::Thread *thread) const = 0;
    virtual egl::Error waitNative(const egl::Thread *thread, EGLint engine) const = 0;
