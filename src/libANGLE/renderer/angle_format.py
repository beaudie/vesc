...
def get_vertex_copy_function(src_format, dst_format):
    ...
    is_10_10_10_2 = src_format.startswith('R10G10B10A2_')

    if src_gl_type == None and not is_10_10_10_2:
        return "nullptr"
    ...
    if is_10_10_10_2:
        is_signed = 'true' if not src_format.startswith('R10G10B10A2_U') else 'false'
        return "CopyXYZ10W2ToXYZW32FVertexData<%s, %s, true>" % (is_signed, normalized)
