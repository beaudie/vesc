...
bool Image9::redefine(RendererD3D *renderer, GLenum target, GLenum internalformat, const gl::Extents &size, bool forceRelease)
{
...
gl::Error Image9::copy(const gl::Extents &destOffset, const gl::Rectangle &sourceArea, RenderTargetD3D *source)
{
    ASSERT(source);

    // ES3.0 only behaviour to copy into a 3d texture
    ASSERT(destOffset.depth == 0);
    ...
    RECT destRect = { destOffset.width, destOffset.height, destOffset.width + width, destOffset.height + height };
...
gl::Error Image9::copy(const gl::Extents &destOffset, const gl::Rectangle &area, const gl::ImageIndex &srcIndex, TextureStorage *srcStorage)
{
