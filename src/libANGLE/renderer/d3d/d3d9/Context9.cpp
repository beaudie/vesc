...
Context9::Context9(const gl::ContextState &state, Renderer9 *renderer) : ContextImpl(state), mRenderer(renderer)
{
}
...
TextureImpl *Context9::createTexture(GLenum target)
{
    switch (target)
    {
...
gl::Error Context9::drawArrays(GLenum mode,
                                GLint first,
                                GLsizei count)
{
