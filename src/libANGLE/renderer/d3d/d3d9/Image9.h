...
class Image9 : public ImageD3D
{
  public:
    ...
    bool redefine(RendererD3D *renderer, GLenum target, GLenum internalformat, const gl::Extents &size, bool forceRelease) override;
    ...
    virtual gl::Error copy(const gl::Extents &destOffset, const gl::Rectangle &sourceArea, RenderTargetD3D *source);
    virtual gl::Error copy(const gl::Extents &destOffset, const gl::Rectangle &sourceArea,
