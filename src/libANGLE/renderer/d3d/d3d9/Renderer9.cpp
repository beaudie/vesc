...
gl::Error Renderer9::setUniformBuffers(const NonOwningOffsetBindingPointer<gl::Buffer> /*vertexUniformBuffers*/[], const NonOwningOffsetBindingPointer<gl::Buffer> /*fragmentUniformBuffers*/[])
{
