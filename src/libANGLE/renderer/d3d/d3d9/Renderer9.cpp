...
Renderer9::Renderer9(egl::Display *display) : RendererD3D(display), mStateManager()
{
    mD3d9Module = NULL;
...
void Renderer9::initializeDevice()
{
    ...
    mStateManager.initialize(mDevice, &mAdapterIdentifier);
...
{
    return mStateManager.getVendorId();
}
