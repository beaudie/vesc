...
const VertexFormat &GetVertexFormatInfo(DWORD supportedDeclTypes, angle::FormatID vertexFormatType)
{
    ...
    const gl::VertexFormat &vertexFormat = gl::GetVertexFormatFromID(vertexFormatType);
