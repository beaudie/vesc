...
SurfaceD3D::SurfaceD3D(RendererD3D *renderer,
    ...
    : SurfaceImpl(),
      mRenderer(renderer),
      mDisplay(display),
      mFixedSize(attribs.get(EGL_FIXED_SIZE_ANGLE, EGL_FALSE) == EGL_TRUE),
      mOrientation(attribs.get(EGL_SURFACE_ORIENTATION_ANGLE, 0)),
      ...
      mWidth(attribs.get(EGL_WIDTH, 0)),
      mHeight(attribs.get(EGL_HEIGHT, 0)),
      mSwapInterval(1),
