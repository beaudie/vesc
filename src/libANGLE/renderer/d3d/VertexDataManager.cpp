...
VertexBufferBinding::VertexBufferBinding(VertexBufferBinding &&other)
    : mBoundVertexBuffer(other.mBoundVertexBuffer)
{
    other.mBoundVertexBuffer = nullptr;
}
...
VertexBufferBinding &VertexBufferBinding::operator=(VertexBufferBinding &&other)
{
    mBoundVertexBuffer       = other.mBoundVertexBuffer;
    other.mBoundVertexBuffer = nullptr;
    return *this;
