...
void VertexDataManager::StoreDirectAttrib(TranslatedAttribute *directAttrib, GLint start)
{
    ...
    directAttrib->vertexBuffer = nullptr;
                                               ...
                                               GLsizei instances)
{
    ...
    translated->vertexBuffer = staticBuffer->getVertexBuffer();
    ASSERT(translated->vertexBuffer);
    translated->serial = translated->vertexBuffer->getSerial();
    translated->offset = streamOffset;

    staticBuffer->bindForOneDrawCall();
                                                ...
                                                GLsizei instances)
{
    ...
    translated->vertexBuffer = mStreamingBuffer->getVertexBuffer();
