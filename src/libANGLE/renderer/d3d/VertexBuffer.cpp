...
// StreaminVertexBufferInterface Implementation
...
StaticVertexBufferInterface::StaticVertexBufferInterface(BufferFactoryD3D *factory)
    : VertexBufferInterface(factory, false), mBindingRevision(0)
{
}
...
bool StaticVertexBufferInterface::isBoundToD3D()
{
    return (mBindingRevision >= mFactory->getVertexBufferBindingRevision());
}

void StaticVertexBufferInterface::bindForOneDrawCall()
{
    mBindingRevision = mFactory->getVertexBufferBindingRevision();
}

void StaticVertexBufferInterface::bindIndefinitely()
{
    mBindingRevision = std::numeric_limits<unsigned int>::max();
}

void StaticVertexBufferInterface::releaseIndefiniteBinding()
{
    mBindingRevision = mFactory->getVertexBufferBindingRevision();
}
