...
static FormatWriteFunctionMap BuildFormatWriteFunctionMap()
{
    ...
    InsertFormatWriteFunctionMapping(&map, GL_RGBA,               GL_UNSIGNED_SHORT,                 WriteColor<R16G16B16A16, GLfloat> );
    ...
    InsertFormatWriteFunctionMapping(&map, GL_RGB,                GL_UNSIGNED_SHORT,                 WriteColor<R16G16B16, GLfloat>    );
