                                                ...
                                                int subresourceID)
{
    ...
    // If the external image is null, the external image is unbound and we release the storage
    ...
    else
    {
        SafeDelete(mTexStorage);
        mTexStorage =
            mRenderer->createTextureStorageExternal(externalImage, planeIndex, subresourceID);
    }
