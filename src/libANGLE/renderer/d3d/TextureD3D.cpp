...
TextureD3D::TextureD3D(RendererD3D *renderer, const gl::TextureState &data)
    : TextureImpl(data),
      mRenderer(renderer),
      mUsage(GL_NONE),
      mDirtyImages(true),
...
gl::Error TextureD3D::generateMipmaps()
{
    ...
    if (mTexStorage && mTexStorage->supportsNativeMipmapFunction())
    {
        ...
        error = mRenderer->generateMipmapsUsingD3D(mTexStorage, mData);
        if (error.isError())
        {
            return error;
        }
...
TextureD3D_2D::TextureD3D_2D(RendererD3D *renderer, const gl::TextureState &data)
    : TextureD3D(renderer, data)
{
...
TextureD3D_Cube::TextureD3D_Cube(RendererD3D *renderer, const gl::TextureState &data)
    : TextureD3D(renderer, data)
{
    for (int i = 0; i < 6; i++)
    {
...
TextureD3D_3D::TextureD3D_3D(RendererD3D *renderer, const gl::TextureState &data)
    : TextureD3D(renderer, data)
{
    for (int i = 0; i < gl::IMPLEMENTATION_MAX_TEXTURE_LEVELS; ++i)
    {
...
TextureD3D_2DArray::TextureD3D_2DArray(RendererD3D *renderer, const gl::TextureState &data)
    : TextureD3D(renderer, data)
{
...
TextureD3D_External::TextureD3D_External(RendererD3D *renderer, const gl::TextureState &data)
    : TextureD3D(renderer, data)
{
