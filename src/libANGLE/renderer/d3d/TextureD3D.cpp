                                     ...
                                     const gl::Texture *source)
{
    ...
    ASSERT(canCreateRenderTargetForImage(gl::ImageIndex::Make2D(static_cast<GLint>(level))));

    ANGLE_TRY(ensureRenderTarget());
    ASSERT(isValidLevel(static_cast<GLint>(level)));
    ANGLE_TRY(updateStorageLevel(static_cast<GLint>(level)));
    ...
    ANGLE_TRY(mRenderer->copyTexture(source, static_cast<GLint>(sourceLevel), sourceRect,
                                     ...
                                     destOffset, mTexStorage, target, static_cast<GLint>(level),
