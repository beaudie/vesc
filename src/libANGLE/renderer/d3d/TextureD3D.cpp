...
gl::Error TextureD3D::getAttachmentRenderTarget(const gl::AttachmentSubResource &subResource,
                                                AttachmentRenderTarget *rtOut)
{
    return getRenderTarget(subResource.textureIndex(), reinterpret_cast<RenderTargetD3D **>(rtOut));
}
