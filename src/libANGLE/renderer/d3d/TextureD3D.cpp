...
gl::Error TextureD3D_3D::copyTexture3d(const gl::Context *context,
...
gl::Error TextureD3D_3D::copySubTexture3d(const gl::Context *context,
...
gl::Error TextureD3D_2DArray::copyTexture3d(const gl::Context *context,
                                            gl::TextureTarget target,
                                            GLenum internalFormat,
                                            GLenum type,
                                            size_t sourceLevel,
...
gl::Error TextureD3D_2DArray::copySubTexture3d(const gl::Context *context,
                                               const gl::TextureTarget target,
                                               const gl::Offset &destOffset,
                                               size_t sourceLevel,
                                               size_t destLevel,
