...
bool TextureD3D::forceReleaseImagesOnSetImage(const uint8_t *pixels) const
{
                                  ...
                                  const uint8_t *pixels)
{
    ...
    redefineImage(level, internalFormatInfo.sizedInternalFormat, size,
                  forceReleaseImagesOnSetImage(pixels));
                                            ...
                                            const uint8_t *pixels)
{
    ...
    redefineImage(level, internalFormat, size, forceReleaseImagesOnSetImage(pixels));
