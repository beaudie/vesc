...
{
    ASSERT(gl::countLeadingZeros(static_cast<unsigned int>(getBaseLevelWidth())) > getBaseLevel());
    return getBaseLevelWidth() << mBaseLevel;
}

GLint TextureD3D::getLevelZeroHeight() const
{
    ASSERT(gl::countLeadingZeros(static_cast<unsigned int>(getBaseLevelHeight())) > getBaseLevel());
...
{
    ASSERT(gl::countLeadingZeros(static_cast<unsigned int>(getBaseLevelDepth())) > getBaseLevel());
