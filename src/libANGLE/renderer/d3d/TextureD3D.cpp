...
void TextureD3D::setBaseLevel(GLuint baseLevel)
{
    ...
    // Base levels that are too large to be actually used need to be clamped to 0, otherwise some
    // queries will result in out of range array access.
...
GLint TextureD3D_2DArray::getLevelZeroDepth() const
{
