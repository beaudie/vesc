                                        ...
                                        const gl::Extents &size)
{
    ...
    TexStoragePointer storage = {mRenderer->createTextureStorage2D(
                                     ...
                                     static_cast<int>(levels), mState.getLabel(), false, false),
                                 context};
                                                   ...
                                                   TexStoragePointer *outStorage) const
{
    ...
    *outStorage = {
        mRenderer->createTextureStorage2D(internalFormat, renderTarget, width, height, levels,
                                          mState.getLabel(), hintLevelZeroOnly, typeless),
        context};
                                          ...
                                          const gl::Extents &size)
{
    ...
    TexStoragePointer storage = {mRenderer->createTextureStorageCube(
                                     internalFormat, renderTarget, size.width,
                                     static_cast<int>(levels), false, false, mState.getLabel()),
                                 context};
                                                     ...
                                                     TexStoragePointer *outStorage) const
{
    ...
    *outStorage = {
        mRenderer->createTextureStorageCube(getBaseLevelInternalFormat(), renderTarget, size,
                                            levels, hintLevelZeroOnly, typeless, mState.getLabel()),
        context};
