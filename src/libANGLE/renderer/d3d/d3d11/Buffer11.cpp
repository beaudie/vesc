...
PackPixelsParams::PackPixelsParams(const gl::Rectangle &areaIn, GLenum formatIn, GLenum typeIn,
                                   GLuint outputPitchIn, const gl::PixelPackState &packIn,
                                   ptrdiff_t offsetIn)
    : area(areaIn),
      format(formatIn),
      type(typeIn),
...
class Buffer11::BufferStorage : angle::NonCopyable
{
  public:
    ...
    virtual bool copyFromStorage(BufferStorage *source, size_t sourceOffset, size_t size,
                                 size_t destOffset) = 0;
...
class Buffer11::NativeStorage : public Buffer11::BufferStorage
{
  public:
    ...
    bool copyFromStorage(BufferStorage *source, size_t sourceOffset, size_t size,
  ...
  private:
    static void fillBufferDesc(D3D11_BUFFER_DESC *bufferDesc, Renderer11 *renderer,
...
class Buffer11::PackStorage : public Buffer11::BufferStorage
{
  public:
    ...
    gl::Error packPixels(ID3D11Texture2D *srcTexure, UINT srcSubresource,
...
gl::Error Buffer11::copySubData(BufferImpl *source, GLintptr sourceOffset, GLintptr destOffset,
                                GLsizeiptr size)
{
...
bool Buffer11::PackStorage::copyFromStorage(BufferStorage *source, size_t sourceOffset, size_t size,
                                            size_t destOffset)
{
