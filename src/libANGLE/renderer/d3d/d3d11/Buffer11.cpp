                               ...
                               size_t offset)
{
    ...
    if (data && size > 0)
    {
        ...
        mDirectBroadcastChannel.signal(context, angle::MessageID::ATTACHMENT_CHANGE);
    }
...
void Buffer11::initializeStaticData(const gl::Context *context)
{
    ...
    mStaticBroadcastChannel.signal(context, angle::MessageID::ATTACHMENT_CHANGE);
}
                                          ...
                                          bool preserveData)
{
    ...
    {
        mOnStorageChanged->signal(context, angle::MessageID::ATTACHMENT_CHANGE);
    }
