...
void Buffer11::initializeStaticData(const gl::Context *context)
{
    ...
    onStateChange(context, angle::SubjectMessage::StorageAndContentsChanged);
}
                                              ...
                                              bool preserveData)
{
    ...
    {
        mOnStorageChanged->onStateChange(context, angle::SubjectMessage::StorageAndContentsChanged);
    }
