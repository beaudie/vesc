...
struct LoadImageFunctionPair
{
    LoadImageFunctionPair(LoadImageFunction loadFunction, bool isCopyOnly)
        : loadFunction(loadFunction), isCopyOnly(isCopyOnly)
    { }
...
struct TextureFormat
{
    ...
    typedef std::map<GLenum, LoadImageFunctionPair> LoadFunctionMap;
