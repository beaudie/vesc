                                      ...
                                      GLfloat *xy)
{
    ...
    auto iter       = samplePositionsMap.find(sampleCount);
    if (iter != samplePositionsMap.end())
    {
    ...
    deviceContext->CopyResource(mResultBuffer.get(), mSamplePositionsBuffer.get());
    ...
    samplePositionsMap[sampleCount].reset((new SamplePosition[sampleCount]));
    std::memcpy(samplePositionsMap[sampleCount].get(), pData, sizeof(SamplePosition) * sampleCount);
