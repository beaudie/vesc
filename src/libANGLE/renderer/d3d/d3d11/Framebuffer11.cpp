...
const Framebuffer11 *Framebuffer11::makeFramebuffer11(const FramebufferImpl *framebuffer)
{
    ASSERT(HAS_DYNAMIC_TYPE(const Framebuffer11*, framebuffer));
    return static_cast<const Framebuffer11*>(framebuffer);
}
