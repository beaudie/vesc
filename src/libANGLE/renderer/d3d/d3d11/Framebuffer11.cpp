...
gl::Error Framebuffer11::clear(const gl::Data &data, const ClearParameters &clearParams)
{
    ...
    if (mRenderer->directRenderingEnabled() && colorAttachment != nullptr &&
                                        ...
                                        uint8_t *pixels) const
{
    ...
    else
    {
        ...
        const bool invertSourceTexture = (colorbuffer->id() == 0 && mRenderer->directRenderingEnabled());
    ...
    if (blitRenderTarget)
    {
        ...
        for (size_t colorAttachment = 0; colorAttachment < colorAttachments.size(); colorAttachment++)
        {
                ...
                drawBufferStates[colorAttachment] != GL_NONE)
            {
                ...
                const bool invertColorSource =
                    (readBuffer->id() == 0 && mRenderer->directRenderingEnabled());
                ...
                const bool invertColorDest =
                    (drawBuffer.id() == 0 && mRenderer->directRenderingEnabled());
