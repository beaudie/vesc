...
class Buffer11 : public BufferD3D
{
  public:
    ...
    angle::Subject *getStaticBroadcastChannel();
    angle::Subject *getDirectBroadcastChannel();
  ...
  private:
    ...
    angle::Subject mStaticBroadcastChannel;
    angle::Subject mDirectBroadcastChannel;
};
