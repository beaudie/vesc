...
void SetUAVRelatedResourceLimits(D3D_FEATURE_LEVEL featureLevel, gl::Caps *caps)
{
    ...
    // Allocate the remaining UAVs for images and shader storage blocks.
    ...
    if (featureLevel == D3D_FEATURE_LEVEL_11_1)
    {
        ...
        caps->maxGeometryAtomicCounterBuffers = caps->maxGeometryAtomicCounterBuffers;

        caps->maxVertexImageUniforms         = caps->maxCombinedShaderOutputResources;
        caps->maxVertexShaderStorageBlocks   = caps->maxCombinedShaderOutputResources;
        caps->maxGeometryImageUniforms       = caps->maxCombinedShaderOutputResources;
        caps->maxGeometryShaderStorageBlocks = caps->maxCombinedShaderOutputResources;
    }
}
