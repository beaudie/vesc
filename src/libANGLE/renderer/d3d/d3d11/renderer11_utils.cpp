...
constexpr std::array<SamplePositionsArray, 5> mSamplePositions = {
    {{{0.5f, 0.5f}},
...
{
    xy[0] = mSamplePositions[static_cast<GLsizei>(ceil(log(sampleCount)))][2 * index];
    xy[1] = mSamplePositions[static_cast<GLsizei>(ceil(log(sampleCount)))][2 * index + 1];
}
