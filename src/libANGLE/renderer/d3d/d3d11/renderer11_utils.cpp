...
unsigned int GetReservedVertexUniformVectors(D3D_FEATURE_LEVEL featureLevel)
{
    ...
    case D3D_FEATURE_LEVEL_9_1:  return 2; // dx_ViewAdjust and dx_ViewCoords
...
static size_t GetMaximumPixelUniformVectors(D3D_FEATURE_LEVEL featureLevel)
{
    ...
    switch (featureLevel)
    {
      ...
      case D3D_FEATURE_LEVEL_9_3:
      case D3D_FEATURE_LEVEL_9_2:
      case D3D_FEATURE_LEVEL_9_1:  return 32 - d3d11_gl::GetReservedFragmentUniformVectors(featureLevel);
