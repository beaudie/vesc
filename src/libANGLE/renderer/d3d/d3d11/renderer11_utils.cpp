    ...
    switch (featureLevel)
    {
        ...
        case D3D_FEATURE_LEVEL_11_0:
            return D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT -
                   d3d11::RESERVED_VERTEX_FRAGMENT_CONSTANT_BUFFER_SLOT_COUNT;
...
std::array<GLuint, 3> GetMaxComputeWorkGroupCount(D3D_FEATURE_LEVEL featureLevel)
{
    ...
    switch (featureLevel)
    {
        case D3D_FEATURE_LEVEL_11_1:
        case D3D_FEATURE_LEVEL_11_0:
            maxComputeWorkGroupCount[0] = D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION;
            maxComputeWorkGroupCount[1] = D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION;
            maxComputeWorkGroupCount[2] = D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION;
            break;
        case D3D_FEATURE_LEVEL_10_1:
        case D3D_FEATURE_LEVEL_10_0:
            ...
            maxComputeWorkGroupCount[0] = D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION;
            maxComputeWorkGroupCount[1] = D3D11_CS_DISPATCH_MAX_THREAD_GROUPS_PER_DIMENSION;
            maxComputeWorkGroupCount[2] = D3D11_CS_4_X_DISPATCH_MAX_THREAD_GROUPS_IN_Z_DIMENSION;
            break;
        default:
...
std::array<GLuint, 3> GetMaxComputeWorkGroupSize(D3D_FEATURE_LEVEL featureLevel)
{
    ...
    switch (featureLevel)
    {
        case D3D_FEATURE_LEVEL_11_1:
        case D3D_FEATURE_LEVEL_11_0:
            maxComputeWorkGroupSize[0] = D3D11_CS_THREAD_GROUP_MAX_X;
            maxComputeWorkGroupSize[1] = D3D11_CS_THREAD_GROUP_MAX_Y;
            maxComputeWorkGroupSize[2] = D3D11_CS_THREAD_GROUP_MAX_Z;
            break;
        case D3D_FEATURE_LEVEL_10_1:
        case D3D_FEATURE_LEVEL_10_0:
            maxComputeWorkGroupSize[0] = D3D11_CS_4_X_THREAD_GROUP_MAX_X;
            maxComputeWorkGroupSize[1] = D3D11_CS_4_X_THREAD_GROUP_MAX_Y;
            maxComputeWorkGroupSize[2] = 1;
            break;
        default:
