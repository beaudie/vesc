    ...
    gl::TexLevelArray<D3D11_SUBRESOURCE_DATA> *outSubresourceData)
{
    ...
    ANGLE_CHECK_11_ALLOC(GetImplAs<Context11>(context),
...
angle::Result LazyResource<ResourceT>::resolveImpl(Renderer11 *renderer,
...
template angle::Result LazyResource<ResourceType::InputLayout>::resolveImpl(
    ...
    const char *name);
template angle::Result LazyResource<ResourceType::PixelShader>::resolveImpl(Renderer11 *renderer,
                                                                            const ShaderData &desc,
                                                                            void *initData,
                                                                            const char *name);
template angle::Result LazyResource<ResourceType::VertexShader>::resolveImpl(Renderer11 *renderer,
                                                                             const ShaderData &desc,
                                                                             void *initData,
                                                                             const char *name);
...
angle::Result LazyInputLayout::resolve(Renderer11 *renderer)
{
...
angle::Result LazyBlendState::resolve(Renderer11 *renderer)
{
