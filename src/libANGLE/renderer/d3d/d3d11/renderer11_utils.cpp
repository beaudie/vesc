                                ...
                                std::vector<std::vector<BYTE>> *outData)
{
    ...
    for (unsigned int i = 0; i < mipLevels; i++)
    {
        ...
        d3dFormatInfo.dataInitializerFunction(mipWidth, mipHeight, mipDepth, outData->at(i).data(),
                                              rowWidth, imageSize);
