...
angle::Result PixelTransfer11::buildShaderMap(const gl::Context *context)
{
    ...
    bufferToTextureFloat.setDebugName("BufferToTextureRGBAps");
    bufferToTextureInt.setDebugName("BufferToTextureRGBA-Ips");
    bufferToTextureUint.setDebugName("BufferToTextureRGBA-UIps");
