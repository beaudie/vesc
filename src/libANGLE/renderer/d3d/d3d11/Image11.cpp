...
gl::Error Image11::loadData(const gl::Box &area, GLint unpackAlignment, GLint unpackRowLength, GLenum type, const void *input)
{
    const gl::InternalFormat &formatInfo = gl::GetInternalFormatInfo(mInternalFormat);
    GLsizei inputRowPitch = formatInfo.computeRowPitch(type, area.width, unpackAlignment, unpackRowLength);
    GLsizei inputDepthPitch = formatInfo.computeDepthPitch(type, area.width, area.height, unpackAlignment, unpackRowLength);
