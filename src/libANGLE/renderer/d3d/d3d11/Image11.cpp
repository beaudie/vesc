      ...
      mRecoveredFromStorageCount(0)
{
    ...
    mFeatureLevel = mRenderer->getRenderer11DeviceCaps()->featureLevel;
}
...
bool Image11::isDirty() const
{
    ...
    if (mDirty && !mStagingTexture && !mRecoverFromStorage && !(d3d11::GetTextureFormatInfo(mInternalFormat, mRenderer->getRenderer11DeviceCaps()).dataInitializerFunction != NULL))
    {
        return false;
    }
