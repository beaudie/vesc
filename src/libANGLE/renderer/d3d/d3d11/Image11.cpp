...
{
    // If mDirty is true
    // AND mStagingTexture doesn't exist AND mStagingTexture doesn't need to be recovered from
    // TextureStorage
                                 ...
                                 const gl::Box &region)
{
    ...
    // multiple times,
    // then we should just keep the staging texture around to prevent the copying from impacting
    // perf.
...
gl::Error Image11::recoverFromAssociatedStorage()
{
    if (mRecoverFromStorage)
    {
        ...
        // its copy of its data.
        // This should not have happened. The TextureStorage should have told this Image11 to
        // recover its data before it was overwritten.
