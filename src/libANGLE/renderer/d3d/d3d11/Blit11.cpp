                                                        ...
                                                        RenderTarget11 *depth)
{
    ...
    // Set the viewport
    stateManager->setShaderResourceShared(SHADER_PIXEL, 0, &depth->getShaderResourceView());
                                                          ...
                                                          bool alsoDepth)
{
    ...
    // Set the viewport
    stateManager->setSimpleViewport(extents);
    stateManager->setShaderResourceShared(SHADER_PIXEL, 0, &depthStencil->getShaderResourceView());
    stateManager->setShaderResource(SHADER_PIXEL, 1, &mStencilSRV);
