                              ...
                              bool unpackUnmultiplyAlpha)
{
    ...
    const Shader *shader = nullptr;
    error = getBlitShader(destFormat, isSigned, unpackPremultiplyAlpha, unpackUnmultiplyAlpha,
                          dimension, &shader);
    if (error.isError())
    {
        return error;
...
gl::Error Blit11::getBlitShader(GLenum destFormat,
                                ...
                                const Shader **shader)
{
    BlitShaderType blitShaderType = GetBlitShaderType(destFormat, unpackPremultiplyAlpha,
                                                      unpackUnmultiplyAlpha, isSigned, dimension);
