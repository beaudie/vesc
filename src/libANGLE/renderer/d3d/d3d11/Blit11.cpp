                                            ...
                                            GLenum destTypeForDownsampling)
{
    ...
    else if (isDestSigned)
    {
        ...
        switch (destinationFormat)
        {
            case GL_RGBA_INTEGER:
                ...
                {
                    return unpackPremultiplyAlpha ? RGBAF_TOI_PREMULTIPLY
            ...
            case GL_RED_INTEGER:
                ...
                {
                    return unpackPremultiplyAlpha ? RGBF_TOI_PREMULTIPLY
                                                  : RGBF_TOI_UNMULTIPLY;
                }
                break;
            default:
    ...
    else
    {
        ...
        case GL_UNSIGNED_SHORT_5_6_5:
            ...
            {
                return  unpackPremultiplyAlpha ? RGBF_565_PREMULTIPLY
                                                    : RGBF_565_UNMULTIPLY;
            }
        case GL_UNSIGNED_SHORT_5_5_5_1:
            ...
            {
                return unpackPremultiplyAlpha ? RGBAF_5551_PREMULTIPLY
        ...
        if (unpackPremultiplyAlpha != unpackUnmultiplyAlpha || floatToIntBlit)
        {
            switch (destinationFormat)
            {
                ...
                case GL_BGRA_EXT:
                    ASSERT(!floatToIntBlit);
                    return unpackPremultiplyAlpha ? RGBAF_PREMULTIPLY
                                                : RGBAF_UNMULTIPLY;
                case GL_RGB:
                case GL_RG:
                case GL_RED:
                    ...
                    {
                        return unpackPremultiplyAlpha ? RGBF_PREMULTIPLY
                                                    : RGBF_UNMULTIPLY;
                    }
                case GL_RGBA_INTEGER:
                    if (unpackPremultiplyAlpha == unpackUnmultiplyAlpha)
                ...
                case GL_LUMINANCE:
                    ASSERT(!floatToIntBlit);
                    return  unpackPremultiplyAlpha ? LUMAF_PREMULTIPLY
                                                : LUMAF_UNMULTIPLY;

                case GL_LUMINANCE_ALPHA:
                    ASSERT(!floatToIntBlit);
                    return unpackPremultiplyAlpha ? LUMAALPHAF_PREMULTIPLY
                                    ...
                                    const Shader **shader)
{
    ...
    blitShaderOperation = getBlitShaderOperation(destFormat, sourceFormat, isSrcSigned, isDestSigned,
