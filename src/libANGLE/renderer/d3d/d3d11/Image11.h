...
class Image11 : public ImageD3D
{
  ...
  private:
    ...
    gl::Error createTemporaryStagingImage2D(DXGI_FORMAT format, ID3D11Texture2D **output);
    gl::Error createTemporaryStagingImage3D(DXGI_FORMAT format, ID3D11Texture3D **output);
