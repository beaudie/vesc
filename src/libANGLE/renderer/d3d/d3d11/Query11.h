...
struct Query11Info
{
    Query11Info() : query(nullptr), beginTimestamp(nullptr), endTimestamp(nullptr) {}
    ID3D11Query *query;
...
class Query11 : public QueryImpl
{
  ...
  private:
    ...
    gl::Error testQuery(Query11Info query);
    ...
    Query11Info mActiveQuery;
    std::deque<Query11Info> mPendingQueries;
};
