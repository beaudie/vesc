...
void RenderTarget11::addDirtyCallback(NotificationID key, const NotificationCallback &callback)
{
    mDirtyCallbacks[key] = callback;
}

void RenderTarget11::removeDirtyCallback(NotificationID key)
{
    mDirtyCallbacks.erase(key);
}
