                              ...
                              const gl::VertexArray::DirtyBits &dirtyBufferDataBits)
{
    ...
    gl::VertexArray::DirtyBits combinedDirtyBits =
        dirtyBits | (dirtyBufferDataBits & mStaticDirtyBitsMask);

    for (size_t dirtyBit : combinedDirtyBits)
    {
                                                   ...
                                                   bool restartEnabled)
{
    ...
    mStaticDirtyBitsMask.set(gl::VertexArray::DIRTY_BIT_ELEMENT_ARRAY_BUFFER, isStatic);
                                              ...
                                              size_t attribIndex)
{
    ...
    mStaticDirtyBitsMask.set(dirtyBit, newStorageType == VertexStorageType::STATIC);
