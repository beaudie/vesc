                                   ...
                                   const gl::VertexArray::DirtyBindingBitsArray &bindingBits)
{
    ...
    constexpr gl::VertexArray::DirtyBindingBits kOnlyDataChangedBits(
        1 << gl::VertexArray::DIRTY_BINDING_BUFFER_DATA);
    ...
    for (size_t dirtyBit : dirtyBits)
    {
        switch (dirtyBit)
        {
            ...
            default:
            {
                ...
                if (dirtyBit < gl::VertexArray::DIRTY_BIT_ATTRIB_MAX)
                {
                ...
                {
                    // Avoid triggering invalidation for non-static attribs.
                    ASSERT(dirtyBit >= gl::VertexArray::DIRTY_BIT_BINDING_0 &&
                           dirtyBit < gl::VertexArray::DIRTY_BINDING_MAX);
                    if (bindingBits[index] == kOnlyDataChangedBits)
                    {
