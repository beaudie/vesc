                                       ...
                                       gl::VertexArray::DirtyBindingBitsArray *bindingBits)
{
    ...
    {
        updateVertexAttribStorage(context, stateManager, {static_cast<int>(attribIndex)});
    }
                                                ...
                                                const gl::AttributesMask &activeDirtyAttribs)
{
    ...
    for (size_t dirtyAttribIndex : activeDirtyAttribs)
    {
        ...
        const auto &currentValue =
            glState.getVertexAttribCurrentValue({static_cast<int>(dirtyAttribIndex)});
                                                  ...
                                                  const gl::AttributesMask &activeDynamicAttribs)
{
    ...
    for (size_t dynamicAttribIndex : activeDynamicAttribs)
    {
        ...
        const auto &currentValue =
            glState.getVertexAttribCurrentValue({static_cast<int>(dynamicAttribIndex)});
