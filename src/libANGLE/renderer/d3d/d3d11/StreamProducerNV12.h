...
{
  public:
    StreamProducerNV12(Renderer11 *renderer, egl::Stream::ConsumerType consumerType);
    ~StreamProducerNV12() override;

    egl::Error produceFrameFromPointer(void *pointer, const egl::AttributeMap &attributes) override;
  ...
  private:
    ...
    egl::Stream::ConsumerType mConsumerType;
