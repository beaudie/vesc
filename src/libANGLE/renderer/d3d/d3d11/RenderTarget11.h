...
{
  public:
    RenderTarget11() : mANGLEFormat(d3d11::ANGLE_FORMAT_NONE) {}
...
class SurfaceRenderTarget11 : public RenderTarget11
{
  ...
  private:
    ...
    ID3D11Resource *getTextureInternal() const;
    ID3D11RenderTargetView *getRenderTargetViewInternal() const;
    ID3D11DepthStencilView *getDepthStencilViewInternal() const;
    ID3D11ShaderResourceView *getShaderResourceViewInternal() const;
