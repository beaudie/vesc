...
class RenderTarget11 : public RenderTargetD3D
{
  public:
    ...
    void addDirtyCallback(NotificationID key, const NotificationCallback &callback);
    void removeDirtyCallback(NotificationID key);
    void signalDirty() override;

  protected:
    std::map<NotificationID, NotificationCallback> mDirtyCallbacks;
};
