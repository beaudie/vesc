...
static inline void InsertLoadFunction(D3D11LoadFunctionMap *map, GLenum internalFormat, GLenum type,
                                      DXGI_FORMAT dxgiFormat, LoadImageFunction loadFunc, bool requiresConversion)
{
    (*map)[internalFormat].push_back(
        GLTypeDXGIFunctionPair(type, DxgiFormatLoadFunctionPair(dxgiFormat, LoadImageFunctionInfo(loadFunc, requiresConversion))));
}
