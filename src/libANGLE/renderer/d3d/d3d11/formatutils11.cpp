...
static inline void InsertD3D11FormatInfoBase(D3D11ES3FormatMap *formatMap, const D3D11LoadFunctionMap *flLoadFunctions, GLenum internalFormat, DXGI_FORMAT texFormat,
                                             DXGI_FORMAT srvFormat, DXGI_FORMAT rtvFormat, DXGI_FORMAT dsvFormat, bool isFeatureLevel9_3)
{
    TextureFormat info;
    ...
    DXGI_FORMAT srvFormat, DXGI_FORMAT rtvFormat, DXGI_FORMAT dsvFormat)
{
    ...
    InsertD3D11FormatInfoBase(map, &flLoadFunctions, internalFormat, texFormat, srvFormat, rtvFormat, dsvFormat, true);
}
    ...
    DXGI_FORMAT srvFormat, DXGI_FORMAT rtvFormat, DXGI_FORMAT dsvFormat)
{
    ...
    InsertD3D11FormatInfoBase(map, &flLoadFunctions, internalFormat, texFormat, srvFormat, rtvFormat, dsvFormat, false);
}
