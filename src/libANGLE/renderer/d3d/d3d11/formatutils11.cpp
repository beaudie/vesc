...
static inline bool OnlyDXGI1_2(const Renderer11DeviceCaps &deviceCaps)
{
    return (deviceCaps.supportsDXGI1_2 == true);
}

static inline bool OnlyDXGI1_1(const Renderer11DeviceCaps &deviceCaps)
{
...
static D3D11ES3FormatMap BuildD3D11FormatMap()
{
    ...
    InsertD3D11FormatInfo(&map, GL_RGB565,            DXGI_FORMAT_R8G8B8A8_UNORM,       DXGI_FORMAT_R8G8B8A8_UNORM,      DXGI_FORMAT_R8G8B8A8_UNORM,      DXGI_FORMAT_UNKNOWN,   OnlyDXGI1_1);
    InsertD3D11FormatInfo(&map, GL_RGB565,            DXGI_FORMAT_B5G6R5_UNORM,         DXGI_FORMAT_B5G6R5_UNORM,        DXGI_FORMAT_B5G6R5_UNORM,        DXGI_FORMAT_UNKNOWN,   OnlyDXGI1_2);
