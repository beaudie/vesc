  ...
  private:
    ...
    class SamplerMetadataD3D11 final : angle::NonCopyable
    {
      public:
        ...
        const dx_SamplerMetadata *appliedData() const;
        void apply(size_t bytesApplied);
        size_t sizeBytes() const;
        bool referencedBytesApplied(size_t referencedBytes) const;

      private:
        std::vector<dx_SamplerMetadata> mSamplerMetadata;
        std::vector<dx_SamplerMetadata> mAppliedSamplerMetadata;
    };
