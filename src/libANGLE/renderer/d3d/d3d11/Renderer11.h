...
class Renderer11 : public RendererD3D
{
  public:
    ...
    gl::Error setUniformBuffers(const NonOwningOffsetBindingPointer<gl::Buffer> vertexUniformBuffers[],
                                const NonOwningOffsetBindingPointer<gl::Buffer> fragmentUniformBuffers[]) override;
  ...
  private:
    ...
    GLintptr mCurrentConstantBufferPSOffset[gl::IMPLEMENTATION_MAX_VERTEX_SHADER_UNIFORM_BUFFERS];
    GLsizeiptr mCurrentConstantBufferPSSize[gl::IMPLEMENTATION_MAX_VERTEX_SHADER_UNIFORM_BUFFERS];
