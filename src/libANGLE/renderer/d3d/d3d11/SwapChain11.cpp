...
SwapChain11::SwapChain11(Renderer11 *renderer,
    ...
    : SwapChainD3D(shareHandle, d3dTexture, backBufferFormat, depthBufferFormat),
      ...
      mEGLSamples(samples),
      mMultiviewCount(1)  // TODO(anglebug.com/2754): Change to multiviewCount.
{
                          ...
                          EGLint swapInterval)
{
    ...
    if (mNativeWindow->getNativeWindow())
    {
        HRESULT hr = mNativeWindow->createSwapChain(
            ...
            backbufferHeight, mNeedsOffscreenTexture ? 1 : getD3DSamples(), mMultiviewCount,
            &mSwapChain);

        // TODO(anglebug.com/2754): add this when DX11 Stereo is added
