...
EGLint SwapChain11::resetOffscreenBuffers(const egl::Thread *thread,
                                          int backbufferWidth,
                                          int backbufferHeight)
{
    if (mNeedsOffscreenTexture)
    {
        EGLint result = resetOffscreenColorBuffer(thread, backbufferWidth, backbufferHeight);
...
EGLint SwapChain11::resetOffscreenColorBuffer(const egl::Thread *thread,
                                              int backbufferWidth,
                                              int backbufferHeight)
{
    ...
    if (previousOffscreenTexture.valid())
    {
        ...
        if (mSwapChain)
        {
            swapRect(thread, 0, 0, backbufferWidth, backbufferHeight);
        }
    }
...
EGLint SwapChain11::resize(const egl::Thread *thread,
                           ...
                           EGLint backbufferHeight)
{
    ...
    return resetOffscreenBuffers(thread, backbufferWidth, backbufferHeight);
}
...
EGLint SwapChain11::reset(const egl::Thread *thread,
                          EGLint backbufferWidth,
                          EGLint backbufferHeight,
                          EGLint swapInterval)
{
    ...
    {
        return resize(thread, backbufferWidth, backbufferHeight);
    }
...
EGLint SwapChain11::swapRect(const egl::Thread *thread,
                             EGLint x,
                             EGLint y,
                             EGLint width,
                             EGLint height)
{
    if (mNeedsOffscreenTexture)
    {
        EGLint result = copyOffscreenToBackbuffer(thread, x, y, width, height);
        if (result != EGL_SUCCESS)
        {
            return result;
        }
    ...
    EGLint result = present(thread, x, y, width, height);
    if (result != EGL_SUCCESS)
    {
        return result;
    }
...
EGLint SwapChain11::copyOffscreenToBackbuffer(const egl::Thread *thread,
                                              EGLint x,
                                              EGLint y,
                                              EGLint width,
                                              EGLint height)
...
EGLint SwapChain11::present(const egl::Thread *thread,
                            EGLint x,
                            EGLint y,
                            EGLint width,
                            EGLint height)
