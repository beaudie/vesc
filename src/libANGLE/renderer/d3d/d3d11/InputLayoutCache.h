...
class InputLayoutCache
{
  public:
    ...
    gl::Error applyVertexBuffers(TranslatedAttribute attributes[gl::MAX_VERTEX_ATTRIBS],
                                 GLenum mode, gl::Program *program, UntranslatedIndexData *indexInfo,
  ...
  private:
    ...
    static void configureIndexedPointSpriteEnableBuffer(std::vector<float> &enableBuffer, UntranslatedIndexData *indexInfo);
