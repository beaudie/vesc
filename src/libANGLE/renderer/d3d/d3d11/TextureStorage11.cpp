                                               ...
                                               const gl::ImageIndex &destIndex)
{
    ...
    ANGLE_TRY(getRenderTarget(context, sourceIndex, &source, 0));
                                                   ...
                                                   GLsizei samples)
{
    ...
    if (needMS)
    {
        ...
        {
            RenderTargetD3D *rt;
            ANGLE_TRY(mMSTexInfo->msTex->getRenderTarget(context, index, &rt, samples));
            *outRT = rt;
            return angle::Result::Continue;
        }
        else
        {
            ...
            ANGLE_TRY(getRenderTarget(context, index, &readRenderTarget, 0));
