...
bool TextureStorage11_EGLImage::isAssociatedImageValid(const gl::ImageIndex &index,
                                                       Image11 *expectedImage)
{
    return false;
}

gl::Error TextureStorage11_EGLImage::releaseAssociatedImage(const gl::ImageIndex &index,
