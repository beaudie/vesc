...
class TextureStorage11_2D : public TextureStorage11
{
  ...
  private:
    ...
    std::unique_ptr<RenderTarget11> mRenderTargets[gl::IMPLEMENTATION_MAX_TEXTURE_LEVELS];
    bool mHasKeyedMutex;
...
class TextureStorage11_Cube : public TextureStorage11
{
  ...
  private:
    ...
    TextureHelper11 mTexture;
    std::unique_ptr<RenderTarget11> mRenderTargets[CUBE_FACE_COUNT]
    ...
    TextureHelper11 mLevelZeroTexture;
    std::unique_ptr<RenderTarget11> mLevelZeroRenderTargets[CUBE_FACE_COUNT];
    bool mUseLevelZeroTexture;
