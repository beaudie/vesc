...
class TextureStorage11_2DArray : public TextureStorage11
{
  ...
  private:
    ...
    {
        RenderTargetKey(int mipLevelIn, int layerIn, int numLayersIn)
  ...
  private:
    ...
    typedef std::map<RenderTargetKey, RenderTarget11 *> RenderTargetMap;
    ...
    typedef std::map<RenderTargetKey, Image11 *> ImageMap;
