...
class TextureStorage11 : public TextureStorage
{
  ...
  private:
    ...
    struct SRVKeyForImage
    {
        SRVKeyForImage(int level, bool layered, int layer, GLenum access, GLenum format);
        bool operator<(const SRVKeyForImage &rhs) const;
        int level;
        bool layered;
        int layer;
        GLenum access;
    ...
    typedef std::map<SRVKeyForImage, d3d11::SharedSRV> SRVCacheForImage;
    gl::Error getCachedOrCreateSRVForImage(const gl::Context *context,
                                           const SRVKeyForImage &key,
                                           const d3d11::SharedSRV **outSRV);
    SRVCacheForImage mSrvCacheForImage;

    struct UAVKeyForImage
    {
        UAVKeyForImage(int level, bool layered, int layer, GLenum access, GLenum format);
        bool operator<(const UAVKeyForImage &rhs) const;
        int level;
        bool layered;
        int layer;
        GLenum access;
    ...
    typedef std::map<UAVKeyForImage, d3d11::SharedUAV> UAVCacheForImage;
