...
class ShaderConstants11 : angle::NonCopyable
{
  public:
    ...
    angle::Result updateBuffer(Renderer11 *renderer,
...
class StateManager11 final : angle::NonCopyable
{
  public:
    ...
    angle::Result initialize(DisplayD3D *display,
                             const gl::Caps &caps,
    ...
    angle::Result applyComputeUniforms(ProgramD3D *programD3D);
  ...
  private:
    ...
    angle::Result syncDepthStencilState(const gl::State &glState);
    ...
    angle::Result applyDriverUniforms();
    angle::Result applyDriverUniformsForShader(gl::ShaderType shaderType);
    angle::Result applyUniforms();
    angle::Result applyUniformsForShader(gl::ShaderType shaderType);
