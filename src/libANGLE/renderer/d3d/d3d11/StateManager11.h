...
class StateManager11 final : angle::NonCopyable
{
  ...
  private:
    ...
    void unsetConflictingView(gl::PipelineType pipelineType, ID3D11View *view);
    void unsetConflictingSRVs(gl::PipelineType currentPipeline,
                              gl::ShaderType conflictShaderType,
                              uintptr_t resource,
                              const gl::ImageIndex *index);
    void unsetConflictingUAVs(gl::PipelineType currentPipeline,
                              gl::ShaderType conflictShaderType,
                              uintptr_t resource,
                              const gl::ImageIndex *index);
    ...
    enum DirtyBitType
    {
        ...
        DIRTY_BIT_RENDERPIPELINE_SRVUAV_STATE,
        DIRTY_BIT_COMPUTEPIPELINE_SRVUAV_STATE,
