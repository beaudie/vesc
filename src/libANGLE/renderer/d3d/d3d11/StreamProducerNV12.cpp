...
egl::Error StreamProducerNV12::validateFramePointer(void *pointer) const
{
...
void StreamProducerNV12::produceFrameFromPointer(void *pointer, const egl::AttributeMap &attributes)
{
