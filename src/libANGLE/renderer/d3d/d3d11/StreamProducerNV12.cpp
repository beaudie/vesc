...
StreamProducerNV12::StreamProducerNV12(Renderer11 *renderer, egl::Stream::ConsumerType consumerType) : mRenderer(renderer), mConsumerType(consumerType), mTexture(nullptr), mArraySlice(0), mTextureWidth(0), mTextureHeight(0)
{
}
...
egl::Error StreamProducerNV12::produceFrameFromPointer(void *pointer, const egl::AttributeMap &attributes)
{
