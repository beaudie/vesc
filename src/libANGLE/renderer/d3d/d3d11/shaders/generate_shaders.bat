...
call:BuildShader Clear11.hlsl           VS_ClearAnyType_FL9         vs_4_0_level_9_3 compiled\clearanytype11_fl9vs.h         %debug%
call:BuildShader Clear11.hlsl           PS_ClearFloat_FL9           ps_4_0_level_9_3 compiled\clearfloat11_fl9ps.h           %debug%
call:BuildShader Clear11.hlsl           VS_ClearAnyType             vs_4_0           compiled\clearanytype11vs.h             %debug%
call:BuildShader Clear11.hlsl           PS_ClearFloat               ps_4_0           compiled\clearfloat11ps.h               %debug%
call:BuildShader Clear11.hlsl           PS_MultiColorClearFloat_FL9 ps_4_0_level_9_3 compiled\multicolorclearfloat11_fl9ps.h %debug%
call:BuildShader Clear11.hlsl           PS_MultiColorClearFloat     ps_4_0           compiled\multicolorclearfloat11ps.h     %debug%
