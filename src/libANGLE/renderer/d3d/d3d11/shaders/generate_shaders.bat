...
call:BuildShader SamplePosition11.hlsl      PS_SamplePosition_2UI    ps_5_0   compiled/sampleposition_2ui_ps.h     %debug%
call:BuildShader SamplePosition11.hlsl      PS_SamplePosition_2I     ps_5_0   compiled/sampleposition_2i_ps.h      %debug%
