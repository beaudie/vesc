...
call:BuildShader MultiplyAlpha.hlsl PS_FtoI_PT_RGBA ps_4_0 compiled\multiplyalpha_ftoi_pt_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_FtoI_PM_RGBA ps_4_0 compiled\multiplyalpha_ftoi_pm_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_FtoI_UM_RGBA ps_4_0 compiled\multiplyalpha_ftoi_um_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_UtoU_PM_RGBA ps_4_0 compiled\multiplyalpha_utou_pm_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_UtoU_UM_RGBA ps_4_0 compiled\multiplyalpha_utou_um_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_ItoI_PM_RGBA ps_4_0 compiled\multiplyalpha_itoi_pm_rgba_ps.h %debug%
call:BuildShader MultiplyAlpha.hlsl PS_ItoI_UM_RGBA ps_4_0 compiled\multiplyalpha_itoi_um_rgba_ps.h %debug%
