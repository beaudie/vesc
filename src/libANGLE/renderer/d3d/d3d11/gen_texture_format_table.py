...
def get_swizzle_format_id(internal_format, angle_format_id, angle_format):
...
def json_to_table_data(internal_format, format_name, prefix, json):
    ...
    parsed["swizzleFormat"] = get_swizzle_format_id(internal_format, format_name, parsed)
...
def parse_json_angle_format_case(format_name, angle_format, json_data):
    ...
    if fallback != None:
        unsupported_case, _, _ = parse_json_angle_format_case(fallback, json_data[fallback], json_data)
