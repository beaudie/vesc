...
inline const TextureFormat GetD3D11FormatInfo(GLenum internalFormat,
...
def parse_json_into_switch_string(json_data):
    ...
    for internal_format_item in json_data:
        ...
        for idx, texture_format in enumerate(json_data[internal_format_item]):
...
with open('texture_format_data.json') as texture_format_json_file:
    ...
    with open('texture_format_table.cpp', 'wt') as out_file:
