...
Format::Format()
    : internalFormat(GL_NONE),
      ...
      srgbDisabledSRVFormat(DXGI_FORMAT_UNKNOWN),
      rtvFormat(DXGI_FORMAT_UNKNOWN),
      srgbDisabledRTVFormat(DXGI_FORMAT_UNKNOWN),
...
Format::Format(GLenum internalFormat,
    ...
    : internalFormat(internalFormat),
      ...
      texFormat(texFormat),
      srvFormat(srvFormat),
      srgbDisabledSRVFormat(srgbDisabledSRVFormat),
      rtvFormat(rtvFormat),
      srgbDisabledRTVFormat(srgbDisabledRTVFormat),
      dsvFormat(dsvFormat),
