...
{
    ANGLE_TRY_FAST(mRenderer->getStateManager()->updateState(context, drawCallParams));
    OutputDebugStringA("Let's not inline this, shall we");
    WARN() << "no, let's not." << std::endl;
