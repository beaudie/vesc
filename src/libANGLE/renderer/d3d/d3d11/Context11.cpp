...
gl::Caps Context11::getNativeCaps() const
{
    ...
    {
        caps.maxDrawBuffers =
            std::min(caps.maxCombinedShaderOutputResources, IMPLEMENTATION_MAX_DRAW_BUFFERS);
        caps.maxColorAttachments =
            std::min(caps.maxCombinedShaderOutputResources, IMPLEMENTATION_MAX_COLOR_ATTACHMENTS);
    }
