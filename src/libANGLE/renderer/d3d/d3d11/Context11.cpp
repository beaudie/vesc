                                                              ...
                                                              GLsizei drawcount)
{
    ...
    gl::ResetBaseVertexBaseInstance resetUniforms(programObject, false, hasBaseInstance);
    ...
    GLsizei drawcount)
{
    ...
    const bool hasBaseInstance = programObject && programObject->hasBaseInstanceUniform();
    gl::ResetBaseVertexBaseInstance resetUniforms(programObject, hasBaseVertex, hasBaseInstance);
