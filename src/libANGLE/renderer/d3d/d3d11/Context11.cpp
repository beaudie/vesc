...
#define MULTI_DRAW_BLOCK(drawType, instanced, bvbi, hasDrawID, hasBaseVertex, hasBaseInstance) \
    ...
    {                                                                                          \
        ...
        MARK_TRANSFORM_FEEDBACK_USAGE(instanced);                                              \
                                         ...
                                         GLsizei drawcount)
{
    ...
    //         //     context, mode, firsts[drawID], counts[drawID],
    //         gl::DrawElementsType::InvalidEnum,
    //         //     nullptr, 0, 0, 0));
    //         ANGLE_TRY(mRenderer->drawArrays(context, mode, firsts[drawID], counts[drawID], 0,
    //         0));
