...
CompilerImpl *Renderer11::createCompiler()
{
    ...
    {
        return new CompilerD3D(SH_HLSL_4_FL9_3_OUTPUT);
    }
    else
    {
        return new CompilerD3D(SH_HLSL_4_OUTPUT);
    }
}
                                    ...
                                    const std::vector<D3DUniform *> &uniformArray)
{
    ...
    if (!mDriverConstantBufferVS)
    {
        ...
        InitConstantBufferDesc(&constantBufferDescription, sizeof(dx_VertexConstants));
    ...
    {
        D3D11_BUFFER_DESC constantBufferDescription = {0};
        InitConstantBufferDesc(&constantBufferDescription, sizeof(dx_PixelConstants));
