                                      ...
                                      bool unpackUnmultiplyAlpha)
{
    ...
    TextureStorage11_2DArray *destStorage11 = GetAs<TextureStorage11_2DArray>(storage);
            ...
            destStorage11->getFormatSet().internalFormat)
    {
        ...
        if (srcTarget != gl::TextureTarget::_2DArray)
        {
            gl::ImageIndex sourceIndex = gl::ImageIndex::MakeFromTarget(destTarget, sourceLevel);
    ...
    else
    {
        ...
        if (destTarget != gl::TextureTarget::_2DArray)
        {
        ...
        // copy
        GLenum sourceFormat = source->getFormat(destTarget, sourceLevel).info->format;
