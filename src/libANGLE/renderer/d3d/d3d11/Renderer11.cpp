...
void Renderer11::populateRenderer11DeviceCaps()
{
    ...
    if (getWorkarounds().disableB5G6R5Support.applied)
    {
        mRenderer11DeviceCaps.B5G6R5support    = 0;
                                     ...
                                     GLsizei instanceCount)
{
    ...
    switch (mode)
    {
        ...
        case gl::PrimitiveMode::Points:
            if (getWorkarounds().useInstancedPointSpriteEmulation.applied)
            {
...
{
    return !getWorkarounds().selectViewInGeometryShader.applied &&
