...
gl::ErrorOrResult<TextureHelper11> CreateStagingTextureFor(const TextureHelper11 &textureHelper,
                                                           const gl::Rectangle &safeArea,
                                                           ID3D11Device *device)
{
    if (textureHelper.getTextureType() == GL_TEXTURE_2D)
    {
    ...
    ASSERT(textureHelper.getTextureType() == GL_TEXTURE_3D);
                                         ...
                                         uint8_t *pixelsOut)
{
    ...
    auto errorOrResult = CreateStagingTextureFor(textureHelper, safeArea, mDevice);
    ...
    if (textureHelper.getTextureType() == GL_TEXTURE_2D && textureHelper.getSampleCount() > 1)
    {
        ...
        resolvedTextureHelper = std::move(TextureHelper11(resolveTex2D));
