                                            ...
                                            RenderTargetD3D *destRenderTarget)
{
    ...
    ANGLE_TRY(
        colorAttachment->getRenderTarget(context, gl::RenderTargetUse::READ, &sourceRenderTarget));
                                      ...
                                      GLint level)
{
    ...
    ANGLE_TRY(
        storage11->getRenderTarget(context, index, &destRenderTarget, gl::RenderTargetUse::DRAW));
                                        ...
                                        GLint level)
{
    ...
    RenderTargetD3D *destRenderTarget = nullptr;
    // TODO same as 2d after i implement cube.
    ANGLE_TRY(
        storage11->getRenderTarget(context, index, &destRenderTarget, gl::RenderTargetUse::DRAW));
    ASSERT(destRenderTarget);
                                             ...
                                             uint8_t *pixelsOut)
{
    ...
    ANGLE_TRY(srcAttachment.getRenderTarget(context, gl::RenderTargetUse::READ, &rt11));
