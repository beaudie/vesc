                                           ...
                                           int stencilBackRef, bool frontFaceCCW)
{
        ...
        stencilRef != mCurStencilRef || stencilBackRef != mCurStencilBackRef)
    {
        ...
        // buffer GL specifies we should clamp the ref value to the nearest bit depth when doing
        // stencil ops
        ...
        ASSERT((depthStencilState.stencilMask & D3D11_DEFAULT_STENCIL_READ_MASK) ==
               (depthStencilState.stencilBackMask & D3D11_DEFAULT_STENCIL_READ_MASK));
