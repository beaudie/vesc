                                      ...
                                      bool unpackUnmultiplyAlpha)
{
            ...
            destStorage11->getFormatSet().internalFormat)
    {
        ...
        auto getTextureD3DResource = [](const gl::Context *context, TextureD3D *texture,
                                        const gl::ImageIndex &index,
                                        const TextureHelper11 **outResource, UINT *outSubresource) {
        ...
        if (srcTarget == gl::TextureTarget::_2D || srcTarget == gl::TextureTarget::_3D)
        {
            ...
            ANGLE_TRY(getTextureD3DResource(context, sourceD3D, sourceIndex, &sourceResource,
                                            &sourceSubresource));
