                                               ...
                                               const GLvoid *indirect)
{
    ...
    TranslatedIndexData indexInfo;
    // Since indirect draw requires that indices data must be in gpu buffer and indirect offset must
    // be a multiple of uint, we can directly use applyIndexBuffer with indices to nullptr and count
    // to 0.
