                                           ...
                                           int stencilBackRef, bool frontFaceCCW)
{
        ...
        stencilRef != mCurStencilRef || stencilBackRef != mCurStencilBackRef)
    {
        ...
        ASSERT((depthStencilState.stencilWritemask & 0xFF) == (depthStencilState.stencilBackWritemask & 0xFF));
        ASSERT(stencilRef == stencilBackRef);
        ASSERT((depthStencilState.stencilMask & 0xFF) == (depthStencilState.stencilBackMask & 0xFF));
