                                           ...
                                           bool stencilBlit)
{
    ...
    // Remove flip from readRect to simplify further operations.
    ...
    bool wholeBufferCopy = !scissorNeeded && !colorMaskingNeeded &&
                           readRect.x == 0 && readRect.width == readSize.width && readRect.y == 0 &&
    ...
    ASSERT(!readRect.isFlippedX() && !readRect.isFlippedY());
    bool flipRequired = drawRect.isFlippedX() || drawRect.isFlippedY();
