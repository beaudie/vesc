                                     ...
                                     GLsizei instances)
{
    ...
    if (adjustedInstanceCount > 0)
    {
        if (mode == GL_POINTS && useInstancedPointSpriteEmulation)
        {
            ...
            // offsets.
            // We keep the original number of instances passed to the function because
            // ANGLE_multiview cannot be supported if this code path is taken.
            ASSERT(getNativeExtensions().multiview == false);
