...
{
    return createDevice(
        nullptr, mRequestedDriverType, nullptr, debug ? D3D11_CREATE_DEVICE_DEBUG : 0, mAvailableFeatureLevels.data(),
    ...
    if (!mCreatedWithDeviceEXT)
    {
        ...
        if (mCreateDebugDevice)
        {
            ...
            if (result == E_INVALIDARG && mAvailableFeatureLevels.size() > 1u && mAvailableFeatureLevels[0] == D3D_FEATURE_LEVEL_11_1)
            {
                ...
                // Try again without passing D3D_FEATURE_LEVEL_11_1 in case we have other feature levels to fall back on.
                // TODO: Remove hard-coding of FL11_1 in case we'll start using higher feature levels.
