...
gl::Error Renderer11::clearRenderTarget(RenderTargetD3D *renderTarget, gl::ColorF *clearValues)
{
    RenderTarget11 *renderTarget11     = GetAs<RenderTarget11>(renderTarget);
    const d3d11::RenderTargetView &rtv = renderTarget11->getRenderTargetView();
    float value[4] = {clearValues->red, clearValues->green, clearValues->blue, clearValues->alpha};
    mDeviceContext->ClearRenderTargetView(rtv.get(), value);
