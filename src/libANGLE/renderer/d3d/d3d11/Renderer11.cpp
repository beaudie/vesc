...
gl::Error Renderer11::createRenderTarget(int width, int height, GLenum format, GLsizei samples, RenderTargetD3D **outRT)
{
    ...
    if (width > 0 && height > 0)
    {
        ...
        if (bindDSV)
        {
            ...
            *outRT = new TextureRenderTarget11(dsv, texture, srv, format, formatInfo.angleFormat,
        ...
        else if (bindRTV)
        {
            ...
            *outRT = new TextureRenderTarget11(rtv, texture, srv, format, formatInfo.angleFormat,
                                               width, height, 1, supportedSamples);
    ...
    {
        *outRT = new TextureRenderTarget11(reinterpret_cast<ID3D11RenderTargetView *>(NULL),
