                                         ...
                                         uint8_t *pixelsOut)
{
    ...
    std::cout << "----readFromAttachment START\n";
    ...
    std::cout << "----CreateStagingTexture START\n";
    std::cout << textureHelper.getSampleCount() << std::endl;
    ...
    std::cout << "----CreateStagingTexture END\n";
    ...
    if (textureHelper.getTextureType() == GL_TEXTURE_2D && textureHelper.getSampleCount() > 1)
    {
        ...
        if (FAILED(result))
        {
            std::cout << "Failed to create resolve texture\n";
            return gl::Error(GL_OUT_OF_MEMORY,
    ...
    std::cout << "----CopySubresourceRegion START\n";
    ...
    ANGLE_TRY(error);
    std::cout << "----readFromAttachment END\n";
    return gl::NoError();
}
