...
void Renderer11::generateDisplayExtensions(egl::DisplayExtensions *outExtensions) const
{
    ...
    outExtensions->d3dTexture2DImage = true;
    ...
    const egl::AttributeMap &attribs)
{
    if (target == EGL_D3D_TEXTURE_2D_ANGLE)
    {
        ...
        EGLint mipLevel = attribs.getAsInt(EGL_D3D_TEXTURE_LEVEL_ANGLE, 0);
        ...
        {
            return egl::Error(EGL_BAD_PARAMETER, "Texture does not have enough mip levels.");
        }
