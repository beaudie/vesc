                                     ...
                                     ShaderExecutableD3D **outExecutable)
{
    switch (type)
    {
        case SHADER_VERTEX:
        {
            ...
            if (FAILED(result))
            {
                return gl::OutOfMemory() << "Failed to create vertex shader, result: 0x%X."
                                         << result;
            }
            ...
            if (!streamOutVaryings.empty())
            {
                ...
                if (FAILED(result))
                {
                    return gl::OutOfMemory() << "Failed to create steam output shader, result: 0x%X."
                                             << result;
                }
            }
        ...
        case SHADER_PIXEL:
        {
            ...
            if (FAILED(result))
            {
                return gl::OutOfMemory() << "Failed to create pixel shader, result: 0x%X."
                                         << result;
            }
        ...
        case SHADER_GEOMETRY:
        {
            ...
            if (FAILED(result))
            {
                return gl::OutOfMemory() << "Failed to create geometry shader, result: 0x%X."
                                         << result;
            }
        ...
        case SHADER_COMPUTE:
        {
            ...
            if (FAILED(result))
            {
                return gl::OutOfMemory() << "Failed to create compute shader, result: 0x%X."
                                         << result;
            }
