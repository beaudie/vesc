...
gl::Error Renderer11::setTexture(gl::SamplerType type, int index, gl::Texture *texture)
{
    ...
    if (texture)
    {
        ...
        textureState.baseLevel        = textureState.getEffectiveBaseLevel() + storage11->getTopLevel();
...
TextureImpl *Renderer11::createTexture(GLenum target, const gl::TextureState &state)
{
    switch(target)
    {
        case GL_TEXTURE_2D:
