...
static void CalculateConstantBufferParams(GLintptr offset, GLsizeiptr size, UINT *outFirstConstant, UINT *outNumConstants)
{
    ...
    *outNumConstants = rx::roundUp(size, (GLsizeiptr)256) / 16;
