...
void Renderer11::populateRenderer11DeviceCaps()
{
    ...
    // Some Intel cards (e.g. Intel HD Graphics 2000 found in Dell Optiplex 790) claim to support 16-bit textures
    // but fail basic tests with them. As a result, we shouldn't try to use 16-bit textures on Intel cards.
