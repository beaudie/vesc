...
void Renderer11::generateDisplayExtensions(egl::DisplayExtensions *outExtensions)
{
...
bool Renderer11::getShareHandleSupport()
{
    ...
    d3d11::ANGLED3D11DeviceType deviceType = d3d11::ANGLE_D3D11_DEVICE_TYPE_UNKNOWN;

    if (mCreatedWithDeviceEXT)
    {
        deviceType = d3d11::GetDeviceType(mDevice);
    ...
    else
    {
        if ((mRequestedDriverType == D3D_DRIVER_TYPE_SOFTWARE) ||
            ...
            (mRequestedDriverType == D3D_DRIVER_TYPE_NULL))
        {
            deviceType = d3d11::ANGLE_D3D11_DEVICE_TYPE_SOFTWARE_REF_OR_NULL;
        }

        if (mRequestedDriverType == D3D_DRIVER_TYPE_WARP)
        {
            deviceType = d3d11::ANGLE_D3D11_DEVICE_TYPE_WARP;
        }
    }
    ...
    else if (deviceType == d3d11::ANGLE_D3D11_DEVICE_TYPE_WARP)
    {
