                                              ...
                                              ShaderExecutableD3D **outExectuable)
{
    ...
    if (features.enableIEEEStrictness)
...
void Renderer11::generateWorkarounds(angle::FeaturesD3D *features) const
{
    d3d11::GenerateWorkarounds(mRenderer11DeviceCaps, mAdapterDescription, features);
