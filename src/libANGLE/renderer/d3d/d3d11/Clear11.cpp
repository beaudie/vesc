                                        ...
                                        const gl::FramebufferState &fboData)
{
    ...
    for (auto colorAttachmentIndex : fboData.getEnabledDrawBuffers())
    {
        ...
        ANGLE_TRY(attachment.getRenderTarget(context, gl::RenderTargetUse::DRAW, &renderTarget));
    ...
    if (clearParams.clearDepth || clearParams.clearStencil)
    {
        ...
        ANGLE_TRY(depthStencilAttachment->getRenderTarget(context, gl::RenderTargetUse::DRAW,
