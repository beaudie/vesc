      ...
      mBlendState(nullptr)
{
    ...
    // TODO: As a potential performance optimizations, evaluate use of a single color
    // floatClear shader that can be used where only one RT needs to be cleared or alpha
                                    ...
                                    const gl::FramebufferState &fboData)
{
    ...
    {
        case GL_FLOAT:
            // TODO: Evaluate performance impact of using a single-color clear instead of a
            // multi-color clear
