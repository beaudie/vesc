...
angle::Result Clear11::ensureResourcesInitialized(const gl::Context *context)
{
    ...
    mBlendStateKey.blendStateExt.mEnabledMask.reset();
    mBlendStateKey.blendStateExt.setColorMask(true, true, true, true);
    mBlendStateKey.blendStateExt.setEquations(GL_FUNC_ADD, GL_FUNC_ADD);
    mBlendStateKey.blendStateExt.setFactors(GL_ONE, GL_ZERO, GL_ONE, GL_ZERO);
                                        ...
                                        const gl::FramebufferState &fboData)
{
    ...
    ASSERT(mBlendStateKey.blendStateExt.mMaxDrawBuffers == D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT);
