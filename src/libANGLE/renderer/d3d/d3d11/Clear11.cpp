...
inline float AdjustAlphaFor1BitOutput(float alpha)
{
      ...
      mBlendState(nullptr)
{
    ...
    else
    {
        mFloatMultiColorClearShader =
            new ClearShader("Clear11 IL", g_VS_ClearAnyType_FL9, ArraySize(g_VS_ClearAnyType_FL9),
                            "Clear11 VS", g_PS_MultiColorClearFloat,
                            ArraySize(g_PS_MultiColorClearFloat), "Clear11 Float PS (multi color)");

        mFloatClearShader = new ClearShader(
            "Clear11 IL", g_VS_ClearAnyType_FL9, ArraySize(g_VS_ClearAnyType_FL9), "Clear11 VS",
