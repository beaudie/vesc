...
Clear11::ClearShader::ClearShader(const D3D11_INPUT_ELEMENT_DESC *ilDesc,
    ...
    : vertexShader(vsByteCode, vsSize, vsDebugName),
      pixelShader(psByteCode, psSize, psDebugName),
      inputLayout(new d3d11::LazyInputLayout(ilDesc, ilSize, vsByteCode, vsSize, ilDebugName))
{
}
      ...
      mBlendState(nullptr)
{
    ...
    const size_t inputLayoutArraySize = 1;
    ...
    {
        mFloatClearShader =
            new ClearShader(&inputLayout, inputLayoutArraySize, "Clear11 IL", g_VS_ClearAnyType,
    ...
    else
    {
        mFloatClearShader =
            new ClearShader(&inputLayout, inputLayoutArraySize, "Clear11 IL", g_VS_ClearAnyType,
                            ArraySize(g_VS_ClearAnyType), "Clear11 VS", g_PS_ClearFloat,
    ...
    if (renderer->isES3Capable())
    {
        mUintClearShader =
            new ClearShader(&inputLayout, inputLayoutArraySize, "Clear11 IL", g_VS_ClearAnyType,
                            ArraySize(g_VS_ClearAnyType), "Clear11 VS", g_PS_ClearUint,
                            ArraySize(g_PS_ClearUint), "Clear11 UINT PS");
        mIntClearShader =
            new ClearShader(&inputLayout, inputLayoutArraySize, "Clear11 IL", g_VS_ClearAnyType,
                            ArraySize(g_VS_ClearAnyType), "Clear11 VS", g_PS_ClearSint,
