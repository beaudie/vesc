...
Clear11::ClearShader::ClearShader(const BYTE *vsByteCode,
    ...
    : vertexShader(vsByteCode, vsSize, vsDebugName), pixelShader(psByteCode, psSize, psDebugName)
{
    // Null input layout
    inputLayout = nullptr;
}
                                    ...
                                    const gl::FramebufferState &fboData)
{
    ...
    if (mVertexBuffer.Get())
    {
        ...
        deviceContext->IASetVertexBuffers(0, 1, mVertexBuffer.GetAddressOf(), &vertexStride,
                                          &startIdx);
    }
    else
    {
