...
Clear11::ShaderManager::ShaderManager()
    : mIl9(),
      ...
      mPsFloat{CLEARPS(Float1), CLEARPS(Float2), CLEARPS(Float3), CLEARPS(Float4),
               CLEARPS(Float5), CLEARPS(Float6), CLEARPS(Float7), CLEARPS(Float8)},
      mPsUInt{CLEARPS(Uint1), CLEARPS(Uint2), CLEARPS(Uint3), CLEARPS(Uint4),
              CLEARPS(Uint5), CLEARPS(Uint6), CLEARPS(Uint7), CLEARPS(Uint8)},
      mPsSInt{CLEARPS(Sint1), CLEARPS(Sint2), CLEARPS(Sint3), CLEARPS(Sint4),
              CLEARPS(Sint5), CLEARPS(Sint6), CLEARPS(Sint7), CLEARPS(Sint8)}
{
}
