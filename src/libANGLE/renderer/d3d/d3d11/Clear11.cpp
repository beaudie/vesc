...
bool AllViewportOffsetsContainWholeNumbers(const std::vector<gl::Offset> &viewportOffsets)
{
                                    ...
                                    const gl::FramebufferState &fboData)
{
    ...
    if (clearParams.scissorEnabled)
    {
        ...
        ASSERT(AllViewportOffsetsContainWholeNumbers(*fboData.getViewportOffsets()));
            ...
            clearParams.scissor.height == 0)
        {
            ...
            // ANGLE_multiview spec. Scissor rect is outside the renderbuffer or is an empty rect.
            return gl::NoError();
        }
    ...
    // rects. If not scissors are necessary, then a single full-size clear is enough.
