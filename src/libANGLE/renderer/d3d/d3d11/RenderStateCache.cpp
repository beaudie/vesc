                                                        ...
                                                        const gl::BlendState &blendState)
{
    ...
    // When fbo has no attachment, the rtvMasks should be set to default value.
    // https://msdn.microsoft.com/en-us/library/windows/desktop/ff476462(v=vs.85).aspx
    // This workaround an Intel driver bug on D3D. When trvMasks is 0 and rendertarget
    // is not set, samples will pass out side of current viewport.
