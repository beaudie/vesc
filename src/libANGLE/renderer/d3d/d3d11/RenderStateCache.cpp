...
// scenarios.
const unsigned int RenderStateCache::kMaxBlendStates        = 1024;
const unsigned int RenderStateCache::kMaxRasterizerStates   = 1024;
const unsigned int RenderStateCache::kMaxDepthStencilStates = 1024;
const unsigned int RenderStateCache::kMaxSamplerStates      = 1024;
