...
{
    if ((mDirectRenderingEnabled != directRenderingActive) ||
        (directRenderingActive && (colorBufferHeight != mDirectRenderingColorBufferHeight)))
    {
        mDirectRenderingEnabled           = directRenderingActive;
                                 ...
                                 float zFar)
{
    ...
    mPixelConstants.viewScale[1] = mDirectRenderingEnabled ? 1.0f : -1.0f;
