    ...
    for (size_t dirtyBit : dirtyBits)
    {
        switch (dirtyBit)
        {
            ...
            case gl::State::DIRTY_BIT_IMAGE_BINDINGS:
                ...
                // https://bugs.chromium.org/p/angleproject/issues/detail?id=2814
                invalidateTexturesAndSamplers();
                break;
    ...
    for (auto dirtyBit : dirtyBitsCopy)
    {
        switch (dirtyBit)
        {
            ...
            case DIRTY_BIT_PROGRAM_UNIFORM_BUFFERS:
                ...
                break;
            case DIRTY_BIT_PROGRAM_ATOMIC_COUNTER_BUFFERS:
                // TODO: https://bugs.chromium.org/p/angleproject/issues/detail?id=1729
                break;
            case DIRTY_BIT_PROGRAM_SHADER_STORAGE_BUFFERS:
                // TODO: https://bugs.chromium.org/p/angleproject/issues/detail?id=1951
                break;
            case DIRTY_BIT_SHADERS:
