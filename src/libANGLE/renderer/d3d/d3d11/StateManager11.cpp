...
gl::Error StateManager11::syncUniformBuffers(const gl::Context *context, ProgramD3D *programD3D)
{
    ...
    gl::ShaderMap<unsigned int> shaderReservedUBOs = {};
    shaderReservedUBOs[gl::ShaderType::Vertex]     = reservedVertex;
    shaderReservedUBOs[gl::ShaderType::Fragment]   = reservedFragment;
