...
void StateManager11::setRenderTarget(ID3D11RenderTargetView *rtv, ID3D11DepthStencilView *dsv)
{
    if (rtv)
    {
        unsetConflictingView(gl::PipelineType::RenderPipeline, rtv, true);
    }

    if (dsv)
    {
        unsetConflictingView(gl::PipelineType::RenderPipeline, dsv, true);
    }
                                      ...
                                      ID3D11DepthStencilView *dsv)
{
    ...
    {
        unsetConflictingView(gl::PipelineType::RenderPipeline, rtvs[rtvIndex], true);
    }
                                          ...
                                          bool isRenderTarget)
{
    ...
    if (foundOne && (pipeline != conflictPipeline || isRenderTarget))
    {
        ...
        {
            case gl::PipelineType::RenderPipeline:
