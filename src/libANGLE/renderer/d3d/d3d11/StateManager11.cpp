                                          ...
                                          GLint baseVertex)
{
         ...
         ++iter)
    {
        ...
        if (*iter == DIRTY_BIT_GRAPHICS_SRVUAV_STATE)
        {
            iter.resetLaterBit(DIRTY_BIT_TEXTURE_AND_SAMPLER_STATE);
        }
