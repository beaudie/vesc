...
angle::Result StateManager11::getUAVsForShader(const gl::Context *context,
                                               ...
                                               UAVList *uavList)
{
    ANGLE_TRY(syncShaderStorageBuffersForShader(context, shaderType, uavList));
    ANGLE_TRY(setUAVsForRWImages(context, shaderType, uavList));
    ANGLE_TRY(syncAtomicCounterBuffersForShader(context, shaderType, uavList));
