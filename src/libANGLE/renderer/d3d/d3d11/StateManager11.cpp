...
gl::Error StateManager11::setRasterizerState(const gl::RasterizerState &rasterState)
{
    ...
    auto &stateCache = mRenderer->getStateCache();
    ...
    if (mCurPresentPathFastEnabled)
    {
        ...
        error =
            stateCache.getRasterizerState(modifiedRasterState, mCurScissorEnabled, &dxRasterState);
    }
    else
    {
        error = stateCache.getRasterizerState(rasterState, mCurScissorEnabled, &dxRasterState);
    }
