...
void StateManager11::setRenderTargetDesc(size_t width, size_t height, DXGI_FORMAT format)
{
    mRenderTargetDesc.width  = width;
    mRenderTargetDesc.height = height;
    mRenderTargetDesc.format = format;
}
...
void StateManager11::setViewport(const gl::Rectangle &viewport,
                                 float zNear,
                                 float zFar,
                                 GLenum drawMode,
                                 GLenum frontFace,
