...
{
    const gl::FramebufferAttachment *firstColorBuffer = framebufferObject->getFirstColorbuffer();
    const int colorBufferHeight                       = firstColorBuffer ? firstColorBuffer->getSize().height : 0;
