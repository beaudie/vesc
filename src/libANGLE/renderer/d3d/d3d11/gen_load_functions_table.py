...
def get_function_maps_string(typeFunction):
...
def get_unknown_format_string(json_data, internal_format_item, dxgi_unknown_string):
    ...
    for typeFunction in json_data[internal_format_item][dxgi_unknown_string]:
        table_data += get_function_maps_string(typeFunction)
...
def parse_json_into_switch_string(json_data):
    ...
    for internal_format_item in json_data:
        ...
        unknown_format_string = get_unknown_format_string(json_data, internal_format_item, dxgi_format_unknown);
        for dxgi_format_item in json_data[internal_format_item]:
            ...
            # If there is an unknown format in the list,
            # we want to add its elements to the end of all the other formats
