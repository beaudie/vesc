...
const std::map<GLenum, LoadImageFunctionInfo> &GetLoadFunctionsMap(GLenum {internal_format}, DXGI_FORMAT {dxgi_format})
{{
    // clang-format off
...
def load_function_maps_string(typeFunction):
    return '                    loadFunctionsMap.insert(std::make_pair(' + typeFunction['type'] + ', LoadImageFunctionInfo(' + typeFunction['loadFunction'] + ', ' + typeFunction['requiresConversion'] + ')));\n'
...
def parse_json_into_switch_string(json_data):
    ...
    for internal_format_item in json_data:
        ...
        for dxgi_format_item in json_data[internal_format_item]:
            ...
            table_data += '                {\n'
            table_data += '                    static std::map<GLenum, LoadImageFunctionInfo> loadFunctionsMap;\n'
