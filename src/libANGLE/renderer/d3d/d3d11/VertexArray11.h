...
class VertexArray11 : public VertexArrayImpl
{
  public:
    ...
    // Does not apply any state updates - these are done in syncStateInternal which as access to
    ...
    gl::Error syncStateInternal(const gl::Context *context,
  ...
  private:
    ...
    // Dirty bits set mask for static attributes.
    // These attributes need to be updated when buffer data changes.
    gl::VertexArray::DirtyBits mStaticDirtyBitsMask;
