...
bool ShaderD3D::postTranslateCompile(gl::Compiler *compiler, std::string *infoLog)
{
    ...
    mUsesWorkGroupSize         = translatedSource.find("GL_USES_WORK_GROUP_SIZE") != std::string::npos;
    mUsesWorkGroupID           = translatedSource.find("GL_USES_WORK_GROUP_ID") != std::string::npos;
    mUsesLocalInvocationID     = translatedSource.find("GL_USES_LOCAL_INVOCATION_ID") != std::string::npos;
    mUsesGlobalInvocationID    = translatedSource.find("GL_USES_GLOBAL_INVOCATION_ID") != std::string::npos;
    mUsesLocalInvocationIndex  = translatedSource.find("GL_USES_LOCAL_INVOCATION_INDEX") != std::string::npos;
