...
struct D3DUniform : private angle::NonCopyable
{
    ...
    // TODO: This is probably being misused for arrays of arrays.
    unsigned int elementCount() const { return isArray() ? arraySizes.back() : 1u; }
...
class ProgramD3D : public ProgramImpl
{
  ...
  private:
    ...
    void defineUniformStructFields(GLenum shaderType,
                                   const std::vector<sh::ShaderVariable> &fields,
                                   const std::string &namePrefix,
                                   sh::HLSLBlockEncoder *encoder,
                                   D3DUniformMap *uniformMap);
    void defineUniformStructArrayFields(GLenum shaderType,
