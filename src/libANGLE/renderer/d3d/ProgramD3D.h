...
class ProgramD3D : public ProgramImpl
{
  public:
    ...
    void updateShaderStorageBufferCache(
        const gl::Caps &caps,
    ...
    const std::vector<GLint> &getShaderStorageBufferCache(gl::ShaderType shaderType) const;
  ...
  private:
    ...
    gl::ShaderMap<std::vector<int>> mShaderSSBOCaches;
