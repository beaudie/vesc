...
class ProgramD3D : public ProgramImpl
{
  public:
    ...
    GLint getSamplerMapping(ShaderType type, unsigned int samplerIndex, const gl::Caps &caps) const;
    GLenum getSamplerTextureType(ShaderType type, unsigned int samplerIndex) const;
    GLuint getUsedSamplerRange(ShaderType type) const;
    ...
    GLint getReadonlyImageMapping(ShaderType type,
                                  unsigned int imageIndex,
                                  const gl::Caps &caps) const;
    GLint getImageMapping(ShaderType type, unsigned int imageIndex, const gl::Caps &caps) const;
    GLuint getUsedReadonlyImageRange(ShaderType type) const;
    GLuint getUsedImageRange(ShaderType type) const;
    GLenum getReadonlyImageTextureType(ShaderType type, unsigned int imageIndex) const;
    GLenum getImageTextureType(ShaderType type, unsigned int imageIndex) const;
  ...
  private:
    ...
    void assignImageRegisters(D3DUniform *d3dUniform);
