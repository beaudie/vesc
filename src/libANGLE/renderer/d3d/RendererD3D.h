...
class RendererD3D : public Renderer
{
  public:
    ...
    virtual gl::Error applyVertexBuffer(const gl::State &state, GLenum mode, GLint first, GLsizei count, GLsizei instances, UntranslatedIndexData *indexInfo) = 0;
  ...
  protected:
    ...
    virtual gl::Error drawElements(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices,
                                   gl::Buffer *elementArrayBuffer, const TranslatedIndexData &indexInfo, GLsizei instances, bool usesPointSize) = 0;
