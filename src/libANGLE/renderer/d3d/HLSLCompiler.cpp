...
#    endif  // ANGLE_PRELOADED_D3DCOMPILER_MODULE_NAMES
    ...
    if (!mD3DCompilerModule)
    {
        ...
        if (mD3DCompilerModule)
        {
            ANGLE_HISTOGRAM_ENUMERATION("GPU.ANGLE.D3DCompilerLoadLibraryResult",
                                        D3DCompilerLoadLibraryResult::DefaultLibrarySuccess,
                                        D3DCompilerLoadLibraryResult::EnumBoundary);
        }
        else
        {
            ...
            {
                ANGLE_HISTOGRAM_ENUMERATION("GPU.ANGLE.D3DCompilerLoadLibraryResult",
                                            D3DCompilerLoadLibraryResult::OldLibrarySuccess,
                                            D3DCompilerLoadLibraryResult::EnumBoundary);
            }
        }
    }
    ...
    if (!mD3DCompilerModule)
    {
        ...
        ANGLE_HISTOGRAM_ENUMERATION("GPU.ANGLE.D3DCompilerLoadLibraryResult",
                                    D3DCompilerLoadLibraryResult::Failure,
                                    D3DCompilerLoadLibraryResult::EnumBoundary);
