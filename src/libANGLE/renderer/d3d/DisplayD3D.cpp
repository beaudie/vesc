...
std::vector<Renderer *> DisplayD3D::getCandidateRenderers(egl::Display *display,
                                                          EGLNativeDisplayType nativeDisplay,
                                                          EGLint requestedDisplayType)
{
    std::vector<Renderer *> renderersOut;
...
#   if defined(ANGLE_ENABLE_D3D11)
        ...
        {
            renderersOut.push_back(new Renderer11(display));
        }
#   endif
...
#   if defined(ANGLE_ENABLE_D3D9)
        ...
        {
            renderersOut.push_back(new Renderer9(display));
        }
#   endif
...
void DisplayD3D::initialize(Renderer *newRenderer)
{
    ASSERT(mRenderer == nullptr && newRenderer != nullptr);
    mRenderer = static_cast<RendererD3D*>(newRenderer);
}
