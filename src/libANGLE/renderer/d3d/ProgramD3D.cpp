  ...
  public:
    LinkEventRenderingProgram(gl::InfoLog &infoLog,
        ...
        : mInfoLog(infoLog),
          ...
          mWaitEvents(
              {{std::unique_ptr<WaitableEvent>(workerPool->postWorkerTask(vertexTask.get())),
                std::unique_ptr<WaitableEvent>(workerPool->postWorkerTask(pixelTask.get())),
                std::unique_ptr<WaitableEvent>(workerPool->postWorkerTask(geometryTask.get()))}}),
          mUseGS(useGS),
