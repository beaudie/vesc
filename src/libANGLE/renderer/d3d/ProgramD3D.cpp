                                   ...
                                   D3DUniformMap *uniformMap)
{
    ...
    {
        defineUniform(shader->getType(), uniform, uniform.name, RegisterType::t, nullptr,
                      uniformMap);
        return;
    }
    else if (gl::IsImageType(uniform.type))
    {
        ...
        {
            defineUniform(shader->getType(), uniform, uniform.name, RegisterType::u, nullptr,
                          uniformMap);
        }
...
void ProgramD3D::assignImageRegisters(size_t uniformIndex)
{
    ...
    if (computeShader)
    {
        ...
        if (d3dUniform->regType == RegisterType::t)
        {
        ...
        else if (d3dUniform->regType == RegisterType::u)
        {
            AssignImages(d3dUniform->csRegisterIndex, bindingIter->second,
