...
gl::Error ProgramD3D::getPixelExecutableForFramebuffer(const gl::ContextState &data,
                                                       ...
                                                       ShaderExecutableD3D **outExecutable)
{
    ...
    const gl::AttachmentList &colorbuffers = fboD3D->getColorAttachmentsForRender(data);
