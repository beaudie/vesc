                                                 ...
                                                 gl::InfoLog &infoLog)
{
    ...
    std::array<WaitableEvent, 3> waitEvents;
    waitEvents[0] = workerPool->postWorkerTask(&vertexTask);
    waitEvents[1] = workerPool->postWorkerTask(&pixelTask);
    waitEvents[2] = workerPool->postWorkerTask(&geometryTask);
