...
void ProgramD3D::defineUniformsAndAssignRegisters()
{
    ...
    mUsedReadonlyImageRange[gl::ShaderType::Fragment] =
        gl::RangeUI(mUsedShaderSamplerRanges[gl::ShaderType::Fragment].high(),
                    mUsedShaderSamplerRanges[gl::ShaderType::Fragment].high());
    ...
    mUsedImageRange[gl::ShaderType::Fragment] =
        gl::RangeUI(mUsedAtomicCounterRange[gl::ShaderType::Fragment].high(),
                    mUsedAtomicCounterRange[gl::ShaderType::Fragment].high());
