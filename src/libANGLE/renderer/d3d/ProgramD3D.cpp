...
LinkEvent *ProgramD3D::compileProgramExecutables(const gl::Context *context, gl::InfoLog &infoLog)
{
    ...
    return new LinkEventRendering(infoLog, workerPool, vertexTask, pixelTask, geometryTask, useGS,
