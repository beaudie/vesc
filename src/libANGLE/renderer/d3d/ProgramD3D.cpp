...
ProgramD3D::Sampler::Sampler() : active(false), logicalTextureUnit(0), textureType(gl::TextureType::_2D)
{
}
...
gl::TextureType ProgramD3D::getSamplerTextureType(gl::ShaderType type, unsigned int samplerIndex) const
{
    switch (type)
    {
        case gl::SHADER_FRAGMENT:
