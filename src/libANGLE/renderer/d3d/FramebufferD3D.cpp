                                         ...
                                         void *pixels)
{
    ...
    ANGLE_CHECK_HR_MATH(
        contextD3D, sizedFormatInfo.computeRowPitch(type, clippedArea.width, packState.alignment,
    ...
    outputSkipBytes += (clippedArea.x - clippedArea.x) * sizedFormatInfo.pixelBytes +
                       (clippedArea.y - clippedArea.y) * outputPitch;
