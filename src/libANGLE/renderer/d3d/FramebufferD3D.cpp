...
gl::Error FramebufferD3D::clear(const ContextImpl *context, GLbitfield mask)
{
    ClearParameters clearParams = GetClearParameters(context->getState(), mask);
    return clearImpl(context, clearParams);
}

gl::Error FramebufferD3D::clearBufferfv(const ContextImpl *context,
                                        GLenum buffer,
                                        GLint drawbuffer,
...
gl::Error FramebufferD3D::clearBufferuiv(const ContextImpl *context,
                                         GLenum buffer,
                                         GLint drawbuffer,
                                         const GLuint *values)
{
...
gl::Error FramebufferD3D::clearBufferiv(const ContextImpl *context,
                                        GLenum buffer,
                                        GLint drawbuffer,
                                        const GLint *values)
{
...
gl::Error FramebufferD3D::clearBufferfi(const ContextImpl *context,
                                        GLenum buffer,
                                        GLint drawbuffer,
                                        GLfloat depth,
                                        GLint stencil)
...
gl::Error FramebufferD3D::readPixels(const ContextImpl *context,
...
gl::Error FramebufferD3D::blit(const ContextImpl *context,
