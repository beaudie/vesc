...
gl::Error FramebufferD3D::getDefaultHeight(GLint *defaultHeight)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultHeight is unimplemented.";
}

gl::Error FramebufferD3D::getDefaultWidth(GLint *defaultWidth)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultWidth is unimplemented.";
}

gl::Error FramebufferD3D::getDefaultSamples(GLint *defaultSamples)
{
    UNIMPLEMENTED();
    return gl::InternalError() << "getDefaultSamples is unimplemented.";
}

gl::Error FramebufferD3D::getDefaultFixedSampleLocations(GLint *defaultFixedSampleLocations)
{
    UNIMPLEMENTED();
