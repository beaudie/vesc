...
GLenum FramebufferD3D::getImplementationColorReadFormat() const
{
    ...
    GLenum actualFormat = getRenderTargetImplementationFormat(attachmentRenderTarget);
    const gl::InternalFormat &implementationFormatInfo = gl::GetInternalFormatInfo(actualFormat);
