                                          ...
                                          std::vector<PixelShaderOutputVariable> *outPixelShaderKey)
{
    ...
    else
    {
        ...
        for (auto outputPair : programData.getOutputLocations())
        {
            ...
            ASSERT(outputLocation.arrayElementIndices.size() <= 1u);
            const std::string &elementString =
                (outputLocation.arrayElementIndices.empty()
                     ? ""
                     : Str(outputLocation.arrayElementIndices.back()));
            ...
            outputKeyVariable.source =
                variableName + ArrayIndexString(outputLocation.arrayElementIndices);
