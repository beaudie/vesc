                                         ...
                                         bool *outUsesFragDepth) const
{
    ...
    const SemanticInfo &vertexSemantics = GetSemanticInfo(
        SHADER_VERTEX, shaderVersion, registerCount, outputPositionFromVS, usesFragCoord,
    ...
    const SemanticInfo &pixelSemantics = GetSemanticInfo(
        SHADER_PIXEL, shaderVersion, registerCount, outputPositionFromVS, usesFragCoord,
