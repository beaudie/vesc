                                          ...
                                          std::ostringstream &hlslStream) const
{
    ...
    {
        hlslStream << "    uint gl_ViewID_OVR : " << builtins.glViewIDOVR.str() << ";\n";
    }
                                                        ...
                                                        const bool usesViewID) const
{
    ...
    if (builtinsD3D[SHADER_GEOMETRY].glViewportIndex.enabled && usesViewID)
    {
        preambleStream << "\n"
                                        ...
                                        const VaryingPacking &packing)
{
    ...
    if (shaderType == SHADER_VERTEX && metadata.usesViewID())
    {
    ...
    if (shaderType == SHADER_GEOMETRY && metadata.usesViewID())
    {
