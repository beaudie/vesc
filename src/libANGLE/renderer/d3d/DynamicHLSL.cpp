    ...
    const std::vector<sh::Attribute> &shaderAttributes) const
{
    ...
    // TODO: With separable shaders, the substring may not exist
    (void)angle::ReplaceSubstring(&vertexHLSL, VERTEX_ATTRIBUTE_STUB_STRING, structStream.str());
    ...
    const std::vector<GLenum> &outputLayout) const
{
    ...
    // TODO: With separable shaders, the substring may not exist
    (void)angle::ReplaceSubstring(&pixelHLSL, PIXEL_OUTPUT_STUB_STRING, declarationStream.str());
