...
std::string ShaderStorageBlockHeader(gl::Shader *shader, size_t baseUAVRegister)
{
    ...
    gl::Shader *shader) const
{
    ...
    std::string ssboHeader = ShaderStorageBlockHeader(shader, inputLayout.size());
    success = angle::ReplaceSubstring(&vertexHLSL, kShaderStorageDeclarationString, ssboHeader);
    ASSERT(success);
    ...
    gl::Shader *shader) const
{
    ...
    std::string ssboHeader = ShaderStorageBlockHeader(shader, numOutputs);
    success = angle::ReplaceSubstring(&pixelHLSL, kShaderStorageDeclarationString, ssboHeader);
    ASSERT(success);
