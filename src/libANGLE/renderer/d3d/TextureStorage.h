...
{
  public:
    TextureStorage() : mDirtyChannel(nullptr) {}
    ...
    // Only used in D3D11.
    void setDirtyChannel(const angle::BroadcastChannel *dirtyChannel);

  protected:
    const angle::BroadcastChannel *mDirtyChannel;
};
...
inline void TextureStorage::setDirtyChannel(const angle::BroadcastChannel *dirtyChannel)
{
