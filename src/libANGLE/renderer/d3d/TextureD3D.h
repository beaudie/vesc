...
class TextureD3D : public TextureImpl
{
  ...
  protected:
    ...
    virtual gl::Error createCompleteStorage(
        bool renderTarget,
        std::unique_ptr<TextureStorage> *outTexStorage) const = 0;
    ...
    bool mImmutable;
    std::unique_ptr<TextureStorage> mTexStorage;
...
class TextureD3D_2D : public TextureD3D
{
  ...
  private:
    ...
    gl::Error createCompleteStorage(bool renderTarget,
                                    std::unique_ptr<TextureStorage> *outTexStorage) const override;
...
class TextureD3D_3D : public TextureD3D
{
  ...
  private:
    gl::Error initializeStorage(const gl::Context *context, bool renderTarget) override;
    gl::Error createCompleteStorage(bool renderTarget,
                                    std::unique_ptr<TextureStorage> *outStorage) const override;
    gl::Error setCompleteTexStorage(const gl::Context *context,
                                    TextureStorage *newCompleteTexStorage) override;
