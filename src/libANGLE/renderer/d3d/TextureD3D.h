...
{
  public:
    TextureD3D(RendererD3D *renderer, const gl::TextureState &data);
    virtual ~TextureD3D();
...
{
  public:
    TextureD3D_2D(RendererD3D *renderer, const gl::TextureState &data);
...
{
  public:
    TextureD3D_Cube(RendererD3D *renderer, const gl::TextureState &data);
...
{
  public:
    TextureD3D_3D(RendererD3D *renderer, const gl::TextureState &data);
...
{
  public:
    TextureD3D_2DArray(RendererD3D *renderer, const gl::TextureState &data);
...
{
  public:
    TextureD3D_External(RendererD3D *renderer, const gl::TextureState &data);
