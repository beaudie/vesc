...
std::string DynamicImage2DHLSL::generateComputeShaderForImage2DBindSignature(
    ...
    const gl::ImageUnitTextureTypeMap &image2DBoundLayout)
{
    ...
    {
        outputHLSLImage2DUniformGroup(programD3D, programData, out, Image2DHLSLGroup(groupId),
                                      groupedImage2DUniforms[groupId], image2DBoundLayout,
                                      &groupTextureRegisterIndex, &groupRWTextureRegisterIndex,
                                      &image2DTexture3DIndex, &image2DTexture2DArrayIndex,
