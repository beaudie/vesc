        ...
        case GL_IMAGE_2D:
        {
            switch (format)
            {
                ...
                case GL_RGBA8:
                    return readonly
                               ? IMAGE2D_R_UNORM
                               : (globallyCoherent ? IMAGE2D_W_UNORM_COHERENT : IMAGE2D_W_UNORM);
                case GL_RGBA8_SNORM:
                    return readonly
                               ? IMAGE2D_R_SNORM
                               : (globallyCoherent ? IMAGE2D_W_SNORM_COHERENT : IMAGE2D_W_SNORM);
                default:
                    UNREACHABLE();
            ...
            switch (format)
            {
                ...
                case GL_R32I:
                    return readonly ? IMAGE2D_R_INT4
                                    : (globallyCoherent ? IMAGE2D_W_INT4_COHERENT : IMAGE2D_W_INT4);
                default:
                    UNREACHABLE();
                    return IMAGE2D_UNKNOWN;
            }
        ...
        case GL_UNSIGNED_INT_IMAGE_2D:
        {
            switch (format)
            {
                ...
                case GL_R32UI:
                    return readonly
                               ? IMAGE2D_R_UINT4
                               : (globallyCoherent ? IMAGE2D_W_UINT4_COHERENT : IMAGE2D_W_UINT4);
                default:
                    UNREACHABLE();
                    return IMAGE2D_UNKNOWN;
            }
