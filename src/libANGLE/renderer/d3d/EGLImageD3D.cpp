...
EGLImageD3D::EGLImageD3D(RendererD3D *renderer, EGLenum target, egl::ImageSibling *buffer, const egl::AttributeMap &attribs)
    : mRenderer(renderer),
      mBuffer(buffer),
...
void EGLImageD3D::orphan(egl::ImageSibling *sibling)
{
    if (sibling == mBuffer)
    {
