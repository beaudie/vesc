...
class BufferD3D : public BufferImpl
{
  public:
    ...
    virtual gl::Error initializeStaticData(const gl::Context *context);
    virtual gl::Error invalidateStaticData(const gl::Context *context);

    gl::Error promoteStaticUsage(const gl::Context *context, int dataSize);
  ...
  protected:
    void updateSerial();
    gl::Error updateD3DBufferUsage(const gl::Context *context, GLenum usage);
