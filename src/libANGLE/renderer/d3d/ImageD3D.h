...
class ImageD3D : angle::NonCopyable
{
  public:
    ...
    virtual gl::Error setManagedSurface2D(TextureStorage *storage, int level) { return gl::NoError(); };
    virtual gl::Error setManagedSurfaceCube(TextureStorage *storage, int face, int level) { return gl::NoError(); };
    virtual gl::Error setManagedSurface3D(TextureStorage *storage, int level) { return gl::NoError(); };
    virtual gl::Error setManagedSurface2DArray(TextureStorage *storage, int layer, int level) { return gl::NoError(); };
