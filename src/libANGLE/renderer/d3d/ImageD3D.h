...
class ImageD3D
{
  public:
    ...
    virtual bool redefine(RendererD3D *renderer, GLenum target, GLenum internalformat, const gl::Extents &size, bool forceRelease) = 0;
    ...
    gl::Error copy(const gl::Extents &destOffset, const gl::Rectangle &sourceArea, const gl::Framebuffer *source);
  ...
  private:
    ...
    virtual gl::Error copy(const gl::Extents &destOffset, const gl::Rectangle &sourceArea, RenderTargetD3D *source) = 0;
};
