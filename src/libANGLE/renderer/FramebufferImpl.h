...
class FramebufferImpl : angle::NonCopyable
{
  public:
    ...
    virtual gl::Error clear(const rx::ContextImpl *context, GLbitfield mask) = 0;
    virtual gl::Error clearBufferfv(const ContextImpl *context,
                                    GLenum buffer,
                                    GLint drawbuffer,
                                    const GLfloat *values) = 0;
    virtual gl::Error clearBufferuiv(const ContextImpl *context,
                                     GLenum buffer,
                                     GLint drawbuffer,
                                     const GLuint *values) = 0;
    virtual gl::Error clearBufferiv(const ContextImpl *context,
                                    GLenum buffer,
                                    GLint drawbuffer,
                                    const GLint *values) = 0;
    virtual gl::Error clearBufferfi(const ContextImpl *context,
                                    GLenum buffer,
                                    GLint drawbuffer,
                                    GLfloat depth,
                                    GLint stencil) = 0;
    ...
    virtual gl::Error readPixels(const rx::ContextImpl *context,
                                 const gl::Rectangle &area,
                                 GLenum format,
                                 GLenum type,
                                 GLvoid *pixels) const = 0;

    virtual gl::Error blit(const rx::ContextImpl *context,
