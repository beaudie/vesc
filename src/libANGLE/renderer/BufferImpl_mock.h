...
class MockBufferImpl : public BufferImpl
{
  public:
    ...
    MOCK_METHOD(angle::Result,
                copySubData,
                (const gl::Context *, BufferImpl *, GLintptr, GLintptr, GLsizeiptr),
                (override));
    MOCK_METHOD(angle::Result, map, (const gl::Context *, GLenum, void **), (override));
    MOCK_METHOD(angle::Result,
                mapRange,
                (const gl::Context *, size_t, size_t, GLbitfield, void **),
                (override));
    MOCK_METHOD(angle::Result, unmap, (const gl::Context *, GLboolean *), (override));
