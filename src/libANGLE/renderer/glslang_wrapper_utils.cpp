                            ...
                            ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    if (!programExecutable.hasLinkedShaderStage(gl::ShaderType::Compute))
    {
        ...
        {
            AssignTransformFeedbackExtensionQualifiers(programExecutable, varyingPacking,
                                                       shaderType, variableInfoMapOut);
        }
    }
                            ...
                            ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    if (!xfbSource->empty())
    {
        if (!programState.getLinkedTransformFeedbackVaryings().empty())
        {
            if (options.supportsTransformFeedbackExtension)
            {
                GenerateTransformFeedbackExtensionOutputs(programState, resources, xfbSource);
            }
