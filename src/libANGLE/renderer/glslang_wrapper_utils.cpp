                                               ...
                                               ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    xfbOut << "if (" << driverUniforms
           << ".xfbActiveUnpaused != 0)\n{\n"
              "uint xfbIndex = gl_VertexIndex + gl_InstanceIndex * "
           << driverUniforms << ".xfbVerticesPerDraw;\nuvec4 xfbOffsets = uvec4(";
    for (size_t bufferIndex = 0; bufferIndex < bufferCount; ++bufferIndex)
    {
        ...
        xfbOut << driverUniforms << ".xfbBufferOffsets[" << bufferIndex << "] + xfbIndex * "
               << bufferStrides[bufferIndex] / 4;
    }
