                                   ...
                                   ShaderInterfaceVariableInfoMap *variableInfoMapOut)
{
    ...
    bool needToIncreaseBindingIndex = false;
    ...
    for (unsigned int uniformIndex : inputAttachmentUniformRange)
    {
            ...
            inputAttachmentUniform.isActive(shaderType))
        {
            const uint32_t inputAttachmentBindingIndex =
                baseInputAttachmentBindingIndex + inputAttachmentUniform.inputAttachmentIndex;
            ...
            needToIncreaseBindingIndex = true;
        }
    }

    if (needToIncreaseBindingIndex)
    {
