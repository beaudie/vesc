...
{
    // If this extension can be enabled with glEnableExtension (GL_ANGLE_webgl_compatability)
    bool Enableable;

    // Pointer to a boolean member of the Extensions struct
    typedef bool(Extensions::*ExtensionBool);
    ExtensionBool ExtensionsMember;
};
...
struct DisplayExtensions
{
    ...
    bool createContextWebGLCompatability;
};
