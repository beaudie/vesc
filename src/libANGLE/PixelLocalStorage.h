...
class PixelLocalStoragePlane : angle::NonCopyable
{
  public:
    ...
    void getClearValuef(GLfloat value[4]) { memcpy(value, mClearValuef.data(), 4 * 4); }
    void getClearValuei(GLint value[4]) { memcpy(value, mClearValuei.data(), 4 * 4); }
    void getClearValueui(GLuint value[4]) { memcpy(value, mClearValueui.data(), 4 * 4); }
