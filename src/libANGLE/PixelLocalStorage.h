...
class PixelLocalStoragePlane : angle::NonCopyable
{
  public:
    ...
    // Clears the draw buffer at 0-based index 'drawbuffer' on the current framebuffer, using either
    // zero if 'loadop' is GL_ZERO, or 'data' if 'loadop' is GL_CLEAR_ANGLE.
    //
