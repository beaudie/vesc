...
class PixelLocalStoragePlane
{
  public:
    ...
    void setTextureBacked(Context *, const ImageIndex &textureIndex, Texture *);
...
class PixelLocalStorage
{
  public:
    ...
    void setTextureBacked(Context *angle,
                          GLint plane,
                          const ImageIndex &textureIndex,
                          Texture *textureObject)
    {
        growPlanesToFit(plane).setTextureBacked(angle, textureIndex, textureObject);
    }
