...
bool ValidateActiveShaderProgram(Context *context, GLuint pipeline, ProgramID programPacked);
...
bool ValidateProgramUniform1fv(Context *context,
                               ...
                               GLsizei count,
                               const GLfloat *value);
bool ValidateProgramUniform1i(Context *context, ProgramID programPacked, GLint location, GLint v0);
