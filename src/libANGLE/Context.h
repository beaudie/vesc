...
class Context final : public egl::LabeledObject, angle::NonCopyable, public angle::ObserverInterface
{
  public:
    ...
    // Important note:
    //   Theoretically it is possible that this Context will continue to use "DummyContextMutex" in
    ...
    //   For absolute 100% safety "DummyContextMutex" should not be used.
  ...
  private:
    ...
    // If "DummyContextMutex" is locked - start using, activates, and
