...
class Context final : public ValidationContext
{
  public:
    ...
    egl::Error destroy(const egl::Thread *thread);
    ~Context() override;

    egl::Error makeCurrent(const egl::Thread *thread, egl::Surface *surface);
    egl::Error releaseSurface(const egl::Thread *thread);
