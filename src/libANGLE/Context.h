...
class Context final : public egl::LabeledObject, angle::NonCopyable, public angle::ObserverInterface
{
  public:
    ...
    void drawArrays(const DrawCallParams &params);
    void drawArraysInstanced(const DrawCallParams &params);

    void drawElements(const DrawCallParams &params);
    void drawElementsInstanced(const DrawCallParams &params);
    void drawRangeElements(GLuint start, GLuint end, const DrawCallParams &params);
    void drawArraysIndirect(const DrawCallParams &params);
    void drawElementsIndirect(const DrawCallParams &params);
