...
class Context final : public ValidationContext
{
  public:
    ...
    void getBufferParameteriv(BufferTarget target, GLenum pname, GLint *params);
    ...
    void getBufferPointerv(BufferTarget target, GLenum pname, void **params);
    void *mapBuffer(BufferTarget target, GLenum access);
    GLboolean unmapBuffer(BufferTarget target);
    void *mapBufferRange(BufferTarget target,
                         GLintptr offset,
                         GLsizeiptr length,
                         GLbitfield access);
    void flushMappedBufferRange(BufferTarget target, GLintptr offset, GLsizeiptr length);
    ...
    void bufferData(BufferTarget target, GLsizeiptr size, const void *data, BufferUsage usage);
    void bufferSubData(BufferTarget target, GLintptr offset, GLsizeiptr size, const void *data);
    ...
    void bindBufferRange(BufferTarget target,
                         GLuint index,
                         GLuint buffer,
                         GLintptr offset,
                         GLsizeiptr size);
    ...
    void copyBufferSubData(BufferTarget readTarget,
    ...
    void getBufferParameteri64v(BufferTarget target, GLenum pname, GLint64 *params);
