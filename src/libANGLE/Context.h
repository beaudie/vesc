...
class Context final : angle::NonCopyable
{
  public:
    ...
    void getTexParameterivRobust(TextureType target,
                                 ...
                                 GLsizei *length,
                                 GLint *params);
    void getTexParameterIivRobust(GLenum target,
                                  GLenum pname,
                                  GLsizei bufSize,
                                  GLsizei *length,
                                  GLint *params);

    void getTexParameterIuivRobust(GLenum target,
                                   GLenum pname,
                                   GLsizei bufSize,
                                   GLsizei *length,
                                   GLuint *params);
    ...
    void getTexLevelParameterivRobust(GLenum target,
                                      GLint level,
                                      GLenum pname,
                                      GLsizei bufSize,
                                      GLsizei *length,
    ...
    void getTexLevelParameterfvRobust(GLenum target,
                                      GLint level,
                                      GLenum pname,
                                      GLsizei bufSize,
                                      GLsizei *length,
    ...
    void texParameterivRobust(TextureType target,
                              ...
                              GLsizei bufSize,
                              const GLint *params);
    void texParameterIivRobust(GLenum target, GLenum pname, GLsizei bufSize, const GLint *params);
    void texParameterIuivRobust(GLenum target, GLenum pname, GLsizei bufSize, const GLuint *params);
    ...
    void getPointervRobust(GLenum pname, GLsizei bufSize, GLsizei *length, void **params);
