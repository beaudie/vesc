...
class Context final : public ValidationContext
{
  public:
    ...
    void getBufferParameteriv(BufferType target, GLenum pname, GLint *params);
    ...
    void getBufferPointerv(BufferType target, GLenum pname, void **params);
    void *mapBuffer(BufferType target, GLenum access);
    GLboolean unmapBuffer(BufferType target);
    void *mapBufferRange(BufferType target, GLintptr offset, GLsizeiptr length, GLbitfield access);
    void flushMappedBufferRange(BufferType target, GLintptr offset, GLsizeiptr length);
    ...
    void bufferData(BufferType target, GLsizeiptr size, const void *data, BufferUsage usage);
    void bufferSubData(BufferType target, GLintptr offset, GLsizeiptr size, const void *data);
    void attachShader(GLuint program, GLuint shader);
    void bindAttribLocation(GLuint program, GLuint index, const GLchar *name);
    void bindBuffer(BufferType target, GLuint buffer);
    void bindBufferBase(BufferType target, GLuint index, GLuint buffer);
    void bindBufferRange(BufferType target,
                         GLuint index,
                         GLuint buffer,
                         GLintptr offset,
                         GLsizeiptr size);
    ...
    void copyBufferSubData(BufferType readTarget,
    ...
    void getBufferParameteri64v(BufferType target, GLenum pname, GLint64 *params);
