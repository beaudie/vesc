...
class Context final : public egl::LabeledObject, angle::NonCopyable, public angle::ObserverInterface
{
  public:
    ...
    bool isUsingSharedContextMutex() const;
    ...
    //   "kActivationDelayMicro" constant. Current value of "100" microseconds did not cause this
    //   problem during deliberate stress testing. However, if problem happens or extra safety is
    //   critical - increase the "kActivationDelayMicro".
