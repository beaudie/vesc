...
class Context : public ValidationContext
{
  ...
  private:
    ...
    void initGles1();
    void drawArrays_gles1(GLenum mode, GLint first, GLsizei count);
    void drawElements_gles1(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices);
