                                       ...
                                       const AttributeMap &attribMap)
{
    ...
    switch (platform)
    {
        case EGL_PLATFORM_ANGLE_ANGLE:
            ...
            {
                return egl::EglBadParameter() << "Platform ANGLE extension is not active";
            }
            break;
        case EGL_PLATFORM_DEVICE_EXT:
            if (!clientExtensions.platformDevice)
            {
                return egl::EglBadParameter() << "Platform Device extension is not active";
            }
            break;
        default:
            return egl::EglBadConfig() << "Bad platform type.";
    }
    ...
    if (platform == EGL_PLATFORM_ANGLE_ANGLE)
    {
            ...
            switch (curAttrib.first)
            {
                ...
                case EGL_PLATFORM_ANGLE_ENABLE_AUTOMATIC_TRIM_ANGLE:
                    switch (value)
                    {
                        ...
                        case EGL_FALSE:
                            break;
                        default:
                            return egl::EglBadAttribute() << "Invalid automatic trim attribute";
                    }
                ...
                case EGL_PLATFORM_ANGLE_DEVICE_TYPE_ANGLE:
                    switch (value)
                    {
                        ...
                        default:
                            return egl::EglBadAttribute() << "Invalid value for "
                ...
                case EGL_DISPLAY_ROBUST_RESOURCE_INITIALIZATION_ANGLE:
                    ...
                    if (value != EGL_TRUE && value != EGL_FALSE)
                    {
                        return egl::EglBadAttribute() << "EGL_DISPLAY_ROBUST_RESOURCE_"
        ...
        {
            return egl::EglBadAttribute() << "EGL_PLATFORM_ANGLE_DEVICE_TYPE_WARP_ANGLE requires a "
                                             "device type of EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE.";
        }

        if (enableAutoTrimSpecified && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE)
        {
            return egl::EglBadAttribute() << "EGL_PLATFORM_ANGLE_ENABLE_AUTOMATIC_TRIM_ANGLE "
        ...
        {
            return egl::EglBadAttribute() << "EGL_EXPERIMENTAL_PRESENT_PATH_ANGLE requires a "
                                             "device type of EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE.";
        }
        ...
        if (deviceTypeSpecified && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D9_ANGLE &&
            platformType != EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE)
        {
            return egl::EglBadAttribute() << "EGL_PLATFORM_ANGLE_DEVICE_TYPE_ANGLE requires a "
        ...
        if (platformType == EGL_PLATFORM_ANGLE_TYPE_VULKAN_ANGLE)
        {
            ...
            {
                return egl::EglBadAttribute() << "EGL_PLATFORM_ANGLE_TYPE_VULKAN_ANGLE currently "
    ...
    else if (platform == EGL_PLATFORM_DEVICE_EXT)
    {
        ...
        {
            return egl::EglBadAttribute() << "native_display should be a valid EGL device if "
