    ...
    if (platform == EGL_PLATFORM_ANGLE_ANGLE)
    {
        ...
        for (const auto &curAttrib : attribMap)
        {
            ...
            switch (curAttrib.first)
            {
                ...
                case EGL_PLATFORM_ANGLE_ENABLE_D3D11ON12_ANGLE:
                    if (!clientExtensions.platformANGLED3D ||
                        !clientExtensions.platformANGLEEnableD3D11ON12)
                    {
                        return EglBadAttribute()
                               << "EGL_PLATFORM_ANGLE_ENABLE_D3D11ON12_ANGLE extension not active.";
                    }
                    ...
                    switch (value)
                    {
                        ...
                        case EGL_FALSE:
                            break;
                        default:
                            return EglBadAttribute() << "Invalid enable d3d11on12 attribute";
                    }
        ...
        if (enableD3D11on12 && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE)
        {
            return EglBadAttribute() << "EGL_PLATFORM_ANGLE_ENABLE_D3D11ON12_ANGLE "
                                        "requires a device type of "
                                        "EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE.";
        }
