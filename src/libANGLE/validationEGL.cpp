...
static bool TextureHasNonZeroMipLevelsSpecified(const gl::Context *context,
                             ...
                             const AttributeMap &attributes)
{
    ...
    switch (target)
    {
        case EGL_GL_TEXTURE_2D_KHR:
        {
            ...
            const gl::Texture *texture = context->getTexture(reinterpret_cast<uintptr_t>(buffer));
        ...
        case EGL_GL_RENDERBUFFER_KHR:
        {
            ...
            const gl::Renderbuffer *renderbuffer =
                context->getRenderbuffer(reinterpret_cast<uintptr_t>(buffer));
