                                  ...
                                  EGLGetBlobFuncANDROID get)
{
    ...
    {
        return EglBadParameter()
               << "This function can only be called once in the lifetime of Display";
    }
                                     ...
                                     EGLint *binarysize)
{
    ...
    if (binary && *keysize != static_cast<EGLint>(gl::BlobCache::kKeyLength))
    {
                                        ...
                                        EGLint binarysize)
{
    ...
    if (keysize != static_cast<EGLint>(gl::BlobCache::kKeyLength))
    {
        return EglBadParameter() << "Invalid program key size.";
    }
