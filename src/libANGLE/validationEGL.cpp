...
static bool CubeTextureHasUnspecifiedLevel0Face(const gl::Texture *texture)
{
      ...
      case EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_KHR:
        {
            ...
            {
                return Error(EGL_BAD_PARAMETER, "if level is zero and the texture is incomplete, it must have all of "
