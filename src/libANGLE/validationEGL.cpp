         ...
         attributeIter != attributes.end(); attributeIter++)
    {
        ...
        switch (attribute)
        {
            ...
            case EGL_PROTECTED_CONTENT_EXT:
                ...
                break;
            case EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_HI:
            case EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_LO:
                         ...
                         const AttributeMap &attributes)
{
         ...
         attributeIter != attributes.end(); attributeIter++)
    {
        ...
        switch (attribute)
        {
            ...
            case EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_LO:
                ...
                {
                    val->setError(EGL_BAD_ATTRIBUTE,
                                  "Attribute EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_{HI,LO} require "
    ...
    switch (target)
    {
        ...
        case EGL_VULKAN_IMAGE_ANGLE:
            ...
            {
                EGLenum kRequiredParameters[] = {EGL_VULKAN_IMAGE_CREATE_INFO_ANGLE_HI,
