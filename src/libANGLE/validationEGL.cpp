...
bool ValidateStreamAttribute(ValidationContext *val,
...
bool ValidateCreateImageMipLevelCommon(ValidationContext *val,
                                       gl::Context *context,
...
bool ValidateConfigAttribute(ValidationContext *val, const Display *display, EGLAttrib attribute)
{
    switch (attribute)
    {
...
bool ValidateConfigAttributeValue(ValidationContext *val,
...
bool ValidateConfigAttributes(ValidationContext *val,
                              const Display *display,
...
bool ValidateColorspaceAttribute(ValidationContext *val,
...
bool ValidatePlatformType(ValidationContext *val,
...
bool ValidateGetPlatformDisplayCommon(ValidationContext *val,
                                      EGLenum platform,
                                      void *native_display,
...
bool ValidateStream(ValidationContext *val, const Display *display, const Stream *stream)
{
...
bool ValidateLabeledObject(ValidationContext *val,
                           Thread *thread,
                           const Display *display,
...
bool ValidateDisplayPointer(ValidationContext *val, const Display *display)
{
...
void ValidationContext::setError(EGLint error)
{
    eglThread->setError(error, entryPoint, labeledObject, nullptr);
}

void ValidationContext::setError(EGLint error, const char *message...)
{
    ASSERT(message);
    ...
    vsnprintf(buffer, kBufferSize - 1, message, args);

    eglThread->setError(EGL_BAD_ACCESS, entryPoint, labeledObject, buffer);
}
...
bool ValidateSyncControlCHROMIUM(ValidationContext *val,
                                 const Display *display,
...
bool ValidateSyncControlRateANGLE(ValidationContext *val,
                                  const Display *display,
                                  const Surface *eglSurface)
{
    ANGLE_VALIDATION_TRY(ValidateDisplay(val, display));
...
bool ValidateQueryDisplayAttribBase(ValidationContext *val,
                                    const Display *display,
...
bool ValidateGetNativeClientBufferANDROID(ValidationContext *val, const AHardwareBuffer *buffer)
{
