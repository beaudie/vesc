...
class Subject : NonCopyable
{
  public:
    ...
    ANGLE_INLINE bool hasObservers() const
    {
        return (mObserverBindingSentinelNode->getNext() != mObserverBindingSentinelNode);
    }
    void resetObservers();
    ...
    ANGLE_INLINE void addObserver(ObserverBindingBase *observer)
    {
        ...
        // Always add at head
        mObserverBindingSentinelNode->insertListNode(observer);
    }

    ANGLE_INLINE void removeObserver(ObserverBindingBase *observer)
    {
        ASSERT(IsInContainer(observer));
        mObserverBindingSentinelNode->removeListNode(observer);
    }
  ...
  private:
    ...
    angle::ListNode *mObserverBindingSentinelNode;
};
