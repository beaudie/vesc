...
struct PackedVarying
{
    ...
    PackedVarying(const sh::ShaderVariable &varyingIn,
                  ...
                  bool isFirstStructFieldIn)
        : varying(&varyingIn),
          vertexOnly(false),
          isFirstStructField(isFirstStructFieldIn),
    ...
    // Whether this is the first field in the struct.  In Vulkan, this is used to assign a
    // struct-typed varying location to the location of its first field.
    bool isFirstStructField;
