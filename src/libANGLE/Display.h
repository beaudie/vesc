...
class Display final : angle::NonCopyable
{
  public:
    ...
    Error createWindowSurface(const Thread *thread,
                              const Config *configuration,
                              EGLNativeWindowType window,
                              const AttributeMap &attribs,
                              Surface **outSurface);
    Error createPbufferSurface(const Thread *thread,
                               const Config *configuration,
                               const AttributeMap &attribs,
                               Surface **outSurface);
    Error createPbufferFromClientBuffer(const Thread *thread,
                                        const Config *configuration,
                                        EGLenum buftype,
                                        EGLClientBuffer clientBuffer,
                                        const AttributeMap &attribs,
                                        Surface **outSurface);
    Error createPixmapSurface(const Thread *thread,
                              const Config *configuration,
                              NativePixmapType nativePixmap,
                              const AttributeMap &attribs,
                              Surface **outSurface);

    Error createImage(const Thread *thread,
                      gl::Context *context,
                      EGLenum target,
    ...
    Error createContext(const Thread *thread,
                        const Config *configuration,
    ...
    Error waitClient(const Thread *thread) const;
    Error waitNative(const Thread *thread, EGLint engine) const;
  ...
  private:
    ...
    Error restoreLostDevice(const Thread *thread);
