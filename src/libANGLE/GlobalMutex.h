...
using ScopedGlobalEGLMutexLock           = ScopedGlobalMutexLock<GlobalMutexChoice::EGL>;
using ScopedGlobalEGLSyncObjectMutexLock = ScopedGlobalMutexLock<GlobalMutexChoice::Sync>;
