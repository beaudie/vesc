...
class BindingPointer
{
  public:
    ...
    BindingPointer(const BindingPointer &other) : mObject(other.mObject) { mObject->addRef(); }
...
template <class ObjectType>
using BindingPointer = angle::BindingPointer<Display, Error>;
