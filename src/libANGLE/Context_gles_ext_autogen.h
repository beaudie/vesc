...
#define ANGLE_GLES_EXT_CONTEXT_API                                                                 \
    ...
    void importMemoryZirconHandle(GLuint memory, GLuint64 size, HandleType handleTypePacked,       \
                                  GLuint handle);                                                  \
    /* GL_ANGLE_multi_draw */                                                                      \
    ...
    void importSemaphoreZirconHandle(GLuint semaphore, HandleType handleTypePacked,                \
                                     GLuint handle);                                               \
