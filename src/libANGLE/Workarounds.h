...
struct Workarounds : angle::FeaturesStruct
{
    Workarounds();
    ~Workarounds();
    ...
    angle::Feature loseContextOnOutOfMemory =
        angle::Feature("lose_context_on_out_of_memory",
                       angle::FeatureCategory::FRONTEND_WORKAROUNDS,
    ...
    angle::Feature disableProgramCachingForTransformFeedback = angle::Feature(
    ...
    angle::Feature syncFramebufferBindingsOnTexImage =
        angle::Feature("sync_framebuffer_bindings_on_tex_image",
                       angle::FeatureCategory::FRONTEND_WORKAROUNDS,
