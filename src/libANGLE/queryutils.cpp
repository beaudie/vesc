...
GLint GetUniformResourceProperty(const Program *program, GLuint index, const GLenum prop)
{
    ...
    switch (resourceProp)
    {
        ...
        case GL_OFFSET:
            return uniform.blockOffset;

        case GL_ARRAY_STRIDE:
            return uniform.blockArrayStride;

        case GL_MATRIX_STRIDE:
            return uniform.blockMatrixStride;

        case GL_IS_ROW_MAJOR:
            return static_cast<GLint>(uniform.flagBits.blockIsRowMajorMatrix);
