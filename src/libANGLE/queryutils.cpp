                                ...
                                ParamType *params)
{
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_WIDTH:
            *params = ConvertFromGLenum<ParamType>(texture->getWidth(texture->getTarget(), level));
            break;
        case GL_TEXTURE_HEIGHT:
            *params = ConvertFromGLenum<ParamType>(texture->getHeight(texture->getTarget(), level));
            break;
        case GL_TEXTURE_DEPTH:
            *params = ConvertFromGLenum<ParamType>(texture->getDepth(texture->getTarget(), level));
            break;
        case GL_TEXTURE_SAMPLES:
            *params = ConvertFromGLenum<ParamType>(texture->getSamples());
            break;
        case GL_TEXTURE_FIXED_SAMPLE_LOCATIONS:
            *params = ConvertFromGLenum<ParamType>(texture->getFixedSampleLocations());
            break;
        case GL_TEXTURE_COMPRESSED:
            *params =
                ConvertFromGLenum<ParamType>(texture->isCompressed(texture->getTarget(), level));
            break;
        default:
            UNREACHABLE();
            break;
