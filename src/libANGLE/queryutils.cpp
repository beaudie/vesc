    ...
    switch (pname)
    {
        case GL_FRAMEBUFFER_DEFAULT_WIDTH:
        {
                 ...
                 ++attachment)
            {
                ...
                GLint width =
                    static_cast<GLint>(tex->getWidth(texTarget, static_cast<size_t>(texBaseLevel)));
                if (width > maxwidth)
                    maxwidth = width;
            }
        ...
        case GL_FRAMEBUFFER_DEFAULT_HEIGHT:
        {
                 ...
                 ++attachment)
            {
                ...
                GLenum texTarget   = tex->getTarget();
                GLint texBaseLevel = tex->getBaseLevel();
                GLint height       = static_cast<GLint>(
