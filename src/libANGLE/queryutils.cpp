    ...
    switch (pname)
    {
        case GL_TEXTURE_RED_TYPE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->redBits ? info->componentType : GL_NONE));
            break;
        case GL_TEXTURE_GREEN_TYPE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->greenBits ? info->componentType : GL_NONE));
            break;
        case GL_TEXTURE_BLUE_TYPE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->blueBits ? info->componentType : GL_NONE));
            break;
        case GL_TEXTURE_ALPHA_TYPE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->alphaBits ? info->componentType : GL_NONE));
            break;
        case GL_TEXTURE_DEPTH_TYPE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->depthBits ? info->componentType : GL_NONE));
            break;
        case GL_TEXTURE_RED_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->redBits));
            break;
        case GL_TEXTURE_GREEN_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->greenBits));
            break;
        case GL_TEXTURE_BLUE_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->blueBits));
            break;
        case GL_TEXTURE_ALPHA_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->alphaBits));
            break;
        case GL_TEXTURE_DEPTH_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->depthBits));
            break;
        case GL_TEXTURE_STENCIL_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->stencilBits));
            break;
        case GL_TEXTURE_SHARED_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(info->sharedBits));
            break;
        case GL_TEXTURE_INTERNAL_FORMAT:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(info->internalFormat ? info->internalFormat : GL_RGBA));
            break;
        case GL_TEXTURE_WIDTH:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(texture->getWidth(target, level)));
            break;
        case GL_TEXTURE_HEIGHT:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(texture->getHeight(target, level)));
            break;
        case GL_TEXTURE_DEPTH:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(texture->getDepth(target, level)));
            break;
...
void QueryTexParameterBase(const Texture *texture, GLenum pname, ParamType *params)
{
    ...
    switch (pname)
    {
        case GL_TEXTURE_MAG_FILTER:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getMagFilter()));
            break;
        case GL_TEXTURE_MIN_FILTER:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getMinFilter()));
            break;
        case GL_TEXTURE_WRAP_S:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getWrapS()));
            break;
        case GL_TEXTURE_WRAP_T:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getWrapT()));
            break;
        case GL_TEXTURE_WRAP_R:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getWrapR()));
            break;
        ...
        case GL_TEXTURE_IMMUTABLE_LEVELS:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(texture->getImmutableLevels()));
            break;
        case GL_TEXTURE_USAGE_ANGLE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getUsage()));
            break;
        ...
        case GL_TEXTURE_SWIZZLE_R:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getSwizzleRed()));
            break;
        case GL_TEXTURE_SWIZZLE_G:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getSwizzleGreen()));
            break;
        case GL_TEXTURE_SWIZZLE_B:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getSwizzleBlue()));
            break;
        case GL_TEXTURE_SWIZZLE_A:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getSwizzleAlpha()));
            break;
        case GL_TEXTURE_BASE_LEVEL:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getBaseLevel()));
            break;
        case GL_TEXTURE_MAX_LEVEL:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getMaxLevel()));
            break;
        ...
        case GL_TEXTURE_COMPARE_MODE:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getCompareMode()));
            break;
        case GL_TEXTURE_COMPARE_FUNC:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getCompareFunc()));
            break;
        case GL_TEXTURE_SRGB_DECODE_EXT:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(texture->getSRGBDecode()));
            break;
        default:
            UNREACHABLE();
            break;
...
void SetTexParameterBase(Context *context, Texture *texture, GLenum pname, const ParamType *params)
{
    ...
    {
        case GL_TEXTURE_WRAP_S:
            texture->setWrapS(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_WRAP_T:
            texture->setWrapT(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_WRAP_R:
            texture->setWrapR(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MIN_FILTER:
            texture->setMinFilter(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MAG_FILTER:
            texture->setMagFilter(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_USAGE_ANGLE:
            texture->setUsage(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MAX_ANISOTROPY_EXT:
            texture->setMaxAnisotropy(CastQueryValueTo<GLfloat>(pname, params[0]));
            break;
        case GL_TEXTURE_COMPARE_MODE:
            texture->setCompareMode(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_COMPARE_FUNC:
            texture->setCompareFunc(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_SWIZZLE_R:
            texture->setSwizzleRed(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_SWIZZLE_G:
            texture->setSwizzleGreen(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_SWIZZLE_B:
            texture->setSwizzleBlue(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_SWIZZLE_A:
            texture->setSwizzleAlpha(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_BASE_LEVEL:
        {
        ...
        case GL_DEPTH_STENCIL_TEXTURE_MODE:
            texture->setDepthStencilTextureMode(
                clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_SRGB_DECODE_EXT:
            texture->setSRGBDecode(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        default:
            UNREACHABLE();
            break;
...
void QuerySamplerParameterBase(const Sampler *sampler, GLenum pname, ParamType *params)
{
    switch (pname)
    {
        case GL_TEXTURE_MIN_FILTER:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getMinFilter()));
            break;
        case GL_TEXTURE_MAG_FILTER:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getMagFilter()));
            break;
        case GL_TEXTURE_WRAP_S:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getWrapS()));
            break;
        case GL_TEXTURE_WRAP_T:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getWrapT()));
            break;
        case GL_TEXTURE_WRAP_R:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getWrapR()));
            break;
        case GL_TEXTURE_MAX_ANISOTROPY_EXT:
        ...
        case GL_TEXTURE_COMPARE_MODE:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getCompareMode()));
            break;
        case GL_TEXTURE_COMPARE_FUNC:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getCompareFunc()));
            break;
        case GL_TEXTURE_SRGB_DECODE_EXT:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(sampler->getSRGBDecode()));
            break;
        default:
            UNREACHABLE();
            break;
...
void SetSamplerParameterBase(Sampler *sampler, GLenum pname, const ParamType *params)
{
    ...
    {
        case GL_TEXTURE_WRAP_S:
            sampler->setWrapS(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_WRAP_T:
            sampler->setWrapT(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_WRAP_R:
            sampler->setWrapR(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MIN_FILTER:
            sampler->setMinFilter(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MAG_FILTER:
            sampler->setMagFilter(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MAX_ANISOTROPY_EXT:
            sampler->setMaxAnisotropy(CastQueryValueTo<GLfloat>(pname, params[0]));
            break;
        case GL_TEXTURE_COMPARE_MODE:
            sampler->setCompareMode(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_COMPARE_FUNC:
            sampler->setCompareFunc(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        case GL_TEXTURE_MIN_LOD:
        ...
        case GL_TEXTURE_MAX_LOD:
            ...
            break;
        case GL_TEXTURE_SRGB_DECODE_EXT:
            sampler->setSRGBDecode(clampCast<GLenum>(CastQueryValueTo<GLint>(pname, params[0])));
            break;
        default:
            UNREACHABLE();
            break;
                           ...
                           ParamType *params)
{
    switch (pname)
    {
        ...
        case GL_VERTEX_ATTRIB_ARRAY_SIZE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(attrib.size));
            break;
        case GL_VERTEX_ATTRIB_ARRAY_STRIDE:
            *params = CastFromStateValue<ParamType>(
                pname, clampCast<GLint>(attrib.vertexAttribArrayStride));
            break;
        case GL_VERTEX_ATTRIB_ARRAY_TYPE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(attrib.type));
            break;
        ...
        case GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(binding.getBuffer().id()));
            break;
        case GL_VERTEX_ATTRIB_ARRAY_DIVISOR:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(binding.getDivisor()));
            break;
        case GL_VERTEX_ATTRIB_ARRAY_INTEGER:
            *params = CastFromStateValue<ParamType>(pname, static_cast<GLint>(attrib.pureInteger));
            break;
        case GL_VERTEX_ATTRIB_BINDING:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(attrib.bindingIndex));
            break;
        case GL_VERTEX_ATTRIB_RELATIVE_OFFSET:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(attrib.relativeOffset));
            break;
        default:
            UNREACHABLE();
            break;
...
void QueryBufferParameterBase(const Buffer *buffer, GLenum pname, ParamType *params)
{
    ...
    switch (pname)
    {
        case GL_BUFFER_USAGE:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(buffer->getUsage()));
            break;
        case GL_BUFFER_SIZE:
        ...
        case GL_BUFFER_ACCESS_FLAGS:
            *params =
                CastFromStateValue<ParamType>(pname, clampCast<GLint>(buffer->getAccessFlags()));
            break;
        case GL_BUFFER_ACCESS_OES:
            *params = CastFromStateValue<ParamType>(pname, clampCast<GLint>(buffer->getAccess()));
            break;
