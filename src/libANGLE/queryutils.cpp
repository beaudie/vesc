...
void GetInterfaceBlockResourceProperty(const Program *program,
                                       GLuint blockIndex,
                                       GLenum pname,
                                       GLint *params,
                                       GLsizei bufSize,
...

{
    ...
    GetShaderVariableBufferResourceProperty(buffer, pname, params, bufSize, put);
}
                            ...
                            GLint *params)
{
    ...
    for (GLsizei i = 0; i < propCount; i++)
    {
        switch (programInterface)
        {
            ...
            case GL_UNIFORM_BLOCK:
                GetInterfaceBlockResourceProperty(program, index, props[i], params, bufSize, pos);
                break;
