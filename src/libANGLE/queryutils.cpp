...
template <bool isGLfixed, typename ParamType>
GLfloat convertToFloat(ParamType param)
{
    if (isGLfixed)
    {
        return ConvertFixedToFloat(static_cast<GLfixed>(param));
    }
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_MAX_ANISOTROPY_EXT:
            texture->setMaxAnisotropy(
                context, CastQueryValueTo<GLfloat>(pname, convertToFloat<isGLfixed>(params[0])));
            break;
        case GL_TEXTURE_COMPARE_MODE:
        ...
        case GL_TEXTURE_SRGB_DECODE_EXT:
            ...
            break;
        case GL_TEXTURE_CROP_RECT_OES:
            texture->setCrop(gl::Rectangle(
                CastQueryValueTo<GLint>(pname, convertToFloat<isGLfixed>(params[0])),
                CastQueryValueTo<GLint>(pname, convertToFloat<isGLfixed>(params[1])),
                CastQueryValueTo<GLint>(pname, convertToFloat<isGLfixed>(params[2])),
                CastQueryValueTo<GLint>(pname, convertToFloat<isGLfixed>(params[3]))));
            break;
        case GL_GENERATE_MIPMAP:
