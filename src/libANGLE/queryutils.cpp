                              ...
                              GLchar *name)
{
    ...
    {
        case GL_PROGRAM_INPUT:
            program->copyInputResourceName(index, bufSize, length, name);
            break;

        case GL_PROGRAM_OUTPUT:
            program->copyOutputResourceName(index, bufSize, length, name);
            break;

        case GL_UNIFORM:
            program->copyUniformResourceName(index, bufSize, length, name);
            break;

        case GL_BUFFER_VARIABLE:
            program->copyBufferVariableResourceName(index, bufSize, length, name);
            break;
