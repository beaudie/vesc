                                ...
                                ParamType *params)
{
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_FIXED_SAMPLE_LOCATIONS:
            *params = ConvertFrom<ParamType>(
                ConvertTo<bool>(texture->getFixedSampleLocations(target, level)));
            break;
...
void QueryBufferParameterBase(const Buffer *buffer, GLenum pname, ParamType *params)
{
    ...
    switch (pname)
    {
        ...
        case GL_BUFFER_MAPPED:
            *params = ConvertFrom<ParamType>(ConvertTo<bool>(buffer->isMapped()));
            break;
        case GL_BUFFER_MAP_OFFSET:
            *params = ConvertFrom<ParamType>(ConvertTo<bool>(buffer->getMapOffset()));
            break;
