...
class ProgramState final : angle::NonCopyable
{
  public:
    ...
    {
        return mExecutable->mTransformFeedbackBufferMode;
    }
    GLuint getUniformBlockBinding(GLuint uniformBlockIndex) const
    {
        ASSERT(uniformBlockIndex < mExecutable->mUniformBlocks.size());
        return mExecutable->mUniformBlocks[uniformBlockIndex].binding;
    }
    GLuint getShaderStorageBlockBinding(GLuint blockIndex) const
    {
        ASSERT(blockIndex < mExecutable->mShaderStorageBlocks.size());
        return mExecutable->mShaderStorageBlocks[blockIndex].binding;
    }
    ...
    {
        return mExecutable->mProgramInputs;
    }
    ...
    const RangeUI &getSamplerUniformRange() const { return mExecutable->mSamplerUniformRange; }
    const RangeUI &getImageUniformRange() const { return mExecutable->mImageUniformRange; }
    const RangeUI &getAtomicCounterUniformRange() const { return mAtomicCounterUniformRange; }

    const std::vector<TransformFeedbackVarying> &getLinkedTransformFeedbackVaryings() const
    {
        return mExecutable->mLinkedTransformFeedbackVaryings;
    }
    const std::vector<GLsizei> &getTransformFeedbackStrides() const
    {
        return mExecutable->mTransformFeedbackStrides;
    }
    const std::vector<AtomicCounterBuffer> &getAtomicCounterBuffers() const
    {
        return mExecutable->mAtomicCounterBuffers;
    }
...
class Program final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    {
        ASSERT(mLinkResolved);
        ASSERT(index < static_cast<size_t>(mState.mExecutable->mUniforms.size()));
        return mState.mExecutable->mUniforms[index];
    }
    ...
    {
        ASSERT(mLinkResolved);
        return static_cast<GLuint>(mState.mExecutable->mUniformBlocks.size());
    }

    ANGLE_INLINE GLuint getActiveAtomicCounterBufferCount() const
    {
        ASSERT(mLinkResolved);
        return static_cast<GLuint>(mState.mExecutable->mAtomicCounterBuffers.size());
    }

    ANGLE_INLINE GLuint getActiveShaderStorageBlockCount() const
    {
        ASSERT(mLinkResolved);
        return static_cast<GLuint>(mState.mExecutable->mShaderStorageBlocks.size());
    }
