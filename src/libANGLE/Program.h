...
class ProgramState final : angle::NonCopyable
{
  public:
    ...
    const std::string &getTranslatedSource(ShaderType shaderType) const
    {
        return mTranslatedSources[shaderType];
    }

    void setTranslatedSource(ShaderType shaderType, const std::string &translatedSource)
    {
        mTranslatedSources[shaderType] = translatedSource;
    }
  ...
  private:
    ...
    gl::ShaderMap<std::string> mTranslatedSources;
};
