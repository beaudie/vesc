...
// The names and values below refer to gles 3.1
...
class Program final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    bool getLinkedShaderStages() const { return mLinkedShaderStages; }
    bool setLinkedShaderStages(GLbitfield stages) { mLinkedShaderStages = stages; }
