...
using ShaderStagesMask = angle::BitSet<static_cast<size_t>(ShaderType::EnumCount)>;
...
class Program final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    bool hasLinkedVertexShader() const
    {
        return mState.mLinkedShaderStages[static_cast<size_t>(ShaderType::Vertex)];
    }
    bool hasLinkedFragmentShader() const
    {
        return mState.mLinkedShaderStages[static_cast<size_t>(ShaderType::Fragment)];
    }
    bool hasLinkedComputeShader() const
    {
        return mState.mLinkedShaderStages[static_cast<size_t>(ShaderType::Compute)];
    }
    bool hasLinkedGeometryShader() const
    {
        return mState.mLinkedShaderStages[static_cast<size_t>(ShaderType::Geometry)];
    }
