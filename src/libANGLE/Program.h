...
class ProgramState final : angle::NonCopyable
{
  ...
  private:
    ...
    std::array<int, 3> mComputeShaderLocalSize;
...
class Program final : angle::NonCopyable, public LabeledObject
{
  ...
  private:
    ...
    bool incrementAndValidateUniformBlocksCount(GLuint maxUniformBlocks,
                                                const sh::InterfaceBlock &block,
                                                const std::string &errorMessage,
                                                InfoLog &infoLog,
                                                GLuint *uniformBlocksCount);
    ...
    bool doVertexAndFragmentUniformsMatch(std::map<std::string, LinkedUniform> &linkedUniforms,
                                          InfoLog &infoLog);
