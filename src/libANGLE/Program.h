...
class Program final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    void copyInputResourceName(GLuint index, GLsizei bufSize, GLsizei *length, GLchar *name) const;
    void copyOutputResourceName(GLuint index, GLsizei bufSize, GLsizei *length, GLchar *name) const;
    void copyUniformResourceName(GLuint index,
                                 GLsizei bufSize,
                                 GLsizei *length,
                                 GLchar *name) const;
    void copyBufferVariableResourceName(GLuint index,
                                        GLsizei bufSize,
                                        GLsizei *length,
                                        GLchar *name) const;
    ...
    const ProgramBindings &getFragmentInputBindings() cfonst;
  ...
  private:
    ...
    void copyResourceName(const std::string name,
                          GLsizei bufSize,
                          GLsizei *length,
                          GLchar *dest) const;
