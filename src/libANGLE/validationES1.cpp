...
bool ValidateLightCommon(Context* context, GLenum light, LightParameter pname, const GLfloat* param) {
...
bool ValidateLightSingleComponent(Context* context, GLenum light, LightParameter pname, GLfloat param) {
    if (!ValidateLightCommon(context, light, pname, &param)) {
        return false;
    }

    if (GLES1State::GetLightParameterCount(pname) > 1) {
        ANGLE_VALIDATION_ERR(context, InvalidEnum(), InvalidLightParameter);
        return false;
    }
...
bool ValidateMaterialCommon(Context* context, GLenum face, MaterialParameter pname, const GLfloat* params) {
    ANGLE_VALIDATE_IS_GLES1(context);
...
bool ValidateMaterialSingleComponent(Context* context, GLenum face, MaterialParameter pname, GLfloat param) {
    if (!ValidateMaterialCommon(context, face, pname, &param)) {
        return false;
    }
    ANGLE_VALIDATE_IS_GLES1(context);

    if (GLES1State::GetMaterialParameterCount(pname) > 1) {
        ANGLE_VALIDATION_ERR(context, InvalidEnum(), InvalidMaterialParameter);
        return false;
    }
...
{
    GLfloat paramsf[4];
    for (unsigned int i = 0; i < GLES1State::GetLightParameterCount(pname); i++) {
...
bool ValidateMaterialfv(Context *context, GLenum face, MaterialParameter pname, const GLfloat *params)
{
...
bool ValidateMaterialxv(Context *context, GLenum face, MaterialParameter pname, const GLfixed *params)
{
    GLfloat paramsf[4];

    for (unsigned int i = 0; i < GLES1State::GetMaterialParameterCount(pname); i++) {
        paramsf[i] = FixedToFloat(params[i]);
    }
