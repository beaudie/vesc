...
#define ANGLE_VALIDATE_IS_GLES1(context, entryPoint)                                            \
    ...
    {                                                                                           \
        ...
        {                                                                                       \
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kGLES1Only);      \
            return false;                                                                       \
        }                                                                                       \
    } while (0)
                               ...
                               ClientVertexArrayType arrayType)
{
    ...
    switch (arrayType)
    {
        ...
        case ClientVertexArrayType::PointSize:
            ...
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidClientState);
            return false;
    }
}
                                          ...
                                          const void *pointer)
{
    ...
    if (stride < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidVertexPointerStride);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidVertexPointerSize);
        return false;
    }
    ...
    switch (type)
    {
        ...
        case VertexAttribType::UnsignedByte:
            ...
            break;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidVertexPointerType);
            return false;
    }
...
bool ValidateLightCaps(const Context *context, angle::EntryPoint entryPoint, GLenum light)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidLight);
        return false;
    }
                         ...
                         const GLfloat *params)
{
    ...
    switch (pname)
    {
        ...
        case LightParameter::QuadraticAttenuation:
            ...
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidLightParameter);
            return false;
    }
}
                            ...
                            const GLfloat *params)
{
    switch (pname)
    {
        ...
        case MaterialParameter::Shininess:
            ...
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidMaterialParameter);
            return false;
    }
}
                             ...
                             const GLfloat *params)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidMaterialFace);
        return false;
    }
...
bool ValidateClipPlaneCommon(const Context *context, angle::EntryPoint entryPoint, GLenum plane)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidClipPlane);
        return false;
    }
                       ...
                       const GLfloat *params)
{
    ...
    switch (pname)
    {
        case GL_FOG_MODE:
        {
            ...
            switch (modeParam)
            {
                ...
                case GL_LINEAR:
                    return true;
                default:
                    ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidFogMode);
                    return false;
            }
        }
        case GL_FOG_START:
        ...
        case GL_FOG_DENSITY:
            if (params[0] < 0.0f)
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidFogDensity);
                return false;
            }
            break;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidFogParameter);
            return false;
    }
    return true;
}
                          ...
                          const GLfloat *params)
{
    ...
    switch (target)
    {
        ...
        case TextureEnvTarget::PointSprite:
            ...
            break;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidTextureEnvTarget);
            return false;
    }
    return true;
}
                                  ...
                                  const GLfloat *params)
{
    ...
    switch (pname)
    {
        ...
        case PointParameter::PointDistanceAttenuation:
            ...
            break;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidPointParameter);
            return false;
    }
...
bool ValidatePointSizeCommon(const Context *context, angle::EntryPoint entryPoint, GLfloat size)
{
    ...
    if (size <= 0.0f)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidPointSizeValue);
        return false;
    }
                      ...
                      GLfloat f)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidProjectionMatrix);
        return false;
    }
    return true;
}
...
bool ValidateMatrixMode(const Context *context, angle::EntryPoint entryPoint, MatrixType mode)
{
    ...
    switch (mode)
    {
        ...
        case MatrixType::Texture:
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidMatrixMode);
            return false;
    }
}
...
bool ValidatePopMatrix(const Context *context, angle::EntryPoint entryPoint)
{
    ...
    if (stack.size() == 1)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_STACK_UNDERFLOW, kMatrixStackUnderflow);
        return false;
    }
    return true;
}
...
bool ValidatePushMatrix(const Context *context, angle::EntryPoint entryPoint)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_STACK_OVERFLOW, kMatrixStackOverflow);
        return false;
    }
    return true;
}
...
bool ValidateShadeModel(const Context *context, angle::EntryPoint entryPoint, ShadingModel mode)
{
    ...
    switch (mode)
    {
        ...
        case ShadingModel::Smooth:
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidShadingModel);
            return false;
    }
}
