...
{
    OutputVariable(const sh::ShaderVariable &varyingIn) {}
    ...
    unsigned int getBasicTypeElementCount() const { return podStruct.basicTypeElementCount; }
    void resetEffectiveLocation()
    {
...
class ProgramExecutable final : public angle::Subject
{
  public:
    ...
    const std::vector<OutputVariable> &getOutputVariables() const { return mOutputVariables; }
