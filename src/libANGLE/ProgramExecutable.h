...
struct SamplerBinding
{
    ...
    // mSamplerBoundTextureUnits that stores the texture unit bound to this sampler.
...
class ProgramExecutable final : public angle::Subject
{
  ...
  private:
    ...
    // this vector. Cropped by the amount of unused elements reported by the driver.
