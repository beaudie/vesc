...
class VertexArrayState final : public angle::NonCopyable
{
  public:
    ...
    const std::vector<AttribBinding> &getAttribBindings() const { return mAttribBindings; }
    const AttribBinding &getAttribBinding(size_t bindingIndex) const
    {
  ...
  private:
    ...
    std::vector<AttribBinding> mAttribBindings;
...
class VertexArray final : public LabeledObject
{
  public:
    ...
    const std::vector<AttribBinding> &getAttribBindings() const
    {
