...
class VertexArray
{
  public:
    ...
    enum DirtyBitType
    {
        ...
        DIRTY_BIT_ATTRIB_0_ENABLED  = 0,
        DIRTY_BIT_ATTRIB_15_ENABLED = DIRTY_BIT_ATTRIB_0_ENABLED + gl::MAX_VERTEX_ATTRIBS - 1,
        // Reserve bits 16-31 for attrib pointers
        DIRTY_BIT_ATTRIB_0_POINTER,
        DIRTY_BIT_ATTRIB_15_POINTER = DIRTY_BIT_ATTRIB_0_POINTER + gl::MAX_VERTEX_ATTRIBS - 1,
        // Reserve bits 32-47 for divisors
        DIRTY_BIT_ATTRIB_0_DIVISOR,
        DIRTY_BIT_ATTRIB_15_DIVISOR = DIRTY_BIT_ATTRIB_0_DIVISOR + gl::MAX_VERTEX_ATTRIBS - 1,
