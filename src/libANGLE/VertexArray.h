...
class VertexArray final : public LabeledObject
{
  public:
    ...
    enum DirtyBitType
    {
        ...
        DIRTY_BIT_BINDING_0_DIVISOR = DIRTY_BIT_ATTRIB_MAX_POINTER,
        DIRTY_BIT_BINDING_MAX_DIVISOR =
            DIRTY_BIT_BINDING_0_DIVISOR + gl::MAX_VERTEX_ATTRIB_BINDINGS,

        DIRTY_BIT_MIN_ES31 = DIRTY_BIT_BINDING_MAX_DIVISOR,

        // Reserve bits for changes to VertexAttribFormat
        DIRTY_BIT_ATTRIB_0_FORMAT   = DIRTY_BIT_MIN_ES31,
        ...
        DIRTY_BIT_UNKNOWN = DIRTY_BIT_BINDING_MAX_BUFFER,
