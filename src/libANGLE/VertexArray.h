...
class VertexArrayState final : angle::NonCopyable
{
  public:
    ...
    AttributesMask getBoundAttributesMaskOnBinding(GLuint bindingIndex) const;
  ...
  private:
    ...
    std::array<AttributesMask, MAX_VERTEX_ATTRIB_BINDINGS> mBoundAttributesMaskOnBindings;
};
