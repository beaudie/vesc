...
struct Active
{
    ...
    void unionReferencesWith(const Active &other);
...
struct LinkedUniform : public sh::Uniform, public Active
{
    LinkedUniform();
...
struct BufferVariable : public sh::ShaderVariable, public Active
{
    BufferVariable();
...
struct ShaderVariableBuffer : public Active
{
