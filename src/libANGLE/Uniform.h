...
struct ShaderVarGroupBuffer
{
    ShaderVarGroupBuffer();
    virtual ~ShaderVarGroupBuffer();
    ShaderVarGroupBuffer(const ShaderVarGroupBuffer &other) = default;
    ShaderVarGroupBuffer &operator=(const ShaderVarGroupBuffer &other) = default;
...
using AtomicCounterBuffer = ShaderVarGroupBuffer;

// Helper struct representing a single shader uniform block
struct UniformBlock : public ShaderVarGroupBuffer
{
    UniformBlock();
