...
struct LinkedUniform
{
    ...
    bool isInDefaultBlock() const { return flagBits.isDefaultBlock; }
    ...
    int getBufferIndex() const { return flagBits.isDefaultBlock ? -1 : bufferIndex; }
    int getBufferBlockOffset() const { return flagBits.isDefaultBlock ? -1 : blockOffset; }
    int getBufferBlockArrayStride() const
    {
        return flagBits.isDefaultBlock ? -1 : blockArrayStride;
    }
    int getBufferBlockMatrixStride() const
    {
        return flagBits.isDefaultBlock ? -1 : blockMatrixStride;
    }
