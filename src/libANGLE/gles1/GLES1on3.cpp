...
GLES1on3::GLES1on3(Context* context,
                   State* state) : mContext(context), mGLState(state) {
    ...
    { // drawTexOES state
...

        {
            ...
            gl->bufferData(BufferBinding::ElementArray, sizeof(sDrawTexIbo), sDrawTexIbo, BufferUsage::StaticDraw);
    ...
    { // regular draw state
...

        {
            ...
            drawState.projMatrixLoc =
                gl->getUniformLocation(drawProg, "projection");
            drawState.modelviewMatrixLoc =
                gl->getUniformLocation(drawProg, "modelview");
            drawState.textureMatrixLoc =
                gl->getUniformLocation(drawProg, "texture_matrix");
            drawState.modelviewInvTrLoc =
                gl->getUniformLocation(drawProg, "modelview_invtr");
            drawState.textureSampler0Loc =
                gl->getUniformLocation(drawProg, "tex_sampler0");
            drawState.textureCubeSampler0Loc =
                gl->getUniformLocation(drawProg, "tex_cube_sampler0");
            drawState.textureSampler1Loc =
                gl->getUniformLocation(drawProg, "tex_sampler1");
            drawState.textureCubeSampler1Loc =
                gl->getUniformLocation(drawProg, "tex_cube_sampler1");
            drawState.textureSampler2Loc =
                gl->getUniformLocation(drawProg, "tex_sampler2");
            drawState.textureCubeSampler2Loc =
                gl->getUniformLocation(drawProg, "tex_cube_sampler2");
            drawState.textureSampler3Loc =
                gl->getUniformLocation(drawProg, "tex_sampler3");
            drawState.textureCubeSampler3Loc =
                gl->getUniformLocation(drawProg, "tex_cube_sampler3");

            drawState.shadeModelFlatLoc =
                gl->getUniformLocation(drawProg, "shade_model_flat");

            drawState.enableTexture2DLoc =
                gl->getUniformLocation(drawProg, "enable_texture_2d");
            drawState.enableTextureCubeMapLoc =
                gl->getUniformLocation(drawProg, "enable_texture_cube_map");
            drawState.enableLightingLoc =
                gl->getUniformLocation(drawProg, "enable_lighting");
            drawState.enableRescaleNormalLoc =
                gl->getUniformLocation(drawProg, "enable_rescale_normal");
            drawState.enableNormalizeLoc =
                gl->getUniformLocation(drawProg, "enable_normalize");
            drawState.enableColorMaterialLoc =
                gl->getUniformLocation(drawProg, "enable_color_material");
            drawState.enableFogLoc =
                gl->getUniformLocation(drawProg, "enable_fog");
            drawState.enableReflectionMapLoc =
                gl->getUniformLocation(drawProg, "enable_reflection_map");
            drawState.enableAlphaTestLoc =
                gl->getUniformLocation(drawProg, "enable_alpha_test");
            drawState.enableLogicOpLoc =
                gl->getUniformLocation(drawProg, "enable_logic_op");
            drawState.logicOpLoc =
                gl->getUniformLocation(drawProg, "logic_op");

            drawState.alphaFuncLoc =
                gl->getUniformLocation(drawProg, "alpha_func");
            drawState.alphaTestRefLoc =
                gl->getUniformLocation(drawProg, "alpha_test_ref");

            drawState.textureFormatLoc =
                gl->getUniformLocation(drawProg, "texture_format");

            drawState.textureEnvModeLoc =
                gl->getUniformLocation(drawProg, "texture_env_mode");
            drawState.combineRgbLoc =
                gl->getUniformLocation(drawProg, "combine_rgb");
            drawState.combineAlphaLoc =
                gl->getUniformLocation(drawProg, "combine_alpha");
            drawState.src0rgbLoc =
                gl->getUniformLocation(drawProg, "src0_rgb");
            drawState.src0alphaLoc =
                gl->getUniformLocation(drawProg, "src0_alpha");
            drawState.src1rgbLoc =
                gl->getUniformLocation(drawProg, "src1_rgb");
            drawState.src1alphaLoc =
                gl->getUniformLocation(drawProg, "src1_alpha");
            drawState.src2rgbLoc =
                gl->getUniformLocation(drawProg, "src2_rgb");
            drawState.src2alphaLoc =
                gl->getUniformLocation(drawProg, "src2_alpha");
            drawState.op0rgbLoc =
                gl->getUniformLocation(drawProg, "op0_rgb");
            drawState.op0alphaLoc =
                gl->getUniformLocation(drawProg, "op0_alpha");
            drawState.op1rgbLoc =
                gl->getUniformLocation(drawProg, "op1_rgb");
            drawState.op1alphaLoc =
                gl->getUniformLocation(drawProg, "op1_alpha");
            drawState.op2rgbLoc =
                gl->getUniformLocation(drawProg, "op2_rgb");
            drawState.op2alphaLoc =
                gl->getUniformLocation(drawProg, "op2_alpha");
            drawState.textureEnvColorLoc =
                gl->getUniformLocation(drawProg, "texture_env_color");
            drawState.rgbScaleLoc =
                gl->getUniformLocation(drawProg, "texture_env_rgb_scale");
            drawState.alphaScaleLoc =
                gl->getUniformLocation(drawProg, "texture_env_alpha_scale");
            ...
            drawState.materialAmbientLoc =
                gl->getUniformLocation(drawProg, "material_ambient");
            drawState.materialDiffuseLoc =
                gl->getUniformLocation(drawProg, "material_diffuse");
            drawState.materialSpecularLoc =
                gl->getUniformLocation(drawProg, "material_specular");
            drawState.materialEmissiveLoc =
                gl->getUniformLocation(drawProg, "material_emissive");
            ...
            drawState.lightEnablesLoc =
                gl->getUniformLocation(drawProg, "light_enables");
            drawState.lightAmbientsLoc =
                gl->getUniformLocation(drawProg, "light_ambients");
            drawState.lightDiffusesLoc =
                gl->getUniformLocation(drawProg, "light_diffuses");
            drawState.lightSpecularsLoc =
                gl->getUniformLocation(drawProg, "light_speculars");
            drawState.lightPositionsLoc =
                gl->getUniformLocation(drawProg, "light_positions");
            drawState.lightDirectionsLoc =
                gl->getUniformLocation(drawProg, "light_directions");
            ...
            drawState.fogModeLoc =
                gl->getUniformLocation(drawProg, "fog_mode");
            drawState.fogDensityLoc =
                gl->getUniformLocation(drawProg, "fog_density");
            drawState.fogStartLoc =
                gl->getUniformLocation(drawProg, "fog_start");
            drawState.fogEndLoc =
                gl->getUniformLocation(drawProg, "fog_end");
            drawState.fogColorLoc =
                gl->getUniformLocation(drawProg, "fog_color");
            ...
            drawState.pointSizeMinLoc =
                gl->getUniformLocation(drawProg, "point_size_min");
            drawState.pointSizeMaxLoc =
                gl->getUniformLocation(drawProg, "point_size_max");
            ...
            drawState.enableClipPlanesLoc =
                gl->getUniformLocation(drawProg, "enable_clip_planes");
            drawState.clipPlaneEnablesLoc =
                gl->getUniformLocation(drawProg, "clip_plane_enables");
            drawState.clipPlanesLoc =
                gl->getUniformLocation(drawProg, "clip_planes");
...
void GLES1on3::getIntegervImpl(GLenum pname, GLint *params)
{
    ...
    switch (pname) {
        ...
        case GL_ARRAY_BUFFER_BINDING:
            ...
            if (userBufferMapReverse.find(underlyingBufferBinding) !=
                    userBufferMapReverse.end()) {
        ...
        case GL_TEXTURE_COORD_ARRAY_BUFFER_BINDING:
            mContext->getVertexAttribiv( (GLuint)vertexArrayIndex(pname), GL_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING, &underlyingBufferBinding);
            if (userBufferMapReverse.find(underlyingBufferBinding) !=
                    userBufferMapReverse.end()) {
                *params = userBufferMapReverse[underlyingBufferBinding];
            } else {
        ...
        case GL_TEXTURE_COORD_ARRAY_STRIDE:
            mContext->getVertexAttribiv((GLuint)vertexArrayIndex(pname), GL_VERTEX_ATTRIB_ARRAY_STRIDE, params);
            return;
...
void GLES1on3::compressedTexImage2D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void *data) {
    mContext->compressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data);
}

void GLES1on3::compressedTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void *data) {
    mContext->compressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data);
}
...
void GLES1on3::bufferData(BufferBinding target, GLsizeiptr size, const void *data, BufferUsage usage)
{
...
GLboolean GLES1on3::isBuffer(GLuint buffer)
{
    ...
    if (userBufferMapReverse.find(buffer) !=
        userBufferMapReverse.end()) {
        return GL_FALSE;
    }

    if (buffer == drawTex.vbo ||
        buffer == drawTex.ibo) {
        return GL_FALSE;
    }
...
void GLES1on3::orthof(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar)
{
    mGLState->orthof(left, right, bottom, top, zNear, zFar);
}

void GLES1on3::frustumf(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar)
{
    ...
    for (int i = 0; i < 4; i++) {
        if (mGLState->isTextureTargetEnabled(GL_TEXTURE0 + i, GL_TEXTURE_2D)) {
            ...
            if (toDraw) {
                ...
                gl->bufferData(BufferBinding::Array, sizeof(vertexAttrs),
...
void GLES1on3::texCoordPointer(GLint size, GLenum type, GLsizei stride, const void* ptr) {
    mContext->vertexAttribPointer(4 + mGLState->getActiveSampler(), size, type, GL_FALSE, stride, ptr);
}
...
void GLES1on3::draw(bool indexed, GLenum mode, GLint first, GLsizei count, GLenum indexType, const GLvoid* indices) {
...

    {
        ...
        gl->uniformMatrix4fv(drawState.textureMatrixLoc, 4, GL_FALSE, drawState.texEnvBuffer.textureMatrices);
    }
...
//      the currently bound texture image of the appropriate dimensionality.
            ...
            tex2Denables[i] = !texCubeenables[i] && (glS->isTextureTargetEnabled(GL_TEXTURE0 + i, GL_TEXTURE_2D));
        ...
        gl->uniform1i(drawState.textureSampler0Loc, (tex2Denables[0] || !texCubeenables[0]) ? 0 : 4);
        gl->uniform1i(drawState.textureSampler1Loc, (tex2Denables[1] || !texCubeenables[1]) ? 1 : 5);
        gl->uniform1i(drawState.textureSampler2Loc, (tex2Denables[2] || !texCubeenables[2]) ? 2 : 6);
        gl->uniform1i(drawState.textureSampler3Loc, (tex2Denables[3] || !texCubeenables[3]) ? 3 : 7);
        ...
        gl->uniform1iv(drawState.pointSpriteCoordReplaceLoc, 4, drawState.texEnvBuffer.pointSpriteCoordReplaces);
        ...
        gl->uniform1i(drawState.enableReflectionMapLoc, glS->getEnableFeature(GL_REFLECTION_MAP_OES));
        ...
        gl->uniform1fv(drawState.lightSpotlightExponentsLoc, 8, drawState.lightingBuffer.spotlightExponents);
        gl->uniform1fv(drawState.lightSpotlightCutoffAnglesLoc, 8, drawState.lightingBuffer.spotlightCutoffAngles);
        gl->uniform1fv(drawState.lightAttenuationConstsLoc, 8, drawState.lightingBuffer.attenuationConsts);
        gl->uniform1fv(drawState.lightAttenuationLinearsLoc, 8, drawState.lightingBuffer.attenuationLinears);
        gl->uniform1fv(drawState.lightAttenuationQuadraticsLoc, 8, drawState.lightingBuffer.attenuationQuadratics);
