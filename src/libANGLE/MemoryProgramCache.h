...
class MemoryProgramCache final : angle::NonCopyable
{
  public:
    ...
    // TODO syoussefi: compatibility for Chrome until it supports EXT_ANDROID_blob_cache
    ...
    // Store a binary directly.  TODO syoussefi: deprecated.  Will be removed until Chrome supports EXT_ANDROID_blob_cache
