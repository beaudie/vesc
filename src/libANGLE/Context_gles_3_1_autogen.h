...
#define ANGLE_GLES_3_1_CONTEXT_API                                                                 \
    void activeShaderProgram(GLuint pipeline, ShaderProgramID programPacked);                      \
    ...
    void useProgramStages(GLuint pipeline, GLbitfield stages, ShaderProgramID programPacked);      \
