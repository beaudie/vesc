...
{
    ASSERT(mResource);
    return mResource->initializeContents(context, mTarget.textureIndex());
}
...
Error FramebufferAttachmentObject::initializeContents(const Context *context, const ImageIndex &imageIndex)
{
