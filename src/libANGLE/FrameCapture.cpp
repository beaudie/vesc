...
namespace
{
constexpr PackedEnumMap<ParamType, bool, kParamTypeCount> kIsResourceIDType = {
    {ParamType::TBufferID, true},
    {ParamType::TBufferIDConstPointer, true},
    {ParamType::TBufferIDPointer, true},
    {ParamType::TFenceNVID, true},
    {ParamType::TFenceNVIDConstPointer, true},
    {ParamType::TFenceNVIDPointer, true},
    {ParamType::TFramebufferID, true},
    {ParamType::TFramebufferIDConstPointer, true},
    {ParamType::TFramebufferIDPointer, true},
    {ParamType::TMemoryObjectID, true},
    {ParamType::TMemoryObjectIDConstPointer, true},
    {ParamType::TMemoryObjectIDPointer, true},
    {ParamType::TPathID, true},
    {ParamType::TProgramPipelineID, true},
    {ParamType::TProgramPipelineIDConstPointer, true},
    {ParamType::TProgramPipelineIDPointer, true},
    {ParamType::TQueryID, true},
    {ParamType::TQueryIDConstPointer, true},
    {ParamType::TQueryIDPointer, true},
    {ParamType::TRenderbufferID, true},
    {ParamType::TRenderbufferIDConstPointer, true},
    {ParamType::TRenderbufferIDPointer, true},
    {ParamType::TSamplerID, true},
    {ParamType::TSamplerIDConstPointer, true},
    {ParamType::TSamplerIDPointer, true},
    {ParamType::TSemaphoreID, true},
    {ParamType::TSemaphoreIDConstPointer, true},
    {ParamType::TSemaphoreIDPointer, true},
    {ParamType::TShaderProgramID, true},
    {ParamType::TShaderProgramIDConstPointer, true},
    {ParamType::TShaderProgramIDPointer, true},
    {ParamType::TTextureID, true},
    {ParamType::TTextureIDConstPointer, true},
    {ParamType::TTextureIDPointer, true},
    {ParamType::TTransformFeedbackID, true},
    {ParamType::TTransformFeedbackIDConstPointer, true},
    {ParamType::TTransformFeedbackIDPointer, true},
    {ParamType::TVertexArrayID, true},
    {ParamType::TVertexArrayIDConstPointer, true},
    {ParamType::TVertexArrayIDPointer, true}};

constexpr PackedEnumMap<ParamType, ResourceIDType, kParamTypeCount> kResourceIDTypeMap = {
    {ParamType::TBufferID, ResourceIDType::Buffer},
    {ParamType::TBufferIDConstPointer, ResourceIDType::Buffer},
    {ParamType::TBufferIDPointer, ResourceIDType::Buffer},
    {ParamType::TFenceNVID, ResourceIDType::FenceNV},
    {ParamType::TFenceNVIDConstPointer, ResourceIDType::FenceNV},
    {ParamType::TFenceNVIDPointer, ResourceIDType::FenceNV},
    {ParamType::TFramebufferID, ResourceIDType::Framebuffer},
    {ParamType::TFramebufferIDConstPointer, ResourceIDType::Framebuffer},
    {ParamType::TFramebufferIDPointer, ResourceIDType::Framebuffer},
    {ParamType::TMemoryObjectID, ResourceIDType::MemoryObject},
    {ParamType::TMemoryObjectIDConstPointer, ResourceIDType::MemoryObject},
    {ParamType::TMemoryObjectIDPointer, ResourceIDType::MemoryObject},
    {ParamType::TPathID, ResourceIDType::Path},
    {ParamType::TProgramPipelineID, ResourceIDType::ProgramPipeline},
    {ParamType::TProgramPipelineIDConstPointer, ResourceIDType::ProgramPipeline},
    {ParamType::TProgramPipelineIDPointer, ResourceIDType::ProgramPipeline},
    {ParamType::TQueryID, ResourceIDType::Query},
    {ParamType::TQueryIDConstPointer, ResourceIDType::Query},
    {ParamType::TQueryIDPointer, ResourceIDType::Query},
    {ParamType::TRenderbufferID, ResourceIDType::Renderbuffer},
    {ParamType::TRenderbufferIDConstPointer, ResourceIDType::Renderbuffer},
    {ParamType::TRenderbufferIDPointer, ResourceIDType::Renderbuffer},
    {ParamType::TSamplerID, ResourceIDType::Sampler},
    {ParamType::TSamplerIDConstPointer, ResourceIDType::Sampler},
    {ParamType::TSamplerIDPointer, ResourceIDType::Sampler},
    {ParamType::TSemaphoreID, ResourceIDType::Semaphore},
    {ParamType::TSemaphoreIDConstPointer, ResourceIDType::Semaphore},
    {ParamType::TSemaphoreIDPointer, ResourceIDType::Semaphore},
    {ParamType::TShaderProgramID, ResourceIDType::ShaderProgram},
    {ParamType::TShaderProgramIDConstPointer, ResourceIDType::ShaderProgram},
    {ParamType::TShaderProgramIDPointer, ResourceIDType::ShaderProgram},
    {ParamType::TTextureID, ResourceIDType::Texture},
    {ParamType::TTextureIDConstPointer, ResourceIDType::Texture},
    {ParamType::TTextureIDPointer, ResourceIDType::Texture},
    {ParamType::TTransformFeedbackID, ResourceIDType::TransformFeedback},
    {ParamType::TTransformFeedbackIDConstPointer, ResourceIDType::TransformFeedback},
    {ParamType::TTransformFeedbackIDPointer, ResourceIDType::TransformFeedback},
    {ParamType::TVertexArrayID, ResourceIDType::VertexArray},
    {ParamType::TVertexArrayIDConstPointer, ResourceIDType::VertexArray},
    {ParamType::TVertexArrayIDPointer, ResourceIDType::VertexArray}};

constexpr PackedEnumMap<ResourceIDType, const char *> kResourceIDTypeNames = {
    {ResourceIDType::Buffer, "Buffer"},
    {ResourceIDType::FenceNV, "FenceNV"},
    {ResourceIDType::Framebuffer, "Framebuffer"},
    {ResourceIDType::MemoryObject, "MemoryObject"},
    {ResourceIDType::Path, "Path"},
    {ResourceIDType::ProgramPipeline, "ProgramPipeline"},
    {ResourceIDType::Query, "Query"},
    {ResourceIDType::Renderbuffer, "Renderbuffer"},
    {ResourceIDType::Sampler, "Sampler"},
    {ResourceIDType::Semaphore, "Semaphore"},
    {ResourceIDType::ShaderProgram, "ShaderProgram"},
    {ResourceIDType::Texture, "Texture"},
    {ResourceIDType::TransformFeedback, "TransformFeedback"},
    {ResourceIDType::VertexArray, "VertexArray"}};
                                       ...
                                       const ParamCapture &param)
{
    ...
    const ResourceIDType resourceIDType = kResourceIDTypeMap[param.type];
    const char *name                    = kResourceIDTypeNames[resourceIDType];
...
void FrameCapture::updateGeneratedResourceIDs(const gl::Context *context,
                                              const CallCapture &call,
                                              const ParamCapture &param)
{
    GLsizei n = call.params.getParam("n", ParamType::TGLsizei, 0).value.GLsizeiVal;
    ...
    const char *resourceName  = kResourceIDTypeNames[kResourceIDTypeMap[param.type]];
...
void FrameCapture::maybeUpdateResourceIDs(const gl::Context *context, const CallCapture &call)
{
    ...
    {
        if (kIsResourceIDType[param.type])
        {
            mResourceIDCounts[kResourceIDTypeMap[param.type]]++;
        }
    }
    ...
    switch (call.entryPoint)
    {
        case gl::EntryPoint::GenBuffers:
        {
            ...
            updateGeneratedResourceIDs<gl::BufferID>(context, call, buffers);
            break;
        }
        ...
        case gl::EntryPoint::GenFramebuffers:
        {
            ...
            updateGeneratedResourceIDs<gl::FramebufferID>(context, call, framebuffers);
            break;
        }
        ...
        case gl::EntryPoint::GenRenderbuffersOES:
        {
            ...
            updateGeneratedResourceIDs<gl::RenderbufferID>(context, call, renderbuffers);
            break;
        }
        ...
        case gl::EntryPoint::GenSamplers:
        {
            ...
            updateGeneratedResourceIDs<gl::SamplerID>(context, call, samplers);
            break;
        }
        ...
        case gl::EntryPoint::GenTextures:
        {
            ...
            updateGeneratedResourceIDs<gl::TextureID>(context, call, textures);
            break;
        }
...
void FrameCapture::saveCapturedFrameAsCpp(int contextId)
{
    ...
    for (ResourceIDType resourceType : AllEnums<ResourceIDType>())
    {
        ...
        const char *name = kResourceIDTypeNames[resourceType];
