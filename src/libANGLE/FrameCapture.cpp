...
void WriteCppMidExecutionSetupReplay(int contextId,
                                     DataCounters *counters,
                                     std::ostream &out,
                                     std::ostream &header,
                                     std::vector<uint8_t> *binaryData,
                    ...
                    const std::vector<CallCapture> &setupCalls)
{
    ...
    if (!setupCalls.empty())
    {
        WriteCppMidExecutionSetupReplay(contextId, &counters, out, header, &binaryData, setupCalls);
    }
