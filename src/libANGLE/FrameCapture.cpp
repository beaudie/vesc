                              ...
                              const HasResourceTypeMap &hasResourceType)
{
    ...
    header << "extern void *gBufferData;\n";
    ...
    source << "void* gBufferData = nullptr;\n";
    ...
    source << "\n";
    source << "{\n";
    source << "    memcpy(gBufferData, source, size);\n";
    source << "}\n";
    ...
    switch (call.entryPoint)
    {
        ...
        case gl::EntryPoint::MapBufferRange:
        {
            ...
            if (access & GL_MAP_WRITE_BIT)
            {
                ...
                // on Unmap for to repopulate it during replay
                ...
                mBufferDataMap[target] = std::pair<GLintptr, GLsizei>(offset, length);
            }
            break;
        }
        ...
        case gl::EntryPoint::UnmapBuffer:
        {
            ...
            captureClientBufferSnapshot(context, call);
            break;
        }
        default:
            break;
...
void FrameCapture::captureClientBufferSnapshot(const gl::Context *context, const CallCapture &call)
{
    ...
    //   ...
    //   gBufferData = glMapBufferRange(GL_PIXEL_UNPACK_BUFFER, 0, 65536, GL_MAP_WRITE_BIT);
    //   ...
    ...
    GLsizei length  = bufferDataInfo->second.second;
    ...
    dataParamBuffer.addValueParam<GLsizei>("size", ParamType::TGLsizei, length);
