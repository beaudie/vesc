...
void FrameCapture::maybeUpdateResourceIDs(const gl::Context *context, const CallCapture &call)
{
    ...
    switch (call.entryPoint)
    {
        ...
        {
            // TODO(jmadill): Handle shader IDs. http://anglebug.com/3611
            break;
        }

        case gl::EntryPoint::CreateProgram:
        {
            // TODO(jmadill): Handle program IDs. http://anglebug.com/3611
            break;
        }
        ...
        case gl::EntryPoint::GenFencesNV:
        {
            ...
            updateGeneratedResourceIDs<gl::FenceNVID>(context, call, fences);
            break;
        }
        ...
        case gl::EntryPoint::GenProgramPipelines:
        {
            ...
            updateGeneratedResourceIDs<gl::ProgramPipelineID>(context, call, pipelines);
            break;
        }
        ...
        case gl::EntryPoint::GenQueriesEXT:
        {
            ...
            updateGeneratedResourceIDs<gl::QueryID>(context, call, queries);
            break;
        }
        ...
        case gl::EntryPoint::GenSemaphoresEXT:
        {
            ...
            updateGeneratedResourceIDs<gl::SemaphoreID>(context, call, semaphores);
            break;
        }
        ...
        case gl::EntryPoint::GenTransformFeedbacks:
        {
            ...
            updateGeneratedResourceIDs<gl::TransformFeedbackID>(context, call, xfbs);
            break;
        }
        ...
        case gl::EntryPoint::GenVertexArraysOES:
        {
            ...
            updateGeneratedResourceIDs<gl::VertexArrayID>(context, call, vertexArrays);
            break;
        }
