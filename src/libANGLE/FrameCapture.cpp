...
{
    std::string enabled = angle::android::AndroidGetEnvFromProp(kAndroidCaptureEnabled);
    if (!enabled.empty())
    {
    ...
    std::string outDir = angle::android::AndroidGetEnvFromProp(kAndroidOutDir);
    if (!outDir.empty())
    {
    ...
    std::string frameStart = angle::android::AndroidGetEnvFromProp(kAndroidFrameStart);
    if (!frameStart.empty())
    {
    ...
    std::string frameEnd = angle::android::AndroidGetEnvFromProp(kAndroidFrameEnd);
    if (!frameEnd.empty())
    {
...
std::string GetDefaultOutDirectory()
{
    ...
    path += std::string(applicationId) + "/angle_capture/";
