...
void WriteStringPointerParamReplay(DataTracker *dataTracker,
                                   ...
                                   const ParamCapture &param)
{
    // Concatenate the strings to generate a hash
    std::string str;
    ...
    int counter = dataTracker->getStringCounterMap().getStringCounter(str);
    if (counter == kStringNotFound)
    {
        ...
        dataTracker->getStringCounterMap().setStringCounter(str, counter);
...
StringCounterMap::StringCounterMap() = default;

StringCounterMap::~StringCounterMap() = default;

constexpr int kStringNotFound = -1;
int StringCounterMap::getStringCounter(std::string &str)
{
...
void StringCounterMap::setStringCounter(std::string &str, int &counter)
{
    ASSERT(counter >= 0);
