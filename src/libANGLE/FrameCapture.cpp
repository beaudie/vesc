                              ...
                              std::vector<uint8_t> &binaryData)
{
    ...
    header << "constexpr EGLint kReplayDrawSurfaceWidth = " << drawSurfaceWidths[contextId]
           << ";\n";
    header << "constexpr EGLint kReplayDrawSurfaceHeight = " << drawSurfaceHeights[contextId]
           << ";\n";
