        ...
        case GL_UNSIGNED_NORMALIZED:
            ...
            return (format == GL_RGBA && type == GL_UNSIGNED_BYTE && info->pixelBytes >= 1) ||
                   ...
                   (context->getExtensions().readDepthNV && format == GL_DEPTH_COMPONENT &&
                    ...
                    info->depthBits > 0 && info->componentCount == 1) ||
                   (context->getClientVersion() >= ES_3_1 && format == GL_DEPTH_COMPONENT &&
                    type == GL_UNSIGNED_SHORT &&
                    info->sizedInternalFormat == GL_DEPTH_COMPONENT16) ||
                   (context->getClientVersion() >= ES_3_1 && format == GL_DEPTH_COMPONENT &&
                   ...
                   (context->getClientVersion() >= ES_3_1 && format == GL_DEPTH_COMPONENT &&
                    type == GL_UNSIGNED_INT_24_8 &&
                    info->sizedInternalFormat == GL_DEPTH24_STENCIL8);
