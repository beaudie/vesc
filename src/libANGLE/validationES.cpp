                              ...
                              GLsizei depth)
{
    ...
    if (formatInfo.paletted)
    {
        ...
        // Paletted textures must have sides that are powers of two, but ES2 CTS
        // uploads compressed 0x0 compressed images and expects that to work.
        if (!(width == 0 || isPow2(width)) || !(height == 0 || isPow2(height)))
        {
            return false;
        }
    }
