                                  ...
                                  bool restrictedWrapModes)
{
    switch (ConvertToGLenum(params[0]))
    {
        ...
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidTextureWrap);
            return false;
    }
    ...
    switch (ConvertToGLenum(params[0]))
    {
        ...
        case GL_LINEAR_MIPMAP_LINEAR:
            if (restrictedMinFilter)
            {
                ...
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidFilterTexture);
                return false;
            }
            break;
                                     ...
                                     const ParamType *params)
{
    ...
    switch (ConvertToGLenum(params[0]))
    {
        ...
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kUnknownParameter);
            return false;
    }
                                       ...
                                       GLfloat paramValue)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kOutsideOfBounds);
        return false;
    }
                                       ...
                                       GLsizei primcount)
{
    if (primcount <= 0)
    {
        if (primcount < 0)
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativePrimcount);
            return false;
        }
...
bool ValidateDrawInstancedANGLE(const Context *context, angle::EntryPoint entryPoint)
{
    ...
    ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kNoZeroDivisor);
    return false;
}
                              ...
                              bool isSubImage)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kTextureNotPow2);
        return false;
    }
                        ...
                        GLsizei imageSize)
{
    ...
    else
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kImageSizeMustBeZero);
            return false;
        }

        if (pixels != nullptr && endByte > static_cast<GLuint>(imageSize))
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kImageSizeTooSmall);
            return false;
        }
    }
                                      ...
                                      bool pureInteger)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kStrideExceedsWebGLLimit);
        return false;
    }
...
Shader *GetValidShader(const Context *context, angle::EntryPoint entryPoint, ShaderProgramID id)
{
    ...
    if (!validShader)
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kExpectedShaderName);
        }
        else
        {
                              ...
                              GLenum attachment)
{
    if (attachment >= GL_COLOR_ATTACHMENT1_EXT && attachment <= GL_COLOR_ATTACHMENT15_EXT)
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidAttachment);
            return false;
        }
    }
    else
                                               ...
                                               GLsizei height)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kResourceMaxRenderbufferSize);
        return false;
    }
                                       ...
                                       GLenum filter)
{
    switch (filter)
    {
        ...
        case GL_LINEAR:
            break;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kBlitInvalidFilter);
            return false;
    }

    if ((mask & ~(GL_COLOR_BUFFER_BIT | GL_STENCIL_BUFFER_BIT | GL_DEPTH_BUFFER_BIT)) != 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kBlitInvalidMask);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kBlitYUVFramebuffer);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kBlitFeedbackLoop);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kBlitDimensionsOutOfRange);
        return false;
    }
    ...
    if (mask & GL_COLOR_BUFFER_BIT)
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kBlitMissingColor);
            return false;
        }
    }
                                       ...
                                       GLint param)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kDefaultFramebuffer);
        return false;
    }
    return true;
}
                                ...
                                TextureType target)
{
    ...
    if (texture == nullptr)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kTextureNotBound);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kBaseLevelOutOfRange);
        return false;
    }
         ...
         !isPow2(static_cast<int>(texture->getHeight(baseTarget, 0)))))
    {
        ...
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kTextureNotPow2);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kCubemapIncomplete);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kGenerateMipmapZeroSize);
        return false;
    }
                            ...
                            QueryID id)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidQueryType);
        return false;
    }

    if (id.value == 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidQueryId);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kOtherQueryActive);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kQueryTargetMismatch);
        return false;
    }
...
bool ValidateEndQueryBase(const Context *context, angle::EntryPoint entryPoint, QueryType target)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kQueryInactive);
        return false;
    }
                             ...
                             QueryType target)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidQueryTarget);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kQueryActive);
        return false;
    }
                                     ...
                                     GLsizei *numParams)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_CONTEXT_LOST, kContextLost);
                               ...
                               const LinkedUniform **uniformOut)
{
    ...
    if (!program)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidProgramName);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidUniformLocation);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidUniformCount);
        return false;
    }
                             ...
                             const GLint *value)
{
    ...
    ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kUniformTypeMismatch);
    return false;
}
                           ...
                           GLboolean transpose)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kES3Required);
        return false;
    }
                        ...
                        unsigned int *numParams)
{
    ...
    switch (pname)
    {
        ...
        case GL_IMPLEMENTATION_COLOR_READ_FORMAT:
        {
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kReadBufferNone);
                return false;
            }
                                    ...
                                    GLenum target)
{
    ...
    switch (target)
    {
        ...
        case GL_TEXTURE_CUBE_MAP_ARRAY_EXT:
        {
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM,
                                       err::kTextureTypeMismatch);
                return false;
            }
            break;
        }
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidTarget);
            return false;
    }
                                          ...
                                          GLsizei *samples)
{
    ...
    else
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kNotTextureComplete);
            return false;
        }
                              ...
                              GLsizei height)
{
    ...
    if ((width % formatInfo.compressedBlockWidth != 0) ||
        (height % formatInfo.compressedBlockHeight != 0))
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidCompressedRegionSize);
        return false;
    }
                                  ...
                                  GLsizei srcDepth)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidTextureLevel);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kIncompatibleTextures);
        return false;
    }
                                        ...
                                        Format *textureFormatOut)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kIntegerOverflow);
        return false;
    }
    ...
    if (source == nullptr)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kMissingReadAttachment);
        return false;
    }

    if (source->isYUV())
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kCopyFromYUVFramebuffer);
        return false;
    }
    ...
    else
    {
        if ((texType == TextureType::CubeMap || texType == TextureType::CubeMapArray) &&
            width != height)
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kCubemapIncomplete);
            return false;
        }
    ...
    if (context->isWebGL())
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kFeedbackLoop);
            return false;
        }
    }
...
void RecordDrawModeError(const Context *context, angle::EntryPoint entryPoint, PrimitiveMode mode)
{
    ...
    switch (mode)
    {
        ...
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidDrawMode);
            return;
    }
                             ...
                             GLsizei *length)
{
    ...
    if (bufSize < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kNegativeBufferSize);
        return false;
    }
                                    ...
                                    bool defaultFramebuffer)
{
    if (numAttachments < 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kNegativeAttachments);
        return false;
    }
                            ...
                            egl::ImageID imageID)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidEGLImage);
        return false;
    }
                               ...
                               GLint length)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidProgramBinaryFormat);
        return false;
    }
                                  ...
                                  const void *binary)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kNoProgramBinaryFormats);
        return false;
    }
                             ...
                             const GLenum *bufs)
{
    ...
    for (int colorAttachment = 0; colorAttachment < n; colorAttachment++)
    {
             ...
             bufs[colorAttachment] > GL_COLOR_ATTACHMENT31))
        {
            ...
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidDrawBuffer);
            return false;
        }
                             ...
                             BufferBinding target)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kBufferNotMapped);
        return false;
    }
                                ...
                                GLbitfield access)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kMapOutOfRange);
        return false;
    }
    ...
    if (buffer->isImmutable())
    {
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidAccessBits);
            return false;
        }
        ...
        {
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidAccessBits);
            return false;
        }
    }
    ...
    if (length == 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kLengthZero);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidAccessBitsRead);
        return false;
    }

    if ((access & GL_MAP_WRITE_BIT) == 0 && (access & GL_MAP_FLUSH_EXPLICIT_BIT) != 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidAccessBitsFlush);
        return false;
    }
                                        ...
                                        GLsizeiptr length)
{
    ...
    if (buffer == nullptr)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidFlushZero);
        return false;
    }

    if (!buffer->isMapped() || (buffer->getAccessFlags() & GL_MAP_FLUSH_EXPLICIT_BIT) == 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidFlushTarget);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidFlushOutOfRange);
        return false;
    }
                              ...
                              GLsizei *numParams)
{
    ...
    switch (pname)
    {
        ...
        case GL_PROGRAM_BINARY_RETRIEVABLE_HINT:
            if (context->getClientMajorVersion() < 3)
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kEnumRequiresGLES30);
                return false;
            }
            break;
        ...
        case GL_ACTIVE_ATOMIC_COUNTER_BUFFERS:
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kEnumRequiresGLES31);
                return false;
            }
            break;
                                            ...
                                            GLsizei *length)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kRenderbufferNotBound);
        return false;
    }
                                 ...
                                 GLsizei *length)
{
    ...
    if (context->getTextureByType(target) == nullptr)
    {
        ...
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kTextureNotBound);
        return false;
    }
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_CROP_RECT_OES:
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kGLES1Only);
                return false;
            }
            break;
                              ...
                              const ParamType *params)
{
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_BASE_LEVEL:
            ...
            {
                ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kBaseLevelNegative);
                return false;
            }
                                  ...
                                  const ParamType *params)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kInvalidSampler);
        return false;
    }
                                     ...
                                     GLsizei *numParams)
{
    ...
    if (!formatCaps.renderbuffer)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kFormatNotRenderable);
        return false;
    }
...
bool ValidateMultitextureUnit(const Context *context, angle::EntryPoint entryPoint, GLenum texture)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidMultitextureUnit);
        return false;
    }
    return true;
}
                                   ...
                                   GLsizei height)
{
    ...
    if (samples == 0)
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kSamplesZero);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kRenderableInternalFormat);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kZeroBoundToTarget);
        return false;
    }

    if (texture->getImmutableFormat())
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_OPERATION, kImmutableTextureBound);
        return false;
    }
    return true;
}
                                  ...
                                  const GLfloat *val)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kIndexExceedsSamples);
        return false;
    }
                             ...
                             GLbitfield mask)
{
    ...
    {
        ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_VALUE, kInvalidSampleMaskNumber);
        return false;
    }
                                 ...
                                 GraphicsResetStatus other)
{
    ...
    switch (current)
    {
        ...
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidResetStatus);
    }
                           ...
                           LogicalOperation opcodePacked)
{
    switch (opcodePacked)
    {
        ...
        case LogicalOperation::Xor:
            return true;
        default:
            ANGLE_VALIDATION_ERROR(context, entryPoint, GL_INVALID_ENUM, kInvalidLogicOp);
            return false;
    }
}
}  // namespace gl
