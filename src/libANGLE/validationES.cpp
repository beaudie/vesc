                                       ...
                                       GLenum filter)
{
    ...
    // consider it MS. needIntrinsic = false
                                        ...
                                        Format *textureFormatOut)
{
    ...
    // needIntrinsic = true. Treat renderToTexture textures as single sample since they wil be
...
{
    int samples =
        needIntrinsic ? framebuffer->getResourceSamples(context) : framebuffer->getSamples(context);
    if (samples != 0)
    {
