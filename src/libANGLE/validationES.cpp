                                       ...
                                       GLenum filter)
{
    ...
    if ((readFramebuffer->getMultiviewLayout() != GL_NONE && readFramebuffer->getNumViews() > 1) ||
        readFramebuffer->getMultiviewLayout() == GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE)
    {
        context->handleError(InvalidFramebufferOperation()
                                        ...
                                        Format *textureFormatOut)
{
    ...
    if ((source->getMultiviewLayout() != GL_NONE && source->getNumViews() > 1) ||
        source->getMultiviewLayout() == GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE)
    {
        context->handleError(InvalidFramebufferOperation()
                            ...
                            void *pixels)
{
    ...
    if ((readBuffer->getMultiviewLayout() != GL_NONE && readBuffer->getNumViews() > 1) ||
        readBuffer->getMultiviewLayout() == GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE)
    {
        context->handleError(InvalidFramebufferOperation()
