                                               ...
                                               GLuint renderbuffer)
{
    ...
    if (framebuffer->id() == 0)
    {
        context->handleError(InvalidOperation() << GET_ERROR_MESSAGE(DefaultFramebufferTarget));
        return false;
    }
                                        ...
                                        Format *textureFormatOut)
{
    ...
    else
    {
        ...
        {
            context->handleError(InvalidValue() << GET_ERROR_MESSAGE(CubemapIncomplete));
            return false;
        }
                              ...
                              GLsizei primcount)
{
        ...
        !curTransformFeedback->isPaused() && curTransformFeedback->getPrimitiveMode() != mode)
    {
        ...
        context->handleError(InvalidOperation()
                             << GET_ERROR_MESSAGE(InvalidDrawModeTransformFeedback));
        return false;
    }
