...
bool ValidateVertexShaderAttributeTypeMatch(ValidationContext *context)
{
    ...
    if (!AttributesTypeMask::ProgramAttribsMatch(
            program->getAttributesTypeMask(), vao->getAttributesTypeMask(),
            glState.getCurrentValuesTypeMask(), program->getAttributesMask(),
            vao->getAttributesMask()))
    {
