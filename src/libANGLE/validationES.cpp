    ...
    *outErrorCode = GL_INVALID_OPERATION;
    ...
    if (context->getClientVersion() >= Version(2, 0))
    {
        ...
        if (framebuffer->isFoveationEnabled())
        {
            ...
            // TODO (anglebug.com/8484): Handle foveation case for MRT and framebuffer completeness
        }
    }
                              ...
                              const ParamType *params)
{
    ...
    switch (pname)
    {
        ...
        case GL_TEXTURE_FOVEATED_FEATURE_BITS_QCOM:
            ...
            if (static_cast<GLuint>(params[0]) !=
                (static_cast<GLuint>(params[0]) &
            ...
            if ((context->getTextureByType(target)->getFoveatedFeatureBits() &
                ...
                (static_cast<GLuint>(params[0]) & GL_FOVEATION_ENABLE_BIT_QCOM) == 0)
            {
