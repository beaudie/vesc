...
template bool ValidateTexParameterBase(Context *, GLenum, GLenum, GLsizei, GLfloat *);
template bool ValidateTexParameterBase(Context *, GLenum, GLenum, GLsizei, GLint *);
