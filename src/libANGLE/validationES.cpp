                             ...
                             const GLint *value)
{
    ...
    // We do this cheap test first, for a little extra speed.
...
bool ValidateUniformValue(gl::Context *context, GLenum valueType, GLenum uniformType)
{
    ...
    // We do the cheaper test first, for a little extra speed.
                           ...
                           GLboolean transpose)
{
    ...
    const LinkedUniform *uniform = nullptr;
    gl::Program *programObject   = context->getGLState().getProgram();
    return ValidateUniformCommonBase(context, programObject, valueType, count, &uniform) &&
           ValidateUniformMatrixValue(context, valueType, uniform->type);
}
