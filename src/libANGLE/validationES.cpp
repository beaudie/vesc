                                ...
                                GLsizei primcount)
{
    ...
    // Here we skip vertex buffer validation by passing maxVertex = 0 and vertexCount = 0 to avoid
    // retrieving IndexRange.
    if (!ValidateDrawAttribs(context, primcount, 0, 0))
    {
        return false;
    }
