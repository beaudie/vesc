...
class Renderbuffer : public FramebufferAttachmentObject
{
  public:
    ...
    Error setStorageEGLImage(egl::Image *imageTarget);
    void setEGLImageSource(egl::Image *imageSource);
  ...
  private:
    ...
    void orphanEGLImages();
    std::vector<BindingPointer<egl::Image>> mEGLImages;
};
