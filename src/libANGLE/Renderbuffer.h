...
class Renderbuffer : public RenderableObject
{
  public:
    ...
    GLenum getAttachmentInternalFormat(const gl::FramebufferAttachment::Target &/*target*/) const override { return getInternalFormat(); }
    GLsizei getAttachmentSamples(const gl::FramebufferAttachment::Target &/*target*/) const override { return getSamples(); }
