...
bool ValidateUniform1d(Context *context, UniformLocation location, GLdouble x)
{
    return true;
}
...
bool ValidateUniform2d(Context *context, UniformLocation location, GLdouble x, GLdouble y)
{
    return true;
}
