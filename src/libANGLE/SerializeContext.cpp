                               ...
                               FramebufferState *framebufferState)
{
    ...
    bos->writeIntVector<GLenum>(framebufferState->mDrawBufferStates);
    bos->writeInt<GLenum>(framebufferState->mReadBufferState);
                                    ...
                                    FramebufferAttachment *framebufferAttachment)
{
    ...
    bos->writeInt<GLenum>(framebufferAttachment->mType);
    // serialize target variable
    bos->writeInt<GLenum>(framebufferAttachment->mTarget.mBinding);
