...
#define ANGLE_GLES_2_0_CONTEXT_API                                                                 \
    ...
    void attachShader(GLuint program, ShaderID shaderPacked);                                      \
    ...
    ShaderID createShader(ShaderType typePacked);                                                  \
    ...
    void detachShader(GLuint program, ShaderID shaderPacked);                                      \
