...
void Shader::resolveCompile(const Context *context)
{
    ...
    mStatus      = success ? Status::COMPILED : Status::NOT_COMPILED;
}
...
{
    resolveCompile(context);
    return mStatus == Status::COMPILED;
}
