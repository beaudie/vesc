...
using CompileImplFunctor = std::function<bool(const std::string &)>;
...
void Shader::compile(const Context *context)
{
    ...
    auto compileImplFunctor = [this](const std::string &source) {
        return mImplementation->compileInWorkerThread(source);
    };
    mCompileTask =
