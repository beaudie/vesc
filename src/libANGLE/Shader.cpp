        ...
        {
            {
                ...
                int numViews = sh::GetVertexShaderNumViews(compilerHandle);
                // If the number of views is not set through the num_views layout, initialize num
                // views to a default value of 1.
                mState.mNumViews = numViews > 0 ? numViews : 1;
            }
            break;
        }
