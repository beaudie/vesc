...
angle::Result ProgramPipeline::link(const Context *context)
{
    ...
    ShaderMap<SharedProgramExecutable> previousPPOProgramExecutables =
        std::move(mState.mExecutable->mPPOProgramExecutables);
    ...
    mState.mExecutable->mPPOProgramExecutables = std::move(previousPPOProgramExecutables);
