...
void Renderbuffer::onAttach(const Context *context, rx::Serial framebuferSerial)
{
    addRef();
}

void Renderbuffer::onDetach(const Context *context, rx::Serial framebuferSerial)
{
    release(context);
}
