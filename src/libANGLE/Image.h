...
class OrphanedImageHelper final
{
  public:
    ...
    void setForceFlush(bool force) { mForceFlush = force; }
    bool getForceFlush() { return mForceFlush; }
...
inline OrphanedImageHelper::OrphanedImageHelper()
{
    mForceFlush = false;
}
...
class ImageSibling : public gl::FramebufferAttachmentObject
{
  ...
  protected:
    ...
    angle::Result orphanImages(const gl::Context *context, bool retainOrphaned);
