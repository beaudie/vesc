                             ...
                             const sh::BlockMemberInfo &blockInfoIn)
{
    ...
    blockOffset      = blockInfoIn.offset;
    blockArrayStride = blockInfoIn.arrayStride;
...
LinkedUniform::LinkedUniform(const UsedUniform &usedUniform)
{
    ...
    blockOffset                    = usedUniform.blockInfo.offset;
    blockArrayStride               = usedUniform.blockInfo.arrayStride;
    flagBits.blockIsRowMajorMatrix = usedUniform.blockInfo.isRowMajorMatrix;
