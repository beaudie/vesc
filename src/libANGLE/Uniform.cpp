...
void StaticallyUsed::unionWith(const StaticallyUsed &child)
{
    vertexStaticUse |= child.vertexStaticUse;
    fragmentStaticUse |= child.fragmentStaticUse;
    computeStaticUse |= child.computeStaticUse;
}
