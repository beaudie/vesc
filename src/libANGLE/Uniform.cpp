...
BackedBufferInfo::BackedBufferInfo() : bufferBinding(0), dataSize(0)
{
}

BackedBufferInfo::~BackedBufferInfo()
{
}

BackedBufferInfo::BackedBufferInfo(const BackedBufferInfo &other)
{
...
BackedBufferInfo &BackedBufferInfo::operator=(const BackedBufferInfo &other)
{
    bufferBinding = other.bufferBinding;
    dataSize      = other.dataSize;
    memberIndexes = other.memberIndexes;
