...
ANGLE_INLINE bool ColorspaceFormatOverride(const EGLenum colorspace,
                                           const GLenum rendertargetformat,
                                           GLenum &finalizedRenderTargetFormat)
{
    GLenum nonLinearFormat      = getNonLinearFormat(rendertargetformat);
    finalizedRenderTargetFormat = rendertargetformat;
    ...
    switch (colorspace)
    {
        ...
        case EGL_GL_COLORSPACE_SCRGB_EXT:
            ...
            {
                finalizedRenderTargetFormat = nonLinearFormat;
                return true;
            }
            else
            {
