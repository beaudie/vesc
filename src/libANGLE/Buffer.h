...
class BufferState final : angle::NonCopyable
{
  public:
    ...
    int getBindingCount() const { return mBindingCount; }
    int getTransformFeedbackIndexedBindingCount() const
    {
        return mTransformFeedbackIndexedBindingCount;
    }
    int getTransformFeedbackGenericBindingCount() const
    {
        return mTransformFeedbackGenericBindingCount;
    }
