...
std::vector<std::string> getGLbitmaskInString(unsigned int value)
{
    ...
    {
        case 0x1:
            return std::vector<std::string>{"GL_MAP_READ_BIT", "GL_SYNC_FLUSH_COMMANDS_BIT",
                                            "GL_VERTEX_SHADER_BIT",
                                            "GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT"};
        case 0x2:
            return std::vector<std::string>{"GL_MAP_WRITE_BIT", "GL_FRAGMENT_SHADER_BIT",
                                            "GL_ELEMENT_ARRAY_BARRIER_BIT",
                                            "GL_CONTEXT_FLAG_DEBUG_BIT"};
        case 0x4:
            return std::vector<std::string>{"GL_MAP_INVALIDATE_RANGE_BIT", "GL_UNIFORM_BARRIER_BIT",
                                            "GL_GEOMETRY_SHADER_BIT",
                                            "GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT"};
        case 0x8:
            return std::vector<std::string>{"GL_MAP_INVALIDATE_BUFFER_BIT",
                                            "GL_TEXTURE_FETCH_BARRIER_BIT",
                                            "GL_TESS_CONTROL_SHADER_BIT"};
        case 0x10:
            return std::vector<std::string>{"GL_MAP_FLUSH_EXPLICIT_BIT",
                                            "GL_TESS_EVALUATION_SHADER_BIT"};
        case 0x20:
            return std::vector<std::string>{"GL_MAP_UNSYNCHRONIZED_BIT", "GL_COMPUTE_SHADER_BIT",
                                            "GL_SHADER_IMAGE_ACCESS_BARRIER_BIT"};
        case 0x40:
            return std::vector<std::string>{"GL_COMMAND_BARRIER_BIT"};
        case 0x80:
            return std::vector<std::string>{"GL_PIXEL_BUFFER_BARRIER_BIT"};
        case 0x100:
            return std::vector<std::string>{"GL_DEPTH_BUFFER_BIT", "GL_TEXTURE_UPDATE_BARRIER_BIT"};
        case 0x200:
            return std::vector<std::string>{"GL_BUFFER_UPDATE_BARRIER_BIT"};
        case 0x400:
            return std::vector<std::string>{"GL_STENCIL_BUFFER_BIT", "GL_FRAMEBUFFER_BARRIER_BIT"};
        case 0x800:
            return std::vector<std::string>{"GL_TRANSFORM_FEEDBACK_BARRIER_BIT"};
        case 0x1000:
            return std::vector<std::string>{"GL_ATOMIC_COUNTER_BARRIER_BIT"};
        case 0x2000:
            return std::vector<std::string>{"GL_SHADER_STORAGE_BARRIER_BIT"};
        case 0x4000:
            return std::vector<std::string>{"GL_COLOR_BUFFER_BIT"};
        case 0xffffffff:
            return std::vector<std::string>{"GL_ALL_SHADER_BITS", "GL_ALL_BARRIER_BITS"};
        default:
            UNREACHABLE();
    }
