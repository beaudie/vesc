...
// Generated by generate_entry_points.py using data from gl32.h, gl.xml and gl_angle_ext.xml.
//
...
const std::map<const unsigned int, const std::vector<std::string>> GLenumValueToStringLookupTable =
    {{0x0, {"GL_POINTS"}},
     {0x1,
      {"GL_LINES", "GL_MAP_READ_BIT", "GL_SYNC_FLUSH_COMMANDS_BIT", "GL_VERTEX_SHADER_BIT",
       "GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT"}},
     {0x2,
      {"GL_LINE_LOOP", "GL_MAP_WRITE_BIT", "GL_FRAGMENT_SHADER_BIT", "GL_ELEMENT_ARRAY_BARRIER_BIT",
       "GL_CONTEXT_FLAG_DEBUG_BIT"}},
     {0x3, {"GL_LINE_STRIP"}},
     {0x4,
      {"GL_TRIANGLES", "GL_MAP_INVALIDATE_RANGE_BIT", "GL_UNIFORM_BARRIER_BIT",
       "GL_GEOMETRY_SHADER_BIT", "GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT"}},
     {0x5, {"GL_TRIANGLE_STRIP"}},
     {0x6, {"GL_TRIANGLE_FAN"}},
     {0x7, {"GL_QUADS"}},
     {0x8,
      {"GL_MAP_INVALIDATE_BUFFER_BIT", "GL_TEXTURE_FETCH_BARRIER_BIT",
     ...
     {0x20,
      {"GL_MAP_UNSYNCHRONIZED_BIT", "GL_COMPUTE_SHADER_BIT", "GL_SHADER_IMAGE_ACCESS_BARRIER_BIT"}},
     {0x40, {"GL_COMMAND_BARRIER_BIT"}},
     {0x80, {"GL_PIXEL_BUFFER_BARRIER_BIT"}},
     {0x100, {"GL_DEPTH_BUFFER_BIT", "GL_TEXTURE_UPDATE_BARRIER_BIT"}},
     {0x200, {"GL_NEVER", "GL_BUFFER_UPDATE_BARRIER_BIT"}},
     {0x201, {"GL_LESS"}},
     {0x202, {"GL_EQUAL"}},
     {0x203, {"GL_LEQUAL"}},
     {0x204, {"GL_GREATER"}},
     ...
     {0xde1, {"GL_TEXTURE_2D"}},
     {0x1000, {"GL_ATOMIC_COUNTER_BARRIER_BIT", "GL_TEXTURE_WIDTH"}},
     ...
     {0x8c2a, {"GL_TEXTURE_BUFFER", "GL_TEXTURE_BUFFER_BINDING"}},
     ...
     {0x8ca6, {"GL_FRAMEBUFFER_BINDING", "GL_DRAW_FRAMEBUFFER_BINDING"}},
     ...
     {0x8f36, {"GL_COPY_READ_BUFFER", "GL_COPY_READ_BUFFER_BINDING"}},
     {0x8f37, {"GL_COPY_WRITE_BUFFER", "GL_COPY_WRITE_BUFFER_BINDING"}},
