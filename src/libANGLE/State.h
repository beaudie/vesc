...
class State : angle::NonCopyable
{
  public:
    ...
    // Dirty bit masks
    const DirtyBits &unpackStateBits() const { return mUnpackStateBits; }
    const DirtyBits &packStateBits() const { return mPackStateBits; }
    const DirtyBits &clearStateBits() const { return mClearStateBits; }
  ...
  private:
    ...
    DirtyBits mUnpackStateBits;
    DirtyBits mPackStateBits;
    DirtyBits mClearStateBits;
};
