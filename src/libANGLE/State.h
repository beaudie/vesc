...
class State : angle::NonCopyable
{
  public:
    ...
    DrawBufferMask getBlendEnabledDrawBufferMask() const { return mBlendStateExt.blendEnabledMask; }
    ...
    {
        return (mBlendFuncConstantAlphaDrawBuffers & mBlendStateExt.blendEnabledMask).any();
    }

    bool hasSimultaneousConstantColorAndAlphaBlendFunc() const
    {
        return (mBlendFuncConstantColorDrawBuffers & mBlendStateExt.blendEnabledMask).any() &&
