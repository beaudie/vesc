...
class Surface final : public gl::FBOAttachmentObject
{
  public:
    ...
    // FBOAttachmentObject implementation
  ...
  private:
    virtual ~Surface();
    rx::FBOAttachmentObjectImpl *getAttachmentImpl() const override { return mImplementation; }
