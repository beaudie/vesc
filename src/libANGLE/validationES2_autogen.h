...
bool ValidateAttachShader(Context *context, GLuint program, ShaderID shaderPacked);
...
bool ValidateDetachShader(Context *context, GLuint program, ShaderID shaderPacked);
