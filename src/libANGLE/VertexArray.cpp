...
void VertexArray::bindVertexBuffer(size_t bindingIndex,
                                   ...
                                   GLsizei stride)
{
    bindVertexBufferImpl(bindingIndex, boundBuffer, offset, stride);

    mDirtyBits.set(DIRTY_BIT_BINDING_0_BUFFER + bindingIndex);
}

void VertexArray::bindVertexBufferImpl(size_t bindingIndex,
                                       Buffer *boundBuffer,
                                       GLintptr offset,
                                       GLsizei stride)
{
...
void VertexArray::setVertexAttribDivisor(size_t attribIndex, GLuint divisor)
{
    ...
    mDirtyBits.set(DIRTY_BIT_ATTRIB_0_DIVISOR + attribIndex);
}
                                         ...
                                         const void *pointer)
{
    ...
    bindVertexBufferImpl(attribIndex, boundBuffer, offset, effectiveStride);
