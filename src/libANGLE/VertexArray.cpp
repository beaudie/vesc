                                                          ...
                                                          const void *pointer)
{
    ...
    // Whether binding buffer change "from client side to driver side" or
    // "from driver side to client side". (i.e. one of oldBuffer and boundBuffer is zero)
    // Because for client side buffer, backend may transfer it to a tightly packed driver
    // sied buffer and causing stride to change.
