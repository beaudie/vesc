...
void VertexArray::onMakeCurrent(const Context *context)
{
         ...
         ++bindingIndex)
    {
        ...
        if (bufferGL)
        {
            ...
            // TODO:  This all turns into mState.mCachedInvalidMappedArrayBuffer. Check to see if we
            // can simplify it.
