...
const AttribBinding &VertexArray::getAttribBinding(size_t bindingIndex) const
{
                                   ...
                                   GLsizei stride)
{
    ...
    AttribBinding *binding = &mState.mAttribBindings[bindingIndex];
...
void VertexArray::setVertexAttribBinding(size_t attribIndex, size_t bindingIndex)
{
    ...
    AttribFormat *format = &mState.mVertexAttribs[attribIndex].format;
                                    ...
                                    const void *pointer)
{
    ...
    AttribFormat *format    = &attrib.format;
