    ...
    : mLabel(), mVertexBindings(maxAttribBindings), mMaxEnabledAttribute(0)
{
    ...
    mVertexAttributesTypeMask.reset();
}
                                         ...
                                         GLuint bindingIndex)
{
    ...
    if (mState.mVertexAttributes[attribIndex].bindingIndex != bindingIndex)
    {
        ...
        mState.mVertexAttributesTypeMask.resetIndex(mState.mVertexAttributes[attribIndex].bindingIndex);
        mState.mVertexAttributesTypeMask.setIndex(GetVertexAttributeBaseType(mState.mVertexAttributes[attribIndex]), bindingIndex, true);
