...
State::State()
{
    ...
    mUnpackStateBits.set(DIRTY_BIT_UNPACK_ALIGNMENT);
    mUnpackStateBits.set(DIRTY_BIT_UNPACK_ROW_LENGTH);
    mPackStateBits.set(DIRTY_BIT_PACK_ALIGNMENT);
    mPackStateBits.set(DIRTY_BIT_PACK_REVERSE_ROW_ORDER);
    mClearStateBits.set(DIRTY_BIT_RASTERIZER_DISCARD_ENABLED);
    mClearStateBits.set(DIRTY_BIT_SCISSOR_TEST_ENABLED);
    mClearStateBits.set(DIRTY_BIT_SCISSOR);
    mClearStateBits.set(DIRTY_BIT_VIEWPORT);
    mClearStateBits.set(DIRTY_BIT_CLEAR_COLOR);
    mClearStateBits.set(DIRTY_BIT_CLEAR_DEPTH);
    mClearStateBits.set(DIRTY_BIT_CLEAR_STENCIL);
    mClearStateBits.set(DIRTY_BIT_COLOR_MASK);
    mClearStateBits.set(DIRTY_BIT_DEPTH_MASK);
    mClearStateBits.set(DIRTY_BIT_STENCIL_WRITEMASK_FRONT);
    mClearStateBits.set(DIRTY_BIT_STENCIL_WRITEMASK_BACK);
}
