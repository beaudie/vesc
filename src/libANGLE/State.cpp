...
void State::setEnableFeature(GLenum feature, bool enabled)
{
    switch (feature)
    {
        ...
        case GL_ALPHA_TEST:
            ...
            break;
        case GL_TEXTURE_2D:
            mGLES1State.mTexUnitEnables[mActiveSampler].enable2D = enabled;
            break;
        case GL_TEXTURE_CUBE_MAP:
            mGLES1State.mTexUnitEnables[mActiveSampler].enableCubeMap = enabled;
            break;
...
bool State::getEnableFeature(GLenum feature) const
{
    switch (feature)
    {
        ...
        case GL_TEXTURE_2D:
            return mGLES1State.mTexUnitEnables[mActiveSampler].enable2D;
        case GL_TEXTURE_CUBE_MAP:
            return mGLES1State.mTexUnitEnables[mActiveSampler].enableCubeMap;
        default:
            UNREACHABLE();
            return false;
    }
