                                    ...
                                    GLsizeiptr size)
{
    ...
    switch (target)
    {
        ...
        case BufferBinding::Uniform:
            UpdateBufferBinding(context, &mUniformBuffers[index], buffer, target);
            mDirtyBits.set(DIRTY_BIT_UNIFORM_BUFFER_BINDINGS);
            break;
        case BufferBinding::AtomicCounter:
            UpdateBufferBinding(context, &mAtomicCounterBuffers[index], buffer, target);
            break;
        case BufferBinding::ShaderStorage:
            UpdateBufferBinding(context, &mShaderStorageBuffers[index], buffer, target);
            break;
        default:
            UNREACHABLE();
            break;
