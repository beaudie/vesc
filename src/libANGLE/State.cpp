...
{
    currMatrix() *= angle::Mat4::ortho(left, right, bottom, top, zNear, zFar);
}

void State::frustumf(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar)
{
    currMatrix() *= angle::Mat4::frustum(left, right, bottom, top, zNear, zFar);
}
...
{
    currMatrix() *= angle::Mat4::rotate(deg, angle::Vector3(x, y, z));
}

void State::scalef(float x, float y, float z)
{
    currMatrix() *= angle::Mat4::scale(angle::Vector3(x, y, z));
}

void State::translatef(float x, float y, float z)
{
    currMatrix() *= angle::Mat4::translate(angle::Vector3(x, y, z));
}
