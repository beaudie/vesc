...
{
    stencilMask = CastMaskValue(stencilMask);
...
{
    stencilBackMask = CastMaskValue(stencilBackMask);
...
{
    stencilWritemask = CastMaskValue(stencilWritemask);
...
{
    stencilBackWritemask = CastMaskValue(stencilBackWritemask);
