...
bool State::getEnableFeature(GLenum feature) const
{
    switch (feature)
    {
      ...
      case GL_TEXTURE_2D:
      case GL_TEXTURE_CUBE_MAP:
          return isTextureTargetEnabled(mActiveSampler, feature);
      ...
      case GL_TEXTURE_COORD_ARRAY:
          return mEnabledClientStates.find(feature) !=
