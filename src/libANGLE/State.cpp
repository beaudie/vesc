...
State::State()
    : mMaxDrawBuffers(0),
      ...
      mNearZ(0),
      mFarZ(0),
      mDrawFramebufferViewportOffsets(TransformViewportOffsetArrayToVectorOfOffsets(
...
void State::setDrawFramebufferBinding(Framebuffer *framebuffer)
{
        ...
        framebuffer->getMultiviewLayout() == GL_FRAMEBUFFER_MULTIVIEW_SIDE_BY_SIDE_ANGLE)
    {
        ...
        retrieveAndStoreViewportOffsets();
...
void State::retrieveAndStoreViewportOffsets()
{
