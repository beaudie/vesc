...
void State::setBufferBinding(const Context *context, BufferType target, Buffer *buffer)
{
...
Buffer *State::getTargetBuffer(BufferType target) const
{
    switch (target)
    {
        case BufferType::ElementArray:
...
void State::getIntegerv(const Context *context, GLenum pname, GLint *params)
{
    ...
    switch (pname)
    {
        case GL_ARRAY_BUFFER_BINDING:
            *params = mBoundBuffers[BufferType::Array].id();
            break;
        case GL_DRAW_INDIRECT_BUFFER_BINDING:
            *params = mBoundBuffers[BufferType::DrawIndirect].id();
            break;
      ...
      case GL_UNIFORM_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::Uniform].id();
          break;
      ...
      case GL_COPY_READ_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::CopyRead].id();
          break;
      case GL_COPY_WRITE_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::CopyWrite].id();
          break;
      case GL_PIXEL_PACK_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::PixelPack].id();
          break;
      case GL_PIXEL_UNPACK_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::PixelUnpack].id();
          break;
      case GL_READ_BUFFER:
      ...
      case GL_ATOMIC_COUNTER_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::AtomicCounter].id();
          break;
      case GL_SHADER_STORAGE_BUFFER_BINDING:
          *params = mBoundBuffers[BufferType::ShaderStorage].id();
          break;
      default:
        UNREACHABLE();
        break;
...
bool State::hasMappedBuffer(BufferType target) const
{
    if (target == BufferType::Array)
    {
