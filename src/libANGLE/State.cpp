...
State::State(const State *shareContextState,
    ...
    : mID({gIDCounter++}),
      ...
      mSharedContextMutexActivation(singleContextMutex == nullptr
                                        ? SharedContextMutexActivation::kPermanent
                                        : SharedContextMutexActivation::kNone),
      mSharedContextMutexTempActivationTime(0.0),
