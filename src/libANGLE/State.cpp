                       ...
                       bool robustResourceInit)
{
    ...
    mSampleMask         = false;
    mSampleMaskValues.resize(mMaxSampleMaskWords);
    for (size_t maskIndex = 0; maskIndex < mMaxSampleMaskWords; ++maskIndex)
    {
...
void State::setSampleMask(bool enabled)
{
    mSampleMask = enabled;
...
GLbitfield State::getSampleMask(GLuint maskNumber) const
{
    ASSERT(maskNumber < mMaxSampleMaskWords);
