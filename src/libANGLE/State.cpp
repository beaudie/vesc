...
void State::getIntegerv(const Context *context, GLenum pname, GLint *params)
{
    ...
    switch (pname)
    {
      ...
      case GL_STENCIL_VALUE_MASK:
          *params = (context->getClientVersion() >= Version(3, 1)
                         ? ConvertFromMaskValue(mDepthStencil.stencilMask)
                         : rightClampCast<GLint>(mDepthStencil.stencilMask));
          break;
      ...
      case GL_STENCIL_BACK_VALUE_MASK:
          *params = (context->getClientVersion() >= Version(3, 1)
                         ? ConvertFromMaskValue(mDepthStencil.stencilBackMask)
                         : rightClampCast<GLint>(mDepthStencil.stencilBackMask));
          break;
      ...
      case GL_STENCIL_WRITEMASK:
          *params = (context->getClientVersion() >= Version(3, 1)
                         ? ConvertFromMaskValue(mDepthStencil.stencilWritemask)
                         : rightClampCast<GLint>(mDepthStencil.stencilWritemask));
          break;
      case GL_STENCIL_BACK_WRITEMASK:
          *params = (context->getClientVersion() >= Version(3, 1)
                         ? ConvertFromMaskValue(mDepthStencil.stencilBackWritemask)
                         : rightClampCast<GLint>(mDepthStencil.stencilBackWritemask));
          break;
