...
State::State(const State *shareContextState,
    ...
    : mID({gIDCounter++}),
      ...
      mFragmentShaderFramebufferFetchMRT(false)
{}
...
void State::setEnableFeature(GLenum feature, bool enabled)
{
    switch (feature)
    {
        ...
        case GL_FRAGMENT_SHADER_FRAMEBUFFER_FETCH_MRT_ARM:
            mFragmentShaderFramebufferFetchMRT = enabled;
            return;
    }
...
bool State::getEnableFeature(GLenum feature) const
{
    switch (feature)
    {
        ...
        case GL_FRAGMENT_SHADER_FRAMEBUFFER_FETCH_MRT_ARM:
            return mFragmentShaderFramebufferFetchMRT;
    }
...
void State::getBooleanv(GLenum pname, GLboolean *params) const
{
    switch (pname)
    {
        ...
        // GL_ARM_shader_framebuffer_fetch
        case GL_FRAGMENT_SHADER_FRAMEBUFFER_FETCH_MRT_ARM:
            *params = mFragmentShaderFramebufferFetchMRT;
            break;
        default:
            UNREACHABLE();
            break;
...
void State::getFloatv(GLenum pname, GLfloat *params) const
{
    ...
    switch (pname)
    {
        ...
        // GL_ARM_shader_framebuffer_fetch
        case GL_FRAGMENT_SHADER_FRAMEBUFFER_FETCH_MRT_ARM:
            *params = mFragmentShaderFramebufferFetchMRT ? 1.0f : 0.0f;
            break;
        default:
            UNREACHABLE();
            break;
...
angle::Result State::getIntegerv(const Context *context, GLenum pname, GLint *params) const
{
    ...
    switch (pname)
    {
        ...
        // GL_ARM_shader_framebuffer_fetch
        case GL_FRAGMENT_SHADER_FRAMEBUFFER_FETCH_MRT_ARM:
            *params = mFragmentShaderFramebufferFetchMRT ? 1 : 0;
            break;
