...
DisplayExtensions::DisplayExtensions()
    : createContextRobustness(false),
      ...
      d3dTypelessTextureClientBuffer(false),
...
std::vector<std::string> DisplayExtensions::getStrings() const
{
    ...
    InsertExtensionString("EGL_ANGLE_d3d_typeless_texture_client_buffer",        d3dTypelessTextureClientBuffer,     &extensionStrings);
