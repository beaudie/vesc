...
const ExtensionInfoMap &GetExtensionInfoMap()
{
    auto buildExtensionInfoMap = []() {
        ...
        map["GL_ANGLE_memory_object_fuchsia"] = enableableExtension(&Extensions::memoryObjectZirconHandle);
        ...
        map["GL_ANGLE_semaphore_fuchsia"] = enableableExtension(&Extensions::semaphoreZirconHandle);
