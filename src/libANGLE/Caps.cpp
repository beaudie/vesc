...
Caps GenerateMinimumCaps(const Version &clientVersion, const Extensions &extensions)
{
    ...
    if (clientVersion >= Version(2, 0))
    {
        ...
        caps.maxShaderTextureImageUnits[gl::ShaderType::Fragment] = 8;
    ...
    if (clientVersion >= Version(3, 0))
    {
        ...
        caps.maxShaderUniformBlocks[gl::ShaderType::Vertex]     = 12;
        caps.maxVertexOutputComponents  = 64;
        caps.maxShaderTextureImageUnits[gl::ShaderType::Vertex] = 16;

        // Table 6.32
        caps.maxFragmentUniformComponents = 896;
        caps.maxFragmentUniformVectors    = 224;
        caps.maxShaderUniformBlocks[gl::ShaderType::Fragment]     = 12;
        ...
        caps.maxCombinedVertexUniformComponents =
            caps.maxShaderUniformBlocks[gl::ShaderType::Vertex] * (caps.maxUniformBlockSize / 4) +
            caps.maxVertexUniformComponents;
        caps.maxCombinedFragmentUniformComponents =
            caps.maxShaderUniformBlocks[gl::ShaderType::Fragment] * (caps.maxUniformBlockSize / 4) +
    ...
    if (clientVersion >= Version(3, 1))
    {
        ...
        caps.maxShaderStorageBlocks[gl::ShaderType::Vertex] = 0;
        ...
        caps.maxShaderStorageBlocks[gl::ShaderType::Fragment] = 0;
        ...
        caps.maxShaderUniformBlocks[gl::ShaderType::Compute]     = 12;
        caps.maxShaderTextureImageUnits[gl::ShaderType::Compute] = 16;
        ...
        caps.maxShaderStorageBlocks[gl::ShaderType::Compute] = 4;
    ...
    if (extensions.geometryShader)
    {
        ...
        caps.maxShaderUniformBlocks[gl::ShaderType::Geometry]     = 12;
        ...
        caps.maxShaderTextureImageUnits[gl::ShaderType::Geometry] = 16;
        caps.maxGeometryAtomicCounterBuffers  = 0;
        caps.maxGeometryAtomicCounters        = 0;
        caps.maxShaderStorageBlocks[gl::ShaderType::Geometry]     = 0;
