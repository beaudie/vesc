...
const char *ValidateDrawElementsStates(const Context *context, angle::EntryPoint entryPoint);
...
const char *ValidateDrawStates(const Context *context, angle::EntryPoint entryPoint);
