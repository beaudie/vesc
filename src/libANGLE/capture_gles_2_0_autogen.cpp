                                      ...
                                      ShaderID *shadersPacked)
{
    ...
    CaptureGetAttachedShaders_count(context, isCallValid, program, maxCount, count, shadersPacked,
                                    &countParam);
    ...
    CaptureGetAttachedShaders_shadersPacked(context, isCallValid, program, maxCount, count,
