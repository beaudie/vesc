...
class ShaderState final : angle::NonCopyable
{
  public:
    ...
    {
        return rx::SpecConstUsageBits(mCompiledShaderState.specConstUsageBits);
    }
    ...
    {
        return mCompiledShaderState.hasValidGeometryShaderInputPrimitiveType
                   ? static_cast<PrimitiveMode>(
                         mCompiledShaderState.geometryShaderInputPrimitiveType)
                   : Optional<PrimitiveMode>::Invalid();
    }

    Optional<PrimitiveMode> getGeometryShaderOutputPrimitiveType() const
    {
        return mCompiledShaderState.hasValidGeometryShaderOutputPrimitiveType
                   ? static_cast<PrimitiveMode>(
                         mCompiledShaderState.geometryShaderOutputPrimitiveType)
                   : Optional<PrimitiveMode>::Invalid();
    }

    Optional<GLint> getGeometryShaderMaxVertices() const
    {
        return mCompiledShaderState.hasValidGeometryShaderMaxVertices
                   ? static_cast<GLint>(mCompiledShaderState.geometryShaderMaxVertices)
                   : Optional<GLint>::Invalid();
    }
  ...
  private:
    ...
    sh::CompiledShaderState mCompiledShaderState;
...
class Shader final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    {
        return BlendEquationBitSet(mState.mCompiledShaderState.advancedBlendEquationBits);
    }
    rx::SpecConstUsageBits getSpecConstUsageBits() const
    {
        return rx::SpecConstUsageBits(mState.mCompiledShaderState.specConstUsageBits);
    }
