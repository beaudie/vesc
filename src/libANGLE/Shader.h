...
class ShaderState final : angle::NonCopyable
{
  public:
    ...
    {
        return static_cast<PrimitiveMode>(mCompiledShaderState.geometryShaderInputPrimitiveType);
    }

    Optional<PrimitiveMode> getGeometryShaderOutputPrimitiveType() const
    {
        return static_cast<PrimitiveMode>(mCompiledShaderState.geometryShaderOutputPrimitiveType);
    }
