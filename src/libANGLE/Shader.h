...
class ShaderState final : angle::NonCopyable
{
  public:
    ...
    const std::vector<uint32_t> &getCompiledBinary() const { return mCompiledBinary; }
  ...
  private:
    ...
    std::vector<uint32_t> mCompiledBinary;
    std::string mSource;
...
class Shader final : angle::NonCopyable, public LabeledObject
{
  public:
    ...
    const std::vector<uint32_t> &getCompiledBinary();
