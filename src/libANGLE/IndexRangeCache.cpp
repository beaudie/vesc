...
{
    IndexRangeMap::const_iterator i =
        mIndexRangeCache.find(IndexRangeKey(type, offset, count, primitiveRestartEnabled));
...
bool IndexRangeCache::IndexRangeKey::operator<(const IndexRangeKey &rhs) const
{
    ...
    return primitiveRestartEnabled < rhs.primitiveRestartEnabled;
}
