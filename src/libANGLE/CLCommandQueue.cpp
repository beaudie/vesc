...
#define ANGLE_TRY_CREATE_EVENT(commandType)                                                 \
    do                                                                                      \
    {                                                                                       \
        if (errorCode == CL_SUCCESS && event != nullptr)                                    \
        {                                                                                   \
            ASSERT(eventCreateFunc);                                                        \
            *event = Object::Create<Event>(errorCode, *this, commandType, eventCreateFunc); \
        }                                                                                   \
    } while (0)
                                       ...
                                       cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_READ_BUFFER);
    return errorCode;
}
                                        ...
                                        cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_WRITE_BUFFER);
    return errorCode;
}
                                           ...
                                           cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_READ_BUFFER_RECT);
    return errorCode;
}
                                            ...
                                            cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_WRITE_BUFFER_RECT);
    return errorCode;
}
                                       ...
                                       cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_COPY_BUFFER);
    return errorCode;
}
                                           ...
                                           cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_COPY_BUFFER_RECT);
    return errorCode;
}
                                       ...
                                       cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_FILL_BUFFER);
    return errorCode;
}
                                     ...
                                     cl_int &errorCode)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_MAP_BUFFER);
    return map;
}
                                      ...
                                      cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_READ_IMAGE);
    return errorCode;
}
                                       ...
                                       cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_WRITE_IMAGE);
    return errorCode;
}
                                      ...
                                      cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_COPY_IMAGE);
    return errorCode;
}
                                      ...
                                      cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_FILL_IMAGE);
    return errorCode;
}
                                              ...
                                              cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_COPY_IMAGE_TO_BUFFER);
    return errorCode;
}
                                              ...
                                              cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_COPY_BUFFER_TO_IMAGE);
    return errorCode;
}
                                    ...
                                    cl_int &errorCode)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_MAP_IMAGE);
    return map;
}
                                           ...
                                           cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_UNMAP_MEM_OBJECT);
    return errorCode;
}
                                              ...
                                              cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_MIGRATE_MEM_OBJECTS);
    return errorCode;
}
                                          ...
                                          cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_NDRANGE_KERNEL);
    return errorCode;
}
                                 ...
                                 cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_TASK);
    return errorCode;
}
                                         ...
                                         cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_NATIVE_KERNEL);
    return errorCode;
}
                                               ...
                                               cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_MARKER);
    return errorCode;
}
                                                ...
                                                cl_event *event)
{
    ...
    ANGLE_TRY_CREATE_EVENT(CL_COMMAND_BARRIER);
    return errorCode;
}
