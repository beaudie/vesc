                                     ...
                                     const GLfloat *transformValues)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION, "GL_CHROMIUM_path_rendering is not available.");
        return false;
    }
                                   ...
                                   const void *pixels)
{
    ...
    if (isCompressed)
    {
        ...
        if (isSubImage)
        {
            ...
            {
                context->validationError(GL_INVALID_OPERATION, "Invalid compressed format dimension.");
                return false;
            }
    ...
    else
    {
        ...
        switch (format)
        {
            ...
            case GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_LOSSY_DECODE_ETC2_ANGLE:
                if (context->getExtensions().lossyETCDecode)
                {
                    context->validationError(GL_INVALID_OPERATION, "ETC lossy decode formats can't work with this type.");
                    return false;
                }
                else
                {
                    context->validationError(GL_INVALID_ENUM, "ANGLE_lossy_etc_decode extension is not supported.");
                    return false;
                }
                break;
            case GL_DEPTH_COMPONENT:
                               ...
                               const GLchar *message)
{
    ...
    {
        context
            ->validationError(GL_STACK_OVERFLOW,
...
static bool ValidateObjectIdentifierAndName(Context *context, GLenum identifier, GLuint name)
{
    switch (identifier)
    {
        ...
        case GL_TRANSFORM_FEEDBACK:
            ...
            {
                context->validationError(GL_INVALID_VALUE, "name is not a valid transform feedback.");
                return false;
            }
            return true;
...
static bool ValidateLabelLength(Context *context, GLsizei length, const GLchar *label)
{
    ...
    {
        context->validationError(GL_INVALID_VALUE, "Label length is larger than GL_MAX_LABEL_LENGTH.");
        return false;
    }
...
bool ValidateClear(Context *context, GLbitfield mask)
{
    ...
    if (extensions.multiview && extensions.disjointTimerQuery)
    {
        ...
        {
            context->validationError(GL_INVALID_OPERATION, "There is an active query for target "
                                  ...
                                  const void *data)
{
    ...
    {
        context->validationError(GL_INVALID_ENUM, "Rectangle texture cannot have a compressed format.");
        return false;
    }
                                         ...
                                         const GLchar *name)
{
    ...
    {
        context->validationError(GL_INVALID_VALUE, "Location must be less than "
...
bool ValidateCoverageModulationCHROMIUM(Context *context, GLenum components)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"GL_CHROMIUM_framebuffer_mixed_samples is not available.");
        return false;
    }
    switch (components)
    {
        ...
        default:
            context->validationError(
                GL_INVALID_ENUM,"GLenum components is not one of GL_RGB, GL_RGBA, GL_ALPHA or GL_NONE.");
            return false;
    }
                                                 ...
                                                 const GLfloat *coeffs)
{
    ...
    if (binding.type != GL_NONE)
    {
        ...
        switch (binding.type)
        {
            ...
            default:
                context->validationError(
                    GL_INVALID_OPERATION,"Fragment input type is not a floating point scalar or vector.");
                return false;
        }
                                 ...
                                 GLboolean unpackUnmultiplyAlpha)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"GL_CHROMIUM_copy_texture extension not available.");
        return false;
    }
    ...
    {
        context->validationError(GL_INVALID_OPERATION, "Source texture internal format is invalid.");
        return false;
    }
    ...
    if (dest == nullptr)
    {
        context->validationError(GL_INVALID_VALUE, "Destination texture is not a valid texture object.");
        return false;
    }
                                    ...
                                    GLboolean unpackUnmultiplyAlpha)
{
    ...
    {
        context->validationError(GL_INVALID_VALUE, "The source level of the source texture must be defined.");
        return false;
    }
    ...
    {
        context
            ->validationError(GL_INVALID_OPERATION,"The destination level of the destination texture must be defined.");
        return false;
    }
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"Destination internal format and type combination is not valid.");
        return false;
    }
    ...
    {
        context->validationError(GL_INVALID_VALUE, "Destination texture not large enough to copy to.");
        return false;
    }
...
bool ValidateCompressedCopyTextureCHROMIUM(Context *context, GLuint sourceId, GLuint destId)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"GL_CHROMIUM_copy_compressed_texture extension not available.");
        return false;
    }
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"Source texture must have a compressed internal format.");
        return false;
    }
    ...
    {
        context->validationError(GL_INVALID_VALUE, "Destination texture must be of type GL_TEXTURE_2D.");
        return false;
    }
...
bool ValidateRequestExtensionANGLE(Context *context, const GLchar *name)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION, "GL_ANGLE_request_extension is not available.");
        return false;
    }
                                 ...
                                 const void *ptr)
{
    ...
    if (context->getClientVersion() >= ES_3_1)
    {
        ...
        {
            context->validationError(GL_INVALID_VALUE, "stride cannot be greater than MAX_VERTEX_ATTRIB_STRIDE.");
            return false;
        }

        if (index >= caps.maxVertexAttribBindings)
        {
            context->validationError(GL_INVALID_VALUE, "index must be smaller than MAX_VERTEX_ATTRIB_BINDINGS.");
            return false;
        }
    }
    ...
    {
        context
            ->validationError(GL_INVALID_OPERATION,"Client data cannot be used with a non-default vertex array object.");
        return false;
    }
                                                 ...
                                                 GLsizei height)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION,"GL_ANGLE_framebuffer_multisample not available");
        return false;
    }
                                      ...
                                      GLint *precision)
{
    switch (shadertype)
    {
        ...
        case GL_COMPUTE_SHADER:
            context->validationError(GL_INVALID_OPERATION,"compute shader precision not yet implemented.");
            return false;
        default:
            context->validationError(GL_INVALID_ENUM, kErrorInvalidShaderType);
            return false;
...
bool ValidateHint(Context *context, GLenum target, GLenum mode)
{
    ...
    switch (target)
    {
        ...
        case GL_FRAGMENT_SHADER_DERIVATIVE_HINT:
            ...
            {
                context->validationError(GL_INVALID_ENUM, "hint requires OES_standard_derivatives.");
                return false;
            }
            break;
    ...
    if (texture != 0)
    {
        ...
        switch (textarget)
        {
            ...
            case TextureTarget::Rectangle:
            {
                ...
                {
                    context->validationError(GL_INVALID_OPERATION,"Textarget must match the texture target type.");
                    return false;
                }
            }
            break;
...
bool ValidateGenerateMipmap(Context *context, TextureType target)
{
    ...
    {
        context->validationError(GL_INVALID_OPERATION, kError);
        return false;
    }
...
bool ValidateLinkProgram(Context *context, GLuint program)
{
    if (context->hasActiveTransformFeedback(program))
    {
        ...
        context->validationError(GL_INVALID_OPERATION, "Cannot link program while program is "
...
bool ValidateUseProgram(Context *context, GLuint program)
{
    ...
    if (context->getGLState().isTransformFeedbackActiveUnpaused())
    {
        // ES 3.0.4 section 2.15 page 91
        context
            ->validationError(GL_INVALID_OPERATION,"Cannot change active program while transform feedback is unpaused.");
        return false;
    }
