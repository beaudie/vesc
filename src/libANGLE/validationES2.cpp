...
bool IsValidESSLShaderSourceString(const char *str, size_t len)
{
    enum ParseState
    {
    ...
    ParseState state = BEGINING_OF_LINE;
    size_t pos       = 0;
    ...
    while (pos < len)
    {
        ...
        switch (state)
        {
            case BEGINING_OF_LINE:
                ...
                {
                    state = IN_PREPORCESSOR_DIRECTIVE;
                    pos++;
                }
                else
                {
            ...
            case IN_PREPORCESSOR_DIRECTIVE:
