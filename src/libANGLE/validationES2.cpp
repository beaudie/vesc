                                    ...
                                    GLboolean enabled)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidEnum(), DebugInvalidSource);
        return false;
    }

    if (!ValidDebugType(type) && type != GL_DONT_CARE)
    {
        ANGLE_VALIDATION_ERR(context, InvalidEnum(), DebugInvalidType);
        return false;
    }

    if (!ValidDebugSeverity(severity) && severity != GL_DONT_CARE)
    {
        ANGLE_VALIDATION_ERR(context, InvalidEnum(), DebugInvalidSeverity);
        return false;
    }
