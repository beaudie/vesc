...
bool ValidateClear(ValidationContext *context, GLbitfield mask)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidValue(), ClearInvalidMask);
        return false;
    }
...
bool ValidateBindTexture(Context *context, GLenum target, GLuint texture)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidOperation(), SubtextureFormatType);
        return false;
    }
                                         ...
                                         const GLchar *name)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidValue(), NameInvalidCharacters);
        return false;
    }
                                    ...
                                    GLboolean unpackUnmultiplyAlpha)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidValue(), SubtextureDimensions);
        return false;
    }
...
bool ValidateCreateShader(Context *context, GLenum type)
{
    switch (type)
    {
        ...
        default:
            ANGLE_VALIDATION_ERR(context, InvalidEnum(), InvalidShaderName);
            return false;
    }
                        ...
                        GLenum usage)
{
    ...
    if (!buffer)
    {
        ANGLE_VALIDATION_ERR(context, InvalidOperation(), BufferDataNull);
        return false;
    }
                           ...
                           const void *data)
{
    ...
    if (!buffer)
    {
        ANGLE_VALIDATION_ERR(context, InvalidOperation(), BufferSubDataNull);
        return false;
    }
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidValue(), ParamOverflow);
        return false;
    }
                                ...
                                const GLchar *name)
{
    ...
    if (context->getExtensions().webglCompatibility && !ValidateWebGLNamePrefix(context, name))
    {
        return false;
    }
...
bool ValidateDepthRangef(ValidationContext *context, GLfloat zNear, GLfloat zFar)
{
    ...
    {
        ANGLE_VALIDATION_ERR(context, InvalidOperation(), DepthRange);
        return false;
    }
