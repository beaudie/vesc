                                    ...
                                    GLboolean unpackUnmultiplyAlpha)
{
    ...
    if (!IsValidCopyTextureSourceInternalFormatEnum(sourceFormat.info->internalFormat))
    {
        context->handleError(
            Error(GL_INVALID_OPERATION, "Source texture internal format is invalid."));
        return false;
    ...
    if (!IsValidCopyTextureDestinationFormatType(context, destFormat.internalFormat,
                                                 destFormat.type))
    {
        context->handleError(
            Error(GL_INVALID_OPERATION,
