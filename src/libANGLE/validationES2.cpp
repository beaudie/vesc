...
bool IsValidCopyTextureSourceTarget(const Context *context, TextureType type)
{
    switch (type)
    {
        ...
        case TextureType::VideoImage:
            return context->getExtensions().webglVideoTextureWEBGL;
        default:
            return false;
    }
}
...
bool ValidCap(const Context *context, GLenum cap, bool queryOnly)
{
    switch (cap)
    {
        ...
        case GL_TEXTURE_RECTANGLE_ANGLE:
            return context->getExtensions().webglCompatibilityANGLE;
                                         ...
                                         const GLchar *name)
{
    ...
    if (context->getExtensions().webglCompatibilityANGLE && !IsValidESSLString(name, strlen(name)))
    {
...
{
    if (context->getExtensions().webglCompatibilityANGLE && zNear > zFar)
    {
...
void RecordBindTextureTypeError(const Context *context, TextureType target)
{
    ...
    switch (target)
    {
        ...
        case TextureType::VideoImage:
            ASSERT(!context->getExtensions().webglVideoTextureWEBGL);
