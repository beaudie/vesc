...
bool ValidateMultiDrawArraysWEBGL(Context *context,
                                  PrimitiveMode mode,
                                  const GLint *firsts,
...
bool ValidateMultiDrawElementsWEBGL(Context *context,
                                    PrimitiveMode mode,
                                    const GLsizei *counts,
                                    GLenum type,
                                    ...
                                    GLsizei drawcount)
{
    ...
    for (GLsizei drawID = 0; drawID < drawcount; ++drawID)
    {
        ...
        context->gatherParams<EntryPoint::DrawElements>(mode, counts[drawID], type, indices);
