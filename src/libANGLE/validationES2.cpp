...
// is not one of: CULL_FACE, GL_DEPTH_CLAMP_EXT, DEPTH_TEST, POLYGON_OFFSET_FILL,
// PRIMITIVE_RESTART_FIXED_INDEX, SCISSOR_TEST, STENCIL_TEST, CLIP_DISTANCE[0..7]_EXT
