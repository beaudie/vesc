...
template <angle::EntryPoint EP, typename ReturnType>
constexpr ReturnType GetDefaultReturnValue(Thread *thread);

template <>
constexpr ANGLE_INLINE EGLint
...
template <angle::EntryPoint EP, typename ReturnType>
constexpr ANGLE_INLINE ReturnType GetDefaultReturnValue(Thread *thread)
{
...
template <>
inline EGLNativePixmapType PackParam<EGLNativePixmapType, void *>(void *nativePixmap)
{
    return reinterpret_cast<EGLNativePixmapType>(nativePixmap);
}

template <>
inline EGLNativeWindowType PackParam<EGLNativeWindowType, void *>(void *nativeWindow)
{
