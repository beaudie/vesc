  ...
  public:
    ...
    bool hasLinkedShaderStage(ShaderType shaderType) const
    {
        return mPrograms[shaderType] &&
               mPrograms[shaderType]->getExecutable().hasLinkedShaderStage(shaderType);
    }
...
class ProgramPipeline final : public RefCountObject<ProgramPipelineID>, public LabeledObject
{
  public:
    ...
    const ActiveTextureArray<gl::TextureType> &getActiveSamplerTypes() const;
    ...
    bool isDefaultProgramPipeline() { return (id().value == 0); }
