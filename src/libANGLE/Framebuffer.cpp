...
bool IsClearBufferMaskedOut(const Context *context, GLenum buffer, GLint drawbuffer)
{
    ...
    {
        case GL_COLOR:
            ASSERT(drawbuffer < context->getState().getBlendStateArray().size());
                                        ...
                                        bool stencil)
{
    ...
    if (color && glState.activeDrawBuffersSomeChannelsMasked())
    {
        return true;
    }
...
angle::Result Framebuffer::clear(const Context *context, GLbitfield mask)
{
    ...
    if (context->getState().activeDrawBuffersAllChannelsMasked())
    {
                                                             ...
                                                             GLbitfield mask)
{
    ...
    bool color = (mask & GL_COLOR_BUFFER_BIT) != 0 && !glState.activeDrawBuffersAllChannelsMasked();
