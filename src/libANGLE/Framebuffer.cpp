      ...
      mDirtyStencilAttachmentBinding(this, DIRTY_BIT_STENCIL_ATTACHMENT)
{
    ...
    mState.mDrawBufferTypeMask |= gl::GetDrawBufferTypeMask(getDrawbufferWriteType(0), 0);
}
...
void Framebuffer::setDrawBuffers(size_t count, const GLenum *buffers)
{
    ...
    for (size_t index = 0; index < count; ++index)
    {
        mState.mDrawBufferTypeMask |=
            gl::GetDrawBufferTypeMask(getDrawbufferWriteType(index), index);
                                    ...
                                    const GLint *viewportOffsets)
{
    switch (binding)
    {
        ...
        default:
        {
            ...
            mState.mDrawBufferTypeMask |=
                gl::GetDrawBufferTypeMask(getDrawbufferWriteType(colorIndex), colorIndex);
        }
        break;
    }
