...
const FramebufferAttachment *Framebuffer::Data::getReadAttachment() const
{
    ...
    return mColorAttachments[readIndex].valid() ? &mColorAttachments[readIndex] : nullptr;
}
...
{
    if (mDepthAttachment.valid())
    {
        return &mDepthAttachment;
    }
    if (mStencilAttachment.valid())
    {
...
bool Framebuffer::Data::hasValidDepthStencil() const
{
    ...
    return (mDepthAttachment.valid() && mStencilAttachment.valid() &&
