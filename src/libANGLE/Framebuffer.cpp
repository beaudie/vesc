...
bool checkAttachmentSampleCompletenessHelper(const Context *context,
                                       ...
                                       Optional<int> *renderToTextureSamples)
{
    ...
    if (renderToTextureSamples->valid())
    {
        ...
        {
            if (!checkAttachmentSampleCompletenessHelper(
                    context, attachment.getRenderToTextureSamples(),
    ...
    if (samples->valid())
    {
        ...
        if (renderToTextureSamples->value() ==
            FramebufferAttachment::kDefaultRenderToTextureSamples)
        {
            if (!checkAttachmentSampleCompletenessHelper(context, attachment.getSamples(),
                                                         samples->value(), colorAttachment))
            {
                return false;
            }
        }
