      ...
      mDirtyStencilAttachmentBinding(this, DIRTY_BIT_STENCIL_ATTACHMENT)
{
    ...
    mState.mDrawBufferTypeMask |= GetDrawBufferTypeMask(getDrawbufferWriteType(0), 0);
}
...
void Framebuffer::setDrawBuffers(size_t count, const GLenum *buffers)
{
    ...
    {
        mState.mDrawBufferTypeMask |= GetDrawBufferTypeMask(getDrawbufferWriteType(index), index);
                                    ...
                                    const GLint *viewportOffsets)
{
    switch (binding)
    {
        ...
        default:
        {
            ...
            mState.mDrawBufferTypeMask &= GetDrawBufferTypeMaskReset(colorIndex);
            mState.mDrawBufferTypeMask |=
                GetDrawBufferTypeMask(getDrawbufferWriteType(colorIndex), colorIndex);
        }
        break;
    }
