...
{
  public:
    explicit FramebufferState(EGLint multiviewViewCount);
    explicit FramebufferState(const Caps &caps, GLuint id, EGLint multiviewViewCount);
    ~FramebufferState();

    const std::string &getLabel();
    size_t getReadIndex() const;

    const FramebufferAttachment *getAttachment(const Context *context,
                                               GLenum attachment,
                                               GLint index) const;
    ...
    {
        return mDrawBufferStateLocations;
    }
                          ...
                          public angle::Subject
{
  public:
    ...
    void setDrawBuffersIndexed(const Context *context,
                               size_t count,
