...
class Framebuffer final : public LabeledObject
{
  public:
    ...
    int getSamples(const gl::ContextState &data) const;
    bool usingExtendedDrawBuffers() const;

    GLenum checkStatus(const gl::ContextState &data) const;
    ...
    Error clear(const rx::ContextImpl *context, GLbitfield mask);
    Error clearBufferfv(const rx::ContextImpl *context,
                        GLenum buffer,
                        GLint drawbuffer,
                        const GLfloat *values);
    Error clearBufferuiv(const rx::ContextImpl *context,
                         GLenum buffer,
                         GLint drawbuffer,
                         const GLuint *values);
    Error clearBufferiv(const rx::ContextImpl *context,
                        GLenum buffer,
                        GLint drawbuffer,
                        const GLint *values);
    Error clearBufferfi(const rx::ContextImpl *context,
                        GLenum buffer,
                        GLint drawbuffer,
                        GLfloat depth,
                        GLint stencil);
    ...
    Error readPixels(const rx::ContextImpl *context,
                     const gl::Rectangle &area,
                     GLenum format,
                     GLenum type,
                     GLvoid *pixels) const;

    Error blit(const rx::ContextImpl *context,
