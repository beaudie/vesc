                          ...
                          public angle::Subject
{
  public:
    ...
    PixelLocalStorage &getPixelLocalStorage(Context *);
    ...
    // Pixel local storage must be detached before deleting the framebuffer. The context is
    // responsible for cleaning up its GL objects.
