                           ...
                           gl::Context *context)
{
    ...
    // Note that this needs to be done after the new Context has been made current so any shared
    // resource (e.g. Surfaces) have had their reference counts updated. Otherwise, it's possible
    // for them to be destroyed before the new Context has a chance to indicate it's using them.
