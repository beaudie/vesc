...
Error Display::terminate(const Thread *thread)
{
    ...
    mState.setBlobFunc = nullptr;
    mState.getBlobFunc = nullptr;
...
EGLint Display::programCacheGetAttrib(EGLenum attrib) const
{
    switch (attrib)
    {
        case EGL_PROGRAM_CACHE_KEY_LENGTH_ANGLE:
            return static_cast<EGLint>(egl::BlobCache::kKeyLength);
                                 ...
                                 EGLint *binarysize)
{
    ...
    const egl::BlobCache::Key *programHash = nullptr;
    egl::BlobCache::Value programBinary;
    ...
    if (key)
    {
        ASSERT(*keysize == static_cast<EGLint>(egl::BlobCache::kKeyLength));
        memcpy(key, programHash->data(), egl::BlobCache::kKeyLength);
    }
    ...
    *keysize    = static_cast<EGLint>(egl::BlobCache::kKeyLength);
                                    ...
                                    EGLint binarysize)
{
    ...
    memcpy(programHash.data(), key, egl::BlobCache::kKeyLength);
