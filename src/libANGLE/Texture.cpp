                         ...
                         const Framebuffer *source)
{
    ...
    auto initState =
        source->getReadColorbuffer()->needsInit() ? InitState::MayNeedInit : InitState::Clean;
                           ...
                           const Texture *source)
{
    ...
    auto initState = needsInit ? InitState::MayNeedInit : InitState::Clean;
...
Error Texture::setEGLImageTarget(const Context *context, GLenum target, egl::Image *imageTarget)
{
    ...
    auto initState = imageTarget->sourceNeedsInit() ? InitState::MayNeedInit : InitState::Clean;
...
{
    return mState.getImageDesc(imageIndex).initState == InitState::MayNeedInit;
}
