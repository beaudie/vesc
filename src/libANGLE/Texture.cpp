...
Error Texture::copyTexture3d(const Context *context,
                             TextureTarget target,
                             GLint level,
                             GLenum internalFormat,
                             GLenum type,
                             ...
                             Texture *source)
{
    ...
    ANGLE_TRY(mTexture->copyTexture3d(context, target, internalFormat, type, sourceLevel, level,
                                      unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha,
                                      source));
...
Error Texture::copySubTexture3d(const Context *context,
                                TextureTarget target,
                                GLint level,
                                const Offset &destOffset,
                                GLint sourceLevel,
                                ...
                                Texture *source)
{
    ...
    return mTexture->copySubTexture3d(context, target, destOffset, sourceLevel, level, sourceBox,
                                      unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha,
                                      source);
}
