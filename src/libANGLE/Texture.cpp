...
void Texture::setMipChainImageInfos(size_t levels, Extents baseSize, GLenum sizedInternalFormat)
{
    for (size_t level = 0; level < levels; level++)
    {
        ...
        ImageInfo levelInfo(levelSize, sizedInternalFormat);
...
Texture::ImageInfo::ImageInfo()
    : ImageInfo(Extents(0, 0, 0), GL_NONE)
{
}

Texture::ImageInfo::ImageInfo(const Extents &size, GLenum internalFormat)
    : size(size),
