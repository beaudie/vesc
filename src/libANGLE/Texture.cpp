                                              ...
                                              const ContextState &data) const
{
    ...
    if (mType != TextureType::_2DMultisample && mType != TextureType::_2DMultisampleArray &&
    ...
    if (mType != TextureType::_2DMultisample && mType != TextureType::_2DMultisampleArray &&
        baseImageDesc.format.info->depthBits > 0 && data.getClientMajorVersion() >= 3)
    {
    ...
    if (mType != TextureType::_2DMultisample && mType != TextureType::_2DMultisampleArray &&
        baseImageDesc.format.info->depthBits > 0 && mDepthStencilTextureMode == GL_STENCIL_INDEX)
    {
        if ((samplerState.minFilter != GL_NEAREST &&
             samplerState.minFilter != GL_NEAREST_MIPMAP_NEAREST) ||
            samplerState.magFilter != GL_NEAREST)
