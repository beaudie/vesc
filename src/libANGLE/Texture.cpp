...
GLsizei Texture::getAttachmentWidth(const gl::AttachmentSubResource &subResource) const
{
    return getWidth(subResource.textureIndex().type, subResource.textureIndex().mipIndex);
}

GLsizei Texture::getAttachmentHeight(const gl::AttachmentSubResource &subResource) const
{
    return getHeight(subResource.textureIndex().type, subResource.textureIndex().mipIndex);
}

GLenum Texture::getAttachmentInternalFormat(const gl::AttachmentSubResource &subResource) const
{
    return getInternalFormat(subResource.textureIndex().type, subResource.textureIndex().mipIndex);
}

GLsizei Texture::getAttachmentSamples(const gl::AttachmentSubResource &subResource) const
{
