...
void Texture::onBindToMultisampleFBO()
{
    if (!mState.mHasBeenBoundToMultisampleFBO)
    {
        mDirtyBits.set(DIRTY_BIT_BOUND_TO_MULTISAMPLE_FBO);
        mState.mHasBeenBoundToMultisampleFBO = true;
    }
}
