                                ...
                                const uint8_t *pixels)
{
    ...
    else if (mState.isDownscaled())
    {
        ...
        INFO() << "Calling glTexImage on downscaled texture " << getId() << "!";
    }
                                  ...
                                  const Extents &size)
{
    ...
    {
        mState.setDownscaled(false);
        INFO() << "Calling glTexStorage on downscaled texture " << getId() << "!";
    }
                                             ...
                                             bool fixedSampleLocations)
{
    ...
    {
        mState.setDownscaled(false);
        INFO() << "Calling glTexStorageMultisample on downscaled texture " << getId() << "!";
    }
