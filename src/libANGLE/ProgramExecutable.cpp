                       ...
                       ProgramOutput &outputVariable)
{
    ...
    if (apiIndex != -1)
    {
        ...
        outputVariable.pod.hasApiAssignedIndex = true;
        return;
    }
...
ProgramOutput::ProgramOutput(const sh::ShaderVariable &var)
{
    ...
    SetBitField(pod.hasApiAssignedIndex, false);
    ...
    const ProgramAliasedBindings &fragmentOutputIndices)
{
         ...
         outputVariableIndex++)
    {
        ...
        bool hasApiAssignedLocation = fragmentOutputLocations.getBinding(outputVariable);
