...
ShaderType ProgramExecutable::getTransformFeedbackStage(
    const LinkingVariables &linkingVariables) const
{
    if (linkingVariables.mIsShaderStageUsedBitset[ShaderType::Geometry])
    {
        return ShaderType::Geometry;
    }
    if (linkingVariables.mIsShaderStageUsedBitset[ShaderType::TessEvaluation])
    {
...
{
    ShaderType tfStage = getTransformFeedbackStage(linkingVariables);
    ...
    for (ShaderType shaderType : kAllGraphicsShaderTypes)
    {
        ...
        // drawing.
        if (linkingVariables.mIsShaderStageUsedBitset[shaderType] ||
