...
TextureManager *AllocateOrGetSharedTextureManager(const ContextState *shareContextState,
    TextureManager* shareTextures, ContextStateMember<TextureManager> member)
{
    if (shareContextState)
    {
        TextureManager *textureManager = (*shareContextState).*member;
        ASSERT(shareTextures == nullptr || textureManager);
...
ContextState::ContextState(uintptr_t contextIn,
    ...
    : mClientVersion(clientVersion),
      ...
      mTextures(AllocateOrGetSharedTextureManager(shareContextState, shareTextures, &ContextState::mTextures)),
      mRenderbuffers(
