...
class GLES1State
{
  public:
    ...
    bool mVertexArrayEnabled                = false;
    bool mNormalArrayEnabled                = false;
    bool mColorArrayEnabled                 = false;
    bool mPointSizeArrayEnabled             = false;
    ...
    AlphaTestFunc mAlphaFunc = AlphaTestFunc::AlwaysPass;
