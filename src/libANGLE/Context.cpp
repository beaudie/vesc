...
void Context::renderbufferStorageMultisample(GLenum target,
                                             ...
                                             GLsizei height)
{
    renderbufferStorageMultisampleImpl(target, samples, internalformat, width, height, false);
}
...
void Context::renderbufferStorageMultisampleEXT(GLenum target,
                                                ...
                                                GLsizei height)
{
    renderbufferStorageMultisampleImpl(target, samples, internalformat, width, height, true);
}
                                                 ...
                                                 bool isRenderToTexture)
{
    ...
    ANGLE_CONTEXT_TRY(renderbuffer->setStorageMultisample(this, samples, convertedInternalFormat,
                                                          width, height, isRenderToTexture));
}
