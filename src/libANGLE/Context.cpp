...
void Context::initialize()
{
    ...
    mComputeDirtyBits.set(State::DIRTY_BIT_PROGRAM_PIPELINE_BINDING);
    mComputeDirtyBits.set(State::DIRTY_BIT_PROGRAM_PIPELINE_EXECUTABLE);
...
void StateCache::updateActiveAttribsMask(Context *context)
{
    ...
    else
    {
        ...
        {
            activeAttribs = glState.getProgramPipeline()
                                ->getShaderProgram(gl::ShaderType::Vertex)
