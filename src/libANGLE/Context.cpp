...
enum SubjectIndexes : angle::SubjectIndex
{
    ...
    kImage0SubjectIndex         = kTexture0SubjectIndex,
...
void Context::updateCaps()
{
    ...
    mDrawDirtyObjects.set(State::DIRTY_OBJECT_INIT_IMAGES, robustInit);
    ...
    mComputeDirtyObjects.set(State::DIRTY_OBJECT_INIT_IMAGES, robustInit);
