...
constexpr state::DirtyBits kDrawInvalidateDirtyBits{state::DIRTY_BIT_READ_FRAMEBUFFER_BINDING};
...
void Context::initializeDefaultResources()
{
    ...
    mPixelLocalStorageEXTEnableDisableDirtyObjects = kPixelLocalStorageEXTEnableDisableDirtyObjects;
