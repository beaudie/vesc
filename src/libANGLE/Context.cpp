...
void Context::initWorkarounds()
{
    ...
    mWorkarounds.loseContextOnOutOfMemory.applied =
        (mResetStrategy == GL_LOSE_CONTEXT_ON_RESET_EXT);

    if (mWorkarounds.syncFramebufferBindingsOnTexImage.applied)
    {
                           ...
                           unsigned int line)
{
    if (errorCode == GL_OUT_OF_MEMORY &&
        mContext->getWorkarounds().loseContextOnOutOfMemory.applied)
    {
