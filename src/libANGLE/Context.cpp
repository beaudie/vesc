...
void Context::getIndexedBooleanv(GLenum target, GLuint index, GLboolean *data)
{
    UNREACHABLE();
}

void Context::getIndexedIntegerv(GLenum target, GLuint index, GLint *data)
{
    // Queries about context capabilities and maximums are answered by Context.
    // Queries about current GL state values are answered by State.
    ...
    switch (target)
    {
        ...
        case GL_MAX_COMPUTE_WORK_GROUP_SIZE:
            ...
            break;
        default:
            mGLState.getIndexedIntegerv(target, index, data);
    }
}

void Context::getIndexedInteger64v(GLenum target, GLuint index, GLint64 *data)
{
    // Queries about context capabilities and maximums are answered by Context.
    // Queries about current GL state values are answered by State.
    ...
    mGLState.getIndexedInteger64v(target, index, data);
}
