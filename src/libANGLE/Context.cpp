...
void Context::initCaps(const egl::DisplayExtensions &displayExtensions, bool robustResourceInit)
{
    ...
    {
        ASSERT(displayExtensions.robustResourceInitialization);
                                ...
                                GLsizei height)
{
    ...
    Framebuffer *framebuffer = mGLState.getReadFramebuffer();
    ANGLE_CONTEXT_TRY(framebuffer->ensureReadAttachmentInitialized(this, GL_COLOR_BUFFER_BIT));
