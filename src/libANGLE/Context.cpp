                                  ...
                                  GLsizei height)
{
    ...
    GLenum convertedIntenalFormat = getConvertedRenderbufferFormat(internalformat);

    Renderbuffer *renderbuffer = mGLState.getCurrentRenderbuffer();
    handleError(renderbuffer->setStorage(convertedIntenalFormat, width, height));
}
                                             ...
                                             GLsizei height)
{
    ...
    Renderbuffer *renderbuffer = mGLState.getCurrentRenderbuffer();
    handleError(
        renderbuffer->setStorageMultisample(samples, convertedIntenalFormat, width, height));
}
