...
void Context::getPointervRobust(GLenum pname, GLsizei bufSize, GLsizei *length, void **params)
{
    UNIMPLEMENTED();
}
...
void Context::getTexParameterIivRobust(GLenum target,
                                       GLenum pname,
                                       GLsizei bufSize,
                                       GLsizei *length,
                                       GLint *params)
...
void Context::getTexParameterIuivRobust(GLenum target,
                                        GLenum pname,
                                        GLsizei bufSize,
                                        GLsizei *length,
                                        GLuint *params)
...
void Context::getTexLevelParameterivRobust(GLenum target,
                                           GLint level,
                                           GLenum pname,
                                           GLsizei bufSize,
                                           GLsizei *length,
...
void Context::texParameterIivRobust(GLenum target,
                                    GLenum pname,
                                    GLsizei bufSize,
                                    const GLint *params)
{
...
void Context::texParameterIuivRobust(GLenum target,
                                     GLenum pname,
                                     GLsizei bufSize,
                                     const GLuint *params)
{
...
void getnUniformivRobustANGLE(GLuint program,
                              GLint location,
                              GLsizei bufSize,
                              GLsizei *length,
                              GLint *params)
