...
void Context::getPathParameterf(GLuint path, GLenum pname, GLfloat *value)
{
...
void Context::getPathParameteri(GLuint path, GLenum pname, GLint *value)
{
    GLfloat val = 0.0f;
    getPathParameterf(path, pname, value != nullptr ? &val : nullptr);
    if (value)
