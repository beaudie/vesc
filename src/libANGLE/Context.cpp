...
void StateCache::updateValidDrawModes(Context *context)
{
        ...
        !curTransformFeedback->isPaused())
    {
        ...
        mCachedValidDrawModes = {{
            {PrimitiveMode::Points, pointsOK},
            {PrimitiveMode::Lines, linesOK},
            {PrimitiveMode::LineLoop, linesOK},
            {PrimitiveMode::LineStrip, linesOK},
            {PrimitiveMode::Triangles, trisOK},
            {PrimitiveMode::TriangleStrip, trisOK},
            {PrimitiveMode::TriangleFan, trisOK},
        }};
