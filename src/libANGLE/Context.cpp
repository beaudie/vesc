...
void Context::initCaps(const egl::DisplayExtensions &displayExtensions)
{
    ...
    {
        LimitCap(&mCaps.maxVertexAttribBindings, mCaps.maxVertexAttributes);
    }
    else
    {
    ...
    LimitCap(&mCaps.maxVertexTextureImageUnits, IMPLEMENTATION_MAX_ACTIVE_TEXTURES);
    LimitCap(&mCaps.maxTextureImageUnits, IMPLEMENTATION_MAX_ACTIVE_TEXTURES);
