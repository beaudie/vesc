...
void Context::gles1_draw(bool indexed, GLenum mode, GLint first, GLsizei count, GLenum indexType, const GLvoid* indices) {
...

    {
        ...
        const auto& texEnv = mGLState.getTexEnv(mGLState.getActiveSampler());
        ...
        uniform1i(drawState.textureEnvModeLoc, texEnv.envMode);
        uniform1i(drawState.combineRgbLoc, texEnv.combineRgb);
        uniform1i(drawState.combineAlphaLoc, texEnv.combineAlpha);
        uniform1i(drawState.src0rgbLoc, texEnv.src0rgb);
        uniform1i(drawState.src0alphaLoc, texEnv.src0alpha);
        uniform1i(drawState.src1rgbLoc, texEnv.src1rgb);
        uniform1i(drawState.src1alphaLoc, texEnv.src1alpha);
        uniform1i(drawState.src2rgbLoc, texEnv.src2rgb);
        uniform1i(drawState.src2alphaLoc, texEnv.src2alpha);
        uniform1i(drawState.op0rgbLoc, texEnv.op0rgb);
        uniform1i(drawState.op0alphaLoc, texEnv.op0alpha);
        uniform1i(drawState.op1rgbLoc, texEnv.op1rgb);
        uniform1i(drawState.op1alphaLoc, texEnv.op1alpha);
        uniform1i(drawState.op2rgbLoc, texEnv.op2rgb);
        uniform1i(drawState.op2alphaLoc, texEnv.op2alpha);
        uniform4fv(drawState.textureEnvColorLoc, 1, texEnv.envColor.data());
        uniform1f(drawState.rgbScaleLoc, texEnv.rgbScale);
        uniform1f(drawState.alphaScaleLoc, texEnv.alphaScale);
        uniform1i(drawState.pointSpriteCoordReplaceLoc, texEnv.pointSpriteCoordReplace);
