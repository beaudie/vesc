...
{
    bool hasHalFloatExtSupport = context->getExtensions().vertexHalfFloat;
    VertexAttribTypeCase halfFloatValidity =
        (hasHalFloatExtSupport) ? VertexAttribTypeCase::Valid : VertexAttribTypeCase::Invalid;
