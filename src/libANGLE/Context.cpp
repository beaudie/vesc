...
{
    return static_cast<EGLint>(attribs.get(EGL_CONTEXT_MINOR_VERSION, 1));
}
...
void Context::getIntegerv(GLenum pname, GLint *params)
{
    ...
    switch (pname)
    {
      ...
      case GL_MAJOR_VERSION:                            *params = mClientMajorVersion;                                  break;
      case GL_MINOR_VERSION:                            *params = mClientMinorVersion;                                  break;
