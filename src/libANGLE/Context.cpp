                                   ...
                                   GLint level)
{
    ...
    if (texture != 0)
    {
        ...
        framebuffer->setAttachment(isWebGL1(), GL_TEXTURE, attachment, index, textureObj);
    }
    else
    {
                                      ...
                                      GLuint renderbuffer)
{
    ...
    if (renderbuffer != 0)
    {
        ...
        framebuffer->setAttachment(isWebGL1(), GL_RENDERBUFFER, attachment,
                                      ...
                                      GLint layer)
{
    ...
    if (texture != 0)
    {
        ...
        framebuffer->setAttachment(isWebGL1(), GL_TEXTURE, attachment, index, textureObject);
    }
    else
    {
        framebuffer->resetAttachment(this, attachment);
