                                   ...
                                   bool patchOK)
{
    ...
    mCachedValidDrawModes[PrimitiveMode::Unused1]                = false;
    mCachedValidDrawModes[PrimitiveMode::Unused2]                = false;
    mCachedValidDrawModes[PrimitiveMode::Unused3]                = false;
    ...
    mCachedValidDrawModes[PrimitiveMode::InvalidEnum] = false;
}
...
void StateCache::updateValidDrawModes(Context *context)
{
    ...
    if (!programExecutable || !programExecutable->hasLinkedShaderStage(ShaderType::Geometry))
    {
        ...
        setValidDrawModes(true, true, true, true, true, true);
        return;
    }
