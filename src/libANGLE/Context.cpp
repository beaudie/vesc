...
void Context::makeCurrent(egl::Surface *surface)
{
    ...
    {
        defaultFBO->setInvalidAttachment(GL_DEPTH);
    }
    ...
    {
        defaultFBO->setInvalidAttachment(GL_STENCIL);
    }
...
{
    mFramebufferMap[0]->setInvalidAttachment(GL_BACK);
    mFramebufferMap[0]->setInvalidAttachment(GL_DEPTH);
    mFramebufferMap[0]->setInvalidAttachment(GL_STENCIL);
    mRenderBuffer = EGL_NONE;
}
