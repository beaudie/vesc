                               ...
                               GLsizei srcDepth)
{
    ...
    if (srcTarget == GL_RENDERBUFFER)
    {
        ...
        if (dstTarget == GL_RENDERBUFFER)
        {
            ...
            ANGLE_CONTEXT_TRY(writeBuffer->copyImageSubData(this, readBuffer, srcLevel, srcX, srcY,
                                                            srcZ, dstLevel, dstX, dstY, dstZ,
                                                            srcWidth, srcHeight, srcDepth));
        }
        else
        {
            // Destintation target is a Texture
            ...
            ANGLE_CONTEXT_TRY(writeTexture->copyImageSubData(this, readBuffer, srcLevel, srcX, srcY,
                                                             srcZ, dstLevel, dstX, dstY, dstZ,
                                                             srcWidth, srcHeight, srcDepth));
        }
    }
    else
    {
        ...
        if (dstTarget == GL_RENDERBUFFER)
        {
            ...
            ANGLE_CONTEXT_TRY(writeBuffer->copyImageSubData(this, readTexture, srcLevel, srcX, srcY,
                                                            srcZ, dstLevel, dstX, dstY, dstZ,
                                                            srcWidth, srcHeight, srcDepth));
        }
        else
        {
            ...
            ANGLE_CONTEXT_TRY(writeTexture->copyImageSubData(this, readTexture, srcLevel, srcX,
                                                             srcY, srcZ, dstLevel, dstX, dstY, dstZ,
                                                             srcWidth, srcHeight, srcDepth));
        }
    }
}
