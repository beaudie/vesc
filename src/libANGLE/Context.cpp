                               ...
                               GLsizei srcDepth)
{
    ...
    if (srcTarget == GL_RENDERBUFFER)
    {
        ...
        if (dstTarget == GL_RENDERBUFFER)
        {
            ...
            ANGLE_CONTEXT_TRY(writeBuffer->copyImageSubData<gl::Renderbuffer>(
        ...
        else
        {
            ...
            ANGLE_CONTEXT_TRY(writeTexture->copyImageSubData<gl::Renderbuffer>(
                this, readBuffer, srcLevel, srcX, srcY, srcZ, dstLevel, dstX, dstY, dstZ, srcWidth,
                srcHeight, srcDepth));
        }
    }
    else
    {
        ...
        if (dstTarget == GL_RENDERBUFFER)
        {
            ...
            ANGLE_CONTEXT_TRY(writeBuffer->copyImageSubData<gl::Texture>(
        ...
        else
        {
            ...
            ANGLE_CONTEXT_TRY(writeTexture->copyImageSubData<gl::Texture>(
                this, readTexture, srcLevel, srcX, srcY, srcZ, dstLevel, dstX, dstY, dstZ, srcWidth,
                srcHeight, srcDepth));
        }
    }
