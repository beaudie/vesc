...
egl::Error Context::setDefaultFramebuffer(egl::Surface *drawSurface, egl::Surface *readSurface)
{
    ...
    {
        newDefaultDrawFramebuffer =
            new Framebuffer(mImplementation.get(), Framebuffer::kDefaultDrawFramebufferHandle);
    }
    ...
    else
    {
        if (readSurface != nullptr)
        {
            newDefaultReadFramebuffer = readSurface->createDefaultFramebuffer(
                this, Framebuffer::kDefaultReadFramebufferHandle);
        }
        else
        {
            newDefaultReadFramebuffer =
                new Framebuffer(mImplementation.get(), Framebuffer::kDefaultReadFramebufferHandle);
        }
    }
...
egl::Error Context::unsetDefaultFramebuffer()
{
    ...
    gl::Framebuffer *defaultReadFramebuffer =
        (mCurrentDrawSurface == mCurrentReadSurface)
            ? mState.mFramebufferManager->getFramebuffer(Framebuffer::kDefaultDrawFramebufferHandle)
            : mState.mFramebufferManager->getFramebuffer(
                  Framebuffer::kDefaultReadFramebufferHandle);
    ...
    mState.mFramebufferManager->setDefaultReadFramebuffer(nullptr);
