...
void Context::initGles1()
{
    ...
    GLint vshaderLen = sizeof(kGLES1DrawTexOESCore_vshader);
    GLint fshaderLen = sizeof(kGLES1DrawTexOESCore_vshader);

    shaderSource(drawTexVShader, 1, (const GLchar *const *)&kGLES1DrawTexOESCore_vshader, &vshaderLen);
    shaderSource(drawTexFShader, 1, (const GLchar *const *)&kGLES1DrawTexOESCore_fshader, &fshaderLen);
