...
void Overlay::initOverlayWidgets()
{
...

    {
        ...
        mState.mOverlayWidgets[WidgetId::VulkanShaderBufferHitRate].reset(widget);
        {
            const int32_t fontSize = GetFontSize(kFontLayerSmall, kLargeFont);
            const int32_t offsetX =
                mState.mOverlayWidgets[WidgetId::VulkanShaderBufferHitRate]->coords[0];
            const int32_t offsetY =
                mState.mOverlayWidgets[WidgetId::VulkanShaderBufferHitRate]->coords[1];
            const int32_t width  = 40 * kFontGlyphWidths[fontSize];
            const int32_t height = kFontGlyphHeights[fontSize];
