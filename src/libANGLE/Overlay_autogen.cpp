...
void Overlay::initOverlayWidgets()
{
...

    {
        ...
        mState.mOverlayWidgets[WidgetId::FPS] = widget;
    }

    {
        ...
        mState.mOverlayWidgets[WidgetId::VulkanLastValidationMessage] = widget;
    }

    {
        ...
        mState.mOverlayWidgets[WidgetId::VulkanValidationMessageCount] = widget;
    }

    {
        ...
        mState.mOverlayWidgets[WidgetId::VulkanCommandGraphSize] = widget;
        {
            const int32_t fontSize = GetFontSize(kFontLayerSmall, kLargeFont);
...

    {
        ...
        mState.mOverlayWidgets[WidgetId::VulkanSecondaryCommandBufferPoolWaste] = widget;
        {
            const int32_t fontSize = GetFontSize(kFontLayerSmall, kLargeFont);
            const int32_t offsetX =
