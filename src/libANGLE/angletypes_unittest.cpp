...
{
    {
        ...
        ASSERT_EQ(blendStateExt.mMaxColorMask, 0xFu);
...

    {
        ...
        ASSERT_EQ(blendStateExt.mMaxColorMask, is64Bit ? 0x0F0F0F0Fu : 0xFFFFu);
...

    {
        ...
        ASSERT_EQ(blendStateExt.mMaxColorMask, is64Bit ? 0x0F0F0F0F0F0F0F0Fu : 0xFFFFFFFFu);
...
// Test that max color mask correctly compares with the current color mask
TEST(BlendStateExt, MaxColorMask)
{
    ...
    const gl::DrawBufferMask diff = blendStateExt.compareColorMask(blendStateExt.mMaxColorMask);
