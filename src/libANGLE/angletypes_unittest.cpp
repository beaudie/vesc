...
TEST(Rectangle, Combine)
{
    ...
    gl::CombineRectangles(rect1, rect2, &result);
    ...
    gl::CombineRectangles(rect1, rect3, &result);
    ASSERT_EQ(result.x0(), 0);
    ASSERT_EQ(result.y0(), 0);
    ...
    gl::CombineRectangles(rect1, rect4, &result);
    ...
    gl::CombineRectangles(rect1, rect5, &result);
    ASSERT_EQ(result.x0(), 0);
    ASSERT_EQ(result.y0(), -30);
