...
class MockSurfaceImpl : public rx::SurfaceImpl
{
  public:
    ...
    MOCK_METHOD2(attachToFramebuffer, egl::Error(const gl::Context *, FramebufferImpl *));
    MOCK_METHOD2(detachFromFramebuffer, egl::Error(const gl::Context *, FramebufferImpl *));
