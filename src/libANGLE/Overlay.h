...
class OverlayState : angle::NonCopyable
{
  ...
  private:
    ...
    angle::PackedEnumMap<WidgetId, overlay::Widget *> mOverlayWidgets;
};
...
class Overlay : angle::NonCopyable
{
  public:
    ...
    rx::OverlayImpl *getImplementation() const { return mImpl; }
  ...
  private:
    ...
    Widget *getWidgetAs(WidgetId id) const
    {
        ...
        return reinterpret_cast<Widget *>(mState.mOverlayWidgets[id]);
    }
