...
_MD_GLES_EXT_LINK_TEMPLATE = """[`{full_name}`](https://khronos.org/registry/OpenGL/extensions/{vendor}/{vendor}_{name_camel_case}.txt)"""
_MD_ANGLE_EXT_LINK_TEMPLATE = """[`{full_name}`](https://chromium.googlesource.com/angle/angle/+/refs/heads/main/extensions/{full_name}.txt)"""
