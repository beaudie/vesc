...
namespace
{
bool IsStencilMaskedOut(GLuint stencilWritemask, GLuint framebufferStencilSize)
{
...
{
    return IsStencilMaskedOut(stencilWritemask, framebufferStencilSize);
}
...
{
    return IsStencilMaskedOut(stencilBackWritemask, framebufferStencilSize) ||
