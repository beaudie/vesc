...
static UnsizedInternalFormatInfoMap BuildUnsizedInternalFormatInfoMap()
{
    ...
    // Luminance alpha formats
    //                | Internal format    | L | A | Format            | Type             | Component type        | Supported      | Renderable     | Filterable   |
    AddLUMAFormat(&map, GL_ALPHA,            0,  8, GL_ALPHA,           GL_UNSIGNED_BYTE,  GL_UNSIGNED_NORMALIZED, RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE,        8,  0, GL_LUMINANCE,       GL_UNSIGNED_BYTE,  GL_UNSIGNED_NORMALIZED, RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE_ALPHA,  8,  8, GL_LUMINANCE_ALPHA, GL_UNSIGNED_BYTE,  GL_UNSIGNED_NORMALIZED, RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_ALPHA,            0, 16, GL_ALPHA,           GL_HALF_FLOAT_OES, GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE,       16,  0, GL_LUMINANCE,       GL_HALF_FLOAT_OES, GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE_ALPHA, 16, 16, GL_LUMINANCE_ALPHA, GL_HALF_FLOAT_OES, GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_ALPHA,            0, 32, GL_ALPHA,           GL_FLOAT,          GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE,       32,  0, GL_LUMINANCE,       GL_FLOAT,          GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
    AddLUMAFormat(&map, GL_LUMINANCE_ALPHA, 32, 32, GL_LUMINANCE_ALPHA, GL_FLOAT,          GL_FLOAT,               RequireES<2, 0>, RequireES<2, 0>, NeverSupported);
