...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    //                         | Internal format  |sized|D |S |X | Format          | Type            | Component type        | Texture supported                                | Filterable    | Texture attachment                               | Renderbuffer   | Blend
    AddDepthStencilFormat(&map, GL_STENCIL_INDEX8, true, 0, 8, 0, GL_STENCIL_INDEX, GL_UNSIGNED_BYTE, GL_UNSIGNED_NORMALIZED, RequireESAndExt<1, 0, &Extensions::stencilIndex8>, NeverSupported, RequireESAndExt<1, 0, &Extensions::stencilIndex8>, RequireES<1, 0>, RequireES<1, 0>);
