...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddRGBAXFormat(&map, GL_RED,            false, FB<16,  0,  0,  0, 0, 0>(), GL_RED,            GL_SHORT,                       GL_SIGNED_NORMALIZED,   false, RequireExt<&Extensions::textureNorm16EXT>,           AlwaysSupported, NeverSupported,                                    NeverSupported, NeverSupported);
    ...
    AddRGBAXFormat(&map, GL_RG,             false, FB<16, 16,  0,  0, 0, 0>(), GL_RG,             GL_SHORT,                       GL_SIGNED_NORMALIZED,   false, RequireExt<&Extensions::textureNorm16EXT>,           AlwaysSupported, NeverSupported,                                    NeverSupported, NeverSupported);
    ...
    AddRGBAXFormat(&map, GL_RGB,            false, FB<16, 16, 16,  0, 0, 0>(), GL_RGB,            GL_SHORT,                       GL_SIGNED_NORMALIZED,   false, RequireExt<&Extensions::textureNorm16EXT>,           AlwaysSupported, NeverSupported,                                    NeverSupported, NeverSupported);
    ...
    AddRGBAXFormat(&map, GL_RGBA,           false, FB<16, 16, 16, 16, 0, 0>(), GL_RGBA,           GL_SHORT,                       GL_SIGNED_NORMALIZED,   false, RequireExt<&Extensions::textureNorm16EXT>,           AlwaysSupported, NeverSupported,                                    NeverSupported, NeverSupported);
