...
InternalFormat::InternalFormat()
    : internalFormat(GL_NONE),
      ...
      renderbufferAttachmentSupport(NeverSupported)
{
}
...
void AddRGBAFormat(InternalFormatInfoMap *map,
                   ...
                   InternalFormat::SupportCheckFunction renderbufferAttachmentSupport)
{
    ...
    formatInfo.renderbufferAttachmentSupport = renderbufferAttachmentSupport;
