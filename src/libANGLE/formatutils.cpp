...
InternalFormat::InternalFormat()
    : internalFormat(GL_NONE),
      ...
      framebufferAttachmentSupport(NeverSupported),
...
void AddRGBAFormat(InternalFormatInfoMap *map,
                   ...
                   InternalFormat::SupportCheckFunction framebufferAttachmentSupport,
                   InternalFormat::SupportCheckFunction renderbufferSupport)
{
    ...
    formatInfo.framebufferAttachmentSupport = framebufferAttachmentSupport;
...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    //                 | Internal format     |sized| R | G | B | A |S | Format         | Type                             | Component type        | SRGB | Texture supported                             | Filterable     | Framebuffer attachment                        | Renderbuffer                                 |
    ...
    // Depth stencil formats
    //                         | Internal format         |sized| D |S | X | Format            | Type                             | Component type        | Texture supported                                                | Filterable                                      | Framebuffer attachment                                                                | Renderbuffer                                                                         |
    ...
    //                | Internal format           |sized| L | A | Format            | Type             | Component type        | Texture supported                                                           | Filterable                                               | Framebuffer attachment | Renderbuffer |
    ...
    //                       | Internal format                             |W |H | BS |CC| Format | Type            | SRGB | Texture supported                                                              | Filterable     | Framebuffer attachment | Renderbuffer |
    ...
    //                 |Internal format |sized | R | G | B | A |S | Format | Type                           | Comp    | SRGB | Texture supported           | Filterable                                               | Framebuffer attachment                | Renderbuffer                         |
