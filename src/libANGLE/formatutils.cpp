...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddDepthStencilFormat(&map, GL_DEPTH_STENCIL,   false, 24, 8,  0, GL_DEPTH_STENCIL,   GL_UNSIGNED_INT_24_8,              GL_UNSIGNED_NORMALIZED, RequireESOrExt<3, 0, &Extensions::packedDepthStencil>, AlwaysSupported, RequireExtAndExt<&Extensions::packedDepthStencil, &Extensions::depthTextureOES>,   RequireExtAndExt<&Extensions::packedDepthStencil, &Extensions::depthTextureOES>  );
