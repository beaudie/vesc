...
{
    return bytes == 1 ? 0 : (1 + Log2(bytes - 1));
}

constexpr uint32_t PackTypeInfo(GLuint bytes, bool specialized)
{
    return bytes | Log2(bytes) | (specialized << 16);
}
...
uint32_t GetPackedTypeInfo(GLenum type)
{
    switch (type)
    {
        ...
        case GL_BYTE:
        {
            static constexpr uint32_t packed = PackTypeInfo(1, false);
            return packed;
        }
        ...
        case GL_HALF_FLOAT_OES:
        {
            static constexpr uint32_t packed = PackTypeInfo(2, false);
            return packed;
        }
        case GL_UNSIGNED_INT:
        case GL_INT:
        case GL_FLOAT:
        {
            static constexpr uint32_t packed = PackTypeInfo(4, false);
            return packed;
        }
        ...
        {
            static constexpr uint32_t packed = PackTypeInfo(2, true);
            return packed;
        }
        ...
        case GL_UNSIGNED_INT_5_9_9_9_REV:
        {
            ...
            static constexpr uint32_t packed = PackTypeInfo(4, true);
            return packed;
        }
        case GL_FLOAT_32_UNSIGNED_INT_24_8_REV:
        {
            static constexpr uint32_t packed = PackTypeInfo(8, true);
            return packed;
        }
        default:
        {
