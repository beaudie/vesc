...
YuvFormatInfo::YuvFormatInfo(GLenum internalFormat)
{
    ...
    if (gl::IsYuvFormat(internalFormat))
    {
        ...
        gl::GetSubSampleFactor(internalFormat, &widthSubSampleFactor, &heightSubSampleFactor);
...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddYUVFormat(&map,  GL_G8_B8R8_2PLANE_420_UNORM_ANGLEX,           true,   8,   8,  8,   0,  0,  GL_G8_B8R8_2PLANE_420_UNORM_ANGLEX,   GL_UNSIGNED_BYTE, GL_UNSIGNED_NORMALIZED, false, RequireExt<&Extensions::textureExternalYuvSamplingANGLE>, RequireExt<&Extensions::textureExternalYuvSamplingANGLE>, RequireExt<&Extensions::textureExternalYuvSamplingANGLE>, NeverSupported, NeverSupported);
    // clang-format on
