...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddPalettedFormat(&map, GL_PALETTE4_RGB8_OES,      4,   3, GL_RGB,    3, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE4_RGBA8_OES,     4,   4, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE4_R5_G6_B5_OES,  4,   2, GL_RGB,    3, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE4_RGBA4_OES,     4,   2, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE4_RGB5_A1_OES,   4,   2, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE8_RGB8_OES,      8,   3, GL_RGB,    3, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE8_RGBA8_OES,     8,   4, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE8_R5_G6_B5_OES,  8,   2, GL_RGB,    3, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE8_RGBA4_OES,     8,   2, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
    AddPalettedFormat(&map, GL_PALETTE8_RGB5_A1_OES,   8,   2, GL_RGBA,   4, RequireExt<&Extensions::palettedTextureANGLE>, RequireExt<&Extensions::palettedTextureANGLE>, NeverSupported,     NeverSupported, NeverSupported);
