...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddRGBAFormat(&map, GL_RGBX8_ANGLEX,      true,  8,  8,  8,  0, 0, GL_RGBA,         GL_UNSIGNED_BYTE,                  GL_UNSIGNED_NORMALIZED, false, AlwaysSupported,                                    NeverSupported,  AlwaysSupported,                                    AlwaysSupported,                                NeverSupported);
