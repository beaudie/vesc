...
static InternalFormatInfoMap BuildInternalFormatInfoMap()
{
    ...
    AddDepthStencilFormat(&map, GL_DEPTH_COMPONENT16,     true, 16, 0,  0, GL_DEPTH_COMPONENT, GL_UNSIGNED_SHORT,                 GL_UNSIGNED_NORMALIZED, RequireES<1, 0>,                                                   RequireESOrExt<3, 0, &Extensions::depthTextureANY>, RequireES<1, 0>,                                                                     RequireES<1, 0>                                                                       );
    ...
    AddDepthStencilFormat(&map, GL_DEPTH_COMPONENT32_OES, true, 32, 0,  0, GL_DEPTH_COMPONENT, GL_UNSIGNED_INT,                   GL_UNSIGNED_NORMALIZED, RequireExtOrExt<&Extensions::depthTextureANY, &Extensions::depth32>, AlwaysSupported,                                RequireExtOrExt<&Extensions::depthTextureANY, &Extensions::depth32>,                   RequireExtOrExt<&Extensions::depthTextureANY, &Extensions::depth32>                   );
