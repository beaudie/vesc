    ...
    const gl::PixelUnpackState &unpack) const
{
    ...
    CheckedNumeric<size_t> rowPitch;
    CheckedNumeric<size_t> depthPitch;
    ...
    auto totalSize = (size.depth - 1) * depthPitch + (size.height - 1) * rowPitch +
                     size.width * computePixelBytes(formatType);
                                                               ...
                                                               bool applySkipImages) const
{
    size_t rowPitch;
    size_t depthPitch;
    CheckedNumeric<size_t> checkedSkipBytes;
    CheckedNumeric<size_t> checkedCopyBytes;
    ...
    CheckedNumeric<size_t> endByte = checkedCopyBytes + checkedSkipBytes;
