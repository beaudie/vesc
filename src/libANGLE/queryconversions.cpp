                     ...
                     QueryT *outParams)
{
    ...
    {
        std::vector<GLint> intParams(numParams, 0);
        context->getIndexedIntegerv(pname, index, intParams.data());
    ...
    {
        std::vector<GLboolean> boolParams(numParams, GL_FALSE);
        context->getIndexedBooleanv(pname, index, boolParams.data());
    ...
    {
        std::vector<GLint64> int64Params(numParams, 0);
        context->getIndexedInteger64v(pname, index, int64Params.data());
...
template void CastStateValues<GLboolean>(Context *,
                                         GLenum,
                                         GLenum,
                                         GLuint index,
                                         unsigned int,
                                         GLboolean *);
template void CastStateValues<GLint>(Context *,
                                     GLenum,
                                     GLenum,
                                     GLuint index,
                                     unsigned int,
                                     GLint *);
template void CastStateValues<GLuint>(Context *,
                                      GLenum,
                                      GLenum,
                                      GLuint index,
                                      unsigned int,
                                      GLuint *);
template void CastStateValues<GLfloat>(Context *,
                                       GLenum,
                                       GLenum,
                                       GLuint index,
                                       unsigned int,
                                       GLfloat *);
template void CastStateValues<GLint64>(Context *,
                                       GLenum,
                                       GLenum,
                                       GLuint index,
                                       unsigned int,
