...
template GLfloat CastFromGLintStateValue<GLfloat, uint32_t>(GLenum pname, uint32_t value);
template GLint CastFromGLintStateValue<GLint, uint32_t>(GLenum pname, uint32_t value);
template GLint64 CastFromGLintStateValue<GLint64, uint32_t>(GLenum pname, uint32_t value);
template GLuint CastFromGLintStateValue<GLuint, uint32_t>(GLenum pname, uint32_t value);
...
template GLfloat CastFromGLintStateValue<GLfloat, uint64_t>(GLenum pname, uint64_t value);
template GLint CastFromGLintStateValue<GLint, uint64_t>(GLenum pname, uint64_t value);
