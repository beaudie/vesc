                               ...
                               size_t *valueSizeRet) const
{
    ...
    switch (name)
    {
        ...
        default:
            ANGLE_CL_ERROR(CL_INVALID_VALUE);
    }
...
Program::Program(Context &context, std::string &&source)
    : mContext(&context),
      ...
      mImpl(std::invoke([&]() -> rx::CLProgramImpl::Ptr {
          rx::CLProgramImpl::Ptr implPtr = nullptr;
          return IsError(context.getImpl().createProgramWithSource(*this, source, implPtr))
                     ? nullptr
                     : std::move(implPtr);
      })),
...
Program::Program(Context &context,
    ...
    : mContext(&context),
      ...
      mImpl(std::invoke([&]() -> rx::CLProgramImpl::Ptr {
          rx::CLProgramImpl::Ptr implPtr = nullptr;
          return IsError(context.getImpl().createProgramWithBinary(*this, lengths, binaries,
...
Program::Program(Context &context, DevicePtrs &&devices, const char *kernelNames)
    : mContext(&context),
      ...
      mImpl(std::invoke([&]() -> rx::CLProgramImpl::Ptr {
          rx::CLProgramImpl::Ptr implPtr = nullptr;
          return IsError(
                     context.getImpl().createProgramWithBuiltInKernels(*this, kernelNames, implPtr))
                     ? nullptr
                     : std::move(implPtr);
      })),
      mSource(std::invoke([&]() -> std::string {
...
Program::Program(Context &context,
    ...
    : mContext(&context),
      ...
      mImpl(std::invoke([&]() -> rx::CLProgramImpl::Ptr {
          rx::CLProgramImpl::Ptr implPtr = nullptr;
          return IsError(context.getImpl().linkProgram(*this, devices, options, inputPrograms,
