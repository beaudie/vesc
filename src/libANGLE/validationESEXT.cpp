                                       ...
                                       const GLenum storeops[])
{
    ...
    if (n != static_cast<GLsizei>(context->getState().getPixelLocalStorageActivePlanes()))
    {
        context->validationError(entryPoint, GL_INVALID_OPERATION, kPLSNNotEqualActivePlanes);
        return false;
    }
