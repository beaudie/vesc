...
bool ValidateBlendEquationSeparateiEXT(const Context *context,
                                       ...
                                       GLenum modeAlpha)
{
    if (!context->getExtensions().drawBuffersIndexed)
    {
        context->validationError(GL_INVALID_OPERATION, kExtensionNotEnabled);
        return false;
    }
...
bool ValidateBlendEquationSeparateiOES(const Context *context,
                                       ...
                                       GLenum modeAlpha)
{
    return ValidateBlendEquationSeparateiEXT(context, buf, modeRGB, modeAlpha);
}

bool ValidateBlendEquationiOES(const Context *context, GLuint buf, GLenum mode)
{
    return ValidateBlendEquationiEXT(context, buf, mode);
}
...
bool ValidateBlendFuncSeparateiOES(const Context *context,
                                   ...
                                   GLenum dstAlpha)
{
    return ValidateBlendFuncSeparateiEXT(context, buf, srcRGB, dstRGB, srcAlpha, dstAlpha);
}

bool ValidateBlendFunciOES(const Context *context, GLuint buf, GLenum src, GLenum dst)
{
    return ValidateBlendFunciEXT(context, buf, src, dst);
}
