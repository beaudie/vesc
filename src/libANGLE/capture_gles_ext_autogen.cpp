                               ...
                               GLboolean unpackUnmultiplyAlpha)
{
    ...
    ParamBuffer paramBuffer("glCopyTexture3DANGLE");
                                  ...
                                  GLboolean unpackUnmultiplyAlpha)
{
    ...
    bool isCallValid = ValidateCopySubTexture3DANGLE(
        ...
        unpackUnmultiplyAlpha);
    ParamBuffer paramBuffer("glCopySubTexture3DANGLE");
    paramBuffer.addValueParam("sourceId", ParamType::TGLuint, sourceId);
    paramBuffer.addValueParam("sourceLevel", ParamType::TGLint, sourceLevel);
    paramBuffer.addValueParam("destTargetPacked", ParamType::TTextureTarget, destTargetPacked);
    paramBuffer.addValueParam("destId", ParamType::TGLuint, destId);
                                 ...
                                 GLenum filter)
{
    ...
    ParamBuffer paramBuffer("glBlitFramebufferANGLE");
                                                ...
                                                GLsizei height)
{
    ...
    ParamBuffer paramBuffer("glRenderbufferStorageMultisampleANGLE");
                                     ...
                                     GLsizei primcount)
{
    ...
    ParamBuffer paramBuffer("glDrawArraysInstancedANGLE");
                                       ...
                                       GLsizei primcount)
{
    ...
    bool isCallValid = ValidateDrawElementsInstancedANGLE(context, modePacked, count, typePacked,
                                                          indices, primcount);
    ParamBuffer paramBuffer("glDrawElementsInstancedANGLE");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
...
void CaptureVertexAttribDivisorANGLE(Context *context, GLuint index, GLuint divisor)
{
    ...
    ParamBuffer paramBuffer("glVertexAttribDivisorANGLE");
                                 ...
                                 GLsizei drawcount)
{
    ...
    ParamBuffer paramBuffer("glMultiDrawArraysANGLE");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
                                          ...
                                          GLsizei drawcount)
{
    ...
    ParamBuffer paramBuffer("glMultiDrawArraysInstancedANGLE");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
                                   ...
                                   GLsizei drawcount)
{
    ...
    ParamBuffer paramBuffer("glMultiDrawElementsANGLE");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
                                            ...
                                            GLsizei drawcount)
{
    ...
    ParamBuffer paramBuffer("glMultiDrawElementsInstancedANGLE");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
...
void CaptureProvokingVertexANGLE(Context *context, ProvokingVertex modePacked)
{
    ...
    ParamBuffer paramBuffer("glProvokingVertexANGLE");
...
void CaptureRequestExtensionANGLE(Context *context, const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glRequestExtensionANGLE");
                                   ...
                                   GLboolean *params)
{
    ...
    ParamBuffer paramBuffer("glGetBooleanvRobustANGLE");
                                            ...
                                            GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetBufferParameterivRobustANGLE");
                                 ...
                                 GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetFloatvRobustANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                                           ...
                                                           GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetFramebufferAttachmentParameterivRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
                                   ...
                                   GLint *data)
{
    ...
    ParamBuffer paramBuffer("glGetIntegervRobustANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                    ...
                                    GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetProgramivRobustANGLE");
                                                  ...
                                                  GLint *params)
{
    ...
    bool isCallValid = ValidateGetRenderbufferParameterivRobustANGLE(context, target, pname,
                                                                     bufSize, length, params);
    ParamBuffer paramBuffer("glGetRenderbufferParameterivRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                   ...
                                   GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetShaderivRobustANGLE");
                                         ...
                                         GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexParameterfvRobustANGLE");
                                         ...
                                         GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexParameterivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                    ...
                                    GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetUniformfvRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                    ...
                                    GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetUniformivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                         ...
                                         GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetVertexAttribfvRobustANGLE");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                         ...
                                         GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetVertexAttribivRobustANGLE");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                               ...
                                               void **pointer)
{
    ...
    ParamBuffer paramBuffer("glGetVertexAttribPointervRobustANGLE");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                  ...
                                  void *pixels)
{
    ...
    ParamBuffer paramBuffer("glReadPixelsRobustANGLE");
    paramBuffer.addValueParam("x", ParamType::TGLint, x);
    paramBuffer.addValueParam("y", ParamType::TGLint, y);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
    paramBuffer.addValueParam("height", ParamType::TGLsizei, height);
                                  ...
                                  const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexImage2DRobustANGLE");
                                      ...
                                      const GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterfvRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                      ...
                                      const GLint *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                     ...
                                     const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexSubImage2DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
                                  ...
                                  const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexImage3DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLint, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                     ...
                                     const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexSubImage3DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
                                            ...
                                            const GLvoid *data)
{
    ...
    ParamBuffer paramBuffer("glCompressedTexImage2DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                               ...
                                               const GLvoid *data)
{
    ...
    bool isCallValid = ValidateCompressedTexSubImage2DRobustANGLE(
        ...
        data);
    ParamBuffer paramBuffer("glCompressedTexSubImage2DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
                                            ...
                                            const GLvoid *data)
{
    ...
    ParamBuffer paramBuffer("glCompressedTexImage3DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                               ...
                                               const GLvoid *data)
{
    ...
    ParamBuffer paramBuffer("glCompressedTexSubImage3DRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
                                  ...
                                  GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryivRobustANGLE");
                                         ...
                                         GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectuivRobustANGLE");
                                         ...
                                         void **params)
{
    ...
    ParamBuffer paramBuffer("glGetBufferPointervRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                     ...
                                     GLint *data)
{
    ...
    ParamBuffer paramBuffer("glGetIntegeri_vRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                           ...
                                           GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetInternalformativRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                          ...
                                          GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetVertexAttribIivRobustANGLE");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                           ...
                                           GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetVertexAttribIuivRobustANGLE");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                     ...
                                     GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetUniformuivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                               ...
                                               GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetActiveUniformBlockivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                     ...
                                     GLint64 *data)
{
    ...
    ParamBuffer paramBuffer("glGetInteger64vRobustANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                       ...
                                       GLint64 *data)
{
    ...
    ParamBuffer paramBuffer("glGetInteger64i_vRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                              ...
                                              GLint64 *params)
{
    ...
    bool isCallValid = ValidateGetBufferParameteri64vRobustANGLE(context, targetPacked, pname,
                                                                 bufSize, length, params);
    ParamBuffer paramBuffer("glGetBufferParameteri64vRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                          ...
                                          const GLint *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterivRobustANGLE");
                                          ...
                                          const GLfloat *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterfvRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                             ...
                                             GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetSamplerParameterivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                             ...
                                             GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetSamplerParameterfvRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                                 ...
                                                 GLint *params)
{
    ...
    bool isCallValid = ValidateGetFramebufferParameterivRobustANGLE(context, sampler, pname,
                                                                    bufSize, length, params);
    ParamBuffer paramBuffer("glGetFramebufferParameterivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                             ...
                                             GLint *params)
{
    ...
    bool isCallValid = ValidateGetProgramInterfaceivRobustANGLE(context, program, programInterface,
                                                                pname, bufSize, length, params);
    ParamBuffer paramBuffer("glGetProgramInterfaceivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                     ...
                                     GLboolean *data)
{
    ...
    ParamBuffer paramBuffer("glGetBooleani_vRobustANGLE");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                        ...
                                        GLfloat *val)
{
    ...
    ParamBuffer paramBuffer("glGetMultisamplefvRobustANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                              ...
                                              GLint *params)
{
    ...
    bool isCallValid = ValidateGetTexLevelParameterivRobustANGLE(context, targetPacked, level,
                                                                 pname, bufSize, length, params);
    ParamBuffer paramBuffer("glGetTexLevelParameterivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                              ...
                                              GLfloat *params)
{
    ...
    bool isCallValid = ValidateGetTexLevelParameterfvRobustANGLE(context, targetPacked, level,
                                                                 pname, bufSize, length, params);
    ParamBuffer paramBuffer("glGetTexLevelParameterfvRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                              ...
                                              void **params)
{
    ...
    ParamBuffer paramBuffer("glGetPointervRobustANGLERobustANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                   ...
                                   void *data)
{
    ...
    ParamBuffer paramBuffer("glReadnPixelsRobustANGLE");
    paramBuffer.addValueParam("x", ParamType::TGLint, x);
    paramBuffer.addValueParam("y", ParamType::TGLint, y);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
    paramBuffer.addValueParam("height", ParamType::TGLsizei, height);
                                     ...
                                     GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetnUniformfvRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                     ...
                                     GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetnUniformivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                      ...
                                      GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetnUniformuivRobustANGLE");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                       ...
                                       const GLint *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterIivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                        ...
                                        const GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterIuivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                          ...
                                          GLint *params)
{
    ...
    bool isCallValid = ValidateGetTexParameterIivRobustANGLE(context, targetPacked, pname, bufSize,
                                                             length, params);
    ParamBuffer paramBuffer("glGetTexParameterIivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                           ...
                                           GLuint *params)
{
    ...
    bool isCallValid = ValidateGetTexParameterIuivRobustANGLE(context, targetPacked, pname, bufSize,
                                                              length, params);
    ParamBuffer paramBuffer("glGetTexParameterIuivRobustANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                           ...
                                           const GLint *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterIivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                            ...
                                            const GLuint *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterIuivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                              ...
                                              GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetSamplerParameterIivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                               ...
                                               GLuint *params)
{
    ...
    bool isCallValid = ValidateGetSamplerParameterIuivRobustANGLE(context, sampler, pname, bufSize,
                                                                  length, params);
    ParamBuffer paramBuffer("glGetSamplerParameterIuivRobustANGLE");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                        ...
                                        GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectivRobustANGLE");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                          ...
                                          GLint64 *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjecti64vRobustANGLE");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                           ...
                                           GLuint64 *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectui64vRobustANGLE");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                                    ...
                                    GLenum type)
{
    ...
    ParamBuffer paramBuffer("glTexImage2DExternalANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLint, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
...
void CaptureInvalidateTextureANGLE(Context *context, TextureType targetPacked)
{
    ...
    ParamBuffer paramBuffer("glInvalidateTextureANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
                                         ...
                                         GLboolean fixedsamplelocations)
{
    ...
    ParamBuffer paramBuffer("glTexStorage2DMultisampleANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("samples", ParamType::TGLsizei, samples);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                        ...
                                        GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexLevelParameterivANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                        ...
                                        GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexLevelParameterfvANGLE");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetMultisamplefvANGLE(Context *context, GLenum pname, GLuint index, GLfloat *val)
{
    ...
    ParamBuffer paramBuffer("glGetMultisamplefvANGLE");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
...
void CaptureSampleMaskiANGLE(Context *context, GLuint maskNumber, GLbitfield mask)
{
    ...
    ParamBuffer paramBuffer("glSampleMaskiANGLE");
                                           ...
                                           GLchar *source)
{
    ...
    ParamBuffer paramBuffer("glGetTranslatedShaderSourceANGLE");
    paramBuffer.addValueParam("shader", ParamType::TGLuint, shader);
    paramBuffer.addValueParam("bufsize", ParamType::TGLsizei, bufsize);
                                        ...
                                        const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glBindUniformLocationCHROMIUM");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
...
void CaptureCompressedCopyTextureCHROMIUM(Context *context, GLuint sourceId, GLuint destId)
{
    ...
    ParamBuffer paramBuffer("glCompressedCopyTextureCHROMIUM");
    paramBuffer.addValueParam("sourceId", ParamType::TGLuint, sourceId);
    paramBuffer.addValueParam("destId", ParamType::TGLuint, destId);
                                ...
                                GLboolean unpackUnmultiplyAlpha)
{
    ...
    bool isCallValid = ValidateCopyTextureCHROMIUM(
        context, sourceId, sourceLevel, destTargetPacked, destId, destLevel, internalFormat,
        destType, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
    ParamBuffer paramBuffer("glCopyTextureCHROMIUM");
    paramBuffer.addValueParam("sourceId", ParamType::TGLuint, sourceId);
    paramBuffer.addValueParam("sourceLevel", ParamType::TGLint, sourceLevel);
    paramBuffer.addValueParam("destTargetPacked", ParamType::TTextureTarget, destTargetPacked);
    paramBuffer.addValueParam("destId", ParamType::TGLuint, destId);
                                   ...
                                   GLboolean unpackUnmultiplyAlpha)
{
    ...
    ParamBuffer paramBuffer("glCopySubTextureCHROMIUM");
    paramBuffer.addValueParam("sourceId", ParamType::TGLuint, sourceId);
    paramBuffer.addValueParam("sourceLevel", ParamType::TGLint, sourceLevel);
    paramBuffer.addValueParam("destTargetPacked", ParamType::TTextureTarget, destTargetPacked);
    paramBuffer.addValueParam("destId", ParamType::TGLuint, destId);
...
void CaptureCoverageModulationCHROMIUM(Context *context, GLenum components)
{
    ...
    ParamBuffer paramBuffer("glCoverageModulationCHROMIUM");
...
void CaptureMatrixLoadfCHROMIUM(Context *context, GLenum matrixMode, const GLfloat *matrix)
{
    ...
    ParamBuffer paramBuffer("glMatrixLoadfCHROMIUM");
...
void CaptureMatrixLoadIdentityCHROMIUM(Context *context, GLenum matrixMode)
{
    ...
    ParamBuffer paramBuffer("glMatrixLoadIdentityCHROMIUM");
    paramBuffer.addValueParam("matrixMode", ParamType::TGLenum, matrixMode);
                                ...
                                GraphicsResetStatus otherPacked)
{
    ...
    ParamBuffer paramBuffer("glLoseContextCHROMIUM");
...
void CaptureGenPathsCHROMIUM(Context *context, GLsizei range)
{
    ...
    ParamBuffer paramBuffer("glGenPathsCHROMIUM");
...
void CaptureDeletePathsCHROMIUM(Context *context, GLuint first, GLsizei range)
{
    ...
    ParamBuffer paramBuffer("glDeletePathsCHROMIUM");
...
void CaptureIsPathCHROMIUM(Context *context, GLuint path)
{
    ...
    ParamBuffer paramBuffer("glIsPathCHROMIUM");
                                 ...
                                 const void *coords)
{
    ...
    bool isCallValid = ValidatePathCommandsCHROMIUM(context, path, numCommands, commands, numCoords,
                                                    coordType, coords);
    ParamBuffer paramBuffer("glPathCommandsCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
...
void CapturePathParameterfCHROMIUM(Context *context, GLuint path, GLenum pname, GLfloat value)
{
    ...
    ParamBuffer paramBuffer("glPathParameterfCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CapturePathParameteriCHROMIUM(Context *context, GLuint path, GLenum pname, GLint value)
{
    ...
    ParamBuffer paramBuffer("glPathParameteriCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetPathParameterfvCHROMIUM(Context *context, GLuint path, GLenum pname, GLfloat *value)
{
    ...
    ParamBuffer paramBuffer("glGetPathParameterfvCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetPathParameterivCHROMIUM(Context *context, GLuint path, GLenum pname, GLint *value)
{
    ...
    ParamBuffer paramBuffer("glGetPathParameterivCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CapturePathStencilFuncCHROMIUM(Context *context, GLenum func, GLint ref, GLuint mask)
{
    ...
    ParamBuffer paramBuffer("glPathStencilFuncCHROMIUM");
...
void CaptureStencilFillPathCHROMIUM(Context *context, GLuint path, GLenum fillMode, GLuint mask)
{
    ...
    ParamBuffer paramBuffer("glStencilFillPathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
...
void CaptureStencilStrokePathCHROMIUM(Context *context, GLuint path, GLint reference, GLuint mask)
{
    ...
    ParamBuffer paramBuffer("glStencilStrokePathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
...
void CaptureCoverFillPathCHROMIUM(Context *context, GLuint path, GLenum coverMode)
{
    ...
    ParamBuffer paramBuffer("glCoverFillPathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
...
void CaptureCoverStrokePathCHROMIUM(Context *context, GLuint path, GLenum coverMode)
{
    ...
    ParamBuffer paramBuffer("glCoverStrokePathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("coverMode", ParamType::TGLenum, coverMode);
                                             ...
                                             GLenum coverMode)
{
    ...
    ParamBuffer paramBuffer("glStencilThenCoverFillPathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("fillMode", ParamType::TGLenum, fillMode);
    paramBuffer.addValueParam("mask", ParamType::TGLuint, mask);
    paramBuffer.addValueParam("coverMode", ParamType::TGLenum, coverMode);
                                               ...
                                               GLenum coverMode)
{
    ...
    ParamBuffer paramBuffer("glStencilThenCoverStrokePathCHROMIUM");
    paramBuffer.addValueParam("path", ParamType::TGLuint, path);
    paramBuffer.addValueParam("reference", ParamType::TGLint, reference);
    paramBuffer.addValueParam("mask", ParamType::TGLuint, mask);
    paramBuffer.addValueParam("coverMode", ParamType::TGLenum, coverMode);
                                           ...
                                           const GLfloat *transformValues)
{
    ...
    ParamBuffer paramBuffer("glCoverFillPathInstancedCHROMIUM");
                                             ...
                                             const GLfloat *transformValues)
{
    ...
    bool isCallValid = ValidateCoverStrokePathInstancedCHROMIUM(
        context, numPath, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
    ParamBuffer paramBuffer("glCoverStrokePathInstancedCHROMIUM");
    paramBuffer.addValueParam("numPath", ParamType::TGLsizei, numPath);
    paramBuffer.addValueParam("pathNameType", ParamType::TGLenum, pathNameType);
                                               ...
                                               const GLfloat *transformValues)
{
    ...
    ParamBuffer paramBuffer("glStencilStrokePathInstancedCHROMIUM");
    paramBuffer.addValueParam("numPath", ParamType::TGLsizei, numPath);
    paramBuffer.addValueParam("pathNameType", ParamType::TGLenum, pathNameType);
                                             ...
                                             const GLfloat *transformValues)
{
    ...
    ParamBuffer paramBuffer("glStencilFillPathInstancedCHROMIUM");
                                                      ...
                                                      const GLfloat *transformValues)
{
    ...
    bool isCallValid = ValidateStencilThenCoverFillPathInstancedCHROMIUM(
        ...
        transformValues);
    ParamBuffer paramBuffer("glStencilThenCoverFillPathInstancedCHROMIUM");
    paramBuffer.addValueParam("numPaths", ParamType::TGLsizei, numPaths);
    paramBuffer.addValueParam("pathNameType", ParamType::TGLenum, pathNameType);
                                                        ...
                                                        const GLfloat *transformValues)
{
    ...
    bool isCallValid = ValidateStencilThenCoverStrokePathInstancedCHROMIUM(
        ...
        transformValues);
    ParamBuffer paramBuffer("glStencilThenCoverStrokePathInstancedCHROMIUM");
    paramBuffer.addValueParam("numPaths", ParamType::TGLsizei, numPaths);
    paramBuffer.addValueParam("pathNameType", ParamType::TGLenum, pathNameType);
                                              ...
                                              const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glBindFragmentInputLocationCHROMIUM");
                                                ...
                                                const GLfloat *coeffs)
{
    ...
    ParamBuffer paramBuffer("glProgramPathFragmentInputGenCHROMIUM");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
                                    ...
                                    const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glBindFragDataLocationEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                           ...
                                           const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glBindFragDataLocationIndexedEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
...
void CaptureGetFragDataIndexEXT(Context *context, GLuint program, const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glGetFragDataIndexEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                               ...
                                               const GLchar *name)
{
    ...
    ParamBuffer paramBuffer("glGetProgramResourceLocationIndexEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("programInterface", ParamType::TGLenum, programInterface);
...
void CaptureInsertEventMarkerEXT(Context *context, GLsizei length, const GLchar *marker)
{
    ...
    ParamBuffer paramBuffer("glInsertEventMarkerEXT");
...
void CapturePopGroupMarkerEXT(Context *context)
{
    ...
    ParamBuffer paramBuffer("glPopGroupMarkerEXT");
...
void CapturePushGroupMarkerEXT(Context *context, GLsizei length, const GLchar *marker)
{
    ...
    ParamBuffer paramBuffer("glPushGroupMarkerEXT");
    paramBuffer.addValueParam("length", ParamType::TGLsizei, length);
                                  ...
                                  const GLenum *attachments)
{
    ...
    ParamBuffer paramBuffer("glDiscardFramebufferEXT");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
...
void CaptureBeginQueryEXT(Context *context, QueryType targetPacked, GLuint id)
{
    ...
    ParamBuffer paramBuffer("glBeginQueryEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TQueryType, targetPacked);
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
...
void CaptureDeleteQueriesEXT(Context *context, GLsizei n, const GLuint *ids)
{
    ...
    ParamBuffer paramBuffer("glDeleteQueriesEXT");
...
void CaptureEndQueryEXT(Context *context, QueryType targetPacked)
{
    ...
    ParamBuffer paramBuffer("glEndQueryEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TQueryType, targetPacked);
...
void CaptureGenQueriesEXT(Context *context, GLsizei n, GLuint *ids)
{
    ...
    ParamBuffer paramBuffer("glGenQueriesEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGetQueryObjecti64vEXT(Context *context, GLuint id, GLenum pname, GLint64 *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjecti64vEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetQueryObjectivEXT(Context *context, GLuint id, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectivEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetQueryObjectui64vEXT(Context *context, GLuint id, GLenum pname, GLuint64 *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectui64vEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetQueryObjectuivEXT(Context *context, GLuint id, GLenum pname, GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryObjectuivEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetQueryivEXT(Context *context, QueryType targetPacked, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetQueryivEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TQueryType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureIsQueryEXT(Context *context, GLuint id)
{
    ...
    ParamBuffer paramBuffer("glIsQueryEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
...
void CaptureQueryCounterEXT(Context *context, GLuint id, QueryType targetPacked)
{
    ...
    ParamBuffer paramBuffer("glQueryCounterEXT");
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("targetPacked", ParamType::TQueryType, targetPacked);
...
void CaptureDrawBuffersEXT(Context *context, GLsizei n, const GLenum *bufs)
{
    ...
    ParamBuffer paramBuffer("glDrawBuffersEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
                                  ...
                                  GLint level)
{
    ...
    ParamBuffer paramBuffer("glFramebufferTextureEXT");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
                                   ...
                                   GLsizei primcount)
{
    ...
    ParamBuffer paramBuffer("glDrawArraysInstancedEXT");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
                                     ...
                                     GLsizei primcount)
{
    ...
    bool isCallValid = ValidateDrawElementsInstancedEXT(context, modePacked, count, typePacked,
                                                        indices, primcount);
    ParamBuffer paramBuffer("glDrawElementsInstancedEXT");
    paramBuffer.addValueParam("modePacked", ParamType::TPrimitiveMode, modePacked);
    paramBuffer.addValueParam("count", ParamType::TGLsizei, count);
    paramBuffer.addValueParam("typePacked", ParamType::TDrawElementsType, typePacked);
...
void CaptureVertexAttribDivisorEXT(Context *context, GLuint index, GLuint divisor)
{
    ...
    ParamBuffer paramBuffer("glVertexAttribDivisorEXT");
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
    paramBuffer.addValueParam("divisor", ParamType::TGLuint, divisor);
                                      ...
                                      GLsizeiptr length)
{
    ...
    ParamBuffer paramBuffer("glFlushMappedBufferRangeEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
                              ...
                              GLbitfield access)
{
    ...
    ParamBuffer paramBuffer("glMapBufferRangeEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
    paramBuffer.addValueParam("offset", ParamType::TGLintptr, offset);
    paramBuffer.addValueParam("length", ParamType::TGLsizeiptr, length);
                                ...
                                GLuint64 offset)
{
    ...
    ParamBuffer paramBuffer("glBufferStorageMemEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
...
void CaptureCreateMemoryObjectsEXT(Context *context, GLsizei n, GLuint *memoryObjects)
{
    ...
    ParamBuffer paramBuffer("glCreateMemoryObjectsEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureDeleteMemoryObjectsEXT(Context *context, GLsizei n, const GLuint *memoryObjects)
{
    ...
    ParamBuffer paramBuffer("glDeleteMemoryObjectsEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
                                          ...
                                          GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetMemoryObjectParameterivEXT");
...
void CaptureGetUnsignedBytevEXT(Context *context, GLenum pname, GLubyte *data)
{
    ...
    ParamBuffer paramBuffer("glGetUnsignedBytevEXT");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetUnsignedBytei_vEXT(Context *context, GLenum target, GLuint index, GLubyte *data)
{
    ...
    ParamBuffer paramBuffer("glGetUnsignedBytei_vEXT");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("index", ParamType::TGLuint, index);
...
void CaptureIsMemoryObjectEXT(Context *context, GLuint memoryObject)
{
    ...
    ParamBuffer paramBuffer("glIsMemoryObjectEXT");
    paramBuffer.addValueParam("memoryObject", ParamType::TGLuint, memoryObject);
                                       ...
                                       const GLint *params)
{
    ...
    ParamBuffer paramBuffer("glMemoryObjectParameterivEXT");
    paramBuffer.addValueParam("memoryObject", ParamType::TGLuint, memoryObject);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                               ...
                               GLuint64 offset)
{
    ...
    ParamBuffer paramBuffer("glTexStorageMem2DEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
                                          ...
                                          GLuint64 offset)
{
    ...
    ParamBuffer paramBuffer("glTexStorageMem2DMultisampleEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("samples", ParamType::TGLsizei, samples);
    paramBuffer.addValueParam("internalFormat", ParamType::TGLenum, internalFormat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                               ...
                               GLuint64 offset)
{
    ...
    ParamBuffer paramBuffer("glTexStorageMem3DEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("levels", ParamType::TGLsizei, levels);
    paramBuffer.addValueParam("internalFormat", ParamType::TGLenum, internalFormat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                          ...
                                          GLuint64 offset)
{
    ...
    ParamBuffer paramBuffer("glTexStorageMem3DMultisampleEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("samples", ParamType::TGLsizei, samples);
    paramBuffer.addValueParam("internalFormat", ParamType::TGLenum, internalFormat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                              ...
                              GLint fd)
{
    ...
    ParamBuffer paramBuffer("glImportMemoryFdEXT");
    paramBuffer.addValueParam("memory", ParamType::TGLuint, memory);
...
void CaptureGetGraphicsResetStatusEXT(Context *context)
{
    ...
    ParamBuffer paramBuffer("glGetGraphicsResetStatusEXT");
                             ...
                             GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetnUniformfvEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                             ...
                             GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetnUniformivEXT");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("location", ParamType::TGLint, location);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                           ...
                           void *data)
{
    ...
    ParamBuffer paramBuffer("glReadnPixelsEXT");
    paramBuffer.addValueParam("x", ParamType::TGLint, x);
    paramBuffer.addValueParam("y", ParamType::TGLint, y);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
    paramBuffer.addValueParam("height", ParamType::TGLsizei, height);
...
void CaptureDeleteSemaphoresEXT(Context *context, GLsizei n, const GLuint *semaphores)
{
    ...
    ParamBuffer paramBuffer("glDeleteSemaphoresEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGenSemaphoresEXT(Context *context, GLsizei n, GLuint *semaphores)
{
    ...
    ParamBuffer paramBuffer("glGenSemaphoresEXT");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
                                          ...
                                          GLuint64 *params)
{
    ...
    ParamBuffer paramBuffer("glGetSemaphoreParameterui64vEXT");
...
void CaptureIsSemaphoreEXT(Context *context, GLuint semaphore)
{
    ...
    ParamBuffer paramBuffer("glIsSemaphoreEXT");
    paramBuffer.addValueParam("semaphore", ParamType::TGLuint, semaphore);
                                       ...
                                       const GLuint64 *params)
{
    ...
    ParamBuffer paramBuffer("glSemaphoreParameterui64vEXT");
    paramBuffer.addValueParam("semaphore", ParamType::TGLuint, semaphore);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                               ...
                               const GLenum *dstLayouts)
{
    ...
    ParamBuffer paramBuffer("glSignalSemaphoreEXT");
    paramBuffer.addValueParam("semaphore", ParamType::TGLuint, semaphore);
                             ...
                             const GLenum *srcLayouts)
{
    ...
    ParamBuffer paramBuffer("glWaitSemaphoreEXT");
    paramBuffer.addValueParam("semaphore", ParamType::TGLuint, semaphore);
    paramBuffer.addValueParam("numBufferBarriers", ParamType::TGLuint, numBufferBarriers);
                                 ...
                                 GLint fd)
{
    ...
    ParamBuffer paramBuffer("glImportSemaphoreFdEXT");
    paramBuffer.addValueParam("semaphore", ParamType::TGLuint, semaphore);
    paramBuffer.addValueParam("handleTypePacked", ParamType::THandleType, handleTypePacked);
    paramBuffer.addValueParam("fd", ParamType::TGLint, fd);
                            ...
                            GLsizei width)
{
    ...
    ParamBuffer paramBuffer("glTexStorage1DEXT");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("levels", ParamType::TGLsizei, levels);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                            ...
                            GLsizei height)
{
    ...
    ParamBuffer paramBuffer("glTexStorage2DEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("levels", ParamType::TGLsizei, levels);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                            ...
                            GLsizei depth)
{
    ...
    bool isCallValid = ValidateTexStorage3DEXT(context, targetPacked, levels, internalformat, width,
                                               height, depth);
    ParamBuffer paramBuffer("glTexStorage3DEXT");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("levels", ParamType::TGLsizei, levels);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                    ...
                                    const void *userParam)
{
    ...
    ParamBuffer paramBuffer("glDebugMessageCallbackKHR");
                                   ...
                                   GLboolean enabled)
{
    ...
    ParamBuffer paramBuffer("glDebugMessageControlKHR");
                                  ...
                                  const GLchar *buf)
{
    ...
    ParamBuffer paramBuffer("glDebugMessageInsertKHR");
    paramBuffer.addValueParam("source", ParamType::TGLenum, source);
    paramBuffer.addValueParam("type", ParamType::TGLenum, type);
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("severity", ParamType::TGLenum, severity);
                                  ...
                                  GLchar *messageLog)
{
    ...
    ParamBuffer paramBuffer("glGetDebugMessageLogKHR");
                              ...
                              GLchar *label)
{
    ...
    ParamBuffer paramBuffer("glGetObjectLabelKHR");
                                 ...
                                 GLchar *label)
{
    ...
    ParamBuffer paramBuffer("glGetObjectPtrLabelKHR");
...
void CaptureGetPointervKHR(Context *context, GLenum pname, void **params)
{
    ...
    ParamBuffer paramBuffer("glGetPointervKHR");
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                           ...
                           const GLchar *label)
{
    ...
    ParamBuffer paramBuffer("glObjectLabelKHR");
    paramBuffer.addValueParam("identifier", ParamType::TGLenum, identifier);
    paramBuffer.addValueParam("name", ParamType::TGLuint, name);
    paramBuffer.addValueParam("length", ParamType::TGLsizei, length);
                              ...
                              const GLchar *label)
{
    ...
    ParamBuffer paramBuffer("glObjectPtrLabelKHR");
...
void CapturePopDebugGroupKHR(Context *context)
{
    ...
    ParamBuffer paramBuffer("glPopDebugGroupKHR");
                              ...
                              const GLchar *message)
{
    ...
    ParamBuffer paramBuffer("glPushDebugGroupKHR");
    paramBuffer.addValueParam("source", ParamType::TGLenum, source);
    paramBuffer.addValueParam("id", ParamType::TGLuint, id);
    paramBuffer.addValueParam("length", ParamType::TGLsizei, length);
...
void CaptureMaxShaderCompilerThreadsKHR(Context *context, GLuint count)
{
    ...
    ParamBuffer paramBuffer("glMaxShaderCompilerThreadsKHR");
    paramBuffer.addValueParam("count", ParamType::TGLuint, count);
...
void CaptureDeleteFencesNV(Context *context, GLsizei n, const GLuint *fences)
{
    ...
    ParamBuffer paramBuffer("glDeleteFencesNV");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureFinishFenceNV(Context *context, GLuint fence)
{
    ...
    ParamBuffer paramBuffer("glFinishFenceNV");
...
void CaptureGenFencesNV(Context *context, GLsizei n, GLuint *fences)
{
    ...
    ParamBuffer paramBuffer("glGenFencesNV");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGetFenceivNV(Context *context, GLuint fence, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetFenceivNV");
    paramBuffer.addValueParam("fence", ParamType::TGLuint, fence);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureIsFenceNV(Context *context, GLuint fence)
{
    ...
    ParamBuffer paramBuffer("glIsFenceNV");
    paramBuffer.addValueParam("fence", ParamType::TGLuint, fence);
...
void CaptureSetFenceNV(Context *context, GLuint fence, GLenum condition)
{
    ...
    ParamBuffer paramBuffer("glSetFenceNV");
    paramBuffer.addValueParam("fence", ParamType::TGLuint, fence);
...
void CaptureTestFenceNV(Context *context, GLuint fence)
{
    ...
    ParamBuffer paramBuffer("glTestFenceNV");
    paramBuffer.addValueParam("fence", ParamType::TGLuint, fence);
                                                 ...
                                                 GLeglImageOES image)
{
    ...
    ParamBuffer paramBuffer("glEGLImageTargetRenderbufferStorageOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
                                       ...
                                       GLeglImageOES image)
{
    ...
    ParamBuffer paramBuffer("glEGLImageTargetTexture2DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("image", ParamType::TGLeglImageOES, image);
                        ...
                        GLfloat height)
{
    ...
    ParamBuffer paramBuffer("glDrawTexfOES");
...
void CaptureDrawTexfvOES(Context *context, const GLfloat *coords)
{
    ...
    ParamBuffer paramBuffer("glDrawTexfvOES");
...
void CaptureDrawTexiOES(Context *context, GLint x, GLint y, GLint z, GLint width, GLint height)
{
    ...
    ParamBuffer paramBuffer("glDrawTexiOES");
    paramBuffer.addValueParam("x", ParamType::TGLint, x);
    paramBuffer.addValueParam("y", ParamType::TGLint, y);
    paramBuffer.addValueParam("z", ParamType::TGLint, z);
    paramBuffer.addValueParam("width", ParamType::TGLint, width);
...
void CaptureDrawTexivOES(Context *context, const GLint *coords)
{
    ...
    ParamBuffer paramBuffer("glDrawTexivOES");
                        ...
                        GLshort height)
{
    ...
    ParamBuffer paramBuffer("glDrawTexsOES");
...
void CaptureDrawTexsvOES(Context *context, const GLshort *coords)
{
    ...
    ParamBuffer paramBuffer("glDrawTexsvOES");
                        ...
                        GLfixed height)
{
    ...
    ParamBuffer paramBuffer("glDrawTexxOES");
...
void CaptureDrawTexxvOES(Context *context, const GLfixed *coords)
{
    ...
    ParamBuffer paramBuffer("glDrawTexxvOES");
...
void CaptureBindFramebufferOES(Context *context, GLenum target, GLuint framebuffer)
{
    ...
    ParamBuffer paramBuffer("glBindFramebufferOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
...
void CaptureBindRenderbufferOES(Context *context, GLenum target, GLuint renderbuffer)
{
    ...
    ParamBuffer paramBuffer("glBindRenderbufferOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
...
void CaptureCheckFramebufferStatusOES(Context *context, GLenum target)
{
    ...
    ParamBuffer paramBuffer("glCheckFramebufferStatusOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
...
void CaptureDeleteFramebuffersOES(Context *context, GLsizei n, const GLuint *framebuffers)
{
    ...
    ParamBuffer paramBuffer("glDeleteFramebuffersOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureDeleteRenderbuffersOES(Context *context, GLsizei n, const GLuint *renderbuffers)
{
    ...
    ParamBuffer paramBuffer("glDeleteRenderbuffersOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
                                       ...
                                       GLuint renderbuffer)
{
    ...
    ParamBuffer paramBuffer("glFramebufferRenderbufferOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
                                    ...
                                    GLint level)
{
    ...
    bool isCallValid = ValidateFramebufferTexture2DOES(context, target, attachment, textargetPacked,
                                                       texture, level);
    ParamBuffer paramBuffer("glFramebufferTexture2DOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
...
void CaptureGenFramebuffersOES(Context *context, GLsizei n, GLuint *framebuffers)
{
    ...
    ParamBuffer paramBuffer("glGenFramebuffersOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGenRenderbuffersOES(Context *context, GLsizei n, GLuint *renderbuffers)
{
    ...
    ParamBuffer paramBuffer("glGenRenderbuffersOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGenerateMipmapOES(Context *context, TextureType targetPacked)
{
    ...
    ParamBuffer paramBuffer("glGenerateMipmapOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
                                                   ...
                                                   GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetFramebufferAttachmentParameterivOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                          ...
                                          GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetRenderbufferParameterivOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureIsFramebufferOES(Context *context, GLuint framebuffer)
{
    ...
    ParamBuffer paramBuffer("glIsFramebufferOES");
    paramBuffer.addValueParam("framebuffer", ParamType::TGLuint, framebuffer);
...
void CaptureIsRenderbufferOES(Context *context, GLuint renderbuffer)
{
    ...
    ParamBuffer paramBuffer("glIsRenderbufferOES");
    paramBuffer.addValueParam("renderbuffer", ParamType::TGLuint, renderbuffer);
                                   ...
                                   GLsizei height)
{
    ...
    ParamBuffer paramBuffer("glRenderbufferStorageOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
    paramBuffer.addValueParam("height", ParamType::TGLsizei, height);
                                ...
                                void *binary)
{
    ...
    ParamBuffer paramBuffer("glGetProgramBinaryOES");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
    paramBuffer.addValueParam("bufSize", ParamType::TGLsizei, bufSize);
                             ...
                             GLint length)
{
    ...
    ParamBuffer paramBuffer("glProgramBinaryOES");
    paramBuffer.addValueParam("program", ParamType::TGLuint, program);
                                 ...
                                 void **params)
{
    ...
    ParamBuffer paramBuffer("glGetBufferPointervOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureMapBufferOES(Context *context, BufferBinding targetPacked, GLenum access)
{
    ...
    ParamBuffer paramBuffer("glMapBufferOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
...
void CaptureUnmapBufferOES(Context *context, BufferBinding targetPacked)
{
    ...
    ParamBuffer paramBuffer("glUnmapBufferOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TBufferBinding, targetPacked);
...
void CaptureCurrentPaletteMatrixOES(Context *context, GLuint matrixpaletteindex)
{
    ...
    ParamBuffer paramBuffer("glCurrentPaletteMatrixOES");
...
void CaptureLoadPaletteFromModelViewMatrixOES(Context *context)
{
    ...
    ParamBuffer paramBuffer("glLoadPaletteFromModelViewMatrixOES");
                                  ...
                                  const void *pointer)
{
    ...
    ParamBuffer paramBuffer("glMatrixIndexPointerOES");
                             ...
                             const void *pointer)
{
    ...
    ParamBuffer paramBuffer("glWeightPointerOES");
    paramBuffer.addValueParam("size", ParamType::TGLint, size);
    paramBuffer.addValueParam("type", ParamType::TGLenum, type);
    paramBuffer.addValueParam("stride", ParamType::TGLsizei, stride);
                                ...
                                const void *pointer)
{
    ...
    ParamBuffer paramBuffer("glPointSizePointerOES");
...
void CaptureQueryMatrixxOES(Context *context, GLfixed *mantissa, GLint *exponent)
{
    ...
    ParamBuffer paramBuffer("glQueryMatrixxOES");
                                    ...
                                    const void *data)
{
    ...
    ParamBuffer paramBuffer("glCompressedTexImage3DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                                       ...
                                       const void *data)
{
    ...
    ParamBuffer paramBuffer("glCompressedTexSubImage3DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
                                 ...
                                 GLsizei height)
{
    ...
    ParamBuffer paramBuffer("glCopyTexSubImage3DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
                                    ...
                                    GLint zoffset)
{
    ...
    ParamBuffer paramBuffer("glFramebufferTexture3DOES");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
    paramBuffer.addValueParam("textargetPacked", ParamType::TTextureTarget, textargetPacked);
    paramBuffer.addValueParam("texture", ParamType::TGLuint, texture);
                          ...
                          const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexImage3DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
                             ...
                             const void *pixels)
{
    ...
    ParamBuffer paramBuffer("glTexSubImage3DOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureTarget, targetPacked);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
    paramBuffer.addValueParam("xoffset", ParamType::TGLint, xoffset);
    paramBuffer.addValueParam("yoffset", ParamType::TGLint, yoffset);
...
void CaptureGetSamplerParameterIivOES(Context *context, GLuint sampler, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetSamplerParameterIivOES");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                       ...
                                       GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetSamplerParameterIuivOES");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                  ...
                                  GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexParameterIivOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                   ...
                                   GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexParameterIuivOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                   ...
                                   const GLint *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterIivOES");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                    ...
                                    const GLuint *param)
{
    ...
    ParamBuffer paramBuffer("glSamplerParameterIuivOES");
    paramBuffer.addValueParam("sampler", ParamType::TGLuint, sampler);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                               ...
                               const GLint *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterIivOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                ...
                                const GLuint *params)
{
    ...
    ParamBuffer paramBuffer("glTexParameterIuivOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetTexGenfvOES(Context *context, GLenum coord, GLenum pname, GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexGenfvOES");
...
void CaptureGetTexGenivOES(Context *context, GLenum coord, GLenum pname, GLint *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexGenivOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureGetTexGenxvOES(Context *context, GLenum coord, GLenum pname, GLfixed *params)
{
    ...
    ParamBuffer paramBuffer("glGetTexGenxvOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGenfOES(Context *context, GLenum coord, GLenum pname, GLfloat param)
{
    ...
    ParamBuffer paramBuffer("glTexGenfOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGenfvOES(Context *context, GLenum coord, GLenum pname, const GLfloat *params)
{
    ...
    ParamBuffer paramBuffer("glTexGenfvOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGeniOES(Context *context, GLenum coord, GLenum pname, GLint param)
{
    ...
    ParamBuffer paramBuffer("glTexGeniOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGenivOES(Context *context, GLenum coord, GLenum pname, const GLint *params)
{
    ...
    ParamBuffer paramBuffer("glTexGenivOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGenxOES(Context *context, GLenum coord, GLenum pname, GLfixed param)
{
    ...
    ParamBuffer paramBuffer("glTexGenxOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
...
void CaptureTexGenxvOES(Context *context, GLenum coord, GLenum pname, const GLfixed *params)
{
    ...
    ParamBuffer paramBuffer("glTexGenxvOES");
    paramBuffer.addValueParam("coord", ParamType::TGLenum, coord);
    paramBuffer.addValueParam("pname", ParamType::TGLenum, pname);
                                       ...
                                       GLboolean fixedsamplelocations)
{
    ...
    ParamBuffer paramBuffer("glTexStorage3DMultisampleOES");
    paramBuffer.addValueParam("targetPacked", ParamType::TTextureType, targetPacked);
    paramBuffer.addValueParam("samples", ParamType::TGLsizei, samples);
    paramBuffer.addValueParam("internalformat", ParamType::TGLenum, internalformat);
    paramBuffer.addValueParam("width", ParamType::TGLsizei, width);
...
void CaptureBindVertexArrayOES(Context *context, GLuint array)
{
    ...
    ParamBuffer paramBuffer("glBindVertexArrayOES");
...
void CaptureDeleteVertexArraysOES(Context *context, GLsizei n, const GLuint *arrays)
{
    ...
    ParamBuffer paramBuffer("glDeleteVertexArraysOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureGenVertexArraysOES(Context *context, GLsizei n, GLuint *arrays)
{
    ...
    ParamBuffer paramBuffer("glGenVertexArraysOES");
    paramBuffer.addValueParam("n", ParamType::TGLsizei, n);
...
void CaptureIsVertexArrayOES(Context *context, GLuint array)
{
    ...
    ParamBuffer paramBuffer("glIsVertexArrayOES");
    paramBuffer.addValueParam("array", ParamType::TGLuint, array);
                                           ...
                                           GLsizei numViews)
{
    ...
    ParamBuffer paramBuffer("glFramebufferTextureMultiviewOVR");
    paramBuffer.addValueParam("target", ParamType::TGLenum, target);
    paramBuffer.addValueParam("attachment", ParamType::TGLenum, attachment);
    paramBuffer.addValueParam("texture", ParamType::TGLuint, texture);
    paramBuffer.addValueParam("level", ParamType::TGLint, level);
