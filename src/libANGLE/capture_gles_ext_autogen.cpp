                                                        ...
                                                        GLuint baseInstance)
{
    ...
    return CallCapture("glDrawArraysInstancedBaseInstanceANGLE", std::move(paramBuffer));
}
                                                                    ...
                                                                    GLuint baseInstance)
{
    ...
    return CallCapture("glDrawElementsInstancedBaseVertexBaseInstanceANGLE",
                                                             ...
                                                             const GLuint *baseInstances)
{
    ...
    return CallCapture("glMultiDrawArraysInstancedBaseInstanceANGLE", std::move(paramBuffer));
}
    ...
    const GLuint *baseInstances)
{
    ...
    return CallCapture("glMultiDrawElementsInstancedBaseVertexBaseInstanceANGLE",
                       std::move(paramBuffer));
}
