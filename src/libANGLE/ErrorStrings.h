...
MSG kExtensionNotSupported = "Extension is not supported.";
...
MSG kInvalidIndexRangeMultiview = "indices must be positive and less than GL_MAX_MULTIVIEW_BUFFERS_EXT.";
MSG kInvalidIndexRangeColorAttach = "indices must be positive and less than GL_MAX_COLOR_ATTACHMENTS.";
...
MSG kInvalidLocationMultiview = "location must be GL_MULTIVIEW_EXT, or GL_NONE.";
MSG kInvalidLocationColorAttach = "location must be GL_COLOR_ATTACHMENT_EXT, or GL_NONE.";
...
MSG kInvalidNegativeNumber = "Number of values must be positive.";
