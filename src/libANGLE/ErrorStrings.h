...
MSG kAnyBlendEquationNotSupported = "Active fragment shader does not include any layout qualifier for the advanced blend equation";
...
MSG kBlendEquationWithMRT = "Advanced blend equation only can be used when only one draw buffer is not NONE";
