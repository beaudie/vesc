...
// MSGorStrings.h: Contains mapping of commonly used MSGor messages

#ifndef LIBANGLE_MSGORSTRINGS_H_
#define LIBANGLE_MSGORSTRINGS_H_
...
MSG kBlitExtensionMultisampledWholeBufferBlit =
...
MSG kBlitDepthOrStencilFormatMismatch =
    "Depth/stencil buffer format combination not allowed for blit.";
MSG kBlitIntegerWithLinearFilter =
...
MSG kBlitSameImageDepthOrStencil =
...
MSG kColorNumberGreaterThanMaxDualSourceDrawBuffers =
    "Color number for secondary color greater than or equal to MAX_DUAL_SOURCE_DRAW_BUFFERS";
MSG kColorNumberGreaterThanMaxDrawBuffers =
...
MSG kCompressedTextureDimensionsMustMatchData =
...
MSG kDestinationLevelNotDefined =
...
MSG kElementArrayBufferBoundForTransformFeedback =
...
MSG kFramebufferTextureLayerIncorrectTextureType =
...
MSG kIndexExceedsMaxActiveUniformBlock =
    "Index must be less than program active uniform block count.";
MSG kIndexExceedsMaxAtomicCounterBufferBindings =
...
MSG kIndexExceedsMaxTransformFeedbackAttribs =
...
MSG kIndexExceedsMaxWorkgroupDimensions =
...
MSG kInternalFormatRequiresTexture2DArray =
...
MSG kInvalidDrawModeTransformFeedback =
...
MSG kMultisampleTextureExtensionOrES31Required =
...
MSG kNoActiveGraphicsShaderStage =
...
MSG kOffsetMustBeMultipleOfUint =
...
MSG kPixelPackBufferBoundForTransformFeedback =
    "It is undefined behavior to use a pixel pack buffer that is bound for transform feedback.";
MSG kPixelUnpackBufferBoundForTransformFeedback =
...
MSG kShaderToDetachMustBeAttached =
...
MSG kStencilReferenceMaskOrMismatch =
...
MSG kTextureWidthOrHeightOutOfRange =
    "Width and height must be less than or equal to GL_MAX_TEXTURE_SIZE.";
MSG kTransformFeedbackBufferDoubleBound =
...
MSG kTransformFeedbackVaryingIndexOutOfRange =
...
MSG kUniformBufferBoundForTransformFeedback =
...
MSG kUnsizedInternalFormatUnsupported =
    "Internalformat is one of the unsupported unsized base internalformats.";
MSG kUnsupportedDrawModeForTransformFeedback =
...
MSG kWebglBindAttribLocationReservedPrefix =
    "Attributes that begin with 'webgl_' = or '_webgl_' are not allowed.";
MSG kWebglNameLengthLimitExceeded =
...
#endif  // LIBANGLE_MSGORSTRINGS_H_
