...
#define ERRMSG(name, message) static constexpr char *g_kError##name = static_cast<char *>(message);
...
ERRMSG(DefaultFramebufferTarget, "Cannot change default FBO's attachments");
