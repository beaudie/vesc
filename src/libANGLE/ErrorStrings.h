...
ERRMSG(AtLeastOneDivisorOfZero, "At least one enabled attribute must have a divisor of zero.");
...
ERRMSG(DebugInvalidSeverity, "Invalid debug severity.");
ERRMSG(DebugInvalidSource, "Invalid debug source.");
ERRMSG(DebugInvalidType, "Invalid debug type.");
...
ERRMSG(IndexExceedsMaxDraw, "Index exceeds MAX_DRAW_BUFFERS.");
ERRMSG(IndexExceedsMaxVertex, "Index exceeds MAX_VERTEX_ATTRIBS.");
...
ERRMSG(InvalidFilterExternalTexture,
...
ERRMSG(InvalidFramebufferTextureParameter, "Invalid parameter name for renderbuffer attachment.");
...
ERRMSG(InvalidWrapModeExternalTexture, "External textures only support CLAMP_TO_EDGE wrap mode.");
...
ERRMSG(PrimcountMustBeGreaterThanOrEqualToZero, "Primcount must be greater than or equal to zero.");
...
ERRMSG(QueryInvalidId, "Invalid query Id.");
ERRMSG(QueryInvalidTarget, "Invalid query target.");
ERRMSG(QueryInvalidType, "Invalid query type.");
...
ERRMSG(VertexArrayHasNoBuffer, "An enabled vertex array has no buffer.");
ERRMSG(VertexArrayHasNoBufferPointer, "An enabled vertex array has no buffer and no pointer.");
