...
MSG kInvalidCreateFlags = "Create flags must only include bits defined by GL_ANGLE_external_objects_flags";
...
MSG kInvalidUsageFlags = "Usage flags must only include bits defined by GL_ANGLE_external_objects_flags";
