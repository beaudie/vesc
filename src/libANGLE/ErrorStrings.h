...
MSG kPLSRasterizerDiscardEnabled = "Attempted to begin pixel local storage with GL_SAMPLE_ALPHA_TO_COVERAGE enabled.";
MSG kPLSReservedColorAttachmentInUse = "When beginning pixel local storage, the framebuffer cannot have color attachments on or after: GL_COLOR_ATTACHMENT0 + min(GL_MAX_COLOR_ATTACHMENTS_WITH_ACTIVE_PLS_ANGLE, GL_MAX_COMBINED_DRAW_BUFFERS_AND_PLS_PLANES_ANGLE - <planes>).";
