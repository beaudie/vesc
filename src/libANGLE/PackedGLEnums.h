...
// implements parts of the std::array interface except with enum values instead of indices. Some of
// the std::bitset with shifts and casts to/from integer isn't present because it doesn't make sense
// for enums.
template <typename E>
