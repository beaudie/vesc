...
struct LinkingVariables final : private angle::NonCopyable
{
    ...
    ShaderMap<std::vector<sh::ShaderVariable>> linkingOutputVaryings;
    ShaderMap<std::vector<sh::ShaderVariable>> linkingInputVaryings;
    ShaderMap<std::vector<sh::ShaderVariable>> linkingUniforms;
    ShaderMap<std::vector<sh::InterfaceBlock>> linkingUniformBlocks;
