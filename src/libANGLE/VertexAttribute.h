...
bool sameVertexFormat(const gl::VertexAttribute &newAttrib,
                      const gl::VertexAttribute &cachedAttrib);
bool sameBindingBuffer(const gl::VertexBinding &newBinding, const gl::VertexBinding &cachedBinding);
