...
rx::StreamProducerImpl *Stream::getStreamProducer()
{
...
Error Stream::consumerAcquire()
{
    ...
    mTextures[0]->imageFromStream(this, mProducerImplementation->getGLFrameDescription(0));
    mTextures[1]->imageFromStream(this, mProducerImplementation->getGLFrameDescription(1));
...
Error Stream::consumerRelease()
{
    ...
    // Release the images
    mTextures[0]->imageFromStream(nullptr, mProducerImplementation->getGLFrameDescription(0));
    mTextures[1]->imageFromStream(nullptr, mProducerImplementation->getGLFrameDescription(1));
