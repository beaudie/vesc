                 ...
                 egl::BlobCache::Key *hashOut)
{
    ...
    // Include the built-in resources, which define the status of extensions and values of shader
    // constants.
    hashStream << Compiler::CalculateBuiltInResources(context->getState());
