...
struct PixelUnpackState : PackUnpackStateBase
{
    PixelUnpackState() {}

    explicit PixelUnpackState(GLint alignmentIn, GLint rowLengthIn)
    {
...
struct PixelPackState : PackUnpackStateBase
{
