...
// GLES1 emulation: State specific to GLES1 contexts
...
struct LightParameters
{
    ...
    ColorF diffuse;
    ColorF specular;
    angle::Vector4 position;
    angle::Vector3 direction;
...
struct TextureEnvironmentParameters
{
    ...
    TextureCombine combineRgb;
    TextureCombine combineAlpha;

    TextureSrc src0rgb;
    TextureSrc src0alpha;

    TextureSrc src1rgb;
    TextureSrc src1alpha;

    TextureSrc src2rgb;
    TextureSrc src2alpha;
