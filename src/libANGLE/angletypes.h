...
class BlendStateExt final
{
  ...
  public:
    ...
    struct StorageType final
    {
        ...
        static constexpr size_t kBits = std::is_same<ElementType, BlendFactorType>::value ? 8 : 4;
#endif
    ...
    using FactorStorage    = StorageType<BlendFactorType>;
    using EquationStorage  = StorageType<BlendEquationType>;
    ...
    void setBlendIndexed(const size_t index, const bool enabled);
