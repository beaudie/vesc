...
// itself).
//
// Some entry points pass a void pointer argument to UnlockedTailCall::run method intended to be
// consumed by tail call functions added by the backend, the rest of the entry points pass in a
// nullptr. This necessitates tail call functions to guard against unintentional nullptr access.
