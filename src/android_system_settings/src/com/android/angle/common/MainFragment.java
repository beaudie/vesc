...
public class MainFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (DEBUG)
        {
            Map<String, ?> preferences = PreferenceManager.getDefaultSharedPreferences(getActivity().getApplicationContext()).getAll();
        ...
        mShowAngleInUseSwitchPref.setOnPreferenceChangeListener(
                new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue)
                    {
                        if (DEBUG)
                        {
                            Log.v(TAG, "how angle in use switch: " + newValue.toString());
                        }
