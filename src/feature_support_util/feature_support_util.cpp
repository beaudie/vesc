...
// This function is part of the version-2 API:
ANGLE_EXPORT bool ANGLEGetSystemInfo(void **systemInfoHandle)
{
...
// This function is part of the version-2 API:
ANGLE_EXPORT bool ANGLEEvalRulesForApplication(void *rulesHandle,
                                               int rulesVersion,
                                               void *systemInfoHandle,
                                               const char *appName)
{
...
// This function is part of the version-2 API:
ANGLE_EXPORT void ANGLEFreeRulesHandle(void *rulesHandle)
{
    RuleList *rules = reinterpret_cast<RuleList *>(rulesHandle);
    delete rules;
}
...
// This function is part of the version-2 API:
ANGLE_EXPORT void ANGLEFreeSystemInfoHandle(void *systemInfoHandle)
{
    angle::SystemInfo *systemInfo = reinterpret_cast<angle::SystemInfo *>(systemInfoHandle);
    delete systemInfo;
}
