...
class DebugAnnotator : angle::NonCopyable
{
  public:
    ...
    virtual bool logMessage(int severity,
                            const char *function,
                            int line,
...
std::ostream &Fmt0x0NX(std::ostream &os, T value)
{
    os << "0x";
...
template <typename T>
std::ostream &Fmt0x04X(std::ostream &os, T value)
{
    return priv::Fmt0x0NX<4>(os, value);
}

template <typename T>
std::ostream &Fmt0x08X(std::ostream &os, T value)
{
    return priv::Fmt0x0NX<8>(os, value);
}
...
#define COMPACT_ANGLE_LOG_EX_EVENT(ClassName, ...) \
    ::gl::priv::ClassName(__FUNCTION__, __LINE__, ::gl::priv::LOG_EVENT, ##__VA_ARGS__)
#define COMPACT_ANGLE_LOG_EX_WARN(ClassName, ...) \
    ::gl::priv::ClassName(__FUNCTION__, __LINE__, ::gl::priv::LOG_WARN, ##__VA_ARGS__)
#define COMPACT_ANGLE_LOG_EX_ERR(ClassName, ...) \
    ::gl::priv::ClassName(__FUNCTION__, __LINE__, ::gl::priv::LOG_ERR, ##__VA_ARGS__)
...
#define ANGLE_LOG_IS_ON(severity) (::gl::priv::ShouldCreateLogMessage(::gl::priv::LOG_##severity))
