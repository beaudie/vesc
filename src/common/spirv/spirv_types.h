...
// IdResult, IdResultType, IdMemorySemantics and IdScope are all traslated as IdRef.  This makes the
// type verification weaker, but stops the API from becoming tediously verbose.
