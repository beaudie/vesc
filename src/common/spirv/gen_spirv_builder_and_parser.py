...
#ifndef COMMON_{file_name_capitalized}_AUTOGEN_H_
#define COMMON_{file_name_capitalized}_AUTOGEN_H_
...
#endif // COMMON_{file_name_capitalized}_AUTOGEN_H_
"""
...
builder_helper_functions = """uint32_t MakeLengthOp(size_t length, spv::Op op)
{{
        ...
        with (open(self.path_prefix + spirv_builder_file + '_autogen.h', 'w')) as f:
            f.write(
                header_template.format(
                    ...
                    data_source_name=spirv_grammar_file,
                    file_name=spirv_builder_file,
                    file_name_capitalized=spirv_builder_file.upper(),
                    verb='generate',
                    function_list=''.join(self.instruction_builder_prototypes)))
        ...
        with (open(self.path_prefix + spirv_parser_file + '_autogen.h', 'w')) as f:
            f.write(
                header_template.format(
                    ...
                    file_name_capitalized=spirv_parser_file.upper(),
                    verb='parse',
                    function_list=''.join(self.instruction_parser_prototypes)))
