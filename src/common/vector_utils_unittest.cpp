...
TEST(VectorUtilsTest, Comparison)
{
    ...
    ASSERT_EQ(Vector4(0.0, 0.0, 0.0, 0.0), Vector4(0.0, 0.0, 0.0, 0.0));
    ASSERT_NE(Vector4(1.0, 0.0, 0.0, 0.0), Vector4(0.0, 0.0, 0.0, 0.0));
    ASSERT_NE(Vector4(0.0, 1.0, 0.0, 0.0), Vector4(0.0, 0.0, 0.0, 0.0));
    ASSERT_NE(Vector4(0.0, 0.0, 1.0, 0.0), Vector4(0.0, 0.0, 0.0, 0.0));
    ASSERT_NE(Vector4(0.0, 0.0, 0.0, 1.0), Vector4(0.0, 0.0, 0.0, 0.0));
}
