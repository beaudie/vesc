...
//      list of objects that already exist without needing to encapsulate them in a container.
//  What this isn't -
...
{
  public:
    ListNode() { detachListNode(); }
    ListNode(const ListNode &other) { detachListNode(); }
    ...
    ANGLE_INLINE void detachListNode()
    {
