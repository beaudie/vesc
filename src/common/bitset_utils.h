...
class BitSetT final
{
  public:
    ...
    constexpr bool anyExcluding(ParamT pos) const;
    constexpr bool noneExcluding(ParamT pos) const;
...
template <size_t N, typename BitsT, typename ParamT>
constexpr bool BitSetT<N, BitsT, ParamT>::anyExcluding(ParamT pos) const
{
    return (mBits & ~Bit<BitsT>(pos)) != 0;
}

template <size_t N, typename BitsT, typename ParamT>
constexpr bool BitSetT<N, BitsT, ParamT>::noneExcluding(ParamT pos) const
{
    return (mBits & ~Bit<BitsT>(pos)) == 0;
}
