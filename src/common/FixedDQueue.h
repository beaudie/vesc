  ...
  public:
    ...
    class iterator
    {
      ...
      private:
        Storage &mData;
        size_type mIndex;
        friend class FixedDQueue<T, N, Storage>;
...
template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::reference FixedDQueue<T, N, Storage>::operator[](size_type pos)
{
    ASSERT(pos < mSize);
...
template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::const_reference FixedDQueue<T, N, Storage>::operator[](
    size_type pos) const
{
    ASSERT(pos < mSize);
    return mData[(pos + mFrontIndex) % N];
...
template <class T, size_t N, class Storage>
ANGLE_INLINE typename FixedDQueue<T, N, Storage>::reference FixedDQueue<T, N, Storage>::back()
{
    ASSERT(mSize > 0);
...
template <class T, size_t N, class Storage>
ANGLE_INLINE typename FixedDQueue<T, N, Storage>::const_reference FixedDQueue<T, N, Storage>::back()
    const
{
    ASSERT(mSize > 0);
    return mData[(mBackIndex - 1) % N];
...
template <class T, size_t N, class Storage>
void FixedDQueue<T, N, Storage>::clear()
{
...
template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::iterator FixedDQueue<T, N, Storage>::begin()
{
    return iterator(mData, mFrontIndex);
}

template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::const_iterator FixedDQueue<T, N, Storage>::begin() const
{
    return const_iterator(mData, mFrontIndex);
}

template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::iterator FixedDQueue<T, N, Storage>::end()
{
    return iterator(mData, mBackIndex);
}

template <class T, size_t N, class Storage>
typename FixedDQueue<T, N, Storage>::const_iterator FixedDQueue<T, N, Storage>::end() const
{
    return const_iterator(mData, mBackIndex);
}
}  // namespace angle
