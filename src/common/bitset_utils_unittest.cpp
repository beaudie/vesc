...
using BitSetLargeTypes = ::testing::Types<BitSetLarge<70>, BitSetLarge<130>, BitSetLarge<511>>;
...
template <typename T>
class BitSet128Test : public testing::Test
{
  protected:
    T mBitSet;
};

using BitSet128Types = ::testing::Types<BitSet128<50>, BitSet128<70>, BitSet128<120>>;
TYPED_TEST_SUITE(BitSet128Test, BitSet128Types);

TYPED_TEST(BitSet128Test, BasicTest)
{
    TypeParam &mBits = this->mBitSet;
