...
{
    DestT destLo = std::numeric_limits<DestT>::min();
    DestT destHi = std::numeric_limits<DestT>::max();
    SrcT srcLo = static_cast<SrcT>(destLo);
    SrcT srcHi = static_cast<SrcT>(destHi);
