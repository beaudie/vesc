...
template <typename T>
base::CheckedNumeric<T> CheckedRoundUp(const T value, const T alignment)
{
    base::CheckedNumeric<T> checkedValue(value);
    base::CheckedNumeric<T> checkedAlignment(alignment);
