...
inline DestT clampCast(SrcT value)
{
    ...
    long double destLo = static_cast<long double>(std::numeric_limits<DestT>::lowest());
    long double destHi = static_cast<long double>(std::numeric_limits<DestT>::max());
    long double srcLo  = static_cast<long double>(std::numeric_limits<SrcT>::lowest());
    long double srcHi  = static_cast<long double>(std::numeric_limits<SrcT>::max());
