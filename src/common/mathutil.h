...
{
    static DestT destLo = std::numeric_limits<DestT>::lowest();
    static SrcT srcLo   = static_cast<SrcT>(destLo);
...
{
    static DestT destHi = std::numeric_limits<DestT>::max();
    static SrcT srcHi   = static_cast<SrcT>(destHi);
