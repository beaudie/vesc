...
{
    uint8_t bits[4];
    bits[0]         = ToPackedUnorm8(f1);
    bits[1]         = ToPackedUnorm8(f2);
    bits[2]         = ToPackedUnorm8(f3);
    bits[3]         = ToPackedUnorm8(f4);
    uint32_t result = 0u;
    for (int i = 0; i < 4; ++i)
    {
        int shift = i * 8;
...
{
    int8_t bits[4];
    bits[0]         = ToPackedSnorm8(f1);
    bits[1]         = ToPackedSnorm8(f2);
    bits[2]         = ToPackedSnorm8(f3);
    bits[3]         = ToPackedSnorm8(f4);
    uint32_t result = 0u;
    for (int i = 0; i < 4; ++i)
    {
        int shift = i * 8;
