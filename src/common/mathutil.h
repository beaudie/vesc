...
inline unsigned int packSnorm2x16(float f1, float f2)
{
...
inline void unpackSnorm2x16(unsigned int u, float *f1, float *f2)
{
...
inline unsigned int packUnorm2x16(float f1, float f2)
{
...
inline void unpackUnorm2x16(unsigned int u, float *f1, float *f2)
{
...
inline unsigned int packHalf2x16(float f1, float f2)
{
...
inline void unpackHalf2x16(unsigned int u, float *f1, float *f2)
{
    uint16_t leastSignificantBits = static_cast<uint16_t>(u & 0xFFFF);
    uint16_t mostSignificantBits = static_cast<uint16_t>(u >> 16);
