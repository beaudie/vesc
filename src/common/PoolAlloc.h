...
#if defined(NDEBUG)
#    define ANGLE_POOL_ALLOC_GUARD_BLOCKS 1  // define to enable guard block sanity checking
#endif
  ...
  private:
    ...
    struct Header
    {
        Header(Header *nextPage, size_t pageCount)
            : nextPage(nextPage),
              pageCount(pageCount)
#    if ANGLE_POOL_ALLOC_GUARD_BLOCKS
              ,
              lastAllocation(0)
#    endif
        {}
...
#    endif
        // This is optimized entirely away if ANGLE_POOL_ALLOC_GUARD_BLOCKS is not defined
