...
ANGLE_INLINE void cofactor_transposed(const T4x4 &m, T4x4 &coft)
{
    coft(0, 0) = m(1, 1) * m(2, 2) * m(3, 3) + m(2, 1) * m(3, 2) * m(1, 3) +
                 m(3, 1) * m(1, 2) * m(2, 3) - m(1, 1) * m(3, 2) * m(2, 3) -
                 m(2, 1) * m(1, 2) * m(3, 3) - m(3, 1) * m(2, 2) * m(1, 3);
    coft(1, 0) =
        -(m(1, 0) * m(2, 2) * m(3, 3) + m(2, 0) * m(3, 2) * m(1, 3) + m(3, 0) * m(1, 2) * m(2, 3) -
          m(1, 0) * m(3, 2) * m(2, 3) - m(2, 0) * m(1, 2) * m(3, 3) - m(3, 0) * m(2, 2) * m(1, 3));
    coft(2, 0) = m(1, 0) * m(2, 1) * m(3, 3) + m(2, 0) * m(3, 1) * m(1, 3) +
                 m(3, 0) * m(1, 1) * m(2, 3) - m(1, 0) * m(3, 1) * m(2, 3) -
                 m(2, 0) * m(1, 1) * m(3, 3) - m(3, 0) * m(2, 1) * m(1, 3);
    coft(3, 0) =
