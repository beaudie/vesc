...
class VectorBase
{
  public:
    ...
    static void Store(const FullVector &source, Type *destination);
    ...
    FullVector operator-() const;
    FullVector operator+(const FullVector &other) const;
    FullVector operator-(const FullVector &other) const;
    FullVector operator*(const FullVector &other) const;
    FullVector operator/(const FullVector &other) const;
    FullVector operator*(Type other) const;
    FullVector operator/(Type other) const;
    friend FullVector operator*(Type a, const FullVector &b) { return b * a; }
    ...
    bool operator==(const FullVector &other) const;
    bool operator!=(const FullVector &other) const;

    // Other arithmetic operations
    Type length() const;
    Type lengthSquared() const;
    Type dot(const FullVector &other) const;
  ...
  protected:
    ...
    void initWithList(Type arg1, const Args &... args);
...
template <size_t Dimension, typename Type>
template <size_t CurrentIndex, typename... Args>
void VectorBase<Dimension, Type>::initWithList(Type arg1, const Args &... args)
{
