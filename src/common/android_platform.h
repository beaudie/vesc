...
#        if __NDK_MAJOR__ == 15
#            warning "jasonjason __NDK_MAJOR__ == 15"
#        elif __NDK_MAJOR__ == 16
#            warning "jasonjason __NDK_MAJOR__ == 16"
#        elif __NDK_MAJOR__ == 17
#            warning "jasonjason __NDK_MAJOR__ == 17"
#        elif __NDK_MAJOR__ == 18
#            warning "jasonjason __NDK_MAJOR__ == 18"
#        elif __NDK_MAJOR__ == 19
#            warning "jasonjason __NDK_MAJOR__ == 19"
#        elif __NDK_MAJOR__ == 20
#            warning "jasonjason __NDK_MAJOR__ == 20"
#        elif __NDK_MAJOR__ == 21
#            warning "jasonjason __NDK_MAJOR__ == 21"
#        elif __NDK_MAJOR__ == 22
#            warning "jasonjason __NDK_MAJOR__ == 22"
#        elif __NDK_MAJOR__ == 23
#            warning "jasonjason __NDK_MAJOR__ == 23"
#        elif __NDK_MAJOR__ == 24
#            warning "jasonjason __NDK_MAJOR__ == 24"
#        elif __NDK_MAJOR__ == 25
#            warning "jasonjason __NDK_MAJOR__ == 25"
#        endif
#    else
...
#        warning "jasonjason ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL defined"
#    else
#        define ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL __ANDROID_API__
#        warning "jasonjason ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL defined"
#    endif
...
#        warning "jasonjason including hardware_buffer.h"
#    else
#        warning "jasonjason not including hardware_buffer.h"
#    endif
