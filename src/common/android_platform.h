...
#        define ANGLE_AHARDWAREBUFFER_NDK_BUILD
#        define ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL __NDK_MAJOR__
#    else
#        define ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD
#        define ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL __ANDROID_API__
#    endif

#    if (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD) && ANGLE_AHARDWAREBUFFER_BUILD_LEVEL >= 15) || defined(ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD) 
