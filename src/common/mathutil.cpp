...
void convert999E5toRGBFloats(unsigned int input, float *red, float *green, float *blue)
{
    ...
    *red =
        inputData->R * pow(2.0f, (float)inputData->E - g_sharedexp_bias - g_sharedexp_mantissabits);
    *green =
        inputData->G * pow(2.0f, (float)inputData->E - g_sharedexp_bias - g_sharedexp_mantissabits);
    *blue =
        inputData->B * pow(2.0f, (float)inputData->E - g_sharedexp_bias - g_sharedexp_mantissabits);
}
