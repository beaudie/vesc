...
size_t GetIndex(GLenum uniformType)
{{
    switch (uniformType)
    {{
...
{{
    return static_cast<UniformTypeIndex>(GetIndex(uniformType));
}}
...
const UniformTypeInfo &GetUniformTypeInfoFromIndex(UniformTypeIndex typeIndex)
{{
    size_t index = static_cast<size_t>(typeIndex);
