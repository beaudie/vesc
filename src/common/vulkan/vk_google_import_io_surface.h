...
#ifndef CUSTOM_VK_GOOGLE_IMPORT_IO_SURFACE_H_
#define CUSTOM_VK_GOOGLE_IMPORT_IO_SURFACE_H_
...
#    error \
        "VK_GOOGLE_import_io_surface is already defined in the Vulkan headers, you can delete this file"
#endif

static constexpr VkStructureType VK_STRUCTURE_TYPE_IMPORT_IO_SURFACE_GOOGLE =
    static_cast<VkStructureType>(1000178099);
...
#endif  // CUSTOM_VK_GOOGLE_IMPORT_IO_SURFACE_H_
