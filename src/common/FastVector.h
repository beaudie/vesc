...
class FastVector final
{
  public:
    ...
    void resizeAndCopyData(const uint8_t *data, size_type count);
...
template <class T, size_t N, class Storage>
void FastVector<T, N, Storage>::resizeAndCopyData(const uint8_t *data, size_type count)
{
...
class FastMap final
{
  public:
    ...
    void resizeAndCopyData(const uint8_t *data, size_type count)
    {
        mData.resizeAndCopyData(data, count);
    }
