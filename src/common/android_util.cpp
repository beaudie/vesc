...
enum {
    ...
    (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL) && \
...
#if !defined(ANGLE_PLATFORM_ANDROID) || \
    (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL < 16) || \
    (defined(ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL < 28)
    /**
     * Corresponding formats:
...
#if !defined(ANGLE_PLATFORM_ANDROID) || \
    (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL < 17) || \
    (defined(ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL < 28)
    /**
     * Corresponding formats:
...
#if !defined(ANGLE_PLATFORM_ANDROID) || \
    (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL < 20) || \
    (defined(ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL < 29)
    /**
     * YUV 420 888 format.
    ...
    (defined(ANGLE_AHARDWAREBUFFER_NDK_BUILD_LEVEL)) || \
    (defined(ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL) && \
     ANGLE_AHARDWAREBUFFER_PLATFORM_BUILD_LEVEL < 33)
    /**
     * Corresponding formats:
