...
namespace
{
class FuchsiaPageFaultHandler : public PageFaultHandler
{
  public:
    FuchsiaPageFaultHandler(PageFaultCallback callback) : PageFaultHandler(callback) {}
    ~FuchsiaPageFaultHandler() override {}

    bool enable() override;
    bool disable() override;
};

bool FuchsiaPageFaultHandler::disable()
{
    UNIMPLEMENTED();
    return true;
}

bool FuchsiaPageFaultHandler::enable()
{
    UNIMPLEMENTED();
    return true;
}
...
{
    return new FuchsiaPageFaultHandler(callback);
}
#else
namespace
{
