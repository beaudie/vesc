...
static void output(bool traceInDebugOnly, gl::MessageType messageType, DebugTraceOutputType outputType,
...
void trace(bool traceInDebugOnly, gl::MessageType messageType, const char *format, ...)
{
    va_list vararg;
...
ScopedPerfEventHelper::ScopedPerfEventHelper(const char* format, ...)
{
    ...
    va_start(vararg, format);
#if defined(ANGLE_ENABLE_DEBUG_ANNOTATIONS)
    output(true, gl::MESSAGE_EVENT, DebugTraceOutputTypeBeginEvent, format, vararg);
#else
    output(true, gl::MESSAGE_EVENT, DebugTraceOutputTypeNone, format, vararg);
