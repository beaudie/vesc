...
class DebugAnnotationWrapper
{
  public:
    ...
    virtual void beginEvent(std::wstring eventName) = 0;
    virtual void endEvent() = 0;
    virtual void setMarker(std::wstring markerName) = 0;
...
{
  public:
    void beginEvent(std::wstring eventName)
    {
    ...
    void setMarker(std::wstring markerName)
    {
...
class D3D11DebugAnnotationWrapper : public DebugAnnotationWrapper
{
  public:
    ...
    virtual void beginEvent(std::wstring eventName)
    {
        initializeDevice();
    ...
    virtual void setMarker(std::wstring markerName)
    {
        initializeDevice();
