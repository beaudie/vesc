...
#include <dxgidebug.h>
#endif // _DEBUG && ANGLE_ENABLE_D3D11 && ANGLE_ENABLE_WINDOWS_STORE
...
void UninitializeDebugAnnotations()
{
    ...
    {
        delete g_DebugAnnotationWrapper;
        g_DebugAnnotationWrapper = NULL;
    }
}
    ...
    if (perfActive())
    {
        ...
        switch (outputType)
        {
            ...
            case DebugTraceOutputTypeBeginEvent:
                g_DebugAnnotationWrapper->beginEvent(formattedWideMessage.c_str());
                break;
            case DebugTraceOutputTypeSetMarker:
                g_DebugAnnotationWrapper->setMarker(formattedWideMessage.c_str());
                break;
        }
    }
#endif // ANGLE_ENABLE_DEBUG_ANNOTATIONS
...
#if defined(ANGLE_ENABLE_DEBUG_TRACE_TO_DEBUGGER) 	63
	OutputDebugStringA(formattedMessage.c_str());	64
