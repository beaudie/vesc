...
class RingBufferCheckPoint final
{
  public:
    void reset() { *this = {}; }
...
class RingBufferAllocator final : angle::NonCopyable
{
  public:
    ...
    RingBufferCheckPoint getReleaseCheckPoint() const;
    void release(const RingBufferCheckPoint &checkPoint);
...
class SharedRingBufferCheckPoint final : angle::NonCopyable
{
  public:
    void releaseAndUpdate(RingBufferCheckPoint *newValue);

  private:
    friend class SharedRingBufferAllocator;
    RingBufferCheckPoint pop();
    std::mutex mMutex;
    RingBufferCheckPoint mValue;
...
class SharedRingBufferAllocator final : angle::NonCopyable
{
  public:
    ...
    SharedRingBufferCheckPoint *acquireSharedCP();
    void releaseToSharedCP();

  private:
    RingBufferAllocator mAllocator;
    SharedRingBufferCheckPoint *mSharedCP = nullptr;
};
