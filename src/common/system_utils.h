...
// Returns false if memory address is outside of handling range
// to fall back to the default page handler.
typedef std::function<bool(uintptr_t)> PageFaultCallback;
