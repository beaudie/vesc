                    ...
                    [
                        {
                            ...
                            [
                                ...
                                '<(vulkan_layers_path)/lvl_genvk.py',
                                '<(vulkan_layers_path)/reg.py',
                                '<(vulkan_layers_path)/unique_objects_generator.py',
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/lvl_genvk.py', '-o', '<(angle_gen_path)/vulkan',
                                '-registry', '<(vulkan_layers_path)/vk.xml', 'unique_objects_wrappers.h',
                            ],
                        },
                    ],
                },
                    ...
                    [
                        {
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/lvl_genvk.py', '-o',
