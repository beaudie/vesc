...

{
    'variables':
    {
        'glslang_path': '../../third_party/glslang/src',
        'spirv_headers_path': '../../third_party/spirv-headers/src',
        'spirv_tools_path': '../../third_party/spirv-tools/src',
        ...
        [
            ...
            '<(spirv_tools_path)/source/instruction.cpp',
            ...
            '<(spirv_tools_path)/source/validate_ssa.cpp',
                    ...
                    [
                        {
                            ...
                            [
                                ...
                                'python', '<(vulkan_layers_path)/vk-generate.py', 'Win32',
                    ...
                    [
                        {
                            ...
                            [
                                # TODO(jmadill): Select correct display server for Linux/Android/etc.
                                'python', '<(vulkan_layers_path)/vk-layer-generate.py', 'Win32', 'unique_objects',
                                '<(vulkan_layers_path)/include/vulkan/vulkan.h', '<(angle_gen_path)/vulkan/unique_objects.cpp',
                            ],
                        },
                    ],
                },
                    ...
                    [
                        {
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/genvk.py', '-outdir',
                                '<(angle_gen_path)/vulkan', '-registry', '<(vulkan_layers_path)/vk.xml',
                                'thread_check.h',
                            ],
                        },
                    ],
                    ...
                    [
                        {
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/genvk.py', '-outdir', '<(angle_gen_path)/vulkan',
                                '-registry', '<(vulkan_layers_path)/vk.xml', 'parameter_validation.h',
                            ],
                        },
                    ],
                },
