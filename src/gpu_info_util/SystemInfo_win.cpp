...
bool GetSystemInfo(SystemInfo *info)
{
    ...
    // Call FindGraphicsGPUto populate graphicsGPUIndex, isOptimus, and isAMDSwitchable.
    FindGraphicsGPU(info);

    // Override graphcsGPUIndex. The first index returned by EnumAdapters is the graphics GPU. We
    // can override the heuristic to find the graphics GPU
    info->graphicsGPUIndex = 0;
