...
GLenum GL_APIENTRY ClientWaitSync(GLsync sync, GLbitfield flags, GLuint64 timeout)
{
    EVENT("(GLsync sync = 0x%016" PRIxPTR ", GLbitfield flags = %s, GLuint64 timeout = %llu)",
          (uintptr_t)sync, GLbitfieldToString(gl::GLenumGroup::SyncObjectMask, flags).c_str(),
                                        ...
                                        GLint basevertex)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::DrawElementsType, type), (uintptr_t)indices, basevertex);
                                             ...
                                             GLint basevertex)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::PrimitiveType, mode), start, end, count,
        GLenumToString(gl::GLenumGroup::DrawElementsType, type), (uintptr_t)indices, basevertex);
...
GLsync GL_APIENTRY FenceSync(GLenum condition, GLbitfield flags)
{
    EVENT("(GLenum condition = %s, GLbitfield flags = %s)",
          GLenumToString(gl::GLenumGroup::SyncCondition, condition),
          GLbitfieldToString(gl::GLenumGroup::DefaultGroup, flags).c_str());
...
void GL_APIENTRY FramebufferTexture(GLenum target, GLenum attachment, GLuint texture, GLint level)
{
    EVENT("(GLenum target = %s, GLenum attachment = %s, GLuint texture = %u, GLint level = %d)",
          ...
          GLenumToString(gl::GLenumGroup::FramebufferAttachment, attachment), texture, level);
...
void GL_APIENTRY GetBufferParameteri64v(GLenum target, GLenum pname, GLint64 *params)
{
    EVENT("(GLenum target = %s, GLenum pname = %s, GLint64 *params = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::BufferTargetARB, target),
          GLenumToString(gl::GLenumGroup::DefaultGroup, pname), (uintptr_t)params);
...
void GL_APIENTRY GetInteger64v(GLenum pname, GLint64 *data)
{
    EVENT("(GLenum pname = %s, GLint64 *data = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::GetPName, pname), (uintptr_t)data);
...
void GL_APIENTRY GetMultisamplefv(GLenum pname, GLuint index, GLfloat *val)
{
    EVENT("(GLenum pname = %s, GLuint index = %u, GLfloat *val = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::DefaultGroup, pname), index, (uintptr_t)val);
...
GetSynciv(GLsync sync, GLenum pname, GLsizei bufSize, GLsizei *length, GLint *values)
{
    EVENT("(GLsync sync = 0x%016" PRIxPTR
          ...
          (uintptr_t)sync, GLenumToString(gl::GLenumGroup::SyncParameterName, pname), bufSize,
                                             ...
                                             const GLint *basevertex)
{
    EVENT("(GLenum mode = %s, const GLsizei *count = 0x%016" PRIxPTR
          ...
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode), (uintptr_t)count,
          GLenumToString(gl::GLenumGroup::DrawElementsType, type), (uintptr_t)indices, drawcount,
...
{
    EVENT("(GLenum mode = %s)", GLenumToString(gl::GLenumGroup::VertexProvokingMode, mode));
...
void GL_APIENTRY SampleMaski(GLuint maskNumber, GLbitfield mask)
{
    EVENT("(GLuint maskNumber = %u, GLbitfield mask = %s)", maskNumber,
          GLbitfieldToString(gl::GLenumGroup::DefaultGroup, mask).c_str());
...
{
    EVENT("(GLsync sync = 0x%016" PRIxPTR ", GLbitfield flags = %s, GLuint64 timeout = %llu)",
          (uintptr_t)sync, GLbitfieldToString(gl::GLenumGroup::DefaultGroup, flags).c_str(),
          static_cast<unsigned long long>(timeout));
