...
{
    EVENT(
        "(GLenum target = %s, GLenum internalformat = %s, GLenum format = %s, GLenum type = %s, "
        "const void *data = 0x%016" PRIxPTR ")",
        GLenumToString(gl::GLenumGroup::BufferStorageTarget, target),
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat),
        GLenumToString(gl::GLenumGroup::PixelFormat, format),
        GLenumToString(gl::GLenumGroup::PixelType, type), (uintptr_t)data);
...
{
    EVENT(
        "(GLenum target = %s, GLenum internalformat = %s, GLintptr offset = %llu, GLsizeiptr size "
        "= %llu, GLenum format = %s, GLenum type = %s, const void *data = 0x%016" PRIxPTR ")",
        GLenumToString(gl::GLenumGroup::DefaultGroup, target),
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat),
...
{
    EVENT(
        "(GLuint srcName = %u, GLenum srcTarget = %s, GLint srcLevel = %d, GLint srcX = %d, GLint "
        "srcY = %d, GLint srcZ = %d, GLuint dstName = %u, GLenum dstTarget = %s, GLint dstLevel = "
        "%d, GLint dstX = %d, GLint dstY = %d, GLint dstZ = %d, GLsizei srcWidth = %d, GLsizei "
        "srcHeight = %d, GLsizei srcDepth = %d)",
        srcName, GLenumToString(gl::GLenumGroup::CopyBufferSubDataTarget, srcTarget), srcLevel,
        srcX, srcY, srcZ, dstName,
        GLenumToString(gl::GLenumGroup::CopyBufferSubDataTarget, dstTarget), dstLevel, dstX, dstY,
                                     ...
                                     GLboolean enabled)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::DebugSource, source),
        GLenumToString(gl::GLenumGroup::DebugType, type),
        GLenumToString(gl::GLenumGroup::DebugSeverity, severity), count, (uintptr_t)ids,
        GLenumToString(gl::GLenumGroup::Boolean, enabled));
                                    ...
                                    const GLchar *buf)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::DebugSource, source),
        GLenumToString(gl::GLenumGroup::DebugType, type), id,
        GLenumToString(gl::GLenumGroup::DebugSeverity, severity), length, (uintptr_t)buf);
...
void GL_APIENTRY FramebufferParameteri(GLenum target, GLenum pname, GLint param)
{
    EVENT("(GLenum target = %s, GLenum pname = %s, GLint param = %d)",
          GLenumToString(gl::GLenumGroup::FramebufferTarget, target),
          GLenumToString(gl::GLenumGroup::FramebufferParameterName, pname), param);
...
void GL_APIENTRY GetFramebufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
    EVENT("(GLenum target = %s, GLenum pname = %s, GLint *params = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::FramebufferTarget, target),
          GLenumToString(gl::GLenumGroup::FramebufferAttachmentParameterName, pname),
          (uintptr_t)params);
                                       ...
                                       GLint64 *params)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat),
        GLenumToString(gl::GLenumGroup::InternalFormatPName, pname), bufSize, (uintptr_t)params);
...
GetObjectLabel(GLenum identifier, GLuint name, GLsizei bufSize, GLsizei *length, GLchar *label)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::DefaultGroup, identifier), name, bufSize, (uintptr_t)length,
        (uintptr_t)label);
                                       ...
                                       GLint *params)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        program, GLenumToString(gl::GLenumGroup::ProgramInterface, programInterface),
        GLenumToString(gl::GLenumGroup::ProgramInterfacePName, pname), (uintptr_t)params);
                                        ...
                                        GLchar *name)
{
    EVENT(
        ...
        program, GLenumToString(gl::GLenumGroup::ProgramInterface, programInterface), index,
                                       ...
                                       const GLenum *attachments)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        GLenumToString(gl::GLenumGroup::FramebufferTarget, target), numAttachments,
                                          ...
                                          GLsizei height)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::DefaultGroup, target), numAttachments,
                                         ...
                                         GLsizei stride)
{
    EVENT("(GLenum mode = %s, const void *indirect = 0x%016" PRIxPTR
          ...
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode), (uintptr_t)indirect, drawcount,
          stride);
                                           ...
                                           GLsizei stride)
{
    EVENT("(GLenum mode = %s, GLenum type = %s, const void *indirect = 0x%016" PRIxPTR
          ", GLsizei drawcount = %d, GLsizei stride = %d)",
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode),
          GLenumToString(gl::GLenumGroup::DrawElementsType, type), (uintptr_t)indirect, drawcount,
          stride);
...
void GL_APIENTRY ObjectLabel(GLenum identifier, GLuint name, GLsizei length, const GLchar *label)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        GLenumToString(gl::GLenumGroup::ObjectIdentifier, identifier), name, length,
        (uintptr_t)label);
...
void GL_APIENTRY PushDebugGroup(GLenum source, GLuint id, GLsizei length, const GLchar *message)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        GLenumToString(gl::GLenumGroup::DebugSource, source), id, length, (uintptr_t)message);
...
{
    EVENT(
        "(GLenum target = %s, GLenum internalformat = %s, GLuint buffer = %u, GLintptr offset = "
                                         ...
                                         GLboolean fixedsamplelocations)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::TextureTarget, target), samples,
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat), width, height,
        GLenumToString(gl::GLenumGroup::Boolean, fixedsamplelocations));
                                         ...
                                         GLboolean fixedsamplelocations)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::TextureTarget, target), samples,
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat), width, height, depth,
        GLenumToString(gl::GLenumGroup::Boolean, fixedsamplelocations));
...
{
    EVENT(
        "(GLuint texture = %u, GLenum target = %s, GLuint origtexture = %u, GLenum internalformat "
        "= %s, GLuint minlevel = %u, GLuint numlevels = %u, GLuint minlayer = %u, GLuint numlayers "
        "= %u)",
        texture, GLenumToString(gl::GLenumGroup::TextureTarget, target), origtexture,
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat), minlevel, numlevels,
        minlayer, numlayers);
                                    ...
                                    GLuint relativeoffset)
{
    EVENT(
        ...
        attribindex, size, GLenumToString(gl::GLenumGroup::DefaultGroup, type),
        GLenumToString(gl::GLenumGroup::Boolean, normalized), relativeoffset);
                                     ...
                                     GLuint relativeoffset)
{
    EVENT(
        ...
        attribindex, size, GLenumToString(gl::GLenumGroup::DefaultGroup, type), relativeoffset);
                                     ...
                                     GLuint relativeoffset)
{
    EVENT(
        "(GLuint attribindex = %u, GLint size = %d, GLenum type = %s, GLuint relativeoffset = %u)",
        attribindex, size, GLenumToString(gl::GLenumGroup::VertexAttribType, type), relativeoffset);
