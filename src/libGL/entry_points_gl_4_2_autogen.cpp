                                                   ...
                                                   GLuint baseinstance)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::PrimitiveType, type), (uintptr_t)indices, instancecount,
        baseinstance);
...
void GL_APIENTRY DrawTransformFeedbackInstanced(GLenum mode, GLuint id, GLsizei instancecount)
{
    EVENT("(GLenum mode = %s, GLuint id = %u, GLsizei instancecount = %d)",
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode), id, instancecount);
                                                      ...
                                                      GLsizei instancecount)
{
    EVENT("(GLenum mode = %s, GLuint id = %u, GLuint stream = %u, GLsizei instancecount = %d)",
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode), id, stream, instancecount);
                                                ...
                                                GLint *params)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        program, bufferIndex, GLenumToString(gl::GLenumGroup::AtomicCounterBufferPName, pname),
        (uintptr_t)params);
