                                      ...
                                      const void *data)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::InternalFormat, internalformat), width, border, imageSize,
        (uintptr_t)data);
                                         ...
                                         const void *data)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::TextureTarget, target), level, xoffset, width,
        GLenumToString(gl::GLenumGroup::PixelFormat, format), imageSize, (uintptr_t)data);
...
void GL_APIENTRY GetCompressedTexImage(GLenum target, GLint level, void *img)
{
    EVENT("(GLenum target = %s, GLint level = %d, void *img = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::TextureTarget, target), level, (uintptr_t)img);
...
{
    EVENT("(GLenum target = %s, GLdouble s = %f)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s);
...
void GL_APIENTRY MultiTexCoord1dv(GLenum target, const GLdouble *v)
{
    EVENT("(GLenum target = %s, const GLdouble *v = 0x%016" PRIxPTR ")",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), (uintptr_t)v);
...
{
    EVENT("(GLenum target = %s, GLfloat s = %f)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s);
...
{
    EVENT("(GLenum target = %s, GLint s = %d)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s);
...
{
    EVENT("(GLenum target = %s, GLshort s = %d)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s);
...
void GL_APIENTRY MultiTexCoord2d(GLenum target, GLdouble s, GLdouble t)
{
    EVENT("(GLenum target = %s, GLdouble s = %f, GLdouble t = %f)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s, t);
...
void GL_APIENTRY MultiTexCoord3d(GLenum target, GLdouble s, GLdouble t, GLdouble r)
{
    EVENT("(GLenum target = %s, GLdouble s = %f, GLdouble t = %f, GLdouble r = %f)",
          GLenumToString(gl::GLenumGroup::TextureUnit, target), s, t, r);
