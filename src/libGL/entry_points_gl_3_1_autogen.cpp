                                   ...
                                   GLsizeiptr size)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::CopyBufferSubDataTarget, readTarget),
        GLenumToString(gl::GLenumGroup::CopyBufferSubDataTarget, writeTarget),
...
void GL_APIENTRY DrawArraysInstanced(GLenum mode, GLint first, GLsizei count, GLsizei instancecount)
{
    EVENT("(GLenum mode = %s, GLint first = %d, GLsizei count = %d, GLsizei instancecount = %d)",
          GLenumToString(gl::GLenumGroup::PrimitiveType, mode), first, count, instancecount);
                                       ...
                                       GLsizei instancecount)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::PrimitiveType, mode), count,
        GLenumToString(gl::GLenumGroup::DrawElementsType, type), (uintptr_t)indices, instancecount);
                                         ...
                                         GLint *params)
{
    EVENT(
        ...
        "0x%016" PRIxPTR ")",
        program, uniformBlockIndex, GLenumToString(gl::GLenumGroup::UniformBlockPName, pname),
        (uintptr_t)params);
                                     ...
                                     GLint *params)
{
    EVENT(
        ...
        GLenumToString(gl::GLenumGroup::UniformPName, pname), (uintptr_t)params);
...
void GL_APIENTRY TexBuffer(GLenum target, GLenum internalformat, GLuint buffer)
{
    EVENT("(GLenum target = %s, GLenum internalformat = %s, GLuint buffer = %u)",
          GLenumToString(gl::GLenumGroup::TextureTarget, target),
          GLenumToString(gl::GLenumGroup::InternalFormat, internalformat), buffer);
