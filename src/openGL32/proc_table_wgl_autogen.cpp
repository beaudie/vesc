...
namespace wgl
{
ProcEntry g_procTable[] = {{"ChoosePixelFormat", P(ChoosePixelFormat)},
                           {"DescribePixelFormat", P(DescribePixelFormat)},
                           {"GetEnhMetaFilePixelFormat", P(GetEnhMetaFilePixelFormat)},
                           {"GetPixelFormat", P(GetPixelFormat)},
                           {"SetPixelFormat", P(SetPixelFormat)},
                           {"SwapBuffers", P(SwapBuffers)},
                           {"glAccum", P(gl::Accum)},
