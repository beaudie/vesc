...
// WGL 1.0
int GL_APIENTRY ChoosePixelFormat(HDC hDc, const PIXELFORMATDESCRIPTOR *pPfd)
{
    UNIMPLEMENTED();
    return 0;
}

int GL_APIENTRY DescribePixelFormat(HDC hdc, int ipfd, UINT cjpfd, PIXELFORMATDESCRIPTOR *ppfd)
{
    UNIMPLEMENTED();
    return 0;
}

UINT GL_APIENTRY GetEnhMetaFilePixelFormat(HENHMETAFILE hemf,
                                           UINT cbBuffer,
...
int GL_APIENTRY GetPixelFormat(HDC hdc)
{
    UNIMPLEMENTED();
    return 0;
}

BOOL GL_APIENTRY SetPixelFormat(HDC hdc, int ipfd, const PIXELFORMATDESCRIPTOR *ppfd)
{
    UNIMPLEMENTED();
    return FALSE;
}

BOOL GL_APIENTRY SwapBuffers(HDC hdc)
{
    UNIMPLEMENTED();
    return FALSE;
}
