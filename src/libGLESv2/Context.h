...
class Context
{
  ...
  private:
    ...
    void applyTextures(SamplerType shaderType, const std::vector<Texture*>& textures,
                       const std::vector<GLenum>& textureTypes, const std::vector<SamplerState>& samplers,
    ...
    void generateSwizzles(const std::vector<Texture*>& textures);
    void getCurrentTexturesAndSamplerStates(ProgramBinary *programBinary, SamplerType type, std::vector<Texture*> *outTextures,
                                            std::vector<GLenum> *outTextureTypes, std::vector<SamplerState> *outSamplers);
