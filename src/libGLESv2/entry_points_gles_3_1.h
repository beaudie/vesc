...
// MemoryBarrier has been renamed to MemoryBarrierGL since there is an MSVC macro with the same name
ANGLE_EXPORT void GL_APIENTRY MemoryBarrierGL(GLbitfield barriers);
