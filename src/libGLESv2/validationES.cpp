                                           ...
                                           bool angleExtension)
{
    ...
    GLuint handle = context->getState().getRenderbufferHandle();
    if (handle == 0)
    {
        return gl::error(GL_INVALID_OPERATION, false);
    }
                                               ...
                                               GLenum renderbuffertarget, GLuint renderbuffer)
{
    ...
    GLuint framebufferHandle = context->getState().getTargetFramebufferHandle(target);
                                       ...
                                       GLenum filter, bool fromAngleExtension)
{
    ...
    if (context->getState().getReadFramebufferHandle() == context->getState().getDrawFramebufferHandle())
    {
        if (fromAngleExtension)
        {
                                  ...
                                  GLenum format, GLenum type, GLsizei *bufSize, GLvoid *pixels)
{
    ...
    if (context->getState().getReadFramebufferHandle() != 0 && framebuffer->getSamples() != 0)
    {
        return gl::error(GL_INVALID_OPERATION, false);
    }
