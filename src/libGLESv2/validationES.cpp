...
static bool ValidateDrawBase(Context *context, GLenum mode, GLsizei count)
{
    switch (mode)
    {
      case GL_POINTS:
...
bool ValidateDrawElements(Context *context, GLenum mode, GLsizei count, GLenum type, const GLvoid* indices)
{
    switch (type)
    {
