                                                       ...
                                                       const EGLAttrib *attrib_list)
{
    ...
    return CreatePlatformPixmapSurface(thread, dpyPacked, configPacked, native_pixmapPacked,
                                       attrib_listPacked);
}
                                                       ...
                                                       const EGLAttrib *attrib_list)
{
    ...
    return CreatePlatformWindowSurface(thread, dpyPacked, configPacked, native_windowPacked,
                                       attrib_listPacked);
}
