                                        ...
                                        EGLint *num_config)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ChooseConfig, thread, dpyPacked);
                                       ...
                                       EGLNativePixmapType target)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CopyBuffers, thread, dpyPacked);
                                         ...
                                         const EGLint *attrib_list)
{
    ...
    EGLContext returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateContext, thread, dpyPacked, share_contextPacked);
                                                ...
                                                const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePbufferSurface, thread, dpyPacked);
                                               ...
                                               const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePixmapSurface, thread, dpyPacked);
                                               ...
                                               const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateWindowSurface, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroyContext(EGLDisplay dpy, EGLContext ctx)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroyContext, thread, dpyPacked, ctxPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroySurface(EGLDisplay dpy, EGLSurface surface)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroySurface, thread, dpyPacked);
                                           ...
                                           EGLint *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetConfigAttrib, thread, dpyPacked, attribute);
                                      ...
                                      EGLint *num_config)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetConfigs, thread, dpyPacked);
...
EGLDisplay EGLAPIENTRY EGL_GetCurrentDisplay()
{
    ...
    EGLDisplay returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetCurrentDisplay, thread);
...
EGLSurface EGLAPIENTRY EGL_GetCurrentSurface(EGLint readdraw)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetCurrentSurface, thread);
...
EGLDisplay EGLAPIENTRY EGL_GetDisplay(EGLNativeDisplayType display_id)
{
    ...
    EGLDisplay returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetDisplay, thread);
...
EGLint EGLAPIENTRY EGL_GetError()
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetError, thread);
...
__eglMustCastToProperFunctionPointerType EGLAPIENTRY EGL_GetProcAddress(const char *procname)
{
    ...
    __eglMustCastToProperFunctionPointerType returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetProcAddress, thread);
...
EGLBoolean EGLAPIENTRY EGL_Initialize(EGLDisplay dpy, EGLint *major, EGLint *minor)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(Initialize, thread, dpyPacked);
                                       ...
                                       EGLContext ctx)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(MakeCurrent, thread, dpyPacked, ctxPacked);
                                        ...
                                        EGLint *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryContext, thread, dpyPacked, ctxPacked, attribute);
...
const char *EGLAPIENTRY EGL_QueryString(EGLDisplay dpy, EGLint name)
{
    ...
    const char *returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryString, thread, dpyPacked);
                                        ...
                                        EGLint *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QuerySurface, thread, dpyPacked, attribute);
...
EGLBoolean EGLAPIENTRY EGL_SwapBuffers(EGLDisplay dpy, EGLSurface surface)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SwapBuffers, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_Terminate(EGLDisplay dpy)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(Terminate, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_WaitGL()
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitGL, thread);
...
EGLBoolean EGLAPIENTRY EGL_WaitNative(EGLint engine)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitNative, thread);
...
EGLBoolean EGLAPIENTRY EGL_BindTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(BindTexImage, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_ReleaseTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ReleaseTexImage, thread, dpyPacked);
                                         ...
                                         EGLint value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SurfaceAttrib, thread, dpyPacked, attribute);
...
EGLBoolean EGLAPIENTRY EGL_SwapInterval(EGLDisplay dpy, EGLint interval)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SwapInterval, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_BindAPI(EGLenum api)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(BindAPI, thread);
                                                         ...
                                                         const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePbufferFromClientBuffer, thread, dpyPacked);
...
EGLenum EGLAPIENTRY EGL_QueryAPI()
{
    ...
    EGLenum returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryAPI, thread);
...
EGLBoolean EGLAPIENTRY EGL_ReleaseThread()
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ReleaseThread, thread);
...
EGLBoolean EGLAPIENTRY EGL_WaitClient()
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitClient, thread);
...
EGLContext EGLAPIENTRY EGL_GetCurrentContext()
{
    ...
    EGLContext returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetCurrentContext, thread);
...
EGLint EGLAPIENTRY EGL_ClientWaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags, EGLTime timeout)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ClientWaitSync, thread, dpyPacked);
                                     ...
                                     const EGLAttrib *attrib_list)
{
    ...
    EGLImage returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateImage, thread, dpyPacked, ctxPacked);
                                                       ...
                                                       const EGLAttrib *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePlatformPixmapSurface, thread, dpyPacked);
                                                       ...
                                                       const EGLAttrib *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePlatformWindowSurface, thread, dpyPacked);
...
EGLSync EGLAPIENTRY EGL_CreateSync(EGLDisplay dpy, EGLenum type, const EGLAttrib *attrib_list)
{
    ...
    EGLSync returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateSync, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroyImage(EGLDisplay dpy, EGLImage image)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroyImage, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroySync(EGLDisplay dpy, EGLSync sync)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroySync, thread, dpyPacked);
                                              ...
                                              const EGLAttrib *attrib_list)
{
    ...
    EGLDisplay returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetPlatformDisplay, thread);
                                         ...
                                         EGLAttrib *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetSyncAttrib, thread, dpyPacked, attribute);
...
EGLBoolean EGLAPIENTRY EGL_WaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitSync, thread, dpyPacked);
