...
// entry_points_gles2_ext.h : Defines the GLES 2.0 extension entry points.

#ifndef LIBGLESV2_ENTRYPOINTGLES2EXT_H_
#define LIBGLESV2_ENTRYPOINTGLES2EXT_H_
...
#endif // LIBGLESV2_ENTRYPOINTGLES2EXT_H_
