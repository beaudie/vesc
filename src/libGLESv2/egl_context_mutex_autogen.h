...
ANGLE_INLINE ContextMutex *GetContextMutex_GetConfigAttrib(Thread *thread,
                                                           egl::Display *dpyPacked,
                                                           EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_QuerySurface(Thread *thread,
                                                        egl::Display *dpyPacked,
                                                        EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_SurfaceAttrib(Thread *thread,
                                                         egl::Display *dpyPacked,
                                                         EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_GetSyncAttrib(Thread *thread,
                                                         egl::Display *dpyPacked,
                                                         EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_QueryDeviceAttribEXT(Thread *thread, EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_QueryDebugKHR(Thread *thread, EGLint attribute);
...
ANGLE_INLINE ContextMutex *GetContextMutex_DestroyStreamKHR(Thread *thread,
                                                            egl::Display *dpyPacked);
ANGLE_INLINE ContextMutex *GetContextMutex_QueryStreamKHR(Thread *thread,
                                                          egl::Display *dpyPacked,
                                                          EGLenum attribute);
ANGLE_INLINE ContextMutex *GetContextMutex_QueryStreamu64KHR(Thread *thread,
                                                             egl::Display *dpyPacked,
                                                             EGLenum attribute);
ANGLE_INLINE ContextMutex *GetContextMutex_StreamAttribKHR(Thread *thread,
                                                           egl::Display *dpyPacked,
                                                           EGLenum attribute);
