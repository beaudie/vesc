...
// entry_points_gles3.h : Defines the GLES 3.0 entry points.

#ifndef LIBGLESV2_ENTRYPOINTGLES3_H_
#define LIBGLESV2_ENTRYPOINTGLES3_H_
...
#endif // LIBGLESV2_ENTRYPOINTGLES3_H_
