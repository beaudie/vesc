                           ...
                           const AttributeMap &attributes)
{
    ...
    angle::CaptureEGLCreateImage(context, target, buffer, attributes, image);
...
EGLClientBuffer CreateNativeClientBufferANDROID(Thread *thread, const AttributeMap &attribMap)
{
    ...
    angle::CaptureCreateNativeClientBufferANDROID(thread->getContext(), attribMap, eglClientBuffer);
...
EGLBoolean DestroyImageKHR(Thread *thread, Display *display, Image *img)
{
    ...
    angle::CaptureEGLDestroyImage(thread->getContext(), display, img);
