...
void GL_APIENTRY BindAttribLocationContextANGLE(GLeglContext ctx,
                                                ...
                                                const GLchar *name)
{
    EVENT("(GLuint program = %u, GLuint index = %u, const GLchar *name = 0x%p)", program, index,
          name);
...
{
    EVENT(
        "(GLenum target = 0x%X, GLuint index = %u, GLuint buffer = %u, GLintptr offset = %ld, "
        "GLsizeiptr size = %ld)",
...
{
    EVENT(
        "(GLuint bindingindex = %u, GLuint buffer = %u, GLintptr offset = %ld, GLsizei stride = "
        "%d)",
...
{
    EVENT(
        "(GLenum target = 0x%X, GLsizeiptr size = %ld, const void *data = 0x%p, GLenum usage = "
        "0x%X)",
...
{
    EVENT(
        "(GLenum target = 0x%X, GLintptr offset = %ld, GLsizeiptr size = %ld, const void *data = "
        "0x%p)",
...
void GL_APIENTRY ClearBufferfvContextANGLE(GLeglContext ctx,
                                           ...
                                           const GLfloat *value)
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLfloat *value = 0x%p)", buffer,
          drawbuffer, value);
...
void GL_APIENTRY ClearBufferivContextANGLE(GLeglContext ctx,
                                           ...
                                           const GLint *value)
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLint *value = 0x%p)", buffer,
          drawbuffer, value);
...
void GL_APIENTRY ClearBufferuivContextANGLE(GLeglContext ctx,
                                            ...
                                            const GLuint *value)
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLuint *value = 0x%p)", buffer,
          drawbuffer, value);
...
GLenum GL_APIENTRY ClientWaitSyncContextANGLE(GLeglContext ctx,
                                              ...
                                              GLuint64 timeout)
{
    EVENT("(GLsync sync = 0x%p, GLbitfield flags = 0x%X, GLuint64 timeout = %" PRId64 ")", sync,
          flags, timeout);
                                                     ...
                                                     const void *data)
{
    EVENT(
        "(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLint "
        "zoffset = %d, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLenum format "
        "= 0x%X, GLsizei imageSize = %d, const void *data = 0x%p)",
...
{
    EVENT(
        "(GLenum readTarget = 0x%X, GLenum writeTarget = 0x%X, GLintptr readOffset = %ld, GLintptr "
        "writeOffset = %ld, GLsizeiptr size = %ld)",
...
{
    EVENT("(GLenum type = 0x%X, GLsizei count = %d, const GLchar *const*strings = 0x%p)", type,
          count, strings);
...
{
    EVENT("(GLsizei n = %d, const GLuint *buffers = 0x%p)", n, buffers);
...
{
    EVENT("(GLsizei n = %d, const GLuint *pipelines = 0x%p)", n, pipelines);
...
{
    EVENT("(GLsizei count = %d, const GLuint *samplers = 0x%p)", count, samplers);
...
{
    EVENT("(GLsizei n = %d, const GLuint *textures = 0x%p)", n, textures);
...
{
    EVENT("(GLintptr indirect = %ld)", indirect);
...
{
    EVENT("(GLenum mode = 0x%X, const void *indirect = 0x%p)", mode, indirect);
...
void GL_APIENTRY DrawElementsIndirectContextANGLE(GLeglContext ctx,
                                                  ...
                                                  const void *indirect)
{
    EVENT("(GLenum mode = 0x%X, GLenum type = 0x%X, const void *indirect = 0x%p)", mode, type,
          indirect);
...
{
    EVENT("(GLsizei n = %d, GLuint *buffers = 0x%p)", n, buffers);
...
{
    EVENT("(GLsizei n = %d, GLuint *pipelines = 0x%p)", n, pipelines);
...
{
    EVENT("(GLsizei count = %d, GLuint *samplers = 0x%p)", count, samplers);
...
{
    EVENT("(GLsizei n = %d, GLuint *textures = 0x%p)", n, textures);
...
{
    EVENT(
        "(GLuint program = %u, GLuint index = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, "
        "GLint *size = 0x%p, GLenum *type = 0x%p, GLchar *name = 0x%p)",
                                                       ...
                                                       GLchar *uniformBlockName)
{
    EVENT(
        ...
        "*length = 0x%p, GLchar *uniformBlockName = 0x%p)",
...
{
    EVENT(
        "(GLuint program = %u, GLsizei uniformCount = %d, const GLuint *uniformIndices = 0x%p, "
        "GLenum pname = 0x%X, GLint *params = 0x%p)",
...
{
    EVENT(
        "(GLuint program = %u, GLsizei maxCount = %d, GLsizei *count = 0x%p, GLuint *shaders = "
        "0x%p)",
...
GLint GL_APIENTRY GetAttribLocationContextANGLE(GLeglContext ctx,
                                                ...
                                                const GLchar *name)
{
    EVENT("(GLuint program = %u, const GLchar *name = 0x%p)", program, name);
...
void GL_APIENTRY GetBooleani_vContextANGLE(GLeglContext ctx,
                                           ...
                                           GLboolean *data)
{
    EVENT("(GLenum target = 0x%X, GLuint index = %u, GLboolean *data = 0x%p)", target, index, data);
...
{
    EVENT("(GLenum pname = 0x%X, GLboolean *data = 0x%p)", pname, data);
...
void GL_APIENTRY GetBufferParameteri64vContextANGLE(GLeglContext ctx,
                                                    ...
                                                    GLint64 *params)
{
    EVENT("(GLenum target = 0x%X, GLenum pname = 0x%X, GLint64 *params = 0x%p)", target, pname,
          params);
...
{
    EVENT("(GLenum pname = 0x%X, GLfloat *data = 0x%p)", pname, data);
...
void GL_APIENTRY GetInteger64i_vContextANGLE(GLeglContext ctx,
                                             ...
                                             GLint64 *data)
{
    EVENT("(GLenum target = 0x%X, GLuint index = %u, GLint64 *data = 0x%p)", target, index, data);
...
{
    EVENT("(GLenum pname = 0x%X, GLint64 *data = 0x%p)", pname, data);
...
void GL_APIENTRY GetIntegeri_vContextANGLE(GLeglContext ctx,
                                           ...
                                           GLint *data)
{
    EVENT("(GLenum target = 0x%X, GLuint index = %u, GLint *data = 0x%p)", target, index, data);
...
{
    EVENT("(GLenum pname = 0x%X, GLint *data = 0x%p)", pname, data);
...
void GL_APIENTRY GetMultisamplefvContextANGLE(GLeglContext ctx,
                                              ...
                                              GLfloat *val)
{
    EVENT("(GLenum pname = 0x%X, GLuint index = %u, GLfloat *val = 0x%p)", pname, index, val);
...
{
    EVENT(
        "(GLuint program = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *infoLog = "
        "0x%p)",
...
{
    EVENT(
        "(GLuint pipeline = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *infoLog = "
        "0x%p)",
...
void GL_APIENTRY GetProgramPipelineivContextANGLE(GLeglContext ctx,
                                                  ...
                                                  GLint *params)
{
    EVENT("(GLuint pipeline = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", pipeline, pname,
          params);
...
GLuint GL_APIENTRY GetProgramResourceIndexContextANGLE(GLeglContext ctx,
                                                       ...
                                                       const GLchar *name)
{
    EVENT("(GLuint program = %u, GLenum programInterface = 0x%X, const GLchar *name = 0x%p)",
                                                    ...
                                                    GLchar *name)
{
    EVENT(
        ...
        "= %d, GLsizei *length = 0x%p, GLchar *name = 0x%p)",
                                                  ...
                                                  GLint *params)
{
    EVENT(
        ...
        "propCount = %d, const GLenum *props = 0x%p, GLsizei bufSize = %d, GLsizei *length = 0x%p, "
        "GLint *params = 0x%p)",
...
void GL_APIENTRY GetProgramivContextANGLE(GLeglContext ctx,
                                          ...
                                          GLint *params)
{
    EVENT("(GLuint program = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", program, pname,
          params);
...
void GL_APIENTRY GetSamplerParameterfvContextANGLE(GLeglContext ctx,
                                                   ...
                                                   GLfloat *params)
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, GLfloat *params = 0x%p)", sampler, pname,
          params);
...
void GL_APIENTRY GetSamplerParameterivContextANGLE(GLeglContext ctx,
                                                   ...
                                                   GLint *params)
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", sampler, pname,
          params);
...
{
    EVENT(
        "(GLuint shader = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *infoLog = "
        "0x%p)",
...
{
    EVENT(
        "(GLenum shadertype = 0x%X, GLenum precisiontype = 0x%X, GLint *range = 0x%p, GLint "
        "*precision = 0x%p)",
...
void GL_APIENTRY GetShaderivContextANGLE(GLeglContext ctx,
                                         ...
                                         GLint *params)
{
    EVENT("(GLuint shader = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", shader, pname, params);
...
{
    EVENT(
        "(GLsync sync = 0x%p, GLenum pname = 0x%X, GLsizei bufSize = %d, GLsizei *length = 0x%p, "
        "GLint *values = 0x%p)",
...
void GL_APIENTRY GetTexLevelParameterfvContextANGLE(GLeglContext ctx,
                                                    ...
                                                    GLfloat *params)
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLenum pname = 0x%X, GLfloat *params = 0x%p)",
...
void GL_APIENTRY GetTexLevelParameterivContextANGLE(GLeglContext ctx,
                                                    ...
                                                    GLint *params)
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLenum pname = 0x%X, GLint *params = 0x%p)",
          target, level, pname, params);
                                                         ...
                                                         GLchar *name)
{
    EVENT(
        "(GLuint program = %u, GLuint index = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, "
        "GLsizei *size = 0x%p, GLenum *type = 0x%p, GLchar *name = 0x%p)",
        program, index, bufSize, length, size, type, name);
...
{
    EVENT("(GLuint program = %u, const GLchar *uniformBlockName = 0x%p)", program,
          uniformBlockName);
...
{
    EVENT(
        "(GLuint program = %u, GLsizei uniformCount = %d, const GLchar *const*uniformNames = 0x%p, "
        "GLuint *uniformIndices = 0x%p)",
...
void GL_APIENTRY GetUniformfvContextANGLE(GLeglContext ctx,
                                          ...
                                          GLfloat *params)
{
    EVENT("(GLuint program = %u, GLint location = %d, GLfloat *params = 0x%p)", program, location,
          params);
...
void GL_APIENTRY GetUniformivContextANGLE(GLeglContext ctx,
                                          ...
                                          GLint *params)
{
    EVENT("(GLuint program = %u, GLint location = %d, GLint *params = 0x%p)", program, location,
          params);
...
void GL_APIENTRY GetUniformuivContextANGLE(GLeglContext ctx,
                                           ...
                                           GLuint *params)
{
    EVENT("(GLuint program = %u, GLint location = %d, GLuint *params = 0x%p)", program, location,
          params);
...
void GL_APIENTRY GetVertexAttribIivContextANGLE(GLeglContext ctx,
                                                ...
                                                GLint *params)
{
    EVENT("(GLuint index = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", index, pname, params);
...
void GL_APIENTRY GetVertexAttribIuivContextANGLE(GLeglContext ctx,
                                                 ...
                                                 GLuint *params)
{
    EVENT("(GLuint index = %u, GLenum pname = 0x%X, GLuint *params = 0x%p)", index, pname, params);
...
void GL_APIENTRY GetVertexAttribPointervContextANGLE(GLeglContext ctx,
                                                     ...
                                                     void **pointer)
{
    EVENT("(GLuint index = %u, GLenum pname = 0x%X, void **pointer = 0x%p)", index, pname, pointer);
...
void GL_APIENTRY GetVertexAttribfvContextANGLE(GLeglContext ctx,
                                               ...
                                               GLfloat *params)
{
    EVENT("(GLuint index = %u, GLenum pname = 0x%X, GLfloat *params = 0x%p)", index, pname, params);
...
{
    EVENT(
        "(GLenum target = 0x%X, GLsizei numAttachments = %d, const GLenum *attachments = 0x%p, "
...
{
    EVENT(
        "(GLuint program = %u, GLenum binaryFormat = 0x%X, const void *binary = 0x%p, GLsizei "
        "length = %d)",
        program, binaryFormat, binary, length);
...
{
    EVENT(
        "(GLuint program = %u, GLint location = %d, GLsizei count = %d, const GLint *value = 0x%p)",
        program, location, count, value);
                                        ...
                                        void *pixels)
{
    EVENT(
        "(GLint x = %d, GLint y = %d, GLsizei width = %d, GLsizei height = %d, GLenum format = "
        "0x%X, GLenum type = 0x%X, void *pixels = 0x%p)",
...
void GL_APIENTRY SamplerParameterfvContextANGLE(GLeglContext ctx,
                                                ...
                                                const GLfloat *param)
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, const GLfloat *param = 0x%p)", sampler, pname,
          param);
...
void GL_APIENTRY SamplerParameterivContextANGLE(GLeglContext ctx,
                                                ...
                                                const GLint *param)
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, const GLint *param = 0x%p)", sampler, pname,
          param);
...
{
    EVENT(
        "(GLsizei count = %d, const GLuint *shaders = 0x%p, GLenum binaryformat = 0x%X, const void "
        "*binary = 0x%p, GLsizei length = %d)",
...
{
    EVENT(
        "(GLuint shader = %u, GLsizei count = %d, const GLchar *const*string = 0x%p, const GLint "
        "*length = 0x%p)",
                                        ...
                                        const void *pixels)
{
    EVENT(
        "(GLenum target = 0x%X, GLint level = %d, GLint internalformat = %d, GLsizei width = %d, "
        "GLsizei height = %d, GLsizei depth = %d, GLint border = %d, GLenum format = 0x%X, GLenum "
        "type = 0x%X, const void *pixels = 0x%p)",
                                           ...
                                           const void *pixels)
{
    EVENT(
        "(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLint "
        "zoffset = %d, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLenum format "
        "= 0x%X, GLenum type = 0x%X, const void *pixels = 0x%p)",
...
{
    EVENT(
        "(GLuint program = %u, GLsizei count = %d, const GLchar *const*varyings = 0x%p, GLenum "
        "bufferMode = 0x%X)",
...
void GL_APIENTRY Uniform1fvContextANGLE(GLeglContext ctx,
                                        ...
                                        const GLfloat *value)
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLfloat *value = 0x%p)", location, count,
          value);
...
void GL_APIENTRY Uniform1ivContextANGLE(GLeglContext ctx,
                                        ...
                                        const GLint *value)
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLint *value = 0x%p)", location, count,
          value);
...
void GL_APIENTRY Uniform1uivContextANGLE(GLeglContext ctx,
                                         ...
                                         const GLuint *value)
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLuint *value = 0x%p)", location, count,
          value);
...
{
    EVENT("(GLuint index = %u, const GLfloat *v = 0x%p)", index, v);
...
{
    EVENT("(GLuint index = %u, const GLint *v = 0x%p)", index, v);
...
{
    EVENT("(GLuint index = %u, const GLuint *v = 0x%p)", index, v);
                                                 ...
                                                 const void *pointer)
{
    EVENT(
        ...
        "GLsizei stride = %d, const void *pointer = 0x%p)",
