                                                      ...
                                                      GLuint baseInstance)
{
    ...
    if (context)
    {
        ...
        ANGLE_CAPTURE(DrawArraysInstancedBaseInstanceANGLE, context, modePacked, first, count,
                      instanceCount, baseInstance);
        if (context->skipValidation() ||
            ValidateDrawArraysInstancedBaseInstanceANGLE(context, modePacked, first, count,
                                                         instanceCount, baseInstance))
        {
                                                                  ...
                                                                  GLuint baseInstance)
{
    ...
    if (context)
    {
        ...
        ANGLE_CAPTURE(DrawElementsInstancedBaseVertexBaseInstanceANGLE, context, modePacked, count,
                      typePacked, indices, instanceCounts, baseVertex, baseInstance);
        if (context->skipValidation() || ValidateDrawElementsInstancedBaseVertexBaseInstanceANGLE(
                                                           ...
                                                           const GLuint *baseInstances)
{
    ...
    {
        PrimitiveMode modePacked = FromGLenum<PrimitiveMode>(mode);
        ANGLE_CAPTURE(MultiDrawArraysInstancedBaseInstanceANGLE, context, modePacked, drawcount,
                      counts, instanceCounts, firsts, baseInstances);
        if (context->skipValidation() ||
                                                      ...
                                                      const GLuint *baseInstances)
{
    ...
    if (context)
    {
        PrimitiveMode modePacked    = FromGLenum<PrimitiveMode>(mode);
        DrawElementsType typePacked = FromGLenum<DrawElementsType>(type);
        ANGLE_CAPTURE(MultiDrawElementsInstancedBaseVertexBaseInstanceANGLE, context, modePacked,
                      typePacked, drawcount, counts, instanceCounts, indices, baseVertices,
                      baseInstances);
        if (context->skipValidation() ||
            ValidateMultiDrawElementsInstancedBaseVertexBaseInstanceANGLE(
                context, modePacked, typePacked, drawcount, counts, instanceCounts, indices,
