                                             ...
                                             GLint *params)
{
    ...
    {
        TextureTarget targetPacked = FromGLenum<TextureTarget>(target);
        context->gatherParams<EntryPoint::GetTexLevelParameterivANGLE>(targetPacked, level, pname,
                                                                       params);
                                             ...
                                             GLfloat *params)
{
    ...
    {
        TextureTarget targetPacked = FromGLenum<TextureTarget>(target);
        context->gatherParams<EntryPoint::GetTexLevelParameterfvANGLE>(targetPacked, level, pname,
                                                                       params);
