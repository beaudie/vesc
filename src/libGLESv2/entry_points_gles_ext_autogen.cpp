    ...
    if (context)
    {
        bool isCallValid = (context->skipValidation() ||
                            ValidateDrawArraysInstancedBaseInstanceANGLE(
                                context, mode, first, count, instanceCount, baseInstance));
        if (isCallValid)
        {
            context->drawArraysInstancedBaseInstance(mode, first, count, instanceCount,
                                                     baseInstance);
        }
        ANGLE_CAPTURE(DrawArraysInstancedBaseInstanceANGLE, isCallValid, context, mode, first,
        ...
        bool isCallValid =
            (context->skipValidation() ||
             ValidateDrawElementsInstancedBaseVertexBaseInstanceANGLE(
                 context, mode, count, type, indices, instanceCounts, baseVertex, baseInstance));
        if (isCallValid)
        {
            context->drawElementsInstancedBaseVertexBaseInstance(
                mode, count, type, indices, instanceCounts, baseVertex, baseInstance);
        }
        ANGLE_CAPTURE(DrawElementsInstancedBaseVertexBaseInstanceANGLE, isCallValid, context, mode,
                      count, type, indices, instanceCounts, baseVertex, baseInstance);
    }
}
        ...
        bool isCallValid =
            (context->skipValidation() ||
             ValidateMultiDrawArraysInstancedBaseInstanceANGLE(
                 context, mode, drawcount, counts, instanceCounts, firsts, baseInstances));
        if (isCallValid)
        {
            context->multiDrawArraysInstancedBaseInstance(mode, drawcount, counts, instanceCounts,
                                                          firsts, baseInstances);
        }
        ANGLE_CAPTURE(MultiDrawArraysInstancedBaseInstanceANGLE, isCallValid, context, mode,
    ...
    if (context)
    {
        bool isCallValid = (context->skipValidation() ||
                            ValidateMultiDrawElementsInstancedBaseVertexBaseInstanceANGLE(
                                context, mode, type, drawcount, counts, instanceCounts, indices,
                                baseVertices, baseInstances));
        if (isCallValid)
        {
            context->multiDrawElementsInstancedBaseVertexBaseInstance(mode, type, drawcount, counts,
                                                                      instanceCounts, indices,
                                                                      baseVertices, baseInstances);
        }
        ANGLE_CAPTURE(MultiDrawElementsInstancedBaseVertexBaseInstanceANGLE, isCallValid, context,
                      mode, type, drawcount, counts, instanceCounts, indices, baseVertices,
                      baseInstances);
    }
}
