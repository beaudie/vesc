                                          ...
                                          GLsizei primcount)
{
    ...
    if (context)
    {
        DrawCallParams params(mode, first, count, primcount);

        if (context->skipValidation() || ValidateDrawArraysInstancedANGLE(context, params))
        {
            context->drawArraysInstanced(params);
        }
    }
}
                                            ...
                                            GLsizei primcount)
{
    ...
    if (context)
    {
        DrawCallParams params(mode, count, type, indices, primcount);

        if (context->skipValidation() || ValidateDrawElementsInstancedANGLE(context, params))
        {
            context->drawElementsInstanced(params);
        }
    }
}
...
void GL_APIENTRY DrawArraysContextANGLE(GLeglContext ctx, GLenum mode, GLint first, GLsizei count)
{
    ...
    {
        ASSERT(context == GetValidGlobalContext());
        DrawCallParams params(mode, first, count);

        if (context->skipValidation() || ValidateDrawArrays(context, params))
        {
                                                 ...
                                                 GLsizei instancecount)
{
    ...
    {
        ASSERT(context == GetValidGlobalContext());
        DrawCallParams params(mode, first, count, instancecount);

        if (context->skipValidation() || ValidateDrawArraysInstanced(context, params))
        {
            context->drawArraysInstanced(params);
        }
    }
                                          ...
                                          const void *indices)
{
    ...
    {
        ASSERT(context == GetValidGlobalContext());
        DrawCallParams params(mode, count, type, indices);

        if (context->skipValidation() || ValidateDrawElements(context, params))
        {
            context->drawElements(params);
        }
    }
}
                                                   ...
                                                   GLsizei instancecount)
{
    ...
    {
        ASSERT(context == GetValidGlobalContext());
        DrawCallParams params(mode, count, type, indices, instancecount);

        if (context->skipValidation() || ValidateDrawElementsInstanced(context, params))
        {
            context->drawElementsInstanced(params);
        }
    }
                                               ...
                                               const void *indices)
{
    ...
    if (context)
    {
        ...
        if (context->skipValidation() || ValidateDrawRangeElements(context, start, end, params))
        {
            context->drawRangeElements(start, end, params);
        }
    }
}
