...
#    include "libGLESv2/egl_context_mutex_impl.h"
#endif
                                              ...
                                              EGLGetBlobFuncANDROID get)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SetBlobCacheFuncsANDROID, thread, dpyPacked);
...
EGLClientBuffer EGLAPIENTRY EGL_CreateNativeClientBufferANDROID(const EGLint *attrib_list)
{
    ...
    EGLClientBuffer returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateNativeClientBufferANDROID, thread);
                                                               ...
                                                               EGLint name)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetCompositorTimingSupportedANDROID, thread, dpyPacked);
                                                      ...
                                                      EGLnsecsANDROID *values)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetCompositorTimingANDROID, thread, dpyPacked);
        ...
        returnValue = GetCompositorTimingANDROID(thread, dpyPacked, surfacePacked, numTimestamps,
                                                 names, values);
                                                 ...
                                                 EGLuint64KHR *frameId)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetNextFrameIdANDROID, thread, dpyPacked);
                                                             ...
                                                             EGLint timestamp)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetFrameTimestampSupportedANDROID, thread, dpyPacked);
                                                     ...
                                                     EGLnsecsANDROID *values)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetFrameTimestampsANDROID, thread, dpyPacked);
        ANGLE_EGL_VALIDATE(thread, GetFrameTimestampsANDROID, GetDisplayIfValid(dpyPacked),
                           EGLBoolean, dpyPacked, surfacePacked, frameId, numTimestamps, timestamps,
                           values);
...
EGLClientBuffer EGLAPIENTRY EGL_GetNativeClientBufferANDROID(const struct AHardwareBuffer *buffer)
{
    ...
    EGLClientBuffer returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetNativeClientBufferANDROID, thread);
...
EGLint EGLAPIENTRY EGL_DupNativeFenceFDANDROID(EGLDisplay dpy, EGLSyncKHR sync)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DupNativeFenceFDANDROID, thread, dpyPacked);
                                                   ...
                                                   EGLnsecsANDROID time)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(PresentationTimeANDROID, thread, dpyPacked);
                                               ...
                                               const EGLAttrib *attrib_list)
{
    ...
    EGLDeviceEXT returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateDeviceANGLE, thread);
...
EGLBoolean EGLAPIENTRY EGL_ReleaseDeviceANGLE(EGLDeviceEXT device)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ReleaseDeviceANGLE, thread);
...
const char *EGLAPIENTRY EGL_QueryStringiANGLE(EGLDisplay dpy, EGLint name, EGLint index)
{
    ...
    const char *returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryStringiANGLE, thread, dpyPacked);
                                                   ...
                                                   EGLAttrib *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDisplayAttribANGLE, thread, dpyPacked, attribute);
...
void *EGLAPIENTRY EGL_CopyMetalSharedEventANGLE(EGLDisplay dpy, EGLSyncKHR sync)
{
    ...
    void *returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CopyMetalSharedEventANGLE, thread, dpyPacked);
...
void EGLAPIENTRY EGL_ReleaseHighPowerGPUANGLE(EGLDisplay dpy, EGLContext ctx)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ReleaseHighPowerGPUANGLE, thread, dpyPacked, ctxPacked);
...
void EGLAPIENTRY EGL_ReacquireHighPowerGPUANGLE(EGLDisplay dpy, EGLContext ctx)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ReacquireHighPowerGPUANGLE, thread, dpyPacked, ctxPacked);
...
void EGLAPIENTRY EGL_HandleGPUSwitchANGLE(EGLDisplay dpy)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(HandleGPUSwitchANGLE, thread, dpyPacked);
...
void EGLAPIENTRY EGL_ForceGPUSwitchANGLE(EGLDisplay dpy, EGLint gpuIDHigh, EGLint gpuIDLow)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ForceGPUSwitchANGLE, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_PrepareSwapBuffersANGLE(EGLDisplay dpy, EGLSurface surface)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(PrepareSwapBuffersANGLE, thread, dpyPacked);
...
EGLint EGLAPIENTRY EGL_ProgramCacheGetAttribANGLE(EGLDisplay dpy, EGLenum attrib)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ProgramCacheGetAttribANGLE, thread, dpyPacked);
                                            ...
                                            EGLint *binarysize)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ProgramCacheQueryANGLE, thread, dpyPacked);
                                               ...
                                               EGLint binarysize)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ProgramCachePopulateANGLE, thread, dpyPacked);
...
EGLint EGLAPIENTRY EGL_ProgramCacheResizeANGLE(EGLDisplay dpy, EGLint limit, EGLint mode)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ProgramCacheResizeANGLE, thread, dpyPacked);
                                                    ...
                                                    void **value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QuerySurfacePointerANGLE, thread, dpyPacked, attribute);
        ...
        returnValue = QuerySurfacePointerANGLE(thread, dpyPacked, surfacePacked, attribute, value);
                                                               ...
                                                               const EGLAttrib *attrib_list)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateStreamProducerD3DTextureANGLE, thread, dpyPacked);
                                                     ...
                                                     const EGLAttrib *attrib_list)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamPostD3DTextureANGLE, thread, dpyPacked);
                                                          ...
                                                          EGLFrameTokenANGLE frametoken)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SwapBuffersWithFrameTokenANGLE, thread, dpyPacked);
        ...
        returnValue = SwapBuffersWithFrameTokenANGLE(thread, dpyPacked, surfacePacked, frametoken);
                                           ...
                                           EGLint *denominator)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetMscRateANGLE, thread, dpyPacked);
                                              ...
                                              void *vk_image_create_info)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ExportVkImageANGLE, thread, dpyPacked);
...
void EGLAPIENTRY EGL_WaitUntilWorkScheduledANGLE(EGLDisplay dpy)
{
    ...
    Thread *thread = egl::GetCurrentThread();
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitUntilWorkScheduledANGLE, thread, dpyPacked);
                                                 ...
                                                 EGLuint64KHR *sbc)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetSyncValuesCHROMIUM, thread, dpyPacked);
                                                ...
                                                EGLAttrib *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDeviceAttribEXT, thread, attribute);
...
const char *EGLAPIENTRY EGL_QueryDeviceStringEXT(EGLDeviceEXT device, EGLint name)
{
    ...
    const char *returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDeviceStringEXT, thread);
...
EGLBoolean EGLAPIENTRY EGL_QueryDisplayAttribEXT(EGLDisplay dpy, EGLint attribute, EGLAttrib *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDisplayAttribEXT, thread, dpyPacked, attribute);
                                                 ...
                                                 EGLint *num_formats)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDmaBufFormatsEXT, thread, dpyPacked);
        ...
        returnValue = QueryDmaBufFormatsEXT(thread, dpyPacked, max_formats, formats, num_formats);
                                                   ...
                                                   EGLint *num_modifiers)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDmaBufModifiersEXT, thread, dpyPacked);
        ANGLE_EGL_VALIDATE(thread, QueryDmaBufModifiersEXT, GetDisplayIfValid(dpyPacked),
                           EGLBoolean, dpyPacked, format, max_modifiers, modifiers, external_only,
                           num_modifiers);

        returnValue = QueryDmaBufModifiersEXT(thread, dpyPacked, format, max_modifiers, modifiers,
                                                          ...
                                                          const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePlatformPixmapSurfaceEXT, thread, dpyPacked);
        ...
        returnValue = CreatePlatformPixmapSurfaceEXT(thread, dpyPacked, configPacked, native_pixmap,
                                                     attrib_listPacked);
                                                          ...
                                                          const EGLint *attrib_list)
{
    ...
    EGLSurface returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreatePlatformWindowSurfaceEXT, thread, dpyPacked);
        ...
        returnValue = CreatePlatformWindowSurfaceEXT(thread, dpyPacked, configPacked, native_window,
                                                     attrib_listPacked);
                                                 ...
                                                 const EGLint *attrib_list)
{
    ...
    EGLDisplay returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetPlatformDisplayEXT, thread);
        ANGLE_EGL_VALIDATE(thread, GetPlatformDisplayEXT, nullptr, EGLDisplay, platform,
                           native_display, attrib_listPacked);

        returnValue = GetPlatformDisplayEXT(thread, platform, native_display, attrib_listPacked);
                                              ...
                                              const EGLAttrib *attrib_list)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DebugMessageControlKHR, thread);
                                      ...
                                      EGLLabelKHR label)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(LabelObjectKHR, thread, displayPacked);
...
EGLBoolean EGLAPIENTRY EGL_QueryDebugKHR(EGLint attribute, EGLAttrib *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryDebugKHR, thread, attribute);
                                         ...
                                         EGLTimeKHR timeout)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(ClientWaitSyncKHR, thread, dpyPacked);
...
EGLSyncKHR EGLAPIENTRY EGL_CreateSyncKHR(EGLDisplay dpy, EGLenum type, const EGLint *attrib_list)
{
    ...
    EGLSyncKHR returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateSyncKHR, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroySyncKHR(EGLDisplay dpy, EGLSyncKHR sync)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroySyncKHR, thread, dpyPacked);
                                            ...
                                            EGLint *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(GetSyncAttribKHR, thread, dpyPacked, attribute);
                                           ...
                                           const EGLint *attrib_list)
{
    ...
    EGLImageKHR returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateImageKHR, thread, dpyPacked, ctxPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroyImageKHR(EGLDisplay dpy, EGLImageKHR image)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroyImageKHR, thread, dpyPacked);
                                          ...
                                          const EGLint *attrib_list)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(LockSurfaceKHR, thread, dpyPacked);
                                             ...
                                             EGLAttribKHR *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QuerySurface64KHR, thread, dpyPacked, attribute);
...
EGLBoolean EGLAPIENTRY EGL_UnlockSurfaceKHR(EGLDisplay dpy, EGLSurface surface)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(UnlockSurfaceKHR, thread, dpyPacked);
                                              ...
                                              EGLint n_rects)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SetDamageRegionKHR, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_SignalSyncKHR(EGLDisplay dpy, EGLSyncKHR sync, EGLenum mode)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SignalSyncKHR, thread, dpyPacked);
...
EGLStreamKHR EGLAPIENTRY EGL_CreateStreamKHR(EGLDisplay dpy, const EGLint *attrib_list)
{
    ...
    EGLStreamKHR returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(CreateStreamKHR, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_DestroyStreamKHR(EGLDisplay dpy, EGLStreamKHR stream)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(DestroyStreamKHR, thread, dpyPacked);
                                          ...
                                          EGLint *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryStreamKHR, thread, dpyPacked, attribute);
                                             ...
                                             EGLuint64KHR *value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(QueryStreamu64KHR, thread, dpyPacked, attribute);
                                           ...
                                           EGLint value)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamAttribKHR, thread, dpyPacked, attribute);
...
EGLBoolean EGLAPIENTRY EGL_StreamConsumerAcquireKHR(EGLDisplay dpy, EGLStreamKHR stream)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamConsumerAcquireKHR, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_StreamConsumerGLTextureExternalKHR(EGLDisplay dpy, EGLStreamKHR stream)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamConsumerGLTextureExternalKHR, thread, dpyPacked);
...
EGLBoolean EGLAPIENTRY EGL_StreamConsumerReleaseKHR(EGLDisplay dpy, EGLStreamKHR stream)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamConsumerReleaseKHR, thread, dpyPacked);
                                                    ...
                                                    EGLint n_rects)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(SwapBuffersWithDamageKHR, thread, dpyPacked);
        ...
        returnValue = SwapBuffersWithDamageKHR(thread, dpyPacked, surfacePacked, rects, n_rects);
...
EGLint EGLAPIENTRY EGL_WaitSyncKHR(EGLDisplay dpy, EGLSyncKHR sync, EGLint flags)
{
    ...
    EGLint returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(WaitSyncKHR, thread, dpyPacked);
                                           ...
                                           EGLint height)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(PostSubBufferNV, thread, dpyPacked);
                                                                    ...
                                                                    const EGLAttrib *attrib_list)
{
    ...
    EGLBoolean returnValue;
    {
        ...
        ANGLE_EGL_CONTEXT_LOCK(StreamConsumerGLTextureExternalAttribsNV, thread, dpyPacked);
