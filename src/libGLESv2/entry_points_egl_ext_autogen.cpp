                                                     ...
                                                     EGLnsecsANDROID *values)
{
    ...
    EGL_EVENT(GetFrameTimestampsANDROID,
              ...
              (uintptr_t)dpy, (uintptr_t)surface, frameId, numTimestamps, (uintptr_t)timestamps,
              (uintptr_t)values);
                                                          ...
                                                          EGLFrameTokenANGLE frametoken)
{
    ...
    EGL_EVENT(SwapBuffersWithFrameTokenANGLE,
              ...
              (uintptr_t)dpy, (uintptr_t)surface, frametoken);
                                                          ...
                                                          const EGLint *attrib_list)
{
    ...
    EGLNativePixmapType native_pixmapPacked = PackParam<EGLNativePixmapType>(native_pixmap);
    const AttributeMap &attrib_listPacked   = PackParam<const AttributeMap &>(attrib_list);

    ANGLE_EGL_VALIDATE(thread, CreatePlatformPixmapSurfaceEXT, GetDisplayIfValid(dpyPacked),
                       EGLSurface, dpyPacked, configPacked, native_pixmapPacked, attrib_listPacked);

    return CreatePlatformPixmapSurfaceEXT(thread, dpyPacked, configPacked, native_pixmapPacked,
                                          attrib_listPacked);
}
                                                          ...
                                                          const EGLint *attrib_list)
{
    ...
    Display *dpyPacked                      = PackParam<Display *>(dpy);
    Config *configPacked                    = PackParam<Config *>(config);
    EGLNativeWindowType native_windowPacked = PackParam<EGLNativeWindowType>(native_window);
    const AttributeMap &attrib_listPacked   = PackParam<const AttributeMap &>(attrib_list);

    ANGLE_EGL_VALIDATE(thread, CreatePlatformWindowSurfaceEXT, GetDisplayIfValid(dpyPacked),
                       EGLSurface, dpyPacked, configPacked, native_windowPacked, attrib_listPacked);

    return CreatePlatformWindowSurfaceEXT(thread, dpyPacked, configPacked, native_windowPacked,
                                          attrib_listPacked);
}
                                         ...
                                         EGLTimeKHR timeout)
{
    ...
    EGL_EVENT(ClientWaitSyncKHR,
              ...
              (uintptr_t)dpy, (uintptr_t)sync, flags, timeout);
