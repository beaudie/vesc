                                    ...
                                    const void *data)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLClearBufferData) &&
                                       ...
                                       const void *data)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLClearBufferSubData) &&
