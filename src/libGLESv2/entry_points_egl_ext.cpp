...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p, EGLint attribute = %d, void **value = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p, EGLint x = %d, EGLint y = %d, EGLint width = %d, EGLint height = %d)", dpy, surface, x, y, width, height);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDeviceEXT device = 0x%p, EGLint attribute = %d, EGLAttrib *value = 0x%p)",
...
{
    EVENT("(EGLDeviceEXT device = 0x%p, EGLint name = %d)",
          device, name);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLint attribute = %d, EGLAttrib *value = 0x%p)",
          dpy, attribute, value);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLStreamKHR stream = 0x%p, EGLAttrib attrib_list = 0x%p",
