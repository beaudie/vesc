                                                          ...
                                                          EGLuint64KHR *frameId)
{
    ...
    EVENT("(EGLDisplay dpy = 0x%016" PRIxPTR "f, EGLSurface surface = 0x%016" PRIxPTR
          "f, EGLuint64KHR *frameId = "
          "0x%016" PRIxPTR "f)",
          (uintptr_t)dpy, (uintptr_t)surface, frameId);
                                                               ...
                                                               EGLnsecsANDROID *values)
{
    ANGLE_SCOPED_GLOBAL_LOCK();
    EVENT("(EGLDisplay dpy = 0x%016" PRIxPTR "f, EGLSurface surface = 0x%016" PRIxPTR
          "f, EGLint numTimestamps = %d, "
          "const EGLint *names = 0x%016" PRIxPTR "f, EGLnsecsANDROID *values = 0x%016" PRIxPTR "f)",
                                                              ...
                                                              EGLnsecsANDROID *values)
{
    ANGLE_SCOPED_GLOBAL_LOCK();
    EVENT("(EGLDisplay dpy = 0x%016" PRIxPTR "f, EGLSurface surface = 0x%016" PRIxPTR
          "f, EGLuint64KHR frameId = %llu, "
          "EGLint numTimestamps = %d, const EGLint *timestamps = 0x%016" PRIxPTR
          "f, EGLnsecsANDROID *values = "
          "0x%016" PRIxPTR "f)",
                                                                   ...
                                                                   EGLint timestamp)
{
    ...
    EVENT("(EGLDisplay dpy = 0x%016" PRIxPTR "f, EGLSurface surface = 0x%016" PRIxPTR
          ...
          (uintptr_t)dpy, (uintptr_t)surface, (uintptr_t)timestamp);
