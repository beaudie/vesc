            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLColor4ub) &&
                  ValidateColor4ub(context, angle::EntryPoint::GLColor4ub, red, green, blue,
                                   alpha)));
            if (isCallValid)
            {
    ...
    {
        {
            SCOPED_SHARE_CONTEXT_LOCK(context);
            bool isCallValid = (context->skipValidation() ||
                                ValidateGetClipPlanef(context, angle::EntryPoint::GLGetClipPlanef,
                                                      plane, equation));
            if (isCallValid)
            {
    ...
    {
        {
            SCOPED_SHARE_CONTEXT_LOCK(context);
            bool isCallValid = (context->skipValidation() ||
                                ValidateGetClipPlanex(context, angle::EntryPoint::GLGetClipPlanex,
                                                      plane, equation));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLLightfv) &&
                  ValidateLightfv(context, angle::EntryPoint::GLLightfv, light, pnamePacked,
                                  params)));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLLightxv) &&
                  ValidateLightxv(context, angle::EntryPoint::GLLightxv, light, pnamePacked,
                                  params)));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context,
                  ...
                  ValidateMultiTexCoord4f(context, angle::EntryPoint::GLMultiTexCoord4f, target, s,
                                          t, r, q)));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context,
                  ...
                  ValidateMultiTexCoord4x(context, angle::EntryPoint::GLMultiTexCoord4x, texture, s,
                                          t, r, q)));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLNormalPointer) &&
                  ValidateNormalPointer(context, angle::EntryPoint::GLNormalPointer, typePacked,
                                        stride, pointer)));
            if (isCallValid)
            {
            ...
            bool isCallValid =
                (context->skipValidation() ||
                 (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLPolygonOffsetx) &&
                  ValidatePolygonOffsetx(context, angle::EntryPoint::GLPolygonOffsetx, factor,
                                         units)));
            if (isCallValid)
            {
...
void GL_APIENTRY GL_TexCoordPointer(GLint size, GLenum type, GLsizei stride, const void *pointer)
{
    ...
    if (context)
    {
        VertexAttribType typePacked = PackParam<VertexAttribType>(type);
        {
            ...
            ANGLE_CAPTURE_GL(TexCoordPointer, isCallValid, context, size, typePacked, stride,
                             pointer);
        }
        context->getDisplay()->getCurrentThreadUnlockedTailCall()->run();
    }
...
void GL_APIENTRY GL_VertexPointer(GLint size, GLenum type, GLsizei stride, const void *pointer)
{
    ...
    if (context)
    {
        VertexAttribType typePacked = PackParam<VertexAttribType>(type);
        {
            ...
            ANGLE_CAPTURE_GL(VertexPointer, isCallValid, context, size, typePacked, stride,
                             pointer);
        }
        context->getDisplay()->getCurrentThreadUnlockedTailCall()->run();
    }
