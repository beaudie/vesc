...
GLboolean GL_APIENTRY GL_IsBuffer(GLuint buffer)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsBuffer) &&
...
GLboolean GL_APIENTRY GL_IsEnabled(GLenum cap)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsEnabled) &&
...
GLboolean GL_APIENTRY GL_IsFramebuffer(GLuint framebuffer)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsFramebuffer) &&
...
GLboolean GL_APIENTRY GL_IsProgram(GLuint program)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsProgram) &&
...
GLboolean GL_APIENTRY GL_IsRenderbuffer(GLuint renderbuffer)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsRenderbuffer) &&
...
GLboolean GL_APIENTRY GL_IsShader(GLuint shader)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsShader) &&
...
GLboolean GL_APIENTRY GL_IsTexture(GLuint texture)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsTexture) &&
