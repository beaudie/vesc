...
{
    EVENT("(GLuint program = %u, GLuint index = %u, const GLchar *name = 0x%p)", program, index, name);
...
{
    EVENT("(GLenum target = 0x%X, GLsizeiptr size = %ld, const void *data = 0x%p, GLenum usage = 0x%X)", target, size, data, usage);
...
{
    EVENT("(GLenum target = 0x%X, GLintptr offset = %ld, GLsizeiptr size = %ld, const void *data = 0x%p)", target, offset, size, data);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLenum internalformat = 0x%X, GLsizei width = %d, GLsizei height = %d, GLint border = %d, GLsizei imageSize = %d, const void *data = 0x%p)", target, level, internalformat, width, height, border, imageSize, data);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLsizei width = %d, GLsizei height = %d, GLenum format = 0x%X, GLsizei imageSize = %d, const void *data = 0x%p)", target, level, xoffset, yoffset, width, height, format, imageSize, data);
...
{
    EVENT("(GLenum mode = 0x%X, GLsizei count = %d, GLenum type = 0x%X, const void *indices = 0x%p)", mode, count, type, indices);
...
{
    EVENT("(GLuint program = %u, GLuint index = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLint *size = 0x%p, GLenum *type = 0x%p, GLchar *name = 0x%p)", program, index, bufSize, length, size, type, name);
...
{
    EVENT("(GLuint program = %u, GLsizei maxCount = %d, GLsizei *count = 0x%p, GLuint *shaders = 0x%p)", program, maxCount, count, shaders);
...
{
    EVENT("(GLuint program = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *infoLog = 0x%p)", program, bufSize, length, infoLog);
...
{
    EVENT("(GLuint program = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", program, pname, params);
...
{
    EVENT("(GLuint shader = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *infoLog = 0x%p)", shader, bufSize, length, infoLog);
...
{
    EVENT("(GLenum shadertype = 0x%X, GLenum precisiontype = 0x%X, GLint *range = 0x%p, GLint *precision = 0x%p)", shadertype, precisiontype, range, precision);
...
{
    EVENT("(GLuint program = %u, GLint location = %d, GLfloat *params = 0x%p)", program, location, params);
...
{
    EVENT("(GLuint program = %u, GLint location = %d, GLint *params = 0x%p)", program, location, params);
...
{
    EVENT("(GLint x = %d, GLint y = %d, GLsizei width = %d, GLsizei height = %d, GLenum format = 0x%X, GLenum type = 0x%X, void *pixels = 0x%p)", x, y, width, height, format, type, pixels);
...
{
    EVENT("(GLsizei count = %d, const GLuint *shaders = 0x%p, GLenum binaryformat = 0x%X, const void *binary = 0x%p, GLsizei length = %d)", count, shaders, binaryformat, binary, length);
...
{
    EVENT("(GLuint shader = %u, GLsizei count = %d, const GLchar *const*string = 0x%p, const GLint *length = 0x%p)", shader, count, string, length);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint internalformat = %d, GLsizei width = %d, GLsizei height = %d, GLint border = %d, GLenum format = 0x%X, GLenum type = 0x%X, const void *pixels = 0x%p)", target, level, internalformat, width, height, border, format, type, pixels);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLsizei width = %d, GLsizei height = %d, GLenum format = 0x%X, GLenum type = 0x%X, const void *pixels = 0x%p)", target, level, xoffset, yoffset, width, height, format, type, pixels);
...
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLfloat *value = 0x%p)", location, count, value);
...
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLint *value = 0x%p)", location, count, value);
...
{
    EVENT("(GLuint index = %u, GLint size = %d, GLenum type = 0x%X, GLboolean normalized = %u, GLsizei stride = %d, const void *pointer = 0x%p)", index, size, type, normalized, stride, pointer);
