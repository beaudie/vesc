...
void GL_APIENTRY ActiveTexture(GLenum texture)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ActiveTexture>(texture);
...
void GL_APIENTRY AttachShader(GLuint program, GLuint shader)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::AttachShader>(program, shader);
...
void GL_APIENTRY BindAttribLocation(GLuint program, GLuint index, const GLchar *name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BindAttribLocation>(program, index, name);
...
void GL_APIENTRY BindBuffer(GLenum target, GLuint buffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BindBuffer>(target, buffer);
...
void GL_APIENTRY BindFramebuffer(GLenum target, GLuint framebuffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BindFramebuffer>(target, framebuffer);
...
void GL_APIENTRY BindRenderbuffer(GLenum target, GLuint renderbuffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BindRenderbuffer>(target, renderbuffer);
...
void GL_APIENTRY BindTexture(GLenum target, GLuint texture)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BindTexture>(target, texture);
...
void GL_APIENTRY BlendColor(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BlendColor>(red, green, blue, alpha);
...
void GL_APIENTRY BlendEquation(GLenum mode)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BlendEquation>(mode);
...
void GL_APIENTRY BlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BlendEquationSeparate>(modeRGB, modeAlpha);
...
void GL_APIENTRY BlendFunc(GLenum sfactor, GLenum dfactor)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BlendFunc>(sfactor, dfactor);
                                   ...
                                   GLenum dfactorAlpha)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BlendFuncSeparate>(sfactorRGB, dfactorRGB, sfactorAlpha,
                                                           dfactorAlpha);
...
void GL_APIENTRY BufferData(GLenum target, GLsizeiptr size, const void *data, GLenum usage)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BufferData>(target, size, data, usage);
...
void GL_APIENTRY BufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const void *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::BufferSubData>(target, offset, size, data);
...
GLenum GL_APIENTRY CheckFramebufferStatus(GLenum target)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CheckFramebufferStatus>(target);
...
void GL_APIENTRY Clear(GLbitfield mask)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Clear>(mask);
...
void GL_APIENTRY ClearColor(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ClearColor>(red, green, blue, alpha);
...
void GL_APIENTRY ClearDepthf(GLfloat d)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ClearDepthf>(d);
...
void GL_APIENTRY ClearStencil(GLint s)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ClearStencil>(s);
...
void GL_APIENTRY ColorMask(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ColorMask>(red, green, blue, alpha);
...
void GL_APIENTRY CompileShader(GLuint shader)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CompileShader>(shader);
                                      ...
                                      const void *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CompressedTexImage2D>(target, level, internalformat, width,
                                         ...
                                         const void *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CompressedTexSubImage2D>(
            target, level, xoffset, yoffset, width, height, format, imageSize, data);
                                ...
                                GLint border)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CopyTexImage2D>(target, level, internalformat, x, y, width,
                                                        height, border);
                                   ...
                                   GLsizei height)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CopyTexSubImage2D>(target, level, xoffset, yoffset, x, y,
                                                           width, height);
...
GLuint GL_APIENTRY CreateProgram()
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CreateProgram>();
...
GLuint GL_APIENTRY CreateShader(GLenum type)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CreateShader>(type);
...
void GL_APIENTRY CullFace(GLenum mode)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::CullFace>(mode);
...
void GL_APIENTRY DeleteBuffers(GLsizei n, const GLuint *buffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteBuffers>(n, buffers);
...
void GL_APIENTRY DeleteFramebuffers(GLsizei n, const GLuint *framebuffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteFramebuffers>(n, framebuffers);
...
void GL_APIENTRY DeleteProgram(GLuint program)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteProgram>(program);
...
void GL_APIENTRY DeleteRenderbuffers(GLsizei n, const GLuint *renderbuffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteRenderbuffers>(n, renderbuffers);
...
void GL_APIENTRY DeleteShader(GLuint shader)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteShader>(shader);
...
void GL_APIENTRY DeleteTextures(GLsizei n, const GLuint *textures)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DeleteTextures>(n, textures);
...
void GL_APIENTRY DepthFunc(GLenum func)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DepthFunc>(func);
...
void GL_APIENTRY DepthMask(GLboolean flag)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DepthMask>(flag);
...
void GL_APIENTRY DepthRangef(GLfloat n, GLfloat f)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DepthRangef>(n, f);
...
void GL_APIENTRY DetachShader(GLuint program, GLuint shader)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DetachShader>(program, shader);
...
void GL_APIENTRY Disable(GLenum cap)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Disable>(cap);
...
void GL_APIENTRY DisableVertexAttribArray(GLuint index)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DisableVertexAttribArray>(index);
...
void GL_APIENTRY Enable(GLenum cap)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Enable>(cap);
...
void GL_APIENTRY EnableVertexAttribArray(GLuint index)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::EnableVertexAttribArray>(index);
...
void GL_APIENTRY Finish()
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Finish>();
...
void GL_APIENTRY Flush()
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Flush>();
                                         ...
                                         GLuint renderbuffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::FramebufferRenderbuffer>(target, attachment,
                                      ...
                                      GLint level)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::FramebufferTexture2D>(target, attachment, textarget,
                                                              texture, level);
...
void GL_APIENTRY FrontFace(GLenum mode)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::FrontFace>(mode);
...
void GL_APIENTRY GenBuffers(GLsizei n, GLuint *buffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GenBuffers>(n, buffers);
...
void GL_APIENTRY GenerateMipmap(GLenum target)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GenerateMipmap>(target);
...
void GL_APIENTRY GenFramebuffers(GLsizei n, GLuint *framebuffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GenFramebuffers>(n, framebuffers);
...
void GL_APIENTRY GenRenderbuffers(GLsizei n, GLuint *renderbuffers)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GenRenderbuffers>(n, renderbuffers);
...
void GL_APIENTRY GenTextures(GLsizei n, GLuint *textures)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GenTextures>(n, textures);
                                 ...
                                 GLchar *name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetActiveAttrib>(program, index, bufSize, length, size,
                                                         type, name);
                                  ...
                                  GLchar *name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetActiveUniform>(program, index, bufSize, length, size,
                                                          type, name);
                                    ...
                                    GLuint *shaders)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetAttachedShaders>(program, maxCount, count, shaders);
...
GLint GL_APIENTRY GetAttribLocation(GLuint program, const GLchar *name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetAttribLocation>(program, name);
...
void GL_APIENTRY GetBooleanv(GLenum pname, GLboolean *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetBooleanv>(pname, data);
...
void GL_APIENTRY GetBufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetBufferParameteriv>(target, pname, params);
...
GLenum GL_APIENTRY GetError()
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetError>();
...
void GL_APIENTRY GetFloatv(GLenum pname, GLfloat *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetFloatv>(pname, data);
                                                     ...
                                                     GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetFramebufferAttachmentParameteriv>(target, attachment,
                                                                             pname, params);
...
void GL_APIENTRY GetIntegerv(GLenum pname, GLint *data)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetIntegerv>(pname, data);
...
void GL_APIENTRY GetProgramiv(GLuint program, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetProgramiv>(program, pname, params);
                                   ...
                                   GLchar *infoLog)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetProgramInfoLog>(program, bufSize, length, infoLog);
...
void GL_APIENTRY GetRenderbufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetRenderbufferParameteriv>(target, pname, params);
...
void GL_APIENTRY GetShaderiv(GLuint shader, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetShaderiv>(shader, pname, params);
...
void GL_APIENTRY GetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetShaderInfoLog>(shader, bufSize, length, infoLog);
                                          ...
                                          GLint *precision)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetShaderPrecisionFormat>(shadertype, precisiontype, range,
                                                                  precision);
...
void GL_APIENTRY GetShaderSource(GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetShaderSource>(shader, bufSize, length, source);
...
const GLubyte *GL_APIENTRY GetString(GLenum name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetString>(name);
...
void GL_APIENTRY GetTexParameterfv(GLenum target, GLenum pname, GLfloat *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetTexParameterfv>(target, pname, params);
...
void GL_APIENTRY GetTexParameteriv(GLenum target, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetTexParameteriv>(target, pname, params);
...
void GL_APIENTRY GetUniformfv(GLuint program, GLint location, GLfloat *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetUniformfv>(program, location, params);
...
void GL_APIENTRY GetUniformiv(GLuint program, GLint location, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetUniformiv>(program, location, params);
...
GLint GL_APIENTRY GetUniformLocation(GLuint program, const GLchar *name)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetUniformLocation>(program, name);
...
void GL_APIENTRY GetVertexAttribfv(GLuint index, GLenum pname, GLfloat *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetVertexAttribfv>(index, pname, params);
...
void GL_APIENTRY GetVertexAttribiv(GLuint index, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetVertexAttribiv>(index, pname, params);
...
void GL_APIENTRY GetVertexAttribPointerv(GLuint index, GLenum pname, void **pointer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::GetVertexAttribPointerv>(index, pname, pointer);
...
void GL_APIENTRY Hint(GLenum target, GLenum mode)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Hint>(target, mode);
...
GLboolean GL_APIENTRY IsBuffer(GLuint buffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsBuffer>(buffer);
...
GLboolean GL_APIENTRY IsEnabled(GLenum cap)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsEnabled>(cap);
...
GLboolean GL_APIENTRY IsFramebuffer(GLuint framebuffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsFramebuffer>(framebuffer);
...
GLboolean GL_APIENTRY IsProgram(GLuint program)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsProgram>(program);
...
GLboolean GL_APIENTRY IsRenderbuffer(GLuint renderbuffer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsRenderbuffer>(renderbuffer);
...
GLboolean GL_APIENTRY IsShader(GLuint shader)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsShader>(shader);
...
GLboolean GL_APIENTRY IsTexture(GLuint texture)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::IsTexture>(texture);
...
void GL_APIENTRY LineWidth(GLfloat width)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::LineWidth>(width);
...
void GL_APIENTRY LinkProgram(GLuint program)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::LinkProgram>(program);
...
void GL_APIENTRY PixelStorei(GLenum pname, GLint param)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::PixelStorei>(pname, param);
...
void GL_APIENTRY PolygonOffset(GLfloat factor, GLfloat units)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::PolygonOffset>(factor, units);
                            ...
                            void *pixels)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ReadPixels>(x, y, width, height, format, type, pixels);
...
void GL_APIENTRY ReleaseShaderCompiler()
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ReleaseShaderCompiler>();
                                     ...
                                     GLsizei height)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::RenderbufferStorage>(target, internalformat, width, height);
...
void GL_APIENTRY SampleCoverage(GLfloat value, GLboolean invert)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::SampleCoverage>(value, invert);
...
void GL_APIENTRY Scissor(GLint x, GLint y, GLsizei width, GLsizei height)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Scissor>(x, y, width, height);
                              ...
                              GLsizei length)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ShaderBinary>(count, shaders, binaryformat, binary, length);
                              ...
                              const GLint *length)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ShaderSource>(shader, count, string, length);
...
void GL_APIENTRY StencilFunc(GLenum func, GLint ref, GLuint mask)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilFunc>(func, ref, mask);
...
void GL_APIENTRY StencilFuncSeparate(GLenum face, GLenum func, GLint ref, GLuint mask)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilFuncSeparate>(face, func, ref, mask);
...
void GL_APIENTRY StencilMask(GLuint mask)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilMask>(mask);
...
void GL_APIENTRY StencilMaskSeparate(GLenum face, GLuint mask)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilMaskSeparate>(face, mask);
...
void GL_APIENTRY StencilOp(GLenum fail, GLenum zfail, GLenum zpass)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilOp>(fail, zfail, zpass);
...
void GL_APIENTRY StencilOpSeparate(GLenum face, GLenum sfail, GLenum dpfail, GLenum dppass)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::StencilOpSeparate>(face, sfail, dpfail, dppass);
                            ...
                            const void *pixels)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexImage2D>(target, level, internalformat, width, height,
...
void GL_APIENTRY TexParameterf(GLenum target, GLenum pname, GLfloat param)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexParameterf>(target, pname, param);
...
void GL_APIENTRY TexParameterfv(GLenum target, GLenum pname, const GLfloat *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexParameterfv>(target, pname, params);
...
void GL_APIENTRY TexParameteri(GLenum target, GLenum pname, GLint param)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexParameteri>(target, pname, param);
...
void GL_APIENTRY TexParameteriv(GLenum target, GLenum pname, const GLint *params)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexParameteriv>(target, pname, params);
                               ...
                               const void *pixels)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::TexSubImage2D>(target, level, xoffset, yoffset, width,
...
void GL_APIENTRY Uniform1f(GLint location, GLfloat v0)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform1f>(location, v0);
...
void GL_APIENTRY Uniform1fv(GLint location, GLsizei count, const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform1fv>(location, count, value);
...
void GL_APIENTRY Uniform1i(GLint location, GLint v0)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform1i>(location, v0);
...
void GL_APIENTRY Uniform1iv(GLint location, GLsizei count, const GLint *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform1iv>(location, count, value);
...
void GL_APIENTRY Uniform2f(GLint location, GLfloat v0, GLfloat v1)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform2f>(location, v0, v1);
...
void GL_APIENTRY Uniform2fv(GLint location, GLsizei count, const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform2fv>(location, count, value);
...
void GL_APIENTRY Uniform2i(GLint location, GLint v0, GLint v1)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform2i>(location, v0, v1);
...
void GL_APIENTRY Uniform2iv(GLint location, GLsizei count, const GLint *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform2iv>(location, count, value);
...
void GL_APIENTRY Uniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform3f>(location, v0, v1, v2);
...
void GL_APIENTRY Uniform3fv(GLint location, GLsizei count, const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform3fv>(location, count, value);
...
void GL_APIENTRY Uniform3i(GLint location, GLint v0, GLint v1, GLint v2)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform3i>(location, v0, v1, v2);
...
void GL_APIENTRY Uniform3iv(GLint location, GLsizei count, const GLint *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform3iv>(location, count, value);
...
void GL_APIENTRY Uniform4f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform4f>(location, v0, v1, v2, v3);
...
void GL_APIENTRY Uniform4fv(GLint location, GLsizei count, const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform4fv>(location, count, value);
...
void GL_APIENTRY Uniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform4i>(location, v0, v1, v2, v3);
...
void GL_APIENTRY Uniform4iv(GLint location, GLsizei count, const GLint *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Uniform4iv>(location, count, value);
                                  ...
                                  const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::UniformMatrix2fv>(location, count, transpose, value);
                                  ...
                                  const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::UniformMatrix3fv>(location, count, transpose, value);
                                  ...
                                  const GLfloat *value)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::UniformMatrix4fv>(location, count, transpose, value);
...
void GL_APIENTRY UseProgram(GLuint program)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::UseProgram>(program);
...
void GL_APIENTRY ValidateProgram(GLuint program)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::ValidateProgram>(program);
...
void GL_APIENTRY VertexAttrib1f(GLuint index, GLfloat x)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib1f>(index, x);
...
void GL_APIENTRY VertexAttrib1fv(GLuint index, const GLfloat *v)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib1fv>(index, v);
...
void GL_APIENTRY VertexAttrib2f(GLuint index, GLfloat x, GLfloat y)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib2f>(index, x, y);
...
void GL_APIENTRY VertexAttrib2fv(GLuint index, const GLfloat *v)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib2fv>(index, v);
...
void GL_APIENTRY VertexAttrib3f(GLuint index, GLfloat x, GLfloat y, GLfloat z)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib3f>(index, x, y, z);
...
void GL_APIENTRY VertexAttrib3fv(GLuint index, const GLfloat *v)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib3fv>(index, v);
...
void GL_APIENTRY VertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib4f>(index, x, y, z, w);
...
void GL_APIENTRY VertexAttrib4fv(GLuint index, const GLfloat *v)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttrib4fv>(index, v);
                                     ...
                                     const void *pointer)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::VertexAttribPointer>(index, size, type, normalized, stride,
                                                             pointer);
...
void GL_APIENTRY Viewport(GLint x, GLint y, GLsizei width, GLsizei height)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::Viewport>(x, y, width, height);
