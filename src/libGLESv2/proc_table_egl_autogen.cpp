...
const ProcEntry g_procTable[] = {
    ...
    {"eglProgramCachePopulateMetalBinaryArchiveANGLE", P(EGL_ProgramCachePopulateMetalBinaryArchiveANGLE)},
    {"eglProgramCacheQueryANGLE", P(EGL_ProgramCacheQueryANGLE)},
    {"eglProgramCacheQueryMetalBinaryArchiveANGLE", P(EGL_ProgramCacheQueryMetalBinaryArchiveANGLE)},
