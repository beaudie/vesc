...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLint v0 = %d)", program, location, v0);
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLint v0 = %d, GLint v1 = %d)", program,
          location, v0, v1);
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLint v0 = %d, GLint v1 = %d, GLint v2 = %d)",
...
{
    EVENT(
        "(GLuint program = %d, GLint location = %d, GLint v0 = %d, GLint v1 = %d, GLint v2 = %d, "
        "GLint v3 = %d)",
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLuint v0 = %d)", program, location, v0);
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLuint v0 = %d, GLuint v1 = %d)", program,
          location, v0, v1);
...
{
    EVENT(
        "(GLuint program = %d, GLint location = %d, GLuint v0 = %d, GLuint v1 = %d, GLuint v2 = "
        "%d)",
        program, location, v0, v1, v2);
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLfloat v0 = %d)", program, location, v0);
...
{
    EVENT("(GLuint program = %d, GLint location = %d, GLfloat v0 = %d, GLfloat v1 = %d)", program,
          location, v0, v1);
...
{
    EVENT(
        "(GLuint program = %d, GLint location = %d, GLfloat v0 = %d, GLfloat v1 = %d, GLfloat v2 = "
        "%d)",
        program, location, v0, v1, v2);
