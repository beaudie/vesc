                                   ...
                                   const GLint *value)
{
    ...
    if (context)
    {
        ...
        programObject->setProgramUniform1iv(location, count, value);
    }
}
                                   ...
                                   const GLint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform2iv(location, count, value);
    }
}
                                   ...
                                   const GLint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform3iv(location, count, value);
    }
}
                                   ...
                                   const GLint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform4iv(location, count, value);
    }
}
                                    ...
                                    const GLuint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform1uiv(location, count, value);
    }
}
                                    ...
                                    const GLuint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform2uiv(location, count, value);
    }
}
                                    ...
                                    const GLuint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform3uiv(location, count, value);
    }
}
                                    ...
                                    const GLuint *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform4uiv(location, count, value);
    }
}
                                   ...
                                   const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform1fv(location, count, value);
    }
}
                                   ...
                                   const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform2fv(location, count, value);
    }
}
                                   ...
                                   const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform3fv(location, count, value);
    }
}
                                   ...
                                   const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniform4fv(location, count, value);
    }
}
                                         ...
                                         const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix2fv(location, count, transpose, value);
    }
}
                                         ...
                                         const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix3fv(location, count, transpose, value);
    }
}
                                         ...
                                         const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix4fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix2x3fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix3x2fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix2x4fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix4x2fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix3x4fv(location, count, transpose, value);
    }
}
                                           ...
                                           const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        Program *programObject = context->getProgram(program);
        ASSERT(programObject);
        programObject->setProgramUniformMatrix4x3fv(location, count, transpose, value);
    }
}
