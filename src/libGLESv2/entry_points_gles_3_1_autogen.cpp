    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLActiveShaderProgram>(context) &&
                                     ...
                                     GLenum format)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLBindImageTexture>(context) &&
...
void GL_APIENTRY GL_BindProgramPipeline(GLuint pipeline)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLBindProgramPipeline>(context) &&
                                     ...
                                     GLsizei stride)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLBindVertexBuffer>(context) &&
...
void GL_APIENTRY GL_DeleteProgramPipelines(GLsizei n, const GLuint *pipelines)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLDeleteProgramPipelines>(context) &&
...
void GL_APIENTRY GL_DispatchCompute(GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z)
{
    ...
    if (context)
    {
        ...
        bool isCallValid = (context->skipValidation() ||
                            (ValidateEntryPoint<angle::EntryPoint::GLDispatchCompute>(context) &&
...
void GL_APIENTRY GL_DispatchComputeIndirect(GLintptr indirect)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLDispatchComputeIndirect>(context) &&
              ValidateDispatchComputeIndirect(context, angle::EntryPoint::GLDispatchComputeIndirect,
                                              indirect)));
        if (isCallValid)
        {
...
void GL_APIENTRY GL_DrawArraysIndirect(GLenum mode, const void *indirect)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLDrawArraysIndirect>(context) &&
...
void GL_APIENTRY GL_DrawElementsIndirect(GLenum mode, GLenum type, const void *indirect)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLDrawElementsIndirect>(context) &&
...
void GL_APIENTRY GL_FramebufferParameteri(GLenum target, GLenum pname, GLint param)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLFramebufferParameteri>(context) &&
...
void GL_APIENTRY GL_GenProgramPipelines(GLsizei n, GLuint *pipelines)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGenProgramPipelines>(context) &&
...
void GL_APIENTRY GL_GetBooleani_v(GLenum target, GLuint index, GLboolean *data)
{
    ...
    if (context)
    {
        SCOPED_SHARE_CONTEXT_LOCK(context);
        bool isCallValid = (context->skipValidation() ||
                            (ValidateEntryPoint<angle::EntryPoint::GLGetBooleani_v>(context) &&
...
void GL_APIENTRY GL_GetFramebufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetFramebufferParameteriv>(context) &&
...
void GL_APIENTRY GL_GetMultisamplefv(GLenum pname, GLuint index, GLfloat *val)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetMultisamplefv>(context) &&
              ValidateGetMultisamplefv(context, angle::EntryPoint::GLGetMultisamplefv, pname, index,
                                       val)));
        if (isCallValid)
        {
                                          ...
                                          GLint *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetProgramInterfaceiv>(context) &&
                                              ...
                                              GLchar *infoLog)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetProgramPipelineInfoLog>(context) &&
              ValidateGetProgramPipelineInfoLog(context,
...
void GL_APIENTRY GL_GetProgramPipelineiv(GLuint pipeline, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetProgramPipelineiv>(context) &&
                                           ...
                                           GLchar *name)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetProgramResourceName>(context) &&
              ValidateGetProgramResourceName(context, angle::EntryPoint::GLGetProgramResourceName,
                                             programPacked, programInterface, index, bufSize,
                                             length, name)));
        if (isCallValid)
        {
                                         ...
                                         GLint *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetProgramResourceiv>(context) &&
                                           ...
                                           GLfloat *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetTexLevelParameterfv>(context) &&
...
void GL_APIENTRY GL_GetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint *params)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLGetTexLevelParameteriv>(context) &&
...
void GL_APIENTRY GL_MemoryBarrier(GLbitfield barriers)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLMemoryBarrier>(context) &&
...
void GL_APIENTRY GL_MemoryBarrierByRegion(GLbitfield barriers)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLMemoryBarrierByRegion>(context) &&
...
void GL_APIENTRY GL_ProgramUniform1f(GLuint program, GLint location, GLfloat v0)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1f>(context) &&
                                      ...
                                      const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1fv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform1i(GLuint program, GLint location, GLint v0)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1i>(context) &&
                                      ...
                                      const GLint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1iv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform1ui(GLuint program, GLint location, GLuint v0)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1ui>(context) &&
                                       ...
                                       const GLuint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform1uiv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform2f(GLuint program, GLint location, GLfloat v0, GLfloat v1)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2f>(context) &&
                                      ...
                                      const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2fv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform2i(GLuint program, GLint location, GLint v0, GLint v1)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2i>(context) &&
                                      ...
                                      const GLint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2iv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform2ui(GLuint program, GLint location, GLuint v0, GLuint v1)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2ui>(context) &&
                                       ...
                                       const GLuint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform2uiv>(context) &&
...
GL_ProgramUniform3f(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3f>(context) &&
                                      ...
                                      const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3fv>(context) &&
...
void GL_APIENTRY GL_ProgramUniform3i(GLuint program, GLint location, GLint v0, GLint v1, GLint v2)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3i>(context) &&
                                      ...
                                      const GLint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3iv>(context) &&
...
GL_ProgramUniform3ui(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3ui>(context) &&
                                       ...
                                       const GLuint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform3uiv>(context) &&
...
GL_ProgramUniform4f(GLuint program, GLint location, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4f>(context) &&
                                      ...
                                      const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4fv>(context) &&
...
GL_ProgramUniform4i(GLuint program, GLint location, GLint v0, GLint v1, GLint v2, GLint v3)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4i>(context) &&
                                      ...
                                      const GLint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4iv>(context) &&
...
GL_ProgramUniform4ui(GLuint program, GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4ui>(context) &&
                                       ...
                                       const GLuint *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniform4uiv>(context) &&
                                            ...
                                            const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix2fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix2x3fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix2x4fv>(context) &&
                                            ...
                                            const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix3fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix3x2fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix3x4fv>(context) &&
                                            ...
                                            const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix4fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix4x2fv>(context) &&
                                              ...
                                              const GLfloat *value)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLProgramUniformMatrix4x3fv>(context) &&
...
void GL_APIENTRY GL_SampleMaski(GLuint maskNumber, GLbitfield mask)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLSampleMaski>(context) &&
                                            ...
                                            GLboolean fixedsamplelocations)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLTexStorage2DMultisample>(context) &&
...
void GL_APIENTRY GL_UseProgramStages(GLuint pipeline, GLbitfield stages, GLuint program)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLUseProgramStages>(context) &&
...
void GL_APIENTRY GL_ValidateProgramPipeline(GLuint pipeline)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLValidateProgramPipeline>(context) &&
...
void GL_APIENTRY GL_VertexAttribBinding(GLuint attribindex, GLuint bindingindex)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLVertexAttribBinding>(context) &&
                                       ...
                                       GLuint relativeoffset)
{
    ...
    if (context)
    {
        ...
        SCOPED_SHARE_CONTEXT_LOCK(context);
        bool isCallValid = (context->skipValidation() ||
                            (ValidateEntryPoint<angle::EntryPoint::GLVertexAttribFormat>(context) &&
                             ValidateVertexAttribFormat(
                                 context, angle::EntryPoint::GLVertexAttribFormat, attribindex,
                                        ...
                                        GLuint relativeoffset)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLVertexAttribIFormat>(context) &&
...
void GL_APIENTRY GL_VertexBindingDivisor(GLuint bindingindex, GLuint divisor)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidateEntryPoint<angle::EntryPoint::GLVertexBindingDivisor>(context) &&
