...
class Framebuffer
{
  public:
    ...
    int getSamples(GLint clientVesion, const gl::TextureCapsMap &textureCaps,
                   const gl::Extensions &extensions) const;
    bool usingExtendedDrawBuffers() const;

    virtual GLenum completeness(GLint clientVesion, const gl::TextureCapsMap &textureCaps, const gl::Extensions &extensions) const;
...
class DefaultFramebuffer : public Framebuffer
{
  public:
    ...
    GLenum completeness(GLint clientVesion, const gl::TextureCapsMap &textureCaps, const gl::Extensions &extensions) const override;
    virtual FramebufferAttachment *getAttachment(GLenum attachment) const;
