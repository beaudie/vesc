...
{
    return gl::GetProgramResourceiv(program, programInterface, index, propCount, props, bufSize, length, params);
}
...
{
    return gl::TexStorage2DMultisample(target, samples, internalformat, width, height, fixedsamplelocations);
}
...
{
    return gl::CopySubTexture3DANGLE(sourceId, sourceLevel, destTarget, destId, destLevel, xoffset, yoffset, zoffset, x, y, z, width, height, depth, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
}
...
{
    return gl::MultiDrawElementsInstancedANGLE(mode, counts, type, indices, instanceCounts, drawcount);
}


// GL_ANGLE_multiview
void GL_APIENTRY glFramebufferTextureMultiviewLayeredANGLE(GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews)
{
    return gl::FramebufferTextureMultiviewLayeredANGLE(target, attachment, texture, level, baseViewIndex, numViews);
}

void GL_APIENTRY glFramebufferTextureMultiviewSideBySideANGLE(GLenum target, GLenum attachment, GLuint texture, GLint level, GLsizei numViews, const GLint * viewportOffsets)
{
    return gl::FramebufferTextureMultiviewSideBySideANGLE(target, attachment, texture, level, numViews, viewportOffsets);
}
...
{
    return gl::GetFramebufferAttachmentParameterivRobustANGLE(target, attachment, pname, bufSize, length, params);
}
...
{
    return gl::ReadPixelsRobustANGLE(x, y, width, height, format, type, bufSize, length, columns, rows, pixels);
}
...
{
    return gl::TexImage2DRobustANGLE(target, level, internalformat, width, height, border, format, type, bufSize, pixels);
}
...
{
    return gl::TexSubImage2DRobustANGLE(target, level, xoffset, yoffset, width, height, format, type, bufSize, pixels);
}
...
{
    return gl::TexImage3DRobustANGLE(target, level, internalformat, width, height, depth, border, format, type, bufSize, pixels);
}
...
{
    return gl::TexSubImage3DRobustANGLE(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bufSize, pixels);
}
...
{
    return gl::CompressedTexImage2DRobustANGLE(target, level, internalformat, width, height, border, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexSubImage2DRobustANGLE(target, level, xoffset, yoffset, width, height, format, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexImage3DRobustANGLE(target, level, internalformat, width, height, depth, border, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexSubImage3DRobustANGLE(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, dataSize, data);
}
...
{
    return gl::GetInternalformativRobustANGLE(target, internalformat, pname, bufSize, length, params);
}
...
{
    return gl::GetActiveUniformBlockivRobustANGLE(program, uniformBlockIndex, pname, bufSize, length, params);
}
...
void GL_APIENTRY glGetFramebufferParameterivRobustANGLE(GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * params)
{
...
{
    return gl::GetProgramInterfaceivRobustANGLE(program, programInterface, pname, bufSize, length, params);
}
...
{
    return gl::ReadnPixelsRobustANGLE(x, y, width, height, format, type, bufSize, length, columns, rows, data);
}
...
{
    return gl::TexStorage2DMultisampleANGLE(target, samples, internalformat, width, height, fixedsamplelocations);
}
...
{
    return gl::CopySubTextureCHROMIUM(sourceId, sourceLevel, destTarget, destId, destLevel, xoffset, yoffset, x, y, width, height, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
}
...
void GL_APIENTRY glPathCommandsCHROMIUM(GLuint path, GLsizei numCommands, const GLubyte * commands, GLsizei numCoords, GLenum coordType, const void* coords)
{
...
void GL_APIENTRY glCoverFillPathInstancedCHROMIUM(GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::CoverFillPathInstancedCHROMIUM(numPath, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}

void GL_APIENTRY glCoverStrokePathInstancedCHROMIUM(GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::CoverStrokePathInstancedCHROMIUM(numPath, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}

void GL_APIENTRY glStencilStrokePathInstancedCHROMIUM(GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilStrokePathInstancedCHROMIUM(numPath, pathNameType, paths, pathBase, reference, mask, transformType, transformValues);
}

void GL_APIENTRY glStencilFillPathInstancedCHROMIUM(GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilFillPathInstancedCHROMIUM(numPaths, pathNameType, paths, pathBase, fillMode, mask, transformType, transformValues);
}

void GL_APIENTRY glStencilThenCoverFillPathInstancedCHROMIUM(GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilThenCoverFillPathInstancedCHROMIUM(numPaths, pathNameType, paths, pathBase, fillMode, mask, coverMode, transformType, transformValues);
}

void GL_APIENTRY glStencilThenCoverStrokePathInstancedCHROMIUM(GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilThenCoverStrokePathInstancedCHROMIUM(numPaths, pathNameType, paths, pathBase, reference, mask, coverMode, transformType, transformValues);
}

void GL_APIENTRY glBindFragmentInputLocationCHROMIUM(GLuint programs, GLint location, const GLchar * name)
{
    return gl::BindFragmentInputLocationCHROMIUM(programs, location, name);
}

void GL_APIENTRY glProgramPathFragmentInputGenCHROMIUM(GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat * coeffs)
{
...
{
    return gl::GetDebugMessageLogKHR(count, bufSize, sources, types, ids, severities, lengths, messageLog);
}
...
{
    return gl::TexStorage3DMultisampleOES(target, samples, internalformat, width, height, depth, fixedsamplelocations);
}
...
{
    return gl::BindImageTextureContextANGLE(ctx, unit, texture, level, layered, layer, access, format);
}
...
{
    return gl::BlendFuncSeparateContextANGLE(ctx, sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
}
...
{
    return gl::BlitFramebufferContextANGLE(ctx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}
...
{
    return gl::BlitFramebufferANGLEContextANGLE(ctx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}
...
{
    return gl::CompressedTexImage2DContextANGLE(ctx, target, level, internalformat, width, height, border, imageSize, data);
}
...
{
    return gl::CompressedTexImage3DContextANGLE(ctx, target, level, internalformat, width, height, depth, border, imageSize, data);
}
...
{
    return gl::CompressedTexSubImage2DContextANGLE(ctx, target, level, xoffset, yoffset, width, height, format, imageSize, data);
}
...
{
    return gl::CompressedTexSubImage3DContextANGLE(ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
}
...
{
    return gl::CopyBufferSubDataContextANGLE(ctx, readTarget, writeTarget, readOffset, writeOffset, size);
}
...
{
    return gl::CopyTexImage2DContextANGLE(ctx, target, level, internalformat, x, y, width, height, border);
}
...
{
    return gl::CopyTexSubImage2DContextANGLE(ctx, target, level, xoffset, yoffset, x, y, width, height);
}
...
{
    return gl::CopyTexSubImage3DContextANGLE(ctx, target, level, xoffset, yoffset, zoffset, x, y, width, height);
}
...
{
    return gl::FramebufferRenderbufferContextANGLE(ctx, target, attachment, renderbuffertarget, renderbuffer);
}
...
{
    return gl::FramebufferRenderbufferOESContextANGLE(ctx, target, attachment, renderbuffertarget, renderbuffer);
}
...
{
    return gl::FramebufferTexture2DOESContextANGLE(ctx, target, attachment, textarget, texture, level);
}
...
{
    return gl::GetActiveUniformBlockNameContextANGLE(ctx, program, uniformBlockIndex, bufSize, length, uniformBlockName);
}
...
{
    return gl::GetActiveUniformsivContextANGLE(ctx, program, uniformCount, uniformIndices, pname, params);
}
...
{
    return gl::GetDebugMessageLogKHRContextANGLE(ctx, count, bufSize, sources, types, ids, severities, lengths, messageLog);
}
...
{
    return gl::GetFramebufferAttachmentParameterivContextANGLE(ctx, target, attachment, pname, params);
}
...
{
    return gl::GetFramebufferAttachmentParameterivOESContextANGLE(ctx, target, attachment, pname, params);
}
...
{
    return gl::GetProgramResourceNameContextANGLE(ctx, program, programInterface, index, bufSize, length, name);
}
...
{
    return gl::GetProgramResourceivContextANGLE(ctx, program, programInterface, index, propCount, props, bufSize, length, params);
}
...
{
    return gl::GetShaderPrecisionFormatContextANGLE(ctx, shadertype, precisiontype, range, precision);
}
...
{
    return gl::GetTransformFeedbackVaryingContextANGLE(ctx, program, index, bufSize, length, size, type, name);
}
...
{
    return gl::GetUniformIndicesContextANGLE(ctx, program, uniformCount, uniformNames, uniformIndices);
}
...
{
    return gl::InvalidateSubFramebufferContextANGLE(ctx, target, numAttachments, attachments, x, y, width, height);
}
...
{
    return gl::ProgramUniformMatrix2x3fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::ProgramUniformMatrix2x4fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::ProgramUniformMatrix3x2fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::ProgramUniformMatrix3x4fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::ProgramUniformMatrix4x2fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::ProgramUniformMatrix4x3fvContextANGLE(ctx, program, location, count, transpose, value);
}
...
{
    return gl::RenderbufferStorageMultisampleContextANGLE(ctx, target, samples, internalformat, width, height);
}
...
{
    return gl::RenderbufferStorageMultisampleANGLEContextANGLE(ctx, target, samples, internalformat, width, height);
}
...
{
    return gl::TexImage2DContextANGLE(ctx, target, level, internalformat, width, height, border, format, type, pixels);
}
...
{
    return gl::TexImage3DContextANGLE(ctx, target, level, internalformat, width, height, depth, border, format, type, pixels);
}
...
{
    return gl::TexStorage2DMultisampleContextANGLE(ctx, target, samples, internalformat, width, height, fixedsamplelocations);
}
...
{
    return gl::TexStorage3DEXTContextANGLE(ctx, target, levels, internalformat, width, height, depth);
}
...
{
    return gl::TexStorage3DMultisampleOESContextANGLE(ctx, target, samples, internalformat, width, height, depth, fixedsamplelocations);
}
...
{
    return gl::TexSubImage2DContextANGLE(ctx, target, level, xoffset, yoffset, width, height, format, type, pixels);
}
...
{
    return gl::TexSubImage3DContextANGLE(ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
}
...
{
    return gl::UniformBlockBindingContextANGLE(ctx, program, uniformBlockIndex, uniformBlockBinding);
}
...
void GL_APIENTRY glMatrixLoadfCHROMIUMContextANGLE(GLeglContext ctx, GLenum matrixMode, const GLfloat * matrix)
{
...
void GL_APIENTRY glPathCommandsCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLsizei numCommands, const GLubyte * commands, GLsizei numCoords, GLenum coordType, const void* coords)
{
    return gl::PathCommandsCHROMIUMContextANGLE(ctx, path, numCommands, commands, numCoords, coordType, coords);
}

void GL_APIENTRY glPathParameterfCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum pname, GLfloat value)
{
    return gl::PathParameterfCHROMIUMContextANGLE(ctx, path, pname, value);
}

void GL_APIENTRY glPathParameteriCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum pname, GLint value)
{
    return gl::PathParameteriCHROMIUMContextANGLE(ctx, path, pname, value);
}

void GL_APIENTRY glGetPathParameterfvCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum pname, GLfloat * value)
{
    return gl::GetPathParameterfvCHROMIUMContextANGLE(ctx, path, pname, value);
}

void GL_APIENTRY glGetPathParameterivCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum pname, GLint * value)
{
    return gl::GetPathParameterivCHROMIUMContextANGLE(ctx, path, pname, value);
}

void GL_APIENTRY glPathStencilFuncCHROMIUMContextANGLE(GLeglContext ctx, GLenum func, GLint ref, GLuint mask)
{
    return gl::PathStencilFuncCHROMIUMContextANGLE(ctx, func, ref, mask);
}

void GL_APIENTRY glStencilFillPathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum fillMode, GLuint mask)
{
    return gl::StencilFillPathCHROMIUMContextANGLE(ctx, path, fillMode, mask);
}

void GL_APIENTRY glStencilStrokePathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLint reference, GLuint mask)
{
    return gl::StencilStrokePathCHROMIUMContextANGLE(ctx, path, reference, mask);
}

void GL_APIENTRY glCoverFillPathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum coverMode)
{
    return gl::CoverFillPathCHROMIUMContextANGLE(ctx, path, coverMode);
}

void GL_APIENTRY glCoverStrokePathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum coverMode)
{
    return gl::CoverStrokePathCHROMIUMContextANGLE(ctx, path, coverMode);
}

void GL_APIENTRY glStencilThenCoverFillPathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode)
{
    return gl::StencilThenCoverFillPathCHROMIUMContextANGLE(ctx, path, fillMode, mask, coverMode);
}

void GL_APIENTRY glStencilThenCoverStrokePathCHROMIUMContextANGLE(GLeglContext ctx, GLuint path, GLint reference, GLuint mask, GLenum coverMode)
{
    return gl::StencilThenCoverStrokePathCHROMIUMContextANGLE(ctx, path, reference, mask, coverMode);
}

void GL_APIENTRY glCoverFillPathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::CoverFillPathInstancedCHROMIUMContextANGLE(ctx, numPath, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}

void GL_APIENTRY glCoverStrokePathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::CoverStrokePathInstancedCHROMIUMContextANGLE(ctx, numPath, pathNameType, paths, pathBase, coverMode, transformType, transformValues);
}

void GL_APIENTRY glStencilStrokePathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPath, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilStrokePathInstancedCHROMIUMContextANGLE(ctx, numPath, pathNameType, paths, pathBase, reference, mask, transformType, transformValues);
}

void GL_APIENTRY glStencilFillPathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilFillPathInstancedCHROMIUMContextANGLE(ctx, numPaths, pathNameType, paths, pathBase, fillMode, mask, transformType, transformValues);
}

void GL_APIENTRY glStencilThenCoverFillPathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilThenCoverFillPathInstancedCHROMIUMContextANGLE(ctx, numPaths, pathNameType, paths, pathBase, fillMode, mask, coverMode, transformType, transformValues);
}

void GL_APIENTRY glStencilThenCoverStrokePathInstancedCHROMIUMContextANGLE(GLeglContext ctx, GLsizei numPaths, GLenum pathNameType, const void * paths, GLuint pathBase, GLint reference, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat * transformValues)
{
    return gl::StencilThenCoverStrokePathInstancedCHROMIUMContextANGLE(ctx, numPaths, pathNameType, paths, pathBase, reference, mask, coverMode, transformType, transformValues);
}

void GL_APIENTRY glBindFragmentInputLocationCHROMIUMContextANGLE(GLeglContext ctx, GLuint programs, GLint location, const GLchar * name)
{
    return gl::BindFragmentInputLocationCHROMIUMContextANGLE(ctx, programs, location, name);
}

void GL_APIENTRY glProgramPathFragmentInputGenCHROMIUMContextANGLE(GLeglContext ctx, GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat * coeffs)
{
    return gl::ProgramPathFragmentInputGenCHROMIUMContextANGLE(ctx, program, location, genMode, components, coeffs);
}
...
{
    return gl::CopySubTextureCHROMIUMContextANGLE(ctx, sourceId, sourceLevel, destTarget, destId, destLevel, xoffset, yoffset, x, y, width, height, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
}
...
{
    return gl::GetBufferParameterivRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetFramebufferAttachmentParameterivRobustANGLEContextANGLE(ctx, target, attachment, pname, bufSize, length, params);
}
...
{
    return gl::GetRenderbufferParameterivRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetTexParameterfvRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetTexParameterivRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetVertexAttribPointervRobustANGLEContextANGLE(ctx, index, pname, bufSize, length, pointer);
}
...
{
    return gl::ReadPixelsRobustANGLEContextANGLE(ctx, x, y, width, height, format, type, bufSize, length, columns, rows, pixels);
}
...
{
    return gl::TexImage2DRobustANGLEContextANGLE(ctx, target, level, internalformat, width, height, border, format, type, bufSize, pixels);
}
...
{
    return gl::TexSubImage2DRobustANGLEContextANGLE(ctx, target, level, xoffset, yoffset, width, height, format, type, bufSize, pixels);
}
...
{
    return gl::TexImage3DRobustANGLEContextANGLE(ctx, target, level, internalformat, width, height, depth, border, format, type, bufSize, pixels);
}
...
{
    return gl::TexSubImage3DRobustANGLEContextANGLE(ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, bufSize, pixels);
}
...
{
    return gl::CompressedTexImage2DRobustANGLEContextANGLE(ctx, target, level, internalformat, width, height, border, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexSubImage2DRobustANGLEContextANGLE(ctx, target, level, xoffset, yoffset, width, height, format, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexImage3DRobustANGLEContextANGLE(ctx, target, level, internalformat, width, height, depth, border, imageSize, dataSize, data);
}
...
{
    return gl::CompressedTexSubImage3DRobustANGLEContextANGLE(ctx, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, dataSize, data);
}
...
{
    return gl::GetBufferPointervRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetInternalformativRobustANGLEContextANGLE(ctx, target, internalformat, pname, bufSize, length, params);
}
...
{
    return gl::GetVertexAttribIivRobustANGLEContextANGLE(ctx, index, pname, bufSize, length, params);
}
...
{
    return gl::GetVertexAttribIuivRobustANGLEContextANGLE(ctx, index, pname, bufSize, length, params);
}
...
{
    return gl::GetUniformuivRobustANGLEContextANGLE(ctx, program, location, bufSize, length, params);
}
...
{
    return gl::GetActiveUniformBlockivRobustANGLEContextANGLE(ctx, program, uniformBlockIndex, pname, bufSize, length, params);
}
...
{
    return gl::GetBufferParameteri64vRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetSamplerParameterivRobustANGLEContextANGLE(ctx, sampler, pname, bufSize, length, params);
}
...
{
    return gl::GetSamplerParameterfvRobustANGLEContextANGLE(ctx, sampler, pname, bufSize, length, params);
}

void GL_APIENTRY glGetFramebufferParameterivRobustANGLEContextANGLE(GLeglContext ctx, GLuint sampler, GLenum pname, GLsizei bufSize, GLsizei * length, GLint * params)
{
    return gl::GetFramebufferParameterivRobustANGLEContextANGLE(ctx, sampler, pname, bufSize, length, params);
}
...
{
    return gl::GetProgramInterfaceivRobustANGLEContextANGLE(ctx, program, programInterface, pname, bufSize, length, params);
}
...
{
    return gl::GetTexLevelParameterivRobustANGLEContextANGLE(ctx, target, level, pname, bufSize, length, params);
}
...
{
    return gl::GetTexLevelParameterfvRobustANGLEContextANGLE(ctx, target, level, pname, bufSize, length, params);
}
...
{
    return gl::ReadnPixelsRobustANGLEContextANGLE(ctx, x, y, width, height, format, type, bufSize, length, columns, rows, data);
}
...
{
    return gl::GetnUniformfvRobustANGLEContextANGLE(ctx, program, location, bufSize, length, params);
}
...
{
    return gl::GetnUniformivRobustANGLEContextANGLE(ctx, program, location, bufSize, length, params);
}
...
{
    return gl::GetnUniformuivRobustANGLEContextANGLE(ctx, program, location, bufSize, length, params);
}
...
{
    return gl::GetTexParameterIivRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetTexParameterIuivRobustANGLEContextANGLE(ctx, target, pname, bufSize, length, params);
}
...
{
    return gl::GetSamplerParameterIivRobustANGLEContextANGLE(ctx, sampler, pname, bufSize, length, params);
}
...
{
    return gl::GetSamplerParameterIuivRobustANGLEContextANGLE(ctx, sampler, pname, bufSize, length, params);
}
...
void GL_APIENTRY glFramebufferTextureMultiviewLayeredANGLEContextANGLE(GLeglContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLint baseViewIndex, GLsizei numViews)
{
    return gl::FramebufferTextureMultiviewLayeredANGLEContextANGLE(ctx, target, attachment, texture, level, baseViewIndex, numViews);
}

void GL_APIENTRY glFramebufferTextureMultiviewSideBySideANGLEContextANGLE(GLeglContext ctx, GLenum target, GLenum attachment, GLuint texture, GLint level, GLsizei numViews, const GLint * viewportOffsets)
{
    return gl::FramebufferTextureMultiviewSideBySideANGLEContextANGLE(ctx, target, attachment, texture, level, numViews, viewportOffsets);
}
...
{
    return gl::CopySubTexture3DANGLEContextANGLE(ctx, sourceId, sourceLevel, destTarget, destId, destLevel, xoffset, yoffset, zoffset, x, y, z, width, height, depth, unpackFlipY, unpackPremultiplyAlpha, unpackUnmultiplyAlpha);
}
...
{
    return gl::TexStorage2DMultisampleANGLEContextANGLE(ctx, target, samples, internalformat, width, height, fixedsamplelocations);
}
...
{
    return gl::MultiDrawArraysInstancedANGLEContextANGLE(ctx, mode, firsts, counts, instanceCounts, drawcount);
}
...
{
    return gl::MultiDrawElementsInstancedANGLEContextANGLE(ctx, mode, counts, type, indices, instanceCounts, drawcount);
}
