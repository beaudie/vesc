...
class Shader
{
  ...
  public:
    ...
    const std::vector<gl::Uniform> &getUniforms() const;
    const std::vector<gl::InterfaceBlock> &getInterfaceBlocks() const;
    std::vector<gl::Varying> &getVaryings();
  ...
  protected:
    ...
    static bool compareVarying(const gl::ShaderVariable &x, const gl::ShaderVariable &y);

    const rx::Renderer *const mRenderer;

    std::vector<gl::Varying> mVaryings;
...
class VertexShader : public Shader
{
  ...
  public:
    ...
    const std::vector<gl::Attribute> &activeAttributes() const { return mActiveAttributes; }
