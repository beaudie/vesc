...
class DynamicHLSL
{
  public:
    ...
    static void getConvertedInputLayout(const VertexFormat inputLayout[], const Attribute shaderAttributes[], GLenum *convertedLayout);
  ...
  private:
    ...
    static GLenum getConvertedAttributeType(const VertexFormat &vertexFormat, const ShaderVariable &shaderAttrib);
};
