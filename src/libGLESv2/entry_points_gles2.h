...
// entry_points_gles2.h : Defines the GLES 2.0 entry points.

#ifndef LIBGLESV2_ENTRYPOINTGLES2_H_
#define LIBGLESV2_ENTRYPOINTGLES2_H_
...
#endif // LIBGLESV2_ENTRYPOINTGLES2_H_
