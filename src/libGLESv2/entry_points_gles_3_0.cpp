                                   ...
                                   const void *indices)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DrawRangeElements>(mode, start, end, count, type, indices);
                                       ...
                                       GLsizei instanceCount)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DrawElementsInstanced>(mode, count, type, indices,
                                                               instanceCount);
