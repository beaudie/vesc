...
static std::string parseObjectLabel(GLsizei length, const GLchar *label)
{
...
static void getObjectLabelBase(const std::string &objectLabel, GLsizei bufSize, GLsizei *length, GLchar *label)
{
    ...
    {
        writeLength = objectLabel.length();
    }
...
void GL_APIENTRY ObjectLabelKHR(GLenum identifier, GLuint name, GLsizei length, const GLchar *label)
{
    ...
    if (context)
    {
        ...
        std::string labelName = parseObjectLabel(length, label);
