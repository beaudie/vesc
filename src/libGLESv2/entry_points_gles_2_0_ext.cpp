...
ANGLE_EXPORT void GL_APIENTRY GetPathParameterfCHROMIUM(GLuint path, GLenum pname, GLfloat *value)
{
    ...
    {
        if (!context->skipValidation() &&
            !ValidateGetPathParameterfCHROMIUM(context, path, pname, value))
        {
            return;
        }
        context->getPathParameterf(path, pname, value);
    }
}
...
ANGLE_EXPORT void GL_APIENTRY GetPathParameteriCHROMIUM(GLuint path, GLenum pname, GLint *value)
{
    ...
    {
        if (!context->skipValidation() &&
            !ValidateGetPathParameteriCHROMIUM(context, path, pname, value))
        {
            return;
        }
        context->getPathParameteri(path, pname, value);
    }
}
