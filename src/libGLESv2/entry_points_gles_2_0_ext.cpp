                                            ...
                                            GLsizei primcount)
{
    ...
    if (context)
    {
        context->saveParams<EntryPoint::DrawElementsInstancedANGLE>(mode, count, type, indices,
                                                                    primcount);
                                                     ...
                                                     GLboolean *params)
{
    ...
    if (context)
    {
        ...
        {
            context->getBooleanvImpl(pname, params);
        }
        else
        {
                                                   ...
                                                   GLfloat *params)
{
    ...
    if (context)
    {
        ...
        {
            context->getFloatvImpl(pname, params);
        }
        else
        {
            CastStateValues(context, nativeType, pname, numParams, params);
                                                     ...
                                                     GLint *data)
{
    ...
    if (context)
    {
        ...
        {
            context->getIntegervImpl(pname, data);
        }
        else
        {
