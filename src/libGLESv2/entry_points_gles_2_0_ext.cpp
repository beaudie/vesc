                                                  ...
                                                  GLboolean unpackUnmultiplyAlpha)
{
    ...
    if (context)
    {
        if (!ValidateCopyTextureCHROMIUM(context, sourceId, destId, internalFormat, destType,
                                                     ...
                                                     GLboolean unpackUnmultiplyAlpha)
{
    ...
    if (context)
    {
        if (!ValidateCopySubTextureCHROMIUM(context, sourceId, destId, xoffset, yoffset, x, y,
