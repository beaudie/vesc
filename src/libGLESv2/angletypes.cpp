...
bool VertexFormat::operator<(const VertexFormat& other) const
{
    return ANGLE_LESS_THAN_HELPER(mType, other.mType) :
           ANGLE_LESS_THAN_HELPER(mNormalized, other.mNormalized) :
           ANGLE_LESS_THAN_HELPER(mComponents, other.mComponents) :
           mPureInteger < other.mPureInteger;
}
