...
GLenum DynamicHLSL::getConvertedAttributeType(const VertexFormat &vertexFormat, const ShaderVariable &shaderAttrib)
{
    ...
    else
    {
        switch (shaderComponentCount)
        {
          case 1:  return GL_CONVERTED_FLOAT_ANGLEX;
          case 2:  return GL_CONVERTED_VEC2_ANGLEX;
          case 3:  return GL_CONVERTED_VEC3_ANGLEX;
          case 4:  return GL_CONVERTED_VEC4_ANGLEX;
          default: UNREACHABLE(); return GL_NONE;
        }
    }
}
