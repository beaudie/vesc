...
std::string DynamicHLSL::generateGeometryShaderHLSL(int registers, Shader *fragmentShader, Shader *vertexShader) const
{
    ...
    return generatePointSpriteHLSL(registers, fragmentShaderD3D, vertexShaderD3D);
}
