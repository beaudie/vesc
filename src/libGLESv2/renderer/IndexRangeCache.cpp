...
static Range2ui ComputeTypedRange(const IndexType *indices, GLsizei count)
{
...
Range2ui IndexRangeCache::ComputeRange(GLenum type, const GLvoid *indices, GLsizei count)
{
    switch (type)
    {
...
void IndexRangeCache::addRange(GLenum type, unsigned int offset, GLsizei count, const Range2ui &range,
...
bool IndexRangeCache::findRange(GLenum type, unsigned int offset, GLsizei count,
                                Range2ui *outRange, unsigned int *outStreamOffset) const
{
    ...
    {
        if (outRange)        *outRange = Range2ui(0, 0);
...
IndexRangeCache::IndexBounds::IndexBounds(const Range2ui &rangeIn, unsigned int offset)
