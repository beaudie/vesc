...
class TextureD3D_2D : public TextureD3D
{
  ...
  private:
    ...
    gl::Error createCompleteStorage(bool renderTarget, TextureStorageInterface2D **outTexStorage) const;
    gl::Error setCompleteTexStorage(TextureStorageInterface2D *newCompleteTexStorage);
...
class TextureD3D_Cube : public TextureD3D
{
  ...
  private:
    ...
    virtual gl::Error initializeStorage(bool renderTarget);
    gl::Error createCompleteStorage(bool renderTarget, TextureStorageInterfaceCube **outTexStorage) const;
    gl::Error setCompleteTexStorage(TextureStorageInterfaceCube *newCompleteTexStorage);
...
class TextureD3D_3D : public TextureD3D
{
  ...
  private:
    ...
    virtual gl::Error initializeStorage(bool renderTarget);
    gl::Error createCompleteStorage(bool renderTarget, TextureStorageInterface3D **outStorage) const;
    gl::Error setCompleteTexStorage(TextureStorageInterface3D *newCompleteTexStorage);
...
class TextureD3D_2DArray : public TextureD3D
{
  ...
  private:
    ...
    virtual gl::Error initializeStorage(bool renderTarget);
    gl::Error createCompleteStorage(bool renderTarget, TextureStorageInterface2DArray **outStorage) const;
    gl::Error setCompleteTexStorage(TextureStorageInterface2DArray *newCompleteTexStorage);
