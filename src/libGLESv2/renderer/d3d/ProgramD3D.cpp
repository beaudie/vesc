...
void ProgramD3D::applyUniforms(const std::vector<gl::LinkedUniform*> &uniforms)
{
    mRenderer->applyUniforms(*this, uniforms);
}

bool ProgramD3D::applyUniformBuffers(const std::vector<gl::UniformBlock*> uniformBlocks, const std::vector<gl::Buffer*> boundBuffers,
                                     const gl::Caps &caps)
{
