...
// Shader11.cpp: Defines the rx::Shader11 class which implements rx::ShaderImpl.
...
namespace rx
{
    ...
    void ShaderD3D::initializeCompiler()
    {
        if (!mFragmentCompiler)
        {
            ...
            if (result)
            {
                ...
                resources.MaxVertexAttribs = gl::MAX_VERTEX_ATTRIBS;
                ...
                resources.MaxTextureImageUnits = gl::MAX_TEXTURE_IMAGE_UNITS;
    ...
    void VertexShaderD3D::compile(const std::string &source)
    {
        uncompile();
    ...
    void FragmentShaderD3D::compile(const std::string &source)
    {
        uncompile();
