...
EGLint SwapChain9::reset(int backbufferWidth, int backbufferHeight, EGLint swapInterval)
{
    ...
    const gl_d3d9::D3D9FormatInfo &backBufferd3dFormatInfo = gl_d3d9::GetD3D9FormatInfo(mBackBufferFormat);
    ...
    const gl_d3d9::D3D9FormatInfo &depthBufferd3dFormatInfo = gl_d3d9::GetD3D9FormatInfo(mDepthBufferFormat);
