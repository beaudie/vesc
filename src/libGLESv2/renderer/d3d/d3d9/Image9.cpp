...
void Image9::createSurface()
{
    ...
    if (mWidth != 0 && mHeight != 0)
    {
        ...
        if (d3dFormatInfo.dataInitializerFunction != NULL)
        {
            ...
            d3dFormatInfo.dataInitializerFunction(mWidth, mHeight, 1, lockedRect.pBits, lockedRect.Pitch, 0);
                      ...
                      GLint unpackAlignment, GLenum type, const void *input)
{
    ...
    d3dFormatInfo.loadFunction(width, height, depth, input, inputRowPitch, 0, locked.pBits, locked.Pitch, 0);
                                ...
                                const void *input)
{
    ...
    d3d9FormatInfo.loadFunction(width, height, depth, input, inputRowPitch, inputDepthPitch,
