...
void Image9::createSurface()
{
    ...
    if (mWidth != 0 && mHeight != 0)
    {
        ...
        const gl_d3d9::D3D9Format &d3dFormatInfo = gl_d3d9::GetD3D9FormatInfo(mInternalFormat);
                                ...
                                const void *input)
{
    ...
    const gl_d3d9::D3D9Format &d3d9FormatInfo = gl_d3d9::GetD3D9FormatInfo(mInternalFormat);
