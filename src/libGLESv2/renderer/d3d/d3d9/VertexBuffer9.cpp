                                          ...
                                          GLint start, GLsizei count, GLsizei instances, unsigned int offset)
{
    if (mVertexBuffer)
    {
        ...
        const d3d9::D3D9VertexFormatInfo &d3dVertexInfo = d3d9::GetD3D9VertexFormatInfo(mRenderer->getCapsDeclTypes(), vertexFormat);
                                  ...
                                  unsigned int *outSpaceRequired) const
{
    ...
    const d3d9::D3D9VertexFormatInfo &d3d9VertexInfo = d3d9::GetD3D9VertexFormatInfo(mRenderer->getCapsDeclTypes(), vertexFormat);
