...
gl::Error Renderer9::copyToRenderTarget(TextureStorageInterface2D *dest, TextureStorageInterface2D *source)
{
    if (!source || !dest)
    {
        return gl::Error(GL_OUT_OF_MEMORY, "Internal texture storage was unexpectedly NULL.");
    }
...
gl::Error Renderer9::copyToRenderTarget(TextureStorageInterfaceCube *dest, TextureStorageInterfaceCube *source)
{
    if (!source || !dest)
    {
        return gl::Error(GL_OUT_OF_MEMORY, "Internal texture storage was unexpectedly NULL.");
...
gl::Error Renderer9::copyToRenderTarget(TextureStorageInterface3D *dest, TextureStorageInterface3D *source)
{
...
gl::Error Renderer9::copyToRenderTarget(TextureStorageInterface2DArray *dest, TextureStorageInterface2DArray *source)
{
...
gl::Error Renderer9::copyImage(gl::Framebuffer *framebuffer, const gl::Rectangle &sourceRect, GLenum destFormat,
