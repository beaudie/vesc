...
gl::Error Renderer9::applyVertexBuffer(gl::ProgramBinary *programBinary, const gl::State &state,
...
void Renderer9::applyTransformFeedbackBuffers(const std::vector<gl::Buffer*> &transformFeedbackBuffers, std::vector<GLintptr> offsets)
{
    UNREACHABLE();
}
