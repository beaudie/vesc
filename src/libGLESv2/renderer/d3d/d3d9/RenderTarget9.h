...
{
  public:
    SurfaceRenderTarget9(IDirect3DSurface9 *surface, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth,
                         GLsizei samples);
    virtual ~SurfaceRenderTarget9();

    GLsizei getWidth() const override { return mWidth; }
    GLsizei getHeight() const override { return mHeight; }
    GLsizei getDepth() const override { return mDepth; }
    GLenum getInternalFormat() const override { return mInternalFormat; }
    GLenum getActualFormat() const override { return mActualFormat; }
    GLsizei getSamples() const override { return mSamples; }
