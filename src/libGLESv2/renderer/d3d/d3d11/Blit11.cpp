                            ...
                            GLenum swizzleRed, GLenum swizzleGreen, GLenum swizzleBlue, GLenum swizzleAlpha)
{
    ...
    const d3d11::DXGIFormatInfo &dxgiFormatInfo = d3d11::GetDXGIFormatInfo(sourceSRVDesc.Format);
                         ...
                         const gl::Rectangle *scissor, GLenum destFormat, GLenum filter)
{
    ...
    const d3d11::DXGIFormatInfo &dxgiFormatInfo = d3d11::GetDXGIFormatInfo(sourceSRVDesc.Format);
    const gl::InternalFormatInfo &internalFormatInfo = gl::GetInternalFormatInfo(dxgiFormatInfo.internalFormat);
