...
// format.
typedef std::map<GLenum, D3D11Format> D3D11ES3FormatMap;
...
const D3D11Format &GetD3D11FormatInfo(GLenum internalFormat)
{
    ...
    {
        static const D3D11Format defaultInfo;
        return defaultInfo;
    }
}

typedef std::map<gl::VertexFormat, D3D11VertexFormat> D3D11VertexFormatInfoMap;
typedef std::pair<gl::VertexFormat, D3D11VertexFormat> D3D11VertexFormatPair;
...
const D3D11VertexFormat &GetD3D11VertexInfo(const gl::VertexFormat &vertexFormat)
{
    ...
    {
        static const D3D11VertexFormat defaultInfo;
        return defaultInfo;
    }
}
