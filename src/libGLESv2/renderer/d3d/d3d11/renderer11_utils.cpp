...
static gl::TextureCaps GenerateTextureFormatCaps(GLenum internalFormat, ID3D11Device *device)
{
    ...
    const gl_d3d11::D3D11Format &formatInfo = gl_d3d11::GetD3D11FormatInfo(internalFormat);
...
{
    const gl_d3d11::D3D11Format &d3dFormatInfo = gl_d3d11::GetD3D11FormatInfo(internalFormat);
