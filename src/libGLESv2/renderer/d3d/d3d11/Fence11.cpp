...
FenceNV11::FenceNV11(rx::Renderer11 *renderer)
    : FenceNVImpl(),
      mRenderer(renderer),
      mQuery(NULL)
{
...
FenceSync11::FenceSync11(rx::Renderer11 *renderer)
    : FenceSyncImpl(),
      mRenderer(renderer),
      mQuery(NULL)
{
...
gl::Error FenceSync11::test(bool flushCommandBuffer, GLboolean *outFinished)
{
    return FenceTestHelper(this, flushCommandBuffer, outFinished);
}
