...
SwapChain11::SwapChain11(Renderer11 *renderer, rx::SurfaceHandler handler, HANDLE shareHandle,
                         GLenum backBufferFormat, GLenum depthBufferFormat)
    : mRenderer(renderer),
      SwapChain(handler, shareHandle, backBufferFormat, depthBufferFormat)
{
    mSwapChain = NULL;
...
EGLint SwapChain11::resetOffscreenTexture(int backbufferWidth, int backbufferHeight)
{
    ...
    {
        const bool useSharedResource = !mHandler.getNativeWindow() && mRenderer->getShareHandleSupport();
...
EGLint SwapChain11::reset(int backbufferWidth, int backbufferHeight, EGLint swapInterval)
{
    ...
    if (mHandler.getNativeWindow())
    {
        ...
        HRESULT result = mHandler.createSwapChain(device, mRenderer->getDxgiFactory(),
