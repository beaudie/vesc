...
gl::Error TextureStorage11_2D::getRenderTarget(const gl::ImageIndex &index, RenderTarget **outRT)
{
    ...
    if (!mRenderTarget[level])
    {
        ...
        if (mRenderTargetFormat != DXGI_FORMAT_UNKNOWN)
        {
            ...
            mRenderTarget[level] = new TextureRenderTarget11(rtv, texture, srv, mInternalFormat, getLevelWidth(level), getLevelHeight(level), 1, 1);
        ...
        else if (mDepthStencilFormat != DXGI_FORMAT_UNKNOWN)
        {
            ...
            mRenderTarget[level] = new TextureRenderTarget11(dsv, texture, srv, mInternalFormat, getLevelWidth(level), getLevelHeight(level), 1, 1);
...
gl::Error TextureStorage11_Cube::getRenderTarget(const gl::ImageIndex &index, RenderTarget **outRT)
{
    ...
    if (!mRenderTarget[faceIndex][level])
    {
        ...
        if (mRenderTargetFormat != DXGI_FORMAT_UNKNOWN)
        {
            ...
            mRenderTarget[faceIndex][level] = new TextureRenderTarget11(rtv, texture, srv, mInternalFormat, getLevelWidth(level), getLevelHeight(level), 1, 1);
        ...
        else if (mDepthStencilFormat != DXGI_FORMAT_UNKNOWN)
        {
            ...
            mRenderTarget[faceIndex][level] = new TextureRenderTarget11(dsv, texture, srv, mInternalFormat, getLevelWidth(level), getLevelHeight(level), 1, 1);
...
gl::Error TextureStorage11_3D::getRenderTarget(const gl::ImageIndex &index, RenderTarget **outRT)
{
    ...
    if (!index.hasLayer())
    {
        if (!mLevelRenderTargets[mipLevel])
        {
            ...
            mLevelRenderTargets[mipLevel] = new TextureRenderTarget11(rtv, texture, srv, mInternalFormat, getLevelWidth(mipLevel), getLevelHeight(mipLevel), getLevelDepth(mipLevel), 1);
    ...
    else
    {
        ...
        if (mLevelLayerRenderTargets.find(key) == mLevelLayerRenderTargets.end())
        {
            ...
            mLevelLayerRenderTargets[key] = new TextureRenderTarget11(rtv, texture, srv, mInternalFormat, getLevelWidth(mipLevel), getLevelHeight(mipLevel), 1, 1);
...
gl::Error TextureStorage11_2DArray::getRenderTarget(const gl::ImageIndex &index, RenderTarget **outRT)
{
    ...
    if (mRenderTargets.find(key) == mRenderTargets.end())
    {
        ...
        if (mRenderTargetFormat != DXGI_FORMAT_UNKNOWN)
        {
            ...
            mRenderTargets[key] = new TextureRenderTarget11(rtv, texture, srv, mInternalFormat, getLevelWidth(mipLevel), getLevelHeight(mipLevel), 1, 1);
