...
void Clear11::clearFramebuffer(const gl::ClearParameters &clearParams, gl::Framebuffer *frameBuffer)
{
    ...
    std::vector<MaskAndRenderTarget> maskedClearRenderTargets;
...
ID3D11BlendState *Clear11::getBlendState(const std::vector<MaskAndRenderTarget>& rts)
{
