...
{
  public:
    Renderer11(egl::Display *display, EGLNativeDisplayType hDc, egl::RequestedDisplayAttributes requestedDisplayAttributes);
    virtual ~Renderer11();
  ...
  private:
    ...
    HMODULE mDxgiModule;
    HDC mDc;
    egl::RequestedDisplayAttributes mRequestedDisplayAttributes;
