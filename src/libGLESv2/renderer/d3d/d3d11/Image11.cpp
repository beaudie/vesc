...
void Image11::generateMipmap(Image11 *dest, Image11 *src)
{
    ...
    const d3d11::DXGIFormatInfo &dxgiFormatInfo = d3d11::GetDXGIFormatInfo(src->getDXGIFormat());
...
bool Image11::isDirty() const
{
    ...
    return (mDirty && (mStagingTexture || gl_d3d11::GetD3D11FormatInfo(mInternalFormat).dataInitializerFunction != NULL));
}
                       ...
                       GLint unpackAlignment, GLenum type, const void *input)
{
    ...
    const d3d11::DXGIFormatInfo &dxgiFormatInfo = d3d11::GetDXGIFormatInfo(mDXGIFormat);
    GLuint outputPixelSize = dxgiFormatInfo.pixelBytes;

    const gl_d3d11::D3D11FormatInfo &d3dFormatInfo = gl_d3d11::GetD3D11FormatInfo(mInternalFormat);
...
void Image11::createStagingTexture()
{
    ...
    if (mWidth > 0 && mHeight > 0 && mDepth > 0)
    {
        ...
        if (mTarget == GL_TEXTURE_3D)
        {
            ...
            if (gl_d3d11::GetD3D11FormatInfo(mInternalFormat).dataInitializerFunction != NULL)
            {
