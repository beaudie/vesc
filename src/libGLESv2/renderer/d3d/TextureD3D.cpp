...
{
    GLenum sizedInternalFormat = gl::GetInternalFormatInfo(internalFormat).pixelBytes > 0 ? internalFormat
                                                                                          : gl::GetFormatTypeInfo(format, type).internalFormat;
...
bool TextureD3D_2D::isSamplerComplete(const gl::SamplerState &samplerState) const
{
    ...
    const gl::InternalFormatInfo &formatInfo = gl::GetInternalFormatInfo(getInternalFormat(0));
...
{
    int faceIndex = targetToIndex(target);
    GLenum sizedInternalFormat = gl::GetInternalFormatInfo(format).pixelBytes > 0 ? format
                                                                                  : gl::GetFormatTypeInfo(format, GL_UNSIGNED_BYTE).internalFormat;
...
void TextureD3D_2DArray::setImage(GLint level, GLsizei width, GLsizei height, GLsizei depth, GLenum internalFormat, GLenum format, GLenum type, const gl::PixelUnpackState &unpack, const void *pixels)
{
    ...
    const gl::InternalFormatInfo &formatInfo = gl::GetInternalFormatInfo(sizedInternalFormat);
...
void TextureD3D_2DArray::setCompressedImage(GLint level, GLenum format, GLsizei width, GLsizei height, GLsizei depth, GLsizei imageSize, const void *pixels)
{
    ...
    const gl::InternalFormatInfo &formatInfo = gl::GetInternalFormatInfo(format);
...
{
    const gl::InternalFormatInfo &formatInfo = gl::GetInternalFormatInfo(getInternalFormat(level));
    GLsizei inputDepthPitch = formatInfo.computeDepthPitch(type, width, height, unpack.alignment);
