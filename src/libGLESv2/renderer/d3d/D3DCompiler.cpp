...
#include "libGLESv2/renderer/d3d/D3DCompiler.h"
...
ShaderBlob *D3DCompiler::compileToBinary(gl::InfoLog &infoLog, const char *hlsl, const char *profile,
