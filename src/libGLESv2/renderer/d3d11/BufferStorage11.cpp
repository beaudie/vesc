...
{
    DirectBufferStorage11 *storage = getStorage(BUFFER_USAGE_PIXEL);
    ...
    bufferSRVDesc.Buffer.ElementWidth = storage->getSize() / d3d11::GetFormatPixelBytes(srvFormat, mRenderer->getCurrentClientVersion());
