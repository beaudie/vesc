...
class Buffer11 : public BufferD3D
{
  ...
  private:
    ...
    TypedBuffer11 *mMappedStorage;

    std::map<BufferUsage, TypedBuffer11*> mTypedBuffers;
    ...
    TypedBuffer11 *getTypedBuffer(BufferUsage usage);
    TypedBuffer11 *getLatestTypedBuffer() const;
};
