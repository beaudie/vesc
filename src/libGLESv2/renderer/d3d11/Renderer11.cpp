                                 ...
                                 GLenum type, GLuint outputPitch, const gl::PixelPackState &pack, void *pixels)
{
    ...
    safeArea.width  = gl::clamp(area.width  - negativeX, 0, static_cast<int>(textureDesc.Width)  - safeArea.x);
    safeArea.height = gl::clamp(area.height - negativeY, 0, static_cast<int>(textureDesc.Height) - safeArea.y);
