...
EGLint Renderer11::initialize()
{
    ...
    mCaps = d3d11_gl::GenerateCaps(mDevice);
...
const gl::Caps &Renderer11::getCaps() const
{
    return mCaps;
}
...
bool Renderer11::getShareHandleSupport() const
{
    ...
    return mCaps.extensions.textureFormatBGRA8888 && !gl::perfActive();
}
...
bool Renderer11::supportsFastCopyBufferToTexture(GLenum internalFormat) const
{
    ...
    if (!gl::GetTextureCaps(mCaps.textureCaps, internalFormat).colorRendering)
    {
        return false;
    }
