...
class Renderer11 : public Renderer
{
  ...
  private:
    ...
    ID3D11ShaderResourceView *mCurVertexTextures[gl::IMPLEMENTATION_MAX_VERTEX_TEXTURE_IMAGE_UNITS];
    ID3D11ShaderResourceView *mCurPixelTextures[gl::MAX_TEXTURE_IMAGE_UNITS];
