...
class TextureStorage11 : public TextureStorage
{
  ...
  protected:
    ...
    virtual void createSRV(int baseLevel, int mipLevels, DXGI_FORMAT format, ID3D11Resource *texture, ID3D11ShaderResourceView **SRV) = 0;
...
class TextureStorage11_2D : public TextureStorage11
{
  ...
  private:
   ...
   virtual void createSRV(int baseLevel, int mipLevels, DXGI_FORMAT format, ID3D11Resource *texture, ID3D11ShaderResourceView **SRV);
