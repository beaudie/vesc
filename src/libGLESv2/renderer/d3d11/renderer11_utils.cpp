...
gl::Caps GenerateCaps(ID3D11Device *device)
{
    ...
    {
        caps.textureCaps[*internalFormat] = GenerateTextureFormatCaps(*internalFormat, device);
    }
    ...
    caps.max3DTextureSize = d3d11::GetMaximum3DTextureSize(featureLevel);
    caps.max2DTextureSize = d3d11::GetMaximum2DTextureSize(featureLevel);
    caps.maxCubeMapTextureSize = d3d11::GetMaximumCubeMapTextureSize(featureLevel);
    caps.maxArrayTextureLayers = d3d11::GetMaximum2DTextureArraySize(featureLevel);
    ...
    // increased to 16
    caps.maxDrawBuffers = d3d11::GetMaximumSimultaneousRenderTargets(featureLevel);
    caps.maxColorAttachments = d3d11::GetMaximumSimultaneousRenderTargets(featureLevel);

    // D3D11 has the same limit for viewport width and height
    caps.maxViewportWidth = d3d11::GetMaximumViewportSize(featureLevel);
    ...
    caps.extensions.textureFormatBGRA8888 = gl::GetBGRA8TextureSupport(caps.textureCaps);
    ...
    caps.extensions.textureHalfFloat = gl::GetHalfFloatTextureSupport(caps.textureCaps);
    caps.extensions.textureHalfFloatLinear = gl::GetHalfFloatTextureFilteringSupport(caps.textureCaps);
    caps.extensions.textureFloat = gl::GetFloatTextureSupport(caps.textureCaps);
    caps.extensions.textureFloatLinear = gl::GetFloatTextureFilteringSupport(caps.textureCaps);
    caps.extensions.textureRG = gl::GetRGTextureSupport(caps.textureCaps, caps.extensions.textureHalfFloat, caps.extensions.textureFloat);
    caps.extensions.textureCompressionDXT1 = gl::GetDXT1TextureSupport(caps.textureCaps);
    caps.extensions.textureCompressionDXT3 = gl::GetDXT3TextureSupport(caps.textureCaps);
    caps.extensions.textureCompressionDXT5 = gl::GetDXT5TextureSupport(caps.textureCaps);
    caps.extensions.depthTextures = gl::GetDepthTextureSupport(caps.textureCaps);
    ...
    caps.extensions.colorBufferFloat = gl::GetColorBufferFloatSupport(caps.textureCaps);
