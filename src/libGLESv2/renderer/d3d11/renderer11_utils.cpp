...
std::pair<int, int> GetViewportRange(D3D_FEATURE_LEVEL featureLevel)
{
    switch (featureLevel)
    {
      case D3D_FEATURE_LEVEL_11_1:
      case D3D_FEATURE_LEVEL_11_0: return std::make_pair(D3D11_VIEWPORT_BOUNDS_MIN, D3D11_VIEWPORT_BOUNDS_MAX);

      case D3D_FEATURE_LEVEL_10_1:
      case D3D_FEATURE_LEVEL_10_0: return std::make_pair(D3D10_VIEWPORT_BOUNDS_MIN, D3D10_VIEWPORT_BOUNDS_MAX);

      // No constants for D3D9 viewport size limits, use the maximum texture sizes
      case D3D_FEATURE_LEVEL_9_3:  return std::make_pair(-D3D_FL9_3_REQ_TEXTURE2D_U_OR_V_DIMENSION, D3D_FL9_3_REQ_TEXTURE2D_U_OR_V_DIMENSION);
      case D3D_FEATURE_LEVEL_9_2:
      case D3D_FEATURE_LEVEL_9_1:  return std::make_pair(-D3D_FL9_1_REQ_TEXTURE2D_U_OR_V_DIMENSION, D3D_FL9_1_REQ_TEXTURE2D_U_OR_V_DIMENSION);

      default: UNREACHABLE();      return std::make_pair(0, 0);
    }
}
