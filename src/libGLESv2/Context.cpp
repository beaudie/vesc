...
bool Context::getIntegerv(GLenum pname, GLint *params)
{
    ...
    switch (pname)
    {
      ...
      case GL_STENCIL_VALUE_MASK:                       *params = uint2int(mState.depthStencil.stencilMask);            break;
      case GL_STENCIL_BACK_FUNC:                        *params = mState.depthStencil.stencilBackFunc;                  break;
      case GL_STENCIL_BACK_REF:                         *params = mState.stencilBackRef;                                break;
      case GL_STENCIL_BACK_VALUE_MASK:                  *params = uint2int(mState.depthStencil.stencilBackMask);        break;
      ...
      case GL_STENCIL_WRITEMASK:                        *params = uint2int(mState.depthStencil.stencilWritemask);       break;
      case GL_STENCIL_BACK_WRITEMASK:                   *params = uint2int(mState.depthStencil.stencilBackWritemask);   break;
