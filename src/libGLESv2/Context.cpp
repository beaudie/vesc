...
{
    const TextureCaps &formatCaps = gl::GetTextureCaps(getCaps().textureCaps, internalformat);
...
void Context::initExtensionStrings()
{
    ...
    std::vector<std::string> extensions = GetExtensionStrings(getCaps().extensions, mClientVersion);
