...
GLuint State::getIndexedUniformBufferHandle(GLuint index) const
{
...
GLuint State::getIndexedTransformFeedbackBufferHandle(GLuint index) const
{
...
void State::detachRenderbuffer(GLuint renderbuffer)
{
    ...
    Framebuffer *readFramebuffer = mBoundReadFramebuffer;
    Framebuffer *drawFramebuffer = mBoundDrawFramebuffer;
