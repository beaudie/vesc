                                    ...
                                    cl_uint *num_platforms)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetPlatformIDs), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetPlatformIDs");
    ...
    cl_int retval            = next(num_entries, platforms, num_platforms);
                                     ...
                                     size_t *param_value_size_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetPlatformInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetPlatformInfo");

    // Call down to the next layer
    void *entry               = funcMap["clGetPlatformInfo"];
    PFNCLGetPlatformInfo next = reinterpret_cast<PFNCLGetPlatformInfo>(entry);
    cl_int retval = next(platform, param_name, param_value_size, param_value, param_value_size_ret);
                                  ...
                                  cl_uint *num_devices)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetDeviceIDs), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetDeviceIDs");

    // Call down to the next layer
    void *entry            = funcMap["clGetDeviceIDs"];
    PFNCLGetDeviceIDs next = reinterpret_cast<PFNCLGetDeviceIDs>(entry);
    cl_int retval          = next(platform, device_type, num_entries, devices, num_devices);
                                   ...
                                   size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetDeviceInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetDeviceInfo");

    // Call down to the next layer
    void *entry             = funcMap["clGetDeviceInfo"];
    PFNCLGetDeviceInfo next = reinterpret_cast<PFNCLGetDeviceInfo>(entry);
    cl_int retval = next(device, param_name, param_value_size, param_value, param_value_size_ret);
                                       ...
                                       cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateContext), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateContext");

    // Call down to the next layer
    void *entry             = funcMap["clCreateContext"];
    PFNCLCreateContext next = reinterpret_cast<PFNCLCreateContext>(entry);
    cl_context retval = next(properties, num_devices, devices, pfn_notify, user_data, errcode_ret);
                        ...
                        cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateContextFromType), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateContextFromType");
    ...
    cl_context retval = next(properties, device_type, pfn_notify, user_data, errcode_ret);
...
cl_int CL_API_CALL clRetainContext(cl_context context)
{
    ...
    std::sprintf(entryPointMessage, "clRetainContext(context = 0x%016" PRIxPTR ")",
                 (uintptr_t)context);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainContext), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainContext");

    // Call down to the next layer
    void *entry             = funcMap["clRetainContext"];
    PFNCLRetainContext next = reinterpret_cast<PFNCLRetainContext>(entry);
    cl_int retval           = next(context);
...
cl_int CL_API_CALL clReleaseContext(cl_context context)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseContext(context = 0x%016" PRIxPTR ")",
                 (uintptr_t)context);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseContext), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseContext");
                                    ...
                                    size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetContextInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetContextInfo");

    // Call down to the next layer
    void *entry              = funcMap["clGetContextInfo"];
    PFNCLGetContextInfo next = reinterpret_cast<PFNCLGetContextInfo>(entry);
    cl_int retval = next(context, param_name, param_value_size, param_value, param_value_size_ret);
...
cl_int CL_API_CALL clRetainCommandQueue(cl_command_queue command_queue)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainCommandQueue), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainCommandQueue");

    // Call down to the next layer
    void *entry                  = funcMap["clRetainCommandQueue"];
    PFNCLRetainCommandQueue next = reinterpret_cast<PFNCLRetainCommandQueue>(entry);
    cl_int retval                = next(command_queue);
...
cl_int CL_API_CALL clReleaseCommandQueue(cl_command_queue command_queue)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseCommandQueue(command_queue = 0x%016" PRIxPTR ")",
                 (uintptr_t)command_queue);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseCommandQueue), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseCommandQueue");
                                         ...
                                         size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetCommandQueueInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetCommandQueueInfo");

    // Call down to the next layer
    void *entry                   = funcMap["clGetCommandQueueInfo"];
    PFNCLGetCommandQueueInfo next = reinterpret_cast<PFNCLGetCommandQueueInfo>(entry);
    cl_int retval =
        next(command_queue, param_name, param_value_size, param_value, param_value_size_ret);
                                  ...
                                  cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateBuffer");

    // Call down to the next layer
    void *entry            = funcMap["clCreateBuffer"];
    PFNCLCreateBuffer next = reinterpret_cast<PFNCLCreateBuffer>(entry);
    cl_mem retval          = next(context, flags, size, host_ptr, errcode_ret);
...
cl_int CL_API_CALL clRetainMemObject(cl_mem memobj)
{
    ...
    std::sprintf(entryPointMessage, "clRetainMemObject(memobj = 0x%016" PRIxPTR ")",
                 (uintptr_t)memobj);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainMemObject), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainMemObject");

    // Call down to the next layer
    void *entry               = funcMap["clRetainMemObject"];
    PFNCLRetainMemObject next = reinterpret_cast<PFNCLRetainMemObject>(entry);
    cl_int retval             = next(memobj);
...
cl_int CL_API_CALL clReleaseMemObject(cl_mem memobj)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseMemObject(memobj = 0x%016" PRIxPTR ")",
                 (uintptr_t)memobj);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseMemObject), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseMemObject");
                                              ...
                                              cl_uint *num_image_formats)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetSupportedImageFormats), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetSupportedImageFormats");
    ...
    cl_int retval = next(context, flags, image_type, num_entries, image_formats, num_image_formats);
                                      ...
                                      size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetMemObjectInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetMemObjectInfo");

    // Call down to the next layer
    void *entry                = funcMap["clGetMemObjectInfo"];
    PFNCLGetMemObjectInfo next = reinterpret_cast<PFNCLGetMemObjectInfo>(entry);
    cl_int retval = next(memobj, param_name, param_value_size, param_value, param_value_size_ret);
                                  ...
                                  size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetImageInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetImageInfo");

    // Call down to the next layer
    void *entry            = funcMap["clGetImageInfo"];
    PFNCLGetImageInfo next = reinterpret_cast<PFNCLGetImageInfo>(entry);
    cl_int retval = next(image, param_name, param_value_size, param_value, param_value_size_ret);
...
cl_int CL_API_CALL clRetainSampler(cl_sampler sampler)
{
    ...
    std::sprintf(entryPointMessage, "clRetainSampler(sampler = 0x%016" PRIxPTR ")",
                 (uintptr_t)sampler);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainSampler), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainSampler");

    // Call down to the next layer
    void *entry             = funcMap["clRetainSampler"];
    PFNCLRetainSampler next = reinterpret_cast<PFNCLRetainSampler>(entry);
    cl_int retval           = next(sampler);
...
cl_int CL_API_CALL clReleaseSampler(cl_sampler sampler)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseSampler(sampler = 0x%016" PRIxPTR ")",
                 (uintptr_t)sampler);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseSampler), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseSampler");
                                    ...
                                    size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetSamplerInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetSamplerInfo");

    // Call down to the next layer
    void *entry              = funcMap["clGetSamplerInfo"];
    PFNCLGetSamplerInfo next = reinterpret_cast<PFNCLGetSamplerInfo>(entry);
    cl_int retval = next(sampler, param_name, param_value_size, param_value, param_value_size_ret);
                                                 ...
                                                 cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateProgramWithSource), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateProgramWithSource");
    ...
    cl_program retval                 = next(context, count, strings, lengths, errcode_ret);
                                                 ...
                                                 cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateProgramWithBinary), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateProgramWithBinary");
    ...
    cl_program retval =
        next(context, num_devices, device_list, lengths, binaries, binary_status, errcode_ret);
...
cl_int CL_API_CALL clRetainProgram(cl_program program)
{
    ...
    std::sprintf(entryPointMessage, "clRetainProgram(program = 0x%016" PRIxPTR ")",
                 (uintptr_t)program);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainProgram");

    // Call down to the next layer
    void *entry             = funcMap["clRetainProgram"];
    PFNCLRetainProgram next = reinterpret_cast<PFNCLRetainProgram>(entry);
    cl_int retval           = next(program);
...
cl_int CL_API_CALL clReleaseProgram(cl_program program)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseProgram(program = 0x%016" PRIxPTR ")",
                 (uintptr_t)program);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseProgram");
                                  ...
                                  void *user_data)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLBuildProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clBuildProgram");

    // Call down to the next layer
    void *entry            = funcMap["clBuildProgram"];
    PFNCLBuildProgram next = reinterpret_cast<PFNCLBuildProgram>(entry);
    cl_int retval = next(program, num_devices, device_list, options, pfn_notify, user_data);
                                    ...
                                    size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetProgramInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetProgramInfo");

    // Call down to the next layer
    void *entry              = funcMap["clGetProgramInfo"];
    PFNCLGetProgramInfo next = reinterpret_cast<PFNCLGetProgramInfo>(entry);
    cl_int retval = next(program, param_name, param_value_size, param_value, param_value_size_ret);
                                         ...
                                         size_t *param_value_size_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetProgramBuildInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetProgramBuildInfo");

    // Call down to the next layer
    void *entry                   = funcMap["clGetProgramBuildInfo"];
    PFNCLGetProgramBuildInfo next = reinterpret_cast<PFNCLGetProgramBuildInfo>(entry);
    cl_int retval =
        next(program, device, param_name, param_value_size, param_value, param_value_size_ret);
                                     ...
                                     cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateKernel");

    // Call down to the next layer
    void *entry            = funcMap["clCreateKernel"];
    PFNCLCreateKernel next = reinterpret_cast<PFNCLCreateKernel>(entry);
    cl_kernel retval       = next(program, kernel_name, errcode_ret);
                                            ...
                                            cl_uint *num_kernels_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateKernelsInProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateKernelsInProgram");
    ...
    cl_int retval                    = next(program, num_kernels, kernels, num_kernels_ret);
...
cl_int CL_API_CALL clRetainKernel(cl_kernel kernel)
{
    ...
    std::sprintf(entryPointMessage, "clRetainKernel(kernel = 0x%016" PRIxPTR ")",
                 (uintptr_t)kernel);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainKernel");

    // Call down to the next layer
    void *entry            = funcMap["clRetainKernel"];
    PFNCLRetainKernel next = reinterpret_cast<PFNCLRetainKernel>(entry);
    cl_int retval          = next(kernel);
...
cl_int CL_API_CALL clReleaseKernel(cl_kernel kernel)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseKernel(kernel = 0x%016" PRIxPTR ")",
                 (uintptr_t)kernel);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseKernel");
                                  ...
                                  const void *arg_value)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetKernelArg), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetKernelArg");

    // Call down to the next layer
    void *entry            = funcMap["clSetKernelArg"];
    PFNCLSetKernelArg next = reinterpret_cast<PFNCLSetKernelArg>(entry);
    cl_int retval          = next(kernel, arg_index, arg_size, arg_value);
                                   ...
                                   size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetKernelInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetKernelInfo");

    // Call down to the next layer
    void *entry             = funcMap["clGetKernelInfo"];
    PFNCLGetKernelInfo next = reinterpret_cast<PFNCLGetKernelInfo>(entry);
    cl_int retval = next(kernel, param_name, param_value_size, param_value, param_value_size_ret);
                                            ...
                                            size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value, (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetKernelWorkGroupInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetKernelWorkGroupInfo");
    ...
    cl_int retval =
        next(kernel, device, param_name, param_value_size, param_value, param_value_size_ret);
...
cl_int CL_API_CALL clWaitForEvents(cl_uint num_events, const cl_event *event_list)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLWaitForEvents), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clWaitForEvents");

    // Call down to the next layer
    void *entry             = funcMap["clWaitForEvents"];
    PFNCLWaitForEvents next = reinterpret_cast<PFNCLWaitForEvents>(entry);
    cl_int retval           = next(num_events, event_list);
                                  ...
                                  size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetEventInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetEventInfo");

    // Call down to the next layer
    void *entry            = funcMap["clGetEventInfo"];
    PFNCLGetEventInfo next = reinterpret_cast<PFNCLGetEventInfo>(entry);
    cl_int retval = next(event, param_name, param_value_size, param_value, param_value_size_ret);
...
cl_int CL_API_CALL clRetainEvent(cl_event event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainEvent), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainEvent");

    // Call down to the next layer
    void *entry           = funcMap["clRetainEvent"];
    PFNCLRetainEvent next = reinterpret_cast<PFNCLRetainEvent>(entry);
    cl_int retval         = next(event);
...
cl_int CL_API_CALL clReleaseEvent(cl_event event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseEvent), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseEvent");
                                           ...
                                           size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetEventProfilingInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetEventProfilingInfo");
...
cl_int CL_API_CALL clFlush(cl_command_queue command_queue)
{
    ...
    std::sprintf(entryPointMessage, "clFlush(command_queue = 0x%016" PRIxPTR ")",
                 (uintptr_t)command_queue);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLFlush), -1, entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clFlush");
...
cl_int CL_API_CALL clFinish(cl_command_queue command_queue)
{
    ...
    std::sprintf(entryPointMessage, "clFinish(command_queue = 0x%016" PRIxPTR ")",
                 (uintptr_t)command_queue);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLFinish), -1, entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clFinish");
                                       ...
                                       cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueReadBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueReadBuffer");

    // Call down to the next layer
    void *entry                 = funcMap["clEnqueueReadBuffer"];
    PFNCLEnqueueReadBuffer next = reinterpret_cast<PFNCLEnqueueReadBuffer>(entry);
    cl_int retval               = next(command_queue, buffer, blocking_read, offset, size, ptr,
                                        ...
                                        cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueWriteBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueWriteBuffer");

    // Call down to the next layer
    void *entry                  = funcMap["clEnqueueWriteBuffer"];
    PFNCLEnqueueWriteBuffer next = reinterpret_cast<PFNCLEnqueueWriteBuffer>(entry);
    cl_int retval                = next(command_queue, buffer, blocking_write, offset, size, ptr,
                                        num_events_in_wait_list, event_wait_list, event);
                                       ...
                                       cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueCopyBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueCopyBuffer");

    // Call down to the next layer
    void *entry                 = funcMap["clEnqueueCopyBuffer"];
    PFNCLEnqueueCopyBuffer next = reinterpret_cast<PFNCLEnqueueCopyBuffer>(entry);
    cl_int retval = next(command_queue, src_buffer, dst_buffer, src_offset, dst_offset, size,
                         num_events_in_wait_list, event_wait_list, event);
                                      ...
                                      cl_event *event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueReadImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueReadImage");

    // Call down to the next layer
    void *entry                = funcMap["clEnqueueReadImage"];
    PFNCLEnqueueReadImage next = reinterpret_cast<PFNCLEnqueueReadImage>(entry);
    cl_int retval = next(command_queue, image, blocking_read, origin, region, row_pitch,
                                       ...
                                       cl_event *event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueWriteImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueWriteImage");

    // Call down to the next layer
    void *entry                 = funcMap["clEnqueueWriteImage"];
    PFNCLEnqueueWriteImage next = reinterpret_cast<PFNCLEnqueueWriteImage>(entry);
    cl_int retval = next(command_queue, image, blocking_write, origin, region, input_row_pitch,
                                      ...
                                      cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 num_events_in_wait_list, (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueCopyImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueCopyImage");

    // Call down to the next layer
    void *entry                = funcMap["clEnqueueCopyImage"];
    PFNCLEnqueueCopyImage next = reinterpret_cast<PFNCLEnqueueCopyImage>(entry);
    cl_int retval = next(command_queue, src_image, dst_image, src_origin, dst_origin, region,
                         num_events_in_wait_list, event_wait_list, event);
                                              ...
                                              cl_event *event)
{
    ...
    std::sprintf(
        ...
        (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueCopyImageToBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueCopyImageToBuffer");
    ...
    cl_int retval = next(command_queue, src_image, dst_buffer, src_origin, region, dst_offset,
                         num_events_in_wait_list, event_wait_list, event);
                                              ...
                                              cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueCopyBufferToImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueCopyBufferToImage");
    ...
    cl_int retval = next(command_queue, src_buffer, dst_image, src_offset, dst_origin, region,
                         num_events_in_wait_list, event_wait_list, event);
                                     ...
                                     cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueMapBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueMapBuffer");

    // Call down to the next layer
    void *entry                = funcMap["clEnqueueMapBuffer"];
    PFNCLEnqueueMapBuffer next = reinterpret_cast<PFNCLEnqueueMapBuffer>(entry);
    void *retval               = next(command_queue, buffer, blocking_map, map_flags, offset, size,
                                    ...
                                    cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event, (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueMapImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueMapImage");

    // Call down to the next layer
    void *entry               = funcMap["clEnqueueMapImage"];
    PFNCLEnqueueMapImage next = reinterpret_cast<PFNCLEnqueueMapImage>(entry);
    void *retval =
        next(command_queue, image, blocking_map, map_flags, origin, region, image_row_pitch,
                                           ...
                                           cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 num_events_in_wait_list, (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueUnmapMemObject), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueUnmapMemObject");
    ...
    cl_int retval =
        next(command_queue, memobj, mapped_ptr, num_events_in_wait_list, event_wait_list, event);
                                          ...
                                          cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueNDRangeKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueNDRangeKernel");

    // Call down to the next layer
    void *entry                    = funcMap["clEnqueueNDRangeKernel"];
    PFNCLEnqueueNDRangeKernel next = reinterpret_cast<PFNCLEnqueueNDRangeKernel>(entry);
    cl_int retval = next(command_queue, kernel, work_dim, global_work_offset, global_work_size,
                                         ...
                                         cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 num_events_in_wait_list, (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueNativeKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueNativeKernel");

    // Call down to the next layer
    void *entry                   = funcMap["clEnqueueNativeKernel"];
    PFNCLEnqueueNativeKernel next = reinterpret_cast<PFNCLEnqueueNativeKernel>(entry);
    cl_int retval = next(command_queue, user_func, args, cb_args, num_mem_objects, mem_list,
                                             ...
                                             cl_command_queue_properties *old_properties)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetCommandQueueProperty), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetCommandQueueProperty");
    ...
    cl_int retval                     = next(command_queue, properties, enable, old_properties);
                                   ...
                                   cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateImage2D), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateImage2D");

    // Call down to the next layer
    void *entry             = funcMap["clCreateImage2D"];
    PFNCLCreateImage2D next = reinterpret_cast<PFNCLCreateImage2D>(entry);
    cl_mem retval = next(context, flags, image_format, image_width, image_height, image_row_pitch,
                                   ...
                                   cl_int *errcode_ret)
{
    ...
    std::sprintf(
        ...
        (uintptr_t)host_ptr, (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateImage3D), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateImage3D");

    // Call down to the next layer
    void *entry             = funcMap["clCreateImage3D"];
    PFNCLCreateImage3D next = reinterpret_cast<PFNCLCreateImage3D>(entry);
    cl_mem retval = next(context, flags, image_format, image_width, image_height, image_depth,
...
cl_int CL_API_CALL clEnqueueMarker(cl_command_queue command_queue, cl_event *event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueMarker), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueMarker");

    // Call down to the next layer
    void *entry             = funcMap["clEnqueueMarker"];
    PFNCLEnqueueMarker next = reinterpret_cast<PFNCLEnqueueMarker>(entry);
    cl_int retval           = next(command_queue, event);
                                          ...
                                          const cl_event *event_list)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueWaitForEvents), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueWaitForEvents");

    // Call down to the next layer
    void *entry                    = funcMap["clEnqueueWaitForEvents"];
    PFNCLEnqueueWaitForEvents next = reinterpret_cast<PFNCLEnqueueWaitForEvents>(entry);
    cl_int retval                  = next(command_queue, num_events, event_list);
...
cl_int CL_API_CALL clEnqueueBarrier(cl_command_queue command_queue)
{
    ...
    std::sprintf(entryPointMessage, "clEnqueueBarrier(command_queue = 0x%016" PRIxPTR ")",
                 (uintptr_t)command_queue);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueBarrier), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueBarrier");
...
cl_int CL_API_CALL clUnloadCompiler()
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLUnloadCompiler), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clUnloadCompiler");
...
void *CL_API_CALL clGetExtensionFunctionAddress(const char *func_name)
{
    ...
    std::sprintf(entryPointMessage, "clGetExtensionFunctionAddress(func_name = 0x%016" PRIxPTR ")",
                 (uintptr_t)func_name);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetExtensionFunctionAddress), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetExtensionFunctionAddress");
                                                  ...
                                                  cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateCommandQueue), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateCommandQueue");

    // Call down to the next layer
    void *entry                  = funcMap["clCreateCommandQueue"];
    PFNCLCreateCommandQueue next = reinterpret_cast<PFNCLCreateCommandQueue>(entry);
    cl_command_queue retval      = next(context, device, properties, errcode_ret);
                                       ...
                                       cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateSampler), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateSampler");

    // Call down to the next layer
    void *entry             = funcMap["clCreateSampler"];
    PFNCLCreateSampler next = reinterpret_cast<PFNCLCreateSampler>(entry);
    cl_sampler retval = next(context, normalized_coords, addressing_mode, filter_mode, errcode_ret);
                                 ...
                                 cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueTask), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueTask");

    // Call down to the next layer
    void *entry           = funcMap["clEnqueueTask"];
    PFNCLEnqueueTask next = reinterpret_cast<PFNCLEnqueueTask>(entry);
    cl_int retval = next(command_queue, kernel, num_events_in_wait_list, event_wait_list, event);
                                     ...
                                     cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateSubBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateSubBuffer");

    // Call down to the next layer
    void *entry               = funcMap["clCreateSubBuffer"];
    PFNCLCreateSubBuffer next = reinterpret_cast<PFNCLCreateSubBuffer>(entry);
    cl_mem retval = next(buffer, flags, buffer_create_type, buffer_create_info, errcode_ret);
                                                    ...
                                                    void *user_data)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetMemObjectDestructorCallback), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetMemObjectDestructorCallback");
    ...
    cl_int retval = next(memobj, pfn_notify, user_data);
...
cl_event CL_API_CALL clCreateUserEvent(cl_context context, cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateUserEvent), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateUserEvent");

    // Call down to the next layer
    void *entry               = funcMap["clCreateUserEvent"];
    PFNCLCreateUserEvent next = reinterpret_cast<PFNCLCreateUserEvent>(entry);
    cl_event retval           = next(context, errcode_ret);
...
cl_int CL_API_CALL clSetUserEventStatus(cl_event event, cl_int execution_status)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetUserEventStatus), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetUserEventStatus");

    // Call down to the next layer
    void *entry                  = funcMap["clSetUserEventStatus"];
    PFNCLSetUserEventStatus next = reinterpret_cast<PFNCLSetUserEventStatus>(entry);
    cl_int retval                = next(event, execution_status);
                                      ...
                                      void *user_data)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)user_data);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetEventCallback), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetEventCallback");

    // Call down to the next layer
    void *entry                = funcMap["clSetEventCallback"];
    PFNCLSetEventCallback next = reinterpret_cast<PFNCLSetEventCallback>(entry);
    cl_int retval              = next(event, command_exec_callback_type, pfn_notify, user_data);
                                           ...
                                           cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueReadBufferRect), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueReadBufferRect");
    ...
    cl_int retval = next(command_queue, buffer, blocking_read, buffer_origin, host_origin, region,
                         buffer_row_pitch, buffer_slice_pitch, host_row_pitch, host_slice_pitch,
                                            ...
                                            cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueWriteBufferRect), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueWriteBufferRect");
    ...
    cl_int retval = next(command_queue, buffer, blocking_write, buffer_origin, host_origin, region,
                         buffer_row_pitch, buffer_slice_pitch, host_row_pitch, host_slice_pitch,
                         ptr, num_events_in_wait_list, event_wait_list, event);
                                           ...
                                           cl_event *event)
{
    ...
    std::sprintf(
        ...
        (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueCopyBufferRect), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueCopyBufferRect");
    ...
    cl_int retval = next(command_queue, src_buffer, dst_buffer, src_origin, dst_origin, region,
                                      ...
                                      cl_uint *num_devices_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateSubDevices), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateSubDevices");

    // Call down to the next layer
    void *entry                = funcMap["clCreateSubDevices"];
    PFNCLCreateSubDevices next = reinterpret_cast<PFNCLCreateSubDevices>(entry);
    cl_int retval = next(in_device, properties, num_devices, out_devices, num_devices_ret);
...
cl_int CL_API_CALL clRetainDevice(cl_device_id device)
{
    ...
    std::sprintf(entryPointMessage, "clRetainDevice(device = 0x%016" PRIxPTR ")",
                 (uintptr_t)device);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLRetainDevice), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clRetainDevice");

    // Call down to the next layer
    void *entry            = funcMap["clRetainDevice"];
    PFNCLRetainDevice next = reinterpret_cast<PFNCLRetainDevice>(entry);
    cl_int retval          = next(device);
...
cl_int CL_API_CALL clReleaseDevice(cl_device_id device)
{
    ...
    std::sprintf(entryPointMessage, "clReleaseDevice(device = 0x%016" PRIxPTR ")",
                 (uintptr_t)device);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLReleaseDevice), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clReleaseDevice");
                                 ...
                                 cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateImage");

    // Call down to the next layer
    void *entry           = funcMap["clCreateImage"];
    PFNCLCreateImage next = reinterpret_cast<PFNCLCreateImage>(entry);
    cl_mem retval         = next(context, flags, image_format, image_desc, host_ptr, errcode_ret);
                                                         ...
                                                         cl_int *errcode_ret)
{
    ...
    // ALOGI("%s", "LLLLL Function is clCreateProgramWithBuiltInKernels");
    ...
    cl_program retval = next(context, num_devices, device_list, kernel_names, errcode_ret);
                                    ...
                                    void *user_data)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)pfn_notify, (uintptr_t)user_data);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCompileProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCompileProgram");

    // Call down to the next layer
    void *entry              = funcMap["clCompileProgram"];
    PFNCLCompileProgram next = reinterpret_cast<PFNCLCompileProgram>(entry);
    cl_int retval            = next(program, num_devices, device_list, options, num_input_headers,
                                     ...
                                     cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)user_data, (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLLinkProgram), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clLinkProgram");

    // Call down to the next layer
    void *entry           = funcMap["clLinkProgram"];
    PFNCLLinkProgram next = reinterpret_cast<PFNCLLinkProgram>(entry);
    cl_program retval     = next(context, num_devices, device_list, options, num_input_programs,
...
cl_int CL_API_CALL clUnloadPlatformCompiler(cl_platform_id platform)
{
    ...
    std::sprintf(entryPointMessage, "clUnloadPlatformCompiler(platform = 0x%016" PRIxPTR ")",
                 (uintptr_t)platform);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLUnloadPlatformCompiler), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clUnloadPlatformCompiler");
                                      ...
                                      size_t *param_value_size_ret)
{
    ...
    std::sprintf(
        ...
        (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetKernelArgInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetKernelArgInfo");

    // Call down to the next layer
    void *entry                = funcMap["clGetKernelArgInfo"];
    PFNCLGetKernelArgInfo next = reinterpret_cast<PFNCLGetKernelArgInfo>(entry);
    cl_int retval =
        next(kernel, arg_index, param_name, param_value_size, param_value, param_value_size_ret);
                                       ...
                                       cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueFillBuffer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueFillBuffer");

    // Call down to the next layer
    void *entry                 = funcMap["clEnqueueFillBuffer"];
    PFNCLEnqueueFillBuffer next = reinterpret_cast<PFNCLEnqueueFillBuffer>(entry);
    cl_int retval               = next(command_queue, buffer, pattern, pattern_size, offset, size,
                                       num_events_in_wait_list, event_wait_list, event);
                                      ...
                                      cl_event *event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueFillImage), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueFillImage");

    // Call down to the next layer
    void *entry                = funcMap["clEnqueueFillImage"];
    PFNCLEnqueueFillImage next = reinterpret_cast<PFNCLEnqueueFillImage>(entry);
    cl_int retval = next(command_queue, image, fill_color, origin, region, num_events_in_wait_list,
                                              ...
                                              cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueMigrateMemObjects), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueMigrateMemObjects");
    ...
    cl_int retval                      = next(command_queue, num_mem_objects, mem_objects, flags,
                                              num_events_in_wait_list, event_wait_list, event);
                                               ...
                                               cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueMarkerWithWaitList), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueMarkerWithWaitList");
    ...
    cl_int retval = next(command_queue, num_events_in_wait_list, event_wait_list, event);
                                                ...
                                                cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueBarrierWithWaitList), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueBarrierWithWaitList");
                                                           ...
                                                           const char *func_name)
{
    ...
    g_push_debug_group(
        ...
        static_cast<GLuint>(angle::EntryPoint::CLGetExtensionFunctionAddressForPlatform), -1,
        entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetExtensionFunctionAddressForPlatform");
    ...
    void *retval = next(platform, func_name);
                                   ...
                                   cl_int *errcode_ret)
{
    ...
    // ALOGI("%s", "LLLLL Function is clCreateCommandQueueWithProperties");
                                ...
                                cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreatePipe), -1, entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreatePipe");

    // Call down to the next layer
    void *entry          = funcMap["clCreatePipe"];
    PFNCLCreatePipe next = reinterpret_cast<PFNCLCreatePipe>(entry);
    cl_mem retval =
        next(context, flags, pipe_packet_size, pipe_max_packets, properties, errcode_ret);
                                 ...
                                 size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetPipeInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetPipeInfo");

    // Call down to the next layer
    void *entry           = funcMap["clGetPipeInfo"];
    PFNCLGetPipeInfo next = reinterpret_cast<PFNCLGetPipeInfo>(entry);
    cl_int retval = next(pipe, param_name, param_value_size, param_value, param_value_size_ret);
                             ...
                             cl_uint alignment)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSVMAlloc), -1, entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSVMAlloc");

    // Call down to the next layer
    void *entry        = funcMap["clSVMAlloc"];
    PFNCLSVMAlloc next = reinterpret_cast<PFNCLSVMAlloc>(entry);
    void *retval       = next(context, flags, size, alignment);
...
void CL_API_CALL clSVMFree(cl_context context, void *svm_pointer)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSVMFree), -1, entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSVMFree");
                              ...
                              cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateSamplerWithProperties), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateSamplerWithProperties");
    ...
    cl_sampler retval = next(context, sampler_properties, errcode_ret);
                                            ...
                                            const void *arg_value)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetKernelArgSVMPointer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetKernelArgSVMPointer");
    ...
    cl_int retval                    = next(kernel, arg_index, arg_value);
                                       ...
                                       const void *param_value)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)kernel, param_name, param_value_size, (uintptr_t)param_value);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetKernelExecInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetKernelExecInfo");

    // Call down to the next layer
    void *entry                 = funcMap["clSetKernelExecInfo"];
    PFNCLSetKernelExecInfo next = reinterpret_cast<PFNCLSetKernelExecInfo>(entry);
    cl_int retval               = next(kernel, param_name, param_value_size, param_value);
                                    ...
                                    cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMFree), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMFree");

    // Call down to the next layer
    void *entry              = funcMap["clEnqueueSVMFree"];
    PFNCLEnqueueSVMFree next = reinterpret_cast<PFNCLEnqueueSVMFree>(entry);
    cl_int retval = next(command_queue, num_svm_pointers, svm_pointers, pfn_free_func, user_data,
                         num_events_in_wait_list, event_wait_list, event);
                                      ...
                                      cl_event *event)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMMemcpy), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMMemcpy");

    // Call down to the next layer
    void *entry                = funcMap["clEnqueueSVMMemcpy"];
    PFNCLEnqueueSVMMemcpy next = reinterpret_cast<PFNCLEnqueueSVMMemcpy>(entry);
    cl_int retval              = next(command_queue, blocking_copy, dst_ptr, src_ptr, size,
                                      num_events_in_wait_list, event_wait_list, event);
                                       ...
                                       cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 size, num_events_in_wait_list, (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMMemFill), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMMemFill");

    // Call down to the next layer
    void *entry                 = funcMap["clEnqueueSVMMemFill"];
    PFNCLEnqueueSVMMemFill next = reinterpret_cast<PFNCLEnqueueSVMMemFill>(entry);
    cl_int retval               = next(command_queue, svm_ptr, pattern, pattern_size, size,
                                       num_events_in_wait_list, event_wait_list, event);
                                   ...
                                   cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMMap), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMMap");

    // Call down to the next layer
    void *entry             = funcMap["clEnqueueSVMMap"];
    PFNCLEnqueueSVMMap next = reinterpret_cast<PFNCLEnqueueSVMMap>(entry);
    cl_int retval = next(command_queue, blocking_map, flags, svm_ptr, size, num_events_in_wait_list,
                         event_wait_list, event);
                                     ...
                                     cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMUnmap), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMUnmap");

    // Call down to the next layer
    void *entry               = funcMap["clEnqueueSVMUnmap"];
    PFNCLEnqueueSVMUnmap next = reinterpret_cast<PFNCLEnqueueSVMUnmap>(entry);
    cl_int retval = next(command_queue, svm_ptr, num_events_in_wait_list, event_wait_list, event);
                                                  ...
                                                  cl_command_queue command_queue)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetDefaultDeviceCommandQueue), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetDefaultDeviceCommandQueue");
    ...
    cl_int retval = next(context, device, command_queue);
                                           ...
                                           cl_ulong *host_timestamp)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetDeviceAndHostTimer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetDeviceAndHostTimer");
    ...
    cl_int retval                   = next(device, device_timestamp, host_timestamp);
...
cl_int CL_API_CALL clGetHostTimer(cl_device_id device, cl_ulong *host_timestamp)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetHostTimer), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetHostTimer");

    // Call down to the next layer
    void *entry            = funcMap["clGetHostTimer"];
    PFNCLGetHostTimer next = reinterpret_cast<PFNCLGetHostTimer>(entry);
    cl_int retval          = next(device, host_timestamp);
                                             ...
                                             cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateProgramWithIL), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateProgramWithIL");

    // Call down to the next layer
    void *entry                   = funcMap["clCreateProgramWithIL"];
    PFNCLCreateProgramWithIL next = reinterpret_cast<PFNCLCreateProgramWithIL>(entry);
    cl_program retval             = next(context, il, length, errcode_ret);
...
cl_kernel CL_API_CALL clCloneKernel(cl_kernel source_kernel, cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCloneKernel), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCloneKernel");

    // Call down to the next layer
    void *entry           = funcMap["clCloneKernel"];
    PFNCLCloneKernel next = reinterpret_cast<PFNCLCloneKernel>(entry);
    cl_kernel retval      = next(source_kernel, errcode_ret);
                                           ...
                                           size_t *param_value_size_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)param_value_size_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLGetKernelSubGroupInfo), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clGetKernelSubGroupInfo");
    ...
    cl_int retval = next(kernel, device, param_name, input_value_size, input_value,
                                          ...
                                          cl_event *event)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)event_wait_list, (uintptr_t)event);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLEnqueueSVMMigrateMem), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clEnqueueSVMMigrateMem");

    // Call down to the next layer
    void *entry                    = funcMap["clEnqueueSVMMigrateMem"];
    PFNCLEnqueueSVMMigrateMem next = reinterpret_cast<PFNCLEnqueueSVMMigrateMem>(entry);
    cl_int retval = next(command_queue, num_svm_pointers, svm_pointers, sizes, flags,
                         num_events_in_wait_list, event_wait_list, event);
                                               ...
                                               void *user_data)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetProgramReleaseCallback), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetProgramReleaseCallback");
    ...
    cl_int retval                       = next(program, pfn_notify, user_data);
                                                      ...
                                                      const void *spec_value)
{
    ...
    // ALOGI("%s", "LLLLL Function is clSetProgramSpecializationConstant");
    ...
    cl_int retval = next(program, spec_id, spec_size, spec_value);
                                                  ...
                                                  void *user_data)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLSetContextDestructorCallback), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clSetContextDestructorCallback");
    ...
    cl_int retval = next(context, pfn_notify, user_data);
                                                ...
                                                cl_int *errcode_ret)
{
    ...
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateBufferWithProperties), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateBufferWithProperties");
    ...
    cl_mem retval = next(context, properties, flags, size, host_ptr, errcode_ret);
                                               ...
                                               cl_int *errcode_ret)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 (uintptr_t)errcode_ret);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLCreateImageWithProperties), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clCreateImageWithProperties");
    ...
    cl_mem retval =
        next(context, properties, flags, image_format, image_desc, host_ptr, errcode_ret);
                                          ...
                                          cl_uint *num_platforms)
{
    ...
    std::sprintf(entryPointMessage,
                 ...
                 num_entries, (uintptr_t)platforms, (uintptr_t)num_platforms);
    g_push_debug_group(GL_DEBUG_SOURCE_THIRD_PARTY_KHR,
                       static_cast<GLuint>(angle::EntryPoint::CLIcdGetPlatformIDsKHR), -1,
                       entryPointMessage);

    // ALOGI("%s", "LLLLL Function is clIcdGetPlatformIDsKHR");
