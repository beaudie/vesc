...
#define ANGLE_SCOPED_GLOBAL_LOCK() egl::priv::ScopedGlobalEGLMutexLock globalMutexLock
#if ANGLE_CAPTURE_ENABLED
#    define ANGLE_SCOPED_GLOBAL_EGL_AND_EGL_SYNC_LOCK() \
        egl::priv::ScopedGlobalEGLMutexLock globalMutexLock
#else
#    define ANGLE_SCOPED_GLOBAL_EGL_AND_EGL_SYNC_LOCK()      \
        egl::priv::ScopedGlobalEGLMutexLock globalMutexLock; \
        egl::priv::ScopedGlobalEGLSyncObjectMutexLock globalEGLSyncObjectMutexLock
#endif

#if ANGLE_CAPTURE_ENABLED
#    define ANGLE_SCOPED_GLOBAL_EGL_SYNC_LOCK() egl::priv::ScopedGlobalEGLMutexLock globalMutexLock
#else
...
#    if defined(ANGLE_FORCE_CONTEXT_CHECK_EVERY_CALL)
#        define SCOPED_SHARE_CONTEXT_LOCK(context)                \
            egl::priv::ScopedGlobalEGLMutexLock shareContextLock; \
