...
// Note: this function may temporary change mutex type to SharedContextMutex.
...
// Note: this function will permanently change mutex type to SharedContextMutex.
                                                                         ...
                                                                         gl::ContextID contextID)
{
    ...
    return context != nullptr ? context->lockAndActivateSharedContextMutex(
                                    gl::SharedContextMutexActivation::kPermanent)
                              : ScopedContextMutexLock();
}
                                                                        ...
                                                                        ImageID imageID)
{
    ...
    ScopedContextMutexLock lock =
        context->lockAndActivateSharedContextMutex(gl::SharedContextMutexActivation::kPermanent);
    if (image != nullptr)
    {
