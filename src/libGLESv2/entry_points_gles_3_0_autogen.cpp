...
void GL_APIENTRY TexImage3D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::TexImage3D>(target, level, internalformat, width, height, depth, border, format, type, pixels);

        if (context->skipValidation() || ValidateTexImage3D(context, target, level, internalformat, width, height, depth, border, format, type, pixels))
        {
...
void GL_APIENTRY TexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::TexSubImage3D>(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);

        if (context->skipValidation() || ValidateTexSubImage3D(context, target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels))
        {
...
void GL_APIENTRY CopyTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::CopyTexSubImage3D>(target, level, xoffset, yoffset, zoffset, x, y, width, height);
...
void GL_APIENTRY CompressedTexImage3D(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const void *data)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::CompressedTexImage3D>(target, level, internalformat, width, height, depth, border, imageSize, data);

        if (context->skipValidation() || ValidateCompressedTexImage3D(context, target, level, internalformat, width, height, depth, border, imageSize, data))
        {
...
void GL_APIENTRY CompressedTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const void *data)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::CompressedTexSubImage3D>(target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);

        if (context->skipValidation() || ValidateCompressedTexSubImage3D(context, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data))
        {
...
void *GL_APIENTRY MapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
    ...
    if (context)
    {
        ...
        if (context->skipValidation() || ValidateMapBufferRange(context, target, offset, length, access))
        {
...
void GL_APIENTRY FlushMappedBufferRange(GLenum target, GLintptr offset, GLsizeiptr length)
{
    ...
    if (context)
    {
        ...
        if (context->skipValidation() || ValidateFlushMappedBufferRange(context, target, offset, length))
        {
...
void GL_APIENTRY BindBufferRange(GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size)
{
    ...
    if (context)
    {
        ...
        if (context->skipValidation() || ValidateBindBufferRange(context, target, index, buffer, offset, size))
        {
...
void GL_APIENTRY CopyBufferSubData(GLenum readTarget, GLenum writeTarget, GLintptr readOffset, GLintptr writeOffset, GLsizeiptr size)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::CopyBufferSubData>(readTarget, writeTarget, readOffset, writeOffset, size);

        if (context->skipValidation() || ValidateCopyBufferSubData(context, readTarget, writeTarget, readOffset, writeOffset, size))
        {
...
void GL_APIENTRY GetBufferParameteri64v(GLenum target, GLenum pname, GLint64 *params)
{
    ...
    if (context)
    {
        ...
        if (context->skipValidation() || ValidateGetBufferParameteri64v(context, target, pname, params))
        {
...
void GL_APIENTRY TexStorage2D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::TexStorage2D>(target, levels, internalformat, width, height);

        if (context->skipValidation() || ValidateTexStorage2D(context, target, levels, internalformat, width, height))
        {
...
void GL_APIENTRY TexStorage3D(GLenum target, GLsizei levels, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth)
{
    ...
    if (context)
    {
        context->gatherParams<EntryPoint::TexStorage3D>(target, levels, internalformat, width, height, depth);

        if (context->skipValidation() || ValidateTexStorage3D(context, target, levels, internalformat, width, height, depth))
        {
