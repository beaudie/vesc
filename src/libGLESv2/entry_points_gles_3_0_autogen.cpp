...
GLboolean GL_APIENTRY IsQuery(GLuint id)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::IsQuery, GLboolean>();
        }
...
GLboolean GL_APIENTRY UnmapBuffer(GLenum target)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::UnmapBuffer, GLboolean>();
        }
                                 ...
                                 GLbitfield access)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::MapBufferRange, void *>();
        }
...
GLboolean GL_APIENTRY IsVertexArray(GLuint array)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::IsVertexArray, GLboolean>();
        }
...
GLint GL_APIENTRY GetFragDataLocation(GLuint program, const GLchar *name)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::GetFragDataLocation, GLint>();
        }
...
const GLubyte *GL_APIENTRY GetStringi(GLenum name, GLuint index)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::GetStringi, const GLubyte *>();
        }
...
GLuint GL_APIENTRY GetUniformBlockIndex(GLuint program, const GLchar *uniformBlockName)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::GetUniformBlockIndex, GLuint>();
        }
...
GLsync GL_APIENTRY FenceSync(GLenum condition, GLbitfield flags)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::FenceSync, GLsync>();
        }
...
GLboolean GL_APIENTRY IsSync(GLsync sync)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::IsSync, GLboolean>();
        }
...
GLenum GL_APIENTRY ClientWaitSync(GLsync sync, GLbitfield flags, GLuint64 timeout)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::ClientWaitSync, GLenum>();
        }
...
GLboolean GL_APIENTRY IsSampler(GLuint sampler)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::IsSampler, GLboolean>();
        }
...
GLboolean GL_APIENTRY IsTransformFeedback(GLuint id)
{
    ...
    if (context)
    {
        ...
        {
            return GetDefaultReturnType<EntryPoint::IsTransformFeedback, GLboolean>();
        }
