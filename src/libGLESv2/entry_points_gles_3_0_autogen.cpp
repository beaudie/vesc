...
GLboolean GL_APIENTRY GL_IsQuery(GLuint id)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsQuery) &&
...
GLboolean GL_APIENTRY GL_IsSampler(GLuint sampler)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsSampler) &&
...
GLboolean GL_APIENTRY GL_IsSync(GLsync sync)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsSync) &&
...
GLboolean GL_APIENTRY GL_IsVertexArray(GLuint array)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLIsVertexArray) &&
                                    ...
                                    GLbitfield access)
{
    ...
    if (context)
    {
        ...
        bool isCallValid =
            (context->skipValidation() ||
             (ValidatePixelLocalStorageInactive(context, angle::EntryPoint::GLMapBufferRange) &&
              ValidateMapBufferRange(context, angle::EntryPoint::GLMapBufferRange, targetPacked,
