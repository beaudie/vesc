...
{
    EVENT("(GLenum target = 0x%X, GLuint index = %u, GLuint buffer = %u, GLintptr offset = %ld, GLsizeiptr size = %ld)", target, index, buffer, offset, size);
...
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLfloat *value = 0x%p)", buffer, drawbuffer, value);
...
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLint *value = 0x%p)", buffer, drawbuffer, value);
...
{
    EVENT("(GLenum buffer = 0x%X, GLint drawbuffer = %d, const GLuint *value = 0x%p)", buffer, drawbuffer, value);
...
{
    EVENT("(GLsync sync = 0x%p, GLbitfield flags = 0x%X, GLuint64 timeout = %" PRId64 ")", sync, flags, timeout);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLenum internalformat = 0x%X, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLint border = %d, GLsizei imageSize = %d, const void *data = 0x%p)", target, level, internalformat, width, height, depth, border, imageSize, data);
...
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLint zoffset = %d, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLenum format = 0x%X, GLsizei imageSize = %d, const void *data = 0x%p)", target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, data);
...
{
    EVENT("(GLenum readTarget = 0x%X, GLenum writeTarget = 0x%X, GLintptr readOffset = %ld, GLintptr writeOffset = %ld, GLsizeiptr size = %ld)", readTarget, writeTarget, readOffset, writeOffset, size);
...
{
    EVENT("(GLenum mode = 0x%X, GLsizei count = %d, GLenum type = 0x%X, const void *indices = 0x%p, GLsizei instancecount = %d)", mode, count, type, indices, instancecount);
...
{
    EVENT("(GLenum mode = 0x%X, GLuint start = %u, GLuint end = %u, GLsizei count = %d, GLenum type = 0x%X, const void *indices = 0x%p)", mode, start, end, count, type, indices);
...
{
    EVENT("(GLuint program = %u, GLuint uniformBlockIndex = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLchar *uniformBlockName = 0x%p)", program, uniformBlockIndex, bufSize, length, uniformBlockName);
...
{
    EVENT("(GLuint program = %u, GLuint uniformBlockIndex = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", program, uniformBlockIndex, pname, params);
...
{
    EVENT("(GLuint program = %u, GLsizei uniformCount = %d, const GLuint *uniformIndices = 0x%p, GLenum pname = 0x%X, GLint *params = 0x%p)", program, uniformCount, uniformIndices, pname, params);
...
{
    EVENT("(GLenum target = 0x%X, GLenum pname = 0x%X, GLint64 *params = 0x%p)", target, pname, params);
...
{
    EVENT("(GLenum target = 0x%X, GLenum internalformat = 0x%X, GLenum pname = 0x%X, GLsizei bufSize = %d, GLint *params = 0x%p)", target, internalformat, pname, bufSize, params);
...
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, GLfloat *params = 0x%p)", sampler, pname, params);
...
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, GLint *params = 0x%p)", sampler, pname, params);
...
{
    EVENT("(GLsync sync = 0x%p, GLenum pname = 0x%X, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLint *values = 0x%p)", sync, pname, bufSize, length, values);
...
{
    EVENT("(GLuint program = %u, GLuint index = %u, GLsizei bufSize = %d, GLsizei *length = 0x%p, GLsizei *size = 0x%p, GLenum *type = 0x%p, GLchar *name = 0x%p)", program, index, bufSize, length, size, type, name);
...
{
    EVENT("(GLuint program = %u, const GLchar *uniformBlockName = 0x%p)", program, uniformBlockName);
...
{
    EVENT("(GLuint program = %u, GLsizei uniformCount = %d, const GLchar *const*uniformNames = 0x%p, GLuint *uniformIndices = 0x%p)", program, uniformCount, uniformNames, uniformIndices);
...
{
    EVENT("(GLuint program = %u, GLint location = %d, GLuint *params = 0x%p)", program, location, params);
...
{
    EVENT("(GLenum target = 0x%X, GLsizei numAttachments = %d, const GLenum *attachments = 0x%p, GLint x = %d, GLint y = %d, GLsizei width = %d, GLsizei height = %d)", target, numAttachments, attachments, x, y, width, height);
...
{
    EVENT("(GLuint program = %u, GLenum binaryFormat = 0x%X, const void *binary = 0x%p, GLsizei length = %d)", program, binaryFormat, binary, length);
...
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, const GLfloat *param = 0x%p)", sampler, pname, param);
...
{
    EVENT("(GLuint sampler = %u, GLenum pname = 0x%X, const GLint *param = 0x%p)", sampler, pname, param);
...
void GL_APIENTRY TexImage3D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const void *pixels)
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint internalformat = %d, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLint border = %d, GLenum format = 0x%X, GLenum type = 0x%X, const void *pixels = 0x%p)", target, level, internalformat, width, height, depth, border, format, type, pixels);
...
void GL_APIENTRY TexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *pixels)
{
    EVENT("(GLenum target = 0x%X, GLint level = %d, GLint xoffset = %d, GLint yoffset = %d, GLint zoffset = %d, GLsizei width = %d, GLsizei height = %d, GLsizei depth = %d, GLenum format = 0x%X, GLenum type = 0x%X, const void *pixels = 0x%p)", target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels);
...
{
    EVENT("(GLuint program = %u, GLsizei count = %d, const GLchar *const*varyings = 0x%p, GLenum bufferMode = 0x%X)", program, count, varyings, bufferMode);
...
{
    EVENT("(GLint location = %d, GLsizei count = %d, const GLuint *value = 0x%p)", location, count, value);
...
{
    EVENT("(GLint location = %d, GLsizei count = %d, GLboolean transpose = %u, const GLfloat *value = 0x%p)", location, count, transpose, value);
...
{
    EVENT("(GLuint index = %u, GLint size = %d, GLenum type = 0x%X, GLsizei stride = %d, const void *pointer = 0x%p)", index, size, type, stride, pointer);
