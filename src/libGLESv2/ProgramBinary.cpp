...
// TODO: mark static use on interface block nested struct members.
bool IsStaticallyUsed(const sh::InterfaceBlockField &var)
{
    return var.staticUse;
}

bool IsStaticallyUsed(const sh::ShaderVariable &var)
{
    return true;
}
                                      ...
                                      const FragmentShader &fragmentShader)
{
    ...
    for (unsigned int blockIndex = 0; blockIndex < vertexInterfaceBlocks.size(); blockIndex++)
    {
        ...
        // Note: shared and std140 layouts are always condiered active
