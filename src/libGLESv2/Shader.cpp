...
void Shader::parseVaryings(void *compiler)
{
    if (!mHlsl.empty())
    {
        // TODO(jmadill): process staticUse.
        std::vector<sh::Varying> activeVaryings;
        ShGetVaryings(compiler, &activeVaryings);
...
void Shader::compileToHLSL(void *compiler)
{
    ...
    else if (result)
    {
        ...
        // TODO(jmadill): process staticUse.
        ShGetUniforms(compiler, &mActiveUniforms);
        ...
        // TODO(jmadill): process staticUse.
        ShGetInterfaceBlocks(compiler, &mActiveInterfaceBlocks);
...
void VertexShader::parseAttributes()
{
    ...
    {
        // TODO(jmadill): process staticUse
        ShGetAttributes(mVertexCompiler, &mActiveAttributes);
    }
}
...
void FragmentShader::compile()
{
    ...
    {
        // TODO(jmadill): process staticUse
        ShGetOutputVariables(mFragmentCompiler, &mActiveOutputVariables);
    }
}
