...
{
    LinkedUniform(GLenum type, GLenum precision, const std::string &name, unsigned int arraySize, const int blockIndex, const gl::BlockMemberInfo &blockInfo);
    ...
    const gl::BlockMemberInfo blockInfo;
