...
namespace egl
{
// Warning: Called before the Validation. Need to use "TryGetContextMutex()".
...
{
    return TryGetActiveSharedContextMutex(dpyPacked->getContext(share_contextPacked));
}
...
ContextMutex *GetContextMutex_CreateImage(Thread *thread,
                                          ...
                                          gl::ContextID ctxPacked)
{
    return TryGetActiveSharedContextMutex(dpyPacked->getContext(ctxPacked));
}
...
ContextMutex *GetContextMutex_ReleaseHighPowerGPUANGLE(Thread *thread,
                                                       ...
                                                       gl::ContextID ctxPacked)
{
    return TryGetContextMutex(dpyPacked->getContext(ctxPacked));
}
