...
{
// Warning:
//   Called before the Validation. Need to use GetContextIfValid() and Try*Get*ContextMutex().
...
{
    return TryEnsureActiveAndGetSharedContextMutex(
        GetContextIfValid(dpyPacked, share_contextPacked));
}
...
ContextMutex *GetContextMutex_GetConfigAttrib(Thread *thread,
                                              egl::Display *dpyPacked,
                                              EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryContext(Thread *thread,
                                           ...
                                           EGLint attribute)
{
    // Don't get mutex for all atributes to avoid activating SharedContextMutex when not required.
    switch (attribute)
    {
        // Dynamic state.
        case EGL_RENDER_BUFFER:
            return TryGetContextMutexForThread(GetContextIfValid(dpyPacked, ctxPacked), thread);
...
ContextMutex *GetContextMutex_QuerySurface(Thread *thread,
                                           egl::Display *dpyPacked,
                                           EGLint attribute)
{
    switch (attribute)
...
ContextMutex *GetContextMutex_SurfaceAttrib(Thread *thread,
                                            egl::Display *dpyPacked,
                                            EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_CreateImage(Thread *thread,
                                          ...
                                          gl::ContextID ctxPacked)
{
    return TryEnsureActiveAndGetSharedContextMutex(GetContextIfValid(dpyPacked, ctxPacked));
}
...
ContextMutex *GetContextMutex_GetSyncAttrib(Thread *thread,
                                            egl::Display *dpyPacked,
                                            EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryDisplayAttribANGLE(Thread *thread,
                                                      egl::Display *dpyPacked,
                                                      EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QuerySurfacePointerANGLE(Thread *thread,
                                                       egl::Display *dpyPacked,
                                                       EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryDeviceAttribEXT(Thread *thread, EGLint attribute)
{
    return nullptr;
}
...
ContextMutex *GetContextMutex_QueryDisplayAttribEXT(Thread *thread,
                                                    egl::Display *dpyPacked,
                                                    EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryDebugKHR(Thread *thread, EGLint attribute)
{
    return nullptr;
}
...
ContextMutex *GetContextMutex_GetSyncAttribKHR(Thread *thread,
                                               egl::Display *dpyPacked,
                                               EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QuerySurface64KHR(Thread *thread,
                                                egl::Display *dpyPacked,
                                                EGLint attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryStreamKHR(Thread *thread,
                                             egl::Display *dpyPacked,
                                             EGLenum attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_QueryStreamu64KHR(Thread *thread,
                                                egl::Display *dpyPacked,
                                                EGLenum attribute)
{
    return nullptr;
...
ContextMutex *GetContextMutex_StreamAttribKHR(Thread *thread,
                                              egl::Display *dpyPacked,
                                              EGLenum attribute)
{
    return nullptr;
