...
{
// Warning:
//   Called before the Validation. Need to use GetContextIfValid() and TryGet*ContextMutex().
                                           ...
                                           EGLint attribute)
{
    ...
    switch (attribute)
    {
        ...
        case EGL_RENDER_BUFFER:
            return TryGetContextMutex(GetContextIfValid(dpyPacked, ctxPacked), thread);
