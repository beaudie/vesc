...
{
    EVENT("(EGLNativeDisplayType display_id = 0x%p)", display_id);
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLint *major = 0x%p, EGLint *minor = 0x%p)", dpy, major, minor);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLint name = %d)", dpy, name);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig *configs = 0x%p, "
        "EGLint config_size = %d, EGLint *num_config = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, const EGLint *attrib_list = 0x%p, "
        "EGLConfig *configs = 0x%p, EGLint config_size = %d, EGLint *num_config = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, EGLint attribute = %d, EGLint "
        "*value = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, EGLNativeWindowType win = 0x%p, "
        "const EGLint *attrib_list = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, const EGLint *attrib_list = "
        "0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, EGLNativePixmapType pixmap = "
        "0x%p, "
        "const EGLint *attrib_list = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p)", dpy, surface);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p, EGLint attribute = %d, EGLint "
        "*value = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, EGLContext share_context = "
        "0x%p, "
        "const EGLint *attrib_list = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLContext ctx = 0x%p)", dpy, ctx);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLSurface draw = 0x%p, EGLSurface read = 0x%p, "
        "EGLContext ctx = 0x%p)",
        dpy, draw, read, ctx);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLContext ctx = 0x%p, EGLint attribute = %d, EGLint *value "
        "= 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p, EGLNativePixmapType target = "
        "0x%p)",
        dpy, surface, target);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSurface surface = 0x%p, EGLint buffer = %d)", dpy, surface,
          buffer);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLint interval = %d)", dpy, interval);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLenum buftype = 0x%X, EGLClientBuffer buffer = 0x%p, "
        "EGLConfig config = 0x%p, const EGLint *attrib_list = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLenum type = 0x%X, const EGLint* attrib_list = 0x%p)", dpy,
          type, attrib_list);
    Thread *thread = GetCurrentThread();
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSync sync = 0x%p)", dpy, sync);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLSync sync = 0x%p, EGLint flags = 0x%X, EGLTime timeout = "
        "%lu)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLSync sync = 0x%p, EGLint attribute = 0x%X, EGLAttrib "
        "*value = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLContext ctx = 0x%p, EGLenum target = 0x%X, "
        "EGLClientBuffer buffer = 0x%p, const EGLAttrib *attrib_list = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLImage image = 0x%p)", dpy, image);
    Thread *thread = GetCurrentThread();
...
{
    EVENT(
        "(EGLenum platform = %d, void* native_display = 0x%p, const EGLint* attrib_list = "
        "0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, void* native_window = 0x%p, "
        "const EGLint* attrib_list = 0x%p)",
...
{
    EVENT(
        "(EGLDisplay dpy = 0x%p, EGLConfig config = 0x%p, void* native_pixmap = 0x%p, "
        "const EGLint* attrib_list = 0x%p)",
...
{
    EVENT("(EGLDisplay dpy = 0x%p, EGLSync sync = 0x%p, EGLint flags = 0x%X)", dpy, sync, flags);
    Thread *thread = GetCurrentThread();
