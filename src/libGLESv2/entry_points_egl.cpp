...
EGLint EGLAPIENTRY GetError(void)
{
    ...
    thread->setError(egl::EglSuccess());
    return error;
}
...
EGLBoolean EGLAPIENTRY Initialize(EGLDisplay dpy, EGLint *major, EGLint *minor)
{
    ...
    {
        thread->setError(egl::EglBadDisplay());
        return EGL_FALSE;
    }
...
const char *EGLAPIENTRY QueryString(EGLDisplay dpy, EGLint name)
{
    ...
    switch (name)
    {
      ...
      case EGL_VERSION:
        ...
        break;
      default:
          thread->setError(egl::EglBadParameter());
          return nullptr;
    }
...
EGLBoolean EGLAPIENTRY DestroySurface(EGLDisplay dpy, EGLSurface surface)
{
    ...
    {
        thread->setError(egl::EglBadSurface());
        return EGL_FALSE;
    }
...
EGLBoolean EGLAPIENTRY QuerySurface(EGLDisplay dpy, EGLSurface surface, EGLint attribute, EGLint *value)
{
    ...
    switch (attribute)
    {
      ...
      case EGL_POST_SUB_BUFFER_SUPPORTED_NV:
        ...
        {
            thread->setError(egl::EglBadAttribute());
            return EGL_FALSE;
        }
      ...
      case EGL_SURFACE_ORIENTATION_ANGLE:
          ...
          {
              thread->setError(egl::EglBadAttribute() << "EGL_SURFACE_ORIENTATION_ANGLE cannot be "
                                                         "queried without "
      ...
      case EGL_DIRECT_COMPOSITION_ANGLE:
          ...
          {
              thread->setError(egl::EglBadAttribute() << "EGL_DIRECT_COMPOSITION_ANGLE cannot be "
                                                         "used without "
...
EGLBoolean EGLAPIENTRY DestroyContext(EGLDisplay dpy, EGLContext ctx)
{
    ...
    {
        thread->setError(egl::EglBadContext());
        return EGL_FALSE;
    }
...
EGLBoolean EGLAPIENTRY SwapBuffers(EGLDisplay dpy, EGLSurface surface)
{
    ...
    {
        thread->setError(egl::EglContextLost());
        return EGL_FALSE;
    }
...
EGLBoolean EGLAPIENTRY BindTexImage(EGLDisplay dpy, EGLSurface surface, EGLint buffer)
{
    ...
    {
        thread->setError(egl::EglBadAccess());
        return EGL_FALSE;
    }

    if (eglSurface->getTextureFormat() == EGL_NO_TEXTURE)
    {
        thread->setError(egl::EglBadMatch());
        return EGL_FALSE;
    }
...
EGLSync EGLAPIENTRY CreateSync(EGLDisplay dpy, EGLenum type, const EGLAttrib *attrib_list)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglCreateSync unimplemented.");
    return EGL_NO_SYNC;
}
...
EGLBoolean EGLAPIENTRY DestroySync(EGLDisplay dpy, EGLSync sync)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglDestroySync unimplemented.");
    return EGL_FALSE;
}
...
EGLint EGLAPIENTRY ClientWaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags, EGLTime timeout)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglClientWaitSync unimplemented.");
    return 0;
}
...
EGLBoolean EGLAPIENTRY GetSyncAttrib(EGLDisplay dpy, EGLSync sync, EGLint attribute, EGLAttrib *value)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglSyncAttrib unimplemented.");
    return EGL_FALSE;
}
...
EGLImage EGLAPIENTRY CreateImage(EGLDisplay dpy, EGLContext ctx, EGLenum target, EGLClientBuffer buffer, const EGLAttrib *attrib_list)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglCreateImage unimplemented.");
    return EGL_NO_IMAGE;
}
...
EGLBoolean EGLAPIENTRY DestroyImage(EGLDisplay dpy, EGLImage image)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglDestroyImage unimplemented.");
    return EGL_FALSE;
}
...
EGLDisplay EGLAPIENTRY GetPlatformDisplay(EGLenum platform, void *native_display, const EGLAttrib *attrib_list)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglGetPlatformDisplay unimplemented.");
...
EGLSurface EGLAPIENTRY CreatePlatformWindowSurface(EGLDisplay dpy, EGLConfig config, void *native_window, const EGLAttrib *attrib_list)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglCreatePlatformWindowSurface unimplemented.");
    return EGL_NO_SURFACE;
}
...
EGLSurface EGLAPIENTRY CreatePlatformPixmapSurface(EGLDisplay dpy, EGLConfig config, void *native_pixmap, const EGLAttrib *attrib_list)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglCreatePlatformPixmapSurface unimplemented.");
    return EGL_NO_SURFACE;
}
...
EGLBoolean EGLAPIENTRY WaitSync(EGLDisplay dpy, EGLSync sync, EGLint flags)
{
    ...
    UNIMPLEMENTED();
    thread->setError(egl::EglBadDisplay() << "eglWaitSync unimplemented.");
    return EGL_FALSE;
}
