...
GLint CastStateValueToInt(GLenum nativeType, GLenum queryType, GLenum pname, NativeT value)
{
    ...
    if (nativeType == GL_INT_64_ANGLEX && queryType == GL_INT)
    {
        ...
        return static_cast<GLint>(clampedValue);
    }
...
template <typename QueryT, typename NativeT>
QueryT CastStateValue(GLenum nativeType, GLenum queryType, GLenum pname, NativeT value)
{
    switch (queryType)
    {
      case GL_INT:              return CastStateValueToInt<QueryT, NativeT>(nativeType, queryType, pname, value);
      case GL_INT_64_ANGLEX:    return CastStateValueToInt<QueryT, NativeT>(nativeType, queryType, pname, value);
...
void GetCastStateValues(gl::Context *context, GLenum nativeType, GLenum queryType,
                          GLenum pname, unsigned int numParams, QueryT *outParams)
{
    if (nativeType == GL_INT)
    {
        ...
        {
            outParams[i] = CastStateValue<QueryT>(GL_INT, queryType, pname, intParams[i]);
        }
    ...
    else if (nativeType == GL_FLOAT)
    {
        ...
        for (unsigned int i = 0; i < numParams; ++i)
        {
            outParams[i] = CastStateValue<QueryT>(GL_FLOAT, queryType, pname, floatParams[i]);
        }
    ...
    else if (nativeType == GL_INT_64_ANGLEX)
    {
        ...
        for (unsigned int i = 0; i < numParams; ++i)
        {
            outParams[i] = CastStateValue<QueryT>(GL_INT_64_ANGLEX, queryType, pname, int64Params[i]);
        }
...
void __stdcall glGetBooleanv(GLenum pname, GLboolean* params)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            {
                GetCastStateValues(context, nativeType, GL_BOOL, pname, numParams, params);
            }
        }
    }
    catch(std::bad_alloc&)
...
void __stdcall glGetFloatv(GLenum pname, GLfloat* params)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            {
                GetCastStateValues(context, nativeType, GL_FLOAT, pname, numParams, params);
            }
        }
    }
    catch(std::bad_alloc&)
...
void __stdcall glGetIntegerv(GLenum pname, GLint* params)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            {
                GetCastStateValues(context, nativeType, GL_INT, pname, numParams, params);
            }
        }
    }
    catch(std::bad_alloc&)
...
void __stdcall glGetInteger64v(GLenum pname, GLint64* params)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            {
                GetCastStateValues(context, nativeType, GL_INT_64_ANGLEX, pname, numParams, params);
            }
        }
    }
    catch(std::bad_alloc&)
