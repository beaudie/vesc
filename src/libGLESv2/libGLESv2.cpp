...
GLvoid* __stdcall glMapBufferRange(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            {
                return gl::error<GLvoid*>(GL_INVALID_VALUE, NULL);
            }
            ...
            if (buffer == NULL)
            {
                return gl::error<GLvoid*>(GL_INVALID_OPERATION, NULL);
            }
...
void __stdcall glFlushMappedBufferRange(GLenum target, GLintptr offset, GLsizeiptr length)
{
    ...
    try
    {
        ...
        if (context)
        {
            ...
            // We do not support a non-trivial implementation of FlushMappedBufferRange
        }
    }
    catch(std::bad_alloc&)
    {
