...
class Texture : public RefCountObject
{
  public:
    ...
    virtual bool isSamplerComplete(const SamplerState &samplerState, const Context &context) const = 0;
...
class Texture2D : public Texture
{
  public:
    ...
    virtual bool isSamplerComplete(const SamplerState &samplerState, const Context &context) const;
