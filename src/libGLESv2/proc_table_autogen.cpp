...
ProcEntry g_procTable[] = {
    ...
    {"eglStreamConsumerGLTextureExternalAttribsNV", P(egl::StreamConsumerGLTextureExternalAttribsNV)},
    ...
    {"glCompressedCopyTextureCHROMIUMContextANGLE", P(gl::CompressedCopyTextureCHROMIUMContextANGLE)},
    ...
    {"glCompressedTexImage3DRobustANGLEContextANGLE", P(gl::CompressedTexImage3DRobustANGLEContextANGLE)},
    ...
    {"glCompressedTexSubImage2DRobustANGLEContextANGLE", P(gl::CompressedTexSubImage2DRobustANGLEContextANGLE)},
    ...
    {"glCompressedTexSubImage3DRobustANGLEContextANGLE", P(gl::CompressedTexSubImage3DRobustANGLEContextANGLE)},
    ...
    {"glEGLImageTargetRenderbufferStorageOESContextANGLE", P(gl::EGLImageTargetRenderbufferStorageOESContextANGLE)},
    ...
    {"glFramebufferTextureMultiviewLayeredANGLEContextANGLE", P(gl::FramebufferTextureMultiviewLayeredANGLEContextANGLE)},
    {"glFramebufferTextureMultiviewSideBySideANGLE", P(gl::FramebufferTextureMultiviewSideBySideANGLE)},
    {"glFramebufferTextureMultiviewSideBySideANGLEContextANGLE", P(gl::FramebufferTextureMultiviewSideBySideANGLEContextANGLE)},
    ...
    {"glGetActiveUniformBlockivRobustANGLEContextANGLE", P(gl::GetActiveUniformBlockivRobustANGLEContextANGLE)},
    ...
    {"glGetBufferParameteri64vRobustANGLEContextANGLE", P(gl::GetBufferParameteri64vRobustANGLEContextANGLE)},
    ...
    {"glGetBufferParameterivRobustANGLEContextANGLE", P(gl::GetBufferParameterivRobustANGLEContextANGLE)},
    ...
    {"glGetFramebufferAttachmentParameterivContextANGLE", P(gl::GetFramebufferAttachmentParameterivContextANGLE)},
    {"glGetFramebufferAttachmentParameterivRobustANGLE", P(gl::GetFramebufferAttachmentParameterivRobustANGLE)},
    {"glGetFramebufferAttachmentParameterivRobustANGLEContextANGLE", P(gl::GetFramebufferAttachmentParameterivRobustANGLEContextANGLE)},
    ...
    {"glGetInternalformativRobustANGLEContextANGLE", P(gl::GetInternalformativRobustANGLEContextANGLE)},
    ...
    {"glGetPointervRobustANGLERobustANGLEContextANGLE", P(gl::GetPointervRobustANGLERobustANGLEContextANGLE)},
    ...
    {"glGetProgramInterfaceivRobustANGLEContextANGLE", P(gl::GetProgramInterfaceivRobustANGLEContextANGLE)},
    ...
    {"glGetQueryObjecti64vRobustANGLEContextANGLE", P(gl::GetQueryObjecti64vRobustANGLEContextANGLE)},
    ...
    {"glGetQueryObjectui64vRobustANGLEContextANGLE", P(gl::GetQueryObjectui64vRobustANGLEContextANGLE)},
    ...
    {"glGetRenderbufferParameterivRobustANGLEContextANGLE", P(gl::GetRenderbufferParameterivRobustANGLEContextANGLE)},
    {"glGetSamplerParameterIivRobustANGLE", P(gl::GetSamplerParameterIivRobustANGLE)},
    {"glGetSamplerParameterIivRobustANGLEContextANGLE", P(gl::GetSamplerParameterIivRobustANGLEContextANGLE)},
    ...
    {"glGetSamplerParameterfvRobustANGLEContextANGLE", P(gl::GetSamplerParameterfvRobustANGLEContextANGLE)},
    ...
    {"glGetSamplerParameterivRobustANGLEContextANGLE", P(gl::GetSamplerParameterivRobustANGLEContextANGLE)},
    ...
    {"glGetTexLevelParameterfvRobustANGLEContextANGLE", P(gl::GetTexLevelParameterfvRobustANGLEContextANGLE)},
    ...
    {"glGetTexLevelParameterivRobustANGLEContextANGLE", P(gl::GetTexLevelParameterivRobustANGLEContextANGLE)},
    {"glGetTexParameterIivRobustANGLE", P(gl::GetTexParameterIivRobustANGLE)},
    {"glGetTexParameterIivRobustANGLEContextANGLE", P(gl::GetTexParameterIivRobustANGLEContextANGLE)},
    {"glGetTexParameterIuivRobustANGLE", P(gl::GetTexParameterIuivRobustANGLE)},
    {"glGetTexParameterIuivRobustANGLEContextANGLE", P(gl::GetTexParameterIuivRobustANGLEContextANGLE)},
    ...
    {"glGetTranslatedShaderSourceANGLEContextANGLE", P(gl::GetTranslatedShaderSourceANGLEContextANGLE)},
    ...
    {"glGetVertexAttribIivRobustANGLEContextANGLE", P(gl::GetVertexAttribIivRobustANGLEContextANGLE)},
    ...
    {"glGetVertexAttribIuivRobustANGLEContextANGLE", P(gl::GetVertexAttribIuivRobustANGLEContextANGLE)},
    ...
    {"glGetVertexAttribPointervRobustANGLEContextANGLE", P(gl::GetVertexAttribPointervRobustANGLEContextANGLE)},
    ...
    {"glLoadPaletteFromModelViewMatrixOESContextANGLE", P(gl::LoadPaletteFromModelViewMatrixOESContextANGLE)},
    ...
    {"glRenderbufferStorageMultisampleANGLEContextANGLE", P(gl::RenderbufferStorageMultisampleANGLEContextANGLE)},
    {"glRenderbufferStorageMultisampleContextANGLE", P(gl::RenderbufferStorageMultisampleContextANGLE)},
    ...
    {"glSamplerParameterIivRobustANGLEContextANGLE", P(gl::SamplerParameterIivRobustANGLEContextANGLE)},
    {"glSamplerParameterIuivRobustANGLE", P(gl::SamplerParameterIuivRobustANGLE)},
    {"glSamplerParameterIuivRobustANGLEContextANGLE", P(gl::SamplerParameterIuivRobustANGLEContextANGLE)},
    ...
    {"glSamplerParameterfvRobustANGLEContextANGLE", P(gl::SamplerParameterfvRobustANGLEContextANGLE)},
    ...
    {"glSamplerParameterivRobustANGLEContextANGLE", P(gl::SamplerParameterivRobustANGLEContextANGLE)},
