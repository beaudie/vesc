  ...
  private:
                             ...
                             size_t subblockIdx) const
    {
        ...
        for (size_t j = dyBegin; j < dyEnd && (y + j) < h; j++)
        {
            ...
            {
                const int pixelIndex = subblockIdx * 4 + getIndex(i, j);
                row[i]               = pixelIndex;
                pixelIndicesStat[pixelIndex]++;
            }
        }
    }
                           ...
                           int *maxColorIndex) const
    {
        ...
        *minColorIndex = minIndex;
        *maxColorIndex = maxIndex;
    }
                                                     ...
                                                     bool nonOpaquePunchThroughAlpha) const
    {
        ...
        static const size_t kNumPixels = 16;
