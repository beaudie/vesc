...
static void LoadA8ToRGBA8SSE2(size_t width,
                              size_t height,
                              size_t depth,
                              const uint8_t *input,
...
void LoadRGBA8ToBGRA8SSE2(size_t width,
                          size_t height,
                          size_t depth,
                          const uint8_t *input,
                          size_t inputRowPitch,
                      ...
                      size_t outputDepthPitch)
{
    ...
    if (gl::supportsSSE2())
    {
        LoadRGBA8ToBGRA8SSE2(width, height, depth, input, inputRowPitch, inputDepthPitch,
