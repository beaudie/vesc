...
void DirectiveParser::parseLine(Token *token)
{
    ...
    else
    {
        ...
        errorSettings.allowOperatorsNotInESSL1               = (mShaderVersion >= 300);
...
int DirectiveParser::parseExpressionIf(Token *token)
{
    ...
    int expression = 0;
    ExpressionParser::ErrorSettings errorSettings;
    // #if allows a wider variety of operators than what's available in ESSL1 itself.
    errorSettings.allowOperatorsNotInESSL1               = true;
