...
{
    raw_ptr<FILE> yy_input_file;

    raw_ptr<char> yy_ch_buf;  /* input buffer */
    raw_ptr<char> yy_buf_pos; /* current position in input buffer */
...
struct yyguts_t
{
    ...
    raw_ptr<YY_BUFFER_STATE> yy_buffer_stack; /**< Stack as an array. */
    char yy_hold_char;
    int yy_n_chars;
    int yyleng_r;
    raw_ptr<char> yy_c_buf_p;
    int yy_init;
    int yy_start;
    int yy_did_buffer_switch_on_eof;
    int yy_start_stack_ptr;
    int yy_start_stack_depth;
    raw_ptr<int> yy_start_stack;
    yy_state_type yy_last_accepting_state;
    raw_ptr<char> yy_last_accepting_cpos;

    int yylineno_r;
    int yy_flex_debug_r;

    raw_ptr<char> yytext_r;
    int yy_more_flag;
    int yy_more_len;

    raw_ptr<YYSTYPE> yylval_r;
