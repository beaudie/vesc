                                                        ...
                                                        int targetGLSLVersion)
{
    ...
    emu->addEmulatedFunction(BuiltInId::isnan_Float1, "bool isnan_emu(float x) { return x != x; }");
    emu->addEmulatedFunction(BuiltInId::isnan_Float2,
                             R"(bvec2 isnan_emu(vec2 x)
                             {
                                 bvec2 isnan;
                                 for (int i = 0; i < 2; i++)
                                 {
