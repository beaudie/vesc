                                        ...
                                        DriverUniform &driverUniforms)
{
    TIntermBinary *emuInstanceID =
        driverUniforms.createDriverUniformRef(kEmuInstanceIDField.rawName().data());
    ...
    DriverUniform &driverUniforms)
{
    ...
    TIntermBinary *coverageMask =
        driverUniforms.createDriverUniformRef(kCoverageMaskField.rawName().data());
