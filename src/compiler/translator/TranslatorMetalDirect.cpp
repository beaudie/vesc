...
void AddFragColorDeclaration(TIntermBlock &root, TSymbolTable &symbolTable, bool secondary)
{
    root.insertChildNodes(FindMainIndex(&root),
                          TIntermSequence{new TIntermDeclaration{
                              secondary ? BuiltInVariable::gl_SecondaryFragColorEXT()
                                          ...
                                          DriverUniformMetal *driverUniforms)
{
    ...
    if (getShaderType() == GL_FRAGMENT_SHADER)
    {
        ...
        if (usesFragColor)
        {
            AddFragColorDeclaration(*root, symbolTable, false);
        }
        ...
        {
            AddFragColorDeclaration(*root, symbolTable, true);
        }
