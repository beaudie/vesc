...
bool Traverser::visitAggregate(Visit visit, TIntermAggregate *node)
{
    ...
    if (is2DArray)
    {
        ...
        offsetNode = new TIntermAggregate(texCoordNode->getType(), EOpConstructIVec3, constructOffsetIvecArguments);
    ...
    TIntermAggregate *texelFetchNode = new TIntermAggregate(node->getType(), EOpCallBuiltInFunction, texelFetchArguments);
