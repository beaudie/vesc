...
//
// RewriteStructSamplersMetal: Extract structs from samplers.
//
...
#ifndef COMPILER_TRANSLATOR_TRANSLATORMETALDIRECT_REWRITESTRUCTSAMPLERSMETAL_H_
#define COMPILER_TRANSLATOR_TRANSLATORMETALDIRECT_REWRITESTRUCTSAMPLERSMETAL_H_
...
ANGLE_NO_DISCARD bool RewriteStructSamplersMetal(TCompiler *compiler,
                                                 TIntermBlock *root,
                                                 TSymbolTable *symbolTable,
                                                 int *removedUniformsCountOut);
}  // namespace sh

#endif  // COMPILER_TRANSLATOR_TRANSLATORMETALDIRECT_REWRITESTRUCTSAMPLERSMETAL_H_
