...
TBuiltinsWorkaroundVulkanGLSL::TBuiltinsWorkaroundVulkanGLSL(TSymbolTable *symbolTable,
                                                             ShCompileOptions options)
    : TIntermTraverser(true, false, false, symbolTable), mCompileOptions(options)
{}

void TBuiltinsWorkaroundVulkanGLSL::visitSymbol(TIntermSymbol *node)
{
...
bool TBuiltinsWorkaroundVulkanGLSL::visitDeclaration(Visit, TIntermDeclaration *node)
{
