...
const unsigned int kMinArraySizeUseStructuredBuffer = 20u;
    ...
    const ReferencedInterfaceBlocks &referencedInterfaceBlocks)
{
    ...
    for (const auto &blockReference : referencedInterfaceBlocks)
    {
        ...
        // TODO(xinghua.cao@intel.com): support "instanceVariable != nullptr" and member is matrix.
                ...
                kMinArraySizeUseStructuredBuffer)
        {
            ...
            interfaceBlocks += uniformBlockWithOneArrayStructureMemberString(
...
TString ResourcesHLSL::uniformBlockWithOneArrayStructureMemberString(
