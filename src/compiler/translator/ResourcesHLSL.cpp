    ...
    const TInterfaceBlock &interfaceBlock)
{
    ...
    // Restrict field and sub-fields types matches std140 storage layout rules, even the uniform
    // does not use std140 qualifier.
    bool shouldPadUniformBlockMember = shoudPadUniformBlockMemberForStructuredBuffer(fieldType);
