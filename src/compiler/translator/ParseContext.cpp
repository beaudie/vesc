...
void TParseContext::parseLocalSize(TLayoutQualifier *layoutQualifier,
                                   const TString &qualifierType,
                                   const TSourceLoc &qualifierTypeLine,
                                   int intValue,
                                   ...
                                   size_t index)
{
    ...
    layoutQualifier->localSize[index] = intValue;
}
                                                     ...
                                                     const TSourceLoc &intValueLine)
{
    ...
    {
        parseLocalSize(&qualifier, qualifierType, qualifierTypeLine, intValue, intValueLine,
                       intValueString, 0);
    }
