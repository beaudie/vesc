                                                ...
                                                const TLayoutQualifier &layoutQualifier)
{
    ...
    if (loc < 0 || loc >= mMaxUniformLocations || loc + objectLocationCount > mMaxUniformLocations)
    {
...
{
    int loc = layoutQualifier.location;
    if (loc < 0 || loc >= mMaxVertexAttribs || loc + objectLocationCount > mMaxVertexAttribs)
    {
