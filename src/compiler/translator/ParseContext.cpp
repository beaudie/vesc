                                                ...
                                                bool outOfRangeIndexIsError)
{
    ...
    return intermediate.addConstantUnion(&unionArray[size * index],
                                         node->getType(), line);
}
                                               ...
                                               bool outOfRangeIndexIsError)
{
    ...
    TConstantUnion *unionArray = node->getUnionArrayPointer();
    return intermediate.addConstantUnion(&unionArray[arrayElementSize * index],
                                         node->getType(), line);
}
                                                         ...
                                                         const TSourceLoc &fieldLocation)
{
    ...
    if (baseExpression->isVector())
    {
        ...
        if (baseExpression->getAsConstantUnion())
        {
            ...
            indexedExpression = addConstVectorNode(fields, baseExpression->getAsConstantUnion(), fieldLocation, true);
        }
        else
        {
