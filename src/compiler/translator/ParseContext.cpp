    ...
    const TSourceLoc &location)
{
    ...
    const TFunction *function    = symbolTable.addUserDefinedFunctionPrototypeDeclaration(
                                                  ...
                                                  TIntermFunctionPrototype **prototypeOut)
{
    ...
    else
    {
        ...
        function        = symbolTable.addUserDefinedFunctionDefinition(function, &wasDefined);
        if (wasDefined)
        {
