    ...
    const TVector<unsigned int> &arraySizes)
{
    ...
    {
        // TODO(oetuaho@nvidia.com): Is getArraySizeProduct() correct here?
                                                        ...
                                                        TPublicType *elementType)
{
    ...
    {
        error(arrayLoc, "function parameter array must specify a size", name->c_str());
    }
