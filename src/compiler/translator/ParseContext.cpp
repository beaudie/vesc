                                                ...
                                                const TLayoutQualifier &layoutQualifier)
{
    ...
    {
        if (loc >= mMaxUniformLocations || loc + objectLocationCount > mMaxUniformLocations ||
                                                  ...
                                                  const TLayoutQualifier &layoutQualifier)
{
    ...
    if (loc >= 0)  // Shader-specified location
    {
        if (loc >= mMaxVertexAttribs || loc + objectLocationCount > mMaxVertexAttribs ||
            objectLocationCount > mMaxVertexAttribs)
        {
