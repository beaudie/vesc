...
void TParseContext::parseInvocations(int intValue,
                                     ...
                                     int *numInvocations)
{
    // The SPEC isn't clear if 'invocations' less than 1 is an compile error or not, however we
    // limit 'invocations' to be at least 1.
...
void TParseContext::parseMaxVertices(int intValue,
                                     ...
                                     int *maxVertices)
{
    // The SPEC isn't clear if 'max_vertices' less than 0 is an compile error or not, however we
    // limit 'max_vertices' to be at least 0.
