                               ...
                               PerformanceDiagnostics *perfDiagnostics)
{
    ...
    mUniformBlockNotOptimizedNameSet.clear();
        ...
        (compileOptions & SH_ALLOW_TRANSLATE_UNIFORM_BLOCK_TO_STRUCTUREDBUFFER) != 0)
    {
        if (!sh::RecordUniformBlocksWithLargeArrayMember(root, mUniformBlockOptimizedMap,
                                                         mUniformBlockNotOptimizedNameSet))
        {
            return false;
        }
    }
...
const std::set<std::string> *TranslatorHLSL::getUniformBlockNotOptimizedNameSet() const
{
