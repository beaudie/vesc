...
HLSLSRVTextureGroup SRVTextureGroup(const TBasicType type, TLayoutImageInternalFormat imageInternalFormat)
{
...
HLSLUAVTextureGroup UAVTextureGroup(const TBasicType type, TLayoutImageInternalFormat imageInternalFormat)
{
    switch (imageInternalFormat)
    {
        case EiifRGBA32F:
