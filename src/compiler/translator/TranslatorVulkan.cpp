                                          ...
                                          bool usesFragCoord)
{
    ...
    TIntermConstantUnion *zero = CreateBasicConstant(0.0f);

    // bp.x > 0
    TIntermBinary *checkX = new TIntermBinary(EOpGreaterThan, bpX, zero);
    ...
    // bp.y > 0
    TIntermBinary *checkY = new TIntermBinary(EOpGreaterThan, bpY, zero->deepCopy());
