                                     ...
                                     TOutputVulkanGLSL *outputGLSL)
{
    ...
    if (getShaderType() != GL_COMPUTE_SHADER)
    {
        ...
        // default value of the specialization constant is irrelevant, as it will be replaced with a
        // true or false constant automatically.  We use false to only need to look for
        // OpSpecConstantFalse.
