...
class ReplaceAtomicCounterFunctionsTraverser : public TIntermTraverser
{
  public:
    ...
    bool visitAggregate(Visit visit, TIntermAggregate *node) override
    {
        ...
        const char *substituteFunction = "atomicAdd";
        ...
        TIntermTyped *substituteCall = CreateBuiltInFunctionCallNode(
            substituteFunction, substituteArguments, *mSymbolTable, 310);
...
const TVariable *DeclareAtomicCountersBuffer(TIntermBlock *root, TSymbolTable *symbolTable)
{
    ...
    // Define a storage block "AtomicCounters" with instance name "atomicCounters".
    return DeclareInterfaceBlock(root, symbolTable, fieldList, EvqBuffer, "AtomicCounters",
                                 "atomicCounters");
}
