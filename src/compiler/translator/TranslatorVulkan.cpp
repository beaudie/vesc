    ...
    if (getShaderType() == GL_FRAGMENT_SHADER)
    {
        ...
        for (const Varying &inputVarying : inputVaryings)
        {
            ...
            if (inputVarying.name == "gl_PointCoord")
            {
                ...
                FlipBuiltinVariable(root, driverUniforms, "invViewportYScale", &getSymbolTable(),
            ...
            {
                TIntermBinary *pivot =
                    CreateDriverUniformRef(driverUniforms, "halfRenderAreaHeight");
                FlipBuiltinVariable(root, driverUniforms, "viewportYScale", &getSymbolTable(),
