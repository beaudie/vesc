                         ...
                         TIntermTyped *pivot)
{
    ...
    // Create the expression "(builtin.y - pivot) * ANGLEUniforms.viewportScaleFactor.y +
    // pivot
                               ...
                               const TVariable *driverUniforms)
{
    ...
    FlipBuiltinVariable(root, insertSequence, driverUniforms, symbolTable,
                                 ...
                                 PerformanceDiagnostics * /*perfDiagnostics*/)
{
    ...
    if (getShaderType() == GL_FRAGMENT_SHADER)
    {
        ...
        if (usesPointCoord)
        {
            ...
            FlipBuiltinVariable(root, GetMainSequence(root), driverUniforms, &getSymbolTable(),
