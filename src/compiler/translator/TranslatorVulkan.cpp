                                        ...
                                        const TVariable *driverUniforms)
{
    ...
    TIntermBinary *zRotated = new TIntermBinary(EOpMatrixTimesVector, preRotationRef->deepCopy(),
                                                glPosXY->deepCopy());

    // Create the assignment "gl_Position.xy = (gl_Position.xy * preRotation)"
    TIntermBinary *assignment  = new TIntermBinary(TOperator::EOpAssign, glPosXY->deepCopy(),
                                                   zRotated);
