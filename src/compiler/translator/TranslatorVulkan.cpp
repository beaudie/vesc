                                     ...
                                     DriverUniform *driverUniforms)
{
    ...
    switch (packedShaderType)
    {
        case gl::ShaderType::Fragment:
        {
            ...
            // Translating GL_ARM_shader_framebuffer_fetch is a different operation
            // from translating the GL_EXT extension. So they need to be handled in separate
            // passes even though the extensions themselves have similar functionality.
