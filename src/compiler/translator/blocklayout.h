...
class ShaderVariableVisitor
{
  public:
    ...
    virtual void visitSamplerOrImageOrSubpassInput(const sh::ShaderVariable &variable) {}
...
class VariableNameVisitor : public ShaderVariableVisitor
{
  ...
  protected:
    virtual void visitNamedSamplerOrImageOrSubpassInput(const sh::ShaderVariable &variable,
  ...
  private:
    void visitSamplerOrImageOrSubpassInput(const sh::ShaderVariable &variable) final;
