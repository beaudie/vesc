...
class ShaderVariableVisitor
{
  public:
    ...
    virtual void visitSampler(const sh::ShaderVariable &sampler, unsigned int arrayNestingIndex) {}
...
class VariableNameVisitor : public ShaderVariableVisitor
{
  public:
    ...
    void enterArray(const ShaderVariable &arrayVar, unsigned int arrayNestingIndex) override;

    void exitArray(const ShaderVariable &arrayVar, unsigned int arrayNestingIndex) override;
  ...
  private:
    void visitSampler(const sh::ShaderVariable &sampler, unsigned int arrayNestingIndex) final;
    void visitVariable(const ShaderVariable &variable,
                       unsigned int arrayNestingIndex,
                       bool isRowMajor) final;
