...
const char *UniformRegisterPrefix(const TType &type)
{
...
TString UniformHLSL::interfaceBlockStructNameString(const TInterfaceBlock &interfaceBlock)
{
...
TString UniformHLSL::interfaceBlockFieldTypeString(const TField &field, TLayoutBlockStorage blockStorage)
{
...
TString UniformHLSL::interfaceBlockFieldString(const TInterfaceBlock &interfaceBlock, TLayoutBlockStorage blockStorage)
{
    TString hlsl;
...
TString UniformHLSL::interfaceBlockFieldString(const TInterfaceBlock &interfaceBlock, const TField &field)
{
    if (interfaceBlock.hasInstanceName())
    {
