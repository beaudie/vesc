...
OutputHLSL::OutputHLSL(
    ...
    : TIntermTraverser(true, true, true, symbolTable),
      ...
      mInsideMain(false),
      mUniformBlockTranslatedToStructuredBuffer(uniformBlockTranslatedToStructuredBuffer),
                        ...
                        const BuiltInFunctionEmulator *builtInFunctionEmulator) const
{
    ...
    out << mResourcesHLSL->uniformBlocksHeader(mReferencedUniformBlocks,
                                               mUniformBlockTranslatedToStructuredBuffer);
    ...
    switch (node->getOp())
    {
        ...
        case EOpIndexDirect:
        {
            ...
            else
            {
                ...
                if (visit == PostVisit)
                {
                    ...
                    if (interfaceBlock && mUniformBlockTranslatedToStructuredBuffer.count(
        ...
        case EOpIndexDirectInterfaceBlock:
        {
            ...
            if (visit == InVisit)
            {
                ...
                if (structInStd140UniformBlock || mUniformBlockTranslatedToStructuredBuffer.count(
                                                      interfaceBlock->uniqueId().get()) != 0)
                {
                    out << "_";
                }
