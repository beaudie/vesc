...
void OutputHLSL::header(TInfoSinkBase &out, const BuiltInFunctionEmulator *builtInFunctionEmulator)
{
    ...
    for (TextureFunctionSet::const_iterator textureFunction = mUsesTexture.begin(); textureFunction != mUsesTexture.end(); textureFunction++)
    {
        ...
        else
        {
            ...
            {
                out << "\n"
                       "    int internalFormatBits = samplerMetadata[samplerIndex].y;\n"
                       "    if (internalFormatBits == 8)\n"
                       "    {\n"
                       "        return uint4(floatSample * 255);\n"
                       "    }\n"
                       "    else if (internalFormatBits == 16)\n"
                       "    {\n"
                       "        return uint4(floatSample * 65535);\n"
                       "    }\n"
                       "    else if (internalFormatBits == 10)\n"
                       "    {\n"
                       "        return uint4(floatSample.xyz * 1023, floatSample.w * 3);\n"
                       "    }\n"
                       "    else\n"
                       "    {\n"
            ...
            else if (IsIntegerSampler(textureFunction->sampler))
            {
                out << "\n"
                       ...
                       "    if (internalFormatBits == 8)\n"
                       "    {\n"
                       "        return int4(floatSample * 128);\n"
                       "    }\n"
                       "    else if (internalFormatBits == 16)\n"
                       "    {\n"
                       "        return int4(floatSample * 32768);\n"
                       "    }\n"
                       "    else if (internalFormatBits == 10)\n"
                       "    {\n"
                       "        return int4(floatSample.xyz * 512, floatSample.w * 2);\n"
                       "    }\n"
                       "    else\n"
                       "    {\n"
