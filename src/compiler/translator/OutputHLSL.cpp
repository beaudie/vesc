    ...
    switch (node->getOp())
    {
        ...
        case EOpCallInternalRawFunction:
        {
            ...
            else
            {
                ...
                const ImmutableString &textureFunctionName = mTextureFunctionHLSL->useTextureFunction(
...
void OutputHLSL::writeArgument(const TIntermSymbol *symbol, TInfoSinkBase &out)
{
