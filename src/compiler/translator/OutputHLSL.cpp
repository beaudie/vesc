...
OutputHLSL::OutputHLSL(
    ...
    const std::map<int, const TInterfaceBlock *> &uniformBlockTranslatedToStructuredBuffers,
    ...
    : TIntermTraverser(true, true, true, symbolTable),
      ...
      mInsideMain(false),
      mUniformBlockTranslatedToStructuredBuffers(uniformBlockTranslatedToStructuredBuffers),
                        ...
                        const BuiltInFunctionEmulator *builtInFunctionEmulator) const
{
    ...
    out << mResourcesHLSL->uniformBlocksHeader(mReferencedUniformBlocks,
                                               mUniformBlockTranslatedToStructuredBuffers);
    ...
    switch (node->getOp())
    {
        ...
        case EOpIndexDirect:
        {
            ...
            else
            {
                ...
                if (visit == PostVisit)
                {
                    ...
                    if (interfaceBlock && mUniformBlockTranslatedToStructuredBuffers.count(
        ...
        case EOpIndexDirectInterfaceBlock:
        {
            ...
            if (visit == InVisit)
            {
                ...
                if (structInStd140UniformBlock || mUniformBlockTranslatedToStructuredBuffers.count(
                                                      interfaceBlock->uniqueId().get()) != 0)
                {
                    out << "_";
                }
