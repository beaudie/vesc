...
struct SetVaryingInterpolationCallback
{
  public:
    SetVaryingInterpolationCallback(InterpolationType interpolation)
        : mInterpolation(interpolation)
    {}

    void operator()(Varying &varying)
    {
...
{
    SetVaryingInterpolationCallback callback(GetInterpolationType(baseTypeQualifier));
    GetVariableInfo(type, name, &fieldsOut, &callback);
}
