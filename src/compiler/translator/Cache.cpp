                         ...
                         unsigned char secondarySize)
{
    ...
    // Even better than numeric_limit::max() because it also fails
    // static_asserts below if EnumComponentType is signed.
    const EnumComponentType MaxEnumValue = ~0;
    ...
    value = 0;
    components.basicType = (EnumComponentType)basicType;
    components.precision = (EnumComponentType)precision;
    components.qualifier = (EnumComponentType)qualifier;
