...
//
// DeferGlobalInitializers is an AST traverser to move global initializers into a function, and
// adding a function call to that function in the beginning of main().
