...
class Matrix
{
  public:
    ...
    const T &operator()(unsigned int rowIndex, unsigned int columnIndex) const
    {
    ...
    const T &at(unsigned int rowIndex, unsigned int columnIndex) const
    {
    ...
    std::vector<T> compMult(const Matrix<T> &mat1)
    {
    ...
    std::vector<T> outerProduct(const Matrix<T> &mat1)
    {
