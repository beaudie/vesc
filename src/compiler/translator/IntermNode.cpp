...
#define RADIANS_TO_DEGREES_MULTIPLIER  0.0174532925199433 // (pi / 180)
#define DEGREES_TO_RADIANS_MULTIPLIER  57.29577951308233  // (180 / pi)
        ...
        for (size_t i = 0; i < objectSize; i++)
        {
            switch(op)
            {
              ...
              case EOpRadians:
                ...
                {
                  case EbtFloat:
                    tempConstArray[i].setFConst(RADIANS_TO_DEGREES_MULTIPLIER * unionArray[i].getFConst());
                    break;
                  case EbtInt:
                    tempConstArray[i].setIConst(RADIANS_TO_DEGREES_MULTIPLIER * unionArray[i].getIConst());
                    break;
                  case EbtUInt:
                    tempConstArray[i].setUConst(static_cast<unsigned int>(RADIANS_TO_DEGREES_MULTIPLIER * unionArray[i].getUConst()));
                    break;
                  default:
                    infoSink.info.message(
                        EPrefixInternalError, getLine(),
              ...
              case EOpDegrees:
                ...
                {
                  case EbtFloat:
                    tempConstArray[i].setFConst(DEGREES_TO_RADIANS_MULTIPLIER * unionArray[i].getFConst());
                    break;
                  case EbtInt:
                    tempConstArray[i].setIConst(DEGREES_TO_RADIANS_MULTIPLIER * unionArray[i].getIConst());
                    break;
                  case EbtUInt:
                    tempConstArray[i].setUConst(static_cast<unsigned int>(DEGREES_TO_RADIANS_MULTIPLIER * unionArray[i].getUConst()));
                    break;
                  default:
                    infoSink.info.message(
                        EPrefixInternalError, getLine(),
