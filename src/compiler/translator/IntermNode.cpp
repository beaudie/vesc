...
size_t TIntermInvariantPreciseDeclaration::getChildCount() const
{
    return 1;
}

TIntermNode *TIntermInvariantPreciseDeclaration::getChildNode(size_t index) const
{
    ASSERT(mSymbol);
    ASSERT(index == 0);
    return mSymbol;
...
bool TIntermInvariantPreciseDeclaration::replaceChildNode(TIntermNode *original,
...
TIntermInvariantPreciseDeclaration::TIntermInvariantPreciseDeclaration(TIntermSymbol *symbol,
                                                                       bool isPrecise,
...
TIntermInvariantPreciseDeclaration::TIntermInvariantPreciseDeclaration(
    const TIntermInvariantPreciseDeclaration &node)
    : TIntermInvariantPreciseDeclaration(static_cast<TIntermSymbol *>(node.mSymbol->deepCopy()),
                                         node.mIsPrecise,
                                         node.mLine)
{}
