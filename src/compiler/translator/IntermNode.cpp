    ...
    for (size_t i = 0; i < objectSize; i++)
    {
        switch (op)
        {
            ...
            case EOpFindMSB:
            {
                ...
                {
                    for (unsigned int j = 31u; j >= 0u; --j)
                    {
                        if (((value & (1u << j)) == 0u) == lookForZero)
                        {
                            resultArray[i].setIConst(j);
                            break;
                        }
    ...
    switch (op)
    {
            ...
            for (size_t i = 0; i < maxObjectSize; ++i)
            {
                ...
                else
                {
                    ...
                    if (aggregate->getBasicType() == EbtInt)
                    {
                        ...
                        uint32_t signBitMask    = (1u << (offset + bits - 1));
        ...
        case EOpBitfieldInsert:
        {
            ...
            for (size_t i = 0; i < maxObjectSize; ++i)
            {
                ...
                {
                    uint32_t insertMask = ((1u << bits) - 1u) << offset;
