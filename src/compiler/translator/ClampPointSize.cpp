...
{
    TIntermSymbol *pointSizeNode = ReferToBuiltInSymbol("gl_PointSize", symbolTable, 100);
    ...
    TIntermAggregate *clampedPointSize =
    ...
    // RunAtTheEndOfShader(root, assignPointSize);
}
