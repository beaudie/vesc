...
#ifndef COMPILER_EMULATE_PRECISION_H_
#define COMPILER_EMULATE_PRECISION_H_
...
class EmulatePrecision : public TIntermTraverser
{
  ...
  private:
    ...
    // During traversing, save all the changes that need to happen;
    // then do them by calling updateTree().
    std::vector<NodeUpdateEntry> mReplacements;
};

#endif  // COMPILER_EMULATE_PRECISION_H_
