...
class TIntermTraverser : angle::NonCopyable
{
  ...
  protected:
    ...
    {
        NodeInsertMultipleEntry(TIntermAggregate *_parent, TIntermSequence::size_type _position,
                                TIntermSequence _insertionsBefore, TIntermSequence _insertionsAfter)
            : parent(_parent),
            position(_position),
    ...
    // Same as above, but supports simultaneous insertion of statements before and after the node currently being traversed.
