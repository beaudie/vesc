...
class TIntermBlock;
class TIntermInvariantPreciseDeclaration;
...
class TIntermNode : angle::NonCopyable
{
  public:
    ...
    virtual TIntermInvariantPreciseDeclaration *getAsInvariantPreciseDeclarationNode()
    {
        return nullptr;
    }
...
class TIntermInvariantPreciseDeclaration : public TIntermNode
{
  public:
    TIntermInvariantPreciseDeclaration(TIntermSymbol *symbol,
                                       bool isPrecise,
                                       const TSourceLoc &line);

    virtual TIntermInvariantPreciseDeclaration *getAsInvariantPreciseDeclarationNode() override
    {
        return this;
    }
    bool visit(Visit visit, TIntermTraverser *it) final;
    ...
    TIntermInvariantPreciseDeclaration *deepCopy() const override
    {
        return new TIntermInvariantPreciseDeclaration(*this);
    }
  ...
  private:
    ...
    TIntermInvariantPreciseDeclaration(const TIntermInvariantPreciseDeclaration &);
};
