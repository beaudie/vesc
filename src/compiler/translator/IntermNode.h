...
class TIntermAggregate : public TIntermOperator, public TIntermAggregateBase
{
  public:
    ...
    // Used for built-in functions under EOpCallBuiltInFunction. Name needs to be set before calling this.
