...
class TIntermTyped : public TIntermNode
{
  public:
    ...
    virtual TIntermTyped *deepCopy() { return nullptr; }
...
class TIntermSymbol : public TIntermTyped
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermSymbol(*this); }
...
class TIntermConstantUnion : public TIntermTyped
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermConstantUnion(*this); }
...
class TIntermBinary : public TIntermOperator
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermBinary(*this); }
...
class TIntermUnary : public TIntermOperator
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermUnary(*this); }
...
class TIntermAggregate : public TIntermOperator
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermAggregate(*this); }
...
class TIntermSelection : public TIntermTyped
{
  public:
    ...
    TIntermTyped *deepCopy() override { return new TIntermSelection(*this); }
