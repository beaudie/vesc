...
class TIntermNode : angle::NonCopyable
{
  public:
    ...
    virtual TIntermGlobalQualifierDeclaration *getAsInvariantDeclarationNode() { return nullptr; }
...
class TIntermGlobalQualifierDeclaration : public TIntermNode
{
  public:
    ...
    virtual TIntermGlobalQualifierDeclaration *getAsInvariantDeclarationNode() override
    {
        return this;
    }
    bool visit(Visit visit, TIntermTraverser *it) final;
