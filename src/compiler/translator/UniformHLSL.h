...
class UniformHLSL : angle::NonCopyable
{
  ...
  private:
    ...
    unsigned int assignUniformRegister(const TType &type, const TString &name);
    unsigned int assignSamplerInStructUniformRegister(const TType &type,
                                                      const TString &name,
                                                      unsigned int *registerCount);
    unsigned int assignSamplerInStructUniformRegister(const TType &type, const TString &name);
