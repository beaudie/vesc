...
static const ImmutableString kMainName("main");
static const ImmutableString kImageLoadName("imageLoad");
static const ImmutableString kImageStoreName("imageStore");
static const ImmutableString kImageSizeName("imageSize");
...
ImmutableString TSymbol::name() const
{
    ...
    ImmutableStringBuilder symbolNameOut(9u);  // 1 char prefix plus max 8 hex digits.
    symbolNameOut << "s";
...
const ImmutableString TFunction::buildMangledName() const
{
...
ImmutableString TFunction::GetMangledNameFromCall(const char *functionName,
