                       ...
                       TSymbolTable *symbolTable)
{
    ...
    TFunction *oldMain =
        new TFunction(symbolTable, nullptr, new TType(EbtVoid), SymbolType::ANGLE_INTERNAL);
    ...
    TIntermAggregate *oldMainCall = TIntermAggregate::CreateFunctionCall(*oldMain, new TIntermSequence());
