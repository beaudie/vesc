...
void SPIRVBuilder::predefineCommonTypes()
{
    ...
    // TODO: use reserved ids in vk::spirv::ReservedIds instead
    // http://anglebug.com/7220
    type.type = EbtVoid;
...
void SPIRVBuilder::writeNonSemanticOverview(spirv::Blob *blob, spirv::IdRef id)
{
    ...
    const spirv::IdRef zero = getUintConstant(0);
    spirv::WriteExtInst(blob, spirv::IdResultType(vk::spirv::kIdVoid), id,
                        spirv::IdRef(vk::spirv::kIdNonSemanticInstructionSet),
                        spirv::LiteralExtInstInteger(vk::spirv::kNonSemanticOverview),
                        {zero, zero});
}
