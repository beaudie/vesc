...
FunctionId::FunctionId()
    : mOp(EOpNull),
      mParam1(TTypeStaticInstance::GetBasic<EbtVoid>()),
      mParam2(TTypeStaticInstance::GetBasic<EbtVoid>()),
      mParam3(TTypeStaticInstance::GetBasic<EbtVoid>()),
      mParam4(TTypeStaticInstance::GetBasic<EbtVoid>())
{
}
