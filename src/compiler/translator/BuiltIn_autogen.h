...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(22);
    static constexpr const TSymbolUniqueId gl_ViewID_OVRESSL1       = TSymbolUniqueId(23);
};

constexpr const int kLastStaticBuiltInId = 23;
