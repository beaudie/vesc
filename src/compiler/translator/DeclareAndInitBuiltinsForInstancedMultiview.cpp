...
{
    return ReferToBuiltInSymbol("gl_InstanceID", symbolTable, 300);
}
                                                 ...
                                                 const TSymbolTable &symbolTable)
{
    ...
    if (shaderType == GL_VERTEX_SHADER)
    {
        ...
        InitializeViewIDAndInstanceID(viewIDSymbol, instanceIDSymbol, numberOfViews, symbolTable, initializers);
