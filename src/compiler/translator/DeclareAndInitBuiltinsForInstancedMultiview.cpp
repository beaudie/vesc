...
void SelectViewIndexInVertexShader(TIntermTyped *viewIDSymbol,
                                   TIntermTyped *multiviewBaseViewLayerIndexSymbolSymbol,
                                   TIntermSequence *initializers)
{
    ...
    TIntermBinary *sumOfViewIDAndBaseViewIndex =
        new TIntermBinary(EOpAdd, viewIDAsInt->deepCopy(), multiviewBaseViewLayerIndexSymbolSymbol);
    ...
    TIntermBinary *multiviewBaseViewLayerIndexZeroComparison =
        new TIntermBinary(EOpLessThan, multiviewBaseViewLayerIndexSymbolSymbol->deepCopy(),
