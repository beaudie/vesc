...
void InsertBuiltInFunctions(sh::GLenum type, ShShaderSpec spec, const ShBuiltInResources &resources, TSymbolTable &symbolTable)
{
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpTrunc, genType, "trunc", genType);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpRound, genType, "round", genType);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, EOpRoundEven, genType, "roundEven", genType);
