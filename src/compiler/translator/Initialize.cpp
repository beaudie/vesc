                      ...
                      TSymbolTable &symbolTable)
{
    ...
    switch (type)
    {
      ...
      case GL_COMPUTE_SHADER:
      {
          ...
          TVariable *maxWorkGroupSizeVar = new TVariable(
              NewPoolTString("gl_MaxComputeWorkGroupSize"), TType(EbtInt, EbpHigh, EvqConst, 3));

          TConstantUnion *workGroupSizeUnionArray = new TConstantUnion[3];
          workGroupSizeUnionArray[0].setIConst(resources.MaxComputeWorkGroupSizeX);
          workGroupSizeUnionArray[1].setIConst(resources.MaxComputeWorkGroupSizeY);
          workGroupSizeUnionArray[2].setIConst(resources.MaxComputeWorkGroupSizeZ);
          maxWorkGroupSizeVar->shareConstPointer(workGroupSizeUnionArray);

          symbolTable.insert(ESSL3_1_BUILTINS, maxWorkGroupSizeVar);

          TVariable *maxWorkGroupCountVar = new TVariable(
              NewPoolTString("gl_MaxComputeWorkGroupCount"), TType(EbtInt, EbpHigh, EvqConst, 3));

          TConstantUnion *workGroupCountUnionArray = new TConstantUnion[3];
          workGroupCountUnionArray[0].setIConst(resources.MaxComputeWorkGroupCountX);
          workGroupCountUnionArray[1].setIConst(resources.MaxComputeWorkGroupCountY);
          workGroupCountUnionArray[2].setIConst(resources.MaxComputeWorkGroupCountZ);
          maxWorkGroupCountVar->shareConstPointer(workGroupCountUnionArray);

          symbolTable.insert(ESSL3_1_BUILTINS, maxWorkGroupCountVar);
