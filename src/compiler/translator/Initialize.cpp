                            ...
                            TSymbolTable &symbolTable)
{
    ...
    {
        constexpr char *ext = "GL_OES_geometry_shader";
                      ...
                      TSymbolTable &symbolTable)
{
    ...
    switch (type)
    {
        case GL_FRAGMENT_SHADER:
        {
            ...
            if (resources.OES_geometry_shader)
            {
                symbolTable.insertVariableExt(ESSL3_1_BUILTINS, "GL_OES_geometry_shader",
                                              "gl_PrimitiveID",
        ...
        {
            constexpr char *extension = "GL_OES_geometry_shader";

            // Add built-in interface block gl_PerVertex.
            // TODO(jiawei.shao@intel.com): implement GL_OES_shader_io_blocks.
            const TString *glPerVertexString = NewPoolTString("gl_PerVertex");
            symbolTable.declareInterfaceBlockName(ESSL3_1_BUILTINS, extension, glPerVertexString);
            ...
            constexpr char *instanceName = "gl_in";
            TInterfaceBlock *glInBlock =
                new TInterfaceBlock(glPerVertexString, fieldList, NewPoolTString(instanceName), 0,
                                    true, TLayoutQualifier::create());
            symbolTable.insertVariableExt(
                ESSL3_1_BUILTINS, extension, instanceName,
                TType(glInBlock, EvqPerVertexIn, TLayoutQualifier::create()));
            ...
            glPositionType.setInterfaceBlock(new TInterfaceBlock(
                glPerVertexString, fieldList, nullptr, 0, true, TLayoutQualifier::create()));
