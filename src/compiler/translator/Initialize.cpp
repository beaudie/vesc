                      ...
                      TSymbolTable &symbolTable)
{
    ...
    switch (type)
    {
        ...
        case GL_GEOMETRY_SHADER_EXT:
        {
            ...
            TField *glPointSizeField = new TField(new TType(EbtFloat, EbpHigh, EvqPointSize, 1),
                                                  NewPoolTString("gl_PointSize"), zeroSourceLoc);
            fields->push_back(glPositionField);
            fields->push_back(glPointSizeField);
            ...
            symbolTable.insert(COMMON_BUILTINS, extension,
                               new TVariable(NewPoolTString("gl_PointSize"),
                                             TType(EbtFloat, EbpHigh, EvqPosition, 1)));
