...
{
    const TType *voidType = TTypeStaticInstance::Get1<EbtVoid>();
    const TType *float1   = TTypeStaticInstance::Get1<EbtFloat>();
    const TType *float2   = TTypeStaticInstance::Get1<EbtFloat, 2>();
    const TType *float3   = TTypeStaticInstance::Get1<EbtFloat, 3>();
    const TType *float4   = TTypeStaticInstance::Get1<EbtFloat, 4>();
    const TType *int1     = TTypeStaticInstance::Get1<EbtInt>();
    const TType *int2     = TTypeStaticInstance::Get1<EbtInt, 2>();
    const TType *int3     = TTypeStaticInstance::Get1<EbtInt, 3>();
    const TType *uint1    = TTypeStaticInstance::Get1<EbtUInt>();
    const TType *bool1    = TTypeStaticInstance::Get1<EbtBool>();
    const TType *genType  = TTypeStaticInstance::Get1<EbtGenType>();
    const TType *genIType = TTypeStaticInstance::Get1<EbtGenIType>();
    const TType *genUType = TTypeStaticInstance::Get1<EbtGenUType>();
    const TType *genBType = TTypeStaticInstance::Get1<EbtGenBType>();
    ...
    const TType *outGenType  = TTypeStaticInstance::Get2<EbtGenType, EvqOut>();
    const TType *outGenIType = TTypeStaticInstance::Get2<EbtGenIType, EvqOut>();
    ...
    const TType *mat2   = TTypeStaticInstance::Get1<EbtFloat, 2, 2>();
    const TType *mat3   = TTypeStaticInstance::Get1<EbtFloat, 3, 3>();
    const TType *mat4   = TTypeStaticInstance::Get1<EbtFloat, 4, 4>();
    const TType *mat2x3 = TTypeStaticInstance::Get1<EbtFloat, 2, 3>();
    const TType *mat3x2 = TTypeStaticInstance::Get1<EbtFloat, 3, 2>();
    const TType *mat2x4 = TTypeStaticInstance::Get1<EbtFloat, 2, 4>();
    const TType *mat4x2 = TTypeStaticInstance::Get1<EbtFloat, 4, 2>();
    const TType *mat3x4 = TTypeStaticInstance::Get1<EbtFloat, 3, 4>();
    const TType *mat4x3 = TTypeStaticInstance::Get1<EbtFloat, 4, 3>();
    ...
    const TType *vec  = TTypeStaticInstance::Get1<EbtVec>();
    const TType *ivec = TTypeStaticInstance::Get1<EbtIVec>();
    const TType *uvec = TTypeStaticInstance::Get1<EbtUVec>();
    const TType *bvec = TTypeStaticInstance::Get1<EbtBVec>();
    ...
    // Integer functions
    //
    const TType *outGenUType = TTypeStaticInstance::Get2<EbtGenUType, EvqOut>();
    ...
    const TType *sampler2D   = TTypeStaticInstance::Get1<EbtSampler2D>();
    const TType *samplerCube = TTypeStaticInstance::Get1<EbtSamplerCube>();
    ...
    {
        const TType *samplerExternalOES = TTypeStaticInstance::Get1<EbtSamplerExternalOES>();
    ...
    {
        const TType *sampler2DRect = TTypeStaticInstance::Get1<EbtSampler2DRect>();
    ...
    const TType *gvec4 = TTypeStaticInstance::Get1<EbtGVec4>();

    const TType *gsampler2D      = TTypeStaticInstance::Get1<EbtGSampler2D>();
    const TType *gsamplerCube    = TTypeStaticInstance::Get1<EbtGSamplerCube>();
    const TType *gsampler3D      = TTypeStaticInstance::Get1<EbtGSampler3D>();
    const TType *gsampler2DArray = TTypeStaticInstance::Get1<EbtGSampler2DArray>();
    const TType *gsampler2DMS    = TTypeStaticInstance::Get1<EbtGSampler2DMS>();
    ...
    {
        const TType *samplerExternal2DY2YEXT = TTypeStaticInstance::Get1<EbtSamplerExternal2DY2YEXT>();
        ...
        const TType *yuvCscStandardEXT = TTypeStaticInstance::Get1<EbtYuvCscStandardEXT>();
    ...
    const TType *sampler2DShadow      = TTypeStaticInstance::Get1<EbtSampler2DShadow>();
    const TType *samplerCubeShadow    = TTypeStaticInstance::Get1<EbtSamplerCubeShadow>();
    const TType *sampler2DArrayShadow = TTypeStaticInstance::Get1<EbtSampler2DArrayShadow>();
    ...
    const TType *atomicCounter = TTypeStaticInstance::Get1<EbtAtomicCounter>();
    ...
    const TType *int1InOut  = TTypeStaticInstance::Get2<EbtInt, EvqInOut>();
    const TType *uint1InOut = TTypeStaticInstance::Get2<EbtUInt, EvqInOut>();
    ...
    const TType *gimage2D      = TTypeStaticInstance::Get1<EbtGImage2D>();
    const TType *gimage3D      = TTypeStaticInstance::Get1<EbtGImage3D>();
    const TType *gimage2DArray = TTypeStaticInstance::Get1<EbtGImage2DArray>();
    const TType *gimageCube    = TTypeStaticInstance::Get1<EbtGImageCube>();
