...
void InsertBuiltInFunctions(sh::GLenum type, ShShaderSpec spec, const ShBuiltInResources &resources, TSymbolTable &symbolTable)
{
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int1, "min", int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "min", int2, int2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "min", int3, int3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "min", int4, int4);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "min", int2, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "min", int3, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "min", int4, int1);
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint1, "min", uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "min", uint2, uint2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "min", uint3, uint3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "min", uint4, uint4);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "min", uint2, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "min", uint3, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "min", uint4, uint1);
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int1, "max", int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "max", int2, int2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "max", int3, int3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "max", int4, int4);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "max", int2, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "max", int3, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "max", int4, int1);

    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint1, "max", uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "max", uint2, uint2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "max", uint3, uint3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "max", uint4, uint4);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "max", uint2, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "max", uint3, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "max", uint4, uint1);
    ...
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int1, "clamp", int1, int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "clamp", int2, int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "clamp", int3, int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "clamp", int4, int1, int1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int2, "clamp", int2, int2, int2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int3, "clamp", int3, int3, int3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, int4, "clamp", int4, int4, int4);

    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint1, "clamp", uint1, uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "clamp", uint2, uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "clamp", uint3, uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "clamp", uint4, uint1, uint1);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint2, "clamp", uint2, uint2, uint2);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint3, "clamp", uint3, uint3, uint3);
    symbolTable.insertBuiltIn(COMMON_BUILTINS, uint4, "clamp", uint4, uint4, uint4);
