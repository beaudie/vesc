...
{
    const TType *voidType = TTypeStaticInstance::GetBasic<EbtVoid>();
    const TType *float1   = TTypeStaticInstance::GetBasic<EbtFloat>();
    const TType *float2   = TTypeStaticInstance::GetBasic<EbtFloat, 2>();
    const TType *float3   = TTypeStaticInstance::GetBasic<EbtFloat, 3>();
    const TType *float4   = TTypeStaticInstance::GetBasic<EbtFloat, 4>();
    const TType *int1     = TTypeStaticInstance::GetBasic<EbtInt>();
    const TType *int2     = TTypeStaticInstance::GetBasic<EbtInt, 2>();
    const TType *int3     = TTypeStaticInstance::GetBasic<EbtInt, 3>();
    const TType *uint1    = TTypeStaticInstance::GetBasic<EbtUInt>();
    const TType *bool1    = TTypeStaticInstance::GetBasic<EbtBool>();
    const TType *genType  = TTypeStaticInstance::GetBasic<EbtGenType>();
    const TType *genIType = TTypeStaticInstance::GetBasic<EbtGenIType>();
    const TType *genUType = TTypeStaticInstance::GetBasic<EbtGenUType>();
    const TType *genBType = TTypeStaticInstance::GetBasic<EbtGenBType>();
    ...
    const TType *outGenType  = TTypeStaticInstance::GetQualified<EbtGenType, EvqOut>();
    const TType *outGenIType = TTypeStaticInstance::GetQualified<EbtGenIType, EvqOut>();
    ...
    const TType *mat2   = TTypeStaticInstance::GetBasic<EbtFloat, 2, 2>();
    const TType *mat3   = TTypeStaticInstance::GetBasic<EbtFloat, 3, 3>();
    const TType *mat4   = TTypeStaticInstance::GetBasic<EbtFloat, 4, 4>();
    const TType *mat2x3 = TTypeStaticInstance::GetBasic<EbtFloat, 2, 3>();
    const TType *mat3x2 = TTypeStaticInstance::GetBasic<EbtFloat, 3, 2>();
    const TType *mat2x4 = TTypeStaticInstance::GetBasic<EbtFloat, 2, 4>();
    const TType *mat4x2 = TTypeStaticInstance::GetBasic<EbtFloat, 4, 2>();
    const TType *mat3x4 = TTypeStaticInstance::GetBasic<EbtFloat, 3, 4>();
    const TType *mat4x3 = TTypeStaticInstance::GetBasic<EbtFloat, 4, 3>();
    ...
    const TType *vec  = TTypeStaticInstance::GetBasic<EbtVec>();
    const TType *ivec = TTypeStaticInstance::GetBasic<EbtIVec>();
    const TType *uvec = TTypeStaticInstance::GetBasic<EbtUVec>();
    const TType *bvec = TTypeStaticInstance::GetBasic<EbtBVec>();
    ...
    // Integer functions
    //
    const TType *outGenUType = TTypeStaticInstance::GetQualified<EbtGenUType, EvqOut>();
    ...
    const TType *sampler2D   = TTypeStaticInstance::GetBasic<EbtSampler2D>();
    const TType *samplerCube = TTypeStaticInstance::GetBasic<EbtSamplerCube>();
    ...
    {
        const TType *samplerExternalOES = TTypeStaticInstance::GetBasic<EbtSamplerExternalOES>();
    ...
    {
        const TType *sampler2DRect = TTypeStaticInstance::GetBasic<EbtSampler2DRect>();
    ...
    const TType *gvec4 = TTypeStaticInstance::GetBasic<EbtGVec4>();

    const TType *gsampler2D      = TTypeStaticInstance::GetBasic<EbtGSampler2D>();
    const TType *gsamplerCube    = TTypeStaticInstance::GetBasic<EbtGSamplerCube>();
    const TType *gsampler3D      = TTypeStaticInstance::GetBasic<EbtGSampler3D>();
    const TType *gsampler2DArray = TTypeStaticInstance::GetBasic<EbtGSampler2DArray>();
    const TType *gsampler2DMS    = TTypeStaticInstance::GetBasic<EbtGSampler2DMS>();
    ...
    if (resources.EXT_YUV_target)
    {
        const TType *samplerExternal2DY2YEXT =
            TTypeStaticInstance::GetBasic<EbtSamplerExternal2DY2YEXT>();
        ...
        const TType *yuvCscStandardEXT = TTypeStaticInstance::GetBasic<EbtYuvCscStandardEXT>();
    ...
    const TType *sampler2DShadow      = TTypeStaticInstance::GetBasic<EbtSampler2DShadow>();
    const TType *samplerCubeShadow    = TTypeStaticInstance::GetBasic<EbtSamplerCubeShadow>();
    const TType *sampler2DArrayShadow = TTypeStaticInstance::GetBasic<EbtSampler2DArrayShadow>();
    ...
    const TType *atomicCounter = TTypeStaticInstance::GetBasic<EbtAtomicCounter>();
    ...
    const TType *int1InOut  = TTypeStaticInstance::GetQualified<EbtInt, EvqInOut>();
    const TType *uint1InOut = TTypeStaticInstance::GetQualified<EbtUInt, EvqInOut>();
    ...
    const TType *gimage2D      = TTypeStaticInstance::GetBasic<EbtGImage2D>();
    const TType *gimage3D      = TTypeStaticInstance::GetBasic<EbtGImage3D>();
    const TType *gimage2DArray = TTypeStaticInstance::GetBasic<EbtGImage2DArray>();
    const TType *gimageCube    = TTypeStaticInstance::GetBasic<EbtGImageCube>();
