                            ...
                            TSymbolTable &symbolTable)
{
    ...
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", sampler2DShadow, float2);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", sampler2DShadow, float2,
                              float1);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", sampler2DArrayShadow,
                              float3);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", sampler2DArrayShadow,
                              float3, float1);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", samplerCubeShadow, float3);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGather", samplerCubeShadow, float3,
                              float1);
    ...
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGatherOffset", gsampler2DArray,
                              float3, int2, int1);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGatherOffset", sampler2DShadow,
                              float2, float1, int2);
    symbolTable.insertBuiltIn(ESSL3_1_BUILTINS, gvec4, "textureGatherOffset", sampler2DArrayShadow,
                              float3, float1, int2);
