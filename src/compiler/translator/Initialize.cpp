...
{
    const TType *voidType = TCache::getType1<EbtVoid>();
    const TType *float1   = TCache::getType1<EbtFloat>();
    const TType *float2   = TCache::getType1<EbtFloat, 2>();
    const TType *float3   = TCache::getType1<EbtFloat, 3>();
    const TType *float4   = TCache::getType1<EbtFloat, 4>();
    const TType *int1     = TCache::getType1<EbtInt>();
    const TType *int2     = TCache::getType1<EbtInt, 2>();
    const TType *int3     = TCache::getType1<EbtInt, 3>();
    const TType *uint1    = TCache::getType1<EbtUInt>();
    const TType *bool1    = TCache::getType1<EbtBool>();
    const TType *genType  = TCache::getType1<EbtGenType>();
    const TType *genIType = TCache::getType1<EbtGenIType>();
    const TType *genUType = TCache::getType1<EbtGenUType>();
    const TType *genBType = TCache::getType1<EbtGenBType>();
    ...
    const TType *outGenType  = TCache::getType2<EbtGenType, EvqOut>();
    const TType *outGenIType = TCache::getType2<EbtGenIType, EvqOut>();
    ...
    const TType *mat2   = TCache::getType1<EbtFloat, 2, 2>();
    const TType *mat3   = TCache::getType1<EbtFloat, 3, 3>();
    const TType *mat4   = TCache::getType1<EbtFloat, 4, 4>();
    const TType *mat2x3 = TCache::getType1<EbtFloat, 2, 3>();
    const TType *mat3x2 = TCache::getType1<EbtFloat, 3, 2>();
    const TType *mat2x4 = TCache::getType1<EbtFloat, 2, 4>();
    const TType *mat4x2 = TCache::getType1<EbtFloat, 4, 2>();
    const TType *mat3x4 = TCache::getType1<EbtFloat, 3, 4>();
    const TType *mat4x3 = TCache::getType1<EbtFloat, 4, 3>();
    ...
    const TType *vec  = TCache::getType1<EbtVec>();
    const TType *ivec = TCache::getType1<EbtIVec>();
    const TType *uvec = TCache::getType1<EbtUVec>();
    const TType *bvec = TCache::getType1<EbtBVec>();
    ...
    // Integer functions
    //
    const TType *outGenUType = TCache::getType2<EbtGenUType, EvqOut>();
    ...
    const TType *sampler2D   = TCache::getType1<EbtSampler2D>();
    const TType *samplerCube = TCache::getType1<EbtSamplerCube>();
    ...
    {
        const TType *samplerExternalOES = TCache::getType1<EbtSamplerExternalOES>();
    ...
    {
        const TType *sampler2DRect = TCache::getType1<EbtSampler2DRect>();
    ...
    const TType *gvec4 = TCache::getType1<EbtGVec4>();

    const TType *gsampler2D      = TCache::getType1<EbtGSampler2D>();
    const TType *gsamplerCube    = TCache::getType1<EbtGSamplerCube>();
    const TType *gsampler3D      = TCache::getType1<EbtGSampler3D>();
    const TType *gsampler2DArray = TCache::getType1<EbtGSampler2DArray>();
    const TType *gsampler2DMS    = TCache::getType1<EbtGSampler2DMS>();
    ...
    {
        const TType *samplerExternal2DY2YEXT = TCache::getType1<EbtSamplerExternal2DY2YEXT>();
        ...
        const TType *yuvCscStandardEXT = TCache::getType1<EbtYuvCscStandardEXT>();
    ...
    const TType *sampler2DShadow      = TCache::getType1<EbtSampler2DShadow>();
    const TType *samplerCubeShadow    = TCache::getType1<EbtSamplerCubeShadow>();
    const TType *sampler2DArrayShadow = TCache::getType1<EbtSampler2DArrayShadow>();
    ...
    const TType *atomicCounter = TCache::getType1<EbtAtomicCounter>();
    ...
    const TType *int1InOut  = TCache::getType2<EbtInt, EvqInOut>();
    const TType *uint1InOut = TCache::getType2<EbtUInt, EvqInOut>();
    ...
    const TType *gimage2D      = TCache::getType1<EbtGImage2D>();
    const TType *gimage3D      = TCache::getType1<EbtGImage3D>();
    const TType *gimage2DArray = TCache::getType1<EbtGImage2DArray>();
    const TType *gimageCube    = TCache::getType1<EbtGImageCube>();
