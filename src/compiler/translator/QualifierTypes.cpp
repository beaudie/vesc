                                      ...
                                      TDiagnostics *diagnostics)
{
    ...
    // TODO (mradev): How do multiple locations get combined?
    ...
    bool areQualifierChecksRelaxed) const
{
    ...
    std::vector<const TQualifierWrapperBase *> qualifierSequenceCopy = mQualifiers;
    ...
    {
        SortSequence(qualifierSequenceCopy);
    }

    for (size_t i = 1; i < qualifierSequenceCopy.size(); ++i)
    {
        const TQualifierWrapperBase *qualifier = qualifierSequenceCopy[i];
