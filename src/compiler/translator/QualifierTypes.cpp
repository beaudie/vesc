                                                ...
                                                TPrecision *outPrecision) const
{
    ...
    *outQualifier = static_cast<const TStorageQualifierWrapper *>(mQualifiers[0])->getQualifier();
    ...
    for (size_t i = 1; i < mQualifiers.size(); ++i)
    {
        ...
        switch (qualifier->getType())
        {
            ...
            case QtLayout:
                break;
            case QtStorage:
                tempResult = joinFunctionStorageQualifier(
                    outQualifier,
    ...
    for (size_t i = 1; i < mQualifiers.size(); ++i)
    {
        ...
        switch (qualifier->getType())
        {
            ...
            case QtLayout:
                ...
                break;
            case QtStorage:
                tempResult = joinVariableStorageQualifier(
                    &publicType.qualifier,
                    static_cast<const TStorageQualifierWrapper *>(qualifier)->getQualifier());
                break;
            case QtPrecision:
...
bool TQualifierSequence::joinFunctionStorageQualifier(TQualifier *joinedQualifier,
                                                      TQualifier storageQualifier) const
{
    switch (storageQualifier)
    {
