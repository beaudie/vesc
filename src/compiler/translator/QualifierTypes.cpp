...
bool JoinSmoothIn(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool JoinSmoothOut(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool JoinFlatIn(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool JoinFlatOut(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool JoinCentroidIn(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool JoinCentroidOut(TQualifier *joinedQualifier)
{
    switch (*joinedQualifier)
    {
        case EvqGlobal:
...
bool TQualifierSequence::isQualifierSequenceValid(TParseContext *context) const
{
    std::string errorMessage;
    if (HasRepeatingQualifiers(mQualifiers, &errorMessage))
    {
        context->error(mQualifiers[0]->getLine(), "qualifier sequence", errorMessage.c_str());
        return false;
    }
...
TPublicType TQualifierSequence::getPublicType(TParseContext *context) const
{
    ...
    if (!isQualifierSequenceValid(context))
    {
        return publicType;
    }
    ...
    for (size_t i = 1; i < mQualifiers.size(); ++i)
    {
        ...
        switch (qualifier->getType())
        {
            case QtInvariant:
                ...
                break;
            case QtInterpolation:
                // Expressions as 'flat centroid' and 'smooth centroid' will be handled by
                // joinStorageQualifier
                                                    ...
                                                    TQualifier interpolationQualifier) const
{
    ...
    {
        case EvqSmooth:
            if (!JoinSmooth(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqFlat:
            if (!JoinFlat(&publicType->qualifier))
            {
                return false;
            }
            break;
                                              ...
                                              TQualifier storageQualifier) const
{
    ...
    {
        case EvqUniform:
            if (!JoinUniform(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqAttribute:
            if (!JoinAttribute(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqVaryingIn:
            if (!JoinVaryingIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqVaryingOut:
            if (!JoinVaryingOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqCentroid:
        {
            if (!JoinCentroid(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqFragmentIn:
        {
            if (!JoinFragmentIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqVertexIn:
        {
            if (!JoinVertexIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqComputeIn:
        {
            if (!JoinComputeIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqFragmentOut:
        {
            if (!JoinFragmentOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqVertexOut:
        {
            if (!JoinVertexOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqCentroidOut:
        {
            if (!JoinCentroidOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqCentroidIn:
        {
            if (!JoinCentroidIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqSmoothIn:
        {
            if (!JoinSmoothIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqFlatOut:
        {
            if (!JoinFlatOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqSmoothOut:
        {
            if (!JoinSmoothOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqConst:
            if (!JoinConst(&publicType->qualifier))
            {
                return false;
            }
            break;
        case EvqIn:
        {
            if (!JoinIn(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqOut:
        {
            if (!JoinOut(&publicType->qualifier))
            {
                return false;
            }
            break;
        ...
        case EvqInOut:
        {
            if (!JoinInOut(&publicType->qualifier))
            {
                return false;
            }
            break;
