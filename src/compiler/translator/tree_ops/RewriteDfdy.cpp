...
constexpr angle::
    PackedEnumMap<vk::SurfaceRotation, FlipXYValues, angle::EnumSize<vk::SurfaceRotation>()>
        kFlipXY = {{{vk::SurfaceRotation::Identity, {{1.0f, 1.0f}}},
    ...
    PackedEnumMap<vk::SurfaceRotation, FlipXYValues, angle::EnumSize<vk::SurfaceRotation>()>
        kRotatedFlipXYForDFdx = {
            {{vk::SurfaceRotation::Identity,
              {{kFlipXY[vk::SurfaceRotation::Identity][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Identity][0],
                kFlipXY[vk::SurfaceRotation::Identity][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Identity][1]}}},
             {vk::SurfaceRotation::Rotated90Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated90Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated90Degrees][0],
                kFlipXY[vk::SurfaceRotation::Rotated90Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated90Degrees][1]}}},
             {vk::SurfaceRotation::Rotated180Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated180Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated180Degrees][0],
                kFlipXY[vk::SurfaceRotation::Rotated180Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated180Degrees][1]}}},
             {vk::SurfaceRotation::Rotated270Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated270Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated270Degrees][0],
                kFlipXY[vk::SurfaceRotation::Rotated270Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated270Degrees][1]}}},
             {vk::SurfaceRotation::FlippedIdentity,
              {{kFlipXY[vk::SurfaceRotation::FlippedIdentity][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedIdentity][0],
                kFlipXY[vk::SurfaceRotation::FlippedIdentity][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedIdentity][1]}}},
             {vk::SurfaceRotation::FlippedRotated90Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated90Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated90Degrees][0],
                kFlipXY[vk::SurfaceRotation::FlippedRotated90Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated90Degrees][1]}}},
             {vk::SurfaceRotation::FlippedRotated180Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated180Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated180Degrees][0],
                kFlipXY[vk::SurfaceRotation::FlippedRotated180Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated180Degrees][1]}}},
             {vk::SurfaceRotation::FlippedRotated270Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated270Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated270Degrees][0],
                kFlipXY[vk::SurfaceRotation::FlippedRotated270Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated270Degrees][1]}}}}};
...
constexpr angle::
    PackedEnumMap<vk::SurfaceRotation, FlipXYValues, angle::EnumSize<vk::SurfaceRotation>()>
        kRotatedFlipXYForDFdy = {
            {{vk::SurfaceRotation::Identity,
              {{kFlipXY[vk::SurfaceRotation::Identity][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Identity][4],
                kFlipXY[vk::SurfaceRotation::Identity][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Identity][5]}}},
             {vk::SurfaceRotation::Rotated90Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated90Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated90Degrees][4],
                kFlipXY[vk::SurfaceRotation::Rotated90Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated90Degrees][5]}}},
             {vk::SurfaceRotation::Rotated180Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated180Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated180Degrees][4],
                kFlipXY[vk::SurfaceRotation::Rotated180Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated180Degrees][5]}}},
             {vk::SurfaceRotation::Rotated270Degrees,
              {{kFlipXY[vk::SurfaceRotation::Rotated270Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated270Degrees][4],
                kFlipXY[vk::SurfaceRotation::Rotated270Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::Rotated270Degrees][5]}}},
             {vk::SurfaceRotation::FlippedIdentity,
              {{kFlipXY[vk::SurfaceRotation::FlippedIdentity][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedIdentity][4],
                kFlipXY[vk::SurfaceRotation::FlippedIdentity][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedIdentity][5]}}},
             {vk::SurfaceRotation::FlippedRotated90Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated90Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated90Degrees][4],
                kFlipXY[vk::SurfaceRotation::FlippedRotated90Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated90Degrees][5]}}},
             {vk::SurfaceRotation::FlippedRotated180Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated180Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated180Degrees][4],
                kFlipXY[vk::SurfaceRotation::FlippedRotated180Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated180Degrees][5]}}},
             {vk::SurfaceRotation::FlippedRotated270Degrees,
              {{kFlipXY[vk::SurfaceRotation::FlippedRotated270Degrees][0] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated270Degrees][4],
                kFlipXY[vk::SurfaceRotation::FlippedRotated270Degrees][1] *
                    kFragRotationMatrices[vk::SurfaceRotation::FlippedRotated270Degrees][5]}}}}};
