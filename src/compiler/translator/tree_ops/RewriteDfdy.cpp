                      ...
                      const DriverUniform *driverUniforms)
{
    ...
    Traverser traverser(pSymbolTable, compileOptions, specConsts, driverUniforms);
                 ...
                 const DriverUniform *driverUniforms)
{
    ...
    return Traverser::Apply(compiler, compileOptions, root, symbolTable, specConsts,
                            driverUniforms);
}
