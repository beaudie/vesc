...
class RewriteToImagesTraverser : public TIntermTraverser
{
  public:
    ...
    bool visitAggregate(Visit, TIntermAggregate *aggregate) override
    {
        ...
        {
            // Since ES 3.1 sometimes makes us have readonly and writeonly aliases of the same
            // image, we might have to surround the store with memoryBarrier calls.
            //
            ...
            // _before_ any potential memoryBarrier.
            //
            ...
            if (pls.image2DForLoading != pls.image2DForStoring)
            {
                // The load and store images are aliased. Also surround the store with memory
                // barriers.
