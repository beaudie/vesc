...
class NodeBuilder
{
  public:
    ...
    TIntermNode *createBuiltInInterlockBeginCall()
    {
        ...
        //
        // TODO(anglebug.com/7279): Tegra X1 has a desktop OpenGL context with
        // ARB_fragment_shader_interlock. Consider adding these functions to Android so PLS can be
        // coherent on Tegra X1.
#if !defined(ANDROID)
