                                          ...
                                          std::vector<ShaderVariable> *uniforms)
{
    ...
    TType *loadVarType = new TType(loadVarBasicType, loadVarPrecision, EvqGlobal, loadVarVecSize);
                                            ...
                                            std::vector<ShaderVariable> *uniforms)
{
    ...
    for (auto originInOutVarIter : declaredInOutVarMap)
    {
        ...
        TType *newOutVarType =
            new TType(loadVarBasicType, loadVarPrecision, EvqGlobal, loadVarVecSize);
