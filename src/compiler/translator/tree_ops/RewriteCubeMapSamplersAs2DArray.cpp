  ...
  private:
                                         ...
                                         TIntermFunctionDefinition **declOut)
    {
        ...
        TIntermDeclaration *dPDXdxDecl = CreateTempInitDeclarationNode(
            &dPDXdx->variable(),
            CreateBuiltInFunctionCallNode("dFdx", new TIntermSequence({IndexDirect(recipOuter, 0)}),
                                          *mSymbolTable, 100));
        TIntermDeclaration *dPDYdxDecl = CreateTempInitDeclarationNode(
            &dPDYdx->variable(),
            CreateBuiltInFunctionCallNode("dFdx", new TIntermSequence({IndexDirect(recipOuter, 1)}),
                                          *mSymbolTable, 100));
        TIntermDeclaration *dPDZdxDecl = CreateTempInitDeclarationNode(
            &dPDZdx->variable(),
            CreateBuiltInFunctionCallNode("dFdx", new TIntermSequence({IndexDirect(recipOuter, 2)}),
                                          *mSymbolTable, 100));
        TIntermDeclaration *dPDXdyDecl = CreateTempInitDeclarationNode(
            &dPDXdy->variable(),
            CreateBuiltInFunctionCallNode("dFdy", new TIntermSequence({IndexDirect(recipOuter, 0)}),
                                          *mSymbolTable, 100));
        TIntermDeclaration *dPDYdyDecl = CreateTempInitDeclarationNode(
            &dPDYdy->variable(),
            CreateBuiltInFunctionCallNode("dFdy", new TIntermSequence({IndexDirect(recipOuter, 1)}),
                                          *mSymbolTable, 100));
        TIntermDeclaration *dPDZdyDecl = CreateTempInitDeclarationNode(
            &dPDZdy->variable(),
            CreateBuiltInFunctionCallNode("dFdy", new TIntermSequence({IndexDirect(recipOuter, 2)}),
                                          *mSymbolTable, 100));
