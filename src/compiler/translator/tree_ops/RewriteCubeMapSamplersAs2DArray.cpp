  ...
  private:
                                         ...
                                         TIntermFunctionDefinition **declOut)
    {
        ...
        if (implicit)
        {
            ...
            TFunction *dFdx = new TFunction(mSymbolTable, ImmutableString("dFdx"),
                                            SymbolType::BuiltIn, vec3Type, false);
            TFunction *dFdy = new TFunction(mSymbolTable, ImmutableString("dFdy"),
                                            SymbolType::BuiltIn, vec3Type, false);
