...
constexpr const ImmutableString kEmulatedGLDrawIDName("gl_DrawID");
                     ...
                     bool shouldCollect)
{
    ...
    if (traverser.isGLDrawIDUsed())
    {
        ...
        ImmutableString mappedName = HashName(kEmulatedGLDrawIDName, hashFunction, nameMap);
        ...
        if (shouldCollect)
        {
            ...
            uniform.mappedName = mappedName.data();
