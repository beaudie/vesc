...
class TransformArrayHelper
{
  public:
    ...
    {
        const TSpan<unsigned int> &arraySizes = mBaseExpressionType.getArraySizes();
    ...
    {
        const TSpan<unsigned int> &baseTypeArraySizes = mBaseExpressionType.getArraySizes();
  ...
  private:
    ...
    void incrementIndices(const TSpan<unsigned int> &arraySizes)
    {
