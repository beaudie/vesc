...
class RewriteRowMajorMatricesTraverser : public TIntermTraverser
{
  ...
  private:
    typedef absl::flat_hash_map<const TStructure *, StructConversionData> StructMap;
    typedef absl::flat_hash_map<const TVariable *, TVariable *> InterfaceBlockMap;
    typedef absl::flat_hash_map<const TField *, bool> InterfaceBlockFieldConverted;
