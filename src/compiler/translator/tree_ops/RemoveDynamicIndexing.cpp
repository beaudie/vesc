...
{
  public:
    RemoveDynamicIndexingTraverser(std::function<bool(TIntermBinary *)> &&matcher,
                                   TSymbolTable *symbolTable,
  ...
  protected:
    ...
    std::function<bool(TIntermBinary *)> mMatcher;
    PerformanceDiagnostics *mPerfDiagnostics;
};

RemoveDynamicIndexingTraverser::RemoveDynamicIndexingTraverser(
    std::function<bool(TIntermBinary *)> &&matcher,
    TSymbolTable *symbolTable,
    PerformanceDiagnostics *perfDiagnostics)
...
bool RemoveDynamicIndexingIf(std::function<bool(TIntermBinary *)> &&matcher,
                             TCompiler *compiler,
                             TIntermNode *root,
                             TSymbolTable *symbolTable,
                             PerformanceDiagnostics *perfDiagnostics)
