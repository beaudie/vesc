                                    ...
                                    TIntermSequence *declarationsOut)
{
    ...
    (*inputAttachmentMap)[static_cast<uint32_t>(index)] = inputAttachmentVar;
                                    ...
                                    const TVariable **lastFragDataOut)
{
    ...
    for (size_t index : indexUsage)
    {
        ...
        DeclareInputAttachmentVariable(symbolTable, *attachmentTypes[index], index,
                                       inputAttachmentMap, &declarations);
    }
                                           ...
                                           InputAttachmentMap *inputAttachmentMap)
{
    ...
    if (!DeclareVariables(compiler, root, indexUsage, usesLastFragData, attachmentTypes,
                          inputAttachmentMap, &lastFragData))
    {
        return false;
    }
    ...
    if (!ReplaceVariables(compiler, root, *inputAttachmentMap, lastFragData))
    {
        return false;
    }
