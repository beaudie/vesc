                                     ...
                                     bool addBaseVertexToVertexID)
{
    ...
    if (addBaseVertexToVertexID)
    {
        ...
        // TODO(shrekshao): set uniform value of angle_BaseVertex in all draw call variants if dirty
        // when this workaround is effective
        AddBaseVertexToGLVertexIDTraverser traverserVertexID;
        root->traverse(&traverserVertexID);
        traverserVertexID.updateTree();
    }
    ...
    if (builtInVariableBaseVertex)
    {
        ...
        ReplaceVariable(root, builtInVariableBaseVertex, baseVertex);
    }
    ...
    if (builtInVariableBaseInstance)
    {
        ...
        ReplaceVariable(root, builtInVariableBaseInstance, baseInstance);
    }
