...
class RemoveInactiveVariablesTraverser : public TIntermTraverser
{
  public:
    RemoveInactiveVariablesTraverser(const std::vector<sh::ShaderVariable> &uniforms,
...
RemoveInactiveVariablesTraverser::RemoveInactiveVariablesTraverser(
...
bool RemoveInactiveVariablesTraverser::visitDeclaration(Visit visit, TIntermDeclaration *node)
{
...
bool RemoveInactiveVariables(TCompiler *compiler,
                             TIntermBlock *root,
                             const std::vector<sh::ShaderVariable> &uniforms,
                             const std::vector<sh::InterfaceBlock> &interfaceBlocks)
{
    RemoveInactiveVariablesTraverser traverser(uniforms, interfaceBlocks);
