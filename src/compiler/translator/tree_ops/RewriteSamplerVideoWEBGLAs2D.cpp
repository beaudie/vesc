...
class RewriteSamplerVideoWEBGLAs2DTraverser : public TIntermTraverser
{
  ...
  private:
    void declareSampler2D(const TVariable *samplerVideoWEBGLVar, TIntermDeclaration *node)
    {
        ...
        TVariable *sampler2DVar =
            new TVariable(mSymbolTable, samplerVideoWEBGLVar->name(), newType, SymbolType::UserDefined);
...
void RewriteSamplerVideoWEBGLAs2D(TIntermBlock *root,
