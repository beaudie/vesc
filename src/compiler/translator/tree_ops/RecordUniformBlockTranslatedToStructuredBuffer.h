...
#ifndef COMPILER_TRANSLATOR_TREEOPS_RECORDUNIFORMBLOCKTRANSLATEDTOSTRUCTUREDBUFFER_H_
#define COMPILER_TRANSLATOR_TREEOPS_RECORDUNIFORMBLOCKTRANSLATEDTOSTRUCTUREDBUFFER_H_
