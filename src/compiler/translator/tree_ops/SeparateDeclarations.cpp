...
class SeparateDeclarationsTraverser : private TIntermTraverser
{
  ...
  private:
    ...
    void replaceAccessChain(TIntermTyped *toReplace);
...
void SeparateDeclarationsTraverser::visitSymbol(TIntermSymbol *symbol)
{
    ...
    {
        replaceAccessChain(mVariableMap[variable]->deepCopy());
    }
}
...
void SeparateDeclarationsTraverser::replaceAccessChain(TIntermTyped *replacement)
{
