...
const TVariable *GetBaseOpaqueUniform(TIntermTyped *node, bool *isSamplerInStructOut)
{
  ...
  private:
                                                   ...
                                                   bool *isOriginalUsedOut)
    {
        ...
        for (size_t argIndex = 0; argIndex < callArguments.size(); ++argIndex)
        {
            ...
            const TVariable *opaqueUniform = GetBaseOpaqueUniform(callArgument, &isSamplerInStruct);
            ...
            if (!((isSamplerInStruct && isParameterArrayOfSamplerOrImage) ||
                  (isArrayOfArrayOfSamplerOrImage && isParameterArrayOfSamplerOrImage) ||
                  isAtomicCounter))
            {
                continue;
            }
