                                ...
                                const FragmentOutputVariableList &fragmentOutputVariables)
{
    ...
    // FIXME: update comments: 4x4 matrix (from https://en.wikipedia.org/wiki/Ordered_dithering)
    ...
    // FIXME: should we be subtracting -7.5, -8 or something else here? (see "adds energy" above)
