                                                         ...
                                                         TIntermFunctionDefinition **funcDefOut)
{
    ...
    //
    //     if (conv_standard == itu_601)
    //       return itu601Matrix * color;
    //
    //     else if (conv_standard == itu_601_full_range)
    //       return itu601Matrix * color;
    //
    //     else if (conv_standard == itu_709)
    ...
    TIntermBlock *returnItu601MulBlock          = new TIntermBlock;
    TIntermBlock *returnItu601FullRangeMulBlock = new TIntermBlock;
    TIntermBlock *returnItu709MulBlock          = new TIntermBlock;

    returnItu601MulBlock->appendStatement(returnItu601Mul);
    returnItu601FullRangeMulBlock->appendStatement(returnItu601FullRangeMul);
    returnItu709MulBlock->appendStatement(returnItu709Mul);
    ...
    // conv_standard == itu_*
    TIntermTyped *isItu601 = new TIntermBinary(EOpEqual, new TIntermSymbol(convParam), itu601);
    TIntermTyped *isItu601FullRange =
        new TIntermBinary(EOpEqual, new TIntermSymbol(convParam), itu601FullRange);
    TIntermTyped *isItu709 = new TIntermBinary(EOpEqual, new TIntermSymbol(convParam), itu709);

    // if (conv_standard == itu_*) return Matrix * color
    TIntermBlock *body = new TIntermBlock;

    body->appendStatement(new TIntermIfElse(isItu601, returnItu601MulBlock, nullptr));
    body->appendStatement(
        new TIntermIfElse(isItu601FullRange, returnItu601FullRangeMulBlock, nullptr));
    body->appendStatement(new TIntermIfElse(isItu709, returnItu709MulBlock, nullptr));
