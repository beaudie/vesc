                      ...
                      const DriverUniform *driverUniforms)
{
    ...
    Traverser traverser(pSymbolTable, compileOptions, shaderVersion, specConsts, driverUniforms);
                                ...
                                const DriverUniform *driverUniforms)
{
    ...
    return Traverser::Apply(compiler, compileOptions, root, symbolTable, shaderVersion, specConsts,
                            driverUniforms);
}
