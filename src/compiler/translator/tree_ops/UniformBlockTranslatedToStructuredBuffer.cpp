...
namespace
{
// Only when an uniform block member's array size is greater than or equal to
...
// There is a maximum of D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT(128) slots are available for
// shader resources on Direct3D 11. When shader version is 300, we only use
...
bool RecordUniformBlockTranslatedToStructuredBuffer(
    TIntermNode *root,
