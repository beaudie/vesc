...
void CollectVariables::visitSymbol(TIntermSymbol *symbol)
{
    ...
    else if (symbol->getType().getBasicType() == EbtInterfaceBlock)
    {
        ...
        if (!mPerVertexAdded)
        {
            ...
            const char kPointSizeName[] = "gl_PointSize";
            ...
            ShaderVariable pointSizeInfo;
            pointSizeInfo.name       = kPointSizeName;
            pointSizeInfo.mappedName = kPointSizeName;
            pointSizeInfo.type       = GL_FLOAT;
            pointSizeInfo.arraySize  = 0;
            pointSizeInfo.precision  = GL_HIGH_FLOAT;
            pointSizeInfo.staticUse  = true;

            info.fields.push_back(positionInfo);
            info.fields.push_back(pointSizeInfo);
