...
// TODO(jiawei.shao@intel.com): remove this function once it is completely removed from Chromium.
const std::vector<Varying> *GetVaryings(const ShHandle handle)
{
    ...
    switch (compiler->getShaderType())
    {
        ...
        // Compute shaders have no varyings, and geometry shaders may have both input and output
        // varyings. So we shouldn't call this function on these shaders.
        default:
        {
            UNREACHABLE();
            return nullptr;
