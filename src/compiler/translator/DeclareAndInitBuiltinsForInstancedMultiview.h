...
// change its qualifier depending on the shader type and version.
...
// - Add an initializers of ViewID_OVR and InstanceID to the beginning of the body of main. The pass
