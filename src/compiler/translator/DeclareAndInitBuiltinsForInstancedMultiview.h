...
// change its qualifier depending on the shader type and version. If the shader type is a vertex
// shader, the following AST transformations are applied: - Replace every occurrence of
// gl_InstanceID with InstanceID, mark InstanceID as internal and set its qualifier to EvqTemporary.
// - Add an initializers of ViewID_OVR and InstanceID to the beginning of the body of main.
