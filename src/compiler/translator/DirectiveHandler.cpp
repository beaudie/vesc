                                        ...
                                        const std::string &behavior)
{
    ...
    if (iter != mExtensionBehavior.end())
    {
        ...
        if (name == "GL_OVR_multiview2")
        {
            ...
            TExtensionBehavior::iterator iter =
                mExtensionBehavior.find(GetExtensionByName(kMultiviewExtName));
            if (iter != mExtensionBehavior.end())
            {
                iter->second = behaviorVal;
            }
        ...
        if (name == "GL_EXT_geometry_shader" || name == "GL_EXT_tessellation_shader")
        {
            ...
            TExtensionBehavior::iterator iter =
                mExtensionBehavior.find(GetExtensionByName(kIOBlocksExtName));
            if (iter != mExtensionBehavior.end())
            {
                iter->second = behaviorVal;
            }
