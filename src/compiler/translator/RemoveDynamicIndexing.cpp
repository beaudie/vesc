...
class RemoveDynamicIndexingTraverser : public TLValueTrackingTraverser
{
  ...
  protected:
    ...
    WarningDiagnostics *mPerformanceDiagnostics;
};
...
bool RemoveDynamicIndexingTraverser::visitBinary(Visit visit, TIntermBinary *node)
{
    ...
    if (node->getOp() == EOpIndexIndirect)
    {
        ...
        {
            mPerformanceDiagnostics->warning(node->getLine(),
...
void RemoveDynamicIndexing(TIntermNode *root,
                           ...
                           WarningDiagnostics *performanceDiagnostics)
{
    RemoveDynamicIndexingTraverser traverser(symbolTable, shaderVersion, performanceDiagnostics);
    do
    {
