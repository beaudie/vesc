                                               ...
                                               TQualifier baseQualifier)
{
    ...
    TIntermBinary *indexNode = new TIntermBinary(EOpIndexDirect, baseSymbol, TIntermTyped::CreateIndexNode(index));
    return indexNode;
}
...
TIntermAggregate *GetIndexFunctionDefinition(TType type, bool write)
{
    ...
    TIntermBinary *cond = new TIntermBinary(EOpLessThan, CreateIndexSymbol(), CreateIntConstantNode(0));
