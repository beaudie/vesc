...
TIntermAggregate *GetIndexFunctionDefinition(TType type, bool write)
{
    ...
    indexingFunction->getFunctionInfo()->setNameObj(GetIndexFunctionName(type, write));
                                          ...
                                          TIntermTyped *index)
{
    ...
    indexingCall->getFunctionInfo()->setNameObj(
                                                 ...
                                                 TIntermTyped *writtenValue)
{
    ...
    indexedWriteCall->getFunctionInfo()->setNameObj(
