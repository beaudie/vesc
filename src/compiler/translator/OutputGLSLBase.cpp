...
bool TOutputGLSLBase::isCoreGLSLOutput(ShShaderOutput output)
{
	return (output == SH_GLSL_150_CORE_OUTPUT || SH_GLSL_410_CORE_OUTPUT || SH_GLSL_420_CORE_OUTPUT);
