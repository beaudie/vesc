...
// to be accesses of a global struct, so the WGSL traverse can fill in the members of this global
...
using BuiltinAnnotationsMap = TMap<const TField *, ImmutableString>;

// `builtinAnnotationsOut` is an outvariable mapping the fields of ANGLE_Input and ANGLE_Output to
// the correct @builtin() annotations, e.g. builtinAnnotationsOut[gl_VertexID_field] =
