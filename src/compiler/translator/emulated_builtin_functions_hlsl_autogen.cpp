...
constexpr FunctionPair g_hlslFunctions[] = {
    {BUILTIN_FUNCTION_ID_mod_Float1_Float1,
     "float mod_emu(float x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float2_Float2,
     "float2 mod_emu(float2 x, float2 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float2_Float1,
     "float2 mod_emu(float2 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float3_Float3,
     "float3 mod_emu(float3 x, float3 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float3_Float1,
     "float3 mod_emu(float3 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float4_Float4,
     "float4 mod_emu(float4 x, float4 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mod_Float4_Float1,
     "float4 mod_emu(float4 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_frexp_Float1_Int1,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_frexp_Float2_Int2,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_frexp_Float3_Int3,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_frexp_Float4_Int4,
    ...
    {BUILTIN_FUNCTION_ID_faceforward_Float1_Float1_Float1,
     ...
     "    }\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_faceforward_Float2_Float2_Float2,
     ...
     "    }\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_faceforward_Float3_Float3_Float3,
     ...
     "    }\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_faceforward_Float4_Float4_Float4,
     ...
     "    }\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_atan_Float1_Float1,
    ...
    {BUILTIN_FUNCTION_ID_atan_Float4_Float4,
     ...
     "    x[2]), atan2(y[3], x[3]));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_asinh_Float1,
     "float asinh_emu(in float x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_asinh_Float2,
     "float2 asinh_emu(in float2 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_asinh_Float3,
     "float3 asinh_emu(in float3 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_asinh_Float4,
     "float4 asinh_emu(in float4 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_acosh_Float1,
     "float acosh_emu(in float x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_acosh_Float2,
     "float2 acosh_emu(in float2 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_acosh_Float3,
     "float3 acosh_emu(in float3 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_acosh_Float4,
     "float4 acosh_emu(in float4 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_atanh_Float1,
     "float atanh_emu(in float x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_atanh_Float2,
     "float2 atanh_emu(in float2 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_atanh_Float3,
     "float3 atanh_emu(in float3 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_atanh_Float4,
     "float4 atanh_emu(in float4 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_roundEven_Float1,
     "float roundEven_emu(in float x)\n"
     "{\n"
     "    return (frac(x) == 0.5 && trunc(x) % 2.0 == 0.0) ? trunc(x) : round(x);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_roundEven_Float2,
     ...
     "    return v;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_roundEven_Float3,
     ...
     "    return v;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_roundEven_Float4,
     ...
     "    return v;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_packSnorm2x16_Float2,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_packUnorm2x16_Float2,
     ...
     "    return (y << 16) | x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_packHalf2x16_Float2,
     ...
     "    return (y << 16) | x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_unpackSnorm2x16_UInt1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_unpackUnorm2x16_UInt1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_unpackHalf2x16_UInt1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_packSnorm4x8_Float4,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_packUnorm4x8_Float4,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_unpackSnorm4x8_UInt1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_unpackUnorm4x8_UInt1,
    ...
    {BUILTIN_FUNCTION_ID_inverse_Float2x2,
    ...
    {BUILTIN_FUNCTION_ID_inverse_Float3x3,
     ...
     "    return cof / determinant(transpose(m));\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_inverse_Float4x4,
    ...
    // returned.
    {BUILTIN_FUNCTION_ID_mix_Float1_Float1_Bool1,
     "float mix_emu(float x, float y, bool a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mix_Float2_Float2_Bool2,
     "float2 mix_emu(float2 x, float2 y, bool2 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mix_Float3_Float3_Bool3,
     "float3 mix_emu(float3 x, float3 y, bool3 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_mix_Float4_Float4_Bool4,
     "float4 mix_emu(float4 x, float4 y, bool4 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_UInt1_Int1_Int1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_UInt2_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_UInt3_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_UInt4_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_Int1_Int1_Int1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_Int2_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_Int3_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldExtract_Int4_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_UInt1_UInt1_Int1_Int1,
     ...
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_UInt2_UInt2_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_UInt3_UInt3_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_UInt4_UInt4_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_Int1_Int1_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_Int2_Int2_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_Int3_Int3_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_bitfieldInsert_Int4_Int4_Int1_Int1,
    ...
    {BUILTIN_FUNCTION_ID_tanh_Float1,
     "float tanh_emu(float x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_tanh_Float2,
     "float2 tanh_emu(float2 x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_tanh_Float3,
     "float3 tanh_emu(float3 x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BUILTIN_FUNCTION_ID_tanh_Float4,
