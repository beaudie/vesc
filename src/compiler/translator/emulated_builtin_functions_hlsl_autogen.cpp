...
constexpr FunctionPair g_hlslFunctions[] = {
    {BuiltInFunctionId::mod_Float1_Float1,
     "float mod_emu(float x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float2_Float2,
     "float2 mod_emu(float2 x, float2 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float2_Float1,
     "float2 mod_emu(float2 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float3_Float3,
     "float3 mod_emu(float3 x, float3 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float3_Float1,
     "float3 mod_emu(float3 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float4_Float4,
     "float4 mod_emu(float4 x, float4 y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::mod_Float4_Float1,
     "float4 mod_emu(float4 x, float y)\n"
     "{\n"
     "    return x - y * floor(x / y);\n"
     "}\n"},
    {BuiltInFunctionId::frexp_Float1_Int1,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BuiltInFunctionId::frexp_Float2_Int2,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BuiltInFunctionId::frexp_Float3_Int3,
     ...
     "    return mantissa;\n"
     "}\n"},
    {BuiltInFunctionId::frexp_Float4_Int4,
    ...
    {BuiltInFunctionId::faceforward_Float1_Float1_Float1,
     ...
     "    }\n"
     "}\n"},
    {BuiltInFunctionId::faceforward_Float2_Float2_Float2,
     ...
     "    }\n"
     "}\n"},
    {BuiltInFunctionId::faceforward_Float3_Float3_Float3,
     ...
     "    }\n"
     "}\n"},
    {BuiltInFunctionId::faceforward_Float4_Float4_Float4,
     ...
     "    }\n"
     "}\n"},
    {BuiltInFunctionId::atan_Float1_Float1,
    ...
    {BuiltInFunctionId::atan_Float4_Float4,
     ...
     "    x[2]), atan2(y[3], x[3]));\n"
     "}\n"},
    {BuiltInFunctionId::asinh_Float1,
     "float asinh_emu(in float x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::asinh_Float2,
     "float2 asinh_emu(in float2 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::asinh_Float3,
     "float3 asinh_emu(in float3 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::asinh_Float4,
     "float4 asinh_emu(in float4 x)\n"
     "{\n"
     "    return log(x + sqrt(pow(x, 2.0) + 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::acosh_Float1,
     "float acosh_emu(in float x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::acosh_Float2,
     "float2 acosh_emu(in float2 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::acosh_Float3,
     "float3 acosh_emu(in float3 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::acosh_Float4,
     "float4 acosh_emu(in float4 x)\n"
     "{\n"
     "    return log(x + sqrt(x + 1.0) * sqrt(x - 1.0));\n"
     "}\n"},
    {BuiltInFunctionId::atanh_Float1,
     "float atanh_emu(in float x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BuiltInFunctionId::atanh_Float2,
     "float2 atanh_emu(in float2 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BuiltInFunctionId::atanh_Float3,
     "float3 atanh_emu(in float3 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BuiltInFunctionId::atanh_Float4,
     "float4 atanh_emu(in float4 x)\n"
     "{\n"
     "    return 0.5 * log((1.0 + x) / (1.0 - x));\n"
     "}\n"},
    {BuiltInFunctionId::roundEven_Float1,
     "float roundEven_emu(in float x)\n"
     "{\n"
     "    return (frac(x) == 0.5 && trunc(x) % 2.0 == 0.0) ? trunc(x) : round(x);\n"
     "}\n"},
    {BuiltInFunctionId::roundEven_Float2,
     ...
     "    return v;\n"
     "}\n"},
    {BuiltInFunctionId::roundEven_Float3,
     ...
     "    return v;\n"
     "}\n"},
    {BuiltInFunctionId::roundEven_Float4,
     ...
     "    return v;\n"
     "}\n"},
    {BuiltInFunctionId::packSnorm2x16_Float2,
     ...
     "}\n"},
    {BuiltInFunctionId::packUnorm2x16_Float2,
     ...
     "    return (y << 16) | x;\n"
     "}\n"},
    {BuiltInFunctionId::packHalf2x16_Float2,
     ...
     "    return (y << 16) | x;\n"
     "}\n"},
    {BuiltInFunctionId::unpackSnorm2x16_UInt1,
     ...
     "}\n"},
    {BuiltInFunctionId::unpackUnorm2x16_UInt1,
     ...
     "}\n"},
    {BuiltInFunctionId::unpackHalf2x16_UInt1,
     ...
     "}\n"},
    {BuiltInFunctionId::packSnorm4x8_Float4,
     ...
     "}\n"},
    {BuiltInFunctionId::packUnorm4x8_Float4,
     ...
     "}\n"},
    {BuiltInFunctionId::unpackSnorm4x8_UInt1,
     ...
     "}\n"},
    {BuiltInFunctionId::unpackUnorm4x8_UInt1,
    ...
    {BuiltInFunctionId::inverse_Float2x2,
    ...
    {BuiltInFunctionId::inverse_Float3x3,
     ...
     "    return cof / determinant(transpose(m));\n"
     "}\n"},
    {BuiltInFunctionId::inverse_Float4x4,
    ...
    // returned.
    {BuiltInFunctionId::mix_Float1_Float1_Bool1,
     "float mix_emu(float x, float y, bool a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BuiltInFunctionId::mix_Float2_Float2_Bool2,
     "float2 mix_emu(float2 x, float2 y, bool2 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BuiltInFunctionId::mix_Float3_Float3_Bool3,
     "float3 mix_emu(float3 x, float3 y, bool3 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BuiltInFunctionId::mix_Float4_Float4_Bool4,
     "float4 mix_emu(float4 x, float4 y, bool4 a)\n"
     "{\n"
     "    return a ? y : x;\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_UInt1_Int1_Int1,
     ...
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_UInt2_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_UInt3_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_UInt4_Int1_Int1,
     ...
     "    return (value & mask) >> offset;\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_Int1_Int1_Int1,
     ...
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_Int2_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_Int3_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldExtract_Int4_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_UInt1_UInt1_Int1_Int1,
     ...
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_UInt2_UInt2_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_UInt3_UInt3_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_UInt4_UInt4_Int1_Int1,
     ...
     "    return (base & baseMask) | ((insert << offset) & insertMask);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_Int1_Int1_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_Int2_Int2_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_Int3_Int3_Int1_Int1,
     ...
     "    return asint(resultUnsigned);\n"
     "}\n"},
    {BuiltInFunctionId::bitfieldInsert_Int4_Int4_Int1_Int1,
    ...
    {BuiltInFunctionId::tanh_Float1,
     "float tanh_emu(float x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BuiltInFunctionId::tanh_Float2,
     "float2 tanh_emu(float2 x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BuiltInFunctionId::tanh_Float3,
     "float3 tanh_emu(float3 x)\n"
     "{\n"
     "    return (abs(x) > 15.0) ? sign(x) : tanh(x);\n"
     "}\n"},
    {BuiltInFunctionId::tanh_Float4,
