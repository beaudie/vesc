                                                                    ...
                                                                    TExtension ext)
{
    ...
    {
        mUnmangledBuiltIns[immName] = UnmangledBuiltIn(immName, ext);
    }
}
...
void TSymbolTable::initializeBuiltInVariables(sh::GLenum type,
                                              ...
                                              const ShBuiltInResources &resources)
{
    // Here we initialize built-ins whose type depends on resources or whose type can't be a
    // StaticType, for example structs.
