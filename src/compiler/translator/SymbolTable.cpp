                                 ...
                                 const TType *ptype5)
{
    if (ptype1->getBasicType() == EbtGSampler2D)
    {
        ...
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtSampler2D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtISampler2D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtUSampler2D>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler3D)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtSampler3D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtISampler3D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtUSampler3D>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSamplerCube)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtSamplerCube>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtISamplerCube>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtUSamplerCube>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler2DArray)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtSampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtISampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtUSampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler2DMS)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtSampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtISampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::GetBasic<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::GetBasic<EbtUSampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (IsGImage(ptype1->getBasicType()))
    {
        insertUnmangledBuiltInName(name, level);

        const TType *floatType    = TTypeStaticInstance::GetBasic<EbtFloat, 4>();
        const TType *intType      = TTypeStaticInstance::GetBasic<EbtInt, 4>();
        const TType *unsignedType = TTypeStaticInstance::GetBasic<EbtUInt, 4>();
