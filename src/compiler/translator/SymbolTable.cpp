                                 ...
                                 const TType *ptype5)
{
    ...
    else if (ptype1->getBasicType() == EbtGSampler2DArray)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::Get1<EbtFloat, 4>() : rvalue, name,
                      TTypeStaticInstance::Get1<EbtSampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::Get1<EbtInt, 4>() : rvalue, name,
                      TTypeStaticInstance::Get1<EbtISampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
        insertBuiltIn(level, gvec4 ? TTypeStaticInstance::Get1<EbtUInt, 4>() : rvalue, name,
                      TTypeStaticInstance::Get1<EbtUSampler2DArray>(), ptype2, ptype3, ptype4,
                      ptype5);
    }
