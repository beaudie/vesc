...
constexpr const TType *SpecificType(const TType *type, int size)
{
    ...
    {
        case EbtGenType:
            return TCache::getTypeVecQualified<EbtFloat>(type->getQualifier(),
                                                         static_cast<unsigned char>(size));
        case EbtGenIType:
            return TCache::getTypeVecQualified<EbtInt>(type->getQualifier(),
                                                       static_cast<unsigned char>(size));
        case EbtGenUType:
            return TCache::getTypeVecQualified<EbtUInt>(type->getQualifier(),
                                                        static_cast<unsigned char>(size));
        case EbtGenBType:
            return TCache::getTypeVecQualified<EbtBool>(type->getQualifier(),
                                                        static_cast<unsigned char>(size));
        default:
            return type;
    }
...
constexpr const TType *VectorType(const TType *type, int size)
{
    ...
    {
        case EbtVec:
            return TCache::getTypeVecMat<EbtFloat>(static_cast<unsigned char>(size));
        case EbtIVec:
            return TCache::getTypeVecMat<EbtInt>(static_cast<unsigned char>(size));
        case EbtUVec:
            return TCache::getTypeVecMat<EbtUInt>(static_cast<unsigned char>(size));
        case EbtBVec:
            return TCache::getTypeVecMat<EbtBool>(static_cast<unsigned char>(size));
        default:
            return type;
    }
}
                                 ...
                                 const TType *ptype5)
{
    if (ptype1->getBasicType() == EbtGSampler2D)
    {
        ...
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtFloat, 4>() : rvalue, name,
                      TCache::getType1<EbtSampler2D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtInt, 4>() : rvalue, name,
                      TCache::getType1<EbtISampler2D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtUInt, 4>() : rvalue, name,
                      TCache::getType1<EbtUSampler2D>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler3D)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtFloat, 4>() : rvalue, name,
                      TCache::getType1<EbtSampler3D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtInt, 4>() : rvalue, name,
                      TCache::getType1<EbtISampler3D>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtUInt, 4>() : rvalue, name,
                      TCache::getType1<EbtUSampler3D>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSamplerCube)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtFloat, 4>() : rvalue, name,
                      TCache::getType1<EbtSamplerCube>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtInt, 4>() : rvalue, name,
                      TCache::getType1<EbtISamplerCube>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtUInt, 4>() : rvalue, name,
                      TCache::getType1<EbtUSamplerCube>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler2DArray)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtFloat, 4>() : rvalue, name,
                      TCache::getType1<EbtSampler2DArray>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtInt, 4>() : rvalue, name,
                      TCache::getType1<EbtISampler2DArray>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtUInt, 4>() : rvalue, name,
                      TCache::getType1<EbtUSampler2DArray>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (ptype1->getBasicType() == EbtGSampler2DMS)
    {
        ...
        bool gvec4 = (rvalue->getBasicType() == EbtGVec4);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtFloat, 4>() : rvalue, name,
                      TCache::getType1<EbtSampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtInt, 4>() : rvalue, name,
                      TCache::getType1<EbtISampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
        insertBuiltIn(level, gvec4 ? TCache::getType1<EbtUInt, 4>() : rvalue, name,
                      TCache::getType1<EbtUSampler2DMS>(), ptype2, ptype3, ptype4, ptype5);
    }
    else if (IsGImage(ptype1->getBasicType()))
    {
        insertUnmangledBuiltInName(name, level);

        const TType *floatType    = TCache::getType1<EbtFloat, 4>();
        const TType *intType      = TCache::getType1<EbtInt, 4>();
        const TType *unsignedType = TCache::getType1<EbtUInt, 4>();

        const TType *floatImage    = TCache::getFloatImageType(ptype1->getBasicType());
        const TType *intImage      = TCache::getIntImageType(ptype1->getBasicType());
        const TType *unsignedImage = TCache::getUintImageType(ptype1->getBasicType());
