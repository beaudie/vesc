...
const TSymbol *TSymbolTable::findGlobal(const std::vector<ImmutableString> &names) const
{
...
const TSymbol *TSymbolTable::findBuiltIn(const std::vector<ImmutableString> &names,
