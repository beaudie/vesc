...
constexpr const TType *SpecificType(const TType *type, int size)
{
    ...
    {
        case EbtGenType:
            return TCache::getTypeVecQualified<EbtFloat>(type->getQualifier(), size);
        case EbtGenIType:
            return TCache::getTypeVecQualified<EbtInt>(type->getQualifier(), size);
        case EbtGenUType:
            return TCache::getTypeVecQualified<EbtUInt>(type->getQualifier(), size);
        case EbtGenBType:
            return TCache::getTypeVecQualified<EbtBool>(type->getQualifier(), size);
        default:
            return type;
    }
}
...
constexpr const TType *VectorType(const TType *type, int size)
{
    ...
    {
        case EbtVec:
            return TCache::getTypeVecMat<EbtFloat>(size);
        case EbtIVec:
            return TCache::getTypeVecMat<EbtInt>(size);
        case EbtUVec:
            return TCache::getTypeVecMat<EbtUInt>(size);
        case EbtBVec:
            return TCache::getTypeVecMat<EbtBool>(size);
        default:
            return type;
    }
}
                                 ...
                                 const TType *ptype5)
{
    ...
    else if (IsGImage(ptype1->getBasicType()))
    {
        ...
        const TType *floatImage =
            TCache::getTypeSimple(convertGImageToFloatImage(ptype1->getBasicType()));
        const TType *intImage =
            TCache::getTypeSimple(convertGImageToIntImage(ptype1->getBasicType()));
        const TType *unsignedImage =
            TCache::getTypeSimple(convertGImageToUnsignedImage(ptype1->getBasicType()));
