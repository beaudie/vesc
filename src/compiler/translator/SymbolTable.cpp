                                 ...
                                 const TType *ptype1, const TType *ptype2, const TType *ptype3, const TType *ptype4, const TType *ptype5)
{
    ...
    else
    {
        ...
        TConstParameter param1 = {0, ptype1};
        function->addParameter(param1);

        if (ptype2)
        {
            TConstParameter param2 = {0, ptype2};
            function->addParameter(param2);
        }

        if (ptype3)
        {
            TConstParameter param3 = {0, ptype3};
            function->addParameter(param3);
        }

        if (ptype4)
        {
            TConstParameter param4 = {0, ptype4};
            function->addParameter(param4);
        }

        if (ptype5)
        {
            TConstParameter param5 = {0, ptype5};
