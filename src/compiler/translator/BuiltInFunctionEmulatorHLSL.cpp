                                                        ...
                                                        int targetGLSLVersion)
{
    ...
    emu->addEmulatedFunction(BUILTIN_FUNCTION_ID_isnan_Float1,
...
void InitBuiltInFunctionEmulatorForHLSL(BuiltInFunctionEmulator *emu)
{
    ...
    emu->addEmulatedFunction(BUILTIN_FUNCTION_ID_umulExtended_UInt1_UInt1_UInt1_UInt1,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_umulExtended_UInt1_UInt1_UInt1_UInt1,
        BUILTIN_FUNCTION_ID_umulExtended_UInt2_UInt2_UInt2_UInt2,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_umulExtended_UInt1_UInt1_UInt1_UInt1,
        BUILTIN_FUNCTION_ID_umulExtended_UInt3_UInt3_UInt3_UInt3,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_umulExtended_UInt1_UInt1_UInt1_UInt1,
        BUILTIN_FUNCTION_ID_umulExtended_UInt4_UInt4_UInt4_UInt4,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_umulExtended_UInt1_UInt1_UInt1_UInt1,
        BUILTIN_FUNCTION_ID_imulExtended_Int1_Int1_Int1_Int1,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_imulExtended_Int1_Int1_Int1_Int1,
        BUILTIN_FUNCTION_ID_imulExtended_Int2_Int2_Int2_Int2,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_imulExtended_Int1_Int1_Int1_Int1,
        BUILTIN_FUNCTION_ID_imulExtended_Int3_Int3_Int3_Int3,
    ...
    emu->addEmulatedFunctionWithDependency(
        BUILTIN_FUNCTION_ID_imulExtended_Int1_Int1_Int1_Int1,
        BUILTIN_FUNCTION_ID_imulExtended_Int4_Int4_Int4_Int4,
