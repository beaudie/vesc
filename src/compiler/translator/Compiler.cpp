                                        ...
                                        const int compileOptions)
{
    ...
    if (success)
    {
        ...
        mLocalSizeDeclared = parseContext.isLocalSizeDeclared();
        mLocalSize[0]      = parseContext.getLocalSizeX();
        mLocalSize[1]      = parseContext.getLocalSizeY();
        mLocalSize[2]      = parseContext.getLocalSizeZ();
