                                    ...
                                    ShCompileOptions compileOptions)
{
    ...
    // Remove unreferenced variables as well as statically unused resources such as atomic counters
    // and images.  This must be done after CollectVariables so the latter can participate in shader
    // interface matching before being eliminated.
