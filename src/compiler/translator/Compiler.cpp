                                    ...
                                    ShCompileOptions compileOptions)
{
    ...
    if (shouldCollectVariables(compileOptions))
    {
        ...
        CollectVariables(root, &mAttributes, &mOutputVariables, &mUniforms, &mInputVaryings,
                         ...
                         &mShaderStorageBlocks, &mInBlocks, &mOutBlocks, mResources.HashFunction,
                         &mSymbolTable, mShaderType, mExtensionBehavior);
...
void TCompiler::collectInterfaceBlocks()
{
    ...
    mInterfaceBlocks.reserve(mUniformBlocks.size() + mShaderStorageBlocks.size() +
                             mInBlocks.size() + mOutBlocks.size());
    ...
    mInterfaceBlocks.insert(mInterfaceBlocks.end(), mOutBlocks.begin(), mOutBlocks.end());
}
