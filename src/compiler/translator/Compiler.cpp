                                         ...
                                         const ShCompileOptions compileOptions)
{
    ...
    if (success)
    {
        ...
        {
            mGeometryShaderInputPrimitiveType  = parseContext.getGeometryInputPrimitiveType();
            mGeometryShaderOutputPrimitiveType = parseContext.getGeometryOutputPrimitiveType();
            mGeometryShaderMaxVertices         = parseContext.getGeometryMaxVertices();
            mGeometryShaderInvocations         = parseContext.getGeometryInvocations();
        }
...
void TCompiler::setResourceString()
{
    ...
    strstream << ":MaxVertexAttribs:" << compileResources.MaxVertexAttribs
        ...
        << ":MaxGeometryAtomicCounters:" << compileResources.MaxGeometryInvocations;
    // clang-format on
