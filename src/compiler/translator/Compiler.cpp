...
void TCompiler::setResourceString()
{
    ...
    strstream << ":MaxVertexAttribs:" << compileResources.MaxVertexAttribs
              ...
              << ":MaxComputeSharedMemorySize:" << compileResources.MaxComputeSharedMemorySize
              << ":MaxUniformLocations:" << compileResources.MaxUniformLocations
              << ":MaxShaderStorageBlockSize:" << compileResources.MaxShaderStorageBlockSize
              << ":MaxVertexShaderStorageBlocks:" << compileResources.MaxVertexShaderStorageBlocks
              << ":MaxFragmentShaderStorageBlocks:" << compileResources.MaxFragmentShaderStorageBlocks
              << ":MaxCombinedComputeUniformComponents:" << compileResources.MaxCombinedComputeUniformComponents;
    // clang-format on
