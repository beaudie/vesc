                                         ...
                                         const ShCompileOptions compileOptions)
{
    ...
    {
        auto it = mExtensionBehavior.find(TExtension::WEBGL_multi_draw_arrays);
                                    ...
                                    ShCompileOptions compileOptions)
{
    ...
    if (mShaderType == GL_VERTEX_SHADER &&
        IsExtensionEnabled(mExtensionBehavior, TExtension::WEBGL_multi_draw_arrays))
    {
        if (compileOptions & SH_EMULATE_GL_DRAW_ID)
        {
            EmulateGLDrawID(root, &mSymbolTable, &mUniforms, mResources.HashFunction,
