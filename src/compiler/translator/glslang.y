...
%union {
    ...
    struct {
        ...
        union {
            ...
            TQualifierSequence* qualifierSequence;
        };
    } interm;
}
...
%type <interm.qualifierSequence> type_qualifier
...
declaration
    ...
    | type_qualifier enter_struct struct_declaration_list RIGHT_BRACE SEMICOLON {
        TPublicType publicType = $1->getPublicType(context);
        ES3_OR_NEWER(getQualifierString(publicType.qualifier), @1, "interface blocks");
        $$ = context->addInterfaceBlock(publicType, @2, *$2.string, $3, NULL, @$, NULL, @$);
    }
    | type_qualifier enter_struct struct_declaration_list RIGHT_BRACE IDENTIFIER SEMICOLON {
        TPublicType publicType = $1->getPublicType(context);
        ES3_OR_NEWER(getQualifierString(publicType.qualifier), @1, "interface blocks");
        $$ = context->addInterfaceBlock(publicType, @2, *$2.string, $3, $5.string, @5, NULL, @$);
    }
    | type_qualifier enter_struct struct_declaration_list RIGHT_BRACE IDENTIFIER LEFT_BRACKET constant_expression RIGHT_BRACKET SEMICOLON {
        TPublicType publicType = $1->getPublicType(context);
        ES3_OR_NEWER(getQualifierString(publicType.qualifier), @1, "interface blocks");
        $$ = context->addInterfaceBlock(publicType, @2, *$2.string, $3, $5.string, @5, $7, @6);
    }
    | type_qualifier SEMICOLON {
        context->parseGlobalLayoutQualifier($1->getPublicType(context));
        $$ = 0;
    }
    | type_qualifier IDENTIFIER SEMICOLON // e.g. to qualify an existing variable as invariant
    {
        $$ = context->parseInvariantDeclaration($1->getPublicType(context), @2, $2.string, $2.symbol);
    }
    ;
...
parameter_declaration
    ...
    : type_qualifier parameter_declarator {
        $$ = $2;
        context->checkIsParameterQualifierValid(@2, $1->getPublicType(context), $2.param.type);
    }
    | parameter_declarator {
        $$ = $1;
...
type_qualifier
    : single_type_qualifier {
        $$ = new TQualifierSequence(new TStorageQualifierWrapper(context->symbolTable.atGlobalLevel() ? EvqGlobal : EvqTemporary, @1));
        $$->joinQualifier($1);
    }
