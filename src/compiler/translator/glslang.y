...
parameter_declarator
    ...
    | type_specifier identifier array_specifier {
        // TODO: Parameters can't be unsized. Now it's not a syntax error so need to have a check for it.
...
init_declarator_list
    ...
    | init_declarator_list COMMA identifier array_specifier {
        // TODO: Implicitly sized array without an initializer is not a syntax error anymore. Need to check it.
        $$ = $1;
...
single_declaration
    ...
    | fully_specified_type identifier array_specifier {
        // TODO: Implicitly sized declaration without an initializer is not a syntax error anymore. Need to add a check for it.
        $$.type = $1;
