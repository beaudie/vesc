...
%token <lex> SAMPLERCUBEARRAYARB SAMPLERCUBEARRAYSHADOWARB ISAMPLERCUBEARRAYARB USAMPLERCUBEARRAYARB
...
%token <lex> IMAGECUBEARRAYARB IIMAGECUBEARRAYARB UIMAGECUBEARRAYARB
...
type_specifier_nonarray
    ...
    | SAMPLERCUBEARRAYEXT {
        if (!context->checkCanUseExtension(@1, TExtension::EXT_texture_cube_map_array))
        {
            context->error(@1, "unsupported type", "__samplerCubeArray");
        }
        $$.initialize(EbtSamplerCubeArray, @1);
    ...
    | SAMPLERCUBEARRAYARB {
        if (!context->checkCanUseExtension(@1, TExtension::ARB_texture_cube_map_array))
        {
            context->error(@1, "unsupported type", "__samplerCubeArray");
        }
        $$.initialize(EbtSamplerCubeArray, @1);
