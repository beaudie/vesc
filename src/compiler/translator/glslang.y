...
function_call
    : function_call_or_method {
        $$ = context->addFunctionCallOrMethod($1.function, $1.callOrMethodPair.argumentsList, $1.callOrMethodPair.thisNode, @1);
    }
    ;
...
function_call_header_no_parameters
    : function_call_header VOID_TYPE {
        $$.function = $1;
        $$.callOrMethodPair.argumentsList = context->createEmptyArgumentsList();
    }
...
function_call_header_with_parameters
    : function_call_header assignment_expression {
        $$.callOrMethodPair.argumentsList = context->createEmptyArgumentsList();
        $$.function = $1;
        $$.callOrMethodPair.argumentsList->push_back($2);
    }
    | function_call_header_with_parameters COMMA assignment_expression {
        $$.function = $1.function;
        $$.callOrMethodPair.argumentsList->push_back($3);
    }
    ;
