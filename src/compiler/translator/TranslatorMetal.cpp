...
TIntermTyped *TranslatorMetal::getDriverUniformFlipXYRef(const TVariable *driverUniforms)
{
    return CreateDriverUniformRef(driverUniforms, kFlipXY);
}

TIntermTyped *TranslatorMetal::getDriverUniformNegFlipXYRef(const TVariable *driverUniforms)
{
