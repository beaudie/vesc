...
void TranslatorMetal::initializeFlipRotateSpecConst(FlipRotateSpecConst *specConst)
{
    // We use driver uniform to generate flipXY for now
    specConst->generateSymbol(&getSymbolTable());
}
}  // namespace sh
