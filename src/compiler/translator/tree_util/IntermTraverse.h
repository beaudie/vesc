...
#define DefaultAction nullptr
    ...
    virtual const TAction *visitPreprocessorDirective(Visit visit,
                                                      TIntermPreprocessorDirective *node)
    {
        return &mDefaultLeafNodeAction;
    }
  ...
  protected:
    ...
    TSymbolTable *mSymbolTable;
  private:
    const TAction mDefaultLeafNodeAction;
};
