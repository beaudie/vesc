...
TIntermTyped *GenerateMat2x2ArrayWithIndex(const Mat2x2EnumMap &matrix, TIntermSymbol *specConsts)
{
    auto mat2Type        = new TType(EbtFloat, 2, 2);
    ...
    return new TIntermBinary(EOpIndexDirect, array, specConsts);
}
                                       ...
                                       TIntermSymbol *specConsts)
{
    ...
    return new TIntermBinary(EOpIndexDirect, vec2Array, specConsts);
}
...
SpecConst::SpecConst() : mSymbolTable(nullptr) {}

SpecConst::~SpecConst() {}

void SpecConst::initWithSymbolTable(TSymbolTable *symbolTable)
{
