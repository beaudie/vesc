...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId pt00y = TSymbolUniqueId(2213);
    static constexpr const TSymbolUniqueId texture_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(2214);
    static constexpr const TSymbolUniqueId gl_DepthRangeParameters         = TSymbolUniqueId(2215);
    static constexpr const TSymbolUniqueId gl_DepthRange                   = TSymbolUniqueId(2216);
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(2217);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(2218);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(2219);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(2220);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(2221);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(2222);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(2223);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(2224);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(2225);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(2226);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(2227);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(2228);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(2229);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(2230);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(2231);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(2232);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(2233);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(2234);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(2235);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(2236);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(2237);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(2238);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(2239);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(2240);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(2241);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(2242);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(2243);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(2244);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(2245);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(2246);
    ...
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize   = TSymbolUniqueId(2249);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents   = TSymbolUniqueId(2250);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents  = TSymbolUniqueId(2251);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms     = TSymbolUniqueId(2252);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits = TSymbolUniqueId(2253);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices    = TSymbolUniqueId(2254);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTotalOutputComponents =
        TSymbolUniqueId(2255);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(2256);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters    = TSymbolUniqueId(2257);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounterBuffers =
        TSymbolUniqueId(2258);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(2259);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(2260);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(2261);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(2262);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(2263);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(2264);
    static constexpr const TSymbolUniqueId gl_HelperInvocation      = TSymbolUniqueId(2265);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT = TSymbolUniqueId(2266);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT  = TSymbolUniqueId(2267);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT          = TSymbolUniqueId(2268);
    static constexpr const TSymbolUniqueId gl_LastFragData          = TSymbolUniqueId(2269);
    static constexpr const TSymbolUniqueId gl_LastFragColor         = TSymbolUniqueId(2270);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV        = TSymbolUniqueId(2271);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM      = TSymbolUniqueId(2272);
    static constexpr const TSymbolUniqueId gl_PrimitiveID           = TSymbolUniqueId(2273);
    static constexpr const TSymbolUniqueId gl_Layer                 = TSymbolUniqueId(2274);
    static constexpr const TSymbolUniqueId gl_Position              = TSymbolUniqueId(2275);
    static constexpr const TSymbolUniqueId gl_PointSize             = TSymbolUniqueId(2276);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(2277);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(2278);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(2279);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(2280);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(2281);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(2282);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(2283);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(2284);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(2285);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(2286);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(2287);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(2288);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(2289);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(2290);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(2291);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(2292);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(2293);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(2294);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(2295);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(2296);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(2297);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(2298);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(2299);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(2300);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(2301);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(2302);
