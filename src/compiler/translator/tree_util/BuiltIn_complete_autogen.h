...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId beginInvocationInterlockARB      = TSymbolUniqueId(2826);
    static constexpr const TSymbolUniqueId endInvocationInterlockARB        = TSymbolUniqueId(2827);
    static constexpr const TSymbolUniqueId beginInvocationInterlockNV       = TSymbolUniqueId(2828);
    static constexpr const TSymbolUniqueId endInvocationInterlockNV         = TSymbolUniqueId(2829);
    static constexpr const TSymbolUniqueId beginFragmentShaderOrderingINTEL = TSymbolUniqueId(2830);
