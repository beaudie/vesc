...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId gl_MaxSamples            = TSymbolUniqueId(2859);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(2860);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(2861);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(2862);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(2863);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(2864);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(2865);
    static constexpr const TSymbolUniqueId gl_HelperInvocation      = TSymbolUniqueId(2866);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT = TSymbolUniqueId(2867);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT  = TSymbolUniqueId(2868);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT          = TSymbolUniqueId(2869);
    static constexpr const TSymbolUniqueId gl_LastFragData          = TSymbolUniqueId(2870);
    static constexpr const TSymbolUniqueId gl_LastFragColor         = TSymbolUniqueId(2871);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV        = TSymbolUniqueId(2872);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM      = TSymbolUniqueId(2873);
    static constexpr const TSymbolUniqueId gl_PrimitiveID           = TSymbolUniqueId(2874);
    static constexpr const TSymbolUniqueId gl_Layer                 = TSymbolUniqueId(2875);
    static constexpr const TSymbolUniqueId gl_SampleID              = TSymbolUniqueId(2876);
    static constexpr const TSymbolUniqueId gl_SamplePosition        = TSymbolUniqueId(2877);
    static constexpr const TSymbolUniqueId gl_SampleMaskIn          = TSymbolUniqueId(2878);
    static constexpr const TSymbolUniqueId gl_SampleMask            = TSymbolUniqueId(2879);
    static constexpr const TSymbolUniqueId gl_Position              = TSymbolUniqueId(2880);
    static constexpr const TSymbolUniqueId gl_PointSize             = TSymbolUniqueId(2881);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(2882);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(2883);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(2884);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(2885);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(2886);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(2887);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(2888);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(2889);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(2890);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(2891);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(2892);
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(2893);
    static constexpr const TSymbolUniqueId gl_MaxClipDistances      = TSymbolUniqueId(2894);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(2895);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(2896);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(2897);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(2898);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(2899);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(2900);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(2901);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(2902);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(2903);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(2904);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(2905);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(2906);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(2907);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(2908);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(2909);
