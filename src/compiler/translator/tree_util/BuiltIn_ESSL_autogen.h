...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId imageStore_Image2D1_Int2_Float4  = TSymbolUniqueId(3324);
    static constexpr const TSymbolUniqueId imageStore_IImage2D1_Int2_Int4   = TSymbolUniqueId(3325);
    static constexpr const TSymbolUniqueId imageStore_UImage2D1_Int2_UInt4  = TSymbolUniqueId(3326);
    static constexpr const TSymbolUniqueId imageStore_Image3D1_Int3_Float4  = TSymbolUniqueId(3327);
    static constexpr const TSymbolUniqueId imageStore_IImage3D1_Int3_Int4   = TSymbolUniqueId(3328);
    static constexpr const TSymbolUniqueId imageStore_UImage3D1_Int3_UInt4  = TSymbolUniqueId(3329);
    ...
    static constexpr const TSymbolUniqueId imageStore_IImageCube1_Int3_Int4 = TSymbolUniqueId(3334);
    ...
    static constexpr const TSymbolUniqueId imageStore_IImageCubeArray1_Int3_Int4 =
        TSymbolUniqueId(3337);
    static constexpr const TSymbolUniqueId imageStore_UImageCubeArray1_Int3_UInt4 =
        TSymbolUniqueId(3338);
    static constexpr const TSymbolUniqueId memoryBarrier              = TSymbolUniqueId(3339);
    static constexpr const TSymbolUniqueId memoryBarrierAtomicCounter = TSymbolUniqueId(3340);
    static constexpr const TSymbolUniqueId memoryBarrierBuffer        = TSymbolUniqueId(3341);
    static constexpr const TSymbolUniqueId memoryBarrierImage         = TSymbolUniqueId(3342);
    static constexpr const TSymbolUniqueId barrier                    = TSymbolUniqueId(3343);
    static constexpr const TSymbolUniqueId memoryBarrierShared        = TSymbolUniqueId(3344);
    static constexpr const TSymbolUniqueId groupMemoryBarrier         = TSymbolUniqueId(3345);
    static constexpr const TSymbolUniqueId EmitVertex                 = TSymbolUniqueId(3346);
    static constexpr const TSymbolUniqueId EndPrimitive               = TSymbolUniqueId(3347);
    static constexpr const TSymbolUniqueId textureVideoWEBGL_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(3348);
    static constexpr const TSymbolUniqueId pt00y = TSymbolUniqueId(3349);
    static constexpr const TSymbolUniqueId texture_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(3350);
    static constexpr const TSymbolUniqueId gl_DepthRangeParameters         = TSymbolUniqueId(3351);
    static constexpr const TSymbolUniqueId gl_DepthRange                   = TSymbolUniqueId(3352);
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(3353);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(3354);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(3355);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(3356);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(3357);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(3358);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(3359);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(3360);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(3361);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(3362);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(3363);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(3364);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(3365);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(3366);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(3367);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(3368);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(3369);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(3370);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(3371);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(3372);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(3373);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(3374);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(3375);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(3376);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(3377);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(3378);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(3379);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(3380);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(3381);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(3382);
    ...
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounterBuffers =
        TSymbolUniqueId(3384);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize   = TSymbolUniqueId(3385);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents   = TSymbolUniqueId(3386);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents  = TSymbolUniqueId(3387);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms     = TSymbolUniqueId(3388);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits = TSymbolUniqueId(3389);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices    = TSymbolUniqueId(3390);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTotalOutputComponents =
        TSymbolUniqueId(3391);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(3392);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters    = TSymbolUniqueId(3393);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounterBuffers =
        TSymbolUniqueId(3394);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(3395);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(3396);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(3397);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(3398);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(3399);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(3400);
    static constexpr const TSymbolUniqueId gl_HelperInvocation      = TSymbolUniqueId(3401);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT = TSymbolUniqueId(3402);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT  = TSymbolUniqueId(3403);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT          = TSymbolUniqueId(3404);
    static constexpr const TSymbolUniqueId gl_LastFragData          = TSymbolUniqueId(3405);
    static constexpr const TSymbolUniqueId gl_LastFragColor         = TSymbolUniqueId(3406);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV        = TSymbolUniqueId(3407);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM      = TSymbolUniqueId(3408);
    static constexpr const TSymbolUniqueId gl_PrimitiveID           = TSymbolUniqueId(3409);
    static constexpr const TSymbolUniqueId gl_Layer                 = TSymbolUniqueId(3410);
    static constexpr const TSymbolUniqueId gl_Position              = TSymbolUniqueId(3411);
    static constexpr const TSymbolUniqueId gl_PointSize             = TSymbolUniqueId(3412);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(3413);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(3414);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(3415);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(3416);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(3417);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(3418);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(3419);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(3420);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(3421);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(3422);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(3423);
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(3424);
    static constexpr const TSymbolUniqueId gl_MaxClipDistances      = TSymbolUniqueId(3425);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(3426);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(3427);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(3428);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(3429);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(3430);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(3431);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(3432);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(3433);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(3434);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(3435);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(3436);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(3437);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(3438);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(3439);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(3440);
