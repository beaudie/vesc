...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId memoryBarrier              = TSymbolUniqueId(4553);
    static constexpr const TSymbolUniqueId memoryBarrierAtomicCounter = TSymbolUniqueId(4554);
    static constexpr const TSymbolUniqueId memoryBarrierBuffer        = TSymbolUniqueId(4555);
    static constexpr const TSymbolUniqueId memoryBarrierImage         = TSymbolUniqueId(4556);
    static constexpr const TSymbolUniqueId barrier                    = TSymbolUniqueId(4557);
    static constexpr const TSymbolUniqueId memoryBarrierShared        = TSymbolUniqueId(4558);
    static constexpr const TSymbolUniqueId groupMemoryBarrier         = TSymbolUniqueId(4559);
    static constexpr const TSymbolUniqueId EmitVertex                 = TSymbolUniqueId(4560);
    static constexpr const TSymbolUniqueId EndPrimitive               = TSymbolUniqueId(4561);
    static constexpr const TSymbolUniqueId textureVideoWEBGL_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(4562);
    static constexpr const TSymbolUniqueId pt00y = TSymbolUniqueId(4563);
    static constexpr const TSymbolUniqueId texture_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(4564);
    static constexpr const TSymbolUniqueId gl_DepthRangeParameters         = TSymbolUniqueId(4565);
    static constexpr const TSymbolUniqueId gl_DepthRange                   = TSymbolUniqueId(4566);
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(4567);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(4568);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(4569);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(4570);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(4571);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(4572);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(4573);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(4574);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(4575);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(4576);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(4577);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(4578);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(4579);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(4580);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(4581);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(4582);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(4583);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(4584);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(4585);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(4586);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(4587);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(4588);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(4589);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(4590);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(4591);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(4592);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(4593);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(4594);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(4595);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(4596);
    ...
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize   = TSymbolUniqueId(4599);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents   = TSymbolUniqueId(4600);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents  = TSymbolUniqueId(4601);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms     = TSymbolUniqueId(4602);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits = TSymbolUniqueId(4603);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices    = TSymbolUniqueId(4604);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTotalOutputComponents =
        TSymbolUniqueId(4605);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(4606);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters    = TSymbolUniqueId(4607);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounterBuffers =
        TSymbolUniqueId(4608);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(4609);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(4610);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(4611);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(4612);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(4613);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(4614);
    static constexpr const TSymbolUniqueId gl_HelperInvocation      = TSymbolUniqueId(4615);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT = TSymbolUniqueId(4616);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT  = TSymbolUniqueId(4617);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT          = TSymbolUniqueId(4618);
    static constexpr const TSymbolUniqueId gl_LastFragData          = TSymbolUniqueId(4619);
    static constexpr const TSymbolUniqueId gl_LastFragColor         = TSymbolUniqueId(4620);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV        = TSymbolUniqueId(4621);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM      = TSymbolUniqueId(4622);
    static constexpr const TSymbolUniqueId gl_PrimitiveID           = TSymbolUniqueId(4623);
    static constexpr const TSymbolUniqueId gl_Layer                 = TSymbolUniqueId(4624);
    static constexpr const TSymbolUniqueId gl_Position              = TSymbolUniqueId(4625);
    static constexpr const TSymbolUniqueId gl_PointSize             = TSymbolUniqueId(4626);
    static constexpr const TSymbolUniqueId gl_InstanceID            = TSymbolUniqueId(4627);
    static constexpr const TSymbolUniqueId gl_InstanceIndex         = TSymbolUniqueId(4628);
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(4629);
    static constexpr const TSymbolUniqueId gl_VertexIndex           = TSymbolUniqueId(4630);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(4631);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(4632);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(4633);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(4634);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(4635);
    static constexpr const TSymbolUniqueId angle_BaseVertex         = TSymbolUniqueId(4636);
    static constexpr const TSymbolUniqueId angle_BaseInstance       = TSymbolUniqueId(4637);
    static constexpr const TSymbolUniqueId gl_ClipDistance          = TSymbolUniqueId(4638);
    static constexpr const TSymbolUniqueId gl_MaxClipDistances      = TSymbolUniqueId(4639);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups         = TSymbolUniqueId(4640);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize         = TSymbolUniqueId(4641);
    static constexpr const TSymbolUniqueId gl_WorkGroupID           = TSymbolUniqueId(4642);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID     = TSymbolUniqueId(4643);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID    = TSymbolUniqueId(4644);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex  = TSymbolUniqueId(4645);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn         = TSymbolUniqueId(4646);
    static constexpr const TSymbolUniqueId gl_InvocationID          = TSymbolUniqueId(4647);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS         = TSymbolUniqueId(4648);
    static constexpr const TSymbolUniqueId gl_LayerGS               = TSymbolUniqueId(4649);
    static constexpr const TSymbolUniqueId gl_PerVertex             = TSymbolUniqueId(4650);
    static constexpr const TSymbolUniqueId gl_in                    = TSymbolUniqueId(4651);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock     = TSymbolUniqueId(4652);
    static constexpr const TSymbolUniqueId gl_PositionGS            = TSymbolUniqueId(4653);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR            = TSymbolUniqueId(4654);
