...
{
  public:
    static constexpr const TSymbolUniqueId radians_Float1                   = TSymbolUniqueId(3019);
    static constexpr const TSymbolUniqueId pt00B                            = TSymbolUniqueId(3020);
    static constexpr const TSymbolUniqueId radians_Float2                   = TSymbolUniqueId(3021);
    static constexpr const TSymbolUniqueId pt10B                            = TSymbolUniqueId(3022);
    static constexpr const TSymbolUniqueId radians_Float3                   = TSymbolUniqueId(3023);
    static constexpr const TSymbolUniqueId pt20B                            = TSymbolUniqueId(3024);
    static constexpr const TSymbolUniqueId radians_Float4                   = TSymbolUniqueId(3025);
    static constexpr const TSymbolUniqueId pt30B                            = TSymbolUniqueId(3026);
    static constexpr const TSymbolUniqueId degrees_Float1                   = TSymbolUniqueId(3027);
    static constexpr const TSymbolUniqueId degrees_Float2                   = TSymbolUniqueId(3028);
    static constexpr const TSymbolUniqueId degrees_Float3                   = TSymbolUniqueId(3029);
    static constexpr const TSymbolUniqueId degrees_Float4                   = TSymbolUniqueId(3030);
    static constexpr const TSymbolUniqueId sin_Float1                       = TSymbolUniqueId(3031);
    static constexpr const TSymbolUniqueId sin_Float2                       = TSymbolUniqueId(3032);
    static constexpr const TSymbolUniqueId sin_Float3                       = TSymbolUniqueId(3033);
    static constexpr const TSymbolUniqueId sin_Float4                       = TSymbolUniqueId(3034);
    static constexpr const TSymbolUniqueId cos_Float1                       = TSymbolUniqueId(3035);
    static constexpr const TSymbolUniqueId cos_Float2                       = TSymbolUniqueId(3036);
    static constexpr const TSymbolUniqueId cos_Float3                       = TSymbolUniqueId(3037);
    static constexpr const TSymbolUniqueId cos_Float4                       = TSymbolUniqueId(3038);
    static constexpr const TSymbolUniqueId tan_Float1                       = TSymbolUniqueId(3039);
    static constexpr const TSymbolUniqueId tan_Float2                       = TSymbolUniqueId(3040);
    static constexpr const TSymbolUniqueId tan_Float3                       = TSymbolUniqueId(3041);
    static constexpr const TSymbolUniqueId tan_Float4                       = TSymbolUniqueId(3042);
    static constexpr const TSymbolUniqueId asin_Float1                      = TSymbolUniqueId(3043);
    static constexpr const TSymbolUniqueId asin_Float2                      = TSymbolUniqueId(3044);
    static constexpr const TSymbolUniqueId asin_Float3                      = TSymbolUniqueId(3045);
    static constexpr const TSymbolUniqueId asin_Float4                      = TSymbolUniqueId(3046);
    static constexpr const TSymbolUniqueId acos_Float1                      = TSymbolUniqueId(3047);
    static constexpr const TSymbolUniqueId acos_Float2                      = TSymbolUniqueId(3048);
    static constexpr const TSymbolUniqueId acos_Float3                      = TSymbolUniqueId(3049);
    static constexpr const TSymbolUniqueId acos_Float4                      = TSymbolUniqueId(3050);
    static constexpr const TSymbolUniqueId atan_Float1_Float1               = TSymbolUniqueId(3051);
    static constexpr const TSymbolUniqueId atan_Float2_Float2               = TSymbolUniqueId(3052);
    static constexpr const TSymbolUniqueId atan_Float3_Float3               = TSymbolUniqueId(3053);
    static constexpr const TSymbolUniqueId atan_Float4_Float4               = TSymbolUniqueId(3054);
    static constexpr const TSymbolUniqueId atan_Float1                      = TSymbolUniqueId(3055);
    static constexpr const TSymbolUniqueId atan_Float2                      = TSymbolUniqueId(3056);
    static constexpr const TSymbolUniqueId atan_Float3                      = TSymbolUniqueId(3057);
    static constexpr const TSymbolUniqueId atan_Float4                      = TSymbolUniqueId(3058);
    static constexpr const TSymbolUniqueId sinh_Float1                      = TSymbolUniqueId(3059);
    static constexpr const TSymbolUniqueId sinh_Float2                      = TSymbolUniqueId(3060);
    static constexpr const TSymbolUniqueId sinh_Float3                      = TSymbolUniqueId(3061);
    static constexpr const TSymbolUniqueId sinh_Float4                      = TSymbolUniqueId(3062);
    static constexpr const TSymbolUniqueId cosh_Float1                      = TSymbolUniqueId(3063);
    static constexpr const TSymbolUniqueId cosh_Float2                      = TSymbolUniqueId(3064);
    static constexpr const TSymbolUniqueId cosh_Float3                      = TSymbolUniqueId(3065);
    static constexpr const TSymbolUniqueId cosh_Float4                      = TSymbolUniqueId(3066);
    static constexpr const TSymbolUniqueId tanh_Float1                      = TSymbolUniqueId(3067);
    static constexpr const TSymbolUniqueId tanh_Float2                      = TSymbolUniqueId(3068);
    static constexpr const TSymbolUniqueId tanh_Float3                      = TSymbolUniqueId(3069);
    static constexpr const TSymbolUniqueId tanh_Float4                      = TSymbolUniqueId(3070);
    static constexpr const TSymbolUniqueId asinh_Float1                     = TSymbolUniqueId(3071);
    static constexpr const TSymbolUniqueId asinh_Float2                     = TSymbolUniqueId(3072);
    static constexpr const TSymbolUniqueId asinh_Float3                     = TSymbolUniqueId(3073);
    static constexpr const TSymbolUniqueId asinh_Float4                     = TSymbolUniqueId(3074);
    static constexpr const TSymbolUniqueId acosh_Float1                     = TSymbolUniqueId(3075);
    static constexpr const TSymbolUniqueId acosh_Float2                     = TSymbolUniqueId(3076);
    static constexpr const TSymbolUniqueId acosh_Float3                     = TSymbolUniqueId(3077);
    static constexpr const TSymbolUniqueId acosh_Float4                     = TSymbolUniqueId(3078);
    static constexpr const TSymbolUniqueId atanh_Float1                     = TSymbolUniqueId(3079);
    static constexpr const TSymbolUniqueId atanh_Float2                     = TSymbolUniqueId(3080);
    static constexpr const TSymbolUniqueId atanh_Float3                     = TSymbolUniqueId(3081);
    static constexpr const TSymbolUniqueId atanh_Float4                     = TSymbolUniqueId(3082);
    static constexpr const TSymbolUniqueId pow_Float1_Float1                = TSymbolUniqueId(3083);
    static constexpr const TSymbolUniqueId pow_Float2_Float2                = TSymbolUniqueId(3084);
    static constexpr const TSymbolUniqueId pow_Float3_Float3                = TSymbolUniqueId(3085);
    static constexpr const TSymbolUniqueId pow_Float4_Float4                = TSymbolUniqueId(3086);
    static constexpr const TSymbolUniqueId exp_Float1                       = TSymbolUniqueId(3087);
    static constexpr const TSymbolUniqueId exp_Float2                       = TSymbolUniqueId(3088);
    static constexpr const TSymbolUniqueId exp_Float3                       = TSymbolUniqueId(3089);
    static constexpr const TSymbolUniqueId exp_Float4                       = TSymbolUniqueId(3090);
    static constexpr const TSymbolUniqueId log_Float1                       = TSymbolUniqueId(3091);
    static constexpr const TSymbolUniqueId log_Float2                       = TSymbolUniqueId(3092);
    static constexpr const TSymbolUniqueId log_Float3                       = TSymbolUniqueId(3093);
    static constexpr const TSymbolUniqueId log_Float4                       = TSymbolUniqueId(3094);
    static constexpr const TSymbolUniqueId exp2_Float1                      = TSymbolUniqueId(3095);
    static constexpr const TSymbolUniqueId exp2_Float2                      = TSymbolUniqueId(3096);
    static constexpr const TSymbolUniqueId exp2_Float3                      = TSymbolUniqueId(3097);
    static constexpr const TSymbolUniqueId exp2_Float4                      = TSymbolUniqueId(3098);
    static constexpr const TSymbolUniqueId log2_Float1                      = TSymbolUniqueId(3099);
    static constexpr const TSymbolUniqueId log2_Float2                      = TSymbolUniqueId(3100);
    static constexpr const TSymbolUniqueId log2_Float3                      = TSymbolUniqueId(3101);
    static constexpr const TSymbolUniqueId log2_Float4                      = TSymbolUniqueId(3102);
    static constexpr const TSymbolUniqueId sqrt_Float1                      = TSymbolUniqueId(3103);
    static constexpr const TSymbolUniqueId sqrt_Float2                      = TSymbolUniqueId(3104);
    static constexpr const TSymbolUniqueId sqrt_Float3                      = TSymbolUniqueId(3105);
    static constexpr const TSymbolUniqueId sqrt_Float4                      = TSymbolUniqueId(3106);
    static constexpr const TSymbolUniqueId inversesqrt_Float1               = TSymbolUniqueId(3107);
    static constexpr const TSymbolUniqueId inversesqrt_Float2               = TSymbolUniqueId(3108);
    static constexpr const TSymbolUniqueId inversesqrt_Float3               = TSymbolUniqueId(3109);
    static constexpr const TSymbolUniqueId inversesqrt_Float4               = TSymbolUniqueId(3110);
    static constexpr const TSymbolUniqueId abs_Float1                       = TSymbolUniqueId(3111);
    static constexpr const TSymbolUniqueId abs_Float2                       = TSymbolUniqueId(3112);
    static constexpr const TSymbolUniqueId abs_Float3                       = TSymbolUniqueId(3113);
    static constexpr const TSymbolUniqueId abs_Float4                       = TSymbolUniqueId(3114);
    static constexpr const TSymbolUniqueId abs_Int1                         = TSymbolUniqueId(3115);
    static constexpr const TSymbolUniqueId pt00D                            = TSymbolUniqueId(3116);
    static constexpr const TSymbolUniqueId abs_Int2                         = TSymbolUniqueId(3117);
    static constexpr const TSymbolUniqueId pt10D                            = TSymbolUniqueId(3118);
    static constexpr const TSymbolUniqueId abs_Int3                         = TSymbolUniqueId(3119);
    static constexpr const TSymbolUniqueId pt20D                            = TSymbolUniqueId(3120);
    static constexpr const TSymbolUniqueId abs_Int4                         = TSymbolUniqueId(3121);
    static constexpr const TSymbolUniqueId pt30D                            = TSymbolUniqueId(3122);
    static constexpr const TSymbolUniqueId sign_Float1                      = TSymbolUniqueId(3123);
    static constexpr const TSymbolUniqueId sign_Float2                      = TSymbolUniqueId(3124);
    static constexpr const TSymbolUniqueId sign_Float3                      = TSymbolUniqueId(3125);
    static constexpr const TSymbolUniqueId sign_Float4                      = TSymbolUniqueId(3126);
    static constexpr const TSymbolUniqueId sign_Int1                        = TSymbolUniqueId(3127);
    static constexpr const TSymbolUniqueId sign_Int2                        = TSymbolUniqueId(3128);
    static constexpr const TSymbolUniqueId sign_Int3                        = TSymbolUniqueId(3129);
    static constexpr const TSymbolUniqueId sign_Int4                        = TSymbolUniqueId(3130);
    static constexpr const TSymbolUniqueId floor_Float1                     = TSymbolUniqueId(3131);
    static constexpr const TSymbolUniqueId floor_Float2                     = TSymbolUniqueId(3132);
    static constexpr const TSymbolUniqueId floor_Float3                     = TSymbolUniqueId(3133);
    static constexpr const TSymbolUniqueId floor_Float4                     = TSymbolUniqueId(3134);
    static constexpr const TSymbolUniqueId trunc_Float1                     = TSymbolUniqueId(3135);
    static constexpr const TSymbolUniqueId trunc_Float2                     = TSymbolUniqueId(3136);
    static constexpr const TSymbolUniqueId trunc_Float3                     = TSymbolUniqueId(3137);
    static constexpr const TSymbolUniqueId trunc_Float4                     = TSymbolUniqueId(3138);
    static constexpr const TSymbolUniqueId round_Float1                     = TSymbolUniqueId(3139);
    static constexpr const TSymbolUniqueId round_Float2                     = TSymbolUniqueId(3140);
    static constexpr const TSymbolUniqueId round_Float3                     = TSymbolUniqueId(3141);
    static constexpr const TSymbolUniqueId round_Float4                     = TSymbolUniqueId(3142);
    static constexpr const TSymbolUniqueId roundEven_Float1                 = TSymbolUniqueId(3143);
    static constexpr const TSymbolUniqueId roundEven_Float2                 = TSymbolUniqueId(3144);
    static constexpr const TSymbolUniqueId roundEven_Float3                 = TSymbolUniqueId(3145);
    static constexpr const TSymbolUniqueId roundEven_Float4                 = TSymbolUniqueId(3146);
    static constexpr const TSymbolUniqueId ceil_Float1                      = TSymbolUniqueId(3147);
    static constexpr const TSymbolUniqueId ceil_Float2                      = TSymbolUniqueId(3148);
    static constexpr const TSymbolUniqueId ceil_Float3                      = TSymbolUniqueId(3149);
    static constexpr const TSymbolUniqueId ceil_Float4                      = TSymbolUniqueId(3150);
    static constexpr const TSymbolUniqueId fract_Float1                     = TSymbolUniqueId(3151);
    static constexpr const TSymbolUniqueId fract_Float2                     = TSymbolUniqueId(3152);
    static constexpr const TSymbolUniqueId fract_Float3                     = TSymbolUniqueId(3153);
    static constexpr const TSymbolUniqueId fract_Float4                     = TSymbolUniqueId(3154);
    static constexpr const TSymbolUniqueId mod_Float1_Float1                = TSymbolUniqueId(3155);
    static constexpr const TSymbolUniqueId mod_Float2_Float1                = TSymbolUniqueId(3156);
    static constexpr const TSymbolUniqueId mod_Float3_Float1                = TSymbolUniqueId(3157);
    static constexpr const TSymbolUniqueId mod_Float4_Float1                = TSymbolUniqueId(3158);
    static constexpr const TSymbolUniqueId mod_Float2_Float2                = TSymbolUniqueId(3159);
    static constexpr const TSymbolUniqueId mod_Float3_Float3                = TSymbolUniqueId(3160);
    static constexpr const TSymbolUniqueId mod_Float4_Float4                = TSymbolUniqueId(3161);
    static constexpr const TSymbolUniqueId min_Float1_Float1                = TSymbolUniqueId(3162);
    static constexpr const TSymbolUniqueId min_Float2_Float1                = TSymbolUniqueId(3163);
    static constexpr const TSymbolUniqueId min_Float3_Float1                = TSymbolUniqueId(3164);
    static constexpr const TSymbolUniqueId min_Float4_Float1                = TSymbolUniqueId(3165);
    static constexpr const TSymbolUniqueId min_Float2_Float2                = TSymbolUniqueId(3166);
    static constexpr const TSymbolUniqueId min_Float3_Float3                = TSymbolUniqueId(3167);
    static constexpr const TSymbolUniqueId min_Float4_Float4                = TSymbolUniqueId(3168);
    static constexpr const TSymbolUniqueId min_Int1_Int1                    = TSymbolUniqueId(3169);
    static constexpr const TSymbolUniqueId min_Int2_Int2                    = TSymbolUniqueId(3170);
    static constexpr const TSymbolUniqueId min_Int3_Int3                    = TSymbolUniqueId(3171);
    static constexpr const TSymbolUniqueId min_Int4_Int4                    = TSymbolUniqueId(3172);
    static constexpr const TSymbolUniqueId min_Int2_Int1                    = TSymbolUniqueId(3173);
    static constexpr const TSymbolUniqueId min_Int3_Int1                    = TSymbolUniqueId(3174);
    static constexpr const TSymbolUniqueId min_Int4_Int1                    = TSymbolUniqueId(3175);
    static constexpr const TSymbolUniqueId min_UInt1_UInt1                  = TSymbolUniqueId(3176);
    static constexpr const TSymbolUniqueId pt00E                            = TSymbolUniqueId(3177);
    static constexpr const TSymbolUniqueId min_UInt2_UInt2                  = TSymbolUniqueId(3178);
    static constexpr const TSymbolUniqueId pt10E                            = TSymbolUniqueId(3179);
    static constexpr const TSymbolUniqueId min_UInt3_UInt3                  = TSymbolUniqueId(3180);
    static constexpr const TSymbolUniqueId pt20E                            = TSymbolUniqueId(3181);
    static constexpr const TSymbolUniqueId min_UInt4_UInt4                  = TSymbolUniqueId(3182);
    static constexpr const TSymbolUniqueId pt30E                            = TSymbolUniqueId(3183);
    static constexpr const TSymbolUniqueId min_UInt2_UInt1                  = TSymbolUniqueId(3184);
    static constexpr const TSymbolUniqueId min_UInt3_UInt1                  = TSymbolUniqueId(3185);
    static constexpr const TSymbolUniqueId min_UInt4_UInt1                  = TSymbolUniqueId(3186);
    static constexpr const TSymbolUniqueId max_Float1_Float1                = TSymbolUniqueId(3187);
    static constexpr const TSymbolUniqueId max_Float2_Float1                = TSymbolUniqueId(3188);
    static constexpr const TSymbolUniqueId max_Float3_Float1                = TSymbolUniqueId(3189);
    static constexpr const TSymbolUniqueId max_Float4_Float1                = TSymbolUniqueId(3190);
    static constexpr const TSymbolUniqueId max_Float2_Float2                = TSymbolUniqueId(3191);
    static constexpr const TSymbolUniqueId max_Float3_Float3                = TSymbolUniqueId(3192);
    static constexpr const TSymbolUniqueId max_Float4_Float4                = TSymbolUniqueId(3193);
    static constexpr const TSymbolUniqueId max_Int1_Int1                    = TSymbolUniqueId(3194);
    static constexpr const TSymbolUniqueId max_Int2_Int2                    = TSymbolUniqueId(3195);
    static constexpr const TSymbolUniqueId max_Int3_Int3                    = TSymbolUniqueId(3196);
    static constexpr const TSymbolUniqueId max_Int4_Int4                    = TSymbolUniqueId(3197);
    static constexpr const TSymbolUniqueId max_Int2_Int1                    = TSymbolUniqueId(3198);
    static constexpr const TSymbolUniqueId max_Int3_Int1                    = TSymbolUniqueId(3199);
    static constexpr const TSymbolUniqueId max_Int4_Int1                    = TSymbolUniqueId(3200);
    static constexpr const TSymbolUniqueId max_UInt1_UInt1                  = TSymbolUniqueId(3201);
    static constexpr const TSymbolUniqueId max_UInt2_UInt2                  = TSymbolUniqueId(3202);
    static constexpr const TSymbolUniqueId max_UInt3_UInt3                  = TSymbolUniqueId(3203);
    static constexpr const TSymbolUniqueId max_UInt4_UInt4                  = TSymbolUniqueId(3204);
    static constexpr const TSymbolUniqueId max_UInt2_UInt1                  = TSymbolUniqueId(3205);
    static constexpr const TSymbolUniqueId max_UInt3_UInt1                  = TSymbolUniqueId(3206);
    static constexpr const TSymbolUniqueId max_UInt4_UInt1                  = TSymbolUniqueId(3207);
    static constexpr const TSymbolUniqueId clamp_Float1_Float1_Float1       = TSymbolUniqueId(3208);
    static constexpr const TSymbolUniqueId clamp_Float2_Float1_Float1       = TSymbolUniqueId(3209);
    static constexpr const TSymbolUniqueId clamp_Float3_Float1_Float1       = TSymbolUniqueId(3210);
    static constexpr const TSymbolUniqueId clamp_Float4_Float1_Float1       = TSymbolUniqueId(3211);
    static constexpr const TSymbolUniqueId clamp_Float2_Float2_Float2       = TSymbolUniqueId(3212);
    static constexpr const TSymbolUniqueId clamp_Float3_Float3_Float3       = TSymbolUniqueId(3213);
    static constexpr const TSymbolUniqueId clamp_Float4_Float4_Float4       = TSymbolUniqueId(3214);
    static constexpr const TSymbolUniqueId clamp_Int1_Int1_Int1             = TSymbolUniqueId(3215);
    static constexpr const TSymbolUniqueId clamp_Int2_Int1_Int1             = TSymbolUniqueId(3216);
    static constexpr const TSymbolUniqueId clamp_Int3_Int1_Int1             = TSymbolUniqueId(3217);
    static constexpr const TSymbolUniqueId clamp_Int4_Int1_Int1             = TSymbolUniqueId(3218);
    static constexpr const TSymbolUniqueId clamp_Int2_Int2_Int2             = TSymbolUniqueId(3219);
    static constexpr const TSymbolUniqueId clamp_Int3_Int3_Int3             = TSymbolUniqueId(3220);
    static constexpr const TSymbolUniqueId clamp_Int4_Int4_Int4             = TSymbolUniqueId(3221);
    static constexpr const TSymbolUniqueId clamp_UInt1_UInt1_UInt1          = TSymbolUniqueId(3222);
    static constexpr const TSymbolUniqueId clamp_UInt2_UInt1_UInt1          = TSymbolUniqueId(3223);
    static constexpr const TSymbolUniqueId clamp_UInt3_UInt1_UInt1          = TSymbolUniqueId(3224);
    static constexpr const TSymbolUniqueId clamp_UInt4_UInt1_UInt1          = TSymbolUniqueId(3225);
    static constexpr const TSymbolUniqueId clamp_UInt2_UInt2_UInt2          = TSymbolUniqueId(3226);
    static constexpr const TSymbolUniqueId clamp_UInt3_UInt3_UInt3          = TSymbolUniqueId(3227);
    static constexpr const TSymbolUniqueId clamp_UInt4_UInt4_UInt4          = TSymbolUniqueId(3228);
    static constexpr const TSymbolUniqueId mix_Float1_Float1_Float1         = TSymbolUniqueId(3229);
    static constexpr const TSymbolUniqueId mix_Float2_Float2_Float1         = TSymbolUniqueId(3230);
    static constexpr const TSymbolUniqueId mix_Float3_Float3_Float1         = TSymbolUniqueId(3231);
    static constexpr const TSymbolUniqueId mix_Float4_Float4_Float1         = TSymbolUniqueId(3232);
    static constexpr const TSymbolUniqueId mix_Float2_Float2_Float2         = TSymbolUniqueId(3233);
    static constexpr const TSymbolUniqueId mix_Float3_Float3_Float3         = TSymbolUniqueId(3234);
    static constexpr const TSymbolUniqueId mix_Float4_Float4_Float4         = TSymbolUniqueId(3235);
    static constexpr const TSymbolUniqueId mix_Float1_Float1_Bool1          = TSymbolUniqueId(3236);
    static constexpr const TSymbolUniqueId pt00F                            = TSymbolUniqueId(3237);
    static constexpr const TSymbolUniqueId mix_Float2_Float2_Bool2          = TSymbolUniqueId(3238);
    static constexpr const TSymbolUniqueId pt10F                            = TSymbolUniqueId(3239);
    static constexpr const TSymbolUniqueId mix_Float3_Float3_Bool3          = TSymbolUniqueId(3240);
    static constexpr const TSymbolUniqueId pt20F                            = TSymbolUniqueId(3241);
    static constexpr const TSymbolUniqueId mix_Float4_Float4_Bool4          = TSymbolUniqueId(3242);
    static constexpr const TSymbolUniqueId pt30F                            = TSymbolUniqueId(3243);
    static constexpr const TSymbolUniqueId mix_Int1_Int1_Bool1              = TSymbolUniqueId(3244);
    static constexpr const TSymbolUniqueId mix_Int2_Int2_Bool2              = TSymbolUniqueId(3245);
    static constexpr const TSymbolUniqueId mix_Int3_Int3_Bool3              = TSymbolUniqueId(3246);
    static constexpr const TSymbolUniqueId mix_Int4_Int4_Bool4              = TSymbolUniqueId(3247);
    static constexpr const TSymbolUniqueId mix_UInt1_UInt1_Bool1            = TSymbolUniqueId(3248);
    static constexpr const TSymbolUniqueId mix_UInt2_UInt2_Bool2            = TSymbolUniqueId(3249);
    static constexpr const TSymbolUniqueId mix_UInt3_UInt3_Bool3            = TSymbolUniqueId(3250);
    static constexpr const TSymbolUniqueId mix_UInt4_UInt4_Bool4            = TSymbolUniqueId(3251);
    static constexpr const TSymbolUniqueId mix_Bool1_Bool1_Bool1            = TSymbolUniqueId(3252);
    static constexpr const TSymbolUniqueId mix_Bool2_Bool2_Bool2            = TSymbolUniqueId(3253);
    static constexpr const TSymbolUniqueId mix_Bool3_Bool3_Bool3            = TSymbolUniqueId(3254);
    static constexpr const TSymbolUniqueId mix_Bool4_Bool4_Bool4            = TSymbolUniqueId(3255);
    static constexpr const TSymbolUniqueId step_Float1_Float1               = TSymbolUniqueId(3256);
    static constexpr const TSymbolUniqueId step_Float2_Float2               = TSymbolUniqueId(3257);
    static constexpr const TSymbolUniqueId step_Float3_Float3               = TSymbolUniqueId(3258);
    static constexpr const TSymbolUniqueId step_Float4_Float4               = TSymbolUniqueId(3259);
    static constexpr const TSymbolUniqueId step_Float1_Float2               = TSymbolUniqueId(3260);
    static constexpr const TSymbolUniqueId step_Float1_Float3               = TSymbolUniqueId(3261);
    static constexpr const TSymbolUniqueId step_Float1_Float4               = TSymbolUniqueId(3262);
    static constexpr const TSymbolUniqueId smoothstep_Float1_Float1_Float1  = TSymbolUniqueId(3263);
    static constexpr const TSymbolUniqueId smoothstep_Float2_Float2_Float2  = TSymbolUniqueId(3264);
    static constexpr const TSymbolUniqueId smoothstep_Float3_Float3_Float3  = TSymbolUniqueId(3265);
    static constexpr const TSymbolUniqueId smoothstep_Float4_Float4_Float4  = TSymbolUniqueId(3266);
    static constexpr const TSymbolUniqueId smoothstep_Float1_Float1_Float2  = TSymbolUniqueId(3267);
    static constexpr const TSymbolUniqueId smoothstep_Float1_Float1_Float3  = TSymbolUniqueId(3268);
    static constexpr const TSymbolUniqueId smoothstep_Float1_Float1_Float4  = TSymbolUniqueId(3269);
    static constexpr const TSymbolUniqueId modf_Float1_Float1               = TSymbolUniqueId(3270);
    static constexpr const TSymbolUniqueId pt_o_00B                         = TSymbolUniqueId(3271);
    static constexpr const TSymbolUniqueId modf_Float2_Float2               = TSymbolUniqueId(3272);
    static constexpr const TSymbolUniqueId pt_o_10B                         = TSymbolUniqueId(3273);
    static constexpr const TSymbolUniqueId modf_Float3_Float3               = TSymbolUniqueId(3274);
    static constexpr const TSymbolUniqueId pt_o_20B                         = TSymbolUniqueId(3275);
    static constexpr const TSymbolUniqueId modf_Float4_Float4               = TSymbolUniqueId(3276);
    static constexpr const TSymbolUniqueId pt_o_30B                         = TSymbolUniqueId(3277);
    static constexpr const TSymbolUniqueId isnan_Float1                     = TSymbolUniqueId(3278);
    static constexpr const TSymbolUniqueId isnan_Float2                     = TSymbolUniqueId(3279);
    static constexpr const TSymbolUniqueId isnan_Float3                     = TSymbolUniqueId(3280);
    static constexpr const TSymbolUniqueId isnan_Float4                     = TSymbolUniqueId(3281);
    static constexpr const TSymbolUniqueId isinf_Float1                     = TSymbolUniqueId(3282);
    static constexpr const TSymbolUniqueId isinf_Float2                     = TSymbolUniqueId(3283);
    static constexpr const TSymbolUniqueId isinf_Float3                     = TSymbolUniqueId(3284);
    static constexpr const TSymbolUniqueId isinf_Float4                     = TSymbolUniqueId(3285);
    static constexpr const TSymbolUniqueId floatBitsToInt_Float1            = TSymbolUniqueId(3286);
    static constexpr const TSymbolUniqueId floatBitsToInt_Float2            = TSymbolUniqueId(3287);
    static constexpr const TSymbolUniqueId floatBitsToInt_Float3            = TSymbolUniqueId(3288);
    static constexpr const TSymbolUniqueId floatBitsToInt_Float4            = TSymbolUniqueId(3289);
    static constexpr const TSymbolUniqueId floatBitsToUint_Float1           = TSymbolUniqueId(3290);
    static constexpr const TSymbolUniqueId floatBitsToUint_Float2           = TSymbolUniqueId(3291);
    static constexpr const TSymbolUniqueId floatBitsToUint_Float3           = TSymbolUniqueId(3292);
    static constexpr const TSymbolUniqueId floatBitsToUint_Float4           = TSymbolUniqueId(3293);
    static constexpr const TSymbolUniqueId intBitsToFloat_Int1              = TSymbolUniqueId(3294);
    static constexpr const TSymbolUniqueId intBitsToFloat_Int2              = TSymbolUniqueId(3295);
    static constexpr const TSymbolUniqueId intBitsToFloat_Int3              = TSymbolUniqueId(3296);
    static constexpr const TSymbolUniqueId intBitsToFloat_Int4              = TSymbolUniqueId(3297);
    static constexpr const TSymbolUniqueId uintBitsToFloat_UInt1            = TSymbolUniqueId(3298);
    static constexpr const TSymbolUniqueId uintBitsToFloat_UInt2            = TSymbolUniqueId(3299);
    static constexpr const TSymbolUniqueId uintBitsToFloat_UInt3            = TSymbolUniqueId(3300);
    static constexpr const TSymbolUniqueId uintBitsToFloat_UInt4            = TSymbolUniqueId(3301);
    static constexpr const TSymbolUniqueId fma_Float1_Float1_Float1         = TSymbolUniqueId(3302);
    static constexpr const TSymbolUniqueId fma_Float2_Float2_Float2         = TSymbolUniqueId(3303);
    static constexpr const TSymbolUniqueId fma_Float3_Float3_Float3         = TSymbolUniqueId(3304);
    static constexpr const TSymbolUniqueId fma_Float4_Float4_Float4         = TSymbolUniqueId(3305);
    static constexpr const TSymbolUniqueId fmaExt_Float1_Float1_Float1      = TSymbolUniqueId(3306);
    static constexpr const TSymbolUniqueId fmaExt_Float2_Float2_Float2      = TSymbolUniqueId(3307);
    static constexpr const TSymbolUniqueId fmaExt_Float3_Float3_Float3      = TSymbolUniqueId(3308);
    static constexpr const TSymbolUniqueId fmaExt_Float4_Float4_Float4      = TSymbolUniqueId(3309);
    static constexpr const TSymbolUniqueId frexp_Float1_Int1                = TSymbolUniqueId(3310);
    static constexpr const TSymbolUniqueId pt_o_00D                         = TSymbolUniqueId(3311);
    static constexpr const TSymbolUniqueId frexp_Float2_Int2                = TSymbolUniqueId(3312);
    static constexpr const TSymbolUniqueId pt_o_10D                         = TSymbolUniqueId(3313);
    static constexpr const TSymbolUniqueId frexp_Float3_Int3                = TSymbolUniqueId(3314);
    static constexpr const TSymbolUniqueId pt_o_20D                         = TSymbolUniqueId(3315);
    static constexpr const TSymbolUniqueId frexp_Float4_Int4                = TSymbolUniqueId(3316);
    static constexpr const TSymbolUniqueId pt_o_30D                         = TSymbolUniqueId(3317);
    static constexpr const TSymbolUniqueId ldexp_Float1_Int1                = TSymbolUniqueId(3318);
    static constexpr const TSymbolUniqueId ldexp_Float2_Int2                = TSymbolUniqueId(3319);
    static constexpr const TSymbolUniqueId ldexp_Float3_Int3                = TSymbolUniqueId(3320);
    static constexpr const TSymbolUniqueId ldexp_Float4_Int4                = TSymbolUniqueId(3321);
    static constexpr const TSymbolUniqueId packSnorm2x16_Float2             = TSymbolUniqueId(3322);
    static constexpr const TSymbolUniqueId packHalf2x16_Float2              = TSymbolUniqueId(3323);
    static constexpr const TSymbolUniqueId unpackSnorm2x16_UInt1            = TSymbolUniqueId(3324);
    static constexpr const TSymbolUniqueId unpackHalf2x16_UInt1             = TSymbolUniqueId(3325);
    static constexpr const TSymbolUniqueId packUnorm2x16_Float2             = TSymbolUniqueId(3326);
    static constexpr const TSymbolUniqueId unpackUnorm2x16_UInt1            = TSymbolUniqueId(3327);
    static constexpr const TSymbolUniqueId packUnorm4x8_Float4              = TSymbolUniqueId(3328);
    static constexpr const TSymbolUniqueId packSnorm4x8_Float4              = TSymbolUniqueId(3329);
    static constexpr const TSymbolUniqueId unpackUnorm4x8_UInt1             = TSymbolUniqueId(3330);
    static constexpr const TSymbolUniqueId unpackSnorm4x8_UInt1             = TSymbolUniqueId(3331);
    static constexpr const TSymbolUniqueId length_Float1                    = TSymbolUniqueId(3332);
    static constexpr const TSymbolUniqueId length_Float2                    = TSymbolUniqueId(3333);
    static constexpr const TSymbolUniqueId length_Float3                    = TSymbolUniqueId(3334);
    static constexpr const TSymbolUniqueId length_Float4                    = TSymbolUniqueId(3335);
    static constexpr const TSymbolUniqueId distance_Float1_Float1           = TSymbolUniqueId(3336);
    static constexpr const TSymbolUniqueId distance_Float2_Float2           = TSymbolUniqueId(3337);
    static constexpr const TSymbolUniqueId distance_Float3_Float3           = TSymbolUniqueId(3338);
    static constexpr const TSymbolUniqueId distance_Float4_Float4           = TSymbolUniqueId(3339);
    static constexpr const TSymbolUniqueId dot_Float1_Float1                = TSymbolUniqueId(3340);
    static constexpr const TSymbolUniqueId dot_Float2_Float2                = TSymbolUniqueId(3341);
    static constexpr const TSymbolUniqueId dot_Float3_Float3                = TSymbolUniqueId(3342);
    static constexpr const TSymbolUniqueId dot_Float4_Float4                = TSymbolUniqueId(3343);
    static constexpr const TSymbolUniqueId cross_Float3_Float3              = TSymbolUniqueId(3344);
    static constexpr const TSymbolUniqueId normalize_Float1                 = TSymbolUniqueId(3345);
    static constexpr const TSymbolUniqueId normalize_Float2                 = TSymbolUniqueId(3346);
    static constexpr const TSymbolUniqueId normalize_Float3                 = TSymbolUniqueId(3347);
    static constexpr const TSymbolUniqueId normalize_Float4                 = TSymbolUniqueId(3348);
    static constexpr const TSymbolUniqueId faceforward_Float1_Float1_Float1 = TSymbolUniqueId(3349);
    static constexpr const TSymbolUniqueId faceforward_Float2_Float2_Float2 = TSymbolUniqueId(3350);
    static constexpr const TSymbolUniqueId faceforward_Float3_Float3_Float3 = TSymbolUniqueId(3351);
    static constexpr const TSymbolUniqueId faceforward_Float4_Float4_Float4 = TSymbolUniqueId(3352);
    static constexpr const TSymbolUniqueId reflect_Float1_Float1            = TSymbolUniqueId(3353);
    static constexpr const TSymbolUniqueId reflect_Float2_Float2            = TSymbolUniqueId(3354);
    static constexpr const TSymbolUniqueId reflect_Float3_Float3            = TSymbolUniqueId(3355);
    static constexpr const TSymbolUniqueId reflect_Float4_Float4            = TSymbolUniqueId(3356);
    static constexpr const TSymbolUniqueId refract_Float1_Float1_Float1     = TSymbolUniqueId(3357);
    static constexpr const TSymbolUniqueId refract_Float2_Float2_Float1     = TSymbolUniqueId(3358);
    static constexpr const TSymbolUniqueId refract_Float3_Float3_Float1     = TSymbolUniqueId(3359);
    static constexpr const TSymbolUniqueId refract_Float4_Float4_Float1     = TSymbolUniqueId(3360);
    static constexpr const TSymbolUniqueId matrixCompMult_Float2x2_Float2x2 = TSymbolUniqueId(3361);
    static constexpr const TSymbolUniqueId pt50B                            = TSymbolUniqueId(3362);
    static constexpr const TSymbolUniqueId matrixCompMult_Float3x3_Float3x3 = TSymbolUniqueId(3363);
    static constexpr const TSymbolUniqueId ptA0B                            = TSymbolUniqueId(3364);
    static constexpr const TSymbolUniqueId matrixCompMult_Float4x4_Float4x4 = TSymbolUniqueId(3365);
    static constexpr const TSymbolUniqueId ptF0B                            = TSymbolUniqueId(3366);
    static constexpr const TSymbolUniqueId matrixCompMult_Float2x3_Float2x3 = TSymbolUniqueId(3367);
    static constexpr const TSymbolUniqueId pt90B                            = TSymbolUniqueId(3368);
    static constexpr const TSymbolUniqueId matrixCompMult_Float3x2_Float3x2 = TSymbolUniqueId(3369);
    static constexpr const TSymbolUniqueId pt60B                            = TSymbolUniqueId(3370);
    static constexpr const TSymbolUniqueId matrixCompMult_Float2x4_Float2x4 = TSymbolUniqueId(3371);
    static constexpr const TSymbolUniqueId ptD0B                            = TSymbolUniqueId(3372);
    static constexpr const TSymbolUniqueId matrixCompMult_Float4x2_Float4x2 = TSymbolUniqueId(3373);
    static constexpr const TSymbolUniqueId pt70B                            = TSymbolUniqueId(3374);
    static constexpr const TSymbolUniqueId matrixCompMult_Float3x4_Float3x4 = TSymbolUniqueId(3375);
    static constexpr const TSymbolUniqueId ptE0B                            = TSymbolUniqueId(3376);
    static constexpr const TSymbolUniqueId matrixCompMult_Float4x3_Float4x3 = TSymbolUniqueId(3377);
    static constexpr const TSymbolUniqueId ptB0B                            = TSymbolUniqueId(3378);
    static constexpr const TSymbolUniqueId outerProduct_Float2_Float2       = TSymbolUniqueId(3379);
    static constexpr const TSymbolUniqueId outerProduct_Float3_Float3       = TSymbolUniqueId(3380);
    static constexpr const TSymbolUniqueId outerProduct_Float4_Float4       = TSymbolUniqueId(3381);
    static constexpr const TSymbolUniqueId outerProduct_Float3_Float2       = TSymbolUniqueId(3382);
    static constexpr const TSymbolUniqueId outerProduct_Float2_Float3       = TSymbolUniqueId(3383);
    static constexpr const TSymbolUniqueId outerProduct_Float4_Float2       = TSymbolUniqueId(3384);
    static constexpr const TSymbolUniqueId outerProduct_Float2_Float4       = TSymbolUniqueId(3385);
    static constexpr const TSymbolUniqueId outerProduct_Float4_Float3       = TSymbolUniqueId(3386);
    static constexpr const TSymbolUniqueId outerProduct_Float3_Float4       = TSymbolUniqueId(3387);
    static constexpr const TSymbolUniqueId transpose_Float2x2               = TSymbolUniqueId(3388);
    static constexpr const TSymbolUniqueId transpose_Float3x3               = TSymbolUniqueId(3389);
    static constexpr const TSymbolUniqueId transpose_Float4x4               = TSymbolUniqueId(3390);
    static constexpr const TSymbolUniqueId transpose_Float3x2               = TSymbolUniqueId(3391);
    static constexpr const TSymbolUniqueId transpose_Float2x3               = TSymbolUniqueId(3392);
    static constexpr const TSymbolUniqueId transpose_Float4x2               = TSymbolUniqueId(3393);
    static constexpr const TSymbolUniqueId transpose_Float2x4               = TSymbolUniqueId(3394);
    static constexpr const TSymbolUniqueId transpose_Float4x3               = TSymbolUniqueId(3395);
    static constexpr const TSymbolUniqueId transpose_Float3x4               = TSymbolUniqueId(3396);
    static constexpr const TSymbolUniqueId determinant_Float2x2             = TSymbolUniqueId(3397);
    static constexpr const TSymbolUniqueId determinant_Float3x3             = TSymbolUniqueId(3398);
    static constexpr const TSymbolUniqueId determinant_Float4x4             = TSymbolUniqueId(3399);
    static constexpr const TSymbolUniqueId inverse_Float2x2                 = TSymbolUniqueId(3400);
    static constexpr const TSymbolUniqueId inverse_Float3x3                 = TSymbolUniqueId(3401);
    static constexpr const TSymbolUniqueId inverse_Float4x4                 = TSymbolUniqueId(3402);
    static constexpr const TSymbolUniqueId lessThan_Float2_Float2           = TSymbolUniqueId(3403);
    static constexpr const TSymbolUniqueId lessThan_Float3_Float3           = TSymbolUniqueId(3404);
    static constexpr const TSymbolUniqueId lessThan_Float4_Float4           = TSymbolUniqueId(3405);
    static constexpr const TSymbolUniqueId lessThan_Int2_Int2               = TSymbolUniqueId(3406);
    static constexpr const TSymbolUniqueId lessThan_Int3_Int3               = TSymbolUniqueId(3407);
    static constexpr const TSymbolUniqueId lessThan_Int4_Int4               = TSymbolUniqueId(3408);
    static constexpr const TSymbolUniqueId lessThan_UInt2_UInt2             = TSymbolUniqueId(3409);
    static constexpr const TSymbolUniqueId lessThan_UInt3_UInt3             = TSymbolUniqueId(3410);
    static constexpr const TSymbolUniqueId lessThan_UInt4_UInt4             = TSymbolUniqueId(3411);
    static constexpr const TSymbolUniqueId lessThanEqual_Float2_Float2      = TSymbolUniqueId(3412);
    static constexpr const TSymbolUniqueId lessThanEqual_Float3_Float3      = TSymbolUniqueId(3413);
    static constexpr const TSymbolUniqueId lessThanEqual_Float4_Float4      = TSymbolUniqueId(3414);
    static constexpr const TSymbolUniqueId lessThanEqual_Int2_Int2          = TSymbolUniqueId(3415);
    static constexpr const TSymbolUniqueId lessThanEqual_Int3_Int3          = TSymbolUniqueId(3416);
    static constexpr const TSymbolUniqueId lessThanEqual_Int4_Int4          = TSymbolUniqueId(3417);
    static constexpr const TSymbolUniqueId lessThanEqual_UInt2_UInt2        = TSymbolUniqueId(3418);
    static constexpr const TSymbolUniqueId lessThanEqual_UInt3_UInt3        = TSymbolUniqueId(3419);
    static constexpr const TSymbolUniqueId lessThanEqual_UInt4_UInt4        = TSymbolUniqueId(3420);
    static constexpr const TSymbolUniqueId greaterThan_Float2_Float2        = TSymbolUniqueId(3421);
    static constexpr const TSymbolUniqueId greaterThan_Float3_Float3        = TSymbolUniqueId(3422);
    static constexpr const TSymbolUniqueId greaterThan_Float4_Float4        = TSymbolUniqueId(3423);
    static constexpr const TSymbolUniqueId greaterThan_Int2_Int2            = TSymbolUniqueId(3424);
    static constexpr const TSymbolUniqueId greaterThan_Int3_Int3            = TSymbolUniqueId(3425);
    static constexpr const TSymbolUniqueId greaterThan_Int4_Int4            = TSymbolUniqueId(3426);
    static constexpr const TSymbolUniqueId greaterThan_UInt2_UInt2          = TSymbolUniqueId(3427);
    static constexpr const TSymbolUniqueId greaterThan_UInt3_UInt3          = TSymbolUniqueId(3428);
    static constexpr const TSymbolUniqueId greaterThan_UInt4_UInt4          = TSymbolUniqueId(3429);
    static constexpr const TSymbolUniqueId greaterThanEqual_Float2_Float2   = TSymbolUniqueId(3430);
    static constexpr const TSymbolUniqueId greaterThanEqual_Float3_Float3   = TSymbolUniqueId(3431);
    static constexpr const TSymbolUniqueId greaterThanEqual_Float4_Float4   = TSymbolUniqueId(3432);
    static constexpr const TSymbolUniqueId greaterThanEqual_Int2_Int2       = TSymbolUniqueId(3433);
    static constexpr const TSymbolUniqueId greaterThanEqual_Int3_Int3       = TSymbolUniqueId(3434);
    static constexpr const TSymbolUniqueId greaterThanEqual_Int4_Int4       = TSymbolUniqueId(3435);
    static constexpr const TSymbolUniqueId greaterThanEqual_UInt2_UInt2     = TSymbolUniqueId(3436);
    static constexpr const TSymbolUniqueId greaterThanEqual_UInt3_UInt3     = TSymbolUniqueId(3437);
    static constexpr const TSymbolUniqueId greaterThanEqual_UInt4_UInt4     = TSymbolUniqueId(3438);
    static constexpr const TSymbolUniqueId equal_Float2_Float2              = TSymbolUniqueId(3439);
    static constexpr const TSymbolUniqueId equal_Float3_Float3              = TSymbolUniqueId(3440);
    static constexpr const TSymbolUniqueId equal_Float4_Float4              = TSymbolUniqueId(3441);
    static constexpr const TSymbolUniqueId equal_Int2_Int2                  = TSymbolUniqueId(3442);
    static constexpr const TSymbolUniqueId equal_Int3_Int3                  = TSymbolUniqueId(3443);
    static constexpr const TSymbolUniqueId equal_Int4_Int4                  = TSymbolUniqueId(3444);
    static constexpr const TSymbolUniqueId equal_UInt2_UInt2                = TSymbolUniqueId(3445);
    static constexpr const TSymbolUniqueId equal_UInt3_UInt3                = TSymbolUniqueId(3446);
    static constexpr const TSymbolUniqueId equal_UInt4_UInt4                = TSymbolUniqueId(3447);
    static constexpr const TSymbolUniqueId equal_Bool2_Bool2                = TSymbolUniqueId(3448);
    static constexpr const TSymbolUniqueId equal_Bool3_Bool3                = TSymbolUniqueId(3449);
    static constexpr const TSymbolUniqueId equal_Bool4_Bool4                = TSymbolUniqueId(3450);
    static constexpr const TSymbolUniqueId notEqual_Float2_Float2           = TSymbolUniqueId(3451);
    static constexpr const TSymbolUniqueId notEqual_Float3_Float3           = TSymbolUniqueId(3452);
    static constexpr const TSymbolUniqueId notEqual_Float4_Float4           = TSymbolUniqueId(3453);
    static constexpr const TSymbolUniqueId notEqual_Int2_Int2               = TSymbolUniqueId(3454);
    static constexpr const TSymbolUniqueId notEqual_Int3_Int3               = TSymbolUniqueId(3455);
    static constexpr const TSymbolUniqueId notEqual_Int4_Int4               = TSymbolUniqueId(3456);
    static constexpr const TSymbolUniqueId notEqual_UInt2_UInt2             = TSymbolUniqueId(3457);
    static constexpr const TSymbolUniqueId notEqual_UInt3_UInt3             = TSymbolUniqueId(3458);
    static constexpr const TSymbolUniqueId notEqual_UInt4_UInt4             = TSymbolUniqueId(3459);
    static constexpr const TSymbolUniqueId notEqual_Bool2_Bool2             = TSymbolUniqueId(3460);
    static constexpr const TSymbolUniqueId notEqual_Bool3_Bool3             = TSymbolUniqueId(3461);
    static constexpr const TSymbolUniqueId notEqual_Bool4_Bool4             = TSymbolUniqueId(3462);
    static constexpr const TSymbolUniqueId any_Bool2                        = TSymbolUniqueId(3463);
    static constexpr const TSymbolUniqueId any_Bool3                        = TSymbolUniqueId(3464);
    static constexpr const TSymbolUniqueId any_Bool4                        = TSymbolUniqueId(3465);
    static constexpr const TSymbolUniqueId all_Bool2                        = TSymbolUniqueId(3466);
    static constexpr const TSymbolUniqueId all_Bool3                        = TSymbolUniqueId(3467);
    static constexpr const TSymbolUniqueId all_Bool4                        = TSymbolUniqueId(3468);
    static constexpr const TSymbolUniqueId notFunc_Bool2                    = TSymbolUniqueId(3469);
    static constexpr const TSymbolUniqueId notFunc_Bool3                    = TSymbolUniqueId(3470);
    static constexpr const TSymbolUniqueId notFunc_Bool4                    = TSymbolUniqueId(3471);
    static constexpr const TSymbolUniqueId bitfieldExtract_Int1_Int1_Int1   = TSymbolUniqueId(3472);
    static constexpr const TSymbolUniqueId bitfieldExtract_Int2_Int1_Int1   = TSymbolUniqueId(3473);
    static constexpr const TSymbolUniqueId bitfieldExtract_Int3_Int1_Int1   = TSymbolUniqueId(3474);
    static constexpr const TSymbolUniqueId bitfieldExtract_Int4_Int1_Int1   = TSymbolUniqueId(3475);
    static constexpr const TSymbolUniqueId bitfieldExtract_UInt1_Int1_Int1  = TSymbolUniqueId(3476);
    static constexpr const TSymbolUniqueId bitfieldExtract_UInt2_Int1_Int1  = TSymbolUniqueId(3477);
    static constexpr const TSymbolUniqueId bitfieldExtract_UInt3_Int1_Int1  = TSymbolUniqueId(3478);
    static constexpr const TSymbolUniqueId bitfieldExtract_UInt4_Int1_Int1  = TSymbolUniqueId(3479);
    ...
    static constexpr const TSymbolUniqueId bitfieldReverse_Int1         = TSymbolUniqueId(3488);
    static constexpr const TSymbolUniqueId bitfieldReverse_Int2         = TSymbolUniqueId(3489);
    static constexpr const TSymbolUniqueId bitfieldReverse_Int3         = TSymbolUniqueId(3490);
    static constexpr const TSymbolUniqueId bitfieldReverse_Int4         = TSymbolUniqueId(3491);
    static constexpr const TSymbolUniqueId bitfieldReverse_UInt1        = TSymbolUniqueId(3492);
    static constexpr const TSymbolUniqueId bitfieldReverse_UInt2        = TSymbolUniqueId(3493);
    static constexpr const TSymbolUniqueId bitfieldReverse_UInt3        = TSymbolUniqueId(3494);
    static constexpr const TSymbolUniqueId bitfieldReverse_UInt4        = TSymbolUniqueId(3495);
    static constexpr const TSymbolUniqueId bitCount_Int1                = TSymbolUniqueId(3496);
    static constexpr const TSymbolUniqueId bitCount_Int2                = TSymbolUniqueId(3497);
    static constexpr const TSymbolUniqueId bitCount_Int3                = TSymbolUniqueId(3498);
    static constexpr const TSymbolUniqueId bitCount_Int4                = TSymbolUniqueId(3499);
    static constexpr const TSymbolUniqueId bitCount_UInt1               = TSymbolUniqueId(3500);
    static constexpr const TSymbolUniqueId bitCount_UInt2               = TSymbolUniqueId(3501);
    static constexpr const TSymbolUniqueId bitCount_UInt3               = TSymbolUniqueId(3502);
    static constexpr const TSymbolUniqueId bitCount_UInt4               = TSymbolUniqueId(3503);
    static constexpr const TSymbolUniqueId findLSB_Int1                 = TSymbolUniqueId(3504);
    static constexpr const TSymbolUniqueId findLSB_Int2                 = TSymbolUniqueId(3505);
    static constexpr const TSymbolUniqueId findLSB_Int3                 = TSymbolUniqueId(3506);
    static constexpr const TSymbolUniqueId findLSB_Int4                 = TSymbolUniqueId(3507);
    static constexpr const TSymbolUniqueId findLSB_UInt1                = TSymbolUniqueId(3508);
    static constexpr const TSymbolUniqueId findLSB_UInt2                = TSymbolUniqueId(3509);
    static constexpr const TSymbolUniqueId findLSB_UInt3                = TSymbolUniqueId(3510);
    static constexpr const TSymbolUniqueId findLSB_UInt4                = TSymbolUniqueId(3511);
    static constexpr const TSymbolUniqueId findMSB_Int1                 = TSymbolUniqueId(3512);
    static constexpr const TSymbolUniqueId findMSB_Int2                 = TSymbolUniqueId(3513);
    static constexpr const TSymbolUniqueId findMSB_Int3                 = TSymbolUniqueId(3514);
    static constexpr const TSymbolUniqueId findMSB_Int4                 = TSymbolUniqueId(3515);
    static constexpr const TSymbolUniqueId findMSB_UInt1                = TSymbolUniqueId(3516);
    static constexpr const TSymbolUniqueId findMSB_UInt2                = TSymbolUniqueId(3517);
    static constexpr const TSymbolUniqueId findMSB_UInt3                = TSymbolUniqueId(3518);
    static constexpr const TSymbolUniqueId findMSB_UInt4                = TSymbolUniqueId(3519);
    static constexpr const TSymbolUniqueId uaddCarry_UInt1_UInt1_UInt1  = TSymbolUniqueId(3520);
    static constexpr const TSymbolUniqueId pt_o_00E                     = TSymbolUniqueId(3521);
    static constexpr const TSymbolUniqueId uaddCarry_UInt2_UInt2_UInt2  = TSymbolUniqueId(3522);
    static constexpr const TSymbolUniqueId pt_o_10E                     = TSymbolUniqueId(3523);
    static constexpr const TSymbolUniqueId uaddCarry_UInt3_UInt3_UInt3  = TSymbolUniqueId(3524);
    static constexpr const TSymbolUniqueId pt_o_20E                     = TSymbolUniqueId(3525);
    static constexpr const TSymbolUniqueId uaddCarry_UInt4_UInt4_UInt4  = TSymbolUniqueId(3526);
    static constexpr const TSymbolUniqueId pt_o_30E                     = TSymbolUniqueId(3527);
    static constexpr const TSymbolUniqueId usubBorrow_UInt1_UInt1_UInt1 = TSymbolUniqueId(3528);
    static constexpr const TSymbolUniqueId usubBorrow_UInt2_UInt2_UInt2 = TSymbolUniqueId(3529);
    static constexpr const TSymbolUniqueId usubBorrow_UInt3_UInt3_UInt3 = TSymbolUniqueId(3530);
    static constexpr const TSymbolUniqueId usubBorrow_UInt4_UInt4_UInt4 = TSymbolUniqueId(3531);
    ...
    static constexpr const TSymbolUniqueId imulExtended_Int1_Int1_Int1_Int1 = TSymbolUniqueId(3536);
    static constexpr const TSymbolUniqueId imulExtended_Int2_Int2_Int2_Int2 = TSymbolUniqueId(3537);
    static constexpr const TSymbolUniqueId imulExtended_Int3_Int3_Int3_Int3 = TSymbolUniqueId(3538);
    static constexpr const TSymbolUniqueId imulExtended_Int4_Int4_Int4_Int4 = TSymbolUniqueId(3539);
    static constexpr const TSymbolUniqueId texture2D_Sampler2D1_Float2      = TSymbolUniqueId(3540);
    static constexpr const TSymbolUniqueId pt00I                            = TSymbolUniqueId(3541);
    static constexpr const TSymbolUniqueId texture2DProj_Sampler2D1_Float3  = TSymbolUniqueId(3542);
    static constexpr const TSymbolUniqueId texture2DProj_Sampler2D1_Float4  = TSymbolUniqueId(3543);
    static constexpr const TSymbolUniqueId textureCube_SamplerCube1_Float3  = TSymbolUniqueId(3544);
    static constexpr const TSymbolUniqueId pt00K                            = TSymbolUniqueId(3545);
    static constexpr const TSymbolUniqueId texture2D_SamplerExternalOES1_Float2 =
        TSymbolUniqueId(3546);
    static constexpr const TSymbolUniqueId pt00M = TSymbolUniqueId(3547);
    ...
    static constexpr const TSymbolUniqueId pt00O = TSymbolUniqueId(3551);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler2DRect1_Float2 = TSymbolUniqueId(3554);
    ...
    static constexpr const TSymbolUniqueId dFdxExt_Float1   = TSymbolUniqueId(3565);
    static constexpr const TSymbolUniqueId dFdxExt_Float2   = TSymbolUniqueId(3566);
    static constexpr const TSymbolUniqueId dFdxExt_Float3   = TSymbolUniqueId(3567);
    static constexpr const TSymbolUniqueId dFdxExt_Float4   = TSymbolUniqueId(3568);
    static constexpr const TSymbolUniqueId dFdyExt_Float1   = TSymbolUniqueId(3569);
    static constexpr const TSymbolUniqueId dFdyExt_Float2   = TSymbolUniqueId(3570);
    static constexpr const TSymbolUniqueId dFdyExt_Float3   = TSymbolUniqueId(3571);
    static constexpr const TSymbolUniqueId dFdyExt_Float4   = TSymbolUniqueId(3572);
    static constexpr const TSymbolUniqueId fwidthExt_Float1 = TSymbolUniqueId(3573);
    static constexpr const TSymbolUniqueId fwidthExt_Float2 = TSymbolUniqueId(3574);
    static constexpr const TSymbolUniqueId fwidthExt_Float3 = TSymbolUniqueId(3575);
    static constexpr const TSymbolUniqueId fwidthExt_Float4 = TSymbolUniqueId(3576);
    ...
    static constexpr const TSymbolUniqueId pt00d = TSymbolUniqueId(3582);
    static constexpr const TSymbolUniqueId shadow2DProjEXT_Sampler2DShadow1_Float4 =
        TSymbolUniqueId(3583);
    static constexpr const TSymbolUniqueId texture3D_Sampler3D1_Float3     = TSymbolUniqueId(3584);
    static constexpr const TSymbolUniqueId pt00J                           = TSymbolUniqueId(3585);
    static constexpr const TSymbolUniqueId texture3DProj_Sampler3D1_Float4 = TSymbolUniqueId(3586);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler2D1_Float2       = TSymbolUniqueId(3595);
    static constexpr const TSymbolUniqueId texture_ISampler2D1_Float2      = TSymbolUniqueId(3596);
    static constexpr const TSymbolUniqueId pt00R                           = TSymbolUniqueId(3597);
    static constexpr const TSymbolUniqueId texture_USampler2D1_Float2      = TSymbolUniqueId(3598);
    static constexpr const TSymbolUniqueId pt00X                           = TSymbolUniqueId(3599);
    static constexpr const TSymbolUniqueId texture_Sampler3D1_Float3       = TSymbolUniqueId(3600);
    static constexpr const TSymbolUniqueId texture_ISampler3D1_Float3      = TSymbolUniqueId(3601);
    static constexpr const TSymbolUniqueId pt00S                           = TSymbolUniqueId(3602);
    static constexpr const TSymbolUniqueId texture_USampler3D1_Float3      = TSymbolUniqueId(3603);
    static constexpr const TSymbolUniqueId pt00Y                           = TSymbolUniqueId(3604);
    static constexpr const TSymbolUniqueId texture_SamplerCube1_Float3     = TSymbolUniqueId(3605);
    static constexpr const TSymbolUniqueId texture_ISamplerCube1_Float3    = TSymbolUniqueId(3606);
    static constexpr const TSymbolUniqueId pt00T                           = TSymbolUniqueId(3607);
    static constexpr const TSymbolUniqueId texture_USamplerCube1_Float3    = TSymbolUniqueId(3608);
    static constexpr const TSymbolUniqueId pt00Z                           = TSymbolUniqueId(3609);
    static constexpr const TSymbolUniqueId texture_Sampler2DArray1_Float3  = TSymbolUniqueId(3610);
    static constexpr const TSymbolUniqueId pt00L                           = TSymbolUniqueId(3611);
    static constexpr const TSymbolUniqueId texture_ISampler2DArray1_Float3 = TSymbolUniqueId(3612);
    static constexpr const TSymbolUniqueId pt00U                           = TSymbolUniqueId(3613);
    static constexpr const TSymbolUniqueId texture_USampler2DArray1_Float3 = TSymbolUniqueId(3614);
    static constexpr const TSymbolUniqueId pt00a                           = TSymbolUniqueId(3615);
    static constexpr const TSymbolUniqueId texture_Sampler2DShadow1_Float3 = TSymbolUniqueId(3616);
    static constexpr const TSymbolUniqueId texture_SamplerCubeShadow1_Float4 =
        TSymbolUniqueId(3617);
    static constexpr const TSymbolUniqueId pt00e = TSymbolUniqueId(3618);
    static constexpr const TSymbolUniqueId texture_Sampler2DArrayShadow1_Float4 =
        TSymbolUniqueId(3619);
    static constexpr const TSymbolUniqueId pt00f                          = TSymbolUniqueId(3620);
    static constexpr const TSymbolUniqueId textureProj_Sampler2D1_Float3  = TSymbolUniqueId(3621);
    static constexpr const TSymbolUniqueId textureProj_ISampler2D1_Float3 = TSymbolUniqueId(3622);
    static constexpr const TSymbolUniqueId textureProj_USampler2D1_Float3 = TSymbolUniqueId(3623);
    static constexpr const TSymbolUniqueId textureProj_Sampler2D1_Float4  = TSymbolUniqueId(3624);
    static constexpr const TSymbolUniqueId textureProj_ISampler2D1_Float4 = TSymbolUniqueId(3625);
    static constexpr const TSymbolUniqueId textureProj_USampler2D1_Float4 = TSymbolUniqueId(3626);
    static constexpr const TSymbolUniqueId textureProj_Sampler3D1_Float4  = TSymbolUniqueId(3627);
    static constexpr const TSymbolUniqueId textureProj_ISampler3D1_Float4 = TSymbolUniqueId(3628);
    static constexpr const TSymbolUniqueId textureProj_USampler3D1_Float4 = TSymbolUniqueId(3629);
    ...
    static constexpr const TSymbolUniqueId textureSize_Sampler2D1_Int1      = TSymbolUniqueId(3644);
    static constexpr const TSymbolUniqueId textureSize_ISampler2D1_Int1     = TSymbolUniqueId(3645);
    static constexpr const TSymbolUniqueId textureSize_USampler2D1_Int1     = TSymbolUniqueId(3646);
    static constexpr const TSymbolUniqueId textureSize_Sampler3D1_Int1      = TSymbolUniqueId(3647);
    static constexpr const TSymbolUniqueId textureSize_ISampler3D1_Int1     = TSymbolUniqueId(3648);
    static constexpr const TSymbolUniqueId textureSize_USampler3D1_Int1     = TSymbolUniqueId(3649);
    static constexpr const TSymbolUniqueId textureSize_SamplerCube1_Int1    = TSymbolUniqueId(3650);
    static constexpr const TSymbolUniqueId textureSize_ISamplerCube1_Int1   = TSymbolUniqueId(3651);
    static constexpr const TSymbolUniqueId textureSize_USamplerCube1_Int1   = TSymbolUniqueId(3652);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DArray1_Int1 = TSymbolUniqueId(3653);
    ...
    static constexpr const TSymbolUniqueId texelFetch_Sampler2D1_Int2_Int1  = TSymbolUniqueId(3669);
    static constexpr const TSymbolUniqueId texelFetch_ISampler2D1_Int2_Int1 = TSymbolUniqueId(3670);
    static constexpr const TSymbolUniqueId texelFetch_USampler2D1_Int2_Int1 = TSymbolUniqueId(3671);
    static constexpr const TSymbolUniqueId texelFetch_Sampler3D1_Int3_Int1  = TSymbolUniqueId(3672);
    static constexpr const TSymbolUniqueId texelFetch_ISampler3D1_Int3_Int1 = TSymbolUniqueId(3673);
    static constexpr const TSymbolUniqueId texelFetch_USampler3D1_Int3_Int1 = TSymbolUniqueId(3674);
    ...
    static constexpr const TSymbolUniqueId textureSize_Sampler2DMS1         = TSymbolUniqueId(3703);
    static constexpr const TSymbolUniqueId pt00P                            = TSymbolUniqueId(3704);
    static constexpr const TSymbolUniqueId textureSize_ISampler2DMS1        = TSymbolUniqueId(3705);
    static constexpr const TSymbolUniqueId pt00V                            = TSymbolUniqueId(3706);
    static constexpr const TSymbolUniqueId textureSize_USampler2DMS1        = TSymbolUniqueId(3707);
    static constexpr const TSymbolUniqueId pt00b                            = TSymbolUniqueId(3708);
    static constexpr const TSymbolUniqueId textureSizeExt_Sampler2DMS1      = TSymbolUniqueId(3709);
    static constexpr const TSymbolUniqueId textureSizeExt_ISampler2DMS1     = TSymbolUniqueId(3710);
    static constexpr const TSymbolUniqueId textureSizeExt_USampler2DMS1     = TSymbolUniqueId(3711);
    static constexpr const TSymbolUniqueId textureSizeExt_Sampler2DMSArray1 = TSymbolUniqueId(3712);
    static constexpr const TSymbolUniqueId pt00Q                            = TSymbolUniqueId(3713);
    static constexpr const TSymbolUniqueId textureSizeExt_ISampler2DMSArray1 =
        TSymbolUniqueId(3714);
    static constexpr const TSymbolUniqueId pt00W = TSymbolUniqueId(3715);
    static constexpr const TSymbolUniqueId textureSizeExt_USampler2DMSArray1 =
        TSymbolUniqueId(3716);
    static constexpr const TSymbolUniqueId pt00c = TSymbolUniqueId(3717);
    static constexpr const TSymbolUniqueId textureSize_SamplerCubeArray1_Int1 =
        TSymbolUniqueId(3718);
    static constexpr const TSymbolUniqueId pt00k = TSymbolUniqueId(3719);
    static constexpr const TSymbolUniqueId textureSize_ISamplerCubeArray1_Int1 =
        TSymbolUniqueId(3720);
    static constexpr const TSymbolUniqueId pt00s = TSymbolUniqueId(3721);
    static constexpr const TSymbolUniqueId textureSize_USamplerCubeArray1_Int1 =
        TSymbolUniqueId(3722);
    static constexpr const TSymbolUniqueId pt00x = TSymbolUniqueId(3723);
    static constexpr const TSymbolUniqueId textureSize_SamplerCubeArrayShadow1_Int1 =
        TSymbolUniqueId(3724);
    static constexpr const TSymbolUniqueId pt00l                            = TSymbolUniqueId(3725);
    static constexpr const TSymbolUniqueId texture_SamplerCubeArray1_Float4 = TSymbolUniqueId(3726);
    ...
    static constexpr const TSymbolUniqueId textureSize_SamplerBuffer1      = TSymbolUniqueId(3746);
    static constexpr const TSymbolUniqueId pt00j                           = TSymbolUniqueId(3747);
    static constexpr const TSymbolUniqueId textureSize_ISamplerBuffer1     = TSymbolUniqueId(3748);
    static constexpr const TSymbolUniqueId pt00r                           = TSymbolUniqueId(3749);
    static constexpr const TSymbolUniqueId textureSize_USamplerBuffer1     = TSymbolUniqueId(3750);
    static constexpr const TSymbolUniqueId pt00w                           = TSymbolUniqueId(3751);
    static constexpr const TSymbolUniqueId texelFetch_SamplerBuffer1_Int1  = TSymbolUniqueId(3752);
    static constexpr const TSymbolUniqueId texelFetch_ISamplerBuffer1_Int1 = TSymbolUniqueId(3753);
    static constexpr const TSymbolUniqueId texelFetch_USamplerBuffer1_Int1 = TSymbolUniqueId(3754);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler2D1_Float2_Float1 = TSymbolUniqueId(3764);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler3D1_Float3_Float1 = TSymbolUniqueId(3767);
    ...
    static constexpr const TSymbolUniqueId pt00N = TSymbolUniqueId(3792);
    ...
    static constexpr const TSymbolUniqueId
        textureProjLodOffset_Sampler2DShadow1_Float4_Float1_Int2 = TSymbolUniqueId(3834);
    ...
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DShadow1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3850);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3851);
    static constexpr const TSymbolUniqueId
        textureGradOffset_ISampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3852);
    static constexpr const TSymbolUniqueId
        textureGradOffset_USampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3853);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DArrayShadow1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(3854);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3855);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3856);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(3857);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(3858);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(3859);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(3860);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(3861);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(3862);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(3863);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2DShadow1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(3864);
    ...
    static constexpr const TSymbolUniqueId pt00H = TSymbolUniqueId(3894);
    ...
    static constexpr const TSymbolUniqueId textureGather_Sampler2D1_Float2  = TSymbolUniqueId(3898);
    static constexpr const TSymbolUniqueId textureGather_ISampler2D1_Float2 = TSymbolUniqueId(3899);
    static constexpr const TSymbolUniqueId textureGather_USampler2D1_Float2 = TSymbolUniqueId(3900);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffset_Sampler2DArrayShadow1_Float3_Float1_Int2 = TSymbolUniqueId(3929);
    ...
    static constexpr const TSymbolUniqueId pt10Dx4 = TSymbolUniqueId(3937);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_Sampler2DShadow1_Float2_Float1_4xInt2 = TSymbolUniqueId(3943);
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_Sampler2DArrayShadow1_Float3_Float1_4xInt2 = TSymbolUniqueId(3944);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsetsExt_Sampler2DShadow1_Float2_Float1_4xInt2 = TSymbolUniqueId(3951);
    static constexpr const TSymbolUniqueId
        textureGatherOffsetsExt_Sampler2DArrayShadow1_Float3_Float1_4xInt2 = TSymbolUniqueId(3952);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_ISampler2DArray1_Float3_4xInt2_Int1 = TSymbolUniqueId(3957);
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_USampler2DArray1_Float3_4xInt2_Int1 = TSymbolUniqueId(3958);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsetsExt_Sampler2DArray1_Float3_4xInt2_Int1 = TSymbolUniqueId(3962);
    static constexpr const TSymbolUniqueId
        textureGatherOffsetsExt_ISampler2DArray1_Float3_4xInt2_Int1 = TSymbolUniqueId(3963);
    static constexpr const TSymbolUniqueId
        textureGatherOffsetsExt_USampler2DArray1_Float3_4xInt2_Int1        = TSymbolUniqueId(3964);
    static constexpr const TSymbolUniqueId dFdx_Float1                     = TSymbolUniqueId(3965);
    static constexpr const TSymbolUniqueId dFdx_Float2                     = TSymbolUniqueId(3966);
    static constexpr const TSymbolUniqueId dFdx_Float3                     = TSymbolUniqueId(3967);
    static constexpr const TSymbolUniqueId dFdx_Float4                     = TSymbolUniqueId(3968);
    static constexpr const TSymbolUniqueId dFdy_Float1                     = TSymbolUniqueId(3969);
    static constexpr const TSymbolUniqueId dFdy_Float2                     = TSymbolUniqueId(3970);
    static constexpr const TSymbolUniqueId dFdy_Float3                     = TSymbolUniqueId(3971);
    static constexpr const TSymbolUniqueId dFdy_Float4                     = TSymbolUniqueId(3972);
    static constexpr const TSymbolUniqueId fwidth_Float1                   = TSymbolUniqueId(3973);
    static constexpr const TSymbolUniqueId fwidth_Float2                   = TSymbolUniqueId(3974);
    static constexpr const TSymbolUniqueId fwidth_Float3                   = TSymbolUniqueId(3975);
    static constexpr const TSymbolUniqueId fwidth_Float4                   = TSymbolUniqueId(3976);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float1    = TSymbolUniqueId(3977);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float2    = TSymbolUniqueId(3978);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float3    = TSymbolUniqueId(3979);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float4    = TSymbolUniqueId(3980);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float1_Int1 = TSymbolUniqueId(3981);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float2_Int1 = TSymbolUniqueId(3982);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float3_Int1 = TSymbolUniqueId(3983);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float4_Int1 = TSymbolUniqueId(3984);
    ...
    static constexpr const TSymbolUniqueId interpolateAtCentroidExt_Float1 = TSymbolUniqueId(3989);
    static constexpr const TSymbolUniqueId interpolateAtCentroidExt_Float2 = TSymbolUniqueId(3990);
    static constexpr const TSymbolUniqueId interpolateAtCentroidExt_Float3 = TSymbolUniqueId(3991);
    static constexpr const TSymbolUniqueId interpolateAtCentroidExt_Float4 = TSymbolUniqueId(3992);
    ...
    static constexpr const TSymbolUniqueId atomicCounter_AtomicCounter1 = TSymbolUniqueId(4001);
    static constexpr const TSymbolUniqueId pt00G                        = TSymbolUniqueId(4002);
    ...
    static constexpr const TSymbolUniqueId atomicAdd_UInt1_UInt1            = TSymbolUniqueId(4005);
    static constexpr const TSymbolUniqueId pt_io_00E                        = TSymbolUniqueId(4006);
    static constexpr const TSymbolUniqueId atomicAdd_Int1_Int1              = TSymbolUniqueId(4007);
    static constexpr const TSymbolUniqueId pt_io_00D                        = TSymbolUniqueId(4008);
    static constexpr const TSymbolUniqueId atomicMin_UInt1_UInt1            = TSymbolUniqueId(4009);
    static constexpr const TSymbolUniqueId atomicMin_Int1_Int1              = TSymbolUniqueId(4010);
    static constexpr const TSymbolUniqueId atomicMax_UInt1_UInt1            = TSymbolUniqueId(4011);
    static constexpr const TSymbolUniqueId atomicMax_Int1_Int1              = TSymbolUniqueId(4012);
    static constexpr const TSymbolUniqueId atomicAnd_UInt1_UInt1            = TSymbolUniqueId(4013);
    static constexpr const TSymbolUniqueId atomicAnd_Int1_Int1              = TSymbolUniqueId(4014);
    static constexpr const TSymbolUniqueId atomicOr_UInt1_UInt1             = TSymbolUniqueId(4015);
    static constexpr const TSymbolUniqueId atomicOr_Int1_Int1               = TSymbolUniqueId(4016);
    static constexpr const TSymbolUniqueId atomicXor_UInt1_UInt1            = TSymbolUniqueId(4017);
    static constexpr const TSymbolUniqueId atomicXor_Int1_Int1              = TSymbolUniqueId(4018);
    static constexpr const TSymbolUniqueId atomicExchange_UInt1_UInt1       = TSymbolUniqueId(4019);
    static constexpr const TSymbolUniqueId atomicExchange_Int1_Int1         = TSymbolUniqueId(4020);
    static constexpr const TSymbolUniqueId atomicCompSwap_UInt1_UInt1_UInt1 = TSymbolUniqueId(4021);
    static constexpr const TSymbolUniqueId atomicCompSwap_Int1_Int1_Int1    = TSymbolUniqueId(4022);
    static constexpr const TSymbolUniqueId imageSize_Image2D1               = TSymbolUniqueId(4023);
    static constexpr const TSymbolUniqueId pt00z                            = TSymbolUniqueId(4024);
    static constexpr const TSymbolUniqueId imageSize_IImage2D1              = TSymbolUniqueId(4025);
    static constexpr const TSymbolUniqueId pt01A                            = TSymbolUniqueId(4026);
    static constexpr const TSymbolUniqueId imageSize_UImage2D1              = TSymbolUniqueId(4027);
    static constexpr const TSymbolUniqueId pt01B                            = TSymbolUniqueId(4028);
    static constexpr const TSymbolUniqueId imageSize_Image3D1               = TSymbolUniqueId(4029);
    static constexpr const TSymbolUniqueId pt01C                            = TSymbolUniqueId(4030);
    static constexpr const TSymbolUniqueId imageSize_IImage3D1              = TSymbolUniqueId(4031);
    static constexpr const TSymbolUniqueId pt01D                            = TSymbolUniqueId(4032);
    static constexpr const TSymbolUniqueId imageSize_UImage3D1              = TSymbolUniqueId(4033);
    static constexpr const TSymbolUniqueId pt01E                            = TSymbolUniqueId(4034);
    static constexpr const TSymbolUniqueId imageSize_Image2DArray1          = TSymbolUniqueId(4035);
    static constexpr const TSymbolUniqueId pt01F                            = TSymbolUniqueId(4036);
    static constexpr const TSymbolUniqueId imageSize_IImage2DArray1         = TSymbolUniqueId(4037);
    static constexpr const TSymbolUniqueId pt01G                            = TSymbolUniqueId(4038);
    static constexpr const TSymbolUniqueId imageSize_UImage2DArray1         = TSymbolUniqueId(4039);
    static constexpr const TSymbolUniqueId pt01H                            = TSymbolUniqueId(4040);
    static constexpr const TSymbolUniqueId imageSize_ImageCube1             = TSymbolUniqueId(4041);
    static constexpr const TSymbolUniqueId pt01I                            = TSymbolUniqueId(4042);
    static constexpr const TSymbolUniqueId imageSize_IImageCube1            = TSymbolUniqueId(4043);
    static constexpr const TSymbolUniqueId pt01J                            = TSymbolUniqueId(4044);
    static constexpr const TSymbolUniqueId imageSize_UImageCube1            = TSymbolUniqueId(4045);
    static constexpr const TSymbolUniqueId pt01K                            = TSymbolUniqueId(4046);
    static constexpr const TSymbolUniqueId imageSize_ImageCubeArray1        = TSymbolUniqueId(4047);
    static constexpr const TSymbolUniqueId pt01a                            = TSymbolUniqueId(4048);
    static constexpr const TSymbolUniqueId imageSize_IImageCubeArray1       = TSymbolUniqueId(4049);
    static constexpr const TSymbolUniqueId pt01b                            = TSymbolUniqueId(4050);
    static constexpr const TSymbolUniqueId imageSize_UImageCubeArray1       = TSymbolUniqueId(4051);
    static constexpr const TSymbolUniqueId pt01c                            = TSymbolUniqueId(4052);
    static constexpr const TSymbolUniqueId imageSize_ImageBuffer1           = TSymbolUniqueId(4053);
    static constexpr const TSymbolUniqueId pt01g                            = TSymbolUniqueId(4054);
    static constexpr const TSymbolUniqueId imageSize_IImageBuffer1          = TSymbolUniqueId(4055);
    static constexpr const TSymbolUniqueId pt01h                            = TSymbolUniqueId(4056);
    static constexpr const TSymbolUniqueId imageSize_UImageBuffer1          = TSymbolUniqueId(4057);
    static constexpr const TSymbolUniqueId pt01i                            = TSymbolUniqueId(4058);
    static constexpr const TSymbolUniqueId imageStore_Image2D1_Int2_Float4  = TSymbolUniqueId(4059);
    static constexpr const TSymbolUniqueId imageStore_IImage2D1_Int2_Int4   = TSymbolUniqueId(4060);
    static constexpr const TSymbolUniqueId imageStore_UImage2D1_Int2_UInt4  = TSymbolUniqueId(4061);
    static constexpr const TSymbolUniqueId imageStore_Image3D1_Int3_Float4  = TSymbolUniqueId(4062);
    static constexpr const TSymbolUniqueId imageStore_IImage3D1_Int3_Int4   = TSymbolUniqueId(4063);
    static constexpr const TSymbolUniqueId imageStore_UImage3D1_Int3_UInt4  = TSymbolUniqueId(4064);
    ...
    static constexpr const TSymbolUniqueId imageStore_IImageCube1_Int3_Int4 = TSymbolUniqueId(4069);
    ...
    static constexpr const TSymbolUniqueId imageLoad_Image2D1_Int2         = TSymbolUniqueId(4077);
    static constexpr const TSymbolUniqueId imageLoad_IImage2D1_Int2        = TSymbolUniqueId(4078);
    static constexpr const TSymbolUniqueId imageLoad_UImage2D1_Int2        = TSymbolUniqueId(4079);
    static constexpr const TSymbolUniqueId imageLoad_Image3D1_Int3         = TSymbolUniqueId(4080);
    static constexpr const TSymbolUniqueId imageLoad_IImage3D1_Int3        = TSymbolUniqueId(4081);
    static constexpr const TSymbolUniqueId imageLoad_UImage3D1_Int3        = TSymbolUniqueId(4082);
    static constexpr const TSymbolUniqueId imageLoad_Image2DArray1_Int3    = TSymbolUniqueId(4083);
    static constexpr const TSymbolUniqueId imageLoad_IImage2DArray1_Int3   = TSymbolUniqueId(4084);
    static constexpr const TSymbolUniqueId imageLoad_UImage2DArray1_Int3   = TSymbolUniqueId(4085);
    static constexpr const TSymbolUniqueId imageLoad_ImageCube1_Int3       = TSymbolUniqueId(4086);
    static constexpr const TSymbolUniqueId imageLoad_IImageCube1_Int3      = TSymbolUniqueId(4087);
    static constexpr const TSymbolUniqueId imageLoad_UImageCube1_Int3      = TSymbolUniqueId(4088);
    static constexpr const TSymbolUniqueId imageLoad_ImageCubeArray1_Int3  = TSymbolUniqueId(4089);
    static constexpr const TSymbolUniqueId imageLoad_IImageCubeArray1_Int3 = TSymbolUniqueId(4090);
    static constexpr const TSymbolUniqueId imageLoad_UImageCubeArray1_Int3 = TSymbolUniqueId(4091);
    static constexpr const TSymbolUniqueId imageLoad_ImageBuffer1_Int1     = TSymbolUniqueId(4092);
    static constexpr const TSymbolUniqueId imageLoad_IImageBuffer1_Int1    = TSymbolUniqueId(4093);
    static constexpr const TSymbolUniqueId imageLoad_UImageBuffer1_Int1    = TSymbolUniqueId(4094);
    ...
    static constexpr const TSymbolUniqueId pt01L = TSymbolUniqueId(4114);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicExchangeExt_IImage2DMSArray1_Int3_Int1_Float1 = TSymbolUniqueId(4603);
    static constexpr const TSymbolUniqueId
        imageAtomicExchangeExt_UImage2DMSArray1_Int3_Int1_Float1 = TSymbolUniqueId(4604);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_IImageCubeArray1_Int3_UInt1_UInt1 = TSymbolUniqueId(4621);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_UImageCubeArray1_Int3_UInt1_UInt1 = TSymbolUniqueId(4622);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_IImage2DMS1_Int2_Int1_UInt1_UInt1 = TSymbolUniqueId(4633);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_UImage2DMS1_Int2_Int1_UInt1_UInt1 = TSymbolUniqueId(4634);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_Image2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(4635);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_IImage2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(4636);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_UImage2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(4637);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_Image2DMSArray1_Int3_Int1_Int1_Int1 = TSymbolUniqueId(4668);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_IImage2DMSArray1_Int3_Int1_Int1_Int1 = TSymbolUniqueId(4669);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwapExt_UImage2DMSArray1_Int3_Int1_Int1_Int1   = TSymbolUniqueId(4670);
    static constexpr const TSymbolUniqueId memoryBarrier              = TSymbolUniqueId(4671);
    static constexpr const TSymbolUniqueId memoryBarrierAtomicCounter = TSymbolUniqueId(4672);
    static constexpr const TSymbolUniqueId memoryBarrierBuffer        = TSymbolUniqueId(4673);
    static constexpr const TSymbolUniqueId memoryBarrierImage         = TSymbolUniqueId(4674);
    static constexpr const TSymbolUniqueId barrier                    = TSymbolUniqueId(4675);
    static constexpr const TSymbolUniqueId memoryBarrierShared        = TSymbolUniqueId(4676);
    static constexpr const TSymbolUniqueId groupMemoryBarrier         = TSymbolUniqueId(4677);
    static constexpr const TSymbolUniqueId barrierES3_2               = TSymbolUniqueId(4678);
    static constexpr const TSymbolUniqueId EmitVertex                 = TSymbolUniqueId(4679);
    static constexpr const TSymbolUniqueId EmitVertexES3_2            = TSymbolUniqueId(4680);
    static constexpr const TSymbolUniqueId EndPrimitive               = TSymbolUniqueId(4681);
    static constexpr const TSymbolUniqueId EndPrimitiveES3_2          = TSymbolUniqueId(4682);
    static constexpr const TSymbolUniqueId textureVideoWEBGL_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(4683);
    static constexpr const TSymbolUniqueId pt00y = TSymbolUniqueId(4684);
    static constexpr const TSymbolUniqueId texture_SamplerVideoWEBGL1_Float2 =
        TSymbolUniqueId(4685);
    static constexpr const TSymbolUniqueId gl_DepthRangeParameters         = TSymbolUniqueId(4686);
    static constexpr const TSymbolUniqueId gl_DepthRange                   = TSymbolUniqueId(4687);
    static constexpr const TSymbolUniqueId gl_NumSamples                   = TSymbolUniqueId(4688);
    static constexpr const TSymbolUniqueId gl_NumSamplesES3_2              = TSymbolUniqueId(4689);
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(4690);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(4691);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(4692);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(4693);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(4694);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(4695);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(4696);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(4697);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(4698);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(4699);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(4700);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(4701);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(4702);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(4703);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(4704);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(4705);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(4706);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(4707);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(4708);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(4709);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(4710);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(4711);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(4712);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(4713);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(4714);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(4715);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(4716);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(4717);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(4718);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(4719);
    ...
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize = TSymbolUniqueId(4722);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents = TSymbolUniqueId(4723);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponentsES3_2 =
        TSymbolUniqueId(4724);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents = TSymbolUniqueId(4725);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponentsES3_2 =
        TSymbolUniqueId(4726);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms      = TSymbolUniqueId(4727);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniformsES3_2 = TSymbolUniqueId(4728);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits  = TSymbolUniqueId(4729);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnitsES3_2 =
        TSymbolUniqueId(4730);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices = TSymbolUniqueId(4731);
    ...
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(4735);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponentsES3_2 =
        TSymbolUniqueId(4736);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters = TSymbolUniqueId(4737);
    ...
    static constexpr const TSymbolUniqueId gl_MaxTessControlInputComponents = TSymbolUniqueId(4741);
    ...
    static constexpr const TSymbolUniqueId gl_MaxTessControlImageUniforms = TSymbolUniqueId(4751);
    static constexpr const TSymbolUniqueId gl_MaxTessControlImageUniformsES3_2 =
        TSymbolUniqueId(4752);
    static constexpr const TSymbolUniqueId gl_MaxTessControlAtomicCounters = TSymbolUniqueId(4753);
    ...
    static constexpr const TSymbolUniqueId gl_MaxTessPatchComponents      = TSymbolUniqueId(4757);
    static constexpr const TSymbolUniqueId gl_MaxTessPatchComponentsES3_2 = TSymbolUniqueId(4758);
    static constexpr const TSymbolUniqueId gl_MaxPatchVertices            = TSymbolUniqueId(4759);
    static constexpr const TSymbolUniqueId gl_MaxPatchVerticesES3_2       = TSymbolUniqueId(4760);
    static constexpr const TSymbolUniqueId gl_MaxTessGenLevel             = TSymbolUniqueId(4761);
    static constexpr const TSymbolUniqueId gl_MaxTessGenLevelES3_2        = TSymbolUniqueId(4762);
    ...
    static constexpr const TSymbolUniqueId gl_MaxSamples            = TSymbolUniqueId(4777);
    static constexpr const TSymbolUniqueId gl_MaxSamplesES3_2       = TSymbolUniqueId(4778);
    static constexpr const TSymbolUniqueId gl_MaxClipDistancesAPPLE = TSymbolUniqueId(4779);
    static constexpr const TSymbolUniqueId gl_MaxCullDistancesEXT   = TSymbolUniqueId(4780);
    static constexpr const TSymbolUniqueId gl_MaxCombinedClipAndCullDistancesEXT =
        TSymbolUniqueId(4781);
    static constexpr const TSymbolUniqueId gl_FragCoord                 = TSymbolUniqueId(4782);
    static constexpr const TSymbolUniqueId gl_FrontFacing               = TSymbolUniqueId(4783);
    static constexpr const TSymbolUniqueId gl_PointCoord                = TSymbolUniqueId(4784);
    static constexpr const TSymbolUniqueId gl_FragColor                 = TSymbolUniqueId(4785);
    static constexpr const TSymbolUniqueId gl_FragData                  = TSymbolUniqueId(4786);
    static constexpr const TSymbolUniqueId gl_FragDepth                 = TSymbolUniqueId(4787);
    static constexpr const TSymbolUniqueId gl_HelperInvocation          = TSymbolUniqueId(4788);
    static constexpr const TSymbolUniqueId gl_SecondaryFragColorEXT     = TSymbolUniqueId(4789);
    static constexpr const TSymbolUniqueId gl_SecondaryFragDataEXT      = TSymbolUniqueId(4790);
    static constexpr const TSymbolUniqueId gl_FragDepthEXT              = TSymbolUniqueId(4791);
    static constexpr const TSymbolUniqueId gl_LastFragDataNonCoherent   = TSymbolUniqueId(4792);
    static constexpr const TSymbolUniqueId gl_LastFragData              = TSymbolUniqueId(4793);
    static constexpr const TSymbolUniqueId gl_LastFragColor             = TSymbolUniqueId(4794);
    static constexpr const TSymbolUniqueId gl_LastFragDataNV            = TSymbolUniqueId(4795);
    static constexpr const TSymbolUniqueId gl_LastFragColorARM          = TSymbolUniqueId(4796);
    static constexpr const TSymbolUniqueId gl_PrimitiveID               = TSymbolUniqueId(4797);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDES3_2          = TSymbolUniqueId(4798);
    static constexpr const TSymbolUniqueId gl_Layer                     = TSymbolUniqueId(4799);
    static constexpr const TSymbolUniqueId gl_LayerES3_2                = TSymbolUniqueId(4800);
    static constexpr const TSymbolUniqueId gl_SampleID                  = TSymbolUniqueId(4801);
    static constexpr const TSymbolUniqueId gl_SampleIDES3_2             = TSymbolUniqueId(4802);
    static constexpr const TSymbolUniqueId gl_SamplePosition            = TSymbolUniqueId(4803);
    static constexpr const TSymbolUniqueId gl_SamplePositionES3_2       = TSymbolUniqueId(4804);
    static constexpr const TSymbolUniqueId gl_SampleMaskIn              = TSymbolUniqueId(4805);
    static constexpr const TSymbolUniqueId gl_SampleMaskInES3_2         = TSymbolUniqueId(4806);
    static constexpr const TSymbolUniqueId gl_SampleMask                = TSymbolUniqueId(4807);
    static constexpr const TSymbolUniqueId gl_SampleMaskES3_2           = TSymbolUniqueId(4808);
    static constexpr const TSymbolUniqueId gl_CullDistance              = TSymbolUniqueId(4809);
    static constexpr const TSymbolUniqueId gl_ClipDistance              = TSymbolUniqueId(4810);
    static constexpr const TSymbolUniqueId gl_Position                  = TSymbolUniqueId(4811);
    static constexpr const TSymbolUniqueId gl_PointSize                 = TSymbolUniqueId(4812);
    static constexpr const TSymbolUniqueId gl_InstanceID                = TSymbolUniqueId(4813);
    static constexpr const TSymbolUniqueId gl_InstanceIndex             = TSymbolUniqueId(4814);
    static constexpr const TSymbolUniqueId gl_VertexID                  = TSymbolUniqueId(4815);
    static constexpr const TSymbolUniqueId gl_VertexIndex               = TSymbolUniqueId(4816);
    static constexpr const TSymbolUniqueId gl_ViewportIndex             = TSymbolUniqueId(4817);
    static constexpr const TSymbolUniqueId gl_LayerVS                   = TSymbolUniqueId(4818);
    static constexpr const TSymbolUniqueId gl_DrawID                    = TSymbolUniqueId(4819);
    static constexpr const TSymbolUniqueId gl_BaseVertex                = TSymbolUniqueId(4820);
    static constexpr const TSymbolUniqueId gl_BaseInstance              = TSymbolUniqueId(4821);
    static constexpr const TSymbolUniqueId angle_BaseVertex             = TSymbolUniqueId(4822);
    static constexpr const TSymbolUniqueId angle_BaseInstance           = TSymbolUniqueId(4823);
    static constexpr const TSymbolUniqueId gl_ClipDistanceAPPLE         = TSymbolUniqueId(4824);
    static constexpr const TSymbolUniqueId gl_CullDistanceEXT           = TSymbolUniqueId(4825);
    static constexpr const TSymbolUniqueId gl_NumWorkGroups             = TSymbolUniqueId(4826);
    static constexpr const TSymbolUniqueId gl_WorkGroupSize             = TSymbolUniqueId(4827);
    static constexpr const TSymbolUniqueId gl_WorkGroupID               = TSymbolUniqueId(4828);
    static constexpr const TSymbolUniqueId gl_LocalInvocationID         = TSymbolUniqueId(4829);
    static constexpr const TSymbolUniqueId gl_GlobalInvocationID        = TSymbolUniqueId(4830);
    static constexpr const TSymbolUniqueId gl_LocalInvocationIndex      = TSymbolUniqueId(4831);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDIn             = TSymbolUniqueId(4832);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDInES3_2        = TSymbolUniqueId(4833);
    static constexpr const TSymbolUniqueId gl_InvocationID              = TSymbolUniqueId(4834);
    static constexpr const TSymbolUniqueId gl_InvocationIDES3_2         = TSymbolUniqueId(4835);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGS             = TSymbolUniqueId(4836);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDGSES3_2        = TSymbolUniqueId(4837);
    static constexpr const TSymbolUniqueId gl_LayerGS                   = TSymbolUniqueId(4838);
    static constexpr const TSymbolUniqueId gl_LayerGSES3_2              = TSymbolUniqueId(4839);
    static constexpr const TSymbolUniqueId gl_PerVertex                 = TSymbolUniqueId(4840);
    static constexpr const TSymbolUniqueId gl_PerVertexES3_2            = TSymbolUniqueId(4841);
    static constexpr const TSymbolUniqueId gl_in                        = TSymbolUniqueId(4842);
    static constexpr const TSymbolUniqueId gl_inES3_2                   = TSymbolUniqueId(4843);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlock         = TSymbolUniqueId(4844);
    static constexpr const TSymbolUniqueId gl_PerVertexOutBlockES3_2    = TSymbolUniqueId(4845);
    static constexpr const TSymbolUniqueId gl_PositionGS                = TSymbolUniqueId(4846);
    static constexpr const TSymbolUniqueId gl_PositionGSES3_2           = TSymbolUniqueId(4847);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTCS        = TSymbolUniqueId(4848);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTCSES3_2   = TSymbolUniqueId(4849);
    static constexpr const TSymbolUniqueId gl_InvocationIDTCS           = TSymbolUniqueId(4850);
    static constexpr const TSymbolUniqueId gl_InvocationIDTCSES3_2      = TSymbolUniqueId(4851);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTCS            = TSymbolUniqueId(4852);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTCSES3_2       = TSymbolUniqueId(4853);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTCS         = TSymbolUniqueId(4854);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTCSES3_2    = TSymbolUniqueId(4855);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTCS         = TSymbolUniqueId(4856);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTCSES3_2    = TSymbolUniqueId(4857);
    static constexpr const TSymbolUniqueId gl_PerVertexTCS              = TSymbolUniqueId(4858);
    static constexpr const TSymbolUniqueId gl_PerVertexTCSES3_2         = TSymbolUniqueId(4859);
    static constexpr const TSymbolUniqueId gl_inTCS                     = TSymbolUniqueId(4860);
    static constexpr const TSymbolUniqueId gl_inTCSES3_2                = TSymbolUniqueId(4861);
    static constexpr const TSymbolUniqueId gl_outTCS                    = TSymbolUniqueId(4862);
    static constexpr const TSymbolUniqueId gl_outTCSES3_2               = TSymbolUniqueId(4863);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTcsBlock      = TSymbolUniqueId(4864);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTcsBlockES3_2 = TSymbolUniqueId(4865);
    static constexpr const TSymbolUniqueId gl_PositionTCS               = TSymbolUniqueId(4866);
    static constexpr const TSymbolUniqueId gl_PositionTCSES3_2          = TSymbolUniqueId(4867);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTES        = TSymbolUniqueId(4868);
    static constexpr const TSymbolUniqueId gl_PatchVerticesInTESES3_2   = TSymbolUniqueId(4869);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTES            = TSymbolUniqueId(4870);
    static constexpr const TSymbolUniqueId gl_PrimitiveIDTESES3_2       = TSymbolUniqueId(4871);
    static constexpr const TSymbolUniqueId gl_TessCoord                 = TSymbolUniqueId(4872);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTES         = TSymbolUniqueId(4873);
    static constexpr const TSymbolUniqueId gl_TessLevelOuterTESES3_2    = TSymbolUniqueId(4874);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTES         = TSymbolUniqueId(4875);
    static constexpr const TSymbolUniqueId gl_TessLevelInnerTESES3_2    = TSymbolUniqueId(4876);
    static constexpr const TSymbolUniqueId gl_PerVertexTES              = TSymbolUniqueId(4877);
    static constexpr const TSymbolUniqueId gl_PerVertexTESES3_2         = TSymbolUniqueId(4878);
    static constexpr const TSymbolUniqueId gl_inTES                     = TSymbolUniqueId(4879);
    static constexpr const TSymbolUniqueId gl_inTESES3_2                = TSymbolUniqueId(4880);
    static constexpr const TSymbolUniqueId gl_outTES                    = TSymbolUniqueId(4881);
    static constexpr const TSymbolUniqueId gl_outTESES3_2               = TSymbolUniqueId(4882);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlock      = TSymbolUniqueId(4883);
    static constexpr const TSymbolUniqueId gl_PerVertexOutTesBlockES3_2 = TSymbolUniqueId(4884);
    static constexpr const TSymbolUniqueId gl_PositionTES               = TSymbolUniqueId(4885);
    static constexpr const TSymbolUniqueId gl_PositionTESES3_2          = TSymbolUniqueId(4886);
    static constexpr const TSymbolUniqueId gl_ViewID_OVR                = TSymbolUniqueId(4887);
