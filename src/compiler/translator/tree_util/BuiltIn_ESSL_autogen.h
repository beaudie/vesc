...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId pt01e                            = TSymbolUniqueId(4137);
    ...
    static constexpr const TSymbolUniqueId pt01Q = TSymbolUniqueId(4220);
