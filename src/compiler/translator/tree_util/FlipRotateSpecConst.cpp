...
// This is to make sure the specialization constant code path behaves exactly the same as driver
// uniform code path. This does not really making sense to me right now that Rotated90Degrees and
// Rotated270Degrees are different. But making Rotated270Degrees the same as Rotated90Degrees causes
// dEQP.GLES3_ROTATE270/functional_shaders_builtin_variable_fragcoord_xyz test failure.
...
TIntermBinary *FlipRotateSpecConst::getHalfRenderArea()
{
    ...
    // drawableSize * 0.5f * halfRenderAreaRotationMatrix (TODO: See comment in
