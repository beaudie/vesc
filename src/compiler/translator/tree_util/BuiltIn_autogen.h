...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId texture2D_SamplerVideoWEBGL1    = TSymbolUniqueId(2212);
    static constexpr const TSymbolUniqueId pt01o                           = TSymbolUniqueId(2213);
