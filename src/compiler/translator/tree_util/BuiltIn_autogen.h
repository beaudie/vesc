...
class BuiltInId
{
  public:
    ...
    static constexpr const TSymbolUniqueId pt0r                          = TSymbolUniqueId(89);
    static constexpr const TSymbolUniqueId sqrt_Double2                  = TSymbolUniqueId(90);
    static constexpr const TSymbolUniqueId pt1r                          = TSymbolUniqueId(91);
    static constexpr const TSymbolUniqueId sqrt_Double3                  = TSymbolUniqueId(92);
    static constexpr const TSymbolUniqueId pt2r                          = TSymbolUniqueId(93);
    static constexpr const TSymbolUniqueId sqrt_Double4                  = TSymbolUniqueId(94);
    static constexpr const TSymbolUniqueId pt3r                          = TSymbolUniqueId(95);
    ...
    static constexpr const TSymbolUniqueId pt0C                          = TSymbolUniqueId(109);
    static constexpr const TSymbolUniqueId abs_Int2                      = TSymbolUniqueId(110);
    static constexpr const TSymbolUniqueId pt1C                          = TSymbolUniqueId(111);
    static constexpr const TSymbolUniqueId abs_Int3                      = TSymbolUniqueId(112);
    static constexpr const TSymbolUniqueId pt2C                          = TSymbolUniqueId(113);
    static constexpr const TSymbolUniqueId abs_Int4                      = TSymbolUniqueId(114);
    static constexpr const TSymbolUniqueId pt3C                          = TSymbolUniqueId(115);
    ...
    static constexpr const TSymbolUniqueId pt0D                          = TSymbolUniqueId(216);
    static constexpr const TSymbolUniqueId min_UInt2_UInt2               = TSymbolUniqueId(217);
    static constexpr const TSymbolUniqueId pt1D                          = TSymbolUniqueId(218);
    static constexpr const TSymbolUniqueId min_UInt3_UInt3               = TSymbolUniqueId(219);
    static constexpr const TSymbolUniqueId pt2D                          = TSymbolUniqueId(220);
    static constexpr const TSymbolUniqueId min_UInt4_UInt4               = TSymbolUniqueId(221);
    static constexpr const TSymbolUniqueId pt3D                          = TSymbolUniqueId(222);
    ...
    static constexpr const TSymbolUniqueId pt0E                          = TSymbolUniqueId(297);
    static constexpr const TSymbolUniqueId mix_Float2_Float2_Bool2       = TSymbolUniqueId(298);
    static constexpr const TSymbolUniqueId pt1E                          = TSymbolUniqueId(299);
    static constexpr const TSymbolUniqueId mix_Float3_Float3_Bool3       = TSymbolUniqueId(300);
    static constexpr const TSymbolUniqueId pt2E                          = TSymbolUniqueId(301);
    static constexpr const TSymbolUniqueId mix_Float4_Float4_Bool4       = TSymbolUniqueId(302);
    static constexpr const TSymbolUniqueId pt3E                          = TSymbolUniqueId(303);
    ...
    static constexpr const TSymbolUniqueId pt_o_0C                          = TSymbolUniqueId(405);
    static constexpr const TSymbolUniqueId frexp_Float2_Int2                = TSymbolUniqueId(406);
    static constexpr const TSymbolUniqueId pt_o_1C                          = TSymbolUniqueId(407);
    static constexpr const TSymbolUniqueId frexp_Float3_Int3                = TSymbolUniqueId(408);
    static constexpr const TSymbolUniqueId pt_o_2C                          = TSymbolUniqueId(409);
    static constexpr const TSymbolUniqueId frexp_Float4_Int4                = TSymbolUniqueId(410);
    static constexpr const TSymbolUniqueId pt_o_3C                          = TSymbolUniqueId(411);
    ...
    static constexpr const TSymbolUniqueId pt_o_0D                      = TSymbolUniqueId(655);
    static constexpr const TSymbolUniqueId uaddCarry_UInt2_UInt2_UInt2  = TSymbolUniqueId(656);
    static constexpr const TSymbolUniqueId pt_o_1D                      = TSymbolUniqueId(657);
    static constexpr const TSymbolUniqueId uaddCarry_UInt3_UInt3_UInt3  = TSymbolUniqueId(658);
    static constexpr const TSymbolUniqueId pt_o_2D                      = TSymbolUniqueId(659);
    static constexpr const TSymbolUniqueId uaddCarry_UInt4_UInt4_UInt4  = TSymbolUniqueId(660);
    static constexpr const TSymbolUniqueId pt_o_3D                      = TSymbolUniqueId(661);
    ...
    static constexpr const TSymbolUniqueId pt0H                             = TSymbolUniqueId(675);
    ...
    static constexpr const TSymbolUniqueId pt0J                             = TSymbolUniqueId(679);
    static constexpr const TSymbolUniqueId texture1D_Sampler1D1_Float1      = TSymbolUniqueId(680);
    static constexpr const TSymbolUniqueId pt0s                             = TSymbolUniqueId(681);
    ...
    static constexpr const TSymbolUniqueId pt0I                             = TSymbolUniqueId(685);
    ...
    static constexpr const TSymbolUniqueId pt0y                             = TSymbolUniqueId(688);
    ...
    static constexpr const TSymbolUniqueId pt0c                             = TSymbolUniqueId(691);
    ...
    static constexpr const TSymbolUniqueId texture2D_SamplerExternalOES1_Float2 =
        TSymbolUniqueId(693);
    static constexpr const TSymbolUniqueId pt0L = TSymbolUniqueId(694);
    ...
    static constexpr const TSymbolUniqueId texture2DRect_Sampler2DRect1_Float2 =
        TSymbolUniqueId(697);
    static constexpr const TSymbolUniqueId pt0N = TSymbolUniqueId(698);
    ...
    static constexpr const TSymbolUniqueId pt0Q                              = TSymbolUniqueId(752);
    static constexpr const TSymbolUniqueId texture_USampler2D1_Float2        = TSymbolUniqueId(753);
    static constexpr const TSymbolUniqueId pt0W                              = TSymbolUniqueId(754);
    ...
    static constexpr const TSymbolUniqueId pt0R                              = TSymbolUniqueId(757);
    static constexpr const TSymbolUniqueId texture_USampler3D1_Float3        = TSymbolUniqueId(758);
    static constexpr const TSymbolUniqueId pt0X                              = TSymbolUniqueId(759);
    ...
    static constexpr const TSymbolUniqueId pt0d                              = TSymbolUniqueId(773);
    static constexpr const TSymbolUniqueId texture_Sampler2DArrayShadow1_Float4 =
        TSymbolUniqueId(774);
    static constexpr const TSymbolUniqueId pt0e                            = TSymbolUniqueId(775);
    ...
    static constexpr const TSymbolUniqueId pt00A                           = TSymbolUniqueId(778);
    static constexpr const TSymbolUniqueId texture_USampler1D1_Float1      = TSymbolUniqueId(779);
    static constexpr const TSymbolUniqueId pt00H                           = TSymbolUniqueId(780);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler2DRectShadow1_Float3 =
        TSymbolUniqueId(794);
    static constexpr const TSymbolUniqueId pt0z = TSymbolUniqueId(795);
    static constexpr const TSymbolUniqueId texture_SamplerCubeArrayShadow1_Float4_Float1 =
        TSymbolUniqueId(796);
    static constexpr const TSymbolUniqueId pt0x = TSymbolUniqueId(797);
    static constexpr const TSymbolUniqueId texture_ISamplerCubeArrayShadow1_Float4_Float1 =
        TSymbolUniqueId(798);
    static constexpr const TSymbolUniqueId pt00G = TSymbolUniqueId(799);
    static constexpr const TSymbolUniqueId texture_USamplerCubeArrayShadow1_Float4_Float1 =
        TSymbolUniqueId(800);
    ...
    static constexpr const TSymbolUniqueId textureLod_Sampler1DArrayShadow1_Float3_Float1 =
        TSymbolUniqueId(844);
    static constexpr const TSymbolUniqueId textureLod_ISampler1DArrayShadow1_Float3_Float1 =
        TSymbolUniqueId(845);
    static constexpr const TSymbolUniqueId pt00C = TSymbolUniqueId(846);
    static constexpr const TSymbolUniqueId textureLod_USampler1DArrayShadow1_Float3_Float1 =
        TSymbolUniqueId(847);
    static constexpr const TSymbolUniqueId pt00J = TSymbolUniqueId(848);
    static constexpr const TSymbolUniqueId textureLod_SamplerCubeArray1_Float4_Float1 =
        TSymbolUniqueId(849);
    static constexpr const TSymbolUniqueId pt0w = TSymbolUniqueId(850);
    static constexpr const TSymbolUniqueId textureLod_ISamplerCubeArray1_Float4_Float1 =
        TSymbolUniqueId(851);
    static constexpr const TSymbolUniqueId pt00F = TSymbolUniqueId(852);
    static constexpr const TSymbolUniqueId textureLod_USamplerCubeArray1_Float4_Float1 =
        TSymbolUniqueId(853);
    static constexpr const TSymbolUniqueId pt00M                             = TSymbolUniqueId(854);
    static constexpr const TSymbolUniqueId textureSize_Sampler2D1_Int1       = TSymbolUniqueId(855);
    static constexpr const TSymbolUniqueId textureSize_ISampler2D1_Int1      = TSymbolUniqueId(856);
    static constexpr const TSymbolUniqueId textureSize_USampler2D1_Int1      = TSymbolUniqueId(857);
    static constexpr const TSymbolUniqueId textureSize_Sampler3D1_Int1       = TSymbolUniqueId(858);
    static constexpr const TSymbolUniqueId textureSize_ISampler3D1_Int1      = TSymbolUniqueId(859);
    static constexpr const TSymbolUniqueId textureSize_USampler3D1_Int1      = TSymbolUniqueId(860);
    static constexpr const TSymbolUniqueId textureSize_SamplerCube1_Int1     = TSymbolUniqueId(861);
    static constexpr const TSymbolUniqueId textureSize_ISamplerCube1_Int1    = TSymbolUniqueId(862);
    static constexpr const TSymbolUniqueId textureSize_USamplerCube1_Int1    = TSymbolUniqueId(863);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DArray1_Int1  = TSymbolUniqueId(864);
    static constexpr const TSymbolUniqueId textureSize_ISampler2DArray1_Int1 = TSymbolUniqueId(865);
    static constexpr const TSymbolUniqueId textureSize_USampler2DArray1_Int1 = TSymbolUniqueId(866);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DShadow1_Int1 = TSymbolUniqueId(867);
    ...
    static constexpr const TSymbolUniqueId textureSize_Sampler2DArrayShadow1_Int1 =
        TSymbolUniqueId(869);
    static constexpr const TSymbolUniqueId textureSize_Sampler1D1_Int1       = TSymbolUniqueId(870);
    static constexpr const TSymbolUniqueId textureSize_ISampler1D1_Int1      = TSymbolUniqueId(871);
    static constexpr const TSymbolUniqueId textureSize_USampler1D1_Int1      = TSymbolUniqueId(872);
    static constexpr const TSymbolUniqueId textureSize_Sampler1DShadow1_Int1 = TSymbolUniqueId(873);
    ...
    static constexpr const TSymbolUniqueId textureSize_SamplerCubeArrayShadow1_Int1 =
        TSymbolUniqueId(877);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DRect1        = TSymbolUniqueId(878);
    static constexpr const TSymbolUniqueId textureSize_ISampler2DRect1       = TSymbolUniqueId(879);
    static constexpr const TSymbolUniqueId textureSize_USampler2DRect1       = TSymbolUniqueId(880);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DRectShadow1  = TSymbolUniqueId(881);
    static constexpr const TSymbolUniqueId textureSize_Sampler1DArray1_Int1  = TSymbolUniqueId(882);
    static constexpr const TSymbolUniqueId textureSize_ISampler1DArray1_Int1 = TSymbolUniqueId(883);
    static constexpr const TSymbolUniqueId textureSize_USampler1DArray1_Int1 = TSymbolUniqueId(884);
    static constexpr const TSymbolUniqueId textureSize_Sampler1DArrayShadow1_Int1 =
        TSymbolUniqueId(885);
    static constexpr const TSymbolUniqueId textureSize_SamplerBuffer1  = TSymbolUniqueId(886);
    static constexpr const TSymbolUniqueId pt0v                        = TSymbolUniqueId(887);
    static constexpr const TSymbolUniqueId textureSize_ISamplerBuffer1 = TSymbolUniqueId(888);
    static constexpr const TSymbolUniqueId pt00E                       = TSymbolUniqueId(889);
    static constexpr const TSymbolUniqueId textureSize_USamplerBuffer1 = TSymbolUniqueId(890);
    static constexpr const TSymbolUniqueId pt00L                       = TSymbolUniqueId(891);
    ...
    static constexpr const TSymbolUniqueId textureProjLod_Sampler1DShadow1_Float4_Float1 =
        TSymbolUniqueId(908);
    static constexpr const TSymbolUniqueId texelFetch_Sampler2D1_Int2_Int1  = TSymbolUniqueId(909);
    static constexpr const TSymbolUniqueId texelFetch_ISampler2D1_Int2_Int1 = TSymbolUniqueId(910);
    static constexpr const TSymbolUniqueId texelFetch_USampler2D1_Int2_Int1 = TSymbolUniqueId(911);
    static constexpr const TSymbolUniqueId texelFetch_Sampler3D1_Int3_Int1  = TSymbolUniqueId(912);
    static constexpr const TSymbolUniqueId texelFetch_ISampler3D1_Int3_Int1 = TSymbolUniqueId(913);
    static constexpr const TSymbolUniqueId texelFetch_USampler3D1_Int3_Int1 = TSymbolUniqueId(914);
    ...
    static constexpr const TSymbolUniqueId texelFetch_USampler2DArray1_Int3_Int1 =
        TSymbolUniqueId(917);
    static constexpr const TSymbolUniqueId texelFetch_Sampler1D1_Int1_Int1  = TSymbolUniqueId(918);
    static constexpr const TSymbolUniqueId texelFetch_ISampler1D1_Int1_Int1 = TSymbolUniqueId(919);
    static constexpr const TSymbolUniqueId texelFetch_USampler1D1_Int1_Int1 = TSymbolUniqueId(920);
    static constexpr const TSymbolUniqueId texelFetch_Sampler2DRect1_Int2   = TSymbolUniqueId(921);
    static constexpr const TSymbolUniqueId texelFetch_ISampler2DRect1_Int2  = TSymbolUniqueId(922);
    static constexpr const TSymbolUniqueId texelFetch_USampler2DRect1_Int2  = TSymbolUniqueId(923);
    ...
    static constexpr const TSymbolUniqueId texelFetch_USampler1DArray1_Int2_Int1 =
        TSymbolUniqueId(926);
    static constexpr const TSymbolUniqueId texelFetch_SamplerBuffer1_Int1  = TSymbolUniqueId(927);
    static constexpr const TSymbolUniqueId texelFetch_ISamplerBuffer1_Int1 = TSymbolUniqueId(928);
    static constexpr const TSymbolUniqueId texelFetch_USamplerBuffer1_Int1 = TSymbolUniqueId(929);
    ...
    static constexpr const TSymbolUniqueId
        textureProjGrad_Sampler2DRectShadow1_Float4_Float2_Float2           = TSymbolUniqueId(983);
    static constexpr const TSymbolUniqueId textureQueryLevels_Sampler1D1    = TSymbolUniqueId(984);
    static constexpr const TSymbolUniqueId textureQueryLevels_ISampler1D1   = TSymbolUniqueId(985);
    static constexpr const TSymbolUniqueId textureQueryLevels_USampler1D1   = TSymbolUniqueId(986);
    static constexpr const TSymbolUniqueId textureQueryLevels_Sampler2D1    = TSymbolUniqueId(987);
    static constexpr const TSymbolUniqueId textureQueryLevels_ISampler2D1   = TSymbolUniqueId(988);
    static constexpr const TSymbolUniqueId textureQueryLevels_USampler2D1   = TSymbolUniqueId(989);
    static constexpr const TSymbolUniqueId textureQueryLevels_Sampler3D1    = TSymbolUniqueId(990);
    static constexpr const TSymbolUniqueId textureQueryLevels_ISampler3D1   = TSymbolUniqueId(991);
    static constexpr const TSymbolUniqueId textureQueryLevels_USampler3D1   = TSymbolUniqueId(992);
    static constexpr const TSymbolUniqueId textureQueryLevels_SamplerCube1  = TSymbolUniqueId(993);
    static constexpr const TSymbolUniqueId textureQueryLevels_ISamplerCube1 = TSymbolUniqueId(994);
    static constexpr const TSymbolUniqueId textureQueryLevels_USamplerCube1 = TSymbolUniqueId(995);
    ...
    static constexpr const TSymbolUniqueId textureSamples_Sampler2DMS1      = TSymbolUniqueId(1011);
    static constexpr const TSymbolUniqueId pt0O                             = TSymbolUniqueId(1012);
    static constexpr const TSymbolUniqueId textureSamples_ISampler2DMS1     = TSymbolUniqueId(1013);
    static constexpr const TSymbolUniqueId pt0U                             = TSymbolUniqueId(1014);
    static constexpr const TSymbolUniqueId textureSamples_USampler2DMS1     = TSymbolUniqueId(1015);
    static constexpr const TSymbolUniqueId pt0a                             = TSymbolUniqueId(1016);
    static constexpr const TSymbolUniqueId textureSamples_Sampler2DMSArray1 = TSymbolUniqueId(1017);
    static constexpr const TSymbolUniqueId pt0P                             = TSymbolUniqueId(1018);
    static constexpr const TSymbolUniqueId textureSamples_ISampler2DMSArray1 =
        TSymbolUniqueId(1019);
    static constexpr const TSymbolUniqueId pt0V = TSymbolUniqueId(1020);
    static constexpr const TSymbolUniqueId textureSamples_USampler2DMSArray1 =
        TSymbolUniqueId(1021);
    static constexpr const TSymbolUniqueId pt0b                             = TSymbolUniqueId(1022);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DMS1         = TSymbolUniqueId(1023);
    static constexpr const TSymbolUniqueId textureSize_ISampler2DMS1        = TSymbolUniqueId(1024);
    static constexpr const TSymbolUniqueId textureSize_USampler2DMS1        = TSymbolUniqueId(1025);
    static constexpr const TSymbolUniqueId textureSizeExt_Sampler2DMS1      = TSymbolUniqueId(1026);
    static constexpr const TSymbolUniqueId textureSizeExt_ISampler2DMS1     = TSymbolUniqueId(1027);
    static constexpr const TSymbolUniqueId textureSizeExt_USampler2DMS1     = TSymbolUniqueId(1028);
    static constexpr const TSymbolUniqueId textureSize_Sampler2DMSArray1    = TSymbolUniqueId(1029);
    static constexpr const TSymbolUniqueId textureSize_ISampler2DMSArray1   = TSymbolUniqueId(1030);
    static constexpr const TSymbolUniqueId textureSize_USampler2DMSArray1   = TSymbolUniqueId(1031);
    static constexpr const TSymbolUniqueId textureSizeExt_Sampler2DMSArray1 = TSymbolUniqueId(1032);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler2D1_Float2_Float1 = TSymbolUniqueId(1047);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler3D1_Float3_Float1 = TSymbolUniqueId(1050);
    ...
    static constexpr const TSymbolUniqueId texture_Sampler1D1_Float1_Float1 = TSymbolUniqueId(1071);
    ...
    static constexpr const TSymbolUniqueId pt0M = TSymbolUniqueId(1091);
    ...
    static constexpr const TSymbolUniqueId
        textureLodOffset_Sampler1DArrayShadow1_Float3_Float1_Int1 = TSymbolUniqueId(1185);
    ...
    static constexpr const TSymbolUniqueId
        textureProjLodOffset_Sampler2DShadow1_Float4_Float1_Int2 = TSymbolUniqueId(1195);
    ...
    static constexpr const TSymbolUniqueId
        textureProjLodOffset_Sampler1DShadow1_Float4_Float1_Int1 = TSymbolUniqueId(1202);
    ...
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DShadow1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1227);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1228);
    static constexpr const TSymbolUniqueId
        textureGradOffset_ISampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1229);
    static constexpr const TSymbolUniqueId
        textureGradOffset_USampler2DArray1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1230);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DArrayShadow1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1231);
    ...
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DRect1_Float2_Float2_Float2_Int2 = TSymbolUniqueId(1235);
    static constexpr const TSymbolUniqueId
        textureGradOffset_ISampler2DRect1_Float2_Float2_Float2_Int2 = TSymbolUniqueId(1236);
    static constexpr const TSymbolUniqueId
        textureGradOffset_USampler2DRect1_Float2_Float2_Float2_Int2 = TSymbolUniqueId(1237);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler2DRectShadow1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1238);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler1DShadow1_Float3_Float1_Float1_Int1 = TSymbolUniqueId(1239);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler1DArray1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1240);
    static constexpr const TSymbolUniqueId
        textureGradOffset_ISampler1DArray1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1241);
    static constexpr const TSymbolUniqueId
        textureGradOffset_USampler1DArray1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1242);
    static constexpr const TSymbolUniqueId
        textureGradOffset_Sampler1DArrayShadow1_Float3_Float1_Float1_Int1 = TSymbolUniqueId(1243);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1244);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1245);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2D1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1246);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1247);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1248);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2D1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1249);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(1250);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(1251);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler3D1_Float4_Float3_Float3_Int3 = TSymbolUniqueId(1252);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2DShadow1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1253);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler1D1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1254);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler1D1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1255);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler1D1_Float2_Float1_Float1_Int1 = TSymbolUniqueId(1256);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler1D1_Float4_Float1_Float1_Int1 = TSymbolUniqueId(1257);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler1D1_Float4_Float1_Float1_Int1 = TSymbolUniqueId(1258);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler1D1_Float4_Float1_Float1_Int1 = TSymbolUniqueId(1259);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2DRect1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1260);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2DRect1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1261);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2DRect1_Float3_Float2_Float2_Int2 = TSymbolUniqueId(1262);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2DRect1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1263);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_ISampler2DRect1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1264);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_USampler2DRect1_Float4_Float2_Float2_Int2 = TSymbolUniqueId(1265);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler2DRectShadow1_Float4_Float2_Float2_Int2 =
            TSymbolUniqueId(1266);
    static constexpr const TSymbolUniqueId
        textureProjGradOffset_Sampler1DShadow1_Float4_Float1_Float1_Int1 = TSymbolUniqueId(1267);
    ...
    static constexpr const TSymbolUniqueId pt0G = TSymbolUniqueId(1312);
    ...
    static constexpr const TSymbolUniqueId textureGather_Sampler2D1_Float2  = TSymbolUniqueId(1316);
    static constexpr const TSymbolUniqueId textureGather_ISampler2D1_Float2 = TSymbolUniqueId(1317);
    static constexpr const TSymbolUniqueId textureGather_USampler2D1_Float2 = TSymbolUniqueId(1318);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffset_Sampler2DArrayShadow1_Float3_Float1_Int2 = TSymbolUniqueId(1367);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffset_Sampler2DRectShadow1_Float2_Float1_Int2 = TSymbolUniqueId(1374);
    static constexpr const TSymbolUniqueId textureGatherOffsets_Sampler2D1_Float2_Int4x2 =
        TSymbolUniqueId(1375);
    static constexpr const TSymbolUniqueId pt7C = TSymbolUniqueId(1376);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_ISampler2DArray1_Float3_Int4x2_Int1 = TSymbolUniqueId(1386);
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_USampler2DArray1_Float3_Int4x2_Int1 = TSymbolUniqueId(1387);
    ...
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_Sampler2DShadow1_Float2_Float1_Int4x2 = TSymbolUniqueId(1394);
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_Sampler2DArrayShadow1_Float3_Float1_Int4x2 = TSymbolUniqueId(1395);
    static constexpr const TSymbolUniqueId
        textureGatherOffsets_Sampler2DRectShadow1_Float2_Float1_Int4x2     = TSymbolUniqueId(1396);
    static constexpr const TSymbolUniqueId dFdx_Float1                     = TSymbolUniqueId(1397);
    static constexpr const TSymbolUniqueId dFdx_Float2                     = TSymbolUniqueId(1398);
    static constexpr const TSymbolUniqueId dFdx_Float3                     = TSymbolUniqueId(1399);
    static constexpr const TSymbolUniqueId dFdx_Float4                     = TSymbolUniqueId(1400);
    static constexpr const TSymbolUniqueId dFdy_Float1                     = TSymbolUniqueId(1401);
    static constexpr const TSymbolUniqueId dFdy_Float2                     = TSymbolUniqueId(1402);
    static constexpr const TSymbolUniqueId dFdy_Float3                     = TSymbolUniqueId(1403);
    static constexpr const TSymbolUniqueId dFdy_Float4                     = TSymbolUniqueId(1404);
    static constexpr const TSymbolUniqueId fwidth_Float1                   = TSymbolUniqueId(1405);
    static constexpr const TSymbolUniqueId fwidth_Float2                   = TSymbolUniqueId(1406);
    static constexpr const TSymbolUniqueId fwidth_Float3                   = TSymbolUniqueId(1407);
    static constexpr const TSymbolUniqueId fwidth_Float4                   = TSymbolUniqueId(1408);
    static constexpr const TSymbolUniqueId dFdxFine_Float1                 = TSymbolUniqueId(1409);
    static constexpr const TSymbolUniqueId dFdxFine_Float2                 = TSymbolUniqueId(1410);
    static constexpr const TSymbolUniqueId dFdxFine_Float3                 = TSymbolUniqueId(1411);
    static constexpr const TSymbolUniqueId dFdxFine_Float4                 = TSymbolUniqueId(1412);
    static constexpr const TSymbolUniqueId dFdyFine_Float1                 = TSymbolUniqueId(1413);
    static constexpr const TSymbolUniqueId dFdyFine_Float2                 = TSymbolUniqueId(1414);
    static constexpr const TSymbolUniqueId dFdyFine_Float3                 = TSymbolUniqueId(1415);
    static constexpr const TSymbolUniqueId dFdyFine_Float4                 = TSymbolUniqueId(1416);
    static constexpr const TSymbolUniqueId dFdxCoarse_Float1               = TSymbolUniqueId(1417);
    static constexpr const TSymbolUniqueId dFdxCoarse_Float2               = TSymbolUniqueId(1418);
    static constexpr const TSymbolUniqueId dFdxCoarse_Float3               = TSymbolUniqueId(1419);
    static constexpr const TSymbolUniqueId dFdxCoarse_Float4               = TSymbolUniqueId(1420);
    static constexpr const TSymbolUniqueId dFdyCoarse_Float1               = TSymbolUniqueId(1421);
    static constexpr const TSymbolUniqueId dFdyCoarse_Float2               = TSymbolUniqueId(1422);
    static constexpr const TSymbolUniqueId dFdyCoarse_Float3               = TSymbolUniqueId(1423);
    static constexpr const TSymbolUniqueId dFdyCoarse_Float4               = TSymbolUniqueId(1424);
    static constexpr const TSymbolUniqueId fwidthFine_Float1               = TSymbolUniqueId(1425);
    static constexpr const TSymbolUniqueId fwidthFine_Float2               = TSymbolUniqueId(1426);
    static constexpr const TSymbolUniqueId fwidthFine_Float3               = TSymbolUniqueId(1427);
    static constexpr const TSymbolUniqueId fwidthFine_Float4               = TSymbolUniqueId(1428);
    static constexpr const TSymbolUniqueId fwidthCoarse_Float1             = TSymbolUniqueId(1429);
    static constexpr const TSymbolUniqueId fwidthCoarse_Float2             = TSymbolUniqueId(1430);
    static constexpr const TSymbolUniqueId fwidthCoarse_Float3             = TSymbolUniqueId(1431);
    static constexpr const TSymbolUniqueId fwidthCoarse_Float4             = TSymbolUniqueId(1432);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float1    = TSymbolUniqueId(1433);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float2    = TSymbolUniqueId(1434);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float3    = TSymbolUniqueId(1435);
    static constexpr const TSymbolUniqueId interpolateAtCentroid_Float4    = TSymbolUniqueId(1436);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float1_Int1 = TSymbolUniqueId(1437);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float2_Int1 = TSymbolUniqueId(1438);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float3_Int1 = TSymbolUniqueId(1439);
    static constexpr const TSymbolUniqueId interpolateAtSample_Float4_Int1 = TSymbolUniqueId(1440);
    ...
    static constexpr const TSymbolUniqueId atomicCounter_AtomicCounter1 = TSymbolUniqueId(1445);
    static constexpr const TSymbolUniqueId pt0F                         = TSymbolUniqueId(1446);
    ...
    static constexpr const TSymbolUniqueId atomicAdd_UInt1_UInt1            = TSymbolUniqueId(1458);
    static constexpr const TSymbolUniqueId pt_io_0D                         = TSymbolUniqueId(1459);
    static constexpr const TSymbolUniqueId atomicAdd_Int1_Int1              = TSymbolUniqueId(1460);
    static constexpr const TSymbolUniqueId pt_io_0C                         = TSymbolUniqueId(1461);
    static constexpr const TSymbolUniqueId atomicMin_UInt1_UInt1            = TSymbolUniqueId(1462);
    static constexpr const TSymbolUniqueId atomicMin_Int1_Int1              = TSymbolUniqueId(1463);
    static constexpr const TSymbolUniqueId atomicMax_UInt1_UInt1            = TSymbolUniqueId(1464);
    static constexpr const TSymbolUniqueId atomicMax_Int1_Int1              = TSymbolUniqueId(1465);
    static constexpr const TSymbolUniqueId atomicAnd_UInt1_UInt1            = TSymbolUniqueId(1466);
    static constexpr const TSymbolUniqueId atomicAnd_Int1_Int1              = TSymbolUniqueId(1467);
    static constexpr const TSymbolUniqueId atomicOr_UInt1_UInt1             = TSymbolUniqueId(1468);
    static constexpr const TSymbolUniqueId atomicOr_Int1_Int1               = TSymbolUniqueId(1469);
    static constexpr const TSymbolUniqueId atomicXor_UInt1_UInt1            = TSymbolUniqueId(1470);
    static constexpr const TSymbolUniqueId atomicXor_Int1_Int1              = TSymbolUniqueId(1471);
    static constexpr const TSymbolUniqueId atomicExchange_UInt1_UInt1       = TSymbolUniqueId(1472);
    static constexpr const TSymbolUniqueId atomicExchange_Int1_Int1         = TSymbolUniqueId(1473);
    static constexpr const TSymbolUniqueId atomicCompSwap_UInt1_UInt1_UInt1 = TSymbolUniqueId(1474);
    static constexpr const TSymbolUniqueId atomicCompSwap_Int1_Int1_Int1    = TSymbolUniqueId(1475);
    static constexpr const TSymbolUniqueId imageSize_Image2D1               = TSymbolUniqueId(1476);
    static constexpr const TSymbolUniqueId pt0f                             = TSymbolUniqueId(1477);
    static constexpr const TSymbolUniqueId imageSize_IImage2D1              = TSymbolUniqueId(1478);
    static constexpr const TSymbolUniqueId pt0g                             = TSymbolUniqueId(1479);
    static constexpr const TSymbolUniqueId imageSize_UImage2D1              = TSymbolUniqueId(1480);
    static constexpr const TSymbolUniqueId pt0h                             = TSymbolUniqueId(1481);
    static constexpr const TSymbolUniqueId imageSize_Image3D1               = TSymbolUniqueId(1482);
    static constexpr const TSymbolUniqueId pt0i                             = TSymbolUniqueId(1483);
    static constexpr const TSymbolUniqueId imageSize_IImage3D1              = TSymbolUniqueId(1484);
    static constexpr const TSymbolUniqueId pt0j                             = TSymbolUniqueId(1485);
    static constexpr const TSymbolUniqueId imageSize_UImage3D1              = TSymbolUniqueId(1486);
    static constexpr const TSymbolUniqueId pt0k                             = TSymbolUniqueId(1487);
    static constexpr const TSymbolUniqueId imageSize_Image2DArray1          = TSymbolUniqueId(1488);
    static constexpr const TSymbolUniqueId pt0l                             = TSymbolUniqueId(1489);
    static constexpr const TSymbolUniqueId imageSize_IImage2DArray1         = TSymbolUniqueId(1490);
    static constexpr const TSymbolUniqueId pt0m                             = TSymbolUniqueId(1491);
    static constexpr const TSymbolUniqueId imageSize_UImage2DArray1         = TSymbolUniqueId(1492);
    static constexpr const TSymbolUniqueId pt0n                             = TSymbolUniqueId(1493);
    static constexpr const TSymbolUniqueId imageSize_ImageCube1             = TSymbolUniqueId(1494);
    static constexpr const TSymbolUniqueId pt0o                             = TSymbolUniqueId(1495);
    static constexpr const TSymbolUniqueId imageSize_IImageCube1            = TSymbolUniqueId(1496);
    static constexpr const TSymbolUniqueId pt0p                             = TSymbolUniqueId(1497);
    static constexpr const TSymbolUniqueId imageSize_UImageCube1            = TSymbolUniqueId(1498);
    static constexpr const TSymbolUniqueId pt0q                             = TSymbolUniqueId(1499);
    static constexpr const TSymbolUniqueId imageSize_Image1D1               = TSymbolUniqueId(1500);
    static constexpr const TSymbolUniqueId pt00U                            = TSymbolUniqueId(1501);
    static constexpr const TSymbolUniqueId imageSize_IImage1D1              = TSymbolUniqueId(1502);
    static constexpr const TSymbolUniqueId pt00V                            = TSymbolUniqueId(1503);
    static constexpr const TSymbolUniqueId imageSize_UImage1D1              = TSymbolUniqueId(1504);
    static constexpr const TSymbolUniqueId pt00W                            = TSymbolUniqueId(1505);
    static constexpr const TSymbolUniqueId imageSize_ImageCubeArray1        = TSymbolUniqueId(1506);
    static constexpr const TSymbolUniqueId pt00j                            = TSymbolUniqueId(1507);
    static constexpr const TSymbolUniqueId imageSize_IImageCubeArray1       = TSymbolUniqueId(1508);
    static constexpr const TSymbolUniqueId pt00k                            = TSymbolUniqueId(1509);
    static constexpr const TSymbolUniqueId imageSize_UImageCubeArray1       = TSymbolUniqueId(1510);
    static constexpr const TSymbolUniqueId pt00l                            = TSymbolUniqueId(1511);
    static constexpr const TSymbolUniqueId imageSize_ImageRect1             = TSymbolUniqueId(1512);
    static constexpr const TSymbolUniqueId pt00m                            = TSymbolUniqueId(1513);
    static constexpr const TSymbolUniqueId imageSize_IImageRect1            = TSymbolUniqueId(1514);
    static constexpr const TSymbolUniqueId pt00n                            = TSymbolUniqueId(1515);
    static constexpr const TSymbolUniqueId imageSize_UImageRect1            = TSymbolUniqueId(1516);
    static constexpr const TSymbolUniqueId pt00o                            = TSymbolUniqueId(1517);
    static constexpr const TSymbolUniqueId imageSize_Image1DArray1          = TSymbolUniqueId(1518);
    static constexpr const TSymbolUniqueId pt00X                            = TSymbolUniqueId(1519);
    static constexpr const TSymbolUniqueId imageSize_IImage1DArray1         = TSymbolUniqueId(1520);
    static constexpr const TSymbolUniqueId pt00Y                            = TSymbolUniqueId(1521);
    static constexpr const TSymbolUniqueId imageSize_UImage1DArray1         = TSymbolUniqueId(1522);
    static constexpr const TSymbolUniqueId pt00Z                            = TSymbolUniqueId(1523);
    static constexpr const TSymbolUniqueId imageSize_ImageBuffer1           = TSymbolUniqueId(1524);
    static constexpr const TSymbolUniqueId pt00p                            = TSymbolUniqueId(1525);
    static constexpr const TSymbolUniqueId imageSize_IImageBuffer1          = TSymbolUniqueId(1526);
    static constexpr const TSymbolUniqueId pt00q                            = TSymbolUniqueId(1527);
    static constexpr const TSymbolUniqueId imageSize_UImageBuffer1          = TSymbolUniqueId(1528);
    static constexpr const TSymbolUniqueId pt00r                            = TSymbolUniqueId(1529);
    static constexpr const TSymbolUniqueId imageSize_Image2DMS1             = TSymbolUniqueId(1530);
    static constexpr const TSymbolUniqueId pt00a                            = TSymbolUniqueId(1531);
    static constexpr const TSymbolUniqueId imageSize_IImage2DMS1            = TSymbolUniqueId(1532);
    static constexpr const TSymbolUniqueId pt00b                            = TSymbolUniqueId(1533);
    static constexpr const TSymbolUniqueId imageSize_UImage2DMS1            = TSymbolUniqueId(1534);
    static constexpr const TSymbolUniqueId pt00c                            = TSymbolUniqueId(1535);
    static constexpr const TSymbolUniqueId imageSize_Image2DMSArray1        = TSymbolUniqueId(1536);
    static constexpr const TSymbolUniqueId pt00d                            = TSymbolUniqueId(1537);
    static constexpr const TSymbolUniqueId imageSize_IImage2DMSArray1       = TSymbolUniqueId(1538);
    static constexpr const TSymbolUniqueId pt00e                            = TSymbolUniqueId(1539);
    static constexpr const TSymbolUniqueId imageSize_UImage2DMSArray1       = TSymbolUniqueId(1540);
    static constexpr const TSymbolUniqueId pt00f                            = TSymbolUniqueId(1541);
    static constexpr const TSymbolUniqueId imageSamples_Image2DMS1          = TSymbolUniqueId(1542);
    static constexpr const TSymbolUniqueId imageSamples_IImage2DMS1         = TSymbolUniqueId(1543);
    static constexpr const TSymbolUniqueId imageSamples_UImage2DMS1         = TSymbolUniqueId(1544);
    static constexpr const TSymbolUniqueId imageSamples_Image2DMSArray1     = TSymbolUniqueId(1545);
    static constexpr const TSymbolUniqueId imageSamples_IImage2DMSArray1    = TSymbolUniqueId(1546);
    static constexpr const TSymbolUniqueId imageSamples_UImage2DMSArray1    = TSymbolUniqueId(1547);
    ...
    static constexpr const TSymbolUniqueId imageAtomicOr_Image2D1_Int2_Int1 = TSymbolUniqueId(1848);
    ...
    static constexpr const TSymbolUniqueId imageAtomicOr_Image3D1_Int3_Int1 = TSymbolUniqueId(1851);
    ...
    static constexpr const TSymbolUniqueId imageAtomicOr_Image1D1_Int1_Int1 = TSymbolUniqueId(1866);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwap_Image2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(2076);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwap_IImage2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(2077);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwap_UImage2DMSArray1_Int3_Int1_UInt1_UInt1 = TSymbolUniqueId(2078);
    ...
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwap_IImage2DMSArray1_Int3_Int1_Int1_Int1 = TSymbolUniqueId(2110);
    static constexpr const TSymbolUniqueId
        imageAtomicCompSwap_UImage2DMSArray1_Int3_Int1_Int1_Int1           = TSymbolUniqueId(2111);
    static constexpr const TSymbolUniqueId imageLoad_Image2D1_Int2         = TSymbolUniqueId(2112);
    static constexpr const TSymbolUniqueId imageLoad_IImage2D1_Int2        = TSymbolUniqueId(2113);
    static constexpr const TSymbolUniqueId imageLoad_UImage2D1_Int2        = TSymbolUniqueId(2114);
    static constexpr const TSymbolUniqueId imageLoad_Image3D1_Int3         = TSymbolUniqueId(2115);
    static constexpr const TSymbolUniqueId imageLoad_IImage3D1_Int3        = TSymbolUniqueId(2116);
    static constexpr const TSymbolUniqueId imageLoad_UImage3D1_Int3        = TSymbolUniqueId(2117);
    static constexpr const TSymbolUniqueId imageLoad_Image2DArray1_Int3    = TSymbolUniqueId(2118);
    static constexpr const TSymbolUniqueId imageLoad_IImage2DArray1_Int3   = TSymbolUniqueId(2119);
    static constexpr const TSymbolUniqueId imageLoad_UImage2DArray1_Int3   = TSymbolUniqueId(2120);
    static constexpr const TSymbolUniqueId imageLoad_ImageCube1_Int3       = TSymbolUniqueId(2121);
    static constexpr const TSymbolUniqueId imageLoad_IImageCube1_Int3      = TSymbolUniqueId(2122);
    static constexpr const TSymbolUniqueId imageLoad_UImageCube1_Int3      = TSymbolUniqueId(2123);
    static constexpr const TSymbolUniqueId imageLoad_ImageBuffer1_Int1     = TSymbolUniqueId(2124);
    static constexpr const TSymbolUniqueId imageLoad_IImageBuffer1_Int1    = TSymbolUniqueId(2125);
    static constexpr const TSymbolUniqueId imageLoad_UImageBuffer1_Int1    = TSymbolUniqueId(2126);
    static constexpr const TSymbolUniqueId imageLoad_ImageCubeArray1_Int3  = TSymbolUniqueId(2127);
    static constexpr const TSymbolUniqueId imageLoad_IImageCubeArray1_Int3 = TSymbolUniqueId(2128);
    static constexpr const TSymbolUniqueId imageLoad_UImageCubeArray1_Int3 = TSymbolUniqueId(2129);
    static constexpr const TSymbolUniqueId imageLoad_Image1D1_Int1         = TSymbolUniqueId(2130);
    static constexpr const TSymbolUniqueId imageLoad_IImage1D1_Int1        = TSymbolUniqueId(2131);
    static constexpr const TSymbolUniqueId imageLoad_UImage1D1_Int1        = TSymbolUniqueId(2132);
    static constexpr const TSymbolUniqueId imageLoad_Image1DArray1_Int2    = TSymbolUniqueId(2133);
    static constexpr const TSymbolUniqueId imageLoad_IImage1DArray1_Int2   = TSymbolUniqueId(2134);
    static constexpr const TSymbolUniqueId imageLoad_UImage1DArray1_Int2   = TSymbolUniqueId(2135);
    static constexpr const TSymbolUniqueId imageLoad_Image2DRect1_Int2     = TSymbolUniqueId(2136);
    static constexpr const TSymbolUniqueId imageLoad_IImage2DRect1_Int2    = TSymbolUniqueId(2137);
    static constexpr const TSymbolUniqueId imageLoad_UImage2DRect1_Int2    = TSymbolUniqueId(2138);
    static constexpr const TSymbolUniqueId imageLoad_Image2DMS1_Int2_Int1  = TSymbolUniqueId(2139);
    static constexpr const TSymbolUniqueId imageLoad_IImage2DMS1_Int2_Int1 = TSymbolUniqueId(2140);
    static constexpr const TSymbolUniqueId imageLoad_UImage2DMS1_Int2_Int1 = TSymbolUniqueId(2141);
    ...
    static constexpr const TSymbolUniqueId imageStore_Image2D1_Int2_Float4 = TSymbolUniqueId(2145);
    static constexpr const TSymbolUniqueId imageStore_IImage2D1_Int2_Int4  = TSymbolUniqueId(2146);
    static constexpr const TSymbolUniqueId imageStore_UImage2D1_Int2_UInt4 = TSymbolUniqueId(2147);
    static constexpr const TSymbolUniqueId imageStore_Image3D1_Int3_Float4 = TSymbolUniqueId(2148);
    static constexpr const TSymbolUniqueId imageStore_IImage3D1_Int3_Int4  = TSymbolUniqueId(2149);
    static constexpr const TSymbolUniqueId imageStore_UImage3D1_Int3_UInt4 = TSymbolUniqueId(2150);
    ...
    static constexpr const TSymbolUniqueId imageStore_IImageCube1_Int3_Int4 = TSymbolUniqueId(2155);
    ...
    static constexpr const TSymbolUniqueId imageStore_Image1D1_Int1_Float4 = TSymbolUniqueId(2163);
    static constexpr const TSymbolUniqueId imageStore_IImage1D1_Int1_Int4  = TSymbolUniqueId(2164);
    static constexpr const TSymbolUniqueId imageStore_UImage1D1_Int1_UInt4 = TSymbolUniqueId(2165);
    ...
    static constexpr const TSymbolUniqueId noise1_Float1                    = TSymbolUniqueId(2178);
    static constexpr const TSymbolUniqueId noise1_Float2                    = TSymbolUniqueId(2179);
    static constexpr const TSymbolUniqueId noise1_Float3                    = TSymbolUniqueId(2180);
    static constexpr const TSymbolUniqueId noise1_Float4                    = TSymbolUniqueId(2181);
    static constexpr const TSymbolUniqueId noise2_Float1                    = TSymbolUniqueId(2182);
    static constexpr const TSymbolUniqueId noise2_Float2                    = TSymbolUniqueId(2183);
    static constexpr const TSymbolUniqueId noise2_Float3                    = TSymbolUniqueId(2184);
    static constexpr const TSymbolUniqueId noise2_Float4                    = TSymbolUniqueId(2185);
    static constexpr const TSymbolUniqueId noise3_Float1                    = TSymbolUniqueId(2186);
    static constexpr const TSymbolUniqueId noise3_Float2                    = TSymbolUniqueId(2187);
    static constexpr const TSymbolUniqueId noise3_Float3                    = TSymbolUniqueId(2188);
    static constexpr const TSymbolUniqueId noise3_Float4                    = TSymbolUniqueId(2189);
    static constexpr const TSymbolUniqueId noise4_Float1                    = TSymbolUniqueId(2190);
    static constexpr const TSymbolUniqueId noise4_Float2                    = TSymbolUniqueId(2191);
    static constexpr const TSymbolUniqueId noise4_Float3                    = TSymbolUniqueId(2192);
    static constexpr const TSymbolUniqueId noise4_Float4                    = TSymbolUniqueId(2193);
    static constexpr const TSymbolUniqueId memoryBarrier                    = TSymbolUniqueId(2194);
    static constexpr const TSymbolUniqueId memoryBarrierAtomicCounter       = TSymbolUniqueId(2195);
    static constexpr const TSymbolUniqueId memoryBarrierBuffer              = TSymbolUniqueId(2196);
    static constexpr const TSymbolUniqueId memoryBarrierImage               = TSymbolUniqueId(2197);
    static constexpr const TSymbolUniqueId barrier                          = TSymbolUniqueId(2198);
    static constexpr const TSymbolUniqueId memoryBarrierShared              = TSymbolUniqueId(2199);
    static constexpr const TSymbolUniqueId groupMemoryBarrier               = TSymbolUniqueId(2200);
    static constexpr const TSymbolUniqueId EmitVertex                       = TSymbolUniqueId(2201);
    static constexpr const TSymbolUniqueId EndPrimitive                     = TSymbolUniqueId(2202);
    static constexpr const TSymbolUniqueId EmitStreamVertex_Int1            = TSymbolUniqueId(2203);
    static constexpr const TSymbolUniqueId EndStreamPrimitive_Int1          = TSymbolUniqueId(2204);
    static constexpr const TSymbolUniqueId subpassLoad_SubpassInput1        = TSymbolUniqueId(2205);
    static constexpr const TSymbolUniqueId pt00O                            = TSymbolUniqueId(2206);
    static constexpr const TSymbolUniqueId subpassLoad_ISubpassInput1       = TSymbolUniqueId(2207);
    static constexpr const TSymbolUniqueId pt00P                            = TSymbolUniqueId(2208);
    static constexpr const TSymbolUniqueId subpassLoad_USubpassInput1       = TSymbolUniqueId(2209);
    static constexpr const TSymbolUniqueId pt00Q                            = TSymbolUniqueId(2210);
    static constexpr const TSymbolUniqueId subpassLoad_SubpassInputMS1_Int1 = TSymbolUniqueId(2211);
    static constexpr const TSymbolUniqueId pt00R                            = TSymbolUniqueId(2212);
    static constexpr const TSymbolUniqueId subpassLoad_ISubpassInputMS1_Int1 =
        TSymbolUniqueId(2213);
    static constexpr const TSymbolUniqueId pt00S = TSymbolUniqueId(2214);
    static constexpr const TSymbolUniqueId subpassLoad_USubpassInputMS1_Int1 =
        TSymbolUniqueId(2215);
    static constexpr const TSymbolUniqueId pt00T                           = TSymbolUniqueId(2216);
    static constexpr const TSymbolUniqueId anyInvocation_Bool1             = TSymbolUniqueId(2217);
    static constexpr const TSymbolUniqueId allInvocations_Bool1            = TSymbolUniqueId(2218);
    static constexpr const TSymbolUniqueId allInvocationsEqual_Bool1       = TSymbolUniqueId(2219);
    ...
    static constexpr const TSymbolUniqueId gl_MaxVertexAttribs             = TSymbolUniqueId(2222);
    static constexpr const TSymbolUniqueId gl_MaxVertexUniformVectors      = TSymbolUniqueId(2223);
    static constexpr const TSymbolUniqueId gl_MaxVertexTextureImageUnits   = TSymbolUniqueId(2224);
    static constexpr const TSymbolUniqueId gl_MaxCombinedTextureImageUnits = TSymbolUniqueId(2225);
    static constexpr const TSymbolUniqueId gl_MaxTextureImageUnits         = TSymbolUniqueId(2226);
    static constexpr const TSymbolUniqueId gl_MaxFragmentUniformVectors    = TSymbolUniqueId(2227);
    static constexpr const TSymbolUniqueId gl_MaxVaryingVectors            = TSymbolUniqueId(2228);
    static constexpr const TSymbolUniqueId gl_MaxDrawBuffers               = TSymbolUniqueId(2229);
    static constexpr const TSymbolUniqueId gl_MaxDualSourceDrawBuffersEXT  = TSymbolUniqueId(2230);
    static constexpr const TSymbolUniqueId gl_MaxVertexOutputVectors       = TSymbolUniqueId(2231);
    static constexpr const TSymbolUniqueId gl_MaxFragmentInputVectors      = TSymbolUniqueId(2232);
    static constexpr const TSymbolUniqueId gl_MinProgramTexelOffset        = TSymbolUniqueId(2233);
    static constexpr const TSymbolUniqueId gl_MaxProgramTexelOffset        = TSymbolUniqueId(2234);
    static constexpr const TSymbolUniqueId gl_MaxImageUnits                = TSymbolUniqueId(2235);
    static constexpr const TSymbolUniqueId gl_MaxVertexImageUniforms       = TSymbolUniqueId(2236);
    static constexpr const TSymbolUniqueId gl_MaxFragmentImageUniforms     = TSymbolUniqueId(2237);
    static constexpr const TSymbolUniqueId gl_MaxComputeImageUniforms      = TSymbolUniqueId(2238);
    static constexpr const TSymbolUniqueId gl_MaxCombinedImageUniforms     = TSymbolUniqueId(2239);
    static constexpr const TSymbolUniqueId gl_MaxCombinedShaderOutputResources =
        TSymbolUniqueId(2240);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupCount    = TSymbolUniqueId(2241);
    static constexpr const TSymbolUniqueId gl_MaxComputeWorkGroupSize     = TSymbolUniqueId(2242);
    static constexpr const TSymbolUniqueId gl_MaxComputeUniformComponents = TSymbolUniqueId(2243);
    static constexpr const TSymbolUniqueId gl_MaxComputeTextureImageUnits = TSymbolUniqueId(2244);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounters    = TSymbolUniqueId(2245);
    static constexpr const TSymbolUniqueId gl_MaxComputeAtomicCounterBuffers =
        TSymbolUniqueId(2246);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounters       = TSymbolUniqueId(2247);
    static constexpr const TSymbolUniqueId gl_MaxFragmentAtomicCounters     = TSymbolUniqueId(2248);
    static constexpr const TSymbolUniqueId gl_MaxCombinedAtomicCounters     = TSymbolUniqueId(2249);
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBindings      = TSymbolUniqueId(2250);
    static constexpr const TSymbolUniqueId gl_MaxVertexAtomicCounterBuffers = TSymbolUniqueId(2251);
    ...
    static constexpr const TSymbolUniqueId gl_MaxAtomicCounterBufferSize   = TSymbolUniqueId(2254);
    static constexpr const TSymbolUniqueId gl_MaxGeometryInputComponents   = TSymbolUniqueId(2255);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputComponents  = TSymbolUniqueId(2256);
    static constexpr const TSymbolUniqueId gl_MaxGeometryImageUniforms     = TSymbolUniqueId(2257);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTextureImageUnits = TSymbolUniqueId(2258);
    static constexpr const TSymbolUniqueId gl_MaxGeometryOutputVertices    = TSymbolUniqueId(2259);
    static constexpr const TSymbolUniqueId gl_MaxGeometryTotalOutputComponents =
        TSymbolUniqueId(2260);
    static constexpr const TSymbolUniqueId gl_MaxGeometryUniformComponents = TSymbolUniqueId(2261);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounters    = TSymbolUniqueId(2262);
    static constexpr const TSymbolUniqueId gl_MaxGeometryAtomicCounterBuffers =
        TSymbolUniqueId(2263);
    static constexpr const TSymbolUniqueId gl_FragCoord             = TSymbolUniqueId(2264);
    static constexpr const TSymbolUniqueId gl_FrontFacing           = TSymbolUniqueId(2265);
    static constexpr const TSymbolUniqueId gl_PointCoord            = TSymbolUniqueId(2266);
    static constexpr const TSymbolUniqueId gl_FragColor             = TSymbolUniqueId(2267);
    static constexpr const TSymbolUniqueId gl_FragData              = TSymbolUniqueId(2268);
    static constexpr const TSymbolUniqueId gl_FragDepth             = TSymbolUniqueId(2269);
    ...
    static constexpr const TSymbolUniqueId gl_VertexID              = TSymbolUniqueId(2282);
    static constexpr const TSymbolUniqueId gl_ViewportIndex         = TSymbolUniqueId(2283);
    static constexpr const TSymbolUniqueId gl_LayerVS               = TSymbolUniqueId(2284);
    static constexpr const TSymbolUniqueId gl_DrawID                = TSymbolUniqueId(2285);
    static constexpr const TSymbolUniqueId gl_DrawIDESSL1           = TSymbolUniqueId(2286);
    static constexpr const TSymbolUniqueId gl_BaseVertex            = TSymbolUniqueId(2287);
    static constexpr const TSymbolUniqueId gl_BaseInstance          = TSymbolUniqueId(2288);
    ...
    static constexpr const TSymbolUniqueId gl_ViewID_OVRESSL1       = TSymbolUniqueId(2304);
