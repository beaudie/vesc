...
// Hack to represent shaderType = !GL_COMPUTE_SHADER
#define NOT_GL_COMPUTE_SHADER 0x7194
...
struct SymbolEntry
{
    ...
    constexpr SymbolEntry(ImmutableString &&name,
                          ...
                          sh::GLenum esslExtShaderType2    = 0,
