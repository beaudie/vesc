...
struct ValidateASTOptions
{
    ...
    // Check that references to structs and interface blocks are matched with the corresponding
    // struct and interface block declaration.
    bool validateStructAndInterfaceBlockUsage = true;
