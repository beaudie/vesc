                              ...
                              unsigned numberOfViews)
{
    ...
    TIntermConstantUnion *numberOfViewsUintSymbol = new TIntermConstantUnion(
        numberOfViewsUnsignedConstant, TType(EbtUInt, EbpHigh, EvqTemporary));
...
void DeclareAndInitBuiltinsForInstancedMultiview(TIntermBlock *root, unsigned numberOfViews)
{
    ...
    InitializeBuiltinsInMain(root, instanceIDSymbol, viewIDSymbol, numberOfViews);
