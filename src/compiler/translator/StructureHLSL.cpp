                                      ...
                                      const TIntermSequence *parameters)
{
    ...
    else if (parameters)
    {
        ...
        for (auto parameter : *parameters)
        {
            ...
            // Parameters need to be included in the constructor function name to disambiguate
            // between different constructor functions, particularly between float2x2 and float4
            // parameters.
            constructorFunctionName += "_" + TypeString(paramType);
        }
    }
    else UNREACHABLE();
