...
class TType
{
  public:
    ...
    {
        t.mArraySizes = TSpan<unsigned int>();
    }
    ...
    const TSpan<unsigned int> &getArraySizes() const { return mArraySizes; }
    ...
    void makeIdenticalArrays(const TType &t);
    ...
    void sizeUnsizedArrays(const TSpan<unsigned int> &newArraySizes);
  ...
  private:
    ...
    void makeArraysInternal(const TSpan<unsigned int> &sizes);
    ...
    TSpan<unsigned int> mArraySizes;
