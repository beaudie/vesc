...
class TParseContext : angle::NonCopyable
{
  public:
    TParseContext(TSymbolTable &symt,
        ...
        : intermediate(interm),
          ...
          mComputeWorkGroupSizeDeclared(false),
          mLocalSizeX(1),
          mLocalSizeY(1),
          mLocalSizeZ(1),
    ...
    bool isWorkGroupSizeDeclared() const { return mComputeWorkGroupSizeDeclared; }
    ...
    bool paramErrorCheck(const TSourceLoc &line, const TPublicType &publicType, TType *type);
    ...
    bool layoutSupportedErrorCheck(const TSourceLoc &location,
                                   const TString &layoutQualifierName,
                                   int versionRequired);
    bool layoutWorkGroupSizeErrorCheck(const TSourceLoc &location,
                                       const TLayoutQualifier &layoutQualifier);
    bool functionCallLValueErrorCheck(const TFunction *fnCandidate, TIntermAggregate *);
    void invariantErrorCheck(bool invariant,
    ...
    TPublicType addFullySpecifiedType(const TPublicType &publicType,
  ...
  private:
    ...
    bool mComputeWorkGroupSizeDeclared;
    int mLocalSizeX;
    int mLocalSizeY;
    int mLocalSizeZ;
