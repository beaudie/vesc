...
class TParseContext : angle::NonCopyable
{
  public:
    ...
    TFunction *parseFunctionHeader(const TPublicType &type,
                                   const ImmutableString &name,
                                   const TSourceLoc &location);
    TFunction *addNonConstructorFunc(const ImmutableString &name, const TSourceLoc &loc);
  ...
  private:
    ...
    TIntermTyped *addMethod(const ImmutableString &name,
                            TIntermSequence *arguments,
                            TIntermNode *thisNode,
                            const TSourceLoc &loc);
    TIntermTyped *addConstructor(TIntermSequence *arguments,
                                 TType type,
                                 const TSourceLoc &line);
    TIntermTyped *addNonConstructorFunctionCall(const ImmutableString &name,
                                                TIntermSequence *arguments,
                                                const TSourceLoc &loc);
