...
class TParseContext : angle::NonCopyable
{
  public:
    ...
    void checkLocalVariableStorageQualifier(const TQualifierWrapperBase &qualifier);
    ...
    TPublicType addFullySpecifiedType(const TQualifierSequence &qualifierSequence,
    ...
    TIntermAggregate *parseInvariantDeclaration(const TQualifierSequence &qualifierSequence,
    ...
    void parseGlobalLayoutQualifier(const TQualifierSequence &qualifierSequence);
    ...
    TFieldList *addStructDeclaratorListWithQualifiers(const TQualifierSequence &qualifierSequence,
    ...
    TIntermAggregate *addInterfaceBlock(const TQualifierSequence &qualifierSequence,
                                        const TSourceLoc &nameLine,
