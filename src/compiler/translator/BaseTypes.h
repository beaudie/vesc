...
inline TBasicType convertGTypeToFloat(TBasicType type)
{
    switch (type)
    {
        case EbtGSampler2D:
        ...
        case EbtGSampler3D:
            return EbtSampler3D;
        case EbtGSamplerCube:
            return EbtSamplerCube;
        case EbtGSampler2DArray:
            return EbtSampler2DArray;
        case EbtGImage2D:
            return EbtImage2D;
        case EbtGImage3D:
            return EbtImage3D;
...
inline TBasicType convertGTypeToInt(TBasicType type)
{
    switch (type)
    {
        case EbtGSampler2D:
            return EbtISampler2D;
        case EbtGSampler3D:
            return EbtISampler3D;
        case EbtGSamplerCube:
            return EbtISamplerCube;
        case EbtGSampler2DArray:
            return EbtISampler2DArray;
        case EbtGImage2D:
            return EbtIImage2D;
        case EbtGImage3D:
            return EbtIImage3D;
...
inline TBasicType convertGTypeToUnsigned(TBasicType type)
{
    switch (type)
    {
        case EbtGSampler2D:
            return EbtUSampler2D;
        case EbtGSampler3D:
            return EbtUSampler3D;
        case EbtGSamplerCube:
            return EbtUSamplerCube;
        case EbtGSampler2DArray:
            return EbtUSampler2DArray;
        case EbtGImage2D:
            return EbtUImage2D;
        case EbtGImage3D:
            return EbtUImage3D;
