                                   ...
                                   ShaderVariableVisitor *visitor)
{
    ...
    for (unsigned int arrayElement = 0u; arrayElement < count; ++arrayElement)
    {
        ...
        else
        {
            ...
            {
                visitor->visitOpaqueVariable(elementVar);
            }
            else
            {
...
void VariableNameVisitor::visitOpaqueVariable(const sh::ShaderVariable &variable)
{
    ...
    visitNamedSampler(variable, name, mappedName, mArraySizeStack);
}
                            ...
                            ShaderVariableVisitor *visitor)
{
    ...
    {
        visitor->visitOpaqueVariable(variable);
    }
    else
    {
