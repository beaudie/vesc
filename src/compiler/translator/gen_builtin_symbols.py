...
{{
    ...
    if (entry.esslExtSymbol && entry.esslExtSymbol->name() == name && !IsDesktopGLSpec(mShaderSpec) &&
    ...
    if (entry.glslExtSymbol && entry.glslExtSymbol->name() == name && IsDesktopGLSpec(mShaderSpec) &&
