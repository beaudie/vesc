...
{{
    ...
    {{
        if(entry.esslExtSymbol2)
        {{
            return entry.esslExtSymbol2;
        }}
        if(entry.esslExtVar2)
        {{
            return this->*(entry.esslExtVar2);
        }}
    }}
    return nullptr;
}}
