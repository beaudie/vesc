...
def process_function_group(group_name, group):
    ...
    if 'queryFunction' in group:
        ...
        template_is_in_group_declaration = 'bool is{group_name}(const TFunction *func);'
        is_in_group_declarations.append(template_is_in_group_declaration.format(**template_args))
