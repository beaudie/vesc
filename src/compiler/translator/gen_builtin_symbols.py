...
template_header = """// GENERATED FILE - DO NOT EDIT.
...
// This is a class instead of a namespace so that we can friend this from TSymbolUniqueId.
class BuiltInId
{{
  public:
...
// from TVariable. Now we have to keep symbol constructors taking an id as public even though it's
// supposed to not be accessible from outside of here.
...
with open('BuiltIn_autogen.h', 'wt') as outfile_header:
    output_header = template_header.format(
