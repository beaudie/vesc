...
# Added GLSL types starting at Double to keep mangled names the same for other types
basic_types_enumeration = [
    ...
    'IImageCube', 'UImageCube', 'Double', 'Sampler1D', 'Sampler1DArray', 'Sampler1DArrayShadow',
    'SamplerBuffer', 'SamplerCubeArray', 'SamplerCubeArrayShadow', 'Sampler1DShadow',
    'Sampler2DRectShadow', 'ISampler1D', 'ISampler1DArray', 'ISampler1DArrayShadow',
    'ISampler2DRect', 'ISamplerBuffer', 'ISamplerCubeArray', 'ISamplerCubeArrayShadow',
    'USampler1D', 'USampler1DArray', 'USampler1DArrayShadow', 'USampler2DRect', 'USamplerBuffer',
    'USamplerCubeArray', 'USamplerCubeArrayShadow', 'SubpassInput', 'ISubpassInput',
    'USubpassInput', 'SubpassInputMS', 'ISubpassInputMS', 'USubpassInputMS', 'Image1D', 'IImage1D',
    'UImage1D', 'Image1DArray', 'IImage1DArray', 'UImage1DArray', 'Image2DMS', 'IImage2DMS',
    'UImage2DMS', 'Image2DMSArray', 'IImage2DMSArray', 'UImage2DMSArray', 'Image2DRect',
    'IImage2DRect', 'UImage2DRect', 'ImageCubeArray', 'IImageCubeArray', 'UImageCubeArray',
    'ImageRect', 'IImageRect', 'UImageRect', 'ImageBuffer', 'IImageBuffer', 'UImageBuffer'
]
...
def get_basic_mangled_name(basic):
    ...
    if index < 78:
        return '0' + chr(ord('A') + index - 52)
    return '0' + chr(ord('a') + index - 78)
...
class TType:
    ...
    def specific_image_params_variant(self, variant, basic_type_prefix):
        params = []
...
{{
    return &UnmangledBuiltIns::{extension};
        ...
        for function_props in function_variants:
            ...
            template_mangled_if = """if (name.beginsWith(BuiltInName::{unique_name}))
{{
...
{{
    return &BuiltInVariable::kVar_{name_with_suffix};
                ...
                get_builtin_if_statements.add_obj(level, None, condition, template_args['name'],
...
{{{condition_comment}
    return mVar_{name_with_suffix};
            ...
            name_if = template_name_if.format(**template_args)
            get_builtin_if_statements.add_obj(level, None, get_condition, variable_name,
                                              {'hash_matched_code': name_if})
...
def main():
    ...
    # Check if we've already ran it with the same inputs.
    m = hashlib.md5()
