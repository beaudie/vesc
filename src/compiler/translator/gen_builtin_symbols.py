...
def process_variable_group(group_name, group):
    ...
    if 'variables' in group:
        for variable_name, props in group['variables'].iteritems():
            ...
            template_variable_declaration = 'constexpr const TVariable {name}{suffix}(BuiltInId::{name}{suffix}, BuiltInName::{name}, SymbolType::BuiltIn, TExtension::{extension}, {type});'
