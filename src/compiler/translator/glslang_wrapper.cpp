...
void GetBuiltInResources(const ShBuiltInResources &resources, TBuiltInResource *outResources)
{
    ...
    // outResources->maxClipPlanes                    = resources.MaxClipPlanes;
    ...
    // outResources->maxFragmentInputComponents       = resources.MaxFragmentInputComponents;
    ...
    // outResources->maxLights                        = resources.MaxLights;
    outResources->maxProgramTexelOffset = resources.MaxProgramTexelOffset;
    // outResources->maxVaryingComponents             = resources.MaxVaryingComponents;
    outResources->maxVaryingVectors = resources.MaxVaryingVectors;
    // outResources->maxVertexAttribs                 = resources.MaxVertexAttributes;
    // outResources->maxVertexOutputComponents        = resources.MaxVertexOutputComponents;
                                            ...
                                            std::vector<uint32_t> *spirvBlobOut)
{
    ...
    if (!linkResult)
    {
        ERR() << "Internal error linking Vulkan shader:\n" << program.getInfoLog() << "\n";
        return false;
    }
