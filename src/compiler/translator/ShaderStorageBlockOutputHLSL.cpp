...
BlockMemberInfoMap blockMemberInfoMap;
                                          ...
                                          TLayoutBlockStorage storage)
{
    for (const TField *field : fields)
    {
        ...
        if (fieldType.getStruct())
        {
            ...
            blockMemberInfoMap[field] = memberInfo;
...
bool IsArrayOfSSBOArrays(TIntermTyped *node)
{
                                                                       ...
                                                                       TIntermBinary *node)
{
    ...
    if (visit == InVisit)
    {
        ...
        if (IsArrayOfSSBOArrays(node->getLeft()))
        {
    ...
    else if (visit == PostVisit)
    {
        ...
        // true.
        if (IsArrayOfSSBOArrays(node->getLeft()) && !node->getType().isArray())
        {
            out << ")";
        }
...
{
    const BlockMemberInfo &memberInfo = blockMemberInfoMap[field];
