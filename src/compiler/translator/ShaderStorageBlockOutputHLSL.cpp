...
void ShaderStorageBlockOutputHLSL::traverseAssignementLeftHandSide(TIntermBinary *node)
{
    mBufferVariableInAssignLeft = true;
    traverseAssignementInternal(node->getLeft(), SSBOMethod::STORE);
}

void ShaderStorageBlockOutputHLSL::traverseAssignementRightHandSide(TIntermBinary *node)
{
    mBufferVariableInAssignLeft = false;
    traverseAssignementInternal(node->getRight(), SSBOMethod::LOAD);
}

void ShaderStorageBlockOutputHLSL::traverseAssignementInternal(TIntermTyped *node,
                                                               SSBOMethod method)
{
...
void ShaderStorageBlockOutputHLSL::shaderStorageBlocksHeader()
{
    TInfoSinkBase &out = mOutputHLSL->getInfoSink();
                                                                       ...
                                                                       TIntermBinary *node)
{
    ...
    else if (visit == PostVisit && !mBufferVariableInAssignLeft && isEndOfSSBOAccessChain())
    {
        out << ")";
    }
}
...
void ShaderStorageBlockOutputHLSL::writeDotOperatorOutput(TInfoSinkBase &out, const TField *field)
{
    ...
    if (!mBufferVariableInAssignLeft && isEndOfSSBOAccessChain())
    {
        out << ")";
    }
}
