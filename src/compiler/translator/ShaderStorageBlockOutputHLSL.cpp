...
void SetShaderStorageBlockStructMemberInfo(const TFieldList &fields,
                                           sh::BlockLayoutEncoder *encoder,
                                           TLayoutBlockStorage storage)
{
...
void SetShaderStorageBlockStructArrayMemberInfo(TField *field,
                                                ...
                                                TLayoutBlockStorage storage)
{
    ...
    for (unsigned int arrayElement = 0u; arrayElement < currentArraySize; ++arrayElement)
    {
        ...
        {
            SetShaderStorageBlockStructArrayMemberInfo(field, arrayNestingIndex + 1u, encoder,
                                                       storage);
        }
        else
        {
            SetShaderStorageBlockStructMemberInfo(fieldType.getStruct()->fields(), encoder,
                                                  storage);
        }
    }
}
    ...
    for (TField *field : fields)
    {
        ...
        if (fieldType.getStruct())
        {
            ...
            if (fieldType.isArray())
            {
                ...
                SetShaderStorageBlockStructArrayMemberInfo(field, 0u, encoder, storage);
            }
            else
            {
                SetShaderStorageBlockStructMemberInfo(fieldType.getStruct()->fields(), encoder,
