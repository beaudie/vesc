...
bool OutputSPIRVTraverser::visitSwitch(Visit visit, TIntermSwitch *node)
{
    ...
    if (visit == InVisit)
    {
        ...
        // TODO: write test with empty block at end.  They should automatically jump to merge block.
        // TODO: write a test with nothing like this, does this cause validation errors?
        //
        // switch (x)
        // {
        //   case 1:
