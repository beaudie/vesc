                                        ...
                                        const SpirvTypeSpec &expectedTypeSpec)
{
    ...
    // differentiated by |valueTypeSpec|.  However, it's being assigned (for example through
    // operator=, used in a constructor or passed as a function argument) where the same GLSL type
    // is expected but with differnet SPIR-V type differenations (|expectedTypeSpec|).  SPIR-V 1.4
