...
def _CheckFirefoxCompatability(input_api, output_api):
    ...
    try:
        ...
        try:
            subprocess.check_output(
                ['vpython3', export_target_script, outdir] + _FIREFOX_EXPORT_TARGETS,
...
def CheckChangeOnUpload(input_api, output_api):
    ...
    results.extend(_CheckFirefoxCompatability(input_api, output_api))
    results.extend(
