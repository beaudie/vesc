...
class ProcessImpl : public Process
{
  public:
                ...
                ProcessOutputCapture captureOutput)
    {
        ...
        // Chrome also sets these flags.
        spawnFlags |= FDIO_SPAWN_CLONE_NAMESPACE | FDIO_SPAWN_CLONE_JOB;
        ...
        // FIXME: find out how to run the test executable. http://anglebug.com/7312
        std::string exeName = args[0];
        args[0]             = exeName.c_str();

        char errorMessage[FDIO_SPAWN_ERR_MSG_MAX_LENGTH];
        zx_status_t status =
            fdio_spawn_etc(job->get(), spawnFlags, args[0], args.data(), nullptr, 0, nullptr,
                           mProcessHandle.reset_and_get_address(), errorMessage);
