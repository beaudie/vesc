...
DEFINE_ANGLE_TEST_PLATFORM(D3D9_SOFTWARE,          EGL_PLATFORM_ANGLE_TYPE_D3D9_ANGLE,  EGL_DONT_CARE, EGL_DONT_CARE, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
...
DEFINE_ANGLE_TEST_PLATFORM(D3D11_FL9_3,            EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE,            10,             0, EGL_PLATFORM_ANGLE_DEVICE_TYPE_HARDWARE_ANGLE);

DEFINE_ANGLE_TEST_PLATFORM(D3D11_SOFTWARE,         EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE, EGL_DONT_CARE, EGL_DONT_CARE, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
DEFINE_ANGLE_TEST_PLATFORM(D3D11_FL11_0_SOFTWARE,  EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE,            11,             0, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
DEFINE_ANGLE_TEST_PLATFORM(D3D11_FL10_1_SOFTWARE,  EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE,            10,             1, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
DEFINE_ANGLE_TEST_PLATFORM(D3D11_FL10_0_SOFTWARE,  EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE,            10,             0, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
DEFINE_ANGLE_TEST_PLATFORM(D3D11_FL9_3_SOFTWARE,   EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE,             9,             3, EGL_PLATFORM_ANGLE_DEVICE_TYPE_SOFTWARE_ANGLE);
...
typedef TestFixture<2, D3D9_SOFTWARE>          ES2_D3D9_SOFTWARE;
...
typedef TestFixture<2, D3D11_SOFTWARE>         ES2_D3D11_SOFTWARE;
typedef TestFixture<2, D3D11_FL11_0_SOFTWARE>  ES2_D3D11_FL11_0_SOFTWARE;
typedef TestFixture<2, D3D11_FL10_1_SOFTWARE>  ES2_D3D11_FL10_1_SOFTWARE;
typedef TestFixture<2, D3D11_FL10_0_SOFTWARE>  ES2_D3D11_FL10_0_SOFTWARE;
typedef TestFixture<2, D3D11_FL9_3_SOFTWARE>   ES2_D3D11_FL9_3_SOFTWARE;
...
typedef TestFixture<3, D3D11_FL9_3>            ES3_D3D11_FL9_3;

typedef TestFixture<3, D3D11_SOFTWARE>         ES3_D3D11_SOFTWARE;
typedef TestFixture<3, D3D11_FL11_0_SOFTWARE>  ES3_D3D11_FL11_0_SOFTWARE;
typedef TestFixture<3, D3D11_FL10_1_SOFTWARE>  ES3_D3D11_FL10_1_SOFTWARE;
typedef TestFixture<3, D3D11_FL10_0_SOFTWARE>  ES3_D3D11_FL10_0_SOFTWARE;
typedef TestFixture<3, D3D11_FL9_3_SOFTWARE>   ES3_D3D11_FL9_3_SOFTWARE;
...
typedef TestFixture<3, D3D11_FL9_3_REFERENCE>  ES3_D3D11_FL9_3_REFERENCE;
