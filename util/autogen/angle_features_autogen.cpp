...
constexpr PackedEnumMap<Feature, const char *> kFeatureNames = {{
    ...
    {Feature::UseEmptyChunksToErasePipelineBlobCacheData, "useEmptyChunksToErasePipelineBlobCacheData"},
    ...
    {Feature::UsePipelineBlobCacheChunksVerificationLoop, "usePipelineBlobCacheChunksVerificationLoop"},
    ...
    {Feature::VerifyStoredPipelineBlobCacheChunks, "verifyStoredPipelineBlobCacheChunks"},
