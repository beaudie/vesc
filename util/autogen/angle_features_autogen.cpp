...
constexpr PackedEnumMap<Feature, const char *> kFeatureNames = {{
    ...
    {Feature::EnableLowLatencyExtension, "enableLowLatencyExtension"},
    ...
    {Feature::SupportsAMDAntiLag, "supportsAMDAntiLag"},
    ...
    {Feature::SupportsNVLowLatency2, "supportsNVLowLatency2"},
