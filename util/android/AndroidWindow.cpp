...
static struct android_app *sApp = nullptr;
static pthread_mutex_t sInitWindowMutex;
static pthread_cond_t sInitWindowCond;
static bool sInitWindowDone = false;
...
void android_main(struct android_app *app)
{
    ...
    sApp = app;
    pthread_mutex_init(&sInitWindowMutex, NULL);
    pthread_cond_init(&sInitWindowCond, NULL);
