...
ANGLE_UTIL_EXPORT PFNGLFRAMEBUFFERTEXTUREMULTISAMPLEMULTIVIEWOVRCONTEXTANGLEPROC
...
void LoadGLES(LoadProc loadProc)
{
    ...
    glFramebufferTextureMultisampleMultiviewOVRContextANGLE =
        reinterpret_cast<PFNGLFRAMEBUFFERTEXTUREMULTISAMPLEMULTIVIEWOVRCONTEXTANGLEPROC>(
            loadProc("glFramebufferTextureMultisampleMultiviewOVRContextANGLE"));
