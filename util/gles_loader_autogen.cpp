...
ANGLE_UTIL_EXPORT PFNGLTEXSTORAGE2DEXTERNALANGLEPROC glTexStorage2DExternalANGLE;
...
ANGLE_UTIL_EXPORT PFNGLTEXSTORAGE2DEXTERNALANGLECONTEXTANGLEPROC
...
void LoadGLES(LoadProc loadProc)
{
    ...
    glTexStorage2DExternalANGLE = reinterpret_cast<PFNGLTEXSTORAGE2DEXTERNALANGLEPROC>(
        loadProc("glTexStorage2DExternalANGLE"));
    ...
    glTexStorage2DExternalANGLEContextANGLE =
        reinterpret_cast<PFNGLTEXSTORAGE2DEXTERNALANGLECONTEXTANGLEPROC>(
            loadProc("glTexStorage2DExternalANGLEContextANGLE"));
    glGetTranslatedShaderSourceANGLEContextANGLE =
