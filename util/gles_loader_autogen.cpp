...
ANGLE_UTIL_EXPORT PFNGLPROVOKINGVERTEXPROC glProvokingVertex;
...
ANGLE_UTIL_EXPORT PFNGLPROVOKINGVERTEXCONTEXTANGLEPROC glProvokingVertexContextANGLE;
...
void LoadGLES(LoadProc loadProc)
{
    ...
    glProvokingVertex = reinterpret_cast<PFNGLPROVOKINGVERTEXPROC>(loadProc("glProvokingVertex"));
    ...
    glProvokingVertexContextANGLE = reinterpret_cast<PFNGLPROVOKINGVERTEXCONTEXTANGLEPROC>(
        loadProc("glProvokingVertexContextANGLE"));
    glBindUniformLocationCHROMIUMContextANGLE =
