...
ANGLE_UTIL_EXPORT PFNGLEXTGETBUFFERPOINTERVQCOMPROC glExtGetBufferPointervQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETBUFFERSQCOMPROC glExtGetBuffersQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETFRAMEBUFFERSQCOMPROC glExtGetFramebuffersQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETRENDERBUFFERSQCOMPROC glExtGetRenderbuffersQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXLEVELPARAMETERIVQCOMPROC glExtGetTexLevelParameterivQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXSUBIMAGEQCOMPROC glExtGetTexSubImageQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXTURESQCOMPROC glExtGetTexturesQCOM;
ANGLE_UTIL_EXPORT PFNGLEXTTEXOBJECTSTATEOVERRIDEIQCOMPROC glExtTexObjectStateOverrideiQCOM;
...
ANGLE_UTIL_EXPORT PFNGLEXTGETBUFFERPOINTERVQCOMCONTEXTANGLEPROC
    glExtGetBufferPointervQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETBUFFERSQCOMCONTEXTANGLEPROC glExtGetBuffersQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETFRAMEBUFFERSQCOMCONTEXTANGLEPROC glExtGetFramebuffersQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETRENDERBUFFERSQCOMCONTEXTANGLEPROC
    glExtGetRenderbuffersQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXLEVELPARAMETERIVQCOMCONTEXTANGLEPROC
    glExtGetTexLevelParameterivQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXSUBIMAGEQCOMCONTEXTANGLEPROC glExtGetTexSubImageQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTGETTEXTURESQCOMCONTEXTANGLEPROC glExtGetTexturesQCOMContextANGLE;
ANGLE_UTIL_EXPORT PFNGLEXTTEXOBJECTSTATEOVERRIDEIQCOMCONTEXTANGLEPROC
...
void LoadGLES(LoadProc loadProc)
{
    ...
    glExtGetBufferPointervQCOM =
        reinterpret_cast<PFNGLEXTGETBUFFERPOINTERVQCOMPROC>(loadProc("glExtGetBufferPointervQCOM"));
    glExtGetBuffersQCOM =
        reinterpret_cast<PFNGLEXTGETBUFFERSQCOMPROC>(loadProc("glExtGetBuffersQCOM"));
    glExtGetFramebuffersQCOM =
        reinterpret_cast<PFNGLEXTGETFRAMEBUFFERSQCOMPROC>(loadProc("glExtGetFramebuffersQCOM"));
    glExtGetRenderbuffersQCOM =
        reinterpret_cast<PFNGLEXTGETRENDERBUFFERSQCOMPROC>(loadProc("glExtGetRenderbuffersQCOM"));
    glExtGetTexLevelParameterivQCOM = reinterpret_cast<PFNGLEXTGETTEXLEVELPARAMETERIVQCOMPROC>(
        loadProc("glExtGetTexLevelParameterivQCOM"));
    glExtGetTexSubImageQCOM =
        reinterpret_cast<PFNGLEXTGETTEXSUBIMAGEQCOMPROC>(loadProc("glExtGetTexSubImageQCOM"));
    glExtGetTexturesQCOM =
        reinterpret_cast<PFNGLEXTGETTEXTURESQCOMPROC>(loadProc("glExtGetTexturesQCOM"));
    glExtTexObjectStateOverrideiQCOM = reinterpret_cast<PFNGLEXTTEXOBJECTSTATEOVERRIDEIQCOMPROC>(
    ...
    glExtGetBufferPointervQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTGETBUFFERPOINTERVQCOMCONTEXTANGLEPROC>(
            loadProc("glExtGetBufferPointervQCOMContextANGLE"));
    glExtGetBuffersQCOMContextANGLE = reinterpret_cast<PFNGLEXTGETBUFFERSQCOMCONTEXTANGLEPROC>(
        loadProc("glExtGetBuffersQCOMContextANGLE"));
    glExtGetFramebuffersQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTGETFRAMEBUFFERSQCOMCONTEXTANGLEPROC>(
            loadProc("glExtGetFramebuffersQCOMContextANGLE"));
    glExtGetRenderbuffersQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTGETRENDERBUFFERSQCOMCONTEXTANGLEPROC>(
            loadProc("glExtGetRenderbuffersQCOMContextANGLE"));
    glExtGetTexLevelParameterivQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTGETTEXLEVELPARAMETERIVQCOMCONTEXTANGLEPROC>(
            loadProc("glExtGetTexLevelParameterivQCOMContextANGLE"));
    glExtGetTexSubImageQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTGETTEXSUBIMAGEQCOMCONTEXTANGLEPROC>(
            loadProc("glExtGetTexSubImageQCOMContextANGLE"));
    glExtGetTexturesQCOMContextANGLE = reinterpret_cast<PFNGLEXTGETTEXTURESQCOMCONTEXTANGLEPROC>(
        loadProc("glExtGetTexturesQCOMContextANGLE"));
    glExtTexObjectStateOverrideiQCOMContextANGLE =
        reinterpret_cast<PFNGLEXTTEXOBJECTSTATEOVERRIDEIQCOMCONTEXTANGLEPROC>(
            loadProc("glExtTexObjectStateOverrideiQCOMContextANGLE"));
