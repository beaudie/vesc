...
ANGLE_UTIL_EXPORT PFNGLACQUIRETEXTURESPROC l_glAcquireTextures;
ANGLE_UTIL_EXPORT PFNGLRELEASETEXTURESPROC l_glReleaseTextures;
...
void LoadGLES(LoadProc loadProc)
{
    ...
    l_glAcquireTextures = reinterpret_cast<PFNGLACQUIRETEXTURESPROC>(loadProc("glAcquireTextures"));
    l_glReleaseTextures = reinterpret_cast<PFNGLRELEASETEXTURESPROC>(loadProc("glReleaseTextures"));
