...
ANGLE_UTIL_EXPORT PFNEGLPREPARECREATEWINDOWSURFACEANGLEPROC l_eglPrepareCreateWindowSurfaceANGLE;
...
void LoadUtilEGL(LoadProc loadProc)
{
    ...
    l_eglPrepareCreateWindowSurfaceANGLE =
        reinterpret_cast<PFNEGLPREPARECREATEWINDOWSURFACEANGLEPROC>(
            loadProc("eglPrepareCreateWindowSurfaceANGLE"));
