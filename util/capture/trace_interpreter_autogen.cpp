                             ...
                             const TraceShaderMap &shaders)
{
    ...
    if (strcmp(nameToken, "CreateNativeClientBuffer") == 0)
    {
        ParamBuffer params =
            ParseParameters<decltype(CreateNativeClientBuffer)>(paramTokens, shaders);
        return CallCapture("CreateNativeClientBuffer", std::move(params));
    }
