                           ...
                           TraceInfo *traceInfoOut)
{
    ...
    traceInfoOut->isBinaryDataCompressed = meta["IsBinaryDataCompressed"].GetInt();
    traceInfoOut->areClientArraysEnabled = meta["AreClientArraysEnabled"].GetInt();
    traceInfoOut->isBindGeneratesResourcesEnabled =
        meta["IsBindGeneratesResourcesEnabled"].GetInt();
    traceInfoOut->isWebGLCompatibilityEnabled = meta["IsWebGLCompatibilityEnabled"].GetInt();
    traceInfoOut->isRobustResourceInitEnabled = meta["IsRobustResourceInitEnabled"].GetInt();
