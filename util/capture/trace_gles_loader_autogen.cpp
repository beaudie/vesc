...
ANGLE_TRACE_LOADER_EXPORT PFNGLLATENCYMARKERANGLEPROC t_glLatencyMarkerANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLLOWLATENCYMODEANGLEPROC t_glLowLatencyModeANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNGLLOWLATENCYWAITANGLEPROC t_glLowLatencyWaitANGLE;
...
void LoadTraceGLES(LoadProc loadProc)
{
    ...
    t_glLatencyMarkerANGLE =
        reinterpret_cast<PFNGLLATENCYMARKERANGLEPROC>(loadProc("glLatencyMarkerANGLE"));
    t_glLowLatencyModeANGLE =
        reinterpret_cast<PFNGLLOWLATENCYMODEANGLEPROC>(loadProc("glLowLatencyModeANGLE"));
    t_glLowLatencyWaitANGLE =
        reinterpret_cast<PFNGLLOWLATENCYWAITANGLEPROC>(loadProc("glLowLatencyWaitANGLE"));
