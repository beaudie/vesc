...
ANGLE_TRACE_LOADER_EXPORT PFNGLMEMORYALLOCLOGANGLEPROC t_glMemoryAllocLogANGLE;
...
void LoadTraceGLES(LoadProc loadProc)
{
    ...
    t_glMemoryAllocLogANGLE =
        reinterpret_cast<PFNGLMEMORYALLOCLOGANGLEPROC>(loadProc("glMemoryAllocLogANGLE"));
