...
ANGLE_TRACE_LOADER_EXPORT PFNEGLPROGRAMCACHEPOPULATEMETALBINARYARCHIVEANGLEPROC
    t_eglProgramCachePopulateMetalBinaryArchiveANGLE;
ANGLE_TRACE_LOADER_EXPORT PFNEGLPROGRAMCACHEQUERYMETALBINARYARCHIVEANGLEPROC
    t_eglProgramCacheQueryMetalBinaryArchiveANGLE;
...
void LoadTraceEGL(LoadProc loadProc)
{
    ...
    t_eglProgramCachePopulateMetalBinaryArchiveANGLE =
        reinterpret_cast<PFNEGLPROGRAMCACHEPOPULATEMETALBINARYARCHIVEANGLEPROC>(
            loadProc("eglProgramCachePopulateMetalBinaryArchiveANGLE"));
    t_eglProgramCacheQueryMetalBinaryArchiveANGLE =
        reinterpret_cast<PFNEGLPROGRAMCACHEQUERYMETALBINARYARCHIVEANGLEPROC>(
            loadProc("eglProgramCacheQueryMetalBinaryArchiveANGLE"));
