...
#ifndef UTIL_WGL_LOADER_AUTOGEN_H_
#define UTIL_WGL_LOADER_AUTOGEN_H_

#include <GLES2/gl2.h>
#include <WGL/wgl.h>

// We add an underscore before each function name to ensure common names like "ChoosePixelFormat"
// are "SwapBuffers" don't conflict with our function pointers. We can't use a namespace because
// some functionts conflict with preprocessor definitions.
...
#endif  // UTIL_WGL_LOADER_AUTOGEN_H_
