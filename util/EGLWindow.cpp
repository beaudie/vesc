                                  ...
                                  const EGLPlatformParameters &params)
{
    ...
    for (const std::string &feature : params.disabledFeatureOverrides)
    {
        disabledFeatureOverrides.push_back(feature.c_str());
    }
    for (const std::string &feature : params.enabledFeatureOverrides)
    {
        enabledFeatureOverrides.push_back(feature.c_str());
    }
