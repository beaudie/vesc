...
GLuint CompileProgramWithTransformFeedback(
    ...
    GLenum bufferMode)
{
    return CompileProgramWithTransformFeedback(vsSource, "", fsSource, transformFeedbackVaryings,
                                               bufferMode);
}
                      ...
                      const std::string &fsSource)
{
    ...
    return CompileProgramWithTransformFeedback(vsSource, gsSource, fsSource, emptyVector, GL_NONE);
}
