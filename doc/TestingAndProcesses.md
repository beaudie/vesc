...
This might be caused by a bad bot, clicking on link "Bot assigned to task" will show recent tasks
(for example, BOT_DIED in https://crbug.com/1350556). The best course of action in this case is to stop the bot by clicking the
"stop the bot gracefully" button which will result in a task that looks like "Terminate build117-a9", and open a bug 
in the Infra>Labs component. See also: http://go/gpu-pixel-wrangler-how-to#manually-taking-a-machine-out-of-the-swarming-pool
