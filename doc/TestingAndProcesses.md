...
(for example, lots of BOT_DIED in https://crbug.com/1350556). The best course of action in this case is to stop the bot by clicking the
"stop the bot gracefully" button which will result in a task that looks like "Terminate build117-a9", then open a bug
