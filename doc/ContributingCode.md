...
If you want to contribute code to ANGLE, there are a few things you can do to
make the process flow smoothly.  These are based on the
...
We use the [Gerrit](http://code.google.com/p/gerrit) open source code review
tool. The process is similar, but not identical, to the one used by
ChromiumOS, described here:
...
### Making changes
 ...
 2. Upload the change list
    ...
    * The change list and modified files will be uploaded to
      [Gerrit](https://chromium-review.googlesource.com/#/q/project:angle/angle).
