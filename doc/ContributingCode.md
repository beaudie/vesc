...
### Build maintenance
 ...
 2. ANGLE's BUILD.gn script is used by [Chromium's gn build](https://www.chromium.org/developers/gn-build-configuration). If you change build files other than to add or remove source files you should test the build within a Chromium checkout. Ask project member for help with testing if you don't have a Chromium checkout.
