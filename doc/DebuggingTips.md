...
1. Install [Android SDK](https://g3doc.corp.google.com/devtools/ide/intellij/g3doc/docs/aswb-sdk-v2.md?cl=head).
...
4. Install [Android Debug Bridge](https://developer.android.com/studio/releases/platform-tools).
...
**Steps To Build and Use RenderDoc for Android on Windows**
1. Build arm32 and arm64 android packages
```
mkdir build-android-arm32
cd build-android-arm32/
cmake -DBUILD_ANDROID=On -DANDROID_ABI=armeabi-v7a -G "MinGW Makefiles" ..
...
```
3. Build renderdoc on windows desktop by click "build solution" in visual studio
