...
In the renderdoc directory, create
[Android builds of RenderDoc](https://github.com/baldurk/renderdoc/blob/v1.x/docs/CONTRIBUTING/Compiling.md#android):
...
Note that you need both arm32 and arm64 builds even if working with an arm64 device.
