...
3. Run `python scripts\update_angle_in_installed_unstable_chromium.py` to replace Canary's ANGLE
   with your custom ANGLE (note: Canary must be closed).
...
3. Run `python scripts/update_angle_in_installed_unstable_chromium.py` to replace Dev's ANGLE with
   your custom ANGLE
