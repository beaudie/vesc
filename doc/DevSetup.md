 ...
 * Install the [Windows SDK](https://developer.microsoft.com/en-ca/windows/downloads/sdk-archive/).
   * You can install it through Visual Studio Installer if available.
   * Currently supported Windows SDK version can be found in [vs_toolchain.py](https://chromium.googlesource.com/chromium/src/build/+/refs/heads/main/vs_toolchain.py).
