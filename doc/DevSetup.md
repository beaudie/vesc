...
translator. This is useful for implementing OpenGL ES emulators on top of
desktop OpenGL. To build the translator, build the `angle_shader_translator`
target. Run the binary without arguments to see a usage message.
