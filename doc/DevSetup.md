 ...
 * Install the [Windows 10 SDK](https://developer.microsoft.com/en-ca/windows/downloads/sdk-archive/).
   ...
   * Most often this would be the version in [vs_toolchain.py](https://chromium.googlesource.com/chromium/src/build/+/refs/heads/main/vs_toolchain.py), unless it wasn't updated in ANGLE yet.
     * You can consult ANGLE's [DEPS](https://chromium.googlesource.com/angle/angle/+/refs/heads/main/DEPS) regarding [build.git](https://chromium.googlesource.com/chromium/src/build) version currently in use.
