...
| Extension Name | NVIDIA P400 Win10 | Intel 630 Win10 | NVIDIA P400 Linux | Intel 630 Linux | SwiftShader Win10 | Pixel 4 |
| -------------- | :---------------: | :-------------: | :---------------: | :-------------: | :---------------: | :-----: |
...
| [GL_EXT_memory_object_fd](https://khronos.org/registry/OpenGL/extensions/EXT/EXT_memory_object_fd.txt) | &#10060; | &#10060; | &#10004; | &#10004; | &#10060; | &#10004; |
...
| [GL_EXT_semaphore_fd](https://khronos.org/registry/OpenGL/extensions/EXT/EXT_semaphore_fd.txt) | &#10060; | &#10060; | &#10004; | &#10004; | &#10060; | &#10004; |
...
in [`scripts/extension_data`](../scripts/extension_data). To update or
add a new configuration, first update the JSON data, then modify
[`gen_extensions.py`](../src/libANGLE/gen_extensions.py) if necessary, and
then run [`scripts/run_code_generation.py`](../scripts/run_code_generation.py).

The JSON data is sourced from public ANGLE test runs. Look for `angle_end2end_tests` in a
bot run: [example link](https://ci.chromium.org/ui/p/angle/builders/ci/win-clang-x64-rel/8183/overview).
Search for "`angle_end2end_tests`", then click on the "cas output" and find  `GLinfo_ES3_2_Vulkan.json`.
Copy and paste the file contents into a file in the folder above.
