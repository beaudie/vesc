...
*ROOT ACCESS*. Debuggable apps are [marked debuggable][Debuggable] in the manifest. See the
[android build documentation][UserDebug] for how to build Android from source.
