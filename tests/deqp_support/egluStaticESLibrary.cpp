...
{
#if (!defined(DEQP_SUPPORT_GLES3) || defined(DEQP_GLES3_RUNTIME_LOAD)) && (!defined(DEQP_SUPPORT_GLES2) || defined(DEQP_GLES2_RUNTIME_LOAD))
    return new tcu::StaticFunctionLibrary(NULL, 0);
#else
