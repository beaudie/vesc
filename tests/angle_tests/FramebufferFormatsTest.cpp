...
TYPED_TEST(FramebufferFormatsTest, RenderbufferMultisample_DEPTH_COMPONENT16)
{
    testRenderbufferMultisampleFormat(2, GL_DEPTH_ATTACHMENT, GL_DEPTH16);
}

TYPED_TEST(FramebufferFormatsTest, RenderbufferMultisample_DEPTH_COMPONENT24)
{
    testRenderbufferMultisampleFormat(3, GL_DEPTH_ATTACHMENT, GL_DEPTH24);
}

TYPED_TEST(FramebufferFormatsTest, RenderbufferMultisample_DEPTH_COMPONENT32F)
{
    testRenderbufferMultisampleFormat(3, GL_DEPTH_ATTACHMENT, GL_DEPTH32F);
}
