...
TEST_F(EGLQueryContextTest, GetConfigID)
{
...
TEST_F(EGLQueryContextTest, GetClientType)
{
    EGLint clientType;
...
TEST_F(EGLQueryContextTest, GetClientVersion)
{
    EGLint clientVersion;
    EXPECT_TRUE(eglQueryContext(mDisplay, mContext, EGL_CONTEXT_CLIENT_VERSION, &clientVersion) != EGL_FALSE);
    EXPECT_TRUE(clientVersion == CLIENT_VERSION);
}

TEST_F(EGLQueryContextTest, GetRenderBufferNoSurface)
{
    EGLint renderBuffer;
...
TEST_F(EGLQueryContextTest, GetRenderBufferBoundSurface)
{
...
TEST_F(EGLQueryContextTest, BadDisplay)
{
    EGLint val;
...
TEST_F(EGLQueryContextTest, NotInitialized)
{
    EGLint val;
    eglTerminate(mDisplay);
...
TEST_F(EGLQueryContextTest, BadContext)
{
    EGLint val;
...
TEST_F(EGLQueryContextTest, BadAttribute)
{
    EGLint val;
