...
TEST_F(CollectFragmentVariablesTest, simple_output_var)
{
...
TEST_F(CollectFragmentVariablesTest, location_output_var)
{
    const std::string &shaderString =
        "#version 300 es\n"
        "precision mediump float;\n"
...
TEST_F(CollectVertexVariablesTest, location_attribute)
{
    const std::string &shaderString =
        "#version 300 es\n"
...
TEST_F(CollectVertexVariablesTest, simple_interface_block)
{
    const std::string &shaderString =
        "#version 300 es\n"
        "uniform b1 {\n"
