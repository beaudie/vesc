...
As an ANGLE Sheriff. Your job is to:
 ...
 4. Keep the [ANGLE Standalone Testers](README.md) in good working order.
...
Chrome with the latest ANGLE changes.
 ...
 1. You will be cc'ed on ANGLE rolls. Please check failed rolls to verify there is no blocking
    breakage.
 2. You are also responsible for pausing the roller 24h before branch days, and resuming afterwards.
