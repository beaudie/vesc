...
angle_builder("android-perf", debug = False, cpu = "arm64", test_mode = "perf_tests")
angle_builder("linux-perf", debug = False, cpu = "x64", test_mode = "perf_tests")
angle_builder("win-perf", debug = False, cpu = "x64", test_mode = "perf_tests")
