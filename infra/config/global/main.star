...
def angle_mirrored_builder(name, clang, debug, cpu, uwp, trace_tests, views, verifiers):
    properties = {
        "debug": debug,
        "target_cpu": cpu,
    }
...
angle_mirrored_builder("linux-clang-dbg", True, True, "x64", False, False, views, verifiers)
angle_mirrored_builder("linux-clang-rel", True, False, "x64", False, False, views, verifiers)
angle_mirrored_builder("linux-gcc-dbg", False, True, "x64", False, False, views, verifiers)
angle_mirrored_builder("linux-gcc-rel", False, False, "x64", False, False, views, verifiers)
angle_mirrored_builder("linux-trace-rel", True, False, "x64", False, True, views, verifiers)
angle_mirrored_builder("mac-dbg", True, True, "x64", False, False, views, verifiers)
angle_mirrored_builder("mac-rel", True, False, "x64", False, False, views, verifiers)
angle_mirrored_builder("win-clang-x86-dbg", True, True, "x86", False, False, views, verifiers)
angle_mirrored_builder("win-clang-x86-rel", True, False, "x86", False, False, views, verifiers)
angle_mirrored_builder("win-clang-x64-dbg", True, True, "x64", False, False, views, verifiers)
angle_mirrored_builder("win-clang-x64-rel", True, False, "x64", False, False, views, verifiers)
angle_mirrored_builder("win-msvc-x86-dbg", False, True, "x86", False, False, views, verifiers)
angle_mirrored_builder("win-msvc-x86-rel", False, False, "x86", False, False, views, verifiers)
angle_mirrored_builder("win-msvc-x64-dbg", False, True, "x64", False, False, views, verifiers)
angle_mirrored_builder("win-msvc-x64-rel", False, False, "x64", False, False, views, verifiers)
angle_mirrored_builder("win-trace-rel", True, False, "x64", False, True, views, verifiers)
angle_mirrored_builder("winuwp-x64-dbg", False, True, "x64", True, False, views, verifiers)
angle_mirrored_builder("winuwp-x64-rel", False, False, "x64", True, False, views, verifiers)
